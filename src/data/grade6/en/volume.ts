  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'A cube-shaped storage box has a volume of 216 cm³. Recall that cubing a whole number means multiplying it by itself three times. Find the length of one side.', checkMode: 'auto', correctAnswer: '6cm', correctAnswers: ['6cm', '6 cm', '6'], explanation: 'Since the box is a cube, V = side × side × side = side³.\nWe need a number that, when cubed, gives 216.\n6 × 6 × 6 = 216, so the side length is 6 cm.\nAnswer: 6 cm' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'A cube-shaped gift box has a volume of 125 cm³. Recall that cubing a whole number means multiplying it by itself three times. Find the length of one side.', checkMode: 'auto', correctAnswer: '5cm', correctAnswers: ['5cm', '5 cm', '5'], explanation: 'Since the box is a cube, V = side³.\nWe need a number that, when cubed, gives 125.\n5 × 5 × 5 = 125, so the side length is 5 cm.\nAnswer: 5 cm' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'A cube-shaped crate has a volume of 343 cm³. Recall that cubing a whole number means multiplying it by itself three times. Find the length of one side.', checkMode: 'auto', correctAnswer: '7cm', correctAnswers: ['7cm', '7 cm', '7'], explanation: 'Since the crate is a cube, V = side³.\nWe need a number that, when cubed, gives 343.\n7 × 7 × 7 = 343, so the side length is 7 cm.\nAnswer: 7 cm' },
