...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        '<DiagramPlaceholder label="Visual showing fraction strips for 2/3, 4/6, 6/9 and 8/12 side by side as equal lengths, alongside a factor list for 36 and 48 with the HCF highlighted in orange" />',

      videoPlaceholder:
        '<VideoPlaceholder label="Short video showing how to generate equivalent fractions by multiplying and how to simplify a fraction to lowest terms using the Highest Common Factor" />',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        '<DiagramPlaceholder label="Number line from 0 to 1 showing 1/2, 2/3, 3/4, and 5/6 plotted in order with their equivalent twelfths shown below each fraction" />',

      videoPlaceholder:
        '<VideoPlaceholder label="Short video showing how to compare and order fractions by finding the LCM of the denominators and converting to equivalent fractions" />',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        '<DiagramPlaceholder label="Visual showing fraction bars for 1/4 and 2/3 converted to twelfths and combined to give 11/12 with LCM highlighted in orange converted fractions in blue and result in red" />',

      videoPlaceholder:
        '<VideoPlaceholder label="Short video showing step by step how to add and subtract fractions by finding the LCM converting to equivalent fractions and adding or subtracting numerators" />',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        '<DiagramPlaceholder label="Visual showing the conversion of 3 and 2/5 to 17/5 with whole number in blue numerator in orange denominator in red and improper fraction in green alongside the reverse conversion of 23/6 to 3 and 5/6" />',

      videoPlaceholder:
        '<VideoPlaceholder label="Short video showing how to convert between mixed numbers and improper fractions and how to add mixed numbers by converting to improper fractions first" />',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        '<DiagramPlaceholder label="Visual showing fraction multiplication for 2/3 times 3/4 with numerators multiplied in blue denominators multiplied in red the unsimplified result 6/12 and the simplified answer 1/2 in green with HCF highlighted in orange" />',

      videoPlaceholder:
        '<VideoPlaceholder label="Short video showing how to multiply a fraction by a whole number find a fraction of a whole number and multiply a fraction by a fraction with simplification" />',
    },
  ],
  topicPractice: [
