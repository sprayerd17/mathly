...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramSvg:
        '<svg viewBox="0 0 220 125" xmlns="http://www.w3.org/2000/svg"><text x="110" y="13" font-size="11" fill="#0f1f3d" font-weight="700" text-anchor="middle">Favourite Fruit — Grade 6 Survey</text><text x="6" y="28" font-size="10" fill="#0f1f3d" font-weight="700">Key:</text><circle cx="32" cy="25" r="5" fill="#16a34a"/><text x="40" y="28" font-size="10" fill="#2563eb" font-weight="700">= 10 learners</text><line x1="6" y1="34" x2="214" y2="34" stroke="#9ca3af" stroke-width="1"/><text x="6" y="54" font-size="10.5" fill="#0f1f3d" font-weight="700">Apples</text><circle cx="70" cy="50" r="6" fill="#16a34a"/><circle cx="86" cy="50" r="6" fill="#16a34a"/><circle cx="102" cy="50" r="6" fill="#16a34a"/><text x="190" y="54" font-size="11" fill="#dc2626" font-weight="700" text-anchor="middle">30</text><line x1="6" y1="64" x2="214" y2="64" stroke="#9ca3af" stroke-width="0.6" stroke-dasharray="2,2"/><text x="6" y="84" font-size="10.5" fill="#0f1f3d" font-weight="700">Bananas</text><circle cx="70" cy="80" r="6" fill="#16a34a"/><circle cx="86" cy="80" r="6" fill="#16a34a"/><path d="M 102,74 A 6,6 0 0 0 102,86 Z" fill="#16a34a"/><circle cx="102" cy="80" r="6" fill="none" stroke="#16a34a" stroke-width="1.2"/><text x="190" y="84" font-size="11" fill="#dc2626" font-weight="700" text-anchor="middle">25</text><line x1="6" y1="94" x2="214" y2="94" stroke="#9ca3af" stroke-width="0.6" stroke-dasharray="2,2"/><text x="6" y="114" font-size="10.5" fill="#0f1f3d" font-weight="700">Oranges</text><circle cx="70" cy="110" r="6" fill="#16a34a"/><path d="M 86,104 A 6,6 0 0 0 86,116 Z" fill="#16a34a"/><circle cx="86" cy="110" r="6" fill="none" stroke="#16a34a" stroke-width="1.2"/><text x="190" y="114" font-size="11" fill="#dc2626" font-weight="700" text-anchor="middle">15</text></svg>',
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        'The ordered data set written out as 3, 3, 3, 6, 9, 11, 14, with the repeated 3s in orange to show the mode and the 6 in green to show the median, and a caption below stating Mean = 7 in blue, Median = 6 in green, Mode = 3 in orange',
