...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        '<DiagramPlaceholder label="Two right-angled triangles side by side — a smaller object triangle in blue with legs 3 and 4, and a larger enlarged image triangle in green with legs 6 and 8 — showing the same shape but a different size" />',
      diagramSvg:
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        '<DiagramPlaceholder label="Squared grid showing a small blue object triangle XYZ enlarged by scale factor 2 from a purple centre of enlargement O, to a larger green image triangle X′Y′Z′, with dashed rays from O through each pair of matching vertices" />',
      diagramSvg:
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        '<DiagramPlaceholder label="Squared grid showing a larger blue object rectangle PQRS reduced by scale factor 1/2 from a purple centre of enlargement O, to a smaller red image rectangle P′Q′R′S′, with dashed rays from O through each pair of matching vertices" />',
      diagramSvg:
