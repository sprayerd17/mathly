...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video explaining place value of decimal fractions to 3 decimal places with worked examples using tenths hundredths and thousandths',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video explaining how to compare and order decimal fractions by comparing digit by digit from left to right using place value',
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video showing how to add and subtract decimal fractions by lining up decimal points and adding zeros to make equal decimal places',
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video showing how to multiply decimal fractions by a whole number and by 10 100 and 1000 with worked examples',
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video showing how to divide decimal fractions by a whole number by keeping the decimal point in position and how dividing by 10 100 and 1000 moves the decimal point to the left',
  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'Two athletes ran 100 m in 12.8 seconds and 12.79 seconds. Which time is faster (smaller)?', answer: '12.79 seconds', checkMode: 'auto', correctAnswer: '12.79', correctAnswers: ['12.79', '12.79 seconds', '12.79s'], explanation: 'Compare tenths: 8 > 7, so 12.80 > 12.79. The faster (smaller) time is 12.79 seconds.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'A learner says that in 4.004 the two 4s must have the same value because "the number reads the same both times." Is this correct? Explain.', answer: 'No — the first 4 is in the units place with value 4, and the second 4 is in the thousandths place with value 0.004. Even though the digit looks the same, its value depends entirely on its place value position.', checkMode: 'self' },
