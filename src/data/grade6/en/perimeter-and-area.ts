  ...
  practiceSets: [
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'A square tabletop has sides of 90 cm. What length of edging tape is needed to go all the way around it?', answer: '360 cm', checkMode: 'auto', correctAnswer: '360 cm', correctAnswers: ['360 cm', '360cm', '360'], explanation: 'The tape goes around the perimeter: P = 4 × side = 4 × 90 = 360 cm ✓', diagramSvg: '<svg viewBox="0 0 220 190" xmlns="http://www.w3.org/2000/svg"><rect x="55" y="35" width="110" height="110" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="110.0" y="23" font-size="14" fill="#2563eb" font-weight="700" text-anchor="middle">90 cm</text></svg>' },
        ...
        { difficulty: 'Medium', question: 'A square poster has an area of 3600 cm². What is the length of each side?', answer: '60 cm', checkMode: 'auto', correctAnswer: '60 cm', correctAnswers: ['60 cm', '60cm', '60'], explanation: 'Side × side = 3600, so the side length is the square root of 3600.\n√3600 = 60 cm ✓', diagramSvg: '<svg viewBox="0 0 220 190" xmlns="http://www.w3.org/2000/svg"><rect x="55" y="35" width="110" height="110" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="110.0" y="92.0" font-size="15" fill="#374151" text-anchor="middle">Area = 3600 cm²</text><text x="110.0" y="112.0" font-size="15" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },
    ...
    },
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'A square rug has an area of 9 m². What is the length of each side?', answer: '3 m', checkMode: 'auto', correctAnswer: '3 m', correctAnswers: ['3 m', '3m', '3'], explanation: 'Side × side = 9, so the side length is the square root of 9.\n√9 = 3 m ✓', diagramSvg: '<svg viewBox="0 0 220 190" xmlns="http://www.w3.org/2000/svg"><rect x="55" y="35" width="110" height="110" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="110.0" y="92.0" font-size="15" fill="#374151" text-anchor="middle">Area = 9 m²</text><text x="110.0" y="112.0" font-size="15" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },
    ...
    },
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'A square noticeboard has sides of 80 cm. What length of border trim is needed to go all the way around it?', answer: '320 cm', checkMode: 'auto', correctAnswer: '320 cm', correctAnswers: ['320 cm', '320cm', '320'], explanation: 'The trim goes around the perimeter: P = 4 × side = 4 × 80 = 320 cm ✓', diagramSvg: '<svg viewBox="0 0 220 190" xmlns="http://www.w3.org/2000/svg"><rect x="55" y="35" width="110" height="110" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="110.0" y="23" font-size="14" fill="#2563eb" font-weight="700" text-anchor="middle">80 cm</text></svg>' },
        ...
        { difficulty: 'Medium', question: 'A square placemat has an area of 1600 cm². What is the length of each side?', answer: '40 cm', checkMode: 'auto', correctAnswer: '40 cm', correctAnswers: ['40 cm', '40cm', '40'], explanation: 'Side × side = 1600, so the side length is the square root of 1600.\n√1600 = 40 cm ✓', diagramSvg: '<svg viewBox="0 0 220 190" xmlns="http://www.w3.org/2000/svg"><rect x="55" y="35" width="110" height="110" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="110.0" y="92.0" font-size="15" fill="#374151" text-anchor="middle">Area = 1600 cm²</text><text x="110.0" y="112.0" font-size="15" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },
