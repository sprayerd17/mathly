    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      workedExamples: [
        ...
        },
        {
          ...
          steps: [
            `In a kite, one diagonal runs between the two corners where each pair of equal sides meets — this is the ${bl('long diagonal')}.`,
            `Folding along this diagonal, each pair of equal sides mirrors the other pair exactly, so the halves ${gr('match')}.`,
            `The other (short) diagonal joins the two corners where the two different pairs of sides meet each other — folding along it does ${re('not')} produce matching halves, because the two triangles it creates are different shapes.`,
      ...
      openQuestions: [
        ...
        },
        {
          ...
          answer: 'Thabo is incorrect. Having two diagonals does not mean both are lines of symmetry — it depends on whether each diagonal actually produces matching mirror halves. A kite has two pairs of adjacent equal sides, but the two pairs are different lengths from each other. Only the long diagonal (which runs between the two corners where each pair of equal sides meets) splits the kite into two mirror-image halves. The short diagonal does not, because it creates two differently shaped triangles. So a kite has only 1 line of symmetry, not 2.',
          checkMode: 'self',
        },
      ],
  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'A kite has two pairs of adjacent equal sides, but the pairs are different lengths from each other. How many lines of symmetry does a kite have?', checkMode: 'auto', correctAnswer: '1', correctAnswers: ['1', 'one'], explanation: 'A kite has only 1 line of symmetry — the long diagonal that runs between the two corners where each pair of equal sides meets.' },
        ...
        { difficulty: 'Medium', question: 'A kite\'s two diagonals are drawn. One is the long diagonal (between the two corners where each pair of equal sides meets), and the other is the short diagonal (between the two corners where the two different pairs of sides meet each other). Which one is the line of symmetry?', checkMode: 'auto', correctAnswer: 'the long diagonal', correctAnswers: ['the long diagonal', 'long diagonal', 'long one'], explanation: 'Only the long diagonal of a kite is a line of symmetry. Folding along it makes each pair of equal sides mirror the other pair. The short diagonal does not produce matching halves.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'A kite\'s short diagonal (between the corners where the two different pairs of sides meet each other) is drawn. Is this diagonal a line of symmetry?', checkMode: 'auto', correctAnswer: 'no', correctAnswers: ['no', 'No'], explanation: 'The short diagonal of a kite is not a line of symmetry — only the long diagonal (between the corners where each pair of equal sides meets) produces matching mirror halves.' },
