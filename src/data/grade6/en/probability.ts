...
// ─── Tally mark renderer (group of 5: 4 verticals + 1 diagonal strike) ───────
const t5 = () =>
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      explanation:
        ...
        `</tr></thead>` +
        `<tbody>` +
        `<tr><td style="border:1px solid #e2e8f0;padding:6px 10px;">Heads</td><td style="border:1px solid #e2e8f0;padding:6px 10px;"><span style="display:inline-flex;gap:6px;align-items:center;">${t5()} ${t5()} <span style="font-family:monospace;color:#ea580c;font-size:1.1em;">||</span></span></td><td style="border:1px solid #e2e8f0;padding:6px 10px;color:#16a34a;font-weight:700;">12</td></tr>` +
        `<tr><td style="border:1px solid #e2e8f0;padding:6px 10px;">Tails</td><td style="border:1px solid #e2e8f0;padding:6px 10px;"><span style="display:inline-flex;gap:6px;align-items:center;">${t5()} <span style="font-family:monospace;color:#ea580c;font-size:1.1em;">|||</span></span></td><td style="border:1px solid #e2e8f0;padding:6px 10px;color:#16a34a;font-weight:700;">8</td></tr>` +
      ...
      diagramSvg: '<svg viewBox="0 0 220 170" xmlns="http://www.w3.org/2000/svg"><text x="110" y="14" font-size="11" fill="#0f1f3d" font-weight="700" text-anchor="middle">Experimental P(rolling a 6)</text><line x1="35" y1="20" x2="35" y2="140" stroke="#0f1f3d" stroke-width="2"/><line x1="35" y1="140" x2="205" y2="140" stroke="#0f1f3d" stroke-width="2"/><line x1="35" y1="90" x2="205" y2="90" stroke="#16a34a" stroke-width="1.5" stroke-dasharray="4,3"/><text x="38" y="86" font-size="9" fill="#16a34a" font-weight="700" text-anchor="start">true P ≈ 0.17</text><rect x="55" y="50" width="34" height="90" fill="#ea580c" stroke="#0f1f3d" stroke-width="1.5"/><text x="72" y="46" font-size="11" fill="#ea580c" font-weight="700" text-anchor="middle">0.30</text><text x="72" y="153" font-size="9" fill="#374151" font-weight="700" text-anchor="middle">10 trials</text><text x="72" y="164" font-size="9" fill="#374151" text-anchor="middle">(3/10)</text><rect x="135" y="86" width="34" height="54" fill="#2563eb" stroke="#0f1f3d" stroke-width="1.5"/><text x="152" y="82" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">0.18</text><text x="152" y="153" font-size="9" fill="#374151" font-weight="700" text-anchor="middle">50 trials</text><text x="152" y="164" font-size="9" fill="#374151" text-anchor="middle">(9/50)</text></svg>',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramSvg: '<svg viewBox="0 0 220 148" xmlns="http://www.w3.org/2000/svg"><text x="118" y="14" font-size="12" fill="#0f1f3d" font-weight="700" text-anchor="middle">Coin × Dice Sample Space</text><rect x="66" y="54" width="26" height="52" fill="#f0fdf4"/><rect x="118" y="54" width="26" height="52" fill="#f0fdf4"/><rect x="170" y="54" width="26" height="52" fill="#f0fdf4"/><rect x="40" y="54" width="156" height="52" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="66" y1="54" x2="66" y2="106" stroke="#0f1f3d" stroke-width="1"/><line x1="92" y1="54" x2="92" y2="106" stroke="#0f1f3d" stroke-width="1"/><line x1="118" y1="54" x2="118" y2="106" stroke="#0f1f3d" stroke-width="1"/><line x1="144" y1="54" x2="144" y2="106" stroke="#0f1f3d" stroke-width="1"/><line x1="170" y1="54" x2="170" y2="106" stroke="#0f1f3d" stroke-width="1"/><line x1="40" y1="80" x2="196" y2="80" stroke="#0f1f3d" stroke-width="1"/><text x="53" y="46" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">1</text><text x="79" y="46" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">2</text><text x="105" y="46" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">3</text><text x="131" y="46" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">4</text><text x="157" y="46" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">5</text><text x="183" y="46" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">6</text><text x="30" y="71" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">H</text><text x="30" y="97" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">T</text><text x="53" y="71" font-size="10" fill="#2563eb" text-anchor="middle">H1</text><text x="79" y="71" font-size="10" fill="#16a34a" font-weight="700" text-anchor="middle">H2</text><text x="105" y="71" font-size="10" fill="#2563eb" text-anchor="middle">H3</text><text x="131" y="71" font-size="10" fill="#16a34a" font-weight="700" text-anchor="middle">H4</text><text x="157" y="71" font-size="10" fill="#2563eb" text-anchor="middle">H5</text><text x="183" y="71" font-size="10" fill="#16a34a" font-weight="700" text-anchor="middle">H6</text><text x="53" y="97" font-size="10" fill="#2563eb" text-anchor="middle">T1</text><text x="79" y="97" font-size="10" fill="#16a34a" font-weight="700" text-anchor="middle">T2</text><text x="105" y="97" font-size="10" fill="#2563eb" text-anchor="middle">T3</text><text x="131" y="97" font-size="10" fill="#16a34a" font-weight="700" text-anchor="middle">T4</text><text x="157" y="97" font-size="10" fill="#2563eb" text-anchor="middle">T5</text><text x="183" y="97" font-size="10" fill="#16a34a" font-weight="700" text-anchor="middle">T6</text><text x="118" y="122" font-size="11" fill="#ea580c" font-weight="700" text-anchor="middle">Total outcomes = 2 × 6 = 12</text><rect x="70" y="130" width="10" height="10" fill="#f0fdf4" stroke="#16a34a" stroke-width="1"/><text x="84" y="139" font-size="9" fill="#16a34a" text-anchor="start">= dice shows an even number</text></svg>',
    },
  ],
