  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'Using the map above, how many blocks down separate row 2 and row 4, as between the Bank (C2) and the Park (D4)?', checkMode: 'auto', correctAnswer: '2', correctAnswers: ['2', '2 blocks'], explanation: 'The Bank is in row 2 and the Park is in row 4. 4 − 2 = 2 blocks down.', diagramSvg: GRID_SVG },
