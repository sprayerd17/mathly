...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        '<DiagramPlaceholder label="Grid with columns labelled A to D across the top and rows labelled 1 to 4 down the side, with one cell such as C2 highlighted to show how the letter and number combine into an alpha-numeric grid reference" />',
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        '<DiagramPlaceholder label="Simple town map with a grid labelled A to D across the top and 1 to 4 down the side, with several landmarks such as a clinic, market, school and bank each placed in a different grid cell" />',
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        '<DiagramPlaceholder label="Map grid labelled A to D across the top and 1 to 4 down the side with two landmarks marked, one as a starting point and one as a destination, with an arrow drawn between them showing the route without labelling the number of blocks so learners must work it out" />',
