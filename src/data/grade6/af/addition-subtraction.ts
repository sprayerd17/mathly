...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      explanation:
        ...
        `<p style="margin:0;font-size:14px;">${re('Gaan na')} — Gebruik die omgekeerde bewerking om jou presiese antwoord te bevestig, en kyk of dit naby aan die skatting is.</p>` +
        `</div>` +
      ...
      videoPlaceholder:
        'Kort video wat toon hoe om deur afronding te skat, presies te bereken, en optellings- en aftrekkingsantwoorde met omgekeerde bewerkings na te gaan, met kleurgekodeerde stappe',
    },
  ...
  topicPractice: [
    ...
    // ── V9 Moeilik ───────────────────────────────────────────────────────────────
    {
      ...
      explanation: 'Vind die verskil tussen die Sondag- en Saterdag-opkoms:\n71 294 − 64 837:\nEne: 4−7 → leen. Tiene 9 → 8, Ene 14−7=7\nTiene: 8−3=5\nHonderde: 2−8 → leen. Duisende 1 → 0, Honderde 12−8=4\nDuisende: 0−4 → leen. Tienduisende 7 → 6, Duisende 10−4=6\nTienduisende: 6−6=0\n71 294 − 64 837 = 6 457.\nGaan na: 6 457 + 64 837 = 71 294 ✓',
    },
  ...
  practiceSets: [
    ...
    // omgekeerde bewerkings | 14-16 Woordprobleme | 17-19 Multi-stap woordprobleme
    // ═══════════════════════════════════════════════════════════════════════
    {
      name: 'Stel 1',
      questions: [
