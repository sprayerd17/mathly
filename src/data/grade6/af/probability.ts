...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      icon: '🪙',
      explanation:
        `<p style="margin-bottom:16px;">ʼn Ander manier om waarskynlikheid te ondersoek, is om werklik ʼn eksperiment uit te voer — soos ʼn stertstuk op te gooi, ʼn dobbelsteen te gooi, of ʼn draaibord te draai — baie keer, en te sien wat werklik gebeur. Dit word ${gr('eksperimentele waarskynlikheid')} genoem. Ons teken die resultaat van elke ${bl('proef')} met ʼn ${or('telstreep')} aan, en tel dan die ${or('telstrepe')} om die ${gr('frekwensie')} van elke uitkoms te vind.</p>` +
        ...
        `<p style="color:#374151;font-size:14px;margin:0;">Besluit op die eksperiment en lys die moontlike uitkomste, byvoorbeeld Kop/Stert vir ʼn stertstuk, of 1–6 vir ʼn dobbelsteen.</p>` +
        `</div>` +
        ...
        `<p style="margin-bottom:10px;color:#374151;font-size:14px;">Katlego gooi ʼn stertstuk ${bl('20')} keer op en teken elke resultaat as ʼn ${or('telstreep')} aan:</p>` +
      ...
      workedExamples: [
        {
          question: 'Katlego gooi ʼn stertstuk 20 keer op en teken die resultate in die tabel hierbo aan: Kop = 12, Stert = 8. Vind die eksperimentele waarskynlikheid om kop te gooi.',
          answer: `P(kop) = ${re('12/20 = 3/5')}`,
          steps: [
            ...
            `<strong>Antwoord:</strong> P(kop) = ${re('3/5')}. ✓`,
          ],
        },
        {
      ...
      videoPlaceholder:
        'Kort video wat wys hoe om herhaalde proewe van ʼn stertstuk-, dobbelsteen- of draaibord-eksperiment uit te voer, resultate met ʼn telstreep aan te teken, eksperimentele frekwensie te bereken, en resultate van ʼn klein aantal proewe met ʼn groter aantal proewe te vergelyk',

      diagramPlaceholder:
        'ʼn Telstreep- en frekwensietabel vir 20 stertgooie wat kop- en stert-telstrepe, hul frekwensies en die totaal wys, saam met ʼn vergelyking van eksperimentele waarskynlikheid na 10 proewe teenoor 50 proewe',

      diagramSvg: '<svg viewBox="0 0 220 170" xmlns="http://www.w3.org/2000/svg"><text x="110" y="14" font-size="11" fill="#0f1f3d" font-weight="700" text-anchor="middle">Eksperimentele P(6 gooi)</text><line x1="35" y1="20" x2="35" y2="140" stroke="#0f1f3d" stroke-width="2"/><line x1="35" y1="140" x2="205" y2="140" stroke="#0f1f3d" stroke-width="2"/><line x1="35" y1="90" x2="205" y2="90" stroke="#16a34a" stroke-width="1.5" stroke-dasharray="4,3"/><text x="38" y="86" font-size="9" fill="#16a34a" font-weight="700" text-anchor="start">ware W ≈ 0,17</text><rect x="55" y="50" width="34" height="90" fill="#ea580c" stroke="#0f1f3d" stroke-width="1.5"/><text x="72" y="46" font-size="11" fill="#ea580c" font-weight="700" text-anchor="middle">0,30</text><text x="72" y="153" font-size="9" fill="#374151" font-weight="700" text-anchor="middle">10 proewe</text><text x="72" y="164" font-size="9" fill="#374151" text-anchor="middle">(3/10)</text><rect x="135" y="86" width="34" height="54" fill="#2563eb" stroke="#0f1f3d" stroke-width="1.5"/><text x="152" y="82" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">0,18</text><text x="152" y="153" font-size="9" fill="#374151" font-weight="700" text-anchor="middle">50 proewe</text><text x="152" y="164" font-size="9" fill="#374151" text-anchor="middle">(9/50)</text></svg>',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      explanation:
        ...
        `<p style="font-size:1.05em;font-weight:700;color:#374151;margin:0;">${or('P(gebeurtenis)')} = <span style="display:inline-block;text-align:center;vertical-align:middle;margin-left:8px;"><span style="display:block;border-bottom:2px solid #374151;padding-bottom:3px;">${gr('aantal gunstige uitkomste')}</span><span style="display:block;padding-top:3px;">${bl('totale aantal moontlike uitkomste')}</span></span></p>` +
        `</div>` +
      ...
      diagramSvg: '<svg viewBox="0 0 220 180" xmlns="http://www.w3.org/2000/svg"><rect x="40" y="45" width="140" height="95" rx="18" ry="18" fill="#f8fafc" stroke="#0f1f3d" stroke-width="2.5"/><polygon points="95,47 125,47 118,22 102,22" fill="#f8fafc" stroke="#0f1f3d" stroke-width="2.5"/><line x1="100" y1="30" x2="120" y2="30" stroke="#0f1f3d" stroke-width="2"/><circle cx="58" cy="75" r="8" fill="#dc2626" stroke="#0f1f3d" stroke-width="1"/><circle cx="80" cy="75" r="8" fill="#dc2626" stroke="#0f1f3d" stroke-width="1"/><circle cx="102" cy="75" r="8" fill="#dc2626" stroke="#0f1f3d" stroke-width="1"/><circle cx="124" cy="75" r="8" fill="#dc2626" stroke="#0f1f3d" stroke-width="1"/><circle cx="146" cy="75" r="8" fill="#2563eb" stroke="#0f1f3d" stroke-width="1"/><circle cx="58" cy="108" r="8" fill="#2563eb" stroke="#0f1f3d" stroke-width="1"/><circle cx="80" cy="108" r="8" fill="#2563eb" stroke="#0f1f3d" stroke-width="1"/><circle cx="102" cy="108" r="8" fill="#2563eb" stroke="#0f1f3d" stroke-width="1"/><circle cx="124" cy="108" r="8" fill="#2563eb" stroke="#0f1f3d" stroke-width="1"/><circle cx="146" cy="108" r="8" fill="#2563eb" stroke="#0f1f3d" stroke-width="1"/><text x="110" y="152" font-size="11" text-anchor="middle"><tspan fill="#16a34a" font-weight="700">gunstig = 4</tspan><tspan fill="#374151"> · </tspan><tspan fill="#2563eb" font-weight="700">totaal = 10</tspan></text><text x="110" y="168" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">P(rooi) = 4/10 = 2/5</text></svg>',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      workedExamples: [
        {
          question: 'Thabo gooi ʼn stertstuk op en gooi ʼn dobbelsteen. Hoeveel totale uitkomste is daar?',
          answer: `${or('Totale uitkomste')} = ${or('12')}`,
          steps: [
            `${bl('Stertstukuitkomste')}: kop of stert = ${bl('2')} uitkomste.`,
            `${bl('Dobbelsteenuitkomste')}: 1, 2, 3, 4, 5, 6 = ${bl('6')} uitkomste.`,
            `${or('Totale uitkomste')} = ${bl('2')} × ${bl('6')} = ${or('12')}.`,
          ],
        },
        {
          question: 'ʼn Draaibord het 4 gelyke afdelings — rooi, blou, groen, geel. Vind die waarskynlikheid om op rooi of geel te land.',
          answer: `P(rooi of geel) = ${or('1/2')}`,
          steps: [
      ...
      diagramPlaceholder:
        'Diagram wat ʼn steekproefruimtetabel vir ʼn stertgooi en ʼn dobbelsteengooi wys, met al 12 uitkomste gelys — uitkomste in blou, gunstige uitkomste in groen, totaal in oranje',

      diagramSvg: '<svg viewBox="0 0 220 148" xmlns="http://www.w3.org/2000/svg"><text x="118" y="14" font-size="12" fill="#0f1f3d" font-weight="700" text-anchor="middle">Stert × Dobbelsteen Steekproefruimte</text><rect x="66" y="54" width="26" height="52" fill="#f0fdf4"/><rect x="118" y="54" width="26" height="52" fill="#f0fdf4"/><rect x="170" y="54" width="26" height="52" fill="#f0fdf4"/><rect x="40" y="54" width="156" height="52" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="66" y1="54" x2="66" y2="106" stroke="#0f1f3d" stroke-width="1"/><line x1="92" y1="54" x2="92" y2="106" stroke="#0f1f3d" stroke-width="1"/><line x1="118" y1="54" x2="118" y2="106" stroke="#0f1f3d" stroke-width="1"/><line x1="144" y1="54" x2="144" y2="106" stroke="#0f1f3d" stroke-width="1"/><line x1="170" y1="54" x2="170" y2="106" stroke="#0f1f3d" stroke-width="1"/><line x1="40" y1="80" x2="196" y2="80" stroke="#0f1f3d" stroke-width="1"/><text x="53" y="46" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">1</text><text x="79" y="46" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">2</text><text x="105" y="46" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">3</text><text x="131" y="46" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">4</text><text x="157" y="46" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">5</text><text x="183" y="46" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">6</text><text x="30" y="71" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">K</text><text x="30" y="97" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">S</text><text x="53" y="71" font-size="10" fill="#2563eb" text-anchor="middle">K1</text><text x="79" y="71" font-size="10" fill="#16a34a" font-weight="700" text-anchor="middle">K2</text><text x="105" y="71" font-size="10" fill="#2563eb" text-anchor="middle">K3</text><text x="131" y="71" font-size="10" fill="#16a34a" font-weight="700" text-anchor="middle">K4</text><text x="157" y="71" font-size="10" fill="#2563eb" text-anchor="middle">K5</text><text x="183" y="71" font-size="10" fill="#16a34a" font-weight="700" text-anchor="middle">K6</text><text x="53" y="97" font-size="10" fill="#2563eb" text-anchor="middle">S1</text><text x="79" y="97" font-size="10" fill="#16a34a" font-weight="700" text-anchor="middle">S2</text><text x="105" y="97" font-size="10" fill="#2563eb" text-anchor="middle">S3</text><text x="131" y="97" font-size="10" fill="#16a34a" font-weight="700" text-anchor="middle">S4</text><text x="157" y="97" font-size="10" fill="#2563eb" text-anchor="middle">S5</text><text x="183" y="97" font-size="10" fill="#16a34a" font-weight="700" text-anchor="middle">S6</text><text x="118" y="122" font-size="11" fill="#ea580c" font-weight="700" text-anchor="middle">Totale uitkomste = 2 × 6 = 12</text><rect x="70" y="130" width="10" height="10" fill="#f0fdf4" stroke="#16a34a" stroke-width="1"/><text x="84" y="139" font-size="9" fill="#16a34a" text-anchor="start">= dobbelsteen wys ʼn ewe getal</text></svg>',
    },
  ],
  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Hard', question: 'ʼn Sak het 3 rooi fiches en 7 blou fiches. Kabelo kies ʼn fiche, teken die kleur aan, sit dit terug in die sak, en kies weer. Vind die waarskynlikheid dat hy albei kere ʼn rooi fiche kies.', checkMode: 'auto', correctAnswer: '9/100', correctAnswers: ['9/100'], explanation: 'P(rooi) elke keer = 3/10, aangesien die fiche teruggesit word (onafhanklike gebeurtenisse).\nP(albei kere rooi) = 3/10 × 3/10 = 9/100 ✓' },
        { difficulty: 'Hard', question: 'ʼn Karnavaldraaibord het 8 gelyke afdelings: 1 "wen ʼn prys"-afdeling en 7 "geen prys"-afdelings. Aviwe draai dit 80 keer en land 9 keer op die "wen ʼn prys"-afdeling. Vind eers haar eksperimentele waarskynlikheid om ʼn prys te wen en die teoretiese waarskynlikheid, vind dan die waarskynlikheid dat as sy nog twee keer sou draai (met die draaibord onveranderd), sy albei kere ʼn prys wen.', checkMode: 'self', answer: 'Eksperimentele waarskynlikheid = 9/80 = 0,1125. Teoretiese waarskynlikheid = 1/8 = 0,125 (aangesien 1 uit 8 gelyke afdelings ʼn prys wen) — die eksperimentele resultaat (0,1125) is naby aan die teoretiese resultaat (0,125), wat wys dat met genoeg proewe, eksperimentele waarskynlikheid nader aan teoretiese waarskynlikheid kom. Vir nog twee draaie (onafhanklike gebeurtenisse, aangesien die draaibord elke keer onveranderd bly), gebruik die teoretiese waarskynlikheid: 1/8 × 1/8 = 1/64.' },
      ],
      scoreMessages: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'Rangskik hierdie gebeurtenisse van minste waarskynlik na mees waarskynlik: (A) ʼn blou bal kies uit ʼn sak van 15 rooi balle en 1 blou bal, (B) ʼn 6 gooi met ʼn gewone dobbelsteen, (C) kop opgooi met ʼn stertstuk.', checkMode: 'auto', correctAnswer: 'A, B, C', correctAnswers: ['A, B, C', 'A,B,C', 'ABC'], explanation: 'A: 1/16 = 0,0625.\nB: 1/6 ≈ 0,167.\nC: 1/2 = 0,5.\nVolgorde van minste na mees waarskynlik: A, B, C ✓' },
        { difficulty: 'Easy', question: 'ʼn Draaibord is verdeel in 5 gelyke afdelings, en al 5 afdelings is blou gekleur. Gebruik die waarskynlikheidskaal hierbo getoon, waar sal om op rooi te land val (onmoontlik, onwaarskynlik, ewe waarskynlik, waarskynlik, seker)?', checkMode: 'auto', correctAnswer: 'onmoontlik', correctAnswers: ['onmoontlik'], explanation: 'Geen van die 5 afdelings is rooi nie, so om op rooi te land kan nooit gebeur nie. Dit is onmoontlik ✓', diagramSvg: '<svg viewBox="0 0 220 170" xmlns="http://www.w3.org/2000/svg"><line x1="20" y1="70" x2="200" y2="70" stroke="#0f1f3d" stroke-width="2"/><line x1="20" y1="62" x2="20" y2="78" stroke="#0f1f3d" stroke-width="2"/><line x1="110" y1="62" x2="110" y2="78" stroke="#0f1f3d" stroke-width="2"/><line x1="200" y1="62" x2="200" y2="78" stroke="#0f1f3d" stroke-width="2"/><text x="20" y="95" font-size="13" font-weight="700" fill="#0f1f3d" text-anchor="middle">0</text><text x="110" y="95" font-size="13" font-weight="700" fill="#0f1f3d" text-anchor="middle">0,5</text><text x="200" y="95" font-size="13" font-weight="700" fill="#0f1f3d" text-anchor="middle">1</text><text x="20" y="30" font-size="10" font-weight="700" fill="#374151" text-anchor="middle">Onmoontlik</text><text x="65" y="45" font-size="10" font-weight="700" fill="#374151" text-anchor="middle">Onwaarskynlik</text><text x="110" y="30" font-size="10" font-weight="700" fill="#374151" text-anchor="middle">Ewe</text><text x="110" y="43" font-size="10" font-weight="700" fill="#374151" text-anchor="middle">waarskynlik</text><text x="155" y="45" font-size="10" font-weight="700" fill="#374151" text-anchor="middle">Waarskynlik</text><text x="200" y="30" font-size="10" font-weight="700" fill="#374151" text-anchor="middle">Seker</text><line x1="20" y1="70" x2="20" y2="50" stroke="#9ca3af" stroke-width="1"/><line x1="65" y1="70" x2="65" y2="55" stroke="#9ca3af" stroke-width="1"/><line x1="110" y1="70" x2="110" y2="50" stroke="#9ca3af" stroke-width="1"/><line x1="155" y1="70" x2="155" y2="55" stroke="#9ca3af" stroke-width="1"/><line x1="200" y1="70" x2="200" y2="50" stroke="#9ca3af" stroke-width="1"/></svg>' },

        // Blok 2 — Waarskynlikheid as ʼn Breuk — Enkele Gebeurtenisse (4-8, Maklik-Matig) — DIAGRAM-GEMERK
        { difficulty: 'Easy-Medium', question: 'ʼn Sak bevat 3 rooi fiches en 9 blou fiches, soos getoon. Vind die waarskynlikheid om ʼn rooi fiche te kies. Gee jou antwoord as ʼn vereenvoudigde breuk.', checkMode: 'auto', correctAnswer: '1/4', correctAnswers: ['1/4', '3/12'], explanation: 'Gunstige uitkomste = 3 rooi fiches.\nTotale uitkomste = 3 + 9 = 12 fiches.\nP(rooi) = 3/12 = 1/4 ✓', diagramSvg: '<svg viewBox="0 0 220 190" xmlns="http://www.w3.org/2000/svg"><path d="M 45 55 L 40 155 Q 40 165 50 165 L 170 165 Q 180 165 180 155 L 175 55 Z" fill="#f8fafc" stroke="#0f1f3d" stroke-width="2"/><path d="M 75 55 Q 75 30 110 30 Q 145 30 145 55" fill="none" stroke="#0f1f3d" stroke-width="2"/><circle cx="58" cy="83" r="8" fill="#dc2626" stroke="#0f1f3d" stroke-width="1"/><circle cx="84" cy="83" r="8" fill="#dc2626" stroke="#0f1f3d" stroke-width="1"/><circle cx="110" cy="83" r="8" fill="#dc2626" stroke="#0f1f3d" stroke-width="1"/><circle cx="136" cy="83" r="8" fill="#2563eb" stroke="#0f1f3d" stroke-width="1"/><circle cx="162" cy="83" r="8" fill="#2563eb" stroke="#0f1f3d" stroke-width="1"/><circle cx="58" cy="105" r="8" fill="#2563eb" stroke="#0f1f3d" stroke-width="1"/><circle cx="84" cy="105" r="8" fill="#2563eb" stroke="#0f1f3d" stroke-width="1"/><circle cx="110" cy="105" r="8" fill="#2563eb" stroke="#0f1f3d" stroke-width="1"/><circle cx="136" cy="105" r="8" fill="#2563eb" stroke="#0f1f3d" stroke-width="1"/><circle cx="162" cy="105" r="8" fill="#2563eb" stroke="#0f1f3d" stroke-width="1"/><circle cx="97" cy="127" r="8" fill="#2563eb" stroke="#0f1f3d" stroke-width="1"/><circle cx="123" cy="127" r="8" fill="#2563eb" stroke="#0f1f3d" stroke-width="1"/></svg>' },
        { difficulty: 'Easy-Medium', question: 'ʼn Gewone dobbelsteen genommer 1 tot 6 word gegooi. Vind die waarskynlikheid om ʼn getal groter as 2 te gooi.', checkMode: 'auto', correctAnswer: '2/3', correctAnswers: ['2/3', '4/6'], explanation: 'Getalle groter as 2 van 1-6: 3, 4, 5, 6 — dit is 4 gunstige uitkomste.\nTotale uitkomste op ʼn dobbelsteen = 6.\nP(groter as 2) = 4/6 = 2/3 ✓' },
        { difficulty: 'Medium', question: 'ʼn Draaibord het 20 gelyke afdelings genommer 1 tot 20. Vind die waarskynlikheid om op ʼn veelvoud van 4 te land.', checkMode: 'auto', correctAnswer: '1/4', correctAnswers: ['1/4', '5/20'], explanation: 'Veelvoude van 4 van 1-20: 4, 8, 12, 16, 20 — dit is 5 gunstige uitkomste.\nTotale afdelings = 20.\nP(veelvoud van 4) = 5/20 = 1/4 ✓' },
        { difficulty: 'Medium', question: 'ʼn Skoolfondsinsameling verkoop 400 kaartjies. Kagiso koop 8 van die kaartjies, en slegs 1 kaartjie in totaal sal die hoofprys wen. Vind die waarskynlikheid dat Kagiso die hoofprys wen.', checkMode: 'auto', correctAnswer: '1/50', correctAnswers: ['1/50', '8/400'], explanation: 'Gunstige uitkomste = 8 kaartjies wat Kagiso hou.\nTotale uitkomste = 400 kaartjies.\nP(Kagiso wen) = 8/400 = 1/50 ✓' },
        ...
        // Blok 3 — Uitkomste en Uitkomsruimtes Lys (9-13, Matig) — DIAGRAM-GEMERK
        { difficulty: 'Medium', question: 'Lys al die moontlike uitkomste wanneer ʼn stertstuk opgegooi word en ʼn draaibord met 4 gelyke afdelings gemerk rooi, blou, groen, geel gedraai word. Die leë rooster hieronder het stertstukuitkomste langs die kant en draaibord-uitkomste (R=rooi, B=blou, G=groen, Y=geel) bo-oor — gebruik dit om jou te help om elke paar te lys.', checkMode: 'auto', correctAnswer: 'K-rooi, K-blou, K-groen, K-geel, S-rooi, S-blou, S-groen, S-geel', correctAnswers: ['K-rooi, K-blou, K-groen, K-geel, S-rooi, S-blou, S-groen, S-geel', 'Krooi,Kblou,Kgroen,Kgeel,Srooi,Sblou,Sgroen,Sgeel', 'K-rooi K-blou K-groen K-geel S-rooi S-blou S-groen S-geel'], explanation: 'Stertstukuitkomste: K (kop), S (stert).\nDraaibord-uitkomste: rooi, blou, groen, geel.\nPaar elke stertstukuitkomste met elke draaibord-uitkomste: K-rooi, K-blou, K-groen, K-geel, S-rooi, S-blou, S-groen, S-geel — dit is 8 uitkomste ✓', diagramSvg: '<svg viewBox="0 0 220 170" xmlns="http://www.w3.org/2000/svg"><rect x="33" y="48" width="154" height="94" fill="none" stroke="#0f1f3d" stroke-width="2"/><line x1="33" y1="82" x2="187" y2="82" stroke="#0f1f3d" stroke-width="2"/><line x1="67" y1="48" x2="67" y2="142" stroke="#0f1f3d" stroke-width="2"/><line x1="97" y1="82" x2="97" y2="142" stroke="#9ca3af" stroke-width="1"/><line x1="127" y1="82" x2="127" y2="142" stroke="#9ca3af" stroke-width="1"/><line x1="157" y1="82" x2="157" y2="142" stroke="#9ca3af" stroke-width="1"/><line x1="33" y1="112" x2="187" y2="112" stroke="#9ca3af" stroke-width="1"/><text x="82" y="70" font-size="13" font-weight="700" fill="#2563eb" text-anchor="middle">R</text><text x="112" y="70" font-size="13" font-weight="700" fill="#2563eb" text-anchor="middle">B</text><text x="142" y="70" font-size="13" font-weight="700" fill="#2563eb" text-anchor="middle">G</text><text x="172" y="70" font-size="13" font-weight="700" fill="#2563eb" text-anchor="middle">Y</text><text x="50" y="102" font-size="13" font-weight="700" fill="#2563eb" text-anchor="middle">K</text><text x="50" y="132" font-size="13" font-weight="700" fill="#2563eb" text-anchor="middle">S</text></svg>' },
        ...
        { difficulty: 'Medium', question: 'Sipho draai ʼn draaibord gemerk A, B, C twee keer en beweer dat "A dan B" dieselfde uitkoms is as "B dan A", so net een van hulle hoef in die uitkomsruimte te verskyn. Is Sipho korrek? Verduidelik.', checkMode: 'self', answer: 'Nee, Sipho is nie korrek nie. Die volgorde waarin die draaibord op elke draai land, maak saak, so "A dan B" en "B dan A" is twee verskillende, aparte uitkomste. Elke verskillende volgorde moet apart gelys word in die uitkomsruimte — vir 2 draaie van ʼn 3-afdeling draaibord is daar 3 × 3 = 9 totale uitkomste, en om "A dan B" dieselfde as "B dan A" te behandel sou hulle ondertel.' },

        // Blok 4 — Vergelyk, Regverdig & Multi-Stap Waarskynlikheid (14-16, Matig-Moeilik)
        { difficulty: 'Medium-Hard', question: 'ʼn Pakkie plakkers bevat 18 plakkers: 6 is ster-vormig, 6 is maan-vormig, en 6 is son-vormig. Ntando kies een plakker lukraak. Vind die waarskynlikheid dat dit NIE ster-vormig is nie, en gee aan waar dit op die waarskynlikheidskaal val.', checkMode: 'auto', correctAnswer: '2/3, waarskynlik', correctAnswers: ['2/3, waarskynlik', '2/3 waarskynlik', 'waarskynlik, 2/3', '12/18, waarskynlik'], explanation: 'Nie ster nie = maan of son = 6 + 6 = 12 gunstige uitkomste.\nTotale plakkers = 18.\nP(nie ster nie) = 12/18 = 2/3.\nAangesien 2/3 nader aan 1 (seker) as aan 0,5 (ewe waarskynlik) is, is dit waarskynlik ✓' },
        { difficulty: 'Medium-Hard', question: 'Klas A het 9 leerders uit 30 wat ʼn musiekinstrument speel. Klas B het 14 leerders uit 40 wat ʼn musiekinstrument speel. Watter klas het ʼn groter proporsie leerders wat ʼn musiekinstrument speel? Wys jou berekeninge vir albei klasse en regverdig jou antwoord.', checkMode: 'self', answer: 'Klas A: P(speel ʼn instrument) = 9/30 = 3/10 = 0,3. Klas B: P(speel ʼn instrument) = 14/40 = 7/20 = 0,35. Aangesien 0,35 groter is as 0,3, het Klas B ʼn groter proporsie leerders wat ʼn musiekinstrument speel.' },
        ...
        // Blok 5 — Eksperimentele vs Teoretiese Waarskynlikheid & Onafhanklike Gebeurtenisse (17-19, Moeilik)
        { difficulty: 'Hard', question: 'ʼn Draaibord word vermoed om oneerlik te wees. Refilwe draai dit 40 keer en teken aan dat dit 18 keer op "rooi" land, uit die draaibord se 4 gelyke afdelings. ʼn Klasmaat sê dit bewys die teoretiese waarskynlikheid om op rooi te land met hierdie draaibord is presies 18/40. Is die klasmaat korrek? Verduidelik die verskil tussen eksperimentele en teoretiese waarskynlikheid.', checkMode: 'self', answer: 'Nee, die klasmaat is nie korrek nie. 18/40 = 9/20 is die eksperimentele waarskynlikheid — dit beskryf slegs wat in hierdie spesifieke stel van 40 draaie gebeur het. Die teoretiese waarskynlikheid om op rooi te land met ʼn regverdige draaibord met 4 gelyke afdelings is altyd 1/4, gebaseer op 4 ewe waarskynlike uitkomste. ʼn Resultaat soos 18/40 = 0,45 wat baie hoër is as die verwagte 1/4 = 0,25 kan aandui dat die draaibord oneerlik kan wees, maar ʼn enkele eksperiment kan dit nie definitief bewys nie — meer proewe sou nodig wees om verder te ondersoek.' },
        { difficulty: 'Hard', question: 'ʼn Sak het 5 rooi fiches en 5 blou fiches. Lerato kies ʼn fiche, teken die kleur aan, sit dit terug in die sak, en kies weer. Vind die waarskynlikheid dat sy albei kere ʼn blou fiche kies.', checkMode: 'auto', correctAnswer: '1/4', correctAnswers: ['1/4', '25/100'], explanation: 'P(blou) elke keer = 5/10 = 1/2, aangesien die fiche teruggesit word (onafhanklike gebeurtenisse).\nP(albei kere blou) = 1/2 × 1/2 = 1/4 ✓' },
        { difficulty: 'Hard', question: 'ʼn Karnavaldraaibord het 6 gelyke afdelings: 1 "wen ʼn prys"-afdeling en 5 "geen prys"-afdelings. Sindisiwe draai dit 90 keer en land 14 keer op die "wen ʼn prys"-afdeling. Vind eers haar eksperimentele waarskynlikheid om ʼn prys te wen en die teoretiese waarskynlikheid, vind dan die waarskynlikheid dat as sy nog twee keer sou draai (met die draaibord onveranderd), sy albei kere ʼn prys wen.', checkMode: 'self', answer: 'Eksperimentele waarskynlikheid = 14/90 = 7/45 ≈ 0,156. Teoretiese waarskynlikheid = 1/6 ≈ 0,167 (aangesien 1 uit 6 gelyke afdelings ʼn prys wen) — die eksperimentele resultaat (ongeveer 0,156) is redelik naby aan die teoretiese resultaat (ongeveer 0,167). Vir nog twee draaie (onafhanklike gebeurtenisse, aangesien die draaibord elke keer onveranderd bly), gebruik die teoretiese waarskynlikheid: 1/6 × 1/6 = 1/36.' },
      ],
      scoreMessages: [
        { minScore: 20, message: 'Uitstekend! Jy het die waarskynlikheidskaal, breuke, uitkomsruimtes en eksperimentele waarskynlikheid onder die knie.' },
        { minScore: 15, message: 'Goeie werk! Jy het ʼn goeie begrip van waarskynlikheid — hersien enige vrae wat jy verkeerd gehad het.' },
  ...
  topicPractice: [
    ...
    // ── Q5 Medium ─────────────────────────────────────────────────────────────
    {
      ...
      explanation: 'Getalle kleiner as 3: 1 en 2 — dit is 2 gunstige uitkomste.\nTotale uitkomste op ʼn dobbelsteen = 6.\nP(kleiner as 3) = 2/6 = 1/3 ✓',
    },

    // ── Q6 Hard ───────────────────────────────────────────────────────────────
    {
      difficulty: 'Hard',
      question: 'Lerato sê die waarskynlikheid om kop te gooi met ʼn stertstuk is 1/3. Is sy korrek? Verduidelik.',
      answer: 'Nee — ʼn stertstuk het net 2 uitkomste (kop of stert), so die waarskynlikheid van kop is 1/2 en nie 1/3 nie.',
      checkMode: 'self',
    },
    ...
    {
      difficulty: 'Medium',
      question: 'ʼn Draaibord het 5 gelyke afdelings genommer 1 tot 5. Vind die waarskynlikheid om op ʼn onewe getal te land.',
      answer: '3/5',
      checkMode: 'auto',
      correctAnswer: '3/5',
    ...
    {
      difficulty: 'Hard',
      question: 'Amahle gooi ʼn stertstuk op en draai ʼn draaibord met 3 afdelings. Hoeveel totale uitkomste is daar?',
      answer: '6',
      checkMode: 'auto',
      correctAnswer: '6',
      explanation: 'Stertstukuitkomste: kop of stert = 2.\nDraaibord-uitkomste = 3.\nTotale uitkomste = 2 × 3 = 6 ✓',
    },
    ...
    // ── Q10 Medium ────────────────────────────────────────────────────────────
    {
      ...
      explanation: 'Nie rooi nie = groen of geel = 5 + 3 = 8 gunstige uitkomste.\nTotale fiches = 5 + 3 + 2 = 10.\nP(nie rooi nie) = 8/10 = 4/5 ✓',
    },

    // ── Q11 Hard ──────────────────────────────────────────────────────────────
    {
      difficulty: 'Hard',
      question: 'Thabo gooi ʼn stertstuk 20 keer op en kry 8 keer kop. Wat is die eksperimentele waarskynlikheid van kop, en hoe vergelyk dit met die teoretiese waarskynlikheid?',
