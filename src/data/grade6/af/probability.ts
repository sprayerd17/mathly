...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      icon: '🪙',
      explanation:
        `<p style="margin-bottom:16px;">ʼn Ander manier om waarskynlikheid te ondersoek, is om werklik ʼn eksperiment uit te voer — soos ʼn muntstuk op te gooi, ʼn dobbelsteen te gooi, of ʼn draaibord te draai — baie keer, en te sien wat werklik gebeur. Dit word ${gr('eksperimentele waarskynlikheid')} genoem. Ons teken die resultaat van elke ${bl('proef')} met ʼn ${or('telstreep')} aan, en tel dan die ${or('telstrepe')} om die ${gr('frekwensie')} van elke uitkoms te vind.</p>` +
        ...
        `<p style="color:#374151;font-size:14px;margin:0;">Besluit op die eksperiment en lys die moontlike uitkomste, byvoorbeeld Kruis/Munt vir ʼn muntstuk, of 1–6 vir ʼn dobbelsteen.</p>` +
        `</div>` +
        ...
        `</tr></thead>` +
        `<tbody>` +
        `<tr><td style="border:1px solid #e2e8f0;padding:6px 10px;">Kruis</td><td style="border:1px solid #e2e8f0;padding:6px 10px;"><span style="display:inline-flex;gap:6px;align-items:center;">${t5()} ${t5()} <span style="font-family:monospace;color:#ea580c;font-size:1.1em;">||</span></span></td><td style="border:1px solid #e2e8f0;padding:6px 10px;color:#16a34a;font-weight:700;">12</td></tr>` +
        `<tr><td style="border:1px solid #e2e8f0;padding:6px 10px;">Munt</td><td style="border:1px solid #e2e8f0;padding:6px 10px;"><span style="display:inline-flex;gap:6px;align-items:center;">${t5()} <span style="font-family:monospace;color:#ea580c;font-size:1.1em;">|||</span></span></td><td style="border:1px solid #e2e8f0;padding:6px 10px;color:#16a34a;font-weight:700;">8</td></tr>` +
      ...
      workedExamples: [
        {
          question: 'Katlego gooi ʼn muntstuk 20 keer op en teken die resultate in die tabel hierbo aan: Kruis = 12, Munt = 8. Vind die eksperimentele waarskynlikheid om kruis te gooi.',
          answer: `P(kruis) = ${re('12/20 = 3/5')}`,
          steps: [
            `Totale aantal ${bl('proewe')} = ${bl('20')} opgooie.`,
            `${gr('Frekwensie')} van kruis = ${or('12')}.`,
            `Eksperimentele waarskynlikheid = ${gr('frekwensie')} ÷ ${bl('totale proewe')} = ${or('12')} ÷ ${bl('20')} = ${re('12/20')}.`,
            `Vereenvoudig: ${re('12/20 = 3/5')}.`,
            `<strong>Antwoord:</strong> P(kruis) = ${re('3/5')}. ✓`,
          ],
        },
        {
      ...
      videoPlaceholder:
        'Kort video wat wys hoe om herhaalde proewe van ʼn muntstuk-, dobbelsteen- of draaibord-eksperiment uit te voer, resultate met ʼn telstreep aan te teken, eksperimentele frekwensie te bereken, en resultate van ʼn klein aantal proewe met ʼn groter aantal proewe te vergelyk',

      diagramPlaceholder:
        'ʼn Telstreep- en frekwensietabel vir 20 muntgooie wat kruis- en munt-telstrepe, hul frekwensies en die totaal wys, saam met ʼn vergelyking van eksperimentele waarskynlikheid na 10 proewe teenoor 50 proewe',
      ...
      workedExamples: [
        {
          ...
          steps: [
            `${bl('Muntstukuitkomste')}: kruis of munt = ${bl('2')} uitkomste.`,
  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'Vusi gooi ʼn muntstuk twee keer op en beweer dat "munt dan kruis" (SK) dieselfde uitkoms is as "kruis dan munt" (KS), so net een van hulle hoef in die uitkomsruimte te verskyn. Is Vusi korrek? Verduidelik.', checkMode: 'self', answer: 'Nee, Vusi is nie korrek nie. Die volgorde waarin die muntstuk land, maak saak, so SK en KS is twee verskillende, aparte uitkomste. Albei moet apart gelys word in die uitkomsruimte, wat 4 totale uitkomste gee: KK, KS, SK, SS — nie 3 nie.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'ʼn Kafee bied 4 verskillende drankies en 3 verskillende kruispiegroottes aan. As Owami een drankie en een kruispiegrootte kies, hoeveel verskillende kombinasies is moontlik?', checkMode: 'auto', correctAnswer: '12', correctAnswers: ['12'], explanation: 'Drankie-uitkomste = 4.\nKruispiegrootte-uitkomste = 3.\nTotale kombinasies = 4 × 3 = 12 ✓' },
        ...
        // Blok 5 — Eksperimentele vs Teoretiese Waarskynlikheid & Onafhanklike Gebeurtenisse (17-19, Moeilik)
        { difficulty: 'Hard', question: 'ʼn Muntstuk word vermoed om oneerlik te wees. Thabang gooi dit 50 keer op en teken kruis aan by 32 van daardie opgooie. ʼn Klasmaat sê dit bewys die teoretiese waarskynlikheid om kruis te gooi met hierdie muntstuk is presies 32/50. Is die klasmaat korrek? Verduidelik die verskil tussen eksperimentele en teoretiese waarskynlikheid.', checkMode: 'self', answer: 'Nee, die klasmaat is nie korrek nie. 32/50 = 16/25 is die eksperimentele waarskynlikheid — dit beskryf slegs wat in hierdie spesifieke stel van 50 opgooie gebeur het. Die teoretiese waarskynlikheid om kruis te gooi met ʼn gewone, regverdige muntstuk is altyd 1/2, gebaseer op 2 ewe waarskynlike uitkomste. ʼn Resultaat soos 32/50 wat hoër is as die verwagte 1/2 (wat 25/50 sou wees) kan aandui dat die muntstuk oneerlik kan wees, maar ʼn enkele eksperiment kan dit nie definitief bewys nie — meer proewe sou nodig wees om verder te ondersoek.' },
  ...
  topicPractice: [
    ...
    {
      difficulty: 'Hard',
      question: 'Lerato sê die waarskynlikheid om kruis te gooi met ʼn muntstuk is 1/3. Is sy korrek? Verduidelik.',
      answer: 'Nee — ʼn muntstuk het net 2 uitkomste (kruis of munt), so die waarskynlikheid van kruis is 1/2 en nie 1/3 nie.',
      checkMode: 'self',
    },
    ...
    {
      difficulty: 'Hard',
      question: 'Amahle gooi ʼn muntstuk op en draai ʼn draaibord met 3 afdelings. Hoeveel totale uitkomste is daar?',
      answer: '6',
      checkMode: 'auto',
      correctAnswer: '6',
      explanation: 'Muntstukuitkomste: kruis of munt = 2.\nDraaibord-uitkomste = 3.\nTotale uitkomste = 2 × 3 = 6 ✓',
    },
    ...
    {
      difficulty: 'Hard',
      question: 'Thabo gooi ʼn muntstuk 20 keer op en kry 8 keer kruis. Wat is die eksperimentele waarskynlikheid van kruis, en hoe vergelyk dit met die teoretiese waarskynlikheid?',
