...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        'Rooster met kolomme gemerk A tot D bo-oor en rye gemerk 1 tot 4 langs die kant, met een sel soos C2 uitgelig om te wys hoe die letter en getal saamsmelt tot ʼn alfanumeriese roosterverwysing',
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        'Kaartrooster gemerk A tot D bo-oor en 1 tot 4 langs die kant met twee landmerke gemerk, een as beginpunt en een as bestemming, met ʼn pyl tussen hulle wat die roete wys sonder om die getal blokke te merk sodat leerders dit self moet uitwerk',
