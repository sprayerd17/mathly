  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'ʼn Kubusvormige stoorboks het ʼn volume van 216 cm³. Onthou dat om ʼn heelgetal te kubeer, jy dit drie keer met homself vermenigvuldig. Vind die lengte van een sy.', checkMode: 'auto', correctAnswer: '6cm', correctAnswers: ['6cm', '6 cm', '6'], explanation: 'Aangesien die boks ʼn kubus is, is V = sy × sy × sy = sy³.\nOns benodig ʼn getal wat, wanneer dit gekubeer word, 216 gee.\n6 × 6 × 6 = 216, dus is die sylengte 6 cm.\nAntwoord: 6 cm' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'ʼn Kubusvormige geskenkboks het ʼn volume van 125 cm³. Onthou dat om ʼn heelgetal te kubeer, jy dit drie keer met homself vermenigvuldig. Vind die lengte van een sy.', checkMode: 'auto', correctAnswer: '5cm', correctAnswers: ['5cm', '5 cm', '5'], explanation: 'Aangesien die boks ʼn kubus is, is V = sy³.\nOns benodig ʼn getal wat, wanneer dit gekubeer word, 125 gee.\n5 × 5 × 5 = 125, dus is die sylengte 5 cm.\nAntwoord: 5 cm' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'ʼn Kubusvormige krat het ʼn volume van 343 cm³. Onthou dat om ʼn heelgetal te kubeer, jy dit drie keer met homself vermenigvuldig. Vind die lengte van een sy.', checkMode: 'auto', correctAnswer: '7cm', correctAnswers: ['7cm', '7 cm', '7'], explanation: 'Aangesien die krat ʼn kubus is, is V = sy³.\nOns benodig ʼn getal wat, wanneer dit gekubeer word, 343 gee.\n7 × 7 × 7 = 343, dus is die sylengte 7 cm.\nAntwoord: 7 cm' },
