  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      explanation:
        ...
        `<p style="margin:0;color:#9a3412;">Alle ${or('persentasies')} moet optel tot <strong>100%</strong> en alle ${bl('grade')} moet optel tot <strong>360°</strong>. Gebruik dit as ʼn kontrole nadat jy enige sirkeldiagram gelees het.</p>` +
        `</div>`,

      workedExamples: [
        {
          question: 'ʼn Sirkeldiagram wys dat 50% van leerders skool toe stap, 30% ry bus en 20% word gery. As daar 200 leerders is, hoeveel stap?',
        ...
        {
          question: "Amahle se sirkeldiagram wys ʼn skyf van 90 grade. Watter persentasie van die data verteenwoordig hierdie skyf?",
      ...
      videoPlaceholder:
        'Kort video wat wys hoe om ʼn sirkeldiagram te lees deur tussen grade en persentasies om te skakel en te bereken hoeveel items elke skyf verteenwoordig',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        'Die gerangskikte datastel uitgeskryf as 3, 3, 3, 6, 9, 11, 14, met die herhaalde 3\'s in oranje om die modus te wys en die 6 in groen om die mediaan te wys, en \'n onderskrif hieronder wat Gemiddelde = 7 in blou, Mediaan = 6 in groen, Modus = 3 in oranje toon',
  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium-Hard', question: 'ʼn Sirkeldiagram verdeel ʼn opname van gunsteling skoolvakke in vier skywe: Wiskunde — 28%, Wetenskap — 33%, Engels — 19%, en Lewensvaardighede — die ontbrekende skyf. Watter persentasie verteenwoordig die Lewensvaardighede-skyf?', answer: '20%', checkMode: 'auto', correctAnswer: '20%', correctAnswers: ['20%', '20'], explanation: 'Alle skywe moet optel tot 100%.\n28% + 33% + 19% = 80%.\nOntbrekende skyf: 100% − 80% = 20% ✓' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium-Hard', question: 'ʼn Sirkeldiagram verdeel ʼn opname van huisdiere in vier skywe: Honde — 32%, Katte — 41%, Visse — 15%, en Voëls — die ontbrekende skyf. Watter persentasie verteenwoordig die Voëls-skyf?', answer: '12%', checkMode: 'auto', correctAnswer: '12%', correctAnswers: ['12%', '12'], explanation: 'Alle skywe moet optel tot 100%.\n32% + 41% + 15% = 88%.\nOntbrekende skyf: 100% − 88% = 12% ✓' },
...
export const topicPractice = [
  ...
  {
    difficulty: 'Easy',
    question: 'ʼn Sirkeldiagram wys dat 25% van stemme na Party A gegaan het. As daar altesaam 80 stemgeregtigdes is, hoeveel het vir Party A gestem?',
    answer: '20',
    checkMode: 'auto',
    correctAnswer: '20',
  ...
  {
    difficulty: 'Medium',
    question: 'ʼn Sirkeldiagramskyf beslaan 180 grade. Watter persentasie van die data verteenwoordig hierdie skyf?',
    answer: '50%',
    checkMode: 'auto',
    correctAnswer: '50%',
  ...
  {
    difficulty: 'Hard',
    question: "Thabo se sirkeldiagram wys: Sport — 40%, Lees — 35%, Speletjies — 25%. In ʼn klas van 40 leerders, hoeveel verkies speletjies?",
    answer: '10',
    checkMode: 'auto',
    correctAnswer: '10',
