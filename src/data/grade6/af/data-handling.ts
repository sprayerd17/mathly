  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        // Blok 4 — Gemiddelde en mediaan (13-16, Medium-Moeilik)
        { difficulty: 'Medium', question: 'ʼn Fietsryer teken hierdie afstande (in km) vir 6 oefenritte aan: 64, 72, 88, 68, 80, 84. Vind die gemiddelde en die mediaan van hierdie afstande.', answer: 'Gemiddelde = 76 km, Mediaan = 76 km', checkMode: 'auto', correctAnswer: '76,76', correctAnswers: ['76,76', 'gemiddelde76mediaan76', '76, 76'], explanation: 'Gemiddelde: 64 + 72 + 88 + 68 + 80 + 84 = 456. 456 ÷ 6 = 76.\nMediaan: rangskik die waardes: 64, 68, 72, 80, 84, 88. Daar is 6 waardes (ewe), dus bereken die gemiddeld van die twee middelste waardes (3de en 4de): (72 + 80) ÷ 2 = 76.\nGemiddelde = 76 km, Mediaan = 76 km ✓' },
        { difficulty: 'Medium-Hard', question: 'Die temperatuur (°C) word op middag vir 7 dae aangeteken: 24,6, 26,1, 22,8, 25,3, 23,9, 27,2, 21,5. Vind die gemiddelde temperatuur, afgerond tot 2 desimale plekke.', answer: '24,49°C', checkMode: 'auto', correctAnswer: '24,49', correctAnswers: ['24,49', '24,49°C', '24.49', '24.49°C'], explanation: 'Tel al die waardes op: 24,6 + 26,1 + 22,8 + 25,3 + 23,9 + 27,2 + 21,5 = 171,4.\nTel: 7 waardes.\nGemiddelde = 171,4 ÷ 7 = 24,485... ≈ 24,49°C ✓' },
        { difficulty: 'Hard', question: "Lindiwe se weeklikse sakgeld oor 9 weke (in rand) was: 30, 45, 35, 50, 40, 55, 35, 45, 60. Vind die gemiddelde (afgerond tot 2 desimale plekke) en die mediaan.", answer: 'Gemiddelde = R43,89, Mediaan = R45', checkMode: 'auto', correctAnswer: '43,89,45', correctAnswers: ['43,89,45', 'gemiddelde43,89mediaan45', '43,89, 45', '43.89,45'], explanation: 'Gemiddelde: 30 + 45 + 35 + 50 + 40 + 55 + 35 + 45 + 60 = 395. 395 ÷ 9 = 43,888... ≈ 43,89.\nMediaan: rangskik die waardes: 30, 35, 35, 40, 45, 45, 50, 55, 60. Daar is 9 waardes (onewe), dus is die middelste (5de) waarde die mediaan: 45.\nGemiddelde = R43,89, Mediaan = R45 ✓' },
        { difficulty: 'Hard', question: 'ʼn Leerder bereken die gemiddelde van 12, 18, 15, 21, 9, 13 deur dit op te tel om 88 te kry, en dan deur 5 te deel om 17,6 te kry. Is dit korrek? Verduidelik die fout en gee die korrekte gemiddelde.', answer: 'Nee — daar is 6 waardes, nie 5 nie, so die leerder moet deur 6 deel, nie deur 5 nie. Ook is 12 + 18 + 15 + 21 + 9 + 13 = 88 korrek, maar die korrekte gemiddelde is 88 ÷ 6 = 14,67 (afgerond tot 2 desimale plekke), nie 17,6 nie.', checkMode: 'self' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        // Blok 4 — Gemiddelde en mediaan (13-16, Medium-Moeilik)
        { difficulty: 'Medium', question: 'ʼn Draffer teken hierdie tye (in minute) vir 6 oefenlope aan: 50, 58, 66, 54, 62, 70. Vind die gemiddelde en die mediaan van hierdie tye.', answer: 'Gemiddelde = 60 minute, Mediaan = 60 minute', checkMode: 'auto', correctAnswer: '60,60', correctAnswers: ['60,60', 'gemiddelde60mediaan60', '60, 60'], explanation: 'Gemiddelde: 50 + 58 + 66 + 54 + 62 + 70 = 360. 360 ÷ 6 = 60.\nMediaan: rangskik die waardes: 50, 54, 58, 62, 66, 70. Daar is 6 waardes (ewe), dus bereken die gemiddeld van die twee middelste waardes (3de en 4de): (58 + 62) ÷ 2 = 60.\nGemiddelde = 60 minute, Mediaan = 60 minute ✓' },
        { difficulty: 'Medium-Hard', question: 'Die massa (in kg) van 8 pakkies by ʼn afleweringsdepot word aangeteken: 16,4, 18,2, 15,9, 17,6, 19,1, 14,8, 18,5, 16,0. Vind die gemiddelde massa, afgerond tot 2 desimale plekke.', answer: '17,06 kg', checkMode: 'auto', correctAnswer: '17,06', correctAnswers: ['17,06', '17,06kg', '17.06', '17.06kg'], explanation: 'Tel al die waardes op: 16,4 + 18,2 + 15,9 + 17,6 + 19,1 + 14,8 + 18,5 + 16,0 = 136,5.\nTel: 8 waardes.\nGemiddelde = 136,5 ÷ 8 = 17,0625 ≈ 17,06 kg ✓' },
        { difficulty: 'Hard', question: "Ayanda se weeklikse sakgeld oor 7 weke (in rand) was: 25, 40, 30, 50, 35, 45, 30. Vind die gemiddelde (afgerond tot 2 desimale plekke) en die mediaan.", answer: 'Gemiddelde = R36,43, Mediaan = R35', checkMode: 'auto', correctAnswer: '36,43,35', correctAnswers: ['36,43,35', 'gemiddelde36,43mediaan35', '36,43, 35', '36.43,35'], explanation: 'Gemiddelde: 25 + 40 + 30 + 50 + 35 + 45 + 30 = 255. 255 ÷ 7 = 36,428... ≈ 36,43.\nMediaan: rangskik die waardes: 25, 30, 30, 35, 40, 45, 50. Daar is 7 waardes (onewe), dus is die middelste (4de) waarde die mediaan: 35.\nGemiddelde = R36,43, Mediaan = R35 ✓' },
        ...
        { difficulty: 'Hard', question: 'ʼn Opname van 50 leerders oor gunsteling musiekgenres word op ʼn sirkelgrafiek gewys: Pop — 34%, Hip-hop — 26%, Gospel — die ontbrekende skyf. Vind die aantal leerders vir elke genre, en vind dan die gemiddelde van hierdie drie tellings.', answer: 'Pop = 17, Hip-hop = 13, Gospel = 20. Gemiddelde = 16,67', checkMode: 'auto', correctAnswer: '16,67', correctAnswers: ['16,67', '16,7', '16.67', '16.7'], explanation: 'Pop: 34% van 50 = 17. Hip-hop: 26% van 50 = 13. Gospel (ontbrekende skyf): 100% − 34% − 26% = 40%, so 40% van 50 = 20.\nKontroleer: 17 + 13 + 20 = 50 ✓\nGemiddelde van tellings: (17 + 13 + 20) ÷ 3 = 50 ÷ 3 = 16,666... ≈ 16,67 ✓' },
      ],
      scoreMessages: [
        { minScore: 20, message: 'Uitstekend! Jy het frekwensietabelle, staafgrafieke, sirkelgrafieke, en gemiddelde, mediaan en modus bemeester.' },
        { minScore: 15, message: 'Puik werk! Jy is redelik seker van jouself hiermee — gaan enige gemiste vrae deur.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        // Blok 4 — Gemiddelde en mediaan (13-16, Medium-Moeilik)
        { difficulty: 'Medium', question: 'ʼn Leerder teken sy speltoetsuitslae (uit 60) vir 7 toetse aan: 45, 52, 38, 60, 49, 55, 41. Vind die gemiddelde (afgerond tot 2 desimale plekke) en die mediaan van hierdie uitslae.', answer: 'Gemiddelde = 48,57, Mediaan = 49', checkMode: 'auto', correctAnswer: '48,57,49', correctAnswers: ['48,57,49', 'gemiddelde48,57mediaan49', '48,57, 49', '48.57,49'], explanation: 'Gemiddelde: 45 + 52 + 38 + 60 + 49 + 55 + 41 = 340. 340 ÷ 7 = 48,571... ≈ 48,57.\nMediaan: rangskik die waardes: 38, 41, 45, 49, 52, 55, 60. Daar is 7 waardes (onewe), dus is die middelste (4de) waarde die mediaan: 49.\nGemiddelde = 48,57, Mediaan = 49 ✓' },
        { difficulty: 'Medium-Hard', question: 'Die hoogte (in cm) van 9 saailinge word gemeet: 8,4, 9,1, 7,6, 8,9, 9,5, 7,2, 8,0, 9,3, 8,6. Vind die gemiddelde hoogte, afgerond tot 2 desimale plekke.', answer: '8,51 cm', checkMode: 'auto', correctAnswer: '8,51', correctAnswers: ['8,51', '8,51cm', '8.51', '8.51cm'], explanation: 'Tel al die waardes op: 8,4 + 9,1 + 7,6 + 8,9 + 9,5 + 7,2 + 8,0 + 9,3 + 8,6 = 76,6.\nTel: 9 waardes.\nGemiddelde = 76,6 ÷ 9 = 8,5111... ≈ 8,51 cm ✓' },
        { difficulty: 'Hard', question: "Boitumelo se weeklikse sakgeld oor 6 weke (in rand) was: 30, 40, 50, 35, 45, 40. Vind die gemiddelde en die mediaan.", answer: 'Gemiddelde = R40, Mediaan = R40', checkMode: 'auto', correctAnswer: '40,40', correctAnswers: ['40,40', 'gemiddelde40mediaan40', '40, 40'], explanation: 'Gemiddelde: 30 + 40 + 50 + 35 + 45 + 40 = 240. 240 ÷ 6 = 40.\nMediaan: rangskik die waardes: 30, 35, 40, 40, 45, 50. Daar is 6 waardes (ewe), dus bereken die gemiddeld van die twee middelste waardes (3de en 4de): (40 + 40) ÷ 2 = 40.\nGemiddelde = R40, Mediaan = R40 ✓' },
        { difficulty: 'Hard', question: 'ʼn Leerder bereken die gemiddelde van 20, 35, 25, 40, 30 deur dit op te tel om 150 te kry, en dan deur 6 te deel om 25 te kry. Is dit korrek? Verduidelik die fout en gee die korrekte gemiddelde.', answer: 'Nee — daar is 5 waardes, nie 6 nie, so die leerder moet deur 5 deel, nie deur 6 nie. Ook is 20 + 35 + 25 + 40 + 30 = 150 korrek, maar die korrekte gemiddelde is 150 ÷ 5 = 30, nie 25 nie.', checkMode: 'self' },
