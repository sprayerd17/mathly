...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Kort video wat verduidelik wat ʼn verhouding is, hoe om dit met ʼn dubbelpunt te skryf, en hoe om ʼn verhouding te vereenvoudig deur die GGF te deel',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Kort video wat wys hoe om te toets of twee verhoudings ekwivalent is, en hoe om ʼn bedrag in ʼn verhouding te verdeel met die totale-dele-metode, met ʼn uitgewerkte R1 800 drierigting-verdelingsvoorbeeld',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Kort video wat verduidelik wat ʼn koers is, hoe dit van ʼn verhouding verskil, wat per beteken, en hoe om ʼn eenheidskoers te bereken deur die eerste hoeveelheid deur die tweede te deel',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Kort video wat wys hoe om koersprobleme op te los deur te identifiseer wat gegee is en wat benodig word, en dan te kies om met die eenheidskoers te vermenigvuldig of te deel',
    },
  ],
  topicPractice: [
