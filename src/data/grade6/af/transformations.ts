...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        '<DiagramPlaceholder label="Twee reghoekige driehoeke langs mekaar — ʼn kleiner objekdriehoek in blou met bene 3 en 4, en ʼn groter vergrote beelddriehoek in groen met bene 6 en 8 — wat dieselfde vorm maar ʼn verskillende grootte wys" />',
      diagramSvg:
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        '<DiagramPlaceholder label="Vierkantige rooster wat ʼn klein blou objekdriehoek XYZ wys wat met skaalfaktor 2 vanaf ʼn pers middelpunt van vergroting O vergroot word, na ʼn groter groen beelddriehoek X′Y′Z′, met kolstreep-strale vanaf O deur elke paar ooreenstemmende hoekpunte" />',
      diagramSvg:
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        '<DiagramPlaceholder label="Vierkantige rooster wat ʼn groter blou objekreghoek PQRS wys wat met skaalfaktor 1/2 vanaf ʼn pers middelpunt van vergroting O verklein word, na ʼn kleiner rooi beeldreghoek P′Q′R′S′, met kolstreep-strale vanaf O deur elke paar ooreenstemmende hoekpunte" />',
      diagramSvg:
