...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Kort video wat vergroting en verkleining bekendstel, wat wys hoe die skaalfaktor ʼn objek en sy beeld verbind, met die objek in blou, ʼn vergrote beeld in groen en ʼn verkleinde beeld in rooi',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Kort video wat wys hoe om ʼn driehoek op vierkantige papier te vergroot vanaf ʼn gemerkte middelpunt van vergroting, deur blokkies te tel en met die skaalfaktor te vermenigvuldig',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Kort video wat wys hoe om ʼn reghoek op vierkantige papier te verklein vanaf ʼn gemerkte middelpunt van vergroting, deur blokkies te tel en met ʼn breuk-skaalfaktor soos 1/2 te vermenigvuldig',
    },
  ],
