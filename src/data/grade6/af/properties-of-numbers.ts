...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        'Faktorboomdiagram vir 120 met saamgestelde getalle in blou, priemgetalle omkring in groen, en die finale priemfaktorisering 120 = 2³ × 3 × 5 in rooi',
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        'Venn-diagram wat die faktore van 12 en 18 vergelyk, met die gemene faktore in die oorvleuelende deel en die grootste gemene faktor van 6 in oranje uitgelig',
      ...
      diagramSvg:
        ...
        `<text x="55" y="40" text-anchor="middle" font-size="11" font-weight="700" fill="#2563eb">Faktore van 12</text>` +
        `<text x="195" y="40" text-anchor="middle" font-size="11" font-weight="700" fill="#16a34a">Faktore van 18</text>` +
        ...
        `<text x="125" y="178" text-anchor="middle" font-size="12" font-weight="700" fill="#ea580c">GGF(12, 18) = 6</text>` +
        `</svg>`,
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        'Dubbele getallelyn wat veelvoude van 8 en veelvoude van 12 volgens waarde belyn toon, met die punt waar hulle eerste ontmoet — 24 — in oranje uitgelig as die kleinste gemene veelvoud',
      ...
      diagramSvg:
        ...
        `<text x="130" y="152" text-anchor="middle" font-size="12" font-weight="700" fill="#ea580c">KGV(8, 12) = 24</text>` +
        `</svg>`,
  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'ʼn Cateraar het 60 samoosas en 84 springrolletjies. Sy wil identiese peuselsakkies pak met al die happies sonder dat iets oorbly. Wat is die maksimum aantal peuselsakkies wat sy kan maak?', answer: '12', checkMode: 'auto', correctAnswer: '12', explanation: 'Dit is ʼn GGF-probleem: vind die GGF van 60 en 84.\n60 = 2² × 3 × 5\n84 = 2² × 3 × 7\nGedeelde priemfaktore: 2 (laagste mag 2²) en 3 (laagste mag 3¹)\nGGF = 2² × 3 = 4 × 3 = 12\nSy kan 12 identiese peuselsakkies pak ✓' },
        ...
        { difficulty: 'Hard', question: 'ʼn Skool het 96 potlode en 120 liniale om in identiese skryfbehoeftestelle te pak, met al die items en niks oor nie. Vind eers die priemfaktorisering van 96 en 120, vind dan die maksimum aantal stelle, en sê laastens hoeveel potlode en liniale in elke stel gaan.', answer: '24 stelle, elk met 4 potlode en 5 liniale', checkMode: 'auto', correctAnswer: '24 stelle, elk met 4 potlode en 5 liniale', correctAnswers: ['24 stelle, elk met 4 potlode en 5 liniale', '24 stelle met 4 potlode en 5 liniale elk'], explanation: '96 = 2⁵ × 3\n120 = 2³ × 3 × 5\nGedeelde priemfaktore: 2 (laagste mag 2³) en 3 (laagste mag 3¹)\nGGF = 2³ × 3 = 8 × 3 = 24 stelle\nPotlode per stel: 96 ÷ 24 = 4. Liniale per stel: 120 ÷ 24 = 5 ✓' },
      ],
      scoreMessages: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium-Hard', question: 'ʼn Markstalletjie voorsien vrugte elke 15 dae van nuwe voorraad en groente elke 18 dae, en begin op dieselfde dag. Na hoeveel dae sal albei voorraadopgraderings weer op dieselfde dag gebeur?', answer: '90', checkMode: 'auto', correctAnswer: '90', explanation: 'Vind die KGV van 15 en 18.\n15 = 3 × 5\n18 = 2 × 3²\nHoogste magte: 2¹ (van 18), 3² (van 18), 5¹ (van 15)\nKGV = 2 × 3² × 5 = 2 × 9 × 5 = 90\nAlbei voorraadopgraderings sal weer op dieselfde dag gebeur na 90 dae ✓' },
