  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'Twee atlete hardloop 100 m in 12,8 sekondes en 12,79 sekondes. Watter tyd is vinniger (kleiner)?', answer: '12,79 sekondes', checkMode: 'auto', correctAnswer: '12,79', correctAnswers: ['12.79', '12,79', '12.79 seconds', '12,79 sekondes', '12.79s'], explanation: 'Vergelyk tiendes: 8 > 7, dus 12,80 > 12,79. Die vinniger (kleiner) tyd is 12,79 sekondes.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'ʼn Leerder sê dat die twee 4s in 4,004 dieselfde waarde moet hê omdat "die getal albei kere dieselfde lyk." Is dit korrek? Verduidelik.', answer: 'Nee — die eerste 4 is in die ene-plek met waarde 4, en die tweede 4 is in die duisendstes-plek met waarde 0,004. Al lyk die syfer dieselfde, hang sy waarde heeltemal af van sy plekwaardeposisie.', checkMode: 'self' },
