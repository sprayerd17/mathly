  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      explanation:
        ...
        `<div style="background:#eff6ff;border:1.5px solid #bfdbfe;border-radius:10px;padding:12px 14px;">` +
        `<p style="font-weight:700;color:#2563eb;margin-bottom:4px;">${gr('Ongelyksydige')} driehoek</p>` +
        ...
        `<p style="margin:0;color:#1e3a8a;">ʼn Driehoek kan benoem word deur <strong>beide</strong> ʼn syklassifikasie en ʼn hoekklassifikasie te gebruik. ʼn Driehoek kan byvoorbeeld ʼn ${gr('skerphoekige gelykbenige')} driehoek of ʼn ${gr('reghoekige ongelyksydige')} driehoek wees.</p>` +
        `</div>`,
      ...
      diagramPlaceholder:
        'Die vier maniere om ʼn driehoek volgens sye en hoeke te klassifiseer — gelyksydig, gelykbenig, ongelyksydig en reghoekig.',
      ...
      diagramSvg:
        ...
        '<text x="317" y="138" text-anchor="middle" font-size="13" font-weight="700" fill="#0f1f3d">Ongelyksydig</text>' +
  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy-Medium', question: 'ʼn Driehoek het sye van 8 cm, 3 cm en 6 cm, soos getoon. Klassifiseer hierdie driehoek volgens sy sye.', answer: 'ongelyksydige driehoek', checkMode: 'auto', correctAnswer: 'ongelyksydige driehoek', correctAnswers: ['ongelyksydige driehoek', 'ongelyksydig'], explanation: 'Al drie sylengtes verskil (8 cm, 3 cm, 6 cm), dus is geen sye gelyk nie. Dit maak dit ʼn ongelyksydige driehoek.', diagramSvg: '<svg viewBox="0 0 220 170" xmlns="http://www.w3.org/2000/svg"><polygon points="25,140 195,140 75,25" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="45" y="90" font-size="14" fill="#2563eb" font-weight="700">8 cm</text><text x="140" y="90" font-size="14" fill="#2563eb" font-weight="700">3 cm</text><text x="110" y="158" font-size="14" fill="#2563eb" font-weight="700" text-anchor="middle">6 cm</text></svg>' },
        ...
        { difficulty: 'Medium', question: 'Driehoek C het sye 6 cm, 8 cm, 10 cm met hoeke 37°, 53°, 90°. Driehoek D het sye 6 cm, 6 cm, 6 cm met hoeke 60°, 60°, 60°. Noem een verskil tussen hierdie twee driehoeke volgens sye en een volgens hoeke.', answer: 'Volgens sye — Driehoek C is ongelyksydig (geen gelyke sye) terwyl Driehoek D gelyksydig is (al die sye gelyk). Volgens hoeke — Driehoek C is reghoekig (het ʼn hoek van 90°) terwyl Driehoek D skerphoekig is (al die hoeke 60°).', checkMode: 'self', explanation: 'Driehoek C (6, 8, 10) het drie verskillende sylengtes, dus is dit ongelyksydig, en sy hoek van 90° maak dit reghoekig. Driehoek D (6, 6, 6) het al die sye gelyk, dus is dit gelyksydig, en sy drie hoeke van 60° maak dit skerphoekig. Die twee driehoeke verskil in beide klassifikasies.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium-Hard', question: 'ʼn Reëlmatige agthoek (8 sye) het al die hoeke gelyk. Wat is die grootte van elke binnehoek?', answer: '135 grade', checkMode: 'auto', correctAnswer: '135 grade', correctAnswers: ['135 grade', '135°', '135'], explanation: 'Som van binnehoeke van ʼn agthoek: (8 − 2) × 180 = 6 × 180 = 1080°.\nAl 8 hoeke is gelyk: 1080 ÷ 8 = 135°. ✓' },
