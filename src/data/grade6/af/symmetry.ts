    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      workedExamples: [
        ...
        },
        {
          ...
          steps: [
            `In ʼn vlieër loop een diagonaal tussen die twee hoekpunte waar elke paar gelyke sye ontmoet — dit is die ${bl('lang diagonaal')}.`,
            `Om langs hierdie diagonaal te vou, weerspieël elke paar gelyke sye die ander paar presies, dus ${gr('pas')} die helftes.`,
            `Die ander (kort) diagonaal verbind die twee hoekpunte waar die twee verskillende pare sye mekaar ontmoet — om langs dit te vou gee ${re('nie')} ooreenstemmende helftes nie, want dit skep twee driehoeke van verskillende vorms.`,
      ...
      openQuestions: [
        ...
        },
        {
          ...
          answer: 'Thabo is verkeerd. Om twee diagonale te hê, beteken nie dat albei simmetrielyne is nie — dit hang af van of elke diagonaal werklik ooreenstemmende spieëlhelftes gee. ʼn Vlieër het twee pare aangrensende gelyke sye, maar die twee pare verskil in lengte van mekaar. Net die lang diagonaal (wat tussen die twee hoekpunte loop waar elke paar gelyke sye ontmoet) verdeel die vlieër in twee spieëlbeeld-helftes. Die kort diagonaal doen dit nie, want dit skep twee driehoeke van verskillende vorms. Dus het ʼn vlieër net 1 simmetrielyn, nie 2 nie.',
          checkMode: 'self',
        },
      ],
  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'ʼn Vlieër het twee pare aangrensende gelyke sye, maar die pare verskil in lengte van mekaar. Hoeveel simmetrielyne het ʼn vlieër?', checkMode: 'auto', correctAnswer: '1', correctAnswers: ['1', 'een'], explanation: 'ʼn Vlieër het net 1 simmetrielyn — die lang diagonaal wat tussen die twee hoekpunte loop waar elke paar gelyke sye ontmoet.' },
        ...
        { difficulty: 'Medium', question: 'ʼn Vlieër se twee diagonale word geteken. Die een is die lang diagonaal (tussen die twee hoekpunte waar elke paar gelyke sye ontmoet), en die ander is die kort diagonaal (tussen die twee hoekpunte waar die twee verskillende pare sye mekaar ontmoet). Watter een is die simmetrielyn?', checkMode: 'auto', correctAnswer: 'die lang diagonaal', correctAnswers: ['die lang diagonaal', 'lang diagonaal', 'die lang een'], explanation: 'Net die lang diagonaal van ʼn vlieër is ʼn simmetrielyn. Om daarlangs te vou, weerspieël elke paar gelyke sye die ander paar. Die kort diagonaal gee nie ooreenstemmende helftes nie.' },
        ...
        { difficulty: 'Hard', question: 'Vergelyk ʼn ruit en ʼn vlieër. ʼn Ruit het 2 simmetrielyne terwyl ʼn vlieër net 1 het. Verduidelik die verskil in hul sylengtes wat dit veroorsaak.', answer: 'In ʼn ruit is al 4 sye gelyk in lengte, dus verdeel albei diagonale dit in ooreenstemmende spieëlbeeld-driehoeke — wat 2 simmetrielyne gee. In ʼn vlieër is daar twee pare aangrensende gelyke sye, maar die twee pare verskil in lengte van mekaar (byvoorbeeld, twee sye van 3 cm en twee sye van 5 cm). Net die lang diagonaal (tussen die hoekpunte waar elke paar gelyke sye ontmoet) gee ooreenstemmende helftes; die kort diagonaal doen dit nie, want dit sou probeer om ʼn 3 cm-sy teenoor ʼn 5 cm-sy te laat pas. Omdat ʼn vlieër se sye nie almal gelyk is soos ʼn ruit s\'n nie, werk net een van sy diagonale as ʼn simmetrielyn, nie albei nie.', checkMode: 'self' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'ʼn Vlieër het twee pare aangrensende gelyke sye van verskillende lengtes van mekaar. Watter diagonaal is sy simmetrielyn — die lang een of die kort een?', checkMode: 'auto', correctAnswer: 'die lang diagonaal', correctAnswers: ['die lang diagonaal', 'lang diagonaal', 'die lang een'], explanation: 'Net die lang diagonaal van ʼn vlieër (tussen die hoekpunte waar elke paar gelyke sye ontmoet) is ʼn simmetrielyn.' },
        ...
        { difficulty: 'Medium', question: 'ʼn Vlieër se kort diagonaal (tussen die hoekpunte waar die twee verskillende pare sye mekaar ontmoet) is geteken. Is hierdie diagonaal ʼn simmetrielyn?', checkMode: 'auto', correctAnswer: 'nee', correctAnswers: ['nee', 'Nee'], explanation: 'Die kort diagonaal van ʼn vlieër is nie ʼn simmetrielyn nie — net die lang diagonaal (tussen die hoekpunte waar elke paar gelyke sye ontmoet) gee ooreenstemmende spieëlhelftes.' },
        ...
        { difficulty: 'Hard', question: 'ʼn Leerder beweer: "ʼn Vlieër het twee diagonale, en aangesien diagonale dikwels simmetrielyne in vierhoeke gee, moet ʼn vlieër 2 simmetrielyne hê." Verduidelik waarom hierdie redenasie foutief is, en gee die vlieër se werklike aantal simmetrielyne.', answer: 'Hierdie redenasie is foutief omdat nie elke diagonaal in elke vierhoek outomaties ʼn simmetrielyn is nie — dit hang af van of die vou langs daardie spesifieke diagonaal ware spieëlbeeld-helftes gee. In ʼn vlieër verskil die twee pare aangrensende gelyke sye in lengte van mekaar. Net die lang diagonaal (tussen die hoekpunte waar elke paar gelyke sye ontmoet) gee ooreenstemmende helftes. Die kort diagonaal doen dit nie, want dit sou probeer om een paar gelyke sye teenoor ʼn ander paar van verskillende grootte te laat pas. Dus het ʼn vlieër net 1 simmetrielyn, nie 2 nie — om bloot twee diagonale te hê, waarborg nie twee simmetrielyne nie.', checkMode: 'self' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy-Medium', question: 'ʼn Ongelyksydige driehoek het drie sye wat almal verskillende lengtes het. Hoeveel simmetrielyne het dit?', checkMode: 'auto', correctAnswer: '0', correctAnswers: ['0', 'nul', 'geen'], explanation: 'ʼn Ongelyksydige driehoek het 0 simmetrielyne — aangesien al drie sye verskillende lengtes het, kan geen vou ooit twee ooreenstemmende spieëlhelftes gee nie.' },
