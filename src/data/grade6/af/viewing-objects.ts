...
<div style="background:#eff6ff;border:1.5px solid #bfdbfe;border-radius:10px;padding:14px 20px;margin-bottom:8px;">
  ...
  <p style="margin:0;color:#1e3a8a;font-size:15px;line-height:1.7;">As ʼn saamgestelde voorwerp <strong>simmetries</strong> is in elke rigting (byvoorbeeld, ʼn kleiner boks presies gesentreerd bo-op ʼn groter vierkantige boks), kan sy vooraansig en syaansig <strong>identies</strong> wees, selfs al het die voorwerp duidelik diepte sowel as breedte. Kyk altyd vir simmetrie voordat jy aanneem dat twee aansigte verskillend moet lyk.</p>
      ...
      workedExamples: [
        {
          question: 'Drie stoorbokse staan in ʼn ry, teen mekaar. Al drie bokse het presies dieselfde breedte en diepte, maar hulle hoogtes verskil: die eerste is kort, die tweede is hoog, en die derde is medium hoog, tussenin. Beskryf die vooraansig, syaansig en bo-aansig.',
          steps: [
            '<strong>Vooraansig</strong> — van links na regs styg en daal die buitelyn om by elke boks se hoogte te pas: kort, dan ʼn hoë trap op, dan ʼn trap af na medium. Dit gee ʼn onreëlmatige <strong>trapvorm</strong>, nie ʼn eenvoudige tweetrap-vorm nie.',
            '<strong>Syaansig</strong> — aangesien elke boks presies dieselfde breedte en diepte het, en hulle in ʼn enkele ry staan, kan jy van die kant af (einde-op) net die hoogste boks se hoogte meet — jy kry ʼn <strong>eenvoudige reghoek</strong>, so hoog soos die hoogste boks.',
            '<strong>Bo-aansig</strong> — as jy afkyk, neem elke boks dieselfde grondvlak in beslag, so jy sien <strong>drie gelyke vierkante in ʼn ry</strong> — die bo-aansig kan nie wys dat die bokse verskillende hoogtes het nie.',
          ],
          answer:
      ...
      diagramSvg: '<svg viewBox="0 0 730 190" xmlns="http://www.w3.org/2000/svg"><path d="M35,140 L35,116 L65,116 L65,68 L95,68 L95,92 L125,92 L125,140 Z" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><path d="M35,140 L55,125 M35,116 L55,101 M65,116 L85,101 M65,68 L85,53 M95,68 L115,53 M95,92 L115,77 M125,92 L145,77 M125,140 L145,125 M55,125 L55,101 M55,101 L85,101 M85,101 L85,53 M85,53 L115,53 M115,53 L115,77 M115,77 L145,77 M145,77 L145,125 M145,125 L55,125" fill="none" stroke="#2563eb" stroke-width="1.5"/><path d="M215,140 L215,116 L245,116 L245,68 L275,68 L275,92 L305,92 L305,140 Z" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><rect x="435" y="68" width="30" height="72" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><rect x="585" y="100" width="90" height="24" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="615" y1="100" x2="615" y2="124" stroke="#2563eb" stroke-width="1.5"/><line x1="645" y1="100" x2="645" y2="124" stroke="#2563eb" stroke-width="1.5"/><text x="90" y="178" text-anchor="middle" font-size="13" font-weight="700" fill="#0f1f3d">Die voorwerp</text><text x="270" y="178" text-anchor="middle" font-size="13" font-weight="700" fill="#0f1f3d">Vooraansig</text><text x="450" y="178" text-anchor="middle" font-size="13" font-weight="700" fill="#0f1f3d">Syaansig</text><text x="630" y="178" text-anchor="middle" font-size="13" font-weight="700" fill="#0f1f3d">Bo-aansig</text></svg>',
    },
  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'Buiten voor, kant en bo, noem die vier ander gesigspunte wat in Graad 6 gebruik word.', answer: 'Agter, links en regs (en onder)', checkMode: 'self', explanation: 'Graad 6 gebruik altesaam ses gesigspunte: voor, agter, links, regs, bo en onder.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'ʼn Potlood (voor dit geslyp is) is ʼn seshoekige prisma. Sodra dit geslyp is, watter vorm word bygevoeg om dit ʼn saamgestelde voorwerp te maak?', answer: 'ʼn Keël', checkMode: 'auto', correctAnswer: 'ʼn Keël', correctAnswers: ['ʼn Keël', 'keël', 'ʼn keel', 'keel'], explanation: 'Om ʼn potlood te slyp voeg ʼn keël-vormige punt by die seshoekige prisma-liggaam, wat die potlood ʼn saamgestelde voorwerp maak.' },
        ...
        // Blok 3 — Kubusstrukture (Medium)
        { difficulty: 'Medium', question: 'ʼn Kubusstruktuur het 2 kolomme langs mekaar: een 4 kubusse hoog, een 1 kubus hoog. Wat is die vooraansig-hoogteverskil tussen die twee kolomme?', answer: '3 kubusse', checkMode: 'auto', correctAnswer: '3 kubusse', correctAnswers: ['3 kubusse', '3', 'drie kubusse'], explanation: 'Die hoogteverskil is 4 kubusse min 1 kubus = 3 kubusse.', diagramSvg: '<svg viewBox="0 0 220 150" xmlns="http://www.w3.org/2000/svg"><rect x="40" y="110" width="30" height="20" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><rect x="100" y="50" width="30" height="80" fill="none" stroke="#0f1f3d" stroke-width="2.5"/></svg>' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        // Blok 5 — Saamgestelde geboue (Medium)
        { difficulty: 'Medium', question: 'ʼn Blok klaskamers het ʼn hoër personeelkamer-gedeelte aan een punt aangeheg, met die personeelkamer verder teruggesit (groter diepte) as die klaskamers. Watter aansig sou die beste wys dat die personeelkamer verder teruggesit is: die vooraansig of die bo- (plan-) aansig?', answer: 'Bo- (plan-) aansig', checkMode: 'auto', correctAnswer: 'Bo- (plan-) aansig', correctAnswers: ['Bo- (plan-) aansig', 'bo-aansig', 'planaansig', 'die bo-aansig', 'die planaansig'], explanation: 'Diepteverskille (hoe ver terug ʼn gedeelte gesit is) kan net akkuraat in ʼn plan- (bo-) aansig gesien word, aangesien voor- en syaansigte nie diepte direk wys nie.', diagramSvg: '<svg viewBox="0 0 220 150" xmlns="http://www.w3.org/2000/svg"><path d="M30,40 L150,40 L150,130 L120,130 L120,70 L30,70 Z" fill="none" stroke="#0f1f3d" stroke-width="2.5"/></svg>' },
