  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      openQuestions: [
        ...
        {
          difficulty: 'Easy',
          question: 'ʼn Reëlmatige seshoek het sye van 7 cm elk. Vind die omtrek.',
          answer: '42cm',
          checkMode: 'auto',
          correctAnswer: '42cm',
          correctAnswers: ['42cm', '42 cm', '42'],
          explanation: 'ʼn Reëlmatige seshoek het 6 gelyke sye.\nO = 6 × 7 = 42 cm ✓',
        },
  ...
  practiceSets: [
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'ʼn Vierkantige tafelblad het sye van 90 cm. Watter lengte randlint word benodig om heeltemal rondom dit te gaan?', answer: '360 cm', checkMode: 'auto', correctAnswer: '360 cm', correctAnswers: ['360 cm', '360cm', '360'], explanation: 'Die lint gaan rondom die omtrek: O = 4 × sy = 4 × 90 = 360 cm ✓', diagramSvg: '<svg viewBox="0 0 220 190" xmlns="http://www.w3.org/2000/svg"><rect x="55" y="35" width="110" height="110" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="110.0" y="23" font-size="14" fill="#2563eb" font-weight="700" text-anchor="middle">90 cm</text></svg>' },
        ...
        { difficulty: 'Medium', question: 'ʼn Vierkantige plakkaat het ʼn oppervlakte van 3600 cm². Wat is die lengte van elke sy?', answer: '60 cm', checkMode: 'auto', correctAnswer: '60 cm', correctAnswers: ['60 cm', '60cm', '60'], explanation: 'Sy × sy = 3600, dus is die sylengte die vierkantswortel van 3600.\n√3600 = 60 cm ✓', diagramSvg: '<svg viewBox="0 0 220 190" xmlns="http://www.w3.org/2000/svg"><rect x="55" y="35" width="110" height="110" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="110.0" y="92.0" font-size="15" fill="#374151" text-anchor="middle">Oppervlakte = 3600 cm²</text><text x="110.0" y="112.0" font-size="15" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },
    ...
    },
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'ʼn Vierkantige mat het ʼn oppervlakte van 9 m². Wat is die lengte van elke sy?', answer: '3 m', checkMode: 'auto', correctAnswer: '3 m', correctAnswers: ['3 m', '3m', '3'], explanation: 'Sy × sy = 9, dus is die sylengte die vierkantswortel van 9.\n√9 = 3 m ✓', diagramSvg: '<svg viewBox="0 0 220 190" xmlns="http://www.w3.org/2000/svg"><rect x="55" y="35" width="110" height="110" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="110.0" y="92.0" font-size="15" fill="#374151" text-anchor="middle">Oppervlakte = 9 m²</text><text x="110.0" y="112.0" font-size="15" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },
        ...
        { difficulty: 'Hard', question: 'ʼn Reghoek is 9 m by 7 m en ʼn reëlmatige seshoek het sye van 5 m. Nomvula sê die seshoek het die groter omtrek omdat dit meer sye het. Is sy korrek? Wys die omtrek van elk om te verduidelik.', answer: 'Nee — die reghoek het ʼn omtrek van 32 m (2 × (9 + 7)) en die seshoek het ʼn omtrek van 30 m (6 × 5). Die reghoek het eintlik die groter omtrek, dus is Nomvula verkeerd — meer sye beteken nie altyd ʼn groter omtrek nie.', checkMode: 'self' },
      ],
      scoreMessages: [
        { minScore: 20, message: 'Uitstekend! Jy het omtrek en oppervlakte oor elke vaardigheid in hierdie stel bemeester.' },
        { minScore: 15, message: 'Goeie werk! Jy is selfversekerd met omtrek en oppervlakte — gaan enige gemiste vrae na en probeer nog ʼn stel.' },
    ...
    },
    {
      name: 'Stel 3',
      questions: [
        { difficulty: 'Easy', question: 'ʼn Reëlmatige seshoek het sye van 11 cm elk. Vind die omtrek.', answer: '66 cm', checkMode: 'auto', correctAnswer: '66 cm', correctAnswers: ['66 cm', '66cm', '66'], explanation: 'ʼn Reëlmatige seshoek het 6 gelyke sye.\nO = 6 × 11 = 66 cm ✓', diagramSvg: '<svg viewBox="0 0 220 190" xmlns="http://www.w3.org/2000/svg"><polygon points="139.0,44.8 168.0,95.0 139.0,145.2 81.0,145.2 52.0,95.0 81.0,44.8" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="167.4" y="61.9" font-size="14" fill="#2563eb" font-weight="700" text-anchor="middle">11 cm</text><text x="110" y="182" font-size="13" fill="#374151" text-anchor="middle">reëlmatige seshoek</text></svg>' },
        ...
        { difficulty: 'Medium', question: 'ʼn Vierkantige kennisgewingbord het sye van 80 cm. Watter lengte randstuk word benodig om heeltemal rondom dit te gaan?', answer: '320 cm', checkMode: 'auto', correctAnswer: '320 cm', correctAnswers: ['320 cm', '320cm', '320'], explanation: 'Die randstuk gaan rondom die omtrek: O = 4 × sy = 4 × 80 = 320 cm ✓', diagramSvg: '<svg viewBox="0 0 220 190" xmlns="http://www.w3.org/2000/svg"><rect x="55" y="35" width="110" height="110" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="110.0" y="23" font-size="14" fill="#2563eb" font-weight="700" text-anchor="middle">80 cm</text></svg>' },
        ...
        { difficulty: 'Medium', question: 'ʼn Vierkantige plek-mat het ʼn oppervlakte van 1600 cm². Wat is die lengte van elke sy?', answer: '40 cm', checkMode: 'auto', correctAnswer: '40 cm', correctAnswers: ['40 cm', '40cm', '40'], explanation: 'Sy × sy = 1600, dus is die sylengte die vierkantswortel van 1600.\n√1600 = 40 cm ✓', diagramSvg: '<svg viewBox="0 0 220 190" xmlns="http://www.w3.org/2000/svg"><rect x="55" y="35" width="110" height="110" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="110.0" y="92.0" font-size="15" fill="#374151" text-anchor="middle">Oppervlakte = 1600 cm²</text><text x="110.0" y="112.0" font-size="15" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },
        ...
        { difficulty: 'Medium-Hard', question: 'ʼn Tuinskuur het ʼn reghoekige basis van 4 m by 3 m, en ʼn driehoekige dakgedeelte bo een muur met ʼn basis van 4 m en ʼn hoogte van 1,5 m. Wat is die totale oppervlakte wat deur die basis plus die dakgedeelte bedek word?', answer: '15 m²', checkMode: 'auto', correctAnswer: '15 m²', correctAnswers: ['15 m²', '15m²', '15 m2', '15m2', '15'], explanation: 'Basis-oppervlakte = 4 × 3 = 12 m².\nDakgedeelte-oppervlakte = 0,5 × 4 × 1,5 = 3 m².\nTotaal = 12 + 3 = 15 m² ✓', diagramSvg: '<svg viewBox="0 0 220 190" xmlns="http://www.w3.org/2000/svg"><rect x="35" y="75" width="150" height="75" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><polygon points="35,75 185,75 110.0,20" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="110.0" y1="20" x2="110.0" y2="75" stroke="#dc2626" stroke-width="2" stroke-dasharray="5,4"/><rect x="102.0" y="67" width="8" height="8" fill="none" stroke="#dc2626" stroke-width="1.5"/><text x="124.0" y="47.5" font-size="12" fill="#dc2626" font-weight="700" text-anchor="start">1,5 m</text><text x="110.0" y="170" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">4 m</text><text x="19" y="112.5" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle" transform="rotate(-90 19 112.5)">3 m</text></svg>' },
