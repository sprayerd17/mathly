...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        'Diagram wat algemene 2D-vorms wys — vierkant, reghoek, driehoek en sirkel — elkeen geëtiketteer met die aantal sye in oranje en hoekpunte in groen',
      diagramSvg:
        '<svg viewBox="0 0 440 170" xmlns="http://www.w3.org/2000/svg"><rect x="15" y="20" width="70" height="70" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><circle cx="15" cy="20" r="3.5" fill="#16a34a"/><circle cx="85" cy="20" r="3.5" fill="#16a34a"/><circle cx="15" cy="90" r="3.5" fill="#16a34a"/><circle cx="85" cy="90" r="3.5" fill="#16a34a"/><text x="50" y="112" font-weight="700" font-size="12" text-anchor="middle" fill="#ea580c">4 sye</text><text x="50" y="128" font-weight="700" font-size="12" text-anchor="middle" fill="#16a34a">4 hoeke</text><text x="50" y="150" font-weight="700" font-size="13" text-anchor="middle" fill="#0f1f3d">Vierkant</text><rect x="110" y="30" width="100" height="60" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><circle cx="110" cy="30" r="3.5" fill="#16a34a"/><circle cx="210" cy="30" r="3.5" fill="#16a34a"/><circle cx="110" cy="90" r="3.5" fill="#16a34a"/><circle cx="210" cy="90" r="3.5" fill="#16a34a"/><text x="160" y="112" font-weight="700" font-size="12" text-anchor="middle" fill="#ea580c">4 sye</text><text x="160" y="128" font-weight="700" font-size="12" text-anchor="middle" fill="#16a34a">4 hoeke</text><text x="160" y="150" font-weight="700" font-size="13" text-anchor="middle" fill="#0f1f3d">Reghoek</text><polygon points="230,90 300,90 265,20" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><circle cx="230" cy="90" r="3.5" fill="#16a34a"/><circle cx="300" cy="90" r="3.5" fill="#16a34a"/><circle cx="265" cy="20" r="3.5" fill="#16a34a"/><text x="265" y="112" font-weight="700" font-size="12" text-anchor="middle" fill="#ea580c">3 sye</text><text x="265" y="128" font-weight="700" font-size="12" text-anchor="middle" fill="#16a34a">3 hoeke</text><text x="265" y="150" font-weight="700" font-size="13" text-anchor="middle" fill="#0f1f3d">Driehoek</text><circle cx="370" cy="55" r="35" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="370" y="112" font-weight="700" font-size="12" text-anchor="middle" fill="#ea580c">1 geboë sy</text><text x="370" y="128" font-weight="700" font-size="12" text-anchor="middle" fill="#16a34a">0 hoeke</text><text x="370" y="150" font-weight="700" font-size="13" text-anchor="middle" fill="#0f1f3d">Sirkel</text></svg>',

      videoPlaceholder:
        'Kort video wat 2D-vorms bekendstel en wys hoe om sye en hoekpunte te identifiseer en algemene vorms soos vierkante, reghoeke, driehoeke en sirkels te beskryf',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      explanation:
        lookingAhead(
          ...
          'CAPS Graad 5 verwag dat leerders blootgestel word aan ʼn reeks verskillende driehoeke, maar hulle word nie verwag om tipes driehoeke (gelyksydig, gelykbenig, ongelyksydig) in Graad 5 te benoem nie — dit is Senior Fase (Graad 7+) inhoud, hier gewys vir leerders wat wil sien waarheen dit op pad is.'
        ) +
        ...
        `<div style="background:#eff6ff;border:1.5px solid #bfdbfe;border-radius:10px;padding:12px 14px;">` +
        `<p style="font-weight:700;color:#2563eb;margin-bottom:4px;">${bl('Ongelyksydige driehoek')}</p>` +
        ...
        `<p style="margin:0;color:#1e3a8a;">Tel die ${gr('gelyke sye')}. As al ${or('3 sye')} gelyk is → ${bl('gelyksydig')}. As ${gr('2 sye')} gelyk is → ${bl('gelykbenig')}. As ${re('geen sye')} gelyk is nie → ${bl('ongelyksydig')}.</p>` +
        `</div>`,
      ...
      diagramPlaceholder:
        'Diagram wat die drie soorte driehoeke wys — gelyksydig met 3 gelyke sye in groen, gelykbenig met 2 gelyke sye in groen en 1 ander sy in rooi, ongelyksydig met al die sye in rooi — elkeen geëtiketteer met sylengtes',
      diagramSvg:
        '<svg viewBox="0 0 460 200" xmlns="http://www.w3.org/2000/svg"><line x1="75" y1="78" x2="35" y2="148" stroke="#16a34a" stroke-width="2.5"/><line x1="35" y1="148" x2="115" y2="148" stroke="#16a34a" stroke-width="2.5"/><line x1="115" y1="148" x2="75" y2="78" stroke="#16a34a" stroke-width="2.5"/><text x="16" y="118" font-weight="700" font-size="11" fill="#16a34a">5cm</text><text x="118" y="118" font-weight="700" font-size="11" fill="#16a34a">5cm</text><text x="60" y="168" font-weight="700" font-size="11" fill="#16a34a">5cm</text><text x="75" y="188" font-weight="700" font-size="12" text-anchor="middle" fill="#0f1f3d">Gelyksydig</text><line x1="230" y1="78" x2="190" y2="148" stroke="#16a34a" stroke-width="2.5"/><line x1="190" y1="148" x2="270" y2="148" stroke="#dc2626" stroke-width="2.5"/><line x1="270" y1="148" x2="230" y2="78" stroke="#16a34a" stroke-width="2.5"/><text x="171" y="118" font-weight="700" font-size="11" fill="#16a34a">4cm</text><text x="273" y="118" font-weight="700" font-size="11" fill="#16a34a">4cm</text><text x="215" y="168" font-weight="700" font-size="11" fill="#dc2626">3cm</text><text x="230" y="188" font-weight="700" font-size="12" text-anchor="middle" fill="#0f1f3d">Gelykbenig</text><line x1="340" y1="68" x2="320" y2="148" stroke="#dc2626" stroke-width="2.5"/><line x1="320" y1="148" x2="420" y2="148" stroke="#dc2626" stroke-width="2.5"/><line x1="420" y1="148" x2="340" y2="68" stroke="#dc2626" stroke-width="2.5"/><text x="288" y="112" font-weight="700" font-size="11" fill="#dc2626">3cm</text><text x="378" y="100" font-weight="700" font-size="11" fill="#dc2626">5cm</text><text x="360" y="168" font-weight="700" font-size="11" fill="#dc2626">4cm</text><text x="370" y="188" font-weight="700" font-size="12" text-anchor="middle" fill="#0f1f3d">Skaleen</text></svg>',

      videoPlaceholder:
        'Kort video wat die drie soorte driehoeke verduidelik — gelyksydig, gelykbenig en ongelyksydig — en hoe om elkeen te identifiseer deur gelyke sye te tel',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        'Diagram wat vyf soorte vierhoeke wys — vierkant, reghoek, ruit, parallelogram en trapesium — met gelyke sye gemerk in groen en regte hoeke gemerk in oranje',
      diagramSvg:
        '<svg viewBox="0 0 460 260" xmlns="http://www.w3.org/2000/svg"><rect x="20" y="20" width="70" height="70" fill="none" stroke="#16a34a" stroke-width="2.5"/><path d="M 20 32 L 32 32 L 32 20" fill="none" stroke="#ea580c" stroke-width="1.8"/><path d="M 90 78 L 78 78 L 78 90" fill="none" stroke="#ea580c" stroke-width="1.8"/><text x="55" y="112" font-weight="700" font-size="13" text-anchor="middle" fill="#0f1f3d">Vierkant</text><rect x="130" y="30" width="100" height="50" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="176" y1="26" x2="184" y2="34" stroke="#16a34a" stroke-width="2"/><line x1="176" y1="76" x2="184" y2="84" stroke="#16a34a" stroke-width="2"/><line x1="126" y1="47" x2="134" y2="55" stroke="#16a34a" stroke-width="2"/><line x1="126" y1="55" x2="134" y2="63" stroke="#16a34a" stroke-width="2"/><line x1="226" y1="47" x2="234" y2="55" stroke="#16a34a" stroke-width="2"/><line x1="226" y1="55" x2="234" y2="63" stroke="#16a34a" stroke-width="2"/><path d="M 130 40 L 140 40 L 140 30" fill="none" stroke="#ea580c" stroke-width="1.8"/><path d="M 230 40 L 220 40 L 220 30" fill="none" stroke="#ea580c" stroke-width="1.8"/><text x="180" y="112" font-weight="700" font-size="13" text-anchor="middle" fill="#0f1f3d">Reghoek</text><polygon points="320,20 375,55 320,90 265,55" fill="none" stroke="#16a34a" stroke-width="2.5"/><text x="320" y="112" font-weight="700" font-size="13" text-anchor="middle" fill="#0f1f3d">Ruit</text><polygon points="85,150 185,150 160,220 60,220" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="128" y1="146" x2="136" y2="154" stroke="#16a34a" stroke-width="2"/><line x1="135" y1="146" x2="143" y2="154" stroke="#16a34a" stroke-width="2"/><line x1="103" y1="216" x2="111" y2="224" stroke="#16a34a" stroke-width="2"/><line x1="110" y1="216" x2="118" y2="224" stroke="#16a34a" stroke-width="2"/><line x1="70" y1="181" x2="78" y2="189" stroke="#16a34a" stroke-width="2"/><line x1="176" y1="181" x2="184" y2="189" stroke="#16a34a" stroke-width="2"/><text x="122" y="245" font-weight="700" font-size="13" text-anchor="middle" fill="#0f1f3d">Parallelogram</text><polygon points="310,150 370,150 400,220 280,220" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="340" y="245" font-weight="700" font-size="13" text-anchor="middle" fill="#0f1f3d">Trapesium</text></svg>',

      videoPlaceholder:
        'Kort video wat die vyf soorte vierhoeke verduidelik en hoe om elkeen te identifiseer deur gelyke sye en regte hoeke te kyk',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        'Diagram van ʼn sirkel met die middelpunt gemerk in oranje, die radius geëtiketteer in blou, die deursnee geëtiketteer in rooi en die omtrek geëtiketteer in groen',
      diagramSvg:
        '<svg viewBox="0 0 220 170" xmlns="http://www.w3.org/2000/svg"><circle cx="110" cy="85" r="65" fill="none" stroke="#16a34a" stroke-width="2.5"/><line x1="45" y1="85" x2="175" y2="85" stroke="#dc2626" stroke-width="2.5"/><line x1="110" y1="85" x2="110" y2="20" stroke="#2563eb" stroke-width="2.5"/><circle cx="110" cy="85" r="4" fill="#ea580c"/><text x="118" y="52" font-weight="700" font-size="12" fill="#2563eb">radius</text><text x="110" y="160" font-weight="700" font-size="12" text-anchor="middle" fill="#dc2626">deursnee</text><text x="122" y="80" font-weight="700" font-size="11" fill="#ea580c">middelpunt</text><text x="110" y="13" font-weight="700" font-size="11" text-anchor="middle" fill="#16a34a">omtrek</text></svg>',

      videoPlaceholder:
        'Kort video wat sirkels bekendstel en die middelpunt, radius, deursnee en omtrek verduidelik met voorbeelde van hoe om die deursnee vanaf die radius te bereken en andersom',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        'Diagram wat vyf 2D-vorms wys — driehoek, vierkant, reghoek, ruit en vyfhoek — gesorteer in groepe volgens die aantal sye, met regte hoeke gemerk in oranje en syaantalle in groen',
      diagramSvg:
        '<svg viewBox="0 0 460 200" xmlns="http://www.w3.org/2000/svg"><line x1="290" y1="15" x2="290" y2="175" stroke="#94a3b8" stroke-width="1.5" stroke-dasharray="5,4"/><text x="150" y="22" font-weight="700" font-size="13" text-anchor="middle" fill="#16a34a">4 sye</text><text x="375" y="22" font-weight="700" font-size="13" text-anchor="middle" fill="#64748b">Ander sy-tellings</text><rect x="30" y="40" width="55" height="55" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 30 52 L 42 52 L 42 40" fill="none" stroke="#ea580c" stroke-width="1.8"/><text x="57" y="112" font-weight="700" font-size="12" text-anchor="middle" fill="#16a34a">4</text><text x="57" y="128" font-weight="700" font-size="11" text-anchor="middle" fill="#0f1f3d">Vierkant</text><rect x="110" y="50" width="80" height="40" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 110 60 L 122 60 L 122 50" fill="none" stroke="#ea580c" stroke-width="1.8"/><text x="150" y="112" font-weight="700" font-size="12" text-anchor="middle" fill="#16a34a">4</text><text x="150" y="128" font-weight="700" font-size="11" text-anchor="middle" fill="#0f1f3d">Reghoek</text><polygon points="230,41 257,68 230,95 203,68" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="230" y="112" font-weight="700" font-size="12" text-anchor="middle" fill="#16a34a">4</text><text x="230" y="128" font-weight="700" font-size="11" text-anchor="middle" fill="#0f1f3d">Ruit</text><polygon points="320,95 360,95 340,40" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="340" y="112" font-weight="700" font-size="12" text-anchor="middle" fill="#16a34a">3</text><text x="340" y="128" font-weight="700" font-size="11" text-anchor="middle" fill="#0f1f3d">Driehoek</text><polygon points="420,41 445.68,59.65 435.88,89.84 404.12,89.84 394.32,59.65" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="420" y="112" font-weight="700" font-size="12" text-anchor="middle" fill="#16a34a">5</text><text x="420" y="128" font-weight="700" font-size="11" text-anchor="middle" fill="#0f1f3d">Vyfhoek</text></svg>',

      videoPlaceholder:
        'Kort video wat wys hoe om 2D-vorms volgens hul eienskappe te sorteer en te vergelyk — aantal sye, regte hoeke, gelyke sye en simmetrielyne',
    },
  ],
  topicPractice: [
    // ── V1 Maklik ──────────────────────────────────────────────────────────────
    ...
    // ── V5 Medium ────────────────────────────────────────────────────────────
    {
      ...
      answer: 'ongelyksydige driehoek',
      checkMode: 'auto',
      correctAnswer: 'ongelyksydige driehoek',
    },
  ...
  scoreMessages: [
    { minScore: 15, message: 'Uitstekend! ʼn Volpunt-telling — jy het 2D-vorms vir Graad 5 heeltemal bemeester. Hou so aan!' },
    { minScore: 11, message: 'Uitstekende werk! Jy het ʼn baie sterk begrip van 2D-vorms. Gaan enige gemiste dele weer deur en jy sal dit perfek hê.' },
    ...
    { minScore: 4, message: 'Goeie poging! Werk weer deur die studiegids en uitgewerkte voorbeelde vir elke afdeling, en probeer dan weer.' },
  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy-Medium', question: 'ʼn Driehoek het sye van 7 cm, 4 cm en 5 cm. Watter tipe driehoek is dit?', answer: 'ongelyksydige driehoek', checkMode: 'auto', correctAnswer: 'ongelyksydigedriehoek', correctAnswers: ['ongelyksydigedriehoek', 'ongelyksydig'], explanation: 'Al drie sylengtes verskil (7 cm, 4 cm, 5 cm), dus is geen sye gelyk nie. Dit maak dit ʼn ongelyksydige driehoek.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy-Medium', question: 'ʼn Driehoek het sye van 8 cm, 3 cm en 6 cm. Watter tipe driehoek is dit?', answer: 'ongelyksydige driehoek', checkMode: 'auto', correctAnswer: 'ongelyksydigedriehoek', correctAnswers: ['ongelyksydigedriehoek', 'ongelyksydig'], explanation: 'Al drie sylengtes verskil (8 cm, 3 cm, 6 cm), dus is geen twee sye gelyk nie. Dit maak dit ʼn ongelyksydige driehoek.' },
        ...
        { difficulty: 'Medium', question: 'Sipho sê ʼn ongelyksydige driehoek kan nooit ʼn regte hoek hê nie. Is hy korrek? Verduidelik.', answer: 'Nee — ʼn ongelyksydige driehoek kan ʼn regte hoek hê. Skaleen beskryf slegs die sye (almal verskillende lengtes); dit sê niks oor die hoeke nie.', checkMode: 'self', explanation: 'Skaleen verwys slegs na sylengtes — geen twee sye is gelyk nie. ʼn Driehoek met sye van, sê, 3 cm, 4 cm en 5 cm is ongelyksydig en het ook ʼn regte hoek. Sipho is dus verkeerd; ongelyksydig en ʼn regte hoek hê, is onverwante eienskappe.' },
        ...
        { difficulty: 'Hard', question: 'Sorteer hierdie vorms in dié met ten minste een regte hoek en dié sonder regte hoeke: vierkant, ruit, reghoek, gelyksydige driehoek, trapesium.', answer: 'Ten minste een regte hoek: vierkant, reghoek, regshoekige trapesium. Geen regte hoeke: ruit, gelyksydige driehoek', checkMode: 'auto', correctAnswer: 'vierkantreghoektrapesium', correctAnswers: ['vierkantreghoektrapesium', 'vierkant, reghoek, trapesium', 'vierkantreghoektrapesium/ruitgelyksydigedriehoek'], explanation: 'Vierkant — 4 regte hoeke. Ruit — geen regte hoeke nie (sy hoeke is nie 90° nie). Reghoek — 4 regte hoeke. Gelyksydige driehoek — geen regte hoeke nie, al die hoeke is 60°. Regshoekige trapesium — het regte hoeke per definisie. Dus die vorms met ten minste een regte hoek is vierkant, reghoek en die regshoekige trapesium.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy-Medium', question: 'ʼn Driehoek het sye van 11 cm, 6 cm en 9 cm. Watter tipe driehoek is dit?', answer: 'ongelyksydige driehoek', checkMode: 'auto', correctAnswer: 'ongelyksydigedriehoek', correctAnswers: ['ongelyksydigedriehoek', 'ongelyksydig'], explanation: 'Al drie sylengtes verskil (11 cm, 6 cm, 9 cm), dus is dit ʼn ongelyksydige driehoek.' },
        ...
        { difficulty: 'Hard', question: 'Sorteer hierdie vorms volgens BEIDE aantal sye ÉN of hulle gelyke sye het: gelyksydige driehoek, ongelyksydige driehoek, vierkant, reghoek. Lys die vorm(s) met 3 gelyke sye, dan die vorm(s) met 4 gelyke sye.', answer: '3 gelyke sye: gelyksydige driehoek. 4 gelyke sye: vierkant', checkMode: 'auto', correctAnswer: 'gelyksydigedriehoekvierkant', correctAnswers: ['gelyksydigedriehoekvierkant', 'gelyksydige driehoek, vierkant', 'gelyksydigedriehoek/vierkant'], explanation: 'Gelyksydige driehoek — 3 sye, almal gelyk. Ongelyksydige driehoek — 3 sye, geen gelyk nie. Vierkant — 4 sye, almal gelyk. Reghoek — 4 sye, slegs oorstaande sye gelyk. Die enigste vorm met 3 gelyke sye is die gelyksydige driehoek; die enigste vorm met 4 gelyke sye is die vierkant.' },
