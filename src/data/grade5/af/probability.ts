...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Kort video wat waarskynlikheid verduidelik met alledaagse voorbeelde en wys hoe om gebeurtenisse op die waarskynlikheidskaal van 0 tot 1 te plaas',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Kort video wat wys hoe om waarskynlikheid as ʼn breuk te skryf met sakke gekleurde balle en ʼn dobbelsteen, met stap-vir-stap werk',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      icon: '📋',
      explanation:
        `<p style="margin-bottom:16px;">ʼn ${li('Uitkoms')} is ʼn moontlike resultaat van ʼn eksperiment. Om alle moontlike ${li('uitkomste')} te lys help ons om ${im('waarskynlikheid')} korrek te bereken. Wanneer ons ʼn muntstuk opgooi is daar ${un('2')} moontlike ${li('uitkomste')} — kruis of munt. Wanneer ons ʼn dobbelsteen gooi is daar ${un('6')} moontlike ${li('uitkomste')} — 1, 2, 3, 4, 5 of 6. Lys altyd alle moontlike ${li('uitkomste')} voordat jy ${im('waarskynlikheid')} bereken sodat jy nie een mis nie.</p>` +
        ...
        `<p style="color:#374151;font-size:14px;margin:0;">Een moontlike resultaat van ʼn eksperiment. Wanneer ʼn muntstuk opgegooi word is die ${li('uitkomste')} <strong>kruis</strong> of <strong>munt</strong>.</p>` +
        `</div>` +

        `<div style="background:#f0fdf4;border:1.5px solid #bbf7d0;border-radius:10px;padding:12px 14px;">` +
        `<p style="font-weight:700;color:#16a34a;margin-bottom:4px;">Gunstige uitkoms</p>` +
        `<p style="color:#374151;font-size:14px;margin:0;">ʼn ${li('Uitkoms')} wat ooreenstem met wat jy soek. As jy kruis wil hê, dan is ${ce('kruis')} ʼn ${ce('gunstige uitkoms')}.</p>` +
        `</div>` +
      ...
      workedExamples: [
        {
          ...
          answer: `Daar is ${un('12')} moontlike ${li('uitkomste')}: ${li('Kruis-1, Kruis-2, Kruis-3, Kruis-4, Kruis-5, Kruis-6, Munt-1, Munt-2, Munt-3, Munt-4, Munt-5, Munt-6')}`,
          steps: [
            `Die muntstuk kan op kruis of munt val — ${un('2')} ${li('opsies')}.`,
            `Die dobbelsteen kan 1, 2, 3, 4, 5 of 6 wys — ${un('6')} ${li('opsies')}.`,
            `${un('Totale uitkomste')} = 2 × 6 = ${un('12')}.`,
            `Lys hulle: ${li('Kruis-1, Kruis-2, Kruis-3, Kruis-4, Kruis-5, Kruis-6, Munt-1, Munt-2, Munt-3, Munt-4, Munt-5, Munt-6')}.`,
          ],
        },
        {
          question: 'ʼn Draaibord het 4 gelyke afdelings gekleur rooi, blou, groen en geel. Lerato draai dit een keer. Wat is die waarskynlikheid om op blou of groen te land?',
      ...
      openQuestions: [
        ...
        {
          difficulty: 'Medium',
          question: 'ʼn Draaibord het 5 gelyke afdelings — 2 rooi, 1 blou, 1 groen en 1 geel. Wat is die waarskynlikheid om op rooi of blou te land?',
          answer: '3/5',
          checkMode: 'auto',
          correctAnswer: '3/5',
        ...
        {
          difficulty: 'Hard',
          question: 'Lerato gooi ʼn muntstuk op en draai ʼn draaibord met 3 gelyke afdelings genommer 1, 2 en 3. Hoeveel moontlike uitkomste is daar altesaam?',
          answer: '6',
          checkMode: 'auto',
          correctAnswer: '6',
          explanation: 'Die muntstuk het 2 uitkomste (kruis, munt). Die draaibord het 3 uitkomste (1, 2, 3).\nTotale uitkomste = 2 × 3 = 6.',
        },
      ],

      diagramPlaceholder:
        'Roosterdiagram wat al 12 uitkomste wys wanneer ʼn muntstuk opgegooi en ʼn dobbelsteen gegooi word — kruis-ry en munt-ry elk met 6 dobbelsteenuitkomste, alle uitkomste in blou uitgelig',
      diagramSvg:
        '<svg viewBox="0 0 340 100" xmlns="http://www.w3.org/2000/svg"><text x="15" y="35" font-size="12" font-weight="700" fill="#0f1f3d" text-anchor="start">Kruis</text><text x="15" y="70" font-size="12" font-weight="700" fill="#0f1f3d" text-anchor="start">Munt</text><rect x="70" y="15" width="36" height="30" rx="4" fill="#dbeafe" stroke="#2563eb" stroke-width="1.8"/><text x="88" y="34" font-size="13" font-weight="700" fill="#1e40af" text-anchor="middle">1</text><rect x="114" y="15" width="36" height="30" rx="4" fill="#dbeafe" stroke="#2563eb" stroke-width="1.8"/><text x="132" y="34" font-size="13" font-weight="700" fill="#1e40af" text-anchor="middle">2</text><rect x="158" y="15" width="36" height="30" rx="4" fill="#dbeafe" stroke="#2563eb" stroke-width="1.8"/><text x="176" y="34" font-size="13" font-weight="700" fill="#1e40af" text-anchor="middle">3</text><rect x="202" y="15" width="36" height="30" rx="4" fill="#dbeafe" stroke="#2563eb" stroke-width="1.8"/><text x="220" y="34" font-size="13" font-weight="700" fill="#1e40af" text-anchor="middle">4</text><rect x="246" y="15" width="36" height="30" rx="4" fill="#dbeafe" stroke="#2563eb" stroke-width="1.8"/><text x="264" y="34" font-size="13" font-weight="700" fill="#1e40af" text-anchor="middle">5</text><rect x="290" y="15" width="36" height="30" rx="4" fill="#dbeafe" stroke="#2563eb" stroke-width="1.8"/><text x="308" y="34" font-size="13" font-weight="700" fill="#1e40af" text-anchor="middle">6</text><rect x="70" y="50" width="36" height="30" rx="4" fill="#dbeafe" stroke="#2563eb" stroke-width="1.8"/><text x="88" y="69" font-size="13" font-weight="700" fill="#1e40af" text-anchor="middle">1</text><rect x="114" y="50" width="36" height="30" rx="4" fill="#dbeafe" stroke="#2563eb" stroke-width="1.8"/><text x="132" y="69" font-size="13" font-weight="700" fill="#1e40af" text-anchor="middle">2</text><rect x="158" y="50" width="36" height="30" rx="4" fill="#dbeafe" stroke="#2563eb" stroke-width="1.8"/><text x="176" y="69" font-size="13" font-weight="700" fill="#1e40af" text-anchor="middle">3</text><rect x="202" y="50" width="36" height="30" rx="4" fill="#dbeafe" stroke="#2563eb" stroke-width="1.8"/><text x="220" y="69" font-size="13" font-weight="700" fill="#1e40af" text-anchor="middle">4</text><rect x="246" y="50" width="36" height="30" rx="4" fill="#dbeafe" stroke="#2563eb" stroke-width="1.8"/><text x="264" y="69" font-size="13" font-weight="700" fill="#1e40af" text-anchor="middle">5</text><rect x="290" y="50" width="36" height="30" rx="4" fill="#dbeafe" stroke="#2563eb" stroke-width="1.8"/><text x="308" y="69" font-size="13" font-weight="700" fill="#1e40af" text-anchor="middle">6</text><text x="170" y="95" font-size="10" fill="#64748b" text-anchor="middle">12 totale uitkomste (2 × 6)</text></svg>',

      videoPlaceholder:
        'Kort video wat wys hoe om alle moontlike uitkomste vir ʼn muntstuk-en-dobbelsteen-eksperiment te lys met ʼn tabel en hoe om die lys te gebruik om waarskynlikheid te bereken',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      workedExamples: [
        {
          question: 'Sipho gooi ʼn muntstuk 10 keer op en kry 7 keer kruis en 3 keer munt. Wat is die eksperimentele waarskynlikheid om kruis te kry? Hoe vergelyk dit met die teoretiese waarskynlikheid?',
          answer: `${un('Eksperimentele waarskynlikheid')} van kruis = ${un('7/10')} — hoër as die ${li('teoretiese waarskynlikheid')} van ${li('1/2')} weens die klein ${ce('aantal proewe')}`,
          steps: [
            `${un('Eksperimentele waarskynlikheid')} van kruis = aantal kruise ÷ ${ce('totale aantal opgooie')} = ${un('7')} ÷ ${ce('10')} = ${un('7/10')}.`,
            `${li('Teoretiese waarskynlikheid')} van kruis = ${li('1')} ÷ ${li('2')} = ${li('1/2')} = ${li('5/10')}.`,
      ...
      openQuestions: [
        ...
        {
          difficulty: 'Easy',
          question: 'Thabo gooi ʼn muntstuk 20 keer op en kry 9 keer kruis. Wat is die eksperimentele waarskynlikheid om kruis te kry?',
          answer: '9/20',
          checkMode: 'auto',
          correctAnswer: '9/20',
          explanation: 'Eksperimentele waarskynlikheid = aantal kruise ÷ totale opgooie = 9 ÷ 20 = 9/20.',
        },
      ...
      diagramSvg:
        '<svg viewBox="0 0 230 160" xmlns="http://www.w3.org/2000/svg"><line x1="30" y1="20" x2="30" y2="130" stroke="#0f1f3d" stroke-width="2"/><line x1="30" y1="130" x2="200" y2="130" stroke="#0f1f3d" stroke-width="2"/><text x="24" y="24" font-size="9" fill="#64748b" text-anchor="end">1</text><text x="24" y="133" font-size="9" fill="#64748b" text-anchor="end">0</text><line x1="30" y1="75" x2="200" y2="75" stroke="#2563eb" stroke-width="2" stroke-dasharray="5,4"/><text x="204" y="78" font-size="9" font-weight="700" fill="#2563eb" text-anchor="start">0,5</text><rect x="55" y="53" width="40" height="77" fill="#ea580c"/><text x="75" y="47" font-size="11" font-weight="700" fill="#ea580c" text-anchor="middle">0,7</text><text x="75" y="145" font-size="10" font-weight="700" fill="#0f1f3d" text-anchor="middle">10 proewe</text><rect x="135" y="72" width="40" height="58" fill="#ea580c"/><text x="155" y="66" font-size="11" font-weight="700" fill="#ea580c" text-anchor="middle">0,53</text><text x="155" y="145" font-size="10" font-weight="700" fill="#0f1f3d" text-anchor="middle">30 proewe</text><text x="115" y="158" font-size="9" fill="#64748b" text-anchor="middle">Eksperimentele waarskynlikheid van kruis</text></svg>',

      videoPlaceholder:
        'Kort video wat ʼn waarskynlikheidseksperiment met ʼn muntstuk en dobbelsteen wys, eksperimentele resultate met teoretiese waarskynlikheid vergelyk en verduidelik waarom meer proewe resultate nader aan die teoretiese waarde gee',
    },
  ],
  resultsConfig: {
    totalMarks: 12,
  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      name: 'Stel 1',
      questions: [
        { difficulty: 'Easy', question: 'Sipho vra sy juffrou of dit môre by die skool in Johannesburg gaan sneeu in die somer. Watter enkele woord beskryf die waarskynlikheid dat dit gebeur?', answer: 'onwaarskynlik', checkMode: 'auto', correctAnswer: 'onwaarskynlik', correctAnswers: ['onwaarskynlik'], explanation: 'Sneeu in Johannesburg in die somer gebeur eintlik nooit nie, maar dit is nie fisies onmoontlik nie, dus is hierdie seldsame gebeurtenis onwaarskynlik eerder as onmoontlik — waarskynlikheid naby 0.' },
        ...
        { difficulty: 'Easy', question: 'ʼn Muntstuk word een keer opgegooi. Watter woord beskryf die kans dat dit op kruis val die beste — onmoontlik, onwaarskynlik, ewe waarskynlik, waarskynlik, of seker?', answer: 'ewe waarskynlik', checkMode: 'auto', correctAnswer: 'ewewaarskynlik', correctAnswers: ['ewewaarskynlik', 'ewe waarskynlik'], explanation: 'ʼn Regverdige muntstuk het dieselfde kans om op kruis te val as op munt, dus is dit ewe waarskynlik — waarskynlikheid 1/2.' },
        ...
        { difficulty: 'Easy-Medium', question: 'Zanele draai ʼn draaibord met 6 gelyke afdelings genommer 1 tot 6. Skryf, as ʼn breuk, haar kans dat dit op ʼn getal groter as 4 land.', answer: '1/3', checkMode: 'auto', correctAnswer: '1/3', correctAnswers: ['1/3', '2/6'], explanation: 'Getalle groter as 4 op die draaibord is 5 en 6 — dit is 2 gunstige uitkomste. Totale uitkomste = 6. Waarskynlikheid = 2/6 = 1/3.' },
        ...
        { difficulty: 'Medium', question: 'Thabo gooi ʼn muntstuk op en gooi terselfdertyd ʼn 6-sydige dobbelsteen. Lys alle moontlike uitkomste, en sê dan hoeveel daar altesaam is.', answer: 'Kruis-1, Kruis-2, Kruis-3, Kruis-4, Kruis-5, Kruis-6, Munt-1, Munt-2, Munt-3, Munt-4, Munt-5, Munt-6 — 12 uitkomste altesaam', checkMode: 'auto', correctAnswer: '12', correctAnswers: ['12'], explanation: 'Die muntstuk het 2 uitkomste (kruis, munt) en die dobbelsteen het 6 uitkomste (1-6). Met die tel-beginsel: totale uitkomste = 2 × 6 = 12.' },
        { difficulty: 'Medium', question: 'ʼn Draaibord is in 4 gelyke afdelings verdeel, gekleur rooi, blou, groen en geel, en word terselfdertyd gedraai as ʼn muntstuk opgegooi word. Hoeveel moontlike uitkomste is daar altesaam?', answer: '8', checkMode: 'auto', correctAnswer: '8', correctAnswers: ['8'], explanation: 'Die draaibord het 4 uitkomste en die muntstuk het 2 uitkomste. Totale uitkomste = 4 × 2 = 8.' },
        { difficulty: 'Medium', question: 'ʼn Draaibord het 8 gelyke afdelings genommer 1 tot 8. Zanele wil die waarskynlikheid weet om op ʼn veelvoud van 3 te land. Lys eers die gunstige uitkomste, en gee dan die waarskynlikheid.', answer: 'Gunstige uitkomste is 3 en 6, dus waarskynlikheid = 2/8 = 1/4', checkMode: 'auto', correctAnswer: '1/4', correctAnswers: ['1/4', '2/8'], explanation: 'As jy noukeurig lys, is die veelvoude van 3 van 1 tot 8 slegs 3 en 6 — dit is 2 gunstige uitkomste (9 is nie op die draaibord nie). Totale uitkomste = 8. Waarskynlikheid = 2/8 = 1/4. ʼn Algemene fout is om te vergeet watter veelvoude werklik binne die 1-8 reeks val.' },
        { difficulty: 'Medium', question: 'ʼn Sak het 3 groen fiches en 3 wit fiches. Lys elke moontlike uitkoms wanneer jy een fiche kies, beskryf volgens kleur, en sê hoeveel duidelike kleur-uitkomste daar is.', answer: 'Die duidelike kleur-uitkomste is groen en wit, dus is daar 2 duidelike uitkomste, al is daar 6 individuele fiches', checkMode: 'self' },
        ...
        { difficulty: 'Medium', question: 'Vergelyk hierdie twee draaibords: Draaibord X het 4 gelyke afdelings met 1 rooi gekleur. Draaibord Y het 8 gelyke afdelings met 3 rooi gekleur. Watter draaibord gee ʼn beter kans om op rooi te land? Verduidelik jou redenasie met breuke.', answer: 'Draaibord Y gee ʼn beter kans. Draaibord X: waarskynlikheid van rooi = 1/4 = 2/8. Draaibord Y: waarskynlikheid van rooi = 3/8. Aangesien 3/8 groter is as 2/8, het Draaibord Y die beter kans om op rooi te land.', checkMode: 'self' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'ʼn Draaibord het 2 gelyke afdelings, een swart en een wit. Watter woord beskryf die kans dat die draaibord op swart land die beste?', answer: 'ewe waarskynlik', checkMode: 'auto', correctAnswer: 'ewewaarskynlik', correctAnswers: ['ewewaarskynlik', 'ewe waarskynlik'], explanation: 'Met 2 gelyke afdelings het swart en wit elk dieselfde kans om geland te word — dit is ewe waarskynlik, waarskynlikheid 1/2.' },
        ...
        { difficulty: 'Easy-Medium', question: 'ʼn Draaibord het 6 gelyke afdelings: 2 is pienk en 4 is grys. Wat is die waarskynlikheid dat die draaibord op pienk land?', answer: '1/3', checkMode: 'auto', correctAnswer: '1/3', correctAnswers: ['1/3', '2/6'], explanation: 'Gunstige uitkomste = 2 pienk afdelings. Totale uitkomste = 6 afdelings. Waarskynlikheid = 2/6 = 1/3.' },
        ...
        { difficulty: 'Medium', question: 'ʼn Draaibord genommer 1, 2, 3 word gedraai terwyl ʼn muntstuk terselfdertyd opgegooi word. Lys elke moontlike uitkoms, en sê dan hoeveel daar altesaam is.', answer: '1-Kruis, 2-Kruis, 3-Kruis, 1-Munt, 2-Munt, 3-Munt — 6 uitkomste altesaam', checkMode: 'auto', correctAnswer: '6', correctAnswers: ['6'], explanation: 'Die draaibord het 3 uitkomste en die muntstuk het 2 uitkomste. Met die tel-beginsel: totale uitkomste = 3 × 2 = 6.' },
        ...
        { difficulty: 'Medium', question: 'ʼn Draaibord het 10 gelyke afdelings genommer 1 tot 10. Vind die waarskynlikheid om op ʼn veelvoud van 4 te land deur eers die gunstige uitkomste te lys.', answer: 'Gunstige uitkomste is 4 en 8, dus waarskynlikheid = 2/10 = 1/5', checkMode: 'auto', correctAnswer: '1/5', correctAnswers: ['1/5', '2/10'], explanation: 'As jy noukeurig lys, is die veelvoude van 4 van 1 tot 10 gelyk aan 4 en 8 — dit is 2 gunstige uitkomste (12 is nie op die draaibord nie). Totale uitkomste = 10. Waarskynlikheid = 2/10 = 1/5. Dit is maklik om per ongeluk ʼn veelvoud soos 12 in te sluit wat buite die draaibord se reeks is, dus voorkom eers lys hierdie fout.' },
        ...
        { difficulty: 'Medium', question: 'Twee draaibords word vergelyk: Draaibord P het 6 gelyke afdelings met 2 oranje gekleur. Draaibord Q het 9 gelyke afdelings met 4 oranje gekleur. Watter draaibord gee ʼn beter kans om op oranje te land? Wys jou werk met breuke.', answer: 'Draaibord Q gee ʼn beter kans. Draaibord P: waarskynlikheid van oranje = 2/6 = 1/3. Draaibord Q: waarskynlikheid van oranje = 4/9. As gelykwaardige breuke met noemer 18 vergelyk: 1/3 = 6/18 en 4/9 = 8/18. Aangesien 8/18 > 6/18, gee Draaibord Q die beter kans om op oranje te land.', checkMode: 'self' },
        ...
        { difficulty: 'Hard', question: 'Lerato draai ʼn 4-kleur-draaibord (rooi, blou, groen, geel, almal gelyke afdelings) 40 keer en land 15 keer op rooi. Vind die eksperimentele waarskynlikheid van rooi en die teoretiese waarskynlikheid van rooi, en sê of hulle naby aan mekaar is.', answer: 'Eksperimentele waarskynlikheid = 15/40 = 3/8. Teoretiese waarskynlikheid = 1/4 (10/40). Hierdie is taamlik verskillend — 3/8 is aansienlik hoër as 1/4 — wat kan gebeur met slegs 40 draaie. Meer draaie sou die eksperimentele resultaat waarskynlik nader aan 1/4 bring.', checkMode: 'self' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      name: 'Stel 3',
      questions: [
        { difficulty: 'Easy', question: 'ʼn Draaibord het 5 gelyke afdelings, almal blou gekleur. Watter woord beskryf die waarskynlikheid om op rooi te land?', answer: 'onmoontlik', checkMode: 'auto', correctAnswer: 'onmoontlik', correctAnswers: ['onmoontlik'], explanation: 'Daar is geen rooi afdeling op die draaibord nie, dus kan om op rooi te land nooit gebeur nie — dit is onmoontlik, waarskynlikheid 0.' },
        ...
        { difficulty: 'Easy-Medium', question: 'Musa draai ʼn draaibord met 9 gelyke afdelings genommer 1 tot 9. Gee, as ʼn breuk, die kans dat dit op ʼn getal groter as 6 land.', answer: '1/3', checkMode: 'auto', correctAnswer: '1/3', correctAnswers: ['1/3', '3/9'], explanation: 'Getalle groter as 6 op die draaibord is 7, 8 en 9 — dit is 3 gunstige uitkomste. Totale uitkomste = 9. Waarskynlikheid = 3/9 = 1/3.' },
        ...
        { difficulty: 'Medium', question: 'ʼn Muntstuk word twee keer agtermekaar opgegooi. Lys alle moontlike uitkomste vir die twee opgooie, en sê dan hoeveel daar is.', answer: 'Kruis-Kruis, Kruis-Munt, Munt-Kruis, Munt-Munt — 4 uitkomste altesaam', checkMode: 'auto', correctAnswer: '4', correctAnswers: ['4'], explanation: 'Die eerste opgooi het 2 uitkomste en die tweede opgooi het 2 uitkomste. Met die tel-beginsel: totale uitkomste = 2 × 2 = 4.' },
        { difficulty: 'Medium', question: 'ʼn Muntstuk word opgegooi en ʼn draaibord met 3 gelyke afdelings (gemerk A, B, C) word terselfdertyd gedraai. Hoeveel moontlike uitkomspare is daar altesaam?', answer: '6', checkMode: 'auto', correctAnswer: '6', correctAnswers: ['6'], explanation: 'Die muntstuk het 2 uitkomste en die draaibord het 3 uitkomste. Met die tel-beginsel: totale uitkomste = 2 × 3 = 6.' },
        { difficulty: 'Medium', question: 'ʼn Draaibord het 12 gelyke afdelings genommer 1 tot 12. Vind die waarskynlikheid om op ʼn veelvoud van 5 te land deur eers die gunstige uitkomste te lys.', answer: 'Gunstige uitkomste is 5 en 10, dus waarskynlikheid = 2/12 = 1/6', checkMode: 'auto', correctAnswer: '1/6', correctAnswers: ['1/6', '2/12'], explanation: 'As jy noukeurig lys, is die veelvoude van 5 van 1 tot 12 gelyk aan 5 en 10 — dit is 2 gunstige uitkomste (15 is nie op die draaibord nie). Totale uitkomste = 12. Waarskynlikheid = 2/12 = 1/6. Deur eers te lys voorkom jy om per ongeluk 15 te tel, wat buite die draaibord se reeks is.' },
        ...
        { difficulty: 'Medium', question: 'Twee draaibords word vergelyk vir die kans om op groen te land: Draaibord M het 5 gelyke afdelings met 1 groen gekleur. Draaibord N het 10 gelyke afdelings met 3 groen gekleur. Watter draaibord gee ʼn beter kans? Verduidelik jou redenasie met breuke.', answer: 'Draaibord N gee ʼn beter kans. Draaibord M: waarskynlikheid van groen = 1/5 = 2/10. Draaibord N: waarskynlikheid van groen = 3/10. Aangesien 3/10 groter is as 2/10, het Draaibord N die beter kans om op groen te land.', checkMode: 'self' },
        { difficulty: 'Medium', question: 'ʼn Sportkommentator sê ʼn span het "baie min kans" om te wen, terwyl die ander span "amper seker gaan wen". Verduidelik wat hierdie frases ons vertel oor die waarskynlikheid dat elke span wen, en ongeveer waar elkeen op die 0 tot 1 skaal sal sit.', answer: '"Baie min kans" beteken om te wen is onwaarskynlik vir daardie span, dus is die waarskynlikheid naby aan 0 (miskien ongeveer 0,05 tot 0,15). "Amper seker gaan wen" beteken die ander span sal baie waarskynlik wen, dus is die waarskynlikheid naby aan 1 (miskien ongeveer 0,85 tot 0,95). Saam behoort die twee waarskynlikhede naby aan 1 op te tel, aangesien een span (of ʼn gelykruis-uitslag) moet gebeur.', checkMode: 'self' },
