...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      icon: '📋',
      explanation:
        `<p style="margin-bottom:16px;">ʼn ${li('Uitkoms')} is ʼn moontlike resultaat van ʼn eksperiment. Om alle moontlike ${li('uitkomste')} te lys help ons om ${im('waarskynlikheid')} korrek te bereken. Wanneer ons ʼn stertstuk opgooi is daar ${un('2')} moontlike ${li('uitkomste')} — kop of stert. Wanneer ons ʼn dobbelsteen gooi is daar ${un('6')} moontlike ${li('uitkomste')} — 1, 2, 3, 4, 5 of 6. Lys altyd alle moontlike ${li('uitkomste')} voordat jy ${im('waarskynlikheid')} bereken sodat jy nie een mis nie.</p>` +
        ...
        `<p style="color:#374151;font-size:14px;margin:0;">Een moontlike resultaat van ʼn eksperiment. Wanneer ʼn stertstuk opgegooi word is die ${li('uitkomste')} <strong>kop</strong> of <strong>stert</strong>.</p>` +
        `</div>` +
        ...
        `<p style="color:#374151;font-size:14px;margin:0;">Die telling van <strong>alle</strong> moontlike gelyste ${li('uitkomste')}. Vir ʼn dobbelsteen is die ${un('totaal')} ${un('6')}. Vir ʼn stertstuk is die ${un('totaal')} ${un('2')}.</p>` +
        `</div>` +
      ...
      workedExamples: [
        {
          question: 'Thabo gooi ʼn stertstuk op en gooi terselfdertyd ʼn dobbelsteen. Lys alle moontlike uitkomste.',
          ...
          steps: [
            `Die stertstuk kan op kop of stert val — ${un('2')} ${li('opsies')}.`,
      ...
      openQuestions: [
        ...
        {
          difficulty: 'Hard',
          question: 'Lerato gooi ʼn stertstuk op en draai ʼn draaibord met 3 gelyke afdelings genommer 1, 2 en 3. Hoeveel moontlike uitkomste is daar altesaam?',
          answer: '6',
          checkMode: 'auto',
          correctAnswer: '6',
          explanation: 'Die stertstuk het 2 uitkomste (kop, stert). Die draaibord het 3 uitkomste (1, 2, 3).\nTotale uitkomste = 2 × 3 = 6.',
        },
      ],

      diagramPlaceholder:
        'Roosterdiagram wat al 12 uitkomste wys wanneer ʼn stertstuk opgegooi en ʼn dobbelsteen gegooi word — kop-ry en stert-ry elk met 6 dobbelsteenuitkomste, alle uitkomste in blou uitgelig',
      diagramSvg:
      ...
      videoPlaceholder:
        'Kort video wat wys hoe om alle moontlike uitkomste vir ʼn stertstuk-en-dobbelsteen-eksperiment te lys met ʼn tabel en hoe om die lys te gebruik om waarskynlikheid te bereken',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      workedExamples: [
        {
          question: 'Sipho gooi ʼn stertstuk 10 keer op en kry 7 keer kop en 3 keer stert. Wat is die eksperimentele waarskynlikheid om kop te kry? Hoe vergelyk dit met die teoretiese waarskynlikheid?',
          ...
          steps: [
            `${un('Eksperimentele waarskynlikheid')} van kop = aantal kope ÷ ${ce('totale aantal opgooie')} = ${un('7')} ÷ ${ce('10')} = ${un('7/10')}.`,
      ...
      openQuestions: [
        ...
        {
          difficulty: 'Easy',
          question: 'Thabo gooi ʼn stertstuk 20 keer op en kry 9 keer kop. Wat is die eksperimentele waarskynlikheid om kop te kry?',
          answer: '9/20',
          checkMode: 'auto',
          correctAnswer: '9/20',
          explanation: 'Eksperimentele waarskynlikheid = aantal kope ÷ totale opgooie = 9 ÷ 20 = 9/20.',
        },
      ...
      videoPlaceholder:
        'Kort video wat ʼn waarskynlikheidseksperiment met ʼn stertstuk en dobbelsteen wys, eksperimentele resultate met teoretiese waarskynlikheid vergelyk en verduidelik waarom meer proewe resultate nader aan die teoretiese waarde gee',
    },
  ],
  resultsConfig: {
    totalMarks: 12,
  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'ʼn Stertstuk word een keer opgegooi. Watter woord beskryf die kans dat dit op kop val die beste — onmoontlik, onwaarskynlik, ewe waarskynlik, waarskynlik, of seker?', answer: 'ewe waarskynlik', checkMode: 'auto', correctAnswer: 'ewewaarskynlik', correctAnswers: ['ewewaarskynlik', 'ewe waarskynlik'], explanation: 'ʼn Regverdige stertstuk het dieselfde kans om op kop te val as op stert, dus is dit ewe waarskynlik — waarskynlikheid 1/2.' },
        ...
        { difficulty: 'Medium', question: 'Thabo gooi ʼn stertstuk op en gooi terselfdertyd ʼn 6-sydige dobbelsteen. Lys alle moontlike uitkomste, en sê dan hoeveel daar altesaam is.', answer: 'Kop-1, Kop-2, Kop-3, Kop-4, Kop-5, Kop-6, Stert-1, Stert-2, Stert-3, Stert-4, Stert-5, Stert-6 — 12 uitkomste altesaam', checkMode: 'auto', correctAnswer: '12', correctAnswers: ['12'], explanation: 'Die stertstuk het 2 uitkomste (kop, stert) en die dobbelsteen het 6 uitkomste (1-6). Met die tel-beginsel: totale uitkomste = 2 × 6 = 12.' },
        { difficulty: 'Medium', question: 'ʼn Draaibord is in 4 gelyke afdelings verdeel, gekleur rooi, blou, groen en geel, en word terselfdertyd gedraai as ʼn stertstuk opgegooi word. Hoeveel moontlike uitkomste is daar altesaam?', answer: '8', checkMode: 'auto', correctAnswer: '8', correctAnswers: ['8'], explanation: 'Die draaibord het 4 uitkomste en die stertstuk het 2 uitkomste. Totale uitkomste = 4 × 2 = 8.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'ʼn Stertstuk word twee keer agtermekaar opgegooi. Lys alle moontlike uitkomste vir die twee opgooie, en sê dan hoeveel daar is.', answer: 'Kop-Kop, Kop-Stert, Stert-Kop, Stert-Stert — 4 uitkomste altesaam', checkMode: 'auto', correctAnswer: '4', correctAnswers: ['4'], explanation: 'Die eerste opgooi het 2 uitkomste en die tweede opgooi het 2 uitkomste. Met die tel-beginsel: totale uitkomste = 2 × 2 = 4.' },
        { difficulty: 'Medium', question: 'ʼn Stertstuk word opgegooi en ʼn draaibord met 3 gelyke afdelings (gemerk A, B, C) word terselfdertyd gedraai. Hoeveel moontlike uitkomspare is daar altesaam?', answer: '6', checkMode: 'auto', correctAnswer: '6', correctAnswers: ['6'], explanation: 'Die stertstuk het 2 uitkomste en die draaibord het 3 uitkomste. Met die tel-beginsel: totale uitkomste = 2 × 3 = 6.' },
