...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      explanation:
        ...
        `<span style="background:#eff6ff;border:1px solid #bfdbfe;border-radius:6px;padding:3px 10px;font-size:13px;">${bl('verplasing')}</span>` +
        ...
        `<p style="font-weight:700;color:#2563eb;margin-bottom:4px;">Verplasing (gly)</p>` +
      ...
      workedExamples: [
        {
          ...
          answer: `Dit is ʼn ${bl('verplasing')} van 3 blokke na regs`,
          steps: [
            `Om ʼn vorm te skuif sonder om te draai of te flip, word ʼn ${bl('verplasing')} genoem. Die ${re('objek')} beweeg na ʼn nuwe posisie, maar bly presies dieselfde grootte en vorm.`,
            ...
            `<strong>Antwoord:</strong> Dit is ʼn ${bl('verplasing')} van 3 blokke na regs.`,
          ],
        },
        {
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      icon: '→',
      explanation:
        `<p style="margin-bottom:16px;">ʼn <strong>Verplasing</strong> is wanneer ons ʼn vorm van een posisie na ʼn ander skuif sonder om dit te draai of te flip. Elke punt op die vorm beweeg dieselfde afstand in dieselfde rigting. Ons beskryf ʼn verplasing deur te sê hoe ver die vorm links of regs beweeg en hoe ver dit op of af beweeg. Die vorm en sy ${pu('beeld')} is identies — dieselfde grootte, dieselfde vorm, dieselfde oriëntasie.</p>` +
        ...
        `<p style="font-weight:700;color:#0f1f3d;margin-bottom:10px;font-size:1.02em;">Hoe om ʼn verplasing te beskryf</p>` +
        `<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:10px;margin-bottom:20px;">` +
        ...
        `<p style="margin:0;color:#1e3a8a;">In ʼn verplasing beweeg elke punt van die vorm met <strong>presies dieselfde hoeveelheid</strong> in dieselfde rigting. Die ${pu('beeld')} is altyd kongruent aan die ${re('objek')} — dit het dieselfde grootte, vorm en oriëntasie.</p>` +
        `</div>`,
      ...
      openQuestions: [
        ...
        {
          difficulty: 'Medium',
          question: 'Beskryf, deur die rooster hierbo te gebruik, die verplasing van Begin na Einde.',
          answer: 'Begin beweeg 4 stappe regs en 2 stappe op om Einde te word.',
          checkMode: 'self',
        },
        ...
        // ── Q5 Hard — two translations in a row ──────────────────────────────
        {
          ...
          checkMode: 'auto',
          correctAnswer: '(4,5)',
          explanation: 'Eerste verplasing: (2+3, 4−2) = (5, 2). Tweede verplasing: (5−1, 2+3) = (4, 5). ✓',
        },
      ],
      ...
      videoPlaceholder:
        'Kort video wat wys hoe om ʼn vorm stap vir stap op ʼn rooster te transleer, met horisontale beweging in blou en vertikale beweging in groen, beginposisie in oranje en eindposisie in pers',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Kort video wat wys hoe om ʼn vorm oor ʼn vertikale en ʼn horisontale spieëllyn te reflekteer, met die spieëllyn in rooi, objek in blou, beeld in groen, en afstand vanaf die spieëllyn in oranje',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      openQuestions: [
        ...
        {
          difficulty: 'Hard',
          question: 'Amahle sê ʼn verplasing en ʼn rotasie is dieselfde omdat die vorm nie van grootte verander nie. Is sy korrek? Verduidelik.',
          answer: 'Nie heeltemal nie — albei behou dieselfde grootte, maar hulle is verskillende transformasies. ʼn Verplasing skuif die vorm sonder om dit te draai. ʼn Rotasie draai die vorm om ʼn vaste punt. Die oriëntasie van die vorm verander in ʼn rotasie, maar nie in ʼn verplasing nie.',
          checkMode: 'self',
        },
      ],
      ...
      videoPlaceholder:
        'Kort video wat wys hoe om ʼn vorm om ʼn middelpunt van rotasie te draai, met demonstrasies van kwartdraaie kloksgewys en anti-kloksgewys en ʼn halwe draai van 180 grade, met kloksgewys in blou, anti-kloksgewys in rooi, middelpunt van rotasie in oranje, en grade in groen',
    },
  ],
  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      name: 'Stel 1',
      questions: [
        { difficulty: 'Easy', question: 'ʼn Driehoek gly 5 blokke na links sonder om te draai of te flip. Watter tipe transformasie is dit?', checkMode: 'auto', correctAnswer: 'verplasing', correctAnswers: ['verplasing'], explanation: 'Om ʼn vorm te skuif sonder om te draai of te flip, is altyd ʼn verplasing.' },
        ...
        { difficulty: 'Hard', question: 'Kagiso sê: "ʼn Verplasing en ʼn rotasie moet dieselfde transformasie wees, want in albei bly die beeld kongruent aan die objek." Is Kagiso korrek? Verduidelik jou redenasie.', checkMode: 'self', answer: 'Nee, Kagiso is nie korrek nie. Dit is waar dat beide ʼn verplasing en ʼn rotasie die beeld kongruent aan die objek hou (dieselfde grootte en vorm). Maar hulle is verskillende transformasies: ʼn verplasing skuif die vorm in ʼn reguit lyn sonder om te verander watter kant dit kyk, terwyl ʼn rotasie die vorm om ʼn vaste middelpunt draai, wat wel die oriëntasie (die rigting waarin dit kyk) verander. Dat kongruensie behoue bly, maak nie twee transformasies dieselfde nie — jy moet ook kyk na wat met die oriëntasie van die vorm gebeur.' },
        { difficulty: 'Hard', question: 'ʼn Punt begin by (2,3). Dit word eers 3 stappe regs en 1 stap op getransleer, en dan word die punt wat verkry is oor ʼn vertikale spieëllyn by x = 7 gereflekteer. Wat is die finale posisie van die punt? Wys albei stappe.', checkMode: 'auto', correctAnswer: '(9,4)', correctAnswers: ['(9,4)', '9,4'], explanation: 'Stap 1 — verplasing: (2 + 3, 3 + 1) = (5,4). Stap 2 — refleksie oor x = 7: afstand vanaf (5,4) tot die spieëllyn is 7 − 5 = 2, dus is die beeld 2 eenhede aan die ander kant: 7 + 2 = 9. Finale punt: (9,4). ✓' },
      ...
      scoreMessages: [
        ...
        { minScore: 10, message: 'Goeie poging! Gaan die uitgewerkte voorbeelde vir verplasing, refleksie en rotasie weer deur, en probeer hierdie stel weer.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'ʼn Sterretjie-vorm word 4 blokke af en 2 blokke regs beweeg, sonder om te draai of te flip. Watter tipe transformasie is dit?', checkMode: 'auto', correctAnswer: 'verplasing', correctAnswers: ['verplasing'], explanation: 'Om ʼn vorm in ʼn reguit rigting te skuif sonder om te draai of te flip, is ʼn verplasing.' },
        ...
        { difficulty: 'Hard', question: 'ʼn Punt begin by (1,2). Dit word eers 4 stappe regs en 3 stappe op getransleer, en dan word die punt wat verkry is oor ʼn vertikale spieëllyn by x = 9 gereflekteer. Wat is die finale posisie van die punt? Wys albei stappe.', checkMode: 'auto', correctAnswer: '(13,5)', correctAnswers: ['(13,5)', '13,5'], explanation: 'Stap 1 — verplasing: (1 + 4, 2 + 3) = (5,5). Stap 2 — refleksie oor x = 9: afstand vanaf (5,5) tot die spieëllyn is 9 − 5 = 4, dus is die beeld 4 eenhede aan die ander kant: 9 + 4 = 13. Finale punt: (13,5). ✓' },
        { difficulty: 'Hard', question: 'Bongani transleer ʼn driehoek en sê: "Die beeld is nou ʼn heeltemal ander driehoek, want dit is op ʼn nuwe plek." Beskryf hy ʼn verandering in grootte, vorm, of posisie? Verduidelik waarom die driehoek steeds kongruent aan die oorspronklike is.', checkMode: 'self', answer: 'Bongani beskryf ʼn verandering in posisie, nie grootte of vorm nie. ʼn Verplasing skuif ʼn vorm na ʼn nuwe plek op die rooster sonder om te draai of te flip, dus bly die grootte, vorm en oriëntasie almal presies dieselfde — net die posisie verander. Omdat niks aan die grootte of vorm verander het nie, is die beeld steeds kongruent aan (ʼn presiese identiese kopie van) die objek; dit het net na ʼn nuwe plek geskuif.' },
        { difficulty: 'Hard', question: 'Vergelyk ʼn verplasing en ʼn rotasie. Albei hou die vorm kongruent, maar verduidelik een duidelike manier hoe jy, net deur na die objek en beeld te kyk, kan sê of ʼn verplasing of ʼn rotasie gebruik is. Regverdig dan waarom die beeld in albei gevalle kongruent aan die objek is.', checkMode: 'self', answer: 'Een duidelike manier is om te kyk of die vorm nog steeds in dieselfde rigting kyk. In ʼn verplasing kyk die objek en beeld presies dieselfde kant toe — elke deel van die vorm het net dieselfde afstand in dieselfde rigting geskuif, so lyne wat horisontaal was, bly horisontaal. In ʼn rotasie verander die vorm se oriëntasie — dit word om ʼn vaste middelpunt gedraai om ʼn nuwe rigting te kyk, so lyne wat horisontaal in die objek was, kan nou vertikaal of skuins in die beeld wees. In albei gevalle is die beeld kongruent aan die objek omdat geen van die twee transformasies die vorm groter, kleiner of ʼn ander vorm maak nie — net die posisie en/of oriëntasie verander.' },
      ],
      scoreMessages: [
        { minScore: 20, message: 'Uitstekend! Jy kan met selfvertroue transformasies identifiseer, transleer, reflekteer en draai, en jou redenasie soos ʼn kenner verduidelik.' },
        { minScore: 15, message: 'Goeie werk! Jy het ʼn sterk begrip van transformasies. Gaan enige gemiste vrae weer deur en probeer weer.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'ʼn Pion op ʼn skaakbord gly 2 blokkies vorentoe sonder om te draai. Watter tipe transformasie is dit?', checkMode: 'auto', correctAnswer: 'verplasing', correctAnswers: ['verplasing'], explanation: 'Om ʼn stuk in ʼn reguit rigting te skuif sonder om te draai of te flip, is ʼn verplasing.' },
        { difficulty: 'Easy', question: 'Waar of onwaar: in elke transformasie wat in Graad 5 gedek word (verplasing, refleksie, rotasie), is die beeld altyd kongruent aan die objek, tensy die vorm doelbewus groter of kleiner gemaak word.', checkMode: 'auto', correctAnswer: 'waar', correctAnswers: ['waar', 'Waar'], explanation: 'Waar — verplasings, refleksies en rotasies behou almal die grootte en vorm van die objek. Die beeld is kongruent aan die objek; net die posisie en/of oriëntasie verander.' },
        ...
        { difficulty: 'Hard', question: 'Sipho sê: "ʼn Verplasing en ʼn refleksie moet dieselfde transformasie wees, want in albei is die objek en beeld presies dieselfde grootte." Is Sipho korrek? Verduidelik jou redenasie.', checkMode: 'self', answer: 'Nee, Sipho is nie korrek nie. Dit is waar dat beide ʼn verplasing en ʼn refleksie die objek en beeld dieselfde grootte hou. Maar hulle is verskillend: ʼn verplasing skuif die vorm sonder om te verander watter kant dit kyk, terwyl ʼn refleksie die vorm oor ʼn spieëllyn flip sodat dit ʼn spieëlbeeld word, wat sy oriëntasie omkeer. Dieselfde grootte beteken nie dieselfde transformasie nie — jy moet ook kyk of die vorm geflip is, of net na ʼn nuwe posisie geskuif het.' },
        { difficulty: 'Hard', question: 'ʼn Punt begin by (3,4). Dit word eers 2 stappe regs en 1 stap af getransleer, en dan word die punt wat verkry is oor ʼn vertikale spieëllyn by x = 10 gereflekteer. Wat is die finale posisie van die punt? Wys albei stappe.', checkMode: 'auto', correctAnswer: '(15,3)', correctAnswers: ['(15,3)', '15,3'], explanation: 'Stap 1 — verplasing: (3 + 2, 4 − 1) = (5,3). Stap 2 — refleksie oor x = 10: afstand vanaf (5,3) tot die spieëllyn is 10 − 5 = 5, dus is die beeld 5 eenhede aan die ander kant: 10 + 5 = 15. Finale punt: (15,3). ✓' },
        ...
        { difficulty: 'Hard', question: 'Vergelyk ʼn refleksie en ʼn verplasing deur ʼn spesifieke voorbeeld te gebruik: ʼn vlagvorm met ʼn pyl daarop gedruk wat regs wys. Verduidelik wat met die rigting van die pyl in elke transformasie sou gebeur, en waarom dit jou help om die twee transformasies van mekaar te onderskei.', checkMode: 'self', answer: 'As die vlag getransleer word, wys die pyl steeds presies dieselfde kant toe (regs) — net sy posisie op die rooster verander, want ʼn verplasing skuif net die vorm sonder om te draai of te flip. As die vlag oor ʼn spieëllyn gereflekteer word, word die pyl se rigting gespieël — ʼn pyl wat regs wys, kan byvoorbeeld in die beeld links wys, want ʼn refleksie flip die hele vorm in ʼn spieëlbeeld van homself. Om te kyk of ʼn rigtingaanduiding soos ʼn pyl dieselfde kant toe bly wys of geflip word, is ʼn betroubare manier om ʼn verplasing van ʼn refleksie te onderskei. In albei gevalle bly die vlag kongruent aan die oorspronklike, want geen van die twee transformasies verander sy grootte nie.' },
      ],
      scoreMessages: [
        { minScore: 20, message: 'Fantasties! Jy kan verplasing, refleksie en rotasie op werklike probleme toepas en jou redenasie met selfvertroue regverdig.' },
        { minScore: 15, message: 'Goeie werk! Jy het ʼn sterk begrip van transformasies. Gaan enige gemiste vrae weer deur en probeer weer.' },
        { minScore: 10, message: 'Goeie poging! Gaan die uitgewerkte voorbeelde vir verplasing, refleksie en rotasie weer deur, en probeer die woordprobleme weer.' },
        { minScore: 0, message: 'Hou aan — werk weer deur die studiegids, afdeling vir afdeling, en probeer hierdie stel weer.' },
      ],
    },
  ],
