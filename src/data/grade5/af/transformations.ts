...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Kort video wat die drie tipes transformasies bekendstel — translasie, refleksie en rotasie — met eenvoudige vormvoorbeelde wat die objek in rooi en die beeld in pers wys',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      openQuestions: [
        ...
        {
          difficulty: 'Medium',
          question: 'Beskryf, deur die rooster hierbo te gebruik, die translasie van Begin na Einde.',
