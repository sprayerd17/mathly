...
const MULT_TH =
  ...
  `<th style="padding:7px 14px;font-weight:700;color:#6b7280;border-bottom:2px solid #e5e7eb;border-right:1px solid #e5e7eb">D</th>` +
...
<div style="background:#f0fdf4;border:1.5px solid #bbf7d0;border-radius:10px;padding:14px 16px;">
  ...
  <p style="margin:0;color:#15803d;">Breek ${re('12')} op in <strong>10 + 2</strong>. Vermenigvuldig elke deel afsonderlik en tel dan die resultate bymekaar. Byvoorbeeld: ${re('12')} × ${bl('9')} = (10 × ${bl('9')}) + (2 × ${bl('9')}) = 90 + 18 = ${gr('108')}.</p>
      ...
      practiceQuestions: [],
      diagramPlaceholder: 'ʼn 12 × 12-vermenigvuldigingsrooster-uitleg met slegs die 11×- en 12×-rye ingevul en in ʼn ander kleur uitgelig',
      ...
      videoPlaceholder:
        'Kort video wat patrone in die 11- en 12-tafels wys en wenke gee om hulle te onthou',
    },
...
<div style="background:#fefce8;border:1.5px solid #fde68a;border-radius:10px;padding:14px 16px;">
  ...
  <p style="margin:0;color:#78350f;">Soms is dit baie makliker om ʼn getal in <strong>tiene en ene</strong> (of <strong>honderde en tiene</strong>) op te breek voordat jy vermenigvuldig. Byvoorbeeld, om met 48 te vermenigvuldig lyk moeilik — maar om apart met 40 en dan met 8 te vermenigvuldig is eenvoudig. Die distributiewe eienskap maak dit geldig en betroubaar.</p>
      ...
      practiceQuestions: [],
      videoPlaceholder:
        'Kort video wat wys hoe om die distributiewe eienskap te gebruik om getalle op te breek en vermenigvuldiging makliker te maak',
    },
...
Daar is <strong>3 600 sjokolade</strong> altesaam.`,
      ...
      practiceQuestions: [],
      videoPlaceholder:
        'Kort video wat wys hoe om te skat voordat jy vermenigvuldig en hoe om vermenigvuldiging-woordprobleme op te los deur sleutelwoorde te identifiseer',
    },
  ],
  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy-Medium', question: 'ʼn Leerder beweer 11 × 10 = 1010, en werk dit uit deur elke syfer van 11 apart met 10 te vermenigvuldig (1 × 10 = 10 en 1 × 10 = 10) en die twee resultate langs mekaar te skryf. Is dit korrek? Gee die korrekte antwoord en verduidelik die fout.', answer: '110', checkMode: 'auto', correctAnswer: '110', correctAnswers: ['110'], explanation: 'Om elke syfer apart te vermenigvuldig en die resultate langs mekaar te skryf is nie geldig nie — dit ignoreer die plekwaarde en gee 1010, wat verkeerd is. Om met 10 te vermenigvuldig, skuif jy elke syfer eenvoudig een plek na links: 11 × 10 = 110, nie 1010 nie.' },
        ...
        { difficulty: 'Hard', question: 'Klas A maak geld deur 45 lootjies teen R19 elk te verkoop. Klas B maak geld deur 42 lootjies teen R38 elk te verkoop. Watter klas maak meer geld, en wat is die verskil tussen die twee bedrae?', answer: 'Klas B maak meer geld. Die verskil is R741.', checkMode: 'auto', correctAnswer: '741', correctAnswers: ['741', 'r741', 'klasb', 'klas b'], explanation: 'Klas A: 45 × 19 = 855. Klas B: 42 × 38 = 1 596. Verskil: 1 596 − 855 = 741. Klas B maak R741 meer as Klas A.' },
      ],
      scoreMessages: [
