...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        '<DiagramPlaceholder label="Telmerktabel wat Sipho se vrugte-opname wys met appel 5 piesang 3 mango 2 telmerke in blou en frekwensiegetalle in oranje wat optel tot 10" />',

      videoPlaceholder:
        '<VideoPlaceholder label="Kort video wat wys hoe om rou data te versamel en dit stap vir stap in ʼn telmerktabel en frekwensietabel te organiseer" />',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        '<DiagramPlaceholder label="Staafgrafiek wat Amahle se gunstelingsport-opname wys met horisontale as geëtiketteer Sport in blou vertikale as geëtiketteer Aantal Leerders in rooi skaal in oranje wat in 2e tel van 0 tot 10 en groen stawe vir sokker 10 netbal 8 krieket 5 swem 7" />',

      videoPlaceholder:
        '<VideoPlaceholder label="Kort video wat stap vir stap wys hoe om ʼn staafgrafiek te teken met ʼn geëtiketteerde horisontale as vertikale as konstante skaal en korrek gespasieerde stawe" />',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        '<DiagramPlaceholder label="Prentgrafiek wat boeke gelees deur Sipho 4 volle simbole en Lerato 3 en ʼn half simbole wys met sleutelwaarde 2 in blou volle simbole in groen half simbool in oranje en totale in rooi" />',

      videoPlaceholder:
        '<VideoPlaceholder label="Kort video wat wys hoe om ʼn prentgrafiek te lees deur die sleutelwaarde te kontroleer volle simbole te tel en half simbole te hanteer om totale te vind" />',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        '<DiagramPlaceholder label="Drie panele wat modus in blou wys met 3 as die mees algemene waarde mediaan in groen met gerangskikte datastel en middelste waarde uitgelig en gemiddelde in oranje wat die optelling en delingstappe wys" />',

      videoPlaceholder:
        '<VideoPlaceholder label="Kort video wat modus mediaan en gemiddelde verduidelik met uitgewerkte voorbeelde wat wys hoe om die mees algemene waarde die middelste waarde en die gemiddeld van ʼn datastel te vind" />',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        '<DiagramPlaceholder label="Staafgrafiek wat leerder-afwesighede per dag wys Maandag 3 Dinsdag 7 Woensdag 2 in rooi Donderdag 5 Vrydag 8 in groen met totaal 25 in oranje en breukpaneel wat 12 uit 60 gelyk aan 1/5 in blou wys" />',

      videoPlaceholder:
        '<VideoPlaceholder label="Kort video wat wys hoe om ʼn staafgrafiek en datatabel te interpreteer deur die titel etikette en skaal te lees die hoogste en laagste waardes te identifiseer totale te bereken en waardes as breuke uit te druk" />',
    },
  ],
