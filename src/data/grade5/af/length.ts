...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Kort video wat die vier eenhede van lengte mm cm m en km verduidelik met werklike-lewe-voorbeelde wat wys wanneer om elke eenheid te gebruik',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Kort video wat wys hoe om tussen mm cm m en km om te skakel deur te vermenigvuldig en te deel, met drie uitgewerkte voorbeelde kleurgekodeer groen vir vermenigvuldig rooi vir deel oranje vir omskakelingsfeite blou vir antwoorde',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Kort video wat wys hoe om ʼn liniaal korrek te gebruik, deur by nul te begin, die eindpunt te lees, en die meting met die korrekte eenheid neer te skryf',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Kort video wat wys hoe om lengtes met verskillende eenhede op te tel en af te trek deur eers om te skakel en dan te bereken, met kleurgekodeerde stappe — omskakeling blou, optelling groen, aftrekking rooi, antwoord oranje',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Kort video wat verduidelik hoe om die omtrek van ʼn reghoek en ʼn vierkant te bereken deur al die sylengtes op te tel, met sye kleurgekodeer blou, optelling groen en omtrekantwoord oranje',
    },
  ],
  practiceSets: [
    // ═══════════════════════════════════════════════════════════════════════
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'Sipho se tuinpaadjie is 14m lank. Sy buurman se paadjie is 1 350cm lank. Wie se paadjie is langer, en met hoeveel meter?', checkMode: 'auto', correctAnswer: 'Sipho0,5m', correctAnswers: ['Sipho0,5m', 'Sipho, 0,5m', 'Sipho se paadjie 0,5m', 'Sipho 0,5m'], explanation: 'Skakel 1 350cm om na meter: 1 350 ÷ 100 = 13,5m. Vergelyk: Sipho se paadjie is 14m en die buurman s\'n is 13,5m. Sipho se paadjie is langer, met 14 − 13,5 = 0,5m.' },
