...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      icon: '🕐',
      explanation:
        `<p style="margin-bottom:16px;">Ons kan tyd op ʼn <strong>analoë horlosie</strong> of ʼn <strong>digitale horlosie</strong> lees. ʼn Analoë horlosie het twee wysers — die kort ${bl('uurwyser')} en die lang ${gr('minuutwyser')}. Die ${gr('minuutwyser')} vat 60 minute om heeltemal om te gaan. Elke syfer op die horlosie verteenwoordig 5 minute. ʼn Digitale horlosie wys die tyd met syfers wat deur ʼn dubbelpunt geskei word — byvoorbeeld 3:45 beteken 3 ure en 45 minute. Ons gebruik ook ${or('vm.')} vir tye tussen middernag en middag en ${re('nm.')} vir tye tussen middag en middernag.</p>` +
      ...
      workedExamples: [
        {
          question: 'Die uurwyser wys na 4 en die minuutwyser wys na 6 op ʼn analoë horlosie. Wat is die tyd?',
      ...
      diagramPlaceholder:
        'ʼn Analoë horlosie wat die kort uurwyser in blou na 4 wys en die lang minuutwyser in groen na 6 wys, met die tyd 4:30 geëtiketteer',
      diagramSvg:
      ...
      videoPlaceholder:
        'Kort video wat wys hoe om tyd op ʼn analoë horlosie te lees deur die blou uurwyser en die groen minuutwyser te gebruik, en hoe vm en nm gebruik word',
    },
  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'Op ʼn analoë horlosie wys die uurwyser presies na 3 en die minuutwyser presies na 12. Wat is die tyd?', checkMode: 'auto', correctAnswer: '3:00', correctAnswers: ['3:00', '3 uur', 'drie uur'], explanation: 'Die minuutwyser by 12 beteken dit is presies op die uur. Die uurwyser by 3 beteken die tyd is 3 uur.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'Op ʼn analoë horlosie wys die uurwyser presies na 11 en die minuutwyser presies na 12. Wat is die tyd?', checkMode: 'auto', correctAnswer: '11:00', correctAnswers: ['11:00', '11 uur', 'elf uur'], explanation: 'Die minuutwyser by 12 beteken dit is presies op die uur. Die uurwyser by 11 beteken die tyd is 11 uur.' },
