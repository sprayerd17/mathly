...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Kort video wat desimale breuke verduidelik, insluitend plekwaarde van tiendes en honderdstes, hoe om desimale te lees en te skryf, en hoe desimale verband hou met gewone breuke met noemers 10 en 100',
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Kort video wat wys hoe om desimale breuke te vergelyk en te orden deur desimale kommas op te lyn en plek vir plek te vergelyk van ene na tiendes na honderdstes, insluitend ʼn uitgewerkte voorbeeld van die algemene wanopvatting dat meer syfers ʼn groter getal beteken',
    },
    // ─────────────────────────────────────────────────────────────────────────
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Kort video wat demonstreer hoe om desimale breuke op te tel en af te trek met die kolommetode deur desimale kommas op te lyn en dan syfer vir syfer van regs na links op te tel of af te trek, met oordra wanneer totale 10 of meer bereik en leen wanneer bosyfers te klein is',
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Kort video wat wys hoe om tussen breuke, desimale en persentasies om te skakel met kleurgekodeerde voorbeelde, breuke in blou, desimale in groen en persentasies in rooi',
    },
  ],
