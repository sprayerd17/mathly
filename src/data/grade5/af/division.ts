...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Kort video wat wys hoe vermenigvuldiging-feitefamilies help om delingsprobleme met groter getalle tot by 12 x 12 op te los',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
        ...
        // ── Q6 Hard — word problem with inverse check ────────────────────────
        {
          ...
          parts: [
            ...
            },
            {
              ...
              correctAnswers: ['728x8=5824', '5824', '728×8=5824'],
      ...
      videoPlaceholder:
        'Kort video wat stap-vir-stap langdeling van ʼn 4-syfergetal deur ʼn 1-syfergetal met kleur-gekodeerde stappe wys',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      openQuestions: [
        // ── Q10 Easy — remainder calculation ────────────────────────────────
        {
          ...
          answer: '34 res 3',
          checkMode: 'auto',
          correctAnswer: '34 res 3',
          correctAnswers: ['34 res 3', '34 r 3', '34r3', '34 rem 3'],
          ...
          parts: [
            {
              ...
              correctAnswer: '208 res 2',
              correctAnswers: ['208 res 2', '208 r 2', '208r2', '208 rem 2'],
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
        ...
        // ── Q14 Medium — sharing with changed conditions ──────────────────────
        {
          ...
          parts: [
            ...
            },
            {
              ...
              explanation: 'Oorblywende werkers: 12 − 2 = 10.\n3 456 ÷ 10 = 345,6 → R345,60 (deling deur 10 skuif die desimale komma een plek).\nAntwoord: R345,60 per werker ✓',
            },
            {
      ...
      videoPlaceholder:
        'Kort video wat wys hoe om reste in konteks te interpreteer en delingwoordprobleme op te los deur deling- en groeperingsituasies te identifiseer',
    },
  ],
  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'Bereken 275 ÷ 13 en skryf die res.', answer: '21 res 2', checkMode: 'auto', correctAnswer: '21 res 2', correctAnswers: ['21 res 2', '21 r 2', '21r2', '21 rem 2'], explanation: 'Stap 1: 2 < 13 — neem 27. Skat: 27 ÷ 10 ≈ 2. Probeer 2: 2 × 13 = 26 ≤ 27 ✓.\nStap 2: 27 − 26 = 1. Bring 5 af → 15.\nStap 3: 15 ÷ 13 = 1 res 2. Probeer 1: 1 × 13 = 13 ≤ 15 ✓.\nStap 4: 15 − 13 = 2. Aangesien 2 < 13, is dit die finale res.\nAntwoord: 275 ÷ 13 = 21 res 2 ✓' },
        ...
        { difficulty: 'Medium', question: 'ʼn Liefdadigheidsorganisasie het R950 ingesamel om gelyk tussen 8 vrywilligers verdeel te word.\n\na) Hoeveel kry elke vrywilliger as ʼn heelrand-bedrag, en wat is die res?\nb) Skryf die res as ʼn breuk van R8.\nc) Hoeveel ontvang elke vrywilliger in rand en sent?', answer: '', checkMode: 'auto', parts: [
          { label: 'a) Heelrand-bedrag met res', correctAnswer: '118 res 6', correctAnswers: ['118 res 6', '118 r 6', '118r6', '118 rem 6'], explanation: '950 ÷ 8: Stap 1: 9 ÷ 8 = 1 res 1. Bring 5 af → 15. Stap 2: 15 ÷ 8 = 1 res 7. Bring 0 af → 70. Stap 3: 70 ÷ 8 = 8 res 6.\nAntwoord: 950 ÷ 8 = 118 res 6.' },
        ...
        { difficulty: 'Medium', question: 'ʼn Saal het 365 stoele om in rye te rangskik.\n\nSituasie A: rye van 14 stoele.\nSituasie B: rye van 20 stoele.\n\na) Hoeveel volle rye en hoeveel oorblywende stoele in Situasie A?\nb) Hoeveel volle rye en hoeveel oorblywende stoele in Situasie B?\nc) Watter situasie vermors die minste stoele as oorskot?', answer: '', checkMode: 'auto', parts: [
          { label: 'a) Situasie A (rye van 14)', correctAnswer: '26 res 1', correctAnswers: ['26 res 1', '26 r 1', '26r1', '26 rem 1'], explanation: '365 ÷ 14: Stap 1: 3 < 14 — neem 36. Skat 36 ÷ 10 ≈ 3. Probeer 2: 2 × 14 = 28 ≤ 36 ✓. Kontroleer 3 × 14 = 42 > 36 — dus is 2 korrek. Stap 2: 36 − 28 = 8. Bring 5 af → 85. Stap 3: 85 ÷ 14 — probeer 6: 6 × 14 = 84 ≤ 85 ✓. Res: 85 − 84 = 1.\nAntwoord: 365 ÷ 14 = 26 res 1.' },
          { label: 'b) Situasie B (rye van 20)', correctAnswer: '18 res 5', correctAnswers: ['18 res 5', '18 r 5', '18r5', '18 rem 5'], explanation: '365 ÷ 20: Stap 1: 36 ÷ 20 = 1 res 16. Bring 5 af → 165. Stap 2: 165 ÷ 20 = 8 res 5.\nAntwoord: 365 ÷ 20 = 18 res 5.' },
          { label: 'c) Watter een vermors die minste stoele', correctAnswer: 'Situasie A', correctAnswers: ['Situasie A', 'A', 'situasie a'], explanation: 'Situasie A laat slegs 1 stoel ongebruik, terwyl Situasie B 5 stoele ongebruik laat. Situasie A vermors die minste stoele as oorskot.' },
        ] },
        ...
        { difficulty: 'Medium-Hard', question: 'ʼn Skool het 480 lekkers vir ʼn fondsinsameling.\n\nSituasie A: Die lekkers word gelyk tussen 8 klasse verdeel. Hoeveel lekkers kry elke klas?\nSituasie B: Die lekkers word in sakkies van 16 verpak om te verkoop. Hoeveel sakkies word gemaak?\n\na) Antwoord vir Situasie A.\nb) Antwoord vir Situasie B.\nc) Watter situasie is ʼn delingsituasie en watter is ʼn groeperingsituasie?', answer: '', checkMode: 'auto', parts: [
          { label: 'a) Situasie A', correctAnswer: '60', explanation: '480 ÷ 8 = 60 lekkers per klas (deling: ons ken die aantal groepe, 8 klasse, en vind die hoeveelheid per groep).' },
          { label: 'b) Situasie B', correctAnswer: '30', explanation: '480 ÷ 16 = 30 sakkies (groepering: ons ken die grootte van elke groep, 16 lekkers per sakkie, en vind die aantal groepe).' },
          { label: 'c) Deling teenoor groepering', checkMode: 'self', answer: 'Situasie A is deling — die totaal (480) word gelyk verdeel tussen ʼn bekende aantal klasse (8), en ons vind hoeveel lekkers elke klas kry.\nSituasie B is groepering — ons ken die grootte van elke sakkie (16) en vind hoeveel sakkies (groepe) uit die totaal gemaak kan word.' },
        ] },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'Bereken 346 ÷ 11 en skryf die res.', answer: '31 res 5', checkMode: 'auto', correctAnswer: '31 res 5', correctAnswers: ['31 res 5', '31 r 5', '31r5', '31 rem 5'], explanation: 'Stap 1: 3 < 11 — neem 34. Skat: 34 ÷ 10 ≈ 3. Probeer 3: 3 × 11 = 33 ≤ 34 ✓.\nStap 2: 34 − 33 = 1. Bring 6 af → 16.\nStap 3: 16 ÷ 11 = 1 res 5. Probeer 1: 1 × 11 = 11 ≤ 16 ✓.\nStap 4: 16 − 11 = 5. Aangesien 5 < 11, is dit die finale res.\nAntwoord: 346 ÷ 11 = 31 res 5 ✓' },
        ...
        { difficulty: 'Medium', question: 'ʼn Gemeenskapsgroep het R930 ingesamel om gelyk tussen 8 helpers verdeel te word.\n\na) Hoeveel kry elke helper as ʼn heelrand-bedrag, en wat is die res?\nb) Skryf die res as ʼn breuk van R8.\nc) Hoeveel ontvang elke helper in rand en sent?', answer: '', checkMode: 'auto', parts: [
          { label: 'a) Heelrand-bedrag met res', correctAnswer: '116 res 2', correctAnswers: ['116 res 2', '116 r 2', '116r2', '116 rem 2'], explanation: '930 ÷ 8: Stap 1: 9 ÷ 8 = 1 res 1. Bring 3 af → 13. Stap 2: 13 ÷ 8 = 1 res 5. Bring 0 af → 50. Stap 3: 50 ÷ 8 = 6 res 2.\nAntwoord: 930 ÷ 8 = 116 res 2.' },
        ...
        { difficulty: 'Medium', question: 'ʼn Bioskoop het 482 kaartjies om vir twee verskillende vertonings te verkoop, in rye gesetel.\n\nSituasie A: rye van 15 sitplekke.\nSituasie B: rye van 20 sitplekke.\n\na) Hoeveel volle rye en hoeveel oorblywende sitplekke in Situasie A?\nb) Hoeveel volle rye en hoeveel oorblywende sitplekke in Situasie B?\nc) Watter situasie vermors die minste sitplekke as oorskot?', answer: '', checkMode: 'auto', parts: [
          { label: 'a) Situasie A (rye van 15)', correctAnswer: '32 res 2', correctAnswers: ['32 res 2', '32 r 2', '32r2', '32 rem 2'], explanation: '482 ÷ 15: Stap 1: 48 ÷ 15 = 3 res 3. Bring 2 af → 32. Stap 2: 32 ÷ 15 = 2 res 2.\nAntwoord: 482 ÷ 15 = 32 res 2.' },
          { label: 'b) Situasie B (rye van 20)', correctAnswer: '24 res 2', correctAnswers: ['24 res 2', '24 r 2', '24r2', '24 rem 2'], explanation: '482 ÷ 20: Stap 1: 48 ÷ 20 = 2 res 8. Bring 2 af → 82. Stap 2: 82 ÷ 20 = 4 res 2.\nAntwoord: 482 ÷ 20 = 24 res 2.' },
          { label: 'c) Watter een vermors die minste sitplekke', correctAnswer: 'equal', correctAnswers: ['equal', 'gelyk', 'albei dieselfde', 'geeneen'], explanation: 'Albei situasie’s laat presies 2 sitplekke ongebruik, dus vermors geeneen minder as die ander nie — hulle is ewe doeltreffend.' },
        ] },
        ...
        { difficulty: 'Medium-Hard', question: 'ʼn Skool het 540 potlode vir ʼn skryfbehoefte-veldtog.\n\nSituasie A: Die potlode word gelyk tussen 9 klasse verdeel. Hoeveel potlode kry elke klas?\nSituasie B: Die potlode word in pakkies van 15 verpak om te verkoop. Hoeveel pakkies word gemaak?\n\na) Antwoord vir Situasie A.\nb) Antwoord vir Situasie B.\nc) Watter situasie is ʼn delingsituasie en watter is ʼn groeperingsituasie?', answer: '', checkMode: 'auto', parts: [
          { label: 'a) Situasie A', correctAnswer: '60', explanation: '540 ÷ 9 = 60 potlode per klas (deling: ons ken die aantal groepe, 9 klasse, en vind die hoeveelheid per groep).' },
          { label: 'b) Situasie B', correctAnswer: '36', explanation: '540 ÷ 15 = 36 pakkies (groepering: ons ken die grootte van elke groep, 15 potlode per pakkie, en vind die aantal groepe).' },
          { label: 'c) Deling teenoor groepering', checkMode: 'self', answer: 'Situasie A is deling — die totaal (540) word gelyk verdeel tussen ʼn bekende aantal klasse (9), en ons vind hoeveel potlode elke klas kry.\nSituasie B is groepering — ons ken die grootte van elke pakkie (15) en vind hoeveel pakkies (groepe) uit die totaal gemaak kan word.' },
        ] },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'ʼn Leerder deel 759 ÷ 12 en skat die eerste kwosiëntsyfer as 7, en skryf "7 × 12 = 84, maar 84 > 75, so dit kan nie reg wees nie." Vind die korrekte eerste syfer, en voltooi dan die deling om 759 ÷ 12 te vind.', answer: '759 ÷ 12 = 63 res 3', checkMode: 'auto', correctAnswer: '63 res 3', correctAnswers: ['63 res 3', '63 r 3', '63r3', '63 rem 3'], explanation: 'Die leerder is korrek dat 7 te hoog is, aangesien ons "75" as die eerste gedeeltelike deeltal neem (7 < 12, dus gebruik twee syfers 75), en 7 × 12 = 84 > 75. Probeer 6: 6 × 12 = 72 ≤ 75 ✓.\nStap 1: 75 − 72 = 3. Bring 9 af → 39.\nStap 2: 39 ÷ 12 — probeer 3: 3 × 12 = 36 ≤ 39 ✓. Kontroleer 4 × 12 = 48 > 39 — dus is 3 korrek. Res: 39 − 36 = 3.\nAntwoord: 759 ÷ 12 = 63 res 3 ✓' },
        { difficulty: 'Medium', question: 'Bereken 413 ÷ 17 en skryf die res.', answer: '24 res 5', checkMode: 'auto', correctAnswer: '24 res 5', correctAnswers: ['24 res 5', '24 r 5', '24r5', '24 rem 5'], explanation: 'Stap 1: 4 < 17 — neem 41. Skat: 41 ÷ 20 ≈ 2. Probeer 2: 2 × 17 = 34 ≤ 41 ✓.\nStap 2: 41 − 34 = 7. Bring 3 af → 73.\nStap 3: 73 ÷ 17 = 4 res 5. Probeer 4: 4 × 17 = 68 ≤ 73 ✓.\nStap 4: 73 − 68 = 5. Aangesien 5 < 17, is dit die finale res.\nAntwoord: 413 ÷ 17 = 24 res 5 ✓' },
        ...
        { difficulty: 'Medium', question: 'ʼn Stokvel het R1 100 ingesamel om gelyk tussen 8 lede verdeel te word.\n\na) Hoeveel kry elke lid as ʼn heelrand-bedrag, en wat is die res?\nb) Skryf die res as ʼn breuk van R8.\nc) Hoeveel ontvang elke lid in rand en sent?', answer: '', checkMode: 'auto', parts: [
          { label: 'a) Heelrand-bedrag met res', correctAnswer: '137 res 4', correctAnswers: ['137 res 4', '137 r 4', '137r4', '137 rem 4'], explanation: '1 100 ÷ 8: Stap 1: 11 ÷ 8 = 1 res 3. Bring 0 af → 30. Stap 2: 30 ÷ 8 = 3 res 6. Bring 0 af → 60. Stap 3: 60 ÷ 8 = 7 res 4.\nAntwoord: 1 100 ÷ 8 = 137 res 4.' },
        ...
        { difficulty: 'Medium', question: 'ʼn Troueplek het 517 gaste om in rye te sit.\n\nSituasie A: rye van 16 sitplekke.\nSituasie B: rye van 25 sitplekke.\n\na) Hoeveel volle rye en hoeveel oorblywende gaste in Situasie A?\nb) Hoeveel volle rye en hoeveel oorblywende gaste in Situasie B?\nc) Watter situasie benodig ʼn ekstra gedeeltelik-gevulde ry vir minder oorblywende gaste?', answer: '', checkMode: 'auto', parts: [
          { label: 'a) Situasie A (rye van 16)', correctAnswer: '32 res 5', correctAnswers: ['32 res 5', '32 r 5', '32r5', '32 rem 5'], explanation: '517 ÷ 16: Stap 1: 51 ÷ 16 = 3 res 3. Bring 7 af → 37. Stap 2: 37 ÷ 16 = 2 res 5.\nAntwoord: 517 ÷ 16 = 32 res 5.' },
          { label: 'b) Situasie B (rye van 25)', correctAnswer: '20 res 17', correctAnswers: ['20 res 17', '20 r 17', '20r17', '20 rem 17'], explanation: '517 ÷ 25: Stap 1: 51 ÷ 25 = 2 res 1. Bring 7 af → 17. Stap 2: 17 ÷ 25 = 0 res 17.\nAntwoord: 517 ÷ 25 = 20 res 17.' },
          { label: 'c) Watter situasie het minder oorblywende gaste', correctAnswer: 'Situasie A', correctAnswers: ['Situasie A', 'A', 'situasie a'], explanation: 'Situasie A laat slegs 5 gaste onversorg in ʼn gedeeltelik-gevulde ry, terwyl Situasie B 17 laat. Situasie A het minder oorblywende gaste.' },
        ] },
        ...
        { difficulty: 'Medium-Hard', question: 'ʼn Kerk het 360 gesangboeke vir ʼn spesiale diens.\n\nSituasie A: Die gesangboeke word gelyk tussen 6 afdelings van die kerk verdeel. Hoeveel boeke kry elke afdeling?\nSituasie B: Die gesangboeke word in bokse van 12 vir berging verpak. Hoeveel bokse word gemaak?\n\na) Antwoord vir Situasie A.\nb) Antwoord vir Situasie B.\nc) Watter situasie is ʼn delingsituasie en watter is ʼn groeperingsituasie?', answer: '', checkMode: 'auto', parts: [
          { label: 'a) Situasie A', correctAnswer: '60', explanation: '360 ÷ 6 = 60 gesangboeke per afdeling (deling: ons ken die aantal groepe, 6 afdelings, en vind die hoeveelheid per groep).' },
          { label: 'b) Situasie B', correctAnswer: '30', explanation: '360 ÷ 12 = 30 bokse (groepering: ons ken die grootte van elke groep, 12 boeke per boks, en vind die aantal groepe).' },
          { label: 'c) Deling teenoor groepering', checkMode: 'self', answer: 'Situasie A is deling — die totaal (360) word gelyk verdeel tussen ʼn bekende aantal afdelings (6), en ons vind hoeveel gesangboeke elke afdeling kry.\nSituasie B is groepering — ons ken die grootte van elke boks (12) en vind hoeveel bokse (groepe) uit die totaal gemaak kan word.' },
        ] },
        { difficulty: 'Hard', question: 'ʼn Konferensiesentrum ontvang ʼn aflewering van 2 295 ekstra stoele om by rye van 40 sitplekke elk in die hoofsaal te voeg (elke nuwe sitplek kos R14 om te installeer).\n\nDeur die 2 295 stoele en rye van 40 te gebruik:\na) Hoeveel volle nuwe rye van 40 kan gemaak word?\nb) Hoeveel stoele bly oor nadat die volle rye gemaak is?\nc) As daardie oorblywende stoele ook geïnstalleer word, wat is die totale installasiekoste vir al 2 295 stoele?', answer: '', checkMode: 'auto', parts: [
