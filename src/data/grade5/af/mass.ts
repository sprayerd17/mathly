...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      icon: '⚖️',
      explanation:
        `<p style="margin-bottom:16px;">Massa vertel ons hoe swaar iets is. In Graad 5 is die eenhede van massa wat jy moet ken en gebruik vir berekeninge ${gr('gram (g)')} en ${or('kilogram (kg)')}. ${gr('Gram')} word gebruik vir ligter voorwerpe soos ʼn snytjie brood. ${or('Kilogram')} word gebruik vir swaarder voorwerpe soos ʼn sak meel of ʼn persoon.</p>` +
        ...
        `<p style="margin:0;font-size:14px;color:#6b21a8;"><strong>Vooruitskouing:</strong> ${bl('milligram (mg)')} en ${re('ton (t)')} is ekstra eenhede wat gebruik word vir uiters ligte of uiters swaar voorwerpe. Dit gaan verder as wat CAPS vir Graad 5 vereis (Graad 5 vereis slegs g en kg) — jy sal dit amptelik in ʼn latere graad leer. Dit word hieronder ingesluit as verryking, ingeval jy nuuskierig is!</p>` +
        `</div>` +

        `<p style="margin-bottom:16px;">Die volledige familie van massa-eenhede, van ligste na swaarste, is: ${bl('milligram (mg)')}, ${gr('gram (g)')}, ${or('kilogram (kg)')} en ${re('ton (t)')}. ${bl('Milligram')} word gebruik vir baie ligte dinge soos medisynetablette. ${re('Ton')} word gebruik vir baie swaar dinge soos ʼn vragmotor of ʼn olifant.</p>` +
      ...
      diagramPlaceholder:
        'ʼn Visuele skaal van ligste na swaarste wat die kern-Graad-5-eenhede van massa wys — g (groen, appel) en kg (oranje, sak) — met mg (blou, pil) en t (rooi, vragmotor) aan die uiteindes as verryking',
      diagramSvg:
        '<svg viewBox="0 0 340 150" xmlns="http://www.w3.org/2000/svg"><line x1="20" y1="100" x2="320" y2="100" stroke="#0f1f3d" stroke-width="2"/><circle cx="30" cy="100" r="3" fill="#2563eb"/><circle cx="120" cy="100" r="3" fill="#16a34a"/><circle cx="220" cy="100" r="3" fill="#ea580c"/><circle cx="310" cy="100" r="3" fill="#dc2626"/><circle cx="30" cy="80" r="7" fill="none" stroke="#2563eb" stroke-width="2"/><circle cx="120" cy="70" r="16" fill="none" stroke="#16a34a" stroke-width="2.5"/><path d="M204,60 L236,60 L242,92 L198,92 Z" fill="none" stroke="#ea580c" stroke-width="2.5"/><rect x="288" y="62" width="44" height="24" rx="2" fill="none" stroke="#dc2626" stroke-width="2.5"/><circle cx="298" cy="88" r="5" fill="none" stroke="#dc2626" stroke-width="2"/><circle cx="322" cy="88" r="5" fill="none" stroke="#dc2626" stroke-width="2"/><text x="30" y="128" font-size="12" font-weight="700" fill="#2563eb" text-anchor="middle">mg</text><text x="30" y="140" font-size="8" fill="#6b7280" text-anchor="middle">verryking</text><text x="120" y="128" font-size="13" font-weight="700" fill="#16a34a" text-anchor="middle">g</text><text x="220" y="128" font-size="13" font-weight="700" fill="#ea580c" text-anchor="middle">kg</text><text x="310" y="128" font-size="12" font-weight="700" fill="#dc2626" text-anchor="middle">t</text><text x="310" y="140" font-size="8" fill="#6b7280" text-anchor="middle">verryking</text></svg>',

      videoPlaceholder:
        'Kort video wat die vier eenhede van massa verduidelik — milligram, gram, kilogram en ton — en hoe om die korrekte eenheid vir alledaagse voorwerpe te kies',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      icon: '⚖️',
      explanation:
        `<p style="margin-bottom:16px;">In Graad 5 is die omskakeling wat jy nodig het ${or('1 000 g = 1 kg')}. Om van ${or('kilogram')} na ${gr('gram')} om te skakel, ${gr('vermenigvuldig')} ons met 1 000. Om van ${gr('gram')} na ${or('kilogram')} om te skakel, ${re('deel')} ons deur 1 000. Kyk altyd of jou antwoord sinvol is — om na ʼn kleiner eenheid om te skakel behoort ʼn groter getal te gee.</p>` +

        // ── Looking ahead note ──────────────────────────────────────────────
        `<div style="display:flex;gap:10px;align-items:flex-start;margin-bottom:16px;padding:12px 16px;background:#faf5ff;border:1.5px solid #d8b4fe;border-radius:10px;">` +
        `<span style="font-size:18px;line-height:1;">🔭</span>` +
        `<p style="margin:0;font-size:14px;color:#6b21a8;"><strong>Vooruitskouing:</strong> omskakeling tussen ${bl('mg ↔ g')} en ${re('kg ↔ t')} gaan verder as CAPS Graad 5 (wat slegs g ↔ kg vereis). Hierdie ekstra omskakelings word hieronder as verryking gewys.</p>` +
        `</div>` +

        `<p style="margin-bottom:16px;">Die volledige stel omskakelingsverwantskappe is: ${or('1 000 mg = 1 g')}, ${or('1 000 g = 1 kg')}, ${or('1 000 kg = 1 t')}.</p>` +
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        'Drie soorte skale — ʼn kombuisskaal met skaalmerke in blou en die massalesing in oranje, ʼn badkamerskaal, en ʼn balansskaal met die swaarder kant in rooi wat afgaan en die ligter kant in groen wat opgaan',
      diagramSvg:
        '<svg viewBox="0 0 400 155" xmlns="http://www.w3.org/2000/svg"><circle cx="65" cy="60" r="35" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="65" y1="60" x2="65" y2="28" stroke="#2563eb" stroke-width="1.5"/><line x1="65" y1="60" x2="90" y2="42" stroke="#2563eb" stroke-width="1.5"/><line x1="65" y1="60" x2="40" y2="42" stroke="#2563eb" stroke-width="1.5"/><line x1="65" y1="60" x2="82" y2="36" stroke="#0f1f3d" stroke-width="2"/><circle cx="65" cy="60" r="3" fill="#0f1f3d"/><text x="65" y="108" font-size="11" font-weight="700" fill="#0f1f3d" text-anchor="middle">Kombuisskaal</text><text x="65" y="122" font-size="11" font-weight="700" fill="#ea580c" text-anchor="middle">450 g</text><rect x="165" y="85" width="70" height="14" rx="3" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><rect x="183" y="55" width="34" height="20" rx="2" fill="none" stroke="#0f1f3d" stroke-width="2"/><text x="200" y="69" font-size="9" font-weight="700" fill="#0f1f3d" text-anchor="middle">42 kg</text><text x="200" y="112" font-size="11" font-weight="700" fill="#0f1f3d" text-anchor="middle">Badkamerskaal</text><polygon points="335,75 322,97 348,97" fill="none" stroke="#0f1f3d" stroke-width="2"/><line x1="292" y1="92" x2="378" y2="58" stroke="#0f1f3d" stroke-width="2.5"/><line x1="292" y1="92" x2="292" y2="108" stroke="#dc2626" stroke-width="1.5"/><rect x="276" y="108" width="32" height="13" fill="none" stroke="#dc2626" stroke-width="2"/><line x1="378" y1="58" x2="378" y2="74" stroke="#16a34a" stroke-width="1.5"/><rect x="362" y="74" width="32" height="13" fill="none" stroke="#16a34a" stroke-width="2"/><text x="292" y="135" font-size="10" font-weight="700" fill="#dc2626" text-anchor="middle">swaarder</text><text x="378" y="42" font-size="10" font-weight="700" fill="#16a34a" text-anchor="middle">ligter</text><text x="335" y="148" font-size="11" font-weight="700" fill="#0f1f3d" text-anchor="middle">Balansskaal</text></svg>',

      videoPlaceholder:
        'Kort video wat wys hoe om ʼn kombuisskaal te lees deur skaalmerke te identifiseer en spasies te tel, en hoe ʼn balansskaal aandui watter voorwerp swaarder is',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Kort video wat wys hoe om massametings op te tel, af te trek en te vermenigvuldig deur eers na dieselfde eenheid om te skakel en dan te bereken met kleurgekodeerde stappe',
    },
  ],
  resultsConfig: {
    totalMarks: 12,
  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      name: 'Stel 1',
      questions: [
        { difficulty: 'Easy', question: 'Watter eenheid sal jy gebruik om die massa van ʼn enkele appel te meet: g of kg?', checkMode: 'auto', correctAnswer: 'g', correctAnswers: ['g', 'gram'], explanation: 'ʼn Appel is ʼn ligte voorwerp, dus is gram (g) die sinvolle eenheid. Kilogram sou ʼn ongemaklike, baie klein desimale getal gee.' },
        ...
        { difficulty: 'Easy', question: 'ʼn Bouer kies ʼn eenheid om een sak sement op ʼn afleweringslys te merk. Hy kies gram omdat "gram altyd die veiligste keuse is." Is hy korrek? Verduidelik.', checkMode: 'self', answer: 'Nee, hy is nie korrek nie. Een sak sement het ʼn massa van ongeveer 25 tot 50 kg, wat ʼn sinvolle getal in kilogram is. In gram sou dit ʼn onnodig groot getal soos 25 000 g wees. Kilogram is die regte eenheid vir een sak sement.' },
        { difficulty: 'Easy', question: 'ʼn Fiets het ʼn massa van ongeveer 12 kg en ʼn sak suiker het ʼn massa van ongeveer 2 kg. As jy albei massas met DIESELFDE eenheid moes beskryf sodat die getalle maklik bly om te lees, sou gram of kilogram beter werk, en waarom?', checkMode: 'self', answer: 'Kilogram werk goed vir albei — die fiets is 12 kg en die sak suiker is 2 kg, en albei getalle is maklik om te lees en te vergelyk. In gram sou albei getalle steeds werk (12 000 g en 2 000 g) maar hulle sou onnodig lank wees om te skryf, dus is kilogram die sinvoller gedeelde eenheid hier.' },
        ...
        { difficulty: 'Medium', question: 'ʼn Vragmotor se vrag het ʼn massa van 5 250 000 g. Wat is hierdie massa in kilogram?', checkMode: 'auto', correctAnswer: '5250kg', correctAnswers: ['5250kg', '5250 kg', '5 250 kg', '5250'], explanation: 'Skakel g om na kg deur deur 1 000 te deel: 5 250 000 ÷ 1 000 = 5 250 kg.' },
        ...
        { difficulty: 'Medium', question: 'ʼn Leerder sê ʼn vol waterbottel behoort in kilogram gemeet te word omdat "kilogram die regte wetenskaplike eenheid is." Is hierdie redenasie geldig? Verduidelik wat verkeerd is daarmee.', checkMode: 'self', answer: 'Nee, hierdie redenasie is nie geldig nie. Daar is nie ʼn enkele "regte" eenheid vir elke meting nie — die beste eenheid is watter een ook al ʼn sinvolle, maklik-leesbare getal vir daardie spesifieke voorwerp gee. ʼn Vol waterbottel het ʼn massa van ongeveer 1 kg (of 1 000 g) — beide gram en kilogram gee hier ʼn sinvolle aflesing, dus kan albei redelik wees, maar die redenasie "kilogram is die regte eenheid" bly steeds gebrekkig as ʼn algemene reël.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      name: 'Stel 2',
      questions: [
        { difficulty: 'Easy', question: 'Watter eenheid sal jy gebruik om die massa van ʼn korrel rys te meet: g of kg?', checkMode: 'auto', correctAnswer: 'g', correctAnswers: ['g', 'gram'], explanation: 'ʼn Enkele korrel rys is uiters lig, dus is gram (g) die sinvolle eenheid. Kilogram sou ʼn ongemaklike, baie klein desimale getal gee.' },
        { difficulty: 'Easy', question: 'Thabo tel ʼn mango op en wil dit weeg. Watter eenheid gee die sinvolste aflesing vir die massa daarvan — gram of kilogram?', checkMode: 'auto', correctAnswer: 'g', correctAnswers: ['g', 'gram'], explanation: 'ʼn Mango het ʼn massa van ʼn paar honderd gram, dus gee gram (g) ʼn sinvolle aflesing. Kilogram sou ʼn ongemaklike klein desimale getal gee.' },
        { difficulty: 'Easy', question: 'ʼn Reisiger kies ʼn eenheid om die massa van haar gepakte tas vir die lugredery aan te teken. Sy kies gram omdat "gram altyd die veiligste keuse is." Is sy korrek? Verduidelik.', checkMode: 'self', answer: 'Nee, sy is nie korrek nie. ʼn Gepakte tas het ʼn massa van ongeveer 15 tot 25 kg, wat ʼn sinvolle getal in kilogram is. In gram sou dit ʼn onnodig groot getal soos 20 000 g wees. Kilogram is die regte eenheid vir bagasie.' },
        { difficulty: 'Easy', question: 'ʼn Skooltas het ʼn massa van ongeveer 5 kg en ʼn sak aartappels het ʼn massa van ongeveer 8 kg. As ʼn onderwyser albei massas met dieselfde eenheid wou vergelyk sonder om by lomp getalle uit te kom, sou gram of kilogram beter werk, en waarom?', checkMode: 'self', answer: 'Kilogram werk beter vir albei. In kilogram is die twee massas eenvoudig 5 kg en 8 kg, wat maklik direk vergelyk kan word. In gram sou hulle 5 000 g en 8 000 g wees — korrek, maar onnodig lank om te skryf en te vergelyk.' },
        ...
        { difficulty: 'Medium', question: 'ʼn Aflewering skroewe het ʼn massa van 8 400 g. Wat is hierdie massa in kilogram?', checkMode: 'auto', correctAnswer: '8,4kg', correctAnswers: ['8.4kg', '8.4 kg', '8.4', '8.40kg', '8.40 kg', '8,4kg', '8,4 kg', '8,40kg', '8,40 kg'], explanation: 'Skakel g om na kg deur deur 1 000 te deel: 8 400 ÷ 1 000 = 8,4 kg.' },
        ...
        { difficulty: 'Medium-Hard', question: 'ʼn Resep vra vir 250 g botter. Bongani sê hy kan sy kombuisskaal op kilogram stel en net "0,25" aflees sonder om ʼn eenheid by te voeg, aangesien "almal sal weet wat dit beteken." Verduidelik waarom dit ʼn probleem kan wees.', checkMode: 'self', answer: 'Om die eenheid weg te laat is riskant omdat "0,25" alleen geen aanduiding gee of dit 0,25 g of 0,25 kg beteken nie — dit is baie verskillende hoeveelhede. Verwarring tussen gram en kilogram kan beteken dat 1 000 keer te veel of te min botter gebruik word. Om altyd die volledige meting met sy eenheid neer te skryf (0,25 kg, wat gelyk is aan 250 g) verwyder hierdie risiko.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      name: 'Stel 3',
      questions: [
        { difficulty: 'Easy', question: 'Watter eenheid sal jy gebruik om die massa van ʼn enkele knoop te meet: g of kg?', checkMode: 'auto', correctAnswer: 'g', correctAnswers: ['g', 'gram'], explanation: 'ʼn Knoop is ʼn ligte voorwerp, dus is gram (g) die sinvolle eenheid. Kilogram sou ʼn onnodig klein desimale getal gee vir so ʼn klein voorwerp.' },
        ...
        { difficulty: 'Easy', question: 'ʼn Winkelier kies ʼn eenheid om die massa van ʼn aflewering van 200 brode aan te teken. Hy kies gram omdat "gram meer presies as kilogram is." Is dit ʼn sinvolle keuse? Verduidelik.', checkMode: 'self', answer: 'Nee, dit is nie ʼn sinvolle keuse nie. ʼn Aflewering van 200 brode het ʼn massa van baie duisende gram, dus sou dit in gram aangeteken ʼn lang, moeilik-leesbare getal gee. Kilogram is die sinvolle eenheid vir iets so swaar — "meer presies" maak nie saak as die getal te onhanteerbaar is om te lees of te vergelyk nie.' },
        { difficulty: 'Easy', question: 'ʼn Potlood het ʼn massa van ongeveer 5 g en ʼn sak sement het ʼn massa van ongeveer 25 kg. Verduidelik waarom dit nie sin sou maak om albei voorwerpe met dieselfde eenheid van massa te beskryf nie.', checkMode: 'self', answer: 'Om dieselfde eenheid vir albei te gebruik, sou minstens een getal baie ongemaklik maak om te lees. As gram vir albei gebruik word, sou die sak sement 25 000 g wees, ʼn onnodig groot getal. As kilogram vir albei gebruik word, sou die potlood ongeveer 0,005 kg wees, ʼn ongemaklike klein desimale getal. Omdat die potlood en die sak sement so baie in grootte verskil, benodig elkeen sy eie sinvolle eenheid — gram vir die potlood en kilogram vir die sement — eerder as om een te deel.' },
        ...
        { difficulty: 'Medium', question: 'ʼn Groep skryfbehoeftes het ʼn totale massa van 3 600 g. Wat is hierdie massa in kilogram?', checkMode: 'auto', correctAnswer: '3,6kg', correctAnswers: ['3.6kg', '3.6 kg', '3.60kg', '3.60 kg', '3,6kg', '3,6 kg', '3,60kg', '3,60 kg'], explanation: 'Skakel g om na kg deur deur 1 000 te deel: 3 600 ÷ 1 000 = 3,6 kg.' },
        ...
        { difficulty: 'Medium', question: 'ʼn Leerder sê ʼn sak sement behoort in gram gemeet te word omdat "kleiner eenhede altyd meer akkuraat is." Is hierdie redenasie geldig? Verduidelik wat verkeerd is daarmee.', checkMode: 'self', answer: 'Nee, hierdie redenasie is nie geldig nie. ʼn Kleiner eenheid maak ʼn meting nie outomaties meer akkuraat nie — dit verander net hoe groot die getal lyk. ʼn Sak sement het ʼn massa van etlike kilogram, dus sou dit in gram gemeet ʼn onnodig groot getal gee, soos 25 000 g in plaas van 25 kg. Kilogram is die sinvolle eenheid vir ʼn voorwerp van hierdie grootte.' },
        { difficulty: 'Medium', question: 'Palesa sê om 4,5 kg na gram om te skakel, deel jy deur 1 000, wat 0,0045 g gee. Is Palesa korrek? Verduidelik die fout.', checkMode: 'self', answer: 'Nee, Palesa is verkeerd. Om van kilogram (ʼn groter eenheid) na gram (ʼn kleiner eenheid) om te skakel, moet jy met 1 000 vermenigvuldig, nie deel nie. Die korrekte berekening is 4,5 × 1 000 = 4 500 g. Palesa het die verkeerde bewerking gebruik, en deling het ook die getal in die verkeerde rigting laat beweeg — om na ʼn kleiner eenheid om te skakel, behoort die getal groter te maak, nie kleiner nie.' },
        { difficulty: 'Medium-Hard', question: 'ʼn Baba benodig 120 g aanvullingsvoeding per voeding. ʼn Ouer sê hulle kan net "0,12" op ʼn kilogramskaal meet en die eenheid weglaat, want "dit is voor die hand liggend kilogram." Verduidelik waarom dit riskant is om die eenheid weg te laat.', checkMode: 'self', answer: 'Om die eenheid weg te laat is riskant omdat "0,12" alleen geen aanduiding gee of dit 0,12 g of 0,12 kg beteken nie — dit is baie verskillende hoeveelhede. Vir ʼn baba se voeding kan verwarring tussen gram en kilogram beteken dat ʼn hoeveelheid berei word wat 1 000 keer te veel of te min is. Om altyd die volledige meting met sy eenheid neer te skryf (0,12 kg, wat gelyk is aan 120 g) vermy hierdie verwarring.' },
