...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Kort video wat die verskil tussen 2D-vorms en 3D-voorwerpe verduidelik en wys hoe om vlakke, rande en hoekpunte op ʼn kubus te tel',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Kort video wat die verskil tussen prismas en piramides verduidelik en wys hoe om vlakke, rande en hoekpunte op ʼn driehoekige prisma en ʼn vierkantige piramide te tel',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      explanation:
        ...
        `<p style="color:#6b7280;font-size:13px;margin:0;">Voorbeeld: ʼn blik of ʼn drom.</p>` +
        `</div>` +
        ...
        `<p style="color:#6b7280;font-size:13px;margin:0;">Voorbeeld: ʼn roomyshorinkie of ʼn partytjiehoed.</p>` +
        `</div>` +
  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'ʼn Roomyshorinkie het een plat sirkelvormige bokant en kom tot ʼn punt onderaan. Noem hierdie 3D-voorwerp.', answer: 'keël', checkMode: 'auto', correctAnswer: 'keël', correctAnswers: ['keël', 'ʼn keël', 'keel', 'ʼn keel'], explanation: 'ʼn Keël het 1 plat sirkelvormige vlak, 1 geboë oppervlak en kom tot ʼn punt genoem die apeks.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'ʼn Blik verf (ʼn silinder) en ʼn roomyshorinkie word vergelyk. Hoeveel geboë oppervlakke het elke voorwerp?', answer: '', checkMode: 'auto', parts: [
