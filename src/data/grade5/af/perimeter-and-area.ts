...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        'ʼn Reghoek met sylengtes 10cm en 6cm geëtiketteer in blou, en die omtrekberekening uitgeskryf in groen met die antwoord in oranje',
      diagramSvg:
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        'ʼn Reghoek met die lengte (8cm) geëtiketteer in blou en die breedte (5cm) geëtiketteer in rooi, met die oppervlakteformule in groen en die antwoord in oranje',
      diagramSvg:
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        'ʼn Reghoek en ʼn vierkant langs mekaar wat wys dat die lang dun reghoek ʼn groter omtrek (blou) het maar ʼn kleiner oppervlakte (rooi), met lengte-eenhede in groen en vierkante eenhede in oranje',
      diagramSvg:
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        'ʼn L-vormige kamer verdeel in Reghoek A (geëtiketteer in blou) en Reghoek B (geëtiketteer in groen), met die totale-oppervlakte-formule uitgeskryf in oranje',
      diagramSvg:
        '<svg viewBox="0 0 235 150" xmlns="http://www.w3.org/2000/svg"><polygon points="20,20 140,20 140,60 70,60 70,110 20,110" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="20" y1="60" x2="70" y2="60" stroke="#0f1f3d" stroke-width="1.5" stroke-dasharray="4,3"/><text x="105" y="14" font-size="11" font-weight="700" fill="#2563eb" text-anchor="middle">Reghoek A</text><text x="45" y="128" font-size="11" font-weight="700" fill="#16a34a" text-anchor="middle">Reghoek B</text><text x="190" y="60" font-size="12" font-weight="700" fill="#ea580c" text-anchor="middle">Totale</text><text x="190" y="76" font-size="12" font-weight="700" fill="#ea580c" text-anchor="middle">oppervlakte</text><text x="190" y="92" font-size="12" font-weight="700" fill="#ea580c" text-anchor="middle">= A + B</text></svg>',
  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'ʼn Reghoekige kennisgewingbord is 11cm lank en 7cm breed. Vind beide die omtrek en die oppervlakte.', answer: 'Omtrek = 36cm, Oppervlakte = 77cm²', checkMode: 'auto', correctAnswer: '36cm77cm²', correctAnswers: ['36cm77cm²', '36cm, 77cm²', 'O36A77', 'O36Opp77', 'omtrek36oppervlakte77'], explanation: 'Omtrek = 11 + 11 + 7 + 7 = 36cm.\nOppervlakte = 11 × 7 = 77cm² ✓' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'ʼn Reghoekige venster is 13cm lank en 6cm breed. Vind beide die omtrek en die oppervlakte.', answer: 'Omtrek = 38cm, Oppervlakte = 78cm²', checkMode: 'auto', correctAnswer: '38cm78cm²', correctAnswers: ['38cm78cm²', '38cm, 78cm²', 'O38A78', 'O38Opp78', 'omtrek38oppervlakte78'], explanation: 'Omtrek = 13 + 13 + 6 + 6 = 38cm.\nOppervlakte = 13 × 6 = 78cm² ✓' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'ʼn Reghoekige lessenaar is 180cm lank en 90cm breed. Vind sy omtrek.', answer: '540cm', checkMode: 'auto', correctAnswer: '540cm', correctAnswers: ['540cm', '540 cm'], explanation: 'Omtrek = 180 + 180 + 90 + 90 = 540cm ✓' },
        ...
        { difficulty: 'Medium', question: 'ʼn Vierkantige mat het ʼn oppervlakte van 2,25m². Wat is die lengte van elke sy?', answer: '1,5m', checkMode: 'auto', correctAnswer: '1,5m', correctAnswers: ['1,5m', '1,5 m'], explanation: 'Oppervlakte van vierkant = sy × sy.\n2,25 = sy².\nSy = √2,25 = 1,5m ✓' },
        { difficulty: 'Medium', question: 'ʼn Reghoekige witbord is 16cm lank en 9cm breed. Vind beide die omtrek en die oppervlakte.', answer: 'Omtrek = 50cm, Oppervlakte = 144cm²', checkMode: 'auto', correctAnswer: '50cm144cm²', correctAnswers: ['50cm144cm²', '50cm, 144cm²', 'O50A144', 'O50Opp144', 'omtrek50oppervlakte144'], explanation: 'Omtrek = 16 + 16 + 9 + 9 = 50cm.\nOppervlakte = 16 × 9 = 144cm² ✓' },
