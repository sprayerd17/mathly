  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'Priya kyk na ʼn vlieërvorm wat in die lug vlieg — ʼn diamantagtige vorm met ʼn lang vertikale diagonaal en ʼn korter horisontale diagonaal. Hoeveel simmetrielyne het hierdie vlieërvorm?', checkMode: 'auto', correctAnswer: '1', correctAnswers: ['1', 'een'], explanation: 'ʼn Tipiese vlieërvorm het net 1 simmetrielyn — die lang diagonaal van bo na onder. Die kort diagonaal skep nie bypassende helftes nie, omdat die boonste en onderste driehoeke verskillende groottes het.' },
