...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video explaining decimal fractions including place value of tenths and hundredths how to read and write decimals and how decimals relate to common fractions with denominators 10 and 100',
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video showing how to compare and order decimal fractions by lining up decimal points and comparing place by place from units to tenths to hundredths including a worked example of the common misconception that more digits means a bigger number',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video demonstrating how to add and subtract decimal fractions using the column method by lining up decimal points then adding or subtracting digit by digit from right to left with carrying when totals reach 10 or more and borrowing when top digits are too small',
      ...
      diagramSvg: '<svg viewBox="0 0 220 130" xmlns="http://www.w3.org/2000/svg"><text x="52" y="10" font-weight="700" font-size="11" text-anchor="middle" fill="#0f1f3d">2.47 + 1.85</text><text x="35" y="20" font-weight="700" font-size="11" text-anchor="middle" fill="#ea580c">1</text><text x="65" y="20" font-weight="700" font-size="11" text-anchor="middle" fill="#ea580c">1</text><text x="35" y="34" font-weight="700" font-size="15" text-anchor="middle" fill="#0f1f3d">2</text><text x="50" y="34" font-weight="700" font-size="15" text-anchor="middle" fill="#dc2626">.</text><text x="65" y="34" font-weight="700" font-size="15" text-anchor="middle" fill="#16a34a">4</text><text x="80" y="34" font-weight="700" font-size="15" text-anchor="middle" fill="#2563eb">7</text><text x="15" y="50" font-weight="700" font-size="15" text-anchor="middle" fill="#0f1f3d">+</text><text x="35" y="50" font-weight="700" font-size="15" text-anchor="middle" fill="#0f1f3d">1</text><text x="50" y="50" font-weight="700" font-size="15" text-anchor="middle" fill="#dc2626">.</text><text x="65" y="50" font-weight="700" font-size="15" text-anchor="middle" fill="#16a34a">8</text><text x="80" y="50" font-weight="700" font-size="15" text-anchor="middle" fill="#2563eb">5</text><line x1="15" y1="56" x2="90" y2="56" stroke="#0f1f3d" stroke-width="2"/><text x="35" y="72" font-weight="700" font-size="16" text-anchor="middle" fill="#0f1f3d">4</text><text x="50" y="72" font-weight="700" font-size="16" text-anchor="middle" fill="#dc2626">.</text><text x="65" y="72" font-weight="700" font-size="16" text-anchor="middle" fill="#16a34a">3</text><text x="80" y="72" font-weight="700" font-size="16" text-anchor="middle" fill="#2563eb">2</text><text x="167" y="10" font-weight="700" font-size="11" text-anchor="middle" fill="#0f1f3d">3.24 − 1.57</text><text x="150" y="20" font-weight="700" font-size="10" text-anchor="middle" fill="#ea580c">2</text><text x="180" y="20" font-weight="700" font-size="10" text-anchor="middle" fill="#ea580c">11</text><text x="195" y="20" font-weight="700" font-size="10" text-anchor="middle" fill="#ea580c">14</text><text x="150" y="34" font-weight="700" font-size="15" text-anchor="middle" fill="#0f1f3d">3</text><text x="165" y="34" font-weight="700" font-size="15" text-anchor="middle" fill="#dc2626">.</text><text x="180" y="34" font-weight="700" font-size="15" text-anchor="middle" fill="#16a34a">2</text><text x="195" y="34" font-weight="700" font-size="15" text-anchor="middle" fill="#2563eb">4</text><text x="130" y="50" font-weight="700" font-size="15" text-anchor="middle" fill="#0f1f3d">−</text><text x="150" y="50" font-weight="700" font-size="15" text-anchor="middle" fill="#0f1f3d">1</text><text x="165" y="50" font-weight="700" font-size="15" text-anchor="middle" fill="#dc2626">.</text><text x="180" y="50" font-weight="700" font-size="15" text-anchor="middle" fill="#16a34a">5</text><text x="195" y="50" font-weight="700" font-size="15" text-anchor="middle" fill="#2563eb">7</text><line x1="130" y1="56" x2="205" y2="56" stroke="#0f1f3d" stroke-width="2"/><text x="150" y="72" font-weight="700" font-size="16" text-anchor="middle" fill="#0f1f3d">1</text><text x="165" y="72" font-weight="700" font-size="16" text-anchor="middle" fill="#dc2626">.</text><text x="180" y="72" font-weight="700" font-size="16" text-anchor="middle" fill="#16a34a">6</text><text x="195" y="72" font-weight="700" font-size="16" text-anchor="middle" fill="#2563eb">7</text><text x="110" y="92" font-size="10" text-anchor="middle" fill="#6b7280"><tspan x="110" dy="0">red = decimal point</tspan><tspan x="110" dy="13">green = tenths</tspan><tspan x="110" dy="13">blue = hundredths</tspan></text></svg>',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video showing how to convert between fractions decimals and percentages with colour coded examples fractions in blue decimals in green and percentages in red',
    },
  ],
  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'Order from largest to smallest: 0.3, 0.03, 0.33, 0.31', answer: '0.33, 0.31, 0.3, 0.03', checkMode: 'auto', correctAnswer: '0.33, 0.31, 0.3, 0.03', correctAnswers: ['0.33, 0.31, 0.3, 0.03', '0.33, 0.31, 0.30, 0.03'], explanation: 'Write with 2 decimal places: 0.30, 0.03, 0.33, 0.31. Compare tenths: 0.03 has 0 tenths (smallest); the rest have 3 tenths. Among the 3-tenths group, compare hundredths: 0.33 has 3 hundredths (largest), 0.31 has 1 hundredth, 0.30 has 0 hundredths (smallest of that group). Order from largest to smallest: 0.33, 0.31, 0.3, 0.03 ✓' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium-Hard', question: 'Lindiwe scored 19/25 in a practical test. Write her score as a decimal fraction.', answer: '0.76', checkMode: 'auto', correctAnswer: '0.76', explanation: '19/25 needs to be converted to a fraction with denominator 100: multiply the numerator and denominator by 4 (since 25 × 4 = 100): 19/25 = 76/100 = 0.76 ✓' },
