...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        '<DiagramPlaceholder label="Place value chart showing units in blue tenths in green and hundredths in red with the example number 3.47 colour coded in each column and the fraction equivalent shown below each digit" />',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        '<DiagramPlaceholder label="Column arithmetic diagrams showing 2.47 plus 1.85 equals 4.32 with carry arrows and 3.24 minus 1.57 equals 1.67 with borrow arrows decimal point highlighted in red tenths in green and hundredths in blue" />',
    },
