...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        '<DiagramPlaceholder label="Diagram of a vertical thermometer scale from 0 to 100 degrees Celsius, with the freezing point, boiling point and average human body temperature labelled and the liquid level shown at a sample reading" />',
    },
