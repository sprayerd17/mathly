...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        'Diagram showing common 2D shapes — square rectangle triangle and circle — each labelled with the number of sides in orange and corners in green',
      diagramSvg:
        '<svg viewBox="0 0 440 170" xmlns="http://www.w3.org/2000/svg"><rect x="15" y="20" width="70" height="70" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><circle cx="15" cy="20" r="3.5" fill="#16a34a"/><circle cx="85" cy="20" r="3.5" fill="#16a34a"/><circle cx="15" cy="90" r="3.5" fill="#16a34a"/><circle cx="85" cy="90" r="3.5" fill="#16a34a"/><text x="50" y="112" font-weight="700" font-size="12" text-anchor="middle" fill="#ea580c">4 sides</text><text x="50" y="128" font-weight="700" font-size="12" text-anchor="middle" fill="#16a34a">4 corners</text><text x="50" y="150" font-weight="700" font-size="13" text-anchor="middle" fill="#0f1f3d">Square</text><rect x="110" y="30" width="100" height="60" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><circle cx="110" cy="30" r="3.5" fill="#16a34a"/><circle cx="210" cy="30" r="3.5" fill="#16a34a"/><circle cx="110" cy="90" r="3.5" fill="#16a34a"/><circle cx="210" cy="90" r="3.5" fill="#16a34a"/><text x="160" y="112" font-weight="700" font-size="12" text-anchor="middle" fill="#ea580c">4 sides</text><text x="160" y="128" font-weight="700" font-size="12" text-anchor="middle" fill="#16a34a">4 corners</text><text x="160" y="150" font-weight="700" font-size="13" text-anchor="middle" fill="#0f1f3d">Rectangle</text><polygon points="230,90 300,90 265,20" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><circle cx="230" cy="90" r="3.5" fill="#16a34a"/><circle cx="300" cy="90" r="3.5" fill="#16a34a"/><circle cx="265" cy="20" r="3.5" fill="#16a34a"/><text x="265" y="112" font-weight="700" font-size="12" text-anchor="middle" fill="#ea580c">3 sides</text><text x="265" y="128" font-weight="700" font-size="12" text-anchor="middle" fill="#16a34a">3 corners</text><text x="265" y="150" font-weight="700" font-size="13" text-anchor="middle" fill="#0f1f3d">Triangle</text><circle cx="370" cy="55" r="35" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="370" y="112" font-weight="700" font-size="12" text-anchor="middle" fill="#ea580c">1 curved side</text><text x="370" y="128" font-weight="700" font-size="12" text-anchor="middle" fill="#16a34a">0 corners</text><text x="370" y="150" font-weight="700" font-size="13" text-anchor="middle" fill="#0f1f3d">Circle</text></svg>',

      videoPlaceholder:
        'Short video introducing 2D shapes showing how to identify sides and corners and describe common shapes like squares rectangles triangles and circles',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        'Diagram showing the three types of triangles — equilateral with 3 equal sides in green isosceles with 2 equal sides in green and 1 different side in red scalene with all sides in red — each labelled with side lengths',
      diagramSvg:
        '<svg viewBox="0 0 460 200" xmlns="http://www.w3.org/2000/svg"><line x1="75" y1="78" x2="35" y2="148" stroke="#16a34a" stroke-width="2.5"/><line x1="35" y1="148" x2="115" y2="148" stroke="#16a34a" stroke-width="2.5"/><line x1="115" y1="148" x2="75" y2="78" stroke="#16a34a" stroke-width="2.5"/><text x="16" y="118" font-weight="700" font-size="11" fill="#16a34a">5cm</text><text x="118" y="118" font-weight="700" font-size="11" fill="#16a34a">5cm</text><text x="60" y="168" font-weight="700" font-size="11" fill="#16a34a">5cm</text><text x="75" y="188" font-weight="700" font-size="12" text-anchor="middle" fill="#0f1f3d">Equilateral</text><line x1="230" y1="78" x2="190" y2="148" stroke="#16a34a" stroke-width="2.5"/><line x1="190" y1="148" x2="270" y2="148" stroke="#dc2626" stroke-width="2.5"/><line x1="270" y1="148" x2="230" y2="78" stroke="#16a34a" stroke-width="2.5"/><text x="171" y="118" font-weight="700" font-size="11" fill="#16a34a">4cm</text><text x="273" y="118" font-weight="700" font-size="11" fill="#16a34a">4cm</text><text x="215" y="168" font-weight="700" font-size="11" fill="#dc2626">3cm</text><text x="230" y="188" font-weight="700" font-size="12" text-anchor="middle" fill="#0f1f3d">Isosceles</text><line x1="340" y1="68" x2="320" y2="148" stroke="#dc2626" stroke-width="2.5"/><line x1="320" y1="148" x2="420" y2="148" stroke="#dc2626" stroke-width="2.5"/><line x1="420" y1="148" x2="340" y2="68" stroke="#dc2626" stroke-width="2.5"/><text x="288" y="112" font-weight="700" font-size="11" fill="#dc2626">3cm</text><text x="378" y="100" font-weight="700" font-size="11" fill="#dc2626">5cm</text><text x="360" y="168" font-weight="700" font-size="11" fill="#dc2626">4cm</text><text x="370" y="188" font-weight="700" font-size="12" text-anchor="middle" fill="#0f1f3d">Scalene</text></svg>',

      videoPlaceholder:
        'Short video explaining the three types of triangles — equilateral isosceles and scalene — and how to identify each by counting equal sides',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        'Diagram showing five types of quadrilaterals — square rectangle rhombus parallelogram and trapezium — with equal sides marked in green and right angles marked in orange',
      diagramSvg:
        '<svg viewBox="0 0 460 260" xmlns="http://www.w3.org/2000/svg"><rect x="20" y="20" width="70" height="70" fill="none" stroke="#16a34a" stroke-width="2.5"/><path d="M 20 32 L 32 32 L 32 20" fill="none" stroke="#ea580c" stroke-width="1.8"/><path d="M 90 78 L 78 78 L 78 90" fill="none" stroke="#ea580c" stroke-width="1.8"/><text x="55" y="112" font-weight="700" font-size="13" text-anchor="middle" fill="#0f1f3d">Square</text><rect x="130" y="30" width="100" height="50" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="176" y1="26" x2="184" y2="34" stroke="#16a34a" stroke-width="2"/><line x1="176" y1="76" x2="184" y2="84" stroke="#16a34a" stroke-width="2"/><line x1="126" y1="47" x2="134" y2="55" stroke="#16a34a" stroke-width="2"/><line x1="126" y1="55" x2="134" y2="63" stroke="#16a34a" stroke-width="2"/><line x1="226" y1="47" x2="234" y2="55" stroke="#16a34a" stroke-width="2"/><line x1="226" y1="55" x2="234" y2="63" stroke="#16a34a" stroke-width="2"/><path d="M 130 40 L 140 40 L 140 30" fill="none" stroke="#ea580c" stroke-width="1.8"/><path d="M 230 40 L 220 40 L 220 30" fill="none" stroke="#ea580c" stroke-width="1.8"/><text x="180" y="112" font-weight="700" font-size="13" text-anchor="middle" fill="#0f1f3d">Rectangle</text><polygon points="320,20 375,55 320,90 265,55" fill="none" stroke="#16a34a" stroke-width="2.5"/><text x="320" y="112" font-weight="700" font-size="13" text-anchor="middle" fill="#0f1f3d">Rhombus</text><polygon points="85,150 185,150 160,220 60,220" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="128" y1="146" x2="136" y2="154" stroke="#16a34a" stroke-width="2"/><line x1="135" y1="146" x2="143" y2="154" stroke="#16a34a" stroke-width="2"/><line x1="103" y1="216" x2="111" y2="224" stroke="#16a34a" stroke-width="2"/><line x1="110" y1="216" x2="118" y2="224" stroke="#16a34a" stroke-width="2"/><line x1="70" y1="181" x2="78" y2="189" stroke="#16a34a" stroke-width="2"/><line x1="176" y1="181" x2="184" y2="189" stroke="#16a34a" stroke-width="2"/><text x="122" y="245" font-weight="700" font-size="13" text-anchor="middle" fill="#0f1f3d">Parallelogram</text><polygon points="310,150 370,150 400,220 280,220" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="340" y="245" font-weight="700" font-size="13" text-anchor="middle" fill="#0f1f3d">Trapezium</text></svg>',

      videoPlaceholder:
        'Short video explaining the five types of quadrilaterals and how to identify each by checking equal sides and right angles',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        'Diagram of a circle with the centre marked in orange the radius labelled in blue the diameter labelled in red and the circumference labelled in green',
      diagramSvg:
        '<svg viewBox="0 0 220 170" xmlns="http://www.w3.org/2000/svg"><circle cx="110" cy="85" r="65" fill="none" stroke="#16a34a" stroke-width="2.5"/><line x1="45" y1="85" x2="175" y2="85" stroke="#dc2626" stroke-width="2.5"/><line x1="110" y1="85" x2="110" y2="20" stroke="#2563eb" stroke-width="2.5"/><circle cx="110" cy="85" r="4" fill="#ea580c"/><text x="118" y="52" font-weight="700" font-size="12" fill="#2563eb">radius</text><text x="110" y="160" font-weight="700" font-size="12" text-anchor="middle" fill="#dc2626">diameter</text><text x="122" y="80" font-weight="700" font-size="11" fill="#ea580c">centre</text><text x="110" y="13" font-weight="700" font-size="11" text-anchor="middle" fill="#16a34a">circumference</text></svg>',

      videoPlaceholder:
        'Short video introducing circles and explaining the centre radius diameter and circumference with examples of finding the diameter from the radius and vice versa',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        'Diagram showing five 2D shapes — triangle square rectangle rhombus and pentagon — sorted into groups by number of sides with right angles marked in orange and side counts in green',
      diagramSvg:
        '<svg viewBox="0 0 460 200" xmlns="http://www.w3.org/2000/svg"><line x1="290" y1="15" x2="290" y2="175" stroke="#94a3b8" stroke-width="1.5" stroke-dasharray="5,4"/><text x="150" y="22" font-weight="700" font-size="13" text-anchor="middle" fill="#16a34a">4 sides</text><text x="375" y="22" font-weight="700" font-size="13" text-anchor="middle" fill="#64748b">Other side counts</text><rect x="30" y="40" width="55" height="55" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 30 52 L 42 52 L 42 40" fill="none" stroke="#ea580c" stroke-width="1.8"/><text x="57" y="112" font-weight="700" font-size="12" text-anchor="middle" fill="#16a34a">4</text><text x="57" y="128" font-weight="700" font-size="11" text-anchor="middle" fill="#0f1f3d">Square</text><rect x="110" y="50" width="80" height="40" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 110 60 L 122 60 L 122 50" fill="none" stroke="#ea580c" stroke-width="1.8"/><text x="150" y="112" font-weight="700" font-size="12" text-anchor="middle" fill="#16a34a">4</text><text x="150" y="128" font-weight="700" font-size="11" text-anchor="middle" fill="#0f1f3d">Rectangle</text><polygon points="230,41 257,68 230,95 203,68" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="230" y="112" font-weight="700" font-size="12" text-anchor="middle" fill="#16a34a">4</text><text x="230" y="128" font-weight="700" font-size="11" text-anchor="middle" fill="#0f1f3d">Rhombus</text><polygon points="320,95 360,95 340,40" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="340" y="112" font-weight="700" font-size="12" text-anchor="middle" fill="#16a34a">3</text><text x="340" y="128" font-weight="700" font-size="11" text-anchor="middle" fill="#0f1f3d">Triangle</text><polygon points="420,41 445.68,59.65 435.88,89.84 404.12,89.84 394.32,59.65" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="420" y="112" font-weight="700" font-size="12" text-anchor="middle" fill="#16a34a">5</text><text x="420" y="128" font-weight="700" font-size="11" text-anchor="middle" fill="#0f1f3d">Pentagon</text></svg>',

      videoPlaceholder:
        'Short video showing how to sort and compare 2D shapes by their properties — number of sides right angles equal sides and lines of symmetry',
    },
  ],
  topicPractice: [
    // ── Q1 Easy ──────────────────────────────────────────────────────────────
  ...
  scoreMessages: [
    { minScore: 15, message: 'Outstanding! A perfect score — you have completely mastered 2D Shapes for Grade 5. Keep it up!' },
    { minScore: 11, message: 'Excellent work! You have a very strong grasp of 2D shapes. Review any missed parts and you will have it perfect.' },
