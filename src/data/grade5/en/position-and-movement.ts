...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        'Grid showing columns and rows with a position marked at column 2 row 3 and a compass rose showing North South East West',

      diagramSvg:
        '<svg viewBox="0 0 230 190" xmlns="http://www.w3.org/2000/svg"><text x="85" y="14" font-size="12" fill="#0f1f3d" font-weight="700" text-anchor="middle">Grid Position (2, 3)</text><line x1="30" y1="30" x2="30" y2="150" stroke="#9ca3af" stroke-width="1"/><line x1="70" y1="30" x2="70" y2="150" stroke="#9ca3af" stroke-width="1"/><line x1="110" y1="30" x2="110" y2="150" stroke="#9ca3af" stroke-width="1"/><line x1="150" y1="30" x2="150" y2="150" stroke="#9ca3af" stroke-width="1"/><line x1="30" y1="150" x2="150" y2="150" stroke="#9ca3af" stroke-width="1"/><line x1="30" y1="110" x2="150" y2="110" stroke="#9ca3af" stroke-width="1"/><line x1="30" y1="70" x2="150" y2="70" stroke="#9ca3af" stroke-width="1"/><line x1="30" y1="30" x2="150" y2="30" stroke="#9ca3af" stroke-width="1"/><line x1="30" y1="30" x2="30" y2="150" stroke="#0f1f3d" stroke-width="2"/><line x1="30" y1="150" x2="150" y2="150" stroke="#0f1f3d" stroke-width="2"/><text x="30" y="164" font-size="11" fill="#374151" text-anchor="middle">1</text><text x="70" y="164" font-size="11" fill="#374151" text-anchor="middle">2</text><text x="110" y="164" font-size="11" fill="#374151" text-anchor="middle">3</text><text x="150" y="164" font-size="11" fill="#374151" text-anchor="middle">4</text><text x="90" y="180" font-size="10" fill="#374151" text-anchor="middle">column</text><text x="22" y="154" font-size="11" fill="#374151" text-anchor="end">1</text><text x="22" y="114" font-size="11" fill="#374151" text-anchor="end">2</text><text x="22" y="74" font-size="11" fill="#374151" text-anchor="end">3</text><text x="22" y="34" font-size="11" fill="#374151" text-anchor="end">4</text><text x="10" y="90" font-size="10" fill="#374151" text-anchor="middle" transform="rotate(-90 10 90)">row</text><circle cx="70" cy="70" r="6" fill="#ea580c" stroke="#0f1f3d" stroke-width="1.5"/><text x="78" y="66" font-size="11" fill="#ea580c" font-weight="700">(2, 3)</text><line x1="185" y1="55" x2="185" y2="125" stroke="#16a34a" stroke-width="1.8"/><line x1="160" y1="90" x2="210" y2="90" stroke="#16a34a" stroke-width="1.8"/><path d="M 185,48 L 180,58 L 190,58 Z" fill="#16a34a"/><path d="M 185,132 L 180,122 L 190,122 Z" fill="#16a34a"/><path d="M 213,90 L 205,85 L 205,95 Z" fill="#16a34a"/><path d="M 157,90 L 165,85 L 165,95 Z" fill="#16a34a"/><circle cx="185" cy="90" r="2" fill="#0f1f3d"/><text x="185" y="42" font-size="11" fill="#16a34a" font-weight="700" text-anchor="middle">N</text><text x="185" y="146" font-size="11" fill="#16a34a" font-weight="700" text-anchor="middle">S</text><text x="219" y="94" font-size="11" fill="#16a34a" font-weight="700" text-anchor="start">E</text><text x="151" y="94" font-size="11" fill="#16a34a" font-weight="700" text-anchor="end">W</text></svg>',

      videoPlaceholder:
        'Short video showing how to describe position using direction words grid coordinates and compass directions',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        'Grid showing horizontal axis labelled 1 to 5 and vertical axis labelled 1 to 5 with a star marked at position (3, 4) and three dots forming a horizontal line at row 2',

      diagramSvg:
        '<svg viewBox="0 0 210 200" xmlns="http://www.w3.org/2000/svg"><text x="100" y="14" font-size="12" fill="#0f1f3d" font-weight="700" text-anchor="middle">Grid: Star at (3, 4)</text><line x1="28" y1="26" x2="28" y2="170" stroke="#9ca3af" stroke-width="1"/><line x1="64" y1="26" x2="64" y2="170" stroke="#9ca3af" stroke-width="1"/><line x1="100" y1="26" x2="100" y2="170" stroke="#9ca3af" stroke-width="1"/><line x1="136" y1="26" x2="136" y2="170" stroke="#9ca3af" stroke-width="1"/><line x1="172" y1="26" x2="172" y2="170" stroke="#9ca3af" stroke-width="1"/><line x1="28" y1="170" x2="172" y2="170" stroke="#9ca3af" stroke-width="1"/><line x1="28" y1="134" x2="172" y2="134" stroke="#9ca3af" stroke-width="1"/><line x1="28" y1="98" x2="172" y2="98" stroke="#9ca3af" stroke-width="1"/><line x1="28" y1="62" x2="172" y2="62" stroke="#9ca3af" stroke-width="1"/><line x1="28" y1="26" x2="172" y2="26" stroke="#9ca3af" stroke-width="1"/><line x1="28" y1="26" x2="28" y2="170" stroke="#2563eb" stroke-width="2"/><line x1="28" y1="170" x2="172" y2="170" stroke="#2563eb" stroke-width="2"/><text x="28" y="184" font-size="10" fill="#374151" text-anchor="middle">1</text><text x="64" y="184" font-size="10" fill="#374151" text-anchor="middle">2</text><text x="100" y="184" font-size="10" fill="#374151" text-anchor="middle">3</text><text x="136" y="184" font-size="10" fill="#374151" text-anchor="middle">4</text><text x="172" y="184" font-size="10" fill="#374151" text-anchor="middle">5</text><text x="100" y="197" font-size="9.5" fill="#2563eb" font-weight="700" text-anchor="middle">horizontal axis</text><text x="20" y="174" font-size="10" fill="#374151" text-anchor="end">1</text><text x="20" y="138" font-size="10" fill="#374151" text-anchor="end">2</text><text x="20" y="102" font-size="10" fill="#374151" text-anchor="end">3</text><text x="20" y="66" font-size="10" fill="#374151" text-anchor="end">4</text><text x="20" y="30" font-size="10" fill="#374151" text-anchor="end">5</text><text x="8" y="98" font-size="9.5" fill="#dc2626" font-weight="700" text-anchor="middle" transform="rotate(-90 8 98)">vertical axis</text><line x1="28" y1="134" x2="100" y2="134" stroke="#dc2626" stroke-width="2.5"/><circle cx="28" cy="134" r="5" fill="#ea580c" stroke="#0f1f3d" stroke-width="1"/><circle cx="64" cy="134" r="5" fill="#ea580c" stroke="#0f1f3d" stroke-width="1"/><circle cx="100" cy="134" r="5" fill="#ea580c" stroke="#0f1f3d" stroke-width="1"/><text x="64" y="150" font-size="9" fill="#dc2626" font-weight="700" text-anchor="middle">same row (row 2)</text><text x="100" y="70" font-size="20" fill="#ea580c" text-anchor="middle">&#9733;</text><text x="110" y="66" font-size="10" fill="#ea580c" font-weight="700" text-anchor="start">(3, 4)</text></svg>',

      videoPlaceholder:
        'Short video showing how to read and plot positions on a grid by going across first then up with examples at (3, 4) and a horizontal line at row 2',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        'Grid showing a path from starting position (2, 1) moving 3 steps right then 2 steps up to ending position (5, 3) with arrows and colour coded steps',

      diagramSvg:
        '<svg viewBox="0 0 210 200" xmlns="http://www.w3.org/2000/svg"><text x="100" y="14" font-size="11.5" fill="#0f1f3d" font-weight="700" text-anchor="middle">Path: (2, 1) &#8594; (5, 3)</text><line x1="28" y1="26" x2="28" y2="170" stroke="#9ca3af" stroke-width="1"/><line x1="56" y1="26" x2="56" y2="170" stroke="#9ca3af" stroke-width="1"/><line x1="84" y1="26" x2="84" y2="170" stroke="#9ca3af" stroke-width="1"/><line x1="112" y1="26" x2="112" y2="170" stroke="#9ca3af" stroke-width="1"/><line x1="140" y1="26" x2="140" y2="170" stroke="#9ca3af" stroke-width="1"/><line x1="168" y1="26" x2="168" y2="170" stroke="#9ca3af" stroke-width="1"/><line x1="28" y1="170" x2="168" y2="170" stroke="#9ca3af" stroke-width="1"/><line x1="28" y1="130" x2="168" y2="130" stroke="#9ca3af" stroke-width="1"/><line x1="28" y1="90" x2="168" y2="90" stroke="#9ca3af" stroke-width="1"/><line x1="28" y1="50" x2="168" y2="50" stroke="#9ca3af" stroke-width="1"/><line x1="28" y1="26" x2="28" y2="170" stroke="#0f1f3d" stroke-width="2"/><line x1="28" y1="170" x2="168" y2="170" stroke="#0f1f3d" stroke-width="2"/><text x="28" y="184" font-size="9" fill="#374151" text-anchor="middle">1</text><text x="56" y="184" font-size="9" fill="#374151" text-anchor="middle">2</text><text x="84" y="184" font-size="9" fill="#374151" text-anchor="middle">3</text><text x="112" y="184" font-size="9" fill="#374151" text-anchor="middle">4</text><text x="140" y="184" font-size="9" fill="#374151" text-anchor="middle">5</text><text x="168" y="184" font-size="9" fill="#374151" text-anchor="middle">6</text><text x="20" y="174" font-size="9" fill="#374151" text-anchor="end">1</text><text x="20" y="134" font-size="9" fill="#374151" text-anchor="end">2</text><text x="20" y="94" font-size="9" fill="#374151" text-anchor="end">3</text><text x="20" y="54" font-size="9" fill="#374151" text-anchor="end">4</text><line x1="56" y1="170" x2="136" y2="170" stroke="#2563eb" stroke-width="2.5"/><path d="M 140,170 L 132,165.5 L 132,174.5 Z" fill="#2563eb"/><text x="96" y="182" font-size="9.5" fill="#2563eb" font-weight="700" text-anchor="middle">3 right</text><line x1="140" y1="170" x2="140" y2="94" stroke="#2563eb" stroke-width="2.5"/><path d="M 140,90 L 135.5,98 L 144.5,98 Z" fill="#2563eb"/><text x="152" y="130" font-size="9.5" fill="#2563eb" font-weight="700" text-anchor="start">2 up</text><circle cx="56" cy="170" r="6" fill="#ea580c" stroke="#0f1f3d" stroke-width="1.5"/><text x="56" y="158" font-size="9.5" fill="#ea580c" font-weight="700" text-anchor="middle">Start (2, 1)</text><circle cx="140" cy="90" r="6" fill="#16a34a" stroke="#0f1f3d" stroke-width="1.5"/><text x="140" y="78" font-size="9.5" fill="#16a34a" font-weight="700" text-anchor="middle">End (5, 3)</text></svg>',

      videoPlaceholder:
        'Short video showing how to follow movement instructions on a grid using horizontal and vertical steps with compass direction examples',
    },
  ],
  topicPractice: [
