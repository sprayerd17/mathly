...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramSvg:
        '<svg viewBox="0 0 400 190" xmlns="http://www.w3.org/2000/svg"><ellipse cx="70" cy="60" rx="28" ry="9" fill="none" stroke="#2563eb" stroke-width="2.5"/><ellipse cx="70" cy="120" rx="28" ry="9" fill="none" stroke="#2563eb" stroke-width="2.5"/><line x1="42" y1="60" x2="42" y2="120" stroke="#2563eb" stroke-width="2.5"/><line x1="98" y1="60" x2="98" y2="120" stroke="#2563eb" stroke-width="2.5"/><text x="70" y="45" font-weight="700" font-size="10" text-anchor="middle" fill="#2563eb">flat face</text><text x="70" y="94" font-weight="700" font-size="10" text-anchor="middle" fill="#2563eb">curved surface</text><text x="70" y="175" font-weight="700" font-size="13" text-anchor="middle" fill="#2563eb">Cylinder</text><ellipse cx="210" cy="120" rx="26" ry="8" fill="none" stroke="#dc2626" stroke-width="2.5"/><line x1="210" y1="50" x2="184" y2="120" stroke="#dc2626" stroke-width="2.5"/><line x1="210" y1="50" x2="236" y2="120" stroke="#dc2626" stroke-width="2.5"/><circle cx="210" cy="50" r="4" fill="#ea580c"/><text x="210" y="38" font-weight="700" font-size="10" text-anchor="middle" fill="#ea580c">apex</text><text x="210" y="98" font-weight="700" font-size="10" text-anchor="middle" fill="#dc2626">curved surface</text><text x="210" y="175" font-weight="700" font-size="13" text-anchor="middle" fill="#dc2626">Cone</text><circle cx="330" cy="85" r="33" fill="none" stroke="#16a34a" stroke-width="2.5"/><path d="M 297 85 Q 330 100 363 85" fill="none" stroke="#16a34a" stroke-width="1.3"/><text x="330" y="70" font-weight="700" font-size="10" text-anchor="middle" fill="#16a34a">curved surface</text><text x="330" y="175" font-weight="700" font-size="13" text-anchor="middle" fill="#16a34a">Sphere</text></svg>',
