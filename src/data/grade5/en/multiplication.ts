...
<div style="background:#f0fdf4;border:1.5px solid #bbf7d0;border-radius:10px;padding:14px 16px;">
  ...
  <p style="margin:0;color:#15803d;">Split ${re('12')} into <strong>10 + 2</strong>. Multiply each part separately, then add the results together. For example: ${re('12')} × ${bl('9')} = (10 × ${bl('9')}) + (2 × ${bl('9')}) = 90 + 18 = ${gr('108')}.</p>
      ...
      practiceQuestions: [],
      diagramPlaceholder: 'A 12 × 12 multiplication grid outline with only the 11× and 12× rows filled in and highlighted in a different colour',
      ...
      videoPlaceholder:
        'Short video showing patterns in the 11 and 12 times tables and tips for remembering them',
    },
...
So 256 × 34 = ${pu('8 704')}${we5FullTable}`,
      ...
      videoPlaceholder:
        'Short video showing step by step how to multiply a 3-digit number by a 2-digit number using the column method with two partial products',
    },
...
<div style="background:#fefce8;border:1.5px solid #fde68a;border-radius:10px;padding:14px 16px;">
  ...
  <p style="margin:0;color:#78350f;">Sometimes it is much easier to split a number into <strong>tens and units</strong> (or <strong>hundreds and tens</strong>) before multiplying. For example, multiplying by 48 looks hard — but multiplying by 40 and then by 8 separately is straightforward. The distributive property makes this legal and reliable.</p>
      ...
      practiceQuestions: [],
      videoPlaceholder:
        'Short video showing how to use the distributive property to break numbers apart and make multiplication easier',
    },
...
There are <strong>3 600 chocolates</strong> altogether.`,
      ...
      practiceQuestions: [],
      videoPlaceholder:
        'Short video showing how to estimate before multiplying and solve multiplication word problems by identifying key words',
    },
  ],
  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'A learner worked out 356 × 27 like this: Partial product 1 (356 × 7) = 2 492. Partial product 2 (356 × 2, with placeholder) = 7 120. Total = 9 612. Check this learner\'s working — is it correct? Find the correct total.', answer: '9 612', checkMode: 'auto', correctAnswer: '9612', correctAnswers: ['9612', '9 612'], explanation: 'Check 356 × 7: 7×6=42 write 2 carry 4; 7×5=35+4=39 write 9 carry 3; 7×3=21+3=24. Correct partial product 1 is 2 492 (this one was actually correct). Check 356 × 20: 356 × 2 = 712, so with the placeholder that is 7 120 (also correct). Adding: 2 492 + 7 120 = 9 612 — the total given was actually right, so 356 × 27 = 9 612.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy-Medium', question: 'A learner claims 11 × 10 = 1010, working it out by multiplying each digit of 11 by 10 separately (1 × 10 = 10 and 1 × 10 = 10) and writing the two results side by side. Is this correct? Give the correct answer and explain the mistake.', answer: '110', checkMode: 'auto', correctAnswer: '110', correctAnswers: ['110'], explanation: 'Multiplying each digit separately and writing the results side by side is not valid — that ignores place value and gives 1010, which is wrong. To multiply by 10, you simply shift every digit one place to the left: 11 × 10 = 110, not 1010.' },
