...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        'Conversion chain from mm to cm to m to km, with green multiply arrows for converting to a smaller unit and red divide arrows for converting to a larger unit, conversion facts labelled in orange',
      diagramSvg:
      ...
      videoPlaceholder:
        'Short video showing how to convert between mm cm m and km using multiply and divide with three worked examples colour coded green for multiply red for divide orange for conversion facts blue for answers',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        'A ruler with an object placed from 0 to 24cm, the starting point highlighted in blue, the ending point in green, and the measurement labelled in orange',
      diagramSvg:
      ...
      videoPlaceholder:
        'Short video showing how to use a ruler correctly, starting from zero, reading the ending point, and recording the measurement with the correct unit',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video showing how to add and subtract lengths with different units by converting first then calculating, with colour coded steps — conversion blue addition green subtraction red answer orange',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        'A labelled rectangle with sides 8cm and 5cm and a square with sides 12m, all side lengths highlighted in blue and the perimeter answer shown in orange',
      diagramSvg:
      ...
      videoPlaceholder:
        'Short video explaining how to find the perimeter of a rectangle and a square by adding all side lengths, with sides colour coded blue, addition green and perimeter answer orange',
    },
  ],
  practiceSets: [
    // ═══════════════════════════════════════════════════════════════════════
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'Sipho\'s garden path is 14m long. His neighbour\'s path is 1 350cm long. Whose path is longer, and by how many metres?', checkMode: 'auto', correctAnswer: 'Sipho0.5m', correctAnswers: ['Sipho0.5m', 'Sipho, 0.5m', "Sipho's path 0.5m", 'Sipho 0.5m'], explanation: 'Convert 1 350cm to metres: 1 350 ÷ 100 = 13.5m. Compare: Sipho\'s path is 14m and the neighbour\'s is 13.5m. Sipho\'s path is longer, by 14 − 13.5 = 0.5m.' },
