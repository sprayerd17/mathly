...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video showing how to collect raw data and organise it step by step into a tally table and frequency table',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        'Bar graph showing Amahle favourite sports survey with horizontal axis labelled Sports in blue vertical axis labelled Number of Learners in red scale in orange counting in 2s from 0 to 10 and green bars for football 10 netball 8 cricket 5 swimming 7',

      diagramSvg:
        '<svg viewBox="0 0 220 205" xmlns="http://www.w3.org/2000/svg"><text x="115" y="14" font-size="10.5" fill="#0f1f3d" font-weight="700" text-anchor="middle">Favourite Sports — Grade 5</text><text x="14" y="90.5" font-size="9.5" fill="#dc2626" font-weight="700" text-anchor="middle" transform="rotate(-90 14 90.5)">Number of Learners</text><line x1="44" y1="26" x2="44" y2="155" stroke="#0f1f3d" stroke-width="2"/><line x1="44" y1="155" x2="212" y2="155" stroke="#0f1f3d" stroke-width="2"/><line x1="41" y1="155" x2="44" y2="155" stroke="#0f1f3d" stroke-width="1.5"/><text x="38" y="158" font-size="9.5" fill="#ea580c" font-weight="700" text-anchor="end">0</text><line x1="41" y1="129.2" x2="44" y2="129.2" stroke="#0f1f3d" stroke-width="1.5"/><text x="38" y="132.2" font-size="9.5" fill="#ea580c" font-weight="700" text-anchor="end">2</text><line x1="41" y1="103.4" x2="44" y2="103.4" stroke="#0f1f3d" stroke-width="1.5"/><text x="38" y="106.4" font-size="9.5" fill="#ea580c" font-weight="700" text-anchor="end">4</text><line x1="41" y1="77.6" x2="44" y2="77.6" stroke="#0f1f3d" stroke-width="1.5"/><text x="38" y="80.6" font-size="9.5" fill="#ea580c" font-weight="700" text-anchor="end">6</text><line x1="41" y1="51.8" x2="44" y2="51.8" stroke="#0f1f3d" stroke-width="1.5"/><text x="38" y="54.8" font-size="9.5" fill="#ea580c" font-weight="700" text-anchor="end">8</text><line x1="41" y1="26.0" x2="44" y2="26.0" stroke="#0f1f3d" stroke-width="1.5"/><text x="38" y="29.0" font-size="9.5" fill="#ea580c" font-weight="700" text-anchor="end">10</text><rect x="53" y="26.0" width="24" height="129.0" fill="#16a34a" stroke="#0f1f3d" stroke-width="1.5"/><text x="65" y="169" font-size="8.3" fill="#2563eb" font-weight="700" text-anchor="middle">Football</text><rect x="95" y="51.8" width="24" height="103.2" fill="#16a34a" stroke="#0f1f3d" stroke-width="1.5"/><text x="107" y="169" font-size="8.3" fill="#2563eb" font-weight="700" text-anchor="middle">Netball</text><rect x="137" y="90.5" width="24" height="64.5" fill="#16a34a" stroke="#0f1f3d" stroke-width="1.5"/><text x="149" y="169" font-size="8.3" fill="#2563eb" font-weight="700" text-anchor="middle">Cricket</text><rect x="179" y="64.7" width="24" height="90.3" fill="#16a34a" stroke="#0f1f3d" stroke-width="1.5"/><text x="191" y="169" font-size="8.3" fill="#2563eb" font-weight="700" text-anchor="middle">Swimming</text><text x="128" y="188" font-size="10.5" fill="#2563eb" font-weight="700" text-anchor="middle">Sports</text></svg>',

      videoPlaceholder:
        'Short video showing step by step how to draw a bar graph with a labelled horizontal axis vertical axis consistent scale and correctly spaced bars',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        'Pictograph showing books read by Sipho 4 full symbols and Lerato 3 and a half symbols with key value 2 in blue full symbols in green half symbol in orange and totals in red',

      diagramSvg:
        '<svg viewBox="0 0 200 100" xmlns="http://www.w3.org/2000/svg"><text x="100" y="13" font-size="11" fill="#0f1f3d" font-weight="700" text-anchor="middle">Books Read — Sipho &amp; Lerato</text><text x="6" y="28" font-size="10" fill="#0f1f3d" font-weight="700">Key:</text><circle cx="32" cy="25" r="5" fill="#16a34a"/><text x="40" y="28" font-size="10" fill="#2563eb" font-weight="700">= 2 books</text><line x1="6" y1="34" x2="194" y2="34" stroke="#9ca3af" stroke-width="1"/><text x="6" y="54" font-size="10.5" fill="#0f1f3d" font-weight="700">Sipho</text><circle cx="70" cy="50" r="6" fill="#16a34a"/><circle cx="86" cy="50" r="6" fill="#16a34a"/><circle cx="102" cy="50" r="6" fill="#16a34a"/><circle cx="118" cy="50" r="6" fill="#16a34a"/><text x="170" y="54" font-size="11" fill="#dc2626" font-weight="700" text-anchor="middle">8</text><line x1="6" y1="64" x2="194" y2="64" stroke="#9ca3af" stroke-width="0.6" stroke-dasharray="2,2"/><text x="6" y="84" font-size="10.5" fill="#0f1f3d" font-weight="700">Lerato</text><circle cx="70" cy="80" r="6" fill="#16a34a"/><circle cx="86" cy="80" r="6" fill="#16a34a"/><circle cx="102" cy="80" r="6" fill="#16a34a"/><path d="M 118,74 A 6,6 0 0 0 118,86 Z" fill="#ea580c"/><circle cx="118" cy="80" r="6" fill="none" stroke="#ea580c" stroke-width="1.2"/><text x="170" y="84" font-size="11" fill="#dc2626" font-weight="700" text-anchor="middle">7</text></svg>',

      videoPlaceholder:
        'Short video showing how to read a pictograph by checking the key value counting full symbols and handling half symbols to find totals',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        'Three panels showing mode in blue with 3 as the most frequent value median in green with ordered data set and middle value highlighted and mean in orange showing the addition and division steps',

      diagramSvg:
        '<svg viewBox="0 0 210 125" xmlns="http://www.w3.org/2000/svg"><rect x="2" y="18" width="64" height="100" rx="8" fill="none" stroke="#2563eb" stroke-width="1.5"/><rect x="73" y="18" width="64" height="100" rx="8" fill="none" stroke="#16a34a" stroke-width="1.5"/><rect x="144" y="18" width="64" height="100" rx="8" fill="none" stroke="#ea580c" stroke-width="1.5"/><text x="34" y="30" font-size="10.5" fill="#2563eb" font-weight="700" text-anchor="middle">MODE</text><text x="105" y="30" font-size="10.5" fill="#16a34a" font-weight="700" text-anchor="middle">MEDIAN</text><text x="176" y="30" font-size="10.5" fill="#ea580c" font-weight="700" text-anchor="middle">MEAN</text><circle cx="13" cy="46" r="7" fill="#2563eb" stroke="#0f1f3d" stroke-width="1"/><text x="13" y="49" font-size="7.5" fill="#ffffff" font-weight="700" text-anchor="middle">3</text><circle cx="29" cy="46" r="7" fill="#ffffff" stroke="#9ca3af" stroke-width="1"/><text x="29" y="49" font-size="7.5" fill="#374151" font-weight="700" text-anchor="middle">7</text><circle cx="45" cy="46" r="7" fill="#ffffff" stroke="#9ca3af" stroke-width="1"/><text x="45" y="49" font-size="7.5" fill="#374151" font-weight="700" text-anchor="middle">5</text><circle cx="61" cy="46" r="7" fill="#2563eb" stroke="#0f1f3d" stroke-width="1"/><text x="61" y="49" font-size="7.5" fill="#ffffff" font-weight="700" text-anchor="middle">3</text><circle cx="13" cy="64" r="7" fill="#ffffff" stroke="#9ca3af" stroke-width="1"/><text x="13" y="67" font-size="7.5" fill="#374151" font-weight="700" text-anchor="middle">9</text><circle cx="29" cy="64" r="7" fill="#2563eb" stroke="#0f1f3d" stroke-width="1"/><text x="29" y="67" font-size="7.5" fill="#ffffff" font-weight="700" text-anchor="middle">3</text><circle cx="45" cy="64" r="7" fill="#ffffff" stroke="#9ca3af" stroke-width="1"/><text x="45" y="67" font-size="7.5" fill="#374151" font-weight="700" text-anchor="middle">7</text><text x="34" y="90" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">Mode = 3</text><text x="34" y="102" font-size="6.3" fill="#6b7280" text-anchor="middle">(most frequent value)</text><circle cx="80" cy="50" r="6" fill="#ffffff" stroke="#9ca3af" stroke-width="1"/><text x="80" y="53" font-size="7" fill="#374151" font-weight="700" text-anchor="middle">1</text><circle cx="93" cy="50" r="6" fill="#ffffff" stroke="#9ca3af" stroke-width="1"/><text x="93" y="53" font-size="7" fill="#374151" font-weight="700" text-anchor="middle">3</text><circle cx="106" cy="50" r="7" fill="#16a34a" stroke="#0f1f3d" stroke-width="1"/><text x="106" y="53" font-size="7.5" fill="#ffffff" font-weight="700" text-anchor="middle">6</text><circle cx="119" cy="50" r="6" fill="#ffffff" stroke="#9ca3af" stroke-width="1"/><text x="119" y="53" font-size="7" fill="#374151" font-weight="700" text-anchor="middle">8</text><circle cx="132" cy="50" r="6" fill="#ffffff" stroke="#9ca3af" stroke-width="1"/><text x="132" y="53" font-size="7" fill="#374151" font-weight="700" text-anchor="middle">9</text><text x="106" y="38" font-size="6.5" fill="#16a34a" font-weight="700" text-anchor="middle">middle</text><text x="105" y="90" font-size="12" fill="#16a34a" font-weight="700" text-anchor="middle">Median = 6</text><text x="105" y="102" font-size="6.3" fill="#6b7280" text-anchor="middle">(middle value)</text><text x="176" y="46" font-size="7.3" fill="#0f1f3d" font-weight="700" text-anchor="middle">4+8+6+10+2</text><text x="176" y="60" font-size="9.5" fill="#ea580c" font-weight="700" text-anchor="middle">= 30</text><text x="176" y="76" font-size="7.8" fill="#0f1f3d" font-weight="700" text-anchor="middle">30 &#247; 5 = 6</text><text x="176" y="96" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">Mean = 6</text><text x="176" y="108" font-size="6.3" fill="#6b7280" text-anchor="middle">(total &#247; count)</text></svg>',

      videoPlaceholder:
        'Short video explaining mode median and mean with worked examples showing how to find the most frequent value the middle value and the average of a data set',
    },
