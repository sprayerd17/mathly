...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video explaining the Grade 5 units of mass — grams and kilograms — and how to choose the correct unit for everyday objects, with milligrams and tonnes introduced as enrichment',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video showing how to convert grams and kilograms by multiplying or dividing by 1000 with worked examples, with milligram and tonne conversions introduced as enrichment',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video showing how to read a kitchen scale by identifying scale markings and counting spaces, and how a balance scale indicates which object is heavier',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video showing how to add, subtract and multiply mass measurements by first converting to the same unit and then calculating with colour coded steps',
    },
  ],
  resultsConfig: {
    totalMarks: 12,
