...
export const topicData: TopicData = {
  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      name: 'Set 1',
      questions: [
        { difficulty: 'Easy', question: 'Which unit would you use to measure the mass of a single vitamin tablet: mg, g, kg or t?', checkMode: 'auto', correctAnswer: 'mg', correctAnswers: ['mg', 'milligrams', 'milligram'], explanation: 'A vitamin tablet is extremely light, so milligrams (mg) is the sensible unit. Grams or kilograms would give an awkward tiny decimal.' },
        ...
        { difficulty: 'Easy', question: 'A builder is choosing a unit to label bags of cement on a delivery list. He picks tonnes because "bigger jobs need bigger units." Is he correct? Explain.', checkMode: 'self', answer: 'No, he is not correct. A single bag of cement has a mass of around 25 to 50 kg, which is a sensible number in kilograms. In tonnes it would be a tiny, awkward decimal like 0.03 t. Kilograms is the right unit for one bag — tonnes would only make sense for a very large stockpile of many bags together.' },
        { difficulty: 'Easy', question: 'A bicycle has a mass of about 12 kg and a shipping container has a mass of about 4 t when empty. If you had to describe both masses using the SAME unit so the numbers stay easy to read, which unit would you choose, and why?', checkMode: 'self', answer: 'Kilograms would work reasonably well for both (12 kg and about 4 000 kg), but tonnes make the container easy to read (4 t) while the bicycle becomes an awkward decimal (0.012 t). In practice each object is usually described in its own best-fit unit — kg for the bicycle and t for the container — rather than forcing one unit onto both, because no single unit keeps both numbers sensible.' },
        ...
        { difficulty: 'Medium', question: 'A truck\'s cargo has a mass of 5 250 000 mg. What is this mass in kilograms? (Hint: convert to grams first, then to kilograms.)', checkMode: 'auto', correctAnswer: '5.25kg', correctAnswers: ['5.25kg', '5.25 kg', '5.25'], explanation: 'First convert mg to g by dividing by 1 000: 5 250 000 ÷ 1 000 = 5 250 g. Then convert g to kg by dividing by 1 000: 5 250 ÷ 1 000 = 5.25 kg.' },
        ...
        { difficulty: 'Medium', question: 'A student says a full water bottle should be measured in tonnes because "tonnes are the proper scientific unit." Is this reasoning sound? Explain what is wrong with it.', checkMode: 'self', answer: 'No, this reasoning is not sound. There is no single "proper" unit for every measurement — the best unit is whichever one gives a sensible, easy-to-read number for that particular object. A full water bottle has a mass of roughly 1 kg (or 1 000 g), so using tonnes would give a tiny, awkward decimal like 0.001 t. Kilograms or grams are the sensible choice here, not tonnes.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      name: 'Set 2',
      questions: [
        { difficulty: 'Easy', question: 'Which unit would you use to measure the mass of a grain of rice: mg, g, kg or t?', checkMode: 'auto', correctAnswer: 'mg', correctAnswers: ['mg', 'milligrams', 'milligram'], explanation: 'A single grain of rice is extremely light, so milligrams (mg) is the sensible unit. Grams or kilograms would give an awkward tiny decimal.' },
        { difficulty: 'Easy', question: 'Thabo picks up a mango and wants to weigh it. Which unit gives the most sensible reading for its mass — grams or milligrams?', checkMode: 'auto', correctAnswer: 'g', correctAnswers: ['g', 'grams', 'gram'], explanation: 'A mango has a mass of a few hundred grams, so grams (g) gives a sensible reading. Milligrams would give a huge, unwieldy number.' },
        { difficulty: 'Easy', question: 'A traveller is choosing a unit to record the mass of her packed suitcase for the airline. She picks tonnes because "heavier luggage needs a bigger unit." Is she correct? Explain.', checkMode: 'self', answer: 'No, she is not correct. A packed suitcase has a mass of around 15 to 25 kg, which is a sensible number in kilograms. In tonnes it would be a tiny, awkward decimal like 0.02 t. Kilograms is the right unit for luggage — tonnes are reserved for far heavier things like trucks or shipping containers.' },
        { difficulty: 'Easy', question: 'A schoolbag has a mass of about 5 kg and a whale has a mass of about 8 t. If a teacher wanted to compare both masses using the same unit without ending up with silly numbers, would kilograms or tonnes work better for the whale, and why?', checkMode: 'self', answer: 'Tonnes work far better for the whale. In kilograms the whale would be 8 000 kg, which is an unwieldy number to write and compare, whereas in tonnes it is simply 8 t. The schoolbag is better suited to kilograms (5 kg), since in tonnes it would be an awkward decimal (0.005 t) — this shows that each object usually keeps its own natural unit rather than being forced to share one with something very different in size.' },
        ...
        { difficulty: 'Medium', question: 'A delivery of screws has a mass of 8 400 000 mg. What is this mass in kilograms? (Hint: convert to grams first, then to kilograms.)', checkMode: 'auto', correctAnswer: '8.4kg', correctAnswers: ['8.4kg', '8.4 kg', '8.4', '8.40kg', '8.40 kg'], explanation: 'First convert mg to g by dividing by 1 000: 8 400 000 ÷ 1 000 = 8 400 g. Then convert g to kg by dividing by 1 000: 8 400 ÷ 1 000 = 8.4 kg.' },
        ...
        { difficulty: 'Medium-Hard', question: 'A prescription needs 250 mg of medicine per dose. Bongani says he can use his kitchen scale set to grams and just read off "0.25" without adding a unit, since "the doctor will know what it means." Explain why this could cause a problem.', checkMode: 'self', answer: 'Leaving off the unit is dangerous because "0.25" alone does not say whether it means 0.25 g, 0.25 kg, or something else entirely. For medicine especially, a mix-up between grams and milligrams could mean a dose that is 1 000 times too strong or too weak. Always writing the full measurement with its unit (0.25 g, which equals 250 mg) removes any risk of misreading it.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      name: 'Set 3',
      questions: [
        { difficulty: 'Easy', question: 'Which unit would you use to measure the mass of a single button: mg, g, kg or t?', checkMode: 'auto', correctAnswer: 'g', correctAnswers: ['g', 'grams', 'gram'], explanation: 'A button is a light object, so grams (g) is the sensible unit. Milligrams would give an unnecessarily large number for such a small object, since a button still has a mass of a few grams.' },
        ...
        { difficulty: 'Easy', question: 'A dockworker is choosing a unit to record the mass of a cargo ship\'s full load. He picks kilograms because "kilograms are more precise than tonnes." Is this a sensible choice? Explain.', checkMode: 'self', answer: 'No, this is not a sensible choice. A cargo ship\'s load can have a mass of thousands or millions of kilograms, so recording it in kilograms would give an enormous, unreadable number. Tonnes (t) is the sensible unit for something this heavy — being "more precise" does not matter if the number is too unwieldy to read or compare.' },
        { difficulty: 'Easy', question: 'A pencil has a mass of about 5 g and a small car has a mass of about 1.2 t. Explain why it would not make sense to describe both objects using the same unit of mass.', checkMode: 'self', answer: 'Using the same unit for both would make at least one number very awkward to read. If grams were used for both, the car would be about 1 200 000 g, an enormous number. If tonnes were used for both, the pencil would be about 0.000005 t, an impossibly small decimal. Because the pencil and the car differ so much in size, each needs its own sensible unit — grams for the pencil and tonnes for the car — rather than sharing one.' },
        ...
        { difficulty: 'Medium', question: 'A batch of pills has a total mass of 3 600 000 mg. What is this mass in kilograms? (Hint: convert to grams first, then to kilograms.)', checkMode: 'auto', correctAnswer: '3.6kg', correctAnswers: ['3.6kg', '3.6 kg', '3.60kg', '3.60 kg'], explanation: 'First convert mg to g by dividing by 1 000: 3 600 000 ÷ 1 000 = 3 600 g. Then convert g to kg by dividing by 1 000: 3 600 ÷ 1 000 = 3.6 kg.' },
        ...
        { difficulty: 'Medium', question: 'A student says a bag of cement should be measured in milligrams because "smaller units are always more accurate." Is this reasoning sound? Explain what is wrong with it.', checkMode: 'self', answer: 'No, this reasoning is not sound. A smaller unit does not automatically make a measurement more accurate — it just changes how big the number looks. A bag of cement has a mass of several kilograms, so measuring it in milligrams would give an enormous, unmanageable number with far too many digits, such as 25 000 000 mg instead of 25 kg. Kilograms is the sensible unit for an object this size.' },
        { difficulty: 'Medium', question: 'Palesa says that to convert 4.5 t to kilograms, you divide by 1 000, giving 0.0045 kg. Is Palesa correct? Explain the mistake.', checkMode: 'self', answer: 'No, Palesa is incorrect. Converting from tonnes (a larger unit) to kilograms (a smaller unit) means you multiply by 1 000, not divide. The correct working is 4.5 × 1 000 = 4 500 kg. Palesa used the wrong operation, and dividing also moved the number in the wrong direction — converting to a smaller unit should make the number bigger, not smaller.' },
        { difficulty: 'Medium-Hard', question: 'A baby needs 120 mg of a supplement daily. A parent says they can just measure "0.12" on a gram scale and skip writing the unit, because "it is obviously grams." Explain why skipping the unit is risky here.', checkMode: 'self', answer: 'Skipping the unit is risky because "0.12" alone gives no clue whether it means 0.12 g, 0.12 kg, or something else. For a baby\'s dose, mistaking grams for kilograms (or vice versa) could mean giving a dose that is 1 000 times too much or too little, which could be dangerous. Always writing the full measurement with its unit (0.12 g, which equals 120 mg) avoids this confusion.' },
