  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium-Hard', checkMode: 'self', question: 'A learner worked out 60 423 − 28 156 like this:\n\nTTh Th H T U\n  6  0 4 2 3\n−2  8 1 5 6\n———————————\n  4  8 2 6 7\n\nThe learner wrote 48 267 as the final answer, but their working shows a mistake in the borrowing. Redo the subtraction correctly, explain what the learner most likely did wrong, and give the correct answer.', answer: 'The correct answer is 60 423 − 28 156 = 32 267.\n\nWorking column by column:\n• Units: 3 − 6 → can\'t subtract. Borrow from Tens. Tens: 2 → 1. Units: 13 − 6 = 7\n• Tens: 1 − 5 → can\'t subtract. Borrow from Hundreds. Hundreds: 4 → 3. Tens: 11 − 5 = 6\n• Hundreds: 3 − 1 = 2\n• Thousands: 0 − 8 → can\'t subtract. Borrow from Ten thousands. Ten thousands: 6 → 5. Thousands: 10 − 8 = 2\n• Ten thousands: 5 − 2 = 3\n\nThe learner\'s mistake: in the Thousands column they needed to work out 0 − 8, which is impossible without borrowing. Instead of borrowing from the Ten thousands column, they subtracted the smaller digit from the larger one regardless of position, writing 8 − 0 = 8. Because no borrowing actually took place, the Ten thousands digit was never reduced either, so they also worked out 6 − 2 = 4 instead of the correct 5 − 2 = 3 (after properly borrowing). This produced the incorrect answer of 48 267.\n\nCorrect answer: 32 267' },
