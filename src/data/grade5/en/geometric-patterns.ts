...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramSvg:
        '<svg viewBox="0 0 340 260" xmlns="http://www.w3.org/2000/svg"><text x="170" y="16" font-size="11" font-weight="700" fill="#0f1f3d" text-anchor="middle">Growing circle pattern</text><circle cx="52.5" cy="55.0" r="6" fill="none" stroke="#2563eb" stroke-width="2.2"/><circle cx="67.5" cy="55.0" r="6" fill="none" stroke="#2563eb" stroke-width="2.2"/><circle cx="162.5" cy="47.5" r="6" fill="none" stroke="#2563eb" stroke-width="2.2"/><circle cx="177.5" cy="47.5" r="6" fill="none" stroke="#2563eb" stroke-width="2.2"/><circle cx="162.5" cy="62.5" r="6" fill="none" stroke="#2563eb" stroke-width="2.2"/><circle cx="177.5" cy="62.5" r="6" fill="none" stroke="#2563eb" stroke-width="2.2"/><circle cx="265.0" cy="47.5" r="6" fill="none" stroke="#2563eb" stroke-width="2.2"/><circle cx="280.0" cy="47.5" r="6" fill="none" stroke="#2563eb" stroke-width="2.2"/><circle cx="295.0" cy="47.5" r="6" fill="none" stroke="#2563eb" stroke-width="2.2"/><circle cx="265.0" cy="62.5" r="6" fill="none" stroke="#2563eb" stroke-width="2.2"/><circle cx="280.0" cy="62.5" r="6" fill="none" stroke="#2563eb" stroke-width="2.2"/><circle cx="295.0" cy="62.5" r="6" fill="none" stroke="#2563eb" stroke-width="2.2"/><text x="60" y="88" font-size="9" font-weight="700" fill="#1e40af" text-anchor="middle">Step 1 (2)</text><text x="170" y="88" font-size="9" font-weight="700" fill="#1e40af" text-anchor="middle">Step 2 (4)</text><text x="280" y="88" font-size="9" font-weight="700" fill="#1e40af" text-anchor="middle">Step 3 (6)</text><text x="170" y="103" font-size="9.5" font-weight="700" fill="#ea580c" text-anchor="middle">Rule: add 2 circles each time</text><line x1="20" y1="114" x2="320" y2="114" stroke="#e2e8f0" stroke-width="1.5"/><text x="170" y="132" font-size="11" font-weight="700" fill="#0f1f3d" text-anchor="middle">Growing triangle pattern (each row shown in a line)</text><polygon points="153.0,148.0 159.0,158.8 147.0,158.8" fill="none" stroke="#2563eb" stroke-width="2.0"/><polygon points="170.0,148.0 176.0,158.8 164.0,158.8" fill="none" stroke="#2563eb" stroke-width="2.0"/><polygon points="187.0,148.0 193.0,158.8 181.0,158.8" fill="none" stroke="#2563eb" stroke-width="2.0"/><text x="170" y="172" font-size="9" font-weight="700" fill="#1e40af" text-anchor="middle">Row 1 (3)</text><polygon points="127.5,180.0 133.5,190.8 121.5,190.8" fill="none" stroke="#2563eb" stroke-width="2.0"/><polygon points="144.5,180.0 150.5,190.8 138.5,190.8" fill="none" stroke="#2563eb" stroke-width="2.0"/><polygon points="161.5,180.0 167.5,190.8 155.5,190.8" fill="none" stroke="#2563eb" stroke-width="2.0"/><polygon points="178.5,180.0 184.5,190.8 172.5,190.8" fill="none" stroke="#2563eb" stroke-width="2.0"/><polygon points="195.5,180.0 201.5,190.8 189.5,190.8" fill="none" stroke="#2563eb" stroke-width="2.0"/><polygon points="212.5,180.0 218.5,190.8 206.5,190.8" fill="none" stroke="#2563eb" stroke-width="2.0"/><text x="170" y="204" font-size="9" font-weight="700" fill="#1e40af" text-anchor="middle">Row 2 (6)</text><polygon points="102.0,212.0 108.0,222.8 96.0,222.8" fill="none" stroke="#2563eb" stroke-width="2.0"/><polygon points="119.0,212.0 125.0,222.8 113.0,222.8" fill="none" stroke="#2563eb" stroke-width="2.0"/><polygon points="136.0,212.0 142.0,222.8 130.0,222.8" fill="none" stroke="#2563eb" stroke-width="2.0"/><polygon points="153.0,212.0 159.0,222.8 147.0,222.8" fill="none" stroke="#2563eb" stroke-width="2.0"/><polygon points="170.0,212.0 176.0,222.8 164.0,222.8" fill="none" stroke="#2563eb" stroke-width="2.0"/><polygon points="187.0,212.0 193.0,222.8 181.0,222.8" fill="none" stroke="#2563eb" stroke-width="2.0"/><polygon points="204.0,212.0 210.0,222.8 198.0,222.8" fill="none" stroke="#2563eb" stroke-width="2.0"/><polygon points="221.0,212.0 227.0,222.8 215.0,222.8" fill="none" stroke="#2563eb" stroke-width="2.0"/><polygon points="238.0,212.0 244.0,222.8 232.0,222.8" fill="none" stroke="#2563eb" stroke-width="2.0"/><text x="170" y="236" font-size="9" font-weight="700" fill="#1e40af" text-anchor="middle">Row 3 (9)</text><text x="170" y="252" font-size="9.5" font-weight="700" fill="#ea580c" text-anchor="middle">Rule: add 3 triangles each row</text></svg>',

      videoPlaceholder:
        'Short video explaining how to describe the rule of a geometric pattern in words and extend it step by step using the rule',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video showing how to create your own geometric pattern by choosing a starting shape and a rule then applying the rule step by step',
    },
  ],
  practiceSets: [
    // ═══════════════════════════════════════════════════════════════════════
