...
export const topicData: TopicData = {
  ...
  topicPractice: [
    ...
    // ── Q7 Medium ─────────────────────────────────────────────────────────────
    {
      ...
      answer: 'ʼn vierhoek met beide pare oorstaande sye ewewydig',
      checkMode: 'auto',
      correctAnswer: 'ʼn vierhoek met beide pare oorstaande sye ewewydig',
      explanation: 'Die standaarddefinisie van ʼn parallelogram vereis dat beide pare oorstaande sye ewewydig is. Dit is die minimum voorwaarde wat ʼn parallelogram van ander vierhoeke onderskei.',
    },
    ...
    // ── Q9 Hard ───────────────────────────────────────────────────────────────
    {
      ...
      answer: "Ja — as die diagonale van ʼn vierhoek mekaar halveer, is dit alleen voldoende om te bewys dat beide pare oorstaande sye ewewydig is, wat aan die parallelogramdefinisie voldoen.",
      checkMode: 'self',
    },
    ...
    {
      difficulty: 'Hard',
      question: 'Bewys dat as ʼn vierhoek een paar oorstaande sye het wat beide gelyk en ewewydig is, dit ʼn parallelogram moet wees.',
      answer: 'As een paar sye gelyk en ewewydig is, skep die diagonaal wat die ander twee hoekpunte verbind twee kongruente driehoeke (deur SHS), wat die ander paar sye dwing om ook gelyk en ewewydig te wees.',
      checkMode: 'self',
    },
  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Hard', question: "Thandiwe sê 'ʼn vierhoek met een paar oorstaande hoeke gelyk is altyd ʼn parallelogram'. Vind ʼn teenvoorbeeld om dit te weerlê.", answer: 'ʼn Vlieër het tipies presies een paar oorstaande hoeke gelyk (die hoeke tussen die ongelyke sye), maar sy ander paar oorstaande hoeke is gewoonlik ongelyk, en sy sye is nie albei pare ewewydig nie — dus voldoen ʼn vlieër aan die een-paar-gelyke-hoeke-voorwaarde sonder om ʼn parallelogram te wees, wat die vermoede weerlê.', checkMode: 'self' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'Verduidelik waarom elke ruit ook as ʼn parallelogram geklassifiseer word, deur die definisie van ʼn parallelogram (beide pare oorstaande sye ewewydig) te gebruik.', answer: 'ʼn Ruit word gedefinieer as ʼn parallelogram met al vier sye gelyk — dus voldoen dit reeds per definisie aan die parallelogramvereiste dat beide pare oorstaande sye ewewydig is. Die gelyke-sye-voorwaarde is bloot ʼn addisionele beperking bo-op die parallelogramdefinisie, wat ʼn ruit ʼn spesiale geval van ʼn parallelogram maak.', checkMode: 'self' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'Verduidelik waarom elke reghoek ook as ʼn parallelogram geklassifiseer word, deur die definisie van ʼn parallelogram (beide pare oorstaande sye ewewydig) te gebruik.', answer: 'ʼn Reghoek word gedefinieer as ʼn parallelogram met vier regte hoeke — dus voldoen dit reeds per definisie aan die parallelogramvereiste dat beide pare oorstaande sye ewewydig is. Die regte-hoek-voorwaarde is bloot ʼn addisionele beperking bo-op die parallelogramdefinisie, wat ʼn reghoek ʼn spesiale geval van ʼn parallelogram maak.', checkMode: 'self' },
