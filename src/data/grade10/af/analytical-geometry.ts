...
export const topicData: TopicData = {
  ...
  topicPractice: [
    // ── Q1 Easy — distance formula (integer answer) ───────────────────────────
    {
      ...
      options: ['5', '25', '7', '3'],
      correctIndex: 0,
      explanation: 'afstand = √[(4−1)² + (6−2)²] = √[9+16] = √25 = 5 ✓. (25 is die waarde onder die wortelteken voordat die vierkantswortel getrek word; 7 = 3+4 tel die verskille direk op in plaas van Pythagoras te gebruik; 3 is net die x-verskil.)',
    },
    ...
    // ── Q2 Medium — distance formula with negative coordinates ────────────────
    {
      ...
      options: ['100', '10', '14', '6'],
      correctIndex: 1,
      explanation: 'afstand = √[(4−(−2))² + (−5−3)²] = √[36+64] = √100 = 10 ✓. (100 is die waarde voor die vierkantswortel; 14 = 6+8 tel die verskille direk op in plaas van Pythagoras toe te pas; 6 is net die x-verskil.)',
    },

    // ── Q3 Hard — verify a learner's distance calculation ─────────────────────
    {
      difficulty: 'Hard',
      question: 'Sipho bereken die afstand tussen (0,0) en (6,8) en kry 10. Watter stelling evalueer sy antwoord korrek?',
      checkMode: 'auto',
      options: [
        'Hy is verkeerd — die korrekte afstand is √(36−64), wat onbepaald is.',
        'Hy is verkeerd — die korrekte afstand is 14, aangesien 6+8=14.',
        'Hy is korrek — √[(6−0)²+(8−0)²] = √[36+64] = √100 = 10.',
        'Hy is korrek, maar net omdat (0,0) die oorsprong is; die formule sou ʼn ander antwoord gee vir enige ander beginpunt.',
      ],
      correctIndex: 2,
      explanation: 'afstand = √[(6−0)²+(8−0)²] = √[36+64] = √100 = 10, dus is Sipho se antwoord korrek ✓. Die afstandsformule werk presies dieselfde ongeag watter punt die oorsprong is — opsie D se redenasie is vals, en opsies A en B bevat berekeningsfoute (aftrek in plaas van optel onder die wortelteken, of die bene direk optel).',
    },
    ...
    // ── Q4 Easy — gradient formula (positive integer) ─────────────────────────
    {
      ...
      options: ['1/3', '-3', '-1/3', '3'],
      correctIndex: 3,
      explanation: 'm = (13−4)/(5−2) = 9/3 = 3 ✓. (1/3 kom van die omkering van die formule Δx/Δy in plaas van Δy/Δx; −3 en −1/3 bevat ʼn verkeerde teken.)',
    },
    ...
    // ── Q5 Medium — gradient formula (negative result) ────────────────────────
    {
      ...
      options: ['-2', '-1/2', '2', '1/2'],
      correctIndex: 0,
      explanation: 'm = (−3−5)/(3−(−1)) = −8/4 = −2 ✓. (−1/2 keer die formule Δx/Δy in plaas van Δy/Δx om; 2 en 1/2 verander die teken.)',
    },
    ...
    // ── Q6 Hard — ewewydig lines from gradient comparison ─────────────────────
    {
      ...
      checkMode: 'auto',
      options: [
        'Nee — gradiënt 1 = 4 en gradiënt 2 = 8, dus is hulle nie ewewydig nie.',
        'Ja — albei lyne het gradiënt 4, dus is hulle ewewydig.',
        'Nee — gradiënt 1 = 1/4 en gradiënt 2 = 1/4, dus beteken gelyke gradiënte hier dat die lyne loodreg is, nie ewewydig nie.',
        'Kan nie bepaal word sonder die middelpunt van elke lyn nie.',
      ],
      correctIndex: 1,
      explanation: 'Gradiënt 1 = (9−1)/(2−0) = 8/2 = 4. Gradiënt 2 = (12−4)/(3−1) = 8/2 = 4. Aangesien die gradiënte gelyk is, is die lyne ewewydig ✓.',
    },
    ...
    // ── Q7 Medium — perpendicular gradient ───────────────────────────────────
    {
      ...
      options: ['1/4', '4', '-1/4', '-4'],
      correctIndex: 2,
      explanation: 'Vir loodregte lyne geld m₁ × m₂ = −1, dus is m₂ = −1/4 ✓ (die negatiewe resiprook van 4).',
    },
    ...
    // ── Q8 Hard — verify perpendicular claim ─────────────────────────────────
    {
      ...
      checkMode: 'auto',
      options: [
        'Nee — die produk van die gradiënte is 1, nie −1 nie, dus is die lyne nie loodreg nie.',
        'Nee — loodregte lyne moet gradiënte hê wat gelyk in grootte is, en 2/3 ≠ 3/2.',
        'Ja, maar net omdat albei gradiënte breuke is.',
        'Ja — (2/3) × (−3/2) = −1, wat bevestig dat die lyne loodreg is.',
      ],
      correctIndex: 3,
      explanation: '(2/3) × (−3/2) = −6/6 = −1. Aangesien die produk van die gradiënte −1 is, is die lyne loodreg ✓.',
    },
    ...
    // ── Q9 Easy — midpoint formula (positive coordinates) ────────────────────
    {
      ...
      checkMode: 'auto',
      options: ['(4,6)', '(2,-2)', '(8,12)', '(6,4)'],
      correctIndex: 0,
      explanation: 'M = ((2+6)/2, (8+4)/2) = (4,6) ✓. (2,-2) trek per ongeluk af in plaas van optel; (8,12) vergeet om deur 2 te deel; (6,4) verwissel die x- en y-koördinate.',
    },
    ...
    // ── Q10 Medium — midpoint formula (mixed coordinates) ────────────────────
    {
      ...
      checkMode: 'auto',
      options: ['(5,-3)', '(2,2)', '(4,4)', '(2,3)'],
      correctIndex: 1,
      explanation: 'M = ((−3+7)/2, (5+(−1))/2) = (4/2, 4/2) = (2,2) ✓. (5,-3) trek af in plaas van op te tel; (4,4) vergeet om deur 2 te deel; (2,3) laat die negatiewe teken van −1 weg.',
    },
    ...
    // ── Q11 Hard — find unknown endpoint using midpoint ───────────────────────
    {
      ...
      checkMode: 'auto',
      options: ['(3,-4)', '(5,10)', '(7,-1)', '(-1,7)'],
      correctIndex: 2,
      explanation: 'Met x₂=2a−x₁ en y₂=2b−y₁: x=2(4)−1=7, y=2(3)−7=−1. B=(7,−1) ✓. (3,-4) vergeet om die middelpunt te verdubbel voor aftrekking; (5,10) tel die middelpunt en A op; (-1,7) verwissel die koördinate.',
    },
    ...
    // ── Q12 Medium — find unknown endpoint R ─────────────────────────────────
    {
      ...
      checkMode: 'auto',
      options: ['(2,-1)', '(8,7)', '(2,7)', '(7,2)'],
      correctIndex: 3,
      explanation: 'x=2(5)−3=7, y=2(3)−4=2. R=(7,2) ✓. (2,-1) vergeet om die middelpunt te verdubbel voor aftrekking; (8,7) tel M en P op in plaas van die omgekeerde formule te gebruik; (2,7) verwissel die koördinate.',
    },
    ...
    // ── Q13 Hard — find C using midpoint of BC ───────────────────────────────
    {
      ...
      checkMode: 'auto',
      options: ['(0,0)', '(-2,-3)', '(6,9)', '(2,3)'],
      correctIndex: 0,
      explanation: 'x=2(2)−4=0, y=2(3)−6=0. C=(0,0) ✓. (-2,-3) vergeet om M te verdubbel voor aftrekking; (6,9) tel M en B op; (2,3) bereken B−M in plaas van 2M−B.',
    },
    ...
    // ── Q14 Hard — determine ewewydig lines from two pairs of points ──────────
    {
      ...
      checkMode: 'auto',
      options: [
        'Nee — gradiënt 1 = 2 maar gradiënt 2 = 6, dus is die lyne nie ewewydig nie.',
        'Ja — albei lyne het gradiënt 2, dus is hulle ewewydig.',
        'Nee — die lyne sny mekaar by (1,2), dus kan hulle nie ewewydig wees nie.',
        'Kan nie bepaal word sonder om die afstand tussen die punte te bereken nie.',
      ],
      correctIndex: 1,
      explanation: 'Gradiënt 1 = (10−2)/(5−1) = 8/4 = 2. Gradiënt 2 = (3−(−3))/(3−0) = 6/3 = 2. Aangesien die gradiënte gelyk is, is die lyne ewewydig ✓.',
    },
    ...
    // ── Q15 Hard — distance and gradient in one question ─────────────────────
    {
      ...
      checkMode: 'auto',
      options: ['Afstand = 14, gradiënt = 4/3.', 'Afstand = 10, gradiënt = 3/4.', 'Afstand = 10, gradiënt = 4/3.', 'Afstand = 100, gradiënt = 4/3.'],
      correctIndex: 2,
      explanation: 'Afstand = √[(8−2)²+(7−(−1))²] = √[36+64] = √100 = 10. Gradiënt = (7−(−1))/(8−2) = 8/6 = 4/3 ✓.',
    },
    ...
    // ── Q16 Medium — midpoint of a diagonal in a quadrilateral ───────────────
    {
      ...
      checkMode: 'auto',
      options: ['(2; 1,5)', '(6,5)', '(2,5; 3)', '(3; 2,5)'],
      correctIndex: 3,
      explanation: 'Middelpunt van PR = ((1+5)/2, (1+4)/2) = (3; 2,5) ✓. (2; 1,5) trek af in plaas van op te tel; (6,5) vergeet om deur 2 te deel; (2,5; 3) verwissel die x- en y-koördinate.',
    },
    ...
    // ── Q17 Hard — midpoints of both diagonals to prove parallelogram ─────────
    {
      ...
      checkMode: 'auto',
      options: [
        'Middelpunt van QS = (3; 2,5), wat ooreenstem met die middelpunt van PR, dus is PQRS ʼn parallelogram.',
        'Middelpunt van QS = (2; 1,5), wat nie ooreenstem met die middelpunt van PR nie, dus is PQRS nie ʼn parallelogram nie.',
        'Middelpunt van QS = (3; 2,5), maar aangesien PR en QS nie albei diagonale is nie, bewys dit nie dat PQRS ʼn parallelogram is nie.',
        'Middelpunt van QS = (6,5), wat nie ooreenstem met die middelpunt van PR nie, dus is PQRS nie ʼn parallelogram nie.',
      ],
      correctIndex: 0,
      explanation: 'Middelpunt van QS = ((5+1)/2, (1+4)/2) = (3; 2,5), dieselfde as die middelpunt van PR wat in V16 gevind is. Aangesien beide diagonale dieselfde middelpunt deel, is PQRS ʼn parallelogram ✓.',
    },
    ...
    // ── Q18 Hard — side length to determine rectangle ─────────────────────────
    {
      ...
      checkMode: 'auto',
      options: [
        'PQ = 4, maar PQRS kan nie ʼn reghoek wees nie aangesien slegs een paar sye getoets is.',
        'PQ = 4; aangesien PQ horisontaal en QR vertikaal is, is alle hoeke reg, dus is PQRS ʼn reghoek.',
        'PQ = 3, bereken uit slegs die verskil in y-koördinate, dus is PQRS nie ʼn reghoek nie.',
        'PQ = 16, aangesien (5−1)²=16 reeds die afstand gee sonder ʼn vierkantswortel nodig te hê.',
      ],
      correctIndex: 1,
      explanation: 'PQ = √[(5−1)²+(1−1)²] = √16 = 4. PQ is horisontaal (gradiënt 0) en QR is vertikaal (ongedefinieerde gradiënt), dus vorm PQ⊥QR ʼn regte hoek; dieselfde geld by elke hoekpunt aangesien alle sye horisontaal/vertikaal is, wat bevestig dat PQRS ʼn reghoek is ✓.',
    },
    ...
    // ── Q19 Hard — find D to complete a square ───────────────────────────────
    {
      ...
      checkMode: 'auto',
      options: ['D = (2,3)', 'D = (6,7)', 'D = (2,7)', 'D = (10,7)'],
      correctIndex: 2,
      explanation: 'AB is horisontaal (lengte 4) en BC is vertikaal (lengte 4). Vir ABCD om ʼn vierkant te wees, moet D dieselfde x-koördinaat as A en dieselfde y-koördinaat as C hê: D=(2,7) ✓.',
    },
    ...
    // ── Q20 Hard — verify ABCD is a square by all four side lengths ───────────
    {
      ...
      checkMode: 'auto',
      options: [
        'AB=4, BC=4, CD=4, DA=8 — aangesien een sy verskil, is ABCD nie ʼn vierkant nie.',
        'AB=4, BC=4, CD=4, DA=4 — al vier sye is gelyk, wat ʼn vierkant bevestig.',
        'AB=4, BC=4, CD=8, DA=4 — drie gelyke sye is genoeg om ʼn vierkant te bevestig sonder om die vierde te toets.',
        'AB=16, BC=16, CD=16, DA=16, aangesien die kwadrering van die koördinaatverskille reeds die sylengte gee.',
      ],
      correctIndex: 1,
      explanation: 'AB=√[(6-2)²+(3-3)²]=4, BC=√[(6-6)²+(7-3)²]=4, CD=√[(2-6)²+(7-7)²]=4, DA=√[(2-2)²+(3-7)²]=4. Al vier sye is gelyk aan 4, wat ʼn vierkant bevestig (die horisontale/vertikale sye waarborg regte hoeke) ✓.',
    },
  ],
