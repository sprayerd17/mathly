...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramSvg:
        '<svg viewBox="0 0 260 200" xmlns="http://www.w3.org/2000/svg"><rect x="10" y="20" width="240" height="170" rx="14" fill="#fef2f2" stroke="#dc2626" stroke-width="2"/><text x="130" y="38" font-size="12" fill="#dc2626" font-weight="700" text-anchor="middle">Komplekse getalle ℂ</text><text x="235" y="182" font-size="10" fill="#dc2626" font-weight="700" text-anchor="end">nie-reël, bv. √−9</text><rect x="30" y="52" width="200" height="120" rx="12" fill="#eff6ff" stroke="#2563eb" stroke-width="2"/><text x="130" y="68" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">Reële getalle ℝ</text><circle cx="95" cy="122" r="48" fill="#f0fdf4" stroke="#16a34a" stroke-width="2"/><text x="95" y="98" font-size="11" fill="#16a34a" font-weight="700" text-anchor="middle">Rasionaal ℚ</text><text x="95" y="130" font-size="10" fill="#166534" text-anchor="middle">1/2, 0.75,</text><text x="95" y="144" font-size="10" fill="#166534" text-anchor="middle">−3, 0.3̇</text><circle cx="175" cy="122" r="48" fill="#fff7ed" stroke="#ea580c" stroke-width="2"/><text x="175" y="98" font-size="11" fill="#ea580c" font-weight="700" text-anchor="middle">Irrasionaal</text><text x="175" y="130" font-size="10" fill="#9a3412" text-anchor="middle">√2, π,</text><text x="175" y="144" font-size="10" fill="#9a3412" text-anchor="middle">herhaal nooit</text></svg>',
