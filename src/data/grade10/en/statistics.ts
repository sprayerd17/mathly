...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video showing how to find the modal interval and approximate mean from a grouped frequency table using midpoints and frequencies',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video demonstrating how to enter grouped frequency data into a Casio fx-82 series calculator in STAT 1-VAR mode and read off the mean',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video explaining what an outlier is, how to spot one visually on a number line, and how to decide whether it is a data error or a genuine extreme value',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video showing how to draw a histogram from a grouped frequency table with equal class intervals, why the bars must touch with no gaps, and how to identify the modal class from the tallest bar',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video showing how to split data values into stems and leaves, build an ordered stem-and-leaf plot with a key, read off the mode range and median from it, and construct a back-to-back stem-and-leaf plot comparing two data sets',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramSvg:
        '<svg viewBox="0 0 220 170" xmlns="http://www.w3.org/2000/svg"><line x1="25" y1="110" x2="205" y2="110" stroke="#374151" stroke-width="1.5"/><polygon points="205,110 197,106 197,114" fill="#374151"/><circle cx="51" cy="110" r="4" fill="#2563eb"/><circle cx="78" cy="110" r="4" fill="#2563eb"/><circle cx="115" cy="110" r="4.5" fill="#2563eb"/><circle cx="155" cy="110" r="4" fill="#2563eb"/><circle cx="189" cy="110" r="4" fill="#2563eb"/><text x="51" y="128" font-size="8.5" fill="#2563eb" font-weight="700" text-anchor="middle">4</text><text x="78" y="128" font-size="8.5" fill="#2563eb" font-weight="700" text-anchor="middle">Q1=9</text><text x="115" y="128" font-size="8.5" fill="#2563eb" font-weight="700" text-anchor="middle">Q2=16</text><text x="155" y="128" font-size="8.5" fill="#2563eb" font-weight="700" text-anchor="middle">Q3=23.5</text><text x="189" y="128" font-size="8.5" fill="#2563eb" font-weight="700" text-anchor="middle">30</text><path d="M78,88 L78,80 L155,80 L155,88" fill="none" stroke="#ea580c" stroke-width="1.6"/><text x="116" y="72" font-size="9" fill="#ea580c" font-weight="700" text-anchor="middle">IQR</text><path d="M51,142 L51,150 L189,150 L189,142" fill="none" stroke="#16a34a" stroke-width="1.6"/><text x="120" y="163" font-size="9" fill="#16a34a" font-weight="700" text-anchor="middle">range</text></svg>',

      videoPlaceholder:
        'Short video showing how to find the range, Q1, Q2, Q3 and interquartile range from an ordered data set, and explaining the difference between range and IQR',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      openQuestions: [
        {
          ...
          options: ['7', '4', '16', '3'],
          correctIndex: 0,
          explanation: 'IQR = Q3 − Q1 = 13 − 6 = 7. 4 is Q3 − Median, 16 is the full range (Max − Min), and 3 is Median − Q1.',
        },
        {
          difficulty: 'Easy-Medium',
          question: 'Find the five number summary of this ordered data set: 6, 9, 11, 14, 17, 20, 23, 26, 29.',
          checkMode: 'auto',
          options: ['Min = 6, Q1 = 11, Median = 17, Q3 = 23, Max = 29', 'Min = 6, Q1 = 10, Median = 17, Q3 = 24.5, Max = 29', 'Min = 6, Q1 = 14, Median = 17, Q3 = 20, Max = 29', 'Min = 6, Q1 = 24.5, Median = 17, Q3 = 10, Max = 29'],
          correctIndex: 1,
          explanation: 'n=9 (odd), so median = 5th value = 17. Lower half (excluding median): 6,9,11,14 → Q1=(9+11)÷2=10. Upper half (excluding median): 20,23,26,29 → Q3=(23+26)÷2=24.5. Min=6, Max=29. (Including the median value itself in each half, as in the first option, is a common quartile-position error.)',
        },
        {
          difficulty: 'Medium',
          question: 'This data set is not yet in order: 18, 7, 12, 25, 9, 30, 15, 21, 4. Order it and find the five number summary.',
          checkMode: 'auto',
          options: ['Min = 4, Q1 = 9, Median = 15, Q3 = 21, Max = 30', 'Min = 4, Q1 = 8, Median = 12, Q3 = 23, Max = 30', 'Min = 4, Q1 = 8, Median = 15, Q3 = 23, Max = 30', 'Min = 4, Q1 = 8, Median = 15, Q3 = 23, Max = 25'],
          correctIndex: 2,
          explanation: 'Ordered: 4,7,9,12,15,18,21,25,30. n=9, median = 5th value = 15. Lower half (excluding median): 4,7,9,12 → Q1=(7+9)÷2=8. Upper half (excluding median): 18,21,25,30 → Q3=(21+25)÷2=23. Min=4, Max=30. (Including the median in each half, as in the first option, inflates Q1 and deflates Q3.)',
        },
        {
          difficulty: 'Medium',
          ...
          options: ['23', '31', '18', '27'],
          correctIndex: 3,
          explanation: 'The line inside the box marks the median, which is drawn at 27 on the scale. 23 is Q1 (left edge of the box), 31 is Q3 (right edge of the box), and 18 is the minimum (left whisker end).',
          diagramSvg:
        ...
        },
        {
          ...
          options: ['8', '20', '4', '13'],
          correctIndex: 0,
          explanation: 'IQR = Q3 − Q1 = 31 − 23 = 8 minutes. 20 is the full range (Max − Min = 38 − 18), 13 is Q3 − Min (31 − 18), and 4 is half of the correct IQR.',
          diagramSvg:
            '<svg viewBox="0 0 460 140" xmlns="http://www.w3.org/2000/svg"><text x="230" y="16" font-size="13" font-weight="700" fill="#0f1f3d" text-anchor="middle">Box-and-Whisker Diagram: Race Times (minutes)</text><line x1="40" y1="60" x2="135" y2="60" stroke="#0f1f3d" stroke-width="2"/><line x1="287" y1="60" x2="420" y2="60" stroke="#0f1f3d" stroke-width="2"/><line x1="40" y1="43" x2="40" y2="77" stroke="#0f1f3d" stroke-width="2"/><line x1="420" y1="43" x2="420" y2="77" stroke="#0f1f3d" stroke-width="2"/><rect x="135" y="43" width="152" height="34" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="211" y1="43" x2="211" y2="77" stroke="#0f1f3d" stroke-width="2.5"/><line x1="40" y1="115" x2="420" y2="115" stroke="#0f1f3d" stroke-width="1.5"/><line x1="40" y1="110" x2="40" y2="120" stroke="#0f1f3d" stroke-width="1.5"/><line x1="135" y1="110" x2="135" y2="120" stroke="#0f1f3d" stroke-width="1.5"/><line x1="211" y1="110" x2="211" y2="120" stroke="#0f1f3d" stroke-width="1.5"/><line x1="287" y1="110" x2="287" y2="120" stroke="#0f1f3d" stroke-width="1.5"/><line x1="420" y1="110" x2="420" y2="120" stroke="#0f1f3d" stroke-width="1.5"/><text x="40" y="135" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">18</text><text x="135" y="135" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">23</text><text x="211" y="135" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">27</text><text x="287" y="135" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">31</text><text x="420" y="135" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">38</text></svg>',
        },
        {
          difficulty: 'Hard',
          question: 'A shop manager records the number of items sold by 9 sales assistants in a day: 14, 8, 22, 11, 19, 25, 9, 17, 30. Find the five number summary.',
          checkMode: 'auto',
          options: ['Min = 8, Q1 = 11, Median = 17, Q3 = 22, Max = 30', 'Min = 8, Q1 = 10, Median = 17, Q3 = 23.5, Max = 30', 'Min = 8, Q1 = 10, Median = 14, Q3 = 23.5, Max = 30', 'Min = 8, Q1 = 23.5, Median = 17, Q3 = 10, Max = 30'],
          correctIndex: 1,
          explanation: 'Ordered: 8,9,11,14,17,19,22,25,30. n=9, median = 5th value = 17. Lower half (excluding median): 8,9,11,14 → Q1=(9+11)÷2=10. Upper half (excluding median): 19,22,25,30 → Q3=(22+25)÷2=23.5. Min=8, Max=30.',
        },
      ],
      ...
      videoPlaceholder:
        'Short video showing how to find the five number summary and draw a box-and-whisker diagram step by step from a small data set',
    },
  ],
  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Hard', question: 'A scatter plot shows a strong positive correlation between the number of hours of sunshine and cold-drink sales at a shop, based on 10 clearly upward-trending data points. Kagiso concludes "sunshine directly causes people to buy more cold drinks." Explain why a strong positive correlation on a scatter plot does not, by itself, prove causation.', checkMode: 'auto', options: ['Kagiso is correct — a strong positive correlation on a scatter plot always proves that one variable causes the other.', 'The correlation is meaningless because scatter plots cannot show any real-world relationship.', 'Correlation only applies to negative relationships, so this scatter plot cannot show causation either way.', 'A scatter plot only shows that two variables tend to change together, not that one directly causes the other — another factor (like temperature) or coincidence could explain the pattern, so causation needs further investigation.'], correctIndex: 3, explanation: 'A scatter plot shows association, not causation. There could be a third factor involved (for example, warmer temperature on sunny days making people thirstier), or the relationship could be coincidental. Proving causation requires investigation beyond the graph itself.', diagramSvg: '<svg viewBox="0 0 320 280" xmlns="http://www.w3.org/2000/svg"><line x1="40" y1="20" x2="40" y2="230" stroke="#e5e7eb" stroke-width="1"/><line x1="92" y1="20" x2="92" y2="230" stroke="#e5e7eb" stroke-width="1"/><line x1="144" y1="20" x2="144" y2="230" stroke="#e5e7eb" stroke-width="1"/><line x1="196" y1="20" x2="196" y2="230" stroke="#e5e7eb" stroke-width="1"/><line x1="248" y1="20" x2="248" y2="230" stroke="#e5e7eb" stroke-width="1"/><line x1="300" y1="20" x2="300" y2="230" stroke="#e5e7eb" stroke-width="1"/><line x1="40" y1="20" x2="300" y2="20" stroke="#e5e7eb" stroke-width="1"/><line x1="40" y1="62" x2="300" y2="62" stroke="#e5e7eb" stroke-width="1"/><line x1="40" y1="104" x2="300" y2="104" stroke="#e5e7eb" stroke-width="1"/><line x1="40" y1="146" x2="300" y2="146" stroke="#e5e7eb" stroke-width="1"/><line x1="40" y1="188" x2="300" y2="188" stroke="#e5e7eb" stroke-width="1"/><line x1="40" y1="230" x2="300" y2="230" stroke="#e5e7eb" stroke-width="1"/><line x1="40" y1="230" x2="300" y2="230" stroke="#0f1f3d" stroke-width="1.5"/><line x1="40" y1="20" x2="40" y2="230" stroke="#0f1f3d" stroke-width="1.5"/><text x="170" y="272" font-size="12" fill="#0f1f3d" font-weight="700" text-anchor="middle">Hours of sunshine</text><text x="12" y="125" font-size="12" fill="#0f1f3d" font-weight="700" text-anchor="middle" transform="rotate(-90 12 125)">Cold-drink sales</text><circle cx="66" cy="204" r="4.5" fill="#2563eb"/><circle cx="92" cy="188" r="4.5" fill="#2563eb"/><circle cx="112.8" cy="178" r="4.5" fill="#2563eb"/><circle cx="136.2" cy="152" r="4.5" fill="#2563eb"/><circle cx="157" cy="144" r="4.5" fill="#2563eb"/><circle cx="177.8" cy="118" r="4.5" fill="#2563eb"/><circle cx="201.2" cy="102" r="4.5" fill="#2563eb"/><circle cx="222" cy="80" r="4.5" fill="#2563eb"/><circle cx="248" cy="66.00000000000003" r="4.5" fill="#2563eb"/><circle cx="274" cy="42" r="4.5" fill="#2563eb"/></svg>' },

        // ── Block 5 — Outlier effects on mean vs median (Q17-18) ────────────
        { difficulty: 'Medium', question: 'A set of runners’ times (in seconds) is: 61, 64, 67, 63, 65, 125, 62. Find the mean of this data set, including the outlier, rounded to 2 decimal places.', checkMode: 'auto', options: ['72.43', '63.67', '64', '84.5'], correctIndex: 0, explanation: 'Sum = 61+64+67+63+65+125+62 = 507. Mean = 507÷7 ≈ 72.43. 63.67 is the mean with the outlier excluded, 64 is the median, and 84.5 comes from dividing by 6 instead of 7.' },
        { difficulty: 'Hard', question: 'Using the same data set (61, 64, 67, 63, 65, 125, 62), find the median with the outlier (125) included, and the median with it excluded. Explain what this comparison shows about the effect of an outlier on the median.', checkMode: 'auto', options: ['Median with outlier = 72.43; median without outlier = 63.5 — the outlier greatly changes the median, just like it changes the mean.', 'Median with outlier = 64; median without outlier = 63.5 — very close, showing the median is much less affected by an outlier than the mean, since it depends on position not magnitude.', 'Median with outlier = 64; median without outlier = 63.5 — the outlier greatly distorts the median, just as it distorts the mean.', 'Median with outlier = 67; median without outlier = 63.5 — this shows the median is highly sensitive to outliers.'], correctIndex: 1, explanation: 'Ordered with outlier: 61,62,63,64,65,67,125 → median (4th of 7) = 64. Ordered without outlier: 61,62,63,64,65,67 → median = (63+64)÷2 = 63.5. The two medians are very close, showing the median is much less affected by an extreme outlier than the mean would be, since it depends on position rather than magnitude.' },

        // ── Block 6 — Combined comparison of two data sets (Q19-20) ─────────
        { difficulty: 'Hard', question: "Two branches of a store record their daily sales (in thousands of rand) for a month. Branch X: mean = R52 000, IQR = R9 000. Branch Y: mean = R52 000, IQR = R24 000. Both branches have the same mean daily sales. Explain which branch has more consistent daily sales, and why the mean alone would not reveal this.", checkMode: 'auto', options: ["Branch Y is more consistent, since its IQR (R24 000) is larger, meaning its sales cover a wider, more reliable range.", "Both branches are equally consistent, since they have the same mean daily sales of R52 000.", "Branch X is more consistent, since its IQR (R9 000) is much smaller than Branch Y's (R24 000); the mean alone only shows the average and says nothing about spread, so equal means can hide very different variability.", "Branch X is more consistent, but only because its mean (R52 000) is lower than Branch Y's."], correctIndex: 2, explanation: "Branch X has more consistent daily sales, since its IQR (R9 000) is much smaller than Branch Y's IQR (R24 000), meaning its middle 50% of sales values are far less spread out. The mean alone only shows the average — it says nothing about how spread out or consistent the individual values are, so two data sets can share the same mean while having very different levels of variability." },
        { difficulty: 'Hard', question: "Two farms' weekly egg yields (in dozens) are compared using box-and-whisker plots. Farm P: minimum = 34, Q1 = 46, median = 54, Q3 = 62, maximum = 74. Farm Q: minimum = 24, Q1 = 48, median = 54, Q3 = 60, maximum = 90. Both farms have the same median yield. Using the range and IQR, explain which farm's weekly yields are more predictable.", checkMode: 'auto', options: ['Farm Q is more predictable, since it has the smaller IQR (12 vs 16), and IQR is the only relevant measure of predictability.', 'Farm P is more predictable simply because it has the smaller range (40 vs 66) — IQR is irrelevant here.', 'Both farms are equally predictable, since they share the same median yield of 54.', "Farm Q has the smaller IQR (12 vs 16), but Farm P has no such extreme high or low weeks (range 40 vs Farm Q's 66), making Farm P's yields more predictable week-to-week overall."], correctIndex: 3, explanation: "Farm P's range = 74−34=40 and IQR = 62−46=16. Farm Q's range = 90−24=66 and IQR = 60−48=12. Farm Q has the smaller IQR, meaning its middle 50% is slightly more tightly clustered, but its much larger range (66 vs 40) shows more extreme high and low weeks. Overall, Farm P's yields are more predictable week-to-week since it has no such extreme outlying weeks, even though its middle-50% spread is marginally wider." },
      ],
          scoreMessages: [
        { minScore: 20, message: 'Outstanding! You have mastered mean, median, mode, range, IQR and interpreting box-and-whisker/scatter plots.' },
        { minScore: 15, message: 'Great work! Review any missed questions on the five-number summary or correlation, then try again.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // ── Block 1 — Mean/median/mode/range from raw data (Q1-4) ──────────
        { difficulty: 'Easy', question: 'A basketball team scored these points in 7 matches: 16, 20, 16, 24, 18, 26, 16. Find the mean score, rounded to 2 decimal places.', checkMode: 'auto', options: ['19.43', '18', '16', '22.67'], correctIndex: 0, explanation: 'Sum = 16+20+16+24+18+26+16 = 136. Mean = 136÷7 ≈ 19.43. 18 is the median, 16 is the mode, and 22.67 comes from dividing by 6 instead of 7.' },
        { difficulty: 'Easy', question: 'Seven learners recorded the number of movies they watched this month: 30, 26, 22, 30, 24, 28, 30. Find the mode of this data set.', checkMode: 'auto', options: ['28', '30', '27.14', '8'], correctIndex: 1, explanation: 'Ordered: 22, 24, 26, 28, 30, 30, 30. The value 30 appears three times — more than any other value — so it is the mode. 28 is the median, ≈27.14 is the mean, and 8 is the range.' },
        { difficulty: 'Medium', question: 'A data set of test marks (out of 60) is: 42, 35, 48, 29, 45, 38, 32, 51. Find the median.', checkMode: 'auto', options: ['38', '42', '40', '36.5'], correctIndex: 2, explanation: 'Ordered: 29, 32, 35, 38, 42, 45, 48, 51 (8 values). Median = average of the 4th and 5th values = (38+42)÷2 = 40. Taking only the 4th value (38) or only the 5th value (42) without averaging is a common mistake, and 36.5 comes from averaging the wrong pair (the 3rd and 4th values).' },
        { difficulty: 'Medium-Hard', question: 'A set of plant heights (in cm) is: 6.5, 7.4, 7.1, 7.4, 8.3, 6.5. Find the range of this data set.', checkMode: 'auto', options: ['7.2', '7.25', '6.5', '1.8'], correctIndex: 3, explanation: 'Ordered: 6.5, 6.5, 7.1, 7.4, 7.4, 8.3. Range = largest − smallest = 8.3 − 6.5 = 1.8 cm. 7.2 is the mean, 7.25 is the median, and 6.5 is one of the two modes (this data set is bimodal).' },

        // ── Block 2 — Five-number summary and IQR from ordered data (Q5-8) ──
        { difficulty: 'Easy', question: 'An ordered data set is: 9, 13, 17, 21, 25, 29, 33, 37. Find Q1 and Q3.', checkMode: 'auto', options: ['Q1 = 15, Q3 = 31', 'Q1 = 11, Q3 = 35', 'Q1 = 31, Q3 = 15', 'Q1 = 21, Q3 = 25'], correctIndex: 0, explanation: 'Lower half: 9,13,17,21 → Q1=(13+17)÷2=15. Upper half: 25,29,33,37 → Q3=(29+33)÷2=31. Using the wrong pair of values within each half gives Q1=11, Q3=35, and swapping Q1 and Q3 gives the third option.' },
        { difficulty: 'Medium', question: 'An ordered data set is: 7, 11, 15, 18, 22, 26, 30, 34, 39. Find the interquartile range (IQR).', checkMode: 'auto', options: ['32', '19', '15', '13'], correctIndex: 1, explanation: 'n=9 (odd), median (Q2) = 22. Lower half (excluding median): 7,11,15,18 → Q1=(11+15)÷2=13. Upper half (excluding median): 26,30,34,39 → Q3=(30+34)÷2=32. IQR=32−13=19. 32 is the full range (39−7), 15 comes from wrongly including the median in each half before finding Q1 and Q3, and 13 is Q1 mistaken for the IQR.' },
        { difficulty: 'Medium-Hard', question: 'An ordered data set is: 12, 16, 19, 23, 27, 30, 34, 38, 43, 48. Find the median and the IQR.', checkMode: 'auto', options: ['Median = 27, IQR = 19', 'Median = 28.5, IQR = 27', 'Median = 28.5, IQR = 19', 'Median = 28.5, IQR = 24'], correctIndex: 2, explanation: 'n=10 (even), median = (27+30)÷2 = 28.5. Lower half: 12,16,19,23,27 → Q1=19 (middle value). Upper half: 30,34,38,43,48 → Q3=38 (middle value). IQR = 38−19 = 19. Taking only the 5th value (27) as the median instead of averaging gives the first option, and using the wrong values for Q1/Q3 gives IQR = 27 or 24.' },
        { difficulty: 'Hard', question: 'An ordered data set is: 5, 9, 13, 16, 19, 23, 27, 31. This data set has a five-number summary with Q1 = 11 and Q3 = 25. A second data set has the same minimum and maximum but Q1 = 7 and Q3 = 29. Which data set has its middle 50% more tightly clustered?', checkMode: 'auto', options: ['The second data set (Q1=7, Q3=29)', 'Both data sets are equally clustered', 'It cannot be determined from the given information', 'The first data set (Q1=11, Q3=25)'], correctIndex: 3, explanation: 'IQR of the first data set = 25−11=14. IQR of the second data set = 29−7=22. The smaller IQR (14) means the middle 50% of the first data set is more tightly clustered.' },

        // ── Block 3 — Box-and-whisker plot interpretation (Q9-12) ──────────
        { difficulty: 'Easy', question: 'A box-and-whisker plot for a set of delivery times (in minutes) has minimum = 12, Q1 = 20, median = 27, Q3 = 34, maximum = 50. Find the interquartile range shown by the box.', checkMode: 'auto', options: ['14', '38', '7', '15'], correctIndex: 0, explanation: 'IQR = Q3 − Q1 = 34 − 20 = 14 minutes. 38 is the full range (max−min), 7 is Q3−median, and 15 is median−min.', diagramSvg: '<svg viewBox="0 0 460 140" xmlns="http://www.w3.org/2000/svg"><line x1="40" y1="115" x2="420" y2="115" stroke="#0f1f3d" stroke-width="1.5"/><line x1="40" y1="60" x2="120" y2="60" stroke="#0f1f3d" stroke-width="2"/><line x1="260" y1="60" x2="420" y2="60" stroke="#0f1f3d" stroke-width="2"/><line x1="40" y1="43" x2="40" y2="77" stroke="#0f1f3d" stroke-width="2"/><line x1="420" y1="43" x2="420" y2="77" stroke="#0f1f3d" stroke-width="2"/><rect x="120" y="43" width="140" height="34" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="190" y1="43" x2="190" y2="77" stroke="#0f1f3d" stroke-width="2.5"/><line x1="40" y1="110" x2="40" y2="120" stroke="#0f1f3d" stroke-width="1.5"/><line x1="120" y1="110" x2="120" y2="120" stroke="#0f1f3d" stroke-width="1.5"/><line x1="190" y1="110" x2="190" y2="120" stroke="#0f1f3d" stroke-width="1.5"/><line x1="260" y1="110" x2="260" y2="120" stroke="#0f1f3d" stroke-width="1.5"/><line x1="420" y1="110" x2="420" y2="120" stroke="#0f1f3d" stroke-width="1.5"/><text x="40" y="135" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">12</text><text x="120" y="135" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">20</text><text x="190" y="135" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">27</text><text x="260" y="135" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">34</text><text x="420" y="135" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">50</text></svg>' },
        { difficulty: 'Medium', question: 'A box-and-whisker plot for a set of race times has minimum = 20, Q1 = 33, median = 40, Q3 = 47, maximum = 72. Compare the range and the IQR, and state which is more affected by extreme values.', checkMode: 'auto', options: ['Range = 52, IQR = 14; the IQR is more affected by extreme values since it includes the box width.', 'Range = 52, IQR = 14; the range is more affected by extreme values since it depends only on the minimum and maximum.', 'Range = 27, IQR = 14; the range is more affected by extreme values.', 'Range = 52, IQR = 39; the range is more affected by extreme values.'], correctIndex: 1, explanation: 'Range = max−min = 72−20 = 52. IQR = Q3−Q1 = 47−33 = 14. The range is far more affected by extreme values since it depends only on the two most extreme data points, while the IQR is based on the middle 50% and ignores extreme values entirely.', diagramSvg: '<svg viewBox="0 0 460 140" xmlns="http://www.w3.org/2000/svg"><line x1="40" y1="115" x2="420" y2="115" stroke="#0f1f3d" stroke-width="1.5"/><line x1="40" y1="60" x2="135" y2="60" stroke="#0f1f3d" stroke-width="2"/><line x1="237.30769230769232" y1="60" x2="420" y2="60" stroke="#0f1f3d" stroke-width="2"/><line x1="40" y1="43" x2="40" y2="77" stroke="#0f1f3d" stroke-width="2"/><line x1="420" y1="43" x2="420" y2="77" stroke="#0f1f3d" stroke-width="2"/><rect x="135" y="43" width="102.30769230769232" height="34" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="186.15384615384616" y1="43" x2="186.15384615384616" y2="77" stroke="#0f1f3d" stroke-width="2.5"/><line x1="40" y1="110" x2="40" y2="120" stroke="#0f1f3d" stroke-width="1.5"/><line x1="135" y1="110" x2="135" y2="120" stroke="#0f1f3d" stroke-width="1.5"/><line x1="186.15384615384616" y1="110" x2="186.15384615384616" y2="120" stroke="#0f1f3d" stroke-width="1.5"/><line x1="237.30769230769232" y1="110" x2="237.30769230769232" y2="120" stroke="#0f1f3d" stroke-width="1.5"/><line x1="420" y1="110" x2="420" y2="120" stroke="#0f1f3d" stroke-width="1.5"/><text x="40" y="135" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">20</text><text x="135" y="135" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">33</text><text x="186.15384615384616" y="135" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">40</text><text x="237.30769230769232" y="135" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">47</text><text x="420" y="135" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">72</text></svg>' },
        { difficulty: 'Medium-Hard', question: 'A box-and-whisker plot for a set of salaries has minimum = 30, Q1 = 34, median = 37, Q3 = 50, maximum = 55. The right whisker and the upper part of the box are both much longer than the left whisker and lower part of the box. What does this suggest about the shape of the distribution?', checkMode: 'auto', options: ['The data is skewed to the left (negatively skewed).', 'The data is symmetric, with no skew.', 'The data is skewed to the right (positively skewed), since the values above the median are far more spread out than below it.', 'There is not enough information to determine skew.'], correctIndex: 2, explanation: 'A long right whisker/box and a short left whisker/box mean the higher values are more spread out — this is a right (positive) skew.', diagramSvg: '<svg viewBox="0 0 460 140" xmlns="http://www.w3.org/2000/svg"><line x1="40" y1="115" x2="420" y2="115" stroke="#0f1f3d" stroke-width="1.5"/><line x1="40" y1="60" x2="100.80000000000001" y2="60" stroke="#0f1f3d" stroke-width="2"/><line x1="344" y1="60" x2="420" y2="60" stroke="#0f1f3d" stroke-width="2"/><line x1="40" y1="43" x2="40" y2="77" stroke="#0f1f3d" stroke-width="2"/><line x1="420" y1="43" x2="420" y2="77" stroke="#0f1f3d" stroke-width="2"/><rect x="100.80000000000001" y="43" width="243.2" height="34" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="146.4" y1="43" x2="146.4" y2="77" stroke="#0f1f3d" stroke-width="2.5"/><line x1="40" y1="110" x2="40" y2="120" stroke="#0f1f3d" stroke-width="1.5"/><line x1="100.80000000000001" y1="110" x2="100.80000000000001" y2="120" stroke="#0f1f3d" stroke-width="1.5"/><line x1="146.4" y1="110" x2="146.4" y2="120" stroke="#0f1f3d" stroke-width="1.5"/><line x1="344" y1="110" x2="344" y2="120" stroke="#0f1f3d" stroke-width="1.5"/><line x1="420" y1="110" x2="420" y2="120" stroke="#0f1f3d" stroke-width="1.5"/><text x="40" y="135" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">30</text><text x="100.80000000000001" y="135" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">34</text><text x="146.4" y="135" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">37</text><text x="344" y="135" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">50</text><text x="420" y="135" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">55</text></svg>' },
        { difficulty: 'Hard', question: "Two classes' test results are shown as box-and-whisker plots. Class A: minimum = 50, Q1 = 63, median = 70, Q3 = 78, maximum = 93. Class B: minimum = 45, Q1 = 58, median = 70, Q3 = 86, maximum = 103. Both classes have the same median. Compare which class had more consistent (less spread out) results, using the IQR.", checkMode: 'auto', options: ["Class B had more consistent results, since its IQR (15) is smaller than Class A's IQR (28).", "Neither — both classes have identical spread since they share the same median (70).", "Class A had more consistent results, but only because its range (43) is smaller than Class B's range (58).", "Class A had more consistent results, since its IQR (78−63=15) is smaller than Class B's IQR (86−58=28)."], correctIndex: 3, explanation: "Class A's IQR = 78−63=15. Class B's IQR = 86−58=28. Class A has the smaller IQR, so its results were more consistent (less spread out), even though both classes share the same median score of 70.", diagramSvg: '<svg viewBox="0 0 480 220" xmlns="http://www.w3.org/2000/svg"><line x1="50" y1="165" x2="430" y2="165" stroke="#0f1f3d" stroke-width="1.5"/><text x="57" y="50" font-size="13" fill="#0f1f3d" font-weight="700" text-anchor="end">Class A</text><line x1="82.75862068965517" y1="45" x2="167.9310344827586" y2="45" stroke="#0f1f3d" stroke-width="2"/><line x1="266.2068965517242" y1="45" x2="364.48275862068965" y2="45" stroke="#0f1f3d" stroke-width="2"/><line x1="82.75862068965517" y1="31" x2="82.75862068965517" y2="59" stroke="#0f1f3d" stroke-width="2"/><line x1="364.48275862068965" y1="31" x2="364.48275862068965" y2="59" stroke="#0f1f3d" stroke-width="2"/><rect x="167.9310344827586" y="31" width="98.27586206896558" height="28" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="213.79310344827584" y1="31" x2="213.79310344827584" y2="59" stroke="#0f1f3d" stroke-width="2.5"/><text x="57" y="110" font-size="13" fill="#0f1f3d" font-weight="700" text-anchor="end">Class B</text><line x1="50" y1="105" x2="135.17241379310343" y2="105" stroke="#0f1f3d" stroke-width="2"/><line x1="318.6206896551724" y1="105" x2="430" y2="105" stroke="#0f1f3d" stroke-width="2"/><line x1="50" y1="91" x2="50" y2="119" stroke="#0f1f3d" stroke-width="2"/><line x1="430" y1="91" x2="430" y2="119" stroke="#0f1f3d" stroke-width="2"/><rect x="135.17241379310343" y="91" width="183.44827586206895" height="28" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="213.79310344827584" y1="91" x2="213.79310344827584" y2="119" stroke="#0f1f3d" stroke-width="2.5"/><line x1="50" y1="160" x2="50" y2="170" stroke="#0f1f3d" stroke-width="1.5"/><text x="50" y="185" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">45</text><line x1="82.75862068965517" y1="160" x2="82.75862068965517" y2="170" stroke="#0f1f3d" stroke-width="1.5"/><text x="82.75862068965517" y="201" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">50</text><line x1="135.17241379310343" y1="160" x2="135.17241379310343" y2="170" stroke="#0f1f3d" stroke-width="1.5"/><text x="135.17241379310343" y="185" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">58</text><line x1="167.9310344827586" y1="160" x2="167.9310344827586" y2="170" stroke="#0f1f3d" stroke-width="1.5"/><text x="167.9310344827586" y="201" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">63</text><line x1="213.79310344827584" y1="160" x2="213.79310344827584" y2="170" stroke="#0f1f3d" stroke-width="1.5"/><text x="213.79310344827584" y="185" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">70</text><line x1="266.2068965517242" y1="160" x2="266.2068965517242" y2="170" stroke="#0f1f3d" stroke-width="1.5"/><text x="266.2068965517242" y="201" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">78</text><line x1="318.6206896551724" y1="160" x2="318.6206896551724" y2="170" stroke="#0f1f3d" stroke-width="1.5"/><text x="318.6206896551724" y="185" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">86</text><line x1="364.48275862068965" y1="160" x2="364.48275862068965" y2="170" stroke="#0f1f3d" stroke-width="1.5"/><text x="364.48275862068965" y="201" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">93</text><line x1="430" y1="160" x2="430" y2="170" stroke="#0f1f3d" stroke-width="1.5"/><text x="430" y="185" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">103</text></svg>' },
        ...
        { difficulty: 'Hard', question: 'A scatter plot shows a strong positive correlation between the number of hours of sunshine and cold-drink sales at a shop, based on 10 clearly upward-trending data points. Amahle concludes "sunshine directly causes people to buy more cold drinks." Explain why a strong positive correlation on a scatter plot does not, by itself, prove causation.', checkMode: 'auto', options: ['Amahle is correct — a strong positive correlation on a scatter plot always proves that one variable causes the other.', 'The correlation is meaningless because scatter plots cannot show any real-world relationship.', 'Correlation only applies to negative relationships, so this scatter plot cannot show causation either way.', 'A scatter plot only shows that two variables tend to change together, not that one directly causes the other — another factor (like temperature) or coincidence could explain the pattern, so causation needs further investigation.'], correctIndex: 3, explanation: 'A scatter plot shows association, not causation. There could be a third factor involved (for example, warmer temperature on sunny days making people thirstier), or the relationship could be coincidental. Proving causation requires investigation beyond the graph itself.', diagramSvg: '<svg viewBox="0 0 320 280" xmlns="http://www.w3.org/2000/svg"><line x1="40" y1="20" x2="40" y2="230" stroke="#e5e7eb" stroke-width="1"/><line x1="92" y1="20" x2="92" y2="230" stroke="#e5e7eb" stroke-width="1"/><line x1="144" y1="20" x2="144" y2="230" stroke="#e5e7eb" stroke-width="1"/><line x1="196" y1="20" x2="196" y2="230" stroke="#e5e7eb" stroke-width="1"/><line x1="248" y1="20" x2="248" y2="230" stroke="#e5e7eb" stroke-width="1"/><line x1="300" y1="20" x2="300" y2="230" stroke="#e5e7eb" stroke-width="1"/><line x1="40" y1="20" x2="300" y2="20" stroke="#e5e7eb" stroke-width="1"/><line x1="40" y1="62" x2="300" y2="62" stroke="#e5e7eb" stroke-width="1"/><line x1="40" y1="104" x2="300" y2="104" stroke="#e5e7eb" stroke-width="1"/><line x1="40" y1="146" x2="300" y2="146" stroke="#e5e7eb" stroke-width="1"/><line x1="40" y1="188" x2="300" y2="188" stroke="#e5e7eb" stroke-width="1"/><line x1="40" y1="230" x2="300" y2="230" stroke="#e5e7eb" stroke-width="1"/><line x1="40" y1="230" x2="300" y2="230" stroke="#0f1f3d" stroke-width="1.5"/><line x1="40" y1="20" x2="40" y2="230" stroke="#0f1f3d" stroke-width="1.5"/><text x="170" y="272" font-size="12" fill="#0f1f3d" font-weight="700" text-anchor="middle">Hours of sunshine</text><text x="12" y="125" font-size="12" fill="#0f1f3d" font-weight="700" text-anchor="middle" transform="rotate(-90 12 125)">Cold-drink sales</text><circle cx="66" cy="204" r="4.5" fill="#2563eb"/><circle cx="92" cy="188" r="4.5" fill="#2563eb"/><circle cx="112.8" cy="178" r="4.5" fill="#2563eb"/><circle cx="136.2" cy="152" r="4.5" fill="#2563eb"/><circle cx="157" cy="144" r="4.5" fill="#2563eb"/><circle cx="177.8" cy="118" r="4.5" fill="#2563eb"/><circle cx="201.2" cy="102" r="4.5" fill="#2563eb"/><circle cx="222" cy="80" r="4.5" fill="#2563eb"/><circle cx="248" cy="66.00000000000003" r="4.5" fill="#2563eb"/><circle cx="274" cy="42" r="4.5" fill="#2563eb"/></svg>' },

        // ── Block 5 — Outlier effects on mean vs median (Q17-18) ────────────
        { difficulty: 'Medium', question: 'A set of runners’ times (in seconds) is: 71, 74, 77, 73, 75, 140, 72. Find the mean of this data set, including the outlier, rounded to 2 decimal places.', checkMode: 'auto', options: ['83.14', '73.67', '74', '97'], correctIndex: 0, explanation: 'Sum = 71+74+77+73+75+140+72 = 582. Mean = 582÷7 ≈ 83.14. 73.67 is the mean with the outlier excluded, 74 is the median, and 97 comes from dividing by 6 instead of 7.' },
        { difficulty: 'Hard', question: 'Using the same data set (71, 74, 77, 73, 75, 140, 72), find the median with the outlier (140) included, and the median with it excluded. Explain what this comparison shows about the effect of an outlier on the median.', checkMode: 'auto', options: ['Median with outlier = 83.14; median without outlier = 73.5 — the outlier greatly changes the median, just like it changes the mean.', 'Median with outlier = 74; median without outlier = 73.5 — very close, showing the median is much less affected by an outlier than the mean, since it depends on position not magnitude.', 'Median with outlier = 74; median without outlier = 73.5 — the outlier greatly distorts the median, just as it distorts the mean.', 'Median with outlier = 77; median without outlier = 73.5 — this shows the median is highly sensitive to outliers.'], correctIndex: 1, explanation: 'Ordered with outlier: 71,72,73,74,75,77,140 → median (4th of 7) = 74. Ordered without outlier: 71,72,73,74,75,77 → median = (73+74)÷2 = 73.5. The two medians are very close, showing the median is much less affected by an extreme outlier than the mean would be, since it depends on position rather than magnitude.' },

        // ── Block 6 — Combined comparison of two data sets (Q19-20) ─────────
        { difficulty: 'Hard', question: "Two branches of a store record their daily sales (in thousands of rand) for a month. Branch X: mean = R60 000, IQR = R10 000. Branch Y: mean = R60 000, IQR = R26 000. Both branches have the same mean daily sales. Explain which branch has more consistent daily sales, and why the mean alone would not reveal this.", checkMode: 'auto', options: ["Branch Y is more consistent, since its IQR (R26 000) is larger, meaning its sales cover a wider, more reliable range.", "Both branches are equally consistent, since they have the same mean daily sales of R60 000.", "Branch X is more consistent, since its IQR (R10 000) is much smaller than Branch Y's (R26 000); the mean alone only shows the average and says nothing about spread, so equal means can hide very different variability.", "Branch X is more consistent, but only because its mean (R60 000) is lower than Branch Y's."], correctIndex: 2, explanation: "Branch X has more consistent daily sales, since its IQR (R10 000) is much smaller than Branch Y's IQR (R26 000), meaning its middle 50% of sales values are far less spread out. The mean alone only shows the average — it says nothing about how spread out or consistent the individual values are, so two data sets can share the same mean while having very different levels of variability." },
        { difficulty: 'Hard', question: "Two farms' weekly egg yields (in dozens) are compared using box-and-whisker plots. Farm P: minimum = 38, Q1 = 50, median = 58, Q3 = 66, maximum = 78. Farm Q: minimum = 28, Q1 = 52, median = 58, Q3 = 64, maximum = 94. Both farms have the same median yield. Using the range and IQR, explain which farm's weekly yields are more predictable.", checkMode: 'auto', options: ['Farm Q is more predictable, since it has the smaller IQR (12 vs 16), and IQR is the only relevant measure of predictability.', 'Farm P is more predictable simply because it has the smaller range (40 vs 66) — IQR is irrelevant here.', 'Both farms are equally predictable, since they share the same median yield of 58.', "Farm Q has the smaller IQR (12 vs 16), but Farm P has no such extreme high or low weeks (range 40 vs Farm Q's 66), making Farm P's yields more predictable week-to-week overall."], correctIndex: 3, explanation: "Farm P's range = 78−38=40 and IQR = 66−50=16. Farm Q's range = 94−28=66 and IQR = 64−52=12. Farm Q has the smaller IQR, meaning its middle 50% is slightly more tightly clustered, but its much larger range (66 vs 40) shows more extreme high and low weeks. Overall, Farm P's yields are more predictable week-to-week since it has no such extreme outlying weeks, even though its middle-50% spread is marginally wider." },
      ],
          scoreMessages: [
        { minScore: 20, message: 'Outstanding! You have mastered mean, median, mode, range, IQR and interpreting box-and-whisker/scatter plots.' },
        { minScore: 15, message: 'Great work! Review any missed questions on the five-number summary or correlation, then try again.' },
  ...
  topicPractice: [
    // ── Q1 Easy — modal interval ─────────────────────────────────────────────
    {
      ...
      checkMode: 'auto',
      options: ['5≤x<10', '0≤x<5', '10≤x<15', '0≤x<5 and 5≤x<10 (bimodal)'],
      correctIndex: 0,
      explanation: 'The modal interval is the one with the highest frequency. 5≤x<10 has frequency 7, the highest of the three intervals — 0≤x<5 has frequency 3 and 10≤x<15 has frequency 2, so neither of those is correct, and there is no tie for bimodal.',
    },
    ...
    // ── Q2 Medium — approximate mean ─────────────────────────────────────────
    {
      ...
      correctIndex: 1,
      explanation: 'Midpoints: 2.5, 7.5, 12.5. Σ(midpoint × freq) = (2.5×3)+(7.5×7)+(12.5×2) = 7.5+52.5+25 = 85. Total freq = 12. Mean = 85÷12 ≈ 7.08. 4.58 comes from using the interval endpoints instead of midpoints, 7.5 is just the unweighted average of the three midpoints, and 6.46 comes from leaving out the first term of the sum.',
    },
    ...
    // ── Q3 Hard — endpoints vs midpoints ─────────────────────────────────────
    {
      ...
      checkMode: 'auto',
      options: ['It is not incorrect — endpoints and midpoints always give the exact same mean for grouped data.', 'Endpoints are wrong because they always overestimate the true mean, while midpoints always underestimate it.', 'Using endpoints does not represent the typical value within each interval; midpoints give a fair estimate of where most data points likely fall within that range, making the mean calculation more accurate.', 'It is incorrect only because endpoints are harder to calculate than midpoints, not because of accuracy.'],
      correctIndex: 2,
      explanation: 'Endpoints mark only the boundary of an interval, not a typical value inside it, so using them systematically biases the estimate. Midpoints represent the best single estimate of where data values within each interval are likely to lie, which is why they are used for the approximate mean. Endpoints do not always over- or under-estimate consistently, and the issue is one of accuracy, not calculation difficulty.',
    },
    ...
    // ── Q4 Easy — STAT mode ──────────────────────────────────────────────────
    {
      ...
      checkMode: 'auto',
      options: ['COMP mode', 'TABLE mode', 'EQN mode', 'STAT (statistics) mode'],
      correctIndex: 3,
      explanation: 'You must select STAT (statistics) mode, usually accessed by pressing MODE or MENU and selecting the STAT option. COMP is for general computation, TABLE generates value tables for functions, and EQN solves equations.',
    },
    ...
    // ── Q5 Medium — clearing previous data ──────────────────────────────────
    {
      ...
      checkMode: 'auto',
      options: ['it could mix old and new data together, giving an incorrect result', 'the calculator will automatically overwrite the old data, so there is no effect on the result', 'the calculator will display an error and refuse to calculate anything', 'it only affects the FREQ column, not the x column, so the mean stays correct'],
      correctIndex: 0,
      explanation: 'Old data remains stored in memory and is combined with the new entries, making all statistical results such as the mean incorrect. The calculator does not automatically clear or overwrite previous data, and it will not detect or refuse this — it simply computes statistics using all entries currently stored, old and new alike.',
    },
    ...
    // ── Q6 Hard — calculator steps for mean ─────────────────────────────────
    {
      ...
      checkMode: 'auto',
      options: ['Enter COMP mode, type the midpoints separated by commas, then press the = key to display the mean directly.', 'Enter STAT mode, select 1-VAR, input midpoints in the x column and frequencies in the FREQ column, then access the Var menu (SHIFT+1) and select x̄ for the mean.', 'Enter STAT mode, input only the frequencies (skip the x column), then read the mean from the FREQ total.', 'Enter STAT mode, select 1-VAR, input the interval endpoints (not midpoints) in the x column, then read x̄ from the Var menu.'],
      correctIndex: 1,
      explanation: 'The correct sequence is: enter STAT mode, choose 1-VAR, type each interval midpoint into the x column with its frequency in the FREQ column, then press SHIFT+1 (STAT), select Var, and choose x̄ for the mean. COMP mode does not have FREQ columns for grouped data, skipping the x column leaves no values to average, and using endpoints instead of midpoints gives an incorrect (biased) mean.',
    },
    ...
    // ── Q7 Easy — identify outlier ───────────────────────────────────────────
    {
      ...
      checkMode: 'auto',
      options: ['28', '31', '85', 'there is no outlier in this data set'],
      correctIndex: 2,
      explanation: 'Most values cluster between 28 and 32. The value 85 is far above the rest and is clearly the outlier — 28 and 31 are typical (non-outlier) values within the cluster.',
    },
    ...
    // ── Q8 Medium — outlier decision ─────────────────────────────────────────
    {
      ...
      checkMode: 'auto',
      options: ['a definite data entry error that must be deleted immediately', 'not an outlier at all, since it is only one value away from the rest', 'the mode of the data set, not an outlier', 'investigated further, since it could be a genuine extreme value or a recording error'],
      correctIndex: 3,
      explanation: 'While 3 is much lower than the other values, it could be a genuine extreme value or a data error. It must be investigated in context before deciding whether to remove it — it cannot simply be assumed to be an error, and it clearly stands apart from the cluster of 14–17, so it is not "not an outlier."',
    },
    ...
    // ── Q9 Hard — outlier removal critique ──────────────────────────────────
    {
      ...
      checkMode: 'auto',
      options: ['No — outliers should be investigated before removal; some outliers represent genuine, important values, and removing them without justification could bias the analysis and hide real information.', 'Yes — outliers are always data errors, so removing them always improves accuracy.', 'Yes — since outliers pull the mean away from the median, removing them always makes both measures more accurate.', 'No — outliers should never be removed under any circumstances, even if proven to be a data entry error.'],
      correctIndex: 0,
      explanation: 'Not every outlier is an error — some are genuine, important extreme values, so removing them without investigation can bias the results and hide real information. At the same time, outliers are not always errors, nor should they always be kept unconditionally — context and investigation should decide.',
    },
    ...
    // ── Q10 Easy — modal class from histogram ────────────────────────────────
    {
      ...
      checkMode: 'auto',
      options: ['0≤x<10', '10≤x<20', '20≤x<30', '0≤x<10 and 20≤x<30 (bimodal)'],
      correctIndex: 1,
      explanation: 'The modal class is the class interval with the tallest bar (highest frequency). 10≤x<20 has frequency 9, the highest of the three, so it is the modal class — there is no tie, so it is not bimodal.',
    },
    ...
    // ── Q11 Medium — total frequency from histogram bars ─────────────────────
    {
      ...
      options: ['24', '7', '28', '34'],
      correctIndex: 2,
      explanation: 'The total number of data values equals the sum of all bar heights: 6+10+8+4 = 28. 24 comes from leaving out the last bar, 7 is the mean height (28÷4), and 34 comes from an addition error.',
    },
    ...
    // ── Q12 Hard — why histogram bars have no gaps ───────────────────────────
    {
      ...
      checkMode: 'auto',
      options: ['It is not actually incorrect — gaps make histograms easier to read and are recommended for continuous data.', 'It is incorrect only because it wastes space on the page, not because of what the data represents.', 'It is incorrect because histograms must always have bars of different widths, and gaps interfere with that.', 'A histogram represents continuous data where each class interval joins directly onto the next, so the bars must touch with no gaps; leaving gaps incorrectly suggests the intervals are separate, unrelated categories, as in a bar graph of discrete categories.'],
      correctIndex: 3,
      explanation: 'Continuous data flows from one interval directly into the next, so histogram bars must touch. Gaps wrongly imply the intervals are separate, unrelated categories (like in an ordinary bar graph). This is a matter of correctly representing the data, not readability, page space, or bar width.',
    },
    ...
    // ── Q13 Medium — frequency polygon point ─────────────────────────────────
    {
      ...
      correctIndex: 0,
      explanation: 'The midpoint of 20≤x<30 is (20+30)÷2 = 25. The frequency is 12. Plot the point at coordinates (25, 12) — using the lower bound (20) or upper bound (30) instead of the midpoint, or the wrong frequency value, are common mistakes.',
    },
    ...
    // ── Q14 Hard — comparing frequency polygons ──────────────────────────────
    {
      ...
      checkMode: 'auto',
      options: ["It means Sipho's data set has more total data values overall than Lerato's, no matter what.", "It suggests Sipho's data set has a higher concentration of values around that particular interval compared to Lerato's data set.", "It means Sipho's data has a smaller range than Lerato's data.", "It means there is an error in one of the two frequency polygons, since peaks should always match."],
      correctIndex: 1,
      explanation: "A higher peak at a given interval means more of Sipho's data values fall in that specific interval than Lerato's — a higher local frequency there, not necessarily a larger total data set overall, and it says nothing about range or indicate an error.",
    },
    ...
    // ── Q15 Easy — reading stems and leaves ──────────────────────────────────
    {
      ...
      correctIndex: 2,
      explanation: 'Each leaf is attached to the stem 3 (tens digit): 3|1=31, 3|1=31, 3|4=34, 3|8=38, 3|9=39, giving 31, 31, 34, 38, 39. Missing the repeated leaf, forgetting to attach the stem, or misplacing the decimal point are common mistakes.',
    },
    ...
    // ── Q16 Medium — mode, range, median from a stem-and-leaf plot ───────────
    {
      ...
      checkMode: 'auto',
      options: ['Mode = 54, Range = 18, Median = 58', 'Mode = 51, Range = 18, Median = 60', 'Mode = 54, Range = 8, Median = 60', 'Mode = 54, Range = 18, Median = 60'],
      correctIndex: 3,
      explanation: 'Data in order: 51, 54, 54, 58, 62, 65, 67, 69 (8 values). Mode = 54 (appears twice). Range = 69−51 = 18. Median = average of 4th and 5th values = (58+62)÷2 = 60. Taking only the 4th value (58) as the median, mistaking the first data value (51) for the mode, or subtracting only the leaf digits instead of the full data values for the range are common mistakes.',
    },
    ...
    // ── Q17 Hard — back-to-back stem-and-leaf comparison ─────────────────────
    {
      ...
      checkMode: 'auto',
      options: ["Class A has 6 scores (42,45,48,51,53,57) and Class B has 7 scores (40,44,46,52,55,55,59); Class B has a slightly higher maximum (59 vs 57) and more scores in the 50s, suggesting Class B performed marginally better overall, though both classes cover a similar range.", "Class A has 7 scores and Class B has 6; Class A clearly outperformed Class B since it has more scores overall.", "Both classes have exactly the same set of scores, just written in a different order on each side of the stem.", "Class A performed much better than Class B, since Class A's maximum score (57) is higher than Class B's minimum score (40)."],
      correctIndex: 0,
      explanation: "Reading off the stems: Class A = 42,45,48,51,53,57 (6 scores) and Class B = 40,44,46,52,55,55,59 (7 scores). Class B reaches a slightly higher maximum (59 vs 57) and has more scores in the 50s, suggesting a marginally better overall performance, though the two classes cover a broadly similar range. The score counts are not equal, the actual values differ between classes (not just their order), and comparing a maximum to a minimum does not fairly compare overall performance.",
    },
    ...
    // ── Q18 Easy — range ─────────────────────────────────────────────────────
    {
      ...
      options: ['45', '37', '8', '33'],
      correctIndex: 1,
      explanation: 'Range = largest − smallest = 45 − 8 = 37. 45 is just the maximum, 8 is just the minimum, and 33 comes from using the wrong minimum value (12 instead of 8).',
    },
    ...
    // ── Q19 Medium — quartiles ───────────────────────────────────────────────
    {
      ...
      correctIndex: 2,
      explanation: 'Q2 (median) = (17+21)÷2 = 19. Lower half 5,9,13,17 → Q1=(9+13)÷2=11. Upper half 21,25,29,33 → Q3=(25+29)÷2=27. Swapping Q1 and Q3, using the wrong pair within each half, or picking the edge values of each half without averaging are common mistakes.',
    },
    ...
    // ── Q20 Hard — IQR and what it represents ────────────────────────────────
    {
      ...
      checkMode: 'auto',
      options: ['IQR=16. This represents the average distance of each data point from the mean.', 'IQR=38. This represents the full spread of the entire data set from minimum to maximum.', 'IQR=19. This represents the middle 50% of the data, and it is more affected by extreme values than the range.', 'IQR=16. This represents the spread of the middle 50% of the data, providing a measure of spread that is less affected by extreme values than the full range.'],
      correctIndex: 3,
      explanation: 'IQR = Q3−Q1 = 27−11 = 16. It represents the spread of the middle 50% of the data (between Q1 and Q3), and because it ignores the most extreme 25% on each end, it is less affected by outliers than the full range — not more affected, and it is not the average distance from the mean or the full spread (that is the range).',
    },
    ...
    // ── Q21 Hard — median equals Q2 ─────────────────────────────────────────
    {
      ...
      checkMode: 'auto',
      options: ['Yes — by definition, Q2 (the second quartile) is the same as the median, since both represent the middle value (50th percentile) of an ordered data set.', 'No — Q2 is always exactly halfway between Q1 and Q3, which is only sometimes equal to the median.', 'No — the median and Q2 are unrelated statistics that are only coincidentally similar in most data sets.', 'Only true for data sets with an odd number of values; for even numbers, Q2 and the median are different.'],
      correctIndex: 0,
      explanation: 'Thabo is correct. Q2, the second quartile, is defined as the middle value (50th percentile) of an ordered data set — which is exactly the definition of the median. This holds for data sets with both odd and even numbers of values, and Q2 is not defined as the midpoint of Q1 and Q3.',
    },
    ...
    // ── Q22 Hard — small IQR relative to range ───────────────────────────────
    {
      ...
      checkMode: 'auto',
      options: ['IQR=70. A small IQR relative to the range means the data has no outliers at all.', 'IQR=30. A small IQR relative to the full range suggests the middle 50% of data is tightly clustered, with possibly more extreme values pulling the full range wider, hinting at potential outliers or a skewed distribution.', 'IQR=30. A small IQR relative to the range means the data is evenly spread out across its entire range with no clustering.', 'IQR=20. A small IQR relative to the range always proves the data set contains a calculation error.'],
      correctIndex: 1,
      explanation: 'IQR = Q3−Q1 = 50−20 = 30. A small IQR compared to the full range suggests the middle 50% of the data is tightly clustered while some extreme values stretch the range much wider — this hints at potential outliers or skew, not that the data is evenly spread, not that outliers are ruled out, and not that there is necessarily any error.',
    },
    ...
    // ── Q23 Hard — approximate mean from grouped data ────────────────────────
    {
      ...
      correctIndex: 2,
      explanation: 'Midpoints: 15,25,35. Σ(midpoint×freq) = (15×5)+(25×9)+(35×6) = 75+225+210 = 510. Total frequency = 20. Mean = 510÷20 = 25.5. 20.5 comes from using the interval endpoints instead of midpoints, 25 is just the unweighted average of the three midpoints, and 21.75 comes from leaving out the first term of the sum.',
    },
    ...
    // ── Q24 Hard — calculator mean accuracy for grouped data ─────────────────
    {
      ...
      checkMode: 'auto',
      options: ['Yes — calculators always compute the exact mean regardless of whether the data is grouped or ungrouped.', 'Yes, but only if the class intervals all have the same width.', 'No — calculators can never calculate any kind of mean for grouped data at all.', 'No — for grouped data, even the calculator only provides an approximate mean based on the midpoints you input, since the exact individual values within each interval are unknown.'],
      correctIndex: 3,
      explanation: 'A calculator computes the mean from whatever values are entered — for grouped data, those are midpoints, not the actual individual data values, so the result is still only an approximate mean. Equal interval widths do not change this, and calculators can and do compute a grouped-data mean, but the result remains an estimate, not the exact mean.',
    },
    ...
    // ── Q25 Hard — 40th percentile in context ────────────────────────────────
    {
      ...
      checkMode: 'auto',
      options: ['It means approximately 40% of the data values fall below the range 25≤x<35, placing this interval as the location where the 40th percentile value lies.', 'It means exactly 40 data values fall within the interval 25≤x<35.', 'It means 40% of the data values fall above 35, and the rest fall below 25.', 'It means the interval 25≤x<35 contains the mean of the data set.'],
      correctIndex: 0,
      explanation: 'The kth percentile is the value below which k% of the data falls. The 40th percentile falling in 25≤x<35 means about 40% of values lie below this interval — it says nothing about there being exactly 40 data values, nor about a split above/below 35 and 25, and percentiles describe position/rank, not the mean.',
    },
    ...
    // ── Q26 Hard — range vs IQR outlier reasoning ────────────────────────────
    {
      ...
      checkMode: 'auto',
      options: ['Yes, completely sound — any time the range is more than 4 times the IQR, this proves mathematically that at least one outlier exists.', 'His reasoning is reasonable but not absolutely certain — a large gap between range and IQR often suggests outliers pulling the range wider than the tightly clustered middle 50%, but this should still be investigated by examining the actual data values rather than assumed automatically.', 'No — the range and IQR are unrelated statistics, so no conclusion about outliers can ever be drawn from comparing them.', 'No — a large gap between range and IQR actually proves the data set has no outliers at all.'],
      correctIndex: 1,
      explanation: 'A large gap between the range (60) and the IQR (12) is a reasonable hint that one or more outliers are pulling the range wider than the tightly clustered middle 50%, but it does not mathematically prove an outlier exists — the actual data values should still be examined. The range and IQR are related (both measure spread), so a comparison is meaningful, and the gap does not prove the opposite (no outliers) either.',
    },
  ],
