...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        'Cartesian plane showing two parallel lines with equal gradients labelled in green and two perpendicular lines with gradients multiplying to −1 labelled in orange, gradient calculation shown in blue',
      diagramSvg:
        '<svg viewBox="0 0 300 180" xmlns="http://www.w3.org/2000/svg" font-family="Arial, sans-serif"><text x="75" y="14" font-size="11" fill="#16a34a" font-weight="700" text-anchor="middle">Parallel: equal gradient</text><line x1="25" y1="145" x2="65" y2="85" stroke="#0f1f3d" stroke-width="2.5"/><line x1="85" y1="155" x2="125" y2="95" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 25,145 L 65,145 L 65,85" fill="none" stroke="#16a34a" stroke-width="1.5" stroke-dasharray="3,2"/><text x="45" y="158" font-size="9" fill="#16a34a" font-weight="700" text-anchor="middle">Δx</text><text x="73" y="118" font-size="9" fill="#16a34a" font-weight="700" text-anchor="middle">Δy</text><text x="75" y="174" font-size="10" fill="#16a34a" font-weight="700" text-anchor="middle">m₁ = m₂ (same slope)</text><line x1="160" y1="5" x2="160" y2="175" stroke="#e2e8f0" stroke-width="1"/><text x="225" y="14" font-size="9" fill="#ea580c" font-weight="700" text-anchor="middle">Perpendicular: m₁m₂=−1</text><line x1="190" y1="144" x2="270" y2="96" stroke="#0f1f3d" stroke-width="2.5"/><line x1="206" y1="80" x2="254" y2="160" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 237,116 L 241,123 L 234,127" fill="none" stroke="#ea580c" stroke-width="1.5"/><text x="272" y="92" font-size="10" fill="#ea580c" font-weight="700" text-anchor="start">m₁</text><text x="256" y="166" font-size="10" fill="#ea580c" font-weight="700" text-anchor="start">m₂</text><text x="230" y="174" font-size="10" fill="#ea580c" font-weight="700" text-anchor="middle">m₁ × m₂ = −1</text></svg>',

      videoPlaceholder:
        'Short video showing how to calculate the gradient of a line and how to identify parallel lines by equal gradients and perpendicular lines by negative reciprocal gradients',
    },
  ...
  topicPractice: [
    // ── Q1 Easy — distance formula (integer answer) ───────────────────────────
    {
      ...
      options: ['5', '25', '7', '3'],
      correctIndex: 0,
      explanation: 'distance = √[(4−1)² + (6−2)²] = √[9+16] = √25 = 5 ✓. (25 is the value under the root before taking the square root; 7 = 3+4 adds the differences directly instead of using Pythagoras; 3 is only the x-difference.)',
    },
    ...
    // ── Q2 Medium — distance formula with negative coordinates ────────────────
    {
      ...
      options: ['100', '10', '14', '6'],
      correctIndex: 1,
      explanation: 'distance = √[(4−(−2))² + (−5−3)²] = √[36+64] = √100 = 10 ✓. (100 is the value before the square root; 14 = 6+8 adds the differences directly instead of applying Pythagoras; 6 is only the x-difference.)',
    },

    // ── Q3 Hard — verify a learner's distance calculation ─────────────────────
    {
      difficulty: 'Hard',
      question: "Sipho calculates the distance between (0,0) and (6,8) and gets 10. Which statement correctly evaluates his answer?",
      checkMode: 'auto',
      options: [
        'He is incorrect — the correct distance is √(36−64), which is undefined.',
        'He is incorrect — the correct distance is 14, since 6+8=14.',
        'He is correct — √[(6−0)²+(8−0)²] = √[36+64] = √100 = 10.',
        'He is correct, but only because (0,0) is the origin; the formula would give a different answer for any other starting point.',
      ],
      correctIndex: 2,
      explanation: "distance = √[(6−0)²+(8−0)²] = √[36+64] = √100 = 10, so Sipho's answer is correct ✓. The distance formula works identically regardless of which point is the origin — option D's reasoning is false, and options A and B contain calculation errors (subtracting instead of adding under the root, or adding the legs directly).",
    },
    ...
    // ── Q4 Easy — gradient formula (positive integer) ─────────────────────────
    {
      ...
      options: ['1/3', '-3', '-1/3', '3'],
      correctIndex: 3,
      explanation: 'm = (13 − 4)/(5 − 2) = 9/3 = 3 ✓. (1/3 comes from inverting the formula Δx/Δy instead of Δy/Δx; −3 and −1/3 introduce an incorrect sign.)',
    },
    ...
    // ── Q5 Medium — gradient formula (negative result) ────────────────────────
    {
      ...
      options: ['-2', '-1/2', '2', '1/2'],
      correctIndex: 0,
      explanation: 'm = (−3 − 5)/(3 − (−1)) = −8/4 = −2 ✓. (−1/2 inverts the formula Δx/Δy instead of Δy/Δx; 2 and 1/2 flip the sign.)',
    },
    ...
    // ── Q6 Hard — parallel lines from gradient comparison ─────────────────────
    {
      ...
      checkMode: 'auto',
      options: [
        'No — gradient 1 = 4 and gradient 2 = 8, so they are not parallel.',
        'Yes — both lines have gradient 4, so they are parallel.',
        'No — gradient 1 = 1/4 and gradient 2 = 1/4, so equal gradients here mean the lines are perpendicular, not parallel.',
        'Cannot be determined without the midpoint of each line.',
      ],
      correctIndex: 1,
      explanation: 'Gradient 1 = (9−1)/(2−0) = 8/2 = 4. Gradient 2 = (12−4)/(3−1) = 8/2 = 4. Since the gradients are equal, the lines are parallel ✓.',
    },
    ...
    // ── Q7 Medium — perpendicular gradient ───────────────────────────────────
    {
      ...
      options: ['1/4', '4', '-1/4', '-4'],
      correctIndex: 2,
      explanation: 'For perpendicular lines, m₁ × m₂ = −1, so m₂ = −1/4 ✓ (the negative reciprocal of 4).',
    },
    ...
    // ── Q8 Hard — verify perpendicular claim ─────────────────────────────────
    {
      ...
      checkMode: 'auto',
      options: [
        'No — the product of the gradients is 1, not −1, so the lines are not perpendicular.',
        'No — perpendicular lines must have gradients that are equal in size, and 2/3 ≠ 3/2.',
        'Yes, but only because both gradients are fractions.',
        'Yes — (2/3) × (−3/2) = −1, confirming the lines are perpendicular.',
      ],
      correctIndex: 3,
      explanation: '(2/3) × (−3/2) = −6/6 = −1. Since the product of the gradients is −1, the lines are perpendicular ✓.',
    },
    ...
    // ── Q9 Easy — midpoint formula (positive coordinates) ────────────────────
    {
      ...
      correctIndex: 0,
      explanation: 'M = ((2+6)/2, (8+4)/2) = (4,6) ✓. (2,-2) mistakenly subtracts instead of adding the coordinates; (8,12) forgets to divide by 2; (6,4) swaps the x- and y-coordinates.',
    },
    ...
    // ── Q10 Medium — midpoint formula (mixed coordinates) ────────────────────
    {
      ...
      correctIndex: 1,
      explanation: 'M = ((−3+7)/2, (5+(−1))/2) = (4/2, 4/2) = (2,2) ✓. (5,-3) subtracts instead of adds; (4,4) forgets to divide by 2; (2,3) drops the negative sign on −1.',
    },
    ...
    // ── Q11 Hard — find unknown endpoint using midpoint ───────────────────────
    {
      ...
      correctIndex: 2,
      explanation: 'Using x₂=2a−x₁ and y₂=2b−y₁: x=2(4)−1=7, y=2(3)−7=−1. B=(7,−1) ✓. (3,-4) forgets to double the midpoint before subtracting; (5,10) adds the midpoint to A instead; (-1,7) swaps the coordinates.',
    },
    ...
    // ── Q12 Medium — find unknown endpoint R ─────────────────────────────────
    {
      ...
      correctIndex: 3,
      explanation: 'x=2(5)−3=7, y=2(3)−4=2. R=(7,2) ✓. (2,-1) forgets to double the midpoint before subtracting; (8,7) adds M and P instead of using the reverse formula; (2,7) swaps the coordinates.',
    },
    ...
    // ── Q13 Hard — find C using midpoint of BC ───────────────────────────────
    {
      ...
      correctIndex: 0,
      explanation: 'x=2(2)−4=0, y=2(3)−6=0. C=(0,0) ✓. (-2,-3) forgets to double M before subtracting; (6,9) adds M and B; (2,3) computes B−M instead of 2M−B.',
    },
    ...
    // ── Q14 Hard — determine parallel lines from two pairs of points ──────────
    {
      ...
      checkMode: 'auto',
      options: [
        'No — gradient 1 = 2 but gradient 2 = 6, so the lines are not parallel.',
        'Yes — both lines have gradient 2, so they are parallel.',
        'No — the lines intersect at (1,2), so they cannot be parallel.',
        'Cannot be determined without calculating the distance between the points.',
      ],
      correctIndex: 1,
      explanation: 'Gradient 1 = (10−2)/(5−1) = 8/4 = 2. Gradient 2 = (3−(−3))/(3−0) = 6/3 = 2. Since the gradients are equal, the lines are parallel ✓.',
    },
    ...
    // ── Q15 Hard — distance and gradient in one question ─────────────────────
    {
      ...
      checkMode: 'auto',
      options: ['Distance = 14, gradient = 4/3.', 'Distance = 10, gradient = 3/4.', 'Distance = 10, gradient = 4/3.', 'Distance = 100, gradient = 4/3.'],
      correctIndex: 2,
      explanation: 'Distance = √[(8−2)²+(7−(−1))²] = √[36+64] = √100 = 10. Gradient = (7−(−1))/(8−2) = 8/6 = 4/3 ✓.',
    },
    ...
    // ── Q16 Medium — midpoint of a diagonal in a quadrilateral ───────────────
    {
      ...
      correctIndex: 3,
      explanation: 'Midpoint of PR = ((1+5)/2, (1+4)/2) = (3, 2.5) ✓. (2,1.5) subtracts instead of adding; (6,5) forgets to divide by 2; (2.5,3) swaps the x- and y-coordinates.',
    },
    ...
    // ── Q17 Hard — midpoints of both diagonals to prove parallelogram ─────────
    {
      ...
      checkMode: 'auto',
      options: [
        'Midpoint of QS = (3,2.5), which matches the midpoint of PR, so PQRS is a parallelogram.',
        'Midpoint of QS = (2,1.5), which does not match the midpoint of PR, so PQRS is not a parallelogram.',
        'Midpoint of QS = (3,2.5), but since PR and QS are not both diagonals, this does not prove PQRS is a parallelogram.',
        'Midpoint of QS = (6,5), which does not match the midpoint of PR, so PQRS is not a parallelogram.',
      ],
      correctIndex: 0,
      explanation: 'Midpoint of QS = ((5+1)/2, (1+4)/2) = (3, 2.5), the same as the midpoint of PR found in Q16. Since both diagonals share the same midpoint, PQRS is a parallelogram ✓.',
    },
    ...
    // ── Q18 Hard — side length to determine rectangle ─────────────────────────
    {
      ...
      checkMode: 'auto',
      options: [
        'PQ = 4, but PQRS cannot be a rectangle since only one pair of sides has been checked.',
        'PQ = 4; since PQ is horizontal and QR is vertical, all angles are right angles, so PQRS is a rectangle.',
        'PQ = 3, calculated from the difference in y-coordinates only, so PQRS is not a rectangle.',
        'PQ = 16, since (5−1)²=16 already gives the distance without needing a square root.',
      ],
      correctIndex: 1,
      explanation: 'PQ = √[(5−1)²+(1−1)²] = √16 = 4. PQ is horizontal (gradient 0) and QR is vertical (undefined gradient), so PQ⊥QR forms a right angle; the same holds at each vertex since all sides are horizontal/vertical, confirming PQRS is a rectangle ✓.',
    },
    ...
    // ── Q19 Hard — find D to complete a square ───────────────────────────────
    {
      ...
      correctIndex: 2,
      explanation: 'AB is horizontal (length 4) and BC is vertical (length 4). For ABCD to be a square, D must share its x-coordinate with A and its y-coordinate with C: D=(2,7) ✓.',
    },
    ...
    // ── Q20 Hard — verify ABCD is a square by all four side lengths ───────────
    {
      ...
      checkMode: 'auto',
      options: [
        'AB=4, BC=4, CD=4, DA=8 — since one side differs, ABCD is not a square.',
        'AB=4, BC=4, CD=4, DA=4 — all four sides are equal, confirming a square.',
        'AB=4, BC=4, CD=8, DA=4 — three sides equal is enough to confirm a square without checking the fourth.',
        'AB=16, BC=16, CD=16, DA=16, since squaring the coordinate differences already gives the side length.',
      ],
      correctIndex: 1,
      explanation: 'AB=√[(6-2)²+(3-3)²]=4, BC=√[(6-6)²+(7-3)²]=4, CD=√[(2-6)²+(7-7)²]=4, DA=√[(2-2)²+(3-7)²]=4. All four sides equal 4, confirming a square (the horizontal/vertical sides guarantee right angles) ✓.',
    },
  ],
