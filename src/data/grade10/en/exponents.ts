...
export const topicData: TopicData = {
  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      name: 'Set 1',
      questions: [
        { difficulty: 'Easy', question: 'Simplify x⁶ · x².', checkMode: 'auto', options: ['x⁸', 'x¹²', 'x⁴', 'x⁶'], correctIndex: 0, explanation: 'Add the exponents: x⁶ · x² = x⁶⁺² = x⁸ ✓ (Multiplying or subtracting the exponents, or forgetting to combine them, are common mistakes.)' },
        { difficulty: 'Easy', question: 'Simplify x⁹ ÷ x⁴.', checkMode: 'auto', options: ['x¹³', 'x⁵', 'x⁻⁵', 'x⁹'], correctIndex: 1, explanation: 'Subtract the exponents: x⁹ ÷ x⁴ = x⁹⁻⁴ = x⁵ ✓' },
        { difficulty: 'Easy', question: 'Simplify a⁵ · a⁻².', checkMode: 'auto', options: ['a⁷', 'a⁻¹⁰', 'a³', 'a⁵'], correctIndex: 2, explanation: 'Add the exponents, keeping the sign of the negative exponent: a⁵ · a⁻² = a⁵⁺⁽⁻²⁾ = a³ ✓' },
        { difficulty: 'Easy', question: 'Simplify (x³)⁴.', checkMode: 'auto', options: ['x⁷', 'x³', 'x⁶⁴', 'x¹²'], correctIndex: 3, explanation: 'Use the power-of-a-power law — multiply the exponents: (x³)⁴ = x³ˣ⁴ = x¹² ✓' },
        { difficulty: 'Easy-Medium', question: 'Simplify (2x²)³.', checkMode: 'auto', options: ['8x⁶', '6x⁶', '8x⁵', '2x⁶'], correctIndex: 0, explanation: 'Apply the power to each factor: 2³ · (x²)³ = 8 · x⁶ = 8x⁶ ✓' },
        { difficulty: 'Easy-Medium', question: 'Simplify (3a²b)².', checkMode: 'auto', options: ['6a⁴b²', '9a⁴b²', '9a⁴b', '9a²b²'], correctIndex: 1, explanation: 'Apply the power to each factor: 3² · (a²)² · b² = 9 · a⁴ · b² = 9a⁴b² ✓' },
        { difficulty: 'Medium', question: 'Write x⁻⁴ with a positive exponent.', checkMode: 'auto', options: ['-x⁴', 'x⁴', '1/x⁴', '-1/x⁴'], correctIndex: 2, explanation: 'A negative exponent means the reciprocal: x⁻⁴ = 1/x⁴ ✓' },
        { difficulty: 'Medium', question: 'Simplify (2x⁻³)⁻¹ and write with a positive exponent.', checkMode: 'auto', options: ['2x³', 'x⁻³/2', '1/(2x³)', 'x³/2'], correctIndex: 3, explanation: 'Apply the power to each factor: 2⁻¹ · (x⁻³)⁻¹ = (1/2) · x³ = x³/2 ✓' },
        { difficulty: 'Medium', question: 'Simplify (x⁻²y³) ÷ (x³y⁻¹) and write with positive exponents only.', checkMode: 'auto', options: ['y⁴/x⁵', 'x⁵y⁴', 'y²/x⁵', 'y⁴/x'], correctIndex: 0, explanation: 'x-terms: x⁻² ÷ x³ = x⁻²⁻³ = x⁻⁵ → 1/x⁵. y-terms: y³ ÷ y⁻¹ = y³⁻⁽⁻¹⁾ = y⁴. Combine: y⁴/x⁵ ✓' },
        { difficulty: 'Medium', question: 'Simplify (4a⁻²b)⁻² and write with positive exponents only.', checkMode: 'auto', options: ['a⁴/(8b²)', 'a⁴/(16b²)', 'a⁻⁴/(16b²)', 'a⁴b²/16'], correctIndex: 1, explanation: 'Apply the power to each factor: 4⁻² · (a⁻²)⁻² · b⁻² = (1/16) · a⁴ · b⁻² = a⁴/(16b²) ✓' },
        { difficulty: 'Medium', question: 'Simplify 5x⁰.', checkMode: 'auto', options: ['0', '5x', '5', '1'], correctIndex: 2, explanation: 'Any non-zero base to the power 0 equals 1: 5x⁰ = 5 × 1 = 5 ✓' },
        { difficulty: 'Medium', question: 'Simplify (x²y⁰) ÷ x⁻¹.', checkMode: 'auto', options: ['x', 'x²y', '0', 'x³'], correctIndex: 3, explanation: 'y⁰ = 1, so this is x² ÷ x⁻¹ = x²⁻⁽⁻¹⁾ = x³ ✓' },
        { difficulty: 'Medium', question: 'Simplify (3x²)⁰ + 2.', checkMode: 'auto', options: ['3', '2', '5', '1'], correctIndex: 0, explanation: 'Anything (non-zero) to the power 0 is 1: (3x²)⁰ = 1. So 1 + 2 = 3 ✓' },
        { difficulty: 'Medium', question: 'Simplify (2a³b⁻²)² ÷ (a⁻¹b) and write with positive exponents only.', checkMode: 'auto', options: ['4a⁶/b⁵', '4a⁷/b⁵', '4a⁷b⁵', '2a⁷/b⁵'], correctIndex: 1, explanation: '(2a³b⁻²)² = 4a⁶b⁻⁴. Divide by a⁻¹b: 4a⁶⁻⁽⁻¹⁾b⁻⁴⁻¹ = 4a⁷b⁻⁵ = 4a⁷/b⁵ ✓' },
        { difficulty: 'Medium-Hard', question: 'Evaluate 16^(1/2).', checkMode: 'auto', options: ['8', '256', '4', '16'], correctIndex: 2, explanation: 'A power of 1/2 means the square root: 16^(1/2) = √16 = 4 ✓' },
        { difficulty: 'Medium-Hard', question: 'Evaluate 27^(1/3).', checkMode: 'auto', options: ['9', '19683', '27', '3'], correctIndex: 3, explanation: 'A power of 1/3 means the cube root: 27^(1/3) = ∛27 = 3, since 3³ = 27 ✓' },
        { difficulty: 'Hard', question: 'Evaluate 8^(2/3).', checkMode: 'auto', options: ['4', '2', '64', '8'], correctIndex: 0, explanation: 'Take the cube root first, then square: 8^(2/3) = (∛8)² = 2² = 4 ✓' },
        { difficulty: 'Hard', question: 'Solve for x: 2ˣ = 32.', checkMode: 'auto', options: ['x=4', 'x=5', 'x=6', 'x=16'], correctIndex: 1, explanation: 'Write 32 as a power of 2: 32 = 2⁵. Since the bases are equal, x = 5 ✓' },
        { difficulty: 'Hard', question: 'Solve for x: 3^(2x) = 9.', checkMode: 'auto', options: ['x=2', 'x=4.5', 'x=1', 'x=3'], correctIndex: 2, explanation: 'Write 9 as a power of 3: 9 = 3². So 3^(2x) = 3² means 2x = 2, giving x = 1 ✓' },
        { difficulty: 'Hard', question: "Zanele says x⁻² is always negative because of the minus sign in the exponent. Using x = 3, which statement correctly evaluates her claim?", checkMode: 'auto', options: ['She is correct — x⁻² = -3² = -9, which is negative.', 'She is correct, because any exponent with a minus sign in front produces a negative result.', 'She is incorrect, because x⁻² should be evaluated as -1/x², giving -1/9.', 'She is incorrect — a negative exponent means the reciprocal, not a negative value: x⁻² = 3⁻² = 1/3² = 1/9, a positive fraction.'], correctIndex: 3, explanation: 'A negative exponent tells you to take the reciprocal of the base — it does not make the result negative. For x=3: x⁻²=3⁻²=1/3²=1/9, a positive fraction. Zanele is incorrect.' },
      ],
      scoreMessages: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      name: 'Set 2',
      questions: [
        { difficulty: 'Easy', question: 'Simplify x⁷ · x³.', checkMode: 'auto', options: ['x¹⁰', 'x²¹', 'x⁴', 'x⁷'], correctIndex: 0, explanation: 'Add the exponents: x⁷ · x³ = x⁷⁺³ = x¹⁰ ✓' },
        { difficulty: 'Easy', question: 'Simplify x¹¹ ÷ x⁵.', checkMode: 'auto', options: ['x¹⁶', 'x⁶', 'x⁻⁶', 'x¹¹'], correctIndex: 1, explanation: 'Subtract the exponents: x¹¹ ÷ x⁵ = x¹¹⁻⁵ = x⁶ ✓' },
        { difficulty: 'Easy', question: 'Simplify b⁴ · b⁻³.', checkMode: 'auto', options: ['b⁷', 'b⁻¹²', 'b', 'b⁴'], correctIndex: 2, explanation: 'Add the exponents: b⁴ · b⁻³ = b⁴⁺⁽⁻³⁾ = b¹ = b ✓' },
        { difficulty: 'Easy', question: 'Simplify (x²)⁶.', checkMode: 'auto', options: ['x⁸', 'x²', 'x³⁶', 'x¹²'], correctIndex: 3, explanation: 'Multiply the exponents: (x²)⁶ = x²ˣ⁶ = x¹² ✓' },
        { difficulty: 'Easy-Medium', question: 'Simplify (3x³)².', checkMode: 'auto', options: ['9x⁶', '6x⁶', '9x⁵', '3x⁶'], correctIndex: 0, explanation: 'Apply the power to each factor: 3² · (x³)² = 9 · x⁶ = 9x⁶ ✓' },
        { difficulty: 'Easy-Medium', question: 'Simplify (2a³b²)³.', checkMode: 'auto', options: ['6a⁹b⁶', '8a⁹b⁶', '8a⁹b²', '8a⁶b⁵'], correctIndex: 1, explanation: 'Apply the power to each factor: 2³ · (a³)³ · (b²)³ = 8 · a⁹ · b⁶ = 8a⁹b⁶ ✓' },
        { difficulty: 'Medium', question: 'Write x⁻⁵ with a positive exponent.', checkMode: 'auto', options: ['-x⁵', 'x⁵', '1/x⁵', '-1/x⁵'], correctIndex: 2, explanation: 'A negative exponent means the reciprocal: x⁻⁵ = 1/x⁵ ✓' },
        { difficulty: 'Medium', question: 'Simplify (3x⁻²)⁻¹ and write with a positive exponent.', checkMode: 'auto', options: ['3x²', 'x⁻²/3', '1/(3x²)', 'x²/3'], correctIndex: 3, explanation: 'Apply the power to each factor: 3⁻¹ · (x⁻²)⁻¹ = (1/3) · x² = x²/3 ✓' },
        { difficulty: 'Medium', question: 'Simplify (x⁻³y²) ÷ (x²y⁻²) and write with positive exponents only.', checkMode: 'auto', options: ['y⁴/x⁵', 'x⁵y⁴', '1/x⁵', 'y⁴/x'], correctIndex: 0, explanation: 'x-terms: x⁻³ ÷ x² = x⁻³⁻² = x⁻⁵ → 1/x⁵. y-terms: y² ÷ y⁻² = y²⁻⁽⁻²⁾ = y⁴. Combine: y⁴/x⁵ ✓' },
        { difficulty: 'Medium', question: 'Simplify (2a⁻³b)⁻² and write with positive exponents only.', checkMode: 'auto', options: ['a⁶/(2b²)', 'a⁶/(4b²)', 'a⁻⁶/(4b²)', 'a⁶b²/4'], correctIndex: 1, explanation: 'Apply the power to each factor: 2⁻² · (a⁻³)⁻² · b⁻² = (1/4) · a⁶ · b⁻² = a⁶/(4b²) ✓' },
        { difficulty: 'Medium', question: 'Simplify 7x⁰.', checkMode: 'auto', options: ['0', '7x', '7', '1'], correctIndex: 2, explanation: 'Any non-zero base to the power 0 equals 1: 7x⁰ = 7 × 1 = 7 ✓' },
        { difficulty: 'Medium', question: 'Simplify (a³b⁰) ÷ a⁻².', checkMode: 'auto', options: ['a', 'a³b', '0', 'a⁵'], correctIndex: 3, explanation: 'b⁰ = 1, so this is a³ ÷ a⁻² = a³⁻⁽⁻²⁾ = a⁵ ✓' },
        { difficulty: 'Medium', question: 'Simplify (5x³)⁰ + 6.', checkMode: 'auto', options: ['7', '6', '11', '1'], correctIndex: 0, explanation: 'Anything (non-zero) to the power 0 is 1: (5x³)⁰ = 1. So 1 + 6 = 7 ✓' },
        { difficulty: 'Medium', question: 'Simplify (3a²b⁻³)² ÷ (a⁻¹b) and write with positive exponents only.', checkMode: 'auto', options: ['9a⁴/b⁷', '9a⁵/b⁷', '9a⁵b⁷', '3a⁵/b⁷'], correctIndex: 1, explanation: '(3a²b⁻³)² = 9a⁴b⁻⁶. Divide by a⁻¹b: 9a⁴⁻⁽⁻¹⁾b⁻⁶⁻¹ = 9a⁵b⁻⁷ = 9a⁵/b⁷ ✓' },
        { difficulty: 'Medium-Hard', question: 'Evaluate 25^(1/2).', checkMode: 'auto', options: ['12.5', '625', '5', '25'], correctIndex: 2, explanation: 'A power of 1/2 means the square root: 25^(1/2) = √25 = 5 ✓' },
        { difficulty: 'Medium-Hard', question: 'Evaluate 64^(1/3).', checkMode: 'auto', options: ['64/3', '262144', '64', '4'], correctIndex: 3, explanation: 'A power of 1/3 means the cube root: 64^(1/3) = ∛64 = 4, since 4³ = 64 ✓' },
        { difficulty: 'Hard', question: 'Evaluate 4^(3/2).', checkMode: 'auto', options: ['8', '2', '64', '4'], correctIndex: 0, explanation: 'Take the square root first, then cube: 4^(3/2) = (√4)³ = 2³ = 8 ✓' },
        { difficulty: 'Hard', question: 'Solve for x: 2ˣ = 8.', checkMode: 'auto', options: ['x=2', 'x=3', 'x=4', 'x=8'], correctIndex: 1, explanation: 'Write 8 as a power of 2: 8 = 2³. Since the bases are equal, x = 3 ✓' },
        { difficulty: 'Hard', question: 'Solve for x: 5ˣ = 125.', checkMode: 'auto', options: ['x=25', 'x=5', 'x=3', 'x=125'], correctIndex: 2, explanation: 'Write 125 as a power of 5: 125 = 5³. Since the bases are equal, x = 3 ✓' },
        { difficulty: 'Hard', question: 'Bongani says 9^(1/2) is the same as 9÷2. Which statement correctly explains what the exponent 1/2 actually means?', checkMode: 'auto', options: ['He is correct — a fractional exponent always means dividing the base by the denominator.', 'He is incorrect — an exponent of 1/2 means the square root, not division: 9^(1/2) = √9 = 3, not 4.5.', 'He is correct, since 9^(1/2) and 9÷2 both give the same decimal value.', 'He is incorrect, because 9^(1/2) actually equals 9² = 81.'], correctIndex: 1, explanation: 'A fractional exponent of 1/2 means take the square root, not divide by 2. 9^(1/2)=√9=3, not 4.5 (which is 9÷2). The denominator of a fractional exponent tells you which root to take.' },
      ],
      scoreMessages: [
        { minScore: 18, message: 'Outstanding! You have mastered exponents across every skill in this set.' },
        { minScore: 14, message: 'Great work! You are confident with exponents — review any missed questions and try another set.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        { difficulty: 'Easy', question: 'Simplify x⁵ · x⁴.', checkMode: 'auto', options: ['x⁹', 'x²⁰', 'x¹', 'x⁵'], correctIndex: 0, explanation: 'Add the exponents: x⁵ · x⁴ = x⁵⁺⁴ = x⁹ ✓' },
        { difficulty: 'Easy', question: 'Simplify x¹⁰ ÷ x⁶.', checkMode: 'auto', options: ['x¹⁶', 'x⁴', 'x⁻⁴', 'x¹⁰'], correctIndex: 1, explanation: 'Subtract the exponents: x¹⁰ ÷ x⁶ = x¹⁰⁻⁶ = x⁴ ✓' },
        { difficulty: 'Easy', question: 'Simplify a⁶ · a⁻⁴.', checkMode: 'auto', options: ['a¹⁰', 'a⁻²⁴', 'a²', 'a⁶'], correctIndex: 2, explanation: 'Add the exponents: a⁶ · a⁻⁴ = a⁶⁺⁽⁻⁴⁾ = a² ✓' },
        { difficulty: 'Easy', question: 'Simplify (x⁴)³.', checkMode: 'auto', options: ['x⁷', 'x⁴', 'x⁸¹', 'x¹²'], correctIndex: 3, explanation: 'Multiply the exponents: (x⁴)³ = x⁴ˣ³ = x¹² ✓' },
        { difficulty: 'Easy-Medium', question: 'Simplify (2x⁴)³.', checkMode: 'auto', options: ['8x¹²', '6x¹²', '8x⁷', '2x¹²'], correctIndex: 0, explanation: 'Apply the power to each factor: 2³ · (x⁴)³ = 8 · x¹² = 8x¹² ✓' },
        { difficulty: 'Easy-Medium', question: 'Simplify (3a b²)³.', checkMode: 'auto', options: ['9a³b⁶', '27a³b⁶', '27a³b²', '27a⁴b⁵'], correctIndex: 1, explanation: 'Apply the power to each factor: 3³ · a³ · (b²)³ = 27 · a³ · b⁶ = 27a³b⁶ ✓' },
        { difficulty: 'Medium', question: 'Write x⁻⁶ with a positive exponent.', checkMode: 'auto', options: ['-x⁶', 'x⁶', '1/x⁶', '-1/x⁶'], correctIndex: 2, explanation: 'A negative exponent means the reciprocal: x⁻⁶ = 1/x⁶ ✓' },
        { difficulty: 'Medium', question: 'Simplify (5x⁻²)⁻¹ and write with a positive exponent.', checkMode: 'auto', options: ['5x²', 'x⁻²/5', '1/(5x²)', 'x²/5'], correctIndex: 3, explanation: 'Apply the power to each factor: 5⁻¹ · (x⁻²)⁻¹ = (1/5) · x² = x²/5 ✓' },
        { difficulty: 'Medium', question: 'Simplify (x⁻⁴y³) ÷ (x¹y⁻¹) and write with positive exponents only.', checkMode: 'auto', options: ['y⁴/x⁵', 'x⁵y⁴', 'y²/x⁵', 'y⁴/x³'], correctIndex: 0, explanation: 'x-terms: x⁻⁴ ÷ x¹ = x⁻⁴⁻¹ = x⁻⁵ → 1/x⁵. y-terms: y³ ÷ y⁻¹ = y³⁻⁽⁻¹⁾ = y⁴. Combine: y⁴/x⁵ ✓' },
        { difficulty: 'Medium', question: 'Simplify (3a⁻²b)⁻² and write with positive exponents only.', checkMode: 'auto', options: ['a⁴/(6b²)', 'a⁴/(9b²)', 'a⁻⁴/(9b²)', 'a⁴b²/9'], correctIndex: 1, explanation: 'Apply the power to each factor: 3⁻² · (a⁻²)⁻² · b⁻² = (1/9) · a⁴ · b⁻² = a⁴/(9b²) ✓' },
        { difficulty: 'Medium', question: 'Simplify 9x⁰.', checkMode: 'auto', options: ['0', '9x', '9', '1'], correctIndex: 2, explanation: 'Any non-zero base to the power 0 equals 1: 9x⁰ = 9 × 1 = 9 ✓' },
        { difficulty: 'Medium', question: 'Simplify (b⁴c⁰) ÷ b⁻³.', checkMode: 'auto', options: ['b', 'b⁴c', '0', 'b⁷'], correctIndex: 3, explanation: 'c⁰ = 1, so this is b⁴ ÷ b⁻³ = b⁴⁻⁽⁻³⁾ = b⁷ ✓' },
        { difficulty: 'Medium', question: 'Simplify (7x⁵)⁰ + 4.', checkMode: 'auto', options: ['5', '4', '11', '1'], correctIndex: 0, explanation: 'Anything (non-zero) to the power 0 is 1: (7x⁵)⁰ = 1. So 1 + 4 = 5 ✓' },
        { difficulty: 'Medium', question: 'Simplify (2a³b⁻²)³ ÷ (a⁻¹b) and write with positive exponents only.', checkMode: 'auto', options: ['8a⁹/b⁷', '8a¹⁰/b⁷', '8a¹⁰b⁷', '6a¹⁰/b⁷'], correctIndex: 1, explanation: '(2a³b⁻²)³ = 8a⁹b⁻⁶. Divide by a⁻¹b: 8a⁹⁻⁽⁻¹⁾b⁻⁶⁻¹ = 8a¹⁰b⁻⁷ = 8a¹⁰/b⁷ ✓' },
        { difficulty: 'Medium-Hard', question: 'Evaluate 36^(1/2).', checkMode: 'auto', options: ['18', '1296', '6', '36'], correctIndex: 2, explanation: 'A power of 1/2 means the square root: 36^(1/2) = √36 = 6 ✓' },
        { difficulty: 'Medium-Hard', question: 'Evaluate 125^(1/3).', checkMode: 'auto', options: ['125/3', '1953125', '125', '5'], correctIndex: 3, explanation: 'A power of 1/3 means the cube root: 125^(1/3) = ∛125 = 5, since 5³ = 125 ✓' },
        { difficulty: 'Hard', question: 'Evaluate 9^(3/2).', checkMode: 'auto', options: ['27', '3', '729', '9'], correctIndex: 0, explanation: 'Take the square root first, then cube: 9^(3/2) = (√9)³ = 3³ = 27 ✓' },
        { difficulty: 'Hard', question: 'Solve for x: 2ˣ = 64.', checkMode: 'auto', options: ['x=5', 'x=6', 'x=7', 'x=64'], correctIndex: 1, explanation: 'Write 64 as a power of 2: 64 = 2⁶. Since the bases are equal, x = 6 ✓' },
        { difficulty: 'Hard', question: 'Solve for x: 4ˣ = 64.', checkMode: 'auto', options: ['x=16', 'x=4', 'x=3', 'x=64'], correctIndex: 2, explanation: 'Write 64 as a power of 4: 64 = 4³ (4×4×4=64). Since the bases are equal, x = 3 ✓' },
        { difficulty: 'Hard', question: 'Thabo says (x³)² and x^(3²) give the same answer. Which statement correctly evaluates his claim?', checkMode: 'auto', options: ['He is correct — both expressions simplify to x⁶ because the same two numbers, 3 and 2, are involved.', 'He is incorrect — (x³)² uses the power-of-a-power law to give x⁶, but x^(3²) means x raised to 3²=9, giving x⁹; the bracket placement changes the meaning.', 'He is correct, since exponent notation is always commutative regardless of brackets.', 'He is incorrect, because (x³)² actually equals x⁹ and x^(3²) equals x⁶.'], correctIndex: 1, explanation: '(x³)² uses the power-of-a-power law: multiply the exponents, giving x⁶. But x^(3²) means x raised to 3²=9, giving x⁹. These are different (x⁶≠x⁹), so Thabo is incorrect — the bracket placement changes the meaning of the expression.' },
      ],
      scoreMessages: [
        { minScore: 18, message: 'Outstanding! You have mastered exponents across every skill in this set.' },
        { minScore: 14, message: 'Great work! You are confident with exponents — review any missed questions and try another set.' },
...
export const topicPractice = [
  ...
  // ── Q4 Medium — negative exponent with multiple factors ────────────────────
  {
    ...
    correctIndex: 3,
    explanation: 'Apply the power to each factor: 3⁻² · x²×(⁻²) · y⁻¹×(⁻²) = (1/9) · x⁻⁴ · y². Rewrite with positive exponents: y²/(9x⁴) ✓',
  },

  // ── Q5 Hard — common error: adding different bases ─────────────────────────
  {
    difficulty: 'Hard',
    question: 'Sipho simplifies x³·y² and gets (xy)⁵. Which statement correctly evaluates his claim?',
    checkMode: 'auto',
    options: [
      'He is incorrect — exponents can only be combined when the bases are identical; x³ and y² have different bases, so they cannot be combined into (xy)⁵.',
      'He is correct, since adding the exponents 3+2=5 always works regardless of the bases.',
      'He is incorrect, because the correct simplification is x⁵y⁵.',
      'He is correct — (xy)⁵ is just a shorter way of writing x³·y².',
    ],
    correctIndex: 0,
    explanation: 'The product law x^a·x^b=x^(a+b) only applies when the bases are the same. x³ and y² have different bases (x and y), so their exponents cannot be combined — the expression x³y² is already fully simplified.',
  },
  ...
  // ── Q6 Easy — simplify surd ────────────────────────────────────────────────
  {
    ...
    correctIndex: 1,
    explanation: 'Largest perfect square factor of 32: 32 = 16 × 2. √32 = √16 × √2 = 4√2 ✓',
  },
  ...
  // ── Q8 Hard — locate surd between integers ─────────────────────────────────
  {
    ...
    checkMode: 'auto',
    options: [
      '6 and 7, since 6²=36 and 7²=49 are the closest perfect squares below 55',
      '8 and 9, since 8²=64 is just above 55',
      '54 and 56, the integers immediately surrounding 55 itself',
      '7 and 8, since 7²=49<55<64=8²',
    ],
    correctIndex: 3,
    explanation: '7² = 49 and 8² = 64. Since 49 < 55 < 64, √55 lies between 7 and 8.',
  },
  ...
  {
    difficulty: 'Hard',
    question: 'Lerato says √8+√2=√10. Which statement correctly evaluates her claim?',
    checkMode: 'auto',
    options: [
      'She is correct, because surds add like normal numbers under the same root sign.',
      'She is incorrect — √8=2√2, so √8+√2=2√2+√2=3√2, not √10.',
      'She is correct, since 8+2=10 and the root sign just carries over.',
      'She is incorrect, because √8+√2 cannot be simplified at all.',
    ],
    correctIndex: 1,
    explanation: 'Surds can only be added directly once they are simplified to the same surd form. √8=2√2, so √8+√2=2√2+√2=3√2, not √10 — you cannot add the radicands directly under one root.',
  },
  ...
  // ── Q11 Easy — rational or irrational ─────────────────────────────────────
  {
    ...
    checkMode: 'auto',
    options: ['Irrational, because it involves a square root sign', 'Irrational, because 9 is an odd number', 'Rational, because √9 = 3 exactly, a whole number', 'Irrational, because its decimal never terminates'],
    correctIndex: 2,
  ...
  {
    difficulty: 'Medium',
    question: 'Which statement correctly explains why √5 is irrational?',
    checkMode: 'auto',
    options: [
      '√5 is irrational because it has a square root sign, and all square roots are irrational.',
      '√5 is irrational because 5 is an odd number.',
      '√5 is irrational because it is bigger than 2.',
      '√5 is irrational because 5 is not a perfect square, so √5 cannot be written as an exact fraction and its decimal expansion never terminates or repeats.',
    ],
    correctIndex: 3,
    explanation: '5 is not a perfect square, so its square root cannot be written as an exact fraction; its decimal expansion continues forever without repeating, which is the definition of an irrational number.',
  },

  // ── Q13 Hard — generalise about primes ────────────────────────────────────
  {
    difficulty: 'Hard',
    question: 'Thabo says all square roots of prime numbers are irrational. Which statement correctly evaluates his claim?',
    checkMode: 'auto',
    options: [
      'He is correct — since prime numbers have no perfect-square factors other than 1, their square roots can never simplify to a whole number, making them irrational.',
      'He is incorrect — some prime numbers, like 2, have square roots that are whole numbers.',
      'He is correct, but only for prime numbers greater than 10.',
      'He is incorrect, because all square roots are rational by definition.',
    ],
    correctIndex: 0,
    explanation: 'Prime numbers have no perfect-square factors other than 1, so their square roots can never simplify to a whole number or exact fraction. This makes the square root of every prime number irrational.',
  },
  ...
  {
    difficulty: 'Hard',
    question: 'The diagonal of a rectangle is √32 cm. Which of the following correctly rounds this to 2 decimal places?',
    checkMode: 'auto',
    options: [
      '5.65 cm, because the deciding digit was rounded down incorrectly',
      '5.7 cm, since only 1 decimal place is needed for a measurement',
      '√32 cm exactly, since exact surd form is always preferred for real-world measurements',
      '5.66 cm, since √32 ≈ 5.6568… and the deciding digit (6) is 5 or more, so the second decimal place rounds up',
    ],
    correctIndex: 3,
    explanation: '√32 ≈ 5.6568… To round to 2 decimal places, look at the third decimal digit (6), which is 5 or more, so round up: 5.66 cm. Rounding to a practical number of decimal places is necessary for real-world measurements like cutting material, where exact surd form is not usable.',
  },
  ...
  {
    difficulty: 'Hard',
    question: 'Simplify (x²y⁻³)⁻¹÷(x⁻¹y²) and write with positive exponents only.',
    checkMode: 'auto',
    options: ['y/x', 'xy', 'y/x³', 'x/y'],
    correctIndex: 0,
    explanation: '(x²y⁻³)⁻¹ = x⁻²y³. Divide by x⁻¹y²: x⁻²⁻⁽⁻¹⁾y³⁻² = x⁻¹y¹ = y/x ✓',
  },

  // ── Q19 Hard — zero exponent misconception ─────────────────────────────────
  {
    difficulty: 'Hard',
    question: 'Amahle says x⁰=0 for any value of x. Which statement correctly evaluates her claim?',
    checkMode: 'auto',
    options: [
      'She is correct — any base raised to the power 0 always gives 0.',
      'She is correct, except when x is a fraction.',
      'She is incorrect — any non-zero number raised to the power 0 equals 1, not 0; the expression 0⁰ is undefined.',
      'She is incorrect, because x⁰ actually equals x.',
    ],
    correctIndex: 2,
    explanation: 'Any non-zero number raised to the power 0 equals 1, not 0. The expression 0⁰ is undefined. Amahle is incorrect.',
  },

  // ── Q20 Hard — exact and approximate form ─────────────────────────────────
  {
    difficulty: 'Hard',
    question: 'Simplify √200 and round your answer to 2 decimal places. Which of the following gives both the correct exact and approximate forms?',
    checkMode: 'auto',
    options: [
      '√200 = 20√2 (exact), ≈ 28.28 (rounded)',
      '√200 = 10√2 (exact), ≈ 14.1 (rounded to 1 decimal place)',
      '√200 = 100√2 (exact), ≈ 141.42 (rounded)',
      '√200 = 10√2 (exact), ≈ 14.14 (rounded to 2 decimal places)',
    ],
    correctIndex: 3,
    explanation: '√200 = √(100×2) = 10√2 (exact form). 10√2 ≈ 14.14 (rounded to 2 decimal places).',
  },
]
