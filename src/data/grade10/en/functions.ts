...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video explaining what a function is, how to identify functions from tables and graphs, and how to convert between the four representations',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video showing how to identify the gradient and y-intercept of a linear function, find two points, and sketch the straight-line graph',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video showing how to sketch a quadratic function by finding the turning point and plotting symmetric pairs of points, and how changing a and q affects the parabola',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video explaining the hyperbolic function y=a/x+q — how to identify the vertical and horizontal asymptotes, which quadrants the branches occupy based on the sign of a, and how to sketch the graph',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video explaining the exponential function y=a·bˣ+q — how to identify growth vs decay from the base b, find the horizontal asymptote and y-intercept, and how changing q shifts the graph',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video walking through problem-solving strategies for prescribed functions — how to read a graph to identify parameters, substitute known points to find unknowns, and verify the final equation',
    },
  ],

  topicPractice: [
    // ── Q1 Easy — identify whether y=x² is a function ─────────────────────────
    { difficulty: 'Easy', question: 'Is y=x² a function?', checkMode: 'auto', options: ['Yes — every x-value gives exactly one y-value', 'No — every x-value gives two y-values, positive and negative', 'No — some x-values produce no y-value at all', 'Yes, but only when x is positive'], correctIndex: 0, explanation: "For every value of x, y=x² produces exactly one output value, satisfying the function definition. Squaring doesn't create two outputs — it always returns a single non-negative number." },

    // ── Q2 Medium — identify non-function from a table ────────────────────────
    { difficulty: 'Medium', question: 'Sipho has a table where x=3 gives both y=6 and y=9. Is this a function?', checkMode: 'auto', options: ['Yes — a relation only needs matching values somewhere to be a function', 'No — one input cannot have two different outputs', 'No — because 6 and 9 are not factors of 3', 'Yes — as long as most inputs have one output, it still counts'], correctIndex: 1, explanation: 'One input (x=3) maps to two different outputs (y=6 and y=9). This violates the definition that each input must give exactly one output — a single exception is enough to disqualify the whole relation.' },

    // ── Q3 Hard — vertical line test ──────────────────────────────────────────
    { difficulty: 'Hard', question: 'Lerato says a vertical line graph (like x=5) is a function. Is she correct?', checkMode: 'auto', options: ['Yes — every point on the line has the same x-value, so it passes the definition', 'Yes — vertical lines are always functions since they are straight lines', 'No — a vertical line has one x-value paired with infinitely many y-values, which violates the function definition', 'No — a vertical line has no y-intercept, so it cannot be a function'], correctIndex: 2, explanation: 'A vertical line like x=5 pairs a single x-value with every possible y-value — infinitely many outputs for one input. This directly violates the one-output-per-input rule, so it is not a function (it fails the vertical line test).' },

    // ── Q4 Easy — read gradient and y-intercept ───────────────────────────────
    { difficulty: 'Easy', question: 'Identify the gradient and y-intercept of y=5x−2.', checkMode: 'auto', options: ['gradient=−2, y-intercept=5', 'gradient=5, y-intercept=2', 'gradient=2, y-intercept=−5', 'gradient=5, y-intercept=−2'], correctIndex: 3, explanation: 'Compare y=5x−2 to y=ax+q: the gradient a=5 and the y-intercept q=−2. Swapping which number is which, or losing the sign of −2, gives the wrong answers.' },

    // ── Q5 Medium — write equation from gradient and y-intercept ─────────────
    { difficulty: 'Medium', question: 'Find the equation of a line with gradient 4 passing through (0,−7).', checkMode: 'auto', options: ['y=4x−7', 'y=−7x+4', 'y=4x+7', 'y=7x−4'], correctIndex: 0, explanation: 'The y-intercept is −7 (the line passes through (0,−7)) and the gradient is 4, giving y=4x−7. Swapping the gradient and y-intercept, or losing the sign, gives the wrong options.' },

    // ── Q6 Hard — find linear equation from two points ────────────────────────
    { difficulty: 'Hard', question: 'A line passes through (0,3) and (4,11). Find its equation.', checkMode: 'auto', options: ['y=3x+2', 'y=2x+3', 'y=2x+11', 'y=8x+3'], correctIndex: 1, explanation: 'The y-intercept is 3 (from (0,3)). Gradient=(11−3)/(4−0)=8/4=2. Equation: y=2x+3. The other options mix up gradient/intercept or miscalculate the gradient.' },

    // ── Q7 Easy — find turning point of a quadratic ───────────────────────────
    { difficulty: 'Easy', question: 'Find the turning point of y=x²+5.', checkMode: 'auto', options: ['(5, 0)', '(0, 0)', '(0, 5)', '(1, 5)'], correctIndex: 2, explanation: 'For y=ax²+q, the turning point is (0, q). Here q=5, so the turning point is (0, 5). (0,0) ignores the vertical shift, and (5,0) swaps the coordinates.' },

    // ── Q8 Medium — direction of opening of a parabola ───────────────────────
    { difficulty: 'Medium', question: 'Does y=−3x² open upward or downward?', checkMode: 'auto', options: ["Upward, because the coefficient's magnitude is greater than 1", 'Upward, because −3 is added to x²', 'Cannot be determined without more information', 'Downward, because a=−3 is negative'], correctIndex: 3, explanation: 'Since a=−3<0, the parabola opens downward. The size of |a| (3) affects the width, not the direction — only the sign of a decides upward vs downward.' },

    // ── Q9 Hard — compare widths of two parabolas ─────────────────────────────
    { difficulty: 'Hard', question: 'Compare the width of y=2x² and y=0.5x². Which is narrower?', checkMode: 'auto', options: ['y=2x² is narrower, since |2|>|0.5| makes the parabola steeper/narrower', 'y=0.5x² is narrower, since dividing by 2 compresses the graph horizontally', 'They are the same width, since both are positive parabolas', 'y=2x² is wider, since larger coefficients stretch the graph outward'], correctIndex: 0, explanation: "A larger |a| makes a parabola narrower/steeper. Since |2|>|0.5|, y=2x² is narrower than y=0.5x². It's easy to mix up 'larger a → narrower' with 'larger a → wider'." },

    // ── Q10 Easy — asymptotes of a hyperbola ─────────────────────────────────
    { difficulty: 'Easy', question: 'Find the asymptotes of y=4/x+3.', checkMode: 'auto', options: ['x=4 and y=3', 'x=0 and y=3', 'x=3 and y=0', 'x=0 and y=4'], correctIndex: 1, explanation: 'The vertical asymptote is always x=0 for y=a/x+q. The horizontal asymptote is y=q=3. Confusing a with the asymptote value, or swapping x and y, gives the wrong options.' },

    // ── Q11 Medium — quadrants of a hyperbola ────────────────────────────────
    { difficulty: 'Medium', question: 'In which quadrants do the branches of y=−5/x lie?', checkMode: 'auto', options: ['First and third quadrants', 'First and second quadrants', 'Second and fourth quadrants', 'Third and fourth quadrants'], correctIndex: 2, explanation: 'Since a=−5<0, the branches lie in quadrants 2 and 4. A positive a would place the branches in quadrants 1 and 3 instead.' },

    // ── Q12 Hard — vertical asymptote with vertical shift ────────────────────
    { difficulty: 'Hard', question: 'Thabo says y=2/x and y=2/x+5 have the same vertical asymptote. Is he correct?', checkMode: 'auto', options: ['No — adding 5 shifts the vertical asymptote to x=5', 'No — adding 5 changes the value of a, which moves the vertical asymptote', 'Cannot be determined without a graph', 'Yes — both have a vertical asymptote at x=0, since adding 5 only shifts the graph vertically'], correctIndex: 3, explanation: 'The vertical asymptote of y=a/x+q is always x=0, regardless of q. Adding 5 (changing q) only shifts the horizontal asymptote and the whole graph vertically — it never moves the vertical asymptote.' },

    // ── Q13 Easy — horizontal asymptote of exponential ───────────────────────
    { difficulty: 'Easy', question: 'Find the horizontal asymptote of y=3·2ˣ+4.', checkMode: 'auto', options: ['y=4', 'y=3', 'y=2', 'y=7'], correctIndex: 0, explanation: 'The horizontal asymptote of y=a·bˣ+q is y=q=4. Mistaking a or b for q, or adding a+q, gives the wrong options.' },

    // ── Q14 Medium — growth vs decay ──────────────────────────────────────────
    { difficulty: 'Medium', question: 'Does y=(1/2)ˣ represent growth or decay?', checkMode: 'auto', options: ['Growth, since the base is a fraction', 'Decay, since 0<1/2<1', 'Growth, since 1/2 is positive', 'Neither — the function is constant'], correctIndex: 1, explanation: 'Since 0<b=1/2<1, the function represents exponential decay. A base greater than 1 gives growth; a positive base alone does not guarantee growth.' },

    // ── Q15 Hard — y-intercept of exponential with q ─────────────────────────
    { difficulty: 'Hard', question: 'Find the y-intercept of y=5·3ˣ−2.', checkMode: 'auto', options: ['y=5', 'y=−2', 'y=3', 'y=13'], correctIndex: 2, explanation: 'At x=0: y=5(3⁰)−2=5(1)−2=3. Reporting a alone, q alone, or forgetting the −2 gives the wrong options.' },

    // ── Q16 Hard — find a and q for a linear function ─────────────────────────
    { difficulty: 'Hard', question: 'A line y=ax+q passes through (0,−2) and (3,7). Find a and q.', checkMode: 'auto', options: ['a=−2, q=3', 'a=9, q=−2', 'a=3, q=7', 'a=3, q=−2'], correctIndex: 3, explanation: 'q=−2 (the y-intercept, from the point (0,−2)). a=(7−(−2))/(3−0)=9/3=3. So a=3 and q=−2.' },

    // ── Q17 Hard — find a for a quadratic given turning point and one point ───
    { difficulty: 'Hard', question: 'A quadratic y=ax²+q has turning point (0,2) and passes through (2,10). Find a.', checkMode: 'auto', options: ['a=2', 'a=4', 'a=8', 'a=5'], correctIndex: 0, explanation: 'Substitute (2,10) into y=ax²+2: 10=a(4)+2, so 8=4a, giving a=2.' },

    // ── Q18 Hard — exponential population growth calculation ──────────────────
    { difficulty: 'Hard', question: 'A population grows according to P=500(1.08)ᵗ. Find the population after 6 years, rounded to the nearest whole number.', checkMode: 'auto', options: ['740', '793', '840', '750'], correctIndex: 1, explanation: 'P=500(1.08)⁶=500×1.58687...≈793.' },

    // ── Q19 Hard — relate two quadratics by reflection ───────────────────────
    { difficulty: 'Hard', question: 'Lerato compares y=x²−4 and y=−x²+4. How do these two graphs relate to each other?', checkMode: 'auto', options: ['They are identical graphs, just written differently', 'They have different turning points, at (0,4) and (0,−4) respectively, with no other relationship', 'They are reflections of each other about the x-axis — one opens upward with turning point (0,−4), the other opens downward with turning point (0,4)', 'They are reflections of each other about the y-axis'], correctIndex: 2, explanation: 'y=x²−4 opens upward (a=1>0) with turning point (0,−4). y=−x²+4 opens downward (a=−1<0) with turning point (0,4). Negating the whole expression reflects a graph about the x-axis, not the y-axis.' },

    // ── Q20 Hard — find a and q for a hyperbola ───────────────────────────────
    { difficulty: 'Hard', question: 'A hyperbola y=a/x+q has a horizontal asymptote at y=−1 and passes through (2,1). Find a and q.', checkMode: 'auto', options: ['a=2, q=−1', 'a=6, q=1', 'a=1, q=2', 'a=4, q=−1'], correctIndex: 3, explanation: 'q=−1 (from the horizontal asymptote). Substitute (2,1): 1=a/2−1, so 2=a/2, giving a=4. Thus a=4 and q=−1.' },
  ],
  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'Find the turning point of y = x² − 9.', checkMode: 'auto', options: ['(0, −9)', '(9, 0)', '(0, 9)', '(−9, 0)'], correctIndex: 0, explanation: 'For y = ax² + q, the turning point is (0, q). Here q = −9, so the turning point is (0, −9). Swapping coordinates or losing the sign gives the wrong options.' },
        { difficulty: 'Easy', question: 'Does y = −2x² + 8 open upward or downward?', checkMode: 'auto', options: ['Downward, because 8 is positive', 'Downward, because a = −2 is negative', 'Upward, because |−2| < 8', 'Upward, because the y-intercept is positive'], correctIndex: 1, explanation: 'Since a = −2 < 0, the parabola opens downward. The sign of q (here +8) affects vertical position, not direction — only the sign of a decides that.' },
        { difficulty: 'Easy', question: 'Find the x-intercepts of y = x² − 16.', checkMode: 'auto', options: ['(16, 0) and (−16, 0)', '(8, 0) and (−8, 0)', '(4, 0) and (−4, 0)', '(0, 4) and (0, −4)'], correctIndex: 2, explanation: 'Set y = 0: 0 = x² − 16, so x² = 16, giving x = ±4. The x-intercepts are (4, 0) and (−4, 0). Using 16 itself, halving it to 8, or swapping the x/y coordinates are the traps here.' },

        // Block 2 — hyperbola features from equation (Easy-Medium)
        { difficulty: 'Easy-Medium', question: 'Find the asymptotes of y = 6/x − 1.', checkMode: 'auto', options: ['x = 0 and y = 1', 'x = −1 and y = 0', 'x = 6 and y = −1', 'x = 0 and y = −1'], correctIndex: 3, explanation: 'The vertical asymptote is always x = 0 for y = a/x + q. The horizontal asymptote is y = q = −1.' },
        { difficulty: 'Easy-Medium', question: 'In which quadrants do the branches of y = −4/x lie?', checkMode: 'auto', options: ['Second and fourth quadrants', 'First and third quadrants', 'First and second quadrants', 'Third and fourth quadrants'], correctIndex: 0, explanation: 'Since a = −4 < 0, the branches lie in quadrants 2 and 4.' },
        { difficulty: 'Easy-Medium', question: 'Find the horizontal asymptote of y = 3/x + 7.', checkMode: 'auto', options: ['y = 3', 'y = 7', 'y = 0', 'y = 10'], correctIndex: 1, explanation: 'The horizontal asymptote of y = a/x + q is y = q = 7.' },

        // Block 3 — exponential features from equation (Medium)
        { difficulty: 'Medium', question: 'Find the horizontal asymptote of y = 3·2ˣ + 1.', checkMode: 'auto', options: ['y = 3', 'y = 2', 'y = 1', 'y = 4'], correctIndex: 2, explanation: 'The horizontal asymptote of y = a·bˣ + q is y = q = 1.' },
        { difficulty: 'Medium', question: 'Does y = 5·(1/2)ˣ − 3 represent growth or decay, and what is its horizontal asymptote?', checkMode: 'auto', options: ['Growth; y = −3', 'Growth; y = 5', 'Decay; y = 5', 'Decay; y = −3'], correctIndex: 3, explanation: 'Since 0 < b = 1/2 < 1, this represents exponential decay. The horizontal asymptote is y = q = −3.' },
        { difficulty: 'Medium', question: 'Find the y-intercept of y = 2·3ˣ + 4.', checkMode: 'auto', options: ['(0, 6)', '(0, 4)', '(0, 2)', '(0, 9)'], correctIndex: 0, explanation: 'Set x = 0: y = 2(3⁰) + 4 = 2(1) + 4 = 6. The y-intercept is (0, 6).' },

        // Block 4 — transformations of a and q (Medium)
        { difficulty: 'Medium', question: 'For y = ax² + q, if a increases from 2 to 5 (both positive), what happens to the parabola?', checkMode: 'auto', options: ['The parabola becomes wider, since a larger a stretches it outward', 'The parabola becomes narrower, since a larger |a| makes it steeper — direction and turning point stay the same', 'The turning point shifts to the right', 'The parabola flips to open downward'], correctIndex: 1, explanation: 'A larger |a| makes a parabola narrower/steeper. Since a increases from 2 to 5 (both positive), the parabola becomes narrower — the direction of opening and turning point are unaffected.' },
        { difficulty: 'Medium', question: 'For y = a/x + q, if q changes from 3 to −2, what happens to the graph?', checkMode: 'auto', options: ['The vertical asymptote shifts from x = 3 to x = −2', 'The branches move from quadrants 1 and 3 to quadrants 2 and 4', 'The horizontal asymptote shifts from y = 3 to y = −2 — the whole graph shifts down 5 units', 'Nothing changes, since q does not affect the graph'], correctIndex: 2, explanation: 'The horizontal asymptote of y = a/x + q is always y = q, so it shifts from y = 3 to y = −2 — the graph moves down 5 units. The vertical asymptote (x = 0) and branch shape are unaffected since a is unchanged.' },
        { difficulty: 'Medium', question: 'For y = a·bˣ + q, if q increases (becomes more positive), what happens to the horizontal asymptote?', checkMode: 'auto', options: ['The horizontal asymptote shifts downward', 'The base b increases as well', 'The vertical asymptote shifts upward', 'The horizontal asymptote shifts upward, since it is always at y = q'], correctIndex: 3, explanation: 'The horizontal asymptote of an exponential function y = a·bˣ + q is always at y = q. As q increases, the asymptote (and the whole graph) shifts upward. Exponential functions have no vertical asymptote.' },

        // Block 5 — [DIAGRAM] sketch-description-to-equation (Medium-Hard)
        { difficulty: 'Medium-Hard', question: 'The parabola shown has a turning point at (0, −2) and passes through the point (2, 6). Find the equation of the parabola in the form y = ax² + q.', checkMode: 'auto', options: ['y = 2x² − 2', 'y = x² + 2', 'y = 8x² − 2', 'y = 2x² + 2'], correctIndex: 0, explanation: 'The turning point (0, −2) gives q = −2. Substitute (2, 6): 6 = a(2)² − 2, so 8 = 4a, giving a = 2. Equation: y = 2x² − 2. Misreading the turning point sign, or forgetting to divide 8 by 4, produces the other options.', diagramSvg: '<svg viewBox="0 0 220 220" xmlns="http://www.w3.org/2000/svg"><line x1="14" y1="2" x2="14" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="38" y1="2" x2="38" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="62" y1="2" x2="62" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="86" y1="2" x2="86" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="110" y1="2" x2="110" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="134" y1="2" x2="134" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="158" y1="2" x2="158" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="182" y1="2" x2="182" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="206" y1="2" x2="206" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="206" x2="218" y2="206" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="182" x2="218" y2="182" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="158" x2="218" y2="158" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="134" x2="218" y2="134" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="110" x2="218" y2="110" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="86" x2="218" y2="86" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="62" x2="218" y2="62" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="38" x2="218" y2="38" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="14" x2="218" y2="14" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="110" x2="218" y2="110" stroke="#374151" stroke-width="1.5"/><line x1="110" y1="2" x2="110" y2="218" stroke="#374151" stroke-width="1.5"/><text x="210" y="104" font-size="11" fill="#374151">x</text><text x="116" y="12" font-size="11" fill="#374151">y</text><path d="M86,38 L89,60.5 L92,80 L95,96.5 L98,110 L101,120.5 L104,128 L107,132.5 L110,134 L113,132.5 L116,128 L119,120.5 L122,110 L125,96.5 L128,80 L131,60.5 L134,38" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><circle cx="110" cy="134" r="3.5" fill="#2563eb"/><text x="116" y="150" font-size="12" fill="#2563eb" font-weight="700" text-anchor="start">(0, -2)</text><circle cx="134" cy="38" r="3.5" fill="#2563eb"/><text x="141" y="30" font-size="12" fill="#2563eb" font-weight="700" text-anchor="start">(2, 6)</text></svg>' },
        { difficulty: 'Medium-Hard', question: 'The hyperbola shown has a horizontal asymptote at y = 1 and passes through the point (1, 4). Find the equation of the hyperbola in the form y = a/x + q.', checkMode: 'auto', options: ['y = 4/x + 1', 'y = 3/x + 1', 'y = 3/x − 1', 'y = 4/x − 1'], correctIndex: 1, explanation: 'The horizontal asymptote y = 1 gives q = 1. Substitute (1, 4): 4 = a/1 + 1, so a = 3. Equation: y = 3/x + 1. Using the point y-value directly as a, or flipping the sign of q, gives the wrong options.', diagramSvg: '<svg viewBox="0 0 220 220" xmlns="http://www.w3.org/2000/svg"><line x1="14" y1="2" x2="14" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="38" y1="2" x2="38" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="62" y1="2" x2="62" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="86" y1="2" x2="86" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="110" y1="2" x2="110" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="134" y1="2" x2="134" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="158" y1="2" x2="158" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="182" y1="2" x2="182" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="206" y1="2" x2="206" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="206" x2="218" y2="206" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="182" x2="218" y2="182" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="158" x2="218" y2="158" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="134" x2="218" y2="134" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="110" x2="218" y2="110" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="86" x2="218" y2="86" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="62" x2="218" y2="62" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="38" x2="218" y2="38" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="14" x2="218" y2="14" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="110" x2="218" y2="110" stroke="#374151" stroke-width="1.5"/><line x1="110" y1="2" x2="110" y2="218" stroke="#374151" stroke-width="1.5"/><text x="210" y="104" font-size="11" fill="#374151">x</text><text x="116" y="12" font-size="11" fill="#374151">y</text><line x1="16.88" y1="98" x2="203.12" y2="98" stroke="#ea580c" stroke-width="1.8" stroke-dasharray="5,4"/><text x="204.08" y="92" font-size="12" fill="#ea580c" font-weight="700" text-anchor="end">y = 1</text><path d="M115.76,23 L117.44,39.94 L119.12,50.63 L120.8,58 L122.48,63.38 L124.16,67.49 L125.84,70.73 L127.52,73.34 L129.2,75.5 L130.88,77.31 L132.56,78.85 L134.24,80.18 L135.92,81.33 L137.6,82.35 L139.28,83.25 L140.96,84.05 L142.64,84.76 L144.32,85.41 L146,86 L147.68,86.54 L149.36,87.02 L151.04,87.47 L152.72,87.89 L154.4,88.27 L156.08,88.63 L157.76,88.95 L159.44,89.26 L161.12,89.55 L162.8,89.82 L164.48,90.07 L166.16,90.31 L167.84,90.53 L169.52,90.74 L171.2,90.94 L172.88,91.13 L174.56,91.31 L176.24,91.48 L177.92,91.64 L179.6,91.79 L181.28,91.94 L182.96,92.08 L184.64,92.21 L186.32,92.34 L188,92.46 L189.68,92.58 L191.36,92.69 L193.04,92.8 L194.72,92.9 L196.4,93 L198.08,93.1 L199.76,93.19 L201.44,93.28 L203.12,93.36 L204.8,93.44 L206.48,93.52 L208.16,93.6 L209.84,93.67 L211.52,93.74 L213.2,93.81 L214.88,93.88 L216.56,93.95 L218.24,94.01 L219.92,94.07 L221.6,94.13 L223.28,94.19 L224.96,94.24 L226.64,94.3 L228.32,94.35 L230,94.4" fill="none" stroke="#2563eb" stroke-width="2.5"/><path d="M-10,101.6 L-8.32,101.65 L-6.64,101.7 L-4.96,101.76 L-3.28,101.81 L-1.6,101.87 L0.08,101.93 L1.76,101.99 L3.44,102.05 L5.12,102.12 L6.8,102.19 L8.48,102.26 L10.16,102.33 L11.84,102.4 L13.52,102.48 L15.2,102.56 L16.88,102.64 L18.56,102.72 L20.24,102.81 L21.92,102.9 L23.6,103 L25.28,103.1 L26.96,103.2 L28.64,103.31 L30.32,103.42 L32,103.54 L33.68,103.66 L35.36,103.79 L37.04,103.92 L38.72,104.06 L40.4,104.21 L42.08,104.36 L43.76,104.52 L45.44,104.69 L47.12,104.87 L48.8,105.06 L50.48,105.26 L52.16,105.47 L53.84,105.69 L55.52,105.93 L57.2,106.18 L58.88,106.45 L60.56,106.74 L62.24,107.05 L63.92,107.38 L65.6,107.73 L67.28,108.11 L68.96,108.53 L70.64,108.98 L72.32,109.46 L74,110 L75.68,110.59 L77.36,111.24 L79.04,111.95 L80.72,112.75 L82.4,113.65 L84.08,114.67 L85.76,115.82 L87.44,117.15 L89.12,118.69 L90.8,120.5 L92.48,122.66 L94.16,125.27 L95.84,128.51 L97.52,132.62 L99.2,138 L100.88,145.37 L102.56,156.06 L104.24,173 L105.92,203.88" fill="none" stroke="#2563eb" stroke-width="2.5"/><circle cx="122" cy="62" r="3.5" fill="#2563eb"/><text x="129" y="54" font-size="12" fill="#2563eb" font-weight="700" text-anchor="start">(1, 4)</text></svg>' },
        { difficulty: 'Medium-Hard', question: 'The exponential graph shown has base 2, a horizontal asymptote at y = 2, and passes through the point (0, 5). Find the equation in the form y = a·2ˣ + q.', checkMode: 'auto', options: ['y = 5·2ˣ', 'y = 3·2ˣ + 5', 'y = 3·2ˣ + 2', 'y = 5·2ˣ + 2'], correctIndex: 2, explanation: 'The horizontal asymptote y = 2 gives q = 2. Substitute (0, 5): 5 = a(2⁰) + 2 = a + 2, so a = 3. Equation: y = 3·2ˣ + 2. Using the y-intercept value directly as a, without subtracting q first, gives the wrong options.', diagramSvg: '<svg viewBox="0 0 220 220" xmlns="http://www.w3.org/2000/svg"><line x1="14" y1="2" x2="14" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="38" y1="2" x2="38" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="62" y1="2" x2="62" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="86" y1="2" x2="86" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="110" y1="2" x2="110" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="134" y1="2" x2="134" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="158" y1="2" x2="158" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="182" y1="2" x2="182" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="206" y1="2" x2="206" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="206" x2="218" y2="206" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="182" x2="218" y2="182" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="158" x2="218" y2="158" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="134" x2="218" y2="134" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="110" x2="218" y2="110" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="86" x2="218" y2="86" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="62" x2="218" y2="62" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="38" x2="218" y2="38" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="14" x2="218" y2="14" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="110" x2="218" y2="110" stroke="#374151" stroke-width="1.5"/><line x1="110" y1="2" x2="110" y2="218" stroke="#374151" stroke-width="1.5"/><text x="210" y="104" font-size="11" fill="#374151">x</text><text x="116" y="12" font-size="11" fill="#374151">y</text><line x1="16.88" y1="86" x2="203.12" y2="86" stroke="#ea580c" stroke-width="1.8" stroke-dasharray="5,4"/><text x="204.08" y="80" font-size="12" fill="#ea580c" font-weight="700" text-anchor="end">y = 2</text><path d="M-10,85.96 L-7.33,85.96 L-4.67,85.95 L-2,85.94 L0.67,85.93 L3.33,85.92 L6,85.91 L8.67,85.9 L11.33,85.88 L14,85.86 L16.67,85.84 L19.33,85.81 L22,85.78 L24.67,85.74 L27.33,85.7 L30,85.65 L32.67,85.59 L35.33,85.52 L38,85.44 L40.67,85.34 L43.33,85.23 L46,85.11 L48.67,84.96 L51.33,84.78 L54,84.58 L56.67,84.35 L59.33,84.07 L62,83.75 L64.67,83.38 L67.33,82.94 L70,82.43 L72.67,81.83 L75.33,81.14 L78,80.33 L80.67,79.39 L83.33,78.28 L86,77 L88.67,75.5 L91.33,73.75 L94,71.71 L96.67,69.33 L99.33,66.56 L102,63.32 L104.67,59.54 L107.33,55.14 L110,50 L112.67,44 L115.33,37.01 L118,28.85 L120.67,19.34" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><circle cx="110" cy="50" r="3.5" fill="#2563eb"/><text x="116" y="42" font-size="12" fill="#2563eb" font-weight="700" text-anchor="start">(0, 5)</text></svg>' },
        { difficulty: 'Medium-Hard', question: 'The parabola shown has a turning point at (0, 4) and passes through the point (−1, 1). Find the equation of the parabola in the form y = ax² + q.', checkMode: 'auto', options: ['y = 3x² + 4', 'y = −3x² − 4', 'y = −2x² + 4', 'y = −3x² + 4'], correctIndex: 3, explanation: 'The turning point (0, 4) gives q = 4. Substitute (−1, 1): 1 = a(−1)² + 4, so 1 = a + 4, giving a = −3. Equation: y = −3x² + 4. Dropping the negative sign on a or on q produces the other options.', diagramSvg: '<svg viewBox="0 0 220 220" xmlns="http://www.w3.org/2000/svg"><line x1="14" y1="2" x2="14" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="38" y1="2" x2="38" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="62" y1="2" x2="62" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="86" y1="2" x2="86" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="110" y1="2" x2="110" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="134" y1="2" x2="134" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="158" y1="2" x2="158" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="182" y1="2" x2="182" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="206" y1="2" x2="206" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="206" x2="218" y2="206" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="182" x2="218" y2="182" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="158" x2="218" y2="158" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="134" x2="218" y2="134" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="110" x2="218" y2="110" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="86" x2="218" y2="86" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="62" x2="218" y2="62" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="38" x2="218" y2="38" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="14" x2="218" y2="14" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="110" x2="218" y2="110" stroke="#374151" stroke-width="1.5"/><line x1="110" y1="2" x2="110" y2="218" stroke="#374151" stroke-width="1.5"/><text x="210" y="104" font-size="11" fill="#374151">x</text><text x="116" y="12" font-size="11" fill="#374151">y</text><path d="M86,206 L89,172.25 L92,143 L95,118.25 L98,98 L101,82.25 L104,71 L107,64.25 L110,62 L113,64.25 L116,71 L119,82.25 L122,98 L125,118.25 L128,143 L131,172.25 L134,206" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><circle cx="110" cy="62" r="3.5" fill="#2563eb"/><text x="116" y="54" font-size="12" fill="#2563eb" font-weight="700" text-anchor="start">(0, 4)</text><circle cx="98" cy="98" r="3.5" fill="#2563eb"/><text x="91" y="114" font-size="12" fill="#2563eb" font-weight="700" text-anchor="end">(-1, 1)</text></svg>' },

        // Block 6 — domain/range and mixed hard application (Hard)
        { difficulty: 'Hard', question: 'State the domain and range of y = x² + 3.', checkMode: 'auto', options: ['Domain: x ∈ ℝ. Range: y ≥ 3', 'Domain: x ≥ 3. Range: y ∈ ℝ', 'Domain: x ∈ ℝ. Range: y ≤ 3', 'Domain: x ≠ 0. Range: y ≥ 3'], correctIndex: 0, explanation: "Domain: x ∈ ℝ (all real numbers, since there's no restriction). Range: y ≥ 3, since the parabola opens upward with turning point (0, 3), so the minimum y-value is 3. Confusing which variable the restriction applies to, or the direction of the inequality, gives the wrong options." },
        { difficulty: 'Hard', question: 'State the domain and range of y = 4/x − 2.', checkMode: 'auto', options: ['Domain: x ∈ ℝ, x ≠ −2. Range: y ∈ ℝ, y ≠ 0', 'Domain: x ∈ ℝ, x ≠ 0. Range: y ∈ ℝ, y ≠ −2', 'Domain: x ∈ ℝ, x ≠ 4. Range: y ∈ ℝ, y ≠ −2', 'Domain: x ∈ ℝ. Range: y ∈ ℝ, y ≠ −2'], correctIndex: 1, explanation: 'Domain: x ∈ ℝ, x ≠ 0 (the function is undefined at x = 0). Range: y ∈ ℝ, y ≠ −2 (y can never equal the horizontal asymptote value). Confusing the excluded x-value with q, or forgetting the domain restriction, gives the wrong options.' },
        { difficulty: 'Hard', question: 'A hyperbola y = a/x + q has asymptotes x = 0 and y = 3, and passes through the point (2, 5). Find a and q, and state the equation.', checkMode: 'auto', options: ['y = 5/x + 3', 'y = 4/x + 2', 'y = 4/x + 3', 'y = 2/x + 3'], correctIndex: 2, explanation: 'q = 3 (from the horizontal asymptote). Substitute (2, 5): 5 = a/2 + 3, so 2 = a/2, giving a = 4. Equation: y = 4/x + 3.' },
        { difficulty: 'Hard', question: 'A bacteria colony grows according to N = 200(1.15)ᵗ, where t is time in hours. Find N after 4 hours, rounded to the nearest whole number.', checkMode: 'auto', options: ['300', '320', '400', '350'], correctIndex: 3, explanation: 'N = 200(1.15)⁴ = 200 × 1.74900625 ≈ 349.8, which rounds to 350.' },
      ],
      scoreMessages: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // Block 1 — quadratic features from equation (Easy)
        { difficulty: 'Easy', question: 'Find the turning point of y = x² − 6.', checkMode: 'auto', options: ['(0, −6)', '(6, 0)', '(0, 6)', '(−6, 0)'], correctIndex: 0, explanation: 'For y = ax² + q, the turning point is (0, q). Here q = −6, so the turning point is (0, −6).' },
        { difficulty: 'Easy', question: 'Does y = −4x² + 2 open upward or downward?', checkMode: 'auto', options: ['Upward, since 2 is positive', 'Downward, since a = −4 is negative', 'Upward, since |−4| > 2', 'Downward, since the y-intercept is positive'], correctIndex: 1, explanation: 'Since a = −4 < 0, the parabola opens downward. The sign of q (+2) sets the vertical position, not the direction.' },
        { difficulty: 'Easy', question: 'Find the x-intercepts of y = x² − 36.', checkMode: 'auto', options: ['(0, 6) and (0, −6)', '(18, 0) and (−18, 0)', '(6, 0) and (−6, 0)', '(12, 0) and (−12, 0)'], correctIndex: 2, explanation: 'Set y = 0: 0 = x² − 36, so x² = 36, giving x = ±6. The x-intercepts are (6, 0) and (−6, 0).' },

        // Block 2 — hyperbola features from equation (Easy-Medium)
        { difficulty: 'Easy-Medium', question: 'Find the asymptotes of y = −3/x + 6.', checkMode: 'auto', options: ['x = −3 and y = 6', 'x = 6 and y = 0', 'x = 0 and y = −3', 'x = 0 and y = 6'], correctIndex: 3, explanation: 'The vertical asymptote is always x = 0. The horizontal asymptote is y = q = 6.' },
        { difficulty: 'Easy-Medium', question: 'In which quadrants do the branches of y = −9/x lie?', checkMode: 'auto', options: ['Second and fourth quadrants', 'First and third quadrants', 'First and second quadrants', 'Third and fourth quadrants'], correctIndex: 0, explanation: 'Since a = −9 < 0, the branches lie in quadrants 2 and 4.' },
        { difficulty: 'Easy-Medium', question: 'Find the horizontal asymptote of y = 10/x − 4.', checkMode: 'auto', options: ['y = 10', 'y = −4', 'y = 0', 'y = 4'], correctIndex: 1, explanation: 'The horizontal asymptote of y = a/x + q is y = q = −4.' },

        // Block 3 — exponential features from equation (Medium)
        { difficulty: 'Medium', question: 'Find the horizontal asymptote of y = 2·5ˣ + 3.', checkMode: 'auto', options: ['y = 2', 'y = 5', 'y = 3', 'y = 8'], correctIndex: 2, explanation: 'The horizontal asymptote of y = a·bˣ + q is y = q = 3.' },
        { difficulty: 'Medium', question: 'Does y = 8·(1/3)ˣ − 2 represent growth or decay, and what is its horizontal asymptote?', checkMode: 'auto', options: ['Growth; y = −2', 'Decay; y = 8', 'Growth; y = 8', 'Decay; y = −2'], correctIndex: 3, explanation: 'Since 0 < b = 1/3 < 1, this represents exponential decay. The horizontal asymptote is y = q = −2.' },
        { difficulty: 'Medium', question: 'Find the y-intercept of y = 3·4ˣ + 2.', checkMode: 'auto', options: ['(0, 5)', '(0, 3)', '(0, 2)', '(0, 12)'], correctIndex: 0, explanation: 'Set x = 0: y = 3(4⁰) + 2 = 3(1) + 2 = 5. The y-intercept is (0, 5).' },

        // Block 4 — transformations of a and q (Medium)
        { difficulty: 'Medium', question: 'For y = ax² + q, if q changes from −3 to 6, what happens to the turning point?', checkMode: 'auto', options: ['The turning point stays at (0, −3), since only the width changes', 'The turning point moves from (0, −3) to (0, 6) — the whole parabola shifts upward 9 units', 'The turning point moves to (9, 0)', 'The parabola flips to open downward'], correctIndex: 1, explanation: 'The turning point moves from (0, −3) to (0, 6) — the whole parabola shifts upward 9 units. Width and direction of opening are unaffected since a is unchanged.' },
        { difficulty: 'Medium', question: 'For y = a/x + q, if |a| increases while a stays positive, what happens to the branches?', checkMode: 'auto', options: ['The branches move into quadrants 2 and 4', 'The vertical asymptote moves further from the origin', 'The branches move further from the axes, stretching outward, while staying in quadrants 1 and 3', 'The branches move closer to the origin, shrinking inward'], correctIndex: 2, explanation: 'As |a| increases (a stays positive), the branches move further away from the asymptotes/axes — the curve stretches outward, staying in quadrants 1 and 3. The asymptotes are unaffected.' },
        { difficulty: 'Medium', question: 'For y = a·bˣ + q, if the base b changes from a value greater than 1 to a value between 0 and 1 (a and q unchanged), what happens to the graph?', checkMode: 'auto', options: ['The horizontal asymptote moves to a new value', 'The graph becomes a straight line', 'The y-intercept disappears', 'The graph changes from growth to decay, while the horizontal asymptote y = q stays the same'], correctIndex: 3, explanation: 'The graph changes from exponential growth to exponential decay — instead of rising steeply as x increases, the curve now falls. The horizontal asymptote y = q is unaffected since only b changed.' },

        // Block 5 — [DIAGRAM] sketch-description-to-equation (Medium-Hard)
        { difficulty: 'Medium-Hard', question: 'The parabola shown has a turning point at (0, 3) and passes through the point (1, −2). Find the equation of the parabola in the form y = ax² + q.', checkMode: 'auto', options: ['y = −5x² + 3', 'y = 5x² + 3', 'y = −5x² − 3', 'y = −2x² + 3'], correctIndex: 0, explanation: 'The turning point (0, 3) gives q = 3. Substitute (1, −2): −2 = a(1)² + 3, so a = −5. Equation: y = −5x² + 3. Dropping the sign on a or q, or forgetting to fully subtract 3, gives the wrong options.', diagramSvg: '<svg viewBox="0 0 220 220" xmlns="http://www.w3.org/2000/svg"><line x1="14" y1="2" x2="14" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="38" y1="2" x2="38" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="62" y1="2" x2="62" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="86" y1="2" x2="86" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="110" y1="2" x2="110" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="134" y1="2" x2="134" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="158" y1="2" x2="158" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="182" y1="2" x2="182" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="206" y1="2" x2="206" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="206" x2="218" y2="206" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="182" x2="218" y2="182" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="158" x2="218" y2="158" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="134" x2="218" y2="134" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="110" x2="218" y2="110" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="86" x2="218" y2="86" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="62" x2="218" y2="62" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="38" x2="218" y2="38" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="14" x2="218" y2="14" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="110" x2="218" y2="110" stroke="#374151" stroke-width="1.5"/><line x1="110" y1="2" x2="110" y2="218" stroke="#374151" stroke-width="1.5"/><text x="210" y="104" font-size="11" fill="#374151">x</text><text x="116" y="12" font-size="11" fill="#374151">y</text><path d="M95,167.75 L98,134 L101,107.75 L104,89 L107,77.75 L110,74 L113,77.75 L116,89 L119,107.75 L122,134 L125,167.75" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><circle cx="110" cy="74" r="3.5" fill="#2563eb"/><text x="116" y="66" font-size="12" fill="#2563eb" font-weight="700" text-anchor="start">(0, 3)</text><circle cx="122" cy="134" r="3.5" fill="#2563eb"/><text x="129" y="150" font-size="12" fill="#2563eb" font-weight="700" text-anchor="start">(1, -2)</text></svg>' },
        { difficulty: 'Medium-Hard', question: 'The hyperbola shown has a horizontal asymptote at y = 2 and passes through the point (−1, −3). Find the equation of the hyperbola in the form y = a/x + q.', checkMode: 'auto', options: ['y = 3/x + 2', 'y = 5/x + 2', 'y = 5/x − 2', 'y = −5/x + 2'], correctIndex: 1, explanation: 'The horizontal asymptote y = 2 gives q = 2. Substitute (−1, −3): −3 = a/(−1) + 2, so −3 = −a + 2, giving a = 5. Equation: y = 5/x + 2.', diagramSvg: '<svg viewBox="0 0 220 220" xmlns="http://www.w3.org/2000/svg"><line x1="14" y1="2" x2="14" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="38" y1="2" x2="38" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="62" y1="2" x2="62" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="86" y1="2" x2="86" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="110" y1="2" x2="110" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="134" y1="2" x2="134" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="158" y1="2" x2="158" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="182" y1="2" x2="182" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="206" y1="2" x2="206" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="206" x2="218" y2="206" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="182" x2="218" y2="182" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="158" x2="218" y2="158" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="134" x2="218" y2="134" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="110" x2="218" y2="110" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="86" x2="218" y2="86" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="62" x2="218" y2="62" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="38" x2="218" y2="38" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="14" x2="218" y2="14" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="110" x2="218" y2="110" stroke="#374151" stroke-width="1.5"/><line x1="110" y1="2" x2="110" y2="218" stroke="#374151" stroke-width="1.5"/><text x="210" y="104" font-size="11" fill="#374151">x</text><text x="116" y="12" font-size="11" fill="#374151">y</text><line x1="16.88" y1="86" x2="203.12" y2="86" stroke="#ea580c" stroke-width="1.8" stroke-dasharray="5,4"/><text x="204.08" y="80" font-size="12" fill="#ea580c" font-weight="700" text-anchor="end">y = 2</text><path d="M102.56,182.77 L100.88,164.95 L99.2,152.67 L97.52,143.69 L95.84,136.85 L94.16,131.45 L92.48,127.1 L90.8,123.5 L89.12,120.48 L87.44,117.91 L85.76,115.7 L84.08,113.78 L82.4,112.09 L80.72,110.59 L79.04,109.26 L77.36,108.06 L75.68,106.98 L74,106 L72.32,105.11 L70.64,104.29 L68.96,103.54 L67.28,102.85 L65.6,102.22 L63.92,101.63 L62.24,101.08 L60.56,100.56 L58.88,100.08 L57.2,99.64 L55.52,99.22 L53.84,98.82 L52.16,98.45 L50.48,98.1 L48.8,97.76 L47.12,97.45 L45.44,97.15 L43.76,96.87 L42.08,96.6 L40.4,96.34 L38.72,96.1 L37.04,95.87 L35.36,95.65 L33.68,95.43 L32,95.23 L30.32,95.04 L28.64,94.85 L26.96,94.67 L25.28,94.5 L23.6,94.33 L21.92,94.17 L20.24,94.02 L18.56,93.87 L16.88,93.73 L15.2,93.59 L13.52,93.46 L11.84,93.33 L10.16,93.21 L8.48,93.09 L6.8,92.98 L5.12,92.86 L3.44,92.76 L1.76,92.65 L0.08,92.55 L-1.6,92.45 L-3.28,92.36 L-4.96,92.26 L-6.64,92.17 L-8.32,92.09 L-10,92" fill="none" stroke="#2563eb" stroke-width="2.5"/><path d="M230,80 L228.32,79.91 L226.64,79.83 L224.96,79.74 L223.28,79.64 L221.6,79.55 L219.92,79.45 L218.24,79.35 L216.56,79.24 L214.88,79.14 L213.2,79.02 L211.52,78.91 L209.84,78.79 L208.16,78.67 L206.48,78.54 L204.8,78.41 L203.12,78.27 L201.44,78.13 L199.76,77.98 L198.08,77.83 L196.4,77.67 L194.72,77.5 L193.04,77.33 L191.36,77.15 L189.68,76.96 L188,76.77 L186.32,76.57 L184.64,76.35 L182.96,76.13 L181.28,75.9 L179.6,75.66 L177.92,75.4 L176.24,75.13 L174.56,74.85 L172.88,74.55 L171.2,74.24 L169.52,73.9 L167.84,73.55 L166.16,73.18 L164.48,72.78 L162.8,72.36 L161.12,71.92 L159.44,71.44 L157.76,70.92 L156.08,70.38 L154.4,69.78 L152.72,69.15 L151.04,68.46 L149.36,67.71 L147.68,66.89 L146,66 L144.32,65.02 L142.64,63.94 L140.96,62.74 L139.28,61.41 L137.6,59.91 L135.92,58.22 L134.24,56.3 L132.56,54.09 L130.88,51.52 L129.2,48.5 L127.52,44.9 L125.84,40.55 L124.16,35.15 L122.48,28.31 L120.8,19.33" fill="none" stroke="#2563eb" stroke-width="2.5"/><circle cx="98" cy="146" r="3.5" fill="#2563eb"/><text x="91" y="162" font-size="12" fill="#2563eb" font-weight="700" text-anchor="end">(-1, -3)</text></svg>' },
        { difficulty: 'Medium-Hard', question: 'The exponential graph shown has base 3, a horizontal asymptote at y = 1, and passes through the point (0, 6). Find the equation in the form y = a·3ˣ + q.', checkMode: 'auto', options: ['y = 6·3ˣ', 'y = 6·3ˣ + 1', 'y = 5·3ˣ + 1', 'y = 5·3ˣ − 1'], correctIndex: 2, explanation: 'The horizontal asymptote y = 1 gives q = 1. Substitute (0, 6): 6 = a(3⁰) + 1 = a + 1, so a = 5. Equation: y = 5·3ˣ + 1.', diagramSvg: '<svg viewBox="0 0 220 220" xmlns="http://www.w3.org/2000/svg"><line x1="14" y1="2" x2="14" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="38" y1="2" x2="38" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="62" y1="2" x2="62" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="86" y1="2" x2="86" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="110" y1="2" x2="110" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="134" y1="2" x2="134" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="158" y1="2" x2="158" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="182" y1="2" x2="182" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="206" y1="2" x2="206" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="206" x2="218" y2="206" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="182" x2="218" y2="182" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="158" x2="218" y2="158" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="134" x2="218" y2="134" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="110" x2="218" y2="110" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="86" x2="218" y2="86" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="62" x2="218" y2="62" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="38" x2="218" y2="38" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="14" x2="218" y2="14" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="110" x2="218" y2="110" stroke="#374151" stroke-width="1.5"/><line x1="110" y1="2" x2="110" y2="218" stroke="#374151" stroke-width="1.5"/><text x="210" y="104" font-size="11" fill="#374151">x</text><text x="116" y="12" font-size="11" fill="#374151">y</text><line x1="16.88" y1="98" x2="203.12" y2="98" stroke="#ea580c" stroke-width="1.8" stroke-dasharray="5,4"/><text x="204.08" y="92" font-size="12" fill="#ea580c" font-weight="700" text-anchor="end">y = 1</text><path d="M-10,98 L-7.33,98 L-4.67,98 L-2,98 L0.67,98 L3.33,98 L6,98 L8.67,97.99 L11.33,97.99 L14,97.99 L16.67,97.99 L19.33,97.99 L22,97.98 L24.67,97.98 L27.33,97.97 L30,97.96 L32.67,97.95 L35.33,97.94 L38,97.92 L40.67,97.89 L43.33,97.87 L46,97.83 L48.67,97.78 L51.33,97.72 L54,97.64 L56.67,97.55 L59.33,97.42 L62,97.26 L64.67,97.05 L67.33,96.79 L70,96.46 L72.67,96.03 L75.33,95.49 L78,94.8 L80.67,93.91 L83.33,92.78 L86,91.33 L88.67,89.49 L91.33,87.14 L94,84.13 L96.67,80.3 L99.33,75.4 L102,69.16 L104.67,61.18 L107.33,51 L110,38 L112.67,21.41" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><circle cx="110" cy="38" r="3.5" fill="#2563eb"/><text x="116" y="30" font-size="12" fill="#2563eb" font-weight="700" text-anchor="start">(0, 6)</text></svg>' },
        { difficulty: 'Medium-Hard', question: 'The parabola shown has a turning point at (0, −4) and passes through the point (3, 5). Find the equation of the parabola in the form y = ax² + q.', checkMode: 'auto', options: ['y = 9x² − 4', 'y = x² + 4', 'y = −x² − 4', 'y = x² − 4'], correctIndex: 3, explanation: 'The turning point (0, −4) gives q = −4. Substitute (3, 5): 5 = a(3)² − 4, so 9 = 9a, giving a = 1. Equation: y = x² − 4.', diagramSvg: '<svg viewBox="0 0 220 220" xmlns="http://www.w3.org/2000/svg"><line x1="20" y1="2" x2="20" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="50" y1="2" x2="50" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="80" y1="2" x2="80" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="110" y1="2" x2="110" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="140" y1="2" x2="140" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="170" y1="2" x2="170" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="200" y1="2" x2="200" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="200" x2="218" y2="200" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="170" x2="218" y2="170" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="140" x2="218" y2="140" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="110" x2="218" y2="110" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="80" x2="218" y2="80" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="50" x2="218" y2="50" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="20" x2="218" y2="20" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="110" x2="218" y2="110" stroke="#374151" stroke-width="1.5"/><line x1="110" y1="2" x2="110" y2="218" stroke="#374151" stroke-width="1.5"/><text x="210" y="104" font-size="11" fill="#374151">x</text><text x="116" y="12" font-size="11" fill="#374151">y</text><path d="M74.25,22.19 L77,41.1 L79.75,58.49 L82.5,74.38 L85.25,88.74 L88,101.6 L90.75,112.94 L93.5,122.78 L96.25,131.09 L99,137.9 L101.75,143.19 L104.5,146.98 L107.25,149.24 L110,150 L112.75,149.24 L115.5,146.98 L118.25,143.19 L121,137.9 L123.75,131.09 L126.5,122.78 L129.25,112.94 L132,101.6 L134.75,88.74 L137.5,74.38 L140.25,58.49 L143,41.1 L145.75,22.19" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><circle cx="110" cy="150" r="3.5" fill="#2563eb"/><text x="116" y="166" font-size="12" fill="#2563eb" font-weight="700" text-anchor="start">(0, -4)</text><circle cx="140" cy="60" r="3.5" fill="#2563eb"/><text x="147" y="52" font-size="12" fill="#2563eb" font-weight="700" text-anchor="start">(3, 5)</text></svg>' },

        // Block 6 — domain/range and mixed hard application (Hard)
        { difficulty: 'Hard', question: 'State the domain and range of y = 5x² + 2.', checkMode: 'auto', options: ['Domain: x ∈ ℝ. Range: y ≥ 2', 'Domain: x ∈ ℝ. Range: y ≤ 2', 'Domain: x ≥ 2. Range: y ∈ ℝ', 'Domain: x ∈ ℝ, x ≠ 0. Range: y ≥ 2'], correctIndex: 0, explanation: 'Domain: x ∈ ℝ. Range: y ≥ 2, since the parabola opens upward (a = 5 > 0) with turning point (0, 2), so the minimum y-value is 2.' },
        { difficulty: 'Hard', question: 'State the domain and range of y = 6/x + 1.', checkMode: 'auto', options: ['Domain: x ∈ ℝ, x ≠ 6. Range: y ∈ ℝ, y ≠ 1', 'Domain: x ∈ ℝ, x ≠ 0. Range: y ∈ ℝ, y ≠ 1', 'Domain: x ∈ ℝ, x ≠ 1. Range: y ∈ ℝ, y ≠ 0', 'Domain: x ∈ ℝ. Range: y ∈ ℝ, y ≠ 1'], correctIndex: 1, explanation: 'Domain: x ∈ ℝ, x ≠ 0 (undefined where the denominator is zero). Range: y ∈ ℝ, y ≠ 1 (y can never equal the horizontal asymptote value).' },
        { difficulty: 'Hard', question: 'A hyperbola y = a/x + q has asymptotes x = 0 and y = 4, and passes through the point (−1, 1). Find a and q, and state the equation.', checkMode: 'auto', options: ['y = 1/x + 4', 'y = 3/x − 4', 'y = 3/x + 4', 'y = −3/x + 4'], correctIndex: 2, explanation: 'q = 4 (from the horizontal asymptote). Substitute (−1, 1): 1 = a/(−1) + 4, so 1 = −a + 4, giving a = 3. Equation: y = 3/x + 4.' },
        { difficulty: 'Hard', question: 'A radioactive substance decays according to M = 800(0.92)ᵗ, where t is time in years. Find M after 6 years, rounded to the nearest whole number.', checkMode: 'auto', options: ['520', '450', '600', '485'], correctIndex: 3, explanation: 'M = 800(0.92)⁶ = 800 × 0.606355... ≈ 485.08, which rounds to 485.' },
      ],
      scoreMessages: [
        { minScore: 20, message: 'Outstanding! You have mastered parabolas, hyperbolas and exponential functions.' },
        { minScore: 15, message: 'Great work! Review any missed questions on asymptotes or turning points and try again.' },
