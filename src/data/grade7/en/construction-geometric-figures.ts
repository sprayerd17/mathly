  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramSvg:
        ...
        '<path d="M 77.96,124.47 A 60,60 0 0 0 20,80" fill="none" stroke="#2563eb" stroke-width="1.6"/>' +
        '<path d="M 86.06,74.22 A 70,70 0 0 0 42.4,121.9" fill="none" stroke="#2563eb" stroke-width="1.6"/>' +
        ...
        '<path d="M 198.19,129.74 A 30,30 0 0 0 180.26,111.81" fill="none" stroke="#2563eb" stroke-width="1.6"/>' +
        '<path d="M 246.32,102.41 A 40,40 0 0 0 222.41,126.32" fill="none" stroke="#2563eb" stroke-width="1.6"/>' +
        ...
        '<text x="210" y="136" font-size="9" font-weight="700" fill="#dc2626" text-anchor="middle">arcs don’t meet</text>' +
        '</svg>',
