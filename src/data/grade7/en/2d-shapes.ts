  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'A parallelogram, as shown, has one angle of 58°. Find the size of the largest angle in the parallelogram.', answer: '122°', checkMode: 'auto', correctAnswer: '122', correctAnswers: ['122', '122°', '122 degrees'], explanation: 'Opposite angles in a parallelogram are equal, so the angle opposite 58° is also 58°. Adjacent angles are supplementary: 180° − 58° = 122°. The largest angle is 122°.', diagramSvg: '<svg viewBox="0 0 220 170" xmlns="http://www.w3.org/2000/svg"><polygon points="40,135 165,135 195,35 70,35" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="55" y="122" font-size="14" fill="#2563eb" font-weight="700">58°</text></svg>' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'A parallelogram, as shown, has one angle of 111°. Find the size of the smallest angle in the parallelogram.', answer: '69°', checkMode: 'auto', correctAnswer: '69', correctAnswers: ['69', '69°', '69 degrees'], explanation: 'Opposite angles in a parallelogram are equal, so the angle opposite 111° is also 111°. Adjacent angles are supplementary: 180° − 111° = 69°. The smallest angle is 69°.', diagramSvg: '<svg viewBox="0 0 220 170" xmlns="http://www.w3.org/2000/svg"><polygon points="40,135 165,135 195,35 70,35" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="55" y="122" font-size="14" fill="#2563eb" font-weight="700">111°</text></svg>' },
