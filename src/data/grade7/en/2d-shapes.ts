  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        // Block C — quadrilateral angle sum, properties & exterior angle theorem
        { difficulty: 'Easy', question: 'In the quadrilateral shown, three of the angles are 105°, 88° and 132°. Find the fourth angle.', answer: '35°', checkMode: 'auto', correctAnswer: '35', correctAnswers: ['35', '35°', '35 degrees'], explanation: 'Fourth angle = 360° − 105° − 88° − 132° = 35°. Check: 105+88+132+35 = 360 ✓', diagramSvg: '<svg viewBox="0 0 220 170" xmlns="http://www.w3.org/2000/svg"><polygon points="61.8,135 109.6,135 108.3,96.5 35,35" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="74" y="119.1" font-size="13" fill="#2563eb" font-weight="700">105°</text><text x="95.2" y="121.1" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">88°</text><text x="90.3" y="105.3" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">132°</text><text x="45.7" y="51.9" font-size="15" fill="#ea580c" font-weight="700">?</text></svg>' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        // Block C — quadrilateral angle sum, properties & exterior angle theorem
        { difficulty: 'Easy', question: 'In the quadrilateral shown, three of the angles are 68°, 152° and 94°. Find the fourth angle.', answer: '46°', checkMode: 'auto', correctAnswer: '46', correctAnswers: ['46', '46°', '46 degrees'], explanation: 'Fourth angle = 360° − 68° − 152° − 94° = 46°. Check: 68+152+94+46 = 360 ✓', diagramSvg: '<svg viewBox="0 0 220 170" xmlns="http://www.w3.org/2000/svg"><polygon points="35,135 69.2,135 110.2,113.2 75.4,35" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="51.6" y="123.8" font-size="13" fill="#2563eb" font-weight="700">68°</text><text x="64.4" y="115.6" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">152°</text><text x="91.3" y="106.7" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">94°</text><text x="75.7" y="55" font-size="15" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },
