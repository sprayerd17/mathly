  ...
  practiceSets: [
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'A rectangular whiteboard is 90 cm long and 60 cm wide, as shown. Find its area.', answer: '5400 cm²', checkMode: 'auto', correctAnswer: '5400', correctAnswers: ['5400', '5400 cm²', '5400cm²'], explanation: 'A = l × b = 90 × 60 = 5400 cm² ✓', diagramSvg: '<svg viewBox="0 0 220 190" xmlns="http://www.w3.org/2000/svg"><rect x="40" y="40" width="140" height="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="110.0" y="28" font-size="14" fill="#2563eb" font-weight="700" text-anchor="middle">90 cm</text><text x="26" y="85.0" font-size="14" fill="#dc2626" font-weight="700" text-anchor="middle" transform="rotate(-90 26 85.0)">60 cm</text></svg>' },
        { difficulty: 'Medium', question: 'A triangular sail has a base of 4 m and a height of 3 m, as shown. Find its area.', answer: '6 m²', checkMode: 'auto', correctAnswer: '6', correctAnswers: ['6', '6 m²', '6m²'], explanation: 'A = ½ × b × h = 0.5 × 4 × 3 = 6 m² ✓', diagramSvg: '<svg viewBox="0 0 220 190" xmlns="http://www.w3.org/2000/svg"><polygon points="30,150 190,150 110,30" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="110" y1="30" x2="110" y2="150" stroke="#dc2626" stroke-width="2" stroke-dasharray="5,4"/><rect x="102" y="142" width="8" height="8" fill="none" stroke="#dc2626" stroke-width="1.5"/><text x="110.0" y="172" font-size="14" fill="#2563eb" font-weight="700" text-anchor="middle">4 m</text><text x="156.0" y="90.0" font-size="14" fill="#7c3aed" font-weight="700" text-anchor="start">3 m</text></svg>' },
        { difficulty: 'Hard', question: 'A rectangular poster has an area of 4800 cm². Its length is 80 cm. Find its width, as shown.', answer: '60 cm', checkMode: 'auto', correctAnswer: '60', correctAnswers: ['60', '60 cm', '60cm'], explanation: 'A = l × b\n4800 = 80 × b\nb = 4800 ÷ 80 = 60 cm ✓', diagramSvg: '<svg viewBox="0 0 220 190" xmlns="http://www.w3.org/2000/svg"><rect x="40" y="40" width="140" height="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="110.0" y="28" font-size="14" fill="#2563eb" font-weight="700" text-anchor="middle">80 cm</text><text x="26" y="85.0" font-size="15" fill="#ea580c" font-weight="700" text-anchor="middle" transform="rotate(-90 26 85.0)">?</text><text x="110.0" y="70" font-size="12" fill="#374151" text-anchor="middle">Area = 4800 cm²</text></svg>' },
    ...
    },
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'A rectangular notice board is 120 cm long and 80 cm wide, as shown. Find its area.', answer: '9600 cm²', checkMode: 'auto', correctAnswer: '9600', correctAnswers: ['9600', '9600 cm²', '9600cm²'], explanation: 'A = l × b = 120 × 80 = 9600 cm² ✓', diagramSvg: '<svg viewBox="0 0 220 190" xmlns="http://www.w3.org/2000/svg"><rect x="40" y="40" width="140" height="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="110.0" y="28" font-size="14" fill="#2563eb" font-weight="700" text-anchor="middle">120 cm</text><text x="26" y="85.0" font-size="14" fill="#dc2626" font-weight="700" text-anchor="middle" transform="rotate(-90 26 85.0)">80 cm</text></svg>' },
        ...
        { difficulty: 'Medium', question: 'A square rug has an area of 22500 cm². Find the length of its sides.', answer: '150 cm', checkMode: 'auto', correctAnswer: '150', correctAnswers: ['150', '150 cm', '150cm'], explanation: 'A = l²\n22500 = l²\nl = √22500 = 150 cm ✓' },
