...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video showing how to find the rule of a numeric pattern including linear patterns and patterns based on square numbers',

      diagramPlaceholder: 'Numeric pattern with terms highlighted in blue, common difference highlighted in orange, and the nth term rule written in green',
      diagramSvg: '<svg viewBox="0 0 245 90" xmlns="http://www.w3.org/2000/svg"><rect x="15" y="15" width="32" height="30" fill="#eff6ff" stroke="#2563eb" stroke-width="2"/><text x="31" y="35" font-weight="700" font-size="16" text-anchor="middle" fill="#2563eb">5</text><rect x="75" y="15" width="32" height="30" fill="#eff6ff" stroke="#2563eb" stroke-width="2"/><text x="91" y="35" font-weight="700" font-size="16" text-anchor="middle" fill="#2563eb">9</text><rect x="135" y="15" width="32" height="30" fill="#eff6ff" stroke="#2563eb" stroke-width="2"/><text x="151" y="35" font-weight="700" font-size="16" text-anchor="middle" fill="#2563eb">13</text><rect x="195" y="15" width="32" height="30" fill="#eff6ff" stroke="#2563eb" stroke-width="2"/><text x="211" y="35" font-weight="700" font-size="16" text-anchor="middle" fill="#2563eb">17</text><line x1="47" y1="30" x2="72" y2="30" stroke="#ea580c" stroke-width="2"/><polygon points="72,26 78,30 72,34" fill="#ea580c"/><text x="60" y="21" font-weight="700" font-size="11" text-anchor="middle" fill="#ea580c">+4</text><line x1="107" y1="30" x2="132" y2="30" stroke="#ea580c" stroke-width="2"/><polygon points="132,26 138,30 132,34" fill="#ea580c"/><text x="120" y="21" font-weight="700" font-size="11" text-anchor="middle" fill="#ea580c">+4</text><line x1="167" y1="30" x2="192" y2="30" stroke="#ea580c" stroke-width="2"/><polygon points="192,26 198,30 192,34" fill="#ea580c"/><text x="180" y="21" font-weight="700" font-size="11" text-anchor="middle" fill="#ea580c">+4</text><text x="121" y="70" font-weight="700" font-size="13" text-anchor="middle" fill="#16a34a">nth term = 4n + 1</text></svg>',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video showing how to complete a table of values using a given rule and how to find the rule from a completed table',

      diagramPlaceholder: 'Table of values with the input column highlighted in blue and the output column highlighted in green, showing the rule connecting them written in orange',
      diagramSvg: '<svg viewBox="0 0 230 150" xmlns="http://www.w3.org/2000/svg"><text x="70" y="9" font-size="9" text-anchor="middle" fill="#374151">Table of values</text><rect x="20" y="15" width="100" height="122" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><rect x="20" y="15" width="50" height="26" fill="#eff6ff" stroke="#0f1f3d" stroke-width="1.5"/><text x="45" y="33" font-weight="700" font-size="14" text-anchor="middle" fill="#2563eb">x</text><rect x="70" y="15" width="50" height="26" fill="#f0fdf4" stroke="#0f1f3d" stroke-width="1.5"/><text x="95" y="33" font-weight="700" font-size="14" text-anchor="middle" fill="#16a34a">y</text><line x1="20" y1="41" x2="120" y2="41" stroke="#0f1f3d" stroke-width="1"/><line x1="20" y1="65" x2="120" y2="65" stroke="#0f1f3d" stroke-width="1"/><line x1="20" y1="89" x2="120" y2="89" stroke="#0f1f3d" stroke-width="1"/><line x1="20" y1="113" x2="120" y2="113" stroke="#0f1f3d" stroke-width="1"/><text x="45" y="57" font-size="13" text-anchor="middle" fill="#2563eb">1</text><text x="95" y="57" font-size="13" text-anchor="middle" fill="#16a34a">6</text><text x="45" y="81" font-size="13" text-anchor="middle" fill="#2563eb">2</text><text x="95" y="81" font-size="13" text-anchor="middle" fill="#16a34a">11</text><text x="45" y="105" font-size="13" text-anchor="middle" fill="#2563eb">3</text><text x="95" y="105" font-size="13" text-anchor="middle" fill="#16a34a">16</text><text x="45" y="129" font-size="13" text-anchor="middle" fill="#2563eb">4</text><text x="95" y="129" font-size="13" text-anchor="middle" fill="#16a34a">21</text><text x="175" y="72" font-weight="700" font-size="12" text-anchor="middle" fill="#ea580c">Rule:</text><text x="175" y="88" font-weight="700" font-size="12" text-anchor="middle" fill="#ea580c">y = 5x + 1</text></svg>',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video showing how to plot points from a table of values on a Cartesian plane and describe whether the graph is a straight line or a curve',

      diagramPlaceholder: 'Cartesian plane with x-axis in blue, y-axis in green, plotted points in orange, and a straight line graph shape in red for the rule y equals 2x plus 1',
      diagramSvg: '<svg viewBox="0 0 220 190" xmlns="http://www.w3.org/2000/svg"><line x1="30" y1="160" x2="195" y2="160" stroke="#2563eb" stroke-width="2.5"/><polygon points="195,156 203,160 195,164" fill="#2563eb"/><line x1="40" y1="175" x2="40" y2="12" stroke="#16a34a" stroke-width="2.5"/><polygon points="36,12 40,4 44,12" fill="#16a34a"/><text x="205" y="164" font-weight="700" font-size="11" fill="#2563eb">x</text><text x="40" y="8" font-weight="700" font-size="11" text-anchor="middle" fill="#16a34a">y</text><text x="40" y="172" font-size="9" text-anchor="middle" fill="#0f1f3d">0</text><line x1="60" y1="156" x2="60" y2="164" stroke="#0f1f3d" stroke-width="1"/><text x="60" y="174" font-size="9" text-anchor="middle" fill="#0f1f3d">1</text><line x1="80" y1="156" x2="80" y2="164" stroke="#0f1f3d" stroke-width="1"/><text x="80" y="174" font-size="9" text-anchor="middle" fill="#0f1f3d">2</text><line x1="100" y1="156" x2="100" y2="164" stroke="#0f1f3d" stroke-width="1"/><text x="100" y="174" font-size="9" text-anchor="middle" fill="#0f1f3d">3</text><line x1="36" y1="140" x2="44" y2="140" stroke="#0f1f3d" stroke-width="1"/><text x="30" y="144" font-size="9" text-anchor="end" fill="#0f1f3d">1</text><line x1="36" y1="100" x2="44" y2="100" stroke="#0f1f3d" stroke-width="1"/><text x="30" y="104" font-size="9" text-anchor="end" fill="#0f1f3d">3</text><line x1="36" y1="60" x2="44" y2="60" stroke="#0f1f3d" stroke-width="1"/><text x="30" y="64" font-size="9" text-anchor="end" fill="#0f1f3d">5</text><line x1="36" y1="20" x2="44" y2="20" stroke="#0f1f3d" stroke-width="1"/><text x="30" y="24" font-size="9" text-anchor="end" fill="#0f1f3d">7</text><line x1="40" y1="140" x2="100" y2="20" stroke="#dc2626" stroke-width="2.5"/><circle cx="40" cy="140" r="4" fill="#ea580c"/><circle cx="60" cy="100" r="4" fill="#ea580c"/><circle cx="80" cy="60" r="4" fill="#ea580c"/><text x="48" y="152" font-size="9" fill="#ea580c">(0,1)</text><text x="66" y="94" font-size="9" fill="#ea580c">(1,3)</text><text x="86" y="56" font-size="9" fill="#ea580c">(2,5)</text><text x="130" y="185" font-weight="700" font-size="12" text-anchor="middle" fill="#dc2626">y = 2x + 1 (straight line)</text></svg>',
    },
  ],
  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Hard', question: 'Bongani says the pattern 5, 11, 17, 23 has the rule nth term = 5n, because it works for the first term. Test his rule against every term in the pattern. Is he correct?', answer: 'Bongani is incorrect. Check n=1: 5(1)=5 ✓ (this one happens to match), but check n=2: 5(2)=10, not 11 ✗ — his rule fails from the second term onward. The common difference is actually 6 (11−5=6, 17−11=6, 23−17=6), so the rule should start with 6n. Substituting n=1: 6(1)+c=5 → c=−1. The correct rule is nth term = 6n − 1. Check: 6(1)−1=5 ✓, 6(2)−1=11 ✓, 6(3)−1=17 ✓, 6(4)−1=23 ✓. This shows why a rule that matches the first term is not automatically correct.', checkMode: 'self' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Hard', question: 'Precious says the pattern 8, 17, 26, 35 has the rule nth term = 8n, because it works for the first term. Test her rule against every term in the pattern. Is she correct?', answer: 'Precious is incorrect. Check n=1: 8(1)=8 ✓ (this one happens to match), but check n=2: 8(2)=16, not 17 ✗ — her rule fails from the second term onward. The common difference is actually 9 (17−8=9, 26−17=9, 35−26=9), so the rule should start with 9n. Substituting n=1: 9(1)+c=8 → c=−1. The correct rule is nth term = 9n − 1. Check: 9(1)−1=8 ✓, 9(2)−1=17 ✓, 9(3)−1=26 ✓, 9(4)−1=35 ✓. This shows why a rule that matches the first term is not automatically correct.', checkMode: 'self' },
        ...
        { difficulty: 'Hard', question: 'A stadium arranges seats in rows that follow the rule: seats = 3 × row number + 12. Row 1 has 15 seats, row 2 has 18 seats, and so on.\n\na) How many seats are in row 18?\nb) If a row has 78 seats, which row number is it?', answer: '', checkMode: 'auto', parts: [
          ...
          { label: 'b) Row number for 78 seats', correctAnswer: '22', explanation: 'Set up: 3 × row + 12 = 78. Subtract 12: 3 × row = 66. Divide by 3: row = 22. Check: 3(22)+12=78 ✓' },
        ] },
      ],
      scoreMessages: [
        { minScore: 20, message: 'Outstanding! You have mastered numeric sequences, nth term rules, input-output tables, and geometric patterns — a perfect score!' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Hard', question: 'Sizwe says the pattern 4, 13, 22, 31 has the rule nth term = 4n, because it works for the first term. Test his rule against every term in the pattern. Is he correct?', answer: 'Sizwe is incorrect. Check n=1: 4(1)=4 ✓ (this one happens to match), but check n=2: 4(2)=8, not 13 ✗ — his rule fails from the second term onward. The common difference is actually 9 (13−4=9, 22−13=9, 31−22=9), so the rule should start with 9n. Substituting n=1: 9(1)+c=4 → c=−5. The correct rule is nth term = 9n − 5. Check: 9(1)−5=4 ✓, 9(2)−5=13 ✓, 9(3)−5=22 ✓, 9(4)−5=31 ✓. This shows why a rule that matches the first term is not automatically correct.', checkMode: 'self' },
