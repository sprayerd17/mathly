...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Kort video wat wys hoe om ʼn bedrag in ʼn gegewe verhouding te verdeel en hoe om verhoudings te vergelyk deur ekwivalente vorme te gebruik',
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Kort video wat wys hoe om spoed met die afstand-tyd-formule te bereken en hoe om eenheidskoerse te vind en te vergelyk',
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Kort video wat wys hoe om ʼn proporsie op te stel en op te los met kruisvermenigvuldiging, met voorbeelde uit die alledaagse lewe',
  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        // Blok 5 — Eenheidskoers & koers-woordprobleme, insl. beste-koop-vergelykings (Medium) — posisies 12-15
        { difficulty: 'Medium', question: 'ʼn Dron styg 456 m in 8 minute teen ʼn konstante koers. Wat is sy stygingskoers in meter per minuut?', answer: '57 m/min', checkMode: 'auto', correctAnswer: '57', correctAnswers: ['57', '57m/min', '57 m/min', '57 meter per minuut'], explanation: 'Koers = afstand ÷ tyd.\n456 ÷ 8 = 57 m/min ✓' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'ʼn Vrugtekordiaal-mengsel gebruik water en sapkonsentraat in die verhouding 7:2. ʼn Spysenier moet 18 koppies sapkonsentraat vir ʼn groot lot gebruik. Hoeveel koppies water word benodig?', answer: '63', checkMode: 'auto', correctAnswer: '63', correctAnswers: ['63', '63 koppies'], explanation: 'Verhouding water:sap = 7:2.\nSkaalfaktor = 18 ÷ 2 = 9.\nWater benodig = 7 × 9 = 63 koppies ✓' },
