...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      workedExamples: [
        // ── Example 1: 4131 — divisibility by 3 and 9 via digit sum ─────────
        {
          ...
          answer: `${re('4 131 is deelbaar deur beide 3 en 9')}`,
          steps: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      workedExamples: [
        ...
        // ── Example 9: HCF equal-grouping problem with THREE quantities ──────
        {
          ...
          steps: [
            ...
            `Die priemfaktore gemeenskaplik aan al drie is 2 (laagste mag 2³) en 3 (laagste mag 3¹).`,
      ...
      diagramPlaceholder:
        'ʼn Breukstaafdiagram wat 1/4, 1/6 en 1/9 wys omgeskakel na ekwivalente breuke oor die KGN van 36, met die individuele stawe in groen en die gekombineerde totaalstaaf in blou',
      ...
      diagramSvg:
        ...
        `<text x="118" y="12" text-anchor="middle" font-size="11" font-weight="700" fill="#0f1f3d">Noemers omgeskakel na 36stes (die KGN)</text>` +
  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'ʼn Kafee verkoop pasteitjies in pakke van 6. Sipho wil presies 48 pasteitjies koop. Is 48 ʼn veelvoud van 6? Verduidelik, en sê hoeveel pakke hy nodig het.', answer: 'Ja, 48 is ʼn veelvoud van 6 want 48 ÷ 6 = 8 presies. Hy het 8 pakke nodig.', checkMode: 'self', explanation: '48 ÷ 6 = 8 sonder res, dus is 48 ʼn veelvoud van 6 (met ander woorde, 6 is ʼn faktor van 48). Sipho het 8 pakke nodig om presies 48 pasteitjies te kry.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'ʼn Bakkery verkoop broodrolletjies in sakke van 8. Naledi wil presies 56 rolletjies koop. Is 56 ʼn veelvoud van 8? Verduidelik, en sê hoeveel sakke sy nodig het.', answer: 'Ja, 56 is ʼn veelvoud van 8 want 56 ÷ 8 = 7 presies. Sy het 7 sakke nodig.', checkMode: 'self', explanation: '56 ÷ 8 = 7 sonder res, dus is 56 ʼn veelvoud van 8 (met ander woorde, 8 is ʼn faktor van 56). Naledi het 7 sakke nodig om presies 56 rolletjies te kry.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'ʼn Skryfbehoeftewinkel verkoop potlode in bokse van 12. Ayesha wil presies 84 potlode koop. Is 84 ʼn veelvoud van 12? Verduidelik, en sê hoeveel bokse sy nodig het.', answer: 'Ja, 84 is ʼn veelvoud van 12 want 84 ÷ 12 = 7 presies. Sy het 7 bokse nodig.', checkMode: 'self', explanation: '84 ÷ 12 = 7 sonder res, dus is 84 ʼn veelvoud van 12 (met ander woorde, 12 is ʼn faktor van 84). Ayesha het 7 bokse nodig om presies 84 potlode te kry.' },
