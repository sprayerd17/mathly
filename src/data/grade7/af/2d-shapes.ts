  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramSvg:
        ...
        '<text x="170" y="16" font-size="12" font-weight="700" fill="#0f1f3d" text-anchor="middle">Volgens sylengte</text>' +
        ...
        '<text x="0" y="42" font-size="11" font-weight="700" fill="#2563eb" text-anchor="middle">Gelyksydig</text>' +
        '</g>' +
        ...
        '<text x="0" y="42" font-size="11" font-weight="700" fill="#16a34a" text-anchor="middle">Gelykbenig</text>' +
        '</g>' +
        ...
        '<text x="-2" y="42" font-size="11" font-weight="700" fill="#2563eb" text-anchor="middle">Skerphoekig</text>' +
        '</g>' +
        ...
        '<text x="0" y="42" font-size="11" font-weight="700" fill="#16a34a" text-anchor="middle">Reghoekig</text>' +
        '</g>' +
        ...
        '<text x="0" y="42" font-size="11" font-weight="700" fill="#dc2626" text-anchor="middle">Stomphoekig</text>' +
        '</g>' +
        '</svg>',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramSvg:
        ...
        '<text x="0" y="42" font-size="11" font-weight="700" fill="#2563eb" text-anchor="middle">Vierkant</text>' +
        '</g>' +
        ...
        '<text x="0" y="42" font-size="11" font-weight="700" fill="#16a34a" text-anchor="middle">Reghoek</text>' +
        '</g>' +
        ...
        '<line x1="-9.7" y1="13.1" x2="-14.3" y2="16.9" stroke="#dc2626" stroke-width="2"/>' +
        '<line x1="-9.7" y1="-13.1" x2="-14.3" y2="-16.9" stroke="#dc2626" stroke-width="2"/>' +
        '<text x="0" y="42" font-size="11" font-weight="700" fill="#dc2626" text-anchor="middle">Ruit</text>' +
        '</g>' +
        ...
        '<text x="0" y="42" font-size="11" font-weight="700" fill="#7c3aed" text-anchor="middle">Trapesium</text>' +
        '</g>' +
        ...
        '<text x="0" y="42" font-size="11" font-weight="700" fill="#374151" text-anchor="middle">Vlieër</text>' +
        '</g>' +
        '</svg>',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramSvg:
        ...
        '<text x="112" y="148" font-size="11" font-weight="700" fill="#374151" text-anchor="end">Middelpunt</text>' +
        '<text x="168" y="94" font-size="11" font-weight="700" fill="#2563eb">Radius</text>' +
        '<text x="60" y="122" font-size="11" font-weight="700" fill="#dc2626">Deursnee</text>' +
        '<text x="130" y="30" font-size="11" font-weight="700" fill="#16a34a" text-anchor="middle">Omtrek</text>' +
        '<text x="65" y="203" font-size="11" font-weight="700" fill="#ea580c" text-anchor="middle">Koord</text>' +
        '<text x="185" y="212" font-size="11" font-weight="700" fill="#0f1f3d">Boog</text>' +
        '</svg>',
    },
  ],
  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'Die vorm soos gewys is ʼn reëlmatige seshoek met sye van 9 cm. Bepaal sy omtrek.', answer: '54 cm', checkMode: 'auto', correctAnswer: '54', correctAnswers: ['54', '54cm', '54 cm'], explanation: 'ʼn Reëlmatige seshoek het 6 gelyke sye. Omtrek = 6 × 9 cm = 54 cm.', diagramSvg: '<svg viewBox="0 0 220 170" xmlns="http://www.w3.org/2000/svg"><polygon points="110,32 160.2,61 160.2,119 110,148 59.8,119 59.8,61" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="180.2" y="90" font-size="14" fill="#2563eb" font-weight="700" text-anchor="middle">9 cm</text></svg>' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        // Blok C — vierhoek-hoeksom, eienskappe & buitehoekstelling
        { difficulty: 'Easy', question: 'In die vierhoek soos gewys, is drie van die hoeke 105°, 88° en 132°. Bepaal die vierde hoek.', answer: '35°', checkMode: 'auto', correctAnswer: '35', correctAnswers: ['35', '35°', '35 grade'], explanation: 'Vierde hoek = 360° − 105° − 88° − 132° = 35°. Kontroleer: 105+88+132+35 = 360 ✓', diagramSvg: '<svg viewBox="0 0 220 170" xmlns="http://www.w3.org/2000/svg"><polygon points="61.8,135 109.6,135 108.3,96.5 35,35" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="74" y="119.1" font-size="13" fill="#2563eb" font-weight="700">105°</text><text x="95.2" y="121.1" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">88°</text><text x="90.3" y="105.3" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">132°</text><text x="45.7" y="51.9" font-size="15" fill="#ea580c" font-weight="700">?</text></svg>' },
        ...
        // Blok E — veelhoek binne-/buitehoekformules
        { difficulty: 'Medium', question: 'Bepaal die som van die binnehoeke van ʼn seshoek (6 sye).', answer: '720°', checkMode: 'auto', correctAnswer: '720', correctAnswers: ['720', '720°', '720 grade'], explanation: 'Som van binnehoeke = (n − 2) × 180°. Vir ʼn seshoek, n = 6: (6 − 2) × 180 = 4 × 180 = 720°.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        // Blok C — vierhoek-hoeksom, eienskappe & buitehoekstelling
        { difficulty: 'Easy', question: 'In die vierhoek soos gewys, is drie van die hoeke 68°, 152° en 94°. Bepaal die vierde hoek.', answer: '46°', checkMode: 'auto', correctAnswer: '46', correctAnswers: ['46', '46°', '46 grade'], explanation: 'Vierde hoek = 360° − 68° − 152° − 94° = 46°. Kontroleer: 68+152+94+46 = 360 ✓', diagramSvg: '<svg viewBox="0 0 220 170" xmlns="http://www.w3.org/2000/svg"><polygon points="35,135 69.2,135 110.2,113.2 75.4,35" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="51.6" y="123.8" font-size="13" fill="#2563eb" font-weight="700">68°</text><text x="64.4" y="115.6" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">152°</text><text x="91.3" y="106.7" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">94°</text><text x="75.7" y="55" font-size="15" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },
        { difficulty: 'Medium', question: 'ʼn Parallelogram, soos gewys, het een hoek van 74°. Bepaal die grootte van die kleinste hoek in die parallelogram.', answer: '74°', checkMode: 'auto', correctAnswer: '74', correctAnswers: ['74', '74°', '74 grade'], explanation: 'Oorstaande hoeke in ʼn parallelogram is gelyk, dus is die hoek oorkant 74° ook 74°. Aangrensende hoeke is supplementêr: 180° − 74° = 106°. Die kleinste hoek is 74°.', diagramSvg: '<svg viewBox="0 0 220 170" xmlns="http://www.w3.org/2000/svg"><polygon points="40,135 165,135 195,35 70,35" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="55" y="122" font-size="14" fill="#2563eb" font-weight="700">74°</text></svg>' },
        { difficulty: 'Hard', question: 'In die driehoek soos gewys, is twee binnehoeke 83° en 39°. Die buitehoek by die derde hoekpunt word gevorm deur een sy te verleng. Gebruik die buitehoekstelling (ʼn buitehoek is gelyk aan die som van die twee nie-aangrensende binnehoeke) om die grootte van hierdie buitehoek te bepaal.', answer: '122°', checkMode: 'auto', correctAnswer: '122', correctAnswers: ['122', '122°', '122 grade'], explanation: 'Volgens die buitehoekstelling is die buitehoek = som van die twee nie-aangrensende binnehoeke = 83° + 39° = 122°. Kontroleer: die binnehoek by daardie hoekpunt = 180 − 83 − 39 = 58°, en sy buitehoek = 180 − 58 = 122° ✓', diagramSvg: '<svg viewBox="0 0 230 170" xmlns="http://www.w3.org/2000/svg"><polygon points="30.5,140 159.5,140 42.2,45" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="42.2" y1="45" x2="47.1" y2="5.3" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 52.5,140 A 24,24 0 0 1 43.5,120" fill="none" stroke="#2563eb" stroke-width="2"/><text x="57.5" y="130" font-size="13" fill="#2563eb" font-weight="700">83°</text><path d="M 137.5,140 A 24,24 0 0 0 146.5,120" fill="none" stroke="#2563eb" stroke-width="2"/><text x="132.5" y="130" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">39°</text><path d="M 44.6,25.2 A 20,20 0 0 1 57.7,57.6" fill="none" stroke="#ea580c" stroke-width="2"/><text x="71.9" y="33.0" font-size="14" fill="#ea580c" font-weight="700">?</text></svg>' },
