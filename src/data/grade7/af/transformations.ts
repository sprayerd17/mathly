  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramSvg:
        ...
        '<text x="120" y="164" font-size="11" fill="#0f1f3d" text-anchor="middle" font-weight="700">Refleksie oor x = 7</text>' +
        '</svg>',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramSvg:
        ...
        '<text x="100" y="166" font-size="11" fill="#0f1f3d" text-anchor="middle" font-weight="700">Translasie met (3, −2)</text>' +
        '</svg>',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramSvg:
        '<svg viewBox="0 0 190 198" xmlns="http://www.w3.org/2000/svg">' +
        ...
        '<text x="95" y="181" font-size="10.5" fill="#0f1f3d" text-anchor="middle" font-weight="700">90° kloksgewyse rotasie</text>' +
        '<text x="95" y="193" font-size="10.5" fill="#0f1f3d" text-anchor="middle" font-weight="700">om die oorsprong</text>' +
        '</svg>',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      openQuestions: [
        ...
        {
          difficulty: 'Medium',
          question: 'Kyk na die hoof blokletters H en T.',
          answer: '',
          checkMode: 'auto',
          parts: [
            {
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        },
        {
          ...
          explanation: 'Korrekte reël: (x, y) → (x + (−6), y + (−1)).\n(4, 3) → (4 − 6, 3 − 1) = (−2, 2).\nDie student het by die x-koördinaat bygetel in plaas van afgetrek, wat 10 in plaas van −2 gee. Die korrekte beeld is (−2, 2) ✓',
        },
