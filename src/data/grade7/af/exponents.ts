...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        'Visuele rooster wat vierkantsgetalle van 1² tot 6² as groeiende n × n roosters wys, met die grondtal in blou, eksponent in oranje en waarde in groen',
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        'Visuele diagram wat kubusgetalle van 1³ tot 4³ as groeiende 3D-kubusse wys, met die grondtal in blou, eksponent in oranje en waarde in groen',
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      icon: 'xⁿ',
      explanation:
        `<p style="margin-bottom:16px;"><strong>Eksponensiële notasie</strong> is ʼn korter manier om herhaalde vermenigvuldiging te skryf. Die ${bl('grondtal')} is die getal wat vermenigvuldig word en die ${or('eksponent')} sê vir ons hoeveel keer om dit met homself te vermenigvuldig. Enige getal tot die mag ${or('1')} is gelyk aan homself. Enige getal tot die mag ${or('0')} is gelyk aan ${re('1')} (behalwe 0 self).</p>` +
        ...
        `<p style="margin:0;font-size:14px;">${bl('Grondtal')} tot die mag ${or('1')} — enige getal tot die mag 1 is gelyk aan homself: ${bl('n')}${or('¹')} = ${bl('n')}.</p>` +
        `</div>` +
        ...
        `<p style="margin:0;font-size:14px;">${bl('Grondtal')} tot die mag ${or('0')} — enige nie-nul getal tot die mag 0 is gelyk aan ${re('1')}: ${bl('n')}${or('⁰')} = ${re('1')}.</p>` +
        `</div>` +

        `<div style="display:flex;gap:12px;align-items:flex-start;padding:10px 14px;background:#f0fdf4;border:1.5px solid #bbf7d0;border-radius:9px;">` +
        `<span style="display:inline-block;min-width:22px;height:22px;line-height:22px;background:#16a34a;color:white;border-radius:50%;font-weight:700;font-size:12px;text-align:center;flex-shrink:0;">3</span>` +
        `<p style="margin:0;font-size:14px;">${bl('Grondtal')} tot die mag ${or('n')} — brei uit as ${gr('herhaalde vermenigvuldiging')}: ${bl('a')}${or('ⁿ')} = ${gr('a × a × ⋯ × a')} (n keer) = ${re('antwoord')}.</p>` +
        `</div>` +
        ...
        `<p style="margin:0;color:#1e3a8a;">${bl('2')}${or('⁵')} word gelees as "twee tot die mag vyf" of "twee tot die vyfde". Die ${bl('grondtal')} word altyd eerste geskryf en die ${or('eksponent')} is altyd die klein verhoogde getal.</p>` +
        `</div>`,
      ...
      videoPlaceholder:
        'Kort video wat eksponensiële notasie verduidelik en wys hoe om uitdrukkings met enige grondtal en eksponent uit te brei en te evalueer, insluitend die mag-van-0- en mag-van-1-reëls',
    },
  ],
  ...
  practiceSets: [
    // ═══════════════════════════════════════════════════════════════════════
    // STEL 1 (20 vrae)
    // Blokke: 1-3 Notasie (grondtal/eksponent, skryf eksponensiële vorm) |
    // 4-7 Evalueer magte | 8-11 Eksponentwette (vermenigvuldig/deel dieselfde grondtal) |
    // 12-14 Eksponente 0 en 1 | 15-17 Vergelyk/orden | 18-20 Woordprobleme
    // ═══════════════════════════════════════════════════════════════════════
    {
      name: 'Stel 1',
      questions: [
        { difficulty: 'Easy', question: 'In die uitdrukking 6⁴, watter getal is die grondtal en watter is die eksponent?', answer: 'Grondtal = 6, eksponent = 4', checkMode: 'auto', correctAnswer: 'grondtal6eksponent4', correctAnswers: ['grondtal6eksponent4', 'grondtal=6eksponent=4', '6grondtal4eksponent'], explanation: 'Die grondtal is die getal wat met homself vermenigvuldig word (6), en die eksponent is die klein verhoogde getal wat wys hoeveel keer om dit te vermenigvuldig (4).' },
        { difficulty: 'Easy', question: 'Skryf 8 × 8 × 8 × 8 × 8 in eksponensiële notasie.', answer: '8⁵', checkMode: 'auto', correctAnswer: '8^5', correctAnswers: ['8^5', '8⁵'], explanation: 'Daar is 5 agte wat met mekaar vermenigvuldig word, dus word dit geskryf as 8⁵ (grondtal 8, eksponent 5).' },
        ...
        { difficulty: 'Medium', question: 'Vereenvoudig 3⁴ × 3² deur die eksponentwette te gebruik. Laat jou antwoord as ʼn mag van 3, en evalueer dit dan.', answer: '3⁶ = 729', checkMode: 'auto', correctAnswer: '729', correctAnswers: ['729', '3^6=729', '3⁶=729'], explanation: 'Dieselfde grondtal, dus tel die eksponente op: 3⁴ × 3² = 3^(4+2) = 3⁶ = 729.' },
        { difficulty: 'Medium', question: 'Vereenvoudig 5⁶ ÷ 5² deur die eksponentwette te gebruik. Laat jou antwoord as ʼn mag van 5, en evalueer dit dan.', answer: '5⁴ = 625', checkMode: 'auto', correctAnswer: '625', correctAnswers: ['625', '5^4=625', '5⁴=625'], explanation: 'Dieselfde grondtal, dus trek die eksponente af: 5⁶ ÷ 5² = 5^(6−2) = 5⁴ = 625.' },
        { difficulty: 'Medium-Hard', question: 'Kagiso vereenvoudig 2³ × 2⁵ as 2¹⁵, en sê "jy vermenigvuldig die eksponente." Is hy korrek? Verduidelik en gee die korrekte vereenvoudigde antwoord.', answer: 'Nee — wanneer jy magte met dieselfde grondtal vermenigvuldig, tel jy die eksponente op, jy vermenigvuldig hulle nie. 2³ × 2⁵ = 2^(3+5) = 2⁸ = 256, nie 2¹⁵ nie.', checkMode: 'self' },
        ...
        { difficulty: 'Medium', question: 'Bongani sê 0⁰ en 5⁰ moet altwee gelyk wees aan 1 "want enigiets tot die mag 0 is 1, sonder uitsonderings." Verduidelik waarom hierdie redenasie foutief is.', answer: 'Die reël dat ʼn getal tot die mag 0 gelyk is aan 1, geld net vir nie-nul grondtalle. 0⁰ is ʼn spesiale geval en is nie outomaties gelyk aan 1 soos ander getalle tot die mag 0 nie.', checkMode: 'self' },
        ...
        { difficulty: 'Medium-Hard', question: 'Zinhle beweer 10³ is groter as 3¹⁰ want "10 is ʼn baie groter getal as 3." Is sy korrek? Wys die werklike waardes om jou antwoord te ondersteun.', answer: 'Nee — 10³ = 1 000 maar 3¹⁰ = 59 049, dus is 3¹⁰ baie groter. ʼn Groter grondtal gee nie altyd ʼn groter resultaat nie; die eksponent maak ook baie saak.', checkMode: 'self' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      name: 'Stel 2',
      questions: [
        { difficulty: 'Easy', question: 'In die uitdrukking 9³, watter getal is die grondtal en watter is die eksponent?', answer: 'Grondtal = 9, eksponent = 3', checkMode: 'auto', correctAnswer: 'grondtal9eksponent3', correctAnswers: ['grondtal9eksponent3', 'grondtal=9eksponent=3', '9grondtal3eksponent'], explanation: 'Die grondtal is die getal wat met homself vermenigvuldig word (9), en die eksponent is die klein verhoogde getal wat wys hoeveel keer om dit te vermenigvuldig (3).' },
        { difficulty: 'Easy', question: 'Skryf 5 × 5 × 5 × 5 in eksponensiële notasie.', answer: '5⁴', checkMode: 'auto', correctAnswer: '5^4', correctAnswers: ['5^4', '5⁴'], explanation: 'Daar is 4 vywe wat met mekaar vermenigvuldig word, dus word dit geskryf as 5⁴ (grondtal 5, eksponent 4).' },
        ...
        { difficulty: 'Medium', question: 'Sipho sê 3⁵ = 15 want hy het 3 × 5 bereken. Verduidelik sy fout en gee die korrekte antwoord.', answer: 'Hy het die grondtal met die eksponent vermenigvuldig in plaas daarvan om die grondtal 5 keer met homself te vermenigvuldig. 3⁵ = 3×3×3×3×3 = 243.', checkMode: 'self' },
        { difficulty: 'Medium', question: 'Vereenvoudig 4² × 4³ deur die eksponentwette te gebruik. Laat jou antwoord as ʼn mag van 4, en evalueer dit dan.', answer: '4⁵ = 1 024', checkMode: 'auto', correctAnswer: '1024', correctAnswers: ['1024', '4^5=1024', '4⁵=1024'], explanation: 'Dieselfde grondtal, dus tel die eksponente op: 4² × 4³ = 4^(2+3) = 4⁵ = 1 024.' },
        { difficulty: 'Medium', question: 'Vereenvoudig 6⁷ ÷ 6⁴ deur die eksponentwette te gebruik. Laat jou antwoord as ʼn mag van 6, en evalueer dit dan.', answer: '6³ = 216', checkMode: 'auto', correctAnswer: '216', correctAnswers: ['216', '6^3=216', '6³=216'], explanation: 'Dieselfde grondtal, dus trek die eksponente af: 6⁷ ÷ 6⁴ = 6^(7−4) = 6³ = 216.' },
        { difficulty: 'Medium-Hard', question: 'Amahle vereenvoudig 5³ × 5³ as 5⁹, en sê "jy tel die twee grondtalle op as ʼn eksponent." Is sy korrek? Verduidelik en gee die korrekte vereenvoudigde antwoord.', answer: 'Nee — jy tel die eksponente op (3 en 3), jy skep nie ʼn nuwe eksponent van iets anders nie. 5³ × 5³ = 5^(3+3) = 5⁶ = 15 625, nie 5⁹ nie.', checkMode: 'self' },
        ...
        { difficulty: 'Medium-Hard', question: 'Sibusiso beweer 5⁴ is groter as 4⁵ want "5 is ʼn groter grondtal as 4." Is hy korrek? Wys die werklike waardes om jou antwoord te ondersteun.', answer: 'Nee — 5⁴ = 625 maar 4⁵ = 1 024, dus is 4⁵ groter. ʼn Groter grondtal gee nie altyd ʼn groter resultaat nie; die eksponent maak ook baie saak.', checkMode: 'self' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      name: 'Stel 3',
      questions: [
        { difficulty: 'Easy', question: 'In die uitdrukking 11³, watter getal is die grondtal en watter is die eksponent?', answer: 'Grondtal = 11, eksponent = 3', checkMode: 'auto', correctAnswer: 'grondtal11eksponent3', correctAnswers: ['grondtal11eksponent3', 'grondtal=11eksponent=3', '11grondtal3eksponent'], explanation: 'Die grondtal is die getal wat met homself vermenigvuldig word (11), en die eksponent is die klein verhoogde getal wat wys hoeveel keer om dit te vermenigvuldig (3).' },
        { difficulty: 'Easy', question: 'Skryf 2 × 2 × 2 × 2 × 2 × 2 × 2 × 2 in eksponensiële notasie.', answer: '2⁸', checkMode: 'auto', correctAnswer: '2^8', correctAnswers: ['2^8', '2⁸'], explanation: 'Daar is 8 twees wat met mekaar vermenigvuldig word, dus word dit geskryf as 2⁸ (grondtal 2, eksponent 8).' },
        ...
        { difficulty: 'Medium', question: 'Ayanda sê 2⁵ = 10 want sy het 2 × 5 bereken. Verduidelik haar fout en gee die korrekte antwoord.', answer: 'Sy het die grondtal met die eksponent vermenigvuldig in plaas daarvan om die grondtal 5 keer met homself te vermenigvuldig. 2⁵ = 2×2×2×2×2 = 32.', checkMode: 'self' },
        { difficulty: 'Medium', question: 'Vereenvoudig 2³ × 2⁵ deur die eksponentwette te gebruik. Laat jou antwoord as ʼn mag van 2, en evalueer dit dan.', answer: '2⁸ = 256', checkMode: 'auto', correctAnswer: '256', correctAnswers: ['256', '2^8=256', '2⁸=256'], explanation: 'Dieselfde grondtal, dus tel die eksponente op: 2³ × 2⁵ = 2^(3+5) = 2⁸ = 256.' },
        { difficulty: 'Medium', question: 'Vereenvoudig 9⁵ ÷ 9³ deur die eksponentwette te gebruik. Laat jou antwoord as ʼn mag van 9, en evalueer dit dan.', answer: '9² = 81', checkMode: 'auto', correctAnswer: '81', correctAnswers: ['81', '9^2=81', '9²=81'], explanation: 'Dieselfde grondtal, dus trek die eksponente af: 9⁵ ÷ 9³ = 9^(5−3) = 9² = 81.' },
        { difficulty: 'Medium-Hard', question: 'Thandeka vereenvoudig 7⁵ ÷ 7³ as 7^(5×3), en sê "deling beteken jy vermenigvuldig die eksponente." Is sy korrek? Verduidelik en gee die korrekte vereenvoudigde antwoord.', answer: 'Nee — wanneer jy magte met dieselfde grondtal deel, trek jy die eksponente af, jy vermenigvuldig hulle nie. 7⁵ ÷ 7³ = 7^(5−3) = 7² = 49, nie 7^(5×3) nie.', checkMode: 'self' },
        ...
        { difficulty: 'Medium', question: 'Karabo sê 8⁰ moet gelyk wees aan 8 want "om tot ʼn mag te verhef gee net die grondtal terug wanneer niks anders gebeur nie." Verduidelik waarom hierdie redenasie foutief is.', answer: 'Om tot die mag 0 te verhef gee nie die grondtal terug nie — dit is altyd gelyk aan 1 (vir ʼn nie-nul grondtal), want dit verteenwoordig vermenigvuldiging met die grondtal nul keer. 8⁰ = 1, nie 8 nie.', checkMode: 'self' },
        ...
        { difficulty: 'Medium', question: 'Orden hierdie van kleinste na grootste: 2⁴, 3³, 5², geskei deur kommas.', answer: '2⁴, 5², 3³', checkMode: 'auto', correctAnswer: '2⁴5²3³', correctAnswers: ['2⁴,5²,3³', '2^4,5^2,3^3', '16,25,27'], explanation: '2⁴ = 16, 3³ = 27, 5² = 25. Die waardes van kleinste na grootste geordend: 16, 25, 27 wat 2⁴, 5², 3³ is.' },
        { difficulty: 'Medium-Hard', question: 'Nomvula beweer 6³ is groter as 3⁶ want "6 is ʼn baie groter grondtal as 3." Is sy korrek? Wys die werklike waardes om jou antwoord te ondersteun.', answer: 'Nee — 6³ = 216 maar 3⁶ = 729, dus is 3⁶ baie groter. ʼn Groter grondtal gee nie altyd ʼn groter resultaat nie; die eksponent maak ook baie saak.', checkMode: 'self' },
