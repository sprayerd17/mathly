...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      explanation:
        ...
        `<p style="font-size:1.2em;font-weight:700;color:#374151;margin:0;">${or('P(gebeurtenis)')} = <span style="display:inline-block;text-align:center;vertical-align:middle;"><span style="display:block;border-bottom:2px solid #374151;padding-bottom:2px;">${gr('aantal gunstige uitkomste')}</span><span style="display:block;padding-top:2px;">${bl('totale aantal uitkomste')}</span></span></p>` +
        `</div>` +
      ...
      workedExamples: [
        {
          ...
          steps: [
            ...
            `Pas die formule toe: ${or('P(blou)')} = ${gr('3')} ÷ ${bl('8')} = ${or('3/8')}.`,
            `<strong>Antwoord:</strong> ${or('P(blou)')} = ${or('3/8')}. Die breuk is reeds in sy eenvoudigste vorm.`,
          ],
        },
        {
          question: 'Lerato gooi ʼn dobbelsteen. Vind die waarskynlikheid om ʼn getal groter as 2 te gooi.',
          answer: `${or('P(groter as 2)')} = ${or('4/6')} = ${or('2/3')}`,
          steps: [
            ...
            `Pas die formule toe: ${or('P(> 2)')} = ${gr('4')} ÷ ${bl('6')} = ${or('4/6')}.`,
            `Vereenvoudig: ${or('4/6')} = ${or('2/3')}.`,
            `<strong>Antwoord:</strong> ${or('P(> 2)')} = ${or('2/3')}.`,
          ],
        },
      ],
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      explanation:
        ...
        `<p style="font-size:1.05em;font-weight:700;color:#374151;margin:0;">${bl('P(gebeurtenis)')} = <span style="display:inline-block;text-align:center;vertical-align:middle;"><span style="display:block;border-bottom:2px solid #374151;padding-bottom:2px;">gunstige uitkomste</span><span style="display:block;padding-top:2px;">totale uitkomste</span></span></p>` +
        `</div>` +
      ...
      workedExamples: [
        {
          ...
          steps: [
            ...
            `Bereken die ${bl('teoretiese waarskynlikheid')}: ʼn regverdige muntstuk het 1 gunstige uitkoms (kop) uit 2 totale uitkomste → ${bl('P(kop)')} = 1 ÷ 2 = ${bl('0,5')}.`,
        ...
        },
        {
          ...
          steps: [
            ...
            `Bereken die ${bl('teoretiese waarskynlikheid')}: 1 gunstige uitkoms (ʼn 6 gooi) uit 6 totale uitkomste → ${bl('P(6)')} = ${bl('1/6')} ≈ ${bl('0,167')}.`,
  ...
  topicPractice: [
    ...
    // ── Q2 Easy — certain event ───────────────────────────────────────────────
    {
      ...
      checkMode: 'auto',
      correctAnswer: '1',
      explanation: 'Al die balle is groen, dus is die gebeurtenis seker — P(groen) = 1.',
    },
    ...
    // ── Q3 Medium — probability as a fraction ─────────────────────────────────
    {
      ...
      explanation: 'Gunstige uitkomste: 4 rooi. Totale uitkomste: 4 + 6 = 10. P(rooi) = 4/10 = 2/5.',
    },
    ...
    // ── Q4 Medium — probability of odd number ─────────────────────────────────
    {
      ...
      explanation: 'Onewe getalle op ʼn dobbelsteen: 1, 3, 5 — 3 gunstige uitkomste uit 6 totaal. P(onewe) = 3/6 = 1/2.',
    },
    ...
    // ── Q6 Easy — spinner probability ────────────────────────────────────────
    {
      ...
      checkMode: 'auto',
      correctAnswer: '1/5',
      explanation: '1 gunstige uitkoms (op 3 land) uit 5 ewe waarskynlike uitkomste. P(3) = 1/5.',
    },
    ...
    // ── Q7 Medium — complement probability ───────────────────────────────────
    {
      ...
      explanation: 'Nie groen nie: 2 rooi + 3 blou = 5. Totaal: 2 + 3 + 5 = 10. P(nie groen nie) = 5/10 = 1/2.',
    },
    ...
    // ── Q11 Medium — probability with replacement ─────────────────────────────
    {
      ...
      checkMode: 'auto',
      correctAnswer: '9/25',
      explanation: 'P(wit) = 6/10 = 3/5. Met terugsetting: P(wit en wit) = 3/5 × 3/5 = 9/25.',
    },
