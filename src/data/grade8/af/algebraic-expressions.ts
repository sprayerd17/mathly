  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'Vereenvoudig 5x²+3x−2x²+4x.', checkMode: 'auto', options: ['3x²+7x', '7x²+7x', '3x²−x', '3x⁴+7x'], correctIndex: 0, explanation: 'Groepeer gelyksoortige terme: (5x²−2x²)+(3x+4x).\n5x²−2x²=3x² en 3x+4x=7x.\nAntwoord: 3x²+7x' },
        { difficulty: 'Easy', question: 'Vereenvoudig 6xy+4x−2xy+x.', checkMode: 'auto', options: ['8xy+5x', '4xy+5x', '4xy+3x', '9xy'], correctIndex: 1, explanation: 'Groepeer gelyksoortige terme: (6xy−2xy)+(4x+x).\n6xy−2xy=4xy en 4x+x=5x.\nAntwoord: 4xy+5x' },
        { difficulty: 'Easy', question: 'Vereenvoudig 4a²b+3ab−2a²b.', checkMode: 'auto', options: ['6a²b+3ab', '5a²b', '2a²b+3ab', '2a⁴b+3ab'], correctIndex: 2, explanation: 'Slegs die a²b-terme is gelyksoortig: 4a²b−2a²b=2a²b.\n3ab het ʼn ander eksponent op a, dus kan dit nie gekombineer word nie.\nAntwoord: 2a²b+3ab' },

        // Blok 2 — Uitbrei van hakies, distributiewe wet (Medium)
        { difficulty: 'Medium', question: 'Brei uit: 3x(2x+5).', checkMode: 'auto', options: ['6x²+5x', '5x²+15x', '21x', '6x²+15x'], correctIndex: 3, explanation: 'Vermenigvuldig 3x met elke term binne die hakies.\n(3x)(2x)=6x² en (3x)(5)=15x.\nAntwoord: 6x²+15x' },
        { difficulty: 'Medium', question: 'Brei uit: −4x(x−3).', checkMode: 'auto', options: ['−4x²+12x', '−4x²−12x', '4x²+12x', '−x²+12x'], correctIndex: 0, explanation: 'Vermenigvuldig −4x met elke term binne die hakies.\n(−4x)(x)=−4x² en (−4x)(−3)=+12x.\nAntwoord: −4x²+12x' },
        { difficulty: 'Medium', question: 'Brei uit en vereenvoudig: 2(3x+4)+5x.', checkMode: 'auto', options: ['11x+4', '11x+8', '10x+8', '16x+8'], correctIndex: 1, explanation: 'Brei die hakies uit: 2(3x+4)=6x+8.\nTel die oorblywende term by: 6x+8+5x.\nKombineer gelyksoortige terme: 6x+5x=11x.\nAntwoord: 11x+8' },
        { difficulty: 'Medium', question: 'ʼn Reghoekige tafel het lengte (x+6) cm en breedte 3 cm. Skryf ʼn uitdrukking vir die oppervlakte, en brei dit uit.', checkMode: 'auto', options: ['3x+6', '3x+9', '3x+18', '18x+3'], correctIndex: 2, explanation: 'Oppervlakte van ʼn reghoek = lengte × breedte = 3(x+6).\nBrei uit: (3)(x)+(3)(6)=3x+18.\nAntwoord: 3x+18' },

        // Blok 3 — Faktorisering deur gemeenskaplike faktor (Medium)
        { difficulty: 'Medium', question: 'Faktoriseer 6x+9 volledig.', checkMode: 'auto', options: ['3(2x+9)', '6(x+3)', '3(6x+9)', '3(2x+3)'], correctIndex: 3, explanation: 'Die GGF van 6 en 9 is 3.\nDeel elke term deur 3: 6x÷3=2x en 9÷3=3.\nAntwoord: 3(2x+3)' },
        { difficulty: 'Medium', question: 'Faktoriseer 8x²+12x volledig.', checkMode: 'auto', options: ['4x(2x+3)', '4x(2x+12)', '2x(4x+6)', '4(2x²+3x)'], correctIndex: 0, explanation: 'Die GGF van die koëffisiënte 8 en 12 is 4, en albei terme deel ʼn faktor van x.\nDeel elke term deur 4x: 8x²÷4x=2x en 12x÷4x=3.\nAntwoord: 4x(2x+3)' },
        { difficulty: 'Medium', question: 'Faktoriseer 15xy−10x volledig.', checkMode: 'auto', options: ['5x(3y−10)', '5x(3y−2)', 'x(15y−10)', '5(3xy−2x)'], correctIndex: 1, explanation: 'Die GGF van 15 en 10 is 5, en albei terme deel ʼn faktor van x.\nDeel elke term deur 5x: 15xy÷5x=3y en 10x÷5x=2.\nAntwoord: 5x(3y−2)' },
        ...
        { difficulty: 'Medium-Hard', question: 'Bereken 3x²−2x wanneer x=−2.', checkMode: 'auto', options: ['−8', '8', '16', '40'], correctIndex: 2, explanation: 'Vervang x=−2: 3(−2)²−2(−2).\n(−2)²=4, dus 3(4)=12. Ook −2(−2)=+4.\n12+4=16' },
        { difficulty: 'Medium-Hard', question: 'Bereken 2x+5y wanneer x=0,5 en y=−3.', checkMode: 'auto', options: ['16', '−5', '4,5', '−14'], correctIndex: 3, explanation: 'Vervang x=0,5 en y=−3: 2(0,5)+5(−3).\n2(0,5)=1 en 5(−3)=−15.\n1−15=−14' },
        { difficulty: 'Medium-Hard', question: 'Bereken x²−3x+4 wanneer x=−1.', checkMode: 'auto', options: ['8', '6', '2', '−6'], correctIndex: 0, explanation: 'Vervang x=−1: (−1)²−3(−1)+4.\n(−1)²=1 en −3(−1)=+3.\n1+3+4=8' },
        { difficulty: 'Medium-Hard', question: 'Die koste in rand om ʼn peddelplank te huur is C=6h+12, waar h die aantal ure is. Bepaal die koste wanneer h=2,5 ure.', checkMode: 'auto', options: ['15', '27', '87', '24'], correctIndex: 1, explanation: 'Vervang h=2,5: C=6(2,5)+12.\n6(2,5)=15, dus C=15+12=27.\nDie koste is R27.' },

        // Blok 5 — Multi-stap vereenvoudiging wat verskeie vaardighede kombineer (Hard)
        { difficulty: 'Hard', question: 'Vereenvoudig 3x(x+2)−5x.', checkMode: 'auto', options: ['3x²+11x', '3x²−3x', '3x²+x', '3x⁴+x'], correctIndex: 2, explanation: 'Brei eers uit: 3x(x+2)=3x²+6x.\nTrek 5x af: 3x²+6x−5x.\nKombineer gelyksoortige terme: 6x−5x=x.\nAntwoord: 3x²+x' },
        { difficulty: 'Hard', question: 'Vereenvoudig 4x+8+2x, en faktoriseer dan die resultaat volledig.', checkMode: 'auto', options: ['2(3x+8)', '6x+8', '3(2x+3)', '2(3x+4)'], correctIndex: 3, explanation: 'Vereenvoudig eers: 4x+8+2x=6x+8.\nFaktoriseer: die GGF van 6 en 8 is 2.\nDeel elke term deur 2: 6x÷2=3x en 8÷2=4.\nAntwoord: 2(3x+4)' },
        { difficulty: 'Hard', question: 'Brei uit en vereenvoudig: 2(x+3)+3(x−1).', checkMode: 'auto', options: ['5x+3', '5x+9', '5x', '6x+3'], correctIndex: 0, explanation: 'Brei elke hakie uit: 2(x+3)=2x+6 en 3(x−1)=3x−3.\nTel op: 2x+6+3x−3.\nKombineer gelyksoortige terme: (2x+3x)+(6−3)=5x+3.\nAntwoord: 5x+3' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // Blok 1 — Vereenvoudiging met veelvuldige veranderlikes/eksponente (Easy)
        { difficulty: 'Easy', question: 'Vereenvoudig 7x²+2x−3x²+5x.', checkMode: 'auto', options: ['10x²+7x', '4x²+7x', '4x²−3x', '4x⁴+7x'], correctIndex: 1, explanation: 'Groepeer gelyksoortige terme: (7x²−3x²)+(2x+5x).\n7x²−3x²=4x² en 2x+5x=7x.\nAntwoord: 4x²+7x' },
        { difficulty: 'Easy', question: 'Vereenvoudig 5xy+6x−3xy+2x.', checkMode: 'auto', options: ['8xy+8x', '2xy+4x', '2xy+8x', '10xy'], correctIndex: 2, explanation: 'Groepeer gelyksoortige terme: (5xy−3xy)+(6x+2x).\n5xy−3xy=2xy en 6x+2x=8x.\nAntwoord: 2xy+8x' },
        { difficulty: 'Easy', question: 'Vereenvoudig 6a²b+2ab−3a²b.', checkMode: 'auto', options: ['9a²b+2ab', '5a²b', '3a⁴b+2ab', '3a²b+2ab'], correctIndex: 3, explanation: 'Slegs die a²b-terme is gelyksoortig: 6a²b−3a²b=3a²b.\n2ab het ʼn ander eksponent op a, dus kan dit nie gekombineer word nie.\nAntwoord: 3a²b+2ab' },

        // Blok 2 — Uitbrei van hakies, distributiewe wet (Medium)
        { difficulty: 'Medium', question: 'Brei uit: 4x(3x+2).', checkMode: 'auto', options: ['12x²+8x', '12x²+2x', '7x²+8x', '20x'], correctIndex: 0, explanation: 'Vermenigvuldig 4x met elke term binne die hakies.\n(4x)(3x)=12x² en (4x)(2)=8x.\nAntwoord: 12x²+8x' },
        { difficulty: 'Medium', question: 'Brei uit: −5x(x−2).', checkMode: 'auto', options: ['−5x²−10x', '−5x²+10x', '5x²+10x', '−x²+10x'], correctIndex: 1, explanation: 'Vermenigvuldig −5x met elke term binne die hakies.\n(−5x)(x)=−5x² en (−5x)(−2)=+10x.\nAntwoord: −5x²+10x' },
        { difficulty: 'Medium', question: 'Brei uit en vereenvoudig: 3(2x+5)+4x.', checkMode: 'auto', options: ['10x+5', '9x+15', '10x+15', '18x+15'], correctIndex: 2, explanation: 'Brei die hakies uit: 3(2x+5)=6x+15.\nTel die oorblywende term by: 6x+15+4x.\nKombineer gelyksoortige terme: 6x+4x=10x.\nAntwoord: 10x+15' },
        { difficulty: 'Medium', question: 'ʼn Klaskamerplakkaat het lengte 4 cm en breedte (x+8) cm. Skryf ʼn uitdrukking vir die oppervlakte, en brei dit uit.', checkMode: 'auto', options: ['4x+8', '4x+12', '32x+4', '4x+32'], correctIndex: 3, explanation: 'Oppervlakte van ʼn reghoek = lengte × breedte = 4(x+8).\nBrei uit: (4)(x)+(4)(8)=4x+32.\nAntwoord: 4x+32' },

        // Blok 3 — Faktorisering deur gemeenskaplike faktor (Medium)
        { difficulty: 'Medium', question: 'Faktoriseer 8x+12 volledig.', checkMode: 'auto', options: ['4(2x+3)', '4(2x+12)', '2(4x+6)', '4(8x+12)'], correctIndex: 0, explanation: 'Die GGF van 8 en 12 is 4.\nDeel elke term deur 4: 8x÷4=2x en 12÷4=3.\nAntwoord: 4(2x+3)' },
        { difficulty: 'Medium', question: 'Faktoriseer 10x²+15x volledig.', checkMode: 'auto', options: ['5x(2x+15)', '5x(2x+3)', 'x(10x+15)', '5(2x²+3x)'], correctIndex: 1, explanation: 'Die GGF van die koëffisiënte 10 en 15 is 5, en albei terme deel ʼn faktor van x.\nDeel elke term deur 5x: 10x²÷5x=2x en 15x÷5x=3.\nAntwoord: 5x(2x+3)' },
        { difficulty: 'Medium', question: 'Faktoriseer 21xy−14x volledig.', checkMode: 'auto', options: ['7x(3y−14)', 'x(21y−14)', '7x(3y−2)', '7(3xy−2x)'], correctIndex: 2, explanation: 'Die GGF van 21 en 14 is 7, en albei terme deel ʼn faktor van x.\nDeel elke term deur 7x: 21xy÷7x=3y en 14x÷7x=2.\nAntwoord: 7x(3y−2)' },
        ...
        // Blok 4 — Vervanging met negatiewe/breukwaardes (Medium-Hard)
        { difficulty: 'Medium-Hard', question: 'Bereken 4x²−3x wanneer x=−2.', checkMode: 'auto', options: ['−10', '10', '70', '22'], correctIndex: 3, explanation: 'Vervang x=−2: 4(−2)²−3(−2).\n(−2)²=4, dus 4(4)=16. Ook −3(−2)=+6.\n16+6=22' },
        { difficulty: 'Medium-Hard', question: 'Bereken 3x+4y wanneer x=0,5 en y=−2.', checkMode: 'auto', options: ['−6,5', '9,5', '7', '5,5'], correctIndex: 0, explanation: 'Vervang x=0,5 en y=−2: 3(0,5)+4(−2).\n3(0,5)=1,5 en 4(−2)=−8.\n1,5−8=−6,5' },
        { difficulty: 'Medium-Hard', question: 'Bereken x²−4x+2 wanneer x=−1.', checkMode: 'auto', options: ['5', '7', '−1', '−5'], correctIndex: 1, explanation: 'Vervang x=−1: (−1)²−4(−1)+2.\n(−1)²=1 en −4(−1)=+4.\n1+4+2=7' },
        { difficulty: 'Medium-Hard', question: 'Die koste in rand om ʼn kajak te huur is C=8h+15, waar h die aantal ure is. Bepaal die koste wanneer h=1,5 ure.', checkMode: 'auto', options: ['12', '132', '27', '23'], correctIndex: 2, explanation: 'Vervang h=1,5: C=8(1,5)+15.\n8(1,5)=12, dus C=12+15=27.\nDie koste is R27.' },

        // Blok 5 — Multi-stap vereenvoudiging wat verskeie vaardighede kombineer (Hard)
        { difficulty: 'Hard', question: 'Vereenvoudig 4x(x+3)−7x.', checkMode: 'auto', options: ['4x²+19x', '4x²−4x', '4x⁴+5x', '4x²+5x'], correctIndex: 3, explanation: 'Brei eers uit: 4x(x+3)=4x²+12x.\nTrek 7x af: 4x²+12x−7x.\nKombineer gelyksoortige terme: 12x−7x=5x.\nAntwoord: 4x²+5x' },
        { difficulty: 'Hard', question: 'Vereenvoudig 6x+9+3x, en faktoriseer dan die resultaat volledig.', checkMode: 'auto', options: ['9(x+1)', '9(x+9)', '9x+9', '3(2x+3)'], correctIndex: 0, explanation: 'Vereenvoudig eers: 6x+9+3x=9x+9.\nFaktoriseer: die GGF van 9 en 9 is 9.\nDeel elke term deur 9: 9x÷9=x en 9÷9=1.\nAntwoord: 9(x+1)' },
        { difficulty: 'Hard', question: 'Brei uit en vereenvoudig: 3(x+2)+2(x−4).', checkMode: 'auto', options: ['5x+14', '5x−2', '5x', '5x+2'], correctIndex: 1, explanation: 'Brei elke hakie uit: 3(x+2)=3x+6 en 2(x−4)=2x−8.\nTel op: 3x+6+2x−8.\nKombineer gelyksoortige terme: (3x+2x)+(6−8)=5x−2.\nAntwoord: 5x−2' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // Blok 1 — Vereenvoudiging met veelvuldige veranderlikes/eksponente (Easy)
        { difficulty: 'Easy', question: 'Vereenvoudig 8x²+4x−5x²+3x.', checkMode: 'auto', options: ['13x²+7x', '3x²+x', '3x²+7x', '3x⁴+7x'], correctIndex: 2, explanation: 'Groepeer gelyksoortige terme: (8x²−5x²)+(4x+3x).\n8x²−5x²=3x² en 4x+3x=7x.\nAntwoord: 3x²+7x' },
        { difficulty: 'Easy', question: 'Vereenvoudig 4xy+7x−2xy+3x.', checkMode: 'auto', options: ['6xy+10x', '2xy+4x', '12xy', '2xy+10x'], correctIndex: 3, explanation: 'Groepeer gelyksoortige terme: (4xy−2xy)+(7x+3x).\n4xy−2xy=2xy en 7x+3x=10x.\nAntwoord: 2xy+10x' },
        { difficulty: 'Easy', question: 'Vereenvoudig 5a²b+4ab−3a²b.', checkMode: 'auto', options: ['2a²b+4ab', '8a²b+4ab', '6a²b', '2a⁴b+4ab'], correctIndex: 0, explanation: 'Slegs die a²b-terme is gelyksoortig: 5a²b−3a²b=2a²b.\n4ab het ʼn ander eksponent op a, dus kan dit nie gekombineer word nie.\nAntwoord: 2a²b+4ab' },

        // Blok 2 — Uitbrei van hakies, distributiewe wet (Medium)
        { difficulty: 'Medium', question: 'Brei uit: 5x(2x+3).', checkMode: 'auto', options: ['10x²+3x', '10x²+15x', '7x²+15x', '25x'], correctIndex: 1, explanation: 'Vermenigvuldig 5x met elke term binne die hakies.\n(5x)(2x)=10x² en (5x)(3)=15x.\nAntwoord: 10x²+15x' },
        { difficulty: 'Medium', question: 'Brei uit: −3x(x−5).', checkMode: 'auto', options: ['−3x²−15x', '3x²+15x', '−3x²+15x', '−x²+15x'], correctIndex: 2, explanation: 'Vermenigvuldig −3x met elke term binne die hakies.\n(−3x)(x)=−3x² en (−3x)(−5)=+15x.\nAntwoord: −3x²+15x' },
        { difficulty: 'Medium', question: 'Brei uit en vereenvoudig: 4(2x+3)+3x.', checkMode: 'auto', options: ['11x+3', '9x+12', '20x+12', '11x+12'], correctIndex: 3, explanation: 'Brei die hakies uit: 4(2x+3)=8x+12.\nTel die oorblywende term by: 8x+12+3x.\nKombineer gelyksoortige terme: 8x+3x=11x.\nAntwoord: 11x+12' },
        { difficulty: 'Medium', question: 'ʼn Reghoekige plantbed is 5 m breed en (x+7) m lank. Skryf ʼn uitdrukking vir die oppervlakte, en brei dit uit.', checkMode: 'auto', options: ['5x+35', '5x+7', '5x+12', '35x+5'], correctIndex: 0, explanation: 'Oppervlakte van ʼn reghoek = lengte × breedte = 5(x+7).\nBrei uit: (5)(x)+(5)(7)=5x+35.\nAntwoord: 5x+35' },

        // Blok 3 — Faktorisering deur gemeenskaplike faktor (Medium)
        { difficulty: 'Medium', question: 'Faktoriseer 9x+15 volledig.', checkMode: 'auto', options: ['3(3x+15)', '3(3x+5)', '3(5x+3)', '3(9x+15)'], correctIndex: 1, explanation: 'Die GGF van 9 en 15 is 3.\nDeel elke term deur 3: 9x÷3=3x en 15÷3=5.\nAntwoord: 3(3x+5)' },
        { difficulty: 'Medium', question: 'Faktoriseer 12x²+18x volledig.', checkMode: 'auto', options: ['6x(2x+18)', '3x(4x+6)', '6x(2x+3)', '6(2x²+3x)'], correctIndex: 2, explanation: 'Die GGF van die koëffisiënte 12 en 18 is 6, en albei terme deel ʼn faktor van x.\nDeel elke term deur 6x: 12x²÷6x=2x en 18x÷6x=3.\nAntwoord: 6x(2x+3)' },
        { difficulty: 'Medium', question: 'Faktoriseer 24xy−16x volledig.', checkMode: 'auto', options: ['8x(3y−16)', 'x(24y−16)', '8(3xy−2x)', '8x(3y−2)'], correctIndex: 3, explanation: 'Die GGF van 24 en 16 is 8, en albei terme deel ʼn faktor van x.\nDeel elke term deur 8x: 24xy÷8x=3y en 16x÷8x=2.\nAntwoord: 8x(3y−2)' },
        ...
        // Blok 4 — Vervanging met negatiewe/breukwaardes (Medium-Hard)
        { difficulty: 'Medium-Hard', question: 'Bereken 2x²−5x wanneer x=−3.', checkMode: 'auto', options: ['33', '−3', '3', '51'], correctIndex: 0, explanation: 'Vervang x=−3: 2(−3)²−5(−3).\n(−3)²=9, dus 2(9)=18. Ook −5(−3)=+15.\n18+15=33' },
        { difficulty: 'Medium-Hard', question: 'Bereken 4x+3y wanneer x=0,5 en y=−4.', checkMode: 'auto', options: ['14', '−10', '8', '3,5'], correctIndex: 1, explanation: 'Vervang x=0,5 en y=−4: 4(0,5)+3(−4).\n4(0,5)=2 en 3(−4)=−12.\n2−12=−10' },
        { difficulty: 'Medium-Hard', question: 'Bereken x²−5x+3 wanneer x=−1.', checkMode: 'auto', options: ['7', '−1', '9', '−7'], correctIndex: 2, explanation: 'Vervang x=−1: (−1)²−5(−1)+3.\n(−1)²=1 en −5(−1)=+5.\n1+5+3=9' },
        { difficulty: 'Medium-Hard', question: 'Die koste in rand om ʼn fiets te huur is C=10h+20, waar h die aantal ure is. Bepaal die koste wanneer h=3,5 ure.', checkMode: 'auto', options: ['35', '235', '50', '55'], correctIndex: 3, explanation: 'Vervang h=3,5: C=10(3,5)+20.\n10(3,5)=35, dus C=35+20=55.\nDie koste is R55.' },

        // Blok 5 — Multi-stap vereenvoudiging wat verskeie vaardighede kombineer (Hard)
        { difficulty: 'Hard', question: 'Vereenvoudig 5x(x+1)−4x.', checkMode: 'auto', options: ['5x²+x', '5x²+9x', '5x²−3x', '5x⁴+x'], correctIndex: 0, explanation: 'Brei eers uit: 5x(x+1)=5x²+5x.\nTrek 4x af: 5x²+5x−4x.\nKombineer gelyksoortige terme: 5x−4x=x.\nAntwoord: 5x²+x' },
        { difficulty: 'Hard', question: 'Vereenvoudig 5x+10+3x, en faktoriseer dan die resultaat volledig.', checkMode: 'auto', options: ['2(4x+10)', '2(4x+5)', '8x+10', '5(x+2)'], correctIndex: 1, explanation: 'Vereenvoudig eers: 5x+10+3x=8x+10.\nFaktoriseer: die GGF van 8 en 10 is 2.\nDeel elke term deur 2: 8x÷2=4x en 10÷2=5.\nAntwoord: 2(4x+5)' },
        { difficulty: 'Hard', question: 'Brei uit en vereenvoudig: 4(x+1)+2(x−5).', checkMode: 'auto', options: ['6x+14', '6x', '6x−6', '6x−1'], correctIndex: 2, explanation: 'Brei elke hakie uit: 4(x+1)=4x+4 en 2(x−5)=2x−10.\nTel op: 4x+4+2x−10.\nKombineer gelyksoortige terme: (4x+2x)+(4−10)=6x−6.\nAntwoord: 6x−6' },
