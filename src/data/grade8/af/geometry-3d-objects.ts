  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'ʼn Vaste liggaam het een plat sirkelvormige basis, een geboë oppervlak wat na ʼn enkele punt toe smaller word, en geen ander plat vlakke nie. Wat word hierdie vaste liggaam genoem?', checkMode: 'auto', options: ['silinder', 'sfeer', 'keël', 'vierkantige piramide'], correctIndex: 2, explanation: 'ʼn Vaste liggaam met een sirkelvormige basis en ʼn geboë oppervlak wat na ʼn enkele apeks toe smaller word, is ʼn keël ✓' },
        { difficulty: 'Easy', question: 'ʼn Vaste liggaam het twee identiese, parallelle sirkelvormige basisse wat deur een geboë oppervlak verbind word. Wat word hierdie vaste liggaam genoem?', checkMode: 'auto', options: ['silinder', 'keël', 'sfeer', 'seshoekige prisma'], correctIndex: 0, explanation: 'ʼn Vaste liggaam met twee parallelle identiese sirkelvormige basisse wat deur ʼn geboë oppervlak verbind word, is ʼn silinder ✓' },
        { difficulty: 'Medium', question: 'Zanele klassifiseer drie vaste liggame vir ʼn projek. Vaste liggaam A het 2 parallelle vyfhoekige basisse en reghoekige sy-vlakke. Vaste liggaam B het 1 vyfhoekige basis en driehoekige sy-vlakke wat by ʼn apeks ontmoet. Vaste liggaam C is heeltemal rond met een geboë oppervlak en glad geen plat vlakke nie. Benoem elke vaste liggaam.', checkMode: 'auto', options: ['vyfhoekige piramide, vyfhoekige prisma, sfeer', 'vyfhoekige prisma, vyfhoekige piramide, silinder', 'seshoekige prisma, vyfhoekige piramide, sfeer', 'vyfhoekige prisma, vyfhoekige piramide, sfeer'], correctIndex: 3, explanation: 'Twee parallelle identiese basisse + reghoekige sy-vlakke = prisma, benoem volgens sy basis (vyfhoek) → vyfhoekige prisma.\nEen basis + driehoekige sy-vlakke wat by ʼn apeks ontmoet = piramide → vyfhoekige piramide.\nHeeltemal rond met een geboë oppervlak en geen plat vlakke nie = sfeer ✓' },

        // Blok B: tel V/R/H van benoemde veelvlakke (4-7)
        { difficulty: 'Easy', question: 'Hoeveel vlakke het ʼn seshoekige prisma?', checkMode: 'auto', options: ['6', '8', '12', '9'], correctIndex: 1, explanation: 'ʼn Seshoekige prisma het ʼn basis met 6 sye.\nVlakke = basissye + 2 = 6 + 2 = 8 ✓' },
        { difficulty: 'Easy', question: 'Hoeveel hoekpunte het ʼn vyfhoekige piramide?', checkMode: 'auto', options: ['5', '10', '11', '6'], correctIndex: 3, explanation: 'ʼn Vyfhoekige piramide het ʼn basis met 5 sye.\nHoekpunte = basissye + 1 = 5 + 1 = 6 ✓' },
        { difficulty: 'Medium', question: 'ʼn Geskenkdosie is in die vorm van ʼn driehoekige prisma. Hoeveel rande het dit?', checkMode: 'auto', options: ['9', '6', '5', '12'], correctIndex: 0, explanation: 'ʼn Driehoekige prisma het ʼn basis met 3 sye.\nRande = basissye × 3 = 3 × 3 = 9 ✓' },
        ...
        { difficulty: 'Medium', question: "ʼn Seshoekige piramide het V = 7 en H = 7. Gebruik Euler se formule om R te vind.", checkMode: 'auto', options: ['14', '6', '12', '8'], correctIndex: 2, explanation: "V − R + H = 2\n7 − R + 7 = 2\n14 − R = 2\nR = 12 ✓\nToets: ʼn seshoek-basis het 6 sye, dus R = 6 × 2 = 12 ✓" },
        { difficulty: 'Medium-Hard', question: 'ʼn Leerder beweer dat ʼn neghoekige prisma V = 11, R = 27, H = 16 het. Gebruik Euler se formule om dit te toets. As dit verkeerd is, gee die korrekte waarde van H.', checkMode: 'auto', options: ['16', '18', '9', '20'], correctIndex: 1, explanation: 'ʼn Neghoekige prisma het ʼn basis met 9 sye.\nV = 9 + 2 = 11, R = 9 × 3 = 27, H = 9 × 2 = 18.\nDie leerder se getalle gee 11 − 27 + 16 = 0, nie 2 nie — verkeerd.\nH behoort 18 te wees, nie 16 nie.\nToets: 11 − 27 + 18 = 2 ✓' },
        ...
        { difficulty: 'Medium-Hard', question: 'ʼn Net bestaan uit 2 sirkels en 1 reghoek soos getoon, waar een sirkel die bo-rand van die reghoek raak, die ander sirkel die onder-rand van die reghoek raak, en die reghoek se breedte presies ooreenstem met die omtrek van die sirkels. In watter vaste liggaam vou hierdie net op?', checkMode: 'auto', options: ['keël', 'sfeer', 'seshoekige prisma', 'silinder'], correctIndex: 3, explanation: 'Die net het 2 identiese sirkelvormige basisse en 1 reghoek wat omvou om die geboë oppervlak te vorm, wat ooreenstem met ʼn silinder — die reghoek se breedte moet presies gelyk wees aan die sirkel se omtrek sodat die geboë oppervlak presies aansluit ✓' },
        ...
        { difficulty: 'Hard', question: 'ʼn Reghoekige prisma word gesny deur ʼn plat vlak parallel aan sy reghoekige basis, wat reguit dwarsdeur die prisma sny. Watter vorm is die dwarssnit?', checkMode: 'auto', options: ['vierkant', 'sirkel', 'reghoek', 'driehoek'], correctIndex: 2, explanation: 'ʼn Dwarssnit parallel aan die basis van ʼn prisma is altyd identies in vorm aan die basis. Aangesien die basis ʼn reghoek is, is die dwarssnit ʼn reghoek ✓' },
        ...
        { difficulty: 'Hard', question: 'ʼn Keël wat regop op sy sirkelvormige basis staan, word gesny deur ʼn plat vlak parallel aan sy basis, halfpad tussen die basis en die apeks. Watter vorm is die dwarssnit, en hoe vergelyk sy grootte met die basis?', checkMode: 'auto', options: ['driehoek', 'sirkel', 'ellips', 'halfsirkel'], correctIndex: 1, explanation: 'Om ʼn keël parallel aan sy sirkelvormige basis te sny, gee altyd ʼn sirkelvormige dwarssnit, want elke horisontale snit van ʼn keël is ʼn sirkel. Anders as by ʼn silinder, is hierdie sirkel egter kleiner as die basis — die keël vernou, so dwarssnitte word kleiner hoe nader dit aan die apeks gesny word ✓' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // Blok A: benoem/klassifiseer (1-3)
        { difficulty: 'Easy', question: 'ʼn Vaste liggaam is heeltemal rond, met elke punt op sy oppervlak dieselfde afstand van sy middelpunt, en het glad geen plat vlakke nie. Wat word hierdie vaste liggaam genoem?', checkMode: 'auto', options: ['keël', 'silinder', 'sfeer', 'halfsfeer'], correctIndex: 2, explanation: 'ʼn Heeltemal ronde vaste liggaam waar elke oppervlakpunt ewe ver van die middelpunt is, met geen plat vlakke nie, is ʼn sfeer ✓' },
        { difficulty: 'Easy', question: 'ʼn Vaste liggaam het een sewehoekige (7-sydige) basis en 7 driehoekige vlakke wat almal by ʼn enkele apeks ontmoet. Wat word hierdie vaste liggaam genoem?', checkMode: 'auto', options: ['sewehoekige piramide', 'sewehoekige prisma', 'seshoekige piramide', 'agthoekige piramide'], correctIndex: 0, explanation: 'ʼn Vaste liggaam met een basis en driehoekige vlakke wat by ʼn enkele apeks ontmoet, is ʼn piramide. Die basis het 7 sye, dus is dit ʼn sewehoekige piramide ✓' },
        { difficulty: 'Medium', question: 'Kabelo klassifiseer drie vaste liggame vir ʼn vertoning. Vaste liggaam A het 2 parallelle agthoekige basisse en reghoekige sy-vlakke. Vaste liggaam B het 1 sirkelvormige basis en 1 geboë oppervlak wat na ʼn punt toe vernou. Vaste liggaam C het 2 parallelle sirkelvormige basisse wat deur 1 geboë oppervlak verbind word. Benoem elke vaste liggaam.', checkMode: 'auto', options: ['agthoekige piramide, keël, silinder', 'agthoekige prisma, silinder, keël', 'sewehoekige prisma, keël, silinder', 'agthoekige prisma, keël, silinder'], correctIndex: 3, explanation: 'Twee parallelle identiese basisse + reghoekige sy-vlakke = prisma, benoem volgens sy basis (agthoek) → agthoekige prisma.\nEen sirkelvormige basis + geboë oppervlak wat na ʼn punt toe vernou = keël.\nTwee parallelle sirkelvormige basisse + geboë oppervlak = silinder ✓' },

        // Blok B: tel V/R/H van benoemde veelvlakke (4-7)
        { difficulty: 'Easy', question: 'Hoeveel vlakke het ʼn sewehoekige prisma?', checkMode: 'auto', options: ['7', '9', '14', '10'], correctIndex: 1, explanation: 'ʼn Sewehoekige prisma het ʼn basis met 7 sye.\nVlakke = basissye + 2 = 7 + 2 = 9 ✓' },
        { difficulty: 'Easy', question: 'Hoeveel hoekpunte het ʼn seshoekige piramide?', checkMode: 'auto', options: ['6', '12', '13', '7'], correctIndex: 3, explanation: 'ʼn Seshoekige piramide het ʼn basis met 6 sye.\nHoekpunte = basissye + 1 = 6 + 1 = 7 ✓' },
        { difficulty: 'Medium', question: 'ʼn Juweliersboksie is in die vorm van ʼn driehoekige prisma. Hoeveel hoekpunte het dit?', checkMode: 'auto', options: ['6', '9', '5', '3'], correctIndex: 0, explanation: 'ʼn Driehoekige prisma het ʼn basis met 3 sye.\nHoekpunte = basissye × 2 = 3 × 2 = 6 ✓' },
        ...
        { difficulty: 'Medium', question: "ʼn Sewehoekige piramide het V = 8 en H = 8. Gebruik Euler se formule om R te vind.", checkMode: 'auto', options: ['16', '7', '14', '10'], correctIndex: 2, explanation: "V − R + H = 2\n8 − R + 8 = 2\n16 − R = 2\nR = 14 ✓\nToets: ʼn sewehoek-basis het 7 sye, dus R = 7 × 2 = 14 ✓" },
        { difficulty: 'Medium-Hard', question: 'ʼn Leerder beweer dat ʼn tienhoekige prisma V = 12, R = 30, H = 18 het. Gebruik Euler se formule om dit te toets. As dit verkeerd is, gee die korrekte waarde van H.', checkMode: 'auto', options: ['18', '20', '10', '22'], correctIndex: 1, explanation: 'ʼn Tienhoekige prisma het ʼn basis met 10 sye.\nV = 10 + 2 = 12, R = 10 × 3 = 30, H = 10 × 2 = 20.\nDie leerder se getalle gee 12 − 30 + 18 = 0, nie 2 nie — verkeerd.\nH behoort 20 te wees, nie 18 nie.\nToets: 12 − 30 + 20 = 2 ✓' },
        ...
        // Blok E: dwarssnitte (16-18)
        { difficulty: 'Hard', question: 'ʼn Driehoekige prisma word gesny deur ʼn plat vlak parallel aan sy driehoekige basis, wat reguit dwarsdeur die prisma sny. Watter vorm is die dwarssnit?', checkMode: 'auto', options: ['reghoek', 'vierkant', 'driehoek', 'vyfhoek'], correctIndex: 2, explanation: 'ʼn Dwarssnit parallel aan die basis van ʼn prisma is altyd identies in vorm aan die basis. Aangesien die basis ʼn driehoek is, is die dwarssnit ʼn driehoek ✓' },
        ...
        { difficulty: 'Hard', question: 'ʼn Silinder wat op sy geboë sykant lê, word gesny deur ʼn plat vlak loodreg op sy sirkelvormige basisse, wat oorlangs deur die middelpunt sny. Watter vorm is die dwarssnit?', checkMode: 'auto', options: ['sirkel', 'reghoek', 'vierkant', 'ovaal'], correctIndex: 1, explanation: 'Om ʼn silinder oorlangs deur sy as te sny, loodreg op die sirkelvormige basisse, gee ʼn reghoekige dwarssnit — die lengte daarvan is gelyk aan die silinder se hoogte en die breedte daarvan is gelyk aan die deursnee van die sirkelvormige basis ✓' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // Blok A: benoem/klassifiseer (1-3)
        { difficulty: 'Easy', question: 'ʼn Vaste liggaam het twee identiese, parallelle tienhoekige (10-sydige) basisse wat deur 10 reghoekige vlakke verbind word. Wat word hierdie vaste liggaam genoem?', checkMode: 'auto', options: ['neghoekige prisma', 'tienhoekige piramide', 'tienhoekige prisma', 'twaalfhoekige prisma'], correctIndex: 2, explanation: 'ʼn Vaste liggaam met twee identiese parallelle basisse en reghoekige sy-vlakke is ʼn prisma. Die basis het 10 sye, dus is dit ʼn tienhoekige prisma ✓' },
        { difficulty: 'Easy', question: 'ʼn Vaste liggaam het een plat sirkelvormige basis en een geboë oppervlak wat glad vernou na ʼn enkele apeks bo die basis. Wat word hierdie vaste liggaam genoem?', checkMode: 'auto', options: ['keël', 'silinder', 'sfeer', 'vierkantige piramide'], correctIndex: 0, explanation: 'ʼn Vaste liggaam met ʼn sirkelvormige basis en ʼn geboë oppervlak wat na ʼn enkele apeks toe vernou, is ʼn keël ✓' },
        { difficulty: 'Medium', question: 'Amahle klassifiseer drie vaste liggame vir ʼn wetenskapskou. Vaste liggaam A het 1 neghoekige basis en 9 driehoekige vlakke wat by ʼn apeks ontmoet. Vaste liggaam B het 2 parallelle sirkelvormige basisse wat deur ʼn geboë oppervlak verbind word. Vaste liggaam C is heeltemal rond met glad geen plat vlakke nie. Benoem elke vaste liggaam.', checkMode: 'auto', options: ['neghoekige prisma, silinder, sfeer', 'neghoekige piramide, sfeer, silinder', 'agthoekige piramide, silinder, sfeer', 'neghoekige piramide, silinder, sfeer'], correctIndex: 3, explanation: 'Een basis + driehoekige sy-vlakke wat by ʼn apeks ontmoet = piramide, benoem volgens sy basis (neghoek) → neghoekige piramide.\nTwee parallelle sirkelvormige basisse + geboë oppervlak = silinder.\nHeeltemal rond met geen plat vlakke nie = sfeer ✓' },

        // Blok B: tel V/R/H van benoemde veelvlakke (4-7)
        { difficulty: 'Easy', question: 'Hoeveel vlakke het ʼn agthoekige prisma?', checkMode: 'auto', options: ['8', '10', '16', '11'], correctIndex: 1, explanation: 'ʼn Agthoekige prisma het ʼn basis met 8 sye.\nVlakke = basissye + 2 = 8 + 2 = 10 ✓' },
        { difficulty: 'Easy', question: 'Hoeveel hoekpunte het ʼn sewehoekige piramide?', checkMode: 'auto', options: ['7', '14', '15', '8'], correctIndex: 3, explanation: 'ʼn Sewehoekige piramide het ʼn basis met 7 sye.\nHoekpunte = basissye + 1 = 7 + 1 = 8 ✓' },
        { difficulty: 'Medium', question: 'ʼn Kampeertent is in die vorm van ʼn driehoekige prisma. Hoeveel vlakke het dit?', checkMode: 'auto', options: ['5', '6', '9', '3'], correctIndex: 0, explanation: 'ʼn Driehoekige prisma het ʼn basis met 3 sye.\nVlakke = basissye + 2 = 3 + 2 = 5 ✓' },
        ...
        { difficulty: 'Medium', question: "ʼn Agthoekige piramide het V = 9 en H = 9. Gebruik Euler se formule om R te vind.", checkMode: 'auto', options: ['18', '8', '16', '12'], correctIndex: 2, explanation: "V − R + H = 2\n9 − R + 9 = 2\n18 − R = 2\nR = 16 ✓\nToets: ʼn agthoek-basis het 8 sye, dus R = 8 × 2 = 16 ✓" },
        { difficulty: 'Medium-Hard', question: 'ʼn Leerder beweer dat ʼn sewehoekige prisma V = 9, R = 21, H = 12 het. Gebruik Euler se formule om dit te toets. As dit verkeerd is, gee die korrekte waarde van H.', checkMode: 'auto', options: ['12', '14', '7', '16'], correctIndex: 1, explanation: 'ʼn Sewehoekige prisma het ʼn basis met 7 sye.\nV = 7 + 2 = 9, R = 7 × 3 = 21, H = 7 × 2 = 14.\nDie leerder se getalle gee 9 − 21 + 12 = 0, nie 2 nie — verkeerd.\nH behoort 14 te wees, nie 12 nie.\nToets: 9 − 21 + 14 = 2 ✓' },
        ...
        // Blok E: dwarssnitte (16-18)
        { difficulty: 'Hard', question: 'ʼn Seshoekige prisma word gesny deur ʼn plat vlak parallel aan sy seshoekige basis, wat reguit dwarsdeur die prisma sny. Watter vorm is die dwarssnit?', checkMode: 'auto', options: ['vyfhoek', 'agthoek', 'seshoek', 'reghoek'], correctIndex: 2, explanation: 'ʼn Dwarssnit parallel aan die basis van ʼn prisma is altyd identies in vorm aan die basis. Aangesien die basis ʼn seshoek is, is die dwarssnit ʼn seshoek ✓' },
        ...
        { difficulty: 'Hard', question: 'ʼn Keël wat op sy geboë sykant lê (op sy kant, nie regop nie), word vertikaal gesny deur sy apeks en die middelpunt van sy sirkelvormige basis. Watter vorm is die dwarssnit?', checkMode: 'auto', options: ['sirkel', 'driehoek', 'reghoek', 'halfsirkel'], correctIndex: 1, explanation: 'Om ʼn keël deur sy apeks en deur die middelpunt van sy basis te sny, gee ʼn driehoekige dwarssnit — een kant is die deursnee van die basis, en die ander twee kante loop van die uiteindes van daardie deursnee op na die apeks ✓' },
