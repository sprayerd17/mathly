  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'In die vierhoek getoon, is drie hoeke 84°, 97° en 120°. Bepaal die vierde hoek.', answer: '59°', checkMode: 'auto', correctAnswer: '59', correctAnswers: ['59', '59°', '59 degrees'], explanation: 'Vierde hoek = 360° − 84° − 97° − 120° = 59°. Kontroleer: 84+97+120+59 = 360 ✓', diagramSvg: '<svg viewBox="0 0 220 170" xmlns="http://www.w3.org/2000/svg"><polygon points="40,140 120,140 126.3,89 51.3,32.5" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="53" y="127" font-size="13" fill="#2563eb" font-weight="700">84°</text><text x="109" y="127" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">97°</text><text x="114" y="92" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">120°</text><text x="61" y="53" font-size="15" fill="#ea580c" font-weight="700">?</text></svg>' },
