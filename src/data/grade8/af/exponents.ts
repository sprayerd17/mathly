...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramSvg:
        ...
        `<text x="65" y="76" text-anchor="middle" font-size="9" font-weight="700" fill="#2563eb">nuwe punt</text>` +
        `<circle cx="185" cy="60" r="3" fill="#9ca3af"/>` +
        `<text x="185" y="76" text-anchor="middle" font-size="9" fill="#9ca3af">oorspronklik</text>` +
        `<path d="M180,90 Q125,110 70,90" fill="none" stroke="#2563eb" stroke-width="2"/>` +
        `<polygon points="65,90 75,85 75,96" fill="#2563eb"/>` +
        `<text x="125" y="118" text-anchor="middle" font-size="11" font-weight="700" fill="#2563eb">4 plekke na links geskuif</text>` +
  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      name: 'Stel 1',
      questions: [
        { difficulty: 'Easy', question: 'Vereenvoudig 3⁵ × 3², laat jou antwoord as ʼn mag van 3, en bereken dit dan.', checkMode: 'auto', options: ['59049', '27', '2187', '21'], correctIndex: 2, explanation: 'Dieselfde grondtal — tel die eksponente bymekaar: 3⁵ × 3² = 3^(5+2) = 3⁷ = 2 187 ✓' },
        { difficulty: 'Easy', question: 'Vereenvoudig 4⁶ ÷ 4², laat jou antwoord as ʼn mag van 4, en bereken dit dan.', checkMode: 'auto', options: ['4096', '1/256', '16', '256'], correctIndex: 3, explanation: 'Dieselfde grondtal — trek die eksponente van mekaar af: 4⁶ ÷ 4² = 4^(6−2) = 4⁴ = 256 ✓' },
        ...
        { difficulty: 'Medium', question: 'Vereenvoudig 7⁷ ÷ 7³, laat jou antwoord as ʼn mag van 7, en bereken dit dan.', checkMode: 'auto', options: ['2401', '823543', '1/2401', '28'], correctIndex: 0, explanation: 'Dieselfde grondtal — trek die eksponente van mekaar af: 7⁷ ÷ 7³ = 7^(7−3) = 7⁴ = 2 401 ✓' },
        { difficulty: 'Medium', question: 'Pas die mag-van-ʼn-mag-wet toe om (2³)⁴ te vereenvoudig, en bereken dit dan.', checkMode: 'auto', options: ['128', '4096', '16', '24'], correctIndex: 1, explanation: 'Mag van ʼn mag — vermenigvuldig die eksponente: (2³)⁴ = 2^(3×4) = 2¹² = 4 096 ✓' },
        { difficulty: 'Medium', question: 'Vereenvoudig (3²)³ deur die mag-van-ʼn-mag-wet te gebruik, en bereken dit dan.', checkMode: 'auto', options: ['243', '27', '729', '18'], correctIndex: 2, explanation: 'Mag van ʼn mag — vermenigvuldig die eksponente: (3²)³ = 3^(2×3) = 3⁶ = 729 ✓' },
        { difficulty: 'Medium-Hard', question: 'Gebruik die mag-van-ʼn-produk-wet om (2 × 5)³ te vereenvoudig, en bereken dit dan op twee verskillende maniere om te kontroleer of jou antwoord ooreenstem.', checkMode: 'auto', options: ['40', '30', '343', '1000'], correctIndex: 3, explanation: 'Metode 1: (2 × 5)³ = 10³ = 1 000. Metode 2 (mag van ʼn produk): 2³ × 5³ = 8 × 125 = 1 000. Albei metodes stem ooreen ✓' },
        { difficulty: 'Medium', question: 'Vereenvoudig en bereken: (2³ × 2²) ÷ 2⁴.', checkMode: 'auto', options: ['2', '512', '32', '1/2'], correctIndex: 0, explanation: 'Stap 1: Produkwet in die teller: 2³ × 2² = 2^(3+2) = 2⁵.\nStap 2: Kwosiëntwet: 2⁵ ÷ 2⁴ = 2^(5−4) = 2¹ = 2 ✓' },
        { difficulty: 'Medium-Hard', question: 'Vereenvoudig (3⁴ × 3¹) ÷ 3³, en gee ʼn finale numeriese antwoord.', checkMode: 'auto', options: ['6561', '9', '243', '1/9'], correctIndex: 1, explanation: 'Stap 1: Produkwet: 3⁴ × 3¹ = 3^(4+1) = 3⁵.\nStap 2: Kwosiëntwet: 3⁵ ÷ 3³ = 3^(5−3) = 3² = 9 ✓' },
        ...
        { difficulty: 'Medium', question: 'Vind die kwadraatwortel van 16/25.', checkMode: 'auto', options: ['5/4', '4/5', '4/25', '16/5'], correctIndex: 1, explanation: 'Pas die wortel afsonderlik op die teller en noemer toe.\n√16 = 4 en √25 = 5\n√(16/25) = 4/5 ✓' },
        { difficulty: 'Medium', question: 'Vind die kubuswortel van 27/64.', checkMode: 'auto', options: ['4/3', '3/64', '3/4', '27/4'], correctIndex: 2, explanation: 'Pas die kubuswortel afsonderlik op die teller en noemer toe.\n∛27 = 3 en ∛64 = 4\n∛(27/64) = 3/4 ✓' },
        ...
        { difficulty: 'Easy', question: 'Skryf 123 000 in wetenskaplike notasie.', checkMode: 'auto', options: ['1,23 × 10⁴', '1,23 × 10⁶', '12,3 × 10⁴', '1,23 × 10⁵'], correctIndex: 3, explanation: 'Skuif die desimaal 5 plekke na links: 123 000 → 1,23\nAntwoord: 1,23 × 10⁵ ✓' },
        { difficulty: 'Medium', question: 'Skryf 900 000 000 in wetenskaplike notasie.', checkMode: 'auto', options: ['9 × 10⁸', '9 × 10⁷', '9 × 10⁹', '90 × 10⁷'], correctIndex: 0, explanation: 'Skuif die desimaal 8 plekke na links: 900 000 000 → 9\nAntwoord: 9 × 10⁸ ✓' },
        { difficulty: 'Hard', question: 'ʼn Stadsbiblioteek hou ongeveer 300 000 000 (3,0 × 10⁸) bladsye dokumente in totaal, gestoor in lêers van 24 000 (2,4 × 10⁴) bladsye elk. Skryf albei hoeveelhede in wetenskaplike notasie, en bereken dan hoeveel lêers benodig word.', checkMode: 'auto', options: ['1250', '12500', '125000', '10000'], correctIndex: 1, explanation: 'Deel: (3,0 × 10⁸) ÷ (2,4 × 10⁴)\n= (3,0 ÷ 2,4) × 10^(8−4)\n= 1,25 × 10⁴ = 12 500 lêers ✓' },
      ],
      scoreMessages: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      name: 'Stel 2',
      questions: [
        { difficulty: 'Easy', question: 'Vereenvoudig 5³ × 5⁴, laat jou antwoord as ʼn mag van 5, en bereken dit dan.', checkMode: 'auto', options: ['244140625', '5', '35', '78125'], correctIndex: 3, explanation: 'Dieselfde grondtal — tel die eksponente bymekaar: 5³ × 5⁴ = 5^(3+4) = 5⁷ = 78 125 ✓' },
        { difficulty: 'Easy', question: 'Vereenvoudig 8⁷ ÷ 8³, laat jou antwoord as ʼn mag van 8, en bereken dit dan.', checkMode: 'auto', options: ['4096', '2097152', '1/4096', '32'], correctIndex: 0, explanation: 'Dieselfde grondtal — trek die eksponente van mekaar af: 8⁷ ÷ 8³ = 8^(7−3) = 8⁴ = 4 096 ✓' },
        ...
        { difficulty: 'Medium', question: 'Vereenvoudig 9⁶ ÷ 9⁴, laat jou antwoord as ʼn mag van 9, en bereken dit dan.', checkMode: 'auto', options: ['531441', '81', '1/81', '18'], correctIndex: 1, explanation: 'Dieselfde grondtal — trek die eksponente van mekaar af: 9⁶ ÷ 9⁴ = 9^(6−4) = 9² = 81 ✓' },
        { difficulty: 'Medium', question: 'Pas die mag-van-ʼn-mag-wet toe om (4²)³ te vereenvoudig, en bereken dit dan.', checkMode: 'auto', options: ['1024', '64', '4096', '24'], correctIndex: 2, explanation: 'Mag van ʼn mag — vermenigvuldig die eksponente: (4²)³ = 4^(2×3) = 4⁶ = 4 096 ✓' },
        { difficulty: 'Medium', question: 'Vereenvoudig (2⁴)² deur die mag-van-ʼn-mag-wet te gebruik, en bereken dit dan.', checkMode: 'auto', options: ['64', '4', '16', '256'], correctIndex: 3, explanation: 'Mag van ʼn mag — vermenigvuldig die eksponente: (2⁴)² = 2^(4×2) = 2⁸ = 256 ✓' },
        { difficulty: 'Medium-Hard', question: 'Gebruik die mag-van-ʼn-produk-wet om (3 × 4)³ te vereenvoudig, en bereken dit dan op twee verskillende maniere om te kontroleer of jou antwoord ooreenstem.', checkMode: 'auto', options: ['1728', '108', '36', '343'], correctIndex: 0, explanation: 'Metode 1: (3 × 4)³ = 12³ = 1 728. Metode 2 (mag van ʼn produk): 3³ × 4³ = 27 × 64 = 1 728. Albei metodes stem ooreen ✓' },
        { difficulty: 'Medium', question: 'Vereenvoudig en bereken: (5³ × 5²) ÷ 5⁴.', checkMode: 'auto', options: ['1953125', '5', '3125', '1/5'], correctIndex: 1, explanation: 'Stap 1: Produkwet in die teller: 5³ × 5² = 5^(3+2) = 5⁵.\nStap 2: Kwosiëntwet: 5⁵ ÷ 5⁴ = 5^(5−4) = 5¹ = 5 ✓' },
        { difficulty: 'Medium-Hard', question: 'Vereenvoudig (2⁵ × 2¹) ÷ 2⁴, en gee ʼn finale numeriese antwoord.', checkMode: 'auto', options: ['1024', '64', '4', '1/4'], correctIndex: 2, explanation: 'Stap 1: Produkwet: 2⁵ × 2¹ = 2^(5+1) = 2⁶.\nStap 2: Kwosiëntwet: 2⁶ ÷ 2⁴ = 2^(6−4) = 2² = 4 ✓' },
        ...
        { difficulty: 'Easy', question: 'Bereken (−8)².', checkMode: 'auto', options: ['-64', '16', '8', '64'], correctIndex: 3, explanation: '(−8)² = (−8) × (−8) = +64\nDie negatiewe teken is binne die hakies en word gekwadreer, wat ʼn positiewe resultaat gee ✓' },
        { difficulty: 'Easy', question: 'Bereken −8².', checkMode: 'auto', options: ['-64', '64', '-16', '16'], correctIndex: 0, explanation: '−8² beteken −(8²) = −(64) = −64\nDie eksponent geld slegs vir 8, nie vir die negatiewe teken nie ✓' },
        { difficulty: 'Medium', question: 'Bereken (−3)³ en −3³. Naledi sê hierdie moet verskillend wees omdat "(−a)ⁿ en −aⁿ nooit gelyk is nie." Wys die waardes en kommentaar op haar stelling.', checkMode: 'auto', options: ['27', '-27', '9', '-9'], correctIndex: 1, explanation: '(−3)³ = (−3)×(−3)×(−3) = −27. −3³ = −(3³) = −27. Haar stelling is vals in hierdie geval — vir onewe eksponente is (−a)ⁿ en −aⁿ altyd gelyk, want ʼn negatiewe getal tot ʼn onewe mag bly in albei gevalle negatief.' },
        ...
        { difficulty: 'Medium', question: 'Vind die kwadraatwortel van 25/49.', checkMode: 'auto', options: ['7/5', '5/49', '5/7', '25/7'], correctIndex: 2, explanation: 'Pas die wortel afsonderlik op die teller en noemer toe.\n√25 = 5 en √49 = 7\n√(25/49) = 5/7 ✓' },
        { difficulty: 'Medium', question: 'Vind die kubuswortel van 64/125.', checkMode: 'auto', options: ['5/4', '4/125', '64/5', '4/5'], correctIndex: 3, explanation: 'Pas die kubuswortel afsonderlik op die teller en noemer toe.\n∛64 = 4 en ∛125 = 5\n∛(64/125) = 4/5 ✓' },
        ...
        { difficulty: 'Easy', question: 'Skryf 67 000 in wetenskaplike notasie.', checkMode: 'auto', options: ['6,7 × 10⁴', '6,7 × 10³', '6,7 × 10⁵', '67 × 10³'], correctIndex: 0, explanation: 'Skuif die desimaal 4 plekke na links: 67 000 → 6,7\nAntwoord: 6,7 × 10⁴ ✓' },
        { difficulty: 'Medium', question: 'Skryf 5 000 000 000 in wetenskaplike notasie.', checkMode: 'auto', options: ['5 × 10⁸', '5 × 10⁹', '5 × 10¹⁰', '50 × 10⁸'], correctIndex: 1, explanation: 'Skuif die desimaal 9 plekke na links: 5 000 000 000 → 5\nAntwoord: 5 × 10⁹ ✓' },
        { difficulty: 'Hard', question: 'ʼn Selfoonvervaardiger vervaardig ongeveer 480 000 000 (4,8 × 10⁸) komponente per jaar, verpak in bokse van 160 000 (1,6 × 10⁵) komponente elk. Skryf albei hoeveelhede in wetenskaplike notasie, en bereken dan hoeveel bokse per jaar benodig word.', checkMode: 'auto', options: ['300', '30000', '3000', '4800'], correctIndex: 2, explanation: 'Deel: (4,8 × 10⁸) ÷ (1,6 × 10⁵)\n= (4,8 ÷ 1,6) × 10^(8−5)\n= 3,0 × 10³ = 3 000 bokse ✓' },
      ],
      scoreMessages: [
        { minScore: 20, message: 'Uitstekend! Jy het die wette van eksponente, wortels en wetenskaplike notasie op Graad 8-vlak bemeester.' },
        { minScore: 15, message: 'Goeie werk! Hersien enige gemiste vrae en probeer weer.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      name: 'Stel 3',
      questions: [
        { difficulty: 'Easy', question: 'Vereenvoudig 2⁶ × 2³, laat jou antwoord as ʼn mag van 2, en bereken dit dan.', checkMode: 'auto', options: ['512', '262144', '8', '18'], correctIndex: 0, explanation: 'Dieselfde grondtal — tel die eksponente bymekaar: 2⁶ × 2³ = 2^(6+3) = 2⁹ = 512 ✓' },
        { difficulty: 'Easy', question: 'Vereenvoudig 6⁷ ÷ 6⁵, laat jou antwoord as ʼn mag van 6, en bereken dit dan.', checkMode: 'auto', options: ['279936', '36', '1/36', '12'], correctIndex: 1, explanation: 'Dieselfde grondtal — trek die eksponente van mekaar af: 6⁷ ÷ 6⁵ = 6^(7−5) = 6² = 36 ✓' },
        ...
        { difficulty: 'Medium', question: 'Vereenvoudig 10⁸ ÷ 10⁵, laat jou antwoord as ʼn mag van 10, en bereken dit dan.', checkMode: 'auto', options: ['100000000', '1/1000', '1000', '30'], correctIndex: 2, explanation: 'Dieselfde grondtal — trek die eksponente van mekaar af: 10⁸ ÷ 10⁵ = 10^(8−5) = 10³ = 1 000 ✓' },
        { difficulty: 'Medium', question: 'Pas die mag-van-ʼn-mag-wet toe om (5³)² te vereenvoudig, en bereken dit dan.', checkMode: 'auto', options: ['3125', '25', '30', '15625'], correctIndex: 3, explanation: 'Mag van ʼn mag — vermenigvuldig die eksponente: (5³)² = 5^(3×2) = 5⁶ = 15 625 ✓' },
        { difficulty: 'Medium', question: 'Vereenvoudig (3²)⁴ deur die mag-van-ʼn-mag-wet te gebruik, en bereken dit dan.', checkMode: 'auto', options: ['6561', '729', '81', '24'], correctIndex: 0, explanation: 'Mag van ʼn mag — vermenigvuldig die eksponente: (3²)⁴ = 3^(2×4) = 3⁸ = 6 561 ✓' },
        { difficulty: 'Medium-Hard', question: 'Gebruik die mag-van-ʼn-produk-wet om (2 × 3)⁵ te vereenvoudig, en bereken dit dan op twee verskillende maniere om te kontroleer of jou antwoord ooreenstem.', checkMode: 'auto', options: ['96', '7776', '30', '3125'], correctIndex: 1, explanation: 'Metode 1: (2 × 3)⁵ = 6⁵ = 7 776. Metode 2 (mag van ʼn produk): 2⁵ × 3⁵ = 32 × 243 = 7 776. Albei metodes stem ooreen ✓' },
        { difficulty: 'Medium', question: 'Vereenvoudig en bereken: (3³ × 3²) ÷ 3⁴.', checkMode: 'auto', options: ['19683', '243', '3', '1/3'], correctIndex: 2, explanation: 'Stap 1: Produkwet in die teller: 3³ × 3² = 3^(3+2) = 3⁵.\nStap 2: Kwosiëntwet: 3⁵ ÷ 3⁴ = 3^(5−4) = 3¹ = 3 ✓' },
        { difficulty: 'Medium-Hard', question: 'Vereenvoudig (6⁴ × 6¹) ÷ 6³, en gee ʼn finale numeriese antwoord.', checkMode: 'auto', options: ['1679616', '7776', '1/36', '36'], correctIndex: 3, explanation: 'Stap 1: Produkwet: 6⁴ × 6¹ = 6^(4+1) = 6⁵.\nStap 2: Kwosiëntwet: 6⁵ ÷ 6³ = 6^(5−3) = 6² = 36 ✓' },
        ...
        { difficulty: 'Easy', question: 'Bereken (−9)².', checkMode: 'auto', options: ['81', '-81', '18', '9'], correctIndex: 0, explanation: '(−9)² = (−9) × (−9) = +81\nDie negatiewe teken is binne die hakies en word gekwadreer, wat ʼn positiewe resultaat gee ✓' },
        { difficulty: 'Easy', question: 'Bereken −9².', checkMode: 'auto', options: ['81', '-81', '-18', '18'], correctIndex: 1, explanation: '−9² beteken −(9²) = −(81) = −81\nDie eksponent geld slegs vir 9, nie vir die negatiewe teken nie ✓' },
        { difficulty: 'Medium', question: 'Bereken (−5)³ en −5³. Sibusiso sê hierdie moet verskillend wees omdat "(−a)ⁿ en −aⁿ nooit gelyk is nie." Wys die waardes en kommentaar op sy stelling.', checkMode: 'auto', options: ['125', '25', '-125', '-15'], correctIndex: 2, explanation: '(−5)³ = (−5)×(−5)×(−5) = −125. −5³ = −(5³) = −125. Sy stelling is vals in hierdie geval — vir onewe eksponente is (−a)ⁿ en −aⁿ altyd gelyk, want ʼn negatiewe getal tot ʼn onewe mag bly in albei gevalle negatief.' },
        ...
        { difficulty: 'Medium', question: 'Vind die kwadraatwortel van 36/121.', checkMode: 'auto', options: ['11/6', '6/121', '36/11', '6/11'], correctIndex: 3, explanation: 'Pas die wortel afsonderlik op die teller en noemer toe.\n√36 = 6 en √121 = 11\n√(36/121) = 6/11 ✓' },
        { difficulty: 'Medium', question: 'Vind die kubuswortel van 125/216.', checkMode: 'auto', options: ['5/6', '6/5', '5/216', '125/6'], correctIndex: 0, explanation: 'Pas die kubuswortel afsonderlik op die teller en noemer toe.\n∛125 = 5 en ∛216 = 6\n∛(125/216) = 5/6 ✓' },
        ...
        { difficulty: 'Easy', question: 'Skryf 890 000 in wetenskaplike notasie.', checkMode: 'auto', options: ['8,9 × 10⁴', '8,9 × 10⁵', '8,9 × 10⁶', '89 × 10⁴'], correctIndex: 1, explanation: 'Skuif die desimaal 5 plekke na links: 890 000 → 8,9\nAntwoord: 8,9 × 10⁵ ✓' },
        { difficulty: 'Medium', question: 'Skryf 72 000 000 in wetenskaplike notasie.', checkMode: 'auto', options: ['7,2 × 10⁶', '72 × 10⁶', '7,2 × 10⁷', '7,2 × 10⁸'], correctIndex: 2, explanation: 'Skuif die desimaal 7 plekke na links: 72 000 000 → 7,2\nAntwoord: 7,2 × 10⁷ ✓' },
        { difficulty: 'Hard', question: 'ʼn Nasionale datasentrum verwerk ongeveer 6 600 000 000 (6,6 × 10⁹) rekords per jaar, in bondels van 300 000 (3,0 × 10⁵) rekords elk. Skryf albei hoeveelhede in wetenskaplike notasie, en bereken dan hoeveel bondels per jaar verwerk word.', checkMode: 'auto', options: ['2200', '220000', '6600', '22000'], correctIndex: 3, explanation: 'Deel: (6,6 × 10⁹) ÷ (3,0 × 10⁵)\n= (6,6 ÷ 3,0) × 10^(9−5)\n= 2,2 × 10⁴ = 22 000 bondels ✓' },
      ],
      scoreMessages: [
        { minScore: 20, message: 'Uitstekend! Jy het die wette van eksponente, wortels en wetenskaplike notasie op Graad 8-vlak bemeester.' },
        { minScore: 15, message: 'Goeie werk! Hersien enige gemiste vrae en probeer weer.' },
