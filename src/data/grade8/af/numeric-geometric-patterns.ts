  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'Vind die volgende term in die patroon: 5, 12, 19, 26, 33, ?', checkMode: 'auto', options: ['39', '40', '47', '33'], correctIndex: 1, explanation: 'Die konstante verskil is 7 (12−5=7, 19−12=7, 26−19=7, 33−26=7). Volgende term: 33 + 7 = 40 ✓' },
        { difficulty: 'Easy', question: 'ʼn Spaarrekening begin met R2 400 en groei met R150 elke maand: R2 400, R2 550, R2 700, R2 850. Hoeveel sal in die rekening wees die volgende maand?', checkMode: 'auto', options: ['R2 950', 'R2 850', 'R3 050', 'R3 000'], correctIndex: 3, explanation: 'Die reël is voeg R150 by elke keer. R2 850 + R150 = R3 000 ✓' },
        { difficulty: 'Easy-Medium', question: 'Vind die ontbrekende term: 8, ?, 26, 35.', checkMode: 'auto', options: ['17', '18', '20', '16'], correctIndex: 0, explanation: 'Die bekende verskil is 35 − 26 = 9, so die reël is voeg 9 by elke keer. 8 + 9 = 17. Kontroleer: 26 − 17 = 9 ✓' },
        { difficulty: 'Medium', question: 'ʼn Patroon volg die reël "vermenigvuldig die term met 2, voeg dan 3 by", beginnend by 4: 4, 11, 25, 53. Wat is die volgende term?', checkMode: 'auto', options: ['106', '112', '109', '103'], correctIndex: 2, explanation: 'Pas die reël toe op 53: 53 × 2 = 106, dan 106 + 3 = 109 ✓' },
        ...
        { difficulty: 'Medium', question: 'Vind die nde-term-reël vir die patroon 5, 13, 21, 29.', checkMode: 'auto', options: ['8n', '8n-3', '8n+3', '7n-2'], correctIndex: 1, explanation: 'Konstante verskil = 8. Vervang n=1: 8(1)+c=5 → c=−3. Reël: nde term = 8n − 3. Kontroleer: 8(2)−3=13 ✓, 8(3)−3=21 ✓, 8(4)−3=29 ✓' },
        ...
        { difficulty: 'Hard', question: 'Gebruik die selfoonkontrak-reël koste = 20 × maande + 100, na hoeveel volle maande sal die totale koste eerste ten minste R400 bereik?', checkMode: 'auto', options: ['15', '14', '16', '20'], correctIndex: 0, explanation: 'Stel op: 20 × maande + 100 ≥ 400, so 20 × maande ≥ 300, wat maande ≥ 15 gee. Kontroleer: 14 maande gee 20(14)+100 = 380 (te min). 15 maande gee 20(15)+100 = 400 ✓. 15 maande is die eerste om ten minste R400 te bereik.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // ── Blok 1: Numeriese reekse (volgende/ontbrekende term) ─────────────
        { difficulty: 'Easy', question: 'Vind die volgende term in die patroon: 7, 15, 23, 31, 39, ?', checkMode: 'auto', options: ['46', '55', '47', '39'], correctIndex: 2, explanation: 'Die konstante verskil is 8 (15−7=8, 23−15=8, 31−23=8, 39−31=8). Volgende term: 39 + 8 = 47 ✓' },
        { difficulty: 'Easy', question: 'ʼn Spaarrekening begin met R1 800 en groei met R200 elke maand: R1 800, R2 000, R2 200, R2 400. Hoeveel sal in die rekening wees die volgende maand?', checkMode: 'auto', options: ['R2 600', 'R2 500', 'R2 400', 'R2 800'], correctIndex: 0, explanation: 'Die reël is voeg R200 by elke keer. R2 400 + R200 = R2 600 ✓' },
        { difficulty: 'Easy-Medium', question: 'Vind die ontbrekende term: 10, ?, 32, 43.', checkMode: 'auto', options: ['22', '19', '25', '21'], correctIndex: 3, explanation: 'Die bekende verskil is 43 − 32 = 11, so die reël is voeg 11 by elke keer. 10 + 11 = 21. Kontroleer: 32 − 21 = 11 ✓' },
        { difficulty: 'Medium', question: 'ʼn Patroon volg die reël "vermenigvuldig die term met 2, voeg dan 1 by", beginnend by 3: 3, 7, 15, 31. Wat is die volgende term?', checkMode: 'auto', options: ['62', '63', '64', '61'], correctIndex: 1, explanation: 'Pas die reël toe op 31: 31 × 2 = 62, dan 62 + 1 = 63 ✓' },
        ...
        { difficulty: 'Medium', question: 'Vind die nde-term-reël vir die patroon 6, 17, 28, 39.', checkMode: 'auto', options: ['11n+5', '11n', '11n-5', '6n+11'], correctIndex: 2, explanation: 'Konstante verskil = 11. Vervang n=1: 11(1)+c=6 → c=−5. Reël: nde term = 11n − 5. Kontroleer: 11(2)−5=17 ✓, 11(3)−5=28 ✓, 11(4)−5=39 ✓' },
        ...
        // ── Blok 4: Geometriese/groeiende patrone [DIAGRAM-GEMERK] ───────────
        { difficulty: 'Medium', question: 'ʼn Patroon van vierkante word met vuurhoutjies gebou, soos gewys, met elke nuwe vierkant aan die vorige een verbind en ʼn sy gedeel. Patroon 1 is ʼn enkele vierkant gemaak van 4 vuurhoutjies. Patroon 2 het twee vierkante in ʼn ry verbind, wat een vuurhoutjie deel, en gebruik altesaam 7 vuurhoutjies. Patroon 3 het drie vierkante in ʼn ry verbind, en gebruik altesaam 10 vuurhoutjies. Hoeveel vuurhoutjies word benodig vir Patroon 13?', checkMode: 'auto', options: ['40', '39', '43', '37'], correctIndex: 0, explanation: 'Die patroon neem met 3 vuurhoutjies toe elke keer: 4, 7, 10 (verskille van 3). Reël: vuurhoutjies = 3n + 1. Kontroleer: 3(1)+1=4 ✓, 3(2)+1=7 ✓, 3(3)+1=10 ✓. Patroon 13: 3(13)+1 = 39+1 = 40 vuurhoutjies ✓', diagramSvg: '<svg viewBox="-16 0 252 170" xmlns="http://www.w3.org/2000/svg"><g><line x1="18" y1="60" x2="38" y2="60" stroke="#0f1f3d" stroke-width="2.5"/><line x1="18" y1="78" x2="38" y2="78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="18" y1="60" x2="18" y2="78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="38" y1="60" x2="38" y2="78" stroke="#0f1f3d" stroke-width="2.5"/></g><text x="28" y="100" text-anchor="middle" fill="#374151" font-size="12" font-weight="600">Patroon 1</text><text x="28" y="115" text-anchor="middle" fill="#374151" font-size="11">4 vuurhoutjies</text><g><line x1="85" y1="60" x2="103" y2="60" stroke="#0f1f3d" stroke-width="2.5"/><line x1="103" y1="60" x2="121" y2="60" stroke="#0f1f3d" stroke-width="2.5"/><line x1="85" y1="78" x2="103" y2="78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="103" y1="78" x2="121" y2="78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="85" y1="60" x2="85" y2="78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="103" y1="60" x2="103" y2="78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="121" y1="60" x2="121" y2="78" stroke="#0f1f3d" stroke-width="2.5"/></g><text x="103" y="100" text-anchor="middle" fill="#374151" font-size="12" font-weight="600">Patroon 2</text><text x="103" y="115" text-anchor="middle" fill="#374151" font-size="11">7 vuurhoutjies</text><g><line x1="160" y1="60" x2="178" y2="60" stroke="#0f1f3d" stroke-width="2.5"/><line x1="178" y1="60" x2="196" y2="60" stroke="#0f1f3d" stroke-width="2.5"/><line x1="196" y1="60" x2="214" y2="60" stroke="#0f1f3d" stroke-width="2.5"/><line x1="160" y1="78" x2="178" y2="78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="178" y1="78" x2="196" y2="78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="196" y1="78" x2="214" y2="78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="160" y1="60" x2="160" y2="78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="178" y1="60" x2="178" y2="78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="196" y1="60" x2="196" y2="78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="214" y1="60" x2="214" y2="78" stroke="#0f1f3d" stroke-width="2.5"/></g><text x="187" y="100" text-anchor="middle" fill="#374151" font-size="12" font-weight="600">Patroon 3</text><text x="187" y="115" text-anchor="middle" fill="#374151" font-size="11">10 vuurhoutjies</text></svg>' },
        ...
        { difficulty: 'Hard', question: 'Gebruik die internetkontrak-reël koste = 25 × maande + 150, na hoeveel volle maande sal die totale koste eerste ten minste R550 bereik?', checkMode: 'auto', options: ['15', '17', '22', '16'], correctIndex: 3, explanation: 'Stel op: 25 × maande + 150 ≥ 550, so 25 × maande ≥ 400, wat maande ≥ 16 gee. Kontroleer: 15 maande gee 25(15)+150 = 525 (te min). 16 maande gee 25(16)+150 = 550 ✓. 16 maande is die eerste om ten minste R550 te bereik.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // ── Blok 1: Numeriese reekse (volgende/ontbrekende term) ─────────────
        { difficulty: 'Easy', question: 'Vind die volgende term in die patroon: 9, 16, 23, 30, 37, ?', checkMode: 'auto', options: ['44', '43', '51', '37'], correctIndex: 0, explanation: 'Die konstante verskil is 7 (16−9=7, 23−16=7, 30−23=7, 37−30=7). Volgende term: 37 + 7 = 44 ✓' },
        { difficulty: 'Easy', question: 'ʼn Skuld begin by R3 200 en verminder met R250 elke maand: R3 200, R2 950, R2 700, R2 450. Hoeveel sal geskuld word die volgende maand?', checkMode: 'auto', options: ['R2 300', 'R2 450', 'R2 200', 'R2 150'], correctIndex: 2, explanation: 'Die reël is trek R250 af elke keer. R2 450 − R250 = R2 200 ✓' },
        { difficulty: 'Easy-Medium', question: 'Vind die ontbrekende term: 12, ?, 34, 45.', checkMode: 'auto', options: ['24', '23', '21', '27'], correctIndex: 1, explanation: 'Die bekende verskil is 45 − 34 = 11, so die reël is voeg 11 by elke keer. 12 + 11 = 23. Kontroleer: 34 − 23 = 11 ✓' },
        { difficulty: 'Medium', question: 'ʼn Patroon volg die reël "vermenigvuldig die term met 3, trek dan 2 af", beginnend by 2: 2, 4, 10, 28. Wat is die volgende term?', checkMode: 'auto', options: ['84', '78', '80', '82'], correctIndex: 3, explanation: 'Pas die reël toe op 28: 28 × 3 = 84, dan 84 − 2 = 82 ✓' },
        ...
        { difficulty: 'Medium', question: 'Vind die nde-term-reël vir die patroon 4, 15, 26, 37.', checkMode: 'auto', options: ['11n-7', '11n+7', '11n', '4n+11'], correctIndex: 0, explanation: 'Konstante verskil = 11. Vervang n=1: 11(1)+c=4 → c=−7. Reël: nde term = 11n − 7. Kontroleer: 11(2)−7=15 ✓, 11(3)−7=26 ✓, 11(4)−7=37 ✓' },
        ...
        // ── Blok 4: Geometriese/groeiende patrone [DIAGRAM-GEMERK] ───────────
        { difficulty: 'Medium', question: 'ʼn Patroon van vierkante word met vuurhoutjies gebou, soos gewys, met elke nuwe vierkant aan die vorige een verbind en ʼn sy gedeel. Patroon 1 is ʼn enkele vierkant gemaak van 4 vuurhoutjies. Patroon 2 het twee vierkante in ʼn ry verbind, wat een vuurhoutjie deel, en gebruik altesaam 7 vuurhoutjies. Patroon 3 het drie vierkante in ʼn ry verbind, en gebruik altesaam 10 vuurhoutjies. Hoeveel vuurhoutjies word benodig vir Patroon 7?', checkMode: 'auto', options: ['21', '25', '22', '19'], correctIndex: 2, explanation: 'Die patroon neem met 3 vuurhoutjies toe elke keer: 4, 7, 10 (verskille van 3). Reël: vuurhoutjies = 3n + 1. Kontroleer: 3(1)+1=4 ✓, 3(2)+1=7 ✓, 3(3)+1=10 ✓. Patroon 7: 3(7)+1 = 21+1 = 22 vuurhoutjies ✓', diagramSvg: '<svg viewBox="-16 0 252 170" xmlns="http://www.w3.org/2000/svg"><g><line x1="18" y1="60" x2="38" y2="60" stroke="#0f1f3d" stroke-width="2.5"/><line x1="18" y1="78" x2="38" y2="78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="18" y1="60" x2="18" y2="78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="38" y1="60" x2="38" y2="78" stroke="#0f1f3d" stroke-width="2.5"/></g><text x="28" y="100" text-anchor="middle" fill="#374151" font-size="12" font-weight="600">Patroon 1</text><text x="28" y="115" text-anchor="middle" fill="#374151" font-size="11">4 vuurhoutjies</text><g><line x1="85" y1="60" x2="103" y2="60" stroke="#0f1f3d" stroke-width="2.5"/><line x1="103" y1="60" x2="121" y2="60" stroke="#0f1f3d" stroke-width="2.5"/><line x1="85" y1="78" x2="103" y2="78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="103" y1="78" x2="121" y2="78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="85" y1="60" x2="85" y2="78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="103" y1="60" x2="103" y2="78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="121" y1="60" x2="121" y2="78" stroke="#0f1f3d" stroke-width="2.5"/></g><text x="103" y="100" text-anchor="middle" fill="#374151" font-size="12" font-weight="600">Patroon 2</text><text x="103" y="115" text-anchor="middle" fill="#374151" font-size="11">7 vuurhoutjies</text><g><line x1="160" y1="60" x2="178" y2="60" stroke="#0f1f3d" stroke-width="2.5"/><line x1="178" y1="60" x2="196" y2="60" stroke="#0f1f3d" stroke-width="2.5"/><line x1="196" y1="60" x2="214" y2="60" stroke="#0f1f3d" stroke-width="2.5"/><line x1="160" y1="78" x2="178" y2="78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="178" y1="78" x2="196" y2="78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="196" y1="78" x2="214" y2="78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="160" y1="60" x2="160" y2="78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="178" y1="60" x2="178" y2="78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="196" y1="60" x2="196" y2="78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="214" y1="60" x2="214" y2="78" stroke="#0f1f3d" stroke-width="2.5"/></g><text x="187" y="100" text-anchor="middle" fill="#374151" font-size="12" font-weight="600">Patroon 3</text><text x="187" y="115" text-anchor="middle" fill="#374151" font-size="11">10 vuurhoutjies</text></svg>' },
        ...
        { difficulty: 'Hard', question: 'Gebruik die stroomdiens-reël koste = 15 × maande + 200, na hoeveel volle maande sal die totale koste eerste ten minste R470 bereik?', checkMode: 'auto', options: ['17', '18', '19', '20'], correctIndex: 1, explanation: 'Stel op: 15 × maande + 200 ≥ 470, so 15 × maande ≥ 270, wat maande ≥ 18 gee. Kontroleer: 17 maande gee 15(17)+200 = 455 (te min). 18 maande gee 15(18)+200 = 470 ✓. 18 maande is die eerste om ten minste R470 te bereik.' },
