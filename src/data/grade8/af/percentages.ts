  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'ʼn Tablet se prys styg met 15% na R552. Bereken die oorspronklike prys.', checkMode: 'auto', options: ['R480', 'R469', 'R635', 'R649'], correctIndex: 0, explanation: 'Nuwe prys = 115% van oorspronklike.\nOorspronklike = 552 ÷ 1,15 = R480.\nToets: 480 × 1,15 = 552 ✓' },
        { difficulty: 'Medium', question: 'Na ʼn korting van 10% kos ʼn baadjie R522. Bereken die oorspronklike prys van die baadjie.', checkMode: 'auto', options: ['R574', 'R580', 'R470', 'R475'], correctIndex: 1, explanation: 'Nuwe prys = 90% van oorspronklike.\nOorspronklike = 522 ÷ 0,9 = R580.\nToets: 580 × 0,9 = 522 ✓' },
        { difficulty: 'Medium', question: 'ʼn Klub se ledetal het met 20% na 840 lede toegeneem hierdie jaar. Bereken verlede jaar se ledetal.', checkMode: 'auto', options: ['672', '1 008', '700', '1 050'], correctIndex: 2, explanation: 'Nuwe totaal = 120% van oorspronklike.\nOorspronklike = 840 ÷ 1,2 = 700 lede.\nToets: 700 × 1,2 = 840 ✓' },

        // Blok 2 — Die nuwe bedrag direk bereken (3-6)
        { difficulty: 'Easy', question: 'Zanele se salaris van R6 500 styg met 9%. Gebruik die eenstap-vermenigvuldiger om haar nuwe salaris te bereken.', checkMode: 'auto', options: ['R5 915', 'R7 020', 'R7 670', 'R7 085'], correctIndex: 3, explanation: 'Vermenigvuldiger vir ʼn toename van 9% = 1,09.\nNuwe salaris = 6 500 × 1,09 = R7 085 ✓' },
        { difficulty: 'Medium', question: 'ʼn Kragopwekker met ʼn prys van R3 400 word met 18% afgeslaan. Bereken die verkoopprys deur ʼn enkele vermenigvuldiger te gebruik.', checkMode: 'auto', options: ['R2 788', 'R4 012', 'R2 822', 'R2 176'], correctIndex: 0, explanation: 'Vermenigvuldiger vir ʼn afname van 18% = 0,82.\nVerkoopprys = 3 400 × 0,82 = R2 788 ✓' },
        { difficulty: 'Medium', question: 'ʼn Wildreservaat het 12 500 diere gehad. Oor drie jaar het versigtige bewaring die bevolking met 24% laat toeneem. Bereken die nuwe bevolking.', checkMode: 'auto', options: ['9 500', '15 500', '15 375', '18 500'], correctIndex: 1, explanation: 'Vermenigvuldiger vir ʼn toename van 24% = 1,24.\nNuwe bevolking = 12 500 × 1,24 = 15 500 diere ✓' },
        ...
        { difficulty: 'Easy', question: 'ʼn Leerder se speltoetspunt het van 65 na 78 gestyg (albei uit 100). Bereken die persentasietoename relatief tot die oorspronklike punt.', checkMode: 'auto', options: ['17%', '18%', '20%', '25%'], correctIndex: 2, explanation: 'Toename = 78 − 65 = 13.\nPersentasietoename = 13 ÷ 65 × 100 = 20% ✓' },
        { difficulty: 'Medium', question: 'ʼn Winkel se weeklikse verkope het van R450 000 na R360 000 gedaal. Bereken die persentasieafname.', checkMode: 'auto', options: ['25%', '22%', '15%', '20%'], correctIndex: 3, explanation: 'Afname = 450 000 − 360 000 = 90 000.\nPersentasieafname = 90 000 ÷ 450 000 × 100 = 20% ✓' },
        { difficulty: 'Medium', question: 'ʼn Watertenk het 120 liter bevat en bevat nou 150 liter na reën. Bereken die persentasietoename in die hoeveelheid water.', checkMode: 'auto', options: ['25%', '20%', '23%', '30%'], correctIndex: 0, explanation: 'Toename = 150 − 120 = 30.\nPersentasietoename = 30 ÷ 120 × 100 = 25% ✓' },

        // Blok 4 — Korting/opslag/BTW woordprobleme, Rand-kontekste (10-13)
        { difficulty: 'Medium', question: 'ʼn Wasmasjien het ʼn prys van R780 voor BTW. Bereken die totale prys sodra 15% BTW bygevoeg word.', checkMode: 'auto', options: ['R663', 'R897', 'R889', 'R1 014'], correctIndex: 1, explanation: 'BTW = 15% van R780: 0,15 × 780 = R117.\nTotaal = 780 + 117 = R897 ✓' },
        { difficulty: 'Medium', question: 'ʼn Groothandelaar koop kissies eiers vir R250 elk en verhoog die prys met 50% opslag om aan ʼn supermark te verkoop. Bereken die verkoopprys per kissie.', checkMode: 'auto', options: ['R125', 'R350', 'R375', 'R500'], correctIndex: 2, explanation: 'Opslag = 50% van R250: 0,50 × 250 = R125.\nVerkoopprys = 250 + 125 = R375 ✓' },
        ...
        { difficulty: 'Hard', question: 'ʼn Restaurant-kateraar vra R620 vir ʼn funksie voordat ʼn diensfooi van 15% bygevoeg word. Bereken die totale bedrag wat die kliënt betaal.', checkMode: 'auto', options: ['R527', 'R707', 'R806', 'R713'], correctIndex: 3, explanation: 'Diensfooi = 15% van R620: 0,15 × 620 = R93.\nTotaal = 620 + 93 = R713 ✓' },

        // Blok 5 — Multi-stap opeenvolgende persentasieveranderingskettings (14-16)
        { difficulty: 'Hard', question: 'ʼn Stuk grond met ʼn waarde van R5 000 se waarde styg met 20%, en die volgende jaar daal die nuwe waarde met 10%. Bereken die waarde na albei veranderings.', checkMode: 'auto', options: ['R5 400', 'R5 500', 'R6 600', 'R6 000'], correctIndex: 0, explanation: 'Na die toename van 20%: 5 000 × 1,20 = R6 000.\nNa die afname van 10% op die nuwe waarde: 6 000 × 0,90 = R5 400 ✓' },
        { difficulty: 'Hard', question: 'ʼn Tweedehandse motor met ʼn prys van R2 000 word met 30% afgeslaan vir ʼn vinnige verkoop, en dan verhoog die handelaar die afgeslane prys die volgende maand met 20%. Bereken die finale prys.', checkMode: 'auto', options: ['R1 800', 'R1 680', 'R1 120', 'R1 400'], correctIndex: 1, explanation: 'Na die afname van 30%: 2 000 × 0,70 = R1 400.\nNa die toename van 20% op die nuwe prys: 1 400 × 1,20 = R1 680 ✓' },
        { difficulty: 'Hard', question: 'ʼn Belegging van R4 000 groei met 10% in die eerste jaar, en dan groei die nuwe balans met ʼn verdere 10% in die tweede jaar. Bereken die finale balans.', checkMode: 'auto', options: ['R4 800', 'R4 400', 'R4 840', 'R4 040'], correctIndex: 2, explanation: 'Na jaar 1: 4 000 × 1,10 = R4 400.\nNa jaar 2 (10% van die nuwe balans): 4 400 × 1,10 = R4 840 ✓' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // Blok 1 — Die oorspronklike bedrag vind (0-2)
        { difficulty: 'Easy', question: 'ʼn Paar tekkies se prys styg met 25% na R875. Bereken die oorspronklike prys.', checkMode: 'auto', options: ['R656', 'R1 094', 'R1 167', 'R700'], correctIndex: 3, explanation: 'Nuwe prys = 125% van oorspronklike.\nOorspronklike = 875 ÷ 1,25 = R700.\nToets: 700 × 1,25 = 875 ✓' },
        { difficulty: 'Medium', question: 'Na ʼn korting van 15% kos ʼn verwarmer R578. Bereken die oorspronklike prys van die verwarmer.', checkMode: 'auto', options: ['R680', 'R665', 'R491', 'R503'], correctIndex: 0, explanation: 'Nuwe prys = 85% van oorspronklike.\nOorspronklike = 578 ÷ 0,85 = R680.\nToets: 680 × 0,85 = 578 ✓' },
        { difficulty: 'Medium', question: 'ʼn Koor se ledetal het met 12% na 896 sangers toegeneem hierdie jaar. Bereken verlede jaar se ledetal.', checkMode: 'auto', options: ['788', '800', '1 004', '1 018'], correctIndex: 1, explanation: 'Nuwe totaal = 112% van oorspronklike.\nOorspronklike = 896 ÷ 1,12 = 800 sangers.\nToets: 800 × 1,12 = 896 ✓' },

        // Blok 2 — Die nuwe bedrag direk bereken (3-6)
        { difficulty: 'Easy', question: 'Bongani se salaris van R7 200 styg met 7%. Gebruik die eenstap-vermenigvuldiger om sy nuwe salaris te bereken.', checkMode: 'auto', options: ['R6 696', 'R7 632', 'R7 704', 'R8 208'], correctIndex: 2, explanation: 'Vermenigvuldiger vir ʼn toename van 7% = 1,07.\nNuwe salaris = 7 200 × 1,07 = R7 704 ✓' },
        { difficulty: 'Medium', question: 'ʼn Dronevliegtuig met ʼn prys van R2 600 word met 35% afgeslaan. Bereken die verkoopprys deur ʼn enkele vermenigvuldiger te gebruik.', checkMode: 'auto', options: ['R3 510', 'R1 716', 'R780', 'R1 690'], correctIndex: 3, explanation: 'Vermenigvuldiger vir ʼn afname van 35% = 0,65.\nVerkoopprys = 2 600 × 0,65 = R1 690 ✓' },
        { difficulty: 'Medium', question: 'ʼn Natuurreservaat het 9 800 bome gehad. Oor vyf jaar het ʼn plantprogram die aantal bome met 15% laat toeneem. Bereken die nuwe aantal bome.', checkMode: 'auto', options: ['11 270', '8 330', '11 172', '12 740'], correctIndex: 0, explanation: 'Vermenigvuldiger vir ʼn toename van 15% = 1,15.\nNuwe totaal = 9 800 × 1,15 = 11 270 bome ✓' },
        ...
        // Blok 3 — ʼn Verandering as ʼn persentasie uitdruk (7-9)
        { difficulty: 'Easy', question: 'ʼn Leerder se wiskundepunt het van 80 na 92 gestyg (albei uit 100). Bereken die persentasietoename relatief tot die oorspronklike punt.', checkMode: 'auto', options: ['13%', '15%', '16%', '20%'], correctIndex: 1, explanation: 'Toename = 92 − 80 = 12.\nPersentasietoename = 12 ÷ 80 × 100 = 15% ✓' },
        { difficulty: 'Medium', question: 'ʼn Fabriek se maandelikse produksie het van 560 eenhede na 420 eenhede gedaal. Bereken die persentasieafname.', checkMode: 'auto', options: ['33%', '23%', '25%', '30%'], correctIndex: 2, explanation: 'Afname = 560 − 420 = 140.\nPersentasieafname = 140 ÷ 560 × 100 = 25% ✓' },
        { difficulty: 'Medium', question: 'ʼn Gemeenskapsgroentetuin het verlede seisoen 150 kg produkte gelewer en hierdie seisoen 198 kg. Bereken die persentasietoename in produkte.', checkMode: 'auto', options: ['24%', '33%', '40%', '32%'], correctIndex: 3, explanation: 'Toename = 198 − 150 = 48.\nPersentasietoename = 48 ÷ 150 × 100 = 32% ✓' },

        // Blok 4 — Korting/opslag/BTW woordprobleme, Rand-kontekste (10-13)
        { difficulty: 'Medium', question: 'ʼn Yskas het ʼn prys van R640 voor BTW. Bereken die totale prys sodra 15% BTW bygevoeg word.', checkMode: 'auto', options: ['R736', 'R544', 'R730', 'R832'], correctIndex: 0, explanation: 'BTW = 15% van R640: 0,15 × 640 = R96.\nTotaal = 640 + 96 = R736 ✓' },
        { difficulty: 'Medium', question: 'ʼn Groothandelaar koop bokse teëls vir R400 elk en verhoog die prys met 35% opslag om aan ʼn hardewarewinkel te verkoop. Bereken die verkoopprys per boks.', checkMode: 'auto', options: ['R260', 'R540', 'R500', 'R680'], correctIndex: 1, explanation: 'Opslag = 35% van R400: 0,35 × 400 = R140.\nVerkoopprys = 400 + 140 = R540 ✓' },
        ...
        { difficulty: 'Hard', question: 'ʼn Gebeurtenismaatskappy vra R950 vir ʼn bespreking voordat ʼn diensfooi van 12% bygevoeg word. Bereken die totale bedrag wat die kliënt betaal.', checkMode: 'auto', options: ['R836', 'R1 055', 'R1 064', 'R1 178'], correctIndex: 2, explanation: 'Diensfooi = 12% van R950: 0,12 × 950 = R114.\nTotaal = 950 + 114 = R1 064 ✓' },

        // Blok 5 — Multi-stap opeenvolgende persentasieveranderingskettings (14-16)
        { difficulty: 'Hard', question: 'ʼn Aandeel met ʼn prys van R3 000 se waarde styg met 30%, en die volgende maand daal die nuwe waarde met 20%. Bereken die waarde na albei veranderings.', checkMode: 'auto', options: ['R3 300', 'R4 680', 'R3 900', 'R3 120'], correctIndex: 3, explanation: 'Na die toename van 30%: 3 000 × 1,30 = R3 900.\nNa die afname van 20% op die nuwe waarde: 3 900 × 0,80 = R3 120 ✓' },
        { difficulty: 'Hard', question: 'ʼn Motorfiets met ʼn prys van R1 600 word met 25% afgeslaan vir ʼn vinnige verkoop, en dan verhoog die handelaar die afgeslane prys die volgende maand met 40%. Bereken die finale prys.', checkMode: 'auto', options: ['R1 680', 'R1 840', 'R720', 'R1 200'], correctIndex: 0, explanation: 'Na die afname van 25%: 1 600 × 0,75 = R1 200.\nNa die toename van 40% op die nuwe prys: 1 200 × 1,40 = R1 680 ✓' },
        { difficulty: 'Hard', question: 'ʼn Spaarbalans van R5 000 daal met 20% in ʼn moeilike maand, en dan daal die nuwe balans met ʼn verdere 20% die volgende maand. Bereken die finale balans.', checkMode: 'auto', options: ['R3 000', 'R3 200', 'R4 000', 'R4 800'], correctIndex: 1, explanation: 'Na maand 1: 5 000 × 0,80 = R4 000.\nNa maand 2 (20% van die nuwe balans): 4 000 × 0,80 = R3 200 ✓' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // Blok 1 — Die oorspronklike bedrag vind (0-2)
        { difficulty: 'Easy', question: 'ʼn Mikrogolfoond se prys styg met 18% na R1 180. Bereken die oorspronklike prys.', checkMode: 'auto', options: ['R968', 'R1 392', 'R1 000', 'R1 439'], correctIndex: 2, explanation: 'Nuwe prys = 118% van oorspronklike.\nOorspronklike = 1 180 ÷ 1,18 = R1 000.\nToets: 1 000 × 1,18 = 1 180 ✓' },
        { difficulty: 'Medium', question: 'Na ʼn korting van 40% kos ʼn jas R450. Bereken die oorspronklike prys van die jas.', checkMode: 'auto', options: ['R630', 'R270', 'R321', 'R750'], correctIndex: 3, explanation: 'Nuwe prys = 60% van oorspronklike.\nOorspronklike = 450 ÷ 0,6 = R750.\nToets: 750 × 0,6 = 450 ✓' },
        { difficulty: 'Medium', question: 'ʼn Sokkerklub se aanhangerbasis het met 35% na 945 lede toegeneem hierdie jaar. Bereken verlede jaar se aanhangerbasis.', checkMode: 'auto', options: ['700', '614', '1 276', '1 454'], correctIndex: 0, explanation: 'Nuwe totaal = 135% van oorspronklike.\nOorspronklike = 945 ÷ 1,35 = 700 lede.\nToets: 700 × 1,35 = 945 ✓' },

        // Blok 2 — Die nuwe bedrag direk bereken (3-6)
        { difficulty: 'Easy', question: 'Nomsa se salaris van R8 400 styg met 11%. Gebruik die eenstap-vermenigvuldiger om haar nuwe salaris te bereken.', checkMode: 'auto', options: ['R7 476', 'R9 324', 'R9 240', 'R10 248'], correctIndex: 1, explanation: 'Vermenigvuldiger vir ʼn toename van 11% = 1,11.\nNuwe salaris = 8 400 × 1,11 = R9 324 ✓' },
        { difficulty: 'Medium', question: 'ʼn Wasmasjien met ʼn prys van R5 600 word met 22% afgeslaan. Bereken die verkoopprys deur ʼn enkele vermenigvuldiger te gebruik.', checkMode: 'auto', options: ['R6 832', 'R4 424', 'R4 368', 'R3 136'], correctIndex: 2, explanation: 'Vermenigvuldiger vir ʼn afname van 22% = 0,78.\nVerkoopprys = 5 600 × 0,78 = R4 368 ✓' },
        { difficulty: 'Medium', question: 'ʼn Wildernisreservaat het 7 500 hektaar beskermde grond gehad. Oor vier jaar het nuwe skenkings die beskermde area met 32% laat toeneem. Bereken die nuwe area.', checkMode: 'auto', options: ['5 100', '9 825', '12 300', '9 900'], correctIndex: 3, explanation: 'Vermenigvuldiger vir ʼn toename van 32% = 1,32.\nNuwe area = 7 500 × 1,32 = 9 900 hektaar ✓' },
        ...
        // Blok 3 — ʼn Verandering as ʼn persentasie uitdruk (7-9)
        { difficulty: 'Easy', question: 'ʼn Leerder se natuurwetenskappunt het van 40 na 54 gestyg (albei uit 100). Bereken die persentasietoename relatief tot die oorspronklike punt.', checkMode: 'auto', options: ['35%', '26%', '38%', '30%'], correctIndex: 0, explanation: 'Toename = 54 − 40 = 14.\nPersentasietoename = 14 ÷ 40 × 100 = 35% ✓' },
        { difficulty: 'Medium', question: 'ʼn Winkel se daaglikse kliëntetal het van 720 klante na 540 klante gedaal. Bereken die persentasieafname.', checkMode: 'auto', options: ['33%', '25%', '24%', '20%'], correctIndex: 1, explanation: 'Afname = 720 − 540 = 180.\nPersentasieafname = 180 ÷ 720 × 100 = 25% ✓' },
        { difficulty: 'Medium', question: 'ʼn Dam het 250 miljoen liter water bevat en bevat nou 300 miljoen liter na swaar reën. Bereken die persentasietoename in gestoorde water.', checkMode: 'auto', options: ['17%', '24%', '20%', '25%'], correctIndex: 2, explanation: 'Toename = 300 − 250 = 50.\nPersentasietoename = 50 ÷ 250 × 100 = 20% ✓' },

        // Blok 4 — Korting/opslag/BTW woordprobleme, Rand-kontekste (10-13)
        { difficulty: 'Medium', question: 'ʼn Skootrekenaar het ʼn prys van R860 voor BTW. Bereken die totale prys sodra 15% BTW bygevoeg word.', checkMode: 'auto', options: ['R731', 'R980', 'R1 118', 'R989'], correctIndex: 3, explanation: 'BTW = 15% van R860: 0,15 × 860 = R129.\nTotaal = 860 + 129 = R989 ✓' },
        { difficulty: 'Medium', question: 'ʼn Groothandelaar koop stelle gereedskap vir R480 elk en verhoog die prys met 25% opslag om aan ʼn hardewarewinkel te verkoop. Bereken die verkoopprys per stel.', checkMode: 'auto', options: ['R600', 'R360', 'R576', 'R720'], correctIndex: 0, explanation: 'Opslag = 25% van R480: 0,25 × 480 = R120.\nVerkoopprys = 480 + 120 = R600 ✓' },
        ...
        { difficulty: 'Hard', question: 'ʼn Fotografiestudio vra R750 vir ʼn skoot voordat ʼn diensfooi van 18% bygevoeg word. Bereken die totale bedrag wat die kliënt betaal.', checkMode: 'auto', options: ['R615', 'R885', 'R878', 'R1 020'], correctIndex: 1, explanation: 'Diensfooi = 18% van R750: 0,18 × 750 = R135.\nTotaal = 750 + 135 = R885 ✓' },

        // Blok 5 — Multi-stap opeenvolgende persentasieveranderingskettings (14-16)
        { difficulty: 'Hard', question: 'ʼn Werkswinkel met ʼn waarde van R4 000 se waarde styg met 15%, en die volgende jaar daal die nuwe waarde met 15%. Bereken die waarde na albei veranderings.', checkMode: 'auto', options: ['R4 000', 'R5 290', 'R3 910', 'R4 600'], correctIndex: 2, explanation: 'Na die toename van 15%: 4 000 × 1,15 = R4 600.\nNa die afname van 15% op die nuwe waarde: 4 600 × 0,85 = R3 910 ✓' },
        { difficulty: 'Hard', question: 'ʼn Sleepwa met ʼn prys van R3 000 word met 10% afgeslaan vir ʼn vinnige verkoop, en dan verhoog die handelaar die afgeslane prys die volgende maand met 30%. Bereken die finale prys.', checkMode: 'auto', options: ['R3 600', 'R1 890', 'R2 700', 'R3 510'], correctIndex: 3, explanation: 'Na die afname van 10%: 3 000 × 0,90 = R2 700.\nNa die toename van 30% op die nuwe prys: 2 700 × 1,30 = R3 510 ✓' },
        { difficulty: 'Hard', question: 'ʼn Belegging van R1 600 groei met 25% in die eerste jaar, en dan groei die nuwe balans met ʼn verdere 25% in die tweede jaar. Bereken die finale balans.', checkMode: 'auto', options: ['R2 500', 'R2 400', 'R2 000', 'R1 700'], correctIndex: 0, explanation: 'Na jaar 1: 1 600 × 1,25 = R2 000.\nNa jaar 2 (25% van die nuwe balans): 2 000 × 1,25 = R2 500 ✓' },
