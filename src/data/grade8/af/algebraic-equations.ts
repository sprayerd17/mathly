  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'Los op: 6x + 5 = 2x + 29', checkMode: 'auto', options: ['6', '24', '-6', '7'], correctIndex: 0, explanation: '6x + 5 = 2x + 29\nTrek 2x van albei kante af: 4x + 5 = 29\nTrek 5 van albei kante af: 4x = 24\nDeel albei kante deur 4: x = 6\nKontroleer: 6(6) + 5 = 41 en 2(6) + 29 = 41 ✓' },
        { difficulty: 'Medium', question: 'Los op: 9x − 8 = 4x + 17', checkMode: 'auto', options: ['25', '5', '-5', '6'], correctIndex: 1, explanation: '9x − 8 = 4x + 17\nTrek 4x van albei kante af: 5x − 8 = 17\nTel 8 by albei kante: 5x = 25\nDeel albei kante deur 5: x = 5\nKontroleer: 9(5) − 8 = 37 en 4(5) + 17 = 37 ✓' },
        { difficulty: 'Medium-Hard', question: 'Sewe keer ʼn getal, verminder met 3, is gelyk aan vier keer die getal vermeerder met 15. Stel ʼn vergelyking op en los op.', checkMode: 'auto', options: ['18', '-6', '6', '7'], correctIndex: 2, explanation: 'Laat die getal x wees.\n7x − 3 = 4x + 15\nTrek 4x van albei kante af: 3x − 3 = 15\nTel 3 by albei kante: 3x = 18\nDeel albei kante deur 3: x = 6\nKontroleer: 7(6) − 3 = 39 en 4(6) + 15 = 39 ✓' },
        ...
        { difficulty: 'Hard', question: 'ʼn Vader is 4 keer so oud soos sy seun. Oor 6 jaar sal die vader slegs 3 keer so oud soos sy seun wees. As die seun se huidige ouderdom x is, stel ʼn vergelyking op en vind die seun se huidige ouderdom.', checkMode: 'auto', options: ['18', '12', '-12', '11'], correctIndex: 1, explanation: 'Laat die seun se huidige ouderdom x wees, dus is die vader se huidige ouderdom 4x.\nOor 6 jaar: vader = 4x + 6, seun = x + 6\n4x + 6 = 3(x + 6)\nBrei uit: 4x + 6 = 3x + 18\nTrek 3x van albei kante af: x + 6 = 18\nTrek 6 van albei kante af: x = 12\nDie seun is tans 12 jaar oud.' },
        ...
        { difficulty: 'Medium-Hard', question: 'ʼn Skryfbehoeftewinkel vra ʼn R20-lidmaatskapfooi plus R3 per pen. ʼn Tweede winkel vra ʼn R8-lidmaatskapfooi plus R5 per pen. Vir hoeveel penne, n, sal die totale koste by albei winkels dieselfde wees?', checkMode: 'auto', options: ['12', '-6', '6', '7'], correctIndex: 2, explanation: 'Winkel A se koste: 20 + 3n. Winkel B se koste: 8 + 5n.\n20 + 3n = 8 + 5n\nTrek 3n van albei kante af: 20 = 8 + 2n\nTrek 8 van albei kante af: 12 = 2n\nDeel albei kante deur 2: n = 6\nKontroleer: 20 + 3(6) = 38 en 8 + 5(6) = 38 ✓' },

        // Blok 5 — Oplossings kontroleer deur substitusie / foutopsporing (posisies 16-17)
        { difficulty: 'Medium', question: 'Is x = 6 ʼn oplossing vir 5x − 4 = 3x + 8? Wys jou substitusie-kontrole.', checkMode: 'auto', options: ['Nee, x = 6 bevredig nie die vergelyking nie', 'Slegs die linkerkant is waar', 'Kan nie bepaal word sonder om te kontroleer nie', 'Ja, x = 6 bevredig die vergelyking'], correctIndex: 3, explanation: 'Vervang x = 6 in albei kante.\nLinkerkant: 5(6) − 4 = 30 − 4 = 26\nRegterkant: 3(6) + 8 = 18 + 8 = 26\nAlbei kante is gelyk aan 26, dus is x = 6 ʼn oplossing.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // Blok 1 — Veranderlikes aan albei kante (posisies 0-3)
        { difficulty: 'Medium', question: 'Los op: 8x + 3 = 3x + 38', checkMode: 'auto', options: ['7', '35', '-7', '8'], correctIndex: 0, explanation: '8x + 3 = 3x + 38\nTrek 3x van albei kante af: 5x + 3 = 38\nTrek 3 van albei kante af: 5x = 35\nDeel albei kante deur 5: x = 7\nKontroleer: 8(7) + 3 = 59 en 3(7) + 38 = 59 ✓' },
        { difficulty: 'Medium', question: 'Los op: 10x − 6 = 5x + 29', checkMode: 'auto', options: ['35', '7', '-7', '6'], correctIndex: 1, explanation: '10x − 6 = 5x + 29\nTrek 5x van albei kante af: 5x − 6 = 29\nTel 6 by albei kante: 5x = 35\nDeel albei kante deur 5: x = 7\nKontroleer: 10(7) − 6 = 64 en 5(7) + 29 = 64 ✓' },
        { difficulty: 'Medium-Hard', question: 'Nege keer ʼn getal, verminder met 4, is gelyk aan vyf keer die getal vermeerder met 24. Stel ʼn vergelyking op en los op.', checkMode: 'auto', options: ['28', '-7', '7', '8'], correctIndex: 2, explanation: 'Laat die getal x wees.\n9x − 4 = 5x + 24\nTrek 5x van albei kante af: 4x − 4 = 24\nTel 4 by albei kante: 4x = 28\nDeel albei kante deur 4: x = 7\nKontroleer: 9(7) − 4 = 59 en 5(7) + 24 = 59 ✓' },
        ...
        { difficulty: 'Hard', question: 'ʼn Vader is 5 keer so oud soos sy seun. Oor 4 jaar sal die vader slegs 4 keer so oud soos sy seun wees. As die seun se huidige ouderdom x is, stel ʼn vergelyking op en vind die seun se huidige ouderdom.', checkMode: 'auto', options: ['16', '12', '-12', '13'], correctIndex: 1, explanation: 'Laat die seun se huidige ouderdom x wees, dus is die vader se huidige ouderdom 5x.\nOor 4 jaar: vader = 5x + 4, seun = x + 4\n5x + 4 = 4(x + 4)\nBrei uit: 5x + 4 = 4x + 16\nTrek 4x van albei kante af: x + 4 = 16\nTrek 4 van albei kante af: x = 12\nDie seun is tans 12 jaar oud.' },
        ...
        { difficulty: 'Medium-Hard', question: 'ʼn Drukkerswinkel vra ʼn R25-opstelfooi plus R4 per plakkaat. ʼn Tweede winkel vra ʼn R10-opstelfooi plus R7 per plakkaat. Vir hoeveel plakkate, n, sal die totale koste by albei winkels dieselfde wees?', checkMode: 'auto', options: ['15', '-5', '5', '6'], correctIndex: 2, explanation: '25 + 4n = 10 + 7n\nTrek 4n van albei kante af: 25 = 10 + 3n\nTrek 10 van albei kante af: 15 = 3n\nDeel albei kante deur 3: n = 5\nKontroleer: 25 + 4(5) = 45 en 10 + 7(5) = 45 ✓' },

        // Blok 5 — Oplossings kontroleer deur substitusie / foutopsporing (posisies 16-17)
        { difficulty: 'Medium', question: 'Is x = 7 ʼn oplossing vir 4x + 9 = 2x + 23? Wys jou substitusie-kontrole.', checkMode: 'auto', options: ['Nee, x = 7 bevredig nie die vergelyking nie', 'Slegs die linkerkant is waar', 'Kan nie bepaal word sonder om te kontroleer nie', 'Ja, x = 7 bevredig die vergelyking'], correctIndex: 3, explanation: 'Vervang x = 7 in albei kante.\nLinkerkant: 4(7) + 9 = 28 + 9 = 37\nRegterkant: 2(7) + 23 = 14 + 23 = 37\nAlbei kante is gelyk aan 37, dus is x = 7 ʼn oplossing.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // Blok 1 — Veranderlikes aan albei kante (posisies 0-3)
        { difficulty: 'Medium', question: 'Los op: 7x + 9 = 4x + 27', checkMode: 'auto', options: ['6', '18', '-6', '7'], correctIndex: 0, explanation: '7x + 9 = 4x + 27\nTrek 4x van albei kante af: 3x + 9 = 27\nTrek 9 van albei kante af: 3x = 18\nDeel albei kante deur 3: x = 6\nKontroleer: 7(6) + 9 = 51 en 4(6) + 27 = 51 ✓' },
        { difficulty: 'Medium', question: 'Los op: 11x − 10 = 6x + 30', checkMode: 'auto', options: ['40', '8', '-8', '9'], correctIndex: 1, explanation: '11x − 10 = 6x + 30\nTrek 6x van albei kante af: 5x − 10 = 30\nTel 10 by albei kante: 5x = 40\nDeel albei kante deur 5: x = 8\nKontroleer: 11(8) − 10 = 78 en 6(8) + 30 = 78 ✓' },
        { difficulty: 'Medium-Hard', question: 'Agt keer ʼn getal, verminder met 5, is gelyk aan vyf keer die getal vermeerder met 19. Stel ʼn vergelyking op en los op.', checkMode: 'auto', options: ['24', '-8', '8', '7'], correctIndex: 2, explanation: 'Laat die getal x wees.\n8x − 5 = 5x + 19\nTrek 5x van albei kante af: 3x − 5 = 19\nTel 5 by albei kante: 3x = 24\nDeel albei kante deur 3: x = 8\nKontroleer: 8(8) − 5 = 59 en 5(8) + 19 = 59 ✓' },
        ...
        // Blok 2 — Vergelykings met hakies wat eers uitgebrei moet word (posisies 4-7)
        { difficulty: 'Medium', question: 'Los op: 6(x + 2) = 54', checkMode: 'auto', options: ['52', '-7', '8', '7'], correctIndex: 3, explanation: '6(x + 2) = 54\nBrei die hakie uit: 6x + 12 = 54\nTrek 12 van albei kante af: 6x = 42\nDeel albei kante deur 6: x = 7\nKontroleer: 6(7 + 2) = 6(9) = 54 ✓' },
        { difficulty: 'Medium', question: 'Los op: 4(3x − 2) = 100', checkMode: 'auto', options: ['9', '108', '-9', '10'], correctIndex: 0, explanation: '4(3x − 2) = 100\nBrei die hakie uit: 12x − 8 = 100\nTel 8 by albei kante: 12x = 108\nDeel albei kante deur 12: x = 9\nKontroleer: 4(3(9) − 2) = 4(25) = 100 ✓' },
        { difficulty: 'Medium-Hard', question: 'Los op: 7(x − 3) = 4x + 3', checkMode: 'auto', options: ['24', '8', '-8', '9'], correctIndex: 1, explanation: '7(x − 3) = 4x + 3\nBrei die hakie uit: 7x − 21 = 4x + 3\nTrek 4x van albei kante af: 3x − 21 = 3\nTel 21 by albei kante: 3x = 24\nDeel albei kante deur 3: x = 8\nKontroleer: 7(8 − 3) = 7(5) = 35 en 4(8) + 3 = 35 ✓' },
        ...
        { difficulty: 'Hard', question: 'ʼn Vader is 6 keer so oud soos sy seun. Oor 2 jaar sal die vader slegs 5 keer so oud soos sy seun wees. As die seun se huidige ouderdom x is, stel ʼn vergelyking op en vind die seun se huidige ouderdom.', checkMode: 'auto', options: ['10', '8', '-8', '9'], correctIndex: 1, explanation: 'Laat die seun se huidige ouderdom x wees, dus is die vader se huidige ouderdom 6x.\nOor 2 jaar: vader = 6x + 2, seun = x + 2\n6x + 2 = 5(x + 2)\nBrei uit: 6x + 2 = 5x + 10\nTrek 5x van albei kante af: x + 2 = 10\nTrek 2 van albei kante af: x = 8\nDie seun is tans 8 jaar oud.' },
        ...
        { difficulty: 'Medium-Hard', question: 'ʼn Snoepie vra ʼn R18-stalfooi plus R6 per item. ʼn Tweede stalletjie vra ʼn R6-stalfooi plus R9 per item. Vir hoeveel items, n, sal die totale koste by albei stalletjies dieselfde wees?', checkMode: 'auto', options: ['12', '-4', '4', '5'], correctIndex: 2, explanation: '18 + 6n = 6 + 9n\nTrek 6n van albei kante af: 18 = 6 + 3n\nTrek 6 van albei kante af: 12 = 3n\nDeel albei kante deur 3: n = 4\nKontroleer: 18 + 6(4) = 42 en 6 + 9(4) = 42 ✓' },

        // Blok 5 — Oplossings kontroleer deur substitusie / foutopsporing (posisies 16-17)
        { difficulty: 'Medium', question: 'Is x = 10 ʼn oplossing vir 3x − 8 = 2x + 3? Wys jou substitusie-kontrole, en gee die korrekte oplossing as dit nie is nie.', checkMode: 'auto', options: ['Ja, x = 10 bevredig die vergelyking', 'Slegs die linkerkant is waar', 'Kan nie bepaal word sonder om te kontroleer nie', 'Nee, x = 10 bevredig nie die vergelyking nie'], correctIndex: 3, explanation: 'Vervang x = 10 in albei kante.\nLinkerkant: 3(10) − 8 = 30 − 8 = 22\nRegterkant: 2(10) + 3 = 20 + 3 = 23\n22 is nie gelyk aan 23 nie, dus is x = 10 nie ʼn oplossing nie. Die korrekte oplossing: 3x − 8 = 2x + 3 → x = 11. Kontroleer: 3(11) − 8 = 25 en 2(11) + 3 = 25 ✓' },
