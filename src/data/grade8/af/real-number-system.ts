  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      explanation:
        ...
        `<p style="font-weight:700;color:#374151;margin-bottom:4px;">Telgetalle (N₀)</p>` +
        ...
        `<p style="color:#374151;font-size:14px;margin:0;">Al die telgetalle saam met hul negatiewe: {..., −3, −2, −1, 0, 1, 2, 3, ...}. Nou kan getalle onder nul gaan.</p>` +
        `</div>` +
        ...
        `<p style="margin:0 0 8px 0;color:#1e3a8a;">Elke ${bl('natuurlike getal')} is ook ʼn telgetal. Elke telgetal is ook ʼn ${gr('heelgetal')}. Elke ${gr('heelgetal')} is ook ʼn ${or('rasionale getal')}. Dink daaraan soos bokse binne bokse:</p>` +
        ...
        `<p style="margin:0;color:#854d0e;font-size:14px;"><strong>Wenk:</strong> om te kyk of ʼn getal aan ʼn kleiner versameling behoort, vra "is dit ʼn teltal?" dan "is dit nul of positief?" dan "is dit ʼn telgetal (geen breukdeel nie)?" Werk van die grootste versameling (Q) af na die kleinste (N) wat nog pas.</p>` +
        `</div>`,
      ...
      workedExamples: [
        {
          ...
          steps: [
            ...
            `Aangesien dit in N is, is dit outomaties ook in die telgetalle: 6 ∈ N₀.`,
            `Aangesien dit ʼn telgetal is, is dit outomaties ʼn ${gr('heelgetal')}: 6 ∈ Z.`,
        ...
        },
        {
          ...
          steps: [
            ...
            `Is −4 ʼn telgetal (0, 1, 2, ...)? Nee — telgetalle kan nie negatief wees nie, dus −4 ∉ N₀.`,
            `Is −4 ʼn ${gr('heelgetal')}? Ja — heelgetalle sluit negatiewe telgetalle in: −4 ∈ Z.`,
      ...
      diagramSvg:
        ...
        `<text x="80" y="94" font-size="9.5" font-weight="700" fill="#374151">N0 — telgetalle</text>` +
      ...
      videoPlaceholder:
        'Kort video wat natuurlike getalle, telgetalle, heelgetalle en rasionale getalle bekendstel en wys hoe elke versameling binne die volgende pas',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      explanation:
        ...
        `<p style="margin:0 0 8px 0;color:#7c2d12;">As die getal onder die vierkantswortelteken ʼn <strong>volkome vierkant</strong> is (1, 4, 9, 16, 25, 36, ...), vereenvoudig die vierkantswortel na ʼn telgetal — en telgetalle is altyd ${or('rasionaal')}.</p>` +
      ...
      workedExamples: [
        {
          ...
          steps: [
            ...
            `Aangesien 2 nie ʼn volkome vierkant is nie, vereenvoudig √2 nie na ʼn telgetal nie.`,
        ...
        },
        {
          ...
          steps: [
            ...
            `Dus vereenvoudig √9 presies na die telgetal 3.`,
      ...
      openQuestions: [
        {
          ...
          explanation: '√4 = 2, wat ʼn telgetal is. Aangesien 4 ʼn volkome vierkant is, vereenvoudig sy vierkantswortel na ʼn rasionale getal.',
        },
        {
          difficulty: 'Medium',
          ...
          explanation: '5 is nie ʼn volkome vierkant nie, dus kan √5 nie na ʼn telgetal vereenvoudig word nie. Sy desimaal, 2,2360679..., gaan vir ewig voort sonder ʼn herhalende patroon, dus is dit irrasionaal.',
        },
        {
          difficulty: 'Hard',
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      icon: '🗂️',
      explanation:
        `<p style="margin-bottom:16px;">Noudat ons al vyf groepe ken — ${bl('natuurlike getalle (N)')}, telgetalle (N₀), ${gr('heelgetalle (Z)')}, ${or('rasionale getalle (Q)')}, en ${re('irrasionale getalle')} — kan ons oefen om enige gegewe getal in die versameling(s) waaraan dit behoort te sorteer. Sommige getalle behoort aan verskeie versamelings gelyktydig (soos 7, wat N, N₀, Z en Q is), terwyl irrasionale getalle nooit aan enige van die ander vier versamelings behoort nie.</p>` +
        ...
        `<p style="margin:0;font-size:14px;">Is dit ook ʼn telgetal (geen breuk-/desimale deel nie)? Indien ja, is dit ook ʼn ${gr('heelgetal (Z)')}.</p>` +
        `</div>` +
        ...
        `<p style="margin:0;font-size:14px;">Is dit nul of positief? Indien ja, is dit ook ʼn telgetal (N0). Is dit positief (nie nul nie)? Indien ja, is dit ook ʼn ${bl('natuurlike getal (N)')}.</p>` +
        `</div>` +
      ...
      workedExamples: [
        {
          ...
          steps: [
            ...
            `<strong>−3</strong>: negatief, dus nie N of N0 nie. Dit is ʼn telgetal met ʼn negatiewe teken, dus is dit ${gr('Z')} en ${or('Q')} (= −3/1).`,
            `<strong>3/4</strong>: reeds ʼn breuk wat nie ʼn telgetal is nie, dus is dit slegs ${or('Q')}.`,
        ...
        },
        {
          ...
          steps: [
            ...
            `0 word by definisie by die telgetalle ingesluit, dus 0 ∈ N0.`,
        ...
        },
        {
          ...
          steps: [
            ...
            `Aangesien 20 nie ʼn volkome vierkant is nie, kan √20 nie na ʼn telgetal vereenvoudig word nie.`,
      ...
      openQuestions: [
        ...
        },
        {
          ...
          explanation: '√36 = 6, aangesien 36 ʼn volkome vierkant is (6 × 6 = 36). 6 is ʼn positiewe telgetal, dus behoort dit aan N, N0, Z en Q — dit is rasionaal, nie irrasionaal nie.',
        },
        {
          difficulty: 'Hard',
      ...
      videoPlaceholder:
        'Kort video wat verskeie voorbeelde deurwerk van die klassifisering van gegewe getalle in natuurlik, telgetal, heelgetal, rasionaal of irrasionaal',
    },
  ],
  resultsConfig: {
    totalMarks: 9,
  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'Is 12 ʼn natuurlike getal?', checkMode: 'auto', options: ['Nee — 12 is te groot om as ʼn natuurlike getal te tel', 'Ja — 12 is ʼn positiewe teltal, dus is dit ʼn natuurlike getal', 'Nee — natuurlike getalle moet minder as 10 wees', 'Ja, maar slegs omdat 12 ʼn ewe getal is'], correctIndex: 1, explanation: '12 is ʼn positiewe teltal, dus behoort dit aan die natuurlike getalle (N). ✓' },
        { difficulty: 'Easy', question: 'Is −8 ʼn natuurlike getal? Antwoord ja of nee.', checkMode: 'auto', options: ['Ja — negatiewe getalle tel ook as natuurlike getalle', 'Nee — natuurlike getalle kan nie gelyk aan 8 wees nie', 'Ja, maar slegs omdat −8 ʼn heelgetal is', 'Nee — −8 is negatief, dus is dit nie ʼn natuurlike getal nie'], correctIndex: 3, explanation: 'Natuurlike getalle is die positiewe teltalle {1, 2, 3, ...}. −8 is negatief, dus is dit NIE ʼn natuurlike getal nie. ✓' },
        { difficulty: 'Easy', question: 'Aan watter versameling behoort 0 wat natuurlike getalle (N) nie insluit nie: telgetalle (N0) of slegs heelgetalle?', checkMode: 'auto', options: ['Telgetalle (N0) — omdat 0 ingesluit word sodra dit by die natuurlike getalle gevoeg word', 'Slegs heelgetalle — omdat 0 negatief of positief kan wees', 'Slegs rasionale getalle — omdat 0 as ʼn breuk geskryf kan word', 'Geeneen nie — 0 behoort aan geeneen van hierdie versamelings nie'], correctIndex: 0, explanation: 'Telgetalle (N0) is die natuurlike getalle plus 0: {0, 1, 2, 3, ...}. Natuurlike getalle begin by 1 tel, dus is 0 in N0 maar nie in N nie. ✓' },
        { difficulty: 'Easy', question: 'Is −5 ʼn heelgetal?', checkMode: 'auto', options: ['Nee — heelgetalle kan nie negatief wees nie', 'Nee — −5 is slegs ʼn rasionale getal, nie ʼn heelgetal nie', 'Ja — heelgetalle sluit negatiewe telgetalle in, en −5 pas hierby', 'Ja, maar slegs omdat −5 ʼn onewe getal is'], correctIndex: 2, explanation: 'Heelgetalle (Z) sluit al die telgetalle saam met hul negatiewe in: {..., −2, −1, 0, 1, 2, ...}. −5 pas hierdie definisie. ✓' },

        // Blok 2 — Rasionaal vs irrasionaal vanaf desimale (eindigend/herhalend vs nie-herhalend)
        { difficulty: 'Easy-Medium', question: 'Is 0,375 rasionaal of irrasionaal?', checkMode: 'auto', options: ['Irrasionaal — die syfers eindig nooit nie', 'Rasionaal — 0,375 eindig, dus is dit gelyk aan die breuk 3/8', 'Irrasionaal — enige getal met ʼn desimale punt is nie-herhalend', 'Heelgetal — die desimaal vereenvoudig na ʼn telgetal'], correctIndex: 1, explanation: '0,375 is ʼn eindigende desimaal (dit stop), dus kan dit as ʼn presiese breuk geskryf word: 0,375 = 3/8. Dit maak dit rasionaal. ✓' },
        { difficulty: 'Easy-Medium', question: 'Die desimaal 0,454545... herhaal die paar "45" vir ewig. Is hierdie getal rasionaal of irrasionaal?', checkMode: 'auto', options: ['Irrasionaal — die desimaal eindig nooit tegnies nie', 'Irrasionaal — herhalende desimale is per definisie nie-eindigend en nie-herhalend', 'Rasionaal, maar slegs omdat dit ʼn ewe aantal syfers herhaal', 'Rasionaal — dit herhaal vir ewig in ʼn patroon, dus is dit gelyk aan 5/11'], correctIndex: 3, explanation: 'ʼn Desimaal wat in ʼn duidelike patroon vir ewig herhaal, is steeds rasionaal, al eindig dit nooit tegnies nie. 0,454545... = 5/11, dus is dit rasionaal. ✓' },
        ...
        { difficulty: 'Medium', question: 'Is √16 rasionaal of irrasionaal?', checkMode: 'auto', options: ['Rasionaal — √16 = 4, ʼn telgetal', 'Irrasionaal — vierkantswortels is altyd irrasionaal', 'Irrasionaal — 16 is nie ʼn volkome vierkant nie', 'Slegs ʼn natuurlike getal, nie rasionaal nie'], correctIndex: 0, explanation: '16 is ʼn volkome vierkant (4 × 4 = 16), dus √16 = 4, ʼn telgetal. Dit maak dit rasionaal. ✓' },
        { difficulty: 'Medium', question: 'Is √17 rasionaal of irrasionaal?', checkMode: 'auto', options: ['Rasionaal — elke vierkantswortel is rasionaal sodra dit vereenvoudig is', 'Rasionaal — 17 is ʼn volkome vierkant', 'Irrasionaal — 17 is nie ʼn volkome vierkant nie, dus kan √17 nie na ʼn telgetal vereenvoudig word nie', 'ʼn Natuurlike getal — vierkantswortels is altyd telgetalle'], correctIndex: 2, explanation: '17 is nie ʼn volkome vierkant nie (die naaste volkome vierkante is 16 en 25), dus kan √17 nie na ʼn telgetal vereenvoudig word nie. Sy desimaal, 4,1231056..., is nie-eindigend en nie-herhalend, dus is dit irrasionaal. ✓' },
        { difficulty: 'Medium', question: 'Klassifiseer √49: is dit rasionaal of irrasionaal, en waarna vereenvoudig dit?', checkMode: 'self', answer: 'Rasionaal. 49 is ʼn volkome vierkant (7 × 7 = 49), dus √49 = 7, wat ʼn telgetal is en dus rasionaal.' },
        { difficulty: 'Medium-Hard', question: 'Tussen √40 en √50 lyk een meer "irrasionaal" as die ander, maar klassifiseer BEIDE getalle as rasionaal of irrasionaal, en toon jou redenasie vir elkeen.', checkMode: 'self', answer: 'Albei is irrasionaal. 40 is nie ʼn volkome vierkant nie (tussen 36 = 6² en 49 = 7²), dus √40 = 6,3245553... is nie-eindigend en nie-herhalend. 50 is ook nie ʼn volkome vierkant nie (tussen 49 = 7² en 64 = 8²), dus √50 = 7,0710678... is ook nie-eindigend en nie-herhalend. Geeneen vereenvoudig na ʼn telgetal nie, dus is albei irrasionaal.' },

        // Blok 4 — Volledige multi-versameling klassifikasie
        { difficulty: 'Medium', question: 'Klassifiseer die getal 14 in elke versameling waaraan dit behoort (N, N0, Z, Q, of irrasionaal).', checkMode: 'auto', options: ['Telgetal, heelgetal en rasionale getal (nie natuurlik nie)', 'Natuurlike getal, telgetal, heelgetal en rasionale getal', 'Slegs heelgetal en rasionale getal', 'Natuurlike getal en irrasionale getal'], correctIndex: 1, explanation: '14 is ʼn positiewe hele teltal sonder ʼn breukdeel, dus behoort dit aan N, N0, Z en Q. ✓' },
        { difficulty: 'Medium', question: 'Klassifiseer √81 in elke versameling waaraan dit behoort (N, N0, Z, Q, of irrasionaal).', checkMode: 'auto', options: ['Slegs rasionaal — √81 vereenvoudig nie na ʼn telgetal nie', 'Irrasionaal — 81 is nie ʼn volkome vierkant nie', 'Slegs heelgetal en rasionale getal (nie natuurlik, nie ʼn telgetal nie)', 'Natuurlike getal, telgetal, heelgetal en rasionale getal'], correctIndex: 3, explanation: '81 is ʼn volkome vierkant (9 × 9 = 81), dus √81 = 9. Aangesien 9 ʼn positiewe telgetal is, behoort dit aan N, N0, Z en Q. ✓' },
        ...
        { difficulty: 'Medium', question: 'Rangskik hierdie getalle van kleinste na grootste: √25, 4,9, √16, 5,1.', checkMode: 'auto', options: ['√16, 4,9, √25, 5,1', '4,9, √16, 5,1, √25', '√25, 4,9, √16, 5,1', '5,1, √25, 4,9, √16'], correctIndex: 0, explanation: '√16 = 4, 4,9 = 4,9, √25 = 5, 5,1 = 5,1. Die rangskikking van die waardes 4, 4,9, 5, 5,1 van kleinste na grootste gee √16, 4,9, √25, 5,1. ✓' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // Blok 1 — Klassifisering van getalle volgens tipe (N / N0 / Z / Q)
        { difficulty: 'Easy', question: 'Is 25 ʼn natuurlike getal?', checkMode: 'auto', options: ['Nee — 25 is te groot om as ʼn natuurlike getal te tel', 'Nee — natuurlike getalle moet minder as 20 wees', 'Ja — 25 is ʼn positiewe teltal, dus is dit ʼn natuurlike getal', 'Ja, maar slegs omdat 25 ʼn volkome vierkant is'], correctIndex: 2, explanation: '25 is ʼn positiewe teltal, dus behoort dit aan die natuurlike getalle (N). ✓' },
        { difficulty: 'Easy', question: 'Is −11 ʼn telgetal? Antwoord ja of nee.', checkMode: 'auto', options: ['Nee — −11 is negatief, dus is dit nie ʼn telgetal nie', 'Ja — telgetalle sluit ook negatiewe teltalle in', 'Nee — telgetalle moet ewe wees, en −11 is onewe', 'Ja, maar slegs omdat −11 ʼn heelwaarde sonder ʼn breukdeel is'], correctIndex: 0, explanation: 'Telgetalle (N0) is {0, 1, 2, 3, ...} — hulle kan nie negatief wees nie. −11 is negatief, dus is dit NIE ʼn telgetal nie. ✓' },
        { difficulty: 'Easy', question: 'Noem die kleinste versameling (N, N0 of Z) waaraan die getal 0 behoort.', checkMode: 'auto', options: ['N — omdat 0 die kleinste teltal is', 'Z — omdat 0 met ʼn negatiewe teken geskryf kan word', 'Geeneen nie — 0 behoort nie aan N, N0 of Z nie', 'N0 — omdat 0 ingesluit word sodra dit by die natuurlike getalle gevoeg word'], correctIndex: 3, explanation: '0 is nie in N nie (tel begin by 1), maar dit word by definisie by die telgetalle (N0) ingesluit, dus is N0 die kleinste versameling wat 0 bevat. ✓' },
        { difficulty: 'Easy', question: 'Is −20 ʼn heelgetal?', checkMode: 'auto', options: ['Nee — heelgetalle kan nie negatief wees nie', 'Ja — heelgetalle sluit negatiewe telgetalle in, en −20 pas hierby', 'Nee — −20 is slegs ʼn rasionale getal, nie ʼn heelgetal nie', 'Ja, maar slegs omdat −20 ʼn ewe getal is'], correctIndex: 1, explanation: 'Heelgetalle (Z) sluit al die telgetalle saam met hul negatiewe in, dus pas −20 hierdie definisie. ✓' },

        // Blok 2 — Rasionaal vs irrasionaal vanaf desimale
        { difficulty: 'Easy-Medium', question: 'Is 0,65 rasionaal of irrasionaal?', checkMode: 'auto', options: ['Irrasionaal — die syfers eindig nooit nie', 'Heelgetal — die desimaal vereenvoudig na ʼn telgetal', 'Rasionaal — 0,65 eindig, dus is dit gelyk aan die breuk 13/20', 'Irrasionaal — enige getal met ʼn desimale punt is nie-herhalend'], correctIndex: 2, explanation: '0,65 is ʼn eindigende desimaal, dus kan dit as ʼn presiese breuk geskryf word: 0,65 = 13/20. Dit maak dit rasionaal. ✓' },
        { difficulty: 'Easy-Medium', question: 'Die desimaal 0,363636... herhaal die paar "36" vir ewig. Is hierdie getal rasionaal of irrasionaal?', checkMode: 'auto', options: ['Rasionaal — dit herhaal vir ewig in ʼn patroon, dus is dit gelyk aan 4/11', 'Irrasionaal — die desimaal eindig nooit tegnies nie', 'Irrasionaal — herhalende desimale is per definisie nie-eindigend en nie-herhalend', 'Rasionaal, maar slegs omdat dit ʼn ewe aantal syfers herhaal'], correctIndex: 0, explanation: 'ʼn Desimaal wat in ʼn duidelike patroon vir ewig herhaal, is steeds rasionaal. 0,363636... = 4/11, dus is dit rasionaal. ✓' },
        ...
        // Blok 3 — Wortelgetalle: rasionaal of irrasionaal
        { difficulty: 'Medium', question: 'Is √25 rasionaal of irrasionaal?', checkMode: 'auto', options: ['Irrasionaal — vierkantswortels is altyd irrasionaal', 'Irrasionaal — 25 is nie ʼn volkome vierkant nie', 'Slegs ʼn natuurlike getal, nie rasionaal nie', 'Rasionaal — √25 = 5, ʼn telgetal'], correctIndex: 3, explanation: '25 is ʼn volkome vierkant (5 × 5 = 25), dus √25 = 5, ʼn telgetal. Dit maak dit rasionaal. ✓' },
        { difficulty: 'Medium', question: 'Is √29 rasionaal of irrasionaal?', checkMode: 'auto', options: ['Rasionaal — elke vierkantswortel is rasionaal sodra dit vereenvoudig is', 'Irrasionaal — 29 is nie ʼn volkome vierkant nie, dus kan √29 nie na ʼn telgetal vereenvoudig word nie', 'Rasionaal — 29 is ʼn volkome vierkant', 'ʼn Natuurlike getal — vierkantswortels is altyd telgetalle'], correctIndex: 1, explanation: '29 is nie ʼn volkome vierkant nie (die naaste volkome vierkante is 25 en 36), dus kan √29 nie na ʼn telgetal vereenvoudig word nie. Sy desimaal, 5,3851648..., is nie-eindigend en nie-herhalend, dus is dit irrasionaal. ✓' },
        { difficulty: 'Medium', question: 'Klassifiseer √144: is dit rasionaal of irrasionaal, en waarna vereenvoudig dit?', checkMode: 'self', answer: 'Rasionaal. 144 is ʼn volkome vierkant (12 × 12 = 144), dus √144 = 12, wat ʼn telgetal is en dus rasionaal.' },
        { difficulty: 'Medium-Hard', question: 'Klassifiseer BEIDE √64 en √70 as rasionaal of irrasionaal, en toon jou redenasie vir elkeen.', checkMode: 'self', answer: '√64 is rasionaal: 64 is ʼn volkome vierkant (8 × 8 = 64), dus √64 = 8, ʼn telgetal. √70 is irrasionaal: 70 is nie ʼn volkome vierkant nie (tussen 64 = 8² en 81 = 9²), dus √70 = 8,3666002... is nie-eindigend en nie-herhalend.' },

        // Blok 4 — Volledige multi-versameling klassifikasie
        { difficulty: 'Medium', question: 'Klassifiseer die getal 23 in elke versameling waaraan dit behoort (N, N0, Z, Q, of irrasionaal).', checkMode: 'auto', options: ['Telgetal, heelgetal en rasionale getal (nie natuurlik nie)', 'Slegs heelgetal en rasionale getal', 'Natuurlike getal, telgetal, heelgetal en rasionale getal', 'Natuurlike getal en irrasionale getal'], correctIndex: 2, explanation: '23 is ʼn positiewe hele teltal sonder ʼn breukdeel, dus behoort dit aan N, N0, Z en Q. ✓' },
        { difficulty: 'Medium', question: 'Klassifiseer √100 in elke versameling waaraan dit behoort (N, N0, Z, Q, of irrasionaal).', checkMode: 'auto', options: ['Natuurlike getal, telgetal, heelgetal en rasionale getal', 'Slegs rasionaal — √100 vereenvoudig nie na ʼn telgetal nie', 'Irrasionaal — 100 is nie ʼn volkome vierkant nie', 'Slegs heelgetal en rasionale getal (nie natuurlik, nie ʼn telgetal nie)'], correctIndex: 0, explanation: '100 is ʼn volkome vierkant (10 × 10 = 100), dus √100 = 10. Aangesien 10 ʼn positiewe telgetal is, behoort dit aan N, N0, Z en Q. ✓' },
        ...
        { difficulty: 'Medium', question: 'Rangskik hierdie getalle van kleinste na grootste: √36, 5,9, √49, 6,2.', checkMode: 'auto', options: ['√49, 5,9, √36, 6,2', '6,2, √49, 5,9, √36', '5,9, √49, 6,2, √36', '5,9, √36, 6,2, √49'], correctIndex: 3, explanation: '√36 = 6, 5,9 = 5,9, √49 = 7, 6,2 = 6,2. Die rangskikking van die waardes 5,9, 6, 6,2, 7 van kleinste na grootste gee 5,9, √36 (6), 6,2, √49 (7). ✓' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // Blok 1 — Klassifisering van getalle volgens tipe (N / N0 / Z / Q)
        { difficulty: 'Easy', question: 'Is 40 ʼn natuurlike getal?', checkMode: 'auto', options: ['Ja — 40 is ʼn positiewe teltal, dus is dit ʼn natuurlike getal', 'Nee — 40 is te groot om as ʼn natuurlike getal te tel', 'Nee — natuurlike getalle moet minder as 30 wees', 'Ja, maar slegs omdat 40 ʼn veelvoud van 10 is'], correctIndex: 0, explanation: '40 is ʼn positiewe teltal, dus behoort dit aan die natuurlike getalle (N). ✓' },
        { difficulty: 'Easy', question: 'Is −3 ʼn natuurlike getal? Antwoord ja of nee.', checkMode: 'auto', options: ['Ja — negatiewe getalle tel ook as natuurlike getalle', 'Ja, maar slegs omdat −3 ʼn heelgetal is', 'Nee — −3 is negatief, dus is dit nie ʼn natuurlike getal nie', 'Nee — natuurlike getalle moet ewe wees, en −3 is onewe'], correctIndex: 2, explanation: 'Natuurlike getalle is die positiewe teltalle {1, 2, 3, ...}. −3 is negatief, dus is dit NIE ʼn natuurlike getal nie. ✓' },
        { difficulty: 'Easy', question: 'ʼn Temperatuurlesing van 0°C word op ʼn termometer aangeteken. Aan watter versameling(s) — N, N0, Z, Q — behoort die getal 0?', checkMode: 'auto', options: ['N, N0, Z en Q — 0 behoort aan elke versameling', 'N0, Z en Q — 0 is ʼn telgetal, ʼn heelgetal en rasionaal, maar nie natuurlik nie', 'Slegs Z en Q — 0 is nie ʼn telgetal nie', 'Slegs N0 — 0 behoort nie aan Z of Q nie'], correctIndex: 1, explanation: '0 is nie in N nie (tel begin by 1), maar dit is in N0 by definisie, dit is ʼn heelgetal, en dit kan as 0/1 geskryf word, dus is dit ook in Q. Dus behoort 0 aan N0, Z en Q. ✓' },
        { difficulty: 'Easy', question: 'Is −14 ʼn heelgetal?', checkMode: 'auto', options: ['Nee — heelgetalle kan nie negatief wees nie', 'Nee — −14 is slegs ʼn rasionale getal, nie ʼn heelgetal nie', 'Ja, maar slegs omdat −14 ʼn ewe getal is', 'Ja — heelgetalle sluit negatiewe telgetalle in, en −14 pas hierby'], correctIndex: 3, explanation: 'Heelgetalle (Z) sluit al die telgetalle saam met hul negatiewe in, dus pas −14 hierdie definisie. ✓' },

        // Blok 2 — Rasionaal vs irrasionaal vanaf desimale
        { difficulty: 'Easy-Medium', question: 'Is 0,425 rasionaal of irrasionaal?', checkMode: 'auto', options: ['Rasionaal — 0,425 eindig, dus is dit gelyk aan die breuk 17/40', 'Irrasionaal — die syfers eindig nooit nie', 'Irrasionaal — enige getal met ʼn desimale punt is nie-herhalend', 'Heelgetal — die desimaal vereenvoudig na ʼn telgetal'], correctIndex: 0, explanation: '0,425 is ʼn eindigende desimaal, dus kan dit as ʼn presiese breuk geskryf word: 0,425 = 17/40. Dit maak dit rasionaal. ✓' },
        { difficulty: 'Easy-Medium', question: 'Die desimaal 0,222... herhaal die syfer 2 vir ewig. Is hierdie getal rasionaal of irrasionaal?', checkMode: 'auto', options: ['Irrasionaal — die desimaal eindig nooit tegnies nie', 'Irrasionaal — herhalende desimale is per definisie nie-eindigend en nie-herhalend', 'Rasionaal — dit herhaal vir ewig in ʼn patroon, dus is dit gelyk aan 2/9', 'Rasionaal, maar slegs omdat dit ʼn enkele syfer herhaal'], correctIndex: 2, explanation: 'ʼn Desimaal wat in ʼn duidelike patroon vir ewig herhaal, is steeds rasionaal. 0,222... = 2/9, dus is dit rasionaal. ✓' },
        ...
        // Blok 3 — Wortelgetalle: rasionaal of irrasionaal
        { difficulty: 'Medium', question: 'Is √169 rasionaal of irrasionaal?', checkMode: 'auto', options: ['Irrasionaal — vierkantswortels is altyd irrasionaal', 'Rasionaal — √169 = 13, ʼn telgetal', 'Irrasionaal — 169 is nie ʼn volkome vierkant nie', 'Slegs ʼn natuurlike getal, nie rasionaal nie'], correctIndex: 1, explanation: '169 is ʼn volkome vierkant (13 × 13 = 169), dus √169 = 13, ʼn telgetal. Dit maak dit rasionaal. ✓' },
        { difficulty: 'Medium', question: 'Is √90 rasionaal of irrasionaal?', checkMode: 'auto', options: ['Rasionaal — elke vierkantswortel is rasionaal sodra dit vereenvoudig is', 'Rasionaal — 90 is ʼn volkome vierkant', 'ʼn Natuurlike getal — vierkantswortels is altyd telgetalle', 'Irrasionaal — 90 is nie ʼn volkome vierkant nie, dus kan √90 nie na ʼn telgetal vereenvoudig word nie'], correctIndex: 3, explanation: '90 is nie ʼn volkome vierkant nie (die naaste volkome vierkante is 81 en 100), dus kan √90 nie na ʼn telgetal vereenvoudig word nie. Sy desimaal, 9,4868329..., is nie-eindigend en nie-herhalend, dus is dit irrasionaal. ✓' },
        { difficulty: 'Medium', question: 'Klassifiseer √196: is dit rasionaal of irrasionaal, en waarna vereenvoudig dit?', checkMode: 'self', answer: 'Rasionaal. 196 is ʼn volkome vierkant (14 × 14 = 196), dus √196 = 14, wat ʼn telgetal is en dus rasionaal.' },
        { difficulty: 'Medium-Hard', question: 'Klassifiseer BEIDE √121 en √130 as rasionaal of irrasionaal, en toon jou redenasie vir elkeen.', checkMode: 'self', answer: '√121 is rasionaal: 121 is ʼn volkome vierkant (11 × 11 = 121), dus √121 = 11, ʼn telgetal. √130 is irrasionaal: 130 is nie ʼn volkome vierkant nie (tussen 121 = 11² en 144 = 12²), dus √130 = 11,4017542... is nie-eindigend en nie-herhalend.' },

        // Blok 4 — Volledige multi-versameling klassifikasie
        { difficulty: 'Medium', question: 'Klassifiseer die getal 31 in elke versameling waaraan dit behoort (N, N0, Z, Q, of irrasionaal).', checkMode: 'auto', options: ['Natuurlike getal, telgetal, heelgetal en rasionale getal', 'Telgetal, heelgetal en rasionale getal (nie natuurlik nie)', 'Slegs heelgetal en rasionale getal', 'Natuurlike getal en irrasionale getal'], correctIndex: 0, explanation: '31 is ʼn positiewe hele teltal sonder ʼn breukdeel, dus behoort dit aan N, N0, Z en Q. ✓' },
        { difficulty: 'Medium', question: 'Klassifiseer √225 in elke versameling waaraan dit behoort (N, N0, Z, Q, of irrasionaal).', checkMode: 'auto', options: ['Slegs rasionaal — √225 vereenvoudig nie na ʼn telgetal nie', 'Irrasionaal — 225 is nie ʼn volkome vierkant nie', 'Natuurlike getal, telgetal, heelgetal en rasionale getal', 'Slegs heelgetal en rasionale getal (nie natuurlik, nie ʼn telgetal nie)'], correctIndex: 2, explanation: '225 is ʼn volkome vierkant (15 × 15 = 225), dus √225 = 15. Aangesien 15 ʼn positiewe telgetal is, behoort dit aan N, N0, Z en Q. ✓' },
        ...
        { difficulty: 'Medium', question: 'Rangskik hierdie getalle van kleinste na grootste: √100, 9,8, √81, 10,3.', checkMode: 'auto', options: ['√100, 9,8, √81, 10,3', '√81, 9,8, √100, 10,3', '10,3, √100, 9,8, √81', '9,8, √81, 10,3, √100'], correctIndex: 1, explanation: '√100 = 10, 9,8 = 9,8, √81 = 9, 10,3 = 10,3. Die rangskikking van die waardes 10, 9,8, 9, 10,3 van kleinste na grootste gee √81 (9), 9,8, √100 (10), 10,3. ✓' },
