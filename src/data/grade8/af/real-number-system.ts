  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'Aan watter versameling behoort 0 wat natuurlike getalle (N) nie insluit nie: telgetalle (N0) of slegs heelgetalle?', checkMode: 'auto', correctAnswer: 'telgetalle', correctAnswers: ['telgetalle', 'N0', 'telgetalle (N0)'], explanation: 'Telgetalle (N0) is die natuurlike getalle plus 0: {0, 1, 2, 3, ...}. Natuurlike getalle begin by 1 tel, dus is 0 in N0 maar nie in N nie. ✓' },
        { difficulty: 'Easy', question: 'Is −5 ʼn heelgetal?', checkMode: 'auto', correctAnswer: 'ja', correctAnswers: ['ja'], explanation: 'Heelgetalle (Z) sluit al die telgetalle saam met hul negatiewe in: {..., −2, −1, 0, 1, 2, ...}. −5 pas hierdie definisie. ✓' },
        ...
        { difficulty: 'Medium', question: 'Is √16 rasionaal of irrasionaal?', checkMode: 'auto', correctAnswer: 'rasionaal', correctAnswers: ['rasionaal'], explanation: '16 is ʼn volkome vierkant (4 × 4 = 16), dus √16 = 4, ʼn telgetal. Dit maak dit rasionaal. ✓' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'Is −11 ʼn telgetal? Antwoord ja of nee.', checkMode: 'auto', correctAnswer: 'nee', correctAnswers: ['nee'], explanation: 'Telgetalle (N0) is {0, 1, 2, 3, ...} — hulle kan nie negatief wees nie. −11 is negatief, dus is dit NIE ʼn telgetal nie. ✓' },
        { difficulty: 'Easy', question: 'Noem die kleinste versameling (N, N0 of Z) waaraan die getal 0 behoort.', checkMode: 'auto', correctAnswer: 'N0', correctAnswers: ['N0', 'telgetalle', 'N nul'], explanation: '0 is nie in N nie (tel begin by 1), maar dit word by definisie by die telgetalle (N0) ingesluit, dus is N0 die kleinste versameling wat 0 bevat. ✓' },
        { difficulty: 'Easy', question: 'Is −20 ʼn heelgetal?', checkMode: 'auto', correctAnswer: 'ja', correctAnswers: ['ja'], explanation: 'Heelgetalle (Z) sluit al die telgetalle saam met hul negatiewe in, dus pas −20 hierdie definisie. ✓' },
        ...
        // Blok 3 — Wortelgetalle: rasionaal of irrasionaal
        { difficulty: 'Medium', question: 'Is √25 rasionaal of irrasionaal?', checkMode: 'auto', correctAnswer: 'rasionaal', correctAnswers: ['rasionaal'], explanation: '25 is ʼn volkome vierkant (5 × 5 = 25), dus √25 = 5, ʼn telgetal. Dit maak dit rasionaal. ✓' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'Is −14 ʼn heelgetal?', checkMode: 'auto', correctAnswer: 'ja', correctAnswers: ['ja'], explanation: 'Heelgetalle (Z) sluit al die telgetalle saam met hul negatiewe in, dus pas −14 hierdie definisie. ✓' },
        ...
        // Blok 3 — Wortelgetalle: rasionaal of irrasionaal
        { difficulty: 'Medium', question: 'Is √169 rasionaal of irrasionaal?', checkMode: 'auto', correctAnswer: 'rasionaal', correctAnswers: ['rasionaal'], explanation: '169 is ʼn volkome vierkant (13 × 13 = 169), dus √169 = 13, ʼn telgetal. Dit maak dit rasionaal. ✓' },
