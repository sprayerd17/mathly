  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'ʼn Vierhoek het binnehoeke van 100°, 80°, 95° en ʼn onbekende vierde hoek. Bereken die grootte van die vierde hoek sodat die vierhoek korrek gekonstrueer kan word.', checkMode: 'auto', options: ['180°', '165°', '85°', '185°'], correctIndex: 2, explanation: 'Die hoeke van ʼn vierhoek som tot 360°: 360° − 100° − 80° − 95° = 85°.' },
        ...
        { difficulty: 'Easy', question: 'Wat is die korrekte term vir ʼn lyn wat ʼn lynstuk in twee gelyke dele verdeel terwyl dit dit ook teen presies 90° kruis?', checkMode: 'auto', options: ['middelloodlyn', 'hoekhalveerder', 'loodlyn', 'swaartelyn'], correctIndex: 0, explanation: 'ʼn Middelloodlyn sny ʼn lynstuk presies in die helfte en ontmoet dit gelyktydig teen ʼn regte hoek.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'ʼn Vierhoek het binnehoeke van 90°, 100°, 85° en ʼn onbekende vierde hoek. Bereken die grootte van die vierde hoek sodat die vierhoek korrek gekonstrueer kan word.', checkMode: 'auto', options: ['170°', '85°', '185°', '175°'], correctIndex: 1, explanation: 'Die hoeke van ʼn vierhoek som tot 360°: 360° − 90° − 100° − 85° = 85°.' },
        ...
        { difficulty: 'Easy', question: 'Wat is die korrekte term vir ʼn straal vanaf ʼn hoekpunt wat ʼn hoek in twee presies gelyke dele verdeel?', checkMode: 'auto', options: ['middelloodlyn', 'swaartelyn', 'hoogtelyn', 'hoekhalveerder'], correctIndex: 3, explanation: 'ʼn Hoekhalveerder is ʼn straal vanaf die hoekpunt wat die hoek in twee presies gelyke helftes verdeel.' },
        ...
        { difficulty: 'Easy', question: 'Watter kongruensievoorwaarde geld wanneer ʼn driehoek gekonstrueer word met twee gegewe hoeke en die sy wat tussen hulle ingesluit is?', checkMode: 'auto', options: ['ASA', 'SAS', 'SSS', 'RHS'], correctIndex: 0, explanation: 'ASA (hoek-sy-hoek) word gebruik wanneer twee hoeke en die ingeslote sy tussen hulle bekend is.' },
        { difficulty: 'Medium', question: 'Driehoek DEF het DE = 6 cm, EF = 8 cm en DF = 10 cm. Driehoek PQR het PQ = 6 cm, QR = 8 cm en PR = 10 cm — al drie ooreenstemmende sye gelyk. Verduidelik watter kongruensievoorwaarde bewys dat die driehoeke kongruent is, en waarom geen hoeke gemeet hoef te word nie.', answer: 'SSS (sy-sy-sy) bewys dat die driehoeke kongruent is, want sodra al drie sylengtes van ʼn driehoek vasgestel is, is sy vorm (en dus al sy hoeke) volledig bepaal — daar is slegs een moontlike driehoek met daardie drie sylengtes, dus is geen hoekmetings nodig nie.', checkMode: 'self' },
        { difficulty: 'Medium', question: 'Driehoek GHI en driehoek STU is albei reghoekig. Skuinssy GI = 13 cm is gelyk aan skuinssy SU = 13 cm, en sy GH = 5 cm is gelyk aan sy ST = 5 cm. Gee die kongruensievoorwaarde wat bewys dat die driehoeke kongruent is.', checkMode: 'auto', options: ['SAS', 'ASA', 'RHS', 'SSS'], correctIndex: 2, explanation: 'RHS (regte hoek-skuinssy-sy) geld spesifiek vir reghoekige driehoeke wanneer die skuinssy en een ander sy ooreenstem.' },
      ...
      scoreMessages: [
        { minScore: 18, message: 'Uitstekend! Jy kan met selfvertroue driehoeke en vierhoeke konstrueer en kongruensievoorwaardes toepas.' },
        { minScore: 13, message: 'Goeie werk! Gaan enige gemiste vrae weer deur en probeer weer.' },
        { minScore: 8, message: 'Goeie poging! Gaan die uitgewerkte voorbeelde weer deur en probeer hierdie stel weer.' },
        { minScore: 0, message: 'Hou aan probeer — werk weer deur die studiegids en probeer hierdie stel weer.' },
      ],
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'ʼn Vierhoek het binnehoeke van 70°, 110°, 95° en ʼn onbekende vierde hoek. Bereken die grootte van die vierde hoek sodat die vierhoek korrek gekonstrueer kan word.', checkMode: 'auto', options: ['85°', '180°', '195°', '155°'], correctIndex: 0, explanation: 'Die hoeke van ʼn vierhoek som tot 360°: 360° − 70° − 110° − 95° = 85°.' },
        ...
        { difficulty: 'Easy', question: 'Wat is die korrekte term vir die punt waar die drie hoekhalveerders van ʼn driehoek ontmoet?', checkMode: 'auto', options: ['omsentrum', 'swaartepunt', 'binnesentrum', 'ortosentrum'], correctIndex: 2, explanation: 'Die binnesentrum is die enkele punt binne ʼn driehoek waar al drie hoekhalveerders sny.' },
        ...
        { difficulty: 'Medium', question: 'Twee driehoeke het elk al drie ooreenstemmende sylengtes gelyk. Gee die kongruensievoorwaarde wat bewys dat die driehoeke kongruent is.', checkMode: 'auto', options: ['SAS', 'ASA', 'RHS', 'SSS'], correctIndex: 3, explanation: 'SSS (sy-sy-sy) geld wanneer al drie ooreenstemmende sye van twee driehoeke gelyk is.' },
