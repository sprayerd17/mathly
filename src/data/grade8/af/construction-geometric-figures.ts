  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'Driehoek GHI en driehoek STU is albei reghoekig. Skuinssy GI = 13 cm is gelyk aan skuinssy SU = 13 cm, en sy GH = 5 cm is gelyk aan sy ST = 5 cm. Gee die kongruensievoorwaarde wat bewys dat die driehoeke kongruent is.', answer: 'RHS', checkMode: 'auto', correctAnswer: 'RHS', correctAnswers: ['RHS', 'rhs', 'regte hoek-skuinssy-sy'], explanation: 'RHS (regte hoek-skuinssy-sy) geld spesifiek vir reghoekige driehoeke wanneer die skuinssy en een ander sy ooreenstem.' },
