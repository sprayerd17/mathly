...
export const topicData: TopicData = {
  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      name: 'Stel 1',
      questions: [
        { difficulty: 'Medium', question: 'Bereken −14 + (−9) × 3.', checkMode: 'auto', options: ['-41', '13', '-69', '41'], correctIndex: 0, explanation: 'Vermenigvuldiging voor optelling: −9 × 3 = −27 (verskillende tekens → negatief). Dan −14 + (−27) = −41.' },
        { difficulty: 'Medium', question: 'Bereken 30 − (−6) × 4.', checkMode: 'auto', options: ['6', '54', '144', '-54'], correctIndex: 1, explanation: 'Vermenigvuldiging voor aftrekking: −6 × 4 = −24. Dan 30 − (−24) = 30 + 24 = 54.' },
        { difficulty: 'Medium', question: 'Bereken −18 − (−7) + (−5).', checkMode: 'auto', options: ['-30', '-6', '-16', '16'], correctIndex: 2, explanation: 'Werk van links na regs. Stap 1: −18 − (−7) = −18 + 7 = −11. Stap 2: −11 + (−5) = −16.' },
        ...
        { difficulty: 'Easy', question: 'Bereken (−4)².', checkMode: 'auto', options: ['-16', '8', '4', '16'], correctIndex: 3, explanation: '(−4)² = (−4) × (−4). Dieselfde tekens → positief. 4 × 4 = 16. Antwoord: 16.' },
        { difficulty: 'Easy', question: 'Bereken (−3)³.', checkMode: 'auto', options: ['-27', '27', '9', '-9'], correctIndex: 0, explanation: '(−3)³ = (−3) × (−3) × (−3) = 9 × (−3) = −27 (ʼn onewe mag van ʼn negatiewe getal is negatief).' },
        { difficulty: 'Medium', question: 'Bereken (−2)² − (−3)³.', checkMode: 'auto', options: ['-23', '31', '-31', '22'], correctIndex: 1, explanation: 'Stap 1: (−2)² = 4. Stap 2: (−3)³ = −27. Stap 3: 4 − (−27) = 4 + 27 = 31.' },
        { difficulty: 'Hard', question: 'Bereken −5² + (−2)³.', checkMode: 'auto', options: ['17', '-41', '-33', '33'], correctIndex: 2, explanation: 'Geen hakies om −5 nie, dus geld die eksponent eerste: 5² = 25, dan −5² = −25. Volgende (−2)³ = −8. Laastens −25 + (−8) = −33.' },
        { difficulty: 'Medium', question: 'Gebruik die korrekte bewerkingsorde om 4 × (−3) + (−2)² te bereken.', checkMode: 'auto', options: ['8', '-16', '16', '-8'], correctIndex: 3, explanation: 'Eksponente en vermenigvuldiging voor optelling. Stap 1: 4 × (−3) = −12. Stap 2: (−2)² = 4. Stap 3: −12 + 4 = −8.' },
        { difficulty: 'Medium', question: 'Gebruik die korrekte bewerkingsorde om (−6 + 2)² − 10 te bereken.', checkMode: 'auto', options: ['6', '-26', '26', '-6'], correctIndex: 0, explanation: 'Hakies eerste: −6 + 2 = −4. Dan die eksponent: (−4)² = 16. Laastens 16 − 10 = 6.' },
        { difficulty: 'Medium-Hard', question: 'Gebruik die korrekte bewerkingsorde om −3 × (4 − (−2)) te bereken.', checkMode: 'auto', options: ['-6', '-18', '18', '-30'], correctIndex: 1, explanation: 'Hakies eerste: 4 − (−2) = 4 + 2 = 6. Dan −3 × 6 = −18 (verskillende tekens → negatief).' },
        { difficulty: 'Hard', question: 'Gebruik die korrekte bewerkingsorde om (10 − (−2)) ÷ (−3) + (−4)² te bereken.', checkMode: 'auto', options: ['-20', '20', '12', '8'], correctIndex: 2, explanation: 'Hakies eerste: 10 − (−2) = 12. Dan deling: 12 ÷ (−3) = −4. Dan die eksponent: (−4)² = 16. Laastens −4 + 16 = 12.' },
        { difficulty: 'Medium', question: 'Bereken √81 + (−3)³.', checkMode: 'auto', options: ['36', '18', '0', '-18'], correctIndex: 3, explanation: 'Stap 1: √81 = 9 (aangesien 9 × 9 = 81). Stap 2: (−3)³ = −27. Stap 3: 9 + (−27) = −18.' },
        { difficulty: 'Hard', question: 'Bereken ∛(−27) − (−5)².', checkMode: 'auto', options: ['-28', '22', '28', '-22'], correctIndex: 0, explanation: 'Stap 1: ∛(−27) = −3 (aangesien (−3) × (−3) × (−3) = −27). Stap 2: (−5)² = 25. Stap 3: −3 − 25 = −28.' },
        { difficulty: 'Hard', question: 'Bereken (−2)³ × √16.', checkMode: 'auto', options: ['32', '-32', '-16', '16'], correctIndex: 1, explanation: 'Stap 1: (−2)³ = −8. Stap 2: √16 = 4. Stap 3: −8 × 4 = −32 (verskillende tekens → negatief).' },
        { difficulty: 'Medium', question: 'Die temperatuur by ʼn weerstasie was −7°C. Dit het snags nog ʼn verdere 5°C gedaal, en toe teen mid-oggend 9°C gestyg. Wat was die temperatuur teen mid-oggend?', checkMode: 'auto', options: ['7°C', '3°C', '-3°C', '-21°C'], correctIndex: 2, explanation: 'Begin by −7°C, daal 5°C: −7 − 5 = −12°C. Styg dan 9°C: −12 + 9 = −3°C.' },
        { difficulty: 'Medium-Hard', question: 'ʼn Wandelaar begin op ʼn hoogte van −240 m (onder seespieël). Sy klim 85 m, en klim daarna nog ʼn verdere 60 m. Wat is haar finale hoogte, as ʼn heelgetal?', checkMode: 'auto', options: ['-155', '95', '-385', '-95'], correctIndex: 3, explanation: 'Begin by −240 m. Klim 85 m: −240 + 85 = −155 m. Klim ʼn verdere 60 m: −155 + 60 = −95 m.' },
        { difficulty: 'Medium-Hard', question: 'Kagiso se rekening is R680 oorgetrek, geskryf as −R680. Hy maak ʼn deposito van R250, en trek dan nog ʼn verdere R90 uit. Wat is sy nuwe balans?', checkMode: 'auto', options: ['-R520', '-R340', '-R770', 'R520'], correctIndex: 0, explanation: 'Begin by −680. Deposito 250: −680 + 250 = −430. Onttrekking 90: −430 − 90 = −520. Nuwe balans: −R520.' },
        { difficulty: 'Hard', question: 'Bereken die korrekte waarde van −2 × (−6 + 4) − (−3)².', checkMode: 'auto', options: ['13', '-5', '5', '-13'], correctIndex: 1, explanation: 'Hakies eerste: −6 + 4 = −2. Dan vermenigvuldiging: −2 × (−2) = 4. Dan die eksponent: (−3)² = 9. Laastens 4 − 9 = −5.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      name: 'Stel 2',
      questions: [
        { difficulty: 'Medium', question: 'Bereken −17 + (−6) × 5.', checkMode: 'auto', options: ['-47', '13', '-115', '47'], correctIndex: 0, explanation: 'Vermenigvuldiging voor optelling: −6 × 5 = −30 (verskillende tekens → negatief). Dan −17 + (−30) = −47.' },
        { difficulty: 'Medium', question: 'Bereken 25 − (−8) × 3.', checkMode: 'auto', options: ['1', '49', '99', '-49'], correctIndex: 1, explanation: 'Vermenigvuldiging voor aftrekking: −8 × 3 = −24. Dan 25 − (−24) = 25 + 24 = 49.' },
        { difficulty: 'Medium', question: 'Bereken −21 − (−9) + (−6).', checkMode: 'auto', options: ['-36', '-6', '-18', '18'], correctIndex: 2, explanation: 'Werk van links na regs. Stap 1: −21 − (−9) = −21 + 9 = −12. Stap 2: −12 + (−6) = −18.' },
        ...
        { difficulty: 'Easy', question: 'Bereken (−6)².', checkMode: 'auto', options: ['-36', '12', '6', '36'], correctIndex: 3, explanation: '(−6)² = (−6) × (−6). Dieselfde tekens → positief. 6 × 6 = 36. Antwoord: 36.' },
        { difficulty: 'Easy', question: 'Bereken (−4)³.', checkMode: 'auto', options: ['-64', '64', '16', '-16'], correctIndex: 0, explanation: '(−4)³ = (−4) × (−4) × (−4) = 16 × (−4) = −64 (ʼn onewe mag van ʼn negatiewe getal is negatief).' },
        { difficulty: 'Medium', question: 'Bereken (−3)² − (−2)³.', checkMode: 'auto', options: ['1', '17', '-17', '15'], correctIndex: 1, explanation: 'Stap 1: (−3)² = 9. Stap 2: (−2)³ = −8. Stap 3: 9 − (−8) = 9 + 8 = 17.' },
        { difficulty: 'Hard', question: 'Bereken −6² + (−3)³.', checkMode: 'auto', options: ['9', '-45', '-63', '63'], correctIndex: 2, explanation: 'Geen hakies om −6 nie, dus geld die eksponent eerste: 6² = 36, dan −6² = −36. Volgende (−3)³ = −27. Laastens −36 + (−27) = −63.' },
        { difficulty: 'Medium', question: 'Gebruik die korrekte bewerkingsorde om 5 × (−2) + (−3)² te bereken.', checkMode: 'auto', options: ['1', '-19', '19', '-1'], correctIndex: 3, explanation: 'Eksponente en vermenigvuldiging voor optelling. Stap 1: 5 × (−2) = −10. Stap 2: (−3)² = 9. Stap 3: −10 + 9 = −1.' },
        { difficulty: 'Medium', question: 'Gebruik die korrekte bewerkingsorde om (−7 + 3)² − 12 te bereken.', checkMode: 'auto', options: ['4', '-28', '-4', '28'], correctIndex: 0, explanation: 'Hakies eerste: −7 + 3 = −4. Dan die eksponent: (−4)² = 16. Laastens 16 − 12 = 4.' },
        { difficulty: 'Medium-Hard', question: 'Gebruik die korrekte bewerkingsorde om −4 × (5 − (−3)) te bereken.', checkMode: 'auto', options: ['-8', '-32', '32', '-40'], correctIndex: 1, explanation: 'Hakies eerste: 5 − (−3) = 5 + 3 = 8. Dan −4 × 8 = −32 (verskillende tekens → negatief).' },
        { difficulty: 'Hard', question: 'Gebruik die korrekte bewerkingsorde om (18 − (−6)) ÷ (−4) + (−3)² te bereken.', checkMode: 'auto', options: ['15', '-15', '3', '-3'], correctIndex: 2, explanation: 'Hakies eerste: 18 − (−6) = 24. Dan deling: 24 ÷ (−4) = −6. Dan die eksponent: (−3)² = 9. Laastens −6 + 9 = 3.' },
        { difficulty: 'Medium', question: 'Bereken √64 + (−2)³.', checkMode: 'auto', options: ['16', '-16', '4', '0'], correctIndex: 3, explanation: 'Stap 1: √64 = 8 (aangesien 8 × 8 = 64). Stap 2: (−2)³ = −8. Stap 3: 8 + (−8) = 0.' },
        { difficulty: 'Hard', question: 'Bereken ∛(−8) − (−4)².', checkMode: 'auto', options: ['-18', '14', '18', '-14'], correctIndex: 0, explanation: 'Stap 1: ∛(−8) = −2 (aangesien (−2) × (−2) × (−2) = −8). Stap 2: (−4)² = 16. Stap 3: −2 − 16 = −18.' },
        { difficulty: 'Hard', question: 'Bereken (−3)³ × √9.', checkMode: 'auto', options: ['81', '-81', '-243', '-27'], correctIndex: 1, explanation: 'Stap 1: (−3)³ = −27. Stap 2: √9 = 3. Stap 3: −27 × 3 = −81 (verskillende tekens → negatief).' },
        { difficulty: 'Medium', question: 'Die temperatuur by ʼn weerstasie was −9°C. Dit het snags nog ʼn verdere 6°C gedaal, en toe teen mid-oggend 14°C gestyg. Wat was die temperatuur teen mid-oggend?', checkMode: 'auto', options: ['11°C', '1°C', '-1°C', '-15°C'], correctIndex: 2, explanation: 'Begin by −9°C, daal 6°C: −9 − 6 = −15°C. Styg dan 14°C: −15 + 14 = −1°C.' },
        { difficulty: 'Medium-Hard', question: 'ʼn Wandelaar begin op ʼn hoogte van −310 m (onder seespieël). Sy klim 120 m, en klim daarna nog ʼn verdere 45 m. Wat is haar finale hoogte, as ʼn heelgetal?', checkMode: 'auto', options: ['-190', '145', '-475', '-145'], correctIndex: 3, explanation: 'Begin by −310 m. Klim 120 m: −310 + 120 = −190 m. Klim ʼn verdere 45 m: −190 + 45 = −145 m.' },
        { difficulty: 'Medium-Hard', question: 'Naledi se rekening is R540 oorgetrek, geskryf as −R540. Sy maak ʼn deposito van R300, en trek dan nog ʼn verdere R120 uit. Wat is haar nuwe balans?', checkMode: 'auto', options: ['-R360', '-R120', '-R660', 'R360'], correctIndex: 0, explanation: 'Begin by −540. Deposito 300: −540 + 300 = −240. Onttrekking 120: −240 − 120 = −360. Nuwe balans: −R360.' },
        { difficulty: 'Hard', question: 'Bereken die korrekte waarde van −3 × (−8 + 5) − (−2)².', checkMode: 'auto', options: ['13', '5', '-5', '-13'], correctIndex: 1, explanation: 'Hakies eerste: −8 + 5 = −3. Dan vermenigvuldiging: −3 × (−3) = 9. Dan die eksponent: (−2)² = 4. Laastens 9 − 4 = 5.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      name: 'Stel 3',
      questions: [
        { difficulty: 'Medium', question: 'Bereken −20 + (−8) × 3.', checkMode: 'auto', options: ['-44', '4', '-84', '44'], correctIndex: 0, explanation: 'Vermenigvuldiging voor optelling: −8 × 3 = −24 (verskillende tekens → negatief). Dan −20 + (−24) = −44.' },
        { difficulty: 'Medium', question: 'Bereken 18 − (−9) × 5.', checkMode: 'auto', options: ['-27', '63', '135', '-63'], correctIndex: 1, explanation: 'Vermenigvuldiging voor aftrekking: −9 × 5 = −45. Dan 18 − (−45) = 18 + 45 = 63.' },
        { difficulty: 'Medium', question: 'Bereken −14 − (−8) + (−11).', checkMode: 'auto', options: ['-33', '5', '-17', '17'], correctIndex: 2, explanation: 'Werk van links na regs. Stap 1: −14 − (−8) = −14 + 8 = −6. Stap 2: −6 + (−11) = −17.' },
        ...
        { difficulty: 'Easy', question: 'Bereken (−7)².', checkMode: 'auto', options: ['-49', '14', '7', '49'], correctIndex: 3, explanation: '(−7)² = (−7) × (−7). Dieselfde tekens → positief. 7 × 7 = 49. Antwoord: 49.' },
        { difficulty: 'Easy', question: 'Bereken (−5)³.', checkMode: 'auto', options: ['-125', '125', '25', '-25'], correctIndex: 0, explanation: '(−5)³ = (−5) × (−5) × (−5) = 25 × (−5) = −125 (ʼn onewe mag van ʼn negatiewe getal is negatief).' },
        { difficulty: 'Medium', question: 'Bereken (−4)² − (−2)³.', checkMode: 'auto', options: ['8', '24', '-24', '22'], correctIndex: 1, explanation: 'Stap 1: (−4)² = 16. Stap 2: (−2)³ = −8. Stap 3: 16 − (−8) = 16 + 8 = 24.' },
        { difficulty: 'Hard', question: 'Bereken −4² + (−3)³.', checkMode: 'auto', options: ['-11', '-25', '-43', '43'], correctIndex: 2, explanation: 'Geen hakies om −4 nie, dus geld die eksponent eerste: 4² = 16, dan −4² = −16. Volgende (−3)³ = −27. Laastens −16 + (−27) = −43.' },
        { difficulty: 'Medium', question: 'Gebruik die korrekte bewerkingsorde om 6 × (−3) + (−4)² te bereken.', checkMode: 'auto', options: ['2', '-34', '34', '-2'], correctIndex: 3, explanation: 'Eksponente en vermenigvuldiging voor optelling. Stap 1: 6 × (−3) = −18. Stap 2: (−4)² = 16. Stap 3: −18 + 16 = −2.' },
        { difficulty: 'Medium', question: 'Gebruik die korrekte bewerkingsorde om (−5 + 1)² − 8 te bereken.', checkMode: 'auto', options: ['8', '-24', '-8', '28'], correctIndex: 0, explanation: 'Hakies eerste: −5 + 1 = −4. Dan die eksponent: (−4)² = 16. Laastens 16 − 8 = 8.' },
        { difficulty: 'Medium-Hard', question: 'Gebruik die korrekte bewerkingsorde om −5 × (6 − (−1)) te bereken.', checkMode: 'auto', options: ['-25', '-35', '35', '-30'], correctIndex: 1, explanation: 'Hakies eerste: 6 − (−1) = 6 + 1 = 7. Dan −5 × 7 = −35 (verskillende tekens → negatief).' },
        { difficulty: 'Hard', question: 'Gebruik die korrekte bewerkingsorde om (14 − (−4)) ÷ (−3) + (−5)² te bereken.', checkMode: 'auto', options: ['31', '-31', '19', '-19'], correctIndex: 2, explanation: 'Hakies eerste: 14 − (−4) = 18. Dan deling: 18 ÷ (−3) = −6. Dan die eksponent: (−5)² = 25. Laastens −6 + 25 = 19.' },
        { difficulty: 'Medium', question: 'Bereken √100 + (−4)³.', checkMode: 'auto', options: ['74', '-6', '54', '-54'], correctIndex: 3, explanation: 'Stap 1: √100 = 10 (aangesien 10 × 10 = 100). Stap 2: (−4)³ = −64. Stap 3: 10 + (−64) = −54.' },
        { difficulty: 'Hard', question: 'Bereken ∛(−64) − (−3)².', checkMode: 'auto', options: ['-13', '5', '13', '-5'], correctIndex: 0, explanation: 'Stap 1: ∛(−64) = −4 (aangesien (−4) × (−4) × (−4) = −64). Stap 2: (−3)² = 9. Stap 3: −4 − 9 = −13.' },
        { difficulty: 'Hard', question: 'Bereken (−1)³ × √25.', checkMode: 'auto', options: ['5', '-5', '-25', '25'], correctIndex: 1, explanation: 'Stap 1: (−1)³ = −1. Stap 2: √25 = 5. Stap 3: −1 × 5 = −5 (verskillende tekens → negatief).' },
        { difficulty: 'Medium', question: 'Die temperatuur by ʼn weerstasie was −11°C. Dit het snags nog ʼn verdere 4°C gedaal, en toe teen mid-oggend 19°C gestyg. Wat was die temperatuur teen mid-oggend?', checkMode: 'auto', options: ['-4°C', '-15°C', '4°C', '12°C'], correctIndex: 2, explanation: 'Begin by −11°C, daal 4°C: −11 − 4 = −15°C. Styg dan 19°C: −15 + 19 = 4°C.' },
        { difficulty: 'Medium-Hard', question: 'ʼn Wandelaar begin op ʼn hoogte van −180 m (onder seespieël). Sy klim 95 m, en klim daarna nog ʼn verdere 40 m. Wat is haar finale hoogte, as ʼn heelgetal?', checkMode: 'auto', options: ['-85', '45', '-315', '-45'], correctIndex: 3, explanation: 'Begin by −180 m. Klim 95 m: −180 + 95 = −85 m. Klim ʼn verdere 40 m: −85 + 40 = −45 m.' },
        { difficulty: 'Medium-Hard', question: 'Thandeka se rekening is R415 oorgetrek, geskryf as −R415. Sy maak ʼn deposito van R275, en trek dan nog ʼn verdere R160 uit. Wat is haar nuwe balans?', checkMode: 'auto', options: ['-R300', 'R20', '-R575', 'R300'], correctIndex: 0, explanation: 'Begin by −415. Deposito 275: −415 + 275 = −140. Onttrekking 160: −140 − 160 = −300. Nuwe balans: −R300.' },
        { difficulty: 'Hard', question: 'Bereken die korrekte waarde van −4 × (−9 + 6) − (−5)².', checkMode: 'auto', options: ['37', '-13', '13', '-37'], correctIndex: 1, explanation: 'Hakies eerste: −9 + 6 = −3. Dan vermenigvuldiging: −4 × (−3) = 12. Dan die eksponent: (−5)² = 25. Laastens 12 − 25 = −13.' },
