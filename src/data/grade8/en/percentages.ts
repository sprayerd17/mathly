  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'A tablet increases in price by 15% to R552. Find the original price.', checkMode: 'auto', options: ['R480', 'R469', 'R635', 'R649'], correctIndex: 0, explanation: 'New price = 115% of original.\nOriginal = 552 ÷ 1.15 = R480.\nCheck: 480 × 1.15 = 552 ✓' },
        { difficulty: 'Medium', question: 'After a 10% discount, a jacket costs R522. Find the original price of the jacket.', checkMode: 'auto', options: ['R574', 'R580', 'R470', 'R475'], correctIndex: 1, explanation: 'New price = 90% of original.\nOriginal = 522 ÷ 0.9 = R580.\nCheck: 580 × 0.9 = 522 ✓' },
        { difficulty: 'Medium', question: "A club's membership grew by 20% to 840 members this year. Find last year's membership.", checkMode: 'auto', options: ['672', '1 008', '700', '1 050'], correctIndex: 2, explanation: 'New total = 120% of original.\nOriginal = 840 ÷ 1.2 = 700 members.\nCheck: 700 × 1.2 = 840 ✓' },

        // Block 2 — Calculating the new amount directly (3-6)
        { difficulty: 'Easy', question: "Zanele's salary of R6 500 increases by 9%. Use the one-step multiplier to find her new salary.", checkMode: 'auto', options: ['R5 915', 'R7 020', 'R7 670', 'R7 085'], correctIndex: 3, explanation: 'Multiplier for a 9% increase = 1.09.\nNew salary = 6 500 × 1.09 = R7 085 ✓' },
        { difficulty: 'Medium', question: 'A generator priced at R3 400 is discounted by 18%. Find the sale price using a single multiplier.', checkMode: 'auto', options: ['R2 788', 'R4 012', 'R2 822', 'R2 176'], correctIndex: 0, explanation: 'Multiplier for an 18% decrease = 0.82.\nSale price = 3 400 × 0.82 = R2 788 ✓' },
        { difficulty: 'Medium', question: 'A game reserve had 12 500 animals. Over three years, careful conservation increased the population by 24%. Find the new population.', checkMode: 'auto', options: ['9 500', '15 500', '15 375', '18 500'], correctIndex: 1, explanation: 'Multiplier for a 24% increase = 1.24.\nNew population = 12 500 × 1.24 = 15 500 animals ✓' },
        ...
        { difficulty: 'Easy', question: "A learner's spelling test mark rose from 65 to 78 (both out of 100). Find the percentage increase relative to the original mark.", checkMode: 'auto', options: ['17%', '18%', '20%', '25%'], correctIndex: 2, explanation: 'Increase = 78 − 65 = 13.\nPercentage increase = 13 ÷ 65 × 100 = 20% ✓' },
        { difficulty: 'Medium', question: "A shop's weekly sales fell from R450 000 to R360 000. Find the percentage decrease.", checkMode: 'auto', options: ['25%', '22%', '15%', '20%'], correctIndex: 3, explanation: 'Decrease = 450 000 − 360 000 = 90 000.\nPercentage decrease = 90 000 ÷ 450 000 × 100 = 20% ✓' },
        { difficulty: 'Medium', question: 'A water tank held 120 litres and now holds 150 litres after rain. Find the percentage increase in the amount of water.', checkMode: 'auto', options: ['25%', '20%', '23%', '30%'], correctIndex: 0, explanation: 'Increase = 150 − 120 = 30.\nPercentage increase = 30 ÷ 120 × 100 = 25% ✓' },

        // Block 4 — Discount / markup / VAT word problems, Rand contexts (10-13)
        { difficulty: 'Medium', question: 'A washing machine has a pre-VAT price of R780. Find the total price once 15% VAT is added.', checkMode: 'auto', options: ['R663', 'R897', 'R889', 'R1 014'], correctIndex: 1, explanation: 'VAT = 15% of R780: 0.15 × 780 = R117.\nTotal = 780 + 117 = R897 ✓' },
        { difficulty: 'Medium', question: 'A wholesaler buys crates of eggs for R250 each and marks the price up by 50% to sell to a supermarket. Find the selling price per crate.', checkMode: 'auto', options: ['R125', 'R350', 'R375', 'R500'], correctIndex: 2, explanation: 'Mark-up = 50% of R250: 0.50 × 250 = R125.\nSelling price = 250 + 125 = R375 ✓' },
        ...
        { difficulty: 'Hard', question: 'A catering company charges R620 for a function before adding a 15% service fee. Find the total amount the client pays.', checkMode: 'auto', options: ['R527', 'R707', 'R806', 'R713'], correctIndex: 3, explanation: 'Service fee = 15% of R620: 0.15 × 620 = R93.\nTotal = 620 + 93 = R713 ✓' },

        // Block 5 — Multi-step successive percentage-change chains (14-16)
        { difficulty: 'Hard', question: 'A plot of land valued at R5 000 increases in value by 20%, and the following year the new value decreases by 10%. Find the value after both changes.', checkMode: 'auto', options: ['R5 400', 'R5 500', 'R6 600', 'R6 000'], correctIndex: 0, explanation: 'After the 20% increase: 5 000 × 1.20 = R6 000.\nAfter the 10% decrease on the new value: 6 000 × 0.90 = R5 400 ✓' },
        { difficulty: 'Hard', question: 'A second-hand car priced at R2 000 is discounted by 30% for a quick sale, then the dealer raises the discounted price by 20% the next month. Find the final price.', checkMode: 'auto', options: ['R1 800', 'R1 680', 'R1 120', 'R1 400'], correctIndex: 1, explanation: 'After the 30% decrease: 2 000 × 0.70 = R1 400.\nAfter the 20% increase on the new price: 1 400 × 1.20 = R1 680 ✓' },
        { difficulty: 'Hard', question: "An investment of R4 000 grows by 10% in the first year, then the new balance grows by a further 10% in the second year. Find the final balance.", checkMode: 'auto', options: ['R4 800', 'R4 400', 'R4 840', 'R4 040'], correctIndex: 2, explanation: 'After year 1: 4 000 × 1.10 = R4 400.\nAfter year 2 (10% of the new balance): 4 400 × 1.10 = R4 840 ✓' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // Block 1 — Finding the original amount (0-2)
        { difficulty: 'Easy', question: 'A pair of sneakers increases in price by 25% to R875. Find the original price.', checkMode: 'auto', options: ['R656', 'R1 094', 'R1 167', 'R700'], correctIndex: 3, explanation: 'New price = 125% of original.\nOriginal = 875 ÷ 1.25 = R700.\nCheck: 700 × 1.25 = 875 ✓' },
        { difficulty: 'Medium', question: 'After a 15% discount, a heater costs R578. Find the original price of the heater.', checkMode: 'auto', options: ['R680', 'R665', 'R491', 'R503'], correctIndex: 0, explanation: 'New price = 85% of original.\nOriginal = 578 ÷ 0.85 = R680.\nCheck: 680 × 0.85 = 578 ✓' },
        { difficulty: 'Medium', question: "A choir's membership grew by 12% to 896 singers this year. Find last year's membership.", checkMode: 'auto', options: ['788', '800', '1 004', '1 018'], correctIndex: 1, explanation: 'New total = 112% of original.\nOriginal = 896 ÷ 1.12 = 800 singers.\nCheck: 800 × 1.12 = 896 ✓' },

        // Block 2 — Calculating the new amount directly (3-6)
        { difficulty: 'Easy', question: "Bongani's salary of R7 200 increases by 7%. Use the one-step multiplier to find his new salary.", checkMode: 'auto', options: ['R6 696', 'R7 632', 'R7 704', 'R8 208'], correctIndex: 2, explanation: 'Multiplier for a 7% increase = 1.07.\nNew salary = 7 200 × 1.07 = R7 704 ✓' },
        { difficulty: 'Medium', question: 'A drone priced at R2 600 is discounted by 35%. Find the sale price using a single multiplier.', checkMode: 'auto', options: ['R3 510', 'R1 716', 'R780', 'R1 690'], correctIndex: 3, explanation: 'Multiplier for a 35% decrease = 0.65.\nSale price = 2 600 × 0.65 = R1 690 ✓' },
        { difficulty: 'Medium', question: 'A nature reserve had 9 800 trees. Over five years, a planting programme increased the number of trees by 15%. Find the new number of trees.', checkMode: 'auto', options: ['11 270', '8 330', '11 172', '12 740'], correctIndex: 0, explanation: 'Multiplier for a 15% increase = 1.15.\nNew total = 9 800 × 1.15 = 11 270 trees ✓' },
        ...
        // Block 3 — Expressing a change as a percentage (7-9)
        { difficulty: 'Easy', question: "A learner's mathematics mark rose from 80 to 92 (both out of 100). Find the percentage increase relative to the original mark.", checkMode: 'auto', options: ['13%', '15%', '16%', '20%'], correctIndex: 1, explanation: 'Increase = 92 − 80 = 12.\nPercentage increase = 12 ÷ 80 × 100 = 15% ✓' },
        { difficulty: 'Medium', question: "A factory's monthly output fell from 560 units to 420 units. Find the percentage decrease.", checkMode: 'auto', options: ['33%', '23%', '25%', '30%'], correctIndex: 2, explanation: 'Decrease = 560 − 420 = 140.\nPercentage decrease = 140 ÷ 560 × 100 = 25% ✓' },
        { difficulty: 'Medium', question: 'A community vegetable garden produced 150 kg of produce last season and 198 kg this season. Find the percentage increase in produce.', checkMode: 'auto', options: ['24%', '33%', '40%', '32%'], correctIndex: 3, explanation: 'Increase = 198 − 150 = 48.\nPercentage increase = 48 ÷ 150 × 100 = 32% ✓' },

        // Block 4 — Discount / markup / VAT word problems, Rand contexts (10-13)
        { difficulty: 'Medium', question: 'A fridge has a pre-VAT price of R640. Find the total price once 15% VAT is added.', checkMode: 'auto', options: ['R736', 'R544', 'R730', 'R832'], correctIndex: 0, explanation: 'VAT = 15% of R640: 0.15 × 640 = R96.\nTotal = 640 + 96 = R736 ✓' },
        { difficulty: 'Medium', question: 'A wholesaler buys boxes of tiles for R400 each and marks the price up by 35% to sell to a hardware store. Find the selling price per box.', checkMode: 'auto', options: ['R260', 'R540', 'R500', 'R680'], correctIndex: 1, explanation: 'Mark-up = 35% of R400: 0.35 × 400 = R140.\nSelling price = 400 + 140 = R540 ✓' },
        ...
        { difficulty: 'Hard', question: 'An events company charges R950 for a booking before adding a 12% service fee. Find the total amount the client pays.', checkMode: 'auto', options: ['R836', 'R1 055', 'R1 064', 'R1 178'], correctIndex: 2, explanation: 'Service fee = 12% of R950: 0.12 × 950 = R114.\nTotal = 950 + 114 = R1 064 ✓' },

        // Block 5 — Multi-step successive percentage-change chains (14-16)
        { difficulty: 'Hard', question: 'A share priced at R3 000 increases in value by 30%, and the following month the new value decreases by 20%. Find the value after both changes.', checkMode: 'auto', options: ['R3 300', 'R4 680', 'R3 900', 'R3 120'], correctIndex: 3, explanation: 'After the 30% increase: 3 000 × 1.30 = R3 900.\nAfter the 20% decrease on the new value: 3 900 × 0.80 = R3 120 ✓' },
        { difficulty: 'Hard', question: 'A motorbike priced at R1 600 is discounted by 25% for a quick sale, then the dealer raises the discounted price by 40% the next month. Find the final price.', checkMode: 'auto', options: ['R1 680', 'R1 840', 'R720', 'R1 200'], correctIndex: 0, explanation: 'After the 25% decrease: 1 600 × 0.75 = R1 200.\nAfter the 40% increase on the new price: 1 200 × 1.40 = R1 680 ✓' },
        { difficulty: 'Hard', question: "A savings balance of R5 000 falls by 20% in a difficult month, then the new balance falls by a further 20% the next month. Find the final balance.", checkMode: 'auto', options: ['R3 000', 'R3 200', 'R4 000', 'R4 800'], correctIndex: 1, explanation: 'After month 1: 5 000 × 0.80 = R4 000.\nAfter month 2 (20% of the new balance): 4 000 × 0.80 = R3 200 ✓' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // Block 1 — Finding the original amount (0-2)
        { difficulty: 'Easy', question: 'A microwave increases in price by 18% to R1 180. Find the original price.', checkMode: 'auto', options: ['R968', 'R1 392', 'R1 000', 'R1 439'], correctIndex: 2, explanation: 'New price = 118% of original.\nOriginal = 1 180 ÷ 1.18 = R1 000.\nCheck: 1 000 × 1.18 = 1 180 ✓' },
        { difficulty: 'Medium', question: 'After a 40% discount, a coat costs R450. Find the original price of the coat.', checkMode: 'auto', options: ['R630', 'R270', 'R321', 'R750'], correctIndex: 3, explanation: 'New price = 60% of original.\nOriginal = 450 ÷ 0.6 = R750.\nCheck: 750 × 0.6 = 450 ✓' },
        { difficulty: 'Medium', question: "A soccer club's fan base grew by 35% to 945 members this year. Find last year's fan base.", checkMode: 'auto', options: ['700', '614', '1 276', '1 454'], correctIndex: 0, explanation: 'New total = 135% of original.\nOriginal = 945 ÷ 1.35 = 700 members.\nCheck: 700 × 1.35 = 945 ✓' },

        // Block 2 — Calculating the new amount directly (3-6)
        { difficulty: 'Easy', question: "Nomsa's salary of R8 400 increases by 11%. Use the one-step multiplier to find her new salary.", checkMode: 'auto', options: ['R7 476', 'R9 324', 'R9 240', 'R10 248'], correctIndex: 1, explanation: 'Multiplier for an 11% increase = 1.11.\nNew salary = 8 400 × 1.11 = R9 324 ✓' },
        { difficulty: 'Medium', question: 'A washing machine priced at R5 600 is discounted by 22%. Find the sale price using a single multiplier.', checkMode: 'auto', options: ['R6 832', 'R4 424', 'R4 368', 'R3 136'], correctIndex: 2, explanation: 'Multiplier for a 22% decrease = 0.78.\nSale price = 5 600 × 0.78 = R4 368 ✓' },
        { difficulty: 'Medium', question: 'A wildlife sanctuary had 7 500 hectares of protected land. Over four years, new donations increased the protected area by 32%. Find the new area.', checkMode: 'auto', options: ['5 100', '9 825', '12 300', '9 900'], correctIndex: 3, explanation: 'Multiplier for a 32% increase = 1.32.\nNew area = 7 500 × 1.32 = 9 900 hectares ✓' },
        ...
        // Block 3 — Expressing a change as a percentage (7-9)
        { difficulty: 'Easy', question: "A learner's science mark rose from 40 to 54 (both out of 100). Find the percentage increase relative to the original mark.", checkMode: 'auto', options: ['35%', '26%', '38%', '30%'], correctIndex: 0, explanation: 'Increase = 54 − 40 = 14.\nPercentage increase = 14 ÷ 40 × 100 = 35% ✓' },
        { difficulty: 'Medium', question: "A store's daily footfall fell from 720 customers to 540 customers. Find the percentage decrease.", checkMode: 'auto', options: ['33%', '25%', '24%', '20%'], correctIndex: 1, explanation: 'Decrease = 720 − 540 = 180.\nPercentage decrease = 180 ÷ 720 × 100 = 25% ✓' },
        { difficulty: 'Medium', question: 'A dam held 250 million litres of water and now holds 300 million litres after heavy rain. Find the percentage increase in water stored.', checkMode: 'auto', options: ['17%', '24%', '20%', '25%'], correctIndex: 2, explanation: 'Increase = 300 − 250 = 50.\nPercentage increase = 50 ÷ 250 × 100 = 20% ✓' },

        // Block 4 — Discount / markup / VAT word problems, Rand contexts (10-13)
        { difficulty: 'Medium', question: 'A laptop has a pre-VAT price of R860. Find the total price once 15% VAT is added.', checkMode: 'auto', options: ['R731', 'R980', 'R1 118', 'R989'], correctIndex: 3, explanation: 'VAT = 15% of R860: 0.15 × 860 = R129.\nTotal = 860 + 129 = R989 ✓' },
        { difficulty: 'Medium', question: 'A wholesaler buys sets of tools for R480 each and marks the price up by 25% to sell to a hardware store. Find the selling price per set.', checkMode: 'auto', options: ['R600', 'R360', 'R576', 'R720'], correctIndex: 0, explanation: 'Mark-up = 25% of R480: 0.25 × 480 = R120.\nSelling price = 480 + 120 = R600 ✓' },
        ...
        { difficulty: 'Hard', question: 'A photography studio charges R750 for a shoot before adding an 18% service fee. Find the total amount the client pays.', checkMode: 'auto', options: ['R615', 'R885', 'R878', 'R1 020'], correctIndex: 1, explanation: 'Service fee = 18% of R750: 0.18 × 750 = R135.\nTotal = 750 + 135 = R885 ✓' },

        // Block 5 — Multi-step successive percentage-change chains (14-16)
        { difficulty: 'Hard', question: 'A workshop valued at R4 000 increases in value by 15%, and the following year the new value decreases by 15%. Find the value after both changes.', checkMode: 'auto', options: ['R4 000', 'R5 290', 'R3 910', 'R4 600'], correctIndex: 2, explanation: 'After the 15% increase: 4 000 × 1.15 = R4 600.\nAfter the 15% decrease on the new value: 4 600 × 0.85 = R3 910 ✓' },
        { difficulty: 'Hard', question: 'A trailer priced at R3 000 is discounted by 10% for a quick sale, then the dealer raises the discounted price by 30% the next month. Find the final price.', checkMode: 'auto', options: ['R3 600', 'R1 890', 'R2 700', 'R3 510'], correctIndex: 3, explanation: 'After the 10% decrease: 3 000 × 0.90 = R2 700.\nAfter the 30% increase on the new price: 2 700 × 1.30 = R3 510 ✓' },
        { difficulty: 'Hard', question: "An investment of R1 600 grows by 25% in the first year, then the new balance grows by a further 25% in the second year. Find the final balance.", checkMode: 'auto', options: ['R2 500', 'R2 400', 'R2 000', 'R1 700'], correctIndex: 0, explanation: 'After year 1: 1 600 × 1.25 = R2 000.\nAfter year 2 (25% of the new balance): 2 000 × 1.25 = R2 500 ✓' },
