  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'Calculate: 8 + 6 × 5', checkMode: 'auto', options: ['38', '70', '30', '37'], correctIndex: 0, explanation: 'Multiplication before addition: 6 × 5 = 30, then 8 + 30 = 38 ✓' },
        { difficulty: 'Easy', question: 'Calculate: (14 − 6) × 3 + 7', checkMode: 'auto', options: ['24', '31', '3', '32'], correctIndex: 1, explanation: 'Brackets first: 14 − 6 = 8. Then multiply: 8 × 3 = 24. Then add: 24 + 7 = 31 ✓' },
        { difficulty: 'Medium', question: 'Calculate: 40 − 24 ÷ 4 + 2 × 3', checkMode: 'auto', options: ['18', '34', '40', '41'], correctIndex: 2, explanation: 'Division and multiplication first: 24 ÷ 4 = 6 and 2 × 3 = 6. Then work left to right: 40 − 6 + 6 = 34 + 6 = 40 ✓' },
        { difficulty: 'Medium', question: 'Calculate: 3² + 4 × 5', checkMode: 'auto', options: ['26', '65', '28', '29'], correctIndex: 3, explanation: 'Powers first: 3² = 9. Then multiplication: 4 × 5 = 20. Then add: 9 + 20 = 29 ✓' },
        ...
        { difficulty: 'Medium', question: 'Use the associative property to calculate (7 × 25) × 4 by regrouping to make the calculation easier. What is the answer?', checkMode: 'auto', options: ['700', '680', '175', '710'], correctIndex: 0, explanation: 'Associative property lets us regroup: 7 × (25 × 4) = 7 × 100 = 700. Calculating the original way also gives (7 × 25) × 4 = 175 × 4 = 700 ✓' },
        { difficulty: 'Medium', question: 'Use the distributive property to calculate 12 × (20 − 3).', checkMode: 'auto', options: ['276', '204', '240', '214'], correctIndex: 1, explanation: 'Distribute: 12 × (20 − 3) = (12 × 20) − (12 × 3) = 240 − 36 = 204 ✓' },
        ...
        { difficulty: 'Medium', question: 'Bongani calculates 30 − (10 − 4) by ignoring the brackets and writing 30 − 10 − 4 = 16. What is the correct answer?', checkMode: 'auto', options: ['16', '25', '24', '36'], correctIndex: 2, explanation: 'Brackets must be evaluated first: 10 − 4 = 6, then 30 − 6 = 24. Bongani\'s method of removing the brackets is incorrect ✓' },
        ...
        { difficulty: 'Easy', question: 'Thabo buys 4 packs of apples with 12 apples in each pack. He eats 9 apples. How many apples does he have left?', checkMode: 'auto', options: ['48', '7', '38', '39'], correctIndex: 3, explanation: 'Total apples = 4 × 12 = 48. Apples left = 48 − 9 = 39 ✓' },
        { difficulty: 'Medium', question: 'A cinema sells 45 child tickets at R15 each and 12 adult tickets at R25 each. What is the total amount collected?', checkMode: 'auto', options: ['R975', 'R675', 'R925', 'R965'], correctIndex: 0, explanation: 'Child tickets: 45 × R15 = R675. Adult tickets: 12 × R25 = R300. Total = R675 + R300 = R975 ✓' },
        { difficulty: 'Medium', question: 'A stationery shop has 6 boxes of 24 pencils. The shop sells 38 pencils. How many pencils are left?', checkMode: 'auto', options: ['144', '106', '116', '102'], correctIndex: 1, explanation: 'Total pencils = 6 × 24 = 144. Pencils left = 144 − 38 = 106 ✓' },
        { difficulty: 'Hard', question: 'A school hires 8 buses that each carry 54 learners, and 3 minibuses that each carry 29 learners, for a trip. How many learners can travel in total?', checkMode: 'auto', options: ['432', '529', '519', '509'], correctIndex: 2, explanation: 'Buses: 8 × 54 = 432. Minibuses: 3 × 29 = 87. Total = 432 + 87 = 519 ✓' },

        // Block 5 — Large-number multi-step calculations
        { difficulty: 'Medium', question: 'A factory produces 4 500 items on Monday and Tuesday combined at the same daily rate, plus a separate batch of 3 200 items already in stock. If it produced 4 500 items per day for those two days, calculate: 3 200 + 4 500 × 2.', checkMode: 'auto', options: ['15400', '7700', '12100', '12200'], correctIndex: 3, explanation: 'Multiplication first: 4 500 × 2 = 9 000. Then add: 3 200 + 9 000 = 12 200 ✓' },
        { difficulty: 'Hard', question: 'A farmer harvests 1 250 kg of maize per hectare from 8 hectares, then sells 3 600 kg at the local market. How many kilograms of maize remain?', checkMode: 'auto', options: ['6400', '10000', '5400', '6500'], correctIndex: 0, explanation: 'Total harvested = 1 250 × 8 = 10 000 kg. Remaining = 10 000 − 3 600 = 6 400 kg ✓' },
        ...
        { difficulty: 'Hard', question: 'Calculate 3 × (120 − 45) + 18 using the correct order of operations, and show each step.', checkMode: 'auto', options: ['225', '243', '333', '253'], correctIndex: 1, explanation: 'Brackets first: 120 − 45 = 75. Then multiply: 3 × 75 = 225. Then add: 225 + 18 = 243 ✓' },
      ],
      scoreMessages: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // Block 1 — Order of operations / BODMAS
        { difficulty: 'Easy', question: 'Calculate: 9 + 7 × 4', checkMode: 'auto', options: ['64', '37', '28', '36'], correctIndex: 1, explanation: 'Multiplication before addition: 7 × 4 = 28, then 9 + 28 = 37 ✓' },
        { difficulty: 'Easy', question: 'Calculate: (18 − 9) × 4 + 5', checkMode: 'auto', options: ['36', '-13', '41', '42'], correctIndex: 2, explanation: 'Brackets first: 18 − 9 = 9. Then multiply: 9 × 4 = 36. Then add: 36 + 5 = 41 ✓' },
        { difficulty: 'Medium', question: 'Calculate: 50 − 36 ÷ 6 + 3 × 4', checkMode: 'auto', options: ['44', '55', '34', '56'], correctIndex: 3, explanation: 'Division and multiplication first: 36 ÷ 6 = 6 and 3 × 4 = 12. Then work left to right: 50 − 6 + 12 = 44 + 12 = 56 ✓' },
        { difficulty: 'Medium', question: 'Calculate: 4² + 5 × 6', checkMode: 'auto', options: ['46', '38', '126', '45'], correctIndex: 0, explanation: 'Powers first: 4² = 16. Then multiplication: 5 × 6 = 30. Then add: 16 + 30 = 46 ✓' },
        ...
        { difficulty: 'Medium', question: 'Use the associative property to calculate (4 × 50) × 6 by regrouping to make the calculation easier. What is the answer?', checkMode: 'auto', options: ['200', '1200', '1440', '1210'], correctIndex: 1, explanation: 'Associative property lets us regroup: 4 × (50 × 6) = 4 × 300 = 1 200. Calculating the original way also gives (4 × 50) × 6 = 200 × 6 = 1 200 ✓' },
        { difficulty: 'Medium', question: 'Use the distributive property to calculate 15 × (30 − 2).', checkMode: 'auto', options: ['480', '450', '420', '410'], correctIndex: 2, explanation: 'Distribute: 15 × (30 − 2) = (15 × 30) − (15 × 2) = 450 − 30 = 420 ✓' },
        ...
        { difficulty: 'Medium', question: 'Lindiwe calculates 50 − (12 − 7) by ignoring the brackets and writing 50 − 12 − 7 = 31. What is the correct answer?', checkMode: 'auto', options: ['31', '44', '55', '45'], correctIndex: 3, explanation: 'Brackets must be evaluated first: 12 − 7 = 5, then 50 − 5 = 45. Lindiwe\'s method of removing the brackets is incorrect ✓' },
        ...
        // Block 4 — Multi-step word problems
        { difficulty: 'Easy', question: 'Lerato buys 5 packs of apples with 14 apples in each pack. She eats 11 apples. How many apples does she have left?', checkMode: 'auto', options: ['59', '70', '8', '58'], correctIndex: 0, explanation: 'Total apples = 5 × 14 = 70. Apples left = 70 − 11 = 59 ✓' },
        { difficulty: 'Medium', question: 'A theatre sells 38 child tickets at R18 each and 15 adult tickets at R22 each. What is the total amount collected?', checkMode: 'auto', options: ['R684', 'R1014', 'R984', 'R1004'], correctIndex: 1, explanation: 'Child tickets: 38 × R18 = R684. Adult tickets: 15 × R22 = R330. Total = R684 + R330 = R1 014 ✓' },
        { difficulty: 'Medium', question: 'A stationery shop has 9 boxes of 18 pens. The shop sells 47 pens. How many pens are left?', checkMode: 'auto', options: ['162', '113', '115', '105'], correctIndex: 2, explanation: 'Total pens = 9 × 18 = 162. Pens left = 162 − 47 = 115 ✓' },
        { difficulty: 'Hard', question: 'A school hires 6 buses that each carry 63 learners, and 4 minibuses that each carry 35 learners, for a trip. How many learners can travel in total?', checkMode: 'auto', options: ['378', '508', '528', '518'], correctIndex: 3, explanation: 'Buses: 6 × 63 = 378. Minibuses: 4 × 35 = 140. Total = 378 + 140 = 518 ✓' },

        // Block 5 — Large-number multi-step calculations
        { difficulty: 'Medium', question: 'A warehouse already has 2 900 items in stock and receives 5 200 more items per delivery for 2 deliveries. Calculate: 2 900 + 5 200 × 2.', checkMode: 'auto', options: ['13300', '16200', '8100', '13200'], correctIndex: 0, explanation: 'Multiplication first: 5 200 × 2 = 10 400. Then add: 2 900 + 10 400 = 13 300 ✓' },
        { difficulty: 'Hard', question: 'A farmer harvests 1 800 kg of maize per hectare from 6 hectares, then sells 4 200 kg at the local market. How many kilograms of maize remain?', checkMode: 'auto', options: ['10800', '6600', '5800', '6700'], correctIndex: 1, explanation: 'Total harvested = 1 800 × 6 = 10 800 kg. Remaining = 10 800 − 4 200 = 6 600 kg ✓' },
        ...
        { difficulty: 'Hard', question: 'Calculate 4 × (85 − 29) + 25 using the correct order of operations, and show each step.', checkMode: 'auto', options: ['224', '336', '249', '259'], correctIndex: 2, explanation: 'Brackets first: 85 − 29 = 56. Then multiply: 4 × 56 = 224. Then add: 224 + 25 = 249 ✓' },
      ],
      scoreMessages: [
        { minScore: 18, message: 'Outstanding! You have mastered order of operations and the properties of whole numbers.' },
        { minScore: 14, message: 'Great work! You are confident with most of this — review any missed questions.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // Block 1 — Order of operations / BODMAS
        { difficulty: 'Easy', question: 'Calculate: 7 + 9 × 6', checkMode: 'auto', options: ['96', '54', '61', '60'], correctIndex: 2, explanation: 'Multiplication before addition: 9 × 6 = 54, then 7 + 54 = 61 ✓' },
        { difficulty: 'Easy', question: 'Calculate: (20 − 11) × 5 + 9', checkMode: 'auto', options: ['45', '-26', '55', '54'], correctIndex: 3, explanation: 'Brackets first: 20 − 11 = 9. Then multiply: 9 × 5 = 45. Then add: 45 + 9 = 54 ✓' },
        { difficulty: 'Medium', question: 'Calculate: 60 − 45 ÷ 9 + 4 × 5', checkMode: 'auto', options: ['75', '55', '74', '15'], correctIndex: 0, explanation: 'Division and multiplication first: 45 ÷ 9 = 5 and 4 × 5 = 20. Then work left to right: 60 − 5 + 20 = 55 + 20 = 75 ✓' },
        { difficulty: 'Medium', question: 'Calculate: 5² + 6 × 4', checkMode: 'auto', options: ['34', '49', '124', '48'], correctIndex: 1, explanation: 'Powers first: 5² = 25. Then multiplication: 6 × 4 = 24. Then add: 25 + 24 = 49 ✓' },
        ...
        { difficulty: 'Medium', question: 'Use the associative property to calculate (5 × 20) × 9 by regrouping to make the calculation easier. What is the answer?', checkMode: 'auto', options: ['100', '810', '900', '910'], correctIndex: 2, explanation: 'Associative property lets us regroup: 5 × (20 × 9) = 5 × 180 = 900. Calculating the original way also gives (5 × 20) × 9 = 100 × 9 = 900 ✓' },
        { difficulty: 'Medium', question: 'Use the distributive property to calculate 18 × (40 − 3).', checkMode: 'auto', options: ['774', '720', '656', '666'], correctIndex: 3, explanation: 'Distribute: 18 × (40 − 3) = (18 × 40) − (18 × 3) = 720 − 54 = 666 ✓' },
        ...
        { difficulty: 'Medium', question: 'Mpho calculates 45 − (15 − 6) by ignoring the brackets and writing 45 − 15 − 6 = 24. What is the correct answer?', checkMode: 'auto', options: ['36', '24', '35', '54'], correctIndex: 0, explanation: 'Brackets must be evaluated first: 15 − 6 = 9, then 45 − 9 = 36. Mpho\'s method of removing the brackets is incorrect ✓' },
        ...
        // Block 4 — Multi-step word problems
        { difficulty: 'Easy', question: 'Zinhle buys 6 packs of apples with 15 apples in each pack. She eats 13 apples. How many apples does she have left?', checkMode: 'auto', options: ['90', '77', '8', '76'], correctIndex: 1, explanation: 'Total apples = 6 × 15 = 90. Apples left = 90 − 13 = 77 ✓' },
        { difficulty: 'Medium', question: 'A cinema sells 52 child tickets at R12 each and 20 adult tickets at R17 each. What is the total amount collected?', checkMode: 'auto', options: ['R624', 'R924', 'R964', 'R954'], correctIndex: 2, explanation: 'Child tickets: 52 × R12 = R624. Adult tickets: 20 × R17 = R340. Total = R624 + R340 = R964 ✓' },
        { difficulty: 'Medium', question: 'A bookshop has 7 boxes of 32 books. The shop sells 56 books. How many books are left?', checkMode: 'auto', options: ['224', '164', '158', '168'], correctIndex: 3, explanation: 'Total books = 7 × 32 = 224. Books left = 224 − 56 = 168 ✓' },
        { difficulty: 'Hard', question: 'A school hires 5 buses that each carry 84 learners, and 6 minibuses that each carry 41 learners, for a trip. How many learners can travel in total?', checkMode: 'auto', options: ['666', '420', '660', '676'], correctIndex: 0, explanation: 'Buses: 5 × 84 = 420. Minibuses: 6 × 41 = 246. Total = 420 + 246 = 666 ✓' },

        // Block 5 — Large-number multi-step calculations
        { difficulty: 'Medium', question: 'A warehouse already has 4 100 items in stock and receives 3 700 more items per delivery for 2 deliveries. Calculate: 4 100 + 3 700 × 2.', checkMode: 'auto', options: ['15600', '11500', '7800', '11400'], correctIndex: 1, explanation: 'Multiplication first: 3 700 × 2 = 7 400. Then add: 4 100 + 7 400 = 11 500 ✓' },
        { difficulty: 'Hard', question: 'A farmer harvests 2 100 kg of maize per hectare from 5 hectares, then sells 3 800 kg at the local market. How many kilograms of maize remain?', checkMode: 'auto', options: ['10500', '6200', '6700', '6800'], correctIndex: 2, explanation: 'Total harvested = 2 100 × 5 = 10 500 kg. Remaining = 10 500 − 3 800 = 6 700 kg ✓' },
        ...
        { difficulty: 'Hard', question: 'Calculate 5 × (96 − 38) + 30 using the correct order of operations, and show each step.', checkMode: 'auto', options: ['290', '472', '330', '320'], correctIndex: 3, explanation: 'Brackets first: 96 − 38 = 58. Then multiply: 5 × 58 = 290. Then add: 290 + 30 = 320 ✓' },
      ],
      scoreMessages: [
        { minScore: 18, message: 'Outstanding! You have mastered order of operations and the properties of whole numbers.' },
        { minScore: 14, message: 'Great work! You are confident with most of this — review any missed questions.' },
