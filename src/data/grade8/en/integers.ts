...
export const topicData: TopicData = {
  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      name: 'Set 1',
      questions: [
        { difficulty: 'Medium', question: 'Calculate −14 + (−9) × 3.', checkMode: 'auto', options: ['-41', '13', '-69', '41'], correctIndex: 0, explanation: 'Multiplication before addition: −9 × 3 = −27 (different signs → negative). Then −14 + (−27) = −41.' },
        { difficulty: 'Medium', question: 'Calculate 30 − (−6) × 4.', checkMode: 'auto', options: ['6', '54', '144', '-54'], correctIndex: 1, explanation: 'Multiplication before subtraction: −6 × 4 = −24. Then 30 − (−24) = 30 + 24 = 54.' },
        { difficulty: 'Medium', question: 'Calculate −18 − (−7) + (−5).', checkMode: 'auto', options: ['-30', '-6', '-16', '16'], correctIndex: 2, explanation: 'Work left to right. Step 1: −18 − (−7) = −18 + 7 = −11. Step 2: −11 + (−5) = −16.' },
        ...
        { difficulty: 'Easy', question: 'Calculate (−4)².', checkMode: 'auto', options: ['-16', '8', '4', '16'], correctIndex: 3, explanation: '(−4)² = (−4) × (−4). Same signs → positive. 4 × 4 = 16. Answer: 16.' },
        { difficulty: 'Easy', question: 'Calculate (−3)³.', checkMode: 'auto', options: ['-27', '27', '9', '-9'], correctIndex: 0, explanation: '(−3)³ = (−3) × (−3) × (−3) = 9 × (−3) = −27 (an odd power of a negative number is negative).' },
        { difficulty: 'Medium', question: 'Calculate (−2)² − (−3)³.', checkMode: 'auto', options: ['-23', '31', '-31', '22'], correctIndex: 1, explanation: 'Step 1: (−2)² = 4. Step 2: (−3)³ = −27. Step 3: 4 − (−27) = 4 + 27 = 31.' },
        { difficulty: 'Hard', question: 'Calculate −5² + (−2)³.', checkMode: 'auto', options: ['17', '-41', '-33', '33'], correctIndex: 2, explanation: 'No brackets around −5, so the exponent applies first: 5² = 25, then −5² = −25. Next (−2)³ = −8. Finally −25 + (−8) = −33.' },
        { difficulty: 'Medium', question: 'Use the correct order of operations to calculate 4 × (−3) + (−2)².', checkMode: 'auto', options: ['8', '-16', '16', '-8'], correctIndex: 3, explanation: 'Exponents and multiplication before addition. Step 1: 4 × (−3) = −12. Step 2: (−2)² = 4. Step 3: −12 + 4 = −8.' },
        { difficulty: 'Medium', question: 'Use the correct order of operations to calculate (−6 + 2)² − 10.', checkMode: 'auto', options: ['6', '-26', '26', '-6'], correctIndex: 0, explanation: 'Brackets first: −6 + 2 = −4. Then the exponent: (−4)² = 16. Finally 16 − 10 = 6.' },
        { difficulty: 'Medium-Hard', question: 'Use the correct order of operations to calculate −3 × (4 − (−2)).', checkMode: 'auto', options: ['-6', '-18', '18', '-30'], correctIndex: 1, explanation: 'Brackets first: 4 − (−2) = 4 + 2 = 6. Then −3 × 6 = −18 (different signs → negative).' },
        { difficulty: 'Hard', question: 'Use the correct order of operations to calculate (10 − (−2)) ÷ (−3) + (−4)².', checkMode: 'auto', options: ['-20', '20', '12', '8'], correctIndex: 2, explanation: 'Brackets first: 10 − (−2) = 12. Then division: 12 ÷ (−3) = −4. Then the exponent: (−4)² = 16. Finally −4 + 16 = 12.' },
        { difficulty: 'Medium', question: 'Calculate √81 + (−3)³.', checkMode: 'auto', options: ['36', '18', '0', '-18'], correctIndex: 3, explanation: 'Step 1: √81 = 9 (since 9 × 9 = 81). Step 2: (−3)³ = −27. Step 3: 9 + (−27) = −18.' },
        { difficulty: 'Hard', question: 'Calculate ∛(−27) − (−5)².', checkMode: 'auto', options: ['-28', '22', '28', '-22'], correctIndex: 0, explanation: 'Step 1: ∛(−27) = −3 (since (−3) × (−3) × (−3) = −27). Step 2: (−5)² = 25. Step 3: −3 − 25 = −28.' },
        { difficulty: 'Hard', question: 'Calculate (−2)³ × √16.', checkMode: 'auto', options: ['32', '-32', '-16', '16'], correctIndex: 1, explanation: 'Step 1: (−2)³ = −8. Step 2: √16 = 4. Step 3: −8 × 4 = −32 (different signs → negative).' },
        { difficulty: 'Medium', question: 'The temperature at a weather station was −7°C. It dropped a further 5°C overnight, then rose 9°C by mid-morning. What was the temperature by mid-morning?', checkMode: 'auto', options: ['7°C', '3°C', '-3°C', '-21°C'], correctIndex: 2, explanation: 'Start at −7°C, drop 5°C: −7 − 5 = −12°C. Then rise 9°C: −12 + 9 = −3°C.' },
        { difficulty: 'Medium-Hard', question: 'A hiker starts at an elevation of −240 m (below sea level). She climbs 85 m, then climbs a further 60 m. What is her final elevation, as an integer?', checkMode: 'auto', options: ['-155', '95', '-385', '-95'], correctIndex: 3, explanation: 'Start at −240 m. Climb 85 m: −240 + 85 = −155 m. Climb a further 60 m: −155 + 60 = −95 m.' },
        { difficulty: 'Medium-Hard', question: "Kagiso's account is overdrawn by R680, written as −R680. He deposits R250, then withdraws a further R90. What is his new balance?", checkMode: 'auto', options: ['-R520', '-R340', '-R770', 'R520'], correctIndex: 0, explanation: 'Start at −680. Deposit 250: −680 + 250 = −430. Withdraw 90: −430 − 90 = −520. New balance: −R520.' },
        { difficulty: 'Hard', question: 'Calculate the correct value of −2 × (−6 + 4) − (−3)².', checkMode: 'auto', options: ['13', '-5', '5', '-13'], correctIndex: 1, explanation: 'Brackets first: −6 + 4 = −2. Then multiplication: −2 × (−2) = 4. Then the exponent: (−3)² = 9. Finally 4 − 9 = −5.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      name: 'Set 2',
      questions: [
        { difficulty: 'Medium', question: 'Calculate −17 + (−6) × 5.', checkMode: 'auto', options: ['-47', '13', '-115', '47'], correctIndex: 0, explanation: 'Multiplication before addition: −6 × 5 = −30 (different signs → negative). Then −17 + (−30) = −47.' },
        { difficulty: 'Medium', question: 'Calculate 25 − (−8) × 3.', checkMode: 'auto', options: ['1', '49', '99', '-49'], correctIndex: 1, explanation: 'Multiplication before subtraction: −8 × 3 = −24. Then 25 − (−24) = 25 + 24 = 49.' },
        { difficulty: 'Medium', question: 'Calculate −21 − (−9) + (−6).', checkMode: 'auto', options: ['-36', '-6', '-18', '18'], correctIndex: 2, explanation: 'Work left to right. Step 1: −21 − (−9) = −21 + 9 = −12. Step 2: −12 + (−6) = −18.' },
        ...
        { difficulty: 'Easy', question: 'Calculate (−6)².', checkMode: 'auto', options: ['-36', '12', '6', '36'], correctIndex: 3, explanation: '(−6)² = (−6) × (−6). Same signs → positive. 6 × 6 = 36. Answer: 36.' },
        { difficulty: 'Easy', question: 'Calculate (−4)³.', checkMode: 'auto', options: ['-64', '64', '16', '-16'], correctIndex: 0, explanation: '(−4)³ = (−4) × (−4) × (−4) = 16 × (−4) = −64 (an odd power of a negative number is negative).' },
        { difficulty: 'Medium', question: 'Calculate (−3)² − (−2)³.', checkMode: 'auto', options: ['1', '17', '-17', '15'], correctIndex: 1, explanation: 'Step 1: (−3)² = 9. Step 2: (−2)³ = −8. Step 3: 9 − (−8) = 9 + 8 = 17.' },
        { difficulty: 'Hard', question: 'Calculate −6² + (−3)³.', checkMode: 'auto', options: ['9', '-45', '-63', '63'], correctIndex: 2, explanation: 'No brackets around −6, so the exponent applies first: 6² = 36, then −6² = −36. Next (−3)³ = −27. Finally −36 + (−27) = −63.' },
        { difficulty: 'Medium', question: 'Use the correct order of operations to calculate 5 × (−2) + (−3)².', checkMode: 'auto', options: ['1', '-19', '19', '-1'], correctIndex: 3, explanation: 'Exponents and multiplication before addition. Step 1: 5 × (−2) = −10. Step 2: (−3)² = 9. Step 3: −10 + 9 = −1.' },
        { difficulty: 'Medium', question: 'Use the correct order of operations to calculate (−7 + 3)² − 12.', checkMode: 'auto', options: ['4', '-28', '-4', '28'], correctIndex: 0, explanation: 'Brackets first: −7 + 3 = −4. Then the exponent: (−4)² = 16. Finally 16 − 12 = 4.' },
        { difficulty: 'Medium-Hard', question: 'Use the correct order of operations to calculate −4 × (5 − (−3)).', checkMode: 'auto', options: ['-8', '-32', '32', '-40'], correctIndex: 1, explanation: 'Brackets first: 5 − (−3) = 5 + 3 = 8. Then −4 × 8 = −32 (different signs → negative).' },
        { difficulty: 'Hard', question: 'Use the correct order of operations to calculate (18 − (−6)) ÷ (−4) + (−3)².', checkMode: 'auto', options: ['15', '-15', '3', '-3'], correctIndex: 2, explanation: 'Brackets first: 18 − (−6) = 24. Then division: 24 ÷ (−4) = −6. Then the exponent: (−3)² = 9. Finally −6 + 9 = 3.' },
        { difficulty: 'Medium', question: 'Calculate √64 + (−2)³.', checkMode: 'auto', options: ['16', '-16', '4', '0'], correctIndex: 3, explanation: 'Step 1: √64 = 8 (since 8 × 8 = 64). Step 2: (−2)³ = −8. Step 3: 8 + (−8) = 0.' },
        { difficulty: 'Hard', question: 'Calculate ∛(−8) − (−4)².', checkMode: 'auto', options: ['-18', '14', '18', '-14'], correctIndex: 0, explanation: 'Step 1: ∛(−8) = −2 (since (−2) × (−2) × (−2) = −8). Step 2: (−4)² = 16. Step 3: −2 − 16 = −18.' },
        { difficulty: 'Hard', question: 'Calculate (−3)³ × √9.', checkMode: 'auto', options: ['81', '-81', '-243', '-27'], correctIndex: 1, explanation: 'Step 1: (−3)³ = −27. Step 2: √9 = 3. Step 3: −27 × 3 = −81 (different signs → negative).' },
        { difficulty: 'Medium', question: 'The temperature at a weather station was −9°C. It dropped a further 6°C overnight, then rose 14°C by mid-morning. What was the temperature by mid-morning?', checkMode: 'auto', options: ['11°C', '1°C', '-1°C', '-15°C'], correctIndex: 2, explanation: 'Start at −9°C, drop 6°C: −9 − 6 = −15°C. Then rise 14°C: −15 + 14 = −1°C.' },
        { difficulty: 'Medium-Hard', question: 'A hiker starts at an elevation of −310 m (below sea level). She climbs 120 m, then climbs a further 45 m. What is her final elevation, as an integer?', checkMode: 'auto', options: ['-190', '145', '-475', '-145'], correctIndex: 3, explanation: 'Start at −310 m. Climb 120 m: −310 + 120 = −190 m. Climb a further 45 m: −190 + 45 = −145 m.' },
        { difficulty: 'Medium-Hard', question: "Naledi's account is overdrawn by R540, written as −R540. She deposits R300, then withdraws a further R120. What is her new balance?", checkMode: 'auto', options: ['-R360', '-R120', '-R660', 'R360'], correctIndex: 0, explanation: 'Start at −540. Deposit 300: −540 + 300 = −240. Withdraw 120: −240 − 120 = −360. New balance: −R360.' },
        { difficulty: 'Hard', question: 'Calculate the correct value of −3 × (−8 + 5) − (−2)².', checkMode: 'auto', options: ['13', '5', '-5', '-13'], correctIndex: 1, explanation: 'Brackets first: −8 + 5 = −3. Then multiplication: −3 × (−3) = 9. Then the exponent: (−2)² = 4. Finally 9 − 4 = 5.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      name: 'Set 3',
      questions: [
        { difficulty: 'Medium', question: 'Calculate −20 + (−8) × 3.', checkMode: 'auto', options: ['-44', '4', '-84', '44'], correctIndex: 0, explanation: 'Multiplication before addition: −8 × 3 = −24 (different signs → negative). Then −20 + (−24) = −44.' },
        { difficulty: 'Medium', question: 'Calculate 18 − (−9) × 5.', checkMode: 'auto', options: ['-27', '63', '135', '-63'], correctIndex: 1, explanation: 'Multiplication before subtraction: −9 × 5 = −45. Then 18 − (−45) = 18 + 45 = 63.' },
        { difficulty: 'Medium', question: 'Calculate −14 − (−8) + (−11).', checkMode: 'auto', options: ['-33', '5', '-17', '17'], correctIndex: 2, explanation: 'Work left to right. Step 1: −14 − (−8) = −14 + 8 = −6. Step 2: −6 + (−11) = −17.' },
        ...
        { difficulty: 'Easy', question: 'Calculate (−7)².', checkMode: 'auto', options: ['-49', '14', '7', '49'], correctIndex: 3, explanation: '(−7)² = (−7) × (−7). Same signs → positive. 7 × 7 = 49. Answer: 49.' },
        { difficulty: 'Easy', question: 'Calculate (−5)³.', checkMode: 'auto', options: ['-125', '125', '25', '-25'], correctIndex: 0, explanation: '(−5)³ = (−5) × (−5) × (−5) = 25 × (−5) = −125 (an odd power of a negative number is negative).' },
        { difficulty: 'Medium', question: 'Calculate (−4)² − (−2)³.', checkMode: 'auto', options: ['8', '24', '-24', '22'], correctIndex: 1, explanation: 'Step 1: (−4)² = 16. Step 2: (−2)³ = −8. Step 3: 16 − (−8) = 16 + 8 = 24.' },
        { difficulty: 'Hard', question: 'Calculate −4² + (−3)³.', checkMode: 'auto', options: ['-11', '-25', '-43', '43'], correctIndex: 2, explanation: 'No brackets around −4, so the exponent applies first: 4² = 16, then −4² = −16. Next (−3)³ = −27. Finally −16 + (−27) = −43.' },
        { difficulty: 'Medium', question: 'Use the correct order of operations to calculate 6 × (−3) + (−4)².', checkMode: 'auto', options: ['2', '-34', '34', '-2'], correctIndex: 3, explanation: 'Exponents and multiplication before addition. Step 1: 6 × (−3) = −18. Step 2: (−4)² = 16. Step 3: −18 + 16 = −2.' },
        { difficulty: 'Medium', question: 'Use the correct order of operations to calculate (−5 + 1)² − 8.', checkMode: 'auto', options: ['8', '-24', '-8', '28'], correctIndex: 0, explanation: 'Brackets first: −5 + 1 = −4. Then the exponent: (−4)² = 16. Finally 16 − 8 = 8.' },
        { difficulty: 'Medium-Hard', question: 'Use the correct order of operations to calculate −5 × (6 − (−1)).', checkMode: 'auto', options: ['-25', '-35', '35', '-30'], correctIndex: 1, explanation: 'Brackets first: 6 − (−1) = 6 + 1 = 7. Then −5 × 7 = −35 (different signs → negative).' },
        { difficulty: 'Hard', question: 'Use the correct order of operations to calculate (14 − (−4)) ÷ (−3) + (−5)².', checkMode: 'auto', options: ['31', '-31', '19', '-19'], correctIndex: 2, explanation: 'Brackets first: 14 − (−4) = 18. Then division: 18 ÷ (−3) = −6. Then the exponent: (−5)² = 25. Finally −6 + 25 = 19.' },
        { difficulty: 'Medium', question: 'Calculate √100 + (−4)³.', checkMode: 'auto', options: ['74', '-6', '54', '-54'], correctIndex: 3, explanation: 'Step 1: √100 = 10 (since 10 × 10 = 100). Step 2: (−4)³ = −64. Step 3: 10 + (−64) = −54.' },
        { difficulty: 'Hard', question: 'Calculate ∛(−64) − (−3)².', checkMode: 'auto', options: ['-13', '5', '13', '-5'], correctIndex: 0, explanation: 'Step 1: ∛(−64) = −4 (since (−4) × (−4) × (−4) = −64). Step 2: (−3)² = 9. Step 3: −4 − 9 = −13.' },
        { difficulty: 'Hard', question: 'Calculate (−1)³ × √25.', checkMode: 'auto', options: ['5', '-5', '-25', '25'], correctIndex: 1, explanation: 'Step 1: (−1)³ = −1. Step 2: √25 = 5. Step 3: −1 × 5 = −5 (different signs → negative).' },
        { difficulty: 'Medium', question: 'The temperature at a weather station was −11°C. It dropped a further 4°C overnight, then rose 19°C by mid-morning. What was the temperature by mid-morning?', checkMode: 'auto', options: ['-4°C', '-15°C', '4°C', '12°C'], correctIndex: 2, explanation: 'Start at −11°C, drop 4°C: −11 − 4 = −15°C. Then rise 19°C: −15 + 19 = 4°C.' },
        { difficulty: 'Medium-Hard', question: 'A hiker starts at an elevation of −180 m (below sea level). She climbs 95 m, then climbs a further 40 m. What is her final elevation, as an integer?', checkMode: 'auto', options: ['-85', '45', '-315', '-45'], correctIndex: 3, explanation: 'Start at −180 m. Climb 95 m: −180 + 95 = −85 m. Climb a further 40 m: −85 + 40 = −45 m.' },
        { difficulty: 'Medium-Hard', question: "Thandeka's account is overdrawn by R415, written as −R415. She deposits R275, then withdraws a further R160. What is her new balance?", checkMode: 'auto', options: ['-R300', 'R20', '-R575', 'R300'], correctIndex: 0, explanation: 'Start at −415. Deposit 275: −415 + 275 = −140. Withdraw 160: −140 − 160 = −300. New balance: −R300.' },
        { difficulty: 'Hard', question: 'Calculate the correct value of −4 × (−9 + 6) − (−5)².', checkMode: 'auto', options: ['37', '-13', '13', '-37'], correctIndex: 1, explanation: 'Brackets first: −9 + 6 = −3. Then multiplication: −4 × (−3) = 12. Then the exponent: (−5)² = 25. Finally 12 − 25 = −13.' },
