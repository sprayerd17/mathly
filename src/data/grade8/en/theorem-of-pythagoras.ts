  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'A right-angled triangle has legs 5 cm and 12 cm, as shown in the diagram. Find the hypotenuse.', answer: '13 cm', checkMode: 'auto', correctAnswer: '13', correctAnswers: ['13', '13cm', '13 cm'], explanation: 'c² = 5² + 12² = 25 + 144 = 169\nc = √169 = 13 cm ✓', diagramSvg: '<svg viewBox="0 0 220 170" xmlns="http://www.w3.org/2000/svg"><polygon points="20,140 170,140 20,40" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><rect x="20" y="122" width="18" height="18" fill="none" stroke="#0f1f3d" stroke-width="2"/><text x="95" y="160" font-size="15" fill="#2563eb" font-weight="700" text-anchor="middle">12 cm</text><text x="16" y="94" font-size="15" fill="#2563eb" font-weight="700" text-anchor="end">5 cm</text><text x="108" y="82" font-size="15" fill="#dc2626" font-weight="700">c</text></svg>' },
        { difficulty: 'Easy', question: 'The same right-angled triangle has hypotenuse 13 cm and one leg 5 cm. Confirm the length of the other leg.', answer: '12 cm', checkMode: 'auto', correctAnswer: '12', correctAnswers: ['12', '12cm', '12 cm'], explanation: 'a² = c² − b² = 13² − 5² = 169 − 25 = 144\na = √144 = 12 cm ✓', diagramSvg: '<svg viewBox="0 0 220 170" xmlns="http://www.w3.org/2000/svg"><polygon points="20,140 170,140 20,40" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><rect x="20" y="122" width="18" height="18" fill="none" stroke="#0f1f3d" stroke-width="2"/><text x="95" y="160" font-size="15" fill="#2563eb" font-weight="700" text-anchor="middle">12 cm</text><text x="16" y="94" font-size="15" fill="#2563eb" font-weight="700" text-anchor="end">5 cm</text><text x="100" y="82" font-size="15" fill="#dc2626" font-weight="700">13 cm</text></svg>' },
        { difficulty: 'Easy', question: 'Using the same triangle (legs 5 cm and 12 cm, hypotenuse 13 cm), find its perimeter.', answer: '30 cm', checkMode: 'auto', correctAnswer: '30', correctAnswers: ['30', '30cm', '30 cm'], explanation: 'Perimeter = 5 + 12 + 13 = 30 cm ✓', diagramSvg: '<svg viewBox="0 0 220 170" xmlns="http://www.w3.org/2000/svg"><polygon points="20,140 170,140 20,40" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><rect x="20" y="122" width="18" height="18" fill="none" stroke="#0f1f3d" stroke-width="2"/><text x="95" y="160" font-size="15" fill="#2563eb" font-weight="700" text-anchor="middle">12 cm</text><text x="16" y="94" font-size="15" fill="#2563eb" font-weight="700" text-anchor="end">5 cm</text><text x="100" y="82" font-size="15" fill="#dc2626" font-weight="700">13 cm</text></svg>' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        { difficulty: 'Medium', question: 'Thabo leans a 13 m ladder against a wall, as shown, with its base 5 m from the wall. How high up the wall does it reach?', answer: '12 m', checkMode: 'auto', correctAnswer: '12', correctAnswers: ['12', '12m', '12 m'], explanation: 'height² = 13² − 5² = 169 − 25 = 144\nheight = √144 = 12 m ✓', diagramSvg: '<svg viewBox="0 0 220 180" xmlns="http://www.w3.org/2000/svg"><line x1="30" y1="150" x2="30" y2="20" stroke="#0f1f3d" stroke-width="3"/><line x1="30" y1="150" x2="190" y2="150" stroke="#0f1f3d" stroke-width="3"/><line x1="30" y1="20" x2="190" y2="150" stroke="#dc2626" stroke-width="2.5"/><rect x="30" y="132" width="18" height="18" fill="none" stroke="#0f1f3d" stroke-width="2"/><text x="118" y="78" font-size="15" fill="#dc2626" font-weight="700" text-anchor="middle">ladder = 13 m</text><text x="18" y="88" font-size="14" fill="#374151" text-anchor="end">height?</text><text x="110" y="170" font-size="14" fill="#374151" text-anchor="middle">base?</text></svg>' },
        { difficulty: 'Medium', question: 'Using the same 13 m ladder, if its base is instead repositioned 12 m from the wall, how high up the wall will it now reach?', answer: '5 m', checkMode: 'auto', correctAnswer: '5', correctAnswers: ['5', '5m', '5 m'], explanation: 'height² = 13² − 12² = 169 − 144 = 25\nheight = √25 = 5 m ✓', diagramSvg: '<svg viewBox="0 0 220 180" xmlns="http://www.w3.org/2000/svg"><line x1="30" y1="150" x2="30" y2="20" stroke="#0f1f3d" stroke-width="3"/><line x1="30" y1="150" x2="190" y2="150" stroke="#0f1f3d" stroke-width="3"/><line x1="30" y1="20" x2="190" y2="150" stroke="#dc2626" stroke-width="2.5"/><rect x="30" y="132" width="18" height="18" fill="none" stroke="#0f1f3d" stroke-width="2"/><text x="118" y="78" font-size="15" fill="#dc2626" font-weight="700" text-anchor="middle">ladder = 13 m</text><text x="18" y="88" font-size="14" fill="#374151" text-anchor="end">height?</text><text x="110" y="170" font-size="14" fill="#374151" text-anchor="middle">base?</text></svg>' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Hard', question: 'An isosceles triangle has two equal sides of 20 cm and a base of 24 cm, as shown. Find the height of the triangle (from the apex to the midpoint of the base).', answer: '16 cm', checkMode: 'auto', correctAnswer: '16', correctAnswers: ['16', '16cm', '16 cm'], explanation: 'Half the base = 12 cm.\nh² = 20² − 12² = 400 − 144 = 256\nh = √256 = 16 cm ✓', diagramSvg: '<svg viewBox="0 0 220 170" xmlns="http://www.w3.org/2000/svg"><polygon points="110,20 20,140 200,140" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="110" y1="20" x2="110" y2="140" stroke="#dc2626" stroke-width="2" stroke-dasharray="5,4"/><rect x="102" y="124" width="16" height="16" fill="none" stroke="#0f1f3d" stroke-width="1.5"/><text x="55" y="75" font-size="14" fill="#2563eb" font-weight="700">20 cm</text><text x="155" y="75" font-size="14" fill="#2563eb" font-weight="700">20 cm</text><text x="110" y="160" font-size="14" fill="#2563eb" font-weight="700" text-anchor="middle">24 cm</text><text x="122" y="90" font-size="14" fill="#dc2626" font-weight="700">h</text></svg>' },
        { difficulty: 'Hard', question: 'Using the same isosceles triangle (equal sides 20 cm, base 24 cm, height 16 cm), calculate its area.', answer: '192 cm²', checkMode: 'auto', correctAnswer: '192', correctAnswers: ['192', '192cm²', '192 cm²'], explanation: 'Area = ½ × base × height = ½ × 24 × 16 = 192 cm² ✓', diagramSvg: '<svg viewBox="0 0 220 170" xmlns="http://www.w3.org/2000/svg"><polygon points="110,20 20,140 200,140" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="110" y1="20" x2="110" y2="140" stroke="#dc2626" stroke-width="2" stroke-dasharray="5,4"/><rect x="102" y="124" width="16" height="16" fill="none" stroke="#0f1f3d" stroke-width="1.5"/><text x="55" y="75" font-size="14" fill="#2563eb" font-weight="700">20 cm</text><text x="155" y="75" font-size="14" fill="#2563eb" font-weight="700">20 cm</text><text x="110" y="160" font-size="14" fill="#2563eb" font-weight="700" text-anchor="middle">24 cm</text><text x="122" y="90" font-size="14" fill="#dc2626" font-weight="700">h</text></svg>' },
