  ...
  practiceSets: [
    {
      ...
      questions: [
        ...
        { difficulty: 'Hard', question: 'A vertical pole is 9 m tall. A wire runs from the top of the pole to a point on the ground 4 m from its base. If 3 identical wires are needed to support the pole, find the total length of wire required, rounded to 2 decimal places.', answer: '29.55 m', checkMode: 'auto', correctAnswer: '29.55', correctAnswers: ['29.55', '29.55m', '29.55 m'], explanation: 'One wire: c² = 9² + 4² = 81 + 16 = 97, c = √97 ≈ 9.85 m.\nThree wires: 3 × 9.85 ≈ 29.55 m ✓' },
    ...
    },
    {
      ...
      questions: [
        ...
        { difficulty: 'Hard', question: 'A vertical pole is 9 m tall. A wire runs from the top of the pole to a point on the ground 4 m from its base. If 4 identical wires are needed to support the pole, find the total length of wire required, rounded to 2 decimal places.', answer: '39.40 m', checkMode: 'auto', correctAnswer: '39.40', correctAnswers: ['39.4', '39.40', '39.4m', '39.40m', '39.4 m', '39.40 m'], explanation: 'One wire: c² = 9² + 4² = 81 + 16 = 97, c = √97 ≈ 9.85 m.\nFour wires: 4 × 9.85 ≈ 39.40 m ✓' },
