  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium-Hard', question: 'Seven times a number, decreased by 3, equals four times the number increased by 15. Form an equation and solve it.', answer: '6', checkMode: 'auto', correctAnswer: '6', correctAnswers: ['6', 'x = 6', '7x - 3 = 4x + 15, x = 6'], explanation: 'Let the number be x.\n7x − 3 = 4x + 15\nSubtract 4x from both sides: 3x − 3 = 15\nAdd 3 to both sides: 3x = 18\nDivide both sides by 3: x = 6\nCheck: 7(6) − 3 = 39 and 4(6) + 15 = 39 ✓' },
        ...
        { difficulty: 'Medium-Hard', question: 'A stationery shop charges a R20 joining fee plus R3 per pen. A second shop charges a R8 joining fee plus R5 per pen. For how many pens, n, would the total cost be the same at both shops?', answer: '6', checkMode: 'auto', correctAnswer: '6', correctAnswers: ['6', 'n = 6', '20 + 3n = 8 + 5n, n = 6'], explanation: 'Shop A cost: 20 + 3n. Shop B cost: 8 + 5n.\n20 + 3n = 8 + 5n\nSubtract 3n from both sides: 20 = 8 + 2n\nSubtract 8 from both sides: 12 = 2n\nDivide both sides by 2: n = 6\nCheck: 20 + 3(6) = 38 and 8 + 5(6) = 38 ✓' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium-Hard', question: 'Nine times a number, decreased by 4, equals five times the number increased by 24. Form an equation and solve it.', answer: '7', checkMode: 'auto', correctAnswer: '7', correctAnswers: ['7', 'x = 7', '9x - 4 = 5x + 24, x = 7'], explanation: 'Let the number be x.\n9x − 4 = 5x + 24\nSubtract 5x from both sides: 4x − 4 = 24\nAdd 4 to both sides: 4x = 28\nDivide both sides by 4: x = 7\nCheck: 9(7) − 4 = 59 and 5(7) + 24 = 59 ✓' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium-Hard', question: 'Eight times a number, decreased by 5, equals five times the number increased by 19. Form an equation and solve it.', answer: '8', checkMode: 'auto', correctAnswer: '8', correctAnswers: ['8', 'x = 8', '8x - 5 = 5x + 19, x = 8'], explanation: 'Let the number be x.\n8x − 5 = 5x + 19\nSubtract 5x from both sides: 3x − 5 = 19\nAdd 5 to both sides: 3x = 24\nDivide both sides by 3: x = 8\nCheck: 8(8) − 5 = 59 and 5(8) + 19 = 59 ✓' },
        ...
        { difficulty: 'Medium-Hard', question: 'A tuck shop charges a R18 stall fee plus R6 per item. A second stall has a R6 stall fee but charges R9 per item. For how many items, n, would the total cost be the same at both stalls?', answer: '4', checkMode: 'auto', correctAnswer: '4', correctAnswers: ['4', 'n = 4', '18 + 6n = 6 + 9n, n = 4'], explanation: '18 + 6n = 6 + 9n\nSubtract 6n from both sides: 18 = 6 + 3n\nSubtract 6 from both sides: 12 = 3n\nDivide both sides by 3: n = 4\nCheck: 18 + 6(4) = 42 and 6 + 9(4) = 42 ✓' },
