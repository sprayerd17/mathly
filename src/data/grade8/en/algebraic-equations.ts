  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'Solve: 6x + 5 = 2x + 29', checkMode: 'auto', options: ['6', '24', '-6', '7'], correctIndex: 0, explanation: '6x + 5 = 2x + 29\nSubtract 2x from both sides: 4x + 5 = 29\nSubtract 5 from both sides: 4x = 24\nDivide both sides by 4: x = 6\nCheck: 6(6) + 5 = 41 and 2(6) + 29 = 41 ✓' },
        { difficulty: 'Medium', question: 'Solve: 9x − 8 = 4x + 17', checkMode: 'auto', options: ['25', '5', '-5', '6'], correctIndex: 1, explanation: '9x − 8 = 4x + 17\nSubtract 4x from both sides: 5x − 8 = 17\nAdd 8 to both sides: 5x = 25\nDivide both sides by 5: x = 5\nCheck: 9(5) − 8 = 37 and 4(5) + 17 = 37 ✓' },
        { difficulty: 'Medium-Hard', question: 'Seven times a number, decreased by 3, equals four times the number increased by 15. Form an equation and solve it.', checkMode: 'auto', options: ['18', '-6', '6', '7'], correctIndex: 2, explanation: 'Let the number be x.\n7x − 3 = 4x + 15\nSubtract 4x from both sides: 3x − 3 = 15\nAdd 3 to both sides: 3x = 18\nDivide both sides by 3: x = 6\nCheck: 7(6) − 3 = 39 and 4(6) + 15 = 39 ✓' },
        ...
        { difficulty: 'Medium', question: 'Solve: 3(x + 5) = 27', checkMode: 'auto', options: ['22', '-4', '5', '4'], correctIndex: 3, explanation: '3(x + 5) = 27\nExpand the bracket: 3x + 15 = 27\nSubtract 15 from both sides: 3x = 12\nDivide both sides by 3: x = 4\nCheck: 3(4 + 5) = 3(9) = 27 ✓' },
        { difficulty: 'Medium', question: 'Solve: 4(2x − 3) = 44', checkMode: 'auto', options: ['7', '4', '-7', '8'], correctIndex: 0, explanation: '4(2x − 3) = 44\nExpand the bracket: 8x − 12 = 44\nAdd 12 to both sides: 8x = 56\nDivide both sides by 8: x = 7\nCheck: 4(2(7) − 3) = 4(11) = 44 ✓' },
        { difficulty: 'Medium-Hard', question: 'Solve: 5(x − 2) = 3x + 8', checkMode: 'auto', options: ['-1', '9', '-9', '10'], correctIndex: 1, explanation: '5(x − 2) = 3x + 8\nExpand the bracket: 5x − 10 = 3x + 8\nSubtract 3x from both sides: 2x − 10 = 8\nAdd 10 to both sides: 2x = 18\nDivide both sides by 2: x = 9\nCheck: 5(9 − 2) = 5(7) = 35 and 3(9) + 8 = 35 ✓' },
        ...
        { difficulty: 'Medium', question: 'Solve: x/3 + 5 = 12', checkMode: 'auto', options: ['31', '51', '21', '18'], correctIndex: 2, explanation: 'x/3 + 5 = 12\nSubtract 5 from both sides: x/3 = 7\nMultiply both sides by 3: x = 21\nCheck: 21/3 + 5 = 7 + 5 = 12 ✓' },
        { difficulty: 'Medium', question: 'Solve: (x + 4)/5 = 6', checkMode: 'auto', options: ['30', '34', '25', '26'], correctIndex: 3, explanation: '(x + 4)/5 = 6\nMultiply both sides by 5: x + 4 = 30\nSubtract 4 from both sides: x = 26\nCheck: (26 + 4)/5 = 30/5 = 6 ✓' },
        { difficulty: 'Medium-Hard', question: 'Solve: x/2 + x/3 = 10', checkMode: 'auto', options: ['12', '2', '50', '15'], correctIndex: 0, explanation: 'x/2 + x/3 = 10\nMultiply every term by the lowest common denominator, 6: 3x + 2x = 60\nCollect like terms: 5x = 60\nDivide both sides by 5: x = 12\nCheck: 12/2 + 12/3 = 6 + 4 = 10 ✓' },
        ...
        { difficulty: 'Medium-Hard', question: 'A stationery shop charges a R20 joining fee plus R3 per pen. A second shop charges a R8 joining fee plus R5 per pen. For how many pens, n, would the total cost be the same at both shops?', checkMode: 'auto', options: ['12', '-6', '6', '7'], correctIndex: 2, explanation: 'Shop A cost: 20 + 3n. Shop B cost: 8 + 5n.\n20 + 3n = 8 + 5n\nSubtract 3n from both sides: 20 = 8 + 2n\nSubtract 8 from both sides: 12 = 2n\nDivide both sides by 2: n = 6\nCheck: 20 + 3(6) = 38 and 8 + 5(6) = 38 ✓' },

        // Block 5 — Checking solutions by substitution / error-spotting (positions 16-17)
        { difficulty: 'Medium', question: 'Is x = 6 a solution to 5x − 4 = 3x + 8? Show your substitution check.', checkMode: 'auto', options: ['No, x = 6 does not satisfy the equation', 'Only the left-hand side is true', 'Cannot be determined from the equation alone', 'Yes, x = 6 satisfies the equation'], correctIndex: 3, explanation: 'Substitute x = 6 into both sides.\nLeft side: 5(6) − 4 = 30 − 4 = 26\nRight side: 3(6) + 8 = 18 + 8 = 26\nBoth sides equal 26, so x = 6 is a solution.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // Block 1 — Variables on both sides (positions 0-3)
        { difficulty: 'Medium', question: 'Solve: 8x + 3 = 3x + 38', checkMode: 'auto', options: ['7', '35', '-7', '8'], correctIndex: 0, explanation: '8x + 3 = 3x + 38\nSubtract 3x from both sides: 5x + 3 = 38\nSubtract 3 from both sides: 5x = 35\nDivide both sides by 5: x = 7\nCheck: 8(7) + 3 = 59 and 3(7) + 38 = 59 ✓' },
        { difficulty: 'Medium', question: 'Solve: 10x − 6 = 5x + 29', checkMode: 'auto', options: ['35', '7', '-7', '6'], correctIndex: 1, explanation: '10x − 6 = 5x + 29\nSubtract 5x from both sides: 5x − 6 = 29\nAdd 6 to both sides: 5x = 35\nDivide both sides by 5: x = 7\nCheck: 10(7) − 6 = 64 and 5(7) + 29 = 64 ✓' },
        { difficulty: 'Medium-Hard', question: 'Nine times a number, decreased by 4, equals five times the number increased by 24. Form an equation and solve it.', checkMode: 'auto', options: ['28', '-7', '7', '8'], correctIndex: 2, explanation: 'Let the number be x.\n9x − 4 = 5x + 24\nSubtract 5x from both sides: 4x − 4 = 24\nAdd 4 to both sides: 4x = 28\nDivide both sides by 4: x = 7\nCheck: 9(7) − 4 = 59 and 5(7) + 24 = 59 ✓' },
        ...
        // Block 2 — Equations with brackets to expand first (positions 4-7)
        { difficulty: 'Medium', question: 'Solve: 4(x + 6) = 52', checkMode: 'auto', options: ['46', '-7', '8', '7'], correctIndex: 3, explanation: '4(x + 6) = 52\nExpand the bracket: 4x + 24 = 52\nSubtract 24 from both sides: 4x = 28\nDivide both sides by 4: x = 7\nCheck: 4(7 + 6) = 4(13) = 52 ✓' },
        { difficulty: 'Medium', question: 'Solve: 6(2x − 3) = 54', checkMode: 'auto', options: ['6', '3', '-6', '7'], correctIndex: 0, explanation: '6(2x − 3) = 54\nExpand the bracket: 12x − 18 = 54\nAdd 18 to both sides: 12x = 72\nDivide both sides by 12: x = 6\nCheck: 6(2(6) − 3) = 6(9) = 54 ✓' },
        { difficulty: 'Medium-Hard', question: 'Solve: 6(x − 1) = 4x + 10', checkMode: 'auto', options: ['2', '8', '-8', '9'], correctIndex: 1, explanation: '6(x − 1) = 4x + 10\nExpand the bracket: 6x − 6 = 4x + 10\nSubtract 4x from both sides: 2x − 6 = 10\nAdd 6 to both sides: 2x = 16\nDivide both sides by 2: x = 8\nCheck: 6(8 − 1) = 6(7) = 42 and 4(8) + 10 = 42 ✓' },
        ...
        // Block 3 — Equations with fractions, clearing denominators (positions 8-11)
        { difficulty: 'Medium', question: 'Solve: x/4 + 6 = 15', checkMode: 'auto', options: ['9', '84', '36', '32'], correctIndex: 2, explanation: 'x/4 + 6 = 15\nSubtract 6 from both sides: x/4 = 9\nMultiply both sides by 4: x = 36\nCheck: 36/4 + 6 = 9 + 6 = 15 ✓' },
        { difficulty: 'Medium', question: 'Solve: (x + 7)/3 = 9', checkMode: 'auto', options: ['27', '34', '19', '20'], correctIndex: 3, explanation: '(x + 7)/3 = 9\nMultiply both sides by 3: x + 7 = 27\nSubtract 7 from both sides: x = 20\nCheck: (20 + 7)/3 = 27/3 = 9 ✓' },
        { difficulty: 'Medium-Hard', question: 'Solve: x/3 + x/4 = 7', checkMode: 'auto', options: ['12', '1', '49', '14'], correctIndex: 0, explanation: 'x/3 + x/4 = 7\nMultiply every term by the lowest common denominator, 12: 4x + 3x = 84\nCollect like terms: 7x = 84\nDivide both sides by 7: x = 12\nCheck: 12/3 + 12/4 = 4 + 3 = 7 ✓' },
        ...
        { difficulty: 'Medium-Hard', question: 'A printing shop charges a R25 setup fee plus R4 per poster. A second shop has a R10 setup fee but charges R7 per poster. For how many posters, n, would the total cost be the same at both shops?', checkMode: 'auto', options: ['15', '-5', '5', '6'], correctIndex: 2, explanation: '25 + 4n = 10 + 7n\nSubtract 4n from both sides: 25 = 10 + 3n\nSubtract 10 from both sides: 15 = 3n\nDivide both sides by 3: n = 5\nCheck: 25 + 4(5) = 45 and 10 + 7(5) = 45 ✓' },

        // Block 5 — Checking solutions by substitution / error-spotting (positions 16-17)
        { difficulty: 'Medium', question: 'Is x = 7 a solution to 4x + 9 = 2x + 23? Show your substitution check.', checkMode: 'auto', options: ['No, x = 7 does not satisfy the equation', 'Only the left-hand side is true', 'Cannot be determined from the equation alone', 'Yes, x = 7 satisfies the equation'], correctIndex: 3, explanation: 'Substitute x = 7 into both sides.\nLeft side: 4(7) + 9 = 28 + 9 = 37\nRight side: 2(7) + 23 = 14 + 23 = 37\nBoth sides equal 37, so x = 7 is a solution.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // Block 1 — Variables on both sides (positions 0-3)
        { difficulty: 'Medium', question: 'Solve: 7x + 9 = 4x + 27', checkMode: 'auto', options: ['6', '18', '-6', '7'], correctIndex: 0, explanation: '7x + 9 = 4x + 27\nSubtract 4x from both sides: 3x + 9 = 27\nSubtract 9 from both sides: 3x = 18\nDivide both sides by 3: x = 6\nCheck: 7(6) + 9 = 51 and 4(6) + 27 = 51 ✓' },
        { difficulty: 'Medium', question: 'Solve: 11x − 10 = 6x + 30', checkMode: 'auto', options: ['40', '8', '-8', '9'], correctIndex: 1, explanation: '11x − 10 = 6x + 30\nSubtract 6x from both sides: 5x − 10 = 30\nAdd 10 to both sides: 5x = 40\nDivide both sides by 5: x = 8\nCheck: 11(8) − 10 = 78 and 6(8) + 30 = 78 ✓' },
        { difficulty: 'Medium-Hard', question: 'Eight times a number, decreased by 5, equals five times the number increased by 19. Form an equation and solve it.', checkMode: 'auto', options: ['24', '-8', '8', '7'], correctIndex: 2, explanation: 'Let the number be x.\n8x − 5 = 5x + 19\nSubtract 5x from both sides: 3x − 5 = 19\nAdd 5 to both sides: 3x = 24\nDivide both sides by 3: x = 8\nCheck: 8(8) − 5 = 59 and 5(8) + 19 = 59 ✓' },
        ...
        // Block 2 — Equations with brackets to expand first (positions 4-7)
        { difficulty: 'Medium', question: 'Solve: 6(x + 2) = 54', checkMode: 'auto', options: ['52', '-7', '8', '7'], correctIndex: 3, explanation: '6(x + 2) = 54\nExpand the bracket: 6x + 12 = 54\nSubtract 12 from both sides: 6x = 42\nDivide both sides by 6: x = 7\nCheck: 6(7 + 2) = 6(9) = 54 ✓' },
        { difficulty: 'Medium', question: 'Solve: 4(3x − 2) = 100', checkMode: 'auto', options: ['9', '108', '-9', '10'], correctIndex: 0, explanation: '4(3x − 2) = 100\nExpand the bracket: 12x − 8 = 100\nAdd 8 to both sides: 12x = 108\nDivide both sides by 12: x = 9\nCheck: 4(3(9) − 2) = 4(25) = 100 ✓' },
        { difficulty: 'Medium-Hard', question: 'Solve: 7(x − 3) = 4x + 3', checkMode: 'auto', options: ['24', '8', '-8', '9'], correctIndex: 1, explanation: '7(x − 3) = 4x + 3\nExpand the bracket: 7x − 21 = 4x + 3\nSubtract 4x from both sides: 3x − 21 = 3\nAdd 21 to both sides: 3x = 24\nDivide both sides by 3: x = 8\nCheck: 7(8 − 3) = 7(5) = 35 and 4(8) + 3 = 35 ✓' },
        ...
        // Block 3 — Equations with fractions, clearing denominators (positions 8-11)
        { difficulty: 'Medium', question: 'Solve: x/5 + 8 = 15', checkMode: 'auto', options: ['7', '115', '35', '30'], correctIndex: 2, explanation: 'x/5 + 8 = 15\nSubtract 8 from both sides: x/5 = 7\nMultiply both sides by 5: x = 35\nCheck: 35/5 + 8 = 7 + 8 = 15 ✓' },
        { difficulty: 'Medium', question: 'Solve: (x + 9)/4 = 8', checkMode: 'auto', options: ['32', '41', '22', '23'], correctIndex: 3, explanation: '(x + 9)/4 = 8\nMultiply both sides by 4: x + 9 = 32\nSubtract 9 from both sides: x = 23\nCheck: (23 + 9)/4 = 32/4 = 8 ✓' },
        { difficulty: 'Medium-Hard', question: 'Solve: x/4 + x/5 = 9', checkMode: 'auto', options: ['20', '1', '81', '18'], correctIndex: 0, explanation: 'x/4 + x/5 = 9\nMultiply every term by the lowest common denominator, 20: 5x + 4x = 180\nCollect like terms: 9x = 180\nDivide both sides by 9: x = 20\nCheck: 20/4 + 20/5 = 5 + 4 = 9 ✓' },
        ...
        { difficulty: 'Medium-Hard', question: 'A tuck shop charges a R18 stall fee plus R6 per item. A second stall has a R6 stall fee but charges R9 per item. For how many items, n, would the total cost be the same at both stalls?', checkMode: 'auto', options: ['12', '-4', '4', '5'], correctIndex: 2, explanation: '18 + 6n = 6 + 9n\nSubtract 6n from both sides: 18 = 6 + 3n\nSubtract 6 from both sides: 12 = 3n\nDivide both sides by 3: n = 4\nCheck: 18 + 6(4) = 42 and 6 + 9(4) = 42 ✓' },

        // Block 5 — Checking solutions by substitution / error-spotting (positions 16-17)
        { difficulty: 'Medium', question: 'Is x = 10 a solution to 3x − 8 = 2x + 3? Show your substitution check, and give the correct solution if not.', checkMode: 'auto', options: ['Yes, x = 10 satisfies the equation', 'Only the left-hand side is true', 'Cannot be determined from the equation alone', 'No, x = 10 does not satisfy the equation'], correctIndex: 3, explanation: 'Substitute x = 10 into both sides.\nLeft side: 3(10) − 8 = 30 − 8 = 22\nRight side: 2(10) + 3 = 20 + 3 = 23\n22 does not equal 23, so x = 10 is not a solution. Solving correctly: 3x − 8 = 2x + 3 → x = 11. Check: 3(11) − 8 = 25 and 2(11) + 3 = 25 ✓' },
