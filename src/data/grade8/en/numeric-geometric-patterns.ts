  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'Find the next term in the pattern: 5, 12, 19, 26, 33, ?', checkMode: 'auto', options: ['39', '40', '47', '33'], correctIndex: 1, explanation: 'The common difference is 7 (12−5=7, 19−12=7, 26−19=7, 33−26=7). Next term: 33 + 7 = 40 ✓' },
        { difficulty: 'Easy', question: 'A savings account starts at R2 400 and grows by R150 every month: R2 400, R2 550, R2 700, R2 850. How much will be in the account the next month?', checkMode: 'auto', options: ['R2 950', 'R2 850', 'R3 050', 'R3 000'], correctIndex: 3, explanation: 'The rule is add R150 each time. R2 850 + R150 = R3 000 ✓' },
        { difficulty: 'Easy-Medium', question: 'Find the missing term: 8, ?, 26, 35.', checkMode: 'auto', options: ['17', '18', '20', '16'], correctIndex: 0, explanation: 'The known difference is 35 − 26 = 9, so the rule is add 9 each time. 8 + 9 = 17. Check: 26 − 17 = 9 ✓' },
        { difficulty: 'Medium', question: 'A pattern follows the rule "multiply the term by 2, then add 3", starting at 4: 4, 11, 25, 53. What is the next term?', checkMode: 'auto', options: ['106', '112', '109', '103'], correctIndex: 2, explanation: 'Apply the rule to 53: 53 × 2 = 106, then 106 + 3 = 109 ✓' },
        ...
        { difficulty: 'Medium', question: 'Find the nth term rule for the pattern 5, 13, 21, 29.', checkMode: 'auto', options: ['8n', '8n-3', '8n+3', '7n-2'], correctIndex: 1, explanation: 'Common difference = 8. Substitute n=1: 8(1)+c=5 → c=−3. Rule: nth term = 8n − 3. Check: 8(2)−3=13 ✓, 8(3)−3=21 ✓, 8(4)−3=29 ✓' },
        ...
        { difficulty: 'Hard', question: 'Using the phone contract rule cost = 20 × months + 100, after how many full months will the total cost first reach at least R400?', checkMode: 'auto', options: ['15', '14', '16', '20'], correctIndex: 0, explanation: 'Set up: 20 × months + 100 ≥ 400, so 20 × months ≥ 300, giving months ≥ 15. Check: 14 months gives 20(14)+100 = 380 (too little). 15 months gives 20(15)+100 = 400 ✓. 15 months is the first to reach at least R400.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // ── Block 1: Numeric sequences (next/missing term) ──────────────────
        { difficulty: 'Easy', question: 'Find the next term in the pattern: 7, 15, 23, 31, 39, ?', checkMode: 'auto', options: ['46', '55', '47', '39'], correctIndex: 2, explanation: 'The common difference is 8 (15−7=8, 23−15=8, 31−23=8, 39−31=8). Next term: 39 + 8 = 47 ✓' },
        { difficulty: 'Easy', question: 'A savings account starts at R1 800 and grows by R200 every month: R1 800, R2 000, R2 200, R2 400. How much will be in the account the next month?', checkMode: 'auto', options: ['R2 600', 'R2 500', 'R2 400', 'R2 800'], correctIndex: 0, explanation: 'The rule is add R200 each time. R2 400 + R200 = R2 600 ✓' },
        { difficulty: 'Easy-Medium', question: 'Find the missing term: 10, ?, 32, 43.', checkMode: 'auto', options: ['22', '19', '25', '21'], correctIndex: 3, explanation: 'The known difference is 43 − 32 = 11, so the rule is add 11 each time. 10 + 11 = 21. Check: 32 − 21 = 11 ✓' },
        { difficulty: 'Medium', question: 'A pattern follows the rule "multiply the term by 2, then add 1", starting at 3: 3, 7, 15, 31. What is the next term?', checkMode: 'auto', options: ['62', '63', '64', '61'], correctIndex: 1, explanation: 'Apply the rule to 31: 31 × 2 = 62, then 62 + 1 = 63 ✓' },
        ...
        { difficulty: 'Medium', question: 'Find the nth term rule for the pattern 6, 17, 28, 39.', checkMode: 'auto', options: ['11n+5', '11n', '11n-5', '6n+11'], correctIndex: 2, explanation: 'Common difference = 11. Substitute n=1: 11(1)+c=6 → c=−5. Rule: nth term = 11n − 5. Check: 11(2)−5=17 ✓, 11(3)−5=28 ✓, 11(4)−5=39 ✓' },
        ...
        // ── Block 4: Geometric/growing patterns [DIAGRAM-FLAGGED] ───────────
        { difficulty: 'Medium', question: 'A pattern of squares is built from matchsticks, as shown, with each new square joined to the previous one and sharing one side. Pattern 1 is a single square made of 4 matchsticks. Pattern 2 has two squares joined in a row, sharing one matchstick, using 7 matchsticks in total. Pattern 3 has three squares joined in a row, using 10 matchsticks in total. How many matchsticks are needed for Pattern 13?', checkMode: 'auto', options: ['40', '39', '43', '37'], correctIndex: 0, explanation: 'The pattern increases by 3 matchsticks each time: 4, 7, 10 (differences of 3). Rule: matchsticks = 3n + 1. Check: 3(1)+1=4 ✓, 3(2)+1=7 ✓, 3(3)+1=10 ✓. Pattern 13: 3(13)+1 = 39+1 = 40 matchsticks ✓', diagramSvg: '<svg viewBox="0 0 220 170" xmlns="http://www.w3.org/2000/svg"><g><line x1="18" y1="60" x2="38" y2="60" stroke="#0f1f3d" stroke-width="2.5"/><line x1="18" y1="78" x2="38" y2="78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="18" y1="60" x2="18" y2="78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="38" y1="60" x2="38" y2="78" stroke="#0f1f3d" stroke-width="2.5"/></g><text x="28" y="100" text-anchor="middle" fill="#374151" font-size="12" font-weight="600">Pattern 1</text><text x="28" y="115" text-anchor="middle" fill="#374151" font-size="11">4 sticks</text><g><line x1="85" y1="60" x2="103" y2="60" stroke="#0f1f3d" stroke-width="2.5"/><line x1="103" y1="60" x2="121" y2="60" stroke="#0f1f3d" stroke-width="2.5"/><line x1="85" y1="78" x2="103" y2="78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="103" y1="78" x2="121" y2="78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="85" y1="60" x2="85" y2="78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="103" y1="60" x2="103" y2="78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="121" y1="60" x2="121" y2="78" stroke="#0f1f3d" stroke-width="2.5"/></g><text x="103" y="100" text-anchor="middle" fill="#374151" font-size="12" font-weight="600">Pattern 2</text><text x="103" y="115" text-anchor="middle" fill="#374151" font-size="11">7 sticks</text><g><line x1="160" y1="60" x2="178" y2="60" stroke="#0f1f3d" stroke-width="2.5"/><line x1="178" y1="60" x2="196" y2="60" stroke="#0f1f3d" stroke-width="2.5"/><line x1="196" y1="60" x2="214" y2="60" stroke="#0f1f3d" stroke-width="2.5"/><line x1="160" y1="78" x2="178" y2="78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="178" y1="78" x2="196" y2="78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="196" y1="78" x2="214" y2="78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="160" y1="60" x2="160" y2="78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="178" y1="60" x2="178" y2="78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="196" y1="60" x2="196" y2="78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="214" y1="60" x2="214" y2="78" stroke="#0f1f3d" stroke-width="2.5"/></g><text x="187" y="100" text-anchor="middle" fill="#374151" font-size="12" font-weight="600">Pattern 3</text><text x="187" y="115" text-anchor="middle" fill="#374151" font-size="11">10 sticks</text></svg>' },
        ...
        { difficulty: 'Hard', question: 'Using the internet contract rule cost = 25 × months + 150, after how many full months will the total cost first reach at least R550?', checkMode: 'auto', options: ['15', '17', '22', '16'], correctIndex: 3, explanation: 'Set up: 25 × months + 150 ≥ 550, so 25 × months ≥ 400, giving months ≥ 16. Check: 15 months gives 25(15)+150 = 525 (too little). 16 months gives 25(16)+150 = 550 ✓. 16 months is the first to reach at least R550.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // ── Block 1: Numeric sequences (next/missing term) ──────────────────
        { difficulty: 'Easy', question: 'Find the next term in the pattern: 9, 16, 23, 30, 37, ?', checkMode: 'auto', options: ['44', '43', '51', '37'], correctIndex: 0, explanation: 'The common difference is 7 (16−9=7, 23−16=7, 30−23=7, 37−30=7). Next term: 37 + 7 = 44 ✓' },
        { difficulty: 'Easy', question: 'A debt starts at R3 200 and decreases by R250 every month: R3 200, R2 950, R2 700, R2 450. How much will be owed the next month?', checkMode: 'auto', options: ['R2 300', 'R2 450', 'R2 200', 'R2 150'], correctIndex: 2, explanation: 'The rule is subtract R250 each time. R2 450 − R250 = R2 200 ✓' },
        { difficulty: 'Easy-Medium', question: 'Find the missing term: 12, ?, 34, 45.', checkMode: 'auto', options: ['24', '23', '21', '27'], correctIndex: 1, explanation: 'The known difference is 45 − 34 = 11, so the rule is add 11 each time. 12 + 11 = 23. Check: 34 − 23 = 11 ✓' },
        { difficulty: 'Medium', question: 'A pattern follows the rule "multiply the term by 3, then subtract 2", starting at 2: 2, 4, 10, 28. What is the next term?', checkMode: 'auto', options: ['84', '78', '80', '82'], correctIndex: 3, explanation: 'Apply the rule to 28: 28 × 3 = 84, then 84 − 2 = 82 ✓' },
        ...
        { difficulty: 'Medium', question: 'Find the nth term rule for the pattern 4, 15, 26, 37.', checkMode: 'auto', options: ['11n-7', '11n+7', '11n', '4n+11'], correctIndex: 0, explanation: 'Common difference = 11. Substitute n=1: 11(1)+c=4 → c=−7. Rule: nth term = 11n − 7. Check: 11(2)−7=15 ✓, 11(3)−7=26 ✓, 11(4)−7=37 ✓' },
        ...
        // ── Block 4: Geometric/growing patterns [DIAGRAM-FLAGGED] ───────────
        { difficulty: 'Medium', question: 'A pattern of squares is built from matchsticks, as shown, with each new square joined to the previous one and sharing one side. Pattern 1 is a single square made of 4 matchsticks. Pattern 2 has two squares joined in a row, sharing one matchstick, using 7 matchsticks in total. Pattern 3 has three squares joined in a row, using 10 matchsticks in total. How many matchsticks are needed for Pattern 7?', checkMode: 'auto', options: ['21', '25', '22', '19'], correctIndex: 2, explanation: 'The pattern increases by 3 matchsticks each time: 4, 7, 10 (differences of 3). Rule: matchsticks = 3n + 1. Check: 3(1)+1=4 ✓, 3(2)+1=7 ✓, 3(3)+1=10 ✓. Pattern 7: 3(7)+1 = 21+1 = 22 matchsticks ✓', diagramSvg: '<svg viewBox="0 0 220 170" xmlns="http://www.w3.org/2000/svg"><g><line x1="18" y1="60" x2="38" y2="60" stroke="#0f1f3d" stroke-width="2.5"/><line x1="18" y1="78" x2="38" y2="78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="18" y1="60" x2="18" y2="78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="38" y1="60" x2="38" y2="78" stroke="#0f1f3d" stroke-width="2.5"/></g><text x="28" y="100" text-anchor="middle" fill="#374151" font-size="12" font-weight="600">Pattern 1</text><text x="28" y="115" text-anchor="middle" fill="#374151" font-size="11">4 sticks</text><g><line x1="85" y1="60" x2="103" y2="60" stroke="#0f1f3d" stroke-width="2.5"/><line x1="103" y1="60" x2="121" y2="60" stroke="#0f1f3d" stroke-width="2.5"/><line x1="85" y1="78" x2="103" y2="78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="103" y1="78" x2="121" y2="78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="85" y1="60" x2="85" y2="78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="103" y1="60" x2="103" y2="78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="121" y1="60" x2="121" y2="78" stroke="#0f1f3d" stroke-width="2.5"/></g><text x="103" y="100" text-anchor="middle" fill="#374151" font-size="12" font-weight="600">Pattern 2</text><text x="103" y="115" text-anchor="middle" fill="#374151" font-size="11">7 sticks</text><g><line x1="160" y1="60" x2="178" y2="60" stroke="#0f1f3d" stroke-width="2.5"/><line x1="178" y1="60" x2="196" y2="60" stroke="#0f1f3d" stroke-width="2.5"/><line x1="196" y1="60" x2="214" y2="60" stroke="#0f1f3d" stroke-width="2.5"/><line x1="160" y1="78" x2="178" y2="78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="178" y1="78" x2="196" y2="78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="196" y1="78" x2="214" y2="78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="160" y1="60" x2="160" y2="78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="178" y1="60" x2="178" y2="78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="196" y1="60" x2="196" y2="78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="214" y1="60" x2="214" y2="78" stroke="#0f1f3d" stroke-width="2.5"/></g><text x="187" y="100" text-anchor="middle" fill="#374151" font-size="12" font-weight="600">Pattern 3</text><text x="187" y="115" text-anchor="middle" fill="#374151" font-size="11">10 sticks</text></svg>' },
        ...
        { difficulty: 'Hard', question: 'Using the streaming subscription rule cost = 15 × months + 200, after how many full months will the total cost first reach at least R470?', checkMode: 'auto', options: ['17', '18', '19', '20'], correctIndex: 1, explanation: 'Set up: 15 × months + 200 ≥ 470, so 15 × months ≥ 270, giving months ≥ 18. Check: 17 months gives 15(17)+200 = 455 (too little). 18 months gives 15(18)+200 = 470 ✓. 18 months is the first to reach at least R470.' },
