  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'A solid has one flat circular base, one curved surface that tapers to a single point, and no other flat faces. What is this solid called?', checkMode: 'auto', options: ['cylinder', 'sphere', 'cone', 'square pyramid'], correctIndex: 2, explanation: 'A solid with one circular base and a curved surface tapering to a single apex is a cone ✓' },
        { difficulty: 'Easy', question: 'A solid has two identical, parallel circular bases joined by one curved surface. What is this solid called?', checkMode: 'auto', options: ['cylinder', 'cone', 'sphere', 'hexagonal prism'], correctIndex: 0, explanation: 'A solid with two parallel identical circular bases joined by a curved surface is a cylinder ✓' },
        { difficulty: 'Medium', question: 'Zanele is classifying three solids for a project. Solid A has 2 parallel pentagonal bases and rectangular lateral faces. Solid B has 1 pentagonal base and triangular lateral faces meeting at an apex. Solid C is perfectly round with one curved surface and no flat faces at all. Name each solid.', checkMode: 'auto', options: ['pentagonal pyramid, pentagonal prism, sphere', 'pentagonal prism, pentagonal pyramid, cylinder', 'hexagonal prism, pentagonal pyramid, sphere', 'pentagonal prism, pentagonal pyramid, sphere'], correctIndex: 3, explanation: 'Two parallel identical bases + rectangular lateral faces = prism, named by its base (pentagon) → pentagonal prism.\nOne base + triangular lateral faces meeting at an apex = pyramid → pentagonal pyramid.\nPerfectly round with one curved surface and no flat faces = sphere ✓' },

        // Block B: counting V/E/F of named polyhedra (4-7)
        { difficulty: 'Easy', question: 'How many faces does a hexagonal prism have?', checkMode: 'auto', options: ['6', '8', '12', '9'], correctIndex: 1, explanation: 'A hexagonal prism has a 6-sided base.\nFaces = base sides + 2 = 6 + 2 = 8 ✓' },
        { difficulty: 'Easy', question: 'How many vertices does a pentagonal pyramid have?', checkMode: 'auto', options: ['5', '10', '11', '6'], correctIndex: 3, explanation: 'A pentagonal pyramid has a 5-sided base.\nVertices = base sides + 1 = 5 + 1 = 6 ✓' },
        { difficulty: 'Medium', question: 'A gift box is shaped like a triangular prism. How many edges does it have?', checkMode: 'auto', options: ['9', '6', '5', '12'], correctIndex: 0, explanation: 'A triangular prism has a 3-sided base.\nEdges = base sides × 3 = 3 × 3 = 9 ✓' },
        ...
        { difficulty: 'Medium', question: "A hexagonal pyramid has F = 7 and V = 7. Use Euler's formula to find E.", checkMode: 'auto', options: ['14', '6', '12', '8'], correctIndex: 2, explanation: "F − E + V = 2\n7 − E + 7 = 2\n14 − E = 2\nE = 12 ✓\nCheck: a hexagon base has 6 sides, so E = 6 × 2 = 12 ✓" },
        { difficulty: 'Medium-Hard', question: 'A learner states that a nonagonal prism has F = 11, E = 27, V = 16. Use Euler\'s formula to check this. If it is wrong, state the correct value of V.', checkMode: 'auto', options: ['16', '18', '9', '20'], correctIndex: 1, explanation: 'A nonagonal prism has a 9-sided base.\nF = 9 + 2 = 11, E = 9 × 3 = 27, V = 9 × 2 = 18.\nThe learner\'s numbers give 11 − 27 + 16 = 0, not 2 — wrong.\nV should be 18, not 16.\nCheck: 11 − 27 + 18 = 2 ✓' },
        ...
        { difficulty: 'Medium-Hard', question: 'A net consists of 2 circles and 1 rectangle arranged as shown, where one circle touches the top edge of the rectangle, the other circle touches the bottom edge of the rectangle, and the rectangle\'s width exactly matches the circumference of the circles. Which solid does this net fold into?', checkMode: 'auto', options: ['cone', 'sphere', 'hexagonal prism', 'cylinder'], correctIndex: 3, explanation: 'The net has 2 identical circular bases and 1 rectangle that wraps around to form the curved surface, matching a cylinder — the rectangle\'s width must equal the circle\'s circumference so the curved surface joins up exactly ✓' },
        ...
        { difficulty: 'Hard', question: 'A rectangular prism is sliced by a plane parallel to its rectangular base, cutting straight across the prism. What shape is the cross-section?', checkMode: 'auto', options: ['square', 'circle', 'rectangle', 'triangle'], correctIndex: 2, explanation: 'A cross-section parallel to the base of a prism is always identical in shape to the base. Since the base is a rectangle, the cross-section is a rectangle ✓' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // Block A: naming/classifying (1-3)
        { difficulty: 'Easy', question: 'A solid is perfectly round, with every point on its surface the same distance from its centre, and has no flat faces at all. What is this solid called?', checkMode: 'auto', options: ['cone', 'cylinder', 'sphere', 'hemisphere'], correctIndex: 2, explanation: 'A perfectly round solid where every surface point is equidistant from the centre, with no flat faces, is a sphere ✓' },
        { difficulty: 'Easy', question: 'A solid has one heptagonal (7-sided) base and 7 triangular faces that all meet at a single apex. What is this solid called?', checkMode: 'auto', options: ['heptagonal pyramid', 'heptagonal prism', 'hexagonal pyramid', 'octagonal pyramid'], correctIndex: 0, explanation: 'A solid with one base and triangular faces meeting at a single apex is a pyramid. The base has 7 sides, so it is a heptagonal pyramid ✓' },
        { difficulty: 'Medium', question: 'Kabelo is classifying three solids for a display. Solid A has 2 parallel octagonal bases and rectangular lateral faces. Solid B has 1 circular base and 1 curved surface tapering to a point. Solid C has 2 parallel circular bases joined by 1 curved surface. Name each solid.', checkMode: 'auto', options: ['octagonal pyramid, cone, cylinder', 'octagonal prism, cylinder, cone', 'heptagonal prism, cone, cylinder', 'octagonal prism, cone, cylinder'], correctIndex: 3, explanation: 'Two parallel identical bases + rectangular lateral faces = prism, named by its base (octagon) → octagonal prism.\nOne circular base + curved surface tapering to a point = cone.\nTwo parallel circular bases + curved surface = cylinder ✓' },

        // Block B: counting V/E/F of named polyhedra (4-7)
        { difficulty: 'Easy', question: 'How many faces does a heptagonal prism have?', checkMode: 'auto', options: ['7', '9', '14', '10'], correctIndex: 1, explanation: 'A heptagonal prism has a 7-sided base.\nFaces = base sides + 2 = 7 + 2 = 9 ✓' },
        { difficulty: 'Easy', question: 'How many vertices does a hexagonal pyramid have?', checkMode: 'auto', options: ['6', '12', '13', '7'], correctIndex: 3, explanation: 'A hexagonal pyramid has a 6-sided base.\nVertices = base sides + 1 = 6 + 1 = 7 ✓' },
        { difficulty: 'Medium', question: 'A jewellery box is shaped like a triangular prism. How many vertices does it have?', checkMode: 'auto', options: ['6', '9', '5', '3'], correctIndex: 0, explanation: 'A triangular prism has a 3-sided base.\nVertices = base sides × 2 = 3 × 2 = 6 ✓' },
        ...
        { difficulty: 'Medium', question: "A heptagonal pyramid has F = 8 and V = 8. Use Euler's formula to find E.", checkMode: 'auto', options: ['16', '7', '14', '10'], correctIndex: 2, explanation: "F − E + V = 2\n8 − E + 8 = 2\n16 − E = 2\nE = 14 ✓\nCheck: a heptagon base has 7 sides, so E = 7 × 2 = 14 ✓" },
        { difficulty: 'Medium-Hard', question: 'A learner states that a decagonal prism has F = 12, E = 30, V = 18. Use Euler\'s formula to check this. If it is wrong, state the correct value of V.', checkMode: 'auto', options: ['18', '20', '10', '22'], correctIndex: 1, explanation: 'A decagonal prism has a 10-sided base.\nF = 10 + 2 = 12, E = 10 × 3 = 30, V = 10 × 2 = 20.\nThe learner\'s numbers give 12 − 30 + 18 = 0, not 2 — wrong.\nV should be 20, not 18.\nCheck: 12 − 30 + 20 = 2 ✓' },
        ...
        { difficulty: 'Medium-Hard', question: 'A net consists of 1 circle and 1 sector of a larger circle arranged as shown, where the curved edge of the sector lies directly against the circle so the two curved edges match in length exactly. Which solid does this net fold into?', checkMode: 'auto', options: ['cylinder', 'sphere', 'pentagonal prism', 'cone'], correctIndex: 3, explanation: 'The net has 1 circular base and 1 sector that rolls up into the curved surface of a cone, meeting at a single apex when the sector\'s straight edges are joined — this matches a cone, where the sector\'s curved edge length must equal the base circle\'s circumference ✓' },
        ...
        // Block E: cross-sections (16-18)
        { difficulty: 'Hard', question: 'A triangular prism is sliced by a plane parallel to its triangular base, cutting straight across the prism. What shape is the cross-section?', checkMode: 'auto', options: ['rectangle', 'square', 'triangle', 'pentagon'], correctIndex: 2, explanation: 'A cross-section parallel to the base of a prism is always identical in shape to the base. Since the base is a triangle, the cross-section is a triangle ✓' },
        ...
        { difficulty: 'Hard', question: 'A cylinder lying on its curved side is sliced by a plane perpendicular to its circular bases, cutting lengthwise through the centre. What shape is the cross-section?', checkMode: 'auto', options: ['circle', 'rectangle', 'square', 'oval'], correctIndex: 1, explanation: 'Slicing a cylinder lengthwise through its axis, perpendicular to the circular bases, produces a rectangular cross-section — its length equals the cylinder\'s height and its width equals the diameter of the circular base ✓' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // Block A: naming/classifying (1-3)
        { difficulty: 'Easy', question: 'A solid has two identical, parallel decagonal (10-sided) bases joined by 10 rectangular faces. What is this solid called?', checkMode: 'auto', options: ['nonagonal prism', 'decagonal pyramid', 'decagonal prism', 'dodecagonal prism'], correctIndex: 2, explanation: 'A solid with two identical parallel bases and rectangular lateral faces is a prism. The base has 10 sides, so it is a decagonal prism ✓' },
        { difficulty: 'Easy', question: 'A solid has one flat circular base and one curved surface that narrows smoothly to a single apex above the base. What is this solid called?', checkMode: 'auto', options: ['cone', 'cylinder', 'sphere', 'square pyramid'], correctIndex: 0, explanation: 'A solid with a circular base and a curved surface that narrows to a single apex is a cone ✓' },
        { difficulty: 'Medium', question: 'Amahle is classifying three solids for a science fair. Solid A has 1 nonagonal base and 9 triangular faces meeting at an apex. Solid B has 2 parallel circular bases joined by a curved surface. Solid C is perfectly round with no flat faces at all. Name each solid.', checkMode: 'auto', options: ['nonagonal prism, cylinder, sphere', 'nonagonal pyramid, sphere, cylinder', 'octagonal pyramid, cylinder, sphere', 'nonagonal pyramid, cylinder, sphere'], correctIndex: 3, explanation: 'One base + triangular lateral faces meeting at an apex = pyramid, named by its base (nonagon) → nonagonal pyramid.\nTwo parallel circular bases + curved surface = cylinder.\nPerfectly round with no flat faces = sphere ✓' },

        // Block B: counting V/E/F of named polyhedra (4-7)
        { difficulty: 'Easy', question: 'How many faces does an octagonal prism have?', checkMode: 'auto', options: ['8', '10', '16', '11'], correctIndex: 1, explanation: 'An octagonal prism has an 8-sided base.\nFaces = base sides + 2 = 8 + 2 = 10 ✓' },
        { difficulty: 'Easy', question: 'How many vertices does a heptagonal pyramid have?', checkMode: 'auto', options: ['7', '14', '15', '8'], correctIndex: 3, explanation: 'A heptagonal pyramid has a 7-sided base.\nVertices = base sides + 1 = 7 + 1 = 8 ✓' },
        { difficulty: 'Medium', question: 'A camping tent is shaped like a triangular prism. How many faces does it have?', checkMode: 'auto', options: ['5', '6', '9', '3'], correctIndex: 0, explanation: 'A triangular prism has a 3-sided base.\nFaces = base sides + 2 = 3 + 2 = 5 ✓' },
        ...
        { difficulty: 'Medium', question: "An octagonal pyramid has F = 9 and V = 9. Use Euler's formula to find E.", checkMode: 'auto', options: ['18', '8', '16', '12'], correctIndex: 2, explanation: "F − E + V = 2\n9 − E + 9 = 2\n18 − E = 2\nE = 16 ✓\nCheck: an octagon base has 8 sides, so E = 8 × 2 = 16 ✓" },
        { difficulty: 'Medium-Hard', question: 'A learner states that a heptagonal prism has F = 9, E = 21, V = 12. Use Euler\'s formula to check this. If it is wrong, state the correct value of V.', checkMode: 'auto', options: ['12', '14', '7', '16'], correctIndex: 1, explanation: 'A heptagonal prism has a 7-sided base.\nF = 7 + 2 = 9, E = 7 × 3 = 21, V = 7 × 2 = 14.\nThe learner\'s numbers give 9 − 21 + 12 = 0, not 2 — wrong.\nV should be 14, not 12.\nCheck: 9 − 21 + 14 = 2 ✓' },
        ...
        // Block E: cross-sections (16-18)
        { difficulty: 'Hard', question: 'A hexagonal prism is sliced by a plane parallel to its hexagonal base, cutting straight across the prism. What shape is the cross-section?', checkMode: 'auto', options: ['pentagon', 'octagon', 'hexagon', 'rectangle'], correctIndex: 2, explanation: 'A cross-section parallel to the base of a prism is always identical in shape to the base. Since the base is a hexagon, the cross-section is a hexagon ✓' },
        ...
        { difficulty: 'Hard', question: 'A cone lying on its curved side (on its side, not upright) is sliced vertically through its apex and the centre of its circular base. What shape is the cross-section?', checkMode: 'auto', options: ['circle', 'triangle', 'rectangle', 'semicircle'], correctIndex: 1, explanation: 'Slicing a cone through its apex and through the centre of its base produces a triangular cross-section — one side is the diameter of the base, and the other two sides run from the ends of that diameter up to the apex ✓' },
