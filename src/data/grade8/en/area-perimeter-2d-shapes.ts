  ...
  practiceSets: [
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'A triangular garden plot has sides of 8 m, 9 m and 7 m, as shown. Calculate its perimeter.', answer: '24 m', checkMode: 'auto', correctAnswer: '24', correctAnswers: ['24', '24 m', '24m'], explanation: 'Add all three sides: P = 8 + 9 + 7 = 24 m ✓', diagramSvg: '<svg viewBox="0 0 220 190" xmlns="http://www.w3.org/2000/svg"><polygon points="45,150 175,150 130,35" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="87.5" y="168" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">8 m</text><text x="180" y="98" font-size="13" fill="#dc2626" font-weight="700" text-anchor="start">9 m</text><text x="70" y="90" font-size="13" fill="#7c3aed" font-weight="700" text-anchor="end">7 m</text></svg>' },
        ...
        { difficulty: 'Medium', question: 'A circular table has a diameter of 1.0 m, as shown. Find its circumference to 2 decimal places (π = 3.14).', answer: '3.14 m', checkMode: 'auto', correctAnswer: '3.14m', correctAnswers: ['3.14m', '3.14 m', '3.14'], explanation: 'C = πd = 3.14 × 1.0 = 3.14 m ✓', diagramSvg: '<svg viewBox="0 0 220 190" xmlns="http://www.w3.org/2000/svg"><circle cx="110" cy="95" r="65" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="45" y1="95" x2="175" y2="95" stroke="#dc2626" stroke-width="2"/><text x="110" y="88" font-size="14" fill="#dc2626" font-weight="700" text-anchor="middle">1.0 m</text></svg>' },
        { difficulty: 'Hard', question: 'A circular running track has a circumference of 125.6 m (π = 3.14). Find its radius, as shown.', answer: '20 m', checkMode: 'auto', correctAnswer: '20', correctAnswers: ['20', '20 m', '20m'], explanation: 'C = 2πr\n125.6 = 2 × 3.14 × r\n125.6 = 6.28r\nr = 20 m ✓', diagramSvg: '<svg viewBox="0 0 220 190" xmlns="http://www.w3.org/2000/svg"><circle cx="110" cy="95" r="65" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="110" y1="95" x2="175" y2="95" stroke="#ea580c" stroke-width="2" stroke-dasharray="5,4"/><text x="142" y="88" font-size="15" fill="#ea580c" font-weight="700" text-anchor="middle">?</text><text x="110" y="175" font-size="12" fill="#374151" text-anchor="middle">Circumference = 125.6 m</text></svg>' },
    ...
    },
    {
      ...
      questions: [
        ...
        { difficulty: 'Hard', question: 'A trapezium-shaped garden plot has parallel sides of 8 m and 14 m, and a height of 5 m, as shown. Find its area.', answer: '55 m²', checkMode: 'auto', correctAnswer: '55', correctAnswers: ['55', '55 m²', '55m²'], explanation: 'A = ½ × (a + b) × h = 0.5 × (8 + 14) × 5 = 0.5 × 22 × 5 = 55 m² ✓', diagramSvg: '<svg viewBox="0 0 220 190" xmlns="http://www.w3.org/2000/svg"><polygon points="70,45 150,45 190,145 30,145" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="110" y1="45" x2="110" y2="145" stroke="#7c3aed" stroke-width="2" stroke-dasharray="5,4"/><rect x="102" y="137" width="8" height="8" fill="none" stroke="#7c3aed" stroke-width="1.5"/><text x="110.0" y="33" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">8 m</text><text x="110.0" y="163" font-size="13" fill="#dc2626" font-weight="700" text-anchor="middle">14 m</text><text x="124" y="98" font-size="13" fill="#7c3aed" font-weight="700" text-anchor="start">5 m</text></svg>' },
        ...
        { difficulty: 'Medium', question: 'A circular table has a diameter of 1.2 m, as shown. Find its circumference to 2 decimal places (π = 3.14).', answer: '3.77 m', checkMode: 'auto', correctAnswer: '3.77m', correctAnswers: ['3.77m', '3.77 m', '3.77'], explanation: 'C = πd = 3.14 × 1.2 = 3.768 m ≈ 3.77 m ✓', diagramSvg: '<svg viewBox="0 0 220 190" xmlns="http://www.w3.org/2000/svg"><circle cx="110" cy="95" r="65" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="45" y1="95" x2="175" y2="95" stroke="#dc2626" stroke-width="2"/><text x="110" y="88" font-size="14" fill="#dc2626" font-weight="700" text-anchor="middle">1.2 m</text></svg>' },
        { difficulty: 'Hard', question: 'A circular running track has a circumference of 157 m (π = 3.14). Find its radius, as shown.', answer: '25 m', checkMode: 'auto', correctAnswer: '25', correctAnswers: ['25', '25 m', '25m'], explanation: 'C = 2πr\n157 = 2 × 3.14 × r\n157 = 6.28r\nr = 25 m ✓', diagramSvg: '<svg viewBox="0 0 220 190" xmlns="http://www.w3.org/2000/svg"><circle cx="110" cy="95" r="65" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="110" y1="95" x2="175" y2="95" stroke="#ea580c" stroke-width="2" stroke-dasharray="5,4"/><text x="142" y="88" font-size="15" fill="#ea580c" font-weight="700" text-anchor="middle">?</text><text x="110" y="175" font-size="12" fill="#374151" text-anchor="middle">Circumference = 157 m</text></svg>' },
    ...
    },
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'A circular table has a diameter of 1.6 m, as shown. Find its circumference to 2 decimal places (π = 3.14).', answer: '5.02 m', checkMode: 'auto', correctAnswer: '5.02m', correctAnswers: ['5.02m', '5.02 m', '5.02'], explanation: 'C = πd = 3.14 × 1.6 = 5.024 m ≈ 5.02 m ✓', diagramSvg: '<svg viewBox="0 0 220 190" xmlns="http://www.w3.org/2000/svg"><circle cx="110" cy="95" r="65" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="45" y1="95" x2="175" y2="95" stroke="#dc2626" stroke-width="2"/><text x="110" y="88" font-size="14" fill="#dc2626" font-weight="700" text-anchor="middle">1.6 m</text></svg>' },
        { difficulty: 'Hard', question: 'A circular running track has a circumference of 188.4 m (π = 3.14). Find its radius, as shown.', answer: '30 m', checkMode: 'auto', correctAnswer: '30', correctAnswers: ['30', '30 m', '30m'], explanation: 'C = 2πr\n188.4 = 2 × 3.14 × r\n188.4 = 6.28r\nr = 30 m ✓', diagramSvg: '<svg viewBox="0 0 220 190" xmlns="http://www.w3.org/2000/svg"><circle cx="110" cy="95" r="65" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="110" y1="95" x2="175" y2="95" stroke="#ea580c" stroke-width="2" stroke-dasharray="5,4"/><text x="142" y="88" font-size="15" fill="#ea580c" font-weight="700" text-anchor="middle">?</text><text x="110" y="175" font-size="12" fill="#374151" text-anchor="middle">Circumference = 188.4 m</text></svg>' },
