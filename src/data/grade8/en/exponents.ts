...
export const topicData: TopicData = {
  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      name: 'Set 1',
      questions: [
        { difficulty: 'Easy', question: 'Simplify 3⁵ × 3², leaving your answer as a power of 3, then evaluate it.', checkMode: 'auto', options: ['59049', '27', '2187', '21'], correctIndex: 2, explanation: 'Same base — add the exponents: 3⁵ × 3² = 3^(5+2) = 3⁷ = 2 187 ✓' },
        { difficulty: 'Easy', question: 'Simplify 4⁶ ÷ 4², leaving your answer as a power of 4, then evaluate it.', checkMode: 'auto', options: ['4096', '1/256', '16', '256'], correctIndex: 3, explanation: 'Same base — subtract the exponents: 4⁶ ÷ 4² = 4^(6−2) = 4⁴ = 256 ✓' },
        ...
        { difficulty: 'Medium', question: 'Simplify 7⁷ ÷ 7³, leaving your answer as a power of 7, then evaluate it.', checkMode: 'auto', options: ['2401', '823543', '1/2401', '28'], correctIndex: 0, explanation: 'Same base — subtract the exponents: 7⁷ ÷ 7³ = 7^(7−3) = 7⁴ = 2 401 ✓' },
        { difficulty: 'Medium', question: 'Apply the power of a power law to simplify (2³)⁴, then evaluate it.', checkMode: 'auto', options: ['128', '4096', '16', '24'], correctIndex: 1, explanation: 'Power of a power — multiply the exponents: (2³)⁴ = 2^(3×4) = 2¹² = 4 096 ✓' },
        { difficulty: 'Medium', question: 'Simplify (3²)³ using the power of a power law, then evaluate it.', checkMode: 'auto', options: ['243', '27', '729', '18'], correctIndex: 2, explanation: 'Power of a power — multiply the exponents: (3²)³ = 3^(2×3) = 3⁶ = 729 ✓' },
        { difficulty: 'Medium-Hard', question: 'Use the power of a product law to simplify (2 × 5)³, then evaluate it two different ways to check your answer matches.', checkMode: 'auto', options: ['40', '30', '343', '1000'], correctIndex: 3, explanation: 'Method 1: (2 × 5)³ = 10³ = 1 000. Method 2 (power of a product): 2³ × 5³ = 8 × 125 = 1 000. Both methods agree ✓' },
        { difficulty: 'Medium', question: 'Simplify and evaluate: (2³ × 2²) ÷ 2⁴.', checkMode: 'auto', options: ['2', '512', '32', '1/2'], correctIndex: 0, explanation: 'Step 1: Product law in the numerator: 2³ × 2² = 2^(3+2) = 2⁵.\nStep 2: Quotient law: 2⁵ ÷ 2⁴ = 2^(5−4) = 2¹ = 2 ✓' },
        { difficulty: 'Medium-Hard', question: 'Simplify (3⁴ × 3¹) ÷ 3³, giving a final numerical answer.', checkMode: 'auto', options: ['6561', '9', '243', '1/9'], correctIndex: 1, explanation: 'Step 1: Product law: 3⁴ × 3¹ = 3^(4+1) = 3⁵.\nStep 2: Quotient law: 3⁵ ÷ 3³ = 3^(5−3) = 3² = 9 ✓' },
        ...
        { difficulty: 'Easy', question: 'Calculate (−6)².', checkMode: 'auto', options: ['-36', '12', '36', '6'], correctIndex: 2, explanation: '(−6)² = (−6) × (−6) = +36\nThe negative sign is inside the brackets and is squared, giving a positive result ✓' },
        { difficulty: 'Easy', question: 'Calculate −6².', checkMode: 'auto', options: ['36', '-12', '12', '-36'], correctIndex: 3, explanation: '−6² means −(6²) = −(36) = −36\nThe exponent applies only to 6, not to the negative sign ✓' },
        { difficulty: 'Medium', question: 'Calculate (−2)³ and −2³. Kagiso says these must be different because "(−a)ⁿ and −aⁿ are never equal." Show the values and comment on his claim.', checkMode: 'auto', options: ['-8', '8', '4', '-6'], correctIndex: 0, explanation: '(−2)³ = (−2)×(−2)×(−2) = −8. −2³ = −(2³) = −8. His claim is false in this case — for odd exponents, (−a)ⁿ and −aⁿ are always equal, because a negative number raised to an odd power stays negative either way.' },
        ...
        { difficulty: 'Medium', question: 'Find the square root of 16/25.', checkMode: 'auto', options: ['5/4', '4/5', '4/25', '16/5'], correctIndex: 1, explanation: 'Apply the root to numerator and denominator separately.\n√16 = 4 and √25 = 5\n√(16/25) = 4/5 ✓' },
        { difficulty: 'Medium', question: 'Find the cube root of 27/64.', checkMode: 'auto', options: ['4/3', '3/64', '3/4', '27/4'], correctIndex: 2, explanation: 'Apply the cube root to numerator and denominator separately.\n∛27 = 3 and ∛64 = 4\n∛(27/64) = 3/4 ✓' },
        ...
        { difficulty: 'Easy', question: 'Write 123 000 in scientific notation.', checkMode: 'auto', options: ['1.23 × 10⁴', '1.23 × 10⁶', '12.3 × 10⁴', '1.23 × 10⁵'], correctIndex: 3, explanation: 'Move the decimal 5 places left: 123 000 → 1.23\nAnswer: 1.23 × 10⁵ ✓' },
        { difficulty: 'Medium', question: 'Write 900 000 000 in scientific notation.', checkMode: 'auto', options: ['9 × 10⁸', '9 × 10⁷', '9 × 10⁹', '90 × 10⁷'], correctIndex: 0, explanation: 'Move the decimal 8 places left: 900 000 000 → 9\nAnswer: 9 × 10⁸ ✓' },
        { difficulty: 'Hard', question: 'A city library holds approximately 300 000 000 (3.0 × 10⁸) pages of documents in total, stored in files of 24 000 (2.4 × 10⁴) pages each. Write both quantities in scientific notation, then calculate how many files are needed.', checkMode: 'auto', options: ['1250', '12500', '125000', '10000'], correctIndex: 1, explanation: 'Divide: (3.0 × 10⁸) ÷ (2.4 × 10⁴)\n= (3.0 ÷ 2.4) × 10^(8−4)\n= 1.25 × 10⁴ = 12 500 files ✓' },
      ],
      scoreMessages: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      name: 'Set 2',
      questions: [
        { difficulty: 'Easy', question: 'Simplify 5³ × 5⁴, leaving your answer as a power of 5, then evaluate it.', checkMode: 'auto', options: ['244140625', '5', '35', '78125'], correctIndex: 3, explanation: 'Same base — add the exponents: 5³ × 5⁴ = 5^(3+4) = 5⁷ = 78 125 ✓' },
        { difficulty: 'Easy', question: 'Simplify 8⁷ ÷ 8³, leaving your answer as a power of 8, then evaluate it.', checkMode: 'auto', options: ['4096', '2097152', '1/4096', '32'], correctIndex: 0, explanation: 'Same base — subtract the exponents: 8⁷ ÷ 8³ = 8^(7−3) = 8⁴ = 4 096 ✓' },
        ...
        { difficulty: 'Medium', question: 'Simplify 9⁶ ÷ 9⁴, leaving your answer as a power of 9, then evaluate it.', checkMode: 'auto', options: ['531441', '81', '1/81', '18'], correctIndex: 1, explanation: 'Same base — subtract the exponents: 9⁶ ÷ 9⁴ = 9^(6−4) = 9² = 81 ✓' },
        { difficulty: 'Medium', question: 'Apply the power of a power law to simplify (4²)³, then evaluate it.', checkMode: 'auto', options: ['1024', '64', '4096', '24'], correctIndex: 2, explanation: 'Power of a power — multiply the exponents: (4²)³ = 4^(2×3) = 4⁶ = 4 096 ✓' },
        { difficulty: 'Medium', question: 'Simplify (2⁴)² using the power of a power law, then evaluate it.', checkMode: 'auto', options: ['64', '4', '16', '256'], correctIndex: 3, explanation: 'Power of a power — multiply the exponents: (2⁴)² = 2^(4×2) = 2⁸ = 256 ✓' },
        { difficulty: 'Medium-Hard', question: 'Use the power of a product law to simplify (3 × 4)³, then evaluate it two different ways to check your answer matches.', checkMode: 'auto', options: ['1728', '108', '36', '343'], correctIndex: 0, explanation: 'Method 1: (3 × 4)³ = 12³ = 1 728. Method 2 (power of a product): 3³ × 4³ = 27 × 64 = 1 728. Both methods agree ✓' },
        { difficulty: 'Medium', question: 'Simplify and evaluate: (5³ × 5²) ÷ 5⁴.', checkMode: 'auto', options: ['1953125', '5', '3125', '1/5'], correctIndex: 1, explanation: 'Step 1: Product law in the numerator: 5³ × 5² = 5^(3+2) = 5⁵.\nStep 2: Quotient law: 5⁵ ÷ 5⁴ = 5^(5−4) = 5¹ = 5 ✓' },
        { difficulty: 'Medium-Hard', question: 'Simplify (2⁵ × 2¹) ÷ 2⁴, giving a final numerical answer.', checkMode: 'auto', options: ['1024', '64', '4', '1/4'], correctIndex: 2, explanation: 'Step 1: Product law: 2⁵ × 2¹ = 2^(5+1) = 2⁶.\nStep 2: Quotient law: 2⁶ ÷ 2⁴ = 2^(6−4) = 2² = 4 ✓' },
        ...
        { difficulty: 'Easy', question: 'Calculate (−8)².', checkMode: 'auto', options: ['-64', '16', '8', '64'], correctIndex: 3, explanation: '(−8)² = (−8) × (−8) = +64\nThe negative sign is inside the brackets and is squared, giving a positive result ✓' },
        { difficulty: 'Easy', question: 'Calculate −8².', checkMode: 'auto', options: ['-64', '64', '-16', '16'], correctIndex: 0, explanation: '−8² means −(8²) = −(64) = −64\nThe exponent applies only to 8, not to the negative sign ✓' },
        { difficulty: 'Medium', question: 'Calculate (−3)³ and −3³. Naledi says these must be different because "(−a)ⁿ and −aⁿ are never equal." Show the values and comment on her claim.', checkMode: 'auto', options: ['27', '-27', '9', '-9'], correctIndex: 1, explanation: '(−3)³ = (−3)×(−3)×(−3) = −27. −3³ = −(3³) = −27. Her claim is false in this case — for odd exponents, (−a)ⁿ and −aⁿ are always equal, because a negative number raised to an odd power stays negative either way.' },
        ...
        { difficulty: 'Medium', question: 'Find the square root of 25/49.', checkMode: 'auto', options: ['7/5', '5/49', '5/7', '25/7'], correctIndex: 2, explanation: 'Apply the root to numerator and denominator separately.\n√25 = 5 and √49 = 7\n√(25/49) = 5/7 ✓' },
        { difficulty: 'Medium', question: 'Find the cube root of 64/125.', checkMode: 'auto', options: ['5/4', '4/125', '64/5', '4/5'], correctIndex: 3, explanation: 'Apply the cube root to numerator and denominator separately.\n∛64 = 4 and ∛125 = 5\n∛(64/125) = 4/5 ✓' },
        ...
        { difficulty: 'Easy', question: 'Write 67 000 in scientific notation.', checkMode: 'auto', options: ['6.7 × 10⁴', '6.7 × 10³', '6.7 × 10⁵', '67 × 10³'], correctIndex: 0, explanation: 'Move the decimal 4 places left: 67 000 → 6.7\nAnswer: 6.7 × 10⁴ ✓' },
        { difficulty: 'Medium', question: 'Write 5 000 000 000 in scientific notation.', checkMode: 'auto', options: ['5 × 10⁸', '5 × 10⁹', '5 × 10¹⁰', '50 × 10⁸'], correctIndex: 1, explanation: 'Move the decimal 9 places left: 5 000 000 000 → 5\nAnswer: 5 × 10⁹ ✓' },
        { difficulty: 'Hard', question: 'A phone manufacturer produces approximately 480 000 000 (4.8 × 10⁸) components per year, packed into boxes of 160 000 (1.6 × 10⁵) components each. Write both quantities in scientific notation, then calculate how many boxes are needed per year.', checkMode: 'auto', options: ['300', '30000', '3000', '4800'], correctIndex: 2, explanation: 'Divide: (4.8 × 10⁸) ÷ (1.6 × 10⁵)\n= (4.8 ÷ 1.6) × 10^(8−5)\n= 3.0 × 10³ = 3 000 boxes ✓' },
      ],
      scoreMessages: [
        { minScore: 20, message: 'Outstanding! You have mastered the laws of exponents, roots and scientific notation at Grade 8 level.' },
        { minScore: 15, message: 'Great work! Review any missed questions and try again.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      name: 'Set 3',
      questions: [
        { difficulty: 'Easy', question: 'Simplify 2⁶ × 2³, leaving your answer as a power of 2, then evaluate it.', checkMode: 'auto', options: ['512', '262144', '8', '18'], correctIndex: 0, explanation: 'Same base — add the exponents: 2⁶ × 2³ = 2^(6+3) = 2⁹ = 512 ✓' },
        { difficulty: 'Easy', question: 'Simplify 6⁷ ÷ 6⁵, leaving your answer as a power of 6, then evaluate it.', checkMode: 'auto', options: ['279936', '36', '1/36', '12'], correctIndex: 1, explanation: 'Same base — subtract the exponents: 6⁷ ÷ 6⁵ = 6^(7−5) = 6² = 36 ✓' },
        ...
        { difficulty: 'Medium', question: 'Simplify 10⁸ ÷ 10⁵, leaving your answer as a power of 10, then evaluate it.', checkMode: 'auto', options: ['100000000', '1/1000', '1000', '30'], correctIndex: 2, explanation: 'Same base — subtract the exponents: 10⁸ ÷ 10⁵ = 10^(8−5) = 10³ = 1 000 ✓' },
        { difficulty: 'Medium', question: 'Apply the power of a power law to simplify (5³)², then evaluate it.', checkMode: 'auto', options: ['3125', '25', '30', '15625'], correctIndex: 3, explanation: 'Power of a power — multiply the exponents: (5³)² = 5^(3×2) = 5⁶ = 15 625 ✓' },
        { difficulty: 'Medium', question: 'Simplify (3²)⁴ using the power of a power law, then evaluate it.', checkMode: 'auto', options: ['6561', '729', '81', '24'], correctIndex: 0, explanation: 'Power of a power — multiply the exponents: (3²)⁴ = 3^(2×4) = 3⁸ = 6 561 ✓' },
        { difficulty: 'Medium-Hard', question: 'Use the power of a product law to simplify (2 × 3)⁵, then evaluate it two different ways to check your answer matches.', checkMode: 'auto', options: ['96', '7776', '30', '3125'], correctIndex: 1, explanation: 'Method 1: (2 × 3)⁵ = 6⁵ = 7 776. Method 2 (power of a product): 2⁵ × 3⁵ = 32 × 243 = 7 776. Both methods agree ✓' },
        { difficulty: 'Medium', question: 'Simplify and evaluate: (3³ × 3²) ÷ 3⁴.', checkMode: 'auto', options: ['19683', '243', '3', '1/3'], correctIndex: 2, explanation: 'Step 1: Product law in the numerator: 3³ × 3² = 3^(3+2) = 3⁵.\nStep 2: Quotient law: 3⁵ ÷ 3⁴ = 3^(5−4) = 3¹ = 3 ✓' },
        { difficulty: 'Medium-Hard', question: 'Simplify (6⁴ × 6¹) ÷ 6³, giving a final numerical answer.', checkMode: 'auto', options: ['1679616', '7776', '1/36', '36'], correctIndex: 3, explanation: 'Step 1: Product law: 6⁴ × 6¹ = 6^(4+1) = 6⁵.\nStep 2: Quotient law: 6⁵ ÷ 6³ = 6^(5−3) = 6² = 36 ✓' },
        ...
        { difficulty: 'Medium', question: 'Find the square root of 36/121.', checkMode: 'auto', options: ['11/6', '6/121', '36/11', '6/11'], correctIndex: 3, explanation: 'Apply the root to numerator and denominator separately.\n√36 = 6 and √121 = 11\n√(36/121) = 6/11 ✓' },
        { difficulty: 'Medium', question: 'Find the cube root of 125/216.', checkMode: 'auto', options: ['5/6', '6/5', '5/216', '125/6'], correctIndex: 0, explanation: 'Apply the cube root to numerator and denominator separately.\n∛125 = 5 and ∛216 = 6\n∛(125/216) = 5/6 ✓' },
        ...
        { difficulty: 'Easy', question: 'Write 890 000 in scientific notation.', checkMode: 'auto', options: ['8.9 × 10⁴', '8.9 × 10⁵', '8.9 × 10⁶', '89 × 10⁴'], correctIndex: 1, explanation: 'Move the decimal 5 places left: 890 000 → 8.9\nAnswer: 8.9 × 10⁵ ✓' },
        { difficulty: 'Medium', question: 'Write 72 000 000 in scientific notation.', checkMode: 'auto', options: ['7.2 × 10⁶', '72 × 10⁶', '7.2 × 10⁷', '7.2 × 10⁸'], correctIndex: 2, explanation: 'Move the decimal 7 places left: 72 000 000 → 7.2\nAnswer: 7.2 × 10⁷ ✓' },
        { difficulty: 'Hard', question: 'A national data centre processes approximately 6 600 000 000 (6.6 × 10⁹) records per year, in batches of 300 000 (3.0 × 10⁵) records each. Write both quantities in scientific notation, then calculate how many batches are processed per year.', checkMode: 'auto', options: ['2200', '220000', '6600', '22000'], correctIndex: 3, explanation: 'Divide: (6.6 × 10⁹) ÷ (3.0 × 10⁵)\n= (6.6 ÷ 3.0) × 10^(9−5)\n= 2.2 × 10⁴ = 22 000 batches ✓' },
      ],
      scoreMessages: [
        { minScore: 20, message: 'Outstanding! You have mastered the laws of exponents, roots and scientific notation at Grade 8 level.' },
        { minScore: 15, message: 'Great work! Review any missed questions and try again.' },
