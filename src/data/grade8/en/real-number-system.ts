  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'Is 12 a natural number?', checkMode: 'auto', options: ['No — 12 is too large to count as a natural number', 'Yes — 12 is a positive counting number, so it is a natural number', 'No — natural numbers must be less than 10', 'Yes, but only because 12 is even'], correctIndex: 1, explanation: '12 is a positive counting number, so it belongs to the natural numbers (N). ✓' },
        { difficulty: 'Easy', question: 'Is −8 a natural number? Answer yes or no.', checkMode: 'auto', options: ['Yes — negative numbers count as natural numbers too', 'No — natural numbers cannot be equal to 8', 'Yes, but only because −8 is a whole number', 'No — −8 is negative, so it is not a natural number'], correctIndex: 3, explanation: 'Natural numbers are the positive counting numbers {1, 2, 3, ...}. −8 is negative, so it is NOT a natural number. ✓' },
        { difficulty: 'Easy', question: 'Which set does 0 belong to that natural numbers (N) do not include: whole numbers (N0) or integers only?', checkMode: 'auto', options: ['Whole numbers (N0) — because 0 is included once we add it to the natural numbers', 'Integers only — because 0 can be negative or positive', 'Rational numbers only — because 0 can be written as a fraction', 'Neither — 0 does not belong to any of these sets'], correctIndex: 0, explanation: 'Whole numbers (N0) are the natural numbers plus 0: {0, 1, 2, 3, ...}. Natural numbers start counting at 1, so 0 is in N0 but not in N. ✓' },
        { difficulty: 'Easy', question: 'Is −5 an integer?', checkMode: 'auto', options: ['No — integers cannot be negative', 'No — −5 is only a rational number, not an integer', 'Yes — integers include negative whole numbers, and −5 fits this', 'Yes, but only because −5 is odd'], correctIndex: 2, explanation: 'Integers (Z) include all whole numbers together with their negatives: {..., −2, −1, 0, 1, 2, ...}. −5 fits this definition. ✓' },

        // Block 2 — Rational vs irrational from decimals (terminating/repeating vs non-repeating)
        { difficulty: 'Easy-Medium', question: 'Is 0.375 rational or irrational?', checkMode: 'auto', options: ['Irrational — the digits never terminate', 'Rational — 0.375 terminates, so it equals the fraction 3/8', 'Irrational — any number with a decimal point is non-repeating', 'Integer — the decimal simplifies to a whole number'], correctIndex: 1, explanation: '0.375 is a terminating decimal (it stops), so it can be written as an exact fraction: 0.375 = 3/8. This makes it rational. ✓' },
        { difficulty: 'Easy-Medium', question: 'The decimal 0.454545... repeats the pair "45" forever. Is this number rational or irrational?', checkMode: 'auto', options: ['Irrational — the decimal never technically ends', 'Irrational — repeating decimals are non-terminating and non-repeating by definition', 'Rational, but only because it repeats an even number of digits', 'Rational — it repeats in a pattern forever, so it equals 5/11'], correctIndex: 3, explanation: 'A decimal that repeats in a clear pattern forever is still rational, even though it never technically ends. 0.454545... = 5/11, so it is rational. ✓' },
        ...
        { difficulty: 'Medium', question: 'Is √16 rational or irrational?', checkMode: 'auto', options: ['Rational — √16 = 4, a whole number', 'Irrational — square roots are always irrational', 'Irrational — 16 is not a perfect square', 'Natural number only, not rational'], correctIndex: 0, explanation: '16 is a perfect square (4 × 4 = 16), so √16 = 4, a whole number. This makes it rational. ✓' },
        { difficulty: 'Medium', question: 'Is √17 rational or irrational?', checkMode: 'auto', options: ['Rational — every square root is rational once simplified', 'Rational — 17 is a perfect square', 'Irrational — 17 is not a perfect square, so √17 cannot be simplified to a whole number', 'Natural number — square roots are always whole numbers'], correctIndex: 2, explanation: '17 is not a perfect square (the nearest perfect squares are 16 and 25), so √17 cannot be simplified to a whole number. Its decimal, 4.1231056..., is non-terminating and non-repeating, so it is irrational. ✓' },
        ...
        { difficulty: 'Medium', question: 'Classify the number 14 into every set it belongs to (N, N0, Z, Q, or irrational).', checkMode: 'auto', options: ['Whole number, integer and rational number (not natural)', 'Natural number, whole number, integer and rational number', 'Integer and rational number only', 'Natural number and irrational number'], correctIndex: 1, explanation: '14 is a positive whole counting number with no fraction part, so it belongs to N, N0, Z and Q. ✓' },
        { difficulty: 'Medium', question: 'Classify √81 into every set it belongs to (N, N0, Z, Q, or irrational).', checkMode: 'auto', options: ['Rational only — √81 does not simplify to a whole number', 'Irrational — 81 is not a perfect square', 'Integer and rational number only (not natural, not whole)', 'Natural number, whole number, integer and rational number'], correctIndex: 3, explanation: '81 is a perfect square (9 × 9 = 81), so √81 = 9. Since 9 is a positive whole number, it belongs to N, N0, Z and Q. ✓' },
        ...
        { difficulty: 'Medium', question: 'Arrange these numbers from smallest to largest: √25, 4.9, √16, 5.1.', checkMode: 'auto', options: ['√16, 4.9, √25, 5.1', '4.9, √16, 5.1, √25', '√25, 4.9, √16, 5.1', '5.1, √25, 4.9, √16'], correctIndex: 0, explanation: '√16 = 4, 4.9 = 4.9, √25 = 5, 5.1 = 5.1. Ordering the values 4, 4.9, 5, 5.1 from smallest to largest gives √16, 4.9, √25, 5.1. ✓' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // Block 1 — Classifying numbers by type (N / N0 / Z / Q)
        { difficulty: 'Easy', question: 'Is 25 a natural number?', checkMode: 'auto', options: ['No — 25 is too large to count as a natural number', 'No — natural numbers must be less than 20', 'Yes — 25 is a positive counting number, so it is a natural number', 'Yes, but only because 25 is a perfect square'], correctIndex: 2, explanation: '25 is a positive counting number, so it belongs to the natural numbers (N). ✓' },
        { difficulty: 'Easy', question: 'Is −11 a whole number? Answer yes or no.', checkMode: 'auto', options: ['No — −11 is negative, so it is not a whole number', 'Yes — whole numbers include negative counting numbers too', 'No — whole numbers must be even, and −11 is odd', 'Yes, but only because −11 is a whole value with no fraction part'], correctIndex: 0, explanation: 'Whole numbers (N0) are {0, 1, 2, 3, ...} — they cannot be negative. −11 is negative, so it is NOT a whole number. ✓' },
        { difficulty: 'Easy', question: 'Name the smallest set (N, N0 or Z) that the number 0 belongs to.', checkMode: 'auto', options: ['N — because 0 is the smallest counting number', 'Z — because 0 can be written with a negative sign', 'None of these — 0 does not belong to N, N0 or Z', 'N0 — because 0 is included once we add it to the natural numbers'], correctIndex: 3, explanation: '0 is not in N (counting starts at 1), but it is included in the whole numbers (N0) by definition, so N0 is the smallest set containing 0. ✓' },
        { difficulty: 'Easy', question: 'Is −20 an integer?', checkMode: 'auto', options: ['No — integers cannot be negative', 'Yes — integers include negative whole numbers, and −20 fits this', 'No — −20 is only a rational number, not an integer', 'Yes, but only because −20 is even'], correctIndex: 1, explanation: 'Integers (Z) include all whole numbers together with their negatives, so −20 fits this definition. ✓' },

        // Block 2 — Rational vs irrational from decimals
        { difficulty: 'Easy-Medium', question: 'Is 0.65 rational or irrational?', checkMode: 'auto', options: ['Irrational — the digits never terminate', 'Integer — the decimal simplifies to a whole number', 'Rational — 0.65 terminates, so it equals the fraction 13/20', 'Irrational — any number with a decimal point is non-repeating'], correctIndex: 2, explanation: '0.65 is a terminating decimal, so it can be written as an exact fraction: 0.65 = 13/20. This makes it rational. ✓' },
        { difficulty: 'Easy-Medium', question: 'The decimal 0.363636... repeats the pair "36" forever. Is this number rational or irrational?', checkMode: 'auto', options: ['Rational — it repeats in a pattern forever, so it equals 4/11', 'Irrational — the decimal never technically ends', 'Irrational — repeating decimals are non-terminating and non-repeating by definition', 'Rational, but only because it repeats an even number of digits'], correctIndex: 0, explanation: 'A decimal that repeats in a clear pattern forever is still rational. 0.363636... = 4/11, so it is rational. ✓' },
        ...
        // Block 3 — Surds: rational or irrational
        { difficulty: 'Medium', question: 'Is √25 rational or irrational?', checkMode: 'auto', options: ['Irrational — square roots are always irrational', 'Irrational — 25 is not a perfect square', 'Natural number only, not rational', 'Rational — √25 = 5, a whole number'], correctIndex: 3, explanation: '25 is a perfect square (5 × 5 = 25), so √25 = 5, a whole number. This makes it rational. ✓' },
        { difficulty: 'Medium', question: 'Is √29 rational or irrational?', checkMode: 'auto', options: ['Rational — every square root is rational once simplified', 'Irrational — 29 is not a perfect square, so √29 cannot be simplified to a whole number', 'Rational — 29 is a perfect square', 'Natural number — square roots are always whole numbers'], correctIndex: 1, explanation: '29 is not a perfect square (the nearest perfect squares are 25 and 36), so √29 cannot be simplified to a whole number. Its decimal, 5.3851648..., is non-terminating and non-repeating, so it is irrational. ✓' },
        ...
        // Block 4 — Full multi-set classification
        { difficulty: 'Medium', question: 'Classify the number 23 into every set it belongs to (N, N0, Z, Q, or irrational).', checkMode: 'auto', options: ['Whole number, integer and rational number (not natural)', 'Integer and rational number only', 'Natural number, whole number, integer and rational number', 'Natural number and irrational number'], correctIndex: 2, explanation: '23 is a positive whole counting number with no fraction part, so it belongs to N, N0, Z and Q. ✓' },
        { difficulty: 'Medium', question: 'Classify √100 into every set it belongs to (N, N0, Z, Q, or irrational).', checkMode: 'auto', options: ['Natural number, whole number, integer and rational number', 'Rational only — √100 does not simplify to a whole number', 'Irrational — 100 is not a perfect square', 'Integer and rational number only (not natural, not whole)'], correctIndex: 0, explanation: '100 is a perfect square (10 × 10 = 100), so √100 = 10. Since 10 is a positive whole number, it belongs to N, N0, Z and Q. ✓' },
        ...
        { difficulty: 'Medium', question: 'Arrange these numbers from smallest to largest: √36, 5.9, √49, 6.2.', checkMode: 'auto', options: ['√49, 5.9, √36, 6.2', '6.2, √49, 5.9, √36', '5.9, √49, 6.2, √36', '5.9, √36, 6.2, √49'], correctIndex: 3, explanation: '√36 = 6, 5.9 = 5.9, √49 = 7, 6.2 = 6.2. Ordering the values 5.9, 6, 6.2, 7 from smallest to largest gives 5.9, √36 (6), 6.2, √49 (7). ✓' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // Block 1 — Classifying numbers by type (N / N0 / Z / Q)
        { difficulty: 'Easy', question: 'Is 40 a natural number?', checkMode: 'auto', options: ['Yes — 40 is a positive counting number, so it is a natural number', 'No — 40 is too large to count as a natural number', 'No — natural numbers must be less than 30', 'Yes, but only because 40 is a multiple of 10'], correctIndex: 0, explanation: '40 is a positive counting number, so it belongs to the natural numbers (N). ✓' },
        { difficulty: 'Easy', question: 'Is −3 a natural number? Answer yes or no.', checkMode: 'auto', options: ['Yes — negative numbers count as natural numbers too', 'Yes, but only because −3 is a whole number', 'No — −3 is negative, so it is not a natural number', 'No — natural numbers must be even, and −3 is odd'], correctIndex: 2, explanation: 'Natural numbers are the positive counting numbers {1, 2, 3, ...}. −3 is negative, so it is NOT a natural number. ✓' },
        { difficulty: 'Easy', question: 'A temperature reading of 0°C is recorded on a thermometer. Which set(s) — N, N0, Z, Q — does the number 0 belong to?', checkMode: 'auto', options: ['N, N0, Z and Q — 0 belongs to every set', 'N0, Z and Q — 0 is a whole number, an integer, and rational, but not natural', 'Z and Q only — 0 is not a whole number', 'N0 only — 0 does not belong to Z or Q'], correctIndex: 1, explanation: '0 is not in N (counting starts at 1), but it is in N0 by definition, it is an integer, and it can be written as 0/1, so it is in Q too. So 0 belongs to N0, Z and Q. ✓' },
        { difficulty: 'Easy', question: 'Is −14 an integer?', checkMode: 'auto', options: ['No — integers cannot be negative', 'No — −14 is only a rational number, not an integer', 'Yes, but only because −14 is even', 'Yes — integers include negative whole numbers, and −14 fits this'], correctIndex: 3, explanation: 'Integers (Z) include all whole numbers together with their negatives, so −14 fits this definition. ✓' },

        // Block 2 — Rational vs irrational from decimals
        { difficulty: 'Easy-Medium', question: 'Is 0.425 rational or irrational?', checkMode: 'auto', options: ['Rational — 0.425 terminates, so it equals the fraction 17/40', 'Irrational — the digits never terminate', 'Irrational — any number with a decimal point is non-repeating', 'Integer — the decimal simplifies to a whole number'], correctIndex: 0, explanation: '0.425 is a terminating decimal, so it can be written as an exact fraction: 0.425 = 17/40. This makes it rational. ✓' },
        { difficulty: 'Easy-Medium', question: 'The decimal 0.222... repeats the digit 2 forever. Is this number rational or irrational?', checkMode: 'auto', options: ['Irrational — the decimal never technically ends', 'Irrational — repeating decimals are non-terminating and non-repeating by definition', 'Rational — it repeats in a pattern forever, so it equals 2/9', 'Rational, but only because it repeats a single digit'], correctIndex: 2, explanation: 'A decimal that repeats in a clear pattern forever is still rational. 0.222... = 2/9, so it is rational. ✓' },
        ...
        // Block 3 — Surds: rational or irrational
        { difficulty: 'Medium', question: 'Is √169 rational or irrational?', checkMode: 'auto', options: ['Irrational — square roots are always irrational', 'Rational — √169 = 13, a whole number', 'Irrational — 169 is not a perfect square', 'Natural number only, not rational'], correctIndex: 1, explanation: '169 is a perfect square (13 × 13 = 169), so √169 = 13, a whole number. This makes it rational. ✓' },
        { difficulty: 'Medium', question: 'Is √90 rational or irrational?', checkMode: 'auto', options: ['Rational — every square root is rational once simplified', 'Rational — 90 is a perfect square', 'Natural number — square roots are always whole numbers', 'Irrational — 90 is not a perfect square, so √90 cannot be simplified to a whole number'], correctIndex: 3, explanation: '90 is not a perfect square (the nearest perfect squares are 81 and 100), so √90 cannot be simplified to a whole number. Its decimal, 9.4868329..., is non-terminating and non-repeating, so it is irrational. ✓' },
        ...
        // Block 4 — Full multi-set classification
        { difficulty: 'Medium', question: 'Classify the number 31 into every set it belongs to (N, N0, Z, Q, or irrational).', checkMode: 'auto', options: ['Natural number, whole number, integer and rational number', 'Whole number, integer and rational number (not natural)', 'Integer and rational number only', 'Natural number and irrational number'], correctIndex: 0, explanation: '31 is a positive whole counting number with no fraction part, so it belongs to N, N0, Z and Q. ✓' },
        { difficulty: 'Medium', question: 'Classify √225 into every set it belongs to (N, N0, Z, Q, or irrational).', checkMode: 'auto', options: ['Rational only — √225 does not simplify to a whole number', 'Irrational — 225 is not a perfect square', 'Natural number, whole number, integer and rational number', 'Integer and rational number only (not natural, not whole)'], correctIndex: 2, explanation: '225 is a perfect square (15 × 15 = 225), so √225 = 15. Since 15 is a positive whole number, it belongs to N, N0, Z and Q. ✓' },
        ...
        { difficulty: 'Medium', question: 'Arrange these numbers from smallest to largest: √100, 9.8, √81, 10.3.', checkMode: 'auto', options: ['√100, 9.8, √81, 10.3', '√81, 9.8, √100, 10.3', '10.3, √100, 9.8, √81', '9.8, √81, 10.3, √100'], correctIndex: 1, explanation: '√100 = 10, 9.8 = 9.8, √81 = 9, 10.3 = 10.3. Ordering the values 10, 9.8, 9, 10.3 from smallest to largest gives √81 (9), 9.8, √100 (10), 10.3. ✓' },
