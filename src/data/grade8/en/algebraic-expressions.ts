  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramSvg:
        ...
        `<text x="50" y="102" text-anchor="middle" font-size="10" font-weight="700" fill="#2563eb">coefficient</text>` +
        `<line x1="130" y1="70" x2="140" y2="90" stroke="#0f1f3d" stroke-width="1.5"/>` +
        `<text x="140" y="102" text-anchor="middle" font-size="10" font-weight="700" fill="#0f1f3d">variable</text>` +
        `<line x1="160" y1="40" x2="220" y2="90" stroke="#ea580c" stroke-width="1.5"/>` +
        `<text x="220" y="102" text-anchor="middle" font-size="10" font-weight="700" fill="#ea580c">exponent</text>` +
  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'Simplify 5x²+3x−2x²+4x.', checkMode: 'auto', options: ['3x²+7x', '7x²+7x', '3x²−x', '3x⁴+7x'], correctIndex: 0, explanation: 'Group like terms: (5x²−2x²)+(3x+4x).\n5x²−2x²=3x² and 3x+4x=7x.\nAnswer: 3x²+7x' },
        { difficulty: 'Easy', question: 'Simplify 6xy+4x−2xy+x.', checkMode: 'auto', options: ['8xy+5x', '4xy+5x', '4xy+3x', '9xy'], correctIndex: 1, explanation: 'Group like terms: (6xy−2xy)+(4x+x).\n6xy−2xy=4xy and 4x+x=5x.\nAnswer: 4xy+5x' },
        { difficulty: 'Easy', question: 'Simplify 4a²b+3ab−2a²b.', checkMode: 'auto', options: ['6a²b+3ab', '5a²b', '2a²b+3ab', '2a⁴b+3ab'], correctIndex: 2, explanation: 'Only the a²b terms are like terms: 4a²b−2a²b=2a²b.\n3ab has a different exponent on a, so it cannot be combined.\nAnswer: 2a²b+3ab' },

        // Block 2 — Expanding brackets, distributive law (Medium)
        { difficulty: 'Medium', question: 'Expand 3x(2x+5).', checkMode: 'auto', options: ['6x²+5x', '5x²+15x', '21x', '6x²+15x'], correctIndex: 3, explanation: 'Multiply 3x by each term inside the brackets.\n(3x)(2x)=6x² and (3x)(5)=15x.\nAnswer: 6x²+15x' },
        { difficulty: 'Medium', question: 'Expand −4x(x−3).', checkMode: 'auto', options: ['−4x²+12x', '−4x²−12x', '4x²+12x', '−x²+12x'], correctIndex: 0, explanation: 'Multiply −4x by each term inside the brackets.\n(−4x)(x)=−4x² and (−4x)(−3)=+12x.\nAnswer: −4x²+12x' },
        { difficulty: 'Medium', question: 'Expand and simplify 2(3x+4)+5x.', checkMode: 'auto', options: ['11x+4', '11x+8', '10x+8', '16x+8'], correctIndex: 1, explanation: 'Expand the brackets: 2(3x+4)=6x+8.\nAdd the remaining term: 6x+8+5x.\nCombine like terms: 6x+5x=11x.\nAnswer: 11x+8' },
        { difficulty: 'Medium', question: 'A rectangular table has length (x+6) cm and width 3 cm. Write an expression for its area, and expand it.', checkMode: 'auto', options: ['3x+6', '3x+9', '3x+18', '18x+3'], correctIndex: 2, explanation: 'Area of a rectangle = length × width = 3(x+6).\nExpand: (3)(x)+(3)(6)=3x+18.\nAnswer: 3x+18' },

        // Block 3 — Factorising using a common factor (Medium)
        { difficulty: 'Medium', question: 'Factorise 6x+9 fully.', checkMode: 'auto', options: ['3(2x+9)', '6(x+3)', '3(6x+9)', '3(2x+3)'], correctIndex: 3, explanation: 'The HCF of 6 and 9 is 3.\nDivide each term by 3: 6x÷3=2x and 9÷3=3.\nAnswer: 3(2x+3)' },
        { difficulty: 'Medium', question: 'Factorise 8x²+12x fully.', checkMode: 'auto', options: ['4x(2x+3)', '4x(2x+12)', '2x(4x+6)', '4(2x²+3x)'], correctIndex: 0, explanation: 'The HCF of the coefficients 8 and 12 is 4, and both terms share a factor of x.\nDivide each term by 4x: 8x²÷4x=2x and 12x÷4x=3.\nAnswer: 4x(2x+3)' },
        { difficulty: 'Medium', question: 'Factorise 15xy−10x fully.', checkMode: 'auto', options: ['5x(3y−10)', '5x(3y−2)', 'x(15y−10)', '5(3xy−2x)'], correctIndex: 1, explanation: 'The HCF of 15 and 10 is 5, and both terms share a factor of x.\nDivide each term by 5x: 15xy÷5x=3y and 10x÷5x=2.\nAnswer: 5x(3y−2)' },
        ...
        { difficulty: 'Medium-Hard', question: 'Evaluate 3x²−2x when x=−2.', checkMode: 'auto', options: ['−8', '8', '16', '40'], correctIndex: 2, explanation: 'Substitute x=−2: 3(−2)²−2(−2).\n(−2)²=4, so 3(4)=12. Also −2(−2)=+4.\n12+4=16' },
        { difficulty: 'Medium-Hard', question: 'Evaluate 2x+5y when x=0.5 and y=−3.', checkMode: 'auto', options: ['16', '−5', '4.5', '−14'], correctIndex: 3, explanation: 'Substitute x=0.5 and y=−3: 2(0.5)+5(−3).\n2(0.5)=1 and 5(−3)=−15.\n1−15=−14' },
        { difficulty: 'Medium-Hard', question: 'Evaluate x²−3x+4 when x=−1.', checkMode: 'auto', options: ['8', '6', '2', '−6'], correctIndex: 0, explanation: 'Substitute x=−1: (−1)²−3(−1)+4.\n(−1)²=1 and −3(−1)=+3.\n1+3+4=8' },
        { difficulty: 'Medium-Hard', question: 'The cost in rand to rent a paddleboard is C=6h+12, where h is the number of hours. Find the cost when h=2.5 hours.', checkMode: 'auto', options: ['15', '27', '87', '24'], correctIndex: 1, explanation: 'Substitute h=2.5: C=6(2.5)+12.\n6(2.5)=15, so C=15+12=27.\nThe cost is R27.' },

        // Block 5 — Multi-step simplification combining several skills (Hard)
        { difficulty: 'Hard', question: 'Simplify 3x(x+2)−5x.', checkMode: 'auto', options: ['3x²+11x', '3x²−3x', '3x²+x', '3x⁴+x'], correctIndex: 2, explanation: 'Expand first: 3x(x+2)=3x²+6x.\nSubtract 5x: 3x²+6x−5x.\nCombine like terms: 6x−5x=x.\nAnswer: 3x²+x' },
        { difficulty: 'Hard', question: 'Simplify 4x+8+2x, then factorise the result fully.', checkMode: 'auto', options: ['2(3x+8)', '6x+8', '3(2x+3)', '2(3x+4)'], correctIndex: 3, explanation: 'Simplify first: 4x+8+2x=6x+8.\nFactorise: the HCF of 6 and 8 is 2.\nDivide each term by 2: 6x÷2=3x and 8÷2=4.\nAnswer: 2(3x+4)' },
        { difficulty: 'Hard', question: 'Expand and simplify 2(x+3)+3(x−1).', checkMode: 'auto', options: ['5x+3', '5x+9', '5x', '6x+3'], correctIndex: 0, explanation: 'Expand each bracket: 2(x+3)=2x+6 and 3(x−1)=3x−3.\nAdd: 2x+6+3x−3.\nCombine like terms: (2x+3x)+(6−3)=5x+3.\nAnswer: 5x+3' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // Block 1 — Simplifying with multiple variables/exponents (Easy)
        { difficulty: 'Easy', question: 'Simplify 7x²+2x−3x²+5x.', checkMode: 'auto', options: ['10x²+7x', '4x²+7x', '4x²−3x', '4x⁴+7x'], correctIndex: 1, explanation: 'Group like terms: (7x²−3x²)+(2x+5x).\n7x²−3x²=4x² and 2x+5x=7x.\nAnswer: 4x²+7x' },
        { difficulty: 'Easy', question: 'Simplify 5xy+6x−3xy+2x.', checkMode: 'auto', options: ['8xy+8x', '2xy+4x', '2xy+8x', '10xy'], correctIndex: 2, explanation: 'Group like terms: (5xy−3xy)+(6x+2x).\n5xy−3xy=2xy and 6x+2x=8x.\nAnswer: 2xy+8x' },
        { difficulty: 'Easy', question: 'Simplify 6a²b+2ab−3a²b.', checkMode: 'auto', options: ['9a²b+2ab', '5a²b', '3a⁴b+2ab', '3a²b+2ab'], correctIndex: 3, explanation: 'Only the a²b terms are like terms: 6a²b−3a²b=3a²b.\n2ab has a different exponent on a, so it cannot be combined.\nAnswer: 3a²b+2ab' },

        // Block 2 — Expanding brackets, distributive law (Medium)
        { difficulty: 'Medium', question: 'Expand 4x(3x+2).', checkMode: 'auto', options: ['12x²+8x', '12x²+2x', '7x²+8x', '20x'], correctIndex: 0, explanation: 'Multiply 4x by each term inside the brackets.\n(4x)(3x)=12x² and (4x)(2)=8x.\nAnswer: 12x²+8x' },
        { difficulty: 'Medium', question: 'Expand −5x(x−2).', checkMode: 'auto', options: ['−5x²−10x', '−5x²+10x', '5x²+10x', '−x²+10x'], correctIndex: 1, explanation: 'Multiply −5x by each term inside the brackets.\n(−5x)(x)=−5x² and (−5x)(−2)=+10x.\nAnswer: −5x²+10x' },
        { difficulty: 'Medium', question: 'Expand and simplify 3(2x+5)+4x.', checkMode: 'auto', options: ['10x+5', '9x+15', '10x+15', '18x+15'], correctIndex: 2, explanation: 'Expand the brackets: 3(2x+5)=6x+15.\nAdd the remaining term: 6x+15+4x.\nCombine like terms: 6x+4x=10x.\nAnswer: 10x+15' },
        { difficulty: 'Medium', question: 'A classroom poster has length 4 cm and width (x+8) cm. Write an expression for its area, and expand it.', checkMode: 'auto', options: ['4x+8', '4x+12', '32x+4', '4x+32'], correctIndex: 3, explanation: 'Area of a rectangle = length × width = 4(x+8).\nExpand: (4)(x)+(4)(8)=4x+32.\nAnswer: 4x+32' },

        // Block 3 — Factorising using a common factor (Medium)
        { difficulty: 'Medium', question: 'Factorise 8x+12 fully.', checkMode: 'auto', options: ['4(2x+3)', '4(2x+12)', '2(4x+6)', '4(8x+12)'], correctIndex: 0, explanation: 'The HCF of 8 and 12 is 4.\nDivide each term by 4: 8x÷4=2x and 12÷4=3.\nAnswer: 4(2x+3)' },
        { difficulty: 'Medium', question: 'Factorise 10x²+15x fully.', checkMode: 'auto', options: ['5x(2x+15)', '5x(2x+3)', 'x(10x+15)', '5(2x²+3x)'], correctIndex: 1, explanation: 'The HCF of the coefficients 10 and 15 is 5, and both terms share a factor of x.\nDivide each term by 5x: 10x²÷5x=2x and 15x÷5x=3.\nAnswer: 5x(2x+3)' },
        { difficulty: 'Medium', question: 'Factorise 21xy−14x fully.', checkMode: 'auto', options: ['7x(3y−14)', 'x(21y−14)', '7x(3y−2)', '7(3xy−2x)'], correctIndex: 2, explanation: 'The HCF of 21 and 14 is 7, and both terms share a factor of x.\nDivide each term by 7x: 21xy÷7x=3y and 14x÷7x=2.\nAnswer: 7x(3y−2)' },
        ...
        // Block 4 — Substitution with negative/fractional values (Medium-Hard)
        { difficulty: 'Medium-Hard', question: 'Evaluate 4x²−3x when x=−2.', checkMode: 'auto', options: ['−10', '10', '70', '22'], correctIndex: 3, explanation: 'Substitute x=−2: 4(−2)²−3(−2).\n(−2)²=4, so 4(4)=16. Also −3(−2)=+6.\n16+6=22' },
        { difficulty: 'Medium-Hard', question: 'Evaluate 3x+4y when x=0.5 and y=−2.', checkMode: 'auto', options: ['−6.5', '9.5', '7', '5.5'], correctIndex: 0, explanation: 'Substitute x=0.5 and y=−2: 3(0.5)+4(−2).\n3(0.5)=1.5 and 4(−2)=−8.\n1.5−8=−6.5' },
        { difficulty: 'Medium-Hard', question: 'Evaluate x²−4x+2 when x=−1.', checkMode: 'auto', options: ['5', '7', '−1', '−5'], correctIndex: 1, explanation: 'Substitute x=−1: (−1)²−4(−1)+2.\n(−1)²=1 and −4(−1)=+4.\n1+4+2=7' },
        { difficulty: 'Medium-Hard', question: 'The cost in rand to rent a kayak is C=8h+15, where h is the number of hours. Find the cost when h=1.5 hours.', checkMode: 'auto', options: ['12', '132', '27', '23'], correctIndex: 2, explanation: 'Substitute h=1.5: C=8(1.5)+15.\n8(1.5)=12, so C=12+15=27.\nThe cost is R27.' },

        // Block 5 — Multi-step simplification combining several skills (Hard)
        { difficulty: 'Hard', question: 'Simplify 4x(x+3)−7x.', checkMode: 'auto', options: ['4x²+19x', '4x²−4x', '4x⁴+5x', '4x²+5x'], correctIndex: 3, explanation: 'Expand first: 4x(x+3)=4x²+12x.\nSubtract 7x: 4x²+12x−7x.\nCombine like terms: 12x−7x=5x.\nAnswer: 4x²+5x' },
        { difficulty: 'Hard', question: 'Simplify 6x+9+3x, then factorise the result fully.', checkMode: 'auto', options: ['9(x+1)', '9(x+9)', '9x+9', '3(2x+3)'], correctIndex: 0, explanation: 'Simplify first: 6x+9+3x=9x+9.\nFactorise: the HCF of 9 and 9 is 9.\nDivide each term by 9: 9x÷9=x and 9÷9=1.\nAnswer: 9(x+1)' },
        { difficulty: 'Hard', question: 'Expand and simplify 3(x+2)+2(x−4).', checkMode: 'auto', options: ['5x+14', '5x−2', '5x', '5x+2'], correctIndex: 1, explanation: 'Expand each bracket: 3(x+2)=3x+6 and 2(x−4)=2x−8.\nAdd: 3x+6+2x−8.\nCombine like terms: (3x+2x)+(6−8)=5x−2.\nAnswer: 5x−2' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // Block 1 — Simplifying with multiple variables/exponents (Easy)
        { difficulty: 'Easy', question: 'Simplify 8x²+4x−5x²+3x.', checkMode: 'auto', options: ['13x²+7x', '3x²+x', '3x²+7x', '3x⁴+7x'], correctIndex: 2, explanation: 'Group like terms: (8x²−5x²)+(4x+3x).\n8x²−5x²=3x² and 4x+3x=7x.\nAnswer: 3x²+7x' },
        { difficulty: 'Easy', question: 'Simplify 4xy+7x−2xy+3x.', checkMode: 'auto', options: ['6xy+10x', '2xy+4x', '12xy', '2xy+10x'], correctIndex: 3, explanation: 'Group like terms: (4xy−2xy)+(7x+3x).\n4xy−2xy=2xy and 7x+3x=10x.\nAnswer: 2xy+10x' },
        { difficulty: 'Easy', question: 'Simplify 5a²b+4ab−3a²b.', checkMode: 'auto', options: ['2a²b+4ab', '8a²b+4ab', '6a²b', '2a⁴b+4ab'], correctIndex: 0, explanation: 'Only the a²b terms are like terms: 5a²b−3a²b=2a²b.\n4ab has a different exponent on a, so it cannot be combined.\nAnswer: 2a²b+4ab' },

        // Block 2 — Expanding brackets, distributive law (Medium)
        { difficulty: 'Medium', question: 'Expand 5x(2x+3).', checkMode: 'auto', options: ['10x²+3x', '10x²+15x', '7x²+15x', '25x'], correctIndex: 1, explanation: 'Multiply 5x by each term inside the brackets.\n(5x)(2x)=10x² and (5x)(3)=15x.\nAnswer: 10x²+15x' },
        { difficulty: 'Medium', question: 'Expand −3x(x−5).', checkMode: 'auto', options: ['−3x²−15x', '3x²+15x', '−3x²+15x', '−x²+15x'], correctIndex: 2, explanation: 'Multiply −3x by each term inside the brackets.\n(−3x)(x)=−3x² and (−3x)(−5)=+15x.\nAnswer: −3x²+15x' },
        { difficulty: 'Medium', question: 'Expand and simplify 4(2x+3)+3x.', checkMode: 'auto', options: ['11x+3', '9x+12', '20x+12', '11x+12'], correctIndex: 3, explanation: 'Expand the brackets: 4(2x+3)=8x+12.\nAdd the remaining term: 8x+12+3x.\nCombine like terms: 8x+3x=11x.\nAnswer: 11x+12' },
        { difficulty: 'Medium', question: 'A rectangular garden bed is 5 m wide and (x+7) m long. Write an expression for its area, and expand it.', checkMode: 'auto', options: ['5x+35', '5x+7', '5x+12', '35x+5'], correctIndex: 0, explanation: 'Area of a rectangle = length × width = 5(x+7).\nExpand: (5)(x)+(5)(7)=5x+35.\nAnswer: 5x+35' },

        // Block 3 — Factorising using a common factor (Medium)
        { difficulty: 'Medium', question: 'Factorise 9x+15 fully.', checkMode: 'auto', options: ['3(3x+15)', '3(3x+5)', '3(5x+3)', '3(9x+15)'], correctIndex: 1, explanation: 'The HCF of 9 and 15 is 3.\nDivide each term by 3: 9x÷3=3x and 15÷3=5.\nAnswer: 3(3x+5)' },
        { difficulty: 'Medium', question: 'Factorise 12x²+18x fully.', checkMode: 'auto', options: ['6x(2x+18)', '3x(4x+6)', '6x(2x+3)', '6(2x²+3x)'], correctIndex: 2, explanation: 'The HCF of the coefficients 12 and 18 is 6, and both terms share a factor of x.\nDivide each term by 6x: 12x²÷6x=2x and 18x÷6x=3.\nAnswer: 6x(2x+3)' },
        { difficulty: 'Medium', question: 'Factorise 24xy−16x fully.', checkMode: 'auto', options: ['8x(3y−16)', 'x(24y−16)', '8(3xy−2x)', '8x(3y−2)'], correctIndex: 3, explanation: 'The HCF of 24 and 16 is 8, and both terms share a factor of x.\nDivide each term by 8x: 24xy÷8x=3y and 16x÷8x=2.\nAnswer: 8x(3y−2)' },
        ...
        // Block 4 — Substitution with negative/fractional values (Medium-Hard)
        { difficulty: 'Medium-Hard', question: 'Evaluate 2x²−5x when x=−3.', checkMode: 'auto', options: ['33', '−3', '3', '51'], correctIndex: 0, explanation: 'Substitute x=−3: 2(−3)²−5(−3).\n(−3)²=9, so 2(9)=18. Also −5(−3)=+15.\n18+15=33' },
        { difficulty: 'Medium-Hard', question: 'Evaluate 4x+3y when x=0.5 and y=−4.', checkMode: 'auto', options: ['14', '−10', '8', '3.5'], correctIndex: 1, explanation: 'Substitute x=0.5 and y=−4: 4(0.5)+3(−4).\n4(0.5)=2 and 3(−4)=−12.\n2−12=−10' },
        { difficulty: 'Medium-Hard', question: 'Evaluate x²−5x+3 when x=−1.', checkMode: 'auto', options: ['7', '−1', '9', '−7'], correctIndex: 2, explanation: 'Substitute x=−1: (−1)²−5(−1)+3.\n(−1)²=1 and −5(−1)=+5.\n1+5+3=9' },
        { difficulty: 'Medium-Hard', question: 'The cost in rand to rent a bicycle is C=10h+20, where h is the number of hours. Find the cost when h=3.5 hours.', checkMode: 'auto', options: ['35', '235', '50', '55'], correctIndex: 3, explanation: 'Substitute h=3.5: C=10(3.5)+20.\n10(3.5)=35, so C=35+20=55.\nThe cost is R55.' },

        // Block 5 — Multi-step simplification combining several skills (Hard)
        { difficulty: 'Hard', question: 'Simplify 5x(x+1)−4x.', checkMode: 'auto', options: ['5x²+x', '5x²+9x', '5x²−3x', '5x⁴+x'], correctIndex: 0, explanation: 'Expand first: 5x(x+1)=5x²+5x.\nSubtract 4x: 5x²+5x−4x.\nCombine like terms: 5x−4x=x.\nAnswer: 5x²+x' },
        { difficulty: 'Hard', question: 'Simplify 5x+10+3x, then factorise the result fully.', checkMode: 'auto', options: ['2(4x+10)', '2(4x+5)', '8x+10', '5(x+2)'], correctIndex: 1, explanation: 'Simplify first: 5x+10+3x=8x+10.\nFactorise: the HCF of 8 and 10 is 2.\nDivide each term by 2: 8x÷2=4x and 10÷2=5.\nAnswer: 2(4x+5)' },
        { difficulty: 'Hard', question: 'Expand and simplify 4(x+1)+2(x−5).', checkMode: 'auto', options: ['6x+14', '6x', '6x−6', '6x−1'], correctIndex: 2, explanation: 'Expand each bracket: 4(x+1)=4x+4 and 2(x−5)=2x−10.\nAdd: 4x+4+2x−10.\nCombine like terms: (4x+2x)+(4−10)=6x−6.\nAnswer: 6x−6' },
