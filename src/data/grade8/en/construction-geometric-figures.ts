  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'Triangle GHI and triangle STU are both right-angled. The hypotenuse GI = 13 cm equals the hypotenuse SU = 13 cm, and side GH = 5 cm equals side ST = 5 cm. State which congruency condition proves the triangles are congruent.', answer: 'RHS', checkMode: 'auto', correctAnswer: 'RHS', correctAnswers: ['RHS', 'rhs', 'right angle-hypotenuse-side'], explanation: 'RHS (right angle-hypotenuse-side) applies specifically to right-angled triangles when the hypotenuse and one other side match.' },
