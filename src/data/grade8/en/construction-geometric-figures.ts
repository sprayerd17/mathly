  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'Which congruency condition applies when a triangle is constructed using two given side lengths and the angle enclosed between them?', checkMode: 'auto', options: ['SSS', 'SAS', 'ASA', 'RHS'], correctIndex: 1, explanation: 'SAS (side-angle-side) is used when two sides and the included angle between them are known.' },
        ...
        { difficulty: 'Medium', question: 'Two right-angled triangles both have the same hypotenuse length and the same length for one other corresponding side. State which congruency condition proves the triangles are congruent.', checkMode: 'auto', options: ['SAS', 'SSS', 'ASA', 'RHS'], correctIndex: 3, explanation: 'RHS (right angle-hypotenuse-side) applies specifically to right-angled triangles when the hypotenuse and one other side match.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'What is the correct term for a ray from a vertex that divides an angle into two exactly equal parts?', checkMode: 'auto', options: ['perpendicular bisector', 'median', 'altitude', 'angle bisector'], correctIndex: 3, explanation: 'An angle bisector is a ray from the vertex that splits the angle into two exactly equal halves.' },
        ...
        { difficulty: 'Easy', question: 'Which congruency condition applies when a triangle is constructed using two given angles and the side enclosed between them?', checkMode: 'auto', options: ['ASA', 'SAS', 'SSS', 'RHS'], correctIndex: 0, explanation: 'ASA (angle-side-angle) is used when two angles and the included side between them are known.' },
        { difficulty: 'Medium', question: 'Triangle DEF has DE = 6 cm, EF = 8 cm and DF = 10 cm. Triangle PQR has PQ = 6 cm, QR = 8 cm and PR = 10 cm — all three corresponding sides equal. Explain which congruency condition proves the triangles are congruent, and why no angles need to be measured.', answer: 'SSS (side-side-side) proves the triangles are congruent, because once all three side lengths of a triangle are fixed, its shape (and therefore all its angles) is completely determined — there is only one possible triangle with those three side lengths, so no angle measurements are needed.', checkMode: 'self' },
        { difficulty: 'Medium', question: 'Triangle GHI and triangle STU are both right-angled. The hypotenuse GI = 13 cm equals the hypotenuse SU = 13 cm, and side GH = 5 cm equals side ST = 5 cm. State which congruency condition proves the triangles are congruent.', checkMode: 'auto', options: ['SAS', 'ASA', 'RHS', 'SSS'], correctIndex: 2, explanation: 'RHS (right angle-hypotenuse-side) applies specifically to right-angled triangles when the hypotenuse and one other side match.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'What is the correct term for the point at which the three angle bisectors of a triangle meet?', checkMode: 'auto', options: ['circumcentre', 'centroid', 'incentre', 'orthocentre'], correctIndex: 2, explanation: 'The incentre is the single point inside a triangle where all three angle bisectors intersect.' },
        ...
        { difficulty: 'Easy', question: 'Which congruency condition applies specifically and only to right-angled triangles, using the hypotenuse and one other side?', checkMode: 'auto', options: ['SSS', 'RHS', 'SAS', 'ASA'], correctIndex: 1, explanation: 'RHS (right angle-hypotenuse-side) is the condition reserved for right-angled triangles where the hypotenuse and one other side are known.' },
        ...
        { difficulty: 'Medium', question: 'Two triangles each have all three corresponding side lengths equal. State which congruency condition proves the triangles are congruent.', checkMode: 'auto', options: ['SAS', 'ASA', 'RHS', 'SSS'], correctIndex: 3, explanation: 'SSS (side-side-side) applies when all three corresponding sides of two triangles are equal.' },
