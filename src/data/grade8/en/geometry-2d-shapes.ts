  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'In the quadrilateral shown, three angles are 84°, 97° and 120°. Find the fourth angle.', checkMode: 'auto', options: ['59°', '179°', '156°', '143°'], correctIndex: 0, explanation: 'Fourth angle = 360° − 84° − 97° − 120° = 59°. Check: 84+97+120+59 = 360 ✓', diagramSvg: '<svg viewBox="0 0 220 170" xmlns="http://www.w3.org/2000/svg"><polygon points="40,140 120,140 126.3,89 51.3,32.5" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="53" y="127" font-size="13" fill="#2563eb" font-weight="700">84°</text><text x="109" y="127" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">97°</text><text x="114" y="92" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">120°</text><text x="61" y="53" font-size="15" fill="#ea580c" font-weight="700">?</text></svg>' },
        { difficulty: 'Medium', question: 'A parallelogram, as shown, has one angle of 63°. Find the size of the largest angle in the parallelogram.', checkMode: 'auto', options: ['63°', '117°', '90°', '126°'], correctIndex: 1, explanation: 'Opposite angles in a parallelogram are equal, so the angle opposite 63° is also 63°. Adjacent angles are supplementary: 180° − 63° = 117°. The largest angle is 117°.', diagramSvg: '<svg viewBox="0 0 220 170" xmlns="http://www.w3.org/2000/svg"><polygon points="40,135 165,135 208.1,50.4 83.1,50.4" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="55" y="122" font-size="14" fill="#2563eb" font-weight="700">63°</text></svg>' },
        { difficulty: 'Medium', question: 'A kite ABCD, as shown, has AB = 6.5 cm and BC = 9 cm. Find the perimeter of the kite.', checkMode: 'auto', options: ['15.5 cm', '22 cm', '31 cm', '24.5 cm'], correctIndex: 2, explanation: 'In a kite, AD = AB = 6.5 cm and DC = BC = 9 cm. Perimeter = AB + BC + DC + AD = 6.5 + 9 + 9 + 6.5 = 31 cm.', diagramSvg: '<svg viewBox="0 0 220 170" xmlns="http://www.w3.org/2000/svg"><polygon points="110,25 165,75 110,145 55,75" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="145" y="55" font-size="13" fill="#2563eb" font-weight="700">6.5 cm</text><text x="145" y="115" font-size="13" fill="#2563eb" font-weight="700">9 cm</text></svg>' },
        ...
        { difficulty: 'Medium', question: 'Find the sum of the interior angles of a nonagon (9 sides).', checkMode: 'auto', options: ['1620°', '1440°', '360°', '1260°'], correctIndex: 3, explanation: 'Sum of interior angles = (n − 2) × 180°. For a nonagon, n = 9: (9 − 2) × 180 = 7 × 180 = 1260°.' },
        { difficulty: 'Medium-Hard', question: 'A regular pentadecagon (15 sides) has all equal interior angles. Find the size of each interior angle.', checkMode: 'auto', options: ['156°', '24°', '2340°', '168°'], correctIndex: 0, explanation: 'Sum of interior angles = (15 − 2) × 180 = 13 × 180 = 2340°. Each angle = 2340° ÷ 15 = 156°.' },
        { difficulty: 'Hard', question: 'A regular polygon has an exterior angle of 18° at every vertex. Using the fact that the exterior angles of any polygon add up to 360°, find the number of sides of the polygon.', checkMode: 'auto', options: ['18 sides', '20 sides', '10 sides', '342 sides'], correctIndex: 1, explanation: 'The exterior angles of any polygon sum to 360°. Number of sides = 360° ÷ 18° = 20.' },

        // Block E — similarity vs congruency reasoning
        { difficulty: 'Easy', question: 'Two triangles have exactly the same shape and exactly the same size — every corresponding side and angle matches. Are these triangles congruent or similar?', checkMode: 'auto', options: ['similar', 'symmetrical', 'congruent', 'proportional'], correctIndex: 2, explanation: 'Shapes that are identical in both shape and size (all corresponding sides and angles equal) are congruent.' },
        { difficulty: 'Medium', question: 'Two similar triangles have corresponding sides in the ratio 3 : 8. The smaller triangle\'s side is 12 cm. Find the corresponding side in the larger triangle.', checkMode: 'auto', options: ['96 cm', '17 cm', '36 cm', '32 cm'], correctIndex: 3, explanation: 'Set up the proportion: 3/8 = 12/x. Cross-multiply: 3x = 96. x = 96 ÷ 3 = 32 cm. Check: 12/32 = 3/8 ✓' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        // Block C — quadrilateral properties & angle-sum
        { difficulty: 'Easy', question: 'In the quadrilateral shown, three angles are 76°, 142° and 58°. Find the fourth angle.', checkMode: 'auto', options: ['84°', '142°', '226°', '160°'], correctIndex: 0, explanation: 'Fourth angle = 360° − 76° − 142° − 58° = 84°. Check: 76+142+58+84 = 360 ✓', diagramSvg: '<svg viewBox="0 0 220 170" xmlns="http://www.w3.org/2000/svg"><polygon points="40,140 132.3,140 183.2,100.2 61,55.8" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="59" y="131" font-size="13" fill="#2563eb" font-weight="700">76°</text><text x="124" y="131" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">142°</text><text x="160" y="103" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">58°</text><text x="74" y="72" font-size="15" fill="#ea580c" font-weight="700">?</text></svg>' },
        { difficulty: 'Medium', question: 'A rhombus, as shown, has one angle of 84°. Find the size of the largest angle in the rhombus.', checkMode: 'auto', options: ['84°', '96°', '90°', '168°'], correctIndex: 1, explanation: 'Opposite angles in a rhombus are equal, so the angle opposite 84° is also 84°. Adjacent angles are supplementary: 180° − 84° = 96°. The four angles are 84°, 96°, 84°, 96°, so the largest angle is 96°.', diagramSvg: '<svg viewBox="0 0 220 170" xmlns="http://www.w3.org/2000/svg"><polygon points="110,35 180,85 110,135 40,85" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="52" y="90" font-size="14" fill="#2563eb" font-weight="700">84°</text></svg>' },
        { difficulty: 'Medium', question: 'A kite ABCD, as shown, has AB = 5.5 cm and BC = 8 cm. Find the perimeter of the kite.', checkMode: 'auto', options: ['13.5 cm', '19 cm', '27 cm', '21.5 cm'], correctIndex: 2, explanation: 'In a kite, AD = AB = 5.5 cm and DC = BC = 8 cm. Perimeter = AB + BC + DC + AD = 5.5 + 8 + 8 + 5.5 = 27 cm.', diagramSvg: '<svg viewBox="0 0 220 170" xmlns="http://www.w3.org/2000/svg"><polygon points="110,25 165,75 110,145 55,75" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="145" y="55" font-size="13" fill="#2563eb" font-weight="700">5.5 cm</text><text x="145" y="115" font-size="13" fill="#2563eb" font-weight="700">8 cm</text></svg>' },
        ...
        // Block D — polygon interior/exterior angle formulas
        { difficulty: 'Medium', question: 'Find the sum of the interior angles of a hendecagon (11 sides).', checkMode: 'auto', options: ['1980°', '1800°', '360°', '1620°'], correctIndex: 3, explanation: 'Sum of interior angles = (n − 2) × 180°. For an 11-sided polygon, n = 11: (11 − 2) × 180 = 9 × 180 = 1620°.' },
        { difficulty: 'Medium-Hard', question: 'A regular polygon with 18 sides has all equal interior angles. Find the size of each interior angle.', checkMode: 'auto', options: ['160°', '20°', '2880°', '170°'], correctIndex: 0, explanation: 'Sum of interior angles = (18 − 2) × 180 = 16 × 180 = 2880°. Each angle = 2880° ÷ 18 = 160°.' },
        { difficulty: 'Hard', question: 'A regular polygon has an exterior angle of 15° at every vertex. Using the fact that the exterior angles of any polygon add up to 360°, find the number of sides of the polygon.', checkMode: 'auto', options: ['15 sides', '24 sides', '12 sides', '345 sides'], correctIndex: 1, explanation: 'The exterior angles of any polygon sum to 360°. Number of sides = 360° ÷ 15° = 24.' },

        // Block E — similarity vs congruency reasoning
        { difficulty: 'Easy', question: 'Two triangles have the same angles but different side lengths — one is an enlargement of the other. Are these triangles congruent or similar?', checkMode: 'auto', options: ['congruent', 'symmetrical', 'similar', 'proportional'], correctIndex: 2, explanation: 'Shapes with the same shape (equal angles, sides in proportion) but different sizes are similar, not congruent.' },
        { difficulty: 'Medium', question: 'Two similar triangles have corresponding sides in the ratio 4 : 9. The smaller triangle\'s side is 16 cm. Find the corresponding side in the larger triangle.', checkMode: 'auto', options: ['144 cm', '21 cm', '64 cm', '36 cm'], correctIndex: 3, explanation: 'Set up the proportion: 4/9 = 16/x. Cross-multiply: 4x = 144. x = 144 ÷ 4 = 36 cm. Check: 16/36 = 4/9 ✓' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        // Block C — quadrilateral properties & angle-sum
        { difficulty: 'Easy', question: 'In the quadrilateral shown, three angles are 63°, 155° and 88°. Find the fourth angle.', checkMode: 'auto', options: ['54°', '142°', '209°', '117°'], correctIndex: 0, explanation: 'Fourth angle = 360° − 63° − 155° − 88° = 54°. Check: 63+155+88+54 = 360 ✓', diagramSvg: '<svg viewBox="0 0 220 170" xmlns="http://www.w3.org/2000/svg"><polygon points="40,140 89.7,140 130.2,121.1 89.9,42" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="54" y="131" font-size="13" fill="#2563eb" font-weight="700">63°</text><text x="89" y="131" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">155°</text><text x="117" y="118" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">88°</text><text x="89" y="63" font-size="15" fill="#ea580c" font-weight="700">?</text></svg>' },
        { difficulty: 'Medium', question: 'A parallelogram, as shown, has one angle of 47°. Find the size of the largest angle in the parallelogram.', checkMode: 'auto', options: ['47°', '133°', '90°', '94°'], correctIndex: 1, explanation: 'Opposite angles in a parallelogram are equal, so the angle opposite 47° is also 47°. Adjacent angles are supplementary: 180° − 47° = 133°. The largest angle is 133°.', diagramSvg: '<svg viewBox="0 0 220 170" xmlns="http://www.w3.org/2000/svg"><polygon points="40,135 165,135 211.4,85.3 86.4,85.3" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="55" y="122" font-size="14" fill="#2563eb" font-weight="700">47°</text></svg>' },
        { difficulty: 'Medium', question: 'A kite ABCD, as shown, has AB = 4.5 cm and BC = 10 cm. Find the perimeter of the kite.', checkMode: 'auto', options: ['14.5 cm', '19 cm', '29 cm', '24.5 cm'], correctIndex: 2, explanation: 'In a kite, AD = AB = 4.5 cm and DC = BC = 10 cm. Perimeter = AB + BC + DC + AD = 4.5 + 10 + 10 + 4.5 = 29 cm.', diagramSvg: '<svg viewBox="0 0 220 170" xmlns="http://www.w3.org/2000/svg"><polygon points="110,25 165,75 110,145 55,75" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="145" y="55" font-size="13" fill="#2563eb" font-weight="700">4.5 cm</text><text x="145" y="115" font-size="13" fill="#2563eb" font-weight="700">10 cm</text></svg>' },
        ...
        // Block D — polygon interior/exterior angle formulas
        { difficulty: 'Medium', question: 'Find the sum of the interior angles of a heptagon (7 sides).', checkMode: 'auto', options: ['1260°', '1080°', '360°', '900°'], correctIndex: 3, explanation: 'Sum of interior angles = (n − 2) × 180°. For a heptagon, n = 7: (7 − 2) × 180 = 5 × 180 = 900°.' },
        { difficulty: 'Medium-Hard', question: 'A regular icosagon (20 sides) has all equal interior angles. Find the size of each interior angle.', checkMode: 'auto', options: ['162°', '18°', '3240°', '171°'], correctIndex: 0, explanation: 'Sum of interior angles = (20 − 2) × 180 = 18 × 180 = 3240°. Each angle = 3240° ÷ 20 = 162°.' },
        { difficulty: 'Hard', question: 'A regular polygon has an exterior angle of 20° at every vertex. Using the fact that the exterior angles of any polygon add up to 360°, find the number of sides of the polygon.', checkMode: 'auto', options: ['20 sides', '18 sides', '9 sides', '340 sides'], correctIndex: 1, explanation: 'The exterior angles of any polygon sum to 360°. Number of sides = 360° ÷ 20° = 18.' },

        // Block E — similarity vs congruency reasoning
        { difficulty: 'Easy', question: 'Two rectangles have the same angles (all 90°) and sides in proportion, but one is larger than the other. Are these rectangles congruent or similar?', checkMode: 'auto', options: ['congruent', 'symmetrical', 'similar', 'proportional'], correctIndex: 2, explanation: 'Shapes with the same shape but different sizes are similar, not congruent — congruent shapes must also match in size.' },
        { difficulty: 'Medium', question: 'Two similar triangles have corresponding sides in the ratio 5 : 6. The smaller triangle\'s side is 20 cm. Find the corresponding side in the larger triangle.', checkMode: 'auto', options: ['120 cm', '21 cm', '100 cm', '24 cm'], correctIndex: 3, explanation: 'Set up the proportion: 5/6 = 20/x. Cross-multiply: 5x = 120. x = 120 ÷ 5 = 24 cm. Check: 20/24 = 5/6 ✓' },
