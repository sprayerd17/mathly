  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        // Block C — quadrilateral properties & angle-sum
        { difficulty: 'Easy', question: 'In the quadrilateral shown, three angles are 76°, 142° and 58°. Find the fourth angle.', answer: '84°', checkMode: 'auto', correctAnswer: '84', correctAnswers: ['84', '84°', '84 degrees'], explanation: 'Fourth angle = 360° − 76° − 142° − 58° = 84°. Check: 76+142+58+84 = 360 ✓', diagramSvg: '<svg viewBox="0 0 220 170" xmlns="http://www.w3.org/2000/svg"><polygon points="40,140 132.3,140 183.2,100.2 61,55.8" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="59" y="131" font-size="13" fill="#2563eb" font-weight="700">76°</text><text x="124" y="131" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">142°</text><text x="160" y="103" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">58°</text><text x="74" y="72" font-size="15" fill="#ea580c" font-weight="700">?</text></svg>' },
