  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'Using y = 6x − 4, find y when x = 5.', checkMode: 'auto', options: ['7', '26', '6', '34'], correctIndex: 1, explanation: 'Substitute x = 5: y = 6(5) − 4 = 30 − 4 = 26 ✓' },
        { difficulty: 'Easy', question: 'Using y = −3x + 10, find y when x = 4.', checkMode: 'auto', options: ['22', '-22', '-42', '-2'], correctIndex: 3, explanation: 'Substitute x = 4: y = −3(4) + 10 = −12 + 10 = −2 ✓' },
        { difficulty: 'Medium', question: 'Using y = 2(x + 3) − 1, find y when x = 7.', checkMode: 'auto', options: ['19', '20', '16', '21'], correctIndex: 0, explanation: 'Substitute x = 7: y = 2(7 + 3) − 1 = 2(10) − 1 = 20 − 1 = 19 ✓' },

        // ── Block 2: Solve for x given y (inverse operations) ────────────────
        { difficulty: 'Medium', question: 'Using y = 3x + 8, find x when y = 29.', checkMode: 'auto', options: ['21', '37', '7', '-7'], correctIndex: 2, explanation: '29 = 3x + 8 → 3x = 29 − 8 = 21 → x = 21 ÷ 3 = 7 ✓' },
        { difficulty: 'Medium', question: 'Using y = 5x − 12, find x when y = 33.', checkMode: 'auto', options: ['45', '9', '21', '-9'], correctIndex: 1, explanation: '33 = 5x − 12 → 5x = 33 + 12 = 45 → x = 45 ÷ 5 = 9 ✓' },
        { difficulty: 'Medium-Hard', question: 'Using y = −2x + 7, find x when y = −11.', checkMode: 'auto', options: ['-9', '2', '-18', '9'], correctIndex: 3, explanation: '−11 = −2x + 7 → −2x = −11 − 7 = −18 → x = −18 ÷ −2 = 9 ✓' },
        ...
        { difficulty: 'Medium', question: "A relationship is described as 'add 5 to the input, then multiply by 3'. Write this as an equation, then find y when x = 2.", checkMode: 'auto', options: ['21', '11', '6', '30'], correctIndex: 0, explanation: "Let x = input, y = output. 'Add 5': (x + 5). 'Multiply by 3': y = 3(x + 5). At x = 2: y = 3(2 + 5) = 3(7) = 21 ✓" },
        ...
        { difficulty: 'Medium-Hard', question: 'Generate ordered pairs using y = −2x + 5 for x = −1, 0, 1, 2.', checkMode: 'auto', options: ['(-1, 3), (0, 5), (1, 7), (2, 9)', '(-1, -3), (0, -5), (1, -7), (2, -9)', '(0, 5), (1, 3), (2, 1), (3, -1)', '(-1, 7), (0, 5), (1, 3), (2, 1)'], correctIndex: 3, explanation: 'x=−1: y=−2(−1)+5=2+5=7 → (−1,7). x=0: y=5 → (0,5). x=1: y=−2+5=3 → (1,3). x=2: y=−4+5=1 → (2,1) ✓' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // ── Block 1: Substitute to find y given x ────────────────────────────
        { difficulty: 'Easy', question: 'Using y = 7x − 5, find y when x = 4.', checkMode: 'auto', options: ['6', '-7', '23', '33'], correctIndex: 2, explanation: 'Substitute x = 4: y = 7(4) − 5 = 28 − 5 = 23 ✓' },
        { difficulty: 'Easy', question: 'Using y = −4x + 15, find y when x = 3.', checkMode: 'auto', options: ['3', '27', '-27', '-72'], correctIndex: 0, explanation: 'Substitute x = 3: y = −4(3) + 15 = −12 + 15 = 3 ✓' },
        { difficulty: 'Medium', question: 'Using y = 3(x + 2) − 4, find y when x = 6.', checkMode: 'auto', options: ['24', '16', '28', '20'], correctIndex: 3, explanation: 'Substitute x = 6: y = 3(6 + 2) − 4 = 3(8) − 4 = 24 − 4 = 20 ✓' },

        // ── Block 2: Solve for x given y (inverse operations) ────────────────
        { difficulty: 'Medium', question: 'Using y = 4x + 6, find x when y = 38.', checkMode: 'auto', options: ['32', '8', '44', '-8'], correctIndex: 1, explanation: '38 = 4x + 6 → 4x = 38 − 6 = 32 → x = 32 ÷ 4 = 8 ✓' },
        { difficulty: 'Medium', question: 'Using y = 6x − 15, find x when y = 45.', checkMode: 'auto', options: ['60', '30', '10', '-10'], correctIndex: 2, explanation: '45 = 6x − 15 → 6x = 45 + 15 = 60 → x = 60 ÷ 6 = 10 ✓' },
        { difficulty: 'Medium-Hard', question: 'Using y = −3x + 9, find x when y = −15.', checkMode: 'auto', options: ['8', '-8', '2', '-24'], correctIndex: 0, explanation: '−15 = −3x + 9 → −3x = −15 − 9 = −24 → x = −24 ÷ −3 = 8 ✓' },
        ...
        { difficulty: 'Medium', question: "A relationship is described as 'add 3 to the input, then multiply by 4'. Write this as an equation, then find y when x = 5.", checkMode: 'auto', options: ['23', '20', '44', '32'], correctIndex: 3, explanation: "Let x = input, y = output. 'Add 3': (x + 3). 'Multiply by 4': y = 4(x + 3). At x = 5: y = 4(5 + 3) = 4(8) = 32 ✓" },
        ...
        { difficulty: 'Medium-Hard', question: 'Generate ordered pairs using y = −3x + 4 for x = −1, 0, 1, 2.', checkMode: 'auto', options: ['(-1, 7), (0, 4), (1, 1), (2, -2)', '(-1, 1), (0, 4), (1, 7), (2, 10)', '(-1, -1), (0, -4), (1, -7), (2, -10)', '(0, 4), (1, 1), (2, -2), (3, -5)'], correctIndex: 0, explanation: 'x=−1: y=−3(−1)+4=3+4=7 → (−1,7). x=0: y=4 → (0,4). x=1: y=−3+4=1 → (1,1). x=2: y=−6+4=−2 → (2,−2) ✓' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // ── Block 1: Substitute to find y given x ────────────────────────────
        { difficulty: 'Easy', question: 'Using y = 5x − 9, find y when x = 6.', checkMode: 'auto', options: ['2', '-15', '39', '21'], correctIndex: 3, explanation: 'Substitute x = 6: y = 5(6) − 9 = 30 − 9 = 21 ✓' },
        { difficulty: 'Easy', question: 'Using y = −2x + 18, find y when x = 5.', checkMode: 'auto', options: ['28', '8', '-28', '-46'], correctIndex: 1, explanation: 'Substitute x = 5: y = −2(5) + 18 = −10 + 18 = 8 ✓' },
        { difficulty: 'Medium', question: 'Using y = 4(x − 1) + 3, find y when x = 5.', checkMode: 'auto', options: ['16', '22', '19', '13'], correctIndex: 2, explanation: 'Substitute x = 5: y = 4(5 − 1) + 3 = 4(4) + 3 = 16 + 3 = 19 ✓' },

        // ── Block 2: Solve for x given y (inverse operations) ────────────────
        { difficulty: 'Medium', question: 'Using y = 7x + 2, find x when y = 44.', checkMode: 'auto', options: ['6', '42', '46', '-6'], correctIndex: 0, explanation: '44 = 7x + 2 → 7x = 44 − 2 = 42 → x = 42 ÷ 7 = 6 ✓' },
        { difficulty: 'Medium', question: 'Using y = 8x − 20, find x when y = 44.', checkMode: 'auto', options: ['64', '24', '-8', '8'], correctIndex: 3, explanation: '44 = 8x − 20 → 8x = 44 + 20 = 64 → x = 64 ÷ 8 = 8 ✓' },
        { difficulty: 'Medium-Hard', question: 'Using y = −5x + 6, find x when y = −19.', checkMode: 'auto', options: ['-5', '5', '-25', '-13'], correctIndex: 1, explanation: '−19 = −5x + 6 → −5x = −19 − 6 = −25 → x = −25 ÷ −5 = 5 ✓' },
        ...
        { difficulty: 'Medium', question: "A relationship is described as 'add 7 to the input, then multiply by 2'. Write this as an equation, then find y when x = 6.", checkMode: 'auto', options: ['19', '12', '26', '32'], correctIndex: 2, explanation: "Let x = input, y = output. 'Add 7': (x + 7). 'Multiply by 2': y = 2(x + 7). At x = 6: y = 2(6 + 7) = 2(13) = 26 ✓" },
        ...
        { difficulty: 'Medium-Hard', question: 'Generate ordered pairs using y = −4x + 6 for x = −1, 0, 1, 2.', checkMode: 'auto', options: ['(-1, 2), (0, 6), (1, 10), (2, 14)', '(-1, 10), (0, 6), (1, 2), (2, -2)', '(-1, -2), (0, -6), (1, -10), (2, -14)', '(0, 6), (1, 2), (2, -2), (3, -6)'], correctIndex: 1, explanation: 'x=−1: y=−4(−1)+6=4+6=10 → (−1,10). x=0: y=6 → (0,6). x=1: y=−4+6=2 → (1,2). x=2: y=−8+6=−2 → (2,−2) ✓' },
