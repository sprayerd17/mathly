...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramSvg:
        ...
        `<text x="105" y="12" text-anchor="middle" font-size="9" font-weight="700" fill="#0f1f3d">Cost vs mass — straight line through origin</text>` +
        ...
        `<text x="240" y="35" font-size="9" font-weight="700" fill="#0f1f3d">Table of values</text>` +
  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      name: 'Set 1',
      questions: [
        { difficulty: 'Easy', question: 'Simplify the ratio 24 : 36 to its simplest form.', checkMode: 'auto', options: ['2 : 3', '3 : 2', '4 : 6', '24 : 3'], correctIndex: 0, explanation: 'HCF of 24 and 36 is 12.\n24 ÷ 12 = 2 and 36 ÷ 12 = 3.\nSimplest form: 2 : 3. (The other options come from flipping the ratio, only partly simplifying, or dividing just one of the two numbers by the HCF.)' },
        { difficulty: 'Easy', question: 'Simplify the ratio 18 : 42 to its simplest form.', checkMode: 'auto', options: ['7 : 3', '3 : 7', '6 : 14', '18 : 7'], correctIndex: 1, explanation: 'HCF of 18 and 42 is 6.\n18 ÷ 6 = 3 and 42 ÷ 6 = 7.\nSimplest form: 3 : 7. (The other options come from flipping the ratio, only partly simplifying, or dividing just one of the two numbers by the HCF.)' },
        { difficulty: 'Easy', question: 'Simplify the ratio 150 : 90 to its simplest form.', checkMode: 'auto', options: ['3 : 5', '10 : 6', '5 : 3', '150 : 3'], correctIndex: 2, explanation: 'HCF of 150 and 90 is 30.\n150 ÷ 30 = 5 and 90 ÷ 30 = 3.\nSimplest form: 5 : 3. (The other options come from flipping the ratio, only partly simplifying, or dividing just one of the two numbers by the HCF.)' },
        { difficulty: 'Medium', question: 'Share R360 between Thabo and Lerato in the ratio 4 : 5. Find Thabo\'s share.', checkMode: 'auto', options: ['R200', 'R40', 'R180', 'R160'], correctIndex: 3, explanation: 'Total parts = 4 + 5 = 9.\nValue of 1 part = 360 ÷ 9 = R40.\nThabo\'s share = 4 × R40 = R160. (The other options come from finding the wrong share, stopping at the value of one part, or splitting the total equally and ignoring the ratio.)' },
        { difficulty: 'Medium', question: 'Share R600 between three friends in the ratio 2 : 3 : 5. Find the largest share.', checkMode: 'auto', options: ['R300', 'R120', 'R60', 'R200'], correctIndex: 0, explanation: 'Total parts = 2 + 3 + 5 = 10.\nValue of 1 part = 600 ÷ 10 = R60.\nLargest share = 5 × R60 = R300. (The other options come from finding the wrong share, stopping at the value of one part, or splitting the total equally and ignoring the ratio.)' },
        { difficulty: 'Medium', question: 'Share R200 between Sipho and Amahle in the ratio 3 : 5. Find Amahle\'s share.', checkMode: 'auto', options: ['R75', 'R125', 'R25', 'R100'], correctIndex: 1, explanation: 'Total parts = 3 + 5 = 8.\nValue of 1 part = 200 ÷ 8 = R25.\nAmahle\'s share = 5 × R25 = R125. (The other options come from finding the wrong share, stopping at the value of one part, or splitting the total equally and ignoring the ratio.)' },
        { difficulty: 'Medium', question: 'A class of 40 learners is split into two groups in the ratio of boys to girls of 3 : 5. How many girls are in the class?', checkMode: 'auto', options: ['15', '5', '25', '20'], correctIndex: 2, explanation: 'Total parts = 3 + 5 = 8.\nValue of 1 part = 40 ÷ 8 = 5.\nGirls = 5 × 5 = 25. (The other options come from finding the wrong share, stopping at the value of one part, or splitting the total equally and ignoring the ratio.)' },
        { difficulty: 'Medium', question: 'If 5 kg of rice costs R85, find the cost of 8 kg using direct proportion.', checkMode: 'auto', options: ['R53.12', 'R680', 'R119', 'R136'], correctIndex: 3, explanation: 'Set up equal ratios: 5/85 = 8/x.\nCross multiply: 5x = 8 × 85 = 680.\nx = 680 ÷ 5 = R136. (The other options come from mixing up direct and inverse proportion, forgetting the final division step, or using one unit too few in the calculation.)' },
        { difficulty: 'Medium', question: 'A school buys 12 textbooks for R540. Using direct proportion, find the cost of 20 textbooks.', checkMode: 'auto', options: ['R900', 'R324', 'R10 800', 'R855'], correctIndex: 0, explanation: 'Set up equal ratios: 12/540 = 20/x.\nCross multiply: 12x = 20 × 540 = 10 800.\nx = 10 800 ÷ 12 = R900. (The other options come from mixing up direct and inverse proportion, forgetting the final division step, or using one unit too few in the calculation.)' },
        { difficulty: 'Hard', question: 'The exchange rate is 6 US dollars for R114. Using direct proportion, find how many rand 15 US dollars is worth.', checkMode: 'auto', options: ['R45.60', 'R285', 'R1 710', 'R266'], correctIndex: 1, explanation: 'Set up equal ratios: 6/114 = 15/x.\nCross multiply: 6x = 15 × 114 = 1 710.\nx = 1 710 ÷ 6 = R285. (The other options come from mixing up direct and inverse proportion, forgetting the final division step, or using one unit too few in the calculation.)' },
        { difficulty: 'Hard', question: 'A recipe uses 400 g of flour for every 250 ml of milk. Using direct proportion, find how much flour is needed for 625 ml of milk.', checkMode: 'auto', options: ['160g', '250 000g', '1 000g', '998.4g'], correctIndex: 2, explanation: 'Set up equal ratios: 250/400 = 625/x.\nCross multiply: 250x = 625 × 400 = 250 000.\nx = 250 000 ÷ 250 = 1 000g. (The other options come from mixing up direct and inverse proportion, forgetting the final division step, or using one unit too few in the calculation.)' },
        { difficulty: 'Hard', question: '4 workers can build a wall in 18 days. How many days would 6 workers take, assuming inverse proportion?', checkMode: 'auto', options: ['27 days', '72 days', '16 days', '12 days'], correctIndex: 3, explanation: 'x₁y₁ = x₂y₂.\n4 × 18 = 6 × y₂.\n72 = 6y₂.\ny₂ = 72 ÷ 6 = 12 days. (The other options come from treating it as direct instead of inverse proportion, forgetting to divide by the new value, or simply subtracting the change instead of using the constant product.)' },
        { difficulty: 'Hard', question: 'A car travels at 90 km/h and takes 4 hours for a trip. Find the time taken if it travels at 60 km/h instead.', checkMode: 'auto', options: ['6 hours', '2.67 hours', '360 hours', '34 hours'], correctIndex: 0, explanation: 'x₁y₁ = x₂y₂.\n90 × 4 = 60 × y₂.\n360 = 60y₂.\ny₂ = 360 ÷ 60 = 6 hours. (The other options come from treating it as direct instead of inverse proportion, forgetting to divide by the new value, or simply subtracting the change instead of using the constant product.)' },
        { difficulty: 'Hard', question: '10 taps fill a tank in 8 hours. How long would 16 taps take, assuming inverse proportion?', checkMode: 'auto', options: ['12.8 hours', '5 hours', '80 hours', '2 hours'], correctIndex: 1, explanation: 'x₁y₁ = x₂y₂.\n10 × 8 = 16 × y₂.\n80 = 16y₂.\ny₂ = 80 ÷ 16 = 5 hours. (The other options come from treating it as direct instead of inverse proportion, forgetting to divide by the new value, or simply subtracting the change instead of using the constant product.)' },
        { difficulty: 'Hard', question: 'A shop sells 12 identical items for R156. Find the price of one item (the unit rate).', checkMode: 'auto', options: ['R1 872', '12', 'R13', 'R12'], correctIndex: 2, explanation: 'Unit rate = total cost ÷ number of items.\n156 ÷ 12 = 13.\nPrice per item = R13. (The other options come from multiplying instead of dividing, giving the item count instead of the price, or dividing by one item too many.)' },
        { difficulty: 'Hard', question: 'A car travels at a constant speed of 72 km/h for 3.5 hours. Find the distance travelled.', checkMode: 'auto', options: ['20.57km', '75.5km', '216km', '252km'], correctIndex: 3, explanation: 'Distance = speed × time.\nDistance = 72 × 3.5 = 252km. (The other options come from dividing instead of multiplying, adding speed and time instead of multiplying, or rounding the time down before multiplying.)' },
        { difficulty: 'Hard', question: 'A learner types 210 words in 3.5 minutes at a constant rate. How long would it take to type 480 words at the same rate?', checkMode: 'auto', options: ['8 minutes', '1.53 minutes', '1 680 minutes', '10.29 minutes'], correctIndex: 0, explanation: 'Rate = 210 ÷ 3.5 = 60 words per minute.\nTime for 480 words = 480 ÷ 60 = 8 minutes. (The other options come from inverting the rate, forgetting to divide by the original word count, or using one minute too many when finding the typing rate.)' },
        { difficulty: 'Hard', question: 'A map has a scale of 1 : 50 000. The distance between two towns on the map is 6 cm. Find the real distance in km.', checkMode: 'auto', options: ['300km', '3km', '12km', '3 000km'], correctIndex: 1, explanation: 'Real distance = 6 × 50 000 = 300 000 cm.\nConvert to km: 300 000 ÷ 100 000 = 3km. (The other options come from using the wrong unit-conversion factor, dividing by the scale instead of multiplying, or converting to metres instead of kilometres.)' },
        { difficulty: 'Hard', question: 'A map has a scale of 1 : 20 000. Two landmarks are 3 km apart in real life. Find the distance between them on the map, in cm.', checkMode: 'auto', options: ['0.6cm', '300 000cm', '15cm', '0.15cm'], correctIndex: 2, explanation: 'Convert 3 km to cm: 3 × 100 000 = 300 000 cm.\nMap distance = 300 000 ÷ 20 000 = 15cm. (The other options come from applying the scale the wrong way round, forgetting to divide by the scale at all, or using the wrong unit-conversion factor.)' },
        { difficulty: 'Hard', question: 'Cement, sand and stone are mixed in the ratio 1 : 2 : 3 to make 240 kg of concrete. If the job is scaled up to 3 times the batch size, find the new mass of sand needed.', checkMode: 'auto', options: ['80 kg', '720 kg', '360 kg', '240 kg'], correctIndex: 3, explanation: 'Total parts = 1 + 2 + 3 = 6.\nValue of 1 part = 240 ÷ 6 = 40 kg.\nIngredient (2 parts) = 2 × 40 kg = 80 kg.\nScaled batch total = 240 × 3 = 720 kg, so the ingredient scales the same way: 80 × 3 = 240 kg. (The other options come from forgetting to scale up the batch, confusing the ingredient amount with the whole batch total, or using the wrong ratio number for this ingredient.)' },
      ],
      scoreMessages: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      name: 'Set 2',
      questions: [
        { difficulty: 'Easy', question: 'Simplify the ratio 28 : 42 to its simplest form.', checkMode: 'auto', options: ['2 : 3', '3 : 2', '4 : 6', '28 : 3'], correctIndex: 0, explanation: 'HCF of 28 and 42 is 14.\n28 ÷ 14 = 2 and 42 ÷ 14 = 3.\nSimplest form: 2 : 3. (The other options come from flipping the ratio, only partly simplifying, or dividing just one of the two numbers by the HCF.)' },
        { difficulty: 'Easy', question: 'Simplify the ratio 20 : 45 to its simplest form.', checkMode: 'auto', options: ['9 : 4', '4 : 9', '20 : 45', '20 : 9'], correctIndex: 1, explanation: 'HCF of 20 and 45 is 5.\n20 ÷ 5 = 4 and 45 ÷ 5 = 9.\nSimplest form: 4 : 9. (The other options come from flipping the ratio, only partly simplifying, or dividing just one of the two numbers by the HCF.)' },
        { difficulty: 'Easy', question: 'Simplify the ratio 126 : 84 to its simplest form.', checkMode: 'auto', options: ['2 : 3', '6 : 4', '3 : 2', '126 : 2'], correctIndex: 2, explanation: 'HCF of 126 and 84 is 42.\n126 ÷ 42 = 3 and 84 ÷ 42 = 2.\nSimplest form: 3 : 2. (The other options come from flipping the ratio, only partly simplifying, or dividing just one of the two numbers by the HCF.)' },
        { difficulty: 'Medium', question: 'Share R280 between Sipho and Naledi in the ratio 3 : 4. Find Sipho\'s share.', checkMode: 'auto', options: ['R160', 'R40', 'R140', 'R120'], correctIndex: 3, explanation: 'Total parts = 3 + 4 = 7.\nValue of 1 part = 280 ÷ 7 = R40.\nSipho\'s share = 3 × R40 = R120. (The other options come from finding the wrong share, stopping at the value of one part, or splitting the total equally and ignoring the ratio.)' },
        { difficulty: 'Medium', question: 'Share R450 between three charities in the ratio 1 : 2 : 2. Find the value of each of the two equal (larger) shares.', checkMode: 'auto', options: ['R180', 'R270', 'R90', 'R150'], correctIndex: 0, explanation: 'Total parts = 1 + 2 + 2 = 5.\nValue of 1 part = 450 ÷ 5 = R90.\nEach larger share = 2 × R90 = R180. (The other options come from finding the wrong share, stopping at the value of one part, or splitting the total equally and ignoring the ratio.)' },
        { difficulty: 'Medium', question: 'Share R336 between Buhle and Kagiso in the ratio 4 : 3. Find Buhle\'s share.', checkMode: 'auto', options: ['R144', 'R192', 'R48', 'R168'], correctIndex: 1, explanation: 'Total parts = 4 + 3 = 7.\nValue of 1 part = 336 ÷ 7 = R48.\nBuhle\'s share = 4 × R48 = R192. (The other options come from finding the wrong share, stopping at the value of one part, or splitting the total equally and ignoring the ratio.)' },
        { difficulty: 'Medium', question: 'A farm has 1 050 chickens and ducks in the ratio 3 : 4. How many ducks are on the farm?', checkMode: 'auto', options: ['450', '150', '600', '525'], correctIndex: 2, explanation: 'Total parts = 3 + 4 = 7.\nValue of 1 part = 1 050 ÷ 7 = 150.\nDucks = 4 × 150 = 600. (The other options come from finding the wrong share, stopping at the value of one part, or splitting the total equally and ignoring the ratio.)' },
        { difficulty: 'Medium', question: 'If 4 kg of rice costs R76, find the cost of 9 kg using direct proportion.', checkMode: 'auto', options: ['R33.78', 'R684', 'R152', 'R171'], correctIndex: 3, explanation: 'Set up equal ratios: 4/76 = 9/x.\nCross multiply: 4x = 9 × 76 = 684.\nx = 684 ÷ 4 = R171. (The other options come from mixing up direct and inverse proportion, forgetting the final division step, or using one unit too few in the calculation.)' },
        { difficulty: 'Medium', question: 'A school buys 15 textbooks for R675. Using direct proportion, find the cost of 24 textbooks.', checkMode: 'auto', options: ['R1 080', 'R421.88', 'R16 200', 'R1 035'], correctIndex: 0, explanation: 'Set up equal ratios: 15/675 = 24/x.\nCross multiply: 15x = 24 × 675 = 16 200.\nx = 16 200 ÷ 15 = R1 080. (The other options come from mixing up direct and inverse proportion, forgetting the final division step, or using one unit too few in the calculation.)' },
        { difficulty: 'Hard', question: 'The exchange rate is 8 US dollars for R152. Using direct proportion, find how many rand 20 US dollars is worth.', checkMode: 'auto', options: ['R60.80', 'R380', 'R3 040', 'R361'], correctIndex: 1, explanation: 'Set up equal ratios: 8/152 = 20/x.\nCross multiply: 8x = 20 × 152 = 3 040.\nx = 3 040 ÷ 8 = R380. (The other options come from mixing up direct and inverse proportion, forgetting the final division step, or using one unit too few in the calculation.)' },
        { difficulty: 'Hard', question: 'A recipe uses 480 g of flour for every 300 ml of milk. Using direct proportion, find how much flour is needed for 750 ml of milk.', checkMode: 'auto', options: ['192g', '360 000g', '1 200g', '1 198.4g'], correctIndex: 2, explanation: 'Set up equal ratios: 300/480 = 750/x.\nCross multiply: 300x = 750 × 480 = 360 000.\nx = 360 000 ÷ 300 = 1 200g. (The other options come from mixing up direct and inverse proportion, forgetting the final division step, or using one unit too few in the calculation.)' },
        { difficulty: 'Hard', question: '6 workers can build a wall in 15 days. How many days would 9 workers take, assuming inverse proportion?', checkMode: 'auto', options: ['22.5 days', '90 days', '12 days', '10 days'], correctIndex: 3, explanation: 'x₁y₁ = x₂y₂.\n6 × 15 = 9 × y₂.\n90 = 9y₂.\ny₂ = 90 ÷ 9 = 10 days. (The other options come from treating it as direct instead of inverse proportion, forgetting to divide by the new value, or simply subtracting the change instead of using the constant product.)' },
        { difficulty: 'Hard', question: 'A car travels at 80 km/h and takes 6 hours for a trip. Find the time taken if it travels at 96 km/h instead.', checkMode: 'auto', options: ['5 hours', '7.2 hours', '480 hours', '3 hours'], correctIndex: 0, explanation: 'x₁y₁ = x₂y₂.\n80 × 6 = 96 × y₂.\n480 = 96y₂.\ny₂ = 480 ÷ 96 = 5 hours. (The other options come from treating it as direct instead of inverse proportion, forgetting to divide by the new value, or simply subtracting the change instead of using the constant product.)' },
        { difficulty: 'Hard', question: '12 taps fill a tank in 9 hours. How long would 18 taps take, assuming inverse proportion?', checkMode: 'auto', options: ['13.5 hours', '6 hours', '108 hours', '3 hours'], correctIndex: 1, explanation: 'x₁y₁ = x₂y₂.\n12 × 9 = 18 × y₂.\n108 = 18y₂.\ny₂ = 108 ÷ 18 = 6 hours. (The other options come from treating it as direct instead of inverse proportion, forgetting to divide by the new value, or simply subtracting the change instead of using the constant product.)' },
        { difficulty: 'Hard', question: 'A shop sells 12 identical items for R204. Find the price of one item (the unit rate).', checkMode: 'auto', options: ['R2 448', '12', 'R17', 'R15.69'], correctIndex: 2, explanation: 'Unit rate = total cost ÷ number of items.\n204 ÷ 12 = 17.\nPrice per item = R17. (The other options come from multiplying instead of dividing, giving the item count instead of the price, or dividing by one item too many.)' },
        { difficulty: 'Hard', question: 'A car travels at a constant speed of 84 km/h for 2.5 hours. Find the distance travelled.', checkMode: 'auto', options: ['33.6km', '86.5km', '168km', '210km'], correctIndex: 3, explanation: 'Distance = speed × time.\nDistance = 84 × 2.5 = 210km. (The other options come from dividing instead of multiplying, adding speed and time instead of multiplying, or rounding the time down before multiplying.)' },
        { difficulty: 'Hard', question: 'A learner types 180 words in 3 minutes at a constant rate. How long would it take to type 420 words at the same rate?', checkMode: 'auto', options: ['7 minutes', '1.29 minutes', '1 260 minutes', '9.33 minutes'], correctIndex: 0, explanation: 'Rate = 180 ÷ 3 = 60 words per minute.\nTime for 420 words = 420 ÷ 60 = 7 minutes. (The other options come from inverting the rate, forgetting to divide by the original word count, or using one minute too many when finding the typing rate.)' },
        { difficulty: 'Hard', question: 'A map has a scale of 1 : 25 000. The distance between two towns on the map is 8 cm. Find the real distance in km.', checkMode: 'auto', options: ['200km', '2km', '32km', '2 000km'], correctIndex: 1, explanation: 'Real distance = 8 × 25 000 = 200 000 cm.\nConvert to km: 200 000 ÷ 100 000 = 2km. (The other options come from using the wrong unit-conversion factor, dividing by the scale instead of multiplying, or converting to metres instead of kilometres.)' },
        { difficulty: 'Hard', question: 'A map has a scale of 1 : 40 000. Two landmarks are 6 km apart in real life. Find the distance between them on the map, in cm.', checkMode: 'auto', options: ['2.4cm', '600 000cm', '15cm', '0.15cm'], correctIndex: 2, explanation: 'Convert 6 km to cm: 6 × 100 000 = 600 000 cm.\nMap distance = 600 000 ÷ 40 000 = 15cm. (The other options come from applying the scale the wrong way round, forgetting to divide by the scale at all, or using the wrong unit-conversion factor.)' },
        { difficulty: 'Hard', question: 'Red, blue and yellow paint are mixed in the ratio 2 : 3 : 5 to make 300 L of a special colour. If the batch is scaled up to 2 times the size, find the new volume of blue paint needed.', checkMode: 'auto', options: ['90 L', '600 L', '300 L', '180 L'], correctIndex: 3, explanation: 'Total parts = 2 + 3 + 5 = 10.\nValue of 1 part = 300 ÷ 10 = 30 L.\nIngredient (3 parts) = 3 × 30 L = 90 L.\nScaled batch total = 300 × 2 = 600 L, so the ingredient scales the same way: 90 × 2 = 180 L. (The other options come from forgetting to scale up the batch, confusing the ingredient amount with the whole batch total, or using the wrong ratio number for this ingredient.)' },
      ],
      scoreMessages: [
        { minScore: 20, message: 'Outstanding! You have mastered ratio, sharing, proportion, rate and scale problems.' },
        { minScore: 15, message: 'Great work! Review any missed questions on inverse proportion or scale, then try again.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      name: 'Set 3',
      questions: [
        { difficulty: 'Easy', question: 'Simplify the ratio 32 : 48 to its simplest form.', checkMode: 'auto', options: ['2 : 3', '3 : 2', '4 : 6', '32 : 3'], correctIndex: 0, explanation: 'HCF of 32 and 48 is 16.\n32 ÷ 16 = 2 and 48 ÷ 16 = 3.\nSimplest form: 2 : 3. (The other options come from flipping the ratio, only partly simplifying, or dividing just one of the two numbers by the HCF.)' },
        { difficulty: 'Easy', question: 'Simplify the ratio 27 : 63 to its simplest form.', checkMode: 'auto', options: ['7 : 3', '3 : 7', '9 : 21', '27 : 7'], correctIndex: 1, explanation: 'HCF of 27 and 63 is 9.\n27 ÷ 9 = 3 and 63 ÷ 9 = 7.\nSimplest form: 3 : 7. (The other options come from flipping the ratio, only partly simplifying, or dividing just one of the two numbers by the HCF.)' },
        { difficulty: 'Easy', question: 'Simplify the ratio 180 : 120 to its simplest form.', checkMode: 'auto', options: ['2 : 3', '6 : 4', '3 : 2', '180 : 2'], correctIndex: 2, explanation: 'HCF of 180 and 120 is 60.\n180 ÷ 60 = 3 and 120 ÷ 60 = 2.\nSimplest form: 3 : 2. (The other options come from flipping the ratio, only partly simplifying, or dividing just one of the two numbers by the HCF.)' },
        { difficulty: 'Medium', question: 'Share R420 between Amahle and Thabo in the ratio 5 : 7. Find Amahle\'s share.', checkMode: 'auto', options: ['R245', 'R35', 'R210', 'R175'], correctIndex: 3, explanation: 'Total parts = 5 + 7 = 12.\nValue of 1 part = 420 ÷ 12 = R35.\nAmahle\'s share = 5 × R35 = R175. (The other options come from finding the wrong share, stopping at the value of one part, or splitting the total equally and ignoring the ratio.)' },
        { difficulty: 'Medium', question: 'Share R360 between three cousins in the ratio 2 : 3 : 4. Find the smallest share.', checkMode: 'auto', options: ['R80', 'R120', 'R40', 'R90'], correctIndex: 0, explanation: 'Total parts = 2 + 3 + 4 = 9.\nValue of 1 part = 360 ÷ 9 = R40.\nSmallest share = 2 × R40 = R80. (The other options come from finding the wrong share, stopping at the value of one part, or splitting the total equally and ignoring the ratio.)' },
        { difficulty: 'Medium', question: 'Share R440 between Lerato and Sipho in the ratio 3 : 8. Find Sipho\'s share.', checkMode: 'auto', options: ['R120', 'R320', 'R40', 'R220'], correctIndex: 1, explanation: 'Total parts = 3 + 8 = 11.\nValue of 1 part = 440 ÷ 11 = R40.\nSipho\'s share = 8 × R40 = R320. (The other options come from finding the wrong share, stopping at the value of one part, or splitting the total equally and ignoring the ratio.)' },
        { difficulty: 'Medium', question: 'A garden has 725 rose bushes and shrubs in the ratio 3 : 2. How many rose bushes are there?', checkMode: 'auto', options: ['290', '145', '435', '362.5'], correctIndex: 2, explanation: 'Total parts = 3 + 2 = 5.\nValue of 1 part = 725 ÷ 5 = 145.\nRose bushes = 3 × 145 = 435. (The other options come from finding the wrong share, stopping at the value of one part, or splitting the total equally and ignoring the ratio.)' },
        { difficulty: 'Medium', question: 'If 6 kg of rice costs R108, find the cost of 10 kg using direct proportion.', checkMode: 'auto', options: ['R64.80', 'R1 080', 'R162', 'R180'], correctIndex: 3, explanation: 'Set up equal ratios: 6/108 = 10/x.\nCross multiply: 6x = 10 × 108 = 1 080.\nx = 1 080 ÷ 6 = R180. (The other options come from mixing up direct and inverse proportion, forgetting the final division step, or using one unit too few in the calculation.)' },
        { difficulty: 'Medium', question: 'A school buys 18 textbooks for R720. Using direct proportion, find the cost of 25 textbooks.', checkMode: 'auto', options: ['R1 000', 'R518.40', 'R18 000', 'R960'], correctIndex: 0, explanation: 'Set up equal ratios: 18/720 = 25/x.\nCross multiply: 18x = 25 × 720 = 18 000.\nx = 18 000 ÷ 18 = R1 000. (The other options come from mixing up direct and inverse proportion, forgetting the final division step, or using one unit too few in the calculation.)' },
        { difficulty: 'Hard', question: 'The exchange rate is 5 US dollars for R95. Using direct proportion, find how many rand 18 US dollars is worth.', checkMode: 'auto', options: ['R26.39', 'R342', 'R1 710', 'R323'], correctIndex: 1, explanation: 'Set up equal ratios: 5/95 = 18/x.\nCross multiply: 5x = 18 × 95 = 1 710.\nx = 1 710 ÷ 5 = R342. (The other options come from mixing up direct and inverse proportion, forgetting the final division step, or using one unit too few in the calculation.)' },
        { difficulty: 'Hard', question: 'A recipe uses 320 g of flour for every 200 ml of milk. Using direct proportion, find how much flour is needed for 550 ml of milk.', checkMode: 'auto', options: ['116.36g', '176 000g', '880g', '878.4g'], correctIndex: 2, explanation: 'Set up equal ratios: 200/320 = 550/x.\nCross multiply: 200x = 550 × 320 = 176 000.\nx = 176 000 ÷ 200 = 880g. (The other options come from mixing up direct and inverse proportion, forgetting the final division step, or using one unit too few in the calculation.)' },
        { difficulty: 'Hard', question: '8 workers can build a wall in 21 days. How many days would 12 workers take, assuming inverse proportion?', checkMode: 'auto', options: ['31.5 days', '168 days', '17 days', '14 days'], correctIndex: 3, explanation: 'x₁y₁ = x₂y₂.\n8 × 21 = 12 × y₂.\n168 = 12y₂.\ny₂ = 168 ÷ 12 = 14 days. (The other options come from treating it as direct instead of inverse proportion, forgetting to divide by the new value, or simply subtracting the change instead of using the constant product.)' },
        { difficulty: 'Hard', question: 'A car travels at 75 km/h and takes 8 hours for a trip. Find the time taken if it travels at 60 km/h instead.', checkMode: 'auto', options: ['10 hours', '6.4 hours', '600 hours', '23 hours'], correctIndex: 0, explanation: 'x₁y₁ = x₂y₂.\n75 × 8 = 60 × y₂.\n600 = 60y₂.\ny₂ = 600 ÷ 60 = 10 hours. (The other options come from treating it as direct instead of inverse proportion, forgetting to divide by the new value, or simply subtracting the change instead of using the constant product.)' },
        { difficulty: 'Hard', question: '15 taps fill a tank in 6 hours. How long would 9 taps take, assuming inverse proportion?', checkMode: 'auto', options: ['3.6 hours', '10 hours', '90 hours', '12 hours'], correctIndex: 1, explanation: 'x₁y₁ = x₂y₂.\n15 × 6 = 9 × y₂.\n90 = 9y₂.\ny₂ = 90 ÷ 9 = 10 hours. (The other options come from treating it as direct instead of inverse proportion, forgetting to divide by the new value, or simply subtracting the change instead of using the constant product.)' },
        { difficulty: 'Hard', question: 'A shop sells 15 identical items for R270. Find the price of one item (the unit rate).', checkMode: 'auto', options: ['R4 050', '15', 'R18', 'R16.88'], correctIndex: 2, explanation: 'Unit rate = total cost ÷ number of items.\n270 ÷ 15 = 18.\nPrice per item = R18. (The other options come from multiplying instead of dividing, giving the item count instead of the price, or dividing by one item too many.)' },
        { difficulty: 'Hard', question: 'A car travels at a constant speed of 96 km/h for 1.75 hours. Find the distance travelled.', checkMode: 'auto', options: ['54.86km', '97.75km', '96km', '168km'], correctIndex: 3, explanation: 'Distance = speed × time.\nDistance = 96 × 1.75 = 168km. (The other options come from dividing instead of multiplying, adding speed and time instead of multiplying, or rounding the time down before multiplying.)' },
        { difficulty: 'Hard', question: 'A learner types 240 words in 4 minutes at a constant rate. How long would it take to type 540 words at the same rate?', checkMode: 'auto', options: ['9 minutes', '1.78 minutes', '2 160 minutes', '11.25 minutes'], correctIndex: 0, explanation: 'Rate = 240 ÷ 4 = 60 words per minute.\nTime for 540 words = 540 ÷ 60 = 9 minutes. (The other options come from inverting the rate, forgetting to divide by the original word count, or using one minute too many when finding the typing rate.)' },
        { difficulty: 'Hard', question: 'A map has a scale of 1 : 200 000. The distance between two towns on the map is 4.5 cm. Find the real distance in km.', checkMode: 'auto', options: ['900km', '9km', '2.25km', '9 000km'], correctIndex: 1, explanation: 'Real distance = 4.5 × 200 000 = 900 000 cm.\nConvert to km: 900 000 ÷ 100 000 = 9km. (The other options come from using the wrong unit-conversion factor, dividing by the scale instead of multiplying, or converting to metres instead of kilometres.)' },
        { difficulty: 'Hard', question: 'A map has a scale of 1 : 100 000. Two landmarks are 8 km apart in real life. Find the distance between them on the map, in cm.', checkMode: 'auto', options: ['0.8cm', '800 000cm', '8cm', '0.08cm'], correctIndex: 2, explanation: 'Convert 8 km to cm: 8 × 100 000 = 800 000 cm.\nMap distance = 800 000 ÷ 100 000 = 8cm. (The other options come from applying the scale the wrong way round, forgetting to divide by the scale at all, or using the wrong unit-conversion factor.)' },
        { difficulty: 'Hard', question: 'Orange, apple and mango juice are mixed in the ratio 3 : 4 : 5 to make 360 L of a fruit blend. If the batch is scaled up to 4 times the size, find the new volume of apple juice needed.', checkMode: 'auto', options: ['120 L', '1 440 L', '600 L', '480 L'], correctIndex: 3, explanation: 'Total parts = 3 + 4 + 5 = 12.\nValue of 1 part = 360 ÷ 12 = 30 L.\nIngredient (4 parts) = 4 × 30 L = 120 L.\nScaled batch total = 360 × 4 = 1 440 L, so the ingredient scales the same way: 120 × 4 = 480 L. (The other options come from forgetting to scale up the batch, confusing the ingredient amount with the whole batch total, or using the wrong ratio number for this ingredient.)' },
      ],
      scoreMessages: [
        { minScore: 20, message: 'Outstanding! You have mastered ratio, sharing, proportion, rate and scale problems.' },
        { minScore: 15, message: 'Great work! Review any missed questions on inverse proportion or scale, then try again.' },
