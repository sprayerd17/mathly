  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Hard', question: 'Thandiwe says the line y = −2x + 8 has a gradient of 2. What is the actual gradient of the line?', checkMode: 'auto', options: ['2', '-2', '8', '-8'], correctIndex: 1, explanation: 'In y = mx + c, the coefficient of x is the gradient. Here m = −2, so the gradient is −2, not 2 as Thandiwe says — she has the wrong sign. The negative sign means the line falls from left to right. (8 and −8 mistake the y-intercept for the gradient.)' },
        { difficulty: 'Hard', question: 'A cyclist needs to travel 240 km at a constant average speed of 60 km/h. How long will the journey take?', checkMode: 'auto', options: ['60 hours', '4 minutes', '4 hours', '0.25 hours'], correctIndex: 2, explanation: 'Time = distance ÷ speed = 240 ÷ 60 = 4 hours. (60 hours mistakes the speed for the time; 4 minutes gets the right number but the wrong unit; 0.25 hours inverts the division.)' },
],
      scoreMessages: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Hard', question: 'Katlego says the line y = −3x + 9 has a gradient of 3. What is the actual gradient of the line?', checkMode: 'auto', options: ['3', '-3', '9', '-9'], correctIndex: 1, explanation: 'In y = mx + c, the coefficient of x is the gradient. Here m = −3, so the gradient is −3, not 3 as Katlego says — he has the wrong sign. The negative sign means the line falls from left to right. (9 and −9 mistake the y-intercept for the gradient.)' },
        { difficulty: 'Hard', question: 'A cyclist needs to travel 210 km at a constant average speed of 70 km/h. How long will the journey take?', checkMode: 'auto', options: ['70 hours', '3 minutes', '3 hours', '0.33 hours'], correctIndex: 2, explanation: 'Time = distance ÷ speed = 210 ÷ 70 = 3 hours. (70 hours mistakes the speed for the time; 3 minutes gets the right number but the wrong unit; 0.33 hours inverts the division.)' },
],
      scoreMessages: [
        { minScore: 20, message: 'Outstanding! You have mastered gradients, equations of lines and interpreting graphs.' },
        { minScore: 15, message: 'Great work! Review any missed questions on travel-graphs or equations of lines and try again.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Hard', question: 'Amahle says the line y = −4x + 16 has a gradient of 4. What is the actual gradient of the line?', checkMode: 'auto', options: ['4', '-4', '16', '-16'], correctIndex: 1, explanation: 'In y = mx + c, the coefficient of x is the gradient. Here m = −4, so the gradient is −4, not 4 as Amahle says — she has the wrong sign. The negative sign means the line falls from left to right. (16 and −16 mistake the y-intercept for the gradient.)' },
        { difficulty: 'Hard', question: 'A cyclist needs to travel 315 km at a constant average speed of 45 km/h. How long will the journey take?', checkMode: 'auto', options: ['45 hours', '7 minutes', '7 hours', '0.14 hours'], correctIndex: 2, explanation: 'Time = distance ÷ speed = 315 ÷ 45 = 7 hours. (45 hours mistakes the speed for the time; 7 minutes gets the right number but the wrong unit; 0.14 hours inverts the division.)' },
],
      scoreMessages: [
        { minScore: 20, message: 'Outstanding! You have mastered gradients, equations of lines and interpreting graphs.' },
        { minScore: 15, message: 'Great work! Review any missed questions on travel-graphs or equations of lines and try again.' },
