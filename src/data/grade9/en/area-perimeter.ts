  ...
  practiceSets: [
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'A circular table top has a diameter of 90 cm, as shown. Find its area (π = 3.14).', answer: '6358.5 cm²', checkMode: 'auto', correctAnswer: '6358.5cm²', correctAnswers: ['6358.5cm²', '6358.5 cm²', '6358.5', '6358.50cm²', '6358.50 cm²'], explanation: 'r = d ÷ 2 = 90 ÷ 2 = 45 cm\nA = πr² = 3.14 × 45² = 3.14 × 2025 = 6358.5 cm² ✓' , diagramSvg: '<svg viewBox="0 0 220 190" xmlns="http://www.w3.org/2000/svg"><circle cx="110" cy="95" r="60" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><circle cx="110" cy="95" r="2.5" fill="#0f1f3d"/><line x1="50" y1="95" x2="170" y2="95" stroke="#2563eb" stroke-width="2"/><text x="110" y="87" font-size="14" fill="#2563eb" font-weight="700" text-anchor="middle">d = 90 cm</text></svg>' },
        ...
        { difficulty: 'Hard', question: "Lerato's rectangular poster, originally 60 cm by 40 cm, is reprinted with its length tripled and its width doubled. Find the new area and express it as a multiple of the original area.", answer: 'New dimensions: 180 cm by 80 cm. New area = 14400 cm². Original area = 2400 cm². The new area is 6 times the original (3 × 2 = 6, matching the combined scale factors).', checkMode: 'self' },
      ],
      scoreMessages: [
    ...
    },
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'A circular table top has a diameter of 120 cm, as shown. Find its area (π = 3.14).', answer: '11304 cm²', checkMode: 'auto', correctAnswer: '11304cm²', correctAnswers: ['11304cm²', '11304 cm²', '11304'], explanation: 'r = d ÷ 2 = 120 ÷ 2 = 60 cm\nA = πr² = 3.14 × 60² = 3.14 × 3600 = 11304 cm² ✓' , diagramSvg: '<svg viewBox="0 0 220 190" xmlns="http://www.w3.org/2000/svg"><circle cx="110" cy="95" r="60" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><circle cx="110" cy="95" r="2.5" fill="#0f1f3d"/><line x1="50" y1="95" x2="170" y2="95" stroke="#2563eb" stroke-width="2"/><text x="110" y="87" font-size="14" fill="#2563eb" font-weight="700" text-anchor="middle">d = 120 cm</text></svg>' },
        { difficulty: 'Medium', question: 'A circular flower bed has a radius of 5.5 m, as shown. Calculate its area to 2 decimal places (π = 3.14).', answer: '94.99 m²', checkMode: 'auto', correctAnswer: '94.99m²', correctAnswers: ['94.99m²', '94.99 m²', '94.99'], explanation: 'A = πr² = 3.14 × 5.5² = 3.14 × 30.25 = 94.985 ≈ 94.99 m² ✓' , diagramSvg: '<svg viewBox="0 0 220 190" xmlns="http://www.w3.org/2000/svg"><circle cx="110" cy="95" r="60" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><circle cx="110" cy="95" r="2.5" fill="#0f1f3d"/><line x1="110" y1="95" x2="170" y2="95" stroke="#2563eb" stroke-width="2"/><text x="140" y="87" font-size="14" fill="#2563eb" font-weight="700" text-anchor="middle">r = 5.5 m</text></svg>' },
        ...
        // ── Block 2: Composite figures (parts added or subtracted) ────────────
        { difficulty: 'Medium', question: 'A sports field is made of a rectangle 45 m by 20 m with a semicircle of radius 10 m attached to one of the 20 m ends, as shown. Find the total area to 2 decimal places (π = 3.14).', answer: '1057 m²', checkMode: 'auto', correctAnswer: '1057m²', correctAnswers: ['1057m²', '1057 m²', '1057'], explanation: 'Rectangle area = 45 × 20 = 900 m²\nSemicircle area = ½ × π × 10² = 0.5 × 3.14 × 100 = 157 m²\nTotal area = 900 + 157 = 1057 m² ✓' , diagramSvg: '<svg viewBox="0 0 245 170" xmlns="http://www.w3.org/2000/svg"><rect x="35" y="40" width="130" height="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 165,40 A 45,45 0 0 1 165,130" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="165" y1="40" x2="165" y2="130" stroke="#374151" stroke-width="1.5" stroke-dasharray="5,4"/><text x="100" y="30" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">45 m</text><text x="27" y="89" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">20 m</text><line x1="165" y1="85" x2="210" y2="85" stroke="#2563eb" stroke-width="2"/><text x="215" y="79" font-size="12" fill="#2563eb" font-weight="700">r = 10 m</text></svg>' },
        { difficulty: 'Medium', question: 'A wooden board measuring 90 cm by 60 cm has a semicircular notch of radius 30 cm cut from one edge, as shown. Find the remaining area to 2 decimal places (π = 3.14).', answer: '3987 cm²', checkMode: 'auto', correctAnswer: '3987cm²', correctAnswers: ['3987cm²', '3987 cm²', '3987'], explanation: 'Rectangle area = 90 × 60 = 5400 cm²\nSemicircle area = ½ × π × 30² = 0.5 × 3.14 × 900 = 1413 cm²\nRemaining area = 5400 − 1413 = 3987 cm² ✓' , diagramSvg: '<svg viewBox="0 0 245 170" xmlns="http://www.w3.org/2000/svg"><path d="M 35,40 L 165,40 A 45,45 0 0 0 165,130 L 35,130 Z" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="120" y1="85" x2="165" y2="85" stroke="#374151" stroke-width="1.5" stroke-dasharray="5,4"/><text x="100" y="30" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">90 cm</text><text x="27" y="89" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">60 cm</text><text x="114" y="79" font-size="12" fill="#2563eb" font-weight="700" text-anchor="end">r = 30 cm</text></svg>' },
        ...
        { difficulty: 'Hard', question: "Lerato's rectangular poster, originally 50 cm by 30 cm, is reprinted with its length quadrupled and its width doubled. Find the new area and express it as a multiple of the original area.", answer: 'New dimensions: 200 cm by 60 cm. New area = 12000 cm². Original area = 1500 cm². The new area is 8 times the original (4 × 2 = 8, matching the combined scale factors).', checkMode: 'self' },
      ],
      scoreMessages: [
        { minScore: 18, message: 'Outstanding! You have mastered area, perimeter and scale factor problems.' },
        { minScore: 14, message: 'Great work! You have a strong grasp of these skills — review any missed questions and try another set.' },
    ...
    },
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'A circular table top has a diameter of 140 cm, as shown. Find its area (π = 3.14).', answer: '15386 cm²', checkMode: 'auto', correctAnswer: '15386cm²', correctAnswers: ['15386cm²', '15386 cm²', '15386'], explanation: 'r = d ÷ 2 = 140 ÷ 2 = 70 cm\nA = πr² = 3.14 × 70² = 3.14 × 4900 = 15386 cm² ✓' , diagramSvg: '<svg viewBox="0 0 220 190" xmlns="http://www.w3.org/2000/svg"><circle cx="110" cy="95" r="60" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><circle cx="110" cy="95" r="2.5" fill="#0f1f3d"/><line x1="50" y1="95" x2="170" y2="95" stroke="#2563eb" stroke-width="2"/><text x="110" y="87" font-size="14" fill="#2563eb" font-weight="700" text-anchor="middle">d = 140 cm</text></svg>' },
        ...
        // ── Block 2: Composite figures (parts added or subtracted) ────────────
        { difficulty: 'Medium', question: 'A sports field is made of a rectangle 30 m by 22 m with a semicircle of radius 11 m attached to one of the 22 m ends, as shown. Find the total area to 2 decimal places (π = 3.14).', answer: '849.97 m²', checkMode: 'auto', correctAnswer: '849.97m²', correctAnswers: ['849.97m²', '849.97 m²', '849.97'], explanation: 'Rectangle area = 30 × 22 = 660 m²\nSemicircle area = ½ × π × 11² = 0.5 × 3.14 × 121 = 189.97 m²\nTotal area = 660 + 189.97 = 849.97 m² ✓' , diagramSvg: '<svg viewBox="0 0 245 170" xmlns="http://www.w3.org/2000/svg"><rect x="35" y="40" width="130" height="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 165,40 A 45,45 0 0 1 165,130" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="165" y1="40" x2="165" y2="130" stroke="#374151" stroke-width="1.5" stroke-dasharray="5,4"/><text x="100" y="30" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">30 m</text><text x="27" y="89" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">22 m</text><line x1="165" y1="85" x2="210" y2="85" stroke="#2563eb" stroke-width="2"/><text x="215" y="79" font-size="12" fill="#2563eb" font-weight="700">r = 11 m</text></svg>' },
        { difficulty: 'Medium', question: 'A wooden board measuring 70 cm by 60 cm has a semicircular notch of radius 20 cm cut from one edge, as shown. Find the remaining area to 2 decimal places (π = 3.14).', answer: '3572 cm²', checkMode: 'auto', correctAnswer: '3572cm²', correctAnswers: ['3572cm²', '3572 cm²', '3572'], explanation: 'Rectangle area = 70 × 60 = 4200 cm²\nSemicircle area = ½ × π × 20² = 0.5 × 3.14 × 400 = 628 cm²\nRemaining area = 4200 − 628 = 3572 cm² ✓' , diagramSvg: '<svg viewBox="0 0 245 170" xmlns="http://www.w3.org/2000/svg"><path d="M 35,40 L 165,40 L 165,45 A 40,40 0 0 0 165,125 L 165,130 L 35,130 Z" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="125" y1="85" x2="165" y2="85" stroke="#374151" stroke-width="1.5" stroke-dasharray="5,4"/><text x="100" y="30" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">70 cm</text><text x="27" y="89" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">60 cm</text><text x="119" y="79" font-size="12" fill="#2563eb" font-weight="700" text-anchor="end">r = 20 cm</text></svg>' },
