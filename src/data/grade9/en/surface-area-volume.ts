  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'A measuring cylinder has radius 4 cm and height 20 cm. Find its volume to 2 decimal places.', checkMode: 'auto', correctAnswer: '1004.8cm³', correctAnswers: ['1004.8cm³', '1004.8', '1004.8 cm³', '1004.80cm³', '1004.80', '1 004.8cm³', '1 004.8'], answer: '1 004.8 cm³', explanation: 'V = πr²h = 3.14 × 4² × 20 = 3.14 × 16 × 20 = 1 004.8 cm³'  , diagramSvg: '<svg viewBox="0 0 220 200" xmlns="http://www.w3.org/2000/svg"><ellipse cx="110" cy="45" rx="55" ry="18" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="55" y1="45" x2="55" y2="145" stroke="#0f1f3d" stroke-width="2.5"/><line x1="165" y1="45" x2="165" y2="145" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 55,145 A 55,18 0 0 0 165,145" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 55,145 A 55,18 0 0 1 165,145" fill="none" stroke="#0f1f3d" stroke-width="1.6" stroke-dasharray="4,3"/><line x1="110" y1="45" x2="163" y2="45" stroke="#2563eb" stroke-width="2"/><text x="137" y="38" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">r = 4 cm</text><line x1="30" y1="45" x2="30" y2="145" stroke="#2563eb" stroke-width="2"/><text x="16" y="95" font-size="13" fill="#ea580c" font-weight="700" text-anchor="middle" transform="rotate(-90 16 95)">h = 20 cm</text></svg>'},
