  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'Triangle ABC has AB = 7 cm, BC = 9 cm and AC = 11 cm. Triangle XYZ has XY = 7 cm, YZ = 9 cm and XZ = 11 cm — all three pairs of corresponding sides equal in length. Explain, using the SSS condition, why this alone is enough to prove the triangles are congruent.', answer: 'Once all three side lengths of a triangle are fixed, there is only one possible triangle shape that can be formed from them (the shape is rigid) — so if two triangles share all three corresponding side lengths, they must be identical in shape and size, meaning all corresponding angles are automatically equal too. No angles need to be measured or given.', checkMode: 'self' },
