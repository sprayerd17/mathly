  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'Factorise 10x² + 15x.', checkMode: 'auto', options: ['5x(2x+3)', '5(2x²+3x)', 'x(10x+15)', '5x(2x-3)'], correctIndex: 0, explanation: 'HCF of 10x² and 15x is 5x. 10x²÷5x=2x and 15x÷5x=3. Factorised: 5x(2x+3) ✓ (The other options factor out only part of the HCF, or get a sign wrong.)' },
        { difficulty: 'Easy', question: 'Factorise 6x³ − 18x².', checkMode: 'auto', options: ['6(x³-3x²)', '6x²(x-3)', 'x²(6x-18)', '6x²(x+3)'], correctIndex: 1, explanation: 'HCF of 6x³ and 18x² is 6x². 6x³÷6x²=x and 18x²÷6x²=3. Factorised: 6x²(x-3) ✓' },

        // Block 2 — Common factor, three-term / cubic (Easy-Medium)
        { difficulty: 'Medium', question: 'Factorise 4x³ + 8x² − 12x.', checkMode: 'auto', options: ['4(x³+2x²-3x)', 'x(4x²+8x-12)', '4x(x²+2x-3)', '4x(x²+2x+3)'], correctIndex: 2, explanation: 'HCF of 4x³, 8x² and 12x is 4x. 4x³÷4x=x², 8x²÷4x=2x, 12x÷4x=3. Factorised: 4x(x²+2x-3) ✓' },
        { difficulty: 'Medium', question: 'Factorise 9a²b + 6ab².', checkMode: 'auto', options: ['3(3a²b+2ab²)', 'ab(9a+6b)', '3ab(3a-2b)', '3ab(3a+2b)'], correctIndex: 3, explanation: 'HCF of 9a²b and 6ab² is 3ab. 9a²b÷3ab=3a and 6ab²÷3ab=2b. Factorised: 3ab(3a+2b) ✓' },

        // Block 3 — Difference of two squares, basic (Medium)
        { difficulty: 'Medium', question: 'Factorise x² − 81.', checkMode: 'auto', options: ['(x-9)(x+9)', '(x-9)²', '(x+9)²', '(x-81)(x+81)'], correctIndex: 0, explanation: 'Recognise x²-81 = x²-9². Difference of squares: (x-9)(x+9) ✓ (Squaring one bracket, or forgetting to take the square root of 81, gives the wrong answers.)' },
        { difficulty: 'Medium', question: 'Factorise x² − 121.', checkMode: 'auto', options: ['(x-11)²', '(x-11)(x+11)', '(x+11)²', '(x-121)(x+121)'], correctIndex: 1, explanation: 'Recognise x²-121 = x²-11². Difference of squares: (x-11)(x+11) ✓' },
        { difficulty: 'Medium', question: 'Factorise 16x² − 1.', checkMode: 'auto', options: ['(4x-1)²', '(16x-1)(16x+1)', '(4x-1)(4x+1)', '(4x+1)²'], correctIndex: 2, explanation: '16x² = (4x)² and 1 = (1)². Difference of squares: (4x-1)(4x+1) ✓ (Using 16 instead of its square root 4 gives the wrong factor.)' },

        // Block 4 — Difference of two squares, with coefficients (Medium/Hard)
        { difficulty: 'Medium', question: 'Factorise 9x² − 25.', checkMode: 'auto', options: ['(3x-5)²', '(9x-5)(9x+5)', '(3x-25)(3x+25)', '(3x-5)(3x+5)'], correctIndex: 3, explanation: '9x² = (3x)² and 25 = (5)². Difference of squares: (3x-5)(3x+5) ✓' },
        { difficulty: 'Hard', question: 'Factorise 25x² − 4y².', checkMode: 'auto', options: ['(5x-2y)(5x+2y)', '(5x-2y)²', '(25x-2y)(25x+2y)', '(5x-4y)(5x+4y)'], correctIndex: 0, explanation: '25x² = (5x)² and 4y² = (2y)². Difference of squares: (5x-2y)(5x+2y) ✓' },
        { difficulty: 'Hard', question: 'Lindiwe factorises 36x² − 49 and gets (6x − 7)(6x + 7). Which statement correctly evaluates her answer?', checkMode: 'auto', options: ['She is incorrect — the correct factorisation is (6x-7)².', 'She is correct — 36x² = (6x)² and 49 = (7)², so the difference of squares gives (6x-7)(6x+7).', 'She is incorrect — the correct factorisation is (36x-49)(x+1).', 'She is correct, but only by coincidence — the pattern does not generally apply to expressions like this.'], correctIndex: 1, explanation: '36x² = (6x)² and 49 = (7)² — both perfect squares, and the expression is a subtraction, so the difference-of-squares pattern applies generally, not by coincidence: (6x-7)(6x+7) ✓' },

        // Block 5 — Trinomial x² + bx + c, positive/simple constant (Medium)
        { difficulty: 'Medium', question: 'Factorise x² + 10x + 24.', checkMode: 'auto', options: ['(x-4)(x-6)', '(x+4)(x-6)', '(x+4)(x+6)', '(x+2)(x+12)'], correctIndex: 2, explanation: 'Find two numbers multiplying to 24 and adding to 10: 4 and 6. Factorised: (x+4)(x+6) ✓ (2 and 12 also multiply to 24, but add to 14, not 10.)' },
        { difficulty: 'Medium', question: 'Factorise x² + 11x + 18.', checkMode: 'auto', options: ['(x-2)(x-9)', '(x+2)(x-9)', '(x+3)(x+6)', '(x+2)(x+9)'], correctIndex: 3, explanation: 'Find two numbers multiplying to 18 and adding to 11: 2 and 9. Factorised: (x+2)(x+9) ✓' },
        { difficulty: 'Medium', question: 'Factorise x² − 7x + 12.', checkMode: 'auto', options: ['(x-3)(x-4)', '(x+3)(x+4)', '(x-3)(x+4)', '(x-2)(x-6)'], correctIndex: 0, explanation: 'Find two numbers multiplying to 12 and adding to -7: -3 and -4. Factorised: (x-3)(x-4) ✓' },

        // Block 6 — Trinomial x² + bx + c, negative constant (Medium/Hard)
        { difficulty: 'Medium-Hard', question: 'Factorise x² − 4x − 21.', checkMode: 'auto', options: ['(x+7)(x-3)', '(x-7)(x+3)', '(x-7)(x-3)', '(x+1)(x-21)'], correctIndex: 1, explanation: 'Find two numbers multiplying to -21 and adding to -4: -7 and 3. Factorised: (x-7)(x+3) ✓' },
        { difficulty: 'Medium-Hard', question: 'Factorise x² + 2x − 24.', checkMode: 'auto', options: ['(x-6)(x+4)', '(x+6)(x+4)', '(x+6)(x-4)', '(x+2)(x-12)'], correctIndex: 2, explanation: 'Find two numbers multiplying to -24 and adding to 2: 6 and -4. Factorised: (x+6)(x-4) ✓' },
        { difficulty: 'Hard', question: 'Factorise x² − x − 30.', checkMode: 'auto', options: ['(x+6)(x-5)', '(x-6)(x-5)', '(x+2)(x-15)', '(x-6)(x+5)'], correctIndex: 3, explanation: 'Find two numbers multiplying to -30 and adding to -1: -6 and 5. Factorised: (x-6)(x+5) ✓' },

        // Block 7 — Trinomial with common factor + error-spotting (Hard)
        { difficulty: 'Hard', question: 'Factorise 2x² + 14x + 24 fully.', checkMode: 'auto', options: ['2(x+3)(x+4)', '(x+3)(x+4)', '2(x+3)(x-4)', '2(x+2)(x+6)'], correctIndex: 0, explanation: 'Factor out 2: 2(x²+7x+12). Find two numbers multiplying to 12 and adding to 7: 3 and 4. Factorised: 2(x+3)(x+4) ✓ (Forgetting the common factor 2, or getting a sign wrong, gives the wrong answers.)' },
        { difficulty: 'Hard', question: 'Factorise 3x² − 3x − 18 fully.', checkMode: 'auto', options: ['(x-3)(x+2)', '3(x-3)(x+2)', '3(x-3)(x-2)', '3(x+1)(x-6)'], correctIndex: 1, explanation: 'Factor out 3: 3(x²-x-6). Find two numbers multiplying to -6 and adding to -1: -3 and 2. Factorised: 3(x-3)(x+2) ✓' },
        { difficulty: 'Hard', question: 'Factorise 4x² − 16 fully.', checkMode: 'auto', options: ['4(x²-4)', '(x-2)(x+2)', '4(x-2)(x+2)', '4(x+2)(x+2)'], correctIndex: 2, explanation: 'Factor out the common factor 4: 4(x²-4). Recognise x²-4 as a difference of squares: 4(x-2)(x+2) ✓ (Stopping after the common-factor step, or dropping the 4 altogether, leaves the factorisation incomplete or incorrect.)' },
        { difficulty: 'Hard', question: 'Karabo factorises x² − 5x − 14 and gets (x − 2)(x + 7). Which statement correctly evaluates his answer?', checkMode: 'auto', options: ['He is correct — (-2)(7) = -14 and -2 + 7 = -5, so the factorisation is valid.', 'He is incorrect — the correct factorisation is (x-14)(x+1).', 'He is correct, but the factors should be written in the opposite order: (x+7)(x-2).', 'He is incorrect — the correct factorisation is (x-7)(x+2), since (-7)(2) = -14 and -7 + 2 = -5.'], correctIndex: 3, explanation: 'Although (-2)(7) = -14 ✓, the sum -2 + 7 = 5, not -5. The correct pair is -7 and 2: (-7)(2) = -14 and -7+2 = -5. So the correct factorisation is (x-7)(x+2).' },
      ],
      scoreMessages: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // Block 1 — Common factor, two-term (Easy)
        { difficulty: 'Easy', question: 'Factorise 14x² + 21x.', checkMode: 'auto', options: ['7x(2x+3)', '7(2x²+3x)', 'x(14x+21)', '7x(2x-3)'], correctIndex: 0, explanation: 'HCF of 14x² and 21x is 7x. 14x²÷7x=2x and 21x÷7x=3. Factorised: 7x(2x+3) ✓' },
        { difficulty: 'Easy', question: 'Factorise 8x³ − 20x².', checkMode: 'auto', options: ['4(2x³-5x²)', '4x²(2x-5)', 'x²(8x-20)', '4x²(2x+5)'], correctIndex: 1, explanation: 'HCF of 8x³ and 20x² is 4x². 8x³÷4x²=2x and 20x²÷4x²=5. Factorised: 4x²(2x-5) ✓' },

        // Block 2 — Common factor, three-term / cubic (Easy-Medium)
        { difficulty: 'Medium', question: 'Factorise 6x³ + 9x² − 15x.', checkMode: 'auto', options: ['3(2x³+3x²-5x)', 'x(6x²+9x-15)', '3x(2x²+3x-5)', '3x(2x²+3x+5)'], correctIndex: 2, explanation: 'HCF of 6x³, 9x² and 15x is 3x. 6x³÷3x=2x², 9x²÷3x=3x, 15x÷3x=5. Factorised: 3x(2x²+3x-5) ✓' },
        { difficulty: 'Medium', question: 'Factorise 12a²b + 8ab².', checkMode: 'auto', options: ['4(3a²b+2ab²)', 'ab(12a+8b)', '4ab(3a-2b)', '4ab(3a+2b)'], correctIndex: 3, explanation: 'HCF of 12a²b and 8ab² is 4ab. 12a²b÷4ab=3a and 8ab²÷4ab=2b. Factorised: 4ab(3a+2b) ✓' },

        // Block 3 — Difference of two squares, basic (Medium)
        { difficulty: 'Medium', question: 'Factorise x² − 36.', checkMode: 'auto', options: ['(x-6)(x+6)', '(x-6)²', '(x+6)²', '(x-36)(x+36)'], correctIndex: 0, explanation: 'Recognise x²-36 = x²-6². Difference of squares: (x-6)(x+6) ✓' },
        { difficulty: 'Medium', question: 'Factorise x² − 100.', checkMode: 'auto', options: ['(x-10)²', '(x-10)(x+10)', '(x+10)²', '(x-100)(x+100)'], correctIndex: 1, explanation: 'Recognise x²-100 = x²-10². Difference of squares: (x-10)(x+10) ✓' },
        { difficulty: 'Medium', question: 'Factorise 9x² − 1.', checkMode: 'auto', options: ['(3x-1)²', '(9x-1)(9x+1)', '(3x-1)(3x+1)', '(3x+1)²'], correctIndex: 2, explanation: '9x² = (3x)² and 1 = (1)². Difference of squares: (3x-1)(3x+1) ✓' },

        // Block 4 — Difference of two squares, with coefficients (Medium/Hard)
        { difficulty: 'Medium', question: 'Factorise 16x² − 49.', checkMode: 'auto', options: ['(4x-7)²', '(16x-7)(16x+7)', '(4x-49)(4x+49)', '(4x-7)(4x+7)'], correctIndex: 3, explanation: '16x² = (4x)² and 49 = (7)². Difference of squares: (4x-7)(4x+7) ✓' },
        { difficulty: 'Hard', question: 'Factorise 4x² − 9y².', checkMode: 'auto', options: ['(2x-3y)(2x+3y)', '(2x-3y)²', '(4x-3y)(4x+3y)', '(2x-9y)(2x+9y)'], correctIndex: 0, explanation: '4x² = (2x)² and 9y² = (3y)². Difference of squares: (2x-3y)(2x+3y) ✓' },
        { difficulty: 'Hard', question: 'Thandi factorises 64x² − 81 and gets (8x − 9)(8x + 9). Which statement correctly evaluates her answer?', checkMode: 'auto', options: ['She is incorrect — the correct factorisation is (8x-9)².', 'She is correct — 64x² = (8x)² and 81 = (9)², so the difference of squares gives (8x-9)(8x+9).', 'She is incorrect — the correct factorisation is (64x-81)(x+1).', 'She is correct, but only by coincidence — the pattern does not generally apply to expressions like this.'], correctIndex: 1, explanation: '64x² = (8x)² and 81 = (9)² — both perfect squares, and the expression is a subtraction, so the difference-of-squares pattern applies: (8x-9)(8x+9) ✓' },

        // Block 5 — Trinomial x² + bx + c, positive/simple constant (Medium)
        { difficulty: 'Medium', question: 'Factorise x² + 9x + 14.', checkMode: 'auto', options: ['(x-2)(x-7)', '(x+2)(x-7)', '(x+2)(x+7)', '(x+1)(x+14)'], correctIndex: 2, explanation: 'Find two numbers multiplying to 14 and adding to 9: 2 and 7. Factorised: (x+2)(x+7) ✓' },
        { difficulty: 'Medium', question: 'Factorise x² + 13x + 40.', checkMode: 'auto', options: ['(x-5)(x-8)', '(x+5)(x-8)', '(x+4)(x+10)', '(x+5)(x+8)'], correctIndex: 3, explanation: 'Find two numbers multiplying to 40 and adding to 13: 5 and 8. Factorised: (x+5)(x+8) ✓' },
        { difficulty: 'Medium', question: 'Factorise x² − 9x + 20.', checkMode: 'auto', options: ['(x-4)(x-5)', '(x+4)(x+5)', '(x-4)(x+5)', '(x-2)(x-10)'], correctIndex: 0, explanation: 'Find two numbers multiplying to 20 and adding to -9: -4 and -5. Factorised: (x-4)(x-5) ✓' },

        // Block 6 — Trinomial x² + bx + c, negative constant (Medium/Hard)
        { difficulty: 'Medium-Hard', question: 'Factorise x² − 3x − 40.', checkMode: 'auto', options: ['(x+8)(x-5)', '(x-8)(x+5)', '(x-8)(x-5)', '(x+4)(x-10)'], correctIndex: 1, explanation: 'Find two numbers multiplying to -40 and adding to -3: -8 and 5. Factorised: (x-8)(x+5) ✓' },
        { difficulty: 'Medium-Hard', question: 'Factorise x² + 4x − 21.', checkMode: 'auto', options: ['(x-7)(x+3)', '(x+7)(x+3)', '(x+7)(x-3)', '(x+1)(x-21)'], correctIndex: 2, explanation: 'Find two numbers multiplying to -21 and adding to 4: 7 and -3. Factorised: (x+7)(x-3) ✓' },
        { difficulty: 'Hard', question: 'Factorise x² − 2x − 35.', checkMode: 'auto', options: ['(x+7)(x-5)', '(x-7)(x-5)', '(x+1)(x-35)', '(x-7)(x+5)'], correctIndex: 3, explanation: 'Find two numbers multiplying to -35 and adding to -2: -7 and 5. Factorised: (x-7)(x+5) ✓' },

        // Block 7 — Trinomial with common factor + error-spotting (Hard)
        { difficulty: 'Hard', question: 'Factorise 3x² + 21x + 30 fully.', checkMode: 'auto', options: ['3(x+2)(x+5)', '(x+2)(x+5)', '3(x+2)(x-5)', '3(x+1)(x+10)'], correctIndex: 0, explanation: 'Factor out 3: 3(x²+7x+10). Find two numbers multiplying to 10 and adding to 7: 2 and 5. Factorised: 3(x+2)(x+5) ✓' },
        { difficulty: 'Hard', question: 'Factorise 2x² − 2x − 24 fully.', checkMode: 'auto', options: ['(x-4)(x+3)', '2(x-4)(x+3)', '2(x+4)(x+3)', '2(x+2)(x-6)'], correctIndex: 1, explanation: 'Factor out 2: 2(x²-x-12). Find two numbers multiplying to -12 and adding to -1: -4 and 3. Factorised: 2(x-4)(x+3) ✓' },
        { difficulty: 'Hard', question: 'Factorise 5x² − 45 fully.', checkMode: 'auto', options: ['5(x²-9)', '(x-3)(x+3)', '5(x-3)(x+3)', '5(x+3)(x+3)'], correctIndex: 2, explanation: 'Factor out the common factor 5: 5(x²-9). Recognise x²-9 as a difference of squares: 5(x-3)(x+3) ✓' },
        { difficulty: 'Hard', question: 'Naledi factorises x² − 6x − 16 and gets (x − 2)(x + 8). Which statement correctly evaluates her answer?', checkMode: 'auto', options: ['She is correct — (-2)(8) = -16 and -2 + 8 = -6, so the factorisation is valid.', 'She is incorrect — the correct factorisation is (x-16)(x+1).', 'She is correct, but the factors should be written in the opposite order: (x+8)(x-2).', 'She is incorrect — the correct factorisation is (x-8)(x+2), since (-8)(2) = -16 and -8 + 2 = -6.'], correctIndex: 3, explanation: 'Although (-2)(8) = -16 ✓, the sum -2 + 8 = 6, not -6. The correct pair is -8 and 2: (-8)(2) = -16 and -8+2 = -6. So the correct factorisation is (x-8)(x+2).' },
      ],
      scoreMessages: [
        { minScore: 20, message: 'Outstanding! You have mastered factorising common factors, differences of squares and trinomials.' },
        { minScore: 15, message: 'Great work! Review any missed questions on trinomials or difference of squares and try again.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // Block 1 — Common factor, two-term (Easy)
        { difficulty: 'Easy', question: 'Factorise 12x² + 18x.', checkMode: 'auto', options: ['6x(2x+3)', '6(2x²+3x)', 'x(12x+18)', '6x(2x-3)'], correctIndex: 0, explanation: 'HCF of 12x² and 18x is 6x. 12x²÷6x=2x and 18x÷6x=3. Factorised: 6x(2x+3) ✓' },
        { difficulty: 'Easy', question: 'Factorise 10x³ − 15x².', checkMode: 'auto', options: ['5(2x³-3x²)', '5x²(2x-3)', 'x²(10x-15)', '5x²(2x+3)'], correctIndex: 1, explanation: 'HCF of 10x³ and 15x² is 5x². 10x³÷5x²=2x and 15x²÷5x²=3. Factorised: 5x²(2x-3) ✓' },

        // Block 2 — Common factor, three-term / cubic (Easy-Medium)
        { difficulty: 'Medium', question: 'Factorise 8x³ + 12x² − 20x.', checkMode: 'auto', options: ['4(2x³+3x²-5x)', 'x(8x²+12x-20)', '4x(2x²+3x-5)', '4x(2x²+3x+5)'], correctIndex: 2, explanation: 'HCF of 8x³, 12x² and 20x is 4x. 8x³÷4x=2x², 12x²÷4x=3x, 20x÷4x=5. Factorised: 4x(2x²+3x-5) ✓' },
        { difficulty: 'Medium', question: 'Factorise 15a²b + 10ab².', checkMode: 'auto', options: ['5(3a²b+2ab²)', 'ab(15a+10b)', '5ab(3a-2b)', '5ab(3a+2b)'], correctIndex: 3, explanation: 'HCF of 15a²b and 10ab² is 5ab. 15a²b÷5ab=3a and 10ab²÷5ab=2b. Factorised: 5ab(3a+2b) ✓' },

        // Block 3 — Difference of two squares, basic (Medium)
        { difficulty: 'Medium', question: 'Factorise x² − 16.', checkMode: 'auto', options: ['(x-4)(x+4)', '(x-4)²', '(x+4)²', '(x-16)(x+16)'], correctIndex: 0, explanation: 'Recognise x²-16 = x²-4². Difference of squares: (x-4)(x+4) ✓' },
        { difficulty: 'Medium', question: 'Factorise x² − 144.', checkMode: 'auto', options: ['(x-12)²', '(x-12)(x+12)', '(x+12)²', '(x-144)(x+144)'], correctIndex: 1, explanation: 'Recognise x²-144 = x²-12². Difference of squares: (x-12)(x+12) ✓' },
        { difficulty: 'Medium', question: 'Factorise 25x² − 1.', checkMode: 'auto', options: ['(5x-1)²', '(25x-1)(25x+1)', '(5x-1)(5x+1)', '(5x+1)²'], correctIndex: 2, explanation: '25x² = (5x)² and 1 = (1)². Difference of squares: (5x-1)(5x+1) ✓' },

        // Block 4 — Difference of two squares, with coefficients (Medium/Hard)
        { difficulty: 'Medium', question: 'Factorise 49x² − 9.', checkMode: 'auto', options: ['(7x-3)²', '(49x-3)(49x+3)', '(7x-9)(7x+9)', '(7x-3)(7x+3)'], correctIndex: 3, explanation: '49x² = (7x)² and 9 = (3)². Difference of squares: (7x-3)(7x+3) ✓' },
        { difficulty: 'Hard', question: 'Factorise 9x² − 16y².', checkMode: 'auto', options: ['(3x-4y)(3x+4y)', '(3x-4y)²', '(9x-4y)(9x+4y)', '(3x-16y)(3x+16y)'], correctIndex: 0, explanation: '9x² = (3x)² and 16y² = (4y)². Difference of squares: (3x-4y)(3x+4y) ✓' },
        { difficulty: 'Hard', question: 'Mpho factorises 100x² − 121 and gets (10x − 11)(10x + 11). Which statement correctly evaluates his answer?', checkMode: 'auto', options: ['He is incorrect — the correct factorisation is (10x-11)².', 'He is correct — 100x² = (10x)² and 121 = (11)², so the difference of squares gives (10x-11)(10x+11).', 'He is incorrect — the correct factorisation is (100x-121)(x+1).', 'He is correct, but only by coincidence — the pattern does not generally apply to expressions like this.'], correctIndex: 1, explanation: '100x² = (10x)² and 121 = (11)² — both perfect squares, and the expression is a subtraction, so the difference-of-squares pattern applies: (10x-11)(10x+11) ✓' },

        // Block 5 — Trinomial x² + bx + c, positive/simple constant (Medium)
        { difficulty: 'Medium', question: 'Factorise x² + 8x + 15.', checkMode: 'auto', options: ['(x-3)(x-5)', '(x+3)(x-5)', '(x+3)(x+5)', '(x+1)(x+15)'], correctIndex: 2, explanation: 'Find two numbers multiplying to 15 and adding to 8: 3 and 5. Factorised: (x+3)(x+5) ✓' },
        { difficulty: 'Medium', question: 'Factorise x² + 12x + 35.', checkMode: 'auto', options: ['(x-5)(x-7)', '(x+5)(x-7)', '(x+1)(x+35)', '(x+5)(x+7)'], correctIndex: 3, explanation: 'Find two numbers multiplying to 35 and adding to 12: 5 and 7. Factorised: (x+5)(x+7) ✓' },
        { difficulty: 'Medium', question: 'Factorise x² − 8x + 15.', checkMode: 'auto', options: ['(x-3)(x-5)', '(x+3)(x+5)', '(x-3)(x+5)', '(x-1)(x-15)'], correctIndex: 0, explanation: 'Find two numbers multiplying to 15 and adding to -8: -3 and -5. Factorised: (x-3)(x-5) ✓' },

        // Block 6 — Trinomial x² + bx + c, negative constant (Medium/Hard)
        { difficulty: 'Medium-Hard', question: 'Factorise x² − 4x − 32.', checkMode: 'auto', options: ['(x+8)(x-4)', '(x-8)(x+4)', '(x-8)(x-4)', '(x+2)(x-16)'], correctIndex: 1, explanation: 'Find two numbers multiplying to -32 and adding to -4: -8 and 4. Factorised: (x-8)(x+4) ✓' },
        { difficulty: 'Medium-Hard', question: 'Factorise x² + 3x − 28.', checkMode: 'auto', options: ['(x-7)(x+4)', '(x+7)(x+4)', '(x+7)(x-4)', '(x+2)(x-14)'], correctIndex: 2, explanation: 'Find two numbers multiplying to -28 and adding to 3: 7 and -4. Factorised: (x+7)(x-4) ✓' },
        { difficulty: 'Hard', question: 'Factorise x² − 3x − 18.', checkMode: 'auto', options: ['(x+6)(x-3)', '(x-6)(x-3)', '(x+2)(x-9)', '(x-6)(x+3)'], correctIndex: 3, explanation: 'Find two numbers multiplying to -18 and adding to -3: -6 and 3. Factorised: (x-6)(x+3) ✓' },

        // Block 7 — Trinomial with common factor + error-spotting (Hard)
        { difficulty: 'Hard', question: 'Factorise 4x² + 20x + 24 fully.', checkMode: 'auto', options: ['4(x+2)(x+3)', '(x+2)(x+3)', '4(x+2)(x-3)', '4(x+1)(x+6)'], correctIndex: 0, explanation: 'Factor out 4: 4(x²+5x+6). Find two numbers multiplying to 6 and adding to 5: 2 and 3. Factorised: 4(x+2)(x+3) ✓' },
        { difficulty: 'Hard', question: 'Factorise 3x² − 6x − 45 fully.', checkMode: 'auto', options: ['(x-5)(x+3)', '3(x-5)(x+3)', '3(x+5)(x+3)', '3(x+1)(x-15)'], correctIndex: 1, explanation: 'Factor out 3: 3(x²-2x-15). Find two numbers multiplying to -15 and adding to -2: -5 and 3. Factorised: 3(x-5)(x+3) ✓' },
        { difficulty: 'Hard', question: 'Factorise 6x² − 24 fully.', checkMode: 'auto', options: ['6(x²-4)', '(x-2)(x+2)', '6(x-2)(x+2)', '6(x+2)(x+2)'], correctIndex: 2, explanation: 'Factor out the common factor 6: 6(x²-4). Recognise x²-4 as a difference of squares: 6(x-2)(x+2) ✓' },
        { difficulty: 'Hard', question: 'Thabo factorises x² − 7x − 18 and gets (x − 2)(x + 9). Which statement correctly evaluates his answer?', checkMode: 'auto', options: ['He is correct — (-2)(9) = -18 and -2 + 9 = -7, so the factorisation is valid.', 'He is incorrect — the correct factorisation is (x-18)(x+1).', 'He is correct, but the factors should be written in the opposite order: (x+9)(x-2).', 'He is incorrect — the correct factorisation is (x-9)(x+2), since (-9)(2) = -18 and -9 + 2 = -7.'], correctIndex: 3, explanation: 'Although (-2)(9) = -18 ✓, the sum -2 + 9 = 7, not -7. The correct pair is -9 and 2: (-9)(2) = -18 and -9+2 = -7. So the correct factorisation is (x-9)(x+2).' },
      ],
      scoreMessages: [
        { minScore: 20, message: 'Outstanding! You have mastered factorising common factors, differences of squares and trinomials.' },
        { minScore: 15, message: 'Great work! Review any missed questions on trinomials or difference of squares and try again.' },
