  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'Simplify 3x²y × 4xy².', checkMode: 'auto', options: ['12x³y³', '12x²y²', '7x³y³', '12x³y²'], correctIndex: 0, explanation: 'Multiply coefficients: 3 × 4 = 12. Add exponents of x: x² × x = x³. Add exponents of y: y × y² = y³. Answer: 12x³y³' },
        { difficulty: 'Easy', question: 'Simplify (−2a³b²)(5ab³).', checkMode: 'auto', options: ['10a⁴b⁵', '−10a⁴b⁵', '−10a³b⁶', '3a⁴b⁵'], correctIndex: 1, explanation: 'Multiply coefficients: −2 × 5 = −10. Add exponents of a: a³ × a = a⁴. Add exponents of b: b² × b³ = b⁵. Answer: −10a⁴b⁵' },
        { difficulty: 'Medium', question: 'Simplify 24x⁵y³ ÷ 6x²y.', checkMode: 'auto', options: ['4x³y³', '18x³y²', '4x³y²', '4x⁷y⁴'], correctIndex: 2, explanation: 'Divide coefficients: 24 ÷ 6 = 4. Subtract exponents of x: x⁵ ÷ x² = x³. Subtract exponents of y: y³ ÷ y = y². Answer: 4x³y²' },

        // Block 2 — Expanding a binomial × binomial (general FOIL) (Medium/Hard)
        { difficulty: 'Medium', question: 'Expand (x + 4)(x + 9).', checkMode: 'auto', options: ['x²+36', 'x²+9x+36', 'x²+13x+13', 'x²+13x+36'], correctIndex: 3, explanation: 'FOIL: First: x·x = x². Outer: x·9 = 9x. Inner: 4·x = 4x. Last: 4·9 = 36. Combine: x² + 9x + 4x + 36 = x² + 13x + 36' },
        { difficulty: 'Medium', question: 'Expand (2x − 3)(x + 7).', checkMode: 'auto', options: ['2x²+11x−21', '2x²+11x+21', '2x²-11x-21', '2x²+17x-21'], correctIndex: 0, explanation: 'FOIL: First: 2x·x = 2x². Outer: 2x·7 = 14x. Inner: −3·x = −3x. Last: −3·7 = −21. Combine: 2x² + 14x − 3x − 21 = 2x² + 11x − 21' },
        { difficulty: 'Hard', question: 'A rugby field extension is modelled by (3x + 2)(2x − 5) square metres, where x is measured in metres. Expand this expression fully.', checkMode: 'auto', options: ['6x²+11x-10', '6x²-11x-10', '6x²-11x+10', '6x²-19x-10'], correctIndex: 1, explanation: 'FOIL: First: 3x·2x = 6x². Outer: 3x·(−5) = −15x. Inner: 2·2x = 4x. Last: 2·(−5) = −10. Combine: 6x² − 15x + 4x − 10 = 6x² − 11x − 10' },
        { difficulty: 'Hard', question: 'Buhle expands (x − 6)(x − 8) and gets x² − 14x − 48. What is the correct expansion, and what mistake did she make?', checkMode: 'auto', options: ['x² − 14x − 48 (no mistake — her answer is correct)', 'x² + 14x + 48 — she made a sign error on the middle term', 'x² − 14x + 48 — she made a sign error on the last term', 'x² − 2x + 48 — she made an error combining like terms'], correctIndex: 2, explanation: 'FOIL: First: x·x = x². Outer: x·(−8) = −8x. Inner: −6·x = −6x. Last: (−6)(−8) = +48, since two negatives multiply to a positive. Combine: x² − 8x − 6x + 48 = x² − 14x + 48. Buhle made a sign error on the last term.' },

        // Block 3 — Square of a binomial and difference of two squares (Medium/Hard)
        { difficulty: 'Medium', question: 'Expand (x + 7)² using the special pattern.', checkMode: 'auto', options: ['x²+49', 'x²+7x+49', 'x²+14x+14', 'x²+14x+49'], correctIndex: 3, explanation: 'Use (a + b)² = a² + 2ab + b² with a = x, b = 7. x² + 2(x)(7) + 7² = x² + 14x + 49' },
        { difficulty: 'Medium', question: 'Expand (2x − 5)² using the special pattern.', checkMode: 'auto', options: ['4x²−20x+25', '4x²-25', '4x²-10x+25', '2x²-20x+25'], correctIndex: 0, explanation: 'Use (a − b)² = a² − 2ab + b² with a = 2x, b = 5. (2x)² − 2(2x)(5) + 5² = 4x² − 20x + 25' },
        { difficulty: 'Hard', question: 'A square courtyard has sides of length (x − 9) m, next to a second square courtyard with sides (x + 9) m. Expand (x − 9)(x + 9) to find the pattern connecting the two.', checkMode: 'auto', options: ['x²-18x-81', 'x²-81', 'x²+81', 'x²-9'], correctIndex: 1, explanation: 'This is the difference of two squares pattern: (a − b)(a + b) = a² − b². Here a = x, b = 9, so x² − 9² = x² − 81.' },
        { difficulty: 'Hard', question: 'Kagiso says (x + 4)(x − 4) and (x + 4)² are equal. Which pair of expansions shows he is wrong?', checkMode: 'auto', options: ['x² − 16 and x² − 16 — they are equal, Kagiso is correct', 'x² + 16 and x² + 8x + 16 — they differ by the constant term', 'x² − 16 and x² + 8x + 16 — they differ by the middle term 8x', 'x² − 8x + 16 and x² + 8x + 16 — they differ only in sign of the middle term'], correctIndex: 2, explanation: '(x + 4)(x − 4) is the difference of two squares: x² − 16. (x + 4)² is the square of a binomial: x² + 8x + 16. The two results differ by the middle term 8x, since the "+4, −4" pair cancels while squaring the same "+4" twice adds.' },

        // Block 4 — Substitution with negative/fractional values (Medium-Hard)
        { difficulty: 'Medium-Hard', question: 'Evaluate 2x² − 3x + 1 when x = −3.', checkMode: 'auto', options: ['-8', '10', '26', '28'], correctIndex: 3, explanation: 'Substitute x = −3: 2(−3)² − 3(−3) + 1. (−3)² = 9, so 2(9) = 18. Also −3(−3) = +9. 18 + 9 + 1 = 28' },
        { difficulty: 'Medium-Hard', question: 'Evaluate 3(x − 2)² when x = −1.', checkMode: 'auto', options: ['27', '-9', '3', '9'], correctIndex: 0, explanation: 'Substitute x = −1: 3(−1 − 2)² = 3(−3)². (−3)² = 9, so 3(9) = 27.' },
        { difficulty: 'Medium-Hard', question: 'Evaluate 4x² − 2y when x = ½ and y = −2.', checkMode: 'auto', options: ['-3', '5', '9', '1'], correctIndex: 1, explanation: 'Substitute x = ½, y = −2: 4(½)² − 2(−2). (½)² = ¼, so 4(¼) = 1. Also −2(−2) = +4. 1 + 4 = 5' },

        // Block 5 — Algebraic fractions requiring an LCD (Hard)
        { difficulty: 'Hard', question: 'Simplify x/2 + x/5 by writing both fractions with a common denominator.', checkMode: 'auto', options: ['x/7', '3x/10', '7x/10', '6x/10'], correctIndex: 2, explanation: 'The LCD of 2 and 5 is 10. x/2 = 5x/10 and x/5 = 2x/10. Add: 5x/10 + 2x/10 = 7x/10' },
        { difficulty: 'Hard', question: 'Simplify 2/x + 3/x² by writing both fractions with a common denominator.', checkMode: 'auto', options: ['5/x²', '5/x³', '(2x+3)/x', '(2x+3)/x²'], correctIndex: 3, explanation: 'The LCD of x and x² is x². 2/x = 2x/x² and 3/x² stays as 3/x². Add: 2x/x² + 3/x² = (2x + 3)/x²' },
        { difficulty: 'Hard', question: 'Simplify 5/(2x) − 1/(3x) by writing both fractions with a common denominator.', checkMode: 'auto', options: ['13/(6x)', '4/(6x)', '4/x', '17/(6x)'], correctIndex: 0, explanation: 'The LCD of 2x and 3x is 6x. 5/(2x) = 15/(6x) and 1/(3x) = 2/(6x). Subtract: 15/(6x) − 2/(6x) = 13/(6x)' },

        // Block 6 — Multi-step simplification / error-spotting (Hard)
        { difficulty: 'Hard', question: 'Expand and simplify (x + 3)(x + 2) + 2x.', checkMode: 'auto', options: ['x²+5x+6', 'x²+7x+6', 'x²+9x+8', 'x²+7x+8'], correctIndex: 1, explanation: 'Expand first: (x + 3)(x + 2) = x² + 2x + 3x + 6 = x² + 5x + 6. Add the remaining term: x² + 5x + 6 + 2x. Combine like terms: 5x + 2x = 7x. Answer: x² + 7x + 6' },
        { difficulty: 'Hard', question: 'A student claims (x + 6)² = x² + 36. What is the correct expansion, and what did the student forget?', checkMode: 'auto', options: ['x² + 36 — the student is correct', 'x² + 12x + 36 — the student forgot to add the exponents', 'x² + 12x + 36 — the student forgot the middle term 2ab', 'x² + 6x + 36 — the student used a instead of 2a for the middle term'], correctIndex: 2, explanation: 'Squaring a binomial always gives a trinomial: (x + 6)² = x² + 2(x)(6) + 6² = x² + 12x + 36, not x² + 36. The student forgot the middle term 2ab.' },
        { difficulty: 'Hard', question: 'Evaluate (x + 3)(x − 2) when x = −1.', checkMode: 'auto', options: ['6', '-2', '4', '-6'], correctIndex: 3, explanation: 'Substituting directly: (−1 + 3)(−1 − 2) = (2)(−3) = −6. Checking by expanding first: (x + 3)(x − 2) = x² + x − 6, then substituting x = −1: 1 − 1 − 6 = −6. Both methods give −6.' },
      ],
      scoreMessages: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // Block 1 — Simplifying with more complex exponent laws (Easy)
        { difficulty: 'Easy', question: 'Simplify 4x²y × 3xy³.', checkMode: 'auto', options: ['12x³y⁴', '12x²y³', '7x³y⁴', '12x³y³'], correctIndex: 0, explanation: 'Multiply coefficients: 4 × 3 = 12. Add exponents of x: x² × x = x³. Add exponents of y: y × y³ = y⁴. Answer: 12x³y⁴' },
        { difficulty: 'Easy', question: 'Simplify (−3a²b⁴)(4a³b).', checkMode: 'auto', options: ['12a⁵b⁵', '−12a⁵b⁵', '−12a⁶b⁴', '1a⁵b⁵'], correctIndex: 1, explanation: 'Multiply coefficients: −3 × 4 = −12. Add exponents of a: a² × a³ = a⁵. Add exponents of b: b⁴ × b = b⁵. Answer: −12a⁵b⁵' },
        { difficulty: 'Medium', question: 'Simplify 30x⁶y² ÷ 5x³y.', checkMode: 'auto', options: ['6x³y²', '25x³y', '6x³y', '6x⁹y³'], correctIndex: 2, explanation: 'Divide coefficients: 30 ÷ 5 = 6. Subtract exponents of x: x⁶ ÷ x³ = x³. Subtract exponents of y: y² ÷ y = y. Answer: 6x³y' },

        // Block 2 — Expanding a binomial × binomial (general FOIL) (Medium/Hard)
        { difficulty: 'Medium', question: 'Expand (x + 5)(x + 7).', checkMode: 'auto', options: ['x²+35', 'x²+7x+35', 'x²+12x+12', 'x²+12x+35'], correctIndex: 3, explanation: 'FOIL: First: x·x = x². Outer: x·7 = 7x. Inner: 5·x = 5x. Last: 5·7 = 35. Combine: x² + 7x + 5x + 35 = x² + 12x + 35' },
        { difficulty: 'Medium', question: 'Expand (3x − 2)(x + 4).', checkMode: 'auto', options: ['3x²+10x−8', '3x²+10x+8', '3x²-10x-8', '3x²+14x-8'], correctIndex: 0, explanation: 'FOIL: First: 3x·x = 3x². Outer: 3x·4 = 12x. Inner: −2·x = −2x. Last: −2·4 = −8. Combine: 3x² + 12x − 2x − 8 = 3x² + 10x − 8' },
        { difficulty: 'Hard', question: 'A vegetable patch extension is modelled by (2x + 5)(3x − 4) square metres, where x is measured in metres. Expand this expression fully.', checkMode: 'auto', options: ['6x²-7x-20', '6x²+7x−20', '6x²+7x+20', '6x²-23x-20'], correctIndex: 1, explanation: 'FOIL: First: 2x·3x = 6x². Outer: 2x·(−4) = −8x. Inner: 5·3x = 15x. Last: 5·(−4) = −20. Combine: 6x² − 8x + 15x − 20 = 6x² + 7x − 20' },
        { difficulty: 'Hard', question: 'Sibusiso expands (x − 7)(x − 9) and gets x² − 16x − 63. What is the correct expansion, and what mistake did he make?', checkMode: 'auto', options: ['x² − 16x − 63 (no mistake — his answer is correct)', 'x² + 16x + 63 — he made a sign error on the middle term', 'x² − 16x + 63 — he made a sign error on the last term', 'x² − 2x + 63 — he made an error combining like terms'], correctIndex: 2, explanation: 'FOIL: First: x·x = x². Outer: x·(−9) = −9x. Inner: −7·x = −7x. Last: (−7)(−9) = +63, since two negatives multiply to a positive. Combine: x² − 9x − 7x + 63 = x² − 16x + 63. Sibusiso made a sign error on the last term.' },

        // Block 3 — Square of a binomial and difference of two squares (Medium/Hard)
        { difficulty: 'Medium', question: 'Expand (x + 8)² using the special pattern.', checkMode: 'auto', options: ['x²+64', 'x²+8x+64', 'x²+16x+16', 'x²+16x+64'], correctIndex: 3, explanation: 'Use (a + b)² = a² + 2ab + b² with a = x, b = 8. x² + 2(x)(8) + 8² = x² + 16x + 64' },
        { difficulty: 'Medium', question: 'Expand (3x − 4)² using the special pattern.', checkMode: 'auto', options: ['9x²−24x+16', '9x²-16', '9x²-12x+16', '3x²-24x+16'], correctIndex: 0, explanation: 'Use (a − b)² = a² − 2ab + b² with a = 3x, b = 4. (3x)² − 2(3x)(4) + 4² = 9x² − 24x + 16. The last term stays positive since (−4)² = +16.' },
        { difficulty: 'Hard', question: 'A square field has sides of length (x − 10) m, next to a second square field with sides (x + 10) m. Expand (x − 10)(x + 10) to find the pattern connecting the two.', checkMode: 'auto', options: ['x²-20x-100', 'x²-100', 'x²+100', 'x²-10'], correctIndex: 1, explanation: 'This is the difference of two squares pattern: (a − b)(a + b) = a² − b². Here a = x, b = 10, so x² − 10² = x² − 100.' },
        { difficulty: 'Hard', question: 'Naledi says (x + 5)(x − 5) and (x + 5)² are equal. Which pair of expansions shows she is wrong?', checkMode: 'auto', options: ['x² − 25 and x² − 25 — they are equal, Naledi is correct', 'x² + 25 and x² + 10x + 25 — they differ by the constant term', 'x² − 25 and x² + 10x + 25 — they differ by the middle term 10x', 'x² − 10x + 25 and x² + 10x + 25 — they differ only in sign of the middle term'], correctIndex: 2, explanation: '(x + 5)(x − 5) is the difference of two squares: x² − 25. (x + 5)² is the square of a binomial: x² + 10x + 25. The two results differ by the middle term 10x, since the "+5, −5" pair cancels while squaring the same "+5" twice adds.' },

        // Block 4 — Substitution with negative/fractional values (Medium-Hard)
        { difficulty: 'Medium-Hard', question: 'Evaluate 2x² − 5x + 3 when x = −4.', checkMode: 'auto', options: ['15', '-9', '58', '55'], correctIndex: 3, explanation: 'Substitute x = −4: 2(−4)² − 5(−4) + 3. (−4)² = 16, so 2(16) = 32. Also −5(−4) = +20. 32 + 20 + 3 = 55' },
        { difficulty: 'Medium-Hard', question: 'Evaluate 2(x − 3)² when x = −2.', checkMode: 'auto', options: ['50', '-10', '2', '25'], correctIndex: 0, explanation: 'Substitute x = −2: 2(−2 − 3)² = 2(−5)². (−5)² = 25, so 2(25) = 50.' },
        { difficulty: 'Medium-Hard', question: 'Evaluate 9x² − 3y when x = ⅓ and y = −3.', checkMode: 'auto', options: ['-8', '10', '18', '12'], correctIndex: 1, explanation: 'Substitute x = ⅓, y = −3: 9(⅓)² − 3(−3). (⅓)² = 1/9, so 9(1/9) = 1. Also −3(−3) = +9. 1 + 9 = 10' },

        // Block 5 — Algebraic fractions requiring an LCD (Hard)
        { difficulty: 'Hard', question: 'Simplify x/3 + x/4 by writing both fractions with a common denominator.', checkMode: 'auto', options: ['x/7', '4x/12', '7x/12', '6x/12'], correctIndex: 2, explanation: 'The LCD of 3 and 4 is 12. x/3 = 4x/12 and x/4 = 3x/12. Add: 4x/12 + 3x/12 = 7x/12' },
        { difficulty: 'Hard', question: 'Simplify 5/x + 2/x² by writing both fractions with a common denominator.', checkMode: 'auto', options: ['7/x²', '7/x³', '(5x+2)/x', '(5x+2)/x²'], correctIndex: 3, explanation: 'The LCD of x and x² is x². 5/x = 5x/x² and 2/x² stays as 2/x². Add: 5x/x² + 2/x² = (5x + 2)/x²' },
        { difficulty: 'Hard', question: 'Simplify 3/(2x) − 1/(4x) by writing both fractions with a common denominator.', checkMode: 'auto', options: ['5/(4x)', '2/(4x)', '2/x', '7/(4x)'], correctIndex: 0, explanation: 'The LCD of 2x and 4x is 4x. 3/(2x) = 6/(4x) and 1/(4x) stays as 1/(4x). Subtract: 6/(4x) − 1/(4x) = 5/(4x)' },

        // Block 6 — Multi-step simplification / error-spotting (Hard)
        { difficulty: 'Hard', question: 'Expand and simplify (x + 4)(x + 1) + 3x.', checkMode: 'auto', options: ['x²+5x+4', 'x²+8x+4', 'x²+11x+7', 'x²+8x+7'], correctIndex: 1, explanation: 'Expand first: (x + 4)(x + 1) = x² + x + 4x + 4 = x² + 5x + 4. Add the remaining term: x² + 5x + 4 + 3x. Combine like terms: 5x + 3x = 8x. Answer: x² + 8x + 4' },
        { difficulty: 'Hard', question: 'A student claims (x − 5)² = x² − 25. What is the correct expansion, and what did the student forget?', checkMode: 'auto', options: ['x² − 25 — the student is correct', 'x² − 10x − 25 — the student forgot to add the exponents', 'x² − 10x + 25 — the student forgot the middle term 2ab', 'x² − 5x + 25 — the student used a instead of 2a for the middle term'], correctIndex: 2, explanation: 'Squaring a binomial always gives a trinomial: (x − 5)² = x² − 2(x)(5) + 5² = x² − 10x + 25, not x² − 25. The student forgot the middle term 2ab.' },
        { difficulty: 'Hard', question: 'Evaluate (x + 5)(x − 3) when x = −2.', checkMode: 'auto', options: ['15', '-8', '7', '-15'], correctIndex: 3, explanation: 'Substituting directly: (−2 + 5)(−2 − 3) = (3)(−5) = −15. Checking by expanding first: (x + 5)(x − 3) = x² + 2x − 15, then substituting x = −2: 4 − 4 − 15 = −15. Both methods give −15.' },
      ],
      scoreMessages: [
        { minScore: 20, message: 'Outstanding! You have mastered simplifying, expanding and substituting into algebraic expressions.' },
        { minScore: 15, message: 'Great work! Review any missed questions on binomial products or algebraic fractions and try again.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // Block 1 — Simplifying with more complex exponent laws (Easy)
        { difficulty: 'Easy', question: 'Simplify 5x²y × 2xy³.', checkMode: 'auto', options: ['10x³y⁴', '10x²y³', '7x³y⁴', '10x³y³'], correctIndex: 0, explanation: 'Multiply coefficients: 5 × 2 = 10. Add exponents of x: x² × x = x³. Add exponents of y: y × y³ = y⁴. Answer: 10x³y⁴' },
        { difficulty: 'Easy', question: 'Simplify (−4a³b)(3a²b⁴).', checkMode: 'auto', options: ['12a⁵b⁵', '−12a⁵b⁵', '−12a⁶b⁴', '−1a⁵b⁵'], correctIndex: 1, explanation: 'Multiply coefficients: −4 × 3 = −12. Add exponents of a: a³ × a² = a⁵. Add exponents of b: b × b⁴ = b⁵. Answer: −12a⁵b⁵' },
        { difficulty: 'Medium', question: 'Simplify 36x⁵y⁴ ÷ 9x²y².', checkMode: 'auto', options: ['27x³y²', '4x³y⁶', '4x³y²', '4x⁷y⁶'], correctIndex: 2, explanation: 'Divide coefficients: 36 ÷ 9 = 4. Subtract exponents of x: x⁵ ÷ x² = x³. Subtract exponents of y: y⁴ ÷ y² = y². Answer: 4x³y²' },

        // Block 2 — Expanding a binomial × binomial (general FOIL) (Medium/Hard)
        { difficulty: 'Medium', question: 'Expand (x + 6)(x + 8).', checkMode: 'auto', options: ['x²+48', 'x²+8x+48', 'x²+14x+14', 'x²+14x+48'], correctIndex: 3, explanation: 'FOIL: First: x·x = x². Outer: x·8 = 8x. Inner: 6·x = 6x. Last: 6·8 = 48. Combine: x² + 8x + 6x + 48 = x² + 14x + 48' },
        { difficulty: 'Medium', question: 'Expand (4x − 1)(x + 5).', checkMode: 'auto', options: ['4x²+19x−5', '4x²+19x+5', '4x²-19x-5', '4x²+21x-5'], correctIndex: 0, explanation: 'FOIL: First: 4x·x = 4x². Outer: 4x·5 = 20x. Inner: −1·x = −x. Last: −1·5 = −5. Combine: 4x² + 20x − x − 5 = 4x² + 19x − 5' },
        { difficulty: 'Hard', question: 'A community hall extension is modelled by (2x + 3)(3x − 7) square metres, where x is measured in metres. Expand this expression fully.', checkMode: 'auto', options: ['6x²+5x-21', '6x²−5x−21', '6x²-5x+21', '6x²-23x-21'], correctIndex: 1, explanation: 'FOIL: First: 2x·3x = 6x². Outer: 2x·(−7) = −14x. Inner: 3·3x = 9x. Last: 3·(−7) = −21. Combine: 6x² − 14x + 9x − 21 = 6x² − 5x − 21' },
        { difficulty: 'Hard', question: 'Zanele expands (x − 5)(x − 11) and gets x² − 16x − 55. What is the correct expansion, and what mistake did she make?', checkMode: 'auto', options: ['x² − 16x − 55 (no mistake — her answer is correct)', 'x² + 16x + 55 — she made a sign error on the middle term', 'x² − 16x + 55 — she made a sign error on the last term', 'x² − 6x + 55 — she made an error combining like terms'], correctIndex: 2, explanation: 'FOIL: First: x·x = x². Outer: x·(−11) = −11x. Inner: −5·x = −5x. Last: (−5)(−11) = +55, since two negatives multiply to a positive. Combine: x² − 11x − 5x + 55 = x² − 16x + 55. Zanele made a sign error on the last term.' },

        // Block 3 — Square of a binomial and difference of two squares (Medium/Hard)
        { difficulty: 'Medium', question: 'Expand (x + 9)² using the special pattern.', checkMode: 'auto', options: ['x²+81', 'x²+9x+81', 'x²+18x+18', 'x²+18x+81'], correctIndex: 3, explanation: 'Use (a + b)² = a² + 2ab + b² with a = x, b = 9. x² + 2(x)(9) + 9² = x² + 18x + 81' },
        { difficulty: 'Medium', question: 'Expand (2x − 7)² using the special pattern.', checkMode: 'auto', options: ['4x²−28x+49', '4x²-49', '4x²-14x+49', '2x²-28x+49'], correctIndex: 0, explanation: 'Use (a − b)² = a² − 2ab + b² with a = 2x, b = 7. (2x)² − 2(2x)(7) + 7² = 4x² − 28x + 49' },
        { difficulty: 'Hard', question: 'A square plot has sides of length (x − 6) m, next to a second square plot with sides (x + 6) m. Expand (x − 6)(x + 6) to find the pattern connecting the two.', checkMode: 'auto', options: ['x²-12x-36', 'x²-36', 'x²+36', 'x²-6'], correctIndex: 1, explanation: 'This is the difference of two squares pattern: (a − b)(a + b) = a² − b². Here a = x, b = 6, so x² − 6² = x² − 36.' },
        { difficulty: 'Hard', question: 'Bongani says (x + 3)(x − 3) and (x + 3)² are equal. Which pair of expansions shows he is wrong?', checkMode: 'auto', options: ['x² − 9 and x² − 9 — they are equal, Bongani is correct', 'x² + 9 and x² + 6x + 9 — they differ by the constant term', 'x² − 9 and x² + 6x + 9 — they differ by the middle term 6x', 'x² − 6x + 9 and x² + 6x + 9 — they differ only in sign of the middle term'], correctIndex: 2, explanation: '(x + 3)(x − 3) is the difference of two squares: x² − 9. (x + 3)² is the square of a binomial: x² + 6x + 9. The two results differ by the middle term 6x, since the "+3, −3" pair cancels while squaring the same "+3" twice adds.' },

        // Block 4 — Substitution with negative/fractional values (Medium-Hard)
        { difficulty: 'Medium-Hard', question: 'Evaluate 3x² − 4x + 2 when x = −2.', checkMode: 'auto', options: ['6', '-2', '25', '22'], correctIndex: 3, explanation: 'Substitute x = −2: 3(−2)² − 4(−2) + 2. (−2)² = 4, so 3(4) = 12. Also −4(−2) = +8. 12 + 8 + 2 = 22' },
        { difficulty: 'Medium-Hard', question: 'Evaluate 4(x − 1)² when x = −1.', checkMode: 'auto', options: ['16', '-8', '0', '4'], correctIndex: 0, explanation: 'Substitute x = −1: 4(−1 − 1)² = 4(−2)². (−2)² = 4, so 4(4) = 16.' },
        { difficulty: 'Medium-Hard', question: 'Evaluate 4x² − 3y when x = ½ and y = −3.', checkMode: 'auto', options: ['-8', '10', '11', '13'], correctIndex: 1, explanation: 'Substitute x = ½, y = −3: 4(½)² − 3(−3). (½)² = ¼, so 4(¼) = 1. Also −3(−3) = +9. 1 + 9 = 10' },

        // Block 5 — Algebraic fractions requiring an LCD (Hard)
        { difficulty: 'Hard', question: 'Simplify x/2 + x/3 by writing both fractions with a common denominator.', checkMode: 'auto', options: ['x/5', '4x/6', '5x/6', '6x/6'], correctIndex: 2, explanation: 'The LCD of 2 and 3 is 6. x/2 = 3x/6 and x/3 = 2x/6. Add: 3x/6 + 2x/6 = 5x/6' },
        { difficulty: 'Hard', question: 'Simplify 3/x + 4/x² by writing both fractions with a common denominator.', checkMode: 'auto', options: ['7/x²', '7/x³', '(3x+4)/x', '(3x+4)/x²'], correctIndex: 3, explanation: 'The LCD of x and x² is x². 3/x = 3x/x² and 4/x² stays as 4/x². Add: 3x/x² + 4/x² = (3x + 4)/x²' },
        { difficulty: 'Hard', question: 'Simplify 7/(3x) − 1/(6x) by writing both fractions with a common denominator.', checkMode: 'auto', options: ['13/(6x)', '6/(6x)', '6/x', '15/(6x)'], correctIndex: 0, explanation: 'The LCD of 3x and 6x is 6x. 7/(3x) = 14/(6x) and 1/(6x) stays as 1/(6x). Subtract: 14/(6x) − 1/(6x) = 13/(6x)' },

        // Block 6 — Multi-step simplification / error-spotting (Hard)
        { difficulty: 'Hard', question: 'Expand and simplify (x + 2)(x + 5) + 4x.', checkMode: 'auto', options: ['x²+7x+10', 'x²+11x+10', 'x²+15x+14', 'x²+11x+14'], correctIndex: 1, explanation: 'Expand first: (x + 2)(x + 5) = x² + 5x + 2x + 10 = x² + 7x + 10. Add the remaining term: x² + 7x + 10 + 4x. Combine like terms: 7x + 4x = 11x. Answer: x² + 11x + 10' },
        { difficulty: 'Hard', question: 'A student claims (x − 4)² = x² − 16. What is the correct expansion, and what did the student forget?', checkMode: 'auto', options: ['x² − 16 — the student is correct', 'x² − 8x − 16 — the student forgot to add the exponents', 'x² − 8x + 16 — the student forgot the middle term 2ab', 'x² − 4x + 16 — the student used a instead of 2a for the middle term'], correctIndex: 2, explanation: 'Squaring a binomial always gives a trinomial: (x − 4)² = x² − 2(x)(4) + 4² = x² − 8x + 16, not x² − 16. The student forgot the middle term 2ab.' },
        { difficulty: 'Hard', question: 'Evaluate (x + 4)(x − 1) when x = −3.', checkMode: 'auto', options: ['4', '-7', '2', '-4'], correctIndex: 3, explanation: 'Substituting directly: (−3 + 4)(−3 − 1) = (1)(−4) = −4. Checking by expanding first: (x + 4)(x − 1) = x² + 3x − 4, then substituting x = −3: 9 − 9 − 4 = −4. Both methods give −4.' },
      ],
      scoreMessages: [
        { minScore: 20, message: 'Outstanding! You have mastered simplifying, expanding and substituting into algebraic expressions.' },
        { minScore: 15, message: 'Great work! Review any missed questions on binomial products or algebraic fractions and try again.' },
