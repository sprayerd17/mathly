...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      explanation:
        ...
        `<p style="margin:0;color:#1e3a8a;">P(gebeurtenis) = ${or('aantal gunstige uitkomste')} ÷ totale aantal uitkomste. Die tweerigting-tabel maak dit maklik om albei hierdie waardes direk af te lees.</p>` +
        `</div>`,
      ...
      workedExamples: [
        {
          ...
          answer: `P(kop EN >4) = ${or('2')} ÷ 12 = ${or('1/6')}`,
          steps: [
            ...
            `P(kop EN >4) = ${or('2')} ÷ 12 = <strong>1/6</strong>.`,
        ...
        },
        {
          ...
          answer: `P(vroulik EN Wiskunde) = ${or('6')} ÷ 30 = ${or('1/5')}`,
          steps: [
            ...
            `P(vroulik EN Wiskunde) = ${or('6')} ÷ 30 = <strong>1/5</strong>.`,
          ],
        },
      ],
      ...
      workedExamples: [
        {
          ...
          answer: `P(kop albei kere) = ${or('1/2 × 1/2')} = ${or('1/4')}`,
          steps: [
        ...
        },
        {
          ...
          answer: `P(rooi albei kere) = ${or('3/5 × 3/5')} = ${or('9/25')}`,
          steps: [
            `${bl('Eerste tak:')} P(rooi) = ${bl('3/5')}, P(blou) = ${bl('2/5')}. (3 rooi uit 5 in totaal.)`,
            `${gr('Tweede tak:')} Aangesien die bal teruggesit word, is die waarskynlikhede dieselfde as voorheen. P(rooi) = ${gr('3/5')}, P(blou) = ${gr('2/5')}.`,
  ...
  topicPractice: [
    ...
    // ── Q4 Easy ─────────────────────────────────────────────────────────────
    {
      ...
      checkMode: 'auto',
      correctAnswer: '1/4',
      explanation: 'P(stert eerste) = 1/2. P(stert tweede) = 1/2. Gekombineerd: 1/2 × 1/2 = 1/4.',
    },
    ...
    // ── Q5 Medium ────────────────────────────────────────────────────────────
    {
      ...
      checkMode: 'auto',
      correctAnswer: '9/25',
      explanation: 'P(blou) = 6/10 = 3/5. Aangesien dit teruggesit word, is P(blou weer) = 3/5. Gekombineerd: 3/5 × 3/5 = 9/25.',
    },
    ...
    // ── Q7 Medium ────────────────────────────────────────────────────────────
    {
      ...
      checkMode: 'auto',
      correctAnswer: '1/16',
      explanation: 'P(2 op eerste draai) = 1/4. P(2 op tweede draai) = 1/4. Gekombineerd: 1/4 × 1/4 = 1/16.',
    },
    ...
    // ── Q10 Hard ─────────────────────────────────────────────────────────────
    {
      ...
      answer: 'Verwag = 60 × 1/2 = 30 (aangesien P(kop-stert of stert-kop) = 1/2). Om 27 te kry is naby, wat normale variasie van beperkte proewe wys.',
      checkMode: 'self',
    },
    ...
    // ── Q11 Medium ───────────────────────────────────────────────────────────
    {
      ...
      checkMode: 'auto',
      correctAnswer: '15/32',
      explanation: 'P(groen dan geel) = 5/8 × 3/8 = 15/64. P(geel dan groen) = 3/8 × 5/8 = 15/64. Gekombineerd (enige volgorde) = 15/64 + 15/64 = 30/64 = 15/32.',
    },
    ...
    // ── Q12 Hard ─────────────────────────────────────────────────────────────
    {
      ...
      answer: 'P(rooi eerste) = 3/5. P(rooi tweede, sonder vervanging) = 2/4 = 1/2. Gekombineerd: 3/5 × 1/2 = 3/10.',
      checkMode: 'self',
    },
    ...
    // ── Q15 Hard ─────────────────────────────────────────────────────────────
    {
      ...
      answer: 'P(rooi dan blou) = 4/10 × 6/9 = 24/90. P(blou dan rooi) = 6/10 × 4/9 = 24/90. Gekombineerd (enige volgorde) = 24/90 + 24/90 = 48/90 = 8/15.',
      checkMode: 'self',
    },
  ],
  ...
  // Blok 3 (6-9):   Komplementêre gebeurtenisse P(nie A) = 1 − P(A)
  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'ʼn Dobbelsteen word 60 keer gegooi. Gebaseer op teoretiese waarskynlikheid, hoeveel keer sou jy voorspel dat die dobbelsteen ʼn 3 sal wys?', checkMode: 'auto', correctAnswer: '10', answer: '10', explanation: 'P(3) = 1/6. Voorspelde frekwensie = 1/6 × 60 = 10.' },
        ...
        { difficulty: 'Hard', question: 'ʼn Venn-diagram wys 30 leerders: 12 studeer net Wiskunde, 8 studeer net Wetenskap, 6 studeer beide Wiskunde en Wetenskap, en 4 studeer geen van die twee nie. Vind P(ʼn leerder studeer beide Wiskunde en Wetenskap).', checkMode: 'auto', correctAnswer: '1/5', correctAnswers: ['1/5', '6/30'], answer: '1/5', explanation: 'Totale leerders = 30. Gunstig (beide) = 6. P(beide) = 6/30 = 1/5.' , diagramSvg: '<svg viewBox="0 0 300 210" xmlns="http://www.w3.org/2000/svg"><rect x="15" y="20" width="270" height="160" fill="none" stroke="#0f1f3d" stroke-width="2"/><circle cx="115" cy="100" r="70" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><circle cx="185" cy="100" r="70" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="75" y="35" font-size="13" fill="#0f1f3d" font-weight="700" text-anchor="middle">Wiskunde</text><text x="225" y="35" font-size="13" fill="#0f1f3d" font-weight="700" text-anchor="middle">Wetenskap</text><text x="85" y="105" font-size="16" fill="#2563eb" font-weight="700" text-anchor="middle">12</text><text x="150" y="105" font-size="16" fill="#2563eb" font-weight="700" text-anchor="middle">6</text><text x="215" y="105" font-size="16" fill="#2563eb" font-weight="700" text-anchor="middle">8</text><text x="30" y="35" font-size="16" fill="#2563eb" font-weight="700" text-anchor="middle">4</text></svg>' },
        { difficulty: 'Hard', question: 'ʼn Venn-diagram wys 30 leerders: 12 studeer net Wiskunde, 8 studeer net Wetenskap, 6 studeer beide, en 4 studeer geen van die twee nie. Vind P(ʼn leerder studeer Wiskunde of Wetenskap, of beide).', checkMode: 'auto', correctAnswer: '13/15', correctAnswers: ['13/15', '26/30'], answer: '13/15', explanation: 'Wiskunde of Wetenskap (of beide) = net Wiskunde + net Wetenskap + beide = 12 + 8 + 6 = 26. W = 26/30 = 13/15.' , diagramSvg: '<svg viewBox="0 0 300 210" xmlns="http://www.w3.org/2000/svg"><rect x="15" y="20" width="270" height="160" fill="none" stroke="#0f1f3d" stroke-width="2"/><circle cx="115" cy="100" r="70" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><circle cx="185" cy="100" r="70" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="75" y="35" font-size="13" fill="#0f1f3d" font-weight="700" text-anchor="middle">Wiskunde</text><text x="225" y="35" font-size="13" fill="#0f1f3d" font-weight="700" text-anchor="middle">Wetenskap</text><text x="85" y="105" font-size="16" fill="#2563eb" font-weight="700" text-anchor="middle">12</text><text x="150" y="105" font-size="16" fill="#2563eb" font-weight="700" text-anchor="middle">6</text><text x="215" y="105" font-size="16" fill="#2563eb" font-weight="700" text-anchor="middle">8</text><text x="30" y="35" font-size="16" fill="#2563eb" font-weight="700" text-anchor="middle">4</text></svg>' },
        { difficulty: 'Hard', question: 'ʼn Venn-diagram wys 40 mense: 15 besit net ʼn motor, 10 besit net ʼn fiets, 9 besit beide, en 6 besit geen van die twee nie. Vind P(ʼn persoon besit presies een van die twee, motor of fiets).', checkMode: 'auto', correctAnswer: '5/8', correctAnswers: ['5/8', '25/40'], answer: '5/8', explanation: 'Presies een = net motor + net fiets = 15 + 10 = 25. W = 25/40 = 5/8.' , diagramSvg: '<svg viewBox="0 0 300 210" xmlns="http://www.w3.org/2000/svg"><rect x="15" y="20" width="270" height="160" fill="none" stroke="#0f1f3d" stroke-width="2"/><circle cx="115" cy="100" r="70" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><circle cx="185" cy="100" r="70" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="75" y="35" font-size="13" fill="#0f1f3d" font-weight="700" text-anchor="middle">Motor</text><text x="225" y="35" font-size="13" fill="#0f1f3d" font-weight="700" text-anchor="middle">Fiets</text><text x="85" y="105" font-size="16" fill="#2563eb" font-weight="700" text-anchor="middle">15</text><text x="150" y="105" font-size="16" fill="#2563eb" font-weight="700" text-anchor="middle">9</text><text x="215" y="105" font-size="16" fill="#2563eb" font-weight="700" text-anchor="middle">10</text><text x="30" y="35" font-size="16" fill="#2563eb" font-weight="700" text-anchor="middle">6</text></svg>' },
        { difficulty: 'Hard', question: 'Amahle se Venn-diagram wys 50 kopers: 20 koop net vrugte, 14 koop net groente, 10 koop beide, en 6 koop geeneen nie. Sy beweer P(koop geeneen) = 6/44 omdat 44 kopers wel iets gekoop het. Verduidelik haar fout en gee die korrekte waarskynlikheid.', answer: 'Sy het die verkeerde totaal gebruik. Die waarskynlikheid moet altyd met die totale steekproefgrootte (al 50 kopers) bereken word, nie net dié wat iets gekoop het nie. P(koop geeneen) = 6/50 = 3/25, nie 6/44 nie.', checkMode: 'self' , diagramSvg: '<svg viewBox="0 0 300 210" xmlns="http://www.w3.org/2000/svg"><rect x="15" y="20" width="270" height="160" fill="none" stroke="#0f1f3d" stroke-width="2"/><circle cx="115" cy="100" r="70" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><circle cx="185" cy="100" r="70" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="75" y="35" font-size="13" fill="#0f1f3d" font-weight="700" text-anchor="middle">Vrugte</text><text x="225" y="35" font-size="13" fill="#0f1f3d" font-weight="700" text-anchor="middle">Groente</text><text x="85" y="105" font-size="16" fill="#2563eb" font-weight="700" text-anchor="middle">20</text><text x="150" y="105" font-size="16" fill="#2563eb" font-weight="700" text-anchor="middle">10</text><text x="215" y="105" font-size="16" fill="#2563eb" font-weight="700" text-anchor="middle">14</text><text x="30" y="35" font-size="16" fill="#2563eb" font-weight="700" text-anchor="middle">6</text></svg>' },

        // Blok 6 — Gekombineerde multi-stap waarskynlikheid (Hard)
        { difficulty: 'Hard', question: 'ʼn Houer het 8 penne: 5 blou en 3 swart. Thabo kies ʼn pen, hou dit, en kies dan ʼn tweede pen. Vind P(albei penne is blou).', checkMode: 'auto', correctAnswer: '5/14', answer: '5/14', explanation: 'P(blou eerste) = 5/8. Sonder vervanging, P(blou tweede) = 4/7. Gekombineerd: 5/8 × 4/7 = 20/56 = 5/14.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // Blok 1 — Relatiewe frekwensie (Easy)
        { difficulty: 'Easy', question: 'ʼn Dobbelsteen word 90 keer gegooi. Gebaseer op teoretiese waarskynlikheid, hoeveel keer sou jy voorspel dat die dobbelsteen ʼn 6 sal wys?', checkMode: 'auto', correctAnswer: '15', answer: '15', explanation: 'P(6) = 1/6. Voorspelde frekwensie = 1/6 × 90 = 15.' },
        ...
        { difficulty: 'Easy', question: 'Bongani voorspel dat om ʼn dobbelsteen 90 keer te gooi ongeveer 15 keer ʼn 2 behoort te gee (aangesien P(2) = 1/6). Hy kry werklik 19. Verduidelik die verskil.', answer: 'Verwag = 90 × 1/6 = 15. Om 19 te kry is heelwat hoër as verwag, maar met ʼn beperkte aantal proewe kan hierdie soort variasie natuurlik voorkom weens toevalligheid. Meer worpe sal die resultaat waarskynlik nader aan 15 bring.', checkMode: 'self' },

        // Blok 2 — Enkelgebeurtenis-waarskynlikheid uit ʼn sak/wieletjie (Easy-Medium) [DIAGRAM LATER]
        { difficulty: 'Easy-Medium', question: 'ʼn Sak bevat 4 rooi fiches, 6 blou fiches en 2 groen fiches. Een fiche word lukraak getrek. Vind P(groen).', checkMode: 'auto', correctAnswer: '1/6', correctAnswers: ['1/6', '2/12'], answer: '1/6', explanation: 'Totale fiches = 4 + 6 + 2 = 12. P(groen) = 2/12 = 1/6.' , diagramSvg: '<svg viewBox="0 0 280 210" xmlns="http://www.w3.org/2000/svg"><path d="M 95,60 L 95,40 Q 95,25 140,25 Q 185,25 185,40 L 185,60" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 70,60 L 60,180 Q 60,190 70,190 L 210,190 Q 220,190 220,180 L 210,60 Z" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><circle cx="90" cy="86" r="6" fill="#dc2626"/><text x="104" y="90" font-size="13" fill="#dc2626" font-weight="700">4 rooi</text><circle cx="90" cy="114" r="6" fill="#2563eb"/><text x="104" y="118" font-size="13" fill="#2563eb" font-weight="700">6 blou</text><circle cx="90" cy="142" r="6" fill="#16a34a"/><text x="104" y="146" font-size="13" fill="#16a34a" font-weight="700">2 groen</text></svg>' },
        { difficulty: 'Easy-Medium', question: 'ʼn Wieletjie is in 10 gelyke sektore verdeel: 6 geel, 3 pers en 1 oranje. Die wieletjie word een keer gedraai. Vind P(geel).', checkMode: 'auto', correctAnswer: '3/5', correctAnswers: ['3/5', '6/10'], answer: '3/5', explanation: 'Totale sektore = 10. Gunstig (geel) = 6. P(geel) = 6/10 = 3/5.' , diagramSvg: '<svg viewBox="0 0 280 210" xmlns="http://www.w3.org/2000/svg"><circle cx="130" cy="105" r="78" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 130,105 L 130.00,27.00 A 78,78 0 1 1 84.15,168.10 Z" fill="#ca8a04" fill-opacity="0.18" stroke="#0f1f3d" stroke-width="2"/><path d="M 130,105 L 84.15,168.10 A 78,78 0 0 1 84.15,41.90 Z" fill="#7c3aed" fill-opacity="0.18" stroke="#0f1f3d" stroke-width="2"/><path d="M 130,105 L 84.15,41.90 A 78,78 0 0 1 130.00,27.00 Z" fill="#ea580c" fill-opacity="0.18" stroke="#0f1f3d" stroke-width="2"/><text x="175.99" y="119.94" font-size="12" fill="#ca8a04" font-weight="700" text-anchor="middle">geel (6)</text><text x="81.64" y="105.00" font-size="12" fill="#7c3aed" font-weight="700" text-anchor="middle">pers (3)</text><text x="115.06" y="59.01" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">oranje (1)</text><circle cx="130" cy="105" r="2.5" fill="#0f1f3d"/></svg>' },
        { difficulty: 'Medium', question: 'ʼn Houer bevat 9 wit balle, 3 swart balle en 8 oranje balle. Een bal word lukraak getrek. Vind P(swart) as ʼn persentasie.', checkMode: 'auto', correctAnswer: '15%', correctAnswers: ['15%', '15'], answer: '15%', explanation: 'Totale balle = 9 + 3 + 8 = 20. P(swart) = 3/20 = 15%.' , diagramSvg: '<svg viewBox="0 0 280 170" xmlns="http://www.w3.org/2000/svg"><rect x="35" y="30" width="210" height="115" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="35" y1="30" x2="60" y2="10" stroke="#0f1f3d" stroke-width="2.5"/><line x1="245" y1="30" x2="270" y2="10" stroke="#0f1f3d" stroke-width="2.5"/><line x1="60" y1="10" x2="270" y2="10" stroke="#0f1f3d" stroke-width="2.5"/><line x1="270" y1="10" x2="270" y2="125" stroke="#0f1f3d" stroke-width="1.5" stroke-dasharray="4,3"/><line x1="60" y1="10" x2="60" y2="125" stroke="#0f1f3d" stroke-width="1.5" stroke-dasharray="4,3"/><circle cx="70" cy="56" r="6" fill="#9ca3af"/><text x="84" y="60" font-size="13" fill="#9ca3af" font-weight="700">9 wit</text><circle cx="70" cy="82" r="6" fill="#1f2937"/><text x="84" y="86" font-size="13" fill="#1f2937" font-weight="700">3 swart</text><circle cx="70" cy="108" r="6" fill="#ea580c"/><text x="84" y="112" font-size="13" fill="#ea580c" font-weight="700">8 oranje</text></svg>' },

        // Blok 3 — Komplementêre gebeurtenisse (Medium)
        { difficulty: 'Medium', question: 'P(ʼn bus kom laat aan) = 0,28. Vind P(die bus kom nie laat aan nie).', checkMode: 'auto', correctAnswer: '0,72', correctAnswers: ['0,72', '0.72'], answer: '0,72', explanation: 'Komplementêre gebeurtenisse: P(nie A) = 1 − P(A) = 1 − 0,28 = 0,72.' },
        { difficulty: 'Medium', question: 'ʼn Sak het 20 albasters, waarvan 7 rooi is. Een albaster word lukraak getrek. Vind P(nie rooi).', checkMode: 'auto', correctAnswer: '13/20', answer: '13/20', explanation: 'P(rooi) = 7/20. P(nie rooi) = 1 − 7/20 = 13/20.' },
        { difficulty: 'Medium', question: 'Die waarskynlikheid dat Naledi ʼn skaakspel wen, is 5/9. Vind die waarskynlikheid dat sy nie wen nie.', checkMode: 'auto', correctAnswer: '4/9', answer: '4/9', explanation: 'P(nie wen) = 1 − P(wen) = 1 − 5/9 = 4/9.' },
        { difficulty: 'Medium', question: 'Kagiso sê as P(gebeurtenis A) = 0,7, moet P(nie A) ook 0,7 wees, "aangesien waarskynlikhede simmetries is." Verduidelik waarom hy verkeerd is en gee die korrekte waarde.', answer: 'Hy is verkeerd — komplementêre waarskynlikhede tel op tot 1, hulle is nie outomaties gelyk nie. P(nie A) = 1 − P(A) = 1 − 0,7 = 0,3, nie 0,7 nie.', checkMode: 'self' },

        // Blok 4 — Steekproefruimte (twee dobbelstene / muntstuk+dobbelsteen rooster) (Medium-Hard) [DIAGRAM LATER]
        { difficulty: 'Medium-Hard', question: 'ʼn Muntstuk word opgegooi en ʼn dobbelsteen word gegooi, en die steekproefruimte-rooster van 12 uitkomste word gewys. Vind P(kop en ʼn getal kleiner as 3).', checkMode: 'auto', correctAnswer: '1/6', correctAnswers: ['1/6', '2/12'], answer: '1/6', explanation: 'Totale uitkomste = 12. Getalle kleiner as 3 is 1, 2, dus gunstige uitkomste (kop, 1), (kop, 2) = 2. W = 2/12 = 1/6.' , diagramSvg: '<svg viewBox="0 0 304 124" xmlns="http://www.w3.org/2000/svg"><text x="188" y="16" font-size="12" fill="#0f1f3d" font-weight="700" text-anchor="middle">Die</text><text x="108" y="28" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">1</text><text x="140" y="28" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">2</text><text x="172" y="28" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">3</text><text x="204" y="28" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">4</text><text x="236" y="28" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">5</text><text x="268" y="28" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">6</text><text x="46" y="93" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">K</text><text x="46" y="125" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">S</text><line x1="92" y1="40" x2="92" y2="104" stroke="#0f1f3d" stroke-width="1.5"/><line x1="124" y1="40" x2="124" y2="104" stroke="#0f1f3d" stroke-width="1.5"/><line x1="156" y1="40" x2="156" y2="104" stroke="#0f1f3d" stroke-width="1.5"/><line x1="188" y1="40" x2="188" y2="104" stroke="#0f1f3d" stroke-width="1.5"/><line x1="220" y1="40" x2="220" y2="104" stroke="#0f1f3d" stroke-width="1.5"/><line x1="252" y1="40" x2="252" y2="104" stroke="#0f1f3d" stroke-width="1.5"/><line x1="284" y1="40" x2="284" y2="104" stroke="#0f1f3d" stroke-width="1.5"/><line x1="92" y1="40" x2="284" y2="40" stroke="#0f1f3d" stroke-width="1.5"/><line x1="92" y1="72" x2="284" y2="72" stroke="#0f1f3d" stroke-width="1.5"/><line x1="92" y1="104" x2="284" y2="104" stroke="#0f1f3d" stroke-width="1.5"/><rect x="92" y="40" width="192" height="64" fill="none" stroke="#0f1f3d" stroke-width="2.5"/></svg>' },
        { difficulty: 'Medium-Hard', question: 'Twee dobbelstene word gegooi en die steekproefruimte-rooster van 36 uitkomste word gewys. Vind P(die som is 6).', checkMode: 'auto', correctAnswer: '5/36', answer: '5/36', explanation: 'Totale uitkomste = 36. Pare wat tot 6 optel: (1,5), (2,4), (3,3), (4,2), (5,1) = 5 gunstige uitkomste. W = 5/36.' , diagramSvg: '<svg viewBox="0 0 258 224" xmlns="http://www.w3.org/2000/svg"><text x="158" y="16" font-size="12" fill="#0f1f3d" font-weight="700" text-anchor="middle">Die 2</text><text x="88" y="28" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">1</text><text x="116" y="28" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">2</text><text x="144" y="28" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">3</text><text x="172" y="28" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">4</text><text x="200" y="28" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">5</text><text x="228" y="28" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">6</text><text x="32" y="87" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">1</text><text x="32" y="115" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">2</text><text x="32" y="143" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">3</text><text x="32" y="171" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">4</text><text x="32" y="199" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">5</text><text x="32" y="227" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">6</text><line x1="74" y1="40" x2="74" y2="208" stroke="#0f1f3d" stroke-width="1.2"/><line x1="102" y1="40" x2="102" y2="208" stroke="#0f1f3d" stroke-width="1.2"/><line x1="130" y1="40" x2="130" y2="208" stroke="#0f1f3d" stroke-width="1.2"/><line x1="158" y1="40" x2="158" y2="208" stroke="#0f1f3d" stroke-width="1.2"/><line x1="186" y1="40" x2="186" y2="208" stroke="#0f1f3d" stroke-width="1.2"/><line x1="214" y1="40" x2="214" y2="208" stroke="#0f1f3d" stroke-width="1.2"/><line x1="242" y1="40" x2="242" y2="208" stroke="#0f1f3d" stroke-width="1.2"/><line x1="74" y1="40" x2="242" y2="40" stroke="#0f1f3d" stroke-width="1.2"/><line x1="74" y1="68" x2="242" y2="68" stroke="#0f1f3d" stroke-width="1.2"/><line x1="74" y1="96" x2="242" y2="96" stroke="#0f1f3d" stroke-width="1.2"/><line x1="74" y1="124" x2="242" y2="124" stroke="#0f1f3d" stroke-width="1.2"/><line x1="74" y1="152" x2="242" y2="152" stroke="#0f1f3d" stroke-width="1.2"/><line x1="74" y1="180" x2="242" y2="180" stroke="#0f1f3d" stroke-width="1.2"/><line x1="74" y1="208" x2="242" y2="208" stroke="#0f1f3d" stroke-width="1.2"/><rect x="74" y="40" width="168" height="168" fill="none" stroke="#0f1f3d" stroke-width="2.5"/></svg>' },
        { difficulty: 'Medium-Hard', question: 'Twee dobbelstene word gegooi en die steekproefruimte-rooster van 36 uitkomste word gewys. Vind P(die twee dobbelstene verskil met presies 1).', checkMode: 'auto', correctAnswer: '5/18', correctAnswers: ['5/18', '10/36'], answer: '5/18', explanation: 'Totale uitkomste = 36. Pare wat met 1 verskil: (1,2),(2,1),(2,3),(3,2),(3,4),(4,3),(4,5),(5,4),(5,6),(6,5) = 10 gunstige uitkomste. W = 10/36 = 5/18.' , diagramSvg: '<svg viewBox="0 0 258 224" xmlns="http://www.w3.org/2000/svg"><text x="158" y="16" font-size="12" fill="#0f1f3d" font-weight="700" text-anchor="middle">Die 2</text><text x="88" y="28" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">1</text><text x="116" y="28" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">2</text><text x="144" y="28" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">3</text><text x="172" y="28" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">4</text><text x="200" y="28" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">5</text><text x="228" y="28" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">6</text><text x="32" y="87" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">1</text><text x="32" y="115" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">2</text><text x="32" y="143" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">3</text><text x="32" y="171" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">4</text><text x="32" y="199" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">5</text><text x="32" y="227" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">6</text><line x1="74" y1="40" x2="74" y2="208" stroke="#0f1f3d" stroke-width="1.2"/><line x1="102" y1="40" x2="102" y2="208" stroke="#0f1f3d" stroke-width="1.2"/><line x1="130" y1="40" x2="130" y2="208" stroke="#0f1f3d" stroke-width="1.2"/><line x1="158" y1="40" x2="158" y2="208" stroke="#0f1f3d" stroke-width="1.2"/><line x1="186" y1="40" x2="186" y2="208" stroke="#0f1f3d" stroke-width="1.2"/><line x1="214" y1="40" x2="214" y2="208" stroke="#0f1f3d" stroke-width="1.2"/><line x1="242" y1="40" x2="242" y2="208" stroke="#0f1f3d" stroke-width="1.2"/><line x1="74" y1="40" x2="242" y2="40" stroke="#0f1f3d" stroke-width="1.2"/><line x1="74" y1="68" x2="242" y2="68" stroke="#0f1f3d" stroke-width="1.2"/><line x1="74" y1="96" x2="242" y2="96" stroke="#0f1f3d" stroke-width="1.2"/><line x1="74" y1="124" x2="242" y2="124" stroke="#0f1f3d" stroke-width="1.2"/><line x1="74" y1="152" x2="242" y2="152" stroke="#0f1f3d" stroke-width="1.2"/><line x1="74" y1="180" x2="242" y2="180" stroke="#0f1f3d" stroke-width="1.2"/><line x1="74" y1="208" x2="242" y2="208" stroke="#0f1f3d" stroke-width="1.2"/><rect x="74" y="40" width="168" height="168" fill="none" stroke="#0f1f3d" stroke-width="2.5"/></svg>' },
        ...
        // Blok 5 — Venn-diagram waarskynlikheid met twee versamelings (Hard) [DIAGRAM LATER]
        { difficulty: 'Hard', question: 'ʼn Venn-diagram wys 40 leerders: 16 studeer net Wiskunde, 10 studeer net Wetenskap, 8 studeer beide Wiskunde en Wetenskap, en 6 studeer geen van die twee nie. Vind P(ʼn leerder studeer beide Wiskunde en Wetenskap).', checkMode: 'auto', correctAnswer: '1/5', correctAnswers: ['1/5', '8/40'], answer: '1/5', explanation: 'Totale leerders = 40. Gunstig (beide) = 8. P(beide) = 8/40 = 1/5.' , diagramSvg: '<svg viewBox="0 0 300 210" xmlns="http://www.w3.org/2000/svg"><rect x="15" y="20" width="270" height="160" fill="none" stroke="#0f1f3d" stroke-width="2"/><circle cx="115" cy="100" r="70" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><circle cx="185" cy="100" r="70" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="75" y="35" font-size="13" fill="#0f1f3d" font-weight="700" text-anchor="middle">Wiskunde</text><text x="225" y="35" font-size="13" fill="#0f1f3d" font-weight="700" text-anchor="middle">Wetenskap</text><text x="85" y="105" font-size="16" fill="#2563eb" font-weight="700" text-anchor="middle">16</text><text x="150" y="105" font-size="16" fill="#2563eb" font-weight="700" text-anchor="middle">8</text><text x="215" y="105" font-size="16" fill="#2563eb" font-weight="700" text-anchor="middle">10</text><text x="30" y="35" font-size="16" fill="#2563eb" font-weight="700" text-anchor="middle">6</text></svg>' },
        { difficulty: 'Hard', question: 'ʼn Venn-diagram wys 40 leerders: 16 studeer net Wiskunde, 10 studeer net Wetenskap, 8 studeer beide, en 6 studeer geen van die twee nie. Vind P(ʼn leerder studeer Wiskunde of Wetenskap, of beide).', checkMode: 'auto', correctAnswer: '17/20', correctAnswers: ['17/20', '34/40'], answer: '17/20', explanation: 'Wiskunde of Wetenskap (of beide) = net Wiskunde + net Wetenskap + beide = 16 + 10 + 8 = 34. W = 34/40 = 17/20.' , diagramSvg: '<svg viewBox="0 0 300 210" xmlns="http://www.w3.org/2000/svg"><rect x="15" y="20" width="270" height="160" fill="none" stroke="#0f1f3d" stroke-width="2"/><circle cx="115" cy="100" r="70" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><circle cx="185" cy="100" r="70" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="75" y="35" font-size="13" fill="#0f1f3d" font-weight="700" text-anchor="middle">Wiskunde</text><text x="225" y="35" font-size="13" fill="#0f1f3d" font-weight="700" text-anchor="middle">Wetenskap</text><text x="85" y="105" font-size="16" fill="#2563eb" font-weight="700" text-anchor="middle">16</text><text x="150" y="105" font-size="16" fill="#2563eb" font-weight="700" text-anchor="middle">8</text><text x="215" y="105" font-size="16" fill="#2563eb" font-weight="700" text-anchor="middle">10</text><text x="30" y="35" font-size="16" fill="#2563eb" font-weight="700" text-anchor="middle">6</text></svg>' },
        { difficulty: 'Hard', question: 'ʼn Venn-diagram wys 50 mense: 18 besit net ʼn motor, 14 besit net ʼn fiets, 10 besit beide, en 8 besit geen van die twee nie. Vind P(ʼn persoon besit presies een van die twee, motor of fiets).', checkMode: 'auto', correctAnswer: '16/25', correctAnswers: ['16/25', '32/50'], answer: '16/25', explanation: 'Presies een = net motor + net fiets = 18 + 14 = 32. W = 32/50 = 16/25.' , diagramSvg: '<svg viewBox="0 0 300 210" xmlns="http://www.w3.org/2000/svg"><rect x="15" y="20" width="270" height="160" fill="none" stroke="#0f1f3d" stroke-width="2"/><circle cx="115" cy="100" r="70" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><circle cx="185" cy="100" r="70" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="75" y="35" font-size="13" fill="#0f1f3d" font-weight="700" text-anchor="middle">Motor</text><text x="225" y="35" font-size="13" fill="#0f1f3d" font-weight="700" text-anchor="middle">Fiets</text><text x="85" y="105" font-size="16" fill="#2563eb" font-weight="700" text-anchor="middle">18</text><text x="150" y="105" font-size="16" fill="#2563eb" font-weight="700" text-anchor="middle">10</text><text x="215" y="105" font-size="16" fill="#2563eb" font-weight="700" text-anchor="middle">14</text><text x="30" y="35" font-size="16" fill="#2563eb" font-weight="700" text-anchor="middle">8</text></svg>' },
        { difficulty: 'Hard', question: 'Sipho se Venn-diagram wys 60 kopers: 24 koop net vrugte, 18 koop net groente, 12 koop beide, en 6 koop geeneen nie. Hy beweer P(koop geeneen) = 6/54 omdat 54 kopers wel iets gekoop het. Verduidelik sy fout en gee die korrekte waarskynlikheid.', answer: 'Hy het die verkeerde totaal gebruik. Die waarskynlikheid moet altyd met die totale steekproefgrootte (al 60 kopers) bereken word, nie net dié wat iets gekoop het nie. P(koop geeneen) = 6/60 = 1/10, nie 6/54 nie.', checkMode: 'self' , diagramSvg: '<svg viewBox="0 0 300 210" xmlns="http://www.w3.org/2000/svg"><rect x="15" y="20" width="270" height="160" fill="none" stroke="#0f1f3d" stroke-width="2"/><circle cx="115" cy="100" r="70" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><circle cx="185" cy="100" r="70" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="75" y="35" font-size="13" fill="#0f1f3d" font-weight="700" text-anchor="middle">Vrugte</text><text x="225" y="35" font-size="13" fill="#0f1f3d" font-weight="700" text-anchor="middle">Groente</text><text x="85" y="105" font-size="16" fill="#2563eb" font-weight="700" text-anchor="middle">24</text><text x="150" y="105" font-size="16" fill="#2563eb" font-weight="700" text-anchor="middle">12</text><text x="215" y="105" font-size="16" fill="#2563eb" font-weight="700" text-anchor="middle">18</text><text x="30" y="35" font-size="16" fill="#2563eb" font-weight="700" text-anchor="middle">6</text></svg>' },

        // Blok 6 — Gekombineerde multi-stap waarskynlikheid (Hard)
        { difficulty: 'Hard', question: 'ʼn Houer het 9 penne: 6 blou en 3 swart. Lerato kies ʼn pen, hou dit, en kies dan ʼn tweede pen. Vind P(albei penne is blou).', checkMode: 'auto', correctAnswer: '5/12', answer: '5/12', explanation: 'P(blou eerste) = 6/9 = 2/3. Sonder vervanging, P(blou tweede) = 5/8. Gekombineerd: 2/3 × 5/8 = 10/24 = 5/12.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // Blok 1 — Relatiewe frekwensie (Easy)
        { difficulty: 'Easy', question: 'ʼn Dobbelsteen word 150 keer gegooi. Gebaseer op teoretiese waarskynlikheid, hoeveel keer sou jy voorspel dat die dobbelsteen ʼn 4 sal wys?', checkMode: 'auto', correctAnswer: '25', answer: '25', explanation: 'P(4) = 1/6. Voorspelde frekwensie = 1/6 × 150 = 25.' },
        ...
        { difficulty: 'Easy', question: 'Amahle voorspel dat om ʼn dobbelsteen 72 keer te gooi ongeveer 12 keer ʼn 1 behoort te gee (aangesien P(1) = 1/6). Sy kry werklik 15. Verduidelik die verskil.', answer: 'Verwag = 72 × 1/6 = 12. Om 15 te kry is heelwat hoër as verwag, maar met ʼn beperkte aantal proewe kan hierdie soort variasie natuurlik voorkom weens toevalligheid. Meer worpe sal die resultaat waarskynlik nader aan 12 bring.', checkMode: 'self' },

        // Blok 2 — Enkelgebeurtenis-waarskynlikheid uit ʼn sak/wieletjie (Easy-Medium) [DIAGRAM LATER]
        { difficulty: 'Easy-Medium', question: 'ʼn Sak bevat 7 rooi fiches, 2 blou fiches en 3 groen fiches. Een fiche word lukraak getrek. Vind P(rooi).', checkMode: 'auto', correctAnswer: '7/12', answer: '7/12', explanation: 'Totale fiches = 7 + 2 + 3 = 12. P(rooi) = 7/12.' , diagramSvg: '<svg viewBox="0 0 280 210" xmlns="http://www.w3.org/2000/svg"><path d="M 95,60 L 95,40 Q 95,25 140,25 Q 185,25 185,40 L 185,60" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 70,60 L 60,180 Q 60,190 70,190 L 210,190 Q 220,190 220,180 L 210,60 Z" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><circle cx="90" cy="86" r="6" fill="#dc2626"/><text x="104" y="90" font-size="13" fill="#dc2626" font-weight="700">7 rooi</text><circle cx="90" cy="114" r="6" fill="#2563eb"/><text x="104" y="118" font-size="13" fill="#2563eb" font-weight="700">2 blou</text><circle cx="90" cy="142" r="6" fill="#16a34a"/><text x="104" y="146" font-size="13" fill="#16a34a" font-weight="700">3 groen</text></svg>' },
        { difficulty: 'Easy-Medium', question: 'ʼn Wieletjie is in 6 gelyke sektore verdeel: 1 geel, 2 pers en 3 oranje. Die wieletjie word een keer gedraai. Vind P(oranje).', checkMode: 'auto', correctAnswer: '1/2', correctAnswers: ['1/2', '3/6'], answer: '1/2', explanation: 'Totale sektore = 6. Gunstig (oranje) = 3. P(oranje) = 3/6 = 1/2.' , diagramSvg: '<svg viewBox="0 0 280 210" xmlns="http://www.w3.org/2000/svg"><circle cx="130" cy="105" r="78" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 130,105 L 130.00,27.00 A 78,78 0 0 1 197.55,66.00 Z" fill="#ca8a04" fill-opacity="0.18" stroke="#0f1f3d" stroke-width="2"/><path d="M 130,105 L 197.55,66.00 A 78,78 0 0 1 130.00,183.00 Z" fill="#7c3aed" fill-opacity="0.18" stroke="#0f1f3d" stroke-width="2"/><path d="M 130,105 L 130.00,183.00 A 78,78 0 0 1 130.00,27.00 Z" fill="#ea580c" fill-opacity="0.18" stroke="#0f1f3d" stroke-width="2"/><text x="154.18" y="63.12" font-size="12" fill="#ca8a04" font-weight="700" text-anchor="middle">geel (1)</text><text x="171.88" y="129.18" font-size="12" fill="#7c3aed" font-weight="700" text-anchor="middle">pers (2)</text><text x="81.64" y="105.00" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">oranje (3)</text><circle cx="130" cy="105" r="2.5" fill="#0f1f3d"/></svg>' },
        { difficulty: 'Medium', question: 'ʼn Houer bevat 5 wit balle, 10 swart balle en 5 oranje balle. Een bal word lukraak getrek. Vind P(oranje) as ʼn persentasie.', checkMode: 'auto', correctAnswer: '25%', correctAnswers: ['25%', '25'], answer: '25%', explanation: 'Totale balle = 5 + 10 + 5 = 20. P(oranje) = 5/20 = 1/4 = 25%.' , diagramSvg: '<svg viewBox="0 0 280 170" xmlns="http://www.w3.org/2000/svg"><rect x="35" y="30" width="210" height="115" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="35" y1="30" x2="60" y2="10" stroke="#0f1f3d" stroke-width="2.5"/><line x1="245" y1="30" x2="270" y2="10" stroke="#0f1f3d" stroke-width="2.5"/><line x1="60" y1="10" x2="270" y2="10" stroke="#0f1f3d" stroke-width="2.5"/><line x1="270" y1="10" x2="270" y2="125" stroke="#0f1f3d" stroke-width="1.5" stroke-dasharray="4,3"/><line x1="60" y1="10" x2="60" y2="125" stroke="#0f1f3d" stroke-width="1.5" stroke-dasharray="4,3"/><circle cx="70" cy="56" r="6" fill="#9ca3af"/><text x="84" y="60" font-size="13" fill="#9ca3af" font-weight="700">5 wit</text><circle cx="70" cy="82" r="6" fill="#1f2937"/><text x="84" y="86" font-size="13" fill="#1f2937" font-weight="700">10 swart</text><circle cx="70" cy="108" r="6" fill="#ea580c"/><text x="84" y="112" font-size="13" fill="#ea580c" font-weight="700">5 oranje</text></svg>' },

        // Blok 3 — Komplementêre gebeurtenisse (Medium)
        { difficulty: 'Medium', question: 'P(ʼn winkel is oop op ʼn openbare vakansiedag) = 0,45. Vind P(die winkel is nie oop op ʼn openbare vakansiedag nie).', checkMode: 'auto', correctAnswer: '0,55', correctAnswers: ['0,55', '0.55'], answer: '0,55', explanation: 'Komplementêre gebeurtenisse: P(nie A) = 1 − P(A) = 1 − 0,45 = 0,55.' },
        { difficulty: 'Medium', question: 'ʼn Sak het 15 albasters, waarvan 4 rooi is. Een albaster word lukraak getrek. Vind P(nie rooi).', checkMode: 'auto', correctAnswer: '11/15', answer: '11/15', explanation: 'P(rooi) = 4/15. P(nie rooi) = 1 − 4/15 = 11/15.' },
        { difficulty: 'Medium', question: 'Die waarskynlikheid dat Zanele voor 7:30 by die skool aankom, is 7/10. Vind die waarskynlikheid dat sy nie voor 7:30 aankom nie.', checkMode: 'auto', correctAnswer: '3/10', answer: '3/10', explanation: 'P(nie voor 7:30) = 1 − P(voor 7:30) = 1 − 7/10 = 3/10.' },
        { difficulty: 'Medium', question: 'Thabo sê as P(gebeurtenis A) = 0,15, moet P(nie A) ook klein wees, "aangesien A self onwaarskynlik is." Verduidelik waarom hierdie redenasie verkeerd is en gee die korrekte waarde.', answer: 'Hy is verkeerd — ʼn klein P(A) beteken P(nie A) is eintlik groot, aangesien die twee saam tot 1 moet optel. P(nie A) = 1 − 0,15 = 0,85, wat groot is, nie klein nie.', checkMode: 'self' },

        // Blok 4 — Steekproefruimte (twee dobbelstene / muntstuk+dobbelsteen rooster) (Medium-Hard) [DIAGRAM LATER]
        { difficulty: 'Medium-Hard', question: 'ʼn Muntstuk word opgegooi en ʼn dobbelsteen word gegooi, en die steekproefruimte-rooster van 12 uitkomste word gewys. Vind P(stert en ʼn ewe getal).', checkMode: 'auto', correctAnswer: '1/4', correctAnswers: ['1/4', '3/12'], answer: '1/4', explanation: 'Totale uitkomste = 12. Ewe getalle is 2, 4, 6, dus gunstige uitkomste (stert, 2), (stert, 4), (stert, 6) = 3. W = 3/12 = 1/4.' , diagramSvg: '<svg viewBox="0 0 304 124" xmlns="http://www.w3.org/2000/svg"><text x="188" y="16" font-size="12" fill="#0f1f3d" font-weight="700" text-anchor="middle">Die</text><text x="108" y="28" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">1</text><text x="140" y="28" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">2</text><text x="172" y="28" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">3</text><text x="204" y="28" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">4</text><text x="236" y="28" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">5</text><text x="268" y="28" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">6</text><text x="46" y="93" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">K</text><text x="46" y="125" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">S</text><line x1="92" y1="40" x2="92" y2="104" stroke="#0f1f3d" stroke-width="1.5"/><line x1="124" y1="40" x2="124" y2="104" stroke="#0f1f3d" stroke-width="1.5"/><line x1="156" y1="40" x2="156" y2="104" stroke="#0f1f3d" stroke-width="1.5"/><line x1="188" y1="40" x2="188" y2="104" stroke="#0f1f3d" stroke-width="1.5"/><line x1="220" y1="40" x2="220" y2="104" stroke="#0f1f3d" stroke-width="1.5"/><line x1="252" y1="40" x2="252" y2="104" stroke="#0f1f3d" stroke-width="1.5"/><line x1="284" y1="40" x2="284" y2="104" stroke="#0f1f3d" stroke-width="1.5"/><line x1="92" y1="40" x2="284" y2="40" stroke="#0f1f3d" stroke-width="1.5"/><line x1="92" y1="72" x2="284" y2="72" stroke="#0f1f3d" stroke-width="1.5"/><line x1="92" y1="104" x2="284" y2="104" stroke="#0f1f3d" stroke-width="1.5"/><rect x="92" y="40" width="192" height="64" fill="none" stroke="#0f1f3d" stroke-width="2.5"/></svg>' },
        { difficulty: 'Medium-Hard', question: 'Twee dobbelstene word gegooi en die steekproefruimte-rooster van 36 uitkomste word gewys. Vind P(die som is 10).', checkMode: 'auto', correctAnswer: '1/12', correctAnswers: ['1/12', '3/36'], answer: '1/12', explanation: 'Totale uitkomste = 36. Pare wat tot 10 optel: (4,6), (5,5), (6,4) = 3 gunstige uitkomste. W = 3/36 = 1/12.' , diagramSvg: '<svg viewBox="0 0 258 224" xmlns="http://www.w3.org/2000/svg"><text x="158" y="16" font-size="12" fill="#0f1f3d" font-weight="700" text-anchor="middle">Die 2</text><text x="88" y="28" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">1</text><text x="116" y="28" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">2</text><text x="144" y="28" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">3</text><text x="172" y="28" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">4</text><text x="200" y="28" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">5</text><text x="228" y="28" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">6</text><text x="32" y="87" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">1</text><text x="32" y="115" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">2</text><text x="32" y="143" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">3</text><text x="32" y="171" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">4</text><text x="32" y="199" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">5</text><text x="32" y="227" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">6</text><line x1="74" y1="40" x2="74" y2="208" stroke="#0f1f3d" stroke-width="1.2"/><line x1="102" y1="40" x2="102" y2="208" stroke="#0f1f3d" stroke-width="1.2"/><line x1="130" y1="40" x2="130" y2="208" stroke="#0f1f3d" stroke-width="1.2"/><line x1="158" y1="40" x2="158" y2="208" stroke="#0f1f3d" stroke-width="1.2"/><line x1="186" y1="40" x2="186" y2="208" stroke="#0f1f3d" stroke-width="1.2"/><line x1="214" y1="40" x2="214" y2="208" stroke="#0f1f3d" stroke-width="1.2"/><line x1="242" y1="40" x2="242" y2="208" stroke="#0f1f3d" stroke-width="1.2"/><line x1="74" y1="40" x2="242" y2="40" stroke="#0f1f3d" stroke-width="1.2"/><line x1="74" y1="68" x2="242" y2="68" stroke="#0f1f3d" stroke-width="1.2"/><line x1="74" y1="96" x2="242" y2="96" stroke="#0f1f3d" stroke-width="1.2"/><line x1="74" y1="124" x2="242" y2="124" stroke="#0f1f3d" stroke-width="1.2"/><line x1="74" y1="152" x2="242" y2="152" stroke="#0f1f3d" stroke-width="1.2"/><line x1="74" y1="180" x2="242" y2="180" stroke="#0f1f3d" stroke-width="1.2"/><line x1="74" y1="208" x2="242" y2="208" stroke="#0f1f3d" stroke-width="1.2"/><rect x="74" y="40" width="168" height="168" fill="none" stroke="#0f1f3d" stroke-width="2.5"/></svg>' },
        { difficulty: 'Medium-Hard', question: 'Twee dobbelstene word gegooi en die steekproefruimte-rooster van 36 uitkomste word gewys. Vind P(minstens een dobbelsteen wys ʼn 6).', checkMode: 'auto', correctAnswer: '11/36', answer: '11/36', explanation: 'Totale uitkomste = 36. Uitkomste met minstens een 6: alle pare (6, x) en (x, 6) vir x = 1 tot 6, minus die dubbel-getelde (6,6) = 6 + 6 − 1 = 11. W = 11/36.' , diagramSvg: '<svg viewBox="0 0 258 224" xmlns="http://www.w3.org/2000/svg"><text x="158" y="16" font-size="12" fill="#0f1f3d" font-weight="700" text-anchor="middle">Die 2</text><text x="88" y="28" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">1</text><text x="116" y="28" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">2</text><text x="144" y="28" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">3</text><text x="172" y="28" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">4</text><text x="200" y="28" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">5</text><text x="228" y="28" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">6</text><text x="32" y="87" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">1</text><text x="32" y="115" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">2</text><text x="32" y="143" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">3</text><text x="32" y="171" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">4</text><text x="32" y="199" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">5</text><text x="32" y="227" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">6</text><line x1="74" y1="40" x2="74" y2="208" stroke="#0f1f3d" stroke-width="1.2"/><line x1="102" y1="40" x2="102" y2="208" stroke="#0f1f3d" stroke-width="1.2"/><line x1="130" y1="40" x2="130" y2="208" stroke="#0f1f3d" stroke-width="1.2"/><line x1="158" y1="40" x2="158" y2="208" stroke="#0f1f3d" stroke-width="1.2"/><line x1="186" y1="40" x2="186" y2="208" stroke="#0f1f3d" stroke-width="1.2"/><line x1="214" y1="40" x2="214" y2="208" stroke="#0f1f3d" stroke-width="1.2"/><line x1="242" y1="40" x2="242" y2="208" stroke="#0f1f3d" stroke-width="1.2"/><line x1="74" y1="40" x2="242" y2="40" stroke="#0f1f3d" stroke-width="1.2"/><line x1="74" y1="68" x2="242" y2="68" stroke="#0f1f3d" stroke-width="1.2"/><line x1="74" y1="96" x2="242" y2="96" stroke="#0f1f3d" stroke-width="1.2"/><line x1="74" y1="124" x2="242" y2="124" stroke="#0f1f3d" stroke-width="1.2"/><line x1="74" y1="152" x2="242" y2="152" stroke="#0f1f3d" stroke-width="1.2"/><line x1="74" y1="180" x2="242" y2="180" stroke="#0f1f3d" stroke-width="1.2"/><line x1="74" y1="208" x2="242" y2="208" stroke="#0f1f3d" stroke-width="1.2"/><rect x="74" y="40" width="168" height="168" fill="none" stroke="#0f1f3d" stroke-width="2.5"/></svg>' },
        ...
        // Blok 5 — Venn-diagram waarskynlikheid met twee versamelings (Hard) [DIAGRAM LATER]
        { difficulty: 'Hard', question: 'ʼn Venn-diagram wys 36 leerders: 14 studeer net Wiskunde, 9 studeer net Wetenskap, 7 studeer beide Wiskunde en Wetenskap, en 6 studeer geen van die twee nie. Vind P(ʼn leerder studeer beide Wiskunde en Wetenskap).', checkMode: 'auto', correctAnswer: '7/36', answer: '7/36', explanation: 'Totale leerders = 36. Gunstig (beide) = 7. P(beide) = 7/36.' , diagramSvg: '<svg viewBox="0 0 300 210" xmlns="http://www.w3.org/2000/svg"><rect x="15" y="20" width="270" height="160" fill="none" stroke="#0f1f3d" stroke-width="2"/><circle cx="115" cy="100" r="70" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><circle cx="185" cy="100" r="70" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="75" y="35" font-size="13" fill="#0f1f3d" font-weight="700" text-anchor="middle">Wiskunde</text><text x="225" y="35" font-size="13" fill="#0f1f3d" font-weight="700" text-anchor="middle">Wetenskap</text><text x="85" y="105" font-size="16" fill="#2563eb" font-weight="700" text-anchor="middle">14</text><text x="150" y="105" font-size="16" fill="#2563eb" font-weight="700" text-anchor="middle">7</text><text x="215" y="105" font-size="16" fill="#2563eb" font-weight="700" text-anchor="middle">9</text><text x="30" y="35" font-size="16" fill="#2563eb" font-weight="700" text-anchor="middle">6</text></svg>' },
        { difficulty: 'Hard', question: 'ʼn Venn-diagram wys 36 leerders: 14 studeer net Wiskunde, 9 studeer net Wetenskap, 7 studeer beide, en 6 studeer geen van die twee nie. Vind P(ʼn leerder studeer Wiskunde of Wetenskap, of beide).', checkMode: 'auto', correctAnswer: '5/6', correctAnswers: ['5/6', '30/36'], answer: '5/6', explanation: 'Wiskunde of Wetenskap (of beide) = net Wiskunde + net Wetenskap + beide = 14 + 9 + 7 = 30. W = 30/36 = 5/6.' , diagramSvg: '<svg viewBox="0 0 300 210" xmlns="http://www.w3.org/2000/svg"><rect x="15" y="20" width="270" height="160" fill="none" stroke="#0f1f3d" stroke-width="2"/><circle cx="115" cy="100" r="70" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><circle cx="185" cy="100" r="70" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="75" y="35" font-size="13" fill="#0f1f3d" font-weight="700" text-anchor="middle">Wiskunde</text><text x="225" y="35" font-size="13" fill="#0f1f3d" font-weight="700" text-anchor="middle">Wetenskap</text><text x="85" y="105" font-size="16" fill="#2563eb" font-weight="700" text-anchor="middle">14</text><text x="150" y="105" font-size="16" fill="#2563eb" font-weight="700" text-anchor="middle">7</text><text x="215" y="105" font-size="16" fill="#2563eb" font-weight="700" text-anchor="middle">9</text><text x="30" y="35" font-size="16" fill="#2563eb" font-weight="700" text-anchor="middle">6</text></svg>' },
        { difficulty: 'Hard', question: 'ʼn Venn-diagram wys 45 mense: 16 besit net ʼn motor, 13 besit net ʼn fiets, 8 besit beide, en 8 besit geen van die twee nie. Vind P(ʼn persoon besit presies een van die twee, motor of fiets).', checkMode: 'auto', correctAnswer: '29/45', answer: '29/45', explanation: 'Presies een = net motor + net fiets = 16 + 13 = 29. W = 29/45.' , diagramSvg: '<svg viewBox="0 0 300 210" xmlns="http://www.w3.org/2000/svg"><rect x="15" y="20" width="270" height="160" fill="none" stroke="#0f1f3d" stroke-width="2"/><circle cx="115" cy="100" r="70" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><circle cx="185" cy="100" r="70" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="75" y="35" font-size="13" fill="#0f1f3d" font-weight="700" text-anchor="middle">Motor</text><text x="225" y="35" font-size="13" fill="#0f1f3d" font-weight="700" text-anchor="middle">Fiets</text><text x="85" y="105" font-size="16" fill="#2563eb" font-weight="700" text-anchor="middle">16</text><text x="150" y="105" font-size="16" fill="#2563eb" font-weight="700" text-anchor="middle">8</text><text x="215" y="105" font-size="16" fill="#2563eb" font-weight="700" text-anchor="middle">13</text><text x="30" y="35" font-size="16" fill="#2563eb" font-weight="700" text-anchor="middle">8</text></svg>' },
        { difficulty: 'Hard', question: 'Lindiwe se Venn-diagram wys 55 kopers: 22 koop net vrugte, 17 koop net groente, 11 koop beide, en 5 koop geeneen nie. Sy beweer P(koop geeneen) = 5/50 omdat 50 kopers wel iets gekoop het. Verduidelik haar fout en gee die korrekte waarskynlikheid.', answer: 'Sy het die verkeerde totaal gebruik. Die waarskynlikheid moet altyd met die totale steekproefgrootte (al 55 kopers) bereken word, nie net dié wat iets gekoop het nie. P(koop geeneen) = 5/55 = 1/11, nie 5/50 nie.', checkMode: 'self' , diagramSvg: '<svg viewBox="0 0 300 210" xmlns="http://www.w3.org/2000/svg"><rect x="15" y="20" width="270" height="160" fill="none" stroke="#0f1f3d" stroke-width="2"/><circle cx="115" cy="100" r="70" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><circle cx="185" cy="100" r="70" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="75" y="35" font-size="13" fill="#0f1f3d" font-weight="700" text-anchor="middle">Vrugte</text><text x="225" y="35" font-size="13" fill="#0f1f3d" font-weight="700" text-anchor="middle">Groente</text><text x="85" y="105" font-size="16" fill="#2563eb" font-weight="700" text-anchor="middle">22</text><text x="150" y="105" font-size="16" fill="#2563eb" font-weight="700" text-anchor="middle">11</text><text x="215" y="105" font-size="16" fill="#2563eb" font-weight="700" text-anchor="middle">17</text><text x="30" y="35" font-size="16" fill="#2563eb" font-weight="700" text-anchor="middle">5</text></svg>' },

        // Blok 6 — Gekombineerde multi-stap waarskynlikheid (Hard)
        { difficulty: 'Hard', question: 'ʼn Houer het 10 penne: 7 blou en 3 swart. Sipho kies ʼn pen, hou dit, en kies dan ʼn tweede pen. Vind P(albei penne is blou).', checkMode: 'auto', correctAnswer: '7/15', answer: '7/15', explanation: 'P(blou eerste) = 7/10. Sonder vervanging, P(blou tweede) = 6/9 = 2/3. Gekombineerd: 7/10 × 2/3 = 14/30 = 7/15.' },
