...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        'ʼn Cartesiese vlak wat die lyn y = 2x − 6 wys, met die x-afsny by (3, 0) en y-afsny by (0, −6) duidelik gemerk',
      ...
      videoPlaceholder:
        'Kort video wat y-afsny, x-afsny en gradiënt van lineêre grafieke verduidelik met uitgewerkte voorbeelde',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramPlaceholder:
        'ʼn Cartesiese vlak wat die lyn y = −x + 4 wys, geteken met behulp van sy x-afsny (4, 0) en y-afsny (0, 4)',
      ...
      videoPlaceholder:
        'Kort video wat wys hoe om ʼn reguitlyngrafiek te teken met behulp van die afsnymetode en ʼn tabel van waardes',
    },
  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'Vind die y-afsny van y = 4x + 9.', checkMode: 'auto', options: ['9', '4', '-9', '13'], correctIndex: 0, explanation: 'Stel x = 0: y = 4(0) + 9 = 9. Die y-afsny is 9. (4 is die gradiënt, nie die afsny nie; −9 keer die teken om; 13 tel die gradiënt en afsny verkeerdelik op.)' },
        { difficulty: 'Easy', question: 'Vind die x-afsny van y = 3x − 9.', checkMode: 'auto', options: ['-3', '3', '9', '6'], correctIndex: 1, explanation: 'Stel y = 0: 0 = 3x − 9. Dus 3x = 9, x = 3. Die x-afsny is 3. (−3 keer die teken om; 9 verwar die konstante term met die afsny; 6 is ʼn aftrekkingsfout.)' },

        // Blok 2 — gradiënt tussen twee punte (Easy-Medium)
        { difficulty: 'Easy-Medium', question: 'Vind die gradiënt van die lyn deur (2, 5) en (5, 17).', checkMode: 'auto', options: ['-4', '12', '4', '3'], correctIndex: 2, explanation: 'Gradiënt = (17 − 5) ÷ (5 − 2) = 12 ÷ 3 = 4. (−4 keer die teken om; 12 vergeet om deur Δx te deel; 3 verwar Δx self met die gradiënt.)' },
        { difficulty: 'Easy-Medium', question: 'Vind die gradiënt van die lyn deur (−1, 3) en (3, 15).', checkMode: 'auto', options: ['-3', '12', '4', '3'], correctIndex: 3, explanation: 'Gradiënt = (15 − 3) ÷ (3 − (−1)) = 12 ÷ 4 = 3. (−3 keer die teken om; 12 vergeet om deur Δx te deel; 4 verwar Δx met die gradiënt.)' },
        { difficulty: 'Medium', question: 'Vind die gradiënt van die lyn deur (0, −4) en (6, 8).', checkMode: 'auto', options: ['2', '-2', '12', '6'], correctIndex: 0, explanation: 'Gradiënt = (8 − (−4)) ÷ (6 − 0) = 12 ÷ 6 = 2. (−2 keer die teken om; 12 vergeet om deur Δx te deel; 6 verwar Δx met die gradiënt.)' },

        // Blok 3 — vergelyking van ʼn lyn y = mx + c (Medium)
        { difficulty: 'Medium', question: 'ʼn Lyn het ʼn gradiënt van 6 en ʼn y-afsny van −4. Skryf sy vergelyking.', checkMode: 'auto', options: ['y=-4x+6', 'y=6x-4', 'y=6x+4', 'y=-6x-4'], correctIndex: 1, explanation: 'Deur y = mx + c te gebruik met m = 6 en c = −4: y = 6x − 4. (Die afleiers verwissel m en c, of keer ʼn teken om.)' },
        { difficulty: 'Medium', question: 'ʼn Lyn gaan deur (0, 7) en (4, 23). Vind sy vergelyking.', checkMode: 'auto', options: ['y=7x+4', 'y=4x-7', 'y=4x+7', 'y=16x+7'], correctIndex: 2, explanation: 'y-afsny: (0, 7) het x = 0, dus c = 7. Gradiënt: m = (23 − 7) ÷ (4 − 0) = 16 ÷ 4 = 4. Vergelyking: y = 4x + 7. (Die afleiers verwissel m en c, keer die teken van c om, of vergeet om Δy deur Δx te deel.)' },
        { difficulty: 'Medium', question: 'ʼn Lyn gaan deur (2, 11) en (5, 20). Vind sy vergelyking.', checkMode: 'auto', options: ['y=5x+3', 'y=3x-5', 'y=9x+5', 'y=3x+5'], correctIndex: 3, explanation: 'Gradiënt: m = (20 − 11) ÷ (5 − 2) = 9 ÷ 3 = 3. Vervang (2, 11): 11 = 3(2) + c, dus c = 5. Vergelyking: y = 3x + 5. (Die afleiers verwissel m en c, keer die teken van c om, of vergeet om Δy deur Δx te deel.)' },
        { difficulty: 'Medium', question: 'Vind die x-afsny van y = −4x + 12.', checkMode: 'auto', options: ['3', '-3', '12', '4'], correctIndex: 0, explanation: 'Stel y = 0: 0 = −4x + 12. Dus 4x = 12, x = 3. Die x-afsny is 3. (−3 keer die teken om; 12 verwar die konstante met die afsny; 4 verwar die gradiënt met die afsny.)' },

        // Blok 4 — [DIAGRAM] gradiënt/x-afsny/vergelyking van beskryfde getekende lyn aflees (Medium-Hard)
        { difficulty: 'Medium-Hard', question: 'Die getoonde grafiek is ʼn reguit lyn wat deur (0, 2) en (3, 11) gaan. Vind die gradiënt van die lyn.', checkMode: 'auto', options: ['9', '3', '-3', '2'], correctIndex: 1, explanation: 'Gradiënt = (11 − 2) ÷ (3 − 0) = 9 ÷ 3 = 3. (9 vergeet om deur Δx te deel; −3 keer die teken om; 2 verwar die y-afsny wat van die grafiek afgelees is met die gradiënt.)', diagramSvg: '<svg viewBox="0 0 220 195" xmlns="http://www.w3.org/2000/svg"><line x1="57.29" y1="14" x2="57.29" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="100.43" y1="14" x2="100.43" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="143.57" y1="14" x2="143.57" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="186.71" y1="14" x2="186.71" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="145.01" x2="210" y2="145.01" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="94.55" x2="210" y2="94.55" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="44.08" x2="210" y2="44.08" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="145.01" x2="210" y2="145.01" stroke="#374151" stroke-width="1.5"/><line x1="57.29" y1="165" x2="57.29" y2="14" stroke="#374151" stroke-width="1.5"/><text x="100.43" y="155.01" font-size="7.5" fill="#374151" text-anchor="middle">1</text><text x="143.57" y="155.01" font-size="7.5" fill="#374151" text-anchor="middle">2</text><text x="186.71" y="155.01" font-size="7.5" fill="#374151" text-anchor="middle">3</text><text x="53.29" y="97.05" font-size="7.5" fill="#374151" text-anchor="end">5</text><text x="53.29" y="46.58" font-size="7.5" fill="#374151" text-anchor="end">10</text><text x="53.29" y="155.01" font-size="6.5" fill="#374151" text-anchor="end">0</text><polyline points="37.88,138.45 206.12,20.36" fill="none" stroke="#9ca3af" stroke-width="1.5"/><circle cx="57.29" cy="124.83" r="4" fill="#2563eb"/><text x="64.29" y="117.83" font-size="10.5" fill="#2563eb" font-weight="700" text-anchor="start">(0, 2)</text><circle cx="186.71" cy="33.99" r="4" fill="#2563eb"/><text x="179.71" y="26.99" font-size="10.5" fill="#2563eb" font-weight="700" text-anchor="end">(3, 11)</text></svg>' },
        { difficulty: 'Medium-Hard', question: 'Die getoonde grafiek is ʼn reguit lyn wat deur (0, 6) en (4, −2) gaan. Vind die x-afsny van die lyn.', checkMode: 'auto', options: ['6', '-3', '3', '4'], correctIndex: 2, explanation: 'Gradiënt = (−2 − 6) ÷ (4 − 0) = −8 ÷ 4 = −2. Vergelyking: y = −2x + 6. Stel y = 0: 0 = −2x + 6, dus x = 3. (6 verwar die y-afsny met die x-afsny; −3 keer die teken om; 4 verwar die x-koördinaat van die punt met die afsny.)', diagramSvg: '<svg viewBox="0 0 220 195" xmlns="http://www.w3.org/2000/svg"><line x1="57.29" y1="14" x2="57.29" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="122" y1="14" x2="122" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="186.71" y1="14" x2="186.71" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="117.26" x2="210" y2="117.26" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="47.86" x2="210" y2="47.86" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="117.26" x2="210" y2="117.26" stroke="#374151" stroke-width="1.5"/><line x1="57.29" y1="165" x2="57.29" y2="14" stroke="#374151" stroke-width="1.5"/><text x="122" y="127.26" font-size="7.5" fill="#374151" text-anchor="middle">2</text><text x="186.71" y="127.26" font-size="7.5" fill="#374151" text-anchor="middle">4</text><text x="53.29" y="50.36" font-size="7.5" fill="#374151" text-anchor="end">5</text><text x="53.29" y="127.26" font-size="6.5" fill="#374151" text-anchor="end">0</text><polyline points="37.88,17.33 206.12,161.67" fill="none" stroke="#9ca3af" stroke-width="1.5"/><circle cx="57.29" cy="33.99" r="4" fill="#2563eb"/><text x="64.29" y="26.99" font-size="10.5" fill="#2563eb" font-weight="700" text-anchor="start">(0, 6)</text><circle cx="186.71" cy="145.01" r="4" fill="#2563eb"/><text x="179.71" y="138.01" font-size="10.5" fill="#2563eb" font-weight="700" text-anchor="end">(4, -2)</text></svg>' },
        { difficulty: 'Hard', question: 'Die getoonde grafiek is ʼn reguit lyn wat deur (−1, −5) en (2, 4) gaan. Vind die vergelyking van die lyn.', checkMode: 'auto', options: ['y=-2x+3', 'y=3x+2', 'y=9x-2', 'y=3x-2'], correctIndex: 3, explanation: 'Gradiënt: m = (4 − (−5)) ÷ (2 − (−1)) = 9 ÷ 3 = 3. Vervang (2, 4): 4 = 3(2) + c, dus c = −2. Vergelyking: y = 3x − 2. (Die afleiers verwissel m en c, keer die teken van c om, of vergeet om Δy deur Δx te deel.)', diagramSvg: '<svg viewBox="0 0 220 195" xmlns="http://www.w3.org/2000/svg"><line x1="57.29" y1="14" x2="57.29" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="100.43" y1="14" x2="100.43" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="143.57" y1="14" x2="143.57" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="186.71" y1="14" x2="186.71" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="145.01" x2="210" y2="145.01" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="83.33" x2="210" y2="83.33" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="21.65" x2="210" y2="21.65" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="83.33" x2="210" y2="83.33" stroke="#374151" stroke-width="1.5"/><line x1="100.43" y1="165" x2="100.43" y2="14" stroke="#374151" stroke-width="1.5"/><text x="57.29" y="93.33" font-size="7.5" fill="#374151" text-anchor="middle">-1</text><text x="143.57" y="93.33" font-size="7.5" fill="#374151" text-anchor="middle">1</text><text x="186.71" y="93.33" font-size="7.5" fill="#374151" text-anchor="middle">2</text><text x="96.43" y="147.51" font-size="7.5" fill="#374151" text-anchor="end">-5</text><text x="96.43" y="24.15" font-size="7.5" fill="#374151" text-anchor="end">5</text><text x="96.43" y="93.33" font-size="6.5" fill="#374151" text-anchor="end">0</text><polyline points="37.88,161.67 206.12,17.33" fill="none" stroke="#9ca3af" stroke-width="1.5"/><circle cx="57.29" cy="145.01" r="4" fill="#2563eb"/><text x="64.29" y="138.01" font-size="10.5" fill="#2563eb" font-weight="700" text-anchor="start">(-1, -5)</text><circle cx="186.71" cy="33.99" r="4" fill="#2563eb"/><text x="179.71" y="26.99" font-size="10.5" fill="#2563eb" font-weight="700" text-anchor="end">(2, 4)</text></svg>' },

        // Blok 5 — [DIAGRAM] reisgrafieke / afstand-tyd-grafieke vertolk (Hard)
        { difficulty: 'Hard', question: 'Die afstand-tyd-grafiek wys ʼn huurmotor wat teen ʼn konstante spoed van 60 km/h vir 2,5 uur ry. Watter afstand lê die huurmotor af?', checkMode: 'auto', options: ['150 km', '24 km', '150 km/h', '120 km'], correctIndex: 0, explanation: 'Afstand = spoed × tyd = 60 × 2,5 = 150 km. (24 km deel in plaas daarvan om te vermenigvuldig; 150 km/h verwar die eenheid; 120 km lees die tyd verkeerd as 2 uur in plaas van 2,5.)', diagramSvg: '<svg viewBox="0 0 220 195" xmlns="http://www.w3.org/2000/svg"><line x1="78" y1="14" x2="78" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="127.25" x2="210" y2="127.25" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="122" y1="14" x2="122" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="89.5" x2="210" y2="89.5" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="166" y1="14" x2="166" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="51.75" x2="210" y2="51.75" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="210" y1="14" x2="210" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="14" x2="210" y2="14" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="165" x2="216" y2="165" stroke="#374151" stroke-width="1.5"/><line x1="34" y1="165" x2="34" y2="10" stroke="#374151" stroke-width="1.5"/><text x="122" y="193" font-size="8" fill="#374151" text-anchor="middle">tyd (ure)</text><text x="8" y="89.5" font-size="8" fill="#374151" text-anchor="middle" transform="rotate(-90 8 89.5)">afstand (km)</text><polyline points="34,165 187.04,33.7" fill="none" stroke="#16a34a" stroke-width="2.5"/><circle cx="34" cy="165" r="3" fill="#0f1f3d"/><circle cx="187.04" cy="33.7" r="3" fill="#0f1f3d"/><text x="118.52" y="93.35" font-size="10.5" fill="#2563eb" font-weight="700" text-anchor="start">60 km/h</text><text x="187.04" y="175" font-size="8" fill="#2563eb" font-weight="700" text-anchor="middle">2,5 u</text></svg>' },
        { difficulty: 'Hard', question: 'Die afstand-tyd-grafiek wys ʼn reguit lyn vanaf (0, 0) na (3, 180), waar x tyd in ure is en y afstand in kilometer is. Vind die spoed wat deur die grafiek voorgestel word.', checkMode: 'auto', options: ['180 km/h', '60 km/h', '540 km/h', '3 km/h'], correctIndex: 1, explanation: 'Spoed = gradiënt = (180 − 0) ÷ (3 − 0) = 180 ÷ 3 = 60 km/h. (180 km/h vergeet om deur die tyd te deel; 540 km/h vermenigvuldig in plaas daarvan om te deel; 3 km/h verwar die tydwaarde met die spoed.)', diagramSvg: '<svg viewBox="0 0 220 195" xmlns="http://www.w3.org/2000/svg"><line x1="78" y1="14" x2="78" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="127.25" x2="210" y2="127.25" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="122" y1="14" x2="122" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="89.5" x2="210" y2="89.5" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="166" y1="14" x2="166" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="51.75" x2="210" y2="51.75" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="210" y1="14" x2="210" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="14" x2="210" y2="14" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="165" x2="216" y2="165" stroke="#374151" stroke-width="1.5"/><line x1="34" y1="165" x2="34" y2="10" stroke="#374151" stroke-width="1.5"/><text x="122" y="193" font-size="8" fill="#374151" text-anchor="middle">tyd (ure)</text><text x="8" y="89.5" font-size="8" fill="#374151" text-anchor="middle" transform="rotate(-90 8 89.5)">afstand (km)</text><polyline points="34,165 187.04,33.7" fill="none" stroke="#16a34a" stroke-width="2.5"/><circle cx="34" cy="165" r="4" fill="#2563eb"/><text x="40" y="159" font-size="10.5" fill="#2563eb" font-weight="700" text-anchor="start">(0, 0)</text><circle cx="187.04" cy="33.7" r="4" fill="#2563eb"/><text x="181.04" y="27.7" font-size="10.5" fill="#2563eb" font-weight="700" text-anchor="end">(3, 180)</text></svg>' },
        { difficulty: 'Hard', question: 'Die reisgrafiek wys ʼn fietsryer wat teen ʼn konstante 80 km/h vir 2 uur ry, dan vir 1 uur rus, en dan die laaste 150 km van die reis in 2,5 uur aflê. Vind die fietsryer se spoed op die laaste gedeelte van die reis.', checkMode: 'auto', options: ['375 km/h', '80 km/h', '60 km/h', '30 km/h'], correctIndex: 2, explanation: "Spoed = afstand ÷ tyd = 150 ÷ 2,5 = 60 km/h. (375 km/h vermenigvuldig in plaas daarvan om te deel; 80 km/h verwar dit met die eerste gedeelte se spoed; 30 km/h deel deur die verkeerde tydsinterval.)", diagramSvg: '<svg viewBox="0 0 220 195" xmlns="http://www.w3.org/2000/svg"><line x1="78" y1="14" x2="78" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="127.25" x2="210" y2="127.25" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="122" y1="14" x2="122" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="89.5" x2="210" y2="89.5" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="166" y1="14" x2="166" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="51.75" x2="210" y2="51.75" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="210" y1="14" x2="210" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="14" x2="210" y2="14" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="165" x2="216" y2="165" stroke="#374151" stroke-width="1.5"/><line x1="34" y1="165" x2="34" y2="10" stroke="#374151" stroke-width="1.5"/><text x="122" y="193" font-size="8" fill="#374151" text-anchor="middle">tyd (ure)</text><text x="8" y="89.5" font-size="8" fill="#374151" text-anchor="middle" transform="rotate(-90 8 89.5)">afstand (km)</text><polyline points="34,165 91.14,97.23" fill="none" stroke="#16a34a" stroke-width="2.5"/><text x="58.57" y="123.12" font-size="9.5" fill="#2563eb" font-weight="700" text-anchor="middle">80 km/h</text><polyline points="91.14,97.23 119.71,97.23" fill="none" stroke="#16a34a" stroke-width="2.5"/><text x="105.43" y="91.23" font-size="9" fill="#2563eb" font-weight="700" text-anchor="middle">rus 1 u</text><polyline points="119.71,97.23 191.14,33.7" fill="none" stroke="#16a34a" stroke-width="2.5"/><text x="151.43" y="57.46" font-size="9.5" fill="#2563eb" font-weight="700" text-anchor="middle">150 km</text><circle cx="34" cy="165" r="2.8" fill="#0f1f3d"/><circle cx="91.14" cy="97.23" r="2.8" fill="#0f1f3d"/><circle cx="119.71" cy="97.23" r="2.8" fill="#0f1f3d"/><circle cx="191.14" cy="33.7" r="2.8" fill="#0f1f3d"/><text x="91.14" y="175" font-size="7.5" fill="#374151" text-anchor="middle">2 u</text><text x="191.14" y="175" font-size="7.5" fill="#374151" text-anchor="middle">5,5 u</text></svg>' },
        { difficulty: 'Hard', question: 'Die reisgrafiek wys ʼn bus wat teen 80 km/h vir 2 uur ry, en dan teen 50 km/h vir ʼn verdere 1,5 uur. Vind die totale afstand afgelê.', checkMode: 'auto', options: ['160 km', '130 km', '260 km', '235 km'], correctIndex: 3, explanation: 'Eerste gedeelte: 80 × 2 = 160 km. Tweede gedeelte: 50 × 1,5 = 75 km. Totaal: 160 + 75 = 235 km. (160 km vergeet die tweede gedeelte; 130 km tel die spoed op in plaas van die afstande; 260 km lees die tweede gedeelte verkeerd as 2 uur in plaas van 1,5.)', diagramSvg: '<svg viewBox="0 0 220 195" xmlns="http://www.w3.org/2000/svg"><line x1="78" y1="14" x2="78" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="127.25" x2="210" y2="127.25" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="122" y1="14" x2="122" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="89.5" x2="210" y2="89.5" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="166" y1="14" x2="166" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="51.75" x2="210" y2="51.75" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="210" y1="14" x2="210" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="14" x2="210" y2="14" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="165" x2="216" y2="165" stroke="#374151" stroke-width="1.5"/><line x1="34" y1="165" x2="34" y2="10" stroke="#374151" stroke-width="1.5"/><text x="122" y="193" font-size="8" fill="#374151" text-anchor="middle">tyd (ure)</text><text x="8" y="89.5" font-size="8" fill="#374151" text-anchor="middle" transform="rotate(-90 8 89.5)">afstand (km)</text><polyline points="34,165 123.8,75.6" fill="none" stroke="#16a34a" stroke-width="2.5"/><text x="74.9" y="112.3" font-size="9.5" fill="#2563eb" font-weight="700" text-anchor="middle">80 km/h</text><polyline points="123.8,75.6 191.14,33.7" fill="none" stroke="#16a34a" stroke-width="2.5"/><text x="153.47" y="46.65" font-size="9.5" fill="#2563eb" font-weight="700" text-anchor="middle">50 km/h</text><circle cx="34" cy="165" r="2.8" fill="#0f1f3d"/><circle cx="123.8" cy="75.6" r="2.8" fill="#0f1f3d"/><circle cx="191.14" cy="33.7" r="2.8" fill="#0f1f3d"/><text x="123.8" y="175" font-size="7.5" fill="#374151" text-anchor="middle">2 u</text><text x="191.14" y="175" font-size="7.5" fill="#374151" text-anchor="middle">3,5 u</text></svg>' },

        // Blok 6 — woordprobleem-toepassing, albei afsnypunte, foutopsporing (Hard)
        { difficulty: 'Hard', question: 'ʼn Loodgieter hef fooie volgens die formule K = 15n + 200, waar K die totale koste in rand is en n die aantal ure gewerk is. Vind die koste van ʼn werk wat 10 uur neem.', checkMode: 'auto', options: ['R350', 'R200', 'R150', 'R365'], correctIndex: 0, explanation: 'Vervang n = 10: K = 15(10) + 200 = 150 + 200 = 350. Die koste is R350. (R200 vergeet die uurlikse tarief; R150 vergeet die uitroepfooi; R365 kom van ʼn vermenigvuldigingsfout.)' },
        ...
        { difficulty: 'Hard', question: 'Thandiwe sê die lyn y = −2x + 8 het ʼn gradiënt van 2. Wat is die werklike gradiënt van die lyn?', checkMode: 'auto', options: ['2', '-2', '8', '-8'], correctIndex: 1, explanation: 'In y = mx + c is die koëffisiënt van x die gradiënt. Hier is m = −2, dus is die gradiënt −2, nie 2 soos Thandiwe sê nie — sy het die verkeerde teken. Die negatiewe teken beteken die lyn daal van links na regs. (8 en −8 verwar die y-afsny met die gradiënt.)' },
        { difficulty: 'Hard', question: 'ʼn Fietsryer moet 240 km teen ʼn konstante gemiddelde spoed van 60 km/h reis. Hoe lank sal die reis neem?', checkMode: 'auto', options: ['60 uur', '4 minute', '4 uur', '0,25 uur'], correctIndex: 2, explanation: 'Tyd = afstand ÷ spoed = 240 ÷ 60 = 4 uur. (60 uur verwar die spoed met die tyd; 4 minute kry die regte getal, maar die verkeerde eenheid; 0,25 uur keer die deling om.)' },
],
      scoreMessages: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // Blok 1 — y-afsny / x-afsny vanaf vergelyking (Easy)
        { difficulty: 'Easy', question: 'Vind die y-afsny van y = 5x + 6.', checkMode: 'auto', options: ['6', '5', '-6', '11'], correctIndex: 0, explanation: 'Stel x = 0: y = 5(0) + 6 = 6. Die y-afsny is 6. (5 is die gradiënt, nie die afsny nie; −6 keer die teken om; 11 tel die gradiënt en afsny verkeerdelik op.)' },
        { difficulty: 'Easy', question: 'Vind die x-afsny van y = 4x − 12.', checkMode: 'auto', options: ['-3', '3', '12', '8'], correctIndex: 1, explanation: 'Stel y = 0: 0 = 4x − 12. Dus 4x = 12, x = 3. Die x-afsny is 3. (−3 keer die teken om; 12 verwar die konstante term met die afsny; 8 is ʼn aftrekkingsfout.)' },

        // Blok 2 — gradiënt tussen twee punte (Easy-Medium)
        { difficulty: 'Easy-Medium', question: 'Vind die gradiënt van die lyn deur (1, 6) en (4, 18).', checkMode: 'auto', options: ['-4', '12', '4', '3'], correctIndex: 2, explanation: 'Gradiënt = (18 − 6) ÷ (4 − 1) = 12 ÷ 3 = 4. (−4 keer die teken om; 12 vergeet om deur Δx te deel; 3 verwar Δx self met die gradiënt.)' },
        { difficulty: 'Easy-Medium', question: 'Vind die gradiënt van die lyn deur (−2, 1) en (2, 13).', checkMode: 'auto', options: ['-3', '12', '4', '3'], correctIndex: 3, explanation: 'Gradiënt = (13 − 1) ÷ (2 − (−2)) = 12 ÷ 4 = 3. (−3 keer die teken om; 12 vergeet om deur Δx te deel; 4 verwar Δx met die gradiënt.)' },
        { difficulty: 'Medium', question: 'Vind die gradiënt van die lyn deur (0, 5) en (5, −5).', checkMode: 'auto', options: ['-2', '2', '-10', '5'], correctIndex: 0, explanation: 'Gradiënt = (−5 − 5) ÷ (5 − 0) = −10 ÷ 5 = −2. (2 keer die teken om; −10 vergeet om deur Δx te deel; 5 verwar Δx met die gradiënt.)' },

        // Blok 3 — vergelyking van ʼn lyn y = mx + c (Medium)
        { difficulty: 'Medium', question: 'ʼn Lyn het ʼn gradiënt van 7 en ʼn y-afsny van −5. Skryf sy vergelyking.', checkMode: 'auto', options: ['y=-5x+7', 'y=7x-5', 'y=7x+5', 'y=-7x-5'], correctIndex: 1, explanation: 'Deur y = mx + c te gebruik met m = 7 en c = −5: y = 7x − 5. (Die afleiers verwissel m en c, of keer ʼn teken om.)' },
        { difficulty: 'Medium', question: 'ʼn Lyn gaan deur (0, 4) en (3, 25). Vind sy vergelyking.', checkMode: 'auto', options: ['y=4x+7', 'y=7x-4', 'y=7x+4', 'y=21x+4'], correctIndex: 2, explanation: 'y-afsny: (0, 4) het x = 0, dus c = 4. Gradiënt: m = (25 − 4) ÷ (3 − 0) = 21 ÷ 3 = 7. Vergelyking: y = 7x + 4. (Die afleiers verwissel m en c, keer die teken van c om, of vergeet om Δy deur Δx te deel.)' },
        { difficulty: 'Medium', question: 'ʼn Lyn gaan deur (1, 9) en (4, 18). Vind sy vergelyking.', checkMode: 'auto', options: ['y=6x+3', 'y=3x-6', 'y=9x+6', 'y=3x+6'], correctIndex: 3, explanation: 'Gradiënt: m = (18 − 9) ÷ (4 − 1) = 9 ÷ 3 = 3. Vervang (1, 9): 9 = 3(1) + c, dus c = 6. Vergelyking: y = 3x + 6. (Die afleiers verwissel m en c, keer die teken van c om, of vergeet om Δy deur Δx te deel.)' },
        { difficulty: 'Medium', question: 'Vind die x-afsny van y = −5x + 20.', checkMode: 'auto', options: ['4', '-4', '20', '5'], correctIndex: 0, explanation: 'Stel y = 0: 0 = −5x + 20. Dus 5x = 20, x = 4. Die x-afsny is 4. (−4 keer die teken om; 20 verwar die konstante met die afsny; 5 verwar die gradiënt met die afsny.)' },

        // Blok 4 — [DIAGRAM] gradiënt/x-afsny/vergelyking van beskryfde getekende lyn aflees (Medium-Hard)
        { difficulty: 'Medium-Hard', question: 'Die getoonde grafiek is ʼn reguit lyn wat deur (0, 4) en (2, 14) gaan. Vind die gradiënt van die lyn.', checkMode: 'auto', options: ['10', '5', '-5', '4'], correctIndex: 1, explanation: 'Gradiënt = (14 − 4) ÷ (2 − 0) = 10 ÷ 2 = 5. (10 vergeet om deur Δx te deel; −5 keer die teken om; 4 verwar die y-afsny wat van die grafiek afgelees is met die gradiënt.)', diagramSvg: '<svg viewBox="0 0 220 195" xmlns="http://www.w3.org/2000/svg"><line x1="57.29" y1="14" x2="57.29" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="122" y1="14" x2="122" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="186.71" y1="14" x2="186.71" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="145.01" x2="210" y2="145.01" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="105.36" x2="210" y2="105.36" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="65.71" x2="210" y2="65.71" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="26.05" x2="210" y2="26.05" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="145.01" x2="210" y2="145.01" stroke="#374151" stroke-width="1.5"/><line x1="57.29" y1="165" x2="57.29" y2="14" stroke="#374151" stroke-width="1.5"/><text x="122" y="155.01" font-size="7.5" fill="#374151" text-anchor="middle">1</text><text x="186.71" y="155.01" font-size="7.5" fill="#374151" text-anchor="middle">2</text><text x="53.29" y="107.86" font-size="7.5" fill="#374151" text-anchor="end">5</text><text x="53.29" y="68.21" font-size="7.5" fill="#374151" text-anchor="end">10</text><text x="53.29" y="28.55" font-size="7.5" fill="#374151" text-anchor="end">15</text><text x="53.29" y="155.01" font-size="6.5" fill="#374151" text-anchor="end">0</text><polyline points="37.88,125.19 206.12,22.09" fill="none" stroke="#9ca3af" stroke-width="1.5"/><circle cx="57.29" cy="113.29" r="4" fill="#2563eb"/><text x="64.29" y="106.29" font-size="10.5" fill="#2563eb" font-weight="700" text-anchor="start">(0, 4)</text><circle cx="186.71" cy="33.99" r="4" fill="#2563eb"/><text x="179.71" y="26.99" font-size="10.5" fill="#2563eb" font-weight="700" text-anchor="end">(2, 14)</text></svg>' },
        { difficulty: 'Medium-Hard', question: 'Die getoonde grafiek is ʼn reguit lyn wat deur (0, 8) en (6, −4) gaan. Vind die x-afsny van die lyn.', checkMode: 'auto', options: ['8', '-4', '4', '6'], correctIndex: 2, explanation: 'Gradiënt = (−4 − 8) ÷ (6 − 0) = −12 ÷ 6 = −2. Vergelyking: y = −2x + 8. Stel y = 0: 0 = −2x + 8, dus x = 4. (8 verwar die y-afsny met die x-afsny; −4 keer die teken om; 6 verwar die x-koördinaat van die punt met die afsny.)', diagramSvg: '<svg viewBox="0 0 220 195" xmlns="http://www.w3.org/2000/svg"><line x1="57.29" y1="14" x2="57.29" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="100.43" y1="14" x2="100.43" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="143.57" y1="14" x2="143.57" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="186.71" y1="14" x2="186.71" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="154.27" x2="210" y2="154.27" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="108" x2="210" y2="108" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="61.74" x2="210" y2="61.74" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="15.48" x2="210" y2="15.48" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="108" x2="210" y2="108" stroke="#374151" stroke-width="1.5"/><line x1="57.29" y1="165" x2="57.29" y2="14" stroke="#374151" stroke-width="1.5"/><text x="100.43" y="118" font-size="7.5" fill="#374151" text-anchor="middle">2</text><text x="143.57" y="118" font-size="7.5" fill="#374151" text-anchor="middle">4</text><text x="186.71" y="118" font-size="7.5" fill="#374151" text-anchor="middle">6</text><text x="53.29" y="156.77" font-size="7.5" fill="#374151" text-anchor="end">-5</text><text x="53.29" y="64.24" font-size="7.5" fill="#374151" text-anchor="end">5</text><text x="53.29" y="17.98" font-size="7.5" fill="#374151" text-anchor="end">10</text><text x="53.29" y="118" font-size="6.5" fill="#374151" text-anchor="end">0</text><polyline points="37.88,17.33 206.12,161.67" fill="none" stroke="#9ca3af" stroke-width="1.5"/><circle cx="57.29" cy="33.99" r="4" fill="#2563eb"/><text x="64.29" y="26.99" font-size="10.5" fill="#2563eb" font-weight="700" text-anchor="start">(0, 8)</text><circle cx="186.71" cy="145.01" r="4" fill="#2563eb"/><text x="179.71" y="138.01" font-size="10.5" fill="#2563eb" font-weight="700" text-anchor="end">(6, -4)</text></svg>' },
        { difficulty: 'Hard', question: 'Die getoonde grafiek is ʼn reguit lyn wat deur (−2, −7) en (1, 2) gaan. Vind die vergelyking van die lyn.', checkMode: 'auto', options: ['y=-x+3', 'y=3x+1', 'y=9x-1', 'y=3x-1'], correctIndex: 3, explanation: 'Gradiënt: m = (2 − (−7)) ÷ (1 − (−2)) = 9 ÷ 3 = 3. Vervang (1, 2): 2 = 3(1) + c, dus c = −1. Vergelyking: y = 3x − 1. (Die afleiers verwissel m en c, keer die teken van c om, of vergeet om Δy deur Δx te deel.)', diagramSvg: '<svg viewBox="0 0 220 195" xmlns="http://www.w3.org/2000/svg"><line x1="57.29" y1="14" x2="57.29" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="100.43" y1="14" x2="100.43" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="143.57" y1="14" x2="143.57" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="186.71" y1="14" x2="186.71" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="120.34" x2="210" y2="120.34" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="58.66" x2="210" y2="58.66" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="58.66" x2="210" y2="58.66" stroke="#374151" stroke-width="1.5"/><line x1="143.57" y1="165" x2="143.57" y2="14" stroke="#374151" stroke-width="1.5"/><text x="57.29" y="68.66" font-size="7.5" fill="#374151" text-anchor="middle">-2</text><text x="100.43" y="68.66" font-size="7.5" fill="#374151" text-anchor="middle">-1</text><text x="186.71" y="68.66" font-size="7.5" fill="#374151" text-anchor="middle">1</text><text x="139.57" y="122.84" font-size="7.5" fill="#374151" text-anchor="end">-5</text><text x="139.57" y="68.66" font-size="6.5" fill="#374151" text-anchor="end">0</text><polyline points="37.88,161.67 206.12,17.33" fill="none" stroke="#9ca3af" stroke-width="1.5"/><circle cx="57.29" cy="145.01" r="4" fill="#2563eb"/><text x="64.29" y="138.01" font-size="10.5" fill="#2563eb" font-weight="700" text-anchor="start">(-2, -7)</text><circle cx="186.71" cy="33.99" r="4" fill="#2563eb"/><text x="179.71" y="26.99" font-size="10.5" fill="#2563eb" font-weight="700" text-anchor="end">(1, 2)</text></svg>' },

        // Blok 5 — [DIAGRAM] reisgrafieke / afstand-tyd-grafieke vertolk (Hard)
        { difficulty: 'Hard', question: 'Die afstand-tyd-grafiek wys ʼn huurmotor wat teen ʼn konstante spoed van 50 km/h vir 3,5 uur ry. Watter afstand lê die huurmotor af?', checkMode: 'auto', options: ['175 km', '53,5 km', '150 km', '175 km/h'], correctIndex: 0, explanation: 'Afstand = spoed × tyd = 50 × 3,5 = 175 km. (53,5 km tel op in plaas daarvan om te vermenigvuldig; 150 km lees die tyd verkeerd as 3 uur in plaas van 3,5; 175 km/h verwar die eenheid.)', diagramSvg: '<svg viewBox="0 0 220 195" xmlns="http://www.w3.org/2000/svg"><line x1="78" y1="14" x2="78" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="127.25" x2="210" y2="127.25" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="122" y1="14" x2="122" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="89.5" x2="210" y2="89.5" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="166" y1="14" x2="166" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="51.75" x2="210" y2="51.75" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="210" y1="14" x2="210" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="14" x2="210" y2="14" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="165" x2="216" y2="165" stroke="#374151" stroke-width="1.5"/><line x1="34" y1="165" x2="34" y2="10" stroke="#374151" stroke-width="1.5"/><text x="122" y="193" font-size="8" fill="#374151" text-anchor="middle">tyd (ure)</text><text x="8" y="89.5" font-size="8" fill="#374151" text-anchor="middle" transform="rotate(-90 8 89.5)">afstand (km)</text><polyline points="34,165 187.04,33.7" fill="none" stroke="#16a34a" stroke-width="2.5"/><circle cx="34" cy="165" r="3" fill="#0f1f3d"/><circle cx="187.04" cy="33.7" r="3" fill="#0f1f3d"/><text x="118.52" y="93.35" font-size="10.5" fill="#2563eb" font-weight="700" text-anchor="start">50 km/h</text><text x="187.04" y="175" font-size="8" fill="#2563eb" font-weight="700" text-anchor="middle">3,5 u</text></svg>' },
        { difficulty: 'Hard', question: 'Die afstand-tyd-grafiek wys ʼn reguit lyn vanaf (0, 0) na (4, 220), waar x tyd in ure is en y afstand in kilometer is. Vind die spoed wat deur die grafiek voorgestel word.', checkMode: 'auto', options: ['220 km/h', '55 km/h', '880 km/h', '4 km/h'], correctIndex: 1, explanation: 'Spoed = gradiënt = (220 − 0) ÷ (4 − 0) = 220 ÷ 4 = 55 km/h. (220 km/h vergeet om deur die tyd te deel; 880 km/h vermenigvuldig in plaas daarvan om te deel; 4 km/h verwar die tydwaarde met die spoed.)', diagramSvg: '<svg viewBox="0 0 220 195" xmlns="http://www.w3.org/2000/svg"><line x1="78" y1="14" x2="78" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="127.25" x2="210" y2="127.25" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="122" y1="14" x2="122" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="89.5" x2="210" y2="89.5" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="166" y1="14" x2="166" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="51.75" x2="210" y2="51.75" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="210" y1="14" x2="210" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="14" x2="210" y2="14" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="165" x2="216" y2="165" stroke="#374151" stroke-width="1.5"/><line x1="34" y1="165" x2="34" y2="10" stroke="#374151" stroke-width="1.5"/><text x="122" y="193" font-size="8" fill="#374151" text-anchor="middle">tyd (ure)</text><text x="8" y="89.5" font-size="8" fill="#374151" text-anchor="middle" transform="rotate(-90 8 89.5)">afstand (km)</text><polyline points="34,165 187.04,33.7" fill="none" stroke="#16a34a" stroke-width="2.5"/><circle cx="34" cy="165" r="4" fill="#2563eb"/><text x="40" y="159" font-size="10.5" fill="#2563eb" font-weight="700" text-anchor="start">(0, 0)</text><circle cx="187.04" cy="33.7" r="4" fill="#2563eb"/><text x="181.04" y="27.7" font-size="10.5" fill="#2563eb" font-weight="700" text-anchor="end">(4, 220)</text></svg>' },
        { difficulty: 'Hard', question: 'Die reisgrafiek wys ʼn fietsryer wat teen ʼn konstante 70 km/h vir 1,5 uur ry, dan vir 0,5 uur rus, en dan die laaste 120 km van die reis in 2 uur aflê. Vind die fietsryer se spoed op die laaste gedeelte van die reis.', checkMode: 'auto', options: ['240 km/h', '70 km/h', '60 km/h', '24 km/h'], correctIndex: 2, explanation: "Spoed = afstand ÷ tyd = 120 ÷ 2 = 60 km/h. (240 km/h vermenigvuldig in plaas daarvan om te deel; 70 km/h verwar dit met die eerste gedeelte se spoed; 24 km/h deel deur die verkeerde tydsinterval.)", diagramSvg: '<svg viewBox="0 0 220 195" xmlns="http://www.w3.org/2000/svg"><line x1="78" y1="14" x2="78" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="127.25" x2="210" y2="127.25" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="122" y1="14" x2="122" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="89.5" x2="210" y2="89.5" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="166" y1="14" x2="166" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="51.75" x2="210" y2="51.75" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="210" y1="14" x2="210" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="14" x2="210" y2="14" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="165" x2="216" y2="165" stroke="#374151" stroke-width="1.5"/><line x1="34" y1="165" x2="34" y2="10" stroke="#374151" stroke-width="1.5"/><text x="122" y="193" font-size="8" fill="#374151" text-anchor="middle">tyd (ure)</text><text x="8" y="89.5" font-size="8" fill="#374151" text-anchor="middle" transform="rotate(-90 8 89.5)">afstand (km)</text><polyline points="34,165 92.93,103.72" fill="none" stroke="#16a34a" stroke-width="2.5"/><text x="59.46" y="126.36" font-size="9.5" fill="#2563eb" font-weight="700" text-anchor="middle">70 km/h</text><polyline points="92.93,103.72 112.57,103.72" fill="none" stroke="#16a34a" stroke-width="2.5"/><text x="102.75" y="97.72" font-size="9" fill="#2563eb" font-weight="700" text-anchor="middle">rus 0,5 u</text><polyline points="112.57,103.72 191.14,33.7" fill="none" stroke="#16a34a" stroke-width="2.5"/><text x="147.86" y="60.71" font-size="9.5" fill="#2563eb" font-weight="700" text-anchor="middle">120 km</text><circle cx="34" cy="165" r="2.8" fill="#0f1f3d"/><circle cx="92.93" cy="103.72" r="2.8" fill="#0f1f3d"/><circle cx="112.57" cy="103.72" r="2.8" fill="#0f1f3d"/><circle cx="191.14" cy="33.7" r="2.8" fill="#0f1f3d"/><text x="92.93" y="175" font-size="7.5" fill="#374151" text-anchor="middle">1,5 u</text><text x="191.14" y="175" font-size="7.5" fill="#374151" text-anchor="middle">4 u</text></svg>' },
        { difficulty: 'Hard', question: 'Die reisgrafiek wys ʼn bus wat teen 60 km/h vir 3 uur ry, en dan teen 40 km/h vir ʼn verdere 2 uur. Vind die totale afstand afgelê.', checkMode: 'auto', options: ['180 km', '100 km', '220 km', '260 km'], correctIndex: 3, explanation: 'Eerste gedeelte: 60 × 3 = 180 km. Tweede gedeelte: 40 × 2 = 80 km. Totaal: 180 + 80 = 260 km. (180 km vergeet die tweede gedeelte; 100 km tel die spoed op in plaas van die afstande; 220 km lees die tweede gedeelte verkeerd as 1 uur in plaas van 2.)', diagramSvg: '<svg viewBox="0 0 220 195" xmlns="http://www.w3.org/2000/svg"><line x1="78" y1="14" x2="78" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="127.25" x2="210" y2="127.25" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="122" y1="14" x2="122" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="89.5" x2="210" y2="89.5" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="166" y1="14" x2="166" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="51.75" x2="210" y2="51.75" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="210" y1="14" x2="210" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="14" x2="210" y2="14" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="165" x2="216" y2="165" stroke="#374151" stroke-width="1.5"/><line x1="34" y1="165" x2="34" y2="10" stroke="#374151" stroke-width="1.5"/><text x="122" y="193" font-size="8" fill="#374151" text-anchor="middle">tyd (ure)</text><text x="8" y="89.5" font-size="8" fill="#374151" text-anchor="middle" transform="rotate(-90 8 89.5)">afstand (km)</text><polyline points="34,165 128.29,74.1" fill="none" stroke="#16a34a" stroke-width="2.5"/><text x="77.14" y="111.55" font-size="9.5" fill="#2563eb" font-weight="700" text-anchor="middle">60 km/h</text><polyline points="128.29,74.1 191.14,33.7" fill="none" stroke="#16a34a" stroke-width="2.5"/><text x="155.71" y="45.9" font-size="9.5" fill="#2563eb" font-weight="700" text-anchor="middle">40 km/h</text><circle cx="34" cy="165" r="2.8" fill="#0f1f3d"/><circle cx="128.29" cy="74.1" r="2.8" fill="#0f1f3d"/><circle cx="191.14" cy="33.7" r="2.8" fill="#0f1f3d"/><text x="128.29" y="175" font-size="7.5" fill="#374151" text-anchor="middle">3 u</text><text x="191.14" y="175" font-size="7.5" fill="#374151" text-anchor="middle">5 u</text></svg>' },

        // Blok 6 — woordprobleem-toepassing, albei afsnypunte, foutopsporing (Hard)
        { difficulty: 'Hard', question: 'ʼn Loodgieter hef fooie volgens die formule K = 20n + 150, waar K die totale koste in rand is en n die aantal ure gewerk is. Vind die koste van ʼn werk wat 8 uur neem.', checkMode: 'auto', options: ['R310', 'R150', 'R160', 'R330'], correctIndex: 0, explanation: 'Vervang n = 8: K = 20(8) + 150 = 160 + 150 = 310. Die koste is R310. (R150 vergeet die uurlikse tarief; R160 vergeet die uitroepfooi; R330 kom van ʼn vermenigvuldigingsfout.)' },
        ...
        { difficulty: 'Hard', question: 'Katlego sê die lyn y = −3x + 9 het ʼn gradiënt van 3. Wat is die werklike gradiënt van die lyn?', checkMode: 'auto', options: ['3', '-3', '9', '-9'], correctIndex: 1, explanation: 'In y = mx + c is die koëffisiënt van x die gradiënt. Hier is m = −3, dus is die gradiënt −3, nie 3 soos Katlego sê nie — hy het die verkeerde teken. Die negatiewe teken beteken die lyn daal van links na regs. (9 en −9 verwar die y-afsny met die gradiënt.)' },
        { difficulty: 'Hard', question: 'ʼn Fietsryer moet 210 km teen ʼn konstante gemiddelde spoed van 70 km/h reis. Hoe lank sal die reis neem?', checkMode: 'auto', options: ['70 uur', '3 minute', '3 uur', '0,33 uur'], correctIndex: 2, explanation: 'Tyd = afstand ÷ spoed = 210 ÷ 70 = 3 uur. (70 uur verwar die spoed met die tyd; 3 minute kry die regte getal, maar die verkeerde eenheid; 0,33 uur keer die deling om.)' },
],
      scoreMessages: [
        { minScore: 20, message: 'Uitstekend! Jy het gradiënte, vergelykings van lyne en die vertolking van grafieke bemeester.' },
        { minScore: 15, message: 'Puik werk! Gaan enige gemiste vrae oor reisgrafieke of vergelykings van lyne na en probeer weer.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // Blok 1 — y-afsny / x-afsny vanaf vergelyking (Easy)
        { difficulty: 'Easy', question: 'Vind die y-afsny van y = 2x + 11.', checkMode: 'auto', options: ['11', '2', '-11', '13'], correctIndex: 0, explanation: 'Stel x = 0: y = 2(0) + 11 = 11. Die y-afsny is 11. (2 is die gradiënt, nie die afsny nie; −11 keer die teken om; 13 tel die gradiënt en afsny verkeerdelik op.)' },
        { difficulty: 'Easy', question: 'Vind die x-afsny van y = 6x − 18.', checkMode: 'auto', options: ['-3', '3', '18', '12'], correctIndex: 1, explanation: 'Stel y = 0: 0 = 6x − 18. Dus 6x = 18, x = 3. Die x-afsny is 3. (−3 keer die teken om; 18 verwar die konstante term met die afsny; 12 is ʼn aftrekkingsfout.)' },

        // Blok 2 — gradiënt tussen twee punte (Easy-Medium)
        { difficulty: 'Easy-Medium', question: 'Vind die gradiënt van die lyn deur (3, 4) en (6, 16).', checkMode: 'auto', options: ['-4', '12', '4', '3'], correctIndex: 2, explanation: 'Gradiënt = (16 − 4) ÷ (6 − 3) = 12 ÷ 3 = 4. (−4 keer die teken om; 12 vergeet om deur Δx te deel; 3 verwar Δx self met die gradiënt.)' },
        { difficulty: 'Easy-Medium', question: 'Vind die gradiënt van die lyn deur (−3, −4) en (1, 8).', checkMode: 'auto', options: ['-3', '12', '4', '3'], correctIndex: 3, explanation: 'Gradiënt = (8 − (−4)) ÷ (1 − (−3)) = 12 ÷ 4 = 3. (−3 keer die teken om; 12 vergeet om deur Δx te deel; 4 verwar Δx met die gradiënt.)' },
        { difficulty: 'Medium', question: 'Vind die gradiënt van die lyn deur (0, 7) en (4, −1).', checkMode: 'auto', options: ['-2', '2', '-8', '4'], correctIndex: 0, explanation: 'Gradiënt = (−1 − 7) ÷ (4 − 0) = −8 ÷ 4 = −2. (2 keer die teken om; −8 vergeet om deur Δx te deel; 4 verwar Δx met die gradiënt.)' },

        // Blok 3 — vergelyking van ʼn lyn y = mx + c (Medium)
        { difficulty: 'Medium', question: 'ʼn Lyn het ʼn gradiënt van 8 en ʼn y-afsny van −6. Skryf sy vergelyking.', checkMode: 'auto', options: ['y=-6x+8', 'y=8x-6', 'y=8x+6', 'y=-8x-6'], correctIndex: 1, explanation: 'Deur y = mx + c te gebruik met m = 8 en c = −6: y = 8x − 6. (Die afleiers verwissel m en c, of keer ʼn teken om.)' },
        { difficulty: 'Medium', question: 'ʼn Lyn gaan deur (0, 3) en (5, 28). Vind sy vergelyking.', checkMode: 'auto', options: ['y=3x+5', 'y=5x-3', 'y=5x+3', 'y=25x+3'], correctIndex: 2, explanation: 'y-afsny: (0, 3) het x = 0, dus c = 3. Gradiënt: m = (28 − 3) ÷ (5 − 0) = 25 ÷ 5 = 5. Vergelyking: y = 5x + 3. (Die afleiers verwissel m en c, keer die teken van c om, of vergeet om Δy deur Δx te deel.)' },
        { difficulty: 'Medium', question: 'ʼn Lyn gaan deur (3, 14) en (6, 26). Vind sy vergelyking.', checkMode: 'auto', options: ['y=2x+4', 'y=4x-2', 'y=12x+2', 'y=4x+2'], correctIndex: 3, explanation: 'Gradiënt: m = (26 − 14) ÷ (6 − 3) = 12 ÷ 3 = 4. Vervang (3, 14): 14 = 4(3) + c, dus c = 2. Vergelyking: y = 4x + 2. (Die afleiers verwissel m en c, keer die teken van c om, of vergeet om Δy deur Δx te deel.)' },
        { difficulty: 'Medium', question: 'Vind die x-afsny van y = −6x + 24.', checkMode: 'auto', options: ['4', '-4', '24', '6'], correctIndex: 0, explanation: 'Stel y = 0: 0 = −6x + 24. Dus 6x = 24, x = 4. Die x-afsny is 4. (−4 keer die teken om; 24 verwar die konstante met die afsny; 6 verwar die gradiënt met die afsny.)' },

        // Blok 4 — [DIAGRAM] gradiënt/x-afsny/vergelyking van beskryfde getekende lyn aflees (Medium-Hard)
        { difficulty: 'Medium-Hard', question: 'Die getoonde grafiek is ʼn reguit lyn wat deur (0, −1) en (4, 11) gaan. Vind die gradiënt van die lyn.', checkMode: 'auto', options: ['12', '3', '-3', '-1'], correctIndex: 1, explanation: 'Gradiënt = (11 − (−1)) ÷ (4 − 0) = 12 ÷ 4 = 3. (12 vergeet om deur Δx te deel; −3 keer die teken om; −1 verwar die y-afsny wat van die grafiek afgelees is met die gradiënt.)', diagramSvg: '<svg viewBox="0 0 220 195" xmlns="http://www.w3.org/2000/svg"><line x1="57.29" y1="14" x2="57.29" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="122" y1="14" x2="122" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="186.71" y1="14" x2="186.71" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="135.76" x2="210" y2="135.76" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="89.5" x2="210" y2="89.5" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="43.24" x2="210" y2="43.24" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="135.76" x2="210" y2="135.76" stroke="#374151" stroke-width="1.5"/><line x1="57.29" y1="165" x2="57.29" y2="14" stroke="#374151" stroke-width="1.5"/><text x="122" y="145.76" font-size="7.5" fill="#374151" text-anchor="middle">2</text><text x="186.71" y="145.76" font-size="7.5" fill="#374151" text-anchor="middle">4</text><text x="53.29" y="92" font-size="7.5" fill="#374151" text-anchor="end">5</text><text x="53.29" y="45.74" font-size="7.5" fill="#374151" text-anchor="end">10</text><text x="53.29" y="145.76" font-size="6.5" fill="#374151" text-anchor="end">0</text><polyline points="37.88,161.67 206.12,17.33" fill="none" stroke="#9ca3af" stroke-width="1.5"/><circle cx="57.29" cy="145.01" r="4" fill="#2563eb"/><text x="64.29" y="138.01" font-size="10.5" fill="#2563eb" font-weight="700" text-anchor="start">(0, -1)</text><circle cx="186.71" cy="33.99" r="4" fill="#2563eb"/><text x="179.71" y="26.99" font-size="10.5" fill="#2563eb" font-weight="700" text-anchor="end">(4, 11)</text></svg>' },
        { difficulty: 'Medium-Hard', question: 'Die getoonde grafiek is ʼn reguit lyn wat deur (0, 9) en (5, −6) gaan. Vind die x-afsny van die lyn.', checkMode: 'auto', options: ['9', '-3', '3', '5'], correctIndex: 2, explanation: 'Gradiënt = (−6 − 9) ÷ (5 − 0) = −15 ÷ 5 = −3. Vergelyking: y = −3x + 9. Stel y = 0: 0 = −3x + 9, dus x = 3. (9 verwar die y-afsny met die x-afsny; −3 keer die teken om; 5 verwar die x-koördinaat van die punt met die afsny.)', diagramSvg: '<svg viewBox="0 0 220 195" xmlns="http://www.w3.org/2000/svg"><line x1="57.29" y1="14" x2="57.29" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="109.06" y1="14" x2="109.06" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="160.82" y1="14" x2="160.82" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="137.61" x2="210" y2="137.61" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="100.6" x2="210" y2="100.6" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="63.59" x2="210" y2="63.59" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="26.58" x2="210" y2="26.58" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="100.6" x2="210" y2="100.6" stroke="#374151" stroke-width="1.5"/><line x1="57.29" y1="165" x2="57.29" y2="14" stroke="#374151" stroke-width="1.5"/><text x="109.06" y="110.6" font-size="7.5" fill="#374151" text-anchor="middle">2</text><text x="160.82" y="110.6" font-size="7.5" fill="#374151" text-anchor="middle">4</text><text x="53.29" y="140.11" font-size="7.5" fill="#374151" text-anchor="end">-5</text><text x="53.29" y="66.09" font-size="7.5" fill="#374151" text-anchor="end">5</text><text x="53.29" y="29.08" font-size="7.5" fill="#374151" text-anchor="end">10</text><text x="53.29" y="110.6" font-size="6.5" fill="#374151" text-anchor="end">0</text><polyline points="37.88,17.33 206.12,161.67" fill="none" stroke="#9ca3af" stroke-width="1.5"/><circle cx="57.29" cy="33.99" r="4" fill="#2563eb"/><text x="64.29" y="26.99" font-size="10.5" fill="#2563eb" font-weight="700" text-anchor="start">(0, 9)</text><circle cx="186.71" cy="145.01" r="4" fill="#2563eb"/><text x="179.71" y="138.01" font-size="10.5" fill="#2563eb" font-weight="700" text-anchor="end">(5, -6)</text></svg>' },
        { difficulty: 'Hard', question: 'Die getoonde grafiek is ʼn reguit lyn wat deur (−3, −11) en (2, 4) gaan. Vind die vergelyking van die lyn.', checkMode: 'auto', options: ['y=-2x+3', 'y=3x+2', 'y=15x-2', 'y=3x-2'], correctIndex: 3, explanation: 'Gradiënt: m = (4 − (−11)) ÷ (2 − (−3)) = 15 ÷ 5 = 3. Vervang (2, 4): 4 = 3(2) + c, dus c = −2. Vergelyking: y = 3x − 2. (Die afleiers verwissel m en c, keer die teken van c om, of vergeet om Δy deur Δx te deel.)', diagramSvg: '<svg viewBox="0 0 220 195" xmlns="http://www.w3.org/2000/svg"><line x1="83.18" y1="14" x2="83.18" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="134.94" y1="14" x2="134.94" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="186.71" y1="14" x2="186.71" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="137.61" x2="210" y2="137.61" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="100.6" x2="210" y2="100.6" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="63.59" x2="210" y2="63.59" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="26.58" x2="210" y2="26.58" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="63.59" x2="210" y2="63.59" stroke="#374151" stroke-width="1.5"/><line x1="134.94" y1="165" x2="134.94" y2="14" stroke="#374151" stroke-width="1.5"/><text x="83.18" y="73.59" font-size="7.5" fill="#374151" text-anchor="middle">-2</text><text x="186.71" y="73.59" font-size="7.5" fill="#374151" text-anchor="middle">2</text><text x="130.94" y="140.11" font-size="7.5" fill="#374151" text-anchor="end">-10</text><text x="130.94" y="103.1" font-size="7.5" fill="#374151" text-anchor="end">-5</text><text x="130.94" y="29.08" font-size="7.5" fill="#374151" text-anchor="end">5</text><text x="130.94" y="73.59" font-size="6.5" fill="#374151" text-anchor="end">0</text><polyline points="37.88,161.67 206.12,17.33" fill="none" stroke="#9ca3af" stroke-width="1.5"/><circle cx="57.29" cy="145.01" r="4" fill="#2563eb"/><text x="64.29" y="138.01" font-size="10.5" fill="#2563eb" font-weight="700" text-anchor="start">(-3, -11)</text><circle cx="186.71" cy="33.99" r="4" fill="#2563eb"/><text x="179.71" y="26.99" font-size="10.5" fill="#2563eb" font-weight="700" text-anchor="end">(2, 4)</text></svg>' },

        // Blok 5 — [DIAGRAM] reisgrafieke / afstand-tyd-grafieke vertolk (Hard)
        { difficulty: 'Hard', question: 'Die afstand-tyd-grafiek wys ʼn huurmotor wat teen ʼn konstante spoed van 45 km/h vir 4 uur ry. Watter afstand lê die huurmotor af?', checkMode: 'auto', options: ['180 km', '49 km', '135 km', '180 km/h'], correctIndex: 0, explanation: 'Afstand = spoed × tyd = 45 × 4 = 180 km. (49 km tel op in plaas daarvan om te vermenigvuldig; 135 km lees die tyd verkeerd as 3 uur in plaas van 4; 180 km/h verwar die eenheid.)', diagramSvg: '<svg viewBox="0 0 220 195" xmlns="http://www.w3.org/2000/svg"><line x1="78" y1="14" x2="78" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="127.25" x2="210" y2="127.25" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="122" y1="14" x2="122" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="89.5" x2="210" y2="89.5" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="166" y1="14" x2="166" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="51.75" x2="210" y2="51.75" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="210" y1="14" x2="210" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="14" x2="210" y2="14" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="165" x2="216" y2="165" stroke="#374151" stroke-width="1.5"/><line x1="34" y1="165" x2="34" y2="10" stroke="#374151" stroke-width="1.5"/><text x="122" y="193" font-size="8" fill="#374151" text-anchor="middle">tyd (ure)</text><text x="8" y="89.5" font-size="8" fill="#374151" text-anchor="middle" transform="rotate(-90 8 89.5)">afstand (km)</text><polyline points="34,165 187.04,33.7" fill="none" stroke="#16a34a" stroke-width="2.5"/><circle cx="34" cy="165" r="3" fill="#0f1f3d"/><circle cx="187.04" cy="33.7" r="3" fill="#0f1f3d"/><text x="118.52" y="93.35" font-size="10.5" fill="#2563eb" font-weight="700" text-anchor="start">45 km/h</text><text x="187.04" y="175" font-size="8" fill="#2563eb" font-weight="700" text-anchor="middle">4 u</text></svg>' },
        { difficulty: 'Hard', question: 'Die afstand-tyd-grafiek wys ʼn reguit lyn vanaf (0, 0) na (5, 275), waar x tyd in ure is en y afstand in kilometer is. Vind die spoed wat deur die grafiek voorgestel word.', checkMode: 'auto', options: ['275 km/h', '55 km/h', '1375 km/h', '5 km/h'], correctIndex: 1, explanation: 'Spoed = gradiënt = (275 − 0) ÷ (5 − 0) = 275 ÷ 5 = 55 km/h. (275 km/h vergeet om deur die tyd te deel; 1375 km/h vermenigvuldig in plaas daarvan om te deel; 5 km/h verwar die tydwaarde met die spoed.)', diagramSvg: '<svg viewBox="0 0 220 195" xmlns="http://www.w3.org/2000/svg"><line x1="78" y1="14" x2="78" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="127.25" x2="210" y2="127.25" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="122" y1="14" x2="122" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="89.5" x2="210" y2="89.5" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="166" y1="14" x2="166" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="51.75" x2="210" y2="51.75" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="210" y1="14" x2="210" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="14" x2="210" y2="14" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="165" x2="216" y2="165" stroke="#374151" stroke-width="1.5"/><line x1="34" y1="165" x2="34" y2="10" stroke="#374151" stroke-width="1.5"/><text x="122" y="193" font-size="8" fill="#374151" text-anchor="middle">tyd (ure)</text><text x="8" y="89.5" font-size="8" fill="#374151" text-anchor="middle" transform="rotate(-90 8 89.5)">afstand (km)</text><polyline points="34,165 187.04,33.7" fill="none" stroke="#16a34a" stroke-width="2.5"/><circle cx="34" cy="165" r="4" fill="#2563eb"/><text x="40" y="159" font-size="10.5" fill="#2563eb" font-weight="700" text-anchor="start">(0, 0)</text><circle cx="187.04" cy="33.7" r="4" fill="#2563eb"/><text x="181.04" y="27.7" font-size="10.5" fill="#2563eb" font-weight="700" text-anchor="end">(5, 275)</text></svg>' },
        { difficulty: 'Hard', question: 'Die reisgrafiek wys ʼn fietsryer wat teen ʼn konstante 90 km/h vir 1 uur ry, dan vir 1,5 uur rus, en dan die laaste 100 km van die reis in 2,5 uur aflê. Vind die fietsryer se spoed op die laaste gedeelte van die reis.', checkMode: 'auto', options: ['250 km/h', '90 km/h', '40 km/h', '22,5 km/h'], correctIndex: 2, explanation: "Spoed = afstand ÷ tyd = 100 ÷ 2,5 = 40 km/h. (250 km/h vermenigvuldig in plaas daarvan om te deel; 90 km/h verwar dit met die eerste gedeelte se spoed; 22,5 km/h deel deur die verkeerde tydsinterval.)", diagramSvg: '<svg viewBox="0 0 220 195" xmlns="http://www.w3.org/2000/svg"><line x1="78" y1="14" x2="78" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="127.25" x2="210" y2="127.25" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="122" y1="14" x2="122" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="89.5" x2="210" y2="89.5" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="166" y1="14" x2="166" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="51.75" x2="210" y2="51.75" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="210" y1="14" x2="210" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="14" x2="210" y2="14" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="165" x2="216" y2="165" stroke="#374151" stroke-width="1.5"/><line x1="34" y1="165" x2="34" y2="10" stroke="#374151" stroke-width="1.5"/><text x="122" y="193" font-size="8" fill="#374151" text-anchor="middle">tyd (ure)</text><text x="8" y="89.5" font-size="8" fill="#374151" text-anchor="middle" transform="rotate(-90 8 89.5)">afstand (km)</text><polyline points="34,165 65.43,102.8" fill="none" stroke="#16a34a" stroke-width="2.5"/><text x="45.71" y="125.9" font-size="9.5" fill="#2563eb" font-weight="700" text-anchor="middle">90 km/h</text><polyline points="65.43,102.8 112.57,102.8" fill="none" stroke="#16a34a" stroke-width="2.5"/><text x="89" y="96.8" font-size="9" fill="#2563eb" font-weight="700" text-anchor="middle">rus 1,5 u</text><polyline points="112.57,102.8 191.14,33.7" fill="none" stroke="#16a34a" stroke-width="2.5"/><text x="147.86" y="60.25" font-size="9.5" fill="#2563eb" font-weight="700" text-anchor="middle">100 km</text><circle cx="34" cy="165" r="2.8" fill="#0f1f3d"/><circle cx="65.43" cy="102.8" r="2.8" fill="#0f1f3d"/><circle cx="112.57" cy="102.8" r="2.8" fill="#0f1f3d"/><circle cx="191.14" cy="33.7" r="2.8" fill="#0f1f3d"/><text x="65.43" y="175" font-size="7.5" fill="#374151" text-anchor="middle">1 u</text><text x="191.14" y="175" font-size="7.5" fill="#374151" text-anchor="middle">5 u</text></svg>' },
        { difficulty: 'Hard', question: 'Die reisgrafiek wys ʼn bus wat teen 70 km/h vir 2 uur ry, en dan teen 30 km/h vir ʼn verdere 3 uur. Vind die totale afstand afgelê.', checkMode: 'auto', options: ['140 km', '100 km', '170 km', '230 km'], correctIndex: 3, explanation: 'Eerste gedeelte: 70 × 2 = 140 km. Tweede gedeelte: 30 × 3 = 90 km. Totaal: 140 + 90 = 230 km. (140 km vergeet die tweede gedeelte; 100 km tel die spoed op in plaas van die afstande; 170 km lees die tweede gedeelte verkeerd as 1 uur in plaas van 3.)', diagramSvg: '<svg viewBox="0 0 220 195" xmlns="http://www.w3.org/2000/svg"><line x1="78" y1="14" x2="78" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="127.25" x2="210" y2="127.25" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="122" y1="14" x2="122" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="89.5" x2="210" y2="89.5" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="166" y1="14" x2="166" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="51.75" x2="210" y2="51.75" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="210" y1="14" x2="210" y2="165" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="14" x2="210" y2="14" stroke="#9ca3af" stroke-width="0.5" opacity="0.5"/><line x1="34" y1="165" x2="216" y2="165" stroke="#374151" stroke-width="1.5"/><line x1="34" y1="165" x2="34" y2="10" stroke="#374151" stroke-width="1.5"/><text x="122" y="193" font-size="8" fill="#374151" text-anchor="middle">tyd (ure)</text><text x="8" y="89.5" font-size="8" fill="#374151" text-anchor="middle" transform="rotate(-90 8 89.5)">afstand (km)</text><polyline points="34,165 96.86,85.08" fill="none" stroke="#16a34a" stroke-width="2.5"/><text x="61.43" y="117.04" font-size="9.5" fill="#2563eb" font-weight="700" text-anchor="middle">70 km/h</text><polyline points="96.86,85.08 191.14,33.7" fill="none" stroke="#16a34a" stroke-width="2.5"/><text x="140" y="51.39" font-size="9.5" fill="#2563eb" font-weight="700" text-anchor="middle">30 km/h</text><circle cx="34" cy="165" r="2.8" fill="#0f1f3d"/><circle cx="96.86" cy="85.08" r="2.8" fill="#0f1f3d"/><circle cx="191.14" cy="33.7" r="2.8" fill="#0f1f3d"/><text x="96.86" y="175" font-size="7.5" fill="#374151" text-anchor="middle">2 u</text><text x="191.14" y="175" font-size="7.5" fill="#374151" text-anchor="middle">5 u</text></svg>' },

        // Blok 6 — woordprobleem-toepassing, albei afsnypunte, foutopsporing (Hard)
        { difficulty: 'Hard', question: 'ʼn Loodgieter hef fooie volgens die formule K = 25n + 100, waar K die totale koste in rand is en n die aantal ure gewerk is. Vind die koste van ʼn werk wat 6 uur neem.', checkMode: 'auto', options: ['R250', 'R100', 'R150', 'R280'], correctIndex: 0, explanation: 'Vervang n = 6: K = 25(6) + 100 = 150 + 100 = 250. Die koste is R250. (R100 vergeet die uurlikse tarief; R150 vergeet die uitroepfooi; R280 kom van ʼn vermenigvuldigingsfout.)' },
        ...
        { difficulty: 'Hard', question: 'Amahle sê die lyn y = −4x + 16 het ʼn gradiënt van 4. Wat is die werklike gradiënt van die lyn?', checkMode: 'auto', options: ['4', '-4', '16', '-16'], correctIndex: 1, explanation: 'In y = mx + c is die koëffisiënt van x die gradiënt. Hier is m = −4, dus is die gradiënt −4, nie 4 soos Amahle sê nie — sy het die verkeerde teken. Die negatiewe teken beteken die lyn daal van links na regs. (16 en −16 verwar die y-afsny met die gradiënt.)' },
        { difficulty: 'Hard', question: 'ʼn Fietsryer moet 315 km teen ʼn konstante gemiddelde spoed van 45 km/h reis. Hoe lank sal die reis neem?', checkMode: 'auto', options: ['45 uur', '7 minute', '7 uur', '0,14 uur'], correctIndex: 2, explanation: 'Tyd = afstand ÷ spoed = 315 ÷ 45 = 7 uur. (45 uur verwar die spoed met die tyd; 7 minute kry die regte getal, maar die verkeerde eenheid; 0,14 uur keer die deling om.)' },
],
      scoreMessages: [
        { minScore: 20, message: 'Uitstekend! Jy het gradiënte, vergelykings van lyne en die vertolking van grafieke bemeester.' },
        { minScore: 15, message: 'Puik werk! Gaan enige gemiste vrae oor reisgrafieke of vergelykings van lyne na en probeer weer.' },
