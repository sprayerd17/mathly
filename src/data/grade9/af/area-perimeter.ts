  ...
  practiceSets: [
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'ʼn Sirkelvormige tafelblad het ʼn deursnee van 90 cm, soos getoon. Vind die oppervlakte daarvan (π = 3,14).', answer: '6358,5 cm²', checkMode: 'auto', correctAnswer: '6358,5cm²', correctAnswers: ['6358.5cm²', '6358.5 cm²', '6358.5', '6358.50cm²', '6358.50 cm²', '6358,5cm²', '6358,5 cm²', '6358,5', '6358,50cm²', '6358,50 cm²'], explanation: 'r = d ÷ 2 = 90 ÷ 2 = 45 cm\nO = πr² = 3,14 × 45² = 3,14 × 2025 = 6358,5 cm² ✓' , diagramSvg: '<svg viewBox="0 0 220 190" xmlns="http://www.w3.org/2000/svg"><circle cx="110" cy="95" r="60" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><circle cx="110" cy="95" r="2.5" fill="#0f1f3d"/><line x1="50" y1="95" x2="170" y2="95" stroke="#2563eb" stroke-width="2"/><text x="110" y="87" font-size="14" fill="#2563eb" font-weight="700" text-anchor="middle">d = 90 cm</text></svg>' },
        ...
        { difficulty: 'Hard', question: 'Lerato se reghoekige plakkaat, oorspronklik 60 cm by 40 cm, word herdruk met die lengte verdriedubbel en die breedte verdubbel. Vind die nuwe oppervlakte en druk dit uit as ʼn veelvoud van die oorspronklike oppervlakte.', answer: 'Nuwe afmetings: 180 cm by 80 cm. Nuwe oppervlakte = 14400 cm². Oorspronklike oppervlakte = 2400 cm². Die nuwe oppervlakte is 6 keer die oorspronklike (3 × 2 = 6, wat ooreenstem met die gekombineerde skaalfaktore).', checkMode: 'self' },
      ],
      scoreMessages: [
    ...
    },
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'ʼn Sirkelvormige tafelblad het ʼn deursnee van 120 cm, soos getoon. Vind die oppervlakte daarvan (π = 3,14).', answer: '11304 cm²', checkMode: 'auto', correctAnswer: '11304cm²', correctAnswers: ['11304cm²', '11304 cm²', '11304'], explanation: 'r = d ÷ 2 = 120 ÷ 2 = 60 cm\nO = πr² = 3,14 × 60² = 3,14 × 3600 = 11304 cm² ✓' , diagramSvg: '<svg viewBox="0 0 220 190" xmlns="http://www.w3.org/2000/svg"><circle cx="110" cy="95" r="60" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><circle cx="110" cy="95" r="2.5" fill="#0f1f3d"/><line x1="50" y1="95" x2="170" y2="95" stroke="#2563eb" stroke-width="2"/><text x="110" y="87" font-size="14" fill="#2563eb" font-weight="700" text-anchor="middle">d = 120 cm</text></svg>' },
        { difficulty: 'Medium', question: 'ʼn Sirkelvormige blombedding het ʼn radius van 5,5 m, soos getoon. Bereken die oppervlakte daarvan tot 2 desimale plekke (π = 3,14).', answer: '94,99 m²', checkMode: 'auto', correctAnswer: '94,99m²', correctAnswers: ['94.99m²', '94.99 m²', '94.99', '94,99m²', '94,99 m²', '94,99'], explanation: 'O = πr² = 3,14 × 5,5² = 3,14 × 30,25 = 94,985 ≈ 94,99 m² ✓' , diagramSvg: '<svg viewBox="0 0 220 190" xmlns="http://www.w3.org/2000/svg"><circle cx="110" cy="95" r="60" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><circle cx="110" cy="95" r="2.5" fill="#0f1f3d"/><line x1="110" y1="95" x2="170" y2="95" stroke="#2563eb" stroke-width="2"/><text x="140" y="87" font-size="14" fill="#2563eb" font-weight="700" text-anchor="middle">r = 5,5 m</text></svg>' },
        ...
        { difficulty: 'Hard', question: 'Lerato se reghoekige plakkaat, oorspronklik 50 cm by 30 cm, word herdruk met die lengte verviervoudig en die breedte verdubbel. Vind die nuwe oppervlakte en druk dit uit as ʼn veelvoud van die oorspronklike oppervlakte.', answer: 'Nuwe afmetings: 200 cm by 60 cm. Nuwe oppervlakte = 12000 cm². Oorspronklike oppervlakte = 1500 cm². Die nuwe oppervlakte is 8 keer die oorspronklike (4 × 2 = 8, wat ooreenstem met die gekombineerde skaalfaktore).', checkMode: 'self' },
      ],
      scoreMessages: [
        { minScore: 18, message: 'Uitstekend! Jy het oppervlakte, omtrek en skaalfaktorprobleme bemeester.' },
        { minScore: 14, message: 'Goeie werk! Jy het ʼn sterk begrip van hierdie vaardighede — gaan enige vrae wat jy verkeerd het weer deur en probeer nog ʼn stel.' },
    ...
    },
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'ʼn Sirkelvormige tafelblad het ʼn deursnee van 140 cm, soos getoon. Vind die oppervlakte daarvan (π = 3,14).', answer: '15386 cm²', checkMode: 'auto', correctAnswer: '15386cm²', correctAnswers: ['15386cm²', '15386 cm²', '15386'], explanation: 'r = d ÷ 2 = 140 ÷ 2 = 70 cm\nO = πr² = 3,14 × 70² = 3,14 × 4900 = 15386 cm² ✓' , diagramSvg: '<svg viewBox="0 0 220 190" xmlns="http://www.w3.org/2000/svg"><circle cx="110" cy="95" r="60" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><circle cx="110" cy="95" r="2.5" fill="#0f1f3d"/><line x1="50" y1="95" x2="170" y2="95" stroke="#2563eb" stroke-width="2"/><text x="110" y="87" font-size="14" fill="#2563eb" font-weight="700" text-anchor="middle">d = 140 cm</text></svg>' },
        ...
        { difficulty: 'Hard', question: 'Lerato se reghoekige plakkaat, oorspronklik 40 cm by 30 cm, word herdruk met die lengte met ʼn faktor van 5 vermenigvuldig en die breedte verdubbel. Vind die nuwe oppervlakte en druk dit uit as ʼn veelvoud van die oorspronklike oppervlakte.', answer: 'Nuwe afmetings: 200 cm by 60 cm. Nuwe oppervlakte = 12000 cm². Oorspronklike oppervlakte = 1200 cm². Die nuwe oppervlakte is 10 keer die oorspronklike (5 × 2 = 10, wat ooreenstem met die gekombineerde skaalfaktore).', checkMode: 'self' },
      ],
      scoreMessages: [
        { minScore: 18, message: 'Uitstekend! Jy het oppervlakte, omtrek en skaalfaktorprobleme bemeester.' },
        { minScore: 14, message: 'Goeie werk! Jy het ʼn sterk begrip van hierdie vaardighede — gaan enige vrae wat jy verkeerd het weer deur en probeer nog ʼn stel.' },
