  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Hard', question: 'Reghoekige driehoek DEF (regte hoek by E) moet gekonstrueer en kongruent bewys word aan ʼn ander reghoekige driehoek GHI (regte hoek by H) deur RHS te gebruik. Verduidelik watter drie stukke inligting moet ooreenstem, en waarom RHS as ʼn aparte voorwaarde van SAS beskou word.', answer: 'Die regte hoek, die skuinssylengte, en die lengte van een ander sy moet almal tussen die twee driehoeke ooreenstem. RHS word apart van SAS beskou omdat die regte hoek nie die hoek is wat ingesluit is tussen die skuinssy en die gegewe sy nie — dit is ʼn nie-ingeslote hoek — tog waarborg die vaste regte hoek, gekombineer met die stelling van Pythagoras, steeds dat die derde sy (en dus die hele driehoek) uniek bepaal word.', checkMode: 'self' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Hard', question: 'Reghoekige driehoek JKL (regte hoek by K) moet gekonstrueer en kongruent bewys word aan ʼn ander reghoekige driehoek MNO (regte hoek by N) deur RHS te gebruik. Verduidelik watter drie stukke inligting moet ooreenstem, en waarom RHS as ʼn aparte voorwaarde van SAS beskou word.', answer: 'Die regte hoek, die skuinssylengte, en die lengte van een ander sy moet almal tussen die twee driehoeke ooreenstem. RHS word apart van SAS beskou omdat die regte hoek nie die hoek is wat ingesluit is tussen die skuinssy en die gegewe sy nie — dit is ʼn nie-ingeslote hoek — tog waarborg die vaste regte hoek, gekombineer met die stelling van Pythagoras, steeds dat die derde sy (en dus die hele driehoek) uniek bepaal word.', checkMode: 'self' },
