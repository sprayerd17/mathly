  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'Twee driehoeke het elk twee pare ooreenstemmende sye gelyk, plus een paar gelyke hoeke wat NIE die hoek tussen daardie twee sye is nie (SSH). Lerato sê dit bewys altyd kongruensie, net soos SHS. Is sy korrek? Verduidelik met redenasie.', answer: 'Nee — SSH is nie ʼn betroubare kongruensievoorwaarde nie. Anders as SHS (waar die hoek ingesluit is tussen die twee bekende sye, wat die driehoek uniek vasstel), kan die derde sy by SSH soms vanuit twee verskillende geldige posisies geteken word, wat twee verskillende driehoeke oplewer wat albei aan dieselfde gegewe metings voldoen. Slegs SSS, SHS, HHS en RSS waarborg betroubaar kongruensie.', checkMode: 'self' },
        { difficulty: 'Hard', question: 'ʼn Reghoekige driehoek moet gekonstrueer en kongruent bewys word aan ʼn ander reghoekige driehoek deur RSS te gebruik. Verduidelik watter drie stukke inligting moet ooreenstem, en waarom RSS as ʼn aparte voorwaarde van SHS beskou word.', answer: 'Die regte hoek, die skuinssylengte, en die lengte van een ander sy moet almal tussen die twee driehoeke ooreenstem. RSS word apart van SHS beskou omdat die regte hoek nie die hoek is wat ingesluit is tussen die skuinssy en die gegewe sy nie — dit is ʼn nie-ingeslote hoek — tog waarborg die vaste regte hoek, gekombineer met die stelling van Pythagoras, steeds dat die derde sy (en dus die hele driehoek) uniek bepaal word.', checkMode: 'self' },
        ...
        { difficulty: 'Medium', question: 'ʼn Driehoek word deur HHS gekonstrueer met hoek A = 48° en hoek B = 77°, met die sy AB tussen hulle as die basis. Bereken hoek C, en gee die grootte van die buitehoek by C.', answer: 'Hoek C = 55°; buitehoek by C = 125°', checkMode: 'self', explanation: 'Hoek C = 180° − 48° − 77° = 55°. Die buitehoek by C is gelyk aan die som van die oorstaande binnehoeke: 48° + 77° = 125° (konsekwent, aangesien dit ook gelyk is aan 180° − 55°).' },
        { difficulty: 'Hard', question: 'ʼn Leerder wil ʼn driehoek met sye 6 cm, 8 cm en 13 cm deur SSS konstrueer. Bepaal of hierdie konstruksie moontlik is, en toon jou redenasie.', answer: 'Moontlik — die twee korter sye, 6 cm + 8 cm = 14 cm, is groter as die langste sy, 13 cm, dus sal die passerboë kruis en die driehoek kan gekonstrueer word.', checkMode: 'self', explanation: 'Driehoeksongelykheidkontrole: 6 + 8 = 14 > 13, dus bestaan ʼn geldige driehoek.' },
        { difficulty: 'Medium', question: 'Die reghoekige driehoek wat getoon word, is gekonstrueer met die regte hoek by X, skuinssy YZ = 17 cm, en sy XY = 8 cm. Gee die kongruensievoorwaarde wat van toepassing is, en bereken die lengte van sy XZ.', answer: 'RSS; XZ = 15 cm', checkMode: 'auto', correctAnswer: 'RSS', correctAnswers: ['RSS', 'rss', '15', '15 cm', 'RSS, 15 cm'], explanation: 'Dit is die RSS-voorwaarde. Volgens Pythagoras: 8² + XZ² = 17², dus XZ² = 289 − 64 = 225, wat XZ = 15 cm gee.', diagramSvg: '<svg viewBox="0 0 220 170" xmlns="http://www.w3.org/2000/svg"><polygon points="35,140 35,68 155,140" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><rect x="35" y="128" width="12" height="12" fill="none" stroke="#0f1f3d" stroke-width="2"/><text x="20" y="104" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">XY = 8 cm</text><text x="95" y="158" font-size="13" fill="#ea580c" font-weight="700" text-anchor="middle">XZ = ?</text><text x="105" y="98" font-size="13" fill="#2563eb" font-weight="700">YZ = 17 cm</text><text x="35" y="155" font-size="12" fill="#374151" text-anchor="middle">X</text><text x="35" y="60" font-size="12" fill="#374151" text-anchor="middle">Y</text><text x="160" y="145" font-size="12" fill="#374151">Z</text></svg>' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'Twee driehoeke het twee pare ooreenstemmende hoeke gelyk, saam met die ingeslote sy tussen daardie hoeke gelyk in lengte. Verduidelik, deur die HHS-voorwaarde te gebruik, waarom dit alleen genoeg is om te bewys dat die driehoeke kongruent is.', answer: 'As twee hoeke vasgestel is, word die derde hoek outomaties bepaal omdat hoeke in ʼn driehoek tot 180° som. Gekombineer met die vaste ingeslote sy tussen die twee bekende hoeke, is daar slegs een moontlike driehoekvorm en -grootte wat gevorm kan word — dus moet die driehoeke identies wees, en alle oorblywende sye en hoeke is outomaties ook gelyk.', checkMode: 'self' },
        { difficulty: 'Medium', question: 'Twee driehoeke het elk twee pare ooreenstemmende sye gelyk, plus een paar gelyke hoeke wat NIE die hoek tussen daardie twee sye is nie (SSH). Thabo sê dit bewys altyd kongruensie, net soos SHS. Is hy korrek? Verduidelik met redenasie.', answer: 'Nee — SSH is nie ʼn betroubare kongruensievoorwaarde nie. Anders as SHS (waar die hoek ingesluit is tussen die twee bekende sye, wat die driehoek uniek vasstel), kan die derde sy by SSH soms vanuit twee verskillende geldige posisies geteken word, wat twee verskillende driehoeke oplewer wat albei aan dieselfde gegewe metings voldoen. Slegs SSS, SHS, HHS en RSS waarborg betroubaar kongruensie.', checkMode: 'self' },
        { difficulty: 'Hard', question: 'Reghoekige driehoek DEF (regte hoek by E) moet gekonstrueer en kongruent bewys word aan ʼn ander reghoekige driehoek GHI (regte hoek by H) deur RSS te gebruik. Verduidelik watter drie stukke inligting moet ooreenstem, en waarom RSS as ʼn aparte voorwaarde van SHS beskou word.', answer: 'Die regte hoek, die skuinssylengte, en die lengte van een ander sy moet almal tussen die twee driehoeke ooreenstem. RSS word apart van SHS beskou omdat die regte hoek nie die hoek is wat ingesluit is tussen die skuinssy en die gegewe sy nie — dit is ʼn nie-ingeslote hoek — tog waarborg die vaste regte hoek, gekombineer met die stelling van Pythagoras, steeds dat die derde sy (en dus die hele driehoek) uniek bepaal word.', checkMode: 'self' },
        ...
        { difficulty: 'Medium', question: 'ʼn Driehoek word deur HHS gekonstrueer met hoek A = 55° en hoek B = 63°, met die sy AB tussen hulle as die basis. Bereken hoek C, en gee die grootte van die buitehoek by C.', answer: 'Hoek C = 62°; buitehoek by C = 118°', checkMode: 'self', explanation: 'Hoek C = 180° − 55° − 63° = 62°. Die buitehoek by C is gelyk aan die som van die oorstaande binnehoeke: 55° + 63° = 118° (konsekwent, aangesien dit ook gelyk is aan 180° − 62°).' },
        { difficulty: 'Hard', question: 'ʼn Leerder wil ʼn driehoek met sye 5 cm, 9 cm en 12 cm deur SSS konstrueer. Bepaal of hierdie konstruksie moontlik is, en toon jou redenasie.', answer: 'Moontlik — die twee korter sye, 5 cm + 9 cm = 14 cm, is groter as die langste sy, 12 cm, dus sal die passerboë kruis en die driehoek kan gekonstrueer word.', checkMode: 'self', explanation: 'Driehoeksongelykheidkontrole: 5 + 9 = 14 > 12, dus bestaan ʼn geldige driehoek.' },
        { difficulty: 'Medium', question: 'Die reghoekige driehoek wat getoon word, is gekonstrueer met die regte hoek by P, skuinssy QR = 25 cm, en sy PQ = 15 cm. Gee die kongruensievoorwaarde wat van toepassing is, en bereken die lengte van sy PR.', answer: 'RSS; PR = 20 cm', checkMode: 'auto', correctAnswer: 'RSS', correctAnswers: ['RSS', 'rss', '20', '20 cm', 'RSS, 20 cm'], explanation: 'Dit is die RSS-voorwaarde. Volgens Pythagoras: 15² + PR² = 25², dus PR² = 625 − 225 = 400, wat PR = 20 cm gee.', diagramSvg: '<svg viewBox="0 0 220 170" xmlns="http://www.w3.org/2000/svg"><polygon points="35,140 35,60 175,140" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><rect x="35" y="128" width="12" height="12" fill="none" stroke="#0f1f3d" stroke-width="2"/><text x="20" y="100" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">PQ = 15 cm</text><text x="105" y="158" font-size="13" fill="#ea580c" font-weight="700" text-anchor="middle">PR = ?</text><text x="115" y="92" font-size="13" fill="#2563eb" font-weight="700">QR = 25 cm</text><text x="35" y="155" font-size="12" fill="#374151" text-anchor="middle">P</text><text x="35" y="52" font-size="12" fill="#374151" text-anchor="middle">Q</text><text x="180" y="145" font-size="12" fill="#374151">R</text></svg>' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'Twee driehoeke het twee pare ooreenstemmende sye gelyk, met die hoek tussen daardie twee sye ook gelyk (SHS). Sipho sê dit alleen bewys kongruensie. Is hy korrek? Verduidelik waarom die posisie van die hoek saak maak.', answer: 'Ja — SHS is ʼn betroubare kongruensievoorwaarde omdat die ingeslote hoek (die hoek tussen die twee bekende sye) die driehoek uniek vasstel: sodra twee sye en die hoek tussen hulle vasgestel is, is daar slegs een moontlike posisie vir die derde sy, dus kan slegs een driehoek gevorm word. Dit verskil van SSH, waar ʼn nie-ingeslote hoek soms twee verskillende driehoeke kan toelaat.', checkMode: 'self' },
        { difficulty: 'Hard', question: 'Reghoekige driehoek JKL (regte hoek by K) moet gekonstrueer en kongruent bewys word aan ʼn ander reghoekige driehoek MNO (regte hoek by N) deur RSS te gebruik. Verduidelik watter drie stukke inligting moet ooreenstem, en waarom RSS as ʼn aparte voorwaarde van SHS beskou word.', answer: 'Die regte hoek, die skuinssylengte, en die lengte van een ander sy moet almal tussen die twee driehoeke ooreenstem. RSS word apart van SHS beskou omdat die regte hoek nie die hoek is wat ingesluit is tussen die skuinssy en die gegewe sy nie — dit is ʼn nie-ingeslote hoek — tog waarborg die vaste regte hoek, gekombineer met die stelling van Pythagoras, steeds dat die derde sy (en dus die hele driehoek) uniek bepaal word.', checkMode: 'self' },
        ...
        { difficulty: 'Medium', question: 'ʼn Driehoek word deur HHS gekonstrueer met hoek A = 40° en hoek B = 95°, met die sy AB tussen hulle as die basis. Bereken hoek C, en gee die grootte van die buitehoek by C.', answer: 'Hoek C = 45°; buitehoek by C = 135°', checkMode: 'self', explanation: 'Hoek C = 180° − 40° − 95° = 45°. Die buitehoek by C is gelyk aan die som van die oorstaande binnehoeke: 40° + 95° = 135° (konsekwent, aangesien dit ook gelyk is aan 180° − 45°).' },
        { difficulty: 'Hard', question: 'ʼn Leerder wil ʼn driehoek met sye 7 cm, 10 cm en 16 cm deur SSS konstrueer. Bepaal of hierdie konstruksie moontlik is, en toon jou redenasie.', answer: 'Moontlik — die twee korter sye, 7 cm + 10 cm = 17 cm, is groter as die langste sy, 16 cm, dus sal die passerboë kruis en die driehoek kan gekonstrueer word.', checkMode: 'self', explanation: 'Driehoeksongelykheidkontrole: 7 + 10 = 17 > 16, dus bestaan ʼn geldige driehoek.' },
        { difficulty: 'Medium', question: 'Die reghoekige driehoek wat getoon word, is gekonstrueer met die regte hoek by L, skuinssy MN = 20 cm, en sy LM = 12 cm. Gee die kongruensievoorwaarde wat van toepassing is, en bereken die lengte van sy LN.', answer: 'RSS; LN = 16 cm', checkMode: 'auto', correctAnswer: 'RSS', correctAnswers: ['RSS', 'rss', '16', '16 cm', 'RSS, 16 cm'], explanation: 'Dit is die RSS-voorwaarde. Volgens Pythagoras: 12² + LN² = 20², dus LN² = 400 − 144 = 256, wat LN = 16 cm gee.', diagramSvg: '<svg viewBox="0 0 220 170" xmlns="http://www.w3.org/2000/svg"><polygon points="35,140 35,64 160,140" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><rect x="35" y="128" width="12" height="12" fill="none" stroke="#0f1f3d" stroke-width="2"/><text x="20" y="102" font-size="13" fill="#2563eb" font-weight="700" text-anchor="end">LM = 12 cm</text><text x="97" y="158" font-size="13" fill="#ea580c" font-weight="700" text-anchor="middle">LN = ?</text><text x="100" y="95" font-size="13" fill="#2563eb" font-weight="700">MN = 20 cm</text><text x="35" y="155" font-size="12" fill="#374151" text-anchor="middle">L</text><text x="35" y="56" font-size="12" fill="#374151" text-anchor="middle">M</text><text x="165" y="145" font-size="12" fill="#374151">N</text></svg>' },
