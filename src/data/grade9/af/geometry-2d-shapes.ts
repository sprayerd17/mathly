  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Hard', question: 'In die vyfhoek getoon, is vier van die binnehoeke 100°, 110°, 95° en 90°. Bepaal die grootte van die vyfde hoek.', checkMode: 'auto', correctAnswer: '145°', correctAnswers: ['145°', '145'], answer: '145°', explanation: 'Som van binnehoeke van \'n vyfhoek = (5 − 2) × 180° = 540°.\nVyfde hoek = 540° − 100° − 110° − 95° − 90° = 145°', diagramSvg: '<svg viewBox="0 0 220 200" xmlns="http://www.w3.org/2000/svg"><polygon points="105,35 172,83 146,162 64,162 38,83" stroke="#0f1f3d" stroke-width="2" fill="none"/><text x="105" y="20" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">100°</text><text x="180" y="78" font-size="13" fill="#2563eb" font-weight="700" text-anchor="start">110°</text><text x="160" y="188" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">95°</text><text x="50" y="188" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">90°</text><text x="32" y="78" font-size="16" fill="#ea580c" font-weight="700" text-anchor="end">?</text></svg>' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Hard', question: 'In die vyfhoek getoon, is vier van die binnehoeke 120°, 95°, 100° en 105°. Bepaal die grootte van die vyfde hoek.', checkMode: 'auto', correctAnswer: '120°', correctAnswers: ['120°', '120'], answer: '120°', explanation: 'Som van binnehoeke van \'n vyfhoek = (5 − 2) × 180° = 540°.\nVyfde hoek = 540° − 120° − 95° − 100° − 105° = 120°', diagramSvg: '<svg viewBox="0 0 220 200" xmlns="http://www.w3.org/2000/svg"><polygon points="105,35 172,83 146,162 64,162 38,83" stroke="#0f1f3d" stroke-width="2" fill="none"/><text x="105" y="20" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">120°</text><text x="180" y="78" font-size="13" fill="#2563eb" font-weight="700" text-anchor="start">95°</text><text x="160" y="188" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">100°</text><text x="50" y="188" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">105°</text><text x="32" y="78" font-size="16" fill="#ea580c" font-weight="700" text-anchor="end">?</text></svg>' },
