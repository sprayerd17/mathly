...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video explaining how the discriminant determines whether the roots of a quadratic equation are real and equal, real and unequal (rational or irrational), or non-real',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video consolidating the three methods for solving quadratic equations, with a note on which methods are directly examined at Grade 12 level',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video showing how to solve a quadratic inequality by sketching the parabola from its factorised form and reading the solution off the graph',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video showing how to solve a linear-quadratic system with surd solutions, and how the discriminant of the resulting equation determines tangency or no intersection',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video showing how to solve equations involving surds by isolating the root, squaring both sides, and checking every solution against the original equation to reject extraneous roots',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video revising how to solve exponential equations by writing both sides with the same base, including the substitution method for equations that reduce to a quadratic',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video showing how to solve algebraic fraction equations by stating restrictions, multiplying by the LCD, and checking solutions against the excluded values',
    },
  ],
