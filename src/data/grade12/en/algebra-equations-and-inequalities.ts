...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramSvg:
        '<svg viewBox="0 0 620 190" xmlns="http://www.w3.org/2000/svg"><g><line x1="10" y1="110" x2="190" y2="110" stroke="#0f1f3d" stroke-width="1.5"/><path d="M 20 30 Q 100 175 180 30" fill="none" stroke="#2563eb" stroke-width="2.5"/><circle cx="58" cy="110" r="3.5" fill="#2563eb"/><circle cx="142" cy="110" r="3.5" fill="#2563eb"/><text x="100" y="20" font-size="13" font-weight="700" fill="#2563eb" text-anchor="middle">&#916; &gt; 0</text><text x="100" y="150" font-size="10" font-weight="600" fill="#0f1f3d" text-anchor="middle">two real, unequal roots</text></g><g transform="translate(210,0)"><line x1="10" y1="110" x2="190" y2="110" stroke="#0f1f3d" stroke-width="1.5"/><path d="M 20 30 Q 100 110 180 30" fill="none" stroke="#ea580c" stroke-width="2.5"/><circle cx="100" cy="110" r="3.5" fill="#ea580c"/><text x="100" y="20" font-size="13" font-weight="700" fill="#ea580c" text-anchor="middle">&#916; = 0</text><text x="100" y="150" font-size="10" font-weight="600" fill="#0f1f3d" text-anchor="middle">one real, repeated root</text></g><g transform="translate(420,0)"><line x1="10" y1="110" x2="190" y2="110" stroke="#0f1f3d" stroke-width="1.5"/><path d="M 20 90 Q 100 55 180 90" fill="none" stroke="#dc2626" stroke-width="2.5"/><text x="100" y="20" font-size="13" font-weight="700" fill="#dc2626" text-anchor="middle">&#916; &lt; 0</text><text x="100" y="150" font-size="10" font-weight="600" fill="#0f1f3d" text-anchor="middle">no real roots (non-real)</text></g></svg>',
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramSvg:
        '<svg viewBox="0 0 260 190" xmlns="http://www.w3.org/2000/svg"><line x1="15" y1="160" x2="245" y2="160" stroke="#0f1f3d" stroke-width="1.5"/><line x1="25" y1="150" x2="235" y2="30" stroke="#2563eb" stroke-width="2.5"/><path d="M 30 30 Q 130 185 230 30" fill="none" stroke="#ea580c" stroke-width="2.5"/><circle cx="66" cy="110" r="4.5" fill="#16a34a"/><circle cx="196" cy="55" r="4.5" fill="#16a34a"/><text x="130" y="16" font-size="11.5" font-weight="700" fill="#0f1f3d" text-anchor="middle">line and parabola: 2 points of intersection</text></svg>',
