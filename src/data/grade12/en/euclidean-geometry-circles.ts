...
export const topicData: TopicData = {
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      workedExamples: [
        ...
        },
        {
          ...
          steps: [
            `<svg viewBox="0 0 280 240" width="280" height="240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="50" y1="120" x2="230" y2="120" stroke="#2563eb" stroke-width="2"/><line x1="50" y1="120" x2="114.8" y2="46.28" stroke="#0f1f3d" stroke-width="1.8"/><line x1="114.8" y1="46.28" x2="230" y2="120" stroke="#0f1f3d" stroke-width="1.8"/><line x1="114.8" y1="46.28" x2="114.8" y2="120" stroke="#ea580c" stroke-width="2"/><path d="M 114.8,111 L 105.8,111 L 105.8,120" fill="none" stroke="#0f1f3d" stroke-width="1.8"/><circle cx="50" cy="120" r="3" fill="#0f1f3d"/><text x="46" y="138" font-size="13" fill="#0f1f3d" font-weight="700" text-anchor="middle">A</text><circle cx="230" cy="120" r="3" fill="#0f1f3d"/><text x="234" y="138" font-size="13" fill="#0f1f3d" font-weight="700" text-anchor="middle">B</text><circle cx="114.8" cy="46.28" r="3" fill="#0f1f3d"/><text x="122.8" y="40.28" font-size="13" fill="#0f1f3d" font-weight="700" text-anchor="middle">C</text><circle cx="114.8" cy="120" r="3" fill="#0f1f3d"/><text x="118.8" y="138" font-size="13" fill="#0f1f3d" font-weight="700" text-anchor="middle">D</text><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="136" y="138" font-size="13" fill="#0f1f3d" font-weight="700" text-anchor="middle">O</text><text x="82.4" y="138" font-size="10" fill="#2563eb" font-weight="700" text-anchor="middle">AD = 9 cm</text><text x="172.4" y="138" font-size="10" fill="#2563eb" font-weight="700" text-anchor="middle">DB = 16 cm</text></svg>`,
  ...
  topicPractice: [
    ...
    // ── Q10 Easy — equal tangent segments ────────────────────────────────────
    {
      ...
      diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="15" x2="93.64" y2="42.86" stroke="#16a34a" stroke-width="2.5"/><line x1="140" y1="15" x2="186.36" y2="42.86" stroke="#16a34a" stroke-width="2.5"/><line x1="93.64" y1="42.86" x2="186.36" y2="42.86" stroke="#ea580c" stroke-width="2.5" stroke-dasharray="4,3"/><line x1="93.64" y1="42.86" x2="163.29" y2="206.93" stroke="#0f1f3d" stroke-width="2.5"/><line x1="186.36" y1="42.86" x2="163.29" y2="206.93" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 126.29,23.24 A 16,16 0 0 0 153.71,23.24" fill="none" stroke="#dc2626" stroke-width="2"/><path d="M 157.82,194.04 A 14,14 0 0 1 165.24,193.07" fill="none" stroke="#2563eb" stroke-width="2"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><circle cx="140" cy="15" r="2.5" fill="#0f1f3d"/><text x="134" y="7" font-size="13" fill="#0f1f3d" font-weight="700">P</text><circle cx="93.64" cy="42.86" r="2.5" fill="#0f1f3d"/><text x="73.64" y="48.86" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="186.36" cy="42.86" r="2.5" fill="#0f1f3d"/><text x="196.36" y="50.86" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="163.29" cy="206.93" r="2.5" fill="#0f1f3d"/><text x="157.29" y="226.93" font-size="13" fill="#0f1f3d" font-weight="700">C</text><text x="140" y="45" font-size="11" fill="#dc2626" font-weight="700" text-anchor="middle">50°</text><text x="116.82" y="24.93" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">PA = 9 cm</text><text x="163.18" y="24.93" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>',
    },
  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'Tangents PA and PB are drawn from external point P to a circle, with ∠APB = 46°. Since PA = PB, triangle PAB is isosceles. Find ∠PAB.', checkMode: 'auto', correctAnswer: '67', correctAnswers: ['67', '67°', '67 degrees'], answer: '67°', explanation: 'Since PA = PB (equal tangents from an external point), triangle PAB is isosceles, so ∠PAB = ∠PBA.\n∠PAB = (180° − 46°) ÷ 2 = 134° ÷ 2 = 67° ✓', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="20" x2="100.77" y2="39" stroke="#16a34a" stroke-width="2.5"/><line x1="140" y1="20" x2="179.23" y2="39" stroke="#16a34a" stroke-width="2.5"/><line x1="100.77" y1="39" x2="179.23" y2="39" stroke="#ea580c" stroke-width="2.5"/><path d="M 123.80,27.85 A 18,18 0 0 0 156.20,27.85" fill="none" stroke="#dc2626" stroke-width="2"/><path d="M 114.27,32.46 A 15,15 0 0 1 115.77,39.00" fill="none" stroke="#ea580c" stroke-width="2"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><circle cx="140" cy="20" r="2.5" fill="#0f1f3d"/><text x="134" y="10" font-size="13" fill="#0f1f3d" font-weight="700">P</text><circle cx="100.77" cy="39" r="2.5" fill="#0f1f3d"/><text x="80.77" y="45" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="179.23" cy="39" r="2.5" fill="#0f1f3d"/><text x="189.23" y="49" font-size="13" fill="#0f1f3d" font-weight="700">B</text><text x="140" y="54" font-size="11" fill="#dc2626" font-weight="700" text-anchor="middle">46°</text><text x="125.80" y="31.96" font-size="11" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },
