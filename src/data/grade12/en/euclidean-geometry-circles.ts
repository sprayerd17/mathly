    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        },
        {
          ...
          diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="50" y1="120" x2="230" y2="120" stroke="#2563eb" stroke-width="2"/><line x1="50" y1="120" x2="86" y2="68.38" stroke="#0f1f3d" stroke-width="1.8"/><line x1="86" y1="68.38" x2="230" y2="120" stroke="#0f1f3d" stroke-width="1.8"/><line x1="86" y1="68.38" x2="86" y2="120" stroke="#ea580c" stroke-width="2"/><path d="M 86,111 L 77,111 L 77,120" fill="none" stroke="#0f1f3d" stroke-width="1.8"/><circle cx="50" cy="120" r="3" fill="#0f1f3d"/><text x="46" y="138" font-size="13" fill="#0f1f3d" font-weight="700" text-anchor="middle">A</text><circle cx="230" cy="120" r="3" fill="#0f1f3d"/><text x="234" y="138" font-size="13" fill="#0f1f3d" font-weight="700" text-anchor="middle">B</text><circle cx="86" cy="68.38" r="3" fill="#0f1f3d"/><text x="94" y="62.38" font-size="13" fill="#0f1f3d" font-weight="700" text-anchor="middle">C</text><circle cx="86" cy="120" r="3" fill="#0f1f3d"/><text x="98" y="136" font-size="13" fill="#0f1f3d" font-weight="700" text-anchor="middle">D</text><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="136" y="138" font-size="13" fill="#0f1f3d" font-weight="700" text-anchor="middle">O</text><text x="68" y="138" font-size="10" fill="#2563eb" font-weight="700" text-anchor="middle">AD = 2 cm</text><text x="158" y="150" font-size="10" fill="#2563eb" font-weight="700" text-anchor="middle">DB = 8 cm</text></svg>',
        },
        {
          difficulty: 'Hard',
