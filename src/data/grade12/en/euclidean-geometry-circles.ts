...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video showing a visual overview of all key circle terms labelled on a circle — radius, chord, tangent, arc, cyclic quadrilateral — and demonstrating the angle at centre equals twice the angle at circumference',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video showing diagrams for all three angle theorems — angle at centre twice angle at circumference, equal angles in same segment, and angle in a semicircle — with each relevant angle highlighted in its colour',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video showing a labelled cyclic quadrilateral ABCD with opposite angle pairs highlighted in blue and orange, and an exterior angle highlighted in green, demonstrating both theorems',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video showing a tangent touching a circle — labelling the tangent line in green, the radius at the contact point in blue, equal tangent segments from an external point, and the tangent-chord angle in orange with the matching alternate segment angle',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      workedExamples: [
        ...
        },
        {
          ...
          steps: [
            `<svg viewBox="0 0 280 240" width="280" height="240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="50" y1="120" x2="230" y2="120" stroke="#2563eb" stroke-width="2"/><line x1="50" y1="120" x2="114.8" y2="33.6" stroke="#0f1f3d" stroke-width="1.8"/><line x1="114.8" y1="33.6" x2="230" y2="120" stroke="#0f1f3d" stroke-width="1.8"/><line x1="114.8" y1="33.6" x2="114.8" y2="120" stroke="#ea580c" stroke-width="2"/><path d="M 114.8,111 L 105.8,111 L 105.8,120" fill="none" stroke="#0f1f3d" stroke-width="1.8"/><circle cx="50" cy="120" r="3" fill="#0f1f3d"/><text x="46" y="138" font-size="13" fill="#0f1f3d" font-weight="700" text-anchor="middle">A</text><circle cx="230" cy="120" r="3" fill="#0f1f3d"/><text x="234" y="138" font-size="13" fill="#0f1f3d" font-weight="700" text-anchor="middle">B</text><circle cx="114.8" cy="33.6" r="3" fill="#0f1f3d"/><text x="122.8" y="27.6" font-size="13" fill="#0f1f3d" font-weight="700" text-anchor="middle">C</text><circle cx="114.8" cy="120" r="3" fill="#0f1f3d"/><text x="118.8" y="138" font-size="13" fill="#0f1f3d" font-weight="700" text-anchor="middle">D</text><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="136" y="138" font-size="13" fill="#0f1f3d" font-weight="700" text-anchor="middle">O</text><text x="82.4" y="138" font-size="10" fill="#2563eb" font-weight="700" text-anchor="middle">AD = 9 cm</text><text x="172.4" y="138" font-size="10" fill="#2563eb" font-weight="700" text-anchor="middle">DB = 16 cm</text></svg>`,
      ...
      videoPlaceholder:
        'Short video showing how to combine a circle theorem (tangent-chord angle, angle in a semicircle, cyclic quadrilateral opposite angles) with equiangular (AA) similar triangles to prove a squared-length or product-of-lengths result, working through the tangent-secant rider step by step',
    },
  ],
  ...
  topicPractice: [
    // ── Q1 Easy — angle at circumference (major arc) ─────────────────────────
    {
      ...
      explanation: 'The angle at the centre is twice the angle at the circumference.\nAngle ACB = 140° ÷ 2 = 70° ✓',
      diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="224.57" y2="150.78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="55.43" y2="150.78" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 162.55,128.21 A 24,24 0 0 1 117.45,128.21" fill="none" stroke="#2563eb" stroke-width="2"/><line x1="224.57" y1="150.78" x2="55.43" y2="150.78" stroke="#2563eb" stroke-width="2"/><line x1="140" y1="120" x2="140" y2="150.78" stroke="#0f1f3d" stroke-width="1.8"/><path d="M 140,141.78 L 131,141.78 L 131,150.78" fill="none" stroke="#0f1f3d" stroke-width="1.8"/><line x1="140" y1="30" x2="224.57" y2="150.78" stroke="#ea580c" stroke-width="2"/><line x1="140" y1="30" x2="55.43" y2="150.78" stroke="#ea580c" stroke-width="2"/><line x1="140" y1="210" x2="224.57" y2="150.78" stroke="#0f1f3d" stroke-width="1.6" stroke-dasharray="4,3"/><line x1="140" y1="210" x2="55.43" y2="150.78" stroke="#0f1f3d" stroke-width="1.6" stroke-dasharray="4,3"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><circle cx="224.57" cy="150.78" r="2.5" fill="#0f1f3d"/><text x="232.57" y="154.78" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="55.43" cy="150.78" r="2.5" fill="#0f1f3d"/><text x="35.43" y="154.78" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="140" cy="30" r="2.5" fill="#0f1f3d"/><text x="134" y="18" font-size="13" fill="#0f1f3d" font-weight="700">C</text><circle cx="140" cy="210" r="2.5" fill="#0f1f3d"/><text x="134" y="226" font-size="13" fill="#0f1f3d" font-weight="700">D</text><circle cx="140" cy="150.78" r="2.5" fill="#0f1f3d"/><text x="147" y="147" font-size="12" fill="#0f1f3d" font-weight="700">M</text><text x="140" y="138" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">140°</text><text x="140" y="170" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">AB = 12 cm</text><text x="140" y="50" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>',
    },
    ...
    // ── Q6 Easy — opposite angles of cyclic quadrilateral ────────────────────
    {
      ...
      diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="71.06" y1="62.15" x2="71.06" y2="177.85" stroke="#0f1f3d" stroke-width="2.5"/><line x1="71.06" y1="177.85" x2="224.57" y2="150.78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="224.57" y1="150.78" x2="197.85" y2="51.06" stroke="#0f1f3d" stroke-width="2.5"/><line x1="197.85" y1="51.06" x2="71.06" y2="62.15" stroke="#0f1f3d" stroke-width="2.5"/><line x1="71.06" y1="177.85" x2="71.06" y2="212.85" stroke="#0f1f3d" stroke-width="2.5"/><circle cx="71.06" cy="62.15" r="2.5" fill="#0f1f3d"/><text x="51.06" y="62.15" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="71.06" cy="177.85" r="2.5" fill="#0f1f3d"/><text x="65.06" y="195.85" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="224.57" cy="150.78" r="2.5" fill="#0f1f3d"/><text x="234.57" y="156.78" font-size="13" fill="#0f1f3d" font-weight="700">C</text><circle cx="197.85" cy="51.06" r="2.5" fill="#0f1f3d"/><text x="201.85" y="39.06" font-size="13" fill="#0f1f3d" font-weight="700">D</text><circle cx="71.06" cy="212.85" r="2.5" fill="#0f1f3d"/><text x="81.06" y="222.85" font-size="13" fill="#0f1f3d" font-weight="700">E</text><text x="97.37" y="71.73" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">95°</text><text x="89.06" y="156.4" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">80°</text><text x="198.26" y="141.2" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>',
    },
    ...
    // ── Q10 Easy — equal tangent segments ────────────────────────────────────
    {
      ...
      diagramSvg: '<svg viewBox="0 -118 280 358" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="-92.96" x2="58.43" y2="81.96" stroke="#16a34a" stroke-width="2.5"/><line x1="140" y1="-92.96" x2="221.57" y2="81.96" stroke="#16a34a" stroke-width="2.5"/><line x1="58.43" y1="81.96" x2="221.57" y2="81.96" stroke="#ea580c" stroke-width="2.5" stroke-dasharray="4,3"/><line x1="58.43" y1="81.96" x2="163.29" y2="206.93" stroke="#0f1f3d" stroke-width="2.5"/><line x1="221.57" y1="81.96" x2="163.29" y2="206.93" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 133.24,-78.46 A 16,16 0 0 0 146.76,-78.46" fill="none" stroke="#dc2626" stroke-width="2"/><path d="M 154.29,196.21 A 14,14 0 0 1 169.21,194.24" fill="none" stroke="#2563eb" stroke-width="2"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><circle cx="140" cy="-92.96" r="2.5" fill="#0f1f3d"/><text x="134" y="-100.96" font-size="13" fill="#0f1f3d" font-weight="700">P</text><circle cx="58.43" cy="81.96" r="2.5" fill="#0f1f3d"/><text x="38.43" y="87.96" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="221.57" cy="81.96" r="2.5" fill="#0f1f3d"/><text x="231.57" y="89.96" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="163.29" cy="206.93" r="2.5" fill="#0f1f3d"/><text x="157.29" y="226.93" font-size="13" fill="#0f1f3d" font-weight="700">C</text><text x="140" y="-62.96" font-size="11" fill="#dc2626" font-weight="700" text-anchor="middle">50°</text><text x="99.22" y="-9.5" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">PA = 9 cm</text><text x="180.78" y="-9.5" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>',
    },
  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Hard', question: 'A circle has centre O and radius 25 cm. M is the midpoint of chord AB, and OM = 7 cm. Find the length of AB, then state the size of angle OMA.', checkMode: 'auto', correctAnswer: '48,90', correctAnswers: ['48,90', '48cm,90°', '48 cm, 90°'], answer: 'AB = 48 cm, ∠OMA = 90°', explanation: 'AM² = OA² − OM² = 25² − 7² = 625 − 49 = 576.\nAM = √576 = 24 cm.\nAB = 2 × 24 = 48 cm.\nSince OM is the perpendicular from the centre to the chord, ∠OMA = 90° ✓', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="87.1" y2="47.19" stroke="#0f1f3d" stroke-width="2.5"/><line x1="87.1" y1="47.19" x2="192.9" y2="47.19" stroke="#ea580c" stroke-width="2.5"/><line x1="140" y1="120" x2="140" y2="47.19" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 140,56.19 L 131,56.19 L 131,47.19" fill="none" stroke="#0f1f3d" stroke-width="1.8"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><circle cx="87.1" cy="47.19" r="2.5" fill="#0f1f3d"/><text x="69.1" y="53.19" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="192.9" cy="47.19" r="2.5" fill="#0f1f3d"/><text x="200.9" y="53.19" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="140" cy="47.19" r="2.5" fill="#0f1f3d"/><text x="136" y="37.19" font-size="13" fill="#0f1f3d" font-weight="700">M</text><text x="105.55" y="81.59" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">OA = 25 cm</text><text x="140" y="67.19" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text><text x="154" y="83.59" font-size="12" fill="#2563eb" font-weight="700" text-anchor="start">OM = 7 cm</text><text x="140" y="228" font-size="11" fill="#ea580c" font-weight="700" text-anchor="middle">∠OMA = ?</text></svg>' },

        // Block 2 — Angle at centre = 2 × angle at circumference (+ reflex)
        { difficulty: 'Easy', question: 'In a circle with centre O, chord AB subtends ∠AOB = 96° at the centre. Point C lies on the major arc, on the same side as the 96° angle. Find ∠ACB.', checkMode: 'auto', correctAnswer: '48', correctAnswers: ['48', '48°', '48 degrees'], answer: '48°', explanation: 'The angle at the centre is double the angle at the circumference.\n∠ACB = 96° ÷ 2 = 48° ✓', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="206.88" y2="180.22" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="73.12" y2="180.22" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 157.84,136.06 A 24,24 0 0 1 122.16,136.06" fill="none" stroke="#dc2626" stroke-width="2"/><line x1="206.88" y1="180.22" x2="140" y2="30" stroke="#ea580c" stroke-width="2.5"/><line x1="73.12" y1="180.22" x2="140" y2="30" stroke="#ea580c" stroke-width="2.5"/><path d="M 146.1,43.7 A 15,15 0 0 1 133.9,43.7" fill="none" stroke="#16a34a" stroke-width="2"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><circle cx="206.88" cy="180.22" r="2.5" fill="#0f1f3d"/><text x="188.88" y="184.22" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="73.12" cy="180.22" r="2.5" fill="#0f1f3d"/><text x="81.12" y="184.22" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="140" cy="30" r="2.5" fill="#0f1f3d"/><text x="134" y="18" font-size="13" fill="#0f1f3d" font-weight="700">C</text><text x="140" y="154" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">96°</text><text x="140" y="56" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },
        { difficulty: 'Easy', question: 'In a circle with centre O, chord PQ subtends ∠PRQ = 57° at point R on the circumference. Find ∠POQ at the centre.', checkMode: 'auto', correctAnswer: '114', correctAnswers: ['114', '114°', '114 degrees'], answer: '114°', explanation: 'The angle at the centre is double the angle at the circumference.\n∠POQ = 2 × 57° = 114° ✓', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="215.48" y2="169.02" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="64.52" y2="169.02" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 160.13,133.07 A 24,24 0 0 1 119.87,133.07" fill="none" stroke="#dc2626" stroke-width="2"/><line x1="215.48" y1="169.02" x2="140" y2="30" stroke="#ea580c" stroke-width="2.5"/><line x1="64.52" y1="169.02" x2="140" y2="30" stroke="#ea580c" stroke-width="2.5"/><path d="M 147.16,43.18 A 15,15 0 0 1 132.84,43.18" fill="none" stroke="#16a34a" stroke-width="2"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><circle cx="215.48" cy="169.02" r="2.5" fill="#0f1f3d"/><text x="197.48" y="173.02" font-size="13" fill="#0f1f3d" font-weight="700">P</text><circle cx="64.52" cy="169.02" r="2.5" fill="#0f1f3d"/><text x="72.52" y="173.02" font-size="13" fill="#0f1f3d" font-weight="700">Q</text><circle cx="140" cy="30" r="2.5" fill="#0f1f3d"/><text x="134" y="18" font-size="13" fill="#0f1f3d" font-weight="700">R</text><text x="140" y="154" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text><text x="140" y="56" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">57°</text></svg>' },
        { difficulty: 'Medium', question: 'In a circle with centre O, chord AB subtends ∠AOB = 130° at the centre, measured on the major-arc side. Point D lies on the minor arc. Find the reflex angle AOB, then find ∠ADB.', checkMode: 'auto', correctAnswer: '230,115', correctAnswers: ['230,115', '230°,115°', '230°, 115°'], answer: 'Reflex ∠AOB = 230°, ∠ADB = 115°', explanation: 'Reflex ∠AOB = 360° − 130° = 230°.\nD is on the minor arc, so use the reflex angle: ∠ADB = 230° ÷ 2 = 115° ✓', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="221.57" y2="158.04" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="58.43" y2="158.04" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 161.75,130.14 A 24,24 0 0 1 118.25,130.14" fill="none" stroke="#dc2626" stroke-width="2"/><line x1="221.57" y1="158.04" x2="140" y2="210" stroke="#0f1f3d" stroke-width="2.5" stroke-dasharray="4,3"/><line x1="58.43" y1="158.04" x2="140" y2="210" stroke="#0f1f3d" stroke-width="2.5" stroke-dasharray="4,3"/><path d="M 152.65,201.94 A 15,15 0 0 1 127.35,201.94" fill="none" stroke="#ea580c" stroke-width="2" stroke-dasharray="3,2"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><circle cx="221.57" cy="158.04" r="2.5" fill="#0f1f3d"/><text x="203.57" y="162.04" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="58.43" cy="158.04" r="2.5" fill="#0f1f3d"/><text x="66.43" y="162.04" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="140" cy="210" r="2.5" fill="#0f1f3d"/><text x="146" y="226" font-size="13" fill="#0f1f3d" font-weight="700">D</text><text x="140" y="154" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">130°</text><text x="140" y="184" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },
        { difficulty: 'Hard', question: 'In a circle with centre O, chord AB subtends an angle of (5x + 10)° at the centre and ∠ACB = (2x + 20)° at point C on the circumference (same side). Find x, then find ∠ACB.', checkMode: 'auto', correctAnswer: '30,80', correctAnswers: ['30,80', '30,80°', 'x=30,80°'], answer: 'x = 30, ∠ACB = 80°', explanation: 'Angle at centre = 2 × angle at circumference:\n(5x + 10)° = 2(2x + 20)°.\n5x + 10 = 4x + 40.\nx = 30.\n∠ACB = 2(30) + 20 = 80° ✓ (check: angle at centre = 5(30)+10=160°, and 2×80°=160° ✓)', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="228.63" y2="135.63" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="51.37" y2="135.63" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 163.64,124.17 A 24,24 0 0 1 116.36,124.17" fill="none" stroke="#dc2626" stroke-width="2"/><line x1="228.63" y1="135.63" x2="140" y2="30" stroke="#ea580c" stroke-width="2.5"/><line x1="51.37" y1="135.63" x2="140" y2="30" stroke="#ea580c" stroke-width="2.5"/><path d="M 149.64,41.49 A 15,15 0 0 1 130.36,41.49" fill="none" stroke="#16a34a" stroke-width="2"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><circle cx="228.63" cy="135.63" r="2.5" fill="#0f1f3d"/><text x="210.63" y="139.63" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="51.37" cy="135.63" r="2.5" fill="#0f1f3d"/><text x="59.37" y="139.63" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="140" cy="30" r="2.5" fill="#0f1f3d"/><text x="134" y="18" font-size="13" fill="#0f1f3d" font-weight="700">C</text><text x="140" y="154" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">(5x+10)°</text><text x="140" y="56" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">(2x+20)°</text></svg>' },

        // Block 3 — Angles in same segment + angle in a semicircle
        { difficulty: 'Easy', question: 'In a circle, points C and D lie on the same arc relative to chord AB. ∠ACB = 38°. Find ∠ADB.', checkMode: 'auto', correctAnswer: '38', correctAnswers: ['38', '38°', '38 degrees'], answer: '38°', explanation: 'C and D lie in the same segment relative to chord AB, so angles in the same segment are equal.\n∠ADB = ∠ACB = 38° ✓', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="84.59" y1="49.08" x2="195.41" y2="49.08" stroke="#ea580c" stroke-width="2.5"/><line x1="84.59" y1="49.08" x2="170.78" y2="204.57" stroke="#0f1f3d" stroke-width="2.5"/><line x1="195.41" y1="49.08" x2="170.78" y2="204.57" stroke="#0f1f3d" stroke-width="2.5"/><line x1="84.59" y1="49.08" x2="82.15" y2="188.94" stroke="#0f1f3d" stroke-width="2.5" stroke-dasharray="4,3"/><line x1="195.41" y1="49.08" x2="82.15" y2="188.94" stroke="#0f1f3d" stroke-width="2.5" stroke-dasharray="4,3"/><path d="M 163.51,191.45 A 15,15 0 0 1 173.13,189.75" fill="none" stroke="#2563eb" stroke-width="2"/><path d="M 82.46,170.94 A 18,18 0 0 1 93.48,174.95" fill="none" stroke="#ea580c" stroke-width="2"/><circle cx="84.59" cy="49.08" r="2.5" fill="#0f1f3d"/><text x="66.59" y="55.08" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="195.41" cy="49.08" r="2.5" fill="#0f1f3d"/><text x="203.41" y="55.08" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="170.78" cy="204.57" r="2.5" fill="#0f1f3d"/><text x="178.78" y="198.57" font-size="13" fill="#0f1f3d" font-weight="700">C</text><circle cx="82.15" cy="188.94" r="2.5" fill="#0f1f3d"/><text x="64.15" y="178.94" font-size="13" fill="#0f1f3d" font-weight="700">D</text><text x="170.78" y="228.57" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">38°</text><text x="86.15" y="210.94" font-size="11" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },
        { difficulty: 'Easy', question: 'AB is a diameter of a circle and P is a point on the circumference. ∠PAB = 27°. Find ∠APB, then find ∠PBA.', checkMode: 'auto', correctAnswer: '90,63', correctAnswers: ['90,63', '90°,63°', '90°, 63°'], answer: '∠APB = 90°, ∠PBA = 63°', explanation: 'Since AB is a diameter, ∠APB = 90° (angle in a semicircle).\nIn triangle APB: 27° + 90° + ∠PBA = 180°.\n∠PBA = 180° − 90° − 27° = 63° ✓', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="50" y1="120" x2="230" y2="120" stroke="#ea580c" stroke-width="2.5"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><line x1="50" y1="120" x2="192.9" y2="47.19" stroke="#0f1f3d" stroke-width="2.5"/><line x1="230" y1="120" x2="192.9" y2="47.19" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 183.99,51.73 L 188.53,60.64 L 197.44,56.1" fill="none" stroke="#0f1f3d" stroke-width="1.8"/><circle cx="50" cy="120" r="2.5" fill="#0f1f3d"/><text x="32" y="124" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="230" cy="120" r="2.5" fill="#0f1f3d"/><text x="238" y="124" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="192.9" cy="47.19" r="2.5" fill="#0f1f3d"/><text x="200.9" y="37.19" font-size="13" fill="#0f1f3d" font-weight="700">P</text><path d="M 62.47,113.64 A 14,14 0 0 1 64,120" fill="none" stroke="#2563eb" stroke-width="2"/><text x="76" y="112" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">27°</text><text x="186.9" y="71.19" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },
        { difficulty: 'Medium', question: 'Points A, B, C and D lie on a circle, with C and D on the same arc relative to chord AB. ∠ACB = (3x + 4)° and ∠ADB = (5x − 16)°. Find x, then find ∠ACB.', checkMode: 'auto', correctAnswer: '10,34', correctAnswers: ['10,34', '10,34°', 'x=10,34°'], answer: 'x = 10, ∠ACB = 34°', explanation: 'Angles in the same segment are equal: 3x + 4 = 5x − 16.\n20 = 2x.\nx = 10.\n∠ACB = 3(10) + 4 = 34° ✓', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="89.67" y1="45.39" x2="190.33" y2="45.39" stroke="#ea580c" stroke-width="2.5"/><line x1="89.67" y1="45.39" x2="170.78" y2="204.57" stroke="#0f1f3d" stroke-width="2.5"/><line x1="190.33" y1="45.39" x2="170.78" y2="204.57" stroke="#0f1f3d" stroke-width="2.5"/><line x1="89.67" y1="45.39" x2="82.15" y2="188.94" stroke="#0f1f3d" stroke-width="2.5" stroke-dasharray="4,3"/><line x1="190.33" y1="45.39" x2="82.15" y2="188.94" stroke="#0f1f3d" stroke-width="2.5" stroke-dasharray="4,3"/><path d="M 163.97,191.2 A 15,15 0 0 1 172.61,189.68" fill="none" stroke="#2563eb" stroke-width="2"/><path d="M 83.09,170.96 A 18,18 0 0 1 92.98,174.56" fill="none" stroke="#ea580c" stroke-width="2"/><circle cx="89.67" cy="45.39" r="2.5" fill="#0f1f3d"/><text x="71.67" y="51.39" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="190.33" cy="45.39" r="2.5" fill="#0f1f3d"/><text x="198.33" y="51.39" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="170.78" cy="204.57" r="2.5" fill="#0f1f3d"/><text x="178.78" y="198.57" font-size="13" fill="#0f1f3d" font-weight="700">C</text><circle cx="82.15" cy="188.94" r="2.5" fill="#0f1f3d"/><text x="64.15" y="178.94" font-size="13" fill="#0f1f3d" font-weight="700">D</text><text x="170.78" y="228.57" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">(3x+4)°</text><text x="86.15" y="210.94" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">(5x−16)°</text></svg>' },
        { difficulty: 'Hard', question: 'AB is a diameter of a circle with AB = 20 cm. P is a point on the circumference with AP = 12 cm. Find ∠APB, then find the length of BP.', checkMode: 'auto', correctAnswer: '90,16', correctAnswers: ['90,16', '90°,16cm', '90°, 16 cm'], answer: '∠APB = 90°, BP = 16 cm', explanation: 'AB is a diameter, so ∠APB = 90° (angle in a semicircle).\nTriangle APB is right-angled at P: BP² = AB² − AP² = 20² − 12² = 400 − 144 = 256.\nBP = √256 = 16 cm ✓', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="50" y1="120" x2="230" y2="120" stroke="#ea580c" stroke-width="2.5"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><line x1="50" y1="120" x2="224.57" y2="89.22" stroke="#0f1f3d" stroke-width="2.5"/><line x1="230" y1="120" x2="224.57" y2="89.22" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 214.72,90.95 L 216.46,100.80 L 226.31,99.07" fill="none" stroke="#0f1f3d" stroke-width="1.8"/><circle cx="50" cy="120" r="2.5" fill="#0f1f3d"/><text x="32" y="124" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="230" cy="120" r="2.5" fill="#0f1f3d"/><text x="238" y="124" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="224.57" cy="89.22" r="2.5" fill="#0f1f3d"/><text x="232.57" y="79.22" font-size="13" fill="#0f1f3d" font-weight="700">P</text><text x="115.29" y="100.61" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">AP = 12 cm</text><text x="140" y="140" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">AB = 20 cm</text><text x="253.29" y="98.61" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },

        // Block 4 — Cyclic quadrilateral: opposite angles / exterior angle
        { difficulty: 'Easy', question: 'In cyclic quadrilateral ABCD, ∠A = 102°. Find ∠C.', checkMode: 'auto', correctAnswer: '78', correctAnswers: ['78', '78°', '78 degrees'], answer: '78°', explanation: 'Opposite angles of a cyclic quadrilateral are supplementary.\n∠C = 180° − 102° = 78° ✓', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="55.43" y1="89.22" x2="59.11" y2="159.45" stroke="#0f1f3d" stroke-width="2.5"/><line x1="59.11" y1="159.45" x2="224.57" y2="150.78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="224.57" y1="150.78" x2="197.85" y2="51.06" stroke="#0f1f3d" stroke-width="2.5"/><line x1="197.85" y1="51.06" x2="55.43" y2="89.22" stroke="#0f1f3d" stroke-width="2.5"/><circle cx="55.43" cy="89.22" r="2.5" fill="#0f1f3d"/><text x="35.43" y="89.22" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="59.11" cy="159.45" r="2.5" fill="#0f1f3d"/><text x="53.11" y="177.45" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="224.57" cy="150.78" r="2.5" fill="#0f1f3d"/><text x="234.57" y="156.78" font-size="13" fill="#0f1f3d" font-weight="700">C</text><circle cx="197.85" cy="51.06" r="2.5" fill="#0f1f3d"/><text x="201.85" y="39.06" font-size="13" fill="#0f1f3d" font-weight="700">D</text><text x="81.74" y="98.8" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">102°</text><text x="198.26" y="141.2" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },
        { difficulty: 'Easy', question: 'In cyclic quadrilateral ABCD, ∠B = 95°. Find ∠D.', checkMode: 'auto', correctAnswer: '85', correctAnswers: ['85', '85°', '85 degrees'], answer: '85°', explanation: 'Opposite angles of a cyclic quadrilateral are supplementary.\n∠D = 180° − 95° = 85° ✓', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="51.37" y1="104.37" x2="82.15" y2="188.94" stroke="#0f1f3d" stroke-width="2.5"/><line x1="82.15" y1="188.94" x2="224.57" y2="150.78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="224.57" y1="150.78" x2="197.85" y2="51.06" stroke="#0f1f3d" stroke-width="2.5"/><line x1="197.85" y1="51.06" x2="51.37" y2="104.37" stroke="#0f1f3d" stroke-width="2.5"/><circle cx="51.37" cy="104.37" r="2.5" fill="#0f1f3d"/><text x="31.37" y="104.37" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="82.15" cy="188.94" r="2.5" fill="#0f1f3d"/><text x="76.15" y="206.94" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="224.57" cy="150.78" r="2.5" fill="#0f1f3d"/><text x="234.57" y="156.78" font-size="13" fill="#0f1f3d" font-weight="700">C</text><circle cx="197.85" cy="51.06" r="2.5" fill="#0f1f3d"/><text x="201.85" y="39.06" font-size="13" fill="#0f1f3d" font-weight="700">D</text><text x="100.15" y="167.49" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">95°</text><text x="193.85" y="63.06" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },
        { difficulty: 'Medium', question: 'PQRS is a cyclic quadrilateral with ∠PQR = 118°. Side RS is extended beyond S to a point T, forming exterior angle ∠PST. Find ∠PST, and name the theorem used.', checkMode: 'auto', correctAnswer: '118', correctAnswers: ['118', '118°', '118 degrees'], answer: '118°', explanation: 'The exterior angle of a cyclic quadrilateral equals the interior opposite angle.\n∠PST = ∠PQR = 118° ✓', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="62.06" y1="165" x2="170.78" y2="204.57" stroke="#0f1f3d" stroke-width="2.5"/><line x1="170.78" y1="204.57" x2="220.89" y2="159.45" stroke="#0f1f3d" stroke-width="2.5"/><line x1="220.89" y1="159.45" x2="71.06" y2="62.15" stroke="#0f1f3d" stroke-width="2.5"/><line x1="71.06" y1="62.15" x2="33.32" y2="37.64" stroke="#0f1f3d" stroke-width="2.5"/><line x1="71.06" y1="62.15" x2="62.06" y2="165" stroke="#0f1f3d" stroke-width="2.5"/><circle cx="62.06" cy="165" r="2.5" fill="#0f1f3d"/><text x="54.06" y="185" font-size="13" fill="#0f1f3d" font-weight="700">P</text><circle cx="170.78" cy="204.57" r="2.5" fill="#0f1f3d"/><text x="164.78" y="192.57" font-size="13" fill="#0f1f3d" font-weight="700">Q</text><circle cx="220.89" cy="159.45" r="2.5" fill="#0f1f3d"/><text x="230.89" y="153.45" font-size="13" fill="#0f1f3d" font-weight="700">R</text><circle cx="71.06" cy="62.15" r="2.5" fill="#0f1f3d"/><text x="63.06" y="50.15" font-size="13" fill="#0f1f3d" font-weight="700">S</text><circle cx="33.32" cy="37.64" r="2.5" fill="#0f1f3d"/><text x="23.32" y="25.64" font-size="13" fill="#0f1f3d" font-weight="700">T</text><text x="161.2" y="178.26" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">118°</text><text x="53.08" y="70.92" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },
        { difficulty: 'Hard', question: 'In cyclic quadrilateral ABCD, ∠A = (2x + 15)° and ∠C = (x + 45)°. Find x, then find ∠A and ∠C.', checkMode: 'auto', correctAnswer: '40,95,85', correctAnswers: ['40,95,85', '40,95°,85°', 'x=40,95°,85°'], answer: 'x = 40, ∠A = 95°, ∠C = 85°', explanation: 'Opposite angles are supplementary: (2x + 15) + (x + 45) = 180.\n3x + 60 = 180.\nx = 40.\n∠A = 2(40) + 15 = 95°, ∠C = 40 + 45 = 85°. Check: 95° + 85° = 180° ✓', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="55.43" y1="89.22" x2="71.06" y2="177.85" stroke="#0f1f3d" stroke-width="2.5"/><line x1="71.06" y1="177.85" x2="224.57" y2="150.78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="224.57" y1="150.78" x2="197.85" y2="51.06" stroke="#0f1f3d" stroke-width="2.5"/><line x1="197.85" y1="51.06" x2="55.43" y2="89.22" stroke="#0f1f3d" stroke-width="2.5"/><circle cx="55.43" cy="89.22" r="2.5" fill="#0f1f3d"/><text x="35.43" y="89.22" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="71.06" cy="177.85" r="2.5" fill="#0f1f3d"/><text x="65.06" y="195.85" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="224.57" cy="150.78" r="2.5" fill="#0f1f3d"/><text x="234.57" y="156.78" font-size="13" fill="#0f1f3d" font-weight="700">C</text><circle cx="197.85" cy="51.06" r="2.5" fill="#0f1f3d"/><text x="201.85" y="39.06" font-size="13" fill="#0f1f3d" font-weight="700">D</text><text x="81.74" y="98.8" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">(2x+15)°</text><text x="198.26" y="141.2" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">(x+45)°</text></svg>' },

        // Block 5 — Tangents: equal tangents / tangent-chord (alternate segment)
        { difficulty: 'Easy', question: 'Tangents PA and PB are drawn from external point P to a circle. If PA = 11 cm, find PB.', checkMode: 'auto', correctAnswer: '11', correctAnswers: ['11', '11cm', '11 cm'], answer: '11 cm', explanation: 'Tangent segments from an external point are equal.\nPB = PA = 11 cm ✓', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="20" x2="100.77" y2="39" stroke="#16a34a" stroke-width="2.5"/><line x1="140" y1="20" x2="179.23" y2="39" stroke="#16a34a" stroke-width="2.5"/><path d="M 109.77,34.64 L 114.13,43.64 L 105.13,48.00" fill="none" stroke="#0f1f3d" stroke-width="1.8"/><path d="M 170.23,34.64 L 165.87,43.64 L 174.87,48.00" fill="none" stroke="#0f1f3d" stroke-width="1.8"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><circle cx="140" cy="20" r="2.5" fill="#0f1f3d"/><text x="134" y="10" font-size="13" fill="#0f1f3d" font-weight="700">P</text><circle cx="100.77" cy="39" r="2.5" fill="#0f1f3d"/><text x="80.77" y="43" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="179.23" cy="39" r="2.5" fill="#0f1f3d"/><text x="189.23" y="49" font-size="13" fill="#0f1f3d" font-weight="700">B</text><text x="100.39" y="27.50" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">PA = 11 cm</text><text x="179.62" y="29.50" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },
        { difficulty: 'Easy', question: 'A tangent at point T makes an angle of 58° with chord TC. Point B lies in the alternate segment. Find ∠TBC, and name the theorem used.', checkMode: 'auto', correctAnswer: '58', correctAnswers: ['58', '58°', '58 degrees'], answer: '58°', explanation: 'By the alternate segment theorem (tangent-chord theorem), the inscribed angle in the alternate segment equals the tangent-chord angle.\n∠TBC = 58° ✓', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="70" y1="210" x2="210" y2="210" stroke="#16a34a" stroke-width="2.5"/><line x1="140" y1="210" x2="59.11" y2="80.55" stroke="#ea580c" stroke-width="2.5"/><line x1="140" y1="210" x2="224.57" y2="89.22" stroke="#0f1f3d" stroke-width="2.5"/><line x1="59.11" y1="80.55" x2="224.57" y2="89.22" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 118,210 A 22,22 0 0 1 128.34,191.34" fill="none" stroke="#dc2626" stroke-width="2"/><path d="M 215.97,101.51 A 15,15 0 0 1 209.59,88.43" fill="none" stroke="#2563eb" stroke-width="2"/><circle cx="140" cy="210" r="2.5" fill="#0f1f3d"/><text x="146" y="226" font-size="13" fill="#0f1f3d" font-weight="700">T</text><circle cx="59.11" cy="80.55" r="2.5" fill="#0f1f3d"/><text x="39.11" y="84.55" font-size="13" fill="#0f1f3d" font-weight="700">C</text><circle cx="224.57" cy="89.22" r="2.5" fill="#0f1f3d"/><text x="234.57" y="83.22" font-size="13" fill="#0f1f3d" font-weight="700">B</text><text x="110" y="200" font-size="11" fill="#dc2626" font-weight="700" text-anchor="middle">58°</text><text x="230.57" y="71.22" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },
        { difficulty: 'Medium', question: 'Tangents PA and PB are drawn from external point P to a circle, with ∠APB = 46°. Since PA = PB, triangle PAB is isosceles. Find ∠PAB.', checkMode: 'auto', correctAnswer: '67', correctAnswers: ['67', '67°', '67 degrees'], answer: '67°', explanation: 'Since PA = PB (equal tangents from an external point), triangle PAB is isosceles, so ∠PAB = ∠PBA.\n∠PAB = (180° − 46°) ÷ 2 = 134° ÷ 2 = 67° ✓', diagramSvg: '<svg viewBox="0 -136 280 376" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="-110.34" x2="57.15" y2="84.83" stroke="#16a34a" stroke-width="2.5"/><line x1="140" y1="-110.34" x2="222.85" y2="84.83" stroke="#16a34a" stroke-width="2.5"/><line x1="57.15" y1="84.83" x2="222.85" y2="84.83" stroke="#ea580c" stroke-width="2.5"/><path d="M 132.97,-93.77 A 18,18 0 0 0 147.03,-93.77" fill="none" stroke="#dc2626" stroke-width="2"/><path d="M 63.02,71.03 A 15,15 0 0 1 72.15,84.83" fill="none" stroke="#ea580c" stroke-width="2"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><circle cx="140" cy="-110.34" r="2.5" fill="#0f1f3d"/><text x="134" y="-120.34" font-size="13" fill="#0f1f3d" font-weight="700">P</text><circle cx="57.15" cy="84.83" r="2.5" fill="#0f1f3d"/><text x="37.15" y="90.83" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="222.85" cy="84.83" r="2.5" fill="#0f1f3d"/><text x="232.85" y="94.83" font-size="13" fill="#0f1f3d" font-weight="700">B</text><text x="140" y="-76.34" font-size="11" fill="#dc2626" font-weight="700" text-anchor="middle">46°</text><text x="82.18" y="77.79" font-size="11" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },
        { difficulty: 'Hard', question: 'Tangents PA and PB are drawn from external point P to a circle, touching it at A and B. ∠APB = 40°. C is a point on the major arc AB. Find ∠PAB, then use the alternate segment theorem to find ∠ACB.', checkMode: 'auto', correctAnswer: '70,70', correctAnswers: ['70,70', '70°,70°', '70°, 70°'], answer: '∠PAB = 70°, ∠ACB = 70°', explanation: 'Since PA = PB, triangle PAB is isosceles: ∠PAB = (180° − 40°) ÷ 2 = 70°.\n∠PAB is the tangent-chord angle at A for chord AB. By the alternate segment theorem, ∠ACB = ∠PAB = 70° ✓', diagramSvg: '<svg viewBox="0 -169 280 409" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="-143.14" x2="55.43" y2="89.22" stroke="#16a34a" stroke-width="2.5"/><line x1="140" y1="-143.14" x2="224.57" y2="89.22" stroke="#16a34a" stroke-width="2.5"/><line x1="55.43" y1="89.22" x2="224.57" y2="89.22" stroke="#ea580c" stroke-width="2.5" stroke-dasharray="4,3"/><line x1="55.43" y1="89.22" x2="163.29" y2="206.93" stroke="#0f1f3d" stroke-width="2.5"/><line x1="224.57" y1="89.22" x2="163.29" y2="206.93" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 134.53,-128.11 A 16,16 0 0 0 145.47,-128.11" fill="none" stroke="#dc2626" stroke-width="2"/><path d="M 153.83,196.61 A 14,14 0 0 1 169.75,194.51" fill="none" stroke="#2563eb" stroke-width="2"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><circle cx="140" cy="-143.14" r="2.5" fill="#0f1f3d"/><text x="134" y="-151.14" font-size="13" fill="#0f1f3d" font-weight="700">P</text><circle cx="55.43" cy="89.22" r="2.5" fill="#0f1f3d"/><text x="35.43" y="95.22" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="224.57" cy="89.22" r="2.5" fill="#0f1f3d"/><text x="234.57" y="97.22" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="163.29" cy="206.93" r="2.5" fill="#0f1f3d"/><text x="157.29" y="226.93" font-size="13" fill="#0f1f3d" font-weight="700">C</text><text x="140" y="-113.14" font-size="11" fill="#dc2626" font-weight="700" text-anchor="middle">40°</text><text x="163.29" y="192.93" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        // Block 2 — Angle at centre = 2 × angle at circumference (+ reflex)
        { difficulty: 'Easy', question: 'In a circle with centre O, chord AB subtends ∠AOB = 70° at the centre. Point C lies on the major arc, on the same side as the 70° angle. Find ∠ACB.', checkMode: 'auto', correctAnswer: '35', correctAnswers: ['35', '35°', '35 degrees'], answer: '35°', explanation: 'The angle at the centre is double the angle at the circumference.\n∠ACB = 70° ÷ 2 = 35° ✓', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="191.62" y2="193.72" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="88.38" y2="193.72" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 153.77,139.66 A 24,24 0 0 1 126.23,139.66" fill="none" stroke="#dc2626" stroke-width="2"/><line x1="191.62" y1="193.72" x2="140" y2="30" stroke="#ea580c" stroke-width="2.5"/><line x1="88.38" y1="193.72" x2="140" y2="30" stroke="#ea580c" stroke-width="2.5"/><path d="M 144.51,44.31 A 15,15 0 0 1 135.49,44.31" fill="none" stroke="#16a34a" stroke-width="2"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><circle cx="191.62" cy="193.72" r="2.5" fill="#0f1f3d"/><text x="173.62" y="197.72" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="88.38" cy="193.72" r="2.5" fill="#0f1f3d"/><text x="96.38" y="197.72" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="140" cy="30" r="2.5" fill="#0f1f3d"/><text x="134" y="18" font-size="13" fill="#0f1f3d" font-weight="700">C</text><text x="140" y="154" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">70°</text><text x="140" y="56" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },
        { difficulty: 'Easy', question: 'In a circle with centre O, chord PQ subtends ∠PRQ = 63° at point R on the circumference. Find ∠POQ at the centre.', checkMode: 'auto', correctAnswer: '126', correctAnswers: ['126', '126°', '126 degrees'], answer: '126°', explanation: 'The angle at the centre is double the angle at the circumference.\n∠POQ = 2 × 63° = 126° ✓', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="220.19" y2="160.86" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="59.81" y2="160.86" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 161.38,130.9 A 24,24 0 0 1 118.62,130.9" fill="none" stroke="#dc2626" stroke-width="2"/><line x1="220.19" y1="160.86" x2="140" y2="30" stroke="#ea580c" stroke-width="2.5"/><line x1="59.81" y1="160.86" x2="140" y2="30" stroke="#ea580c" stroke-width="2.5"/><path d="M 147.84,42.79 A 15,15 0 0 1 132.16,42.79" fill="none" stroke="#16a34a" stroke-width="2"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><circle cx="220.19" cy="160.86" r="2.5" fill="#0f1f3d"/><text x="202.19" y="164.86" font-size="13" fill="#0f1f3d" font-weight="700">P</text><circle cx="59.81" cy="160.86" r="2.5" fill="#0f1f3d"/><text x="67.81" y="164.86" font-size="13" fill="#0f1f3d" font-weight="700">Q</text><circle cx="140" cy="30" r="2.5" fill="#0f1f3d"/><text x="134" y="18" font-size="13" fill="#0f1f3d" font-weight="700">R</text><text x="140" y="154" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text><text x="140" y="56" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">63°</text></svg>' },
        { difficulty: 'Medium', question: 'In a circle with centre O, chord AB subtends ∠AOB = 100° at the centre, measured on the major-arc side. Point D lies on the minor arc. Find the reflex angle AOB, then find ∠ADB.', checkMode: 'auto', correctAnswer: '260,130', correctAnswers: ['260,130', '260°,130°', '260°, 130°'], answer: 'Reflex ∠AOB = 260°, ∠ADB = 130°', explanation: 'Reflex ∠AOB = 360° − 100° = 260°.\nD is on the minor arc, so use the reflex angle: ∠ADB = 260° ÷ 2 = 130° ✓', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="208.94" y2="177.85" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="71.06" y2="177.85" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 158.39,135.43 A 24,24 0 0 1 121.61,135.43" fill="none" stroke="#dc2626" stroke-width="2"/><line x1="208.94" y1="177.85" x2="140" y2="210" stroke="#0f1f3d" stroke-width="2.5" stroke-dasharray="4,3"/><line x1="71.06" y1="177.85" x2="140" y2="210" stroke="#0f1f3d" stroke-width="2.5" stroke-dasharray="4,3"/><path d="M 153.59,203.66 A 15,15 0 0 1 126.41,203.66" fill="none" stroke="#ea580c" stroke-width="2" stroke-dasharray="3,2"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><circle cx="208.94" cy="177.85" r="2.5" fill="#0f1f3d"/><text x="190.94" y="181.85" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="71.06" cy="177.85" r="2.5" fill="#0f1f3d"/><text x="79.06" y="181.85" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="140" cy="210" r="2.5" fill="#0f1f3d"/><text x="146" y="226" font-size="13" fill="#0f1f3d" font-weight="700">D</text><text x="140" y="154" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">100°</text><text x="140" y="184" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },
        ...
        // Block 3 — Angles in same segment + angle in a semicircle
        { difficulty: 'Easy', question: 'In a circle, points C and D lie on the same arc relative to chord AB. ∠ACB = 52°. Find ∠ADB.', checkMode: 'auto', correctAnswer: '52', correctAnswers: ['52', '52°', '52 degrees'], answer: '52°', explanation: 'C and D lie in the same segment relative to chord AB, so angles in the same segment are equal.\n∠ADB = ∠ACB = 52° ✓', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="69.08" y1="64.59" x2="210.92" y2="64.59" stroke="#ea580c" stroke-width="2.5"/><line x1="69.08" y1="64.59" x2="170.78" y2="204.57" stroke="#0f1f3d" stroke-width="2.5"/><line x1="210.92" y1="64.59" x2="170.78" y2="204.57" stroke="#0f1f3d" stroke-width="2.5"/><line x1="69.08" y1="64.59" x2="82.15" y2="188.94" stroke="#0f1f3d" stroke-width="2.5" stroke-dasharray="4,3"/><line x1="210.92" y1="64.59" x2="82.15" y2="188.94" stroke="#0f1f3d" stroke-width="2.5" stroke-dasharray="4,3"/><path d="M 161.96,192.43 A 15,15 0 0 1 174.91,190.15" fill="none" stroke="#2563eb" stroke-width="2"/><path d="M 80.27,171.04 A 18,18 0 0 1 95.1,176.44" fill="none" stroke="#ea580c" stroke-width="2"/><circle cx="69.08" cy="64.59" r="2.5" fill="#0f1f3d"/><text x="51.08" y="70.59" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="210.92" cy="64.59" r="2.5" fill="#0f1f3d"/><text x="218.92" y="70.59" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="170.78" cy="204.57" r="2.5" fill="#0f1f3d"/><text x="178.78" y="198.57" font-size="13" fill="#0f1f3d" font-weight="700">C</text><circle cx="82.15" cy="188.94" r="2.5" fill="#0f1f3d"/><text x="64.15" y="178.94" font-size="13" fill="#0f1f3d" font-weight="700">D</text><text x="170.78" y="228.57" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">52°</text><text x="86.15" y="210.94" font-size="11" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },
        { difficulty: 'Easy', question: 'AB is a diameter of a circle and P is a point on the circumference. ∠PAB = 34°. Find ∠APB, then find ∠PBA.', checkMode: 'auto', correctAnswer: '90,56', correctAnswers: ['90,56', '90°,56°', '90°, 56°'], answer: '∠APB = 90°, ∠PBA = 56°', explanation: 'Since AB is a diameter, ∠APB = 90° (angle in a semicircle).\nIn triangle APB: 34° + 90° + ∠PBA = 180°.\n∠PBA = 180° − 90° − 34° = 56° ✓', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="50" y1="120" x2="230" y2="120" stroke="#ea580c" stroke-width="2.5"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><line x1="50" y1="120" x2="173.71" y2="36.55" stroke="#0f1f3d" stroke-width="2.5"/><line x1="230" y1="120" x2="173.71" y2="36.55" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 165.42,42.15 L 171.02,50.44 L 179.31,44.84" fill="none" stroke="#0f1f3d" stroke-width="1.8"/><circle cx="50" cy="120" r="2.5" fill="#0f1f3d"/><text x="32" y="124" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="230" cy="120" r="2.5" fill="#0f1f3d"/><text x="238" y="124" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="173.71" cy="36.55" r="2.5" fill="#0f1f3d"/><text x="181.71" y="26.55" font-size="13" fill="#0f1f3d" font-weight="700">P</text><path d="M 61.61,112.17 A 14,14 0 0 1 64,120" fill="none" stroke="#2563eb" stroke-width="2"/><text x="76" y="112" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">34°</text><text x="167.71" y="60.55" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },
        { difficulty: 'Medium', question: 'Points A, B, C and D lie on a circle, with C and D on the same arc relative to chord AB. ∠ACB = (2x + 9)° and ∠ADB = (4x − 19)°. Find x, then find ∠ACB.', checkMode: 'auto', correctAnswer: '14,37', correctAnswers: ['14,37', '14,37°', 'x=14,37°'], answer: 'x = 14, ∠ACB = 37°', explanation: 'Angles in the same segment are equal: 2x + 9 = 4x − 19.\n28 = 2x.\nx = 14.\n∠ACB = 2(14) + 9 = 37° ✓', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="85.84" y1="48.12" x2="194.16" y2="48.12" stroke="#ea580c" stroke-width="2.5"/><line x1="85.84" y1="48.12" x2="170.78" y2="204.57" stroke="#0f1f3d" stroke-width="2.5"/><line x1="194.16" y1="48.12" x2="170.78" y2="204.57" stroke="#0f1f3d" stroke-width="2.5"/><line x1="85.84" y1="48.12" x2="82.15" y2="188.94" stroke="#0f1f3d" stroke-width="2.5" stroke-dasharray="4,3"/><line x1="194.16" y1="48.12" x2="82.15" y2="188.94" stroke="#0f1f3d" stroke-width="2.5" stroke-dasharray="4,3"/><path d="M 163.62,191.39 A 15,15 0 0 1 173,189.73" fill="none" stroke="#2563eb" stroke-width="2"/><path d="M 82.62,170.95 A 18,18 0 0 1 93.36,174.85" fill="none" stroke="#ea580c" stroke-width="2"/><circle cx="85.84" cy="48.12" r="2.5" fill="#0f1f3d"/><text x="67.84" y="54.12" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="194.16" cy="48.12" r="2.5" fill="#0f1f3d"/><text x="202.16" y="54.12" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="170.78" cy="204.57" r="2.5" fill="#0f1f3d"/><text x="178.78" y="198.57" font-size="13" fill="#0f1f3d" font-weight="700">C</text><circle cx="82.15" cy="188.94" r="2.5" fill="#0f1f3d"/><text x="64.15" y="178.94" font-size="13" fill="#0f1f3d" font-weight="700">D</text><text x="170.78" y="228.57" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">(2x+9)°</text><text x="86.15" y="210.94" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">(4x−19)°</text></svg>' },
        { difficulty: 'Hard', question: 'AB is a diameter of a circle with AB = 26 cm. P is a point on the circumference with AP = 10 cm. Find ∠APB, then find the length of BP.', checkMode: 'auto', correctAnswer: '90,24', correctAnswers: ['90,24', '90°,24cm', '90°, 24 cm'], answer: '∠APB = 90°, BP = 24 cm', explanation: 'AB is a diameter, so ∠APB = 90° (angle in a semicircle).\nTriangle APB is right-angled at P: BP² = AB² − AP² = 26² − 10² = 676 − 100 = 576.\nBP = √576 = 24 cm ✓', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="50" y1="120" x2="230" y2="120" stroke="#ea580c" stroke-width="2.5"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><line x1="50" y1="120" x2="224.57" y2="89.22" stroke="#0f1f3d" stroke-width="2.5"/><line x1="230" y1="120" x2="224.57" y2="89.22" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 214.72,90.95 L 216.46,100.80 L 226.31,99.07" fill="none" stroke="#0f1f3d" stroke-width="1.8"/><circle cx="50" cy="120" r="2.5" fill="#0f1f3d"/><text x="32" y="124" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="230" cy="120" r="2.5" fill="#0f1f3d"/><text x="238" y="124" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="224.57" cy="89.22" r="2.5" fill="#0f1f3d"/><text x="232.57" y="79.22" font-size="13" fill="#0f1f3d" font-weight="700">P</text><text x="115.29" y="100.61" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">AP = 10 cm</text><text x="140" y="140" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">AB = 26 cm</text><text x="253.29" y="98.61" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },

        // Block 4 — Cyclic quadrilateral: opposite angles / exterior angle
        { difficulty: 'Easy', question: 'In cyclic quadrilateral ABCD, ∠A = 88°. Find ∠C.', checkMode: 'auto', correctAnswer: '92', correctAnswers: ['92', '92°', '92 degrees'], answer: '92°', explanation: 'Opposite angles of a cyclic quadrilateral are supplementary.\n∠C = 180° − 88° = 92° ✓', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="55.43" y1="89.22" x2="87.1" y2="192.81" stroke="#0f1f3d" stroke-width="2.5"/><line x1="87.1" y1="192.81" x2="224.57" y2="150.78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="224.57" y1="150.78" x2="197.85" y2="51.06" stroke="#0f1f3d" stroke-width="2.5"/><line x1="197.85" y1="51.06" x2="55.43" y2="89.22" stroke="#0f1f3d" stroke-width="2.5"/><circle cx="55.43" cy="89.22" r="2.5" fill="#0f1f3d"/><text x="35.43" y="89.22" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="87.1" cy="192.81" r="2.5" fill="#0f1f3d"/><text x="81.1" y="210.81" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="224.57" cy="150.78" r="2.5" fill="#0f1f3d"/><text x="234.57" y="156.78" font-size="13" fill="#0f1f3d" font-weight="700">C</text><circle cx="197.85" cy="51.06" r="2.5" fill="#0f1f3d"/><text x="201.85" y="39.06" font-size="13" fill="#0f1f3d" font-weight="700">D</text><text x="81.74" y="98.8" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">88°</text><text x="198.26" y="141.2" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },
        { difficulty: 'Easy', question: 'In cyclic quadrilateral ABCD, ∠B = 73°. Find ∠D.', checkMode: 'auto', correctAnswer: '107', correctAnswers: ['107', '107°', '107 degrees'], answer: '107°', explanation: 'Opposite angles of a cyclic quadrilateral are supplementary.\n∠D = 180° − 73° = 107° ✓', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="87.1" y1="47.19" x2="82.15" y2="188.94" stroke="#0f1f3d" stroke-width="2.5"/><line x1="82.15" y1="188.94" x2="224.57" y2="150.78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="224.57" y1="150.78" x2="197.85" y2="51.06" stroke="#0f1f3d" stroke-width="2.5"/><line x1="197.85" y1="51.06" x2="87.1" y2="47.19" stroke="#0f1f3d" stroke-width="2.5"/><circle cx="87.1" cy="47.19" r="2.5" fill="#0f1f3d"/><text x="67.1" y="47.19" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="82.15" cy="188.94" r="2.5" fill="#0f1f3d"/><text x="76.15" y="206.94" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="224.57" cy="150.78" r="2.5" fill="#0f1f3d"/><text x="234.57" y="156.78" font-size="13" fill="#0f1f3d" font-weight="700">C</text><circle cx="197.85" cy="51.06" r="2.5" fill="#0f1f3d"/><text x="201.85" y="39.06" font-size="13" fill="#0f1f3d" font-weight="700">D</text><text x="100.15" y="167.49" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">73°</text><text x="193.85" y="63.06" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },
        { difficulty: 'Medium', question: 'WXYZ is a cyclic quadrilateral with ∠WXY = 126°. Side YZ is extended beyond Z to a point T, forming exterior angle ∠WZT. Find ∠WZT, and name the theorem used.', checkMode: 'auto', correctAnswer: '126', correctAnswers: ['126', '126°', '126 degrees'], answer: '126°', explanation: 'The exterior angle of a cyclic quadrilateral equals the interior opposite angle.\n∠WZT = ∠WXY = 126° ✓', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="62.06" y1="165" x2="170.78" y2="204.57" stroke="#0f1f3d" stroke-width="2.5"/><line x1="170.78" y1="204.57" x2="206.88" y2="180.22" stroke="#0f1f3d" stroke-width="2.5"/><line x1="206.88" y1="180.22" x2="71.06" y2="62.15" stroke="#0f1f3d" stroke-width="2.5"/><line x1="71.06" y1="62.15" x2="37.1" y2="32.63" stroke="#0f1f3d" stroke-width="2.5"/><line x1="71.06" y1="62.15" x2="62.06" y2="165" stroke="#0f1f3d" stroke-width="2.5"/><circle cx="62.06" cy="165" r="2.5" fill="#0f1f3d"/><text x="54.06" y="185" font-size="13" fill="#0f1f3d" font-weight="700">W</text><circle cx="170.78" cy="204.57" r="2.5" fill="#0f1f3d"/><text x="164.78" y="192.57" font-size="13" fill="#0f1f3d" font-weight="700">X</text><circle cx="206.88" cy="180.22" r="2.5" fill="#0f1f3d"/><text x="216.88" y="174.22" font-size="13" fill="#0f1f3d" font-weight="700">Y</text><circle cx="71.06" cy="62.15" r="2.5" fill="#0f1f3d"/><text x="63.06" y="50.15" font-size="13" fill="#0f1f3d" font-weight="700">Z</text><circle cx="37.1" cy="32.63" r="2.5" fill="#0f1f3d"/><text x="27.1" y="20.63" font-size="13" fill="#0f1f3d" font-weight="700">T</text><text x="161.2" y="178.26" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">126°</text><text x="52.52" y="69.64" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },
        { difficulty: 'Hard', question: 'In cyclic quadrilateral ABCD, ∠A = (3x − 10)° and ∠C = (x + 30)°. Find x, then find ∠A and ∠C.', checkMode: 'auto', correctAnswer: '40,110,70', correctAnswers: ['40,110,70', '40,110°,70°', 'x=40,110°,70°'], answer: 'x = 40, ∠A = 110°, ∠C = 70°', explanation: 'Opposite angles are supplementary: (3x − 10) + (x + 30) = 180.\n4x + 20 = 180.\nx = 40.\n∠A = 3(40) − 10 = 110°, ∠C = 40 + 30 = 70°. Check: 110° + 70° = 180° ✓', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="55.43" y1="89.22" x2="51.37" y2="135.63" stroke="#0f1f3d" stroke-width="2.5"/><line x1="51.37" y1="135.63" x2="224.57" y2="150.78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="224.57" y1="150.78" x2="197.85" y2="51.06" stroke="#0f1f3d" stroke-width="2.5"/><line x1="197.85" y1="51.06" x2="55.43" y2="89.22" stroke="#0f1f3d" stroke-width="2.5"/><circle cx="55.43" cy="89.22" r="2.5" fill="#0f1f3d"/><text x="35.43" y="89.22" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="51.37" cy="135.63" r="2.5" fill="#0f1f3d"/><text x="45.37" y="153.63" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="224.57" cy="150.78" r="2.5" fill="#0f1f3d"/><text x="234.57" y="156.78" font-size="13" fill="#0f1f3d" font-weight="700">C</text><circle cx="197.85" cy="51.06" r="2.5" fill="#0f1f3d"/><text x="201.85" y="39.06" font-size="13" fill="#0f1f3d" font-weight="700">D</text><text x="81.74" y="98.8" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">(3x−10)°</text><text x="198.26" y="141.2" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">(x+30)°</text></svg>' },

        // Block 5 — Tangents: equal tangents / tangent-chord (alternate segment)
        { difficulty: 'Easy', question: 'Tangents PA and PB are drawn from external point P to a circle. If PA = 14 cm, find PB.', checkMode: 'auto', correctAnswer: '14', correctAnswers: ['14', '14cm', '14 cm'], answer: '14 cm', explanation: 'Tangent segments from an external point are equal.\nPB = PA = 14 cm ✓', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="20" x2="100.77" y2="39" stroke="#16a34a" stroke-width="2.5"/><line x1="140" y1="20" x2="179.23" y2="39" stroke="#16a34a" stroke-width="2.5"/><path d="M 109.77,34.64 L 114.13,43.64 L 105.13,48.00" fill="none" stroke="#0f1f3d" stroke-width="1.8"/><path d="M 170.23,34.64 L 165.87,43.64 L 174.87,48.00" fill="none" stroke="#0f1f3d" stroke-width="1.8"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><circle cx="140" cy="20" r="2.5" fill="#0f1f3d"/><text x="134" y="10" font-size="13" fill="#0f1f3d" font-weight="700">P</text><circle cx="100.77" cy="39" r="2.5" fill="#0f1f3d"/><text x="80.77" y="43" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="179.23" cy="39" r="2.5" fill="#0f1f3d"/><text x="189.23" y="49" font-size="13" fill="#0f1f3d" font-weight="700">B</text><text x="100.39" y="27.50" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">PA = 14 cm</text><text x="179.62" y="29.50" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },
        { difficulty: 'Easy', question: 'A tangent at point T makes an angle of 49° with chord TC. Point B lies in the alternate segment. Find ∠TBC, and name the theorem used.', checkMode: 'auto', correctAnswer: '49', correctAnswers: ['49', '49°', '49 degrees'], answer: '49°', explanation: 'By the alternate segment theorem (tangent-chord theorem), the inscribed angle in the alternate segment equals the tangent-chord angle.\n∠TBC = 49° ✓', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="70" y1="210" x2="210" y2="210" stroke="#16a34a" stroke-width="2.5"/><line x1="140" y1="210" x2="50.88" y2="107.47" stroke="#ea580c" stroke-width="2.5"/><line x1="140" y1="210" x2="224.57" y2="89.22" stroke="#0f1f3d" stroke-width="2.5"/><line x1="50.88" y1="107.47" x2="224.57" y2="89.22" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 118,210 A 22,22 0 0 1 125.57,193.4" fill="none" stroke="#dc2626" stroke-width="2"/><path d="M 215.97,101.51 A 15,15 0 0 1 209.65,90.79" fill="none" stroke="#2563eb" stroke-width="2"/><circle cx="140" cy="210" r="2.5" fill="#0f1f3d"/><text x="146" y="226" font-size="13" fill="#0f1f3d" font-weight="700">T</text><circle cx="50.88" cy="107.47" r="2.5" fill="#0f1f3d"/><text x="30.88" y="111.47" font-size="13" fill="#0f1f3d" font-weight="700">C</text><circle cx="224.57" cy="89.22" r="2.5" fill="#0f1f3d"/><text x="234.57" y="83.22" font-size="13" fill="#0f1f3d" font-weight="700">B</text><text x="110" y="200" font-size="11" fill="#dc2626" font-weight="700" text-anchor="middle">49°</text><text x="230.57" y="71.22" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },
        { difficulty: 'Medium', question: 'Tangents PA and PB are drawn from external point P to a circle, with ∠APB = 62°. Since PA = PB, triangle PAB is isosceles. Find ∠PAB.', checkMode: 'auto', correctAnswer: '59', correctAnswers: ['59', '59°', '59 degrees'], answer: '59°', explanation: 'Since PA = PB (equal tangents from an external point), triangle PAB is isosceles, so ∠PAB = ∠PBA.\n∠PAB = (180° − 62°) ÷ 2 = 118° ÷ 2 = 59° ✓', diagramSvg: '<svg viewBox="0 -80 280 320" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="-54.74" x2="62.85" y2="73.65" stroke="#16a34a" stroke-width="2.5"/><line x1="140" y1="-54.74" x2="217.15" y2="73.65" stroke="#16a34a" stroke-width="2.5"/><line x1="62.85" y1="73.65" x2="217.15" y2="73.65" stroke="#ea580c" stroke-width="2.5"/><path d="M 130.73,-39.32 A 18,18 0 0 0 149.27,-39.32" fill="none" stroke="#dc2626" stroke-width="2"/><path d="M 70.58,60.79 A 15,15 0 0 1 77.85,73.65" fill="none" stroke="#ea580c" stroke-width="2"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><circle cx="140" cy="-54.74" r="2.5" fill="#0f1f3d"/><text x="134" y="-64.74" font-size="13" fill="#0f1f3d" font-weight="700">P</text><circle cx="62.85" cy="73.65" r="2.5" fill="#0f1f3d"/><text x="42.85" y="79.65" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="217.15" cy="73.65" r="2.5" fill="#0f1f3d"/><text x="227.15" y="83.65" font-size="13" fill="#0f1f3d" font-weight="700">B</text><text x="140" y="-20.74" font-size="11" fill="#dc2626" font-weight="700" text-anchor="middle">62°</text><text x="87.88" y="66.61" font-size="11" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },
        { difficulty: 'Hard', question: 'Tangents PA and PB are drawn from external point P to a circle, touching it at A and B. ∠APB = 54°. C is a point on the major arc AB. Find ∠PAB, then use the alternate segment theorem to find ∠ACB.', checkMode: 'auto', correctAnswer: '63,63', correctAnswers: ['63,63', '63°,63°', '63°, 63°'], answer: '∠PAB = 63°, ∠ACB = 63°', explanation: 'Since PA = PB, triangle PAB is isosceles: ∠PAB = (180° − 54°) ÷ 2 = 63°.\n∠PAB is the tangent-chord angle at A for chord AB. By the alternate segment theorem, ∠ACB = ∠PAB = 63° ✓', diagramSvg: '<svg viewBox="0 -104 280 344" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="-78.24" x2="59.81" y2="79.14" stroke="#16a34a" stroke-width="2.5"/><line x1="140" y1="-78.24" x2="220.19" y2="79.14" stroke="#16a34a" stroke-width="2.5"/><line x1="59.81" y1="79.14" x2="220.19" y2="79.14" stroke="#ea580c" stroke-width="2.5" stroke-dasharray="4,3"/><line x1="59.81" y1="79.14" x2="163.29" y2="206.93" stroke="#0f1f3d" stroke-width="2.5"/><line x1="220.19" y1="79.14" x2="163.29" y2="206.93" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 132.74,-63.99 A 16,16 0 0 0 147.26,-63.99" fill="none" stroke="#dc2626" stroke-width="2"/><path d="M 154.48,196.05 A 14,14 0 0 1 168.98,194.14" fill="none" stroke="#2563eb" stroke-width="2"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><circle cx="140" cy="-78.24" r="2.5" fill="#0f1f3d"/><text x="134" y="-86.24" font-size="13" fill="#0f1f3d" font-weight="700">P</text><circle cx="59.81" cy="79.14" r="2.5" fill="#0f1f3d"/><text x="39.81" y="85.14" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="220.19" cy="79.14" r="2.5" fill="#0f1f3d"/><text x="230.19" y="87.14" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="163.29" cy="206.93" r="2.5" fill="#0f1f3d"/><text x="157.29" y="226.93" font-size="13" fill="#0f1f3d" font-weight="700">C</text><text x="140" y="-48.24" font-size="11" fill="#dc2626" font-weight="700" text-anchor="middle">54°</text><text x="163.29" y="192.93" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        // Block 2 — Angle at centre = 2 × angle at circumference (+ reflex)
        { difficulty: 'Easy', question: 'In a circle with centre O, chord AB subtends ∠AOB = 112° at the centre. Point C lies on the major arc, on the same side as the 112° angle. Find ∠ACB.', checkMode: 'auto', correctAnswer: '56', correctAnswers: ['56', '56°', '56 degrees'], answer: '56°', explanation: 'The angle at the centre is double the angle at the circumference.\n∠ACB = 112° ÷ 2 = 56° ✓', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="214.61" y2="170.33" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="65.39" y2="170.33" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 159.9,133.42 A 24,24 0 0 1 120.1,133.42" fill="none" stroke="#dc2626" stroke-width="2"/><line x1="214.61" y1="170.33" x2="140" y2="30" stroke="#ea580c" stroke-width="2.5"/><line x1="65.39" y1="170.33" x2="140" y2="30" stroke="#ea580c" stroke-width="2.5"/><path d="M 147.04,43.24 A 15,15 0 0 1 132.96,43.24" fill="none" stroke="#16a34a" stroke-width="2"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><circle cx="214.61" cy="170.33" r="2.5" fill="#0f1f3d"/><text x="196.61" y="174.33" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="65.39" cy="170.33" r="2.5" fill="#0f1f3d"/><text x="73.39" y="174.33" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="140" cy="30" r="2.5" fill="#0f1f3d"/><text x="134" y="18" font-size="13" fill="#0f1f3d" font-weight="700">C</text><text x="140" y="154" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">112°</text><text x="140" y="56" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },
        { difficulty: 'Easy', question: 'In a circle with centre O, chord PQ subtends ∠PRQ = 44° at point R on the circumference. Find ∠POQ at the centre.', checkMode: 'auto', correctAnswer: '88', correctAnswers: ['88', '88°', '88 degrees'], answer: '88°', explanation: 'The angle at the centre is double the angle at the circumference.\n∠POQ = 2 × 44° = 88° ✓', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="202.52" y2="184.74" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="77.48" y2="184.74" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 156.67,137.26 A 24,24 0 0 1 123.33,137.26" fill="none" stroke="#dc2626" stroke-width="2"/><line x1="202.52" y1="184.74" x2="140" y2="30" stroke="#ea580c" stroke-width="2.5"/><line x1="77.48" y1="184.74" x2="140" y2="30" stroke="#ea580c" stroke-width="2.5"/><path d="M 145.62,43.91 A 15,15 0 0 1 134.38,43.91" fill="none" stroke="#16a34a" stroke-width="2"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><circle cx="202.52" cy="184.74" r="2.5" fill="#0f1f3d"/><text x="184.52" y="188.74" font-size="13" fill="#0f1f3d" font-weight="700">P</text><circle cx="77.48" cy="184.74" r="2.5" fill="#0f1f3d"/><text x="85.48" y="188.74" font-size="13" fill="#0f1f3d" font-weight="700">Q</text><circle cx="140" cy="30" r="2.5" fill="#0f1f3d"/><text x="134" y="18" font-size="13" fill="#0f1f3d" font-weight="700">R</text><text x="140" y="154" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text><text x="140" y="56" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">44°</text></svg>' },
        { difficulty: 'Medium', question: 'In a circle with centre O, chord AB subtends ∠AOB = 140° at the centre, measured on the major-arc side. Point D lies on the minor arc. Find the reflex angle AOB, then find ∠ADB.', checkMode: 'auto', correctAnswer: '220,110', correctAnswers: ['220,110', '220°,110°', '220°, 110°'], answer: 'Reflex ∠AOB = 220°, ∠ADB = 110°', explanation: 'Reflex ∠AOB = 360° − 140° = 220°.\nD is on the minor arc, so use the reflex angle: ∠ADB = 220° ÷ 2 = 110° ✓', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="224.57" y2="150.78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="55.43" y2="150.78" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 162.55,128.21 A 24,24 0 0 1 117.45,128.21" fill="none" stroke="#dc2626" stroke-width="2"/><line x1="224.57" y1="150.78" x2="140" y2="210" stroke="#0f1f3d" stroke-width="2.5" stroke-dasharray="4,3"/><line x1="55.43" y1="150.78" x2="140" y2="210" stroke="#0f1f3d" stroke-width="2.5" stroke-dasharray="4,3"/><path d="M 152.29,201.4 A 15,15 0 0 1 127.71,201.4" fill="none" stroke="#ea580c" stroke-width="2" stroke-dasharray="3,2"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><circle cx="224.57" cy="150.78" r="2.5" fill="#0f1f3d"/><text x="206.57" y="154.78" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="55.43" cy="150.78" r="2.5" fill="#0f1f3d"/><text x="63.43" y="154.78" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="140" cy="210" r="2.5" fill="#0f1f3d"/><text x="146" y="226" font-size="13" fill="#0f1f3d" font-weight="700">D</text><text x="140" y="154" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">140°</text><text x="140" y="184" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },
        { difficulty: 'Hard', question: 'In a circle with centre O, chord AB subtends an angle of (6x − 10)° at the centre and ∠ACB = (2x + 15)° at point C on the circumference (same side). Find x, then find ∠ACB.', checkMode: 'auto', correctAnswer: '20,55', correctAnswers: ['20,55', '20,55°', 'x=20,55°'], answer: 'x = 20, ∠ACB = 55°', explanation: 'Angle at centre = 2 × angle at circumference:\n(6x − 10)° = 2(2x + 15)°.\n6x − 10 = 4x + 30.\n2x = 40.\nx = 20.\n∠ACB = 2(20) + 15 = 55° ✓ (check: angle at centre = 6(20)−10=110°, and 2×55°=110° ✓)', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="213.72" y2="171.62" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="66.28" y2="171.62" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 159.66,133.77 A 24,24 0 0 1 120.34,133.77" fill="none" stroke="#dc2626" stroke-width="2"/><line x1="213.72" y1="171.62" x2="140" y2="30" stroke="#ea580c" stroke-width="2.5"/><line x1="66.28" y1="171.62" x2="140" y2="30" stroke="#ea580c" stroke-width="2.5"/><path d="M 146.93,43.31 A 15,15 0 0 1 133.07,43.31" fill="none" stroke="#16a34a" stroke-width="2"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><circle cx="213.72" cy="171.62" r="2.5" fill="#0f1f3d"/><text x="195.72" y="175.62" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="66.28" cy="171.62" r="2.5" fill="#0f1f3d"/><text x="74.28" y="175.62" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="140" cy="30" r="2.5" fill="#0f1f3d"/><text x="134" y="18" font-size="13" fill="#0f1f3d" font-weight="700">C</text><text x="140" y="154" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">(6x−10)°</text><text x="140" y="56" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">(2x+15)°</text></svg>' },

        // Block 3 — Angles in same segment + angle in a semicircle
        { difficulty: 'Easy', question: 'In a circle, points C and D lie on the same arc relative to chord AB. ∠ACB = 61°. Find ∠ADB.', checkMode: 'auto', correctAnswer: '61', correctAnswers: ['61', '61°', '61 degrees'], answer: '61°', explanation: 'C and D lie in the same segment relative to chord AB, so angles in the same segment are equal.\n∠ADB = ∠ACB = 61° ✓', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="61.28" y1="76.37" x2="218.72" y2="76.37" stroke="#ea580c" stroke-width="2.5"/><line x1="61.28" y1="76.37" x2="170.78" y2="204.57" stroke="#0f1f3d" stroke-width="2.5"/><line x1="218.72" y1="76.37" x2="170.78" y2="204.57" stroke="#0f1f3d" stroke-width="2.5"/><line x1="61.28" y1="76.37" x2="82.15" y2="188.94" stroke="#0f1f3d" stroke-width="2.5" stroke-dasharray="4,3"/><line x1="218.72" y1="76.37" x2="82.15" y2="188.94" stroke="#0f1f3d" stroke-width="2.5" stroke-dasharray="4,3"/><path d="M 161.04,193.16 A 15,15 0 0 1 176.03,190.52" fill="none" stroke="#2563eb" stroke-width="2"/><path d="M 78.87,171.24 A 18,18 0 0 1 96.04,177.49" fill="none" stroke="#ea580c" stroke-width="2"/><circle cx="61.28" cy="76.37" r="2.5" fill="#0f1f3d"/><text x="43.28" y="82.37" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="218.72" cy="76.37" r="2.5" fill="#0f1f3d"/><text x="226.72" y="82.37" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="170.78" cy="204.57" r="2.5" fill="#0f1f3d"/><text x="178.78" y="198.57" font-size="13" fill="#0f1f3d" font-weight="700">C</text><circle cx="82.15" cy="188.94" r="2.5" fill="#0f1f3d"/><text x="64.15" y="178.94" font-size="13" fill="#0f1f3d" font-weight="700">D</text><text x="170.78" y="228.57" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">61°</text><text x="86.15" y="210.94" font-size="11" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },
        { difficulty: 'Easy', question: 'AB is a diameter of a circle and P is a point on the circumference. ∠PAB = 42°. Find ∠APB, then find ∠PBA.', checkMode: 'auto', correctAnswer: '90,48', correctAnswers: ['90,48', '90°,48°', '90°, 48°'], answer: '∠APB = 90°, ∠PBA = 48°', explanation: 'Since AB is a diameter, ∠APB = 90° (angle in a semicircle).\nIn triangle APB: 42° + 90° + ∠PBA = 180°.\n∠PBA = 180° − 90° − 42° = 48° ✓', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="50" y1="120" x2="230" y2="120" stroke="#ea580c" stroke-width="2.5"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><line x1="50" y1="120" x2="149.41" y2="30.49" stroke="#0f1f3d" stroke-width="2.5"/><line x1="230" y1="120" x2="149.41" y2="30.49" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 141.98,37.18 L 148.67,44.62 L 156.1,37.92" fill="none" stroke="#0f1f3d" stroke-width="1.8"/><circle cx="50" cy="120" r="2.5" fill="#0f1f3d"/><text x="32" y="124" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="230" cy="120" r="2.5" fill="#0f1f3d"/><text x="238" y="124" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="149.41" cy="30.49" r="2.5" fill="#0f1f3d"/><text x="157.41" y="20.49" font-size="13" fill="#0f1f3d" font-weight="700">P</text><path d="M 60.4,110.63 A 14,14 0 0 1 64,120" fill="none" stroke="#2563eb" stroke-width="2"/><text x="76" y="112" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">42°</text><text x="143.41" y="54.49" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },
        { difficulty: 'Medium', question: 'Points A, B, C and D lie on a circle, with C and D on the same arc relative to chord AB. ∠ACB = (4x − 6)° and ∠ADB = (2x + 18)°. Find x, then find ∠ACB.', checkMode: 'auto', correctAnswer: '12,42', correctAnswers: ['12,42', '12,42°', 'x=12,42°'], answer: 'x = 12, ∠ACB = 42°', explanation: 'Angles in the same segment are equal: 4x − 6 = 2x + 18.\n2x = 24.\nx = 12.\n∠ACB = 4(12) − 6 = 42° ✓', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="79.78" y1="53.12" x2="200.22" y2="53.12" stroke="#ea580c" stroke-width="2.5"/><line x1="79.78" y1="53.12" x2="170.78" y2="204.57" stroke="#0f1f3d" stroke-width="2.5"/><line x1="200.22" y1="53.12" x2="170.78" y2="204.57" stroke="#0f1f3d" stroke-width="2.5"/><line x1="79.78" y1="53.12" x2="82.15" y2="188.94" stroke="#0f1f3d" stroke-width="2.5" stroke-dasharray="4,3"/><line x1="200.22" y1="53.12" x2="82.15" y2="188.94" stroke="#0f1f3d" stroke-width="2.5" stroke-dasharray="4,3"/><path d="M 163.05,191.71 A 15,15 0 0 1 173.64,189.85" fill="none" stroke="#2563eb" stroke-width="2"/><path d="M 81.84,170.94 A 18,18 0 0 1 93.96,175.36" fill="none" stroke="#ea580c" stroke-width="2"/><circle cx="79.78" cy="53.12" r="2.5" fill="#0f1f3d"/><text x="61.78" y="59.12" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="200.22" cy="53.12" r="2.5" fill="#0f1f3d"/><text x="208.22" y="59.12" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="170.78" cy="204.57" r="2.5" fill="#0f1f3d"/><text x="178.78" y="198.57" font-size="13" fill="#0f1f3d" font-weight="700">C</text><circle cx="82.15" cy="188.94" r="2.5" fill="#0f1f3d"/><text x="64.15" y="178.94" font-size="13" fill="#0f1f3d" font-weight="700">D</text><text x="170.78" y="228.57" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">(4x−6)°</text><text x="86.15" y="210.94" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">(2x+18)°</text></svg>' },
        { difficulty: 'Hard', question: 'AB is a diameter of a circle with AB = 17 cm. P is a point on the circumference with AP = 8 cm. Find ∠APB, then find the length of BP.', checkMode: 'auto', correctAnswer: '90,15', correctAnswers: ['90,15', '90°,15cm', '90°, 15 cm'], answer: '∠APB = 90°, BP = 15 cm', explanation: 'AB is a diameter, so ∠APB = 90° (angle in a semicircle).\nTriangle APB is right-angled at P: BP² = AB² − AP² = 17² − 8² = 289 − 64 = 225.\nBP = √225 = 15 cm ✓', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="50" y1="120" x2="230" y2="120" stroke="#ea580c" stroke-width="2.5"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><line x1="50" y1="120" x2="224.57" y2="89.22" stroke="#0f1f3d" stroke-width="2.5"/><line x1="230" y1="120" x2="224.57" y2="89.22" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 214.72,90.95 L 216.46,100.80 L 226.31,99.07" fill="none" stroke="#0f1f3d" stroke-width="1.8"/><circle cx="50" cy="120" r="2.5" fill="#0f1f3d"/><text x="32" y="124" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="230" cy="120" r="2.5" fill="#0f1f3d"/><text x="238" y="124" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="224.57" cy="89.22" r="2.5" fill="#0f1f3d"/><text x="232.57" y="79.22" font-size="13" fill="#0f1f3d" font-weight="700">P</text><text x="115.29" y="100.61" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">AP = 8 cm</text><text x="140" y="140" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">AB = 17 cm</text><text x="253.29" y="98.61" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },

        // Block 4 — Cyclic quadrilateral: opposite angles / exterior angle
        { difficulty: 'Easy', question: 'In cyclic quadrilateral ABCD, ∠A = 97°. Find ∠C.', checkMode: 'auto', correctAnswer: '83', correctAnswers: ['83', '83°', '83 degrees'], answer: '83°', explanation: 'Opposite angles of a cyclic quadrilateral are supplementary.\n∠C = 180° − 97° = 83° ✓', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="55.43" y1="89.22" x2="67.19" y2="172.9" stroke="#0f1f3d" stroke-width="2.5"/><line x1="67.19" y1="172.9" x2="224.57" y2="150.78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="224.57" y1="150.78" x2="197.85" y2="51.06" stroke="#0f1f3d" stroke-width="2.5"/><line x1="197.85" y1="51.06" x2="55.43" y2="89.22" stroke="#0f1f3d" stroke-width="2.5"/><circle cx="55.43" cy="89.22" r="2.5" fill="#0f1f3d"/><text x="35.43" y="89.22" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="67.19" cy="172.9" r="2.5" fill="#0f1f3d"/><text x="61.19" y="190.9" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="224.57" cy="150.78" r="2.5" fill="#0f1f3d"/><text x="234.57" y="156.78" font-size="13" fill="#0f1f3d" font-weight="700">C</text><circle cx="197.85" cy="51.06" r="2.5" fill="#0f1f3d"/><text x="201.85" y="39.06" font-size="13" fill="#0f1f3d" font-weight="700">D</text><text x="81.74" y="98.8" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">97°</text><text x="198.26" y="141.2" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },
        { difficulty: 'Easy', question: 'In cyclic quadrilateral ABCD, ∠B = 64°. Find ∠D.', checkMode: 'auto', correctAnswer: '116', correctAnswers: ['116', '116°', '116 degrees'], answer: '116°', explanation: 'Opposite angles of a cyclic quadrilateral are supplementary.\n∠D = 180° − 64° = 116° ✓', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="112.19" y1="34.4" x2="82.15" y2="188.94" stroke="#0f1f3d" stroke-width="2.5"/><line x1="82.15" y1="188.94" x2="224.57" y2="150.78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="224.57" y1="150.78" x2="197.85" y2="51.06" stroke="#0f1f3d" stroke-width="2.5"/><line x1="197.85" y1="51.06" x2="112.19" y2="34.4" stroke="#0f1f3d" stroke-width="2.5"/><circle cx="112.19" cy="34.4" r="2.5" fill="#0f1f3d"/><text x="92.19" y="34.4" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="82.15" cy="188.94" r="2.5" fill="#0f1f3d"/><text x="76.15" y="206.94" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="224.57" cy="150.78" r="2.5" fill="#0f1f3d"/><text x="234.57" y="156.78" font-size="13" fill="#0f1f3d" font-weight="700">C</text><circle cx="197.85" cy="51.06" r="2.5" fill="#0f1f3d"/><text x="201.85" y="39.06" font-size="13" fill="#0f1f3d" font-weight="700">D</text><text x="100.15" y="167.49" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">64°</text><text x="193.85" y="63.06" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },
        { difficulty: 'Medium', question: 'JKLM is a cyclic quadrilateral with ∠JKL = 109°. Side LM is extended beyond M to a point T, forming exterior angle ∠JMT. Find ∠JMT, and name the theorem used.', checkMode: 'auto', correctAnswer: '109', correctAnswers: ['109', '109°', '109 degrees'], answer: '109°', explanation: 'The exterior angle of a cyclic quadrilateral equals the interior opposite angle.\n∠JMT = ∠JKL = 109° ✓', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="62.06" y1="165" x2="170.78" y2="204.57" stroke="#0f1f3d" stroke-width="2.5"/><line x1="170.78" y1="204.57" x2="229.12" y2="132.53" stroke="#0f1f3d" stroke-width="2.5"/><line x1="229.12" y1="132.53" x2="71.06" y2="62.15" stroke="#0f1f3d" stroke-width="2.5"/><line x1="71.06" y1="62.15" x2="29.95" y2="43.85" stroke="#0f1f3d" stroke-width="2.5"/><line x1="71.06" y1="62.15" x2="62.06" y2="165" stroke="#0f1f3d" stroke-width="2.5"/><circle cx="62.06" cy="165" r="2.5" fill="#0f1f3d"/><text x="54.06" y="185" font-size="13" fill="#0f1f3d" font-weight="700">J</text><circle cx="170.78" cy="204.57" r="2.5" fill="#0f1f3d"/><text x="164.78" y="192.57" font-size="13" fill="#0f1f3d" font-weight="700">K</text><circle cx="229.12" cy="132.53" r="2.5" fill="#0f1f3d"/><text x="239.12" y="126.53" font-size="13" fill="#0f1f3d" font-weight="700">L</text><circle cx="71.06" cy="62.15" r="2.5" fill="#0f1f3d"/><text x="63.06" y="50.15" font-size="13" fill="#0f1f3d" font-weight="700">M</text><circle cx="29.95" cy="43.85" r="2.5" fill="#0f1f3d"/><text x="19.95" y="31.85" font-size="13" fill="#0f1f3d" font-weight="700">T</text><text x="161.2" y="178.26" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">109°</text><text x="53.83" y="72.3" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },
        { difficulty: 'Hard', question: 'In cyclic quadrilateral ABCD, ∠A = (4x − 20)° and ∠C = (2x + 50)°. Find x, then find ∠A and ∠C.', checkMode: 'auto', correctAnswer: '25,80,100', correctAnswers: ['25,80,100', '25,80°,100°', 'x=25,80°,100°'], answer: 'x = 25, ∠A = 80°, ∠C = 100°', explanation: 'Opposite angles are supplementary: (4x − 20) + (2x + 50) = 180.\n6x + 30 = 180.\nx = 25.\n∠A = 4(25) − 20 = 80°, ∠C = 2(25) + 50 = 100°. Check: 80° + 100° = 180° ✓', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="55.43" y1="89.22" x2="109.22" y2="204.57" stroke="#0f1f3d" stroke-width="2.5"/><line x1="109.22" y1="204.57" x2="224.57" y2="150.78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="224.57" y1="150.78" x2="197.85" y2="51.06" stroke="#0f1f3d" stroke-width="2.5"/><line x1="197.85" y1="51.06" x2="55.43" y2="89.22" stroke="#0f1f3d" stroke-width="2.5"/><circle cx="55.43" cy="89.22" r="2.5" fill="#0f1f3d"/><text x="35.43" y="89.22" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="109.22" cy="204.57" r="2.5" fill="#0f1f3d"/><text x="103.22" y="222.57" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="224.57" cy="150.78" r="2.5" fill="#0f1f3d"/><text x="234.57" y="156.78" font-size="13" fill="#0f1f3d" font-weight="700">C</text><circle cx="197.85" cy="51.06" r="2.5" fill="#0f1f3d"/><text x="201.85" y="39.06" font-size="13" fill="#0f1f3d" font-weight="700">D</text><text x="81.74" y="98.8" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">(4x−20)°</text><text x="198.26" y="141.2" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">(2x+50)°</text></svg>' },

        // Block 5 — Tangents: equal tangents / tangent-chord (alternate segment)
        { difficulty: 'Easy', question: 'Tangents PA and PB are drawn from external point P to a circle. If PA = 19 cm, find PB.', checkMode: 'auto', correctAnswer: '19', correctAnswers: ['19', '19cm', '19 cm'], answer: '19 cm', explanation: 'Tangent segments from an external point are equal.\nPB = PA = 19 cm ✓', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="20" x2="100.77" y2="39" stroke="#16a34a" stroke-width="2.5"/><line x1="140" y1="20" x2="179.23" y2="39" stroke="#16a34a" stroke-width="2.5"/><path d="M 109.77,34.64 L 114.13,43.64 L 105.13,48.00" fill="none" stroke="#0f1f3d" stroke-width="1.8"/><path d="M 170.23,34.64 L 165.87,43.64 L 174.87,48.00" fill="none" stroke="#0f1f3d" stroke-width="1.8"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><circle cx="140" cy="20" r="2.5" fill="#0f1f3d"/><text x="134" y="10" font-size="13" fill="#0f1f3d" font-weight="700">P</text><circle cx="100.77" cy="39" r="2.5" fill="#0f1f3d"/><text x="80.77" y="43" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="179.23" cy="39" r="2.5" fill="#0f1f3d"/><text x="189.23" y="49" font-size="13" fill="#0f1f3d" font-weight="700">B</text><text x="100.39" y="27.50" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">PA = 19 cm</text><text x="179.62" y="29.50" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },
        { difficulty: 'Easy', question: 'A tangent at point T makes an angle of 71° with chord TC. Point B lies in the alternate segment. Find ∠TBC, and name the theorem used.', checkMode: 'auto', correctAnswer: '71', correctAnswers: ['71', '71°', '71 degrees'], answer: '71°', explanation: 'By the alternate segment theorem (tangent-chord theorem), the inscribed angle in the alternate segment equals the tangent-chord angle.\n∠TBC = 71° ✓', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="70" y1="210" x2="210" y2="210" stroke="#16a34a" stroke-width="2.5"/><line x1="140" y1="210" x2="84.59" y2="49.08" stroke="#ea580c" stroke-width="2.5"/><line x1="140" y1="210" x2="224.57" y2="89.22" stroke="#0f1f3d" stroke-width="2.5"/><line x1="84.59" y1="49.08" x2="224.57" y2="89.22" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 118,210 A 22,22 0 0 1 132.84,189.2" fill="none" stroke="#dc2626" stroke-width="2"/><path d="M 215.97,101.51 A 15,15 0 0 1 210.15,85.09" fill="none" stroke="#2563eb" stroke-width="2"/><circle cx="140" cy="210" r="2.5" fill="#0f1f3d"/><text x="146" y="226" font-size="13" fill="#0f1f3d" font-weight="700">T</text><circle cx="84.59" cy="49.08" r="2.5" fill="#0f1f3d"/><text x="64.59" y="53.08" font-size="13" fill="#0f1f3d" font-weight="700">C</text><circle cx="224.57" cy="89.22" r="2.5" fill="#0f1f3d"/><text x="234.57" y="83.22" font-size="13" fill="#0f1f3d" font-weight="700">B</text><text x="110" y="200" font-size="11" fill="#dc2626" font-weight="700" text-anchor="middle">71°</text><text x="230.57" y="71.22" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },
        { difficulty: 'Medium', question: 'Tangents PA and PB are drawn from external point P to a circle, with ∠APB = 38°. Since PA = PB, triangle PAB is isosceles. Find ∠PAB.', checkMode: 'auto', correctAnswer: '71', correctAnswers: ['71', '71°', '71 degrees'], answer: '71°', explanation: 'Since PA = PB (equal tangents from an external point), triangle PAB is isosceles, so ∠PAB = ∠PBA.\n∠PAB = (180° − 38°) ÷ 2 = 142° ÷ 2 = 71° ✓', diagramSvg: '<svg viewBox="0 -182 280 422" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="-156.44" x2="54.9" y2="90.7" stroke="#16a34a" stroke-width="2.5"/><line x1="140" y1="-156.44" x2="225.1" y2="90.7" stroke="#16a34a" stroke-width="2.5"/><line x1="54.9" y1="90.7" x2="225.1" y2="90.7" stroke="#ea580c" stroke-width="2.5"/><path d="M 134.14,-139.42 A 18,18 0 0 0 145.86,-139.42" fill="none" stroke="#dc2626" stroke-width="2"/><path d="M 59.79,76.52 A 15,15 0 0 1 69.9,90.7" fill="none" stroke="#ea580c" stroke-width="2"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><circle cx="140" cy="-156.44" r="2.5" fill="#0f1f3d"/><text x="134" y="-166.44" font-size="13" fill="#0f1f3d" font-weight="700">P</text><circle cx="54.9" cy="90.7" r="2.5" fill="#0f1f3d"/><text x="34.9" y="96.7" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="225.1" cy="90.7" r="2.5" fill="#0f1f3d"/><text x="235.1" y="100.7" font-size="13" fill="#0f1f3d" font-weight="700">B</text><text x="140" y="-122.44" font-size="11" fill="#dc2626" font-weight="700" text-anchor="middle">38°</text><text x="79.93" y="83.66" font-size="11" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },
        { difficulty: 'Hard', question: 'Tangents PA and PB are drawn from external point P to a circle, touching it at A and B. ∠APB = 64°. C is a point on the major arc AB. Find ∠PAB, then use the alternate segment theorem to find ∠ACB.', checkMode: 'auto', correctAnswer: '58,58', correctAnswers: ['58,58', '58°,58°', '58°, 58°'], answer: '∠PAB = 58°, ∠ACB = 58°', explanation: 'Since PA = PB, triangle PAB is isosceles: ∠PAB = (180° − 64°) ÷ 2 = 58°.\n∠PAB is the tangent-chord angle at A for chord AB. By the alternate segment theorem, ∠ACB = ∠PAB = 58° ✓', diagramSvg: '<svg viewBox="0 -75 280 315" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="-49.84" x2="63.68" y2="72.31" stroke="#16a34a" stroke-width="2.5"/><line x1="140" y1="-49.84" x2="216.32" y2="72.31" stroke="#16a34a" stroke-width="2.5"/><line x1="63.68" y1="72.31" x2="216.32" y2="72.31" stroke="#ea580c" stroke-width="2.5" stroke-dasharray="4,3"/><line x1="63.68" y1="72.31" x2="163.29" y2="206.93" stroke="#0f1f3d" stroke-width="2.5"/><line x1="216.32" y1="72.31" x2="163.29" y2="206.93" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 131.52,-36.27 A 16,16 0 0 0 148.48,-36.27" fill="none" stroke="#dc2626" stroke-width="2"/><path d="M 154.96,195.68 A 14,14 0 0 1 168.42,193.9" fill="none" stroke="#2563eb" stroke-width="2"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><circle cx="140" cy="-49.84" r="2.5" fill="#0f1f3d"/><text x="134" y="-57.84" font-size="13" fill="#0f1f3d" font-weight="700">P</text><circle cx="63.68" cy="72.31" r="2.5" fill="#0f1f3d"/><text x="43.68" y="78.31" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="216.32" cy="72.31" r="2.5" fill="#0f1f3d"/><text x="226.32" y="80.31" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="163.29" cy="206.93" r="2.5" fill="#0f1f3d"/><text x="157.29" y="226.93" font-size="13" fill="#0f1f3d" font-weight="700">C</text><text x="140" y="-19.84" font-size="11" fill="#dc2626" font-weight="700" text-anchor="middle">64°</text><text x="163.29" y="192.93" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        },
        {
          ...
          diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="50" y1="120" x2="230" y2="120" stroke="#2563eb" stroke-width="2"/><line x1="50" y1="120" x2="86" y2="48" stroke="#0f1f3d" stroke-width="1.8"/><line x1="86" y1="48" x2="230" y2="120" stroke="#0f1f3d" stroke-width="1.8"/><line x1="86" y1="48" x2="86" y2="120" stroke="#ea580c" stroke-width="2"/><path d="M 86,111 L 77,111 L 77,120" fill="none" stroke="#0f1f3d" stroke-width="1.8"/><circle cx="50" cy="120" r="3" fill="#0f1f3d"/><text x="46" y="138" font-size="13" fill="#0f1f3d" font-weight="700" text-anchor="middle">A</text><circle cx="230" cy="120" r="3" fill="#0f1f3d"/><text x="234" y="138" font-size="13" fill="#0f1f3d" font-weight="700" text-anchor="middle">B</text><circle cx="86" cy="48" r="3" fill="#0f1f3d"/><text x="94" y="42" font-size="13" fill="#0f1f3d" font-weight="700" text-anchor="middle">C</text><circle cx="86" cy="120" r="3" fill="#0f1f3d"/><text x="98" y="136" font-size="13" fill="#0f1f3d" font-weight="700" text-anchor="middle">D</text><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="136" y="138" font-size="13" fill="#0f1f3d" font-weight="700" text-anchor="middle">O</text><text x="68" y="138" font-size="10" fill="#2563eb" font-weight="700" text-anchor="middle">AD = 2 cm</text><text x="158" y="150" font-size="10" fill="#2563eb" font-weight="700" text-anchor="middle">DB = 8 cm</text></svg>',
        },
        {
          difficulty: 'Hard',
