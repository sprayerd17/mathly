...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video contrasting combinations with permutations using a committee-selection example, deriving the C(n,r) formula from the counting principle, then showing the multiply-two-groups technique and the at-least-one complement trick',
