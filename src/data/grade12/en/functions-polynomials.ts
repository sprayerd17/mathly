...
export const topicData: TopicData = {
  ...
  topicPractice: [
    ...
    // ── Q19 Hard — find a, b and third root from two known roots ─────────────
    {
      ...
      answer: 'p(1)=1+a+b−8=a+b−7=0, so a+b=7. p(−2)=−8+4a−2b−8=4a−2b−16=0, so 4a−2b=16, 2a−b=8. Adding: 3a=15, a=5. b=2. p(x)=x³+5x²+2x−8. Third root: divide p(x) by (x−1): quotient = x²+6x+8 = (x+2)(x+4). So p(x)=(x−1)(x+2)(x+4), giving product of roots = 1×(−2)×(−4) = 8, matching −(−8)=8 ✓. Third root: x=−4.',
      checkMode: 'self',
    },
  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Hard', question: 'Solve for x: 2x³ + 3x² − 11x − 6 = 0, using your factorisation from Q11.', answer: '', checkMode: 'auto', correctAnswer: 'x=-1/2, x=2, x=-3', correctAnswers: ['x=-1/2, x=2, x=-3', 'x=2, x=-3, x=-1/2', '-1/2; 2; -3', '-0.5, 2, -3'], explanation: '(2x+1)(x−2)(x+3)=0.\n2x+1=0 → x=−½; x−2=0 → x=2; x+3=0 → x=−3 ✓' },
