      ...
      workedExamples: [
        ...
        },
        {
          ...
          steps: [
            ...
            `Calculate (0.85)⁵: 0.85² = 0.7225; 0.7225² = 0.522006; 0.522006 × 0.85 ≈ 0.443705`,
            `Calculate: ${gr('A')} = ${bl('280 000')} × 0.443705 ≈ ${gr('R124 237')}`,
          ],
        },
      ],
      ...
      workedExamples: [
        {
          ...
          steps: [
            ...
            `Calculate (1.0075)⁶⁰ ≈ 1.565681`,
            `Numerator: 1.565681 − 1 = 0.565681`,
            `Divide: 0.565681 ÷ ${or('0.0075')} ≈ 75.4241`,
            `Calculate: ${gr('F')} = ${bl('1 500')} × 75.4241 ≈ ${gr('R113 136')}`,
          ],
        },
        {
          ...
          answer: `${gr('F')} ≈ R81 071`,
          steps: [
            `Identify the ${or('interest rate per period')}: ${or('i')} = 0.08 ÷ 12 ≈ ${or('0.006667')} per month`,
            `Determine the number of payments: n = 3 × 12 = 36 months`,
            `Write down the formula: ${gr('F')} = ${bl('x')} × [(1 + ${or('i')})ⁿ − 1] ÷ ${or('i')}`,
            `Substitute: ${gr('F')} = ${bl('2 000')} × [(1 + ${or('0.006667')})³⁶ − 1] ÷ ${or('0.006667')}`,
            `Calculate (1.006667)³⁶ ≈ 1.270238`,
            `Numerator: 1.270238 − 1 = 0.270238`,
            `Divide: 0.270238 ÷ ${or('0.006667')} ≈ 40.5357`,
            `Calculate: ${gr('F')} = ${bl('2 000')} × 40.5357 ≈ ${gr('R81 071')}`,
          ],
        },
      ],
      ...
      workedExamples: [
        {
          ...
          steps: [
            ...
            `Calculate (1.009167)⁻²⁴⁰ ≈ 0.11192`,
            `Numerator: 1 − 0.11192 = 0.88808`,
            `Divide: 0.88808 ÷ 0.009167 ≈ 96.882`,
            `Rearrange to solve for ${or('x')}: ${or('x')} = ${bl('250 000')} ÷ 96.882 ≈ ${or('R2 580')} per month`,
          ],
        },
        {
        ...
        },
        {
          ...
          answer: `${gr('Outstanding balance')} ≈ R449 012`,
          steps: [
            `Step 1 — Find the monthly repayment. i = 0.10 ÷ 12 ≈ 0.008333 per month, n = 240 months`,
            `${bl('500 000')} = ${or('x')} × [1 − (1.008333)⁻²⁴⁰] ÷ 0.008333`,
            `(1.008333)⁻²⁴⁰ ≈ 0.136458; numerator = 1 − 0.136458 = 0.863542; 0.863542 ÷ 0.008333 ≈ 103.625`,
            `${or('x')} = ${bl('500 000')} ÷ 103.625 ≈ ${or('R4 825.09')} per month`,
            `Step 2 — Find the ${gr('outstanding balance')} after 60 payments. Payments remaining: 240 − 60 = 180`,
            `${gr('Outstanding balance')} = ${or('4 825.09')} × [1 − (1.008333)⁻¹⁸⁰] ÷ 0.008333`,
            `(1.008333)⁻¹⁸⁰ ≈ 0.224517; numerator = 1 − 0.224517 = 0.775483; 0.775483 ÷ 0.008333 ≈ 93.058`,
            `${gr('Outstanding balance')} = ${or('4 825.09')} × 93.058 ≈ ${gr('R449 012')}`,
          ],
        },
      ],
