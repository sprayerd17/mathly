...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      icon: '△',
      explanation:
        `<p style="margin-bottom:16px;">Ons los werklike probleme op in <strong>2D</strong> (met behulp van die sinusreël, kosinusreël en oppervlaktereël op ʼn plat vlak) en brei hierdie tegnieke uit na <strong>3D-probleme</strong> wat hoogtes, afstande en hoeke tussen voorwerpe in drie-dimensionele ruimte behels. In 3D-probleme breek ons die diagram gewoonlik op in verskeie reghoekige of nie-reghoekige driehoeke, los elkeen afsonderlik op, en kombineer die resultate. Ons gebruik <strong>hoogtehoeke</strong> (opkyk vanaf horisontaal) en <strong>dieptehoeke</strong> (afkyk vanaf horisontaal), en pas dikwels die sinusreël toe oor driehoeke wat ʼn gemeenskaplike sy deel.</p>` +
        ...
        `<div style="background:#eff6ff;border:1.5px solid #bfdbfe;border-radius:10px;padding:14px 16px;">` +
        `<p style="font-weight:700;color:#1e40af;margin-bottom:8px;">Sinusreël</p>` +
        ...
        `<div style="background:#f0fdf4;border:1.5px solid #bbf7d0;border-radius:10px;padding:14px 16px;">` +
        `<p style="font-weight:700;color:#166534;margin-bottom:8px;">Kosinusreël</p>` +
        ...
        `<p style="font-weight:700;color:#ea580c;margin-bottom:8px;">Oppervlaktereël</p>` +
        ...
        `<li>Identifiseer ʼn horisontale driehoek in die grondvlak — los dit op met die ${bl('sin- of kosinusreël')} om ʼn horisontale afstand te vind wat met ʼn vertikale driehoek gedeel word.</li>` +
      ...
      workedExamples: [
        {
          ...
          steps: [
            `<strong>Deel (a) — Oppervlakte:</strong> Pas die ${bl('oppervlaktereël')} toe: Oppervlakte = ½ · AB · BC · sin(∠ABC).`,
            `Vervang: Oppervlakte = ½ · ${bl('7')} · ${bl('10')} · sin${bl('60°')} = 35 · (√3/2) ≈ ${gr('30,31 cm²')}.`,
            `<strong>Deel (b) — Lengte AC:</strong> Pas die ${bl('kosinusreël')} toe: AC² = AB² + BC² − 2 · AB · BC · cos(∠ABC).`,
            `Vervang: AC² = ${bl('49')} + ${bl('100')} − 2 · ${bl('7')} · ${bl('10')} · cos${bl('60°')} = 149 − 140 · (0,5) = 149 − 70 = ${bl('79')}.`,
            `<strong>Antwoord:</strong> AC = √79 ≈ ${gr('8,89 cm')} ✓`,
          ],
        },
        {
          question: 'Gebou TP het sy basis P op dieselfde horisontale vlak as punte Q en R. Vanaf Q is die hoogtehoek na die bopunt T gelyk aan x. Hoek PQR = 150°, hoek QPR = y, en PR = a meter. Bewys dat TP = a · tanx · (cosy − √3 · siny).',
          answer: `${gr('TP = a · tanx · (cosy − √3 · siny) ✓')}`,
          steps: [
            `In ${bl('driehoek PQR')} tel die hoeke op tot 180°: ∠PQR + ∠QPR + ∠PRQ = 180°, dus ∠PRQ = 180° − 150° − y = ${bl('30° − y')}.`,
            `Pas die ${bl('sinusreël')} in driehoek PQR toe: PQ / sin(∠PRQ) = PR / sin(∠PQR).`,
            ...
            `Vervang hierdie uitbreiding in TP = 2a · tanx · sin(30° − y): TP = 2a · tanx · ${or('[(1/2)cosy − (√3/2)siny]')} = a · tanx · cosy − √3 · a · tanx · siny = ${gr('a · tanx · (cosy − √3 · siny)')} ✓`,
          ],
        },
        {
          ...
          steps: [
            ...
            `<strong>Antwoord:</strong> h = 30 / 0,3728 ≈ ${gr('80,5 m')} ✓`,
          ],
        },
      ],
      ...
      videoPlaceholder:
        'Kort video wat wys hoe om 2D- en 3D-trigonometrieprobleme op te los deur horisontale en vertikale driehoeke te identifiseer, die sinusreël en kosinusreël toe te pas, en hoogte- en dieptehoeke te gebruik',
    },
  ],
  ...
  practiceSets: [
    ...
    // Blok 6 (16-19): 2D/3D-probleme — oppervlakte/kosinusreël, hoogtehoek-kombinasie — BENODIG DIAGRAM (16,17,19)
    // ═══════════════════════════════════════════════════════════════════════
    {
      name: 'Stel 1',
      questions: [
        ...
        // Blok 6 — 2D/3D-probleme: oppervlaktereël, kosinusreël, hoogtehoek-kombinasie (Matig/Moeilik/Matig/Moeilik)
  ...
  topicPractice: [
    ...
    // ── V13 Matig — oppervlakte van driehoek met oppervlaktereël ──────────────────
    {
      difficulty: 'Medium',
      ...
      checkMode: 'auto',
      correctAnswer: '44,23',
      correctAnswers: ['44,23', '44.23', '44,2', '44.2', '44,22', '44.22', '44,24', '44.24', '44'],
      explanation: 'Oppervlakte = ½ · AB · AC · sin(∠BAC)\n= ½(9)(12)sin55°\n= 54 × 0,8192\n≈ 44,23 cm² ✓',
    },

    // ── V14 Moeilik — kosinusreël om onbekende sy te bepaal ────────────────────────
    {
      difficulty: 'Hard',
      question: 'Gebruik dieselfde driehoek van V13 (AB = 9 cm, AC = 12 cm, hoek BAC = 55°), bepaal die lengte van BC met behulp van die kosinusreël. Gee jou antwoord korrek tot 2 desimale plekke.',
