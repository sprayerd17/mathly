  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'Gebruik ʼn reduksieformule om sin(150°) presies te bepaal.', checkMode: 'auto', correctAnswer: '1/2', correctAnswers: ['1/2', '0.5', '½'], answer: '1/2', explanation: '150° = 180° − 30°, wat in Kwadrant 2 is waar sin positief is.\nsin(180°−30°) = sin30° = 1/2 ✓' },
        { difficulty: 'Easy', question: 'As cosθ = 4/5 en θ in Kwadrant 4 is, bepaal sinθ.', checkMode: 'auto', correctAnswer: '-3/5', correctAnswers: ['-3/5', '−3/5', '-0.6', '−0.6'], answer: '−3/5', explanation: 'sin²θ = 1 − (4/5)² = 1 − 16/25 = 9/25.\nIn Kwadrant 4 is sin negatief, dus sinθ = −3/5 ✓' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // Blok 1 — Reduksieformules / CAST (Maklik/Maklik/Matig)
        { difficulty: 'Easy', question: 'Gebruik ʼn reduksieformule om cos(240°) presies te bepaal.', checkMode: 'auto', correctAnswer: '-1/2', correctAnswers: ['-1/2', '−1/2', '-0.5', '−0.5'], answer: '−1/2', explanation: '240° = 180° + 60°, wat in Kwadrant 3 is waar cos negatief is.\ncos(180°+60°) = −cos60° = −1/2 ✓' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // Blok 1 — Reduksieformules / CAST (Maklik/Maklik/Matig)
        { difficulty: 'Easy', question: 'Gebruik ʼn reduksieformule om sin(315°) presies te bepaal.', checkMode: 'auto', correctAnswer: '-√2/2', correctAnswers: ['-√2/2', '−√2/2', '-sqrt(2)/2', '-0.71'], answer: '−√2/2', explanation: '315° = 360° − 45°, wat in Kwadrant 4 is waar sin negatief is.\nsin(360°−45°) = −sin45° = −√2/2 ✓' },
