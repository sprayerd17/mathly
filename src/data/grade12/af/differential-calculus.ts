    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      openQuestions: [
        // ── Q13 Hard — interpret increasing/decreasing from a diagram ──────────
        {
          ...
          checkMode: 'self',
          diagramSvg: `<svg viewBox="0 0 240 200" xmlns="http://www.w3.org/2000/svg" font-family="Arial, sans-serif"><line x1="8" y1="100" x2="230" y2="100" stroke="#94a3b8" stroke-width="1.5" /><polygon points="230,100 223,96 223,104" fill="#94a3b8" /><line x1="104" y1="192" x2="104" y2="20" stroke="#94a3b8" stroke-width="1.5" /><polygon points="104,20 100,27 108,27" fill="#94a3b8" /><path d="M20,179.3 L32,133.1 L44,100 L56,78.5 L68,66.7 L80,63.1 L92,65.7 L104,73 L116,83.2 L128,94.5 L140,105.2 L152,113.6 L164,118 L176,116.6 L188,107.8 L200,89.7 L212,60.7 L218,41.5" fill="none" stroke="#0f1f3d" stroke-width="2.5" stroke-linejoin="round" stroke-linecap="round" /><circle cx="44" cy="100" r="3.5" fill="#2563eb" /><circle cx="134" cy="100" r="3.5" fill="#2563eb" /><circle cx="194" cy="100" r="3.5" fill="#2563eb" /><text x="44" y="114" font-size="10" font-weight="700" fill="#2563eb" text-anchor="middle">-2</text><text x="134" y="114" font-size="10" font-weight="700" fill="#2563eb" text-anchor="middle">1</text><text x="194" y="114" font-size="10" font-weight="700" fill="#2563eb" text-anchor="middle">3</text><circle cx="80" cy="63" r="3.5" fill="#ea580c" /><circle cx="168" cy="118" r="3.5" fill="#ea580c" /><text x="80" y="50" font-size="10" font-weight="700" fill="#ea580c" text-anchor="middle">plaaslike maks</text><text x="168" y="134" font-size="10" font-weight="700" fill="#ea580c" text-anchor="middle">plaaslike min</text><text x="50" y="155" font-size="16" font-weight="700" fill="#16a34a" text-anchor="middle">↗</text><text x="124" y="155" font-size="16" font-weight="700" fill="#dc2626" text-anchor="middle">↘</text><text x="193" y="155" font-size="16" font-weight="700" fill="#16a34a" text-anchor="middle">↗</text><text x="234" y="104" font-size="11" fill="#64748b" text-anchor="end">x</text><text x="108" y="24" font-size="11" fill="#64748b" text-anchor="start">f(x)</text></svg>`,
        },
