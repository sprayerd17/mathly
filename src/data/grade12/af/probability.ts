...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Kort video wat die fundamentele telbeginsel demonstreer met \'n spyskaart-voorbeeld en \'n nommerplaat-voorbeeld, en wys hoe die aantal beskikbare opsies verminder wanneer herhaling nie toegelaat word nie',
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Kort video wat kombinasies met permutasies vergelyk deur \'n komitee-keuse-voorbeeld te gebruik, die C(n,r)-formule van die telbeginsel aflei, en dan die vermenigvuldig-twee-groepe-tegniek en die ten-minste-een-komplement-truuk wys',
