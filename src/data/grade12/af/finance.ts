      ...
      workedExamples: [
        ...
        },
        {
          ...
          steps: [
            ...
            `Bereken (0,85)⁵: 0,85² = 0,7225; 0,7225² = 0,522006; 0,522006 × 0,85 ≈ 0,443705`,
            `Bereken: ${gr('A')} = ${bl('280 000')} × 0,443705 ≈ ${gr('R124 237')}`,
          ],
        },
      ],
      ...
      workedExamples: [
        {
          ...
          steps: [
            ...
            `Bereken (1,0075)⁶⁰ ≈ 1,565681`,
            `Teller: 1,565681 − 1 = 0,565681`,
            `Deel: 0,565681 ÷ ${or('0,0075')} ≈ 75,4241`,
            `Bereken: ${gr('F')} = ${bl('1 500')} × 75,4241 ≈ ${gr('R113 136')}`,
          ],
        },
        {
          ...
          answer: `${gr('F')} ≈ R81 071`,
          steps: [
            `Identifiseer die ${or('rentekoers per tydperk')}: ${or('i')} = 0,08 ÷ 12 ≈ ${or('0,006667')} per maand`,
            `Bepaal die aantal betalings: n = 3 × 12 = 36 maande`,
            `Skryf die formule neer: ${gr('F')} = ${bl('x')} × [(1 + ${or('i')})ⁿ − 1] ÷ ${or('i')}`,
            `Vervang: ${gr('F')} = ${bl('2 000')} × [(1 + ${or('0,006667')})³⁶ − 1] ÷ ${or('0,006667')}`,
            `Bereken (1,006667)³⁶ ≈ 1,270238`,
            `Teller: 1,270238 − 1 = 0,270238`,
            `Deel: 0,270238 ÷ ${or('0,006667')} ≈ 40,5357`,
            `Bereken: ${gr('F')} = ${bl('2 000')} × 40,5357 ≈ ${gr('R81 071')}`,
          ],
        },
      ],
      ...
      workedExamples: [
        {
          ...
          steps: [
            ...
            `Bereken (1,009167)⁻²⁴⁰ ≈ 0,11192`,
            `Teller: 1 − 0,11192 = 0,88808`,
            `Deel: 0,88808 ÷ 0,009167 ≈ 96,882`,
            `Herrangskik om vir ${or('x')} op te los: ${or('x')} = ${bl('250 000')} ÷ 96,882 ≈ ${or('R2 580')} per maand`,
          ],
        },
        {
        ...
        },
        {
          ...
          answer: `${gr('Uitstaande balans')} ≈ R449 012`,
          steps: [
            `Stap 1 — Vind die maandelikse terugbetaling. i = 0,10 ÷ 12 ≈ 0,008333 per maand, n = 240 maande`,
            `${bl('500 000')} = ${or('x')} × [1 − (1,008333)⁻²⁴⁰] ÷ 0,008333`,
            `(1,008333)⁻²⁴⁰ ≈ 0,136458; teller = 1 − 0,136458 = 0,863542; 0,863542 ÷ 0,008333 ≈ 103,625`,
            `${or('x')} = ${bl('500 000')} ÷ 103,625 ≈ ${or('R4 825,09')} per maand`,
            `Stap 2 — Vind die ${gr('uitstaande balans')} na 60 betalings. Oorblywende betalings: 240 − 60 = 180`,
            `${gr('Uitstaande balans')} = ${or('4 825,09')} × [1 − (1,008333)⁻¹⁸⁰] ÷ 0,008333`,
            `(1,008333)⁻¹⁸⁰ ≈ 0,224517; teller = 1 − 0,224517 = 0,775483; 0,775483 ÷ 0,008333 ≈ 93,058`,
            `${gr('Uitstaande balans')} = ${or('4 825,09')} × 93,058 ≈ ${gr('R449 012')}`,
          ],
        },
      ],
