...
export const topicData: TopicData = {
  ...
  topicPractice: [
    ...
    // ── Q19 Hard — find a, b and third root from two known roots ─────────────
    {
      ...
      answer: 'p(1)=1+a+b−8=a+b−7=0, dus a+b=7. p(−2)=−8+4a−2b−8=4a−2b−16=0, dus 4a−2b=16, 2a−b=8. Optel: 3a=15, a=5. b=2. p(x)=x³+5x²+2x−8. Derde wortel: p(x)=(x−1)(x+2)(x−r). Brei uit: x³+(r+1)x²+(r−2)x−2r=−8 wanneer r=4: (x−1)(x+2)(x−4) gee produk van wortels=1×(−2)×4=−8 ✓. Derde wortel: x=4.',
      checkMode: 'self',
    },
