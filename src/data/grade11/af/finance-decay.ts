  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'ʼn Bank bied ʼn nominale rentekoers van 12% p.j. maandeliks saamgestel. Bereken die effektiewe jaarlikse rentekoers (tot 2 desimale plekke).', checkMode: 'auto', options: ['12,68%', '12,00%', '12,55%', '1,00%'], correctIndex: 0, explanation: 'i_eff = (1 + 0,12/12)^12 − 1 = (1,01)^12 − 1 = 12,68% ✓. 12,00% verwar die nominale koers met die effektiewe koers; 12,55% stel verkeerdelik kwartaalliks saam (m = 4) in plaas van maandeliks; 1,00% gee die maandelikse periodieke koers in plaas van die jaarlikse effektiewe koers.' },
        { difficulty: 'Easy', question: 'ʼn Spaarrekening betaal 8% p.j. kwartaalliks saamgestel. Bereken die effektiewe jaarlikse rentekoers (tot 2 desimale plekke).', checkMode: 'auto', options: ['8,00%', '8,24%', '8,30%', '2,00%'], correctIndex: 1, explanation: 'i_eff = (1 + 0,08/4)^4 − 1 = (1,02)^4 − 1 = 8,24% ✓. 8,00% verwar die nominale koers met die effektiewe koers; 8,30% stel verkeerdelik maandeliks saam (m = 12) in plaas van kwartaalliks; 2,00% gee die kwartaallikse periodieke koers in plaas van die jaarlikse effektiewe koers.' },
        { difficulty: 'Medium', question: 'ʼn Lening dra ʼn nominale rentekoers van 15% p.j. maandeliks saamgestel. Bereken die effektiewe jaarlikse rentekoers (tot 2 desimale plekke).', checkMode: 'auto', options: ['15,00%', '15,87%', '16,08%', '1,25%'], correctIndex: 2, explanation: 'i_eff = (1 + 0,15/12)^12 − 1 = (1,0125)^12 − 1 = 16,08% ✓. 15,00% verwar die nominale koers met die effektiewe koers; 15,87% stel verkeerdelik kwartaalliks saam (m = 4) in plaas van maandeliks; 1,25% gee die maandelikse periodieke koers in plaas van die jaarlikse effektiewe koers.' },
        { difficulty: 'Medium', question: 'ʼn Kredietkaart hef 18% p.j. kwartaalliks saamgestel. Bereken die effektiewe jaarlikse rentekoers (tot 2 desimale plekke).', checkMode: 'auto', options: ['18,00%', '19,56%', '4,50%', '19,25%'], correctIndex: 3, explanation: 'i_eff = (1 + 0,18/4)^4 − 1 = (1,045)^4 − 1 = 19,25% ✓. 18,00% verwar die nominale koers met die effektiewe koers; 19,56% stel verkeerdelik maandeliks saam (m = 12) in plaas van kwartaalliks; 4,50% gee die kwartaallikse periodieke koers in plaas van die jaarlikse effektiewe koers.' },

        // Blok 2 — Effektiewe → nominale koers-omskakeling (Medium, Medium, Hard)
        { difficulty: 'Medium', question: 'ʼn Effektiewe jaarlikse rentekoers van 13% word genoem. Bepaal die ekwivalente nominale jaarlikse koers as rente maandeliks saamgestel word (tot 2 desimale plekke).', checkMode: 'auto', options: ['12,28%', '13,00%', '12,41%', '1,02%'], correctIndex: 0, explanation: '1,13 = (1 + i_nom/12)^12, dus 1 + i_nom/12 = ¹²√1,13 = 1,010237, i_nom = 12 × 0,010237 = 12,28% ✓. 13,00% verwar die effektiewe koers met die nominale koers (geen omskakeling gedoen nie); 12,41% gebruik verkeerdelik kwartaallikse samestelling (m = 4) in plaas van maandeliks; 1,02% gee net die maandelikse periodieke koers en vergeet om met 12 te vermenigvuldig.' },
        { difficulty: 'Medium', question: 'ʼn Effektiewe jaarlikse rentekoers van 9% word genoem. Bepaal die ekwivalente nominale jaarlikse koers as rente kwartaalliks saamgestel word (tot 2 desimale plekke).', checkMode: 'auto', options: ['9,00%', '8,71%', '8,65%', '2,18%'], correctIndex: 1, explanation: '1,09 = (1 + i_nom/4)^4, dus 1 + i_nom/4 = ⁴√1,09 = 1,021783, i_nom = 4 × 0,021783 = 8,71% ✓. 9,00% verwar die effektiewe koers met die nominale koers; 8,65% gebruik verkeerdelik maandelikse samestelling (m = 12) in plaas van kwartaalliks; 2,18% gee net die kwartaallikse periodieke koers en vergeet om met 4 te vermenigvuldig.' },
        { difficulty: 'Hard', question: 'ʼn Bank adverteer ʼn effektiewe jaarlikse rentekoers van 20%. Bepaal die ekwivalente nominale jaarlikse koers, maandeliks saamgestel (tot 2 desimale plekke).', checkMode: 'auto', options: ['20,00%', '18,65%', '18,37%', '1,53%'], correctIndex: 2, explanation: '1,20 = (1 + i_nom/12)^12, dus 1 + i_nom/12 = ¹²√1,20 = 1,015310, i_nom = 12 × 0,015310 = 18,37% ✓. 20,00% verwar die effektiewe koers met die nominale koers; 18,65% gebruik verkeerdelik kwartaallikse samestelling (m = 4) in plaas van maandeliks; 1,53% gee net die maandelikse periodieke koers en vergeet om met 12 te vermenigvuldig.' },

        // Blok 3 — Reguitlyn-waardevermindering (Easy, Medium, Medium, Hard)
        { difficulty: 'Easy', question: 'ʼn Wasmasjien ter waarde van R15 000 verminder in waarde teen 15% p.j. volgens die reguitlynmetode. Bereken die waarde na 3 jaar.', checkMode: 'auto', options: ['R9 211,87', 'R12 750', 'R21 750', 'R8 250'], correctIndex: 3, explanation: 'A = P(1 − ni) = 15 000(1 − 3 × 0,15) = 15 000(0,55) = R8 250 ✓. R9 211,87 gebruik verkeerdelik die saamgestelde (verminderende-balans) formule; R12 750 vergeet om die koers met die aantal jare te vermenigvuldig; R21 750 gebruik groei (1 + ni) in plaas van vermindering (1 − ni).' },
        { difficulty: 'Medium', question: 'ʼn Trekker ter waarde van R250 000 verminder in waarde teen 10% p.j. volgens die reguitlynmetode. Bereken die boekwaarde na 6 jaar.', checkMode: 'auto', options: ['R100 000', 'R132 860,25', 'R225 000', 'R400 000'], correctIndex: 0, explanation: 'A = 250 000(1 − 6 × 0,10) = 250 000(0,40) = R100 000 ✓. R132 860,25 gebruik verkeerdelik die saamgestelde (verminderende-balans) formule; R225 000 vergeet om die koers met die aantal jare te vermenigvuldig; R400 000 gebruik groei (1 + ni) in plaas van vermindering.' },
        { difficulty: 'Medium', question: 'Toerusting ter waarde van R20 000 verminder volgens die reguitlynmetode tot R12 000 na 4 jaar. Bereken die jaarlikse waardeverminderingskoers (as ʼn persentasie, tot 2 desimale plekke).', checkMode: 'auto', options: ['40,00%', '10,00%', '11,99%', '13,33%'], correctIndex: 1, explanation: 'i = (1 − A/P)/n = (1 − 12 000/20 000)/4 = 0,10 = 10,00% ✓. 40,00% vergeet om deur die aantal jare te deel; 11,99% gebruik verkeerdelik die saamgestelde-wortel formule; 13,33% deel deur (n − 1) in plaas van n.' },
        { difficulty: 'Hard', question: 'ʼn Generator ter waarde van R340 000 verminder in waarde teen 12% p.j. volgens die reguitlynmetode. Bereken die boekwaarde na 5 jaar.', checkMode: 'auto', options: ['R179 428,85', 'R299 200', 'R136 000', 'R544 000'], correctIndex: 2, explanation: 'A = 340 000(1 − 5 × 0,12) = 340 000(0,40) = R136 000 ✓. R179 428,85 gebruik verkeerdelik die saamgestelde (verminderende-balans) formule; R299 200 vergeet om die koers met die aantal jare te vermenigvuldig; R544 000 gebruik groei (1 + ni) in plaas van vermindering.' },

        // Blok 4 — Verminderende-balans-waardevermindering (Easy, Medium, Medium, Hard)
        { difficulty: 'Easy', question: 'ʼn Vurkhyser ter waarde van R90 000 verminder in waarde teen 20% p.j. volgens die verminderende-balans-metode. Bereken die waarde na 3 jaar (tot die naaste rand).', checkMode: 'auto', options: ['R36 000', 'R72 000', 'R155 520', 'R46 080'], correctIndex: 3, explanation: 'A = P(1 − i)ⁿ = 90 000(0,80)³ = 90 000 × 0,512 = R46 080 ✓. R36 000 gebruik verkeerdelik die reguitlynformule; R72 000 vergeet om (1 − i) tot die mag n te verhef; R155 520 gebruik groei (1 + i)ⁿ in plaas van vermindering.' },
        { difficulty: 'Medium', question: 'ʼn Bus ter waarde van R150 000 verminder in waarde teen 15% p.j. volgens die verminderende-balans-metode. Bereken die waarde na 5 jaar (tot die naaste rand).', checkMode: 'auto', options: ['R66 555,80', 'R37 500', 'R127 500', 'R301 703,58'], correctIndex: 0, explanation: 'A = 150 000(0,85)⁵ = 150 000 × 0,443705 ≈ R66 555,80 ✓. R37 500 gebruik verkeerdelik die reguitlynformule; R127 500 vergeet om (1 − i) tot die mag n te verhef; R301 703,58 gebruik groei (1 + i)ⁿ in plaas van vermindering.' },
        { difficulty: 'Medium', question: 'ʼn Drukker ter waarde van R40 000 verminder volgens die verminderende-balans-metode tot R23 000 na 4 jaar. Bereken die jaarlikse waardeverminderingskoers (as ʼn persentasie, tot 2 desimale plekke).', checkMode: 'auto', options: ['10,63%', '12,92%', '85,63%', '16,84%'], correctIndex: 1, explanation: 'i = 1 − (A/P)^(1/n) = 1 − (23 000/40 000)^(1/4) = 1 − 0,870798 = 12,92% ✓. 10,63% gebruik verkeerdelik die reguitlyn-tipe formule (1 − A/P)/n; 85,63% vergeet om die n-de wortel te trek voor aftrekking; 16,84% trek die wortel met (n − 1) in plaas van n.' },
        { difficulty: 'Hard', question: 'ʼn Hyskraan ter waarde van R220 000 verminder in waarde teen 18% p.j. volgens die verminderende-balans-metode. Na hoeveel volle jare sal dit die eerste keer minder as R90 000 werd wees?', checkMode: 'auto', options: ['4', '6', '5', '3'], correctIndex: 2, explanation: 'n = log(90 000/220 000) ÷ log(0,82) = 4,50, wat na BO afgerond moet word na 5 volle jare (kontroleer: 220 000 × 0,82⁵ ≈ R81 563 < R90 000) ✓. 4 rond verkeerdelik af in plaas van op; 6 voeg ʼn ekstra jaar by wat nie nodig is nie; 3 kom van ʼn reguitlyn-tipe skatting wat die saamgestelde aard van verminderende balans ignoreer.' },

        // Blok 5 — Vergelyking van waardeverminderingsmetodes (Medium, Hard)
        { difficulty: 'Medium', question: 'ʼn Voertuig ter waarde van R40 000 verminder in waarde teen 15% p.j. Bereken die verskil tussen die verminderende-balans-waarde en die reguitlynwaarde na 3 jaar (tot die naaste rand).', checkMode: 'auto', options: ['R22 000', 'R24 565', 'R46 565', 'R2 565'], correctIndex: 3, explanation: 'Reguitlyn: 40 000(1 − 3 × 0,15) = R22 000. Verminderende balans: 40 000(0,85)³ ≈ R24 565. Verskil = R24 565 − R22 000 = R2 565 ✓. R22 000 gee slegs die reguitlynwaarde; R24 565 gee slegs die verminderende-balanswaarde; R46 565 tel verkeerdelik die twee waardes bymekaar in plaas daarvan om af te trek.' },
        { difficulty: 'Hard', question: 'ʼn Masjien ter waarde van R60 000 verminder in waarde teen 18% p.j. Bereken die verskil tussen die verminderende-balans-waarde en die reguitlynwaarde na 4 jaar (tot die naaste rand).', checkMode: 'auto', options: ['R10 327,31', 'R16 800', 'R27 127,31', 'R43 927,31'], correctIndex: 0, explanation: 'Reguitlyn: 60 000(1 − 4 × 0,18) = R16 800. Verminderende balans: 60 000(0,82)⁴ ≈ R27 127,31. Verskil ≈ R27 127,31 − R16 800 = R10 327,31 ✓. R16 800 gee slegs die reguitlynwaarde; R27 127,31 gee slegs die verminderende-balanswaarde; R43 927,31 tel verkeerdelik die twee waardes bymekaar in plaas daarvan om af te trek.' },

        // Blok 6 — Gekombineerde multi-stap probleme (Easy, Medium, Hard)
        { difficulty: 'Easy', question: 'ʼn Vragmotor ter waarde van R120 000 verminder in waarde volgens die verminderende-balans-metode teen 20% p.j. vir die eerste 2 jaar, waarna die koers na 10% p.j. verander vir nog 1 jaar. Bereken die waarde na 3 jaar (tot die naaste rand).', checkMode: 'auto', options: ['R61 440', 'R69 120', 'R87 480', 'R73 695'], correctIndex: 1, explanation: 'Fase 1 (2 jaar teen 20%): A₁ = 120 000 × (0,80)² = R76 800. Fase 2 (1 jaar teen 10%): A₂ = 76 800 × 0,90 = R69 120 ✓. R61 440 pas verkeerdelik die 20%-koers vir al 3 jaar toe; R87 480 pas verkeerdelik die 10%-koers vir al 3 jaar toe; R73 695 gebruik verkeerdelik die gemiddelde van die twee koerse in plaas daarvan om hulle in fases toe te pas.' },
        { difficulty: 'Medium', question: 'R25 000 word teen 10% p.j. maandeliks saamgestel belê. Skakel dit om na die effektiewe jaarlikse koers, en gebruik dit om die waarde van die belegging na 2 jaar te bereken, jaarliks saamgestel teen daardie effektiewe koers (tot die naaste rand).', checkMode: 'auto', options: ['R30 250', 'R30 235,65', 'R30 509,77', 'R30 000'], correctIndex: 2, explanation: 'i_eff = (1 + 0,10/12)^12 − 1 = 10,4713%. A = 25 000(1,104713)² ≈ R30 509,77 ✓. R30 250 stel verkeerdelik die nominale koers self saam in plaas daarvan om dit eers na die effektiewe koers om te skakel; R30 235,65 pas verkeerdelik enkelvoudige groei toe met die effektiewe koers in plaas van saamstelling; R30 000 pas verkeerdelik enkelvoudige groei toe met die nominale koers.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // Blok 1 — Nominale → effektiewe koers-omskakeling (Easy, Easy, Medium, Medium)
        { difficulty: 'Easy', question: 'ʼn Bank bied ʼn nominale rentekoers van 14% p.j. maandeliks saamgestel. Bereken die effektiewe jaarlikse rentekoers (tot 2 desimale plekke).', checkMode: 'auto', options: ['14,00%', '14,93%', '14,75%', '1,17%'], correctIndex: 1, explanation: 'i_eff = (1 + 0,14/12)^12 − 1 = (1,011667)^12 − 1 = 14,93% ✓. 14,00% verwar die nominale koers met die effektiewe koers; 14,75% stel verkeerdelik kwartaalliks saam (m = 4) in plaas van maandeliks; 1,17% gee die maandelikse periodieke koers in plaas van die jaarlikse effektiewe koers.' },
        { difficulty: 'Easy', question: 'ʼn Spaarrekening betaal 6% p.j. kwartaalliks saamgestel. Bereken die effektiewe jaarlikse rentekoers (tot 2 desimale plekke).', checkMode: 'auto', options: ['6,00%', '6,17%', '6,14%', '1,50%'], correctIndex: 2, explanation: 'i_eff = (1 + 0,06/4)^4 − 1 = (1,015)^4 − 1 = 6,14% ✓. 6,00% verwar die nominale koers met die effektiewe koers; 6,17% stel verkeerdelik maandeliks saam (m = 12) in plaas van kwartaalliks; 1,50% gee die kwartaallikse periodieke koers in plaas van die jaarlikse effektiewe koers.' },
        { difficulty: 'Medium', question: 'ʼn Lening dra ʼn nominale rentekoers van 20% p.j. maandeliks saamgestel. Bereken die effektiewe jaarlikse rentekoers (tot 2 desimale plekke).', checkMode: 'auto', options: ['20,00%', '21,55%', '1,67%', '21,94%'], correctIndex: 3, explanation: 'i_eff = (1 + 0,20/12)^12 − 1 = (1,016667)^12 − 1 = 21,94% ✓. 20,00% verwar die nominale koers met die effektiewe koers; 21,55% stel verkeerdelik kwartaalliks saam (m = 4) in plaas van maandeliks; 1,67% gee die maandelikse periodieke koers in plaas van die jaarlikse effektiewe koers.' },
        { difficulty: 'Medium', question: 'ʼn Kredietkaart hef 16% p.j. kwartaalliks saamgestel. Bereken die effektiewe jaarlikse rentekoers (tot 2 desimale plekke).', checkMode: 'auto', options: ['16,99%', '16,00%', '17,23%', '4,00%'], correctIndex: 0, explanation: 'i_eff = (1 + 0,16/4)^4 − 1 = (1,04)^4 − 1 = 16,99% ✓. 16,00% verwar die nominale koers met die effektiewe koers; 17,23% stel verkeerdelik maandeliks saam (m = 12) in plaas van kwartaalliks; 4,00% gee die kwartaallikse periodieke koers in plaas van die jaarlikse effektiewe koers.' },

        // Blok 2 — Effektiewe → nominale koers-omskakeling (Medium, Medium, Hard)
        { difficulty: 'Medium', question: 'ʼn Effektiewe jaarlikse rentekoers van 16% word genoem. Bepaal die ekwivalente nominale jaarlikse koers as rente maandeliks saamgestel word (tot 2 desimale plekke).', checkMode: 'auto', options: ['16,00%', '14,93%', '15,12%', '1,24%'], correctIndex: 1, explanation: '1,16 = (1 + i_nom/12)^12, dus 1 + i_nom/12 = ¹²√1,16 = 1,012445, i_nom = 12 × 0,012445 = 14,93% ✓. 16,00% verwar die effektiewe koers met die nominale koers; 15,12% gebruik verkeerdelik kwartaallikse samestelling (m = 4) in plaas van maandeliks; 1,24% gee net die maandelikse periodieke koers en vergeet om met 12 te vermenigvuldig.' },
        { difficulty: 'Medium', question: 'ʼn Effektiewe jaarlikse rentekoers van 10% word genoem. Bepaal die ekwivalente nominale jaarlikse koers as rente kwartaalliks saamgestel word (tot 2 desimale plekke).', checkMode: 'auto', options: ['10,00%', '9,57%', '9,65%', '2,41%'], correctIndex: 2, explanation: '1,10 = (1 + i_nom/4)^4, dus 1 + i_nom/4 = ⁴√1,10 = 1,024114, i_nom = 4 × 0,024114 = 9,65% ✓. 10,00% verwar die effektiewe koers met die nominale koers; 9,57% gebruik verkeerdelik maandelikse samestelling (m = 12) in plaas van kwartaalliks; 2,41% gee net die kwartaallikse periodieke koers en vergeet om met 4 te vermenigvuldig.' },
        { difficulty: 'Hard', question: 'ʼn Bank adverteer ʼn effektiewe jaarlikse rentekoers van 25%. Bepaal die ekwivalente nominale jaarlikse koers, maandeliks saamgestel (tot 2 desimale plekke).', checkMode: 'auto', options: ['25,00%', '22,95%', '1,88%', '22,52%'], correctIndex: 3, explanation: '1,25 = (1 + i_nom/12)^12, dus 1 + i_nom/12 = ¹²√1,25 = 1,018768, i_nom = 12 × 0,018768 = 22,52% ✓. 25,00% verwar die effektiewe koers met die nominale koers; 22,95% gebruik verkeerdelik kwartaallikse samestelling (m = 4) in plaas van maandeliks; 1,88% gee net die maandelikse periodieke koers en vergeet om met 12 te vermenigvuldig.' },

        // Blok 3 — Reguitlyn-waardevermindering (Easy, Medium, Medium, Hard)
        { difficulty: 'Easy', question: 'ʼn Yskas ter waarde van R18 000 verminder in waarde teen 20% p.j. volgens die reguitlynmetode. Bereken die waarde na 3 jaar.', checkMode: 'auto', options: ['R7 200', 'R9 216', 'R14 400', 'R28 800'], correctIndex: 0, explanation: 'A = 18 000(1 − 3 × 0,20) = 18 000(0,40) = R7 200 ✓. R9 216 gebruik verkeerdelik die saamgestelde (verminderende-balans) formule; R14 400 vergeet om die koers met die aantal jare te vermenigvuldig; R28 800 gebruik groei (1 + ni) in plaas van vermindering.' },
        { difficulty: 'Medium', question: 'ʼn Afleweringsvoertuig ter waarde van R280 000 verminder in waarde teen 8% p.j. volgens die reguitlynmetode. Bereken die boekwaarde na 7 jaar.', checkMode: 'auto', options: ['R156 197,05', 'R123 200', 'R257 600', 'R436 800'], correctIndex: 1, explanation: 'A = 280 000(1 − 7 × 0,08) = 280 000(0,44) = R123 200 ✓. R156 197,05 gebruik verkeerdelik die saamgestelde (verminderende-balans) formule; R257 600 vergeet om die koers met die aantal jare te vermenigvuldig; R436 800 gebruik groei (1 + ni) in plaas van vermindering.' },
        { difficulty: 'Medium', question: 'Toerusting ter waarde van R32 000 verminder volgens die reguitlynmetode tot R18 800 na 5 jaar. Bereken die jaarlikse waardeverminderingskoers (as ʼn persentasie, tot 2 desimale plekke).', checkMode: 'auto', options: ['41,25%', '10,09%', '8,25%', '10,31%'], correctIndex: 2, explanation: 'i = (1 − A/P)/n = (1 − 18 800/32 000)/5 = 0,0825 = 8,25% ✓. 41,25% vergeet om deur die aantal jare te deel; 10,09% gebruik verkeerdelik die saamgestelde-wortel formule; 10,31% deel deur (n − 1) in plaas van n.' },
        { difficulty: 'Hard', question: 'ʼn Stootskraper ter waarde van R400 000 verminder in waarde teen 15% p.j. volgens die reguitlynmetode. Bereken die boekwaarde na 4 jaar.', checkMode: 'auto', options: ['R208 802,50', 'R340 000', 'R640 000', 'R160 000'], correctIndex: 3, explanation: 'A = 400 000(1 − 4 × 0,15) = 400 000(0,40) = R160 000 ✓. R208 802,50 gebruik verkeerdelik die saamgestelde (verminderende-balans) formule; R340 000 vergeet om die koers met die aantal jare te vermenigvuldig; R640 000 gebruik groei (1 + ni) in plaas van vermindering.' },

        // Blok 4 — Verminderende-balans-waardevermindering (Easy, Medium, Medium, Hard)
        { difficulty: 'Easy', question: 'ʼn Fotostaatmasjien ter waarde van R60 000 verminder in waarde teen 25% p.j. volgens die verminderende-balans-metode. Bereken die waarde na 3 jaar (tot die naaste rand).', checkMode: 'auto', options: ['R25 312,50', 'R15 000', 'R45 000', 'R117 187,50'], correctIndex: 0, explanation: 'A = 60 000(0,75)³ = 60 000 × 0,421875 = R25 312,50 ✓. R15 000 gebruik verkeerdelik die reguitlynformule; R45 000 vergeet om (1 − i) tot die mag n te verhef; R117 187,50 gebruik groei (1 + i)ⁿ in plaas van vermindering.' },
        { difficulty: 'Medium', question: 'ʼn Minibus ter waarde van R175 000 verminder in waarde teen 12% p.j. volgens die verminderende-balans-metode. Bereken die waarde na 6 jaar (tot die naaste rand).', checkMode: 'auto', options: ['R49 000', 'R81 270,72', 'R154 000', 'R345 418,97'], correctIndex: 1, explanation: 'A = 175 000(0,88)⁶ = 175 000 × 0,464404 ≈ R81 270,72 ✓. R49 000 gebruik verkeerdelik die reguitlynformule; R154 000 vergeet om (1 − i) tot die mag n te verhef; R345 418,97 gebruik groei (1 + i)ⁿ in plaas van vermindering.' },
        { difficulty: 'Medium', question: 'ʼn Kamera ter waarde van R55 000 verminder volgens die verminderende-balans-metode tot R28 000 na 5 jaar. Bereken die jaarlikse waardeverminderingskoers (as ʼn persentasie, tot 2 desimale plekke).', checkMode: 'auto', options: ['9,82%', '89,82%', '12,63%', '15,53%'], correctIndex: 2, explanation: 'i = 1 − (A/P)^(1/n) = 1 − (28 000/55 000)^(1/5) = 1 − 0,873693 = 12,63% ✓. 9,82% gebruik verkeerdelik die reguitlyn-tipe formule (1 − A/P)/n; 89,82% vergeet om die n-de wortel te trek voor aftrekking; 15,53% trek die wortel met (n − 1) in plaas van n.' },
        { difficulty: 'Hard', question: 'ʼn Gruistrekker ter waarde van R400 000 verminder in waarde teen 20% p.j. volgens die verminderende-balans-metode. Na hoeveel volle jare sal dit die eerste keer minder as R120 000 werd wees?', checkMode: 'auto', options: ['5', '7', '3', '6'], correctIndex: 3, explanation: 'n = log(120 000/400 000) ÷ log(0,80) = 5,40, wat na BO afgerond moet word na 6 volle jare (kontroleer: 400 000 × 0,80⁶ ≈ R104 858 < R120 000) ✓. 5 rond verkeerdelik af in plaas van op; 7 voeg ʼn ekstra jaar by wat nie nodig is nie; 3 kom van ʼn reguitlyn-tipe skatting wat die saamgestelde aard van verminderende balans ignoreer.' },

        // Blok 5 — Vergelyking van waardeverminderingsmetodes (Medium, Hard)
        { difficulty: 'Medium', question: 'ʼn Voertuig ter waarde van R60 000 verminder in waarde teen 18% p.j. Bereken die verskil tussen die verminderende-balans-waarde en die reguitlynwaarde na 4 jaar (tot die naaste rand).', checkMode: 'auto', options: ['R10 327,31', 'R16 800', 'R27 127,31', 'R43 927,31'], correctIndex: 0, explanation: 'Reguitlyn: 60 000(1 − 4 × 0,18) = R16 800. Verminderende balans: 60 000(0,82)⁴ ≈ R27 127,31. Verskil ≈ R27 127,31 − R16 800 = R10 327,31 ✓. R16 800 gee slegs die reguitlynwaarde; R27 127,31 gee slegs die verminderende-balanswaarde; R43 927,31 tel verkeerdelik die twee waardes bymekaar in plaas daarvan om af te trek.' },
        { difficulty: 'Hard', question: 'ʼn Masjien ter waarde van R80 000 verminder in waarde teen 15% p.j. Bereken die verskil tussen die verminderende-balans-waarde en die reguitlynwaarde na 5 jaar (tot die naaste rand).', checkMode: 'auto', options: ['R20 000', 'R15 496,42', 'R35 496,42', 'R55 496,42'], correctIndex: 1, explanation: 'Reguitlyn: 80 000(1 − 5 × 0,15) = R20 000. Verminderende balans: 80 000(0,85)⁵ ≈ R35 496,42. Verskil ≈ R35 496,42 − R20 000 = R15 496,42 ✓. R20 000 gee slegs die reguitlynwaarde; R35 496,42 gee slegs die verminderende-balanswaarde; R55 496,42 tel verkeerdelik die twee waardes bymekaar in plaas daarvan om af te trek.' },

        // Blok 6 — Gekombineerde multi-stap probleme (Easy, Medium, Hard)
        { difficulty: 'Easy', question: 'ʼn Bus ter waarde van R200 000 verminder in waarde volgens die verminderende-balans-metode teen 25% p.j. vir die eerste 2 jaar, waarna die koers na 15% p.j. verander vir nog 1 jaar. Bereken die waarde na 3 jaar (tot die naaste rand).', checkMode: 'auto', options: ['R84 375', 'R122 825', 'R95 625', 'R102 400'], correctIndex: 2, explanation: 'Fase 1 (2 jaar teen 25%): A₁ = 200 000 × (0,75)² = R112 500. Fase 2 (1 jaar teen 15%): A₂ = 112 500 × 0,85 = R95 625 ✓. R84 375 pas verkeerdelik die 25%-koers vir al 3 jaar toe; R122 825 pas verkeerdelik die 15%-koers vir al 3 jaar toe; R102 400 gebruik verkeerdelik die gemiddelde van die twee koerse in plaas daarvan om hulle in fases toe te pas.' },
        { difficulty: 'Medium', question: 'R30 000 word teen 12% p.j. kwartaalliks saamgestel belê. Skakel dit om na die effektiewe jaarlikse koers, en gebruik dit om die waarde van die belegging na 3 jaar te bereken, jaarliks saamgestel teen daardie effektiewe koers (tot die naaste rand).', checkMode: 'auto', options: ['R42 147,84', 'R41 295,79', 'R40 800', 'R42 772,83'], correctIndex: 3, explanation: 'i_eff = (1 + 0,12/4)^4 − 1 = 12,5509%. A = 30 000(1,125509)³ ≈ R42 772,83 ✓. R42 147,84 stel verkeerdelik die nominale koers self saam in plaas daarvan om dit eers na die effektiewe koers om te skakel; R41 295,79 pas verkeerdelik enkelvoudige groei toe met die effektiewe koers in plaas van saamstelling; R40 800 pas verkeerdelik enkelvoudige groei toe met die nominale koers.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // Blok 1 — Nominale → effektiewe koers-omskakeling (Easy, Easy, Medium, Medium)
        { difficulty: 'Easy', question: 'ʼn Bank bied ʼn nominale rentekoers van 13% p.j. maandeliks saamgestel. Bereken die effektiewe jaarlikse rentekoers (tot 2 desimale plekke).', checkMode: 'auto', options: ['13,00%', '13,65%', '13,80%', '1,08%'], correctIndex: 2, explanation: 'i_eff = (1 + 0,13/12)^12 − 1 = (1,010833)^12 − 1 = 13,80% ✓. 13,00% verwar die nominale koers met die effektiewe koers; 13,65% stel verkeerdelik kwartaalliks saam (m = 4) in plaas van maandeliks; 1,08% gee die maandelikse periodieke koers in plaas van die jaarlikse effektiewe koers.' },
        { difficulty: 'Easy', question: 'ʼn Spaarrekening betaal 7% p.j. kwartaalliks saamgestel. Bereken die effektiewe jaarlikse rentekoers (tot 2 desimale plekke).', checkMode: 'auto', options: ['7,00%', '7,23%', '1,75%', '7,19%'], correctIndex: 3, explanation: 'i_eff = (1 + 0,07/4)^4 − 1 = (1,0175)^4 − 1 = 7,19% ✓. 7,00% verwar die nominale koers met die effektiewe koers; 7,23% stel verkeerdelik maandeliks saam (m = 12) in plaas van kwartaalliks; 1,75% gee die kwartaallikse periodieke koers in plaas van die jaarlikse effektiewe koers.' },
        { difficulty: 'Medium', question: 'ʼn Lening dra ʼn nominale rentekoers van 22% p.j. maandeliks saamgestel. Bereken die effektiewe jaarlikse rentekoers (tot 2 desimale plekke).', checkMode: 'auto', options: ['24,36%', '22,00%', '23,88%', '1,83%'], correctIndex: 0, explanation: 'i_eff = (1 + 0,22/12)^12 − 1 = (1,018333)^12 − 1 = 24,36% ✓. 22,00% verwar die nominale koers met die effektiewe koers; 23,88% stel verkeerdelik kwartaalliks saam (m = 4) in plaas van maandeliks; 1,83% gee die maandelikse periodieke koers in plaas van die jaarlikse effektiewe koers.' },
        { difficulty: 'Medium', question: 'ʼn Kredietkaart hef 20% p.j. kwartaalliks saamgestel. Bereken die effektiewe jaarlikse rentekoers (tot 2 desimale plekke).', checkMode: 'auto', options: ['20,00%', '21,55%', '21,94%', '5,00%'], correctIndex: 1, explanation: 'i_eff = (1 + 0,20/4)^4 − 1 = (1,05)^4 − 1 = 21,55% ✓. 20,00% verwar die nominale koers met die effektiewe koers; 21,94% stel verkeerdelik maandeliks saam (m = 12) in plaas van kwartaalliks; 5,00% gee die kwartaallikse periodieke koers in plaas van die jaarlikse effektiewe koers.' },

        // Blok 2 — Effektiewe → nominale koers-omskakeling (Medium, Medium, Hard)
        { difficulty: 'Medium', question: 'ʼn Effektiewe jaarlikse rentekoers van 14% word genoem. Bepaal die ekwivalente nominale jaarlikse koers as rente maandeliks saamgestel word (tot 2 desimale plekke).', checkMode: 'auto', options: ['14,00%', '13,32%', '13,17%', '1,10%'], correctIndex: 2, explanation: '1,14 = (1 + i_nom/12)^12, dus 1 + i_nom/12 = ¹²√1,14 = 1,010979, i_nom = 12 × 0,010979 = 13,17% ✓. 14,00% verwar die effektiewe koers met die nominale koers; 13,32% gebruik verkeerdelik kwartaallikse samestelling (m = 4) in plaas van maandeliks; 1,10% gee net die maandelikse periodieke koers en vergeet om met 12 te vermenigvuldig.' },
        { difficulty: 'Medium', question: 'ʼn Effektiewe jaarlikse rentekoers van 11% word genoem. Bepaal die ekwivalente nominale jaarlikse koers as rente kwartaalliks saamgestel word (tot 2 desimale plekke).', checkMode: 'auto', options: ['11,00%', '10,48%', '2,64%', '10,57%'], correctIndex: 3, explanation: '1,11 = (1 + i_nom/4)^4, dus 1 + i_nom/4 = ⁴√1,11 = 1,026433, i_nom = 4 × 0,026433 = 10,57% ✓. 11,00% verwar die effektiewe koers met die nominale koers; 10,48% gebruik verkeerdelik maandelikse samestelling (m = 12) in plaas van kwartaalliks; 2,64% gee net die kwartaallikse periodieke koers en vergeet om met 4 te vermenigvuldig.' },
        { difficulty: 'Hard', question: 'ʼn Bank adverteer ʼn effektiewe jaarlikse rentekoers van 18%. Bepaal die ekwivalente nominale jaarlikse koers, maandeliks saamgestel (tot 2 desimale plekke).', checkMode: 'auto', options: ['16,67%', '18,00%', '16,90%', '1,39%'], correctIndex: 0, explanation: '1,18 = (1 + i_nom/12)^12, dus 1 + i_nom/12 = ¹²√1,18 = 1,013889, i_nom = 12 × 0,013889 = 16,67% ✓. 18,00% verwar die effektiewe koers met die nominale koers; 16,90% gebruik verkeerdelik kwartaallikse samestelling (m = 4) in plaas van maandeliks; 1,39% gee net die maandelikse periodieke koers en vergeet om met 12 te vermenigvuldig.' },

        // Blok 3 — Reguitlyn-waardevermindering (Easy, Medium, Medium, Hard)
        { difficulty: 'Easy', question: 'ʼn Skottelgoedwasser ter waarde van R22 000 verminder in waarde teen 25% p.j. volgens die reguitlynmetode. Bereken die waarde na 2 jaar.', checkMode: 'auto', options: ['R12 375', 'R11 000', 'R16 500', 'R33 000'], correctIndex: 1, explanation: 'A = 22 000(1 − 2 × 0,25) = 22 000(0,50) = R11 000 ✓. R12 375 gebruik verkeerdelik die saamgestelde (verminderende-balans) formule; R16 500 vergeet om die koers met die aantal jare te vermenigvuldig; R33 000 gebruik groei (1 + ni) in plaas van vermindering.' },
        { difficulty: 'Medium', question: 'ʼn Sementmenger ter waarde van R320 000 verminder in waarde teen 9% p.j. volgens die reguitlynmetode. Bereken die boekwaarde na 8 jaar.', checkMode: 'auto', options: ['R150 480,81', 'R291 200', 'R89 600', 'R550 400'], correctIndex: 2, explanation: 'A = 320 000(1 − 8 × 0,09) = 320 000(0,28) = R89 600 ✓. R150 480,81 gebruik verkeerdelik die saamgestelde (verminderende-balans) formule; R291 200 vergeet om die koers met die aantal jare te vermenigvuldig; R550 400 gebruik groei (1 + ni) in plaas van vermindering.' },
        { difficulty: 'Medium', question: 'Toerusting ter waarde van R45 000 verminder volgens die reguitlynmetode tot R27 000 na 4 jaar. Bereken die jaarlikse waardeverminderingskoers (as ʼn persentasie, tot 2 desimale plekke).', checkMode: 'auto', options: ['40,00%', '11,99%', '13,33%', '10,00%'], correctIndex: 3, explanation: 'i = (1 − A/P)/n = (1 − 27 000/45 000)/4 = 0,10 = 10,00% ✓. 40,00% vergeet om deur die aantal jare te deel; 11,99% gebruik verkeerdelik die saamgestelde-wortel formule; 13,33% deel deur (n − 1) in plaas van n.' },
        { difficulty: 'Hard', question: 'ʼn Boot ter waarde van R500 000 verminder in waarde teen 18% p.j. volgens die reguitlynmetode. Bereken die boekwaarde na 3 jaar.', checkMode: 'auto', options: ['R230 000', 'R275 684', 'R410 000', 'R770 000'], correctIndex: 0, explanation: 'A = 500 000(1 − 3 × 0,18) = 500 000(0,46) = R230 000 ✓. R275 684 gebruik verkeerdelik die saamgestelde (verminderende-balans) formule; R410 000 vergeet om die koers met die aantal jare te vermenigvuldig; R770 000 gebruik groei (1 + ni) in plaas van vermindering.' },

        // Blok 4 — Verminderende-balans-waardevermindering (Easy, Medium, Medium, Hard)
        { difficulty: 'Easy', question: 'ʼn Dromvliegtuig (drone) ter waarde van R70 000 verminder in waarde teen 18% p.j. volgens die verminderende-balans-metode. Bereken die waarde na 3 jaar (tot die naaste rand).', checkMode: 'auto', options: ['R32 200', 'R38 595,76', 'R57 400', 'R115 012,24'], correctIndex: 1, explanation: 'A = 70 000(0,82)³ = 70 000 × 0,551368 ≈ R38 595,76 ✓. R32 200 gebruik verkeerdelik die reguitlynformule; R57 400 vergeet om (1 − i) tot die mag n te verhef; R115 012,24 gebruik groei (1 + i)ⁿ in plaas van vermindering.' },
        { difficulty: 'Medium', question: 'ʼn Toerbus ter waarde van R195 000 verminder in waarde teen 14% p.j. volgens die verminderende-balans-metode. Bereken die waarde na 6 jaar (tot die naaste rand).', checkMode: 'auto', options: ['R31 200', 'R167 700', 'R78 890,61', 'R428 019,66'], correctIndex: 2, explanation: 'A = 195 000(0,86)⁶ = 195 000 × 0,404567 ≈ R78 890,61 ✓. R31 200 gebruik verkeerdelik die reguitlynformule; R167 700 vergeet om (1 − i) tot die mag n te verhef; R428 019,66 gebruik groei (1 + i)ⁿ in plaas van vermindering.' },
        { difficulty: 'Medium', question: 'ʼn Skootrekenaar ter waarde van R65 000 verminder volgens die verminderende-balans-metode tot R30 000 na 5 jaar. Bereken die jaarlikse waardeverminderingskoers (as ʼn persentasie, tot 2 desimale plekke).', checkMode: 'auto', options: ['10,77%', '90,77%', '17,58%', '14,33%'], correctIndex: 3, explanation: 'i = 1 − (A/P)^(1/n) = 1 − (30 000/65 000)^(1/5) = 1 − 0,856725 = 14,33% ✓. 10,77% gebruik verkeerdelik die reguitlyn-tipe formule (1 − A/P)/n; 90,77% vergeet om die n-de wortel te trek voor aftrekking; 17,58% trek die wortel met (n − 1) in plaas van n.' },
        { difficulty: 'Hard', question: 'ʼn Jag ter waarde van R600 000 verminder in waarde teen 22% p.j. volgens die verminderende-balans-metode. Na hoeveel volle jare sal dit die eerste keer minder as R150 000 werd wees?', checkMode: 'auto', options: ['6', '5', '7', '3'], correctIndex: 0, explanation: 'n = log(150 000/600 000) ÷ log(0,78) = 5,58, wat na BO afgerond moet word na 6 volle jare (kontroleer: 600 000 × 0,78⁶ ≈ R135 120 < R150 000) ✓. 5 rond verkeerdelik af in plaas van op; 7 voeg ʼn ekstra jaar by wat nie nodig is nie; 3 kom van ʼn reguitlyn-tipe skatting wat die saamgestelde aard van verminderende balans ignoreer.' },

        // Blok 5 — Vergelyking van waardeverminderingsmetodes (Medium, Hard)
        { difficulty: 'Medium', question: 'ʼn Afleweringsfiets ter waarde van R50 000 verminder in waarde teen 20% p.j. Bereken die verskil tussen die verminderende-balans-waarde en die reguitlynwaarde na 3 jaar (tot die naaste rand).', checkMode: 'auto', options: ['R20 000', 'R5 600', 'R25 600', 'R45 600'], correctIndex: 1, explanation: 'Reguitlyn: 50 000(1 − 3 × 0,20) = R20 000. Verminderende balans: 50 000(0,80)³ = R25 600. Verskil = R25 600 − R20 000 = R5 600 ✓. R20 000 gee slegs die reguitlynwaarde; R25 600 gee slegs die verminderende-balanswaarde; R45 600 tel verkeerdelik die twee waardes bymekaar in plaas daarvan om af te trek.' },
        { difficulty: 'Hard', question: 'ʼn Vurkhyser ter waarde van R100 000 verminder in waarde teen 16% p.j. Bereken die verskil tussen die verminderende-balans-waarde en die reguitlynwaarde na 6 jaar (tot die naaste rand).', checkMode: 'auto', options: ['R4 000', 'R35 129,80', 'R31 129,80', 'R39 129,80'], correctIndex: 2, explanation: 'Reguitlyn: 100 000(1 − 6 × 0,16) = R4 000. Verminderende balans: 100 000(0,84)⁶ ≈ R35 129,80. Verskil ≈ R35 129,80 − R4 000 = R31 129,80 ✓. R4 000 gee slegs die reguitlynwaarde; R35 129,80 gee slegs die verminderende-balanswaarde; R39 129,80 tel verkeerdelik die twee waardes bymekaar in plaas daarvan om af te trek.' },

        // Blok 6 — Gekombineerde multi-stap probleme (Easy, Medium, Hard)
        { difficulty: 'Easy', question: 'ʼn Vragmotor ter waarde van R160 000 verminder in waarde volgens die verminderende-balans-metode teen 18% p.j. vir die eerste 2 jaar, waarna die koers na 12% p.j. verander vir nog 1 jaar. Bereken die waarde na 3 jaar (tot die naaste rand).', checkMode: 'auto', options: ['R88 218,88', 'R109 035,52', 'R98 260', 'R94 673,92'], correctIndex: 3, explanation: 'Fase 1 (2 jaar teen 18%): A₁ = 160 000 × (0,82)² = R107 584. Fase 2 (1 jaar teen 12%): A₂ = 107 584 × 0,88 ≈ R94 673,92 ✓. R88 218,88 pas verkeerdelik die 18%-koers vir al 3 jaar toe; R109 035,52 pas verkeerdelik die 12%-koers vir al 3 jaar toe; R98 260 gebruik verkeerdelik die gemiddelde van die twee koerse in plaas daarvan om hulle in fases toe te pas.' },
        { difficulty: 'Medium', question: 'R45 000 word teen 9% p.j. maandeliks saamgestel belê. Skakel dit om na die effektiewe jaarlikse koers, en gebruik dit om die waarde van die belegging na 2 jaar te bereken, jaarliks saamgestel teen daardie effektiewe koers (tot die naaste rand).', checkMode: 'auto', options: ['R53 838,61', 'R53 464,50', 'R53 442,62', 'R53 100'], correctIndex: 0, explanation: 'i_eff = (1 + 0,09/12)^12 − 1 = 9,3807%. A = 45 000(1,093807)² ≈ R53 838,61 ✓. R53 464,50 stel verkeerdelik die nominale koers self saam in plaas daarvan om dit eers na die effektiewe koers om te skakel; R53 442,62 pas verkeerdelik enkelvoudige groei toe met die effektiewe koers in plaas van saamstelling; R53 100 pas verkeerdelik enkelvoudige groei toe met die nominale koers.' },
