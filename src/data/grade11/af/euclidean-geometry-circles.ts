  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Hard', question: 'In die sirkel getoon met middelpunt O is AB ʼn middellyn. C en D is punte op die omtrek aan dieselfde kant van AB, met ∠CAB = 25° en ∠DBA = 25°. Bepaal ∠ACB, ∠ADB, en ∠ABC.', checkMode: 'auto', correctAnswer: '90,90,65', correctAnswers: ['90,90,65', '90°,90°,65°', '90°, 90°, 65°'], answer: '∠ACB = 90°, ∠ADB = 90°, ∠ABC = 65°', explanation: 'AB is ʼn middellyn, dus is ∠ACB = 90° en ∠ADB = 90° (hoek in ʼn halfsirkel geld vir enige punt op die sirkel).\nIn driehoek ABC: ∠CAB = 25°, ∠ACB = 90°.\n∠ABC = 180° − 90° − 25° = 65° ✓', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="50" y1="120" x2="230" y2="120" stroke="#ea580c" stroke-width="2.5"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><circle cx="50" cy="120" r="2.5" fill="#0f1f3d"/><text x="30" y="124" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="230" cy="120" r="2.5" fill="#0f1f3d"/><text x="238" y="124" font-size="13" fill="#0f1f3d" font-weight="700">B</text><line x1="50" y1="120" x2="213.72" y2="68.38" stroke="#0f1f3d" stroke-width="2.5"/><line x1="230" y1="120" x2="213.72" y2="68.38" stroke="#0f1f3d" stroke-width="2.5"/><line x1="50" y1="120" x2="66.28" y2="68.38" stroke="#0f1f3d" stroke-width="2.5"/><line x1="230" y1="120" x2="66.28" y2="68.38" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 205.14,71.08 L 207.85,79.67 L 216.43,76.96" fill="none" stroke="#0f1f3d" stroke-width="1.8"/><path d="M 63.57,76.96 L 72.15,79.67 L 74.86,71.08" fill="none" stroke="#0f1f3d" stroke-width="1.8"/><circle cx="213.72" cy="68.38" r="2.5" fill="#0f1f3d"/><text x="221.72" y="60.38" font-size="13" fill="#0f1f3d" font-weight="700">C</text><circle cx="66.28" cy="68.38" r="2.5" fill="#0f1f3d"/><text x="58.28" y="58.38" font-size="13" fill="#0f1f3d" font-weight="700">D</text><text x="73.72" y="110.35" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">25°</text><text x="206.28" y="110.35" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">25°</text></svg>' },
      ],
      scoreMessages: [
        { minScore: 20, message: 'Uitstekend! Jy het sirkelterminologie en die sleutel sirkelstellings bemeester — loodlyn wat ʼn koord halveer, hoek by die middelpunt, hoeke in dieselfde segment, en die hoek in ʼn halfsirkel.' },
        { minScore: 15, message: 'Goeie werk! Hersien enige gemiste vrae oor die hoek-by-middelpunt-stelling of die halfsirkel-stelling, en probeer weer.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Hard', question: 'In die sirkel getoon met middelpunt O is AB ʼn middellyn. C en D is punte op die omtrek aan dieselfde kant van AB, met ∠CAB = 33° en ∠DBA = 33°. Bepaal ∠ACB, ∠ADB, en ∠ABC.', checkMode: 'auto', correctAnswer: '90,90,57', correctAnswers: ['90,90,57', '90°,90°,57°', '90°, 90°, 57°'], answer: '∠ACB = 90°, ∠ADB = 90°, ∠ABC = 57°', explanation: 'AB is ʼn middellyn, dus is ∠ACB = 90° en ∠ADB = 90° (hoek in ʼn halfsirkel geld vir enige punt op die sirkel).\nIn driehoek ABC: ∠CAB = 33°, ∠ACB = 90°.\n∠ABC = 180° − 90° − 33° = 57° ✓', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="50" y1="120" x2="230" y2="120" stroke="#ea580c" stroke-width="2.5"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><circle cx="50" cy="120" r="2.5" fill="#0f1f3d"/><text x="30" y="124" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="230" cy="120" r="2.5" fill="#0f1f3d"/><text x="238" y="124" font-size="13" fill="#0f1f3d" font-weight="700">B</text><line x1="50" y1="120" x2="213.72" y2="68.38" stroke="#0f1f3d" stroke-width="2.5"/><line x1="230" y1="120" x2="213.72" y2="68.38" stroke="#0f1f3d" stroke-width="2.5"/><line x1="50" y1="120" x2="66.28" y2="68.38" stroke="#0f1f3d" stroke-width="2.5"/><line x1="230" y1="120" x2="66.28" y2="68.38" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 205.14,71.08 L 207.85,79.67 L 216.43,76.96" fill="none" stroke="#0f1f3d" stroke-width="1.8"/><path d="M 63.57,76.96 L 72.15,79.67 L 74.86,71.08" fill="none" stroke="#0f1f3d" stroke-width="1.8"/><circle cx="213.72" cy="68.38" r="2.5" fill="#0f1f3d"/><text x="221.72" y="60.38" font-size="13" fill="#0f1f3d" font-weight="700">C</text><circle cx="66.28" cy="68.38" r="2.5" fill="#0f1f3d"/><text x="58.28" y="58.38" font-size="13" fill="#0f1f3d" font-weight="700">D</text><text x="73.72" y="110.35" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">33°</text><text x="206.28" y="110.35" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">33°</text></svg>' },
      ],
      scoreMessages: [
        { minScore: 20, message: 'Uitstekend! Jy het sirkelterminologie en die sleutel sirkelstellings bemeester — loodlyn wat ʼn koord halveer, hoek by die middelpunt, hoeke in dieselfde segment, en die hoek in ʼn halfsirkel.' },
        { minScore: 15, message: 'Goeie werk! Hersien enige gemiste vrae oor die hoek-by-middelpunt-stelling of die halfsirkel-stelling, en probeer weer.' },
