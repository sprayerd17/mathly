...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Kort video wat ʼn visuele oorsig wys van al die sleutel sirkelterme gemerk op een sirkeldiagram — middelpunt, radius, middellyn, koord, raaklyn, snylyn, boog en segment',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Kort video wat ʼn koord wys met die loodlyn vanaf die middelpunt wat dit halveer — met die twee gelyke halfkoorde en die reghoekige driehoek wat vir Pythagoras-berekeninge gebruik word, gemerk',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Kort video wat ʼn koord wys wat ʼn hoek by die middelpunt en ʼn hoek by die omtrek onderspan, wat demonstreer dat die hoek by die middelpunt gelyk is aan dubbel die hoek by die omtrek, en wat die reflekshoek-geval vir ʼn punt op die klein boog wys',
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Kort video wat twee hoeke wys wat deur dieselfde koord aan dieselfde kant onderspan word, wat demonstreer dat hoeke in dieselfde segment gelyk is, en wat dan twee gelyke koorde wys wat gelyke hoeke by die middelpunt en omtrek lewer',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Kort video wat ʼn middellyn met ʼn derde punt op die sirkel wys wat ʼn regte hoek vorm, wat demonstreer dat die hoek in ʼn halfsirkel altyd 90 grade is, en dan die omgekeerde wys waar ʼn 90-grade-hoek bewys dat ʼn koord ʼn middellyn is',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Kort video wat ʼn koordevierhoek ABCD wys met teenoorstaande hoekpare uitgelig in blou en rooi, ʼn sy verleng om die buitehoek in groen te wys wat met die teenoorstaande binnehoek in oranje ooreenstem, en die middelpunt-konstruksie wat in die formele bewys gebruik word',
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      workedExamples: [
        {
          question:
            'ʼn Raaklyn by punt T maak ʼn hoek van 62,5° met koord TC. Bepaal die hoek ∠TAC in die oorstaande segment (A op die ver boog).<br>' +
          ...
          answer: `∠TAC = ${gr('62,5°')}`,
          steps: [
            `Die raaklyn-koordhoek by T tussen die raaklyn en koord TC is ${gr('62,5°')}.`,
            ...
            `∠TAC = ${gr('62,5°')}.`,
            `<strong>Antwoord:</strong> ∠TAC = ${gr('62,5°')}. ✓`,
          ],
        },
        {
      ...
      openQuestions: [
        ...
        },
        {
          difficulty: 'Hard',
          question:
            'PT is ʼn raaklyn aan ʼn sirkel by T. TC is ʼn koord, en A is ʼn punt op die sirkel in die oorstaande segment, met TA en AC getrek om driehoek TAC te vorm. Die raaklyn-koordhoek by T (tussen die raaklyn en koord TC) is 62,5°, en ∠TCA = 60°. Bepaal ∠TAC en ∠ATC, en sê of driehoek TAC gelykbenig is.<br>' +
          ...
          answer:
            `∠TAC = ${gr('62,5°')}, ∠ATC = ${bl('57,5°')}, en aangesien al drie hoeke van △TAC van mekaar verskil (60°, 57,5°, 62,5°), is driehoek TAC ongelyksydig, nie gelykbenig nie.` +
            proofTable([
              ['∠TAC = 62,5°', 'raaklyn-koordstelling (∠TAC is die ∠ in die oorstaande segment, gelyk aan die raaklyn-koordhoek van 62,5°)'],
              ['∠ATC = 180° − 62,5° − 60° = 57,5°', '∠somme van △TAC = 180°'],
              ['∠TCA ≠ ∠ATC ≠ ∠TAC', 'die drie hoeke (60°, 57,5°, 62,5°) is almal verskillend'],
              ['∴ △TAC is ongelyksydig', 'sye teenoor ongelyke hoeke in ʼn driehoek is ongelyk, dus is geen twee sye van △TAC gelyk nie'],
            ]),
          checkMode: 'self',
        },
      ],
      ...
      videoPlaceholder:
        'Kort video wat ʼn raaklyn by T wys met die raaklyn-koordhoek in groen uitgelig, ʼn gelyke ingeskrewe hoek in die oorstaande segment ook in groen uitgelig, en ʼn aparte diagram wat twee gelyke raaklynstukke vanaf ʼn eksterne punt wys',
  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // Blok 1 — Sirkelterminologie (Easy/Easy/Medium/Medium)
        { difficulty: 'Easy', question: 'Wat is die naam van die lyn wat deur ʼn sirkel sny en die omtrek by twee punte kruis?', checkMode: 'auto', options: ['snylyn', 'raaklyn', 'koord', 'middellyn'], correctIndex: 0, explanation: 'ʼn Lyn wat deur ʼn sirkel by twee punte sny, word ʼn snylyn genoem. (ʼn Raaklyn raak die sirkel by slegs een punt, nie twee nie — dit is wat dit van ʼn snylyn onderskei.)' },
        { difficulty: 'Easy', question: 'Wat is die naam van die hoek wat by die middelpunt O van ʼn sirkel deur twee radiusse gevorm word wat na die eindpunte van ʼn koord getrek word?', checkMode: 'auto', options: ['hoek by die omtrek', 'hoek by die middelpunt', 'die hoek in ʼn halfsirkel', 'die raaklyn-koord-hoek'], correctIndex: 1, explanation: 'Die hoek wat by die middelpunt deur twee radiusse na die eindpunte van ʼn koord gevorm word, word die hoek by die middelpunt genoem. (Dit is spesifiek die hoek by O gevorm, nie by ʼn punt op die omtrek nie, en nie die spesiale halfsirkel- of raaklyn-koord-gevalle nie.)' },
        { difficulty: 'Medium', question: 'ʼn Koord gaan deur die middelpunt van ʼn sirkel. Wat word hierdie koord genoem, en hoe vergelyk sy lengte met die radius?', checkMode: 'auto', options: ['radius, gelyk aan die radius', 'middellyn, gelyk aan die radius', 'middellyn, twee keer die radius', 'koord, drie keer die radius'], correctIndex: 2, explanation: 'ʼn Koord deur die middelpunt word ʼn middellyn genoem. Dit is gelyk aan twee radiusse, dus is dit twee keer die lengte van die radius. (ʼn Middellyn is gelyk aan twee radiusse — nie een nie, en nie drie nie — end-tot-end deur die middelpunt.)' },
        { difficulty: 'Medium', question: 'ʼn Gedeelte van ʼn sirkel wat deur ʼn koord en die boog wat dit afsny, begrens word, word ʼn segment genoem. Wat noem ons die korter van die twee boë tussen twee punte op ʼn sirkel?', checkMode: 'auto', options: ['hoofboog', 'klein segment', 'halfsirkel', 'klein boog'], correctIndex: 3, explanation: 'Die korter boog tussen twee punte op ʼn sirkel word die klein boog genoem (die langer een is die hoofboog). (Die klein boog is die korter van die twee boë — moenie dit met die hoofboog, ʼn segment, of ʼn halfsirkel verwar nie.)' },

        // Blok 2 — Loodlyn vanaf middelpunt halveer koord (Easy/Easy/Medium/Hard)
        { difficulty: 'Easy', question: 'In die sirkel getoon met middelpunt O, word OM loodreg op koord AB getrek, waar AB = 24 cm en die radius OA = 15 cm. Bepaal die lengte van OM.', checkMode: 'auto', options: ['9 cm', '12 cm', '24 cm', '15 cm'], correctIndex: 0, explanation: 'Aangesien OM ⊥ AB, halveer OM die koord: AM = 24 ÷ 2 = 12 cm.\nIn reghoekige driehoek OMA: OM² = OA² − AM² = 15² − 12² = 225 − 144 = 81.\nOM = √81 = 9 cm ✓ (Die ander opsies verwar die half-koord AM of die volle koord AB met OM, of gee die radius self in plaas daarvan om Pythagoras toe te pas.)', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="88.38" y2="193.72" stroke="#0f1f3d" stroke-width="2.5"/><line x1="88.38" y1="193.72" x2="191.62" y2="193.72" stroke="#ea580c" stroke-width="2.5"/><line x1="140" y1="120" x2="140" y2="193.72" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 140,184.72 L 131,184.72 L 131,193.72" fill="none" stroke="#0f1f3d" stroke-width="1.8"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><circle cx="88.38" cy="193.72" r="2.5" fill="#0f1f3d"/><text x="70.38" y="199.72" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="191.62" cy="193.72" r="2.5" fill="#0f1f3d"/><text x="199.62" y="199.72" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="140" cy="193.72" r="2.5" fill="#0f1f3d"/><text x="146" y="185.72" font-size="13" fill="#0f1f3d" font-weight="700">M</text><text x="91.08" y="147.68" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">OA = 15 cm</text><text x="140" y="219.72" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">AB = 24 cm</text><text x="154" y="160.86" font-size="12" fill="#ea580c" font-weight="700" text-anchor="start">?</text></svg>' },
        { difficulty: 'Easy', question: 'In die sirkel getoon met middelpunt O en radius 20 cm, is OM loodreg op koord AB en OM = 16 cm. Bepaal die lengte van koord AB.', checkMode: 'auto', options: ['12 cm', '24 cm', '16 cm', '20 cm'], correctIndex: 1, explanation: 'In reghoekige driehoek OMA: AM² = OA² − OM² = 20² − 16² = 400 − 256 = 144.\nAM = √144 = 12 cm.\nAangesien OM die koord halveer, is AB = 2 × AM = 2 × 12 = 24 cm ✓ (Die ander opsies gee die half-koord AM, verwar OM met die koord, of gee die radius in plaas van die volle koord AB.)', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="71.06" y2="177.85" stroke="#0f1f3d" stroke-width="2.5"/><line x1="71.06" y1="177.85" x2="208.94" y2="177.85" stroke="#ea580c" stroke-width="2.5"/><line x1="140" y1="120" x2="140" y2="177.85" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 140,168.85 L 131,168.85 L 131,177.85" fill="none" stroke="#0f1f3d" stroke-width="1.8"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><circle cx="71.06" cy="177.85" r="2.5" fill="#0f1f3d"/><text x="53.06" y="183.85" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="208.94" cy="177.85" r="2.5" fill="#0f1f3d"/><text x="216.94" y="183.85" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="140" cy="177.85" r="2.5" fill="#0f1f3d"/><text x="146" y="169.85" font-size="13" fill="#0f1f3d" font-weight="700">M</text><text x="85.24" y="136.67" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">OA = 20 cm</text><text x="140" y="203.85" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text><text x="154" y="152.93" font-size="12" fill="#2563eb" font-weight="700" text-anchor="start">OM = 16 cm</text></svg>' },
        { difficulty: 'Medium', question: 'In die sirkel getoon met middelpunt O en radius 41 cm, is koord AB = 80 cm. OM word vanaf die middelpunt loodreg op AB getrek. Bepaal die lengte van OM.', checkMode: 'auto', options: ['40 cm', '80 cm', '9 cm', '41 cm'], correctIndex: 2, explanation: 'Aangesien OM ⊥ AB, halveer OM die koord: AM = 80 ÷ 2 = 40 cm.\nIn reghoekige driehoek OMA: OM² = OA² − AM² = 41² − 40² = 1681 − 1600 = 81.\nOM = √81 = 9 cm ✓ (Dieselfde idee as voorheen — moenie die half-koord of volle koord met OM verwar nie, en onthou Pythagoras is nodig, nie net die radius nie.)', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="82.15" y2="188.94" stroke="#0f1f3d" stroke-width="2.5"/><line x1="82.15" y1="188.94" x2="197.85" y2="188.94" stroke="#ea580c" stroke-width="2.5"/><line x1="140" y1="120" x2="140" y2="188.94" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 140,179.94 L 131,179.94 L 131,188.94" fill="none" stroke="#0f1f3d" stroke-width="1.8"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><circle cx="82.15" cy="188.94" r="2.5" fill="#0f1f3d"/><text x="64.15" y="194.94" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="197.85" cy="188.94" r="2.5" fill="#0f1f3d"/><text x="205.85" y="194.94" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="140" cy="188.94" r="2.5" fill="#0f1f3d"/><text x="146" y="180.94" font-size="13" fill="#0f1f3d" font-weight="700">M</text><text x="88.82" y="144.19" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">OA = 41 cm</text><text x="140" y="214.94" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">AB = 80 cm</text><text x="154" y="158.47" font-size="12" fill="#ea580c" font-weight="700" text-anchor="start">?</text></svg>' },
        { difficulty: 'Hard', question: 'In die sirkel getoon met middelpunt O en radius 61 cm, is M die middelpunt van koord AB, met OM = 11 cm. Bepaal die lengte van AB, en gee dan die grootte van hoek OMB.', checkMode: 'auto', options: ['AB = 60 cm, ∠OMB = 90°', 'AB = 120 cm, ∠OMB = 180°', 'AB = 122 cm, ∠OMB = 90°', 'AB = 120 cm, ∠OMB = 90°'], correctIndex: 3, explanation: 'In reghoekige driehoek OMB: BM² = OB² − OM² = 61² − 11² = 3721 − 121 = 3600.\nBM = √3600 = 60 cm.\nAB = 2 × BM = 2 × 60 = 120 cm.\nAangesien OM die loodlyn vanaf die middelpunt na die koord is, is ∠OMB = 90° ✓ (Moenie vergeet om BM te verdubbel om AB te kry nie, en OM ⊥ AB gee altyd ʼn regte hoek, nie ʼn reguithoek nie.)', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="62.06" y2="165" stroke="#0f1f3d" stroke-width="2.5"/><line x1="62.06" y1="165" x2="217.94" y2="165" stroke="#ea580c" stroke-width="2.5"/><line x1="140" y1="120" x2="140" y2="165" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 140,156 L 131,156 L 131,165" fill="none" stroke="#0f1f3d" stroke-width="1.8"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><circle cx="62.06" cy="165" r="2.5" fill="#0f1f3d"/><text x="44.06" y="171" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="217.94" cy="165" r="2.5" fill="#0f1f3d"/><text x="225.94" y="171" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="140" cy="165" r="2.5" fill="#0f1f3d"/><text x="146" y="157" font-size="13" fill="#0f1f3d" font-weight="700">M</text><text x="83.03" y="128.64" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">r = 61 cm</text><text x="140" y="191" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text><text x="154" y="146.5" font-size="12" fill="#2563eb" font-weight="700" text-anchor="start">OM = 11 cm</text></svg>' },

        // Blok 3 — Hoek by middelpunt = 2 × hoek by omtrek (Easy/Easy/Medium/Hard)
        { difficulty: 'Easy', question: 'In die sirkel getoon met middelpunt O, onderspan koord AB ∠AOB = 100° by die middelpunt, en ∠ACB by punt C op die omtrek (hoofboog, dieselfde kant as O). Bepaal ∠ACB.', checkMode: 'auto', options: ['50°', '100°', '200°', '130°'], correctIndex: 0, explanation: 'Die hoek by die middelpunt is dubbel die hoek by die omtrek.\n∠ACB = 100° ÷ 2 = 50° ✓ (Die hoek by die omtrek is die helfte van die hoek by die middelpunt — nie gelyk daaraan nie, nie dubbel nie, en nie die reflekshoek-geval nie.)', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="71.06" y2="177.85" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="208.94" y2="177.85" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 121.61,135.43 A 24,24 0 0 0 158.39,135.43" fill="none" stroke="#dc2626" stroke-width="2"/><line x1="71.06" y1="177.85" x2="140" y2="30" stroke="#ea580c" stroke-width="2.5"/><line x1="208.94" y1="177.85" x2="140" y2="30" stroke="#ea580c" stroke-width="2.5"/><path d="M 133.66,43.59 A 15,15 0 0 0 146.34,43.59" fill="none" stroke="#16a34a" stroke-width="2"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><circle cx="71.06" cy="177.85" r="2.5" fill="#0f1f3d"/><text x="51.06" y="185.85" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="208.94" cy="177.85" r="2.5" fill="#0f1f3d"/><text x="218.94" y="185.85" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="140" cy="30" r="2.5" fill="#0f1f3d"/><text x="134" y="18" font-size="13" fill="#0f1f3d" font-weight="700">C</text><text x="140" y="160" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">100°</text><text x="140" y="60" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },
        { difficulty: 'Easy', question: 'In die sirkel getoon met middelpunt O, onderspan koord PQ ∠PRQ = 55° by punt R op die omtrek. Bepaal die grootte van ∠POQ by die middelpunt.', checkMode: 'auto', options: ['55°', '110°', '27,5°', '250°'], correctIndex: 1, explanation: 'Die hoek by die middelpunt is dubbel die hoek by die omtrek.\n∠POQ = 2 × 55° = 110° ✓ (Die hoek by die middelpunt is dubbel die hoek by die omtrek — moet dit nie gelyk laat, halveer, of met die reflekshoek verwar nie.)', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="66.28" y2="171.62" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="213.72" y2="171.62" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 120.34,133.77 A 24,24 0 0 0 159.66,133.77" fill="none" stroke="#dc2626" stroke-width="2"/><line x1="66.28" y1="171.62" x2="140" y2="30" stroke="#ea580c" stroke-width="2.5"/><line x1="213.72" y1="171.62" x2="140" y2="30" stroke="#ea580c" stroke-width="2.5"/><path d="M 133.07,43.31 A 15,15 0 0 0 146.93,43.31" fill="none" stroke="#16a34a" stroke-width="2"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><circle cx="66.28" cy="171.62" r="2.5" fill="#0f1f3d"/><text x="46.28" y="179.62" font-size="13" fill="#0f1f3d" font-weight="700">P</text><circle cx="213.72" cy="171.62" r="2.5" fill="#0f1f3d"/><text x="223.72" y="179.62" font-size="13" fill="#0f1f3d" font-weight="700">Q</text><circle cx="140" cy="30" r="2.5" fill="#0f1f3d"/><text x="134" y="18" font-size="13" fill="#0f1f3d" font-weight="700">R</text><text x="140" y="160" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text><text x="140" y="60" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">55°</text></svg>' },
        { difficulty: 'Medium', question: 'In die sirkel getoon met middelpunt O, onderspan koord AB ∠AOB = 120° by die middelpunt (gemeet aan die hoofboog-kant). Punt D lê op die omtrek op die hoofboog, aan dieselfde kant as O. Bepaal ∠ADB.', checkMode: 'auto', options: ['120°', '240°', '60°', '90°'], correctIndex: 2, explanation: 'D is op die hoofboog, dieselfde kant as die gegewe 120°-hoek.\n∠ADB = 120° ÷ 2 = 60° ✓ (Dieselfde reël as voorheen: die hoek by die omtrek is presies die helfte van die hoek by die middelpunt, aangesien D op die hoofboog is — dit is nie die hoek-in-\'n-halfsirkel-geval nie.)', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="62.06" y2="165" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="217.94" y2="165" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 119.22,132 A 24,24 0 0 0 160.78,132" fill="none" stroke="#dc2626" stroke-width="2"/><line x1="62.06" y1="165" x2="140" y2="30" stroke="#ea580c" stroke-width="2.5"/><line x1="217.94" y1="165" x2="140" y2="30" stroke="#ea580c" stroke-width="2.5"/><path d="M 132.5,42.99 A 15,15 0 0 0 147.5,42.99" fill="none" stroke="#16a34a" stroke-width="2"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><circle cx="62.06" cy="165" r="2.5" fill="#0f1f3d"/><text x="42.06" y="173" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="217.94" cy="165" r="2.5" fill="#0f1f3d"/><text x="227.94" y="173" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="140" cy="30" r="2.5" fill="#0f1f3d"/><text x="134" y="18" font-size="13" fill="#0f1f3d" font-weight="700">D</text><text x="140" y="160" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">120°</text><text x="140" y="60" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },
        { difficulty: 'Hard', question: 'In die sirkel getoon met middelpunt O, onderspan koord AB ʼn hoek van 160° by die middelpunt aan die hoofboog-kant. Punt E lê op die klein boog. Bepaal die reflekshoek AOB, en bepaal dan ∠AEB.', checkMode: 'auto', options: ['Reflekshoek AOB = 200°, ∠AEB = 80°', 'Reflekshoek AOB = 160°, ∠AEB = 80°', 'Reflekshoek AOB = 200°, ∠AEB = 200°', 'Reflekshoek AOB = 200°, ∠AEB = 100°'], correctIndex: 3, explanation: 'Reflekshoek AOB = 360° − 160° = 200°.\nE is op die klein boog, dus gebruik die reflekshoek: ∠AEB = 200° ÷ 2 = 100° ✓ (Aangesien E op die klein boog lê, moet jy die reflekshoek halveer, nie die oorspronklike gegewe hoek nie — en jy moet eers die reflekshoek bereken.)', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="51.37" y2="135.63" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="228.63" y2="135.63" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 116.36,124.17 A 24,24 0 0 0 163.64,124.17" fill="none" stroke="#dc2626" stroke-width="2"/><line x1="51.37" y1="135.63" x2="140" y2="210" stroke="#16a34a" stroke-width="2.5"/><line x1="228.63" y1="135.63" x2="140" y2="210" stroke="#16a34a" stroke-width="2.5"/><path d="M 128.51,200.36 A 15,15 0 0 1 151.49,200.36" fill="none" stroke="#16a34a" stroke-width="2"/><path d="M 108.49,125.56 A 32,32 0 1 1 171.51,125.56" fill="none" stroke="#dc2626" stroke-width="2" stroke-dasharray="4,3"/><circle cx="140" cy="210" r="2.5" fill="#0f1f3d"/><text x="134" y="230" font-size="13" fill="#0f1f3d" font-weight="700">E</text><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><circle cx="51.37" cy="135.63" r="2.5" fill="#0f1f3d"/><text x="31.37" y="143.63" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="228.63" cy="135.63" r="2.5" fill="#0f1f3d"/><text x="238.63" y="143.63" font-size="13" fill="#0f1f3d" font-weight="700">B</text><text x="140" y="160" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">160°</text><text x="140" y="180" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },

        // Blok 4 — Hoeke in dieselfde segment / gelyke koorde (Easy/Easy/Medium/Hard)
        { difficulty: 'Easy', question: 'In die sirkel getoon lê punte C en D op dieselfde boog relatief tot koord AB (dieselfde kant van AB). ∠ACB = 61°. Bepaal ∠ADB.', checkMode: 'auto', options: ['61°', '119°', '30,5°', '122°'], correctIndex: 0, explanation: 'C en D lê op dieselfde segment relatief tot koord AB, dus is hoeke in dieselfde segment gelyk.\n∠ADB = ∠ACB = 61° ✓ (Hoeke in dieselfde segment is bloot gelyk — moenie die middelpunt-hoek-reël of die sikliese-vierhoek-supplementêre-reël hier toepas nie.)', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="61.28" y1="163.63" x2="218.72" y2="163.63" stroke="#ea580c" stroke-width="2.5"/><line x1="61.28" y1="163.63" x2="185" y2="42.06" stroke="#0f1f3d" stroke-width="2.5"/><line x1="218.72" y1="163.63" x2="185" y2="42.06" stroke="#0f1f3d" stroke-width="2.5"/><line x1="61.28" y1="163.63" x2="109.22" y2="35.43" stroke="#0f1f3d" stroke-width="2.5"/><line x1="218.72" y1="163.63" x2="109.22" y2="35.43" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 175.01,51.87 A 14,14 0 0 0 188.74,55.55" fill="none" stroke="#16a34a" stroke-width="2"/><path d="M 172.16,54.68 A 18,18 0 0 0 189.81,59.41" fill="none" stroke="#16a34a" stroke-width="2"/><path d="M 104.32,48.54 A 14,14 0 0 0 118.31,46.08" fill="none" stroke="#16a34a" stroke-width="2"/><path d="M 102.92,52.29 A 18,18 0 0 0 120.91,49.12" fill="none" stroke="#16a34a" stroke-width="2"/><circle cx="61.28" cy="163.63" r="2.5" fill="#0f1f3d"/><text x="41.28" y="171.63" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="218.72" cy="163.63" r="2.5" fill="#0f1f3d"/><text x="228.72" y="171.63" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="185" cy="42.06" r="2.5" fill="#0f1f3d"/><text x="193" y="36.06" font-size="13" fill="#0f1f3d" font-weight="700">C</text><circle cx="109.22" cy="35.43" r="2.5" fill="#0f1f3d"/><text x="103.22" y="23.43" font-size="13" fill="#0f1f3d" font-weight="700">D</text><text x="176.72" y="72.97" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">61°</text><text x="123.12" y="62.91" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },
        { difficulty: 'Easy', question: 'In die sirkel getoon is koord PQ = koord RS. Koord PQ onderspan ʼn hoek van 55° by die middelpunt. Bepaal die hoek wat koord RS by die middelpunt onderspan.', checkMode: 'auto', options: ['27,5°', '55°', '110°', '125°'], correctIndex: 1, explanation: 'Gelyke koorde onderspan gelyke hoeke by die middelpunt.\nRS onderspan dieselfde hoek as PQ: 55° ✓ (Gelyke koorde onderspan gelyke hoeke by die middelpunt — geen verdubbeling, halvering of supplementêre-hoek-reël is van toepassing nie.)', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="55.43" y1="89.22" x2="116.71" y2="33.07" stroke="#ea580c" stroke-width="2.5"/><line x1="217.94" y1="165" x2="147.84" y2="209.66" stroke="#7c3aed" stroke-width="2.5"/><line x1="89.44" y1="64.83" x2="82.69" y2="57.46" stroke="#ea580c" stroke-width="2"/><line x1="180.21" y1="183.11" x2="185.58" y2="191.55" stroke="#7c3aed" stroke-width="2"/><line x1="140" y1="120" x2="55.43" y2="89.22" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="116.71" y2="33.07" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="217.94" y2="165" stroke="#0f1f3d" stroke-width="2.5" stroke-dasharray="4,3"/><line x1="140" y1="120" x2="147.84" y2="209.66" stroke="#0f1f3d" stroke-width="2.5" stroke-dasharray="4,3"/><path d="M 121.21,113.16 A 20,20 0 0 1 134.82,100.68" fill="none" stroke="#dc2626" stroke-width="2"/><path d="M 165.98,135 A 30,30 0 0 1 142.61,149.89" fill="none" stroke="#7c3aed" stroke-width="2"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><text x="120.5" y="92.15" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">55°</text><text x="158.6" y="159.88" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text><circle cx="55.43" cy="89.22" r="2.5" fill="#0f1f3d"/><text x="35.43" y="93.22" font-size="13" fill="#0f1f3d" font-weight="700">P</text><circle cx="116.71" cy="33.07" r="2.5" fill="#0f1f3d"/><text x="96.71" y="27.07" font-size="13" fill="#0f1f3d" font-weight="700">Q</text><circle cx="217.94" cy="165" r="2.5" fill="#0f1f3d"/><text x="227.94" y="167" font-size="13" fill="#0f1f3d" font-weight="700">R</text><circle cx="147.84" cy="209.66" r="2.5" fill="#0f1f3d"/><text x="153.84" y="225.66" font-size="13" fill="#0f1f3d" font-weight="700">S</text></svg>' },
        { difficulty: 'Medium', question: 'In die sirkel getoon is koord MN = koord XY in dieselfde sirkel. MN onderspan ʼn hoek van 42° by die omtrek. Bepaal die hoek wat XY by die omtrek onderspan.', checkMode: 'auto', options: ['21°', '84°', '42°', '138°'], correctIndex: 2, explanation: 'Gelyke koorde onderspan gelyke hoeke by die omtrek.\nXY onderspan dieselfde hoek as MN: 42° ✓ (Gelyke koorde onderspan gelyke hoeke by die omtrek — geen verdubbeling, halvering of supplementêre-hoek-reël is van toepassing nie.)', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="71.06" y1="177.85" x2="75.26" y2="57.48" stroke="#ea580c" stroke-width="2.5"/><line x1="224.57" y1="150.78" x2="118.23" y2="207.33" stroke="#7c3aed" stroke-width="2.5"/><line x1="78.15" y1="117.84" x2="68.16" y2="117.49" stroke="#ea580c" stroke-width="2"/><line x1="169.05" y1="174.64" x2="173.75" y2="183.47" stroke="#7c3aed" stroke-width="2"/><line x1="71.06" y1="177.85" x2="224.57" y2="89.22" stroke="#0f1f3d" stroke-width="2.5"/><line x1="75.26" y1="57.48" x2="224.57" y2="89.22" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 211.58,96.72 A 15,15 0 0 1 209.9,86.1" fill="none" stroke="#16a34a" stroke-width="2"/><circle cx="224.57" cy="89.22" r="2.5" fill="#0f1f3d"/><text x="234.57" y="93.22" font-size="13" fill="#0f1f3d" font-weight="700">V</text><line x1="224.57" y1="150.78" x2="88.38" y2="46.28" stroke="#0f1f3d" stroke-width="2.5"/><line x1="118.23" y1="207.33" x2="88.38" y2="46.28" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 100.28,55.41 A 15,15 0 0 1 91.11,61.03" fill="none" stroke="#7c3aed" stroke-width="2"/><circle cx="88.38" cy="46.28" r="2.5" fill="#0f1f3d"/><text x="80.38" y="36.28" font-size="13" fill="#0f1f3d" font-weight="700">W</text><text x="195.59" y="96.98" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">42°</text><text x="109.08" y="73.25" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text><circle cx="71.06" cy="177.85" r="2.5" fill="#0f1f3d"/><text x="51.06" y="181.85" font-size="13" fill="#0f1f3d" font-weight="700">M</text><circle cx="75.26" cy="57.48" r="2.5" fill="#0f1f3d"/><text x="55.26" y="51.48" font-size="13" fill="#0f1f3d" font-weight="700">N</text><circle cx="224.57" cy="150.78" r="2.5" fill="#0f1f3d"/><text x="234.57" y="152.78" font-size="13" fill="#0f1f3d" font-weight="700">X</text><circle cx="118.23" cy="207.33" r="2.5" fill="#0f1f3d"/><text x="124.23" y="223.33" font-size="13" fill="#0f1f3d" font-weight="700">Y</text></svg>' },
        { difficulty: 'Hard', question: 'In die sirkel getoon met middelpunt O lê punte A, B, C en D op die omtrek, met C en D op dieselfde boog relatief tot koord AB. ∠ACB = 4x − 6° en ∠ADB = 2x + 18°. Bepaal x, en bepaal dan die grootte van ∠ACB.', checkMode: 'auto', options: ['x = 28, ∠ACB = 106°', 'x = 12, ∠ACB = 12°', 'x = 12, ∠ACB = 54°', 'x = 12, ∠ACB = 42°'], correctIndex: 3, explanation: 'Hoeke in dieselfde segment is gelyk: 4x − 6° = 2x + 18°.\n2x = 24°.\nx = 12°.\n∠ACB = 4(12°) − 6° = 48° − 6° = 42° ✓ (Pasop om die twee hoek-uitdrukkings as supplementêr in plaas van gelyk te behandel, en vervang altyd jou x-waarde terug in die uitdrukking in plaas daarvan om net x te gee.)', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="79.78" y1="186.88" x2="200.22" y2="186.88" stroke="#ea580c" stroke-width="2.5"/><line x1="79.78" y1="186.88" x2="185" y2="42.06" stroke="#0f1f3d" stroke-width="2.5"/><line x1="200.22" y1="186.88" x2="185" y2="42.06" stroke="#0f1f3d" stroke-width="2.5"/><line x1="79.78" y1="186.88" x2="109.22" y2="35.43" stroke="#0f1f3d" stroke-width="2.5"/><line x1="200.22" y1="186.88" x2="109.22" y2="35.43" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 176.77,53.39 A 14,14 0 0 0 186.46,55.98" fill="none" stroke="#16a34a" stroke-width="2"/><path d="M 174.42,56.62 A 18,18 0 0 0 186.88,59.96" fill="none" stroke="#16a34a" stroke-width="2"/><path d="M 106.55,49.17 A 14,14 0 0 0 116.43,47.43" fill="none" stroke="#16a34a" stroke-width="2"/><path d="M 105.79,53.1 A 18,18 0 0 0 118.49,50.86" fill="none" stroke="#16a34a" stroke-width="2"/><circle cx="79.78" cy="186.88" r="2.5" fill="#0f1f3d"/><text x="59.78" y="194.88" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="200.22" cy="186.88" r="2.5" fill="#0f1f3d"/><text x="210.22" y="194.88" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="185" cy="42.06" r="2.5" fill="#0f1f3d"/><text x="193" y="36.06" font-size="13" fill="#0f1f3d" font-weight="700">C</text><circle cx="109.22" cy="35.43" r="2.5" fill="#0f1f3d"/><text x="103.22" y="23.43" font-size="13" fill="#0f1f3d" font-weight="700">D</text><text x="176.72" y="72.97" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">4x − 6°</text><text x="123.12" y="62.91" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">2x + 18°</text></svg>' },

        // Blok 5 — Hoek in ʼn halfsirkel + omgekeerde (Easy/Easy/Medium/Hard)
        { difficulty: 'Easy', question: 'In die sirkel getoon is AB ʼn middellyn en P is ʼn punt op die omtrek. ∠PAB = 35°. Bepaal ∠APB, en bepaal dan ∠PBA.', checkMode: 'auto', options: ['∠APB = 90°, ∠PBA = 55°', '∠APB = 90°, ∠PBA = 35°', '∠APB = 90°, ∠PBA = 145°', '∠APB = 70°, ∠PBA = 55°'], correctIndex: 0, explanation: 'Aangesien AB ʼn middellyn is, is ∠APB = 90° (hoek in ʼn halfsirkel).\nIn driehoek APB: 35° + 90° + ∠PBA = 180°.\n∠PBA = 180° − 90° − 35° = 55° ✓ (∠APB is altyd 90° in ʼn halfsirkel — die ander hoek kom van die hoeksom van die driehoek, nie deur ∠PAB te kopieer, te vergeet om 90° af te trek, of ∠PAB te verdubbel nie.)', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="50" y1="120" x2="230" y2="120" stroke="#ea580c" stroke-width="2.5"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><line x1="50" y1="120" x2="170.78" y2="35.43" stroke="#0f1f3d" stroke-width="2.5"/><line x1="230" y1="120" x2="170.78" y2="35.43" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 162.59,41.16 L 168.33,49.35 L 176.52,43.62" fill="none" stroke="#0f1f3d" stroke-width="1.8"/><circle cx="50" cy="120" r="2.5" fill="#0f1f3d"/><text x="30" y="124" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="230" cy="120" r="2.5" fill="#0f1f3d"/><text x="238" y="124" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="170.78" cy="35.43" r="2.5" fill="#0f1f3d"/><text x="176.78" y="25.43" font-size="13" fill="#0f1f3d" font-weight="700">P</text><text x="183.8" y="71.07" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">35°</text></svg>' },
        { difficulty: 'Easy', question: 'In die sirkel getoon onderspan koord MN ʼn hoek van 90° by punt K op die omtrek. Wat kan jy oor koord MN aflei?', checkMode: 'auto', options: ['MN is ʼn raaklyn aan die sirkel', 'MN is ʼn middellyn van die sirkel', 'MN is ʼn radius van die sirkel', 'Geen gevolgtrekking oor MN kan uit hierdie inligting gemaak word nie'], correctIndex: 1, explanation: 'Volgens die omgekeerde van die hoek-in-ʼn-halfsirkel-stelling, as ʼn koord 90° by ʼn punt op die sirkel onderspan, moet daardie koord ʼn middellyn wees. Dus is MN ʼn middellyn ✓ (Die omgekeerde van die hoek-in-\'n-halfsirkel-stelling identifiseer spesifiek ʼn middellyn — nie ʼn raaklyn of ʼn radius nie.)', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="53.07" y1="96.71" x2="226.93" y2="143.29" stroke="#ea580c" stroke-width="2.5"/><line x1="53.07" y1="96.71" x2="132.16" y2="209.66" stroke="#0f1f3d" stroke-width="2.5"/><line x1="226.93" y1="143.29" x2="132.16" y2="209.66" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 126.42,201.47 L 134.61,195.73 L 140.35,203.92" fill="none" stroke="#0f1f3d" stroke-width="1.8"/><circle cx="53.07" cy="96.71" r="2.5" fill="#0f1f3d"/><text x="33.07" y="100.71" font-size="13" fill="#0f1f3d" font-weight="700">M</text><circle cx="226.93" cy="143.29" r="2.5" fill="#0f1f3d"/><text x="234.93" y="143.29" font-size="13" fill="#0f1f3d" font-weight="700">N</text><circle cx="132.16" cy="209.66" r="2.5" fill="#0f1f3d"/><text x="126.16" y="197.66" font-size="13" fill="#0f1f3d" font-weight="700">K</text><text x="136.67" y="184.06" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">90°</text></svg>' },
        { difficulty: 'Medium', question: 'In die sirkel getoon is AB ʼn middellyn met AB = 17 cm. P is ʼn punt op die omtrek met AP = 8 cm. Bepaal die grootte van ∠APB, en bepaal dan die lengte van BP.', checkMode: 'auto', options: ['∠APB = 90°, BP = 9 cm', '∠APB = 90°, BP = 19 cm', '∠APB = 90°, BP = 15 cm', '∠APB = 180°, BP = 15 cm'], correctIndex: 2, explanation: 'AB is ʼn middellyn, dus is ∠APB = 90° (hoek in ʼn halfsirkel).\nDriehoek APB is reghoekig by P, dus deur Pythagoras: BP² = AB² − AP² = 17² − 8² = 289 − 64 = 225.\nBP = √225 = 15 cm ✓ (BP moet met Pythagoras bereken word — nie deur eenvoudige aftrekking of deur onder die vierkantswortel op te tel nie — en ∠APB is 90°, nie ʼn reguithoek nie.)', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="50" y1="120" x2="230" y2="120" stroke="#ea580c" stroke-width="2.5"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><line x1="50" y1="120" x2="208.94" y2="62.15" stroke="#0f1f3d" stroke-width="2.5"/><line x1="230" y1="120" x2="208.94" y2="62.15" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 199.55,65.57 L 202.97,74.97 L 212.36,71.55" fill="none" stroke="#0f1f3d" stroke-width="1.8"/><circle cx="50" cy="120" r="2.5" fill="#0f1f3d"/><text x="30" y="124" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="230" cy="120" r="2.5" fill="#0f1f3d"/><text x="238" y="124" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="208.94" cy="62.15" r="2.5" fill="#0f1f3d"/><text x="214.94" y="52.15" font-size="13" fill="#0f1f3d" font-weight="700">P</text><text x="197.96" y="85.71" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text><text x="119.47" y="85.07" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">AP = 8 cm</text><text x="140" y="140" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">AB = 17 cm</text><text x="240.51" y="85.6" font-size="11" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },
        { difficulty: 'Hard', question: 'In die sirkel getoon met middelpunt O is AB ʼn middellyn. C en D is punte op die omtrek aan dieselfde kant van AB, met ∠CAB = 25° en ∠DBA = 25°. Bepaal ∠ACB, ∠ADB, en ∠ABC.', checkMode: 'auto', options: ['∠ACB = 90°, ∠ADB = 90°, ∠ABC = 25°', '∠ACB = 50°, ∠ADB = 50°, ∠ABC = 65°', '∠ACB = 90°, ∠ADB = 90°, ∠ABC = 155°', '∠ACB = 90°, ∠ADB = 90°, ∠ABC = 65°'], correctIndex: 3, explanation: 'AB is ʼn middellyn, dus is ∠ACB = 90° en ∠ADB = 90° (hoek in ʼn halfsirkel geld vir enige punt op die sirkel).\nIn driehoek ABC: ∠CAB = 25°, ∠ACB = 90°.\n∠ABC = 180° − 90° − 25° = 65° ✓ (∠ACB en ∠ADB is altwee 90° deur die hoek-in-\'n-halfsirkel-stelling — moenie die middelpunt-hoek-verdubbelingsreël hier toepas nie, en onthou om altwee ander hoeke van 180° in die driehoek af te trek.)', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="50" y1="120" x2="230" y2="120" stroke="#ea580c" stroke-width="2.5"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><circle cx="50" cy="120" r="2.5" fill="#0f1f3d"/><text x="30" y="124" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="230" cy="120" r="2.5" fill="#0f1f3d"/><text x="238" y="124" font-size="13" fill="#0f1f3d" font-weight="700">B</text><line x1="50" y1="120" x2="197.85" y2="51.06" stroke="#0f1f3d" stroke-width="2.5"/><line x1="230" y1="120" x2="197.85" y2="51.06" stroke="#0f1f3d" stroke-width="2.5"/><line x1="50" y1="120" x2="82.15" y2="51.06" stroke="#0f1f3d" stroke-width="2.5"/><line x1="230" y1="120" x2="82.15" y2="51.06" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 189.69,54.86 L 193.5,63.02 L 201.65,59.21" fill="none" stroke="#0f1f3d" stroke-width="1.8"/><path d="M 78.35,59.21 L 86.5,63.02 L 90.31,54.86" fill="none" stroke="#0f1f3d" stroke-width="1.8"/><circle cx="197.85" cy="51.06" r="2.5" fill="#0f1f3d"/><text x="205.85" y="43.06" font-size="13" fill="#0f1f3d" font-weight="700">C</text><circle cx="82.15" cy="51.06" r="2.5" fill="#0f1f3d"/><text x="74.15" y="41.06" font-size="13" fill="#0f1f3d" font-weight="700">D</text><text x="73.72" y="110.35" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">25°</text><text x="206.28" y="110.35" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">25°</text></svg>' },
      ],
      scoreMessages: [
        { minScore: 20, message: 'Uitstekend! Jy het sirkelterminologie en die sleutel sirkelstellings bemeester — loodlyn wat ʼn koord halveer, hoek by die middelpunt, hoeke in dieselfde segment, en die hoek in ʼn halfsirkel.' },
        { minScore: 15, message: 'Goeie werk! Hersien enige gemiste vrae oor die hoek-by-middelpunt-stelling of die halfsirkel-stelling, en probeer weer.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // Blok 1 — Sirkelterminologie (Easy/Easy/Medium/Medium)
        { difficulty: 'Easy', question: 'Wat is die naam van die lynstuk wat enige twee punte op die omtrek van ʼn sirkel verbind?', checkMode: 'auto', options: ['koord', 'snylyn', 'middellyn', 'radius'], correctIndex: 0, explanation: 'ʼn Koord is ʼn lynstuk wat enige twee punte op die omtrek verbind. (ʼn Koord is die lynstuk tussen die twee punte — die snylyn is die oneindige lyn deur hulle, en ʼn radius verbind die middelpunt, nie twee omtrekpunte nie.)' },
        { difficulty: 'Easy', question: 'Wat is die spesiale naam wat gegee word aan die gebied tussen ʼn koord en die boog wat dit afsny, wanneer dit die groter van die twee sulke gebiede is?', checkMode: 'auto', options: ['klein segment', 'hoofsegment', 'hoofboog', 'hoofsektor'], correctIndex: 1, explanation: 'Die groter gebied tussen ʼn koord en sy boog word die hoofsegment genoem (die kleiner een is die klein segment). (Moenie die hoofsegment met die klein segment, die hoofboog, of ʼn sektor verwar nie — ʼn segment word deur ʼn koord en ʼn boog begrens.)' },
        { difficulty: 'Medium', question: 'ʼn Raaklyn raak ʼn sirkel by punt T. Verduidelik die verband tussen die raaklyn en die radius OT, en gee die hoek tussen hulle.', checkMode: 'auto', options: ['parallel, 0°', 'loodreg, 45°', 'loodreg, 90°', 'kollineêr, 180°'], correctIndex: 2, explanation: 'ʼn Raaklyn is altyd loodreg op die radius wat na die raakpunt getrek word, dus is die hoek tussen hulle 90°. (ʼn Raaklyn is loodreg — nooit parallel of kollineêr nie — op die radius by die raakpunt, en die hoek is altyd presies 90°.)' },
        { difficulty: 'Medium', question: 'Wat noem ons al die radiusse wat in dieselfde sirkel getrek word, in terme van hulle lengtes?', checkMode: 'auto', options: ['altyd verskillend', 'slegs gelyk as die koorde waarop hulle betrekking het, gelyk is', 'twee keer die middellyn', 'gelyk'], correctIndex: 3, explanation: 'Al die radiusse van dieselfde sirkel is ewe lank, aangesien elkeen die afstand van die middelpunt na die omtrek is. (Elke radius is bloot die afstand vanaf die middelpunt na die omtrek, dus is alle radiusse in dieselfde sirkel gelyk — dit het niks met enige koorde te doen nie, en ʼn radius is die helfte, nie twee keer nie, van die middellyn.)' },

        // Blok 2 — Loodlyn vanaf middelpunt halveer koord (Easy/Easy/Medium/Hard)
        { difficulty: 'Easy', question: 'In die sirkel getoon met middelpunt O, word OM loodreg op koord AB getrek, waar AB = 14 cm en die radius OA = 25 cm. Bepaal die lengte van OM.', checkMode: 'auto', options: ['24 cm', '7 cm', '14 cm', '25 cm'], correctIndex: 0, explanation: 'Aangesien OM ⊥ AB, halveer OM die koord: AM = 14 ÷ 2 = 7 cm.\nIn reghoekige driehoek OMA: OM² = OA² − AM² = 25² − 7² = 625 − 49 = 576.\nOM = √576 = 24 cm ✓ (Die ander opsies verwar die half-koord AM of die volle koord AB met OM, of gee die radius self in plaas daarvan om Pythagoras toe te pas.)', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="88.38" y2="193.72" stroke="#0f1f3d" stroke-width="2.5"/><line x1="88.38" y1="193.72" x2="191.62" y2="193.72" stroke="#ea580c" stroke-width="2.5"/><line x1="140" y1="120" x2="140" y2="193.72" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 140,184.72 L 131,184.72 L 131,193.72" fill="none" stroke="#0f1f3d" stroke-width="1.8"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><circle cx="88.38" cy="193.72" r="2.5" fill="#0f1f3d"/><text x="70.38" y="199.72" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="191.62" cy="193.72" r="2.5" fill="#0f1f3d"/><text x="199.62" y="199.72" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="140" cy="193.72" r="2.5" fill="#0f1f3d"/><text x="146" y="185.72" font-size="13" fill="#0f1f3d" font-weight="700">M</text><text x="91.08" y="147.68" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">OA = 25 cm</text><text x="140" y="219.72" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">AB = 14 cm</text><text x="154" y="160.86" font-size="12" fill="#ea580c" font-weight="700" text-anchor="start">?</text></svg>' },
        { difficulty: 'Easy', question: 'In die sirkel getoon met middelpunt O en radius 29 cm, is OM loodreg op koord AB en OM = 20 cm. Bepaal die lengte van koord AB.', checkMode: 'auto', options: ['21 cm', '42 cm', '20 cm', '29 cm'], correctIndex: 1, explanation: 'In reghoekige driehoek OMA: AM² = OA² − OM² = 29² − 20² = 841 − 400 = 441.\nAM = √441 = 21 cm.\nAangesien OM die koord halveer, is AB = 2 × AM = 2 × 21 = 42 cm ✓ (Die ander opsies gee die half-koord AM, verwar OM met die koord, of gee die radius in plaas van die volle koord AB.)', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="71.06" y2="177.85" stroke="#0f1f3d" stroke-width="2.5"/><line x1="71.06" y1="177.85" x2="208.94" y2="177.85" stroke="#ea580c" stroke-width="2.5"/><line x1="140" y1="120" x2="140" y2="177.85" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 140,168.85 L 131,168.85 L 131,177.85" fill="none" stroke="#0f1f3d" stroke-width="1.8"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><circle cx="71.06" cy="177.85" r="2.5" fill="#0f1f3d"/><text x="53.06" y="183.85" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="208.94" cy="177.85" r="2.5" fill="#0f1f3d"/><text x="216.94" y="183.85" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="140" cy="177.85" r="2.5" fill="#0f1f3d"/><text x="146" y="169.85" font-size="13" fill="#0f1f3d" font-weight="700">M</text><text x="85.24" y="136.67" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">OA = 29 cm</text><text x="140" y="203.85" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text><text x="154" y="152.93" font-size="12" fill="#2563eb" font-weight="700" text-anchor="start">OM = 20 cm</text></svg>' },
        { difficulty: 'Medium', question: 'In die sirkel getoon met middelpunt O en radius 37 cm, is koord AB = 70 cm. OM word vanaf die middelpunt loodreg op AB getrek. Bepaal die lengte van OM.', checkMode: 'auto', options: ['35 cm', '70 cm', '12 cm', '37 cm'], correctIndex: 2, explanation: 'Aangesien OM ⊥ AB, halveer OM die koord: AM = 70 ÷ 2 = 35 cm.\nIn reghoekige driehoek OMA: OM² = OA² − AM² = 37² − 35² = 1369 − 1225 = 144.\nOM = √144 = 12 cm ✓ (Dieselfde idee as voorheen — moenie die half-koord of volle koord met OM verwar nie, en onthou Pythagoras is nodig, nie net die radius nie.)', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="82.15" y2="188.94" stroke="#0f1f3d" stroke-width="2.5"/><line x1="82.15" y1="188.94" x2="197.85" y2="188.94" stroke="#ea580c" stroke-width="2.5"/><line x1="140" y1="120" x2="140" y2="188.94" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 140,179.94 L 131,179.94 L 131,188.94" fill="none" stroke="#0f1f3d" stroke-width="1.8"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><circle cx="82.15" cy="188.94" r="2.5" fill="#0f1f3d"/><text x="64.15" y="194.94" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="197.85" cy="188.94" r="2.5" fill="#0f1f3d"/><text x="205.85" y="194.94" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="140" cy="188.94" r="2.5" fill="#0f1f3d"/><text x="146" y="180.94" font-size="13" fill="#0f1f3d" font-weight="700">M</text><text x="88.82" y="144.19" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">OA = 37 cm</text><text x="140" y="214.94" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">AB = 70 cm</text><text x="154" y="158.47" font-size="12" fill="#ea580c" font-weight="700" text-anchor="start">?</text></svg>' },
        { difficulty: 'Hard', question: 'In die sirkel getoon met middelpunt O en radius 53 cm, is M die middelpunt van koord AB, met OM = 28 cm. Bepaal die lengte van AB, en gee dan die grootte van hoek OMA.', checkMode: 'auto', options: ['AB = 45 cm, ∠OMA = 90°', 'AB = 90 cm, ∠OMA = 180°', 'AB = 106 cm, ∠OMA = 90°', 'AB = 90 cm, ∠OMA = 90°'], correctIndex: 3, explanation: 'In reghoekige driehoek OMA: AM² = OA² − OM² = 53² − 28² = 2809 − 784 = 2025.\nAM = √2025 = 45 cm.\nAB = 2 × AM = 2 × 45 = 90 cm.\nAangesien OM die loodlyn vanaf die middelpunt na die koord is, is ∠OMA = 90° ✓ (Moenie vergeet om AM te verdubbel om AB te kry nie, en OM ⊥ AB gee altyd ʼn regte hoek, nie ʼn reguithoek nie.)', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="62.06" y2="165" stroke="#0f1f3d" stroke-width="2.5"/><line x1="62.06" y1="165" x2="217.94" y2="165" stroke="#ea580c" stroke-width="2.5"/><line x1="140" y1="120" x2="140" y2="165" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 140,156 L 131,156 L 131,165" fill="none" stroke="#0f1f3d" stroke-width="1.8"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><circle cx="62.06" cy="165" r="2.5" fill="#0f1f3d"/><text x="44.06" y="171" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="217.94" cy="165" r="2.5" fill="#0f1f3d"/><text x="225.94" y="171" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="140" cy="165" r="2.5" fill="#0f1f3d"/><text x="146" y="157" font-size="13" fill="#0f1f3d" font-weight="700">M</text><text x="83.03" y="128.64" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">OA = 53 cm</text><text x="140" y="191" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text><text x="154" y="146.5" font-size="12" fill="#2563eb" font-weight="700" text-anchor="start">OM = 28 cm</text></svg>' },

        // Blok 3 — Hoek by middelpunt = 2 × hoek by omtrek (Easy/Easy/Medium/Hard)
        { difficulty: 'Easy', question: 'In die sirkel getoon met middelpunt O, onderspan koord AB ∠AOB = 160° by die middelpunt, en ∠ACB by punt C op die omtrek (hoofboog, dieselfde kant as O). Bepaal ∠ACB.', checkMode: 'auto', options: ['80°', '160°', '320°', '100°'], correctIndex: 0, explanation: 'Die hoek by die middelpunt is dubbel die hoek by die omtrek.\n∠ACB = 160° ÷ 2 = 80° ✓ (Die hoek by die omtrek is die helfte van die hoek by die middelpunt — nie gelyk daaraan nie, nie dubbel nie, en nie die reflekshoek-geval nie.)', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="51.37" y2="135.63" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="228.63" y2="135.63" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 116.36,124.17 A 24,24 0 0 0 163.64,124.17" fill="none" stroke="#dc2626" stroke-width="2"/><line x1="51.37" y1="135.63" x2="140" y2="30" stroke="#ea580c" stroke-width="2.5"/><line x1="228.63" y1="135.63" x2="140" y2="30" stroke="#ea580c" stroke-width="2.5"/><path d="M 130.36,41.49 A 15,15 0 0 0 149.64,41.49" fill="none" stroke="#16a34a" stroke-width="2"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><circle cx="51.37" cy="135.63" r="2.5" fill="#0f1f3d"/><text x="31.37" y="143.63" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="228.63" cy="135.63" r="2.5" fill="#0f1f3d"/><text x="238.63" y="143.63" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="140" cy="30" r="2.5" fill="#0f1f3d"/><text x="134" y="18" font-size="13" fill="#0f1f3d" font-weight="700">C</text><text x="140" y="160" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">160°</text><text x="140" y="60" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },
        { difficulty: 'Easy', question: 'In die sirkel getoon met middelpunt O, onderspan koord PQ ∠PRQ = 65° by punt R op die omtrek. Bepaal die grootte van ∠POQ by die middelpunt.', checkMode: 'auto', options: ['65°', '130°', '32,5°', '230°'], correctIndex: 1, explanation: 'Die hoek by die middelpunt is dubbel die hoek by die omtrek.\n∠POQ = 2 × 65° = 130° ✓ (Die hoek by die middelpunt is dubbel die hoek by die omtrek — moet dit nie gelyk laat, halveer, of met die reflekshoek verwar nie.)', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="58.43" y2="158.04" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="221.57" y2="158.04" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 118.25,130.14 A 24,24 0 0 0 161.75,130.14" fill="none" stroke="#dc2626" stroke-width="2"/><line x1="58.43" y1="158.04" x2="140" y2="30" stroke="#ea580c" stroke-width="2.5"/><line x1="221.57" y1="158.04" x2="140" y2="30" stroke="#ea580c" stroke-width="2.5"/><path d="M 131.94,42.65 A 15,15 0 0 0 148.06,42.65" fill="none" stroke="#16a34a" stroke-width="2"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><circle cx="58.43" cy="158.04" r="2.5" fill="#0f1f3d"/><text x="38.43" y="166.04" font-size="13" fill="#0f1f3d" font-weight="700">P</text><circle cx="221.57" cy="158.04" r="2.5" fill="#0f1f3d"/><text x="231.57" y="166.04" font-size="13" fill="#0f1f3d" font-weight="700">Q</text><circle cx="140" cy="30" r="2.5" fill="#0f1f3d"/><text x="134" y="18" font-size="13" fill="#0f1f3d" font-weight="700">R</text><text x="140" y="160" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text><text x="140" y="60" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">65°</text></svg>' },
        { difficulty: 'Medium', question: 'In die sirkel getoon met middelpunt O, onderspan koord AB ∠AOB = 96° by die middelpunt (gemeet aan die hoofboog-kant). Punt D lê op die omtrek op die hoofboog, aan dieselfde kant as O. Bepaal ∠ADB.', checkMode: 'auto', options: ['96°', '192°', '48°', '132°'], correctIndex: 2, explanation: 'D is op die hoofboog, dieselfde kant as die gegewe 96°-hoek.\n∠ADB = 96° ÷ 2 = 48° ✓ (Dieselfde reël as voorheen: die hoek by die omtrek is presies die helfte van die hoek by die middelpunt, aangesien D op die hoofboog is.)', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="73.12" y2="180.22" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="206.88" y2="180.22" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 122.16,136.06 A 24,24 0 0 0 157.84,136.06" fill="none" stroke="#dc2626" stroke-width="2"/><line x1="73.12" y1="180.22" x2="140" y2="30" stroke="#ea580c" stroke-width="2.5"/><line x1="206.88" y1="180.22" x2="140" y2="30" stroke="#ea580c" stroke-width="2.5"/><path d="M 133.9,43.7 A 15,15 0 0 0 146.1,43.7" fill="none" stroke="#16a34a" stroke-width="2"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><circle cx="73.12" cy="180.22" r="2.5" fill="#0f1f3d"/><text x="53.12" y="188.22" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="206.88" cy="180.22" r="2.5" fill="#0f1f3d"/><text x="216.88" y="188.22" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="140" cy="30" r="2.5" fill="#0f1f3d"/><text x="134" y="18" font-size="13" fill="#0f1f3d" font-weight="700">D</text><text x="140" y="160" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">96°</text><text x="140" y="60" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },
        { difficulty: 'Hard', question: 'In die sirkel getoon met middelpunt O, onderspan koord AB ʼn hoek van 100° by die middelpunt aan die hoofboog-kant. Punt E lê op die klein boog. Bepaal die reflekshoek AOB, en bepaal dan ∠AEB.', checkMode: 'auto', options: ['Reflekshoek AOB = 260°, ∠AEB = 50°', 'Reflekshoek AOB = 100°, ∠AEB = 50°', 'Reflekshoek AOB = 260°, ∠AEB = 260°', 'Reflekshoek AOB = 260°, ∠AEB = 130°'], correctIndex: 3, explanation: 'Reflekshoek AOB = 360° − 100° = 260°.\nE is op die klein boog, dus gebruik die reflekshoek: ∠AEB = 260° ÷ 2 = 130° ✓ (Aangesien E op die klein boog lê, moet jy die reflekshoek halveer, nie die oorspronklike gegewe hoek nie — en jy moet eers die reflekshoek bereken.)', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="71.06" y2="177.85" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="208.94" y2="177.85" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 121.61,135.43 A 24,24 0 0 0 158.39,135.43" fill="none" stroke="#dc2626" stroke-width="2"/><line x1="71.06" y1="177.85" x2="140" y2="210" stroke="#16a34a" stroke-width="2.5"/><line x1="208.94" y1="177.85" x2="140" y2="210" stroke="#16a34a" stroke-width="2.5"/><path d="M 126.41,203.66 A 15,15 0 0 1 153.59,203.66" fill="none" stroke="#16a34a" stroke-width="2"/><path d="M 115.49,140.57 A 32,32 0 1 1 164.51,140.57" fill="none" stroke="#dc2626" stroke-width="2" stroke-dasharray="4,3"/><circle cx="140" cy="210" r="2.5" fill="#0f1f3d"/><text x="134" y="230" font-size="13" fill="#0f1f3d" font-weight="700">E</text><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><circle cx="71.06" cy="177.85" r="2.5" fill="#0f1f3d"/><text x="51.06" y="185.85" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="208.94" cy="177.85" r="2.5" fill="#0f1f3d"/><text x="218.94" y="185.85" font-size="13" fill="#0f1f3d" font-weight="700">B</text><text x="140" y="160" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">100°</text><text x="140" y="180" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },

        // Blok 4 — Hoeke in dieselfde segment / gelyke koorde (Easy/Easy/Medium/Hard)
        { difficulty: 'Easy', question: 'In die sirkel getoon lê punte C en D op dieselfde boog relatief tot koord AB (dieselfde kant van AB). ∠ACB = 39°. Bepaal ∠ADB.', checkMode: 'auto', options: ['39°', '141°', '19,5°', '78°'], correctIndex: 0, explanation: 'C en D lê op dieselfde segment relatief tot koord AB, dus is hoeke in dieselfde segment gelyk.\n∠ADB = ∠ACB = 39° ✓ (Hoeke in dieselfde segment is bloot gelyk — moenie die middelpunt-hoek-reël of die sikliese-vierhoek-supplementêre-reël hier toepas nie.)', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="83.36" y1="189.94" x2="196.64" y2="189.94" stroke="#ea580c" stroke-width="2.5"/><line x1="83.36" y1="189.94" x2="185" y2="42.06" stroke="#0f1f3d" stroke-width="2.5"/><line x1="196.64" y1="189.94" x2="185" y2="42.06" stroke="#0f1f3d" stroke-width="2.5"/><line x1="83.36" y1="189.94" x2="109.22" y2="35.43" stroke="#0f1f3d" stroke-width="2.5"/><line x1="196.64" y1="189.94" x2="109.22" y2="35.43" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 177.07,53.6 A 14,14 0 0 0 186.1,56.02" fill="none" stroke="#16a34a" stroke-width="2"/><path d="M 174.8,56.89 A 18,18 0 0 0 186.41,60" fill="none" stroke="#16a34a" stroke-width="2"/><path d="M 106.91,49.24 A 14,14 0 0 0 116.11,47.61" fill="none" stroke="#16a34a" stroke-width="2"/><path d="M 106.25,53.18 A 18,18 0 0 0 118.08,51.1" fill="none" stroke="#16a34a" stroke-width="2"/><circle cx="83.36" cy="189.94" r="2.5" fill="#0f1f3d"/><text x="63.36" y="197.94" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="196.64" cy="189.94" r="2.5" fill="#0f1f3d"/><text x="206.64" y="197.94" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="185" cy="42.06" r="2.5" fill="#0f1f3d"/><text x="193" y="36.06" font-size="13" fill="#0f1f3d" font-weight="700">C</text><circle cx="109.22" cy="35.43" r="2.5" fill="#0f1f3d"/><text x="103.22" y="23.43" font-size="13" fill="#0f1f3d" font-weight="700">D</text><text x="176.72" y="72.97" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">39°</text><text x="123.12" y="62.91" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },
        { difficulty: 'Easy', question: 'In die sirkel getoon is koord PQ = koord RS. Koord PQ onderspan ʼn hoek van 82° by die middelpunt. Bepaal die hoek wat koord RS by die middelpunt onderspan.', checkMode: 'auto', options: ['41°', '82°', '164°', '98°'], correctIndex: 1, explanation: 'Gelyke koorde onderspan gelyke hoeke by die middelpunt.\nRS onderspan dieselfde hoek as PQ: 82° ✓ (Gelyke koorde onderspan gelyke hoeke by die middelpunt — geen verdubbeling, halvering of supplementêre-hoek-reël is van toepassing nie.)', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="55.43" y1="89.22" x2="158.71" y2="31.97" stroke="#ea580c" stroke-width="2.5"/><line x1="217.94" y1="165" x2="106.28" y2="203.45" stroke="#7c3aed" stroke-width="2.5"/><line x1="109.49" y1="64.97" x2="104.65" y2="56.22" stroke="#ea580c" stroke-width="2"/><line x1="160.49" y1="179.5" x2="163.74" y2="188.95" stroke="#7c3aed" stroke-width="2"/><line x1="140" y1="120" x2="55.43" y2="89.22" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="158.71" y2="31.97" stroke="#0f1f3d" stroke-width="2.5"/><line x1="140" y1="120" x2="217.94" y2="165" stroke="#0f1f3d" stroke-width="2.5" stroke-dasharray="4,3"/><line x1="140" y1="120" x2="106.28" y2="203.45" stroke="#0f1f3d" stroke-width="2.5" stroke-dasharray="4,3"/><path d="M 121.21,113.16 A 20,20 0 0 1 144.16,100.44" fill="none" stroke="#dc2626" stroke-width="2"/><path d="M 165.98,135 A 30,30 0 0 1 128.76,147.82" fill="none" stroke="#7c3aed" stroke-width="2"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><text x="120.5" y="92.15" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">82°</text><text x="158.6" y="159.88" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text><circle cx="55.43" cy="89.22" r="2.5" fill="#0f1f3d"/><text x="35.43" y="93.22" font-size="13" fill="#0f1f3d" font-weight="700">P</text><circle cx="158.71" cy="31.97" r="2.5" fill="#0f1f3d"/><text x="138.71" y="25.97" font-size="13" fill="#0f1f3d" font-weight="700">Q</text><circle cx="217.94" cy="165" r="2.5" fill="#0f1f3d"/><text x="227.94" y="167" font-size="13" fill="#0f1f3d" font-weight="700">R</text><circle cx="106.28" cy="203.45" r="2.5" fill="#0f1f3d"/><text x="112.28" y="219.45" font-size="13" fill="#0f1f3d" font-weight="700">S</text></svg>' },
        { difficulty: 'Medium', question: 'In die sirkel getoon is koord MN = koord XY in dieselfde sirkel. MN onderspan ʼn hoek van 25° by die omtrek. Bepaal die hoek wat XY by die omtrek onderspan.', checkMode: 'auto', options: ['12,5°', '50°', '25°', '155°'], correctIndex: 2, explanation: 'Gelyke koorde onderspan gelyke hoeke by die omtrek.\nXY onderspan dieselfde hoek as MN: 25° ✓ (Gelyke koorde onderspan gelyke hoeke by die omtrek — geen verdubbeling, halvering of supplementêre-hoek-reël is van toepassing nie.)', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="71.06" y1="177.85" x2="51.37" y2="104.37" stroke="#ea580c" stroke-width="2.5"/><line x1="224.57" y1="150.78" x2="170.78" y2="204.57" stroke="#7c3aed" stroke-width="2.5"/><line x1="66.04" y1="139.82" x2="56.38" y2="142.41" stroke="#ea580c" stroke-width="2"/><line x1="194.14" y1="174.14" x2="201.21" y2="181.21" stroke="#7c3aed" stroke-width="2"/><line x1="71.06" y1="177.85" x2="224.57" y2="89.22" stroke="#0f1f3d" stroke-width="2.5"/><line x1="51.37" y1="104.37" x2="224.57" y2="89.22" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 211.58,96.72 A 15,15 0 0 1 209.63,90.53" fill="none" stroke="#16a34a" stroke-width="2"/><circle cx="224.57" cy="89.22" r="2.5" fill="#0f1f3d"/><text x="234.57" y="93.22" font-size="13" fill="#0f1f3d" font-weight="700">V</text><line x1="224.57" y1="150.78" x2="88.38" y2="46.28" stroke="#0f1f3d" stroke-width="2.5"/><line x1="170.78" y1="204.57" x2="88.38" y2="46.28" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 100.28,55.41 A 15,15 0 0 1 95.31,59.59" fill="none" stroke="#7c3aed" stroke-width="2"/><circle cx="88.38" cy="46.28" r="2.5" fill="#0f1f3d"/><text x="80.38" y="36.28" font-size="13" fill="#0f1f3d" font-weight="700">W</text><text x="195.59" y="96.98" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">25°</text><text x="109.08" y="73.25" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text><circle cx="71.06" cy="177.85" r="2.5" fill="#0f1f3d"/><text x="51.06" y="181.85" font-size="13" fill="#0f1f3d" font-weight="700">M</text><circle cx="51.37" cy="104.37" r="2.5" fill="#0f1f3d"/><text x="31.37" y="98.37" font-size="13" fill="#0f1f3d" font-weight="700">N</text><circle cx="224.57" cy="150.78" r="2.5" fill="#0f1f3d"/><text x="234.57" y="152.78" font-size="13" fill="#0f1f3d" font-weight="700">X</text><circle cx="170.78" cy="204.57" r="2.5" fill="#0f1f3d"/><text x="176.78" y="220.57" font-size="13" fill="#0f1f3d" font-weight="700">Y</text></svg>' },
        { difficulty: 'Hard', question: 'In die sirkel getoon met middelpunt O lê punte A, B, C en D op die omtrek, met C en D op dieselfde boog relatief tot koord AB. ∠ACB = 5x − 4° en ∠ADB = 3x + 10°. Bepaal x, en bepaal dan die grootte van ∠ACB.', checkMode: 'auto', options: ['x = 21,75, ∠ACB = 104,75°', 'x = 7, ∠ACB = 7°', 'x = 7, ∠ACB = 39°', 'x = 7, ∠ACB = 31°'], correctIndex: 3, explanation: 'Hoeke in dieselfde segment is gelyk: 5x − 4° = 3x + 10°.\n2x = 14°.\nx = 7°.\n∠ACB = 5(7°) − 4° = 35° − 4° = 31° ✓ (Pasop om die twee hoek-uitdrukkings as supplementêr in plaas van gelyk te behandel, en vervang altyd jou x-waarde terug in die uitdrukking in plaas daarvan om net x te gee.)', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="93.65" y1="197.15" x2="186.35" y2="197.15" stroke="#ea580c" stroke-width="2.5"/><line x1="93.65" y1="197.15" x2="185" y2="42.06" stroke="#0f1f3d" stroke-width="2.5"/><line x1="186.35" y1="197.15" x2="185" y2="42.06" stroke="#0f1f3d" stroke-width="2.5"/><line x1="93.65" y1="197.15" x2="109.22" y2="35.43" stroke="#0f1f3d" stroke-width="2.5"/><line x1="186.35" y1="197.15" x2="109.22" y2="35.43" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 177.89,54.12 A 14,14 0 0 0 185.12,56.06" fill="none" stroke="#16a34a" stroke-width="2"/><path d="M 175.86,57.57 A 18,18 0 0 0 185.16,60.06" fill="none" stroke="#16a34a" stroke-width="2"/><path d="M 107.88,49.37 A 14,14 0 0 0 115.25,48.07" fill="none" stroke="#16a34a" stroke-width="2"/><path d="M 107.49,53.35 A 18,18 0 0 0 116.97,51.68" fill="none" stroke="#16a34a" stroke-width="2"/><circle cx="93.65" cy="197.15" r="2.5" fill="#0f1f3d"/><text x="73.65" y="205.15" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="186.35" cy="197.15" r="2.5" fill="#0f1f3d"/><text x="196.35" y="205.15" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="185" cy="42.06" r="2.5" fill="#0f1f3d"/><text x="193" y="36.06" font-size="13" fill="#0f1f3d" font-weight="700">C</text><circle cx="109.22" cy="35.43" r="2.5" fill="#0f1f3d"/><text x="103.22" y="23.43" font-size="13" fill="#0f1f3d" font-weight="700">D</text><text x="176.72" y="72.97" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">5x − 4°</text><text x="123.12" y="62.91" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">3x + 10°</text></svg>' },

        // Blok 5 — Hoek in ʼn halfsirkel + omgekeerde (Easy/Easy/Medium/Hard)
        { difficulty: 'Easy', question: 'In die sirkel getoon is AB ʼn middellyn en P is ʼn punt op die omtrek. ∠PAB = 48°. Bepaal ∠APB, en bepaal dan ∠PBA.', checkMode: 'auto', options: ['∠APB = 90°, ∠PBA = 42°', '∠APB = 90°, ∠PBA = 48°', '∠APB = 90°, ∠PBA = 132°', '∠APB = 96°, ∠PBA = 42°'], correctIndex: 0, explanation: 'Aangesien AB ʼn middellyn is, is ∠APB = 90° (hoek in ʼn halfsirkel).\nIn driehoek APB: 48° + 90° + ∠PBA = 180°.\n∠PBA = 180° − 90° − 48° = 42° ✓ (∠APB is altyd 90° in ʼn halfsirkel — die ander hoek kom van die hoeksom van die driehoek, nie deur ∠PAB te kopieer, te vergeet om 90° af te trek, of ∠PAB te verdubbel nie.)', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="50" y1="120" x2="230" y2="120" stroke="#ea580c" stroke-width="2.5"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><line x1="50" y1="120" x2="130.59" y2="30.49" stroke="#0f1f3d" stroke-width="2.5"/><line x1="230" y1="120" x2="130.59" y2="30.49" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 123.9,37.92 L 131.33,44.62 L 138.02,37.18" fill="none" stroke="#0f1f3d" stroke-width="1.8"/><circle cx="50" cy="120" r="2.5" fill="#0f1f3d"/><text x="30" y="124" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="230" cy="120" r="2.5" fill="#0f1f3d"/><text x="238" y="124" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="130.59" cy="30.49" r="2.5" fill="#0f1f3d"/><text x="136.59" y="20.49" font-size="13" fill="#0f1f3d" font-weight="700">P</text><text x="183.8" y="71.07" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">48°</text></svg>' },
        { difficulty: 'Easy', question: 'In die sirkel getoon onderspan koord GH ʼn hoek van 90° by punt W op die omtrek. Wat kan jy oor koord GH aflei?', checkMode: 'auto', options: ['GH is ʼn raaklyn aan die sirkel', 'GH is ʼn middellyn van die sirkel', 'GH is ʼn radius van die sirkel', 'Geen gevolgtrekking oor GH kan uit hierdie inligting gemaak word nie'], correctIndex: 1, explanation: 'Volgens die omgekeerde van die hoek-in-ʼn-halfsirkel-stelling, as ʼn koord 90° by ʼn punt op die sirkel onderspan, moet daardie koord ʼn middellyn wees. Dus is GH ʼn middellyn ✓ (Die omgekeerde van die hoek-in-\'n-halfsirkel-stelling identifiseer spesifiek ʼn middellyn — nie ʼn raaklyn of ʼn radius nie.)', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="53.07" y1="96.71" x2="226.93" y2="143.29" stroke="#ea580c" stroke-width="2.5"/><line x1="53.07" y1="96.71" x2="132.16" y2="209.66" stroke="#0f1f3d" stroke-width="2.5"/><line x1="226.93" y1="143.29" x2="132.16" y2="209.66" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 126.42,201.47 L 134.61,195.73 L 140.35,203.92" fill="none" stroke="#0f1f3d" stroke-width="1.8"/><circle cx="53.07" cy="96.71" r="2.5" fill="#0f1f3d"/><text x="33.07" y="100.71" font-size="13" fill="#0f1f3d" font-weight="700">G</text><circle cx="226.93" cy="143.29" r="2.5" fill="#0f1f3d"/><text x="234.93" y="143.29" font-size="13" fill="#0f1f3d" font-weight="700">H</text><circle cx="132.16" cy="209.66" r="2.5" fill="#0f1f3d"/><text x="126.16" y="197.66" font-size="13" fill="#0f1f3d" font-weight="700">W</text><text x="136.67" y="184.06" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">90°</text></svg>' },
        { difficulty: 'Medium', question: 'In die sirkel getoon is AB ʼn middellyn met AB = 29 cm. P is ʼn punt op die omtrek met AP = 20 cm. Bepaal die grootte van ∠APB, en bepaal dan die lengte van BP.', checkMode: 'auto', options: ['∠APB = 90°, BP = 9 cm', '∠APB = 90°, BP = 35 cm', '∠APB = 90°, BP = 21 cm', '∠APB = 180°, BP = 21 cm'], correctIndex: 2, explanation: 'AB is ʼn middellyn, dus is ∠APB = 90° (hoek in ʼn halfsirkel).\nDriehoek APB is reghoekig by P, dus deur Pythagoras: BP² = AB² − AP² = 29² − 20² = 841 − 400 = 441.\nBP = √441 = 21 cm ✓ (BP moet met Pythagoras bereken word — nie deur eenvoudige aftrekking of deur onder die vierkantswortel op te tel nie — en ∠APB is 90°, nie ʼn reguithoek nie.)', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="50" y1="120" x2="230" y2="120" stroke="#ea580c" stroke-width="2.5"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><line x1="50" y1="120" x2="208.94" y2="62.15" stroke="#0f1f3d" stroke-width="2.5"/><line x1="230" y1="120" x2="208.94" y2="62.15" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 199.55,65.57 L 202.97,74.97 L 212.36,71.55" fill="none" stroke="#0f1f3d" stroke-width="1.8"/><circle cx="50" cy="120" r="2.5" fill="#0f1f3d"/><text x="30" y="124" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="230" cy="120" r="2.5" fill="#0f1f3d"/><text x="238" y="124" font-size="13" fill="#0f1f3d" font-weight="700">B</text><circle cx="208.94" cy="62.15" r="2.5" fill="#0f1f3d"/><text x="214.94" y="52.15" font-size="13" fill="#0f1f3d" font-weight="700">P</text><text x="197.96" y="85.71" font-size="12" fill="#ea580c" font-weight="700" text-anchor="middle">?</text><text x="119.47" y="85.07" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">AP = 20 cm</text><text x="140" y="140" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">AB = 29 cm</text><text x="240.51" y="85.6" font-size="11" fill="#ea580c" font-weight="700" text-anchor="middle">?</text></svg>' },
        { difficulty: 'Hard', question: 'In die sirkel getoon met middelpunt O is AB ʼn middellyn. C en D is punte op die omtrek aan dieselfde kant van AB, met ∠CAB = 33° en ∠DBA = 33°. Bepaal ∠ACB, ∠ADB, en ∠ABC.', checkMode: 'auto', options: ['∠ACB = 90°, ∠ADB = 90°, ∠ABC = 33°', '∠ACB = 66°, ∠ADB = 66°, ∠ABC = 57°', '∠ACB = 90°, ∠ADB = 90°, ∠ABC = 147°', '∠ACB = 90°, ∠ADB = 90°, ∠ABC = 57°'], correctIndex: 3, explanation: 'AB is ʼn middellyn, dus is ∠ACB = 90° en ∠ADB = 90° (hoek in ʼn halfsirkel geld vir enige punt op die sirkel).\nIn driehoek ABC: ∠CAB = 33°, ∠ACB = 90°.\n∠ABC = 180° − 90° − 33° = 57° ✓ (∠ACB en ∠ADB is altwee 90° deur die hoek-in-\'n-halfsirkel-stelling — moenie die middelpunt-hoek-verdubbelingsreël hier toepas nie, en onthou om altwee ander hoeke van 180° in die driehoek af te trek.)', diagramSvg: '<svg viewBox="0 0 280 240" xmlns="http://www.w3.org/2000/svg"><circle cx="140" cy="120" r="90" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="50" y1="120" x2="230" y2="120" stroke="#ea580c" stroke-width="2.5"/><circle cx="140" cy="120" r="3" fill="#0f1f3d"/><text x="146" y="114" font-size="13" fill="#0f1f3d" font-weight="700">O</text><circle cx="50" cy="120" r="2.5" fill="#0f1f3d"/><text x="30" y="124" font-size="13" fill="#0f1f3d" font-weight="700">A</text><circle cx="230" cy="120" r="2.5" fill="#0f1f3d"/><text x="238" y="124" font-size="13" fill="#0f1f3d" font-weight="700">B</text><line x1="50" y1="120" x2="176.61" y2="37.78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="230" y1="120" x2="176.61" y2="37.78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="50" y1="120" x2="103.39" y2="37.78" stroke="#0f1f3d" stroke-width="2.5"/><line x1="230" y1="120" x2="103.39" y2="37.78" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 169.06,42.68 L 173.96,50.23 L 181.51,45.33" fill="none" stroke="#0f1f3d" stroke-width="1.8"/><path d="M 98.49,45.33 L 106.04,50.23 L 110.94,42.68" fill="none" stroke="#0f1f3d" stroke-width="1.8"/><circle cx="176.61" cy="37.78" r="2.5" fill="#0f1f3d"/><text x="184.61" y="29.78" font-size="13" fill="#0f1f3d" font-weight="700">C</text><circle cx="103.39" cy="37.78" r="2.5" fill="#0f1f3d"/><text x="95.39" y="27.78" font-size="13" fill="#0f1f3d" font-weight="700">D</text><text x="73.72" y="110.35" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">33°</text><text x="206.28" y="110.35" font-size="11" fill="#2563eb" font-weight="700" text-anchor="middle">33°</text></svg>' },
      ],
      scoreMessages: [
        { minScore: 20, message: 'Uitstekend! Jy het sirkelterminologie en die sleutel sirkelstellings bemeester — loodlyn wat ʼn koord halveer, hoek by die middelpunt, hoeke in dieselfde segment, en die hoek in ʼn halfsirkel.' },
        { minScore: 15, message: 'Goeie werk! Hersien enige gemiste vrae oor die hoek-by-middelpunt-stelling of die halfsirkel-stelling, en probeer weer.' },
