  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        // Blok 7 — Riderbewyse (CAPS probleemoplossings-kognitiewe vlak)
        { difficulty: 'Hard', question: 'In driehoek ABC lê D op AB en E op AC, met AD = 4 cm, DB = 6 cm, AE = 6 cm en EC = 9 cm. Bewys dat DE ∥ BC.', answer: `Aangesien ${bl('AD/DB = 4/6 = 2/3')} en ${bl('AE/EC = 6/9 = 2/3')}, is die twee verhoudings gelyk, dus is DE ∥ BC volgens die omgekeerde van die Eweredigheidstelling.` + proofTable([
          ['AD/DB = 4/6 = 2/3', 'Gegewe lengtes'],
          ['AE/EC = 6/9 = 2/3', 'Gegewe lengtes'],
          ['AD/DB = AE/EC', 'Albei verhoudings is gelyk aan 2/3 (hierbo getoon)'],
          ['∴ DE ∥ BC', 'Omgekeerde van die Eweredigheidstelling: as ʼn lyn twee sye van ʼn driehoek in dieselfde verhouding verdeel, is dit ewewydig aan die derde sy'],
        ...
        { difficulty: 'Hard', question: 'In driehoek ABC lê D op AB en E op AC sodanig dat ∠ADE = ∠ACB (as gelyk gemerk in die diagram). AD = 6 cm, AE = 8 cm en AC = 15 cm. Bewys dat AD × AB = AE × AC, en bepaal dus AB.', answer: `Aangesien ${bl('∠A')} gemeenskaplik is aan albei driehoeke en ${gr('∠ADE = ∠ACB')} (gegewe), is △ADE ∼ △ACB volgens die HH-voorwaarde. Dus AD/AC = AE/AB, wat gee AD × AB = AE × AC = 6 × 15 = 8 × AB, dus AB = 90/8 = 11.25 cm.` + proofTable([
          ['∠DAE = ∠CAB', 'Gemeenskaplike hoek by A'],
          ['∠ADE = ∠ACB', 'Gegewe (as gelyk gemerk in die diagram)'],
          ['∴ △ADE ∼ △ACB', 'HH-gelykvormigheidsvoorwaarde (twee pare hoeke gelyk)'],
          ['AD/AC = AE/AB', 'Ooreenstemmende sye van gelykvormige driehoeke is eweredig'],
          ['AD × AB = AE × AC', 'Kruisvermenigvuldig die eweredigheid'],
          ['6 × AB = 8 × 15 = 120, dus AB = 11.25 cm', 'Vervang AD = 6, AE = 8, AC = 15 en los op'],
        ]), checkMode: 'self', diagramSvg: '<svg viewBox="0 0 300 250" xmlns="http://www.w3.org/2000/svg"><polygon points="150,28 35,210 265,210" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="98.25" y1="109.9" x2="213.25" y2="128.1" stroke="#0f1f3d" stroke-width="2"/><path d="M 106.8,96.4 A 16,16 0 0 1 114.1,112.4" fill="none" stroke="#16a34a" stroke-width="1.8"/><path d="M 256.5,196.5 A 16,16 0 0 1 249.0,210.0" fill="none" stroke="#16a34a" stroke-width="1.8"/><circle cx="98.25" cy="109.9" r="3" fill="#0f1f3d"/><circle cx="213.25" cy="128.1" r="3" fill="#0f1f3d"/><text x="150" y="18" font-size="13" fill="#374151" font-weight="600" text-anchor="middle">A</text><text x="21" y="226" font-size="13" fill="#374151" font-weight="600" text-anchor="middle">B</text><text x="279" y="226" font-size="13" fill="#374151" font-weight="600" text-anchor="middle">C</text><text x="82" y="112" font-size="13" fill="#374151" font-weight="600" text-anchor="middle">D</text><text x="229" y="130" font-size="13" fill="#374151" font-weight="600" text-anchor="middle">E</text><text x="112" y="66" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">6 cm</text><text x="196" y="72" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">8 cm</text><text x="243" y="112" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">AC = 15 cm</text></svg>' },
      ],
      scoreMessages: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        // Blok 7 — Riderbewyse (CAPS probleemoplossings-kognitiewe vlak)
        { difficulty: 'Hard', question: 'In reghoekige driehoek ABC (reghoek by C), word die hoogtelyn CD vanaf C na skuinssy AB getrek, met D tussen A en B. AD = 4 cm en DB = 9 cm. Bewys dat CD = 6 cm.', answer: `Aangesien △ACD ∼ △CBD (albei gelykvormig aan △ABC volgens HH, en dus gelykvormig aan mekaar), is ${bl('AD/CD = CD/DB')}, dus ${bl('CD² = AD × DB = 4 × 9 = 36')}, wat CD = 6 cm gee.` + proofTable([
          ['∠ADC = ∠CDB = 90°', 'CD ⊥ AB (hoogtelyn na die skuinssy)'],
          ['∠DAC = ∠DCB', 'Albei gelyk aan 90° − ∠B in hulle onderskeie reghoekige driehoeke'],
          ['∴ △ACD ∼ △CBD', 'HH-gelykvormigheidsvoorwaarde (twee pare hoeke gelyk)'],
          ['AD/CD = CD/DB', 'Ooreenstemmende sye van gelykvormige driehoeke is eweredig'],
          ['CD² = AD × DB = 4 × 9 = 36', 'Kruisvermenigvuldig die eweredigheid'],
          ['∴ CD = √36 = 6 cm', 'Trek die vierkantswortel'],
        ]), checkMode: 'self', diagramSvg: '<svg viewBox="0 0 300 250" xmlns="http://www.w3.org/2000/svg"><polygon points="30,205 270,205 183.6,89.8" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="183.6" y1="89.8" x2="183.6" y2="205" stroke="#0f1f3d" stroke-width="2" stroke-dasharray="5,4"/><rect x="176.6" y="198" width="7" height="7" fill="none" stroke="#0f1f3d" stroke-width="1.3"/><rect x="171" y="80.8" width="9" height="9" fill="none" stroke="#0f1f3d" stroke-width="1.3"/><text x="18" y="221" font-size="13" fill="#374151" font-weight="600" text-anchor="middle">A</text><text x="282" y="221" font-size="13" fill="#374151" font-weight="600" text-anchor="middle">B</text><text x="183.6" y="79.8" font-size="13" fill="#374151" font-weight="600" text-anchor="middle">C</text><text x="183.6" y="221" font-size="13" fill="#374151" font-weight="600" text-anchor="middle">D</text><text x="106.8" y="223" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">4 cm</text><text x="226.8" y="223" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">9 cm</text></svg>' },
        { difficulty: 'Hard', question: 'In driehoek ABC is D, E en F onderskeidelik die middelpunte van AB, AC en BC. Bewys dat △DEF ∼ △CBA.', answer: `Deur die Middelpuntstelling drie keer toe te pas, kry ons ${or('DE ∥ BC, DE = ½BC')}, ${or('DF ∥ AC, DF = ½AC')} en ${or('FE ∥ AB, FE = ½AB')}. Dus ${bl('DE/BC = DF/AC = FE/AB = 1/2')}, en volgens SSS-eweredigheid is △DEF ∼ △CBA.` + proofTable([
          ['DE ∥ BC en DE = ½BC', 'Middelpuntstelling in △ABC (D, E middelpunte van AB, AC)'],
          ['DF ∥ AC en DF = ½AC', 'Middelpuntstelling in △ABC (D, F middelpunte van AB, BC)'],
          ['FE ∥ AB en FE = ½AB', 'Middelpuntstelling in △ABC (F, E middelpunte van BC, AC)'],
          ['DE/BC = DF/AC = FE/AB = 1/2', 'Elke sy van △DEF is die helfte van die ooreenstemmende sy van △ABC'],
          ['∴ △DEF ∼ △CBA', 'SSS-eweredigheidsvoorwaarde (al drie pare ooreenstemmende sye in dieselfde verhouding)'],
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Hard', question: 'Driehoek ABC het sye AB = 8 cm, BC = 14 cm en CA = 10 cm. Driehoek DEF het sye DE = 20 cm, EF = 35 cm en FD = 25 cm, met ∠B = 72°. Bewys dat △ABC ∼ △DEF, en bepaal dus ∠E.', answer: `${bl('DE/AB = 20/8 = 2.5')}, ${bl('EF/BC = 35/14 = 2.5')}, ${bl('FD/CA = 25/10 = 2.5')} — al drie verhoudings is gelyk, dus is △ABC ∼ △DEF volgens SSS-eweredigheid, en aangesien ooreenstemmende hoeke van gelykvormige driehoeke gelyk is, is ∠E = ∠B = 72°.` + proofTable([
          ['DE/AB = 20/8 = 2.5', 'Gegewe sylengtes'],
          ['EF/BC = 35/14 = 2.5', 'Gegewe sylengtes'],
          ['FD/CA = 25/10 = 2.5', 'Gegewe sylengtes'],
          ['DE/AB = EF/BC = FD/CA', 'Al drie verhoudings is gelyk aan 2.5 (hierbo getoon)'],
          ['∴ △ABC ∼ △DEF', 'SSS-eweredigheidsvoorwaarde (al drie pare ooreenstemmende sye in dieselfde verhouding)'],
          ['∴ ∠E = ∠B = 72°', 'Ooreenstemmende hoeke van gelykvormige driehoeke is gelyk'],
        ]), checkMode: 'self', diagramSvg: '<svg viewBox="0 0 340 240" xmlns="http://www.w3.org/2000/svg"><polygon points="65,45 25,165 110,165" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="65" y="35" font-size="12" fill="#374151" font-weight="600" text-anchor="middle">A</text><text x="13" y="179" font-size="12" fill="#374151" font-weight="600" text-anchor="middle">B</text><text x="122" y="179" font-size="12" fill="#374151" font-weight="600" text-anchor="middle">C</text><text x="25.0" y="105.0" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">8 cm</text><text x="67.5" y="183.0" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">14 cm</text><text x="102.0" y="103.0" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">10 cm</text><text x="18" y="150" font-size="12" fill="#dc2626" font-weight="700" text-anchor="middle">72°</text><polygon points="235,20 183.0,176.0 293.5,176.0" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="235" y="12" font-size="12" fill="#374151" font-weight="600" text-anchor="middle">D</text><text x="171.0" y="190.0" font-size="12" fill="#374151" font-weight="600" text-anchor="middle">E</text><text x="305.5" y="190.0" font-size="12" fill="#374151" font-weight="600" text-anchor="middle">F</text><text x="187.0" y="98.0" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">20 cm</text><text x="238.3" y="194.0" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">35 cm</text><text x="280.0" y="98.0" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">25 cm</text></svg>' },
      ],
      scoreMessages: [
        { minScore: 20, message: 'Uitstekend! Jy het gelykvormige veelhoeke, die Eweredigheidstelling, en die gelykvormige-driehoeke-bewys van Pythagoras bemeester.' },
        { minScore: 15, message: 'Goeie werk! Gaan enige gemiste vrae oor die Eweredigheidstelling of die Middelpuntstelling weer deur, en probeer weer.' },
