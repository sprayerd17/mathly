  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Hard', question: 'In driehoek ABC lê D op AB en E op AC sodanig dat ∠ADE = ∠ACB (as gelyk gemerk in die diagram). AD = 6 cm, AE = 8 cm en AC = 15 cm. Bewys dat AD × AB = AE × AC, en bepaal dus AB.', answer: `Aangesien ${bl('∠A')} gemeenskaplik is aan albei driehoeke en ${gr('∠ADE = ∠ACB')} (gegewe), is △ADE ∼ △ACB volgens die HH-voorwaarde. Dus AD/AC = AE/AB, wat gee AD × AB = AE × AC, dus 6 × AB = 8 × 15 = 120, en AB = 120/6 = 20 cm.` + proofTable([
          ...
          ['6 × AB = 8 × 15 = 120, dus AB = 120/6 = 20 cm', 'Vervang AD = 6, AE = 8, AC = 15 en los op'],
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Hard', question: 'Driehoek ABC het sye AB = 8 cm, BC = 14 cm en CA = 10 cm (wat ∠B ≈ 44.4° gee volgens die cosinereël). Driehoek DEF het sye DE = 20 cm, EF = 35 cm en FD = 25 cm. Bewys dat △ABC ∼ △DEF, en bepaal dus ∠E.', answer: `${bl('DE/AB = 20/8 = 2.5')}, ${bl('EF/BC = 35/14 = 2.5')}, ${bl('FD/CA = 25/10 = 2.5')} — al drie verhoudings is gelyk, dus is △ABC ∼ △DEF volgens SSS-eweredigheid, en aangesien ooreenstemmende hoeke van gelykvormige driehoeke gelyk is, is ∠E = ∠B ≈ 44.4°.` + proofTable([
          ...
          ['∴ ∠E = ∠B ≈ 44.4°', 'Ooreenstemmende hoeke van gelykvormige driehoeke is gelyk'],
