...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      explanation:
        ...
        `<p style="font-weight:700;color:#0f1f3d;margin-bottom:10px;font-size:1.02em;">1. Aflei van die Oppervlaktereël — Oppervlakte = ½ab sinC</p>` +
        `<div style="display:flex;flex-direction:column;gap:10px;margin-bottom:20px;">` +
        ...
        `<p style="font-weight:700;color:#0f1f3d;margin-bottom:10px;font-size:1.02em;">2. Aflei van die Sinusreël — a/sinA = b/sinB = c/sinC</p>` +
        `<div style="display:flex;flex-direction:column;gap:10px;margin-bottom:20px;">` +
        ...
        `<p style="margin:0;font-size:14px;color:#374151;">Ons het getoon ${gr('b/sinB = c/sinC')}. Deur ʼn hoogte vanaf ʼn ander hoekpunt te trek (bv. vanaf B na AC), koppel dit a en c op presies dieselfde manier, wat ${gr('a/sinA = c/sinC')} gee. Deur albei resultate te kombineer bewys dit die volledige Sinusreël: ${gr('a/sinA = b/sinB = c/sinC')}.</p>` +
        `</div>` +
        `</div>` +
        ...
        `<p style="font-weight:700;color:#0f1f3d;margin-bottom:10px;font-size:1.02em;">3. Aflei van die Kosinusreël — a² = b² + c² − 2bc cosA</p>` +
        `<div style="display:flex;flex-direction:column;gap:10px;margin-bottom:20px;">` +
      ...
      workedExamples: [
        {
          question: 'In driehoek ABC is a = 6 cm, b = 9 cm en die ingeslote hoek C = 70°. Gebruik die afleidingsmetode (nie die Oppervlaktereël-formule direk nie) om die hoogte h te bepaal wat vanaf hoekpunt A na sy BC getrek word, en bepaal sodoende die oppervlakte van die driehoek.',
          ...
          steps: [
            ...
            `Let daarop dat dit ooreenstem met die Oppervlaktereël-formule direk: ½ab sinC = ½ × 6 × 9 × sin70° ≈ 25,37 cm² — die afleidingsmetode en die formule stem ooreen.`,
          ],
        },
        {
          question: 'In driehoek ABC is A = 40°, C = 75° en a = 10 cm. Gebruik die sinusreël se afleidingsmetode om die hoogte h te bepaal wat vanaf hoekpunt B na sy AC getrek word, en bepaal sodoende sy c.',
          ...
          steps: [
            ...
            `Dit is presies die Sinusreël in aksie: a/sinA = c/sinC.`,
          ],
        },
      ],
      ...
      openQuestions: [
        ...
        {
          difficulty: 'Hard',
          question: 'Deur dieselfde diagram as die Kosinusreël-afleiding te gebruik (hoogte h vanaf B na AC, voetpunt D, met AD = c cosA en DC = b − c cosA), begin ʼn leerder eerder by h² = a² − (b − c cosA)² en h² = c² − (c cosA)². Toon alle algebraïese stappe om te bewys dat a² = b² + c² − 2bc cosA.',
      ...
      videoPlaceholder:
        'Kort video wat die Oppervlaktereël, Sinusreël en Kosinusreël van eerste beginsels aflei, wat begin met ʼn enkele hoogte in ʼn driehoek getrek en wys hoe reghoekige-driehoek-trigonometrie en die Stelling van Pythagoras elke reël stap vir stap opbou',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      title: 'Die Sinusreël, Kosinusreël en Oppervlaktereël',
      icon: '△',
      explanation:
        ...
        `<div style="background:#eff6ff;border:1.5px solid #bfdbfe;border-radius:10px;padding:14px 16px;">` +
        `<p style="font-weight:700;color:#1e40af;margin-bottom:6px;">Sinusreël</p>` +
        ...
        `<div style="background:#f0fdf4;border:1.5px solid #bbf7d0;border-radius:10px;padding:14px 16px;">` +
        `<p style="font-weight:700;color:#15803d;margin-bottom:6px;">Kosinusreël</p>` +
        ...
        `<div style="background:#fff7ed;border:1.5px solid #fed7aa;border-radius:10px;padding:14px 16px;">` +
        `<p style="font-weight:700;color:#c2410c;margin-bottom:6px;">Oppervlaktereël</p>` +
        ...
        `<p style="margin:0;color:#1e3a8a;"><strong>Sinusreël eerste</strong> — as jy ʼn ooreenstemmende hoek-sy-paar en een ander element het.<br><strong>Kosinusreël</strong> — vir SHS (twee sye + ingeslote hoek) of SSS (drie sye).<br><strong>Oppervlaktereël</strong> — wanneer jy ook al die oppervlakte nodig het en twee sye + die ingeslote hoek het.</p>` +
        `</div>`,

      workedExamples: [
        {
          question: 'In driehoek ABC is A = 40°, B = 65°, en a = 10 cm. Bepaal sy b met behulp van die Sinusreël.',
          answer: `b ≈ ${gr('14,1 cm')}`,
          steps: [
            `Identifiseer wat bekend is: ${bl('A = 40°')}, ${bl('B = 65°')}, ${bl('a = 10 cm')}.`,
            `Ons het ʼn ooreenstemmende paar (${bl('a')} teenoor ${bl('A')}) en benodig ${gr('b')}, dus pas die ${or('Sinusreël')} toe: ${or('a / sinA = b / sinB')}.`,
        ...
        {
          question: 'In driehoek ABC is b = 8 cm, c = 10 cm, en A = 50°. Bepaal sy a met behulp van die Kosinusreël.',
          answer: `a ≈ ${gr('7,82 cm')}`,
          steps: [
            `Identifiseer wat bekend is: ${bl('b = 8 cm')}, ${bl('c = 10 cm')}, ${bl('A = 50°')} (twee sye en die ingeslote hoek → SHS).`,
            `Pas die ${or('Kosinusreël')} toe: ${or('a² = b² + c² − 2bc · cosA')}.`,
        ...
        },
        {
          ...
          steps: [
            `Identifiseer wat bekend is: ${bl('a = 6 cm')}, ${bl('b = 9 cm')}, ${bl('C = 70°')} (twee sye en die ingeslote hoek).`,
            `Pas die ${or('Oppervlaktereël')} toe: ${or('Oppervlakte = ½ · a · b · sinC')}.`,
      ...
      openQuestions: [
        {
          difficulty: 'Easy',
          question: 'In driehoek PQR is P = 55°, Q = 72°, en sy p = 12 cm. Gebruik die Sinusreël om sy q te bepaal. Rond jou antwoord af tot een desimale plek.',
          ...
          parts: [
            {
              ...
              correctAnswer: '39',
              explanation: 'Kosinusreël: a² = b² + c² − 2bc·cosA\n= 25 + 49 − 2(5)(7)cos60°\n= 74 − 70 × 0,5\n= 74 − 35\n= 39 ✓',
            },
            {
        ...
        {
          difficulty: 'Hard',
          question: 'In driehoek ABC is AB = 9 cm, BC = 12 cm en AC = 15 cm.\n\na) Toon dat hoek B = 90° met behulp van die Kosinusreël.\nb) Bepaal die oppervlakte van die driehoek met die Oppervlaktereël met sye AB en BC en hoek B.\nc) Bevestig jou antwoord met Oppervlakte = ½ × basis × hoogte.',
      ...
      videoPlaceholder:
        'Kort video wat verduidelik wanneer en hoe om die Sinusreël, Kosinusreël en Oppervlaktereël vir nie-reghoekige driehoeke te gebruik, met een volledig uitgewerkte voorbeeld vir elke reël',
    },
    // ─────────────────────────────────────────────────────────────────────────
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      icon: '🗺️',
      explanation:
        `<p style="margin-bottom:16px;">Ons los werklike <strong>tweedimensionele probleme</strong> op deur trigonometriese modelle te bou en te interpreteer, dikwels deur die sinusreël, kosinusreël, oppervlakte-reël en reghoekige-driehoek-trigonometrie binne een multi-stap-probleem te kombineer, veral waar ʼn figuur meer as een driehoek bevat.</p>` +
      ...
      workedExamples: [
        ...
        },
        {
          ...
          steps: [
            ...
            `Pas die ${or('Oppervlaktereël')} toe: ${or('Oppervlakte = ½ · b · c · sin A')} = ½ × ${bl('45')} × ${bl('60')} × sin(${bl('55°')}).`,
            `Bereken: ${or('Oppervlakte')} = ½ × 2700 × 0,8192 = ${or('1350 × 0,8192')} ≈ ${gr('1106,7 m²')} ✓`,
            `Pas die ${or('Kosinusreël')} toe om sy a te bepaal: ${or('a² = b² + c² − 2bc · cos A')}.`,
      ...
      videoPlaceholder:
        'Kort video wat deur multi-stap-2D-trigonometrieprobleme stap — die kruishoogte van kruisende toue, die hoogtehoek-toring-probleem gelyktydig opgelos, en die driehoekige stuk grond met die Oppervlakte- en Kosinusreël',
    },
  ],
  ...
  practiceSets: [
    ...
    // Blok 3 (6-8):   Sinusreël — onbekende sy, dan onbekende hoek          — BENODIG DIAGRAM (7,8,9)
    // Blok 4 (9-11):  Kosinusreël — onbekende sy (SHS), onbekende hoek (SSS)  — BENODIG DIAGRAM (10,11,12)
    // Blok 5 (12-14): Oppervlaktereël                                    — BENODIG DIAGRAM (13,14,15)
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      scoreMessages: [
        ...
        { minScore: 15, message: 'Goeie werk! Hersien enige gemiste vrae oor die sinusreël, kosinusreël of trig-grafieke, en probeer weer.' },
  ...
  topicPractice: [
    ...
    {
      difficulty: 'Medium',
      question: 'In driehoek ABC is A = 35°, B = 70°, a = 12 cm. Bepaal sy b met die Sinusreël.',
      answer: '19,66 cm',
      checkMode: 'auto',
      correctAnswer: '19,66cm',
      correctAnswers: ['19,66cm', '19,66 cm', '≈19,66cm', '≈ 19,66 cm', '19,7cm', '20cm'],
      explanation: 'Sinusreël: a/sinA = b/sinB\n12/sin35° = b/sin70°\nb = 12 × sin70°/sin35° = 12 × 0,9397/0,5736 ≈ 19,66 cm ✓',
    },

    // ── V16 Moeilik — Kosinusreël ────────────────────────────────────────────────
    {
      difficulty: 'Hard',
      question: 'In driehoek ABC is b = 7 cm, c = 9 cm, A = 60°. Bepaal sy a met die Kosinusreël.',
      answer: 'a² = 49 + 81 − 2(7)(9)cos60° = 130 − 63 = 67. a ≈ 8,19 cm.',
      checkMode: 'self',
    },

    // ── V17 Matig — Oppervlaktereël ────────────────────────────────────────────────
    {
      difficulty: 'Medium',
    ...
    // ── V18 Matig — aflei van hoogte h in die Oppervlaktereël-bewys ─────────
    {
      difficulty: 'Medium',
    ...
    // ── V19 Moeilik — volledige kosinusreël-afleiding ────────────────────────────
    {
      difficulty: 'Hard',
