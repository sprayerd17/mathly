  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Hard', question: "ʼn Teater se ry-sitplekpatroon (sitplekke in ry n) is 5, 14, 29, 50. Vind die n-de term reël en gebruik dit om die aantal sitplekke in ry 7 te voorspel.", checkMode: 'auto', correctAnswer: '149', answer: '149', explanation: 'Eerste verskille: 9,15,21. Tweede verskille: 6,6. a=3. T₁=5: 3+b+c=5→b+c=2. T₂=14: 12+2b+c=14→2b+c=2. Trek af: b=0. c=2. Reël: Tₙ=3n²+2. T₇=3(49)+2=147+2=149.' },
        ...
        { difficulty: 'Hard', question: 'ʼn Kwadratiese patroon het Tₙ = 3n² − n en ʼn liniêre patroon het Uₙ = 20n − 25. Vind die waarde(s) van n waarvoor Tₙ = Uₙ, gegewe dat n ʼn positiewe heelgetal moet wees.', answer: '3n²-n=20n-25 → 3n²-21n+25=0... deur klein positiewe heelgetalle te toets: n=1: T=2,U=-5 (nee). n=2: T=10,U=15 (nee). n=3: T=24,U=35 (nee). Deur die kwadratiese formule op 3n²-21n+25=0 toe te pas, kry ons nie-heelgetal wortels (n≈1,52 of n≈5,48), dus is daar geen positiewe heelgetal n waarvoor Tₙ=Uₙ presies is nie; die naaste heelgetal-toets bevestig geen presiese ooreenkoms nie.', checkMode: 'self' },
      ],
      scoreMessages: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        // Blok 6 — Moeilik: gekombineerde/omgekeerde en verifikasieprobleme
        { difficulty: 'Hard', question: "ʼn Saal se ry-sitplekpatroon (sitplekke in ry n) is 6, 15, 30, 51. Vind die n-de term reël en gebruik dit om die aantal sitplekke in ry 6 te voorspel.", checkMode: 'auto', correctAnswer: '111', answer: '111', explanation: 'Eerste verskille: 9,15,21. Tweede verskille: 6,6. a=3. T₁=6: 3+b+c=6→b+c=3. T₂=15: 12+2b+c=15→2b+c=3. Trek af: b=0. c=3. Reël: Tₙ=3n²+3. T₆=3(36)+3=108+3=111.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        // Blok 6 — Moeilik: gekombineerde/omgekeerde en verifikasieprobleme
        { difficulty: 'Hard', question: "ʼn Stadion se ry-sitplekpatroon (sitplekke in ry n) is 7, 16, 31, 52. Vind die n-de term reël en gebruik dit om die aantal sitplekke in ry 5 te voorspel.", checkMode: 'auto', correctAnswer: '79', answer: '79', explanation: 'Eerste verskille: 9,15,21. Tweede verskille: 6,6. a=3. T₁=7: 3+b+c=7→b+c=4. T₂=16: 12+2b+c=16→2b+c=4. Trek af: b=0. c=4. Reël: Tₙ=3n²+4. T₅=3(25)+4=75+4=79.' },
