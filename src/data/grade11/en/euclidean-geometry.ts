  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Hard', question: 'In triangle ABC, D lies on AB and E lies on AC such that ∠ADE = ∠ACB (marked equal in the diagram). AD = 6 cm, AE = 8 cm and AC = 15 cm. Prove that AD × AB = AE × AC, and hence find AB.', answer: `Since ${bl('∠A')} is common to both triangles and ${gr('∠ADE = ∠ACB')} (given), △ADE ∼ △ACB by the AA condition. So AD/AC = AE/AB, which gives AD × AB = AE × AC = 6 × 15 = 8 × AB, so AB = 90/8 = 11.25 cm.` + proofTable([
          ...
          ['6 × AB = 8 × 15 = 120, so AB = 11.25 cm', 'Substituting AD = 6, AE = 8, AC = 15 and solving'],
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Hard', question: 'Triangle ABC has sides AB = 8 cm, BC = 14 cm and CA = 10 cm. Triangle DEF has sides DE = 20 cm, EF = 35 cm and FD = 25 cm, with ∠B = 72°. Prove that △ABC ∼ △DEF, and hence find ∠E.', answer: `${bl('DE/AB = 20/8 = 2.5')}, ${bl('EF/BC = 35/14 = 2.5')}, ${bl('FD/CA = 25/10 = 2.5')} — all three ratios are equal, so △ABC ∼ △DEF by SSS proportionality, and since corresponding angles of similar triangles are equal, ∠E = ∠B = 72°.` + proofTable([
          ...
          ['∴ ∠E = ∠B = 72°', 'Corresponding angles of similar triangles are equal'],
