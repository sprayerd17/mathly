  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Hard', question: "A theatre's row seating pattern (seats in row n) is 5, 14, 29, 50. Find the nth term rule and use it to predict the number of seats in row 7.", checkMode: 'auto', correctAnswer: '149', answer: '149', explanation: 'First differences: 9,15,21. Second differences: 6,6. a=3. T₁=5: 3+b+c=5→b+c=2. T₂=14: 12+2b+c=14→2b+c=2. Subtract: b=0. c=2. Rule: Tₙ=3n²+2. T₇=3(49)+2=147+2=149.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        // Block 6 — Hard: combined/reverse and verification problems
        { difficulty: 'Hard', question: "A hall's row seating pattern (seats in row n) is 6, 15, 30, 51. Find the nth term rule and use it to predict the number of seats in row 6.", checkMode: 'auto', correctAnswer: '111', answer: '111', explanation: 'First differences: 9,15,21. Second differences: 6,6. a=3. T₁=6: 3+b+c=6→b+c=3. T₂=15: 12+2b+c=15→2b+c=3. Subtract: b=0. c=3. Rule: Tₙ=3n²+3. T₆=3(36)+3=108+3=111.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        // Block 6 — Hard: combined/reverse and verification problems
        { difficulty: 'Hard', question: "A stadium's row seating pattern (seats in row n) is 7, 16, 31, 52. Find the nth term rule and use it to predict the number of seats in row 5.", checkMode: 'auto', correctAnswer: '79', answer: '79', explanation: 'First differences: 9,15,21. Second differences: 6,6. a=3. T₁=7: 3+b+c=7→b+c=4. T₂=16: 12+2b+c=16→2b+c=4. Subtract: b=0. c=4. Rule: Tₙ=3n²+4. T₅=3(25)+4=75+4=79.' },
