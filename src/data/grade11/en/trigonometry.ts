...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video deriving the exact values of sin, cos and tan for 30°, 45° and 60° using the 45-45-90 and 30-60-90 special triangles',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video deriving the quotient identity tanθ = sinθ/cosθ and the Pythagorean identity sin²θ + cos²θ = 1, and showing how to use both identities to simplify expressions',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video showing how the parameters k and p affect the period and horizontal position of trigonometric graphs, with live side-by-side comparison of y = sinθ, y = sin(2θ) and y = sin(θ + 45°)',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video explaining reduction formulae using the CAST diagram, with worked examples converting angles in Q2, Q3 and Q4 to their reference angles and determining the correct sign for each ratio',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video showing step by step how to find the general solution of sinθ = k, cosθ = k, and tanθ = k, including identifying the reference angle and writing the complete general solution with n ∈ ℤ',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video deriving the Area Rule, Sine Rule and Cosine Rule from first principles, starting with a single height dropped in a triangle and showing how right-angled trigonometry and the Theorem of Pythagoras build each rule step by step',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video explaining when and how to use the Sine Rule, Cosine Rule and Area Rule for non-right-angled triangles, with one fully worked example for each rule',
    },
  ...
  topicPractice: [
    // ── Q1 Easy — exact value sin 30° ────────────────────────────────────────
    {
      ...
      correctIndex: 0,
      explanation: 'Using the 30-60-90 special triangle: sin 30° = opposite/hypotenuse = 1/2 ✓ (√3/2 is cos 30° or sin 60°; √2/2 is sin 45°; 1 mistakes the ratio for the hypotenuse itself.)',
    },
    ...
    // ── Q2 Easy — exact value cos 45° ────────────────────────────────────────
    {
      ...
      correctIndex: 1,
      explanation: 'Using the 45-45-90 special triangle: cos 45° = adjacent/hypotenuse = 1/√2 = √2/2 ✓ (1/2 is sin 30° or cos 60°; √3/2 is cos 30° or sin 60°; 1/√3 is tan 30°.)',
    },
    ...
    // ── Q3 Medium — exact value tan 60° ──────────────────────────────────────
    {
      ...
      options: ['1/√3', '√3/2', '√3', '1'],
      correctIndex: 2,
      explanation: 'Using the 30-60-90 triangle: tan 60° = opposite/adjacent = √3/1 = √3 ✓ (1/√3 is tan 30°, the reciprocal; √3/2 is sin 60° or cos 30°; 1 mistakes tan 45° for tan 60°.)',
    },
    ...
    // ── Q4 Hard — Sipho's claim about sin 60° ────────────────────────────────
    {
      ...
      checkMode: 'auto',
      options: ['Yes, both equal 1', 'Yes, since sin is a linear function so sin(2×30°) = 2sin30°', 'No — sin 60° = 1/2, while 2×sin 30° = 1', 'No — sin 60° = √3/2 ≈ 0.866, while 2×sin 30° = 1, so they are not equal'],
      correctIndex: 3,
      explanation: 'sin 60° = √3/2 ≈ 0.866, but 2×sin 30° = 2×0.5 = 1. Since 0.866 is not equal to 1, Sipho is incorrect ✓ (the linear-function option wrongly assumes sin(2θ)=2sinθ, which is false; the other No option miscalculates sin 60° as 1/2, which is actually sin 30°.)',
    },
    ...
    // ── Q5 Medium — prove the Pythagorean identity ────────────────────────────
    {
      ...
      checkMode: 'auto',
      options: ['sin²θ+cos²θ = (y/r)²+(x/r)² = (y²+x²)/r² = r²/r² = 1, using x²+y²=r²', 'sin²θ+cos²θ = y²/r + x²/r = (x²+y²)/r = r²/r = r', 'sin²θ+cos²θ = (y/r)²+(x/r)² = (y+x)²/r², which only equals 1 if x+y=r', 'sin²θ+cos²θ = y²/x² + x²/y² = 1, by the definition of tanθ'],
      correctIndex: 0,
      explanation: 'sinθ=y/r and cosθ=x/r, so sin²θ+cos²θ = (y/r)²+(x/r)² = (y²+x²)/r². Since x²+y²=r² (Theorem of Pythagoras), this becomes r²/r² = 1 ✓ (the other options forget to square r in the denominator, wrongly expand (y/r)²+(x/r)² as (y+x)²/r², or substitute the wrong ratio entirely.)',
    },
    ...
    // ── Q6 Hard — find sinθ using the Pythagorean identity ───────────────────
    {
      ...
      correctIndex: 1,
      explanation: 'sin²θ = 1−cos²θ = 1−(5/13)² = 1−25/169 = 144/169, so sinθ = 12/13 (positive in Q1) ✓ (13/12 inverts the ratio; 5/12 confuses sinθ with tanθ; 8/13 comes from an arithmetic slip subtracting 5 from 13 instead of squaring.)',
    },
    ...
    // ── Q7 Medium — period of y = sin(3θ) ────────────────────────────────────
    {
      ...
      correctIndex: 2,
      explanation: 'k=3. Period=360°/3=120° ✓ (3° confuses k with the period; 360° ignores k entirely; 1080° wrongly multiplies 360° by 3 instead of dividing.)',
    },
    ...
    // ── Q8 Hard — transformation of y = cos(θ + 60°) ─────────────────────────
    {
      ...
      checkMode: 'auto',
      options: ['Shifted 60° right', 'Vertically stretched by 60', 'Period changed to 60°', 'Shifted 60° left'],
      correctIndex: 3,
      explanation: 'Since the angle is written as (θ+60°), the graph shifts 60° to the left compared to y=cosθ ✓ (shifting right reverses the direction rule for +p; the other options mistake a horizontal shift for a vertical stretch or a period change, since k is unchanged.)',
    },
    ...
    // ── Q9 Easy — reduction formula sin(180° − 50°) ──────────────────────────
    {
      ...
      correctIndex: 0,
      explanation: 'sin(180°−θ)=sinθ since 180°−50° lies in Q2 where sin is positive, so sin(180°−50°)=sin50° ✓ (-sin 50° wrongly applies a Q3/Q4 sign; the cos 50° options mix up sin with cos.)',
    },
    ...
    // ── Q10 Medium — reduction formula cos(180° + 35°) ───────────────────────
    {
      ...
      correctIndex: 1,
      explanation: 'cos(180°+θ)=−cosθ since 180°+35° lies in Q3 where cos is negative, so cos(180°+35°)=−cos35° ✓ (cos 35° keeps the wrong positive sign; the sin 35° options mix up cos with sin.)',
    },
    ...
    // ── Q11 Hard — simplify using reduction formulae ──────────────────────────
    {
      ...
      correctIndex: 2,
      explanation: 'sin(360°−θ)=−sinθ and cos(−θ)=cosθ, so the expression = −sinθ/cosθ = −tanθ ✓ (tanθ forgets the negative sign; the cotθ options invert the ratio, confusing it with cotangent.)',
    },
    ...
    // ── Q12 Easy — general solution sinθ = √3/2 ──────────────────────────────
    {
      ...
      checkMode: 'auto',
      options: ['θ=60°+360°n only', 'θ=60°+180°n or θ=120°+180°n', 'θ=-60°+360°n or θ=120°+360°n', 'θ=60°+360°n or θ=120°+360°n'],
      correctIndex: 3,
      explanation: 'Reference angle = sin⁻¹(√3/2) = 60°. sinθ is positive → Q1 and Q2: θ=60°+360°n or θ=(180°−60°)+360°n=120°+360°n, n∈ℤ ✓ (the first option misses the Q2 family; 180°n uses tan\'s period instead of 360°n; -60° wrongly applies the cosine ± pattern.)',
    },
    ...
    // ── Q13 Medium — general solution cosθ = −√2/2 ───────────────────────────
    {
      ...
      checkMode: 'auto',
      options: ['θ=135°+360°n or θ=225°+360°n', 'θ=±45°+360°n', 'θ=135°+180°n', 'θ=45°+360°n or θ=315°+360°n'],
      correctIndex: 0,
      explanation: 'Reference angle = cos⁻¹(√2/2)=45°. cosθ is negative → Q2 and Q3: θ=180°−45°=135° or θ=180°+45°=225°, i.e. θ=135°+360°n or θ=225°+360°n, n∈ℤ ✓ (±45° skips reflecting the reference angle into Q2/Q3; 180°n uses the wrong period; 45°/315° wrongly places the solutions in Q1/Q4 where cos is positive.)',
    },
    ...
    // ── Q14 Hard — general solution tanθ = −1 ────────────────────────────────
    {
      ...
      correctIndex: 1,
      explanation: 'Reference angle=45°. Since tanθ is negative, θ=180°−45°=135° as the base solution, so θ=135°+180°n, n∈ℤ ✓ (45°+180°n keeps the wrong sign; 135°+360°n uses the wrong period, sin/cos\'s instead of tan\'s; -45°+180°n applies the wrong reflection.)',
    },
    ...
    // ── Q15 Medium — Sine Rule ────────────────────────────────────────────────
    {
      ...
      correctIndex: 2,
      explanation: 'Sine Rule: b=a×sinB/sinA=12×sin70°/sin35°≈12×0.9397/0.5736≈19.66 cm ✓ (7.33 cm swaps the angle-side pairing; 24.00 cm mistakenly scales by the angle ratio 70/35 instead of the sine ratio; 12.00 cm just copies side a.)',
    },
    ...
    // ── Q16 Hard — Cosine Rule ────────────────────────────────────────────────
    {
      ...
      correctIndex: 2,
      explanation: 'a²=b²+c²−2bc·cosA=49+81−2(7)(9)cos60°=130−63=67, so a=√67≈8.19 cm ✓ (11.40 cm forgets the −2bc·cosA term; 13.89 cm wrongly adds instead of subtracts it; 67.00 cm forgets to take the final square root.)',
    },
    ...
    // ── Q17 Medium — Area Rule ────────────────────────────────────────────────
    {
      ...
      correctIndex: 0,
      explanation: 'Area=½×a×b×sinC=½×8×11×sin45°=½×88×(√2/2)≈31.11 cm² ✓ (62.22 cm² forgets the ½; 88.00 cm² forgets to multiply by sinC at all; 44.00 cm² wrongly uses tan45°=1 instead of sin45°.)',
    },
    ...
    // ── Q18 Medium — deriving the height h in the Area Rule proof ────────────
    {
      ...
      correctIndex: 1,
      explanation: 'In right triangle ADC: sinC=h/AC, so h=AC×sinC=10×sin42°≈10×0.6691≈6.69 cm ✓ (7.43 cm wrongly uses cosC instead of sinC; 0.67 cm forgets to multiply by AC, leaving just the sinC ratio; 9.00 cm wrongly uses tanC instead of sinC.)',
    },
    ...
    // ── Q19 Hard — full cosine rule derivation ────────────────────────────────
    {
      ...
      checkMode: 'auto',
      options: ['Expand (b−c cosA)² incorrectly as b²−(c cosA)², giving a² = b²+c²+2bc cosA', 'Expand (b−c cosA)² incorrectly as b²+2bc cosA+(c cosA)², giving a² = b²+c²+2bc cosA', 'Expand (b−c cosA)² correctly as b²−2bc cosA+(c cosA)², cancel the (c cosA)² terms, and rearrange to get a² = b²+c²−2bc cosA', 'Skip the expansion and directly conclude a² = b²−c²+2bc cosA'],
      correctIndex: 2,
      explanation: 'c²−(c cosA)² = a²−(b−c cosA)². Expanding (b−c cosA)² = b²−2bc cosA+(c cosA)² correctly, the (c cosA)² terms cancel from both sides, leaving c² = a²−b²+2bc cosA, which rearranges to a² = b²+c²−2bc cosA ✓ (the other options contain a sign error in the binomial expansion, or skip the algebra and guess the wrong form.)',
    },
    ...
    // ── Q20 Hard — intersection of crossing ropes ─────────────────────────────
    {
      ...
      correctIndex: 0,
      explanation: 'Intersection height = h1×h2/(h1+h2) = 8×12/(8+12) = 96/20 = 4.8 m ✓ (10 m wrongly averages the two heights; 9.80 m wrongly takes their geometric mean; 4 m wrongly takes their difference — the correct relationship does not depend on the 20 m separation between the poles.)',
    },
    ...
    // ── Q21 Hard — surveyor two-equation setup ────────────────────────────────
    {
      ...
      checkMode: 'auto',
      options: ['tan35° = h/d and tan20° = h/(d+40)', 'tan35° = h/(d+40) and tan20° = h/d', 'tan35° = d/h and tan20° = (d+40)/h', 'tan35° = h/d and tan20° = h/(d-40)'],
      correctIndex: 0,
      explanation: 'Let height=h and distance from the closer point B to the base=d. From B (closer, larger elevation angle): tan35°=h/d. From A (40 m further away): tan20°=h/(d+40) ✓ (swapping the points reverses which angle pairs with which distance; inverting the ratio confuses opposite/adjacent; using d-40 wrongly moves A closer instead of further away.)',
    },
    ...
    // ── Q22 Hard — triangular field area and third side ───────────────────────
    {
      ...
      checkMode: 'auto',
      options: ['Area ≈ 1585.1 m², third side ≈ 47.4 m', 'Area ≈ 792.6 m², third side ≈ 47.4 m', 'Area ≈ 792.6 m², third side ≈ 61.3 m', 'Area ≈ 875.0 m², third side ≈ 47.4 m'],
      correctIndex: 1,
      explanation: 'Area = ½(35)(50)sin65° ≈ 792.6 m². Third side: side² = 35²+50²−2(35)(50)cos65° ≈ 2246.6, side ≈ 47.4 m ✓ (1585.1 m² forgets the ½ in the area formula; 61.3 m comes from wrongly adding instead of subtracting the cosine term; 875.0 m² forgets to multiply by sin65° in the area formula.)',
    },
  ],
