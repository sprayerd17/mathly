...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      diagramSvg:
        '<svg viewBox="0 0 320 190" xmlns="http://www.w3.org/2000/svg" font-family="Arial, sans-serif"><line x1="160" y1="15" x2="160" y2="175" stroke="#e2e8f0" stroke-width="1.5"/><text x="82" y="18" font-size="12" font-weight="700" fill="#0f1f3d" text-anchor="middle">Positive gradient</text><line x1="15" y1="150" x2="150" y2="150" stroke="#0f1f3d" stroke-width="2"/><circle cx="55" cy="150" r="3" fill="#0f1f3d"/><line x1="55" y1="150" x2="112" y2="110" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 83,150 A 28,28 0 0 1 78,134" fill="none" stroke="#2563eb" stroke-width="2"/><text x="90" y="140" font-size="13" font-weight="700" fill="#2563eb">&#952;</text><text x="82" y="178" font-size="10" font-weight="700" fill="#0f1f3d" text-anchor="middle">0&#176; &lt; &#952; &lt; 90&#176;</text><text x="145" y="145" font-size="11" fill="#374151" text-anchor="end">x</text><text x="245" y="18" font-size="12" font-weight="700" fill="#0f1f3d" text-anchor="middle">Negative gradient</text><line x1="170" y1="150" x2="305" y2="150" stroke="#0f1f3d" stroke-width="2"/><circle cx="245" cy="150" r="3" fill="#0f1f3d"/><line x1="245" y1="150" x2="191" y2="105" stroke="#0f1f3d" stroke-width="2.5"/><line x1="245" y1="150" x2="264" y2="166" stroke="#6b7280" stroke-width="1.5" stroke-dasharray="3,3"/><path d="M 273,150 A 28,28 0 0 1 224,132" fill="none" stroke="#2563eb" stroke-width="2"/><path d="M 263,150 A 18,18 0 0 0 259,162" fill="none" stroke="#6b7280" stroke-width="1.5"/><text x="208" y="120" font-size="12" font-weight="700" fill="#2563eb">&#952; = 140&#176;</text><text x="266" y="163" font-size="9" font-weight="700" fill="#6b7280">&#8722;40&#176;</text><text x="245" y="178" font-size="10" font-weight="700" fill="#dc2626" text-anchor="middle">&#8722;40&#176; + 180&#176; = 140&#176;</text><text x="300" y="145" font-size="11" fill="#374151" text-anchor="end">x</text></svg>',
