...
export const topicData: TopicData = {
  ...
  sections: [
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video revising the distance, gradient and midpoint formulas with worked examples on the Cartesian plane',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video showing how to find the equation of a straight line through two points using the gradient formula and point-slope form',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video explaining the parallel and perpendicular gradient rules and showing how to find the equation of a line through a given point using each rule',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video explaining the inclination of a line, the formula m = tan θ, and the +180° correction for negative gradients',
    },
    ...
    // ─────────────────────────────────────────────────────────────────────────
    {
      ...
      videoPlaceholder:
        'Short video showing how to combine distance, gradient, midpoint, and inclination to solve mixed Analytical Geometry problems involving triangles',
    },
  ],
  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'Given A(1, 2) and B(4, 6), calculate the distance AB.', checkMode: 'auto', options: ['5', '7', '25', '3'], correctIndex: 0, explanation: 'd = √[(4 − 1)² + (6 − 2)²] = √[9 + 16] = √25 = 5 ✓ (7 wrongly adds the horizontal and vertical differences instead of using Pythagoras; 25 forgets to take the square root; 3 uses only the horizontal difference.)' },
        { difficulty: 'Easy', question: 'Given A(1, 2) and C(4, 2), calculate the gradient of AC.', checkMode: 'auto', options: ['undefined', '0', '3', '1/3'], correctIndex: 1, explanation: 'm = (2 − 2)/(4 − 1) = 0/3 = 0 ✓ (undefined flips the gradient formula upside down; 3 mistakes the denominator for the answer; 1/3 inverts the correct fraction.)' },
        { difficulty: 'Medium', question: 'A(1, 2), B(4, 6) and C(4, 2) are plotted on the Cartesian plane, forming triangle ABC. Determine the midpoint of BC.', checkMode: 'auto', options: ['(4, 8)', '(8, 4)', '(4, 4)', '(0, 4)'], correctIndex: 2, explanation: 'M = ((4 + 4)/2, (6 + 2)/2) = (8/2, 8/2) = (4, 4) ✓ ((4, 8) forgets to halve the y-sum; (8, 4) swaps the x- and y-coordinates; (0, 4) uses the difference of the x-coordinates instead of their sum.)', diagramSvg: `<svg viewBox="0 0 130 162" xmlns="http://www.w3.org/2000/svg" font-family="Arial, sans-serif"><g stroke="#9ca3af" stroke-width="1"><line x1="26" y1="154" x2="26" y2="26" /><line x1="42" y1="154" x2="42" y2="26" /><line x1="58" y1="154" x2="58" y2="26" /><line x1="74" y1="154" x2="74" y2="26" /><line x1="90" y1="154" x2="90" y2="26" /><line x1="106" y1="154" x2="106" y2="26" /><line x1="122" y1="154" x2="122" y2="26" /><line x1="26" y1="154" x2="122" y2="154" /><line x1="26" y1="138" x2="122" y2="138" /><line x1="26" y1="122" x2="122" y2="122" /><line x1="26" y1="106" x2="122" y2="106" /><line x1="26" y1="90" x2="122" y2="90" /><line x1="26" y1="74" x2="122" y2="74" /><line x1="26" y1="58" x2="122" y2="58" /><line x1="26" y1="42" x2="122" y2="42" /><line x1="26" y1="26" x2="122" y2="26" /></g><g stroke="#0f1f3d" stroke-width="1.5"><line x1="26" y1="138" x2="122" y2="138" /><line x1="42" y1="154" x2="42" y2="26" /></g><g fill="#374151" font-size="9"><text x="26" y="150" text-anchor="middle">-1</text><text x="58" y="150" text-anchor="middle">1</text><text x="74" y="150" text-anchor="middle">2</text><text x="90" y="150" text-anchor="middle">3</text><text x="106" y="150" text-anchor="middle">4</text><text x="122" y="150" text-anchor="middle">5</text><text x="34" y="157" text-anchor="end">-1</text><text x="34" y="141" text-anchor="end">0</text><text x="34" y="125" text-anchor="end">1</text><text x="34" y="109" text-anchor="end">2</text><text x="34" y="93" text-anchor="end">3</text><text x="34" y="77" text-anchor="end">4</text><text x="34" y="61" text-anchor="end">5</text><text x="34" y="45" text-anchor="end">6</text><text x="34" y="29" text-anchor="end">7</text></g><polygon points="58,106 106,42 106,106" fill="none" stroke="#0f1f3d" stroke-width="1.5" /><circle cx="58" cy="106" r="4" fill="#2563eb" stroke="#0f1f3d" stroke-width="1" /><circle cx="106" cy="42" r="4" fill="#2563eb" stroke="#0f1f3d" stroke-width="1" /><circle cx="106" cy="106" r="4" fill="#2563eb" stroke="#0f1f3d" stroke-width="1" /><text x="46" y="112" fill="#2563eb" font-weight="700" font-size="11" text-anchor="start">A(1,2)</text><text x="100" y="56" fill="#2563eb" font-weight="700" font-size="11" text-anchor="end">B(4,6)</text><text x="100" y="98" fill="#2563eb" font-weight="700" font-size="11" text-anchor="end">C(4,2)</text></svg>` },

        // Block 2 — Equation of a line through two points
        { difficulty: 'Easy', question: 'Find the equation of the line through (0, 4) and (2, 8).', checkMode: 'auto', options: ['y = 2x - 4', 'y = 4x + 2', 'y = 2x + 8', 'y = 2x + 4'], correctIndex: 3, explanation: 'm = (8 − 4)/(2 − 0) = 4/2 = 2. Substitute (0, 4): y − 4 = 2(x − 0) → y = 2x + 4 ✓ (y = 2x − 4 flips the sign of the intercept; y = 4x + 2 swaps the gradient and intercept; y = 2x + 8 misreads the y-value at x = 0.)' },
        { difficulty: 'Easy', question: 'Find the equation of the line through (1, 5) and (4, 11).', checkMode: 'auto', options: ['y = 2x + 3', 'y = 2x + 5', 'y = 3x + 2', 'y = 2x - 3'], correctIndex: 0, explanation: 'm = (11 − 5)/(4 − 1) = 6/3 = 2. Substitute (1, 5): y − 5 = 2(x − 1) → y = 2x + 3 ✓ (y = 2x + 5 uses y₁ directly as the intercept instead of solving for it; y = 3x + 2 swaps the gradient and intercept; y = 2x − 3 flips the sign of the intercept.)' },
        { difficulty: 'Medium', question: 'Find the equation of the line through (−3, 6) and (3, −6).', checkMode: 'auto', options: ['y = 2x', 'y = -2x', 'y = -2x + 6', 'y = -2x - 6'], correctIndex: 1, explanation: 'm = (−6 − 6)/(3 − (−3)) = −12/6 = −2. Substitute (3, −6): y − (−6) = −2(x − 3) → y + 6 = −2x + 6 → y = −2x ✓ (y = 2x flips the sign of the gradient; y = −2x + 6 and y = −2x − 6 both make an arithmetic slip simplifying the intercept.)' },
        { difficulty: 'Medium', question: 'Find the equation of the line through (2, 2) and (2, 9).', checkMode: 'auto', options: ['y = 2', 'y = 5.5', 'x = 2', 'undefined (no equation)'], correctIndex: 2, explanation: 'Both points share the x-coordinate 2, so the gradient is undefined and the line is vertical: x = 2 ✓ (y = 2 mixes up the vertical line with a horizontal one; y = 5.5 wrongly treats it as horizontal at the average y-value; stopping at "undefined" never writes the actual line equation.)' },

        // Block 3 — Parallel and perpendicular lines
        { difficulty: 'Easy', question: 'Write down the gradient of a line parallel to y = 2x − 5.', checkMode: 'auto', options: ['-1/2', '-2', '1/2', '2'], correctIndex: 3, explanation: 'Parallel lines have equal gradients. The gradient of y = 2x − 5 is m = 2, so a parallel line also has m = 2 ✓ (-1/2 and 1/2 wrongly apply the perpendicular rule instead of the parallel rule; -2 flips the sign.)' },
        { difficulty: 'Easy', question: 'Write down the gradient of a line perpendicular to y = -1/3x + 4.', checkMode: 'auto', options: ['3', '-1/3', '1/3', '-3'], correctIndex: 0, explanation: 'For perpendicular lines, m₁ × m₂ = −1.\nGiven m₁ = −1/3: m₂ = −1 ÷ (−1/3) = 3 ✓ (-1/3 copies the given gradient as if the lines were parallel; 1/3 drops the sign; -3 makes a sign error on the reciprocal.)' },
        { difficulty: 'Medium', question: 'Find the equation of the line through (1, −1) parallel to y = 2x + 3.', checkMode: 'auto', options: ['y = 2x + 3', 'y = 2x - 3', 'y = -1/2x - 3', 'y = 2x - 1'], correctIndex: 1, explanation: 'Gradient: m = 2 (same as parallel line).\nSubstitute (1, −1): y − (−1) = 2(x − 1) → y + 1 = 2x − 2 → y = 2x − 3 ✓ (y = 2x + 3 reuses the given line without substituting the new point; y = -1/2x - 3 wrongly uses the perpendicular gradient; y = 2x - 1 makes an arithmetic slip.)' },
        { difficulty: 'Hard', question: 'Find the equation of the line through (4, 1) perpendicular to y = -1/3x - 2.', checkMode: 'auto', options: ['y = -1/3x - 11', 'y = 3x - 12', 'y = 3x - 11', 'y = 3x + 11'], correctIndex: 2, explanation: 'Gradient of given line: m₁ = −1/3.\nPerpendicular gradient: m₂ = 3.\nSubstitute (4, 1): y − 1 = 3(x − 4) → y − 1 = 3x − 12 → y = 3x − 11 ✓ (y = -1/3x - 11 forgets to apply the perpendicular rule; y = 3x - 12 forgets to add the 1 back; y = 3x + 11 flips the sign of the intercept.)' },

        // Block 4 — Inclination of a line
        { difficulty: 'Easy', question: 'Determine the inclination of a line with gradient m = 0.5774, rounded to the nearest degree.', checkMode: 'auto', options: ['60', '150', '45', '30'], correctIndex: 3, explanation: 'tan θ = 0.5774 → θ = tan⁻¹(0.5774) ≈ 30°. Gradient is positive so no correction needed. θ ≈ 30° ✓ (60 confuses the angle with its complement; 150 wrongly adds 180° to a positive gradient; 45 is a rounding slip.)' },
        { difficulty: 'Medium', question: 'Determine the inclination of a line with gradient m = 0.7002, rounded to the nearest degree.', checkMode: 'auto', options: ['35', '55', '145', '34'], correctIndex: 0, explanation: 'θ = tan⁻¹(0.7002) ≈ 35° ✓ (55 is the complementary angle 90° − 35°; 145 wrongly adds 180° even though the gradient is positive; 34 is a rounding slip.)' },
        { difficulty: 'Medium', question: 'Determine the inclination of a line with gradient m = −0.5774, rounded to the nearest degree.', checkMode: 'auto', options: ['-30', '150', '30', '60'], correctIndex: 1, explanation: 'θ = tan⁻¹(−0.5774) ≈ −30°. Since the gradient is negative, add 180°: θ = −30° + 180° = 150° ✓ (-30 forgets to add 180°; 30 drops the negative sign; 60 confuses the angle with its complement.)' },
        { difficulty: 'Hard', question: 'Determine the gradient of a line with inclination 65°, rounded to two decimal places.', checkMode: 'auto', options: ['0.47', '-2.14', '2.14', '2.37'], correctIndex: 2, explanation: 'm = tan(65°) ≈ 2.14 ✓ (0.47 uses 1/tan(65°) instead of tan(65°); -2.14 wrongly assumes the angle is obtuse; 2.37 comes from using 67° instead of 65°.)' },

        // Block 5 — Right-angle / isosceles triangle proofs
        { difficulty: 'Medium', question: 'Given A(0, 0), B(5, 0) and C(5, 4), at which vertex is triangle ABC right-angled?', checkMode: 'auto', options: ['A', 'C', 'Not right-angled', 'B'], correctIndex: 3, explanation: 'Gradient of AB: m₁ = (0 − 0)/(5 − 0) = 0 (horizontal). Gradient of BC: m₂ = (4 − 0)/(5 − 5) = undefined (vertical). A horizontal line is perpendicular to a vertical line, so AB ⊥ BC. Therefore triangle ABC is right-angled at B ✓ (A and C misread which two sides meet at the right angle; claiming it is not right-angled ignores that a horizontal and a vertical line are always perpendicular.)' },
        { difficulty: 'Medium', question: 'Given P(1, 1) and Q(5, 1), calculate the length of PQ.', checkMode: 'auto', options: ['4', '16', '0', '5'], correctIndex: 0, explanation: 'PQ = √[(5 − 1)² + (1 − 1)²] = √[16 + 0] = √16 = 4 ✓ (16 forgets to take the square root; 0 wrongly uses the y-difference since the segment is horizontal; 5 is a miscount of the coordinate difference.)' },
        { difficulty: 'Hard', question: 'P(1, 1), Q(5, 1) and R(5, 5) are plotted on the Cartesian plane, forming triangle PQR. Given that PQ = 4 and QR = 4, calculate PR and hence state whether triangle PQR is isosceles.', checkMode: 'auto', options: ['PR = 4; triangle PQR is equilateral', 'PR = 4√2; triangle PQR is isosceles (PQ = QR)', 'PR = 8; triangle PQR is not isosceles', 'PR = 4√2; triangle PQR is scalene'], correctIndex: 1, explanation: 'PR = √[(5 − 1)² + (5 − 1)²] = √[16 + 16] = √32 = 4√2.\nSince PQ = QR = 4 and PR = 4√2, exactly two sides are equal, so triangle PQR is isosceles ✓ (PR = 4 wrongly assumes all three sides match; PR = 8 adds instead of using Pythagoras; the last option gets PR right but misclassifies the triangle as scalene despite two equal sides.)', diagramSvg: `<svg viewBox="0 0 146 146" xmlns="http://www.w3.org/2000/svg" font-family="Arial, sans-serif"><g stroke="#9ca3af" stroke-width="1"><line x1="26" y1="138" x2="26" y2="26" /><line x1="42" y1="138" x2="42" y2="26" /><line x1="58" y1="138" x2="58" y2="26" /><line x1="74" y1="138" x2="74" y2="26" /><line x1="90" y1="138" x2="90" y2="26" /><line x1="106" y1="138" x2="106" y2="26" /><line x1="122" y1="138" x2="122" y2="26" /><line x1="138" y1="138" x2="138" y2="26" /><line x1="26" y1="138" x2="138" y2="138" /><line x1="26" y1="122" x2="138" y2="122" /><line x1="26" y1="106" x2="138" y2="106" /><line x1="26" y1="90" x2="138" y2="90" /><line x1="26" y1="74" x2="138" y2="74" /><line x1="26" y1="58" x2="138" y2="58" /><line x1="26" y1="42" x2="138" y2="42" /><line x1="26" y1="26" x2="138" y2="26" /></g><g stroke="#0f1f3d" stroke-width="1.5"><line x1="26" y1="122" x2="138" y2="122" /><line x1="42" y1="138" x2="42" y2="26" /></g><g fill="#374151" font-size="9"><text x="26" y="134" text-anchor="middle">-1</text><text x="58" y="134" text-anchor="middle">1</text><text x="74" y="134" text-anchor="middle">2</text><text x="90" y="134" text-anchor="middle">3</text><text x="106" y="134" text-anchor="middle">4</text><text x="122" y="134" text-anchor="middle">5</text><text x="138" y="134" text-anchor="middle">6</text><text x="34" y="141" text-anchor="end">-1</text><text x="34" y="125" text-anchor="end">0</text><text x="34" y="109" text-anchor="end">1</text><text x="34" y="93" text-anchor="end">2</text><text x="34" y="77" text-anchor="end">3</text><text x="34" y="61" text-anchor="end">4</text><text x="34" y="45" text-anchor="end">5</text><text x="34" y="29" text-anchor="end">6</text></g><polygon points="58,106 122,106 122,42" fill="none" stroke="#0f1f3d" stroke-width="1.5" /><circle cx="58" cy="106" r="4" fill="#2563eb" stroke="#0f1f3d" stroke-width="1" /><circle cx="122" cy="106" r="4" fill="#2563eb" stroke="#0f1f3d" stroke-width="1" /><circle cx="122" cy="42" r="4" fill="#2563eb" stroke="#0f1f3d" stroke-width="1" /><text x="46" y="111" fill="#2563eb" font-weight="700" font-size="11" text-anchor="start">P(1,1)</text><text x="116" y="98" fill="#2563eb" font-weight="700" font-size="11" text-anchor="end">Q(5,1)</text><text x="116" y="56" fill="#2563eb" font-weight="700" font-size="11" text-anchor="end">R(5,5)</text></svg>` },

        // Block 6 — Angle at a vertex via inclination
        { difficulty: 'Hard', question: 'Given A(−2, 2), B(3, 2) and C(3, −2), determine the size of angle ABC, rounded to one decimal place.', checkMode: 'auto', options: ['45°', '180°', '90°', '51.5°'], correctIndex: 2, explanation: 'Gradient of BA: m₁ = (2 − 2)/(−2 − 3) = 0 (horizontal). Gradient of BC: m₂ = (−2 − 2)/(3 − 3) = undefined (vertical). Since BA is horizontal and BC is vertical, BA ⊥ BC. Therefore angle ABC = 90.0° ✓ (45° halves the angle incorrectly; 180° confuses the angle with a straight line; 51.5° is copied from a different vertex-angle calculation.)' },
        { difficulty: 'Hard', question: 'A(−2, 2), B(3, 2) and C(3, −2) are plotted on the Cartesian plane, forming triangle ABC with a right angle at B. Given that AB = 5 and BC = 4, calculate the length of AC.', checkMode: 'auto', options: ['9', '1', '√9', '√41'], correctIndex: 3, explanation: 'AC = √[(3 − (−2))² + (−2 − 2)²] = √[25 + 16] = √41 ≈ 6.40 ✓ (9 wrongly adds AB + BC instead of using Pythagoras; 1 wrongly subtracts BC from AB; √9 comes from squaring the difference of the two lengths instead of the coordinate differences.)', diagramSvg: `<svg viewBox="0 0 146 130" xmlns="http://www.w3.org/2000/svg" font-family="Arial, sans-serif"><g stroke="#9ca3af" stroke-width="1"><line x1="26" y1="122" x2="26" y2="26" /><line x1="42" y1="122" x2="42" y2="26" /><line x1="58" y1="122" x2="58" y2="26" /><line x1="74" y1="122" x2="74" y2="26" /><line x1="90" y1="122" x2="90" y2="26" /><line x1="106" y1="122" x2="106" y2="26" /><line x1="122" y1="122" x2="122" y2="26" /><line x1="138" y1="122" x2="138" y2="26" /><line x1="26" y1="122" x2="138" y2="122" /><line x1="26" y1="106" x2="138" y2="106" /><line x1="26" y1="90" x2="138" y2="90" /><line x1="26" y1="74" x2="138" y2="74" /><line x1="26" y1="58" x2="138" y2="58" /><line x1="26" y1="42" x2="138" y2="42" /><line x1="26" y1="26" x2="138" y2="26" /></g><g stroke="#0f1f3d" stroke-width="1.5"><line x1="26" y1="74" x2="138" y2="74" /><line x1="74" y1="122" x2="74" y2="26" /></g><g fill="#374151" font-size="9"><text x="26" y="86" text-anchor="middle">-3</text><text x="42" y="86" text-anchor="middle">-2</text><text x="58" y="86" text-anchor="middle">-1</text><text x="90" y="86" text-anchor="middle">1</text><text x="106" y="86" text-anchor="middle">2</text><text x="122" y="86" text-anchor="middle">3</text><text x="138" y="86" text-anchor="middle">4</text><text x="66" y="125" text-anchor="end">-3</text><text x="66" y="109" text-anchor="end">-2</text><text x="66" y="93" text-anchor="end">-1</text><text x="66" y="77" text-anchor="end">0</text><text x="66" y="61" text-anchor="end">1</text><text x="66" y="45" text-anchor="end">2</text><text x="66" y="29" text-anchor="end">3</text></g><polygon points="42,42 122,42 122,106" fill="none" stroke="#0f1f3d" stroke-width="1.5" /><circle cx="42" cy="42" r="4" fill="#2563eb" stroke="#0f1f3d" stroke-width="1" /><circle cx="122" cy="42" r="4" fill="#2563eb" stroke="#0f1f3d" stroke-width="1" /><circle cx="122" cy="106" r="4" fill="#2563eb" stroke="#0f1f3d" stroke-width="1" /><text x="48" y="56" fill="#2563eb" font-weight="700" font-size="11" text-anchor="start">A(-2,2)</text><text x="116" y="56" fill="#2563eb" font-weight="700" font-size="11" text-anchor="end">B(3,2)</text><text x="128" y="118" fill="#2563eb" font-weight="700" font-size="11" text-anchor="end">C(3,-2)</text></svg>` },
      ],
      scoreMessages: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // Block 1 — Distance / gradient / midpoint revision
        { difficulty: 'Easy', question: 'Given A(2, 1) and B(6, 4), calculate the distance AB.', checkMode: 'auto', options: ['5', '7', '25', '4'], correctIndex: 0, explanation: 'd = √[(6 − 2)² + (4 − 1)²] = √[16 + 9] = √25 = 5 ✓ (7 wrongly adds the horizontal and vertical differences instead of using Pythagoras; 25 forgets to take the square root; 4 uses only the horizontal difference.)' },
        { difficulty: 'Easy', question: 'Given A(2, 1) and C(2, 4), calculate the gradient of AC.', checkMode: 'auto', options: ['0', 'undefined', '3', '1/3'], correctIndex: 1, explanation: 'm = (4 − 1)/(2 − 2) = 3/0 = undefined (vertical line) ✓ (0 comes from flipping the gradient formula upside down; 3 mistakes the numerator for the answer; 1/3 inverts the fraction.)' },
        { difficulty: 'Medium', question: 'A(2, 1), B(6, 4) and C(2, 4) are plotted on the Cartesian plane, forming triangle ABC. Determine the midpoint of BC.', checkMode: 'auto', options: ['(8, 8)', '(4, 0)', '(4, 4)', '(6, 4)'], correctIndex: 2, explanation: 'M = ((6 + 2)/2, (4 + 4)/2) = (8/2, 8/2) = (4, 4) ✓ ((8, 8) forgets to divide the sums by 2; (4, 0) uses the difference of the coordinates instead of their sum; (6, 4) only averages the y-coordinate and leaves the x-coordinate unchanged.)', diagramSvg: `<svg viewBox="0 0 162 130" xmlns="http://www.w3.org/2000/svg" font-family="Arial, sans-serif"><g stroke="#9ca3af" stroke-width="1"><line x1="26" y1="122" x2="26" y2="26" /><line x1="42" y1="122" x2="42" y2="26" /><line x1="58" y1="122" x2="58" y2="26" /><line x1="74" y1="122" x2="74" y2="26" /><line x1="90" y1="122" x2="90" y2="26" /><line x1="106" y1="122" x2="106" y2="26" /><line x1="122" y1="122" x2="122" y2="26" /><line x1="138" y1="122" x2="138" y2="26" /><line x1="154" y1="122" x2="154" y2="26" /><line x1="26" y1="122" x2="154" y2="122" /><line x1="26" y1="106" x2="154" y2="106" /><line x1="26" y1="90" x2="154" y2="90" /><line x1="26" y1="74" x2="154" y2="74" /><line x1="26" y1="58" x2="154" y2="58" /><line x1="26" y1="42" x2="154" y2="42" /><line x1="26" y1="26" x2="154" y2="26" /></g><g stroke="#0f1f3d" stroke-width="1.5"><line x1="26" y1="106" x2="154" y2="106" /><line x1="42" y1="122" x2="42" y2="26" /></g><g fill="#374151" font-size="9"><text x="26" y="118" text-anchor="middle">-1</text><text x="58" y="118" text-anchor="middle">1</text><text x="74" y="118" text-anchor="middle">2</text><text x="90" y="118" text-anchor="middle">3</text><text x="106" y="118" text-anchor="middle">4</text><text x="122" y="118" text-anchor="middle">5</text><text x="138" y="118" text-anchor="middle">6</text><text x="154" y="118" text-anchor="middle">7</text><text x="34" y="125" text-anchor="end">-1</text><text x="34" y="109" text-anchor="end">0</text><text x="34" y="93" text-anchor="end">1</text><text x="34" y="77" text-anchor="end">2</text><text x="34" y="61" text-anchor="end">3</text><text x="34" y="45" text-anchor="end">4</text><text x="34" y="29" text-anchor="end">5</text></g><polygon points="74,90 138,42 74,42" fill="none" stroke="#0f1f3d" stroke-width="1.5" /><circle cx="74" cy="90" r="4" fill="#2563eb" stroke="#0f1f3d" stroke-width="1" /><circle cx="138" cy="42" r="4" fill="#2563eb" stroke="#0f1f3d" stroke-width="1" /><circle cx="74" cy="42" r="4" fill="#2563eb" stroke="#0f1f3d" stroke-width="1" /><text x="68" y="102" fill="#2563eb" font-weight="700" font-size="11" text-anchor="start">A(2,1)</text><text x="132" y="56" fill="#2563eb" font-weight="700" font-size="11" text-anchor="end">B(6,4)</text><text x="80" y="56" fill="#2563eb" font-weight="700" font-size="11" text-anchor="start">C(2,4)</text></svg>` },

        // Block 2 — Equation of a line through two points
        { difficulty: 'Easy', question: 'Find the equation of the line through (0, 2) and (3, 8).', checkMode: 'auto', options: ['y = 2x - 2', 'y = 2x + 8', 'y = 3x + 2', 'y = 2x + 2'], correctIndex: 3, explanation: 'm = (8 − 2)/(3 − 0) = 6/3 = 2. Substitute (0, 2): y − 2 = 2(x − 0) → y = 2x + 2 ✓ (y = 2x − 2 flips the sign of the intercept; y = 2x + 8 misreads the y-value at x = 0; y = 3x + 2 divides the differences the wrong way round.)' },
        { difficulty: 'Easy', question: 'Find the equation of the line through (2, 3) and (5, 9).', checkMode: 'auto', options: ['y = 2x - 1', 'y = 2x + 1', 'y = 2x - 4', 'y = 3x - 1'], correctIndex: 0, explanation: 'm = (9 − 3)/(5 − 2) = 6/3 = 2. Substitute (2, 3): y − 3 = 2(x − 2) → y = 2x − 1 ✓ (y = 2x + 1 flips the sign of the intercept; y = 2x − 4 forgets to add y₁ back in; y = 3x − 1 miscalculates the gradient.)' },
        { difficulty: 'Medium', question: 'Find the equation of the line through (−2, 8) and (4, −4).', checkMode: 'auto', options: ['y = 2x + 4', 'y = -2x + 4', 'y = -2x - 4', 'y = -2x + 8'], correctIndex: 1, explanation: 'm = (−4 − 8)/(4 − (−2)) = −12/6 = −2. Substitute (4, −4): y − (−4) = −2(x − 4) → y + 4 = −2x + 8 → y = −2x + 4 ✓ (y = 2x + 4 flips the sign of the gradient; y = -2x - 4 flips the sign of the intercept; y = -2x + 8 forgets to subtract the 4.)' },
        { difficulty: 'Medium', question: 'Find the equation of the line through (5, 1) and (5, 7).', checkMode: 'auto', options: ['y = 5', 'y = 4', 'x = 5', 'undefined (no equation)'], correctIndex: 2, explanation: 'Both points share the x-coordinate 5, so the gradient is undefined and the line is vertical: x = 5 ✓ (y = 5 mixes up the vertical line with a horizontal one; y = 4 wrongly treats it as horizontal at the average y-value; stopping at "undefined" never writes the actual line equation.)' },

        // Block 3 — Parallel and perpendicular lines
        { difficulty: 'Easy', question: 'Write down the gradient of a line parallel to y = 4x + 1.', checkMode: 'auto', options: ['-1/4', '1/4', '-4', '4'], correctIndex: 3, explanation: 'Parallel lines have equal gradients. The gradient of y = 4x + 1 is m = 4, so a parallel line also has m = 4 ✓ (-1/4 and 1/4 wrongly apply the perpendicular rule instead of the parallel rule; -4 flips the sign.)' },
        { difficulty: 'Easy', question: 'Write down the gradient of a line perpendicular to y = 2/5x - 3.', checkMode: 'auto', options: ['-5/2', '2/5', '5/2', '-2/5'], correctIndex: 0, explanation: 'For perpendicular lines, m₁ × m₂ = −1.\nGiven m₁ = 2/5: m₂ = −1 ÷ (2/5) = −5/2 ✓ (2/5 copies the given gradient as if the lines were parallel; 5/2 drops the sign; -2/5 makes a sign error on the reciprocal.)' },
        { difficulty: 'Medium', question: 'Find the equation of the line through (0, −5) parallel to y = 4x + 2.', checkMode: 'auto', options: ['y = 4x + 2', 'y = 4x - 5', 'y = -1/4x - 5', 'y = 4x + 5'], correctIndex: 1, explanation: 'Gradient: m = 4 (same as parallel line).\nSubstitute (0, −5): y − (−5) = 4(x − 0) → y = 4x − 5 ✓ (y = 4x + 2 reuses the given line without substituting the new point; y = -1/4x - 5 wrongly uses the perpendicular gradient; y = 4x + 5 flips the sign of the intercept.)' },
        { difficulty: 'Hard', question: 'Find the equation of the line through (2, 5) perpendicular to y = 2/5x + 1.', checkMode: 'auto', options: ['y = 2/5x + 10', 'y = -5/2x + 5', 'y = -5/2x + 10', 'y = -5/2x - 10'], correctIndex: 2, explanation: 'Gradient of given line: m₁ = 2/5.\nPerpendicular gradient: m₂ = −5/2.\nSubstitute (2, 5): y − 5 = −5/2(x − 2) → y − 5 = −5/2x + 5 → y = −5/2x + 10 ✓ (y = 2/5x + 10 forgets to apply the perpendicular rule; y = -5/2x + 5 forgets to add the 5 back; y = -5/2x - 10 flips the sign of the intercept.)' },

        // Block 4 — Inclination of a line
        { difficulty: 'Easy', question: 'Determine the inclination of a line with gradient m = 1.7321, rounded to the nearest degree.', checkMode: 'auto', options: ['30', '150', '58', '60'], correctIndex: 3, explanation: 'tan θ = 1.7321 → θ = tan⁻¹(1.7321) ≈ 60°. Gradient is positive so no correction needed. θ ≈ 60° ✓ (30 confuses the angle with its complement; 150 wrongly adds 180° to a positive gradient; 58 is a rounding slip.)' },
        { difficulty: 'Medium', question: 'Determine the inclination of a line with gradient m = 0.3640, rounded to the nearest degree.', checkMode: 'auto', options: ['20', '70', '200', '19'], correctIndex: 0, explanation: 'θ = tan⁻¹(0.3640) ≈ 20° ✓ (70 is the complementary angle 90° − 20°; 200 wrongly adds 180° even though the gradient is positive; 19 is a rounding slip.)' },
        { difficulty: 'Medium', question: 'Determine the inclination of a line with gradient m = −2.9042, rounded to the nearest degree.', checkMode: 'auto', options: ['-71', '109', '71', '19'], correctIndex: 1, explanation: 'θ = tan⁻¹(−2.9042) ≈ −71°. Since the gradient is negative, add 180°: θ = −71° + 180° = 109° ✓ (-71 forgets to add 180°; 71 drops the negative sign; 19 confuses the angle with its complement.)' },
        { difficulty: 'Hard', question: 'Determine the gradient of a line with inclination 40°, rounded to two decimal places.', checkMode: 'auto', options: ['1.19', '-0.84', '0.84', '0.64'], correctIndex: 2, explanation: 'm = tan(40°) ≈ 0.84 ✓ (1.19 uses 1/tan(40°) instead of tan(40°); -0.84 wrongly assumes the angle is obtuse; 0.64 comes from using sin(40°) instead of tan(40°).)' },

        // Block 5 — Right-angle / isosceles triangle proofs
        { difficulty: 'Medium', question: 'Given A(0, 0), B(6, 0) and C(6, 3), at which vertex is triangle ABC right-angled?', checkMode: 'auto', options: ['A', 'C', 'Not right-angled', 'B'], correctIndex: 3, explanation: 'Gradient of AB: m₁ = (0 − 0)/(6 − 0) = 0 (horizontal). Gradient of BC: m₂ = (3 − 0)/(6 − 6) = undefined (vertical). A horizontal line is perpendicular to a vertical line, so AB ⊥ BC. Therefore triangle ABC is right-angled at B ✓ (A and C misread which two sides meet at the right angle; claiming it is not right-angled ignores that a horizontal and a vertical line are always perpendicular.)' },
        { difficulty: 'Medium', question: 'Given P(2, 2) and Q(6, 2), calculate the length of PQ.', checkMode: 'auto', options: ['4', '16', '0', '8'], correctIndex: 0, explanation: 'PQ = √[(6 − 2)² + (2 − 2)²] = √[16 + 0] = √16 = 4 ✓ (16 forgets to take the square root; 0 wrongly uses the y-difference since the segment is horizontal; 8 doubles the coordinate difference.)' },
        { difficulty: 'Hard', question: 'P(2, 2), Q(6, 2) and R(6, 6) are plotted on the Cartesian plane, forming triangle PQR. Given that PQ = 4 and QR = 4, calculate PR and hence state whether triangle PQR is isosceles.', checkMode: 'auto', options: ['PR = 4; triangle PQR is equilateral', 'PR = 4√2; triangle PQR is isosceles (PQ = QR)', 'PR = 8; triangle PQR is not isosceles', 'PR = 4√2; triangle PQR is scalene'], correctIndex: 1, explanation: 'PR = √[(6 − 2)² + (6 − 2)²] = √[16 + 16] = √32 = 4√2.\nSince PQ = QR = 4 and PR = 4√2, exactly two sides are equal, so triangle PQR is isosceles ✓ (PR = 4 wrongly assumes all three sides match; PR = 8 adds instead of using Pythagoras; the last option gets PR right but misclassifies the triangle as scalene despite two equal sides.)', diagramSvg: `<svg viewBox="0 0 162 162" xmlns="http://www.w3.org/2000/svg" font-family="Arial, sans-serif"><g stroke="#9ca3af" stroke-width="1"><line x1="26" y1="154" x2="26" y2="26" /><line x1="42" y1="154" x2="42" y2="26" /><line x1="58" y1="154" x2="58" y2="26" /><line x1="74" y1="154" x2="74" y2="26" /><line x1="90" y1="154" x2="90" y2="26" /><line x1="106" y1="154" x2="106" y2="26" /><line x1="122" y1="154" x2="122" y2="26" /><line x1="138" y1="154" x2="138" y2="26" /><line x1="154" y1="154" x2="154" y2="26" /><line x1="26" y1="154" x2="154" y2="154" /><line x1="26" y1="138" x2="154" y2="138" /><line x1="26" y1="122" x2="154" y2="122" /><line x1="26" y1="106" x2="154" y2="106" /><line x1="26" y1="90" x2="154" y2="90" /><line x1="26" y1="74" x2="154" y2="74" /><line x1="26" y1="58" x2="154" y2="58" /><line x1="26" y1="42" x2="154" y2="42" /><line x1="26" y1="26" x2="154" y2="26" /></g><g stroke="#0f1f3d" stroke-width="1.5"><line x1="26" y1="138" x2="154" y2="138" /><line x1="42" y1="154" x2="42" y2="26" /></g><g fill="#374151" font-size="9"><text x="26" y="150" text-anchor="middle">-1</text><text x="58" y="150" text-anchor="middle">1</text><text x="74" y="150" text-anchor="middle">2</text><text x="90" y="150" text-anchor="middle">3</text><text x="106" y="150" text-anchor="middle">4</text><text x="122" y="150" text-anchor="middle">5</text><text x="138" y="150" text-anchor="middle">6</text><text x="154" y="150" text-anchor="middle">7</text><text x="34" y="157" text-anchor="end">-1</text><text x="34" y="141" text-anchor="end">0</text><text x="34" y="125" text-anchor="end">1</text><text x="34" y="109" text-anchor="end">2</text><text x="34" y="93" text-anchor="end">3</text><text x="34" y="77" text-anchor="end">4</text><text x="34" y="61" text-anchor="end">5</text><text x="34" y="45" text-anchor="end">6</text><text x="34" y="29" text-anchor="end">7</text></g><polygon points="74,106 138,106 138,42" fill="none" stroke="#0f1f3d" stroke-width="1.5" /><circle cx="74" cy="106" r="4" fill="#2563eb" stroke="#0f1f3d" stroke-width="1" /><circle cx="138" cy="106" r="4" fill="#2563eb" stroke="#0f1f3d" stroke-width="1" /><circle cx="138" cy="42" r="4" fill="#2563eb" stroke="#0f1f3d" stroke-width="1" /><text x="62" y="111" fill="#2563eb" font-weight="700" font-size="11" text-anchor="start">P(2,2)</text><text x="132" y="98" fill="#2563eb" font-weight="700" font-size="11" text-anchor="end">Q(6,2)</text><text x="132" y="56" fill="#2563eb" font-weight="700" font-size="11" text-anchor="end">R(6,6)</text></svg>` },

        // Block 6 — Angle at a vertex via inclination
        { difficulty: 'Hard', question: 'Given A(−1, 3), B(4, 3) and C(4, −1), determine the size of angle ABC, rounded to one decimal place.', checkMode: 'auto', options: ['45°', '180°', '90°', '51.5°'], correctIndex: 2, explanation: 'Gradient of BA: m₁ = (3 − 3)/(−1 − 4) = 0 (horizontal). Gradient of BC: m₂ = (−1 − 3)/(4 − 4) = undefined (vertical). Since BA is horizontal and BC is vertical, BA ⊥ BC. Therefore angle ABC = 90.0° ✓ (45° halves the angle incorrectly; 180° confuses the angle with a straight line; 51.5° is copied from a different vertex-angle calculation.)' },
        { difficulty: 'Hard', question: 'A(−1, 3), B(4, 3) and C(4, −1) are plotted on the Cartesian plane, forming triangle ABC with a right angle at B. Given that AB = 5 and BC = 4, calculate the length of AC.', checkMode: 'auto', options: ['9', '1', '√9', '√41'], correctIndex: 3, explanation: 'AC = √[(4 − (−1))² + (−1 − 3)²] = √[25 + 16] = √41 ≈ 6.40 ✓ (9 wrongly adds AB + BC instead of using Pythagoras; 1 wrongly subtracts BC from AB; √9 comes from squaring the difference of the two lengths instead of the coordinate differences.)', diagramSvg: `<svg viewBox="0 0 146 130" xmlns="http://www.w3.org/2000/svg" font-family="Arial, sans-serif"><g stroke="#9ca3af" stroke-width="1"><line x1="26" y1="122" x2="26" y2="26" /><line x1="42" y1="122" x2="42" y2="26" /><line x1="58" y1="122" x2="58" y2="26" /><line x1="74" y1="122" x2="74" y2="26" /><line x1="90" y1="122" x2="90" y2="26" /><line x1="106" y1="122" x2="106" y2="26" /><line x1="122" y1="122" x2="122" y2="26" /><line x1="138" y1="122" x2="138" y2="26" /><line x1="26" y1="122" x2="138" y2="122" /><line x1="26" y1="106" x2="138" y2="106" /><line x1="26" y1="90" x2="138" y2="90" /><line x1="26" y1="74" x2="138" y2="74" /><line x1="26" y1="58" x2="138" y2="58" /><line x1="26" y1="42" x2="138" y2="42" /><line x1="26" y1="26" x2="138" y2="26" /></g><g stroke="#0f1f3d" stroke-width="1.5"><line x1="26" y1="90" x2="138" y2="90" /><line x1="58" y1="122" x2="58" y2="26" /></g><g fill="#374151" font-size="9"><text x="26" y="102" text-anchor="middle">-2</text><text x="42" y="102" text-anchor="middle">-1</text><text x="74" y="102" text-anchor="middle">1</text><text x="90" y="102" text-anchor="middle">2</text><text x="106" y="102" text-anchor="middle">3</text><text x="122" y="102" text-anchor="middle">4</text><text x="138" y="102" text-anchor="middle">5</text><text x="50" y="125" text-anchor="end">-2</text><text x="50" y="109" text-anchor="end">-1</text><text x="50" y="93" text-anchor="end">0</text><text x="50" y="77" text-anchor="end">1</text><text x="50" y="61" text-anchor="end">2</text><text x="50" y="45" text-anchor="end">3</text><text x="50" y="29" text-anchor="end">4</text></g><polygon points="42,42 122,42 122,106" fill="none" stroke="#0f1f3d" stroke-width="1.5" /><circle cx="42" cy="42" r="4" fill="#2563eb" stroke="#0f1f3d" stroke-width="1" /><circle cx="122" cy="42" r="4" fill="#2563eb" stroke="#0f1f3d" stroke-width="1" /><circle cx="122" cy="106" r="4" fill="#2563eb" stroke="#0f1f3d" stroke-width="1" /><text x="48" y="56" fill="#2563eb" font-weight="700" font-size="11" text-anchor="start">A(-1,3)</text><text x="116" y="56" fill="#2563eb" font-weight="700" font-size="11" text-anchor="end">B(4,3)</text><text x="128" y="118" fill="#2563eb" font-weight="700" font-size="11" text-anchor="end">C(4,-1)</text></svg>` },
      ],
      scoreMessages: [
        { minScore: 17, message: 'Outstanding! You have mastered lines, gradients, inclination and triangle proofs. Excellent work!' },
        { minScore: 13, message: 'Great work! Review any missed questions on inclination or the mixed triangle applications and try again.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // Block 1 — Distance / gradient / midpoint revision
        { difficulty: 'Easy', question: 'Given A(0, 3) and B(3, 7), calculate the distance AB.', checkMode: 'auto', options: ['5', '7', '25', '3'], correctIndex: 0, explanation: 'd = √[(3 − 0)² + (7 − 3)²] = √[9 + 16] = √25 = 5 ✓ (7 wrongly adds the horizontal and vertical differences instead of using Pythagoras; 25 forgets to take the square root; 3 uses only the horizontal difference.)' },
        { difficulty: 'Easy', question: 'Given A(0, 3) and C(3, 3), calculate the gradient of AC.', checkMode: 'auto', options: ['undefined', '0', '3', '1/3'], correctIndex: 1, explanation: 'm = (3 − 3)/(3 − 0) = 0/3 = 0 ✓ (undefined flips the gradient formula upside down; 3 mistakes the denominator for the answer; 1/3 inverts the correct fraction.)' },
        { difficulty: 'Medium', question: 'A(0, 3), B(3, 7) and C(3, 3) are plotted on the Cartesian plane, forming triangle ABC. Determine the midpoint of BC.', checkMode: 'auto', options: ['(3, 10)', '(6, 5)', '(3, 5)', '(0, 5)'], correctIndex: 2, explanation: 'M = ((3 + 3)/2, (7 + 3)/2) = (6/2, 10/2) = (3, 5) ✓ ((3, 10) forgets to halve the y-sum; (6, 5) forgets to halve the x-sum; (0, 5) uses the difference of the x-coordinates instead of their sum.)', diagramSvg: `<svg viewBox="0 0 114 178" xmlns="http://www.w3.org/2000/svg" font-family="Arial, sans-serif"><g stroke="#9ca3af" stroke-width="1"><line x1="26" y1="170" x2="26" y2="26" /><line x1="42" y1="170" x2="42" y2="26" /><line x1="58" y1="170" x2="58" y2="26" /><line x1="74" y1="170" x2="74" y2="26" /><line x1="90" y1="170" x2="90" y2="26" /><line x1="106" y1="170" x2="106" y2="26" /><line x1="26" y1="170" x2="106" y2="170" /><line x1="26" y1="154" x2="106" y2="154" /><line x1="26" y1="138" x2="106" y2="138" /><line x1="26" y1="122" x2="106" y2="122" /><line x1="26" y1="106" x2="106" y2="106" /><line x1="26" y1="90" x2="106" y2="90" /><line x1="26" y1="74" x2="106" y2="74" /><line x1="26" y1="58" x2="106" y2="58" /><line x1="26" y1="42" x2="106" y2="42" /><line x1="26" y1="26" x2="106" y2="26" /></g><g stroke="#0f1f3d" stroke-width="1.5"><line x1="26" y1="154" x2="106" y2="154" /><line x1="42" y1="170" x2="42" y2="26" /></g><g fill="#374151" font-size="9"><text x="26" y="166" text-anchor="middle">-1</text><text x="58" y="166" text-anchor="middle">1</text><text x="74" y="166" text-anchor="middle">2</text><text x="90" y="166" text-anchor="middle">3</text><text x="106" y="166" text-anchor="middle">4</text><text x="34" y="173" text-anchor="end">-1</text><text x="34" y="157" text-anchor="end">0</text><text x="34" y="141" text-anchor="end">1</text><text x="34" y="125" text-anchor="end">2</text><text x="34" y="109" text-anchor="end">3</text><text x="34" y="93" text-anchor="end">4</text><text x="34" y="77" text-anchor="end">5</text><text x="34" y="61" text-anchor="end">6</text><text x="34" y="45" text-anchor="end">7</text><text x="34" y="29" text-anchor="end">8</text></g><polygon points="42,106 90,42 90,106" fill="none" stroke="#0f1f3d" stroke-width="1.5" /><circle cx="42" cy="106" r="4" fill="#2563eb" stroke="#0f1f3d" stroke-width="1" /><circle cx="90" cy="42" r="4" fill="#2563eb" stroke="#0f1f3d" stroke-width="1" /><circle cx="90" cy="106" r="4" fill="#2563eb" stroke="#0f1f3d" stroke-width="1" /><text x="30" y="112" fill="#2563eb" font-weight="700" font-size="11" text-anchor="start">A(0,3)</text><text x="84" y="56" fill="#2563eb" font-weight="700" font-size="11" text-anchor="end">B(3,7)</text><text x="84" y="98" fill="#2563eb" font-weight="700" font-size="11" text-anchor="end">C(3,3)</text></svg>` },

        // Block 2 — Equation of a line through two points
        { difficulty: 'Easy', question: 'Find the equation of the line through (0, 1) and (4, 9).', checkMode: 'auto', options: ['y = 2x - 1', 'y = 9x + 1', 'y = 4x + 1', 'y = 2x + 1'], correctIndex: 3, explanation: 'm = (9 − 1)/(4 − 0) = 8/4 = 2. Substitute (0, 1): y − 1 = 2(x − 0) → y = 2x + 1 ✓ (y = 2x − 1 flips the sign of the intercept; y = 9x + 1 swaps the gradient and intercept; y = 4x + 1 miscalculates the gradient by using the wrong denominator.)' },
        { difficulty: 'Easy', question: 'Find the equation of the line through (1, 4) and (3, 10).', checkMode: 'auto', options: ['y = 3x + 1', 'y = 3x - 1', 'y = 3x - 3', 'y = 2x + 1'], correctIndex: 0, explanation: 'm = (10 − 4)/(3 − 1) = 6/2 = 3. Substitute (1, 4): y − 4 = 3(x − 1) → y = 3x + 1 ✓ (y = 3x − 1 flips the sign of the intercept; y = 3x − 3 forgets to add the 4 back in; y = 2x + 1 miscalculates the gradient.)' },
        { difficulty: 'Medium', question: 'Find the equation of the line through (−4, 7) and (2, −5).', checkMode: 'auto', options: ['y = 2x - 1', 'y = -2x - 1', 'y = -2x + 1', 'y = -2x - 4'], correctIndex: 1, explanation: 'm = (−5 − 7)/(2 − (−4)) = −12/6 = −2. Substitute (2, −5): y − (−5) = −2(x − 2) → y + 5 = −2x + 4 → y = −2x − 1 ✓ (y = 2x − 1 flips the sign of the gradient; y = -2x + 1 flips the sign of the intercept; y = -2x - 4 makes an arithmetic slip.)' },
        { difficulty: 'Medium', question: 'Find the equation of the line through (−1, 3) and (−1, 9).', checkMode: 'auto', options: ['y = -1', 'y = 6', 'x = -1', 'undefined (no equation)'], correctIndex: 2, explanation: 'Both points share the x-coordinate −1, so the gradient is undefined and the line is vertical: x = −1 ✓ (y = -1 mixes up the vertical line with a horizontal one; y = 6 wrongly treats it as horizontal at the average y-value; stopping at "undefined" never writes the actual line equation.)' },

        // Block 3 — Parallel and perpendicular lines
        { difficulty: 'Easy', question: 'Write down the gradient of a line parallel to y = -3x + 7.', checkMode: 'auto', options: ['1/3', '3', '-1/3', '-3'], correctIndex: 3, explanation: 'Parallel lines have equal gradients. The gradient of y = −3x + 7 is m = −3, so a parallel line also has m = −3 ✓ (1/3 and -1/3 wrongly apply the perpendicular rule instead of the parallel rule; 3 flips the sign.)' },
        { difficulty: 'Easy', question: 'Write down the gradient of a line perpendicular to y = 3/4x - 6.', checkMode: 'auto', options: ['-4/3', '3/4', '4/3', '-3/4'], correctIndex: 0, explanation: 'For perpendicular lines, m₁ × m₂ = −1.\nGiven m₁ = 3/4: m₂ = −1 ÷ (3/4) = −4/3 ✓ (3/4 copies the given gradient as if the lines were parallel; 4/3 drops the sign; -3/4 makes a sign error on the reciprocal.)' },
        { difficulty: 'Medium', question: 'Find the equation of the line through (0, 2) parallel to y = -3x - 1.', checkMode: 'auto', options: ['y = -3x - 1', 'y = -3x + 2', 'y = 1/3x + 2', 'y = -3x - 2'], correctIndex: 1, explanation: 'Gradient: m = −3 (same as parallel line).\nSubstitute (0, 2): y − 2 = −3(x − 0) → y = −3x + 2 ✓ (y = -3x - 1 reuses the given line without substituting the new point; y = 1/3x + 2 wrongly uses the perpendicular gradient; y = -3x - 2 flips the sign of the intercept.)' },
        { difficulty: 'Hard', question: 'Find the equation of the line through (3, 2) perpendicular to y = 3/4x + 5.', checkMode: 'auto', options: ['y = 3/4x + 6', 'y = -4/3x + 4', 'y = -4/3x + 6', 'y = -4/3x - 6'], correctIndex: 2, explanation: 'Gradient of given line: m₁ = 3/4.\nPerpendicular gradient: m₂ = −4/3.\nSubstitute (3, 2): y − 2 = −4/3(x − 3) → y − 2 = −4/3x + 4 → y = −4/3x + 6 ✓ (y = 3/4x + 6 forgets to apply the perpendicular rule; y = -4/3x + 4 forgets to add the 2 back; y = -4/3x - 6 flips the sign of the intercept.)' },

        // Block 4 — Inclination of a line
        { difficulty: 'Easy', question: 'Determine the inclination of a line with gradient m = 0.5, rounded to two decimal places.', checkMode: 'auto', options: ['63.43', '206.57', '25.5', '26.57'], correctIndex: 3, explanation: 'tan θ = 0.5 → θ = tan⁻¹(0.5) ≈ 26.57°. Gradient is positive so no correction needed. θ ≈ 26.57° ✓ (63.43 is the complementary angle 90° − 26.57°; 206.57 wrongly adds 180° to a positive gradient; 25.5 is a rounding slip.)' },
        { difficulty: 'Medium', question: 'Determine the inclination of a line with gradient m = 1.1918, rounded to the nearest degree.', checkMode: 'auto', options: ['50', '40', '230', '49'], correctIndex: 0, explanation: 'θ = tan⁻¹(1.1918) ≈ 50° ✓ (40 is the complementary angle 90° − 50°; 230 wrongly adds 180° even though the gradient is positive; 49 is a rounding slip.)' },
        { difficulty: 'Medium', question: 'Determine the inclination of a line with gradient m = −0.2679, rounded to the nearest degree.', checkMode: 'auto', options: ['-15', '165', '15', '75'], correctIndex: 1, explanation: 'θ = tan⁻¹(−0.2679) ≈ −15°. Since the gradient is negative, add 180°: θ = −15° + 180° = 165° ✓ (-15 forgets to add 180°; 15 drops the negative sign; 75 confuses the angle with its complement.)' },
        { difficulty: 'Hard', question: 'Determine the gradient of a line with inclination 104°, rounded to two decimal places.', checkMode: 'auto', options: ['4.01', '0.25', '-4.01', '3.49'], correctIndex: 2, explanation: 'm = tan(104°) ≈ −4.01 ✓ (4.01 forgets that an obtuse inclination gives a negative gradient; 0.25 uses 1/tan(104°) instead of tan(104°); 3.49 comes from using the complementary angle 74° instead of 104°.)' },

        // Block 5 — Right-angle / isosceles triangle proofs
        { difficulty: 'Medium', question: 'Given A(0, 0), B(4, 0) and C(4, 6), at which vertex is triangle ABC right-angled?', checkMode: 'auto', options: ['A', 'C', 'Not right-angled', 'B'], correctIndex: 3, explanation: 'Gradient of AB: m₁ = (0 − 0)/(4 − 0) = 0 (horizontal). Gradient of BC: m₂ = (6 − 0)/(4 − 4) = undefined (vertical). A horizontal line is perpendicular to a vertical line, so AB ⊥ BC. Therefore triangle ABC is right-angled at B ✓ (A and C misread which two sides meet at the right angle; claiming it is not right-angled ignores that a horizontal and a vertical line are always perpendicular.)' },
        { difficulty: 'Medium', question: 'Given P(0, 0) and Q(4, 0), calculate the length of PQ.', checkMode: 'auto', options: ['4', '16', '0', '8'], correctIndex: 0, explanation: 'PQ = √[(4 − 0)² + (0 − 0)²] = √[16 + 0] = √16 = 4 ✓ (16 forgets to take the square root; 0 wrongly uses the y-difference since the segment is horizontal; 8 doubles the coordinate difference.)' },
        { difficulty: 'Hard', question: 'P(0, 0), Q(4, 0) and R(4, 4) are plotted on the Cartesian plane, forming triangle PQR. Given that PQ = 4 and QR = 4, calculate PR and hence state whether triangle PQR is isosceles.', checkMode: 'auto', options: ['PR = 4; triangle PQR is equilateral', 'PR = 4√2; triangle PQR is isosceles (PQ = QR)', 'PR = 8; triangle PQR is not isosceles', 'PR = 4√2; triangle PQR is scalene'], correctIndex: 1, explanation: 'PR = √[(4 − 0)² + (4 − 0)²] = √[16 + 16] = √32 = 4√2.\nSince PQ = QR = 4 and PR = 4√2, exactly two sides are equal, so triangle PQR is isosceles ✓ (PR = 4 wrongly assumes all three sides match; PR = 8 adds instead of using Pythagoras; the last option gets PR right but misclassifies the triangle as scalene despite two equal sides.)', diagramSvg: `<svg viewBox="0 0 130 130" xmlns="http://www.w3.org/2000/svg" font-family="Arial, sans-serif"><g stroke="#9ca3af" stroke-width="1"><line x1="26" y1="122" x2="26" y2="26" /><line x1="42" y1="122" x2="42" y2="26" /><line x1="58" y1="122" x2="58" y2="26" /><line x1="74" y1="122" x2="74" y2="26" /><line x1="90" y1="122" x2="90" y2="26" /><line x1="106" y1="122" x2="106" y2="26" /><line x1="122" y1="122" x2="122" y2="26" /><line x1="26" y1="122" x2="122" y2="122" /><line x1="26" y1="106" x2="122" y2="106" /><line x1="26" y1="90" x2="122" y2="90" /><line x1="26" y1="74" x2="122" y2="74" /><line x1="26" y1="58" x2="122" y2="58" /><line x1="26" y1="42" x2="122" y2="42" /><line x1="26" y1="26" x2="122" y2="26" /></g><g stroke="#0f1f3d" stroke-width="1.5"><line x1="26" y1="106" x2="122" y2="106" /><line x1="42" y1="122" x2="42" y2="26" /></g><g fill="#374151" font-size="9"><text x="26" y="118" text-anchor="middle">-1</text><text x="58" y="118" text-anchor="middle">1</text><text x="74" y="118" text-anchor="middle">2</text><text x="90" y="118" text-anchor="middle">3</text><text x="106" y="118" text-anchor="middle">4</text><text x="122" y="118" text-anchor="middle">5</text><text x="34" y="125" text-anchor="end">-1</text><text x="34" y="109" text-anchor="end">0</text><text x="34" y="93" text-anchor="end">1</text><text x="34" y="77" text-anchor="end">2</text><text x="34" y="61" text-anchor="end">3</text><text x="34" y="45" text-anchor="end">4</text><text x="34" y="29" text-anchor="end">5</text></g><polygon points="42,106 106,106 106,42" fill="none" stroke="#0f1f3d" stroke-width="1.5" /><circle cx="42" cy="106" r="4" fill="#2563eb" stroke="#0f1f3d" stroke-width="1" /><circle cx="106" cy="106" r="4" fill="#2563eb" stroke="#0f1f3d" stroke-width="1" /><circle cx="106" cy="42" r="4" fill="#2563eb" stroke="#0f1f3d" stroke-width="1" /><text x="30" y="111" fill="#2563eb" font-weight="700" font-size="11" text-anchor="start">P(0,0)</text><text x="100" y="98" fill="#2563eb" font-weight="700" font-size="11" text-anchor="end">Q(4,0)</text><text x="100" y="56" fill="#2563eb" font-weight="700" font-size="11" text-anchor="end">R(4,4)</text></svg>` },

        // Block 6 — Angle at a vertex via inclination
        { difficulty: 'Hard', question: 'Given A(−3, 1), B(2, 1) and C(2, −3), determine the size of angle ABC, rounded to one decimal place.', checkMode: 'auto', options: ['45°', '180°', '90°', '51.5°'], correctIndex: 2, explanation: 'Gradient of BA: m₁ = (1 − 1)/(−3 − 2) = 0 (horizontal). Gradient of BC: m₂ = (−3 − 1)/(2 − 2) = undefined (vertical). Since BA is horizontal and BC is vertical, BA ⊥ BC. Therefore angle ABC = 90.0° ✓ (45° halves the angle incorrectly; 180° confuses the angle with a straight line; 51.5° is copied from a different vertex-angle calculation.)' },
        { difficulty: 'Hard', question: 'A(−3, 1), B(2, 1) and C(2, −3) are plotted on the Cartesian plane, forming triangle ABC with a right angle at B. Given that AB = 5 and BC = 4, calculate the length of AC.', checkMode: 'auto', options: ['9', '1', '√9', '√41'], correctIndex: 3, explanation: 'AC = √[(2 − (−3))² + (−3 − 1)²] = √[25 + 16] = √41 ≈ 6.40 ✓ (9 wrongly adds AB + BC instead of using Pythagoras; 1 wrongly subtracts BC from AB; √9 comes from squaring the difference of the two lengths instead of the coordinate differences.)', diagramSvg: `<svg viewBox="0 0 146 130" xmlns="http://www.w3.org/2000/svg" font-family="Arial, sans-serif"><g stroke="#9ca3af" stroke-width="1"><line x1="26" y1="122" x2="26" y2="26" /><line x1="42" y1="122" x2="42" y2="26" /><line x1="58" y1="122" x2="58" y2="26" /><line x1="74" y1="122" x2="74" y2="26" /><line x1="90" y1="122" x2="90" y2="26" /><line x1="106" y1="122" x2="106" y2="26" /><line x1="122" y1="122" x2="122" y2="26" /><line x1="138" y1="122" x2="138" y2="26" /><line x1="26" y1="122" x2="138" y2="122" /><line x1="26" y1="106" x2="138" y2="106" /><line x1="26" y1="90" x2="138" y2="90" /><line x1="26" y1="74" x2="138" y2="74" /><line x1="26" y1="58" x2="138" y2="58" /><line x1="26" y1="42" x2="138" y2="42" /><line x1="26" y1="26" x2="138" y2="26" /></g><g stroke="#0f1f3d" stroke-width="1.5"><line x1="26" y1="58" x2="138" y2="58" /><line x1="90" y1="122" x2="90" y2="26" /></g><g fill="#374151" font-size="9"><text x="26" y="70" text-anchor="middle">-4</text><text x="42" y="70" text-anchor="middle">-3</text><text x="58" y="70" text-anchor="middle">-2</text><text x="74" y="70" text-anchor="middle">-1</text><text x="106" y="70" text-anchor="middle">1</text><text x="122" y="70" text-anchor="middle">2</text><text x="138" y="70" text-anchor="middle">3</text><text x="82" y="125" text-anchor="end">-4</text><text x="82" y="109" text-anchor="end">-3</text><text x="82" y="93" text-anchor="end">-2</text><text x="82" y="77" text-anchor="end">-1</text><text x="82" y="61" text-anchor="end">0</text><text x="82" y="45" text-anchor="end">1</text><text x="82" y="29" text-anchor="end">2</text></g><polygon points="42,42 122,42 122,106" fill="none" stroke="#0f1f3d" stroke-width="1.5" /><circle cx="42" cy="42" r="4" fill="#2563eb" stroke="#0f1f3d" stroke-width="1" /><circle cx="122" cy="42" r="4" fill="#2563eb" stroke="#0f1f3d" stroke-width="1" /><circle cx="122" cy="106" r="4" fill="#2563eb" stroke="#0f1f3d" stroke-width="1" /><text x="48" y="56" fill="#2563eb" font-weight="700" font-size="11" text-anchor="start">A(-3,1)</text><text x="116" y="56" fill="#2563eb" font-weight="700" font-size="11" text-anchor="end">B(2,1)</text><text x="128" y="118" fill="#2563eb" font-weight="700" font-size="11" text-anchor="end">C(2,-3)</text></svg>` },
      ],
      scoreMessages: [
        { minScore: 17, message: 'Outstanding! You have mastered lines, gradients, inclination and triangle proofs. Excellent work!' },
        { minScore: 13, message: 'Great work! Review any missed questions on inclination or the mixed triangle applications and try again.' },
