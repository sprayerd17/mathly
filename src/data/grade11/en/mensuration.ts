...
export const topicData: TopicData = {
  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // Block 1 — Basic k² surface area scaling (Easy)
        { difficulty: 'Easy', question: 'Every dimension of a square pyramid is multiplied by a constant factor k = 4. By what factor does the surface area increase?', checkMode: 'auto', options: ['16', '4', '64', '8'], correctIndex: 0, explanation: 'Surface area scales by k² = 4² = 16. Using k itself (4) forgets to square it, k³ = 64 cubes it instead, and 8 = 2k confuses scaling with doubling ✓' },
        { difficulty: 'Easy', question: 'A rectangular prism has surface area 60 cm². If every dimension is multiplied by k = 3, find the new surface area.', checkMode: 'auto', options: ['180 cm²', '540 cm²', '1 620 cm²', '69 cm²'], correctIndex: 1, explanation: 'Surface area scales by k² = 3² = 9. New surface area = 60 × 9 = 540 cm². 180 cm² wrongly uses k instead of k², 1 620 cm² wrongly uses k³, and 69 cm² wrongly adds 9 instead of multiplying ✓' },
        { difficulty: 'Easy', question: 'A sphere has surface area 200 cm². Every dimension is multiplied by k = 0.8. Find the new surface area.', checkMode: 'auto', options: ['160 cm²', '102.4 cm²', '128 cm²', '172 cm²'], correctIndex: 2, explanation: 'Surface area scales by k² = 0.8² = 0.64. New surface area = 200 × 0.64 = 128 cm². 160 cm² wrongly uses k instead of k², 102.4 cm² wrongly uses k³, and 172 cm² comes from miscalculating 0.8² ✓' },

        // Block 2 — Basic k³ volume scaling (Easy)
        { difficulty: 'Easy', question: 'Every dimension of a cylinder is multiplied by a constant factor k = 6. By what factor does the volume increase?', checkMode: 'auto', options: ['36', '12', '6', '216'], correctIndex: 3, explanation: 'Volume scales by k³ = 6³ = 216. 36 wrongly uses k² instead of k³, 12 = 2k and 6 = k confuse cubing with simple multiples ✓' },
        { difficulty: 'Easy', question: 'A cone has volume 16 cm³. If every dimension is multiplied by k = 5, find the new volume.', checkMode: 'auto', options: ['2 000 cm³', '400 cm³', '80 cm³', '640 cm³'], correctIndex: 0, explanation: 'Volume scales by k³ = 5³ = 125. New volume = 16 × 125 = 2 000 cm³. 400 cm³ wrongly uses k² instead of k³, 80 cm³ wrongly uses k only, and 640 cm³ is a miscalculated multiple ✓' },
        { difficulty: 'Easy', question: 'A prism is scaled by a factor k = 2.5. By what factor does its volume increase?', checkMode: 'auto', options: ['6.25', '15.625', '5', '12.5'], correctIndex: 1, explanation: 'Volume scales by k³ = 2.5³ = 15.625. 6.25 wrongly uses k² instead of k³, 5 = 2k, and 12.5 = 5k confuse cubing with simple multiples ✓' },

        // Block 3 — Combined solids, added components (Easy-Medium)
        { difficulty: 'Easy-Medium', question: 'A solid is made of a cylinder (radius 4 cm, height 9 cm) with a cone (same radius, height 6 cm) on top. Find the total volume. Use π ≈ 3.14.', checkMode: 'auto', options: ['753.6 cm³', '452.16 cm³', '552.64 cm³', '854.08 cm³'], correctIndex: 2, explanation: 'Cylinder: V = πr²h = 3.14 × 16 × 9 = 452.16 cm³.\nCone: V = ⅓πr²h = ⅓ × 3.14 × 16 × 6 = 100.48 cm³.\nTotal = 452.16 + 100.48 = 552.64 cm³. 753.6 cm³ forgets the ⅓ on the cone, 452.16 cm³ leaves out the cone entirely, and 854.08 cm³ uses the diameter (8 cm) as the cone radius ✓', diagramSvg: '<svg viewBox="0 0 220 220" xmlns="http://www.w3.org/2000/svg"><line x1="65" y1="70" x2="65" y2="165" stroke="#0f1f3d" stroke-width="2.5"/><line x1="155" y1="70" x2="155" y2="165" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 65,165 A 45,15 0 0 0 155,165" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 65,165 A 45,15 0 0 1 155,165" fill="none" stroke="#0f1f3d" stroke-width="1.6" stroke-dasharray="4,3"/><line x1="65" y1="70" x2="110" y2="15" stroke="#0f1f3d" stroke-width="2.5"/><line x1="155" y1="70" x2="110" y2="15" stroke="#0f1f3d" stroke-width="2.5"/><ellipse cx="110" cy="70" rx="45" ry="15" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="30" y="120" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle" transform="rotate(-90 30 120)">h = 9 cm</text><text x="192" y="45" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle" transform="rotate(-90 192 45)">h = 6 cm</text><line x1="110" y1="70" x2="153" y2="70" stroke="#2563eb" stroke-width="2"/><text x="132" y="63" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">r = 4 cm</text></svg>' },
        { difficulty: 'Medium', question: 'A solid is made of a rectangular prism (length 8 cm, width 5 cm, height 3 cm) with a square pyramid (same base 8 cm by 5 cm, height 6 cm) on top. Find the total volume.', checkMode: 'auto', options: ['360 cm³', '80 cm³', '160 cm³', '200 cm³'], correctIndex: 3, explanation: 'Prism: V = 8 × 5 × 3 = 120 cm³.\nPyramid: V = ⅓ × base area × h = ⅓ × 40 × 6 = 80 cm³.\nTotal = 120 + 80 = 200 cm³. 360 cm³ forgets the ⅓ on the pyramid, 80 cm³ leaves out the prism entirely, and 160 cm³ misreads the pyramid height as 3 cm ✓', diagramSvg: '<svg viewBox="0 0 220 210" xmlns="http://www.w3.org/2000/svg"><rect x="75" y="90" width="110" height="85" fill="none" stroke="#0f1f3d" stroke-width="1.6" stroke-dasharray="4,3"/><line x1="40" y1="115" x2="75" y2="90" stroke="#0f1f3d" stroke-width="1.6"/><line x1="150" y1="115" x2="185" y2="90" stroke="#0f1f3d" stroke-width="1.6"/><line x1="150" y1="200" x2="185" y2="175" stroke="#0f1f3d" stroke-width="1.6"/><rect x="40" y="115" width="110" height="85" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="95" y="192" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">8 cm</text><text x="26" y="157.5" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle" transform="rotate(-90 26 157.5)">3 cm</text><text x="162" y="82" font-size="11" fill="#2563eb" font-weight="700" text-anchor="start">5 cm</text><polygon points="40,115 150,115 185,90 75,90" fill="none" stroke="#0f1f3d" stroke-width="1.6" stroke-dasharray="4,3"/><line x1="40" y1="115" x2="95" y2="30" stroke="#0f1f3d" stroke-width="2.5"/><line x1="150" y1="115" x2="95" y2="30" stroke="#0f1f3d" stroke-width="2.5"/><line x1="185" y1="90" x2="95" y2="30" stroke="#0f1f3d" stroke-width="1.6" stroke-dasharray="4,3"/><line x1="75" y1="90" x2="95" y2="30" stroke="#0f1f3d" stroke-width="2.5"/><text x="122" y="59" font-size="12" fill="#2563eb" font-weight="700" text-anchor="start">h = 6 cm</text></svg>' },
        { difficulty: 'Medium', question: 'A closed solid is made of a cylinder (radius 6 cm, height 14 cm) with a hemisphere (radius 6 cm) fixed on top, replacing the top circular face. Find the total surface area of the solid (curved cylinder surface + cylinder base + curved hemisphere surface only). Use π ≈ 3.14.', checkMode: 'auto', options: ['866.64 cm²', '979.68 cm²', '1 092.72 cm²', '753.6 cm²'], correctIndex: 0, explanation: 'Cylinder curved surface: 2πrh = 2 × 3.14 × 6 × 14 = 527.52 cm².\nCylinder base: πr² = 3.14 × 36 = 113.04 cm².\nHemisphere curved surface: 2πr² = 2 × 3.14 × 36 = 226.08 cm².\nTotal = 527.52 + 113.04 + 226.08 = 866.64 cm². 979.68 cm² wrongly double-counts the top circle as well as the hemisphere, 1 092.72 cm² wrongly uses the full sphere formula (4πr²) for the hemisphere, and 753.6 cm² wrongly leaves out the cylinder base ✓', diagramSvg: '<svg viewBox="0 0 220 220" xmlns="http://www.w3.org/2000/svg"><path d="M 65,70 A 45,50 0 0 1 110,25 A 45,50 0 0 1 155,70" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><ellipse cx="110" cy="70" rx="45" ry="15" fill="none" stroke="#0f1f3d" stroke-width="1.6" stroke-dasharray="4,3"/><line x1="65" y1="70" x2="65" y2="165" stroke="#0f1f3d" stroke-width="2.5"/><line x1="155" y1="70" x2="155" y2="165" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 65,165 A 45,15 0 0 0 155,165" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 65,165 A 45,15 0 0 1 155,165" fill="none" stroke="#0f1f3d" stroke-width="1.6" stroke-dasharray="4,3"/><line x1="110" y1="70" x2="153" y2="70" stroke="#2563eb" stroke-width="2"/><text x="132" y="63" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">r = 6 cm</text><line x1="30" y1="70" x2="30" y2="165" stroke="#2563eb" stroke-width="2"/><text x="16" y="120" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle" transform="rotate(-90 16 120)">h = 14 cm</text></svg>' },

        // Block 4 — Combined solids, removed cavity (Medium)
        { difficulty: 'Medium', question: 'A solid cube (side 12 cm) has a cylindrical hole (radius 3 cm, depth 12 cm) drilled straight through it. Find the remaining volume. Use π ≈ 3.14.', checkMode: 'auto', options: ['1 728 cm³', '1 388.88 cm³', '371.52 cm³', '2 067.12 cm³'], correctIndex: 1, explanation: 'Cube: V = 12³ = 1 728 cm³.\nDrilled cylinder (removed): V = πr²h = 3.14 × 9 × 12 = 339.12 cm³.\nRemaining = 1 728 − 339.12 = 1 388.88 cm³. 1 728 cm³ forgets to subtract the hole, 371.52 cm³ wrongly uses the diameter (6 cm) as the hole radius, and 2 067.12 cm³ wrongly adds the hole instead of subtracting it ✓', diagramSvg: '<svg viewBox="0 0 220 190" xmlns="http://www.w3.org/2000/svg"><rect x="75" y="30" width="110" height="85" fill="none" stroke="#0f1f3d" stroke-width="1.6" stroke-dasharray="4,3"/><line x1="40" y1="55" x2="75" y2="30" stroke="#0f1f3d" stroke-width="1.6"/><line x1="150" y1="55" x2="185" y2="30" stroke="#0f1f3d" stroke-width="1.6"/><line x1="150" y1="140" x2="185" y2="115" stroke="#0f1f3d" stroke-width="1.6"/><rect x="40" y="55" width="110" height="85" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><ellipse cx="95" cy="72.5" rx="20" ry="7" fill="none" stroke="#374151" stroke-width="1.8" stroke-dasharray="5,4"/><line x1="75" y1="72.5" x2="75" y2="122.5" stroke="#374151" stroke-width="1.8" stroke-dasharray="5,4"/><line x1="115" y1="72.5" x2="115" y2="122.5" stroke="#374151" stroke-width="1.8" stroke-dasharray="5,4"/><path d="M 75,122.5 A 20,7 0 0 0 115,122.5" fill="none" stroke="#374151" stroke-width="1.8" stroke-dasharray="5,4"/><text x="95" y="158" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">side = 12 cm</text><text x="120" y="66" font-size="11" fill="#2563eb" font-weight="700" text-anchor="start">r = 3 cm</text></svg>' },
        { difficulty: 'Medium', question: 'A solid cylinder (radius 5 cm, height 18 cm) has a cone-shaped cavity (same radius, height 9 cm) removed from the top. Find the remaining volume. Use π ≈ 3.14.', checkMode: 'auto', options: ['706.5 cm³', '1 648.5 cm³', '1 177.5 cm³', '1 413 cm³'], correctIndex: 2, explanation: 'Cylinder: V = πr²h = 3.14 × 25 × 18 = 1 413 cm³.\nCone cavity (removed): V = ⅓πr²h = ⅓ × 3.14 × 25 × 9 = 235.5 cm³.\nRemaining = 1 413 − 235.5 = 1 177.5 cm³. 706.5 cm³ forgets the ⅓ on the cavity, 1 648.5 cm³ wrongly adds the cavity instead of subtracting it, and 1 413 cm³ leaves out the cavity entirely ✓', diagramSvg: '<svg viewBox="0 0 220 220" xmlns="http://www.w3.org/2000/svg"><line x1="65" y1="45" x2="65" y2="165" stroke="#0f1f3d" stroke-width="2.5"/><line x1="155" y1="45" x2="155" y2="165" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 65,165 A 45,15 0 0 0 155,165" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 65,165 A 45,15 0 0 1 155,165" fill="none" stroke="#0f1f3d" stroke-width="1.6" stroke-dasharray="4,3"/><ellipse cx="110" cy="45" rx="45" ry="15" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="80" y1="49" x2="110" y2="85" stroke="#374151" stroke-width="1.8" stroke-dasharray="5,4"/><line x1="140" y1="49" x2="110" y2="85" stroke="#374151" stroke-width="1.8" stroke-dasharray="5,4"/><path d="M 80,49 A 30,10 0 0 0 140,49" fill="none" stroke="#374151" stroke-width="1.8" stroke-dasharray="5,4"/><line x1="30" y1="45" x2="30" y2="165" stroke="#2563eb" stroke-width="2"/><text x="16" y="105" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle" transform="rotate(-90 16 105)">h = 18 cm</text><line x1="110" y1="45" x2="153" y2="45" stroke="#2563eb" stroke-width="2"/><text x="132" y="38" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">r = 5 cm</text><text x="125" y="70" font-size="11" fill="#2563eb" font-weight="700" text-anchor="start">h = 9 cm</text></svg>' },
        { difficulty: 'Medium', question: 'A rectangular box (length 15 cm, width 10 cm, height 8 cm) has two identical cylindrical holes (radius 1.5 cm, depth 8 cm each) drilled straight through it from top to bottom. Find the remaining volume. Use π ≈ 3.14.', checkMode: 'auto', options: ['1 143.48 cm³', '747.84 cm³', '1 200 cm³', '1 086.96 cm³'], correctIndex: 3, explanation: 'Box: V = 15 × 10 × 8 = 1 200 cm³.\nOne hole: V = πr²h = 3.14 × 2.25 × 8 = 56.52 cm³. Two holes = 113.04 cm³.\nRemaining = 1 200 − 113.04 = 1 086.96 cm³. 1 143.48 cm³ only subtracts one hole, 747.84 cm³ wrongly uses the diameter (3 cm) as the hole radius, and 1 200 cm³ forgets to subtract the holes at all ✓', diagramSvg: '<svg viewBox="0 0 220 190" xmlns="http://www.w3.org/2000/svg"><rect x="75" y="30" width="110" height="85" fill="none" stroke="#0f1f3d" stroke-width="1.6" stroke-dasharray="4,3"/><line x1="40" y1="55" x2="75" y2="30" stroke="#0f1f3d" stroke-width="1.6"/><line x1="150" y1="55" x2="185" y2="30" stroke="#0f1f3d" stroke-width="1.6"/><line x1="150" y1="140" x2="185" y2="115" stroke="#0f1f3d" stroke-width="1.6"/><rect x="40" y="55" width="110" height="85" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><ellipse cx="72" cy="70" rx="13" ry="5" fill="none" stroke="#374151" stroke-width="1.6" stroke-dasharray="4,3"/><line x1="59" y1="70" x2="59" y2="120" stroke="#374151" stroke-width="1.6" stroke-dasharray="4,3"/><line x1="85" y1="70" x2="85" y2="120" stroke="#374151" stroke-width="1.6" stroke-dasharray="4,3"/><path d="M 59,120 A 13,5 0 0 0 85,120" fill="none" stroke="#374151" stroke-width="1.6" stroke-dasharray="4,3"/><ellipse cx="118" cy="70" rx="13" ry="5" fill="none" stroke="#374151" stroke-width="1.6" stroke-dasharray="4,3"/><line x1="105" y1="70" x2="105" y2="120" stroke="#374151" stroke-width="1.6" stroke-dasharray="4,3"/><line x1="131" y1="70" x2="131" y2="120" stroke="#374151" stroke-width="1.6" stroke-dasharray="4,3"/><path d="M 105,120 A 13,5 0 0 0 131,120" fill="none" stroke="#374151" stroke-width="1.6" stroke-dasharray="4,3"/><text x="95" y="158" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">15 cm</text><text x="26" y="97.5" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle" transform="rotate(-90 26 97.5)">8 cm</text><text x="162" y="22" font-size="11" fill="#2563eb" font-weight="700" text-anchor="start">10 cm</text><text x="97" y="63" font-size="10" fill="#2563eb" font-weight="700" text-anchor="middle">r = 1.5 cm</text></svg>' },

        // Block 5 — Reverse scaling problems (Medium-Hard)
        { difficulty: 'Medium-Hard', question: 'A solid has surface area 60 cm². Every dimension is scaled by a constant factor k, and the new surface area is 540 cm². Find k.', checkMode: 'auto', options: ['3', '9', '4.5', '81'], correctIndex: 0, explanation: 'Surface area scale factor = new ÷ original = 540 ÷ 60 = 9 = k². So k = √9 = 3. 9 mistakes the scale factor itself for k, 4.5 is a miscalculated ratio, and 81 wrongly squares the scale factor again ✓' },
        { difficulty: 'Medium-Hard', question: 'A solid has volume 16 cm³. Every dimension is scaled by a constant factor k = 5. Find the new volume, then confirm what the original volume must have been if that new volume is 2 000 cm³.', checkMode: 'auto', options: ['400 cm³', '2 000 cm³', '80 cm³', '125 cm³'], correctIndex: 1, explanation: 'Volume scale factor = k³ = 5³ = 125. New volume = 16 × 125 = 2 000 cm³, which matches the given new volume, confirming the original was 16 cm³. 400 cm³ wrongly uses k² instead of k³, 80 cm³ wrongly uses k only, and 125 cm³ mistakes the scale factor itself for the volume ✓' },
        { difficulty: 'Medium-Hard', question: 'A solid has surface area 20 cm². After every dimension is scaled by a constant factor k, the new surface area is 500 cm². Find k.', checkMode: 'auto', options: ['25', '2.5', '5', '12.5'], correctIndex: 2, explanation: 'Surface area scale factor = 500 ÷ 20 = 25 = k². So k = √25 = 5. 25 mistakes the scale factor itself for k, and 2.5 and 12.5 come from miscalculated roots ✓' },
        // Block 6 — Complex combined / mixed / real-world (Hard)
        { difficulty: 'Hard', question: 'A solid sphere (radius 10 cm) has a cylindrical hole (radius 4 cm) drilled straight through its centre, all the way through (the hole passes through the full diameter, 20 cm deep). Find the remaining volume. Use π ≈ 3.14.', checkMode: 'auto', options: ['4 186.67 cm³', '2 135.2 cm³', '5 191.47 cm³', '3 181.87 cm³'], correctIndex: 3, explanation: 'Sphere: V = 4/3πr³ = 4/3 × 3.14 × 1 000 = 4 186.67 cm³.\nDrilled cylinder (removed): V = πr²h = 3.14 × 16 × 20 = 1 004.8 cm³.\nRemaining = 4 186.67 − 1 004.8 = 3 181.87 cm³. 4 186.67 cm³ forgets to subtract the hole, 2 135.2 cm³ wrongly forgets the 4/3 fraction on the sphere formula, and 5 191.47 cm³ wrongly adds the hole instead of subtracting it ✓', diagramSvg: '<svg viewBox="0 0 220 220" xmlns="http://www.w3.org/2000/svg"><circle cx="110" cy="110" r="75" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><ellipse cx="110" cy="110" rx="75" ry="22" fill="none" stroke="#0f1f3d" stroke-width="1.6" stroke-dasharray="4,3"/><line x1="90" y1="37" x2="90" y2="183" stroke="#374151" stroke-width="1.8" stroke-dasharray="5,4"/><line x1="130" y1="37" x2="130" y2="183" stroke="#374151" stroke-width="1.8" stroke-dasharray="5,4"/><ellipse cx="110" cy="37" rx="20" ry="7" fill="none" stroke="#374151" stroke-width="1.8" stroke-dasharray="5,4"/><path d="M 90,183 A 20,7 0 0 0 130,183" fill="none" stroke="#374151" stroke-width="1.8" stroke-dasharray="5,4"/><path d="M 90,183 A 20,7 0 0 1 130,183" fill="none" stroke="#374151" stroke-width="1.4" stroke-dasharray="3,3"/><line x1="110" y1="110" x2="185" y2="110" stroke="#2563eb" stroke-width="2"/><text x="150" y="125" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">R = 10 cm</text><text x="140" y="55" font-size="11" fill="#2563eb" font-weight="700" text-anchor="start">r = 4 cm</text></svg>' },
        { difficulty: 'Hard', question: 'A solid is made of three parts: a cylinder (radius 3 cm, height 12 cm) as the base, with a cone (same radius, height 7 cm) attached to its top surface, and a hemisphere (same radius) also attached to its top surface next to the cone, all combined into one total solid. Find the total volume. Use π ≈ 3.14.', checkMode: 'auto', options: ['461.58 cm³', '593.46 cm³', '518.1 cm³', '405.06 cm³'], correctIndex: 0, explanation: 'Cylinder: V = πr²h = 3.14 × 9 × 12 = 339.12 cm³.\nCone: V = ⅓πr²h = ⅓ × 3.14 × 9 × 7 = 65.94 cm³.\nHemisphere: V = ⅔πr³ = ⅔ × 3.14 × 27 = 56.52 cm³.\nTotal = 339.12 + 65.94 + 56.52 = 461.58 cm³. 593.46 cm³ forgets the ⅓ on the cone, 518.1 cm³ wrongly uses the full sphere formula for the hemisphere, and 405.06 cm³ leaves out the hemisphere entirely ✓', diagramSvg: '<svg viewBox="0 0 220 220" xmlns="http://www.w3.org/2000/svg"><line x1="65" y1="70" x2="65" y2="165" stroke="#0f1f3d" stroke-width="2.5"/><line x1="155" y1="70" x2="155" y2="165" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 65,165 A 45,15 0 0 0 155,165" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 65,165 A 45,15 0 0 1 155,165" fill="none" stroke="#0f1f3d" stroke-width="1.6" stroke-dasharray="4,3"/><ellipse cx="110" cy="70" rx="45" ry="15" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><polygon points="65,70 110,70 87,22" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="110" y1="70" x2="110" y2="50" stroke="#374151" stroke-width="1" stroke-dasharray="2,2"/><path d="M 110,70 A 22,25 0 0 1 133,45 A 22,25 0 0 1 155,70" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><ellipse cx="133" cy="70" rx="22" ry="7" fill="none" stroke="#0f1f3d" stroke-width="1.4" stroke-dasharray="3,2"/><text x="30" y="120" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle" transform="rotate(-90 30 120)">h = 12 cm</text><text x="45" y="15" font-size="10" fill="#2563eb" font-weight="700" text-anchor="middle">h = 7 cm (cone)</text><line x1="110" y1="165" x2="153" y2="165" stroke="#2563eb" stroke-width="2"/><text x="132" y="180" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">r = 3 cm</text></svg>' },
        { difficulty: 'Hard', question: 'A prism has volume 200 cm³ and surface area 180 cm². Every dimension is scaled by a factor of k = 2.\n\na) Find the new volume.\nb) Find the new surface area.\nc) If painting costs R0,06 per cm², find the cost to paint the new (scaled) solid.', checkMode: 'auto', options: ['a) 800 cm³  b) 1 440 cm²  c) R86,40', 'a) 1 600 cm³  b) 720 cm²  c) R43,20', 'a) 1 600 cm³  b) 720 cm²  c) R10,80', 'a) 400 cm³  b) 360 cm²  c) R21,60'], correctIndex: 1, explanation: 'a) Volume scales by k³ = 2³ = 8, so 200 × 8 = 1 600 cm³.\nb) Surface area scales by k² = 2² = 4, so 180 × 4 = 720 cm².\nc) Cost = 720 × R0,06 = R43,20. Swapping k² and k³ between volume and surface area gives 800 cm³ and 1 440 cm²; costing the original (unscaled) surface area of 180 cm² gives R10,80 instead of R43,20; and multiplying by k alone instead of k²/k³ gives 400 cm³ and 360 cm² ✓' },
        { difficulty: 'Hard', question: 'A solid is made of a cylinder (radius 8 cm, height 22 cm) with a hemispherical cap (radius 8 cm) fixed on top, and a cone-shaped cavity (radius 8 cm, height 7 cm) removed from the bottom of the cylinder. Find the total volume. Use π ≈ 3.14.', checkMode: 'auto', options: ['5 961.82 cm³', '6 095.78 cm³', '5 024 cm³', '3 952.21 cm³'], correctIndex: 2, explanation: 'Cylinder: V = πr²h = 3.14 × 64 × 22 = 4 421.12 cm³.\nHemisphere (added): V = ⅔πr³ = ⅔ × 3.14 × 512 = 1 071.79 cm³.\nCone cavity (removed): V = ⅓πr²h = ⅓ × 3.14 × 64 × 7 = 468.91 cm³.\nTotal = 4 421.12 + 1 071.79 − 468.91 = 5 024 cm³. 5 961.82 cm³ wrongly adds the cavity instead of subtracting it, 6 095.78 cm³ wrongly uses the full sphere formula for the hemisphere, and 3 952.21 cm³ leaves out the hemisphere entirely ✓', diagramSvg: '<svg viewBox="0 0 220 240" xmlns="http://www.w3.org/2000/svg"><path d="M 65,45 A 45,50 0 0 1 110,0 A 45,50 0 0 1 155,45" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><ellipse cx="110" cy="45" rx="45" ry="15" fill="none" stroke="#0f1f3d" stroke-width="1.6" stroke-dasharray="4,3"/><line x1="65" y1="45" x2="65" y2="165" stroke="#0f1f3d" stroke-width="2.5"/><line x1="155" y1="45" x2="155" y2="165" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 65,165 A 45,15 0 0 0 155,165" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 65,165 A 45,15 0 0 1 155,165" fill="none" stroke="#0f1f3d" stroke-width="1.6" stroke-dasharray="4,3"/><line x1="85" y1="128" x2="110" y2="165" stroke="#374151" stroke-width="1.8" stroke-dasharray="5,4"/><line x1="135" y1="128" x2="110" y2="165" stroke="#374151" stroke-width="1.8" stroke-dasharray="5,4"/><path d="M 85,128 A 25,8 0 0 0 135,128" fill="none" stroke="#374151" stroke-width="1.8" stroke-dasharray="5,4"/><line x1="110" y1="45" x2="153" y2="45" stroke="#2563eb" stroke-width="2"/><text x="132" y="38" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">r = 8 cm</text><line x1="30" y1="45" x2="30" y2="165" stroke="#2563eb" stroke-width="2"/><text x="16" y="105" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle" transform="rotate(-90 16 105)">h = 22 cm</text><text x="140" y="150" font-size="11" fill="#2563eb" font-weight="700" text-anchor="start">h = 7 cm</text></svg>' },
        { difficulty: 'Hard', question: 'A water tank is made of a cylinder (radius 1.5 m, height 4 m) with a hemispherical dome (radius 1.5 m) on top. Find the capacity of the tank in litres (1 m³ = 1 000 litres). Use π ≈ 3.14.', checkMode: 'auto', options: ['28 260 litres', '42 390 litres', '35.325 litres', '35 325 litres'], correctIndex: 3, explanation: 'Cylinder: V = πr²h = 3.14 × 2.25 × 4 = 28.26 m³.\nHemisphere: V = ⅔πr³ = ⅔ × 3.14 × 3.375 = 7.065 m³.\nTotal = 28.26 + 7.065 = 35.325 m³.\nCapacity = 35.325 × 1 000 = 35 325 litres. 28 260 litres forgets the hemisphere, 42 390 litres wrongly uses the full sphere formula instead of a hemisphere, and 35.325 litres forgets to convert from m³ to litres ✓', diagramSvg: '<svg viewBox="0 0 220 220" xmlns="http://www.w3.org/2000/svg"><path d="M 65,70 A 45,50 0 0 1 110,25 A 45,50 0 0 1 155,70" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><ellipse cx="110" cy="70" rx="45" ry="15" fill="none" stroke="#0f1f3d" stroke-width="1.6" stroke-dasharray="4,3"/><line x1="65" y1="70" x2="65" y2="165" stroke="#0f1f3d" stroke-width="2.5"/><line x1="155" y1="70" x2="155" y2="165" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 65,165 A 45,15 0 0 0 155,165" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 65,165 A 45,15 0 0 1 155,165" fill="none" stroke="#0f1f3d" stroke-width="1.6" stroke-dasharray="4,3"/><line x1="110" y1="70" x2="153" y2="70" stroke="#2563eb" stroke-width="2"/><text x="132" y="63" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">r = 1.5 m</text><line x1="30" y1="70" x2="30" y2="165" stroke="#2563eb" stroke-width="2"/><text x="16" y="120" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle" transform="rotate(-90 16 120)">h = 4 m</text></svg>' },
      ],
      scoreMessages: [
        { minScore: 20, message: 'Outstanding! You have mastered scaling and combined solids.' },
        { minScore: 15, message: 'Great work! Review any missed questions on removed cavities or reverse scaling and try again.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // Block 1 — Basic k² surface area scaling (Easy)
        { difficulty: 'Easy', question: 'Every dimension of a cone is multiplied by a constant factor k = 2.5. By what factor does the surface area increase?', checkMode: 'auto', options: ['6.25', '2.5', '15.625', '5'], correctIndex: 0, explanation: 'Surface area scales by k² = 2.5² = 6.25. Using k itself (2.5) forgets to square it, k³ = 15.625 cubes it instead, and 5 = 2k confuses scaling with doubling ✓' },
        { difficulty: 'Easy', question: 'A triangular prism has surface area 25 cm². If every dimension is multiplied by k = 4, find the new surface area.', checkMode: 'auto', options: ['100 cm²', '400 cm²', '1 600 cm²', '29 cm²'], correctIndex: 1, explanation: 'Surface area scales by k² = 4² = 16. New surface area = 25 × 16 = 400 cm². 100 cm² wrongly uses k instead of k², 1 600 cm² wrongly uses k³, and 29 cm² wrongly adds 4 instead of multiplying ✓' },
        { difficulty: 'Easy', question: 'A cube has surface area 30 cm². Every dimension is multiplied by k = 1.1. Find the new surface area.', checkMode: 'auto', options: ['33 cm²', '36.63 cm²', '36.3 cm²', '31.1 cm²'], correctIndex: 2, explanation: 'Surface area scales by k² = 1.1² = 1.21. New surface area = 30 × 1.21 = 36.3 cm². 33 cm² wrongly uses k instead of k², 36.63 cm² wrongly uses k³, and 31.1 cm² wrongly adds 1.1 instead of multiplying ✓' },

        // Block 2 — Basic k³ volume scaling (Easy)
        { difficulty: 'Easy', question: 'Every dimension of a pyramid is multiplied by a constant factor k = 3.5. By what factor does the volume increase?', checkMode: 'auto', options: ['12.25', '7', '3.5', '42.875'], correctIndex: 3, explanation: 'Volume scales by k³ = 3.5³ = 42.875. 12.25 wrongly uses k² instead of k³, 7 = 2k and 3.5 = k confuse cubing with simple multiples ✓' },
        { difficulty: 'Easy', question: 'A cylinder has volume 8 cm³. If every dimension is multiplied by k = 3, find the new volume.', checkMode: 'auto', options: ['216 cm³', '72 cm³', '24 cm³', '64 cm³'], correctIndex: 0, explanation: 'Volume scales by k³ = 3³ = 27. New volume = 8 × 27 = 216 cm³. 72 cm³ wrongly uses k² instead of k³, 24 cm³ wrongly uses k only, and 64 cm³ is a miscalculated multiple ✓' },
        { difficulty: 'Easy', question: 'A sphere is scaled by a factor k = 0.4. By what factor does its volume decrease? Give your answer as a decimal.', checkMode: 'auto', options: ['0.16', '0.064', '0.8', '0.4'], correctIndex: 1, explanation: 'Volume scales by k³ = 0.4³ = 0.064. 0.16 wrongly uses k² instead of k³, 0.8 = 2k and 0.4 = k confuse cubing with simple multiples ✓' },

        // Block 3 — Combined solids, added components (Easy-Medium)
        { difficulty: 'Easy-Medium', question: 'A solid is made of a cylinder (radius 5 cm, height 10 cm) with a cone (same radius, height 7 cm) on top. Find the total volume. Use π ≈ 3.14.', checkMode: 'auto', options: ['1 334.5 cm³', '785 cm³', '968.17 cm³', '1 517.67 cm³'], correctIndex: 2, explanation: 'Cylinder: V = πr²h = 3.14 × 25 × 10 = 785 cm³.\nCone: V = ⅓πr²h = ⅓ × 3.14 × 25 × 7 = 183.17 cm³.\nTotal = 785 + 183.17 = 968.17 cm³. 1 334.5 cm³ forgets the ⅓ on the cone, 785 cm³ leaves out the cone entirely, and 1 517.67 cm³ uses the diameter (10 cm) as the cone radius ✓', diagramSvg: '<svg viewBox="0 0 220 220" xmlns="http://www.w3.org/2000/svg"><line x1="65" y1="70" x2="65" y2="165" stroke="#0f1f3d" stroke-width="2.5"/><line x1="155" y1="70" x2="155" y2="165" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 65,165 A 45,15 0 0 0 155,165" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 65,165 A 45,15 0 0 1 155,165" fill="none" stroke="#0f1f3d" stroke-width="1.6" stroke-dasharray="4,3"/><line x1="65" y1="70" x2="110" y2="15" stroke="#0f1f3d" stroke-width="2.5"/><line x1="155" y1="70" x2="110" y2="15" stroke="#0f1f3d" stroke-width="2.5"/><ellipse cx="110" cy="70" rx="45" ry="15" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="30" y="120" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle" transform="rotate(-90 30 120)">h = 10 cm</text><text x="192" y="45" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle" transform="rotate(-90 192 45)">h = 7 cm</text><line x1="110" y1="70" x2="153" y2="70" stroke="#2563eb" stroke-width="2"/><text x="132" y="63" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">r = 5 cm</text></svg>' },
        { difficulty: 'Medium', question: 'A solid is made of a rectangular prism (length 14 cm, width 9 cm, height 5 cm) with a square pyramid (same base 14 cm by 9 cm, height 12 cm) on top. Find the total volume.', checkMode: 'auto', options: ['2 142 cm³', '504 cm³', '840 cm³', '1 134 cm³'], correctIndex: 3, explanation: 'Prism: V = 14 × 9 × 5 = 630 cm³.\nPyramid: V = ⅓ × base area × h = ⅓ × 126 × 12 = 504 cm³.\nTotal = 630 + 504 = 1 134 cm³. 2 142 cm³ forgets the ⅓ on the pyramid, 504 cm³ leaves out the prism entirely, and 840 cm³ misreads the pyramid height as 5 cm ✓', diagramSvg: '<svg viewBox="0 0 220 210" xmlns="http://www.w3.org/2000/svg"><rect x="75" y="90" width="110" height="85" fill="none" stroke="#0f1f3d" stroke-width="1.6" stroke-dasharray="4,3"/><line x1="40" y1="115" x2="75" y2="90" stroke="#0f1f3d" stroke-width="1.6"/><line x1="150" y1="115" x2="185" y2="90" stroke="#0f1f3d" stroke-width="1.6"/><line x1="150" y1="200" x2="185" y2="175" stroke="#0f1f3d" stroke-width="1.6"/><rect x="40" y="115" width="110" height="85" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><text x="95" y="192" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">14 cm</text><text x="26" y="157.5" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle" transform="rotate(-90 26 157.5)">5 cm</text><text x="162" y="82" font-size="11" fill="#2563eb" font-weight="700" text-anchor="start">9 cm</text><polygon points="40,115 150,115 185,90 75,90" fill="none" stroke="#0f1f3d" stroke-width="1.6" stroke-dasharray="4,3"/><line x1="40" y1="115" x2="95" y2="30" stroke="#0f1f3d" stroke-width="2.5"/><line x1="150" y1="115" x2="95" y2="30" stroke="#0f1f3d" stroke-width="2.5"/><line x1="185" y1="90" x2="95" y2="30" stroke="#0f1f3d" stroke-width="1.6" stroke-dasharray="4,3"/><line x1="75" y1="90" x2="95" y2="30" stroke="#0f1f3d" stroke-width="2.5"/><text x="122" y="59" font-size="12" fill="#2563eb" font-weight="700" text-anchor="start">h = 12 cm</text></svg>' },
        { difficulty: 'Medium', question: 'A closed solid is made of a cylinder (radius 4.5 cm, height 16 cm) with a hemisphere (radius 4.5 cm) fixed on top, replacing the top circular face. Find the total surface area of the solid (curved cylinder surface + cylinder base + curved hemisphere surface only). Use π ≈ 3.14.', checkMode: 'auto', options: ['642.92 cm²', '706.51 cm²', '770.09 cm²', '579.33 cm²'], correctIndex: 0, explanation: 'Cylinder curved surface: 2πrh = 2 × 3.14 × 4.5 × 16 = 452.16 cm².\nCylinder base: πr² = 3.14 × 20.25 = 63.59 cm².\nHemisphere curved surface: 2πr² = 2 × 3.14 × 20.25 = 127.17 cm².\nTotal = 452.16 + 63.59 + 127.17 = 642.92 cm². 706.51 cm² wrongly double-counts the top circle as well as the hemisphere, 770.09 cm² wrongly uses the full sphere formula (4πr²) for the hemisphere, and 579.33 cm² wrongly leaves out the cylinder base ✓', diagramSvg: '<svg viewBox="0 0 220 220" xmlns="http://www.w3.org/2000/svg"><path d="M 65,70 A 45,50 0 0 1 110,25 A 45,50 0 0 1 155,70" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><ellipse cx="110" cy="70" rx="45" ry="15" fill="none" stroke="#0f1f3d" stroke-width="1.6" stroke-dasharray="4,3"/><line x1="65" y1="70" x2="65" y2="165" stroke="#0f1f3d" stroke-width="2.5"/><line x1="155" y1="70" x2="155" y2="165" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 65,165 A 45,15 0 0 0 155,165" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 65,165 A 45,15 0 0 1 155,165" fill="none" stroke="#0f1f3d" stroke-width="1.6" stroke-dasharray="4,3"/><line x1="110" y1="70" x2="153" y2="70" stroke="#2563eb" stroke-width="2"/><text x="132" y="63" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">r = 4.5 cm</text><line x1="30" y1="70" x2="30" y2="165" stroke="#2563eb" stroke-width="2"/><text x="16" y="120" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle" transform="rotate(-90 16 120)">h = 16 cm</text></svg>' },

        // Block 4 — Combined solids, removed cavity (Medium)
        { difficulty: 'Medium', question: 'A solid cube (side 9 cm) has a cylindrical hole (radius 2.5 cm, depth 9 cm) drilled straight through it. Find the remaining volume. Use π ≈ 3.14.', checkMode: 'auto', options: ['729 cm³', '552.38 cm³', '905.63 cm³', '672.75 cm³'], correctIndex: 1, explanation: 'Cube: V = 9³ = 729 cm³.\nDrilled cylinder (removed): V = πr²h = 3.14 × 6.25 × 9 = 176.63 cm³.\nRemaining = 729 − 176.63 = 552.38 cm³. 729 cm³ forgets to subtract the hole, 905.63 cm³ wrongly adds the hole instead of subtracting it, and 672.75 cm³ wrongly leaves out π from the cylinder formula ✓', diagramSvg: '<svg viewBox="0 0 220 190" xmlns="http://www.w3.org/2000/svg"><rect x="75" y="30" width="110" height="85" fill="none" stroke="#0f1f3d" stroke-width="1.6" stroke-dasharray="4,3"/><line x1="40" y1="55" x2="75" y2="30" stroke="#0f1f3d" stroke-width="1.6"/><line x1="150" y1="55" x2="185" y2="30" stroke="#0f1f3d" stroke-width="1.6"/><line x1="150" y1="140" x2="185" y2="115" stroke="#0f1f3d" stroke-width="1.6"/><rect x="40" y="55" width="110" height="85" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><ellipse cx="95" cy="72.5" rx="20" ry="7" fill="none" stroke="#374151" stroke-width="1.8" stroke-dasharray="5,4"/><line x1="75" y1="72.5" x2="75" y2="122.5" stroke="#374151" stroke-width="1.8" stroke-dasharray="5,4"/><line x1="115" y1="72.5" x2="115" y2="122.5" stroke="#374151" stroke-width="1.8" stroke-dasharray="5,4"/><path d="M 75,122.5 A 20,7 0 0 0 115,122.5" fill="none" stroke="#374151" stroke-width="1.8" stroke-dasharray="5,4"/><text x="95" y="158" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">side = 9 cm</text><text x="120" y="66" font-size="11" fill="#2563eb" font-weight="700" text-anchor="start">r = 2.5 cm</text></svg>' },
        { difficulty: 'Medium', question: 'A solid cylinder (radius 7 cm, height 20 cm) has a cone-shaped cavity (same radius, height 12 cm) removed from the top. Find the remaining volume. Use π ≈ 3.14.', checkMode: 'auto', options: ['1 230.88 cm³', '3 692.64 cm³', '2 461.76 cm³', '3 077.2 cm³'], correctIndex: 2, explanation: 'Cylinder: V = πr²h = 3.14 × 49 × 20 = 3 077.2 cm³.\nCone cavity (removed): V = ⅓πr²h = ⅓ × 3.14 × 49 × 12 = 615.44 cm³.\nRemaining = 3 077.2 − 615.44 = 2 461.76 cm³. 1 230.88 cm³ forgets the ⅓ on the cavity, 3 692.64 cm³ wrongly adds the cavity instead of subtracting it, and 3 077.2 cm³ leaves out the cavity entirely ✓', diagramSvg: '<svg viewBox="0 0 220 220" xmlns="http://www.w3.org/2000/svg"><line x1="65" y1="45" x2="65" y2="165" stroke="#0f1f3d" stroke-width="2.5"/><line x1="155" y1="45" x2="155" y2="165" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 65,165 A 45,15 0 0 0 155,165" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 65,165 A 45,15 0 0 1 155,165" fill="none" stroke="#0f1f3d" stroke-width="1.6" stroke-dasharray="4,3"/><ellipse cx="110" cy="45" rx="45" ry="15" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="80" y1="49" x2="110" y2="85" stroke="#374151" stroke-width="1.8" stroke-dasharray="5,4"/><line x1="140" y1="49" x2="110" y2="85" stroke="#374151" stroke-width="1.8" stroke-dasharray="5,4"/><path d="M 80,49 A 30,10 0 0 0 140,49" fill="none" stroke="#374151" stroke-width="1.8" stroke-dasharray="5,4"/><line x1="30" y1="45" x2="30" y2="165" stroke="#2563eb" stroke-width="2"/><text x="16" y="105" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle" transform="rotate(-90 16 105)">h = 20 cm</text><line x1="110" y1="45" x2="153" y2="45" stroke="#2563eb" stroke-width="2"/><text x="132" y="38" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">r = 7 cm</text><text x="125" y="70" font-size="11" fill="#2563eb" font-weight="700" text-anchor="start">h = 12 cm</text></svg>' },
        { difficulty: 'Medium', question: 'A rectangular box (length 20 cm, width 12 cm, height 10 cm) has three identical cylindrical holes (radius 2 cm, depth 10 cm each) drilled straight through it from top to bottom. Find the remaining volume. Use π ≈ 3.14.', checkMode: 'auto', options: ['2 274.4 cm³', '892.8 cm³', '2 400 cm³', '2 023.2 cm³'], correctIndex: 3, explanation: 'Box: V = 20 × 12 × 10 = 2 400 cm³.\nOne hole: V = πr²h = 3.14 × 4 × 10 = 125.6 cm³. Three holes = 376.8 cm³.\nRemaining = 2 400 − 376.8 = 2 023.2 cm³. 2 274.4 cm³ only subtracts one hole, 892.8 cm³ wrongly uses the diameter (4 cm) as the hole radius, and 2 400 cm³ forgets to subtract the holes at all ✓', diagramSvg: '<svg viewBox="0 0 220 190" xmlns="http://www.w3.org/2000/svg"><rect x="75" y="30" width="110" height="85" fill="none" stroke="#0f1f3d" stroke-width="1.6" stroke-dasharray="4,3"/><line x1="40" y1="55" x2="75" y2="30" stroke="#0f1f3d" stroke-width="1.6"/><line x1="150" y1="55" x2="185" y2="30" stroke="#0f1f3d" stroke-width="1.6"/><line x1="150" y1="140" x2="185" y2="115" stroke="#0f1f3d" stroke-width="1.6"/><rect x="40" y="55" width="110" height="85" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><ellipse cx="58" cy="70" rx="10" ry="4" fill="none" stroke="#374151" stroke-width="1.6" stroke-dasharray="4,3"/><line x1="48" y1="70" x2="48" y2="120" stroke="#374151" stroke-width="1.6" stroke-dasharray="4,3"/><line x1="68" y1="70" x2="68" y2="120" stroke="#374151" stroke-width="1.6" stroke-dasharray="4,3"/><path d="M 48,120 A 10,4 0 0 0 68,120" fill="none" stroke="#374151" stroke-width="1.6" stroke-dasharray="4,3"/><ellipse cx="95" cy="70" rx="10" ry="4" fill="none" stroke="#374151" stroke-width="1.6" stroke-dasharray="4,3"/><line x1="85" y1="70" x2="85" y2="120" stroke="#374151" stroke-width="1.6" stroke-dasharray="4,3"/><line x1="105" y1="70" x2="105" y2="120" stroke="#374151" stroke-width="1.6" stroke-dasharray="4,3"/><path d="M 85,120 A 10,4 0 0 0 105,120" fill="none" stroke="#374151" stroke-width="1.6" stroke-dasharray="4,3"/><ellipse cx="132" cy="70" rx="10" ry="4" fill="none" stroke="#374151" stroke-width="1.6" stroke-dasharray="4,3"/><line x1="122" y1="70" x2="122" y2="120" stroke="#374151" stroke-width="1.6" stroke-dasharray="4,3"/><line x1="142" y1="70" x2="142" y2="120" stroke="#374151" stroke-width="1.6" stroke-dasharray="4,3"/><path d="M 122,120 A 10,4 0 0 0 142,120" fill="none" stroke="#374151" stroke-width="1.6" stroke-dasharray="4,3"/><text x="95" y="158" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">20 cm</text><text x="26" y="97.5" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle" transform="rotate(-90 26 97.5)">10 cm</text><text x="162" y="22" font-size="11" fill="#2563eb" font-weight="700" text-anchor="start">12 cm</text><text x="95" y="45" font-size="10" fill="#2563eb" font-weight="700" text-anchor="middle">r = 2 cm</text></svg>' },

        // Block 5 — Reverse scaling problems (Medium-Hard)
        { difficulty: 'Medium-Hard', question: 'A solid has surface area 25 cm². Every dimension is scaled by a constant factor k, and the new surface area is 400 cm². Find k.', checkMode: 'auto', options: ['4', '16', '8', '2'], correctIndex: 0, explanation: 'Surface area scale factor = new ÷ original = 400 ÷ 25 = 16 = k². So k = √16 = 4. 16 mistakes the scale factor itself for k, and 8 and 2 come from miscalculated roots ✓' },
        { difficulty: 'Medium-Hard', question: 'A solid has volume 8 cm³. Every dimension is scaled by a constant factor k = 3. Find the new volume, then confirm what the value of k must have been if the original volume was 15 cm³ and the new volume is 960 cm³.', checkMode: 'auto', options: ['New volume = 72 cm³; k = 4', 'New volume = 216 cm³; k = 4', 'New volume = 216 cm³; k = 8', 'New volume = 216 cm³; k = 64'], correctIndex: 1, explanation: 'First solid: volume scales by k³ = 3³ = 27, so new volume = 8 × 27 = 216 cm³ (using k² = 9 instead gives the wrong 72 cm³). Second solid: scale factor = 960 ÷ 15 = 64 = k³, so k = ∛64 = 4 (mistaking 64 = k² gives k = 8, and forgetting to take the cube root at all gives k = 64) ✓' },
        { difficulty: 'Medium-Hard', question: 'A solid has surface area 96 cm². After every dimension is scaled by a constant factor k = 2.5, find the new surface area.', checkMode: 'auto', options: ['240 cm²', '1 500 cm²', '600 cm²', '98.5 cm²'], correctIndex: 2, explanation: 'Surface area scales by k² = 2.5² = 6.25. New surface area = 96 × 6.25 = 600 cm². 240 cm² wrongly uses k instead of k², 1 500 cm² wrongly uses k³, and 98.5 cm² wrongly adds 2.5 instead of multiplying ✓' },
        // Block 6 — Complex combined / mixed / real-world (Hard)
        { difficulty: 'Hard', question: 'A solid sphere (radius 12 cm) has a cylindrical hole (radius 5 cm) drilled straight through its centre, all the way through (the hole passes through the full diameter, 24 cm deep). Find the remaining volume. Use π ≈ 3.14.', checkMode: 'auto', options: ['7 234.56 cm³', '3 541.92 cm³', '9 118.56 cm³', '5 350.56 cm³'], correctIndex: 3, explanation: 'Sphere: V = 4/3πr³ = 4/3 × 3.14 × 1 728 = 7 234.56 cm³.\nDrilled cylinder (removed): V = πr²h = 3.14 × 25 × 24 = 1 884 cm³.\nRemaining = 7 234.56 − 1 884 = 5 350.56 cm³. 7 234.56 cm³ forgets to subtract the hole, 3 541.92 cm³ wrongly forgets the 4/3 fraction on the sphere formula, and 9 118.56 cm³ wrongly adds the hole instead of subtracting it ✓', diagramSvg: '<svg viewBox="0 0 220 220" xmlns="http://www.w3.org/2000/svg"><circle cx="110" cy="110" r="75" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><ellipse cx="110" cy="110" rx="75" ry="22" fill="none" stroke="#0f1f3d" stroke-width="1.6" stroke-dasharray="4,3"/><line x1="90" y1="37" x2="90" y2="183" stroke="#374151" stroke-width="1.8" stroke-dasharray="5,4"/><line x1="130" y1="37" x2="130" y2="183" stroke="#374151" stroke-width="1.8" stroke-dasharray="5,4"/><ellipse cx="110" cy="37" rx="20" ry="7" fill="none" stroke="#374151" stroke-width="1.8" stroke-dasharray="5,4"/><path d="M 90,183 A 20,7 0 0 0 130,183" fill="none" stroke="#374151" stroke-width="1.8" stroke-dasharray="5,4"/><path d="M 90,183 A 20,7 0 0 1 130,183" fill="none" stroke="#374151" stroke-width="1.4" stroke-dasharray="3,3"/><line x1="110" y1="110" x2="185" y2="110" stroke="#2563eb" stroke-width="2"/><text x="150" y="125" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle">R = 12 cm</text><text x="140" y="55" font-size="11" fill="#2563eb" font-weight="700" text-anchor="start">r = 5 cm</text></svg>' },
        { difficulty: 'Hard', question: 'A solid is made of three parts: a cylinder (radius 6 cm, height 16 cm) as the base, with a cone (same radius, height 10 cm) attached to its top surface, and a hemisphere (same radius) also attached to its top surface next to the cone, all combined into one total solid. Find the total volume. Use π ≈ 3.14.', checkMode: 'auto', options: ['2 637.6 cm³', '3 391.2 cm³', '3 089.76 cm³', '2 185.44 cm³'], correctIndex: 0, explanation: 'Cylinder: V = πr²h = 3.14 × 36 × 16 = 1 808.64 cm³.\nCone: V = ⅓πr²h = ⅓ × 3.14 × 36 × 10 = 376.8 cm³.\nHemisphere: V = ⅔πr³ = ⅔ × 3.14 × 216 = 452.16 cm³.\nTotal = 1 808.64 + 376.8 + 452.16 = 2 637.6 cm³. 3 391.2 cm³ forgets the ⅓ on the cone, 3 089.76 cm³ wrongly uses the full sphere formula for the hemisphere, and 2 185.44 cm³ leaves out the hemisphere entirely ✓', diagramSvg: '<svg viewBox="0 0 220 220" xmlns="http://www.w3.org/2000/svg"><line x1="65" y1="70" x2="65" y2="165" stroke="#0f1f3d" stroke-width="2.5"/><line x1="155" y1="70" x2="155" y2="165" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 65,165 A 45,15 0 0 0 155,165" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 65,165 A 45,15 0 0 1 155,165" fill="none" stroke="#0f1f3d" stroke-width="1.6" stroke-dasharray="4,3"/><ellipse cx="110" cy="70" rx="45" ry="15" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><polygon points="65,70 110,70 87,22" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="110" y1="70" x2="110" y2="50" stroke="#374151" stroke-width="1" stroke-dasharray="2,2"/><path d="M 110,70 A 22,25 0 0 1 133,45 A 22,25 0 0 1 155,70" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><ellipse cx="133" cy="70" rx="22" ry="7" fill="none" stroke="#0f1f3d" stroke-width="1.4" stroke-dasharray="3,2"/><text x="30" y="120" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle" transform="rotate(-90 30 120)">h = 16 cm</text><text x="45" y="15" font-size="10" fill="#2563eb" font-weight="700" text-anchor="middle">h = 10 cm (cone)</text><line x1="110" y1="165" x2="153" y2="165" stroke="#2563eb" stroke-width="2"/><text x="132" y="180" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">r = 6 cm</text></svg>' },
        { difficulty: 'Hard', question: 'A prism has volume 90 cm³ and surface area 120 cm². Every dimension is scaled by a factor of k = 1.5.\n\na) Find the new volume.\nb) Find the new surface area.\nc) If painting costs R0,07 per cm², find the cost to paint the new (scaled) solid.', checkMode: 'auto', options: ['a) 202.5 cm³  b) 405 cm²  c) R28,35', 'a) 303.75 cm³  b) 270 cm²  c) R18,90', 'a) 303.75 cm³  b) 270 cm²  c) R8,40', 'a) 135 cm³  b) 180 cm²  c) R12,60'], correctIndex: 1, explanation: 'a) Volume scales by k³ = 1.5³ = 3.375, so 90 × 3.375 = 303.75 cm³.\nb) Surface area scales by k² = 1.5² = 2.25, so 120 × 2.25 = 270 cm².\nc) Cost = 270 × R0,07 = R18,90. Swapping k² and k³ between volume and surface area gives 202.5 cm³ and 405 cm²; costing the original (unscaled) surface area of 120 cm² gives R8,40 instead of R18,90; and multiplying by k alone instead of k²/k³ gives 135 cm³ and 180 cm² ✓' },
        { difficulty: 'Hard', question: 'A solid is made of a cylinder (radius 9 cm, height 25 cm) with a hemispherical cap (radius 9 cm) fixed on top, and a cone-shaped cavity (radius 9 cm, height 8 cm) removed from the bottom of the cylinder. Find the total volume. Use π ≈ 3.14.', checkMode: 'auto', options: ['8 562.78 cm³', '8 732.34 cm³', '7 206.3 cm³', '5 680.26 cm³'], correctIndex: 2, explanation: 'Cylinder: V = πr²h = 3.14 × 81 × 25 = 6 358.5 cm³.\nHemisphere (added): V = ⅔πr³ = ⅔ × 3.14 × 729 = 1 526.04 cm³.\nCone cavity (removed): V = ⅓πr²h = ⅓ × 3.14 × 81 × 8 = 678.24 cm³.\nTotal = 6 358.5 + 1 526.04 − 678.24 = 7 206.3 cm³. 8 562.78 cm³ wrongly adds the cavity instead of subtracting it, 8 732.34 cm³ wrongly uses the full sphere formula for the hemisphere, and 5 680.26 cm³ leaves out the hemisphere entirely ✓', diagramSvg: '<svg viewBox="0 0 220 240" xmlns="http://www.w3.org/2000/svg"><path d="M 65,45 A 45,50 0 0 1 110,0 A 45,50 0 0 1 155,45" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><ellipse cx="110" cy="45" rx="45" ry="15" fill="none" stroke="#0f1f3d" stroke-width="1.6" stroke-dasharray="4,3"/><line x1="65" y1="45" x2="65" y2="165" stroke="#0f1f3d" stroke-width="2.5"/><line x1="155" y1="45" x2="155" y2="165" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 65,165 A 45,15 0 0 0 155,165" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 65,165 A 45,15 0 0 1 155,165" fill="none" stroke="#0f1f3d" stroke-width="1.6" stroke-dasharray="4,3"/><line x1="85" y1="128" x2="110" y2="165" stroke="#374151" stroke-width="1.8" stroke-dasharray="5,4"/><line x1="135" y1="128" x2="110" y2="165" stroke="#374151" stroke-width="1.8" stroke-dasharray="5,4"/><path d="M 85,128 A 25,8 0 0 0 135,128" fill="none" stroke="#374151" stroke-width="1.8" stroke-dasharray="5,4"/><line x1="110" y1="45" x2="153" y2="45" stroke="#2563eb" stroke-width="2"/><text x="132" y="38" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">r = 9 cm</text><line x1="30" y1="45" x2="30" y2="165" stroke="#2563eb" stroke-width="2"/><text x="16" y="105" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle" transform="rotate(-90 16 105)">h = 25 cm</text><text x="140" y="150" font-size="11" fill="#2563eb" font-weight="700" text-anchor="start">h = 8 cm</text></svg>' },
        { difficulty: 'Hard', question: 'A water tank is made of a cylinder (radius 1 m, height 3 m) with a hemispherical dome (radius 1 m) on top. Find the capacity of the tank in litres (1 m³ = 1 000 litres). Use π ≈ 3.14.', checkMode: 'auto', options: ['9 420 litres', '13 606.67 litres', '11.51 litres', '11 513.33 litres'], correctIndex: 3, explanation: 'Cylinder: V = πr²h = 3.14 × 1 × 3 = 9.42 m³.\nHemisphere: V = ⅔πr³ = ⅔ × 3.14 × 1 = 2.0933... m³.\nTotal = 9.42 + 2.0933... = 11.5133... m³.\nCapacity = 11.5133... × 1 000 ≈ 11 513.33 litres. 9 420 litres forgets the hemisphere, 13 606.67 litres wrongly uses the full sphere formula instead of a hemisphere, and 11.51 litres forgets to convert from m³ to litres ✓', diagramSvg: '<svg viewBox="0 0 220 220" xmlns="http://www.w3.org/2000/svg"><path d="M 65,70 A 45,50 0 0 1 110,25 A 45,50 0 0 1 155,70" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><ellipse cx="110" cy="70" rx="45" ry="15" fill="none" stroke="#0f1f3d" stroke-width="1.6" stroke-dasharray="4,3"/><line x1="65" y1="70" x2="65" y2="165" stroke="#0f1f3d" stroke-width="2.5"/><line x1="155" y1="70" x2="155" y2="165" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 65,165 A 45,15 0 0 0 155,165" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><path d="M 65,165 A 45,15 0 0 1 155,165" fill="none" stroke="#0f1f3d" stroke-width="1.6" stroke-dasharray="4,3"/><line x1="110" y1="70" x2="153" y2="70" stroke="#2563eb" stroke-width="2"/><text x="132" y="63" font-size="12" fill="#2563eb" font-weight="700" text-anchor="middle">r = 1 m</text><line x1="30" y1="70" x2="30" y2="165" stroke="#2563eb" stroke-width="2"/><text x="16" y="120" font-size="13" fill="#2563eb" font-weight="700" text-anchor="middle" transform="rotate(-90 16 120)">h = 3 m</text></svg>' },
      ],
      scoreMessages: [
        { minScore: 20, message: 'Outstanding! You have mastered scaling and combined solids.' },
        { minScore: 15, message: 'Great work! Review any missed questions on removed cavities or reverse scaling and try again.' },
