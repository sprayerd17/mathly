...
export const topicData: TopicData = {
  ...
  topicPractice: [
    ...
    // ── Q1 Easy — turning point of a shifted parabola ────────────────────────
    {
      ...
      correctIndex: 0,
      explanation: 'For y=(x+p)², the turning point is (−p, 0). Here p=5, so the turning point is (−5, 0). (5, 0) flips the sign of p, (0, 25) confuses the y-intercept with the turning point, and (0, -5) swaps the coordinates.',
    },
    ...
    // ── Q2 Medium — turning point with vertical shift ────────────────────────
    {
      ...
      correctIndex: 1,
      explanation: 'For y=(x−p)²+q, the turning point is (p, q). Here p=3 and q=2, so the turning point is (3, 2). (-3, 2) flips the sign of p, (3, -2) flips the sign of q, and (2, 3) swaps the coordinates.',
    },

    // ── Q3 Hard — horizontal vs vertical shift misconception ─────────────────
    {
      difficulty: 'Hard',
      question: 'Sipho says y=(x+1)² and y=x²+1 represent the same horizontal shift. Is he correct?',
      checkMode: 'auto',
      options: [
        'Yes — both shift the graph 1 unit to the left.',
        'Yes — both shift the graph 1 unit upward.',
        'No — y=(x+1)² shifts the graph 1 unit to the left, while y=x²+1 shifts it 1 unit up (a vertical shift, not horizontal).',
        'No — y=(x+1)² shifts the graph 1 unit to the right, while y=x²+1 shifts it 1 unit up.',
      ],
      correctIndex: 2,
      explanation: 'Adding inside the bracket, as in (x+1)², shifts the graph horizontally (1 unit left). Adding outside, as in x²+1, shifts it vertically (1 unit up). These are different transformations, so Sipho is incorrect.',
    },
    ...
    // ── Q4 Easy — vertical asymptote of a hyperbola ──────────────────────────
    {
      ...
      correctIndex: 3,
      explanation: 'The denominator equals zero when x−5=0, so the vertical asymptote is x=5. x=-5 flips the sign, x=0 mistakenly uses the un-shifted asymptote, and y=5 confuses the vertical asymptote with a horizontal one.',
    },
    ...
    // ── Q6 Hard — substituting into a hyperbola ──────────────────────────────
    {
      ...
      options: ['3', '2', '1', '-1'],
      correctIndex: 0,
      explanation: 'Substitute x=−5: y=2/(−5+6)+1=2/1+1=3. Choosing 2 forgets to add the final +1, 1 wrongly adds q before dividing, and -1 flips the sign of q.',
    },
    ...
    // ── Q7 Medium — exponential horizontal shift direction ───────────────────
    {
      ...
      checkMode: 'auto',
      options: ['shifts 3 units to the right', 'shifts 3 units to the left', 'shifts 3 units up', 'shifts 3 units down'],
      correctIndex: 1,
      explanation: 'Since p=−3 inside the exponent (written as x−3), the graph shifts 3 units to the right. "Shifts 3 units to the left" reverses the direction, and the "up"/"down" options confuse a horizontal shift with a vertical one.',
    },
    ...
    // ── Q8 Hard — exponential growth rate with k ─────────────────────────────
    {
      ...
      checkMode: 'auto',
      options: [
        'With k=3, the graph grows three times as fast — the exponent triples for any given x value compared to y=5ˣ.',
        'With k=3, the graph shifts 3 units to the left compared to y=5ˣ.',
        'With k=3, the graph grows one-third as fast compared to y=5ˣ.',
        'With k=3, the horizontal asymptote moves from y=0 to y=3.',
      ],
      correctIndex: 0,
      explanation: 'The parameter k=3 multiplies the exponent, so the graph grows three times as fast as y=5ˣ. The other options confuse k with a horizontal shift (p), invert the growth effect, or wrongly move the asymptote, which k never affects.',
    },
    ...
    // ── Q9 Medium — parabola equation from turning point ─────────────────────
    {
      ...
      correctIndex: 2,
      explanation: 'Turning point (−1,4) gives p=1 and q=4. Since a=1 (same shape as y=x²): y=(x+1)²+4. The other options flip the sign of p, of q, or of both.',
    },
    ...
    // ── Q10 Hard — hyperbola equation from graph features ────────────────────
    {
      ...
      correctIndex: 0,
      explanation: 'Substitute (5,4): 4=a/(5−2)+3, so 1=a/3, giving a=3. Equation: y=3/(x−2)+3. The other options use the wrong value of a, flip the sign of q, or forget to subtract q before solving for a.',
    },
    ...
    // ── Q11 Medium — finding a in an exponential from a point ────────────────
    {
      ...
      options: ['6', '8', '2', '4'],
      correctIndex: 3,
      explanation: 'Substitute (0,6): 6=a·b⁰+2=a+2 (since b⁰=1). So a=6−2=4. Choosing 6 forgets to subtract q, 8 adds q instead of subtracting it, and 2 confuses a with q itself.',
    },
    ...
    // ── Q12 Hard — finding a in a parabola from two pieces of information ─────
    {
      ...
      options: ['4', '1', '2', '8'],
      correctIndex: 2,
      explanation: 'Substitute (5,6): 6=a(5−3)²−2=4a−2, so 8=4a, giving a=2. Choosing 4 forgets to divide by 4, 1 miscalculates (5−3)² as 8, and 8 stops before dividing by 4.',
    },
    ...
    // ── Q13 Medium — hyperbola equation with q=0 ─────────────────────────────
    {
      ...
      correctIndex: 2,
      explanation: 'Asymptotes give p=1 and q=0: y=a/(x+1). Substitute (0,4): 4=a/(0+1)=a. Equation: y=4/(x+1). The other options flip the sign of p, wrongly keep a nonzero q, or flip the sign of a.',
    },

    // ── Q14 Hard — y-intercept of exponential always at a+q ─────────────────
    {
      difficulty: 'Hard',
      question: 'Sipho says all exponential graphs of the form y=a·bˣ+q pass through the point (0,a+q). Is he correct?',
      checkMode: 'auto',
      options: [
        'Yes — substituting x=0 gives y=a·b⁰+q=a(1)+q=a+q, since any non-zero base raised to the power 0 equals 1.',
        'No — the y-intercept is always (0,q), since bˣ becomes 0 when x=0.',
        'No — the y-intercept is always (0,a), since q only affects the asymptote.',
        'Yes, but only when b=1, since otherwise b⁰ is undefined.',
      ],
      correctIndex: 0,
      explanation: 'Substituting x=0 gives y=a·b⁰+q. Since any non-zero base raised to the power 0 equals 1, this simplifies to y=a+q, so Sipho is correct. The other options wrongly assume b⁰=0, ignore a entirely, or wrongly claim b⁰ is undefined.',
    },
    ...
    // ── Q15 Hard — parabola with given width and turning point ───────────────
    {
      ...
      correctIndex: 2,
      explanation: '"Same width" means a=2, matching y=2x². Turning point (1,3) gives p=1 and q=3, so the equation is y=2(x−1)²+3. The other options flip the sign of p, drop the width value a=2, or flip the sign of q.',
    },
    ...
    // ── Q16 Hard — finding a in a hyperbola from a point ─────────────────────
    {
      ...
      options: ['4', '2', '-8', '8'],
      correctIndex: 3,
      explanation: 'Substitute (−1,2): 2=a/(−1+3)−2=a/2−2, so 4=a/2, giving a=8. Choosing 4 stops before doubling, 2 confuses a with the denominator value, and -8 flips the sign.',
    },
    ...
    // ── Q17 Hard — exponential with p: shift and y-intercept effect ──────────
    {
      ...
      checkMode: 'auto',
      options: [
        "y=3^(x+2) shifts 2 units left. At x=0: y=3^(0+2)=9, compared to y=3⁰=1 for the original — the shifted graph reaches a much higher value at x=0 since it's effectively further along the curve.",
        'y=3^(x+2) shifts 2 units right. At x=0: y=3^(0+2)=9, compared to y=3⁰=1 for the original.',
        'y=3^(x+2) shifts 2 units left. At x=0: y=3^(0+2)=6, compared to y=3⁰=1 for the original.',
        'y=3^(x+2) shifts 2 units left. At x=0: y=3^(0+2)=9, compared to y=3⁰=0 for the original.',
      ],
      correctIndex: 0,
      explanation: 'Since p=2 inside the exponent, the graph shifts 2 units left. At x=0, y=3²=9 for the shifted graph versus y=3⁰=1 for the original. The wrong options reverse the shift direction, miscalculate 3² as 6, or wrongly claim 3⁰=0.',
    },
    ...
    // ── Q18 Hard — finding both a and b in an exponential ────────────────────
    {
      ...
      correctIndex: 0,
      explanation: 'At x=0: 1=a·b⁰−3=a−3, so a=4. At x=1: 5=4b−3, so 8=4b, giving b=2. The other options mix up a and the y-intercept value, forget to subtract q when finding a, or flip the sign of a.',
    },
    ...
    // ── Q20 Hard — full hyperbola equation from asymptotes and a point ────────
    {
      ...
      correctIndex: 1,
      explanation: 'The asymptotes give p=4 and q=−1. Substitute (6,1): 1=a/(6−4)−1, so 2=a/2, giving a=4. Equation: y=4/(x−4)−1. The other options use the wrong value of a, flip the sign of p, or flip the sign of q.',
    },

    // ── Q21 Hard (problem-solving) — general proof of average gradient identity ──
    {
      difficulty: 'Hard',
      question: 'What does the average gradient of f(x)=x² between x=a and x=b (where a≠b) always simplify to, and why?',
      checkMode: 'auto',
      options: [
        'a+b, since (f(b)−f(a))/(b−a) = (b²−a²)/(b−a) = (b−a)(b+a)/(b−a) = a+b after cancelling (b−a), which is nonzero since a≠b.',
        'a−b, since the difference of squares factors as (b−a)(b−a).',
        '2ab, since squaring both values and dividing by their difference always produces a product term.',
        'It cannot be simplified further without knowing the specific values of a and b.',
      ],
      correctIndex: 0,
      explanation: '(f(b)−f(a))/(b−a) = (b²−a²)/(b−a). Since b²−a²=(b−a)(b+a), the (b−a) factors cancel (valid since a≠b), leaving a+b — true for any values of a and b, not just specific numbers.',
    },
    ...
    // ── Q22 Hard (problem-solving) — unknown parameter from a given average gradient ──
    {
      ...
      options: ['6', '3', '18', '2'],
      correctIndex: 3,
      explanation: 'f(1)=−3 and f(4)=a(4−1)²−3=9a−3. Average gradient=(f(4)−f(1))/(4−1)=9a/3=3a. Since the average gradient is 6: 3a=6, so a=2. Choosing 6 mistakes the average gradient itself for a, 3 stops halfway, and 18 forgets to divide by 3.',
    },
  ],
  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'Find the turning point of y=3(x−2)²+5.', checkMode: 'auto', options: ['(2, 5)', '(-2, 5)', '(2, -5)', '(5, 2)'], correctIndex: 0, explanation: 'For y=a(x−p)²+q, the turning point is (p, q). Here p=2 and q=5, so the turning point is (2, 5). The other options flip a sign or swap the coordinates.' },
        ...
        { difficulty: 'Easy-Medium', question: 'A hyperbola y=6/(x+2)−4 passes through a point with x=1. Find the corresponding y-value.', checkMode: 'auto', options: ['2', '-2', '6', '-6'], correctIndex: 1, explanation: 'Substitute x=1: y=6/(1+2)−4=6/3−4=2−4=−2. Choosing 2 forgets to subtract 4, 6 forgets to divide, and -6 flips the sign of the divided term.' },
        { difficulty: 'Easy-Medium', question: 'A hyperbola has vertical asymptote x=1 and horizontal asymptote y=2, and passes through (3,5), in the form y=a/(x−1)+2. Find a.', checkMode: 'auto', options: ['3', '12', '6', '1'], correctIndex: 2, explanation: 'Substitute (3,5): 5=a/(3−1)+2, so 3=a/2, giving a=6. Choosing 3 stops halfway, 12 doubles the answer by mistake, and 1 confuses a with the numerator before solving.' },
        ...
        { difficulty: 'Easy-Medium', question: 'Find the y-intercept of y=3·2ˣ−1.', checkMode: 'auto', options: ['3', '-1', '5', '2'], correctIndex: 3, explanation: 'Substitute x=0: y=3·2⁰−1=3(1)−1=3−1=2 (since 2⁰=1). Choosing 3 forgets to subtract 1, -1 forgets the coefficient a, and 5 miscalculates the subtraction.' },
        { difficulty: 'Medium', question: 'An exponential graph passes through (0,5) with horizontal asymptote y=−3, in the form y=a·2ˣ−3. Find a.', checkMode: 'auto', options: ['8', '2', '-8', '5'], correctIndex: 0, explanation: 'Substitute (0,5): 5=a·2⁰−3=a−3 (since 2⁰=1). So a=5+3=8. Choosing 2 confuses a with q, -8 flips the sign, and 5 confuses a with the y-intercept itself.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'Find the turning point of y=2(x+5)²−1.', checkMode: 'auto', options: ['(-5, -1)', '(5, -1)', '(-5, 1)', '(-1, -5)'], correctIndex: 0, explanation: 'For y=a(x+p)²+q, the turning point is (−p, q). Here p=5 and q=−1, so the turning point is (−5, −1). The other options flip a sign or swap the coordinates.' },
        ...
        { difficulty: 'Easy-Medium', question: 'A hyperbola y=5/(x−1)+2 passes through a point with x=6. Find the corresponding y-value.', checkMode: 'auto', options: ['1', '3', '7', '-3'], correctIndex: 1, explanation: 'Substitute x=6: y=5/(6−1)+2=5/5+2=1+2=3. Choosing 1 forgets to add 2, 7 miscalculates the division, and -3 flips the sign.' },
        { difficulty: 'Easy-Medium', question: 'A hyperbola has vertical asymptote x=−2 and horizontal asymptote y=−1, and passes through (0,3), in the form y=a/(x+2)−1. Find a.', checkMode: 'auto', options: ['4', '2', '8', '16'], correctIndex: 2, explanation: 'Substitute (0,3): 3=a/(0+2)−1, so 4=a/2, giving a=8. Choosing 4 stops halfway, 2 confuses a with the numerator, and 16 doubles the answer.' },
        ...
        { difficulty: 'Easy-Medium', question: 'Find the y-intercept of y=2·3ˣ+4.', checkMode: 'auto', options: ['2', '4', '8', '6'], correctIndex: 3, explanation: 'Substitute x=0: y=2·3⁰+4=2(1)+4=2+4=6 (since 3⁰=1). Choosing 2 forgets to add 4, 4 forgets the coefficient a, and 8 miscalculates the addition.' },
        { difficulty: 'Medium', question: 'An exponential graph passes through (0,7) with horizontal asymptote y=1, in the form y=a·3ˣ+1. Find a.', checkMode: 'auto', options: ['6', '1', '8', '7'], correctIndex: 0, explanation: 'Substitute (0,7): 7=a·3⁰+1=a+1 (since 3⁰=1). So a=7−1=6. Choosing 1 confuses a with q, 8 adds instead of subtracting, and 7 confuses a with the y-intercept itself.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'Find the turning point of y=5(x−1)²−4.', checkMode: 'auto', options: ['(1, -4)', '(-1, -4)', '(1, 4)', '(-4, 1)'], correctIndex: 0, explanation: 'For y=a(x−p)²+q, the turning point is (p, q). Here p=1 and q=−4, so the turning point is (1, −4). The other options flip a sign or swap the coordinates.' },
        ...
        { difficulty: 'Easy-Medium', question: 'A hyperbola y=8/(x+4)−1 passes through a point with x=−2. Find the corresponding y-value.', checkMode: 'auto', options: ['4', '3', '8', '-3'], correctIndex: 1, explanation: 'Substitute x=−2: y=8/(−2+4)−1=8/2−1=4−1=3. Choosing 4 forgets to subtract 1, 8 forgets to divide, and -3 flips the sign.' },
        { difficulty: 'Easy-Medium', question: 'A hyperbola has vertical asymptote x=3 and horizontal asymptote y=1, and passes through (5,4), in the form y=a/(x−3)+1. Find a.', checkMode: 'auto', options: ['3', '12', '6', '1'], correctIndex: 2, explanation: 'Substitute (5,4): 4=a/(5−3)+1, so 3=a/2, giving a=6. Choosing 3 stops halfway, 12 doubles the answer, and 1 confuses a with the numerator before solving.' },
        ...
        { difficulty: 'Easy-Medium', question: 'Find the y-intercept of y=4·2ˣ−5.', checkMode: 'auto', options: ['4', '-5', '9', '-1'], correctIndex: 3, explanation: 'Substitute x=0: y=4·2⁰−5=4(1)−5=4−5=−1 (since 2⁰=1). Choosing 4 forgets to subtract 5, -5 forgets the coefficient a, and 9 adds instead of subtracting.' },
        { difficulty: 'Medium', question: 'An exponential graph passes through (0,10) with horizontal asymptote y=−2, in the form y=a·4ˣ−2. Find a.', checkMode: 'auto', options: ['12', '-2', '8', '10'], correctIndex: 0, explanation: 'Substitute (0,10): 10=a·4⁰−2=a−2 (since 4⁰=1). So a=10+2=12. Choosing -2 confuses a with q, 8 subtracts instead of adding, and 10 confuses a with the y-intercept itself.' },
        ...
        { difficulty: 'Medium', question: 'A parabola has the same shape as y=x² with turning point (5,−3). Write its equation.', checkMode: 'auto', options: ['y=(x+5)²-3', 'y=(x-5)²-3', 'y=(x-5)²+3', 'y=(x+5)²+3'], correctIndex: 1, explanation: 'Turning point (5,−3) gives p=5 and q=−3. Since a=1 (same shape as y=x²): y=(x−5)²−3. The other options flip the sign of p, of q, or of both.' },
        { difficulty: 'Medium', question: 'A parabola in the form y=a(x+1)²+2 has turning point (−1,2) and passes through (1,10). Find a.', checkMode: 'auto', options: ['4', '8', '2', '1'], correctIndex: 2, explanation: 'Substitute (1,10): 10=a(1+1)²+2=4a+2, so 8=4a, giving a=2. Choosing 4 forgets to divide by 4, 8 stops before dividing, and 1 miscalculates (1+1)² as 8.' },
        { difficulty: 'Medium', question: 'A hyperbola has asymptotes x=−4 and y=1, and passes through (−2,4), in the form y=a/(x+4)+1. Find a.', checkMode: 'auto', options: ['3', '12', '1', '6'], correctIndex: 3, explanation: 'Substitute (−2,4): 4=a/(−2+4)+1, so 3=a/2, giving a=6. Choosing 3 stops halfway, 12 doubles the answer, and 1 confuses a with the numerator before solving.' },

        { difficulty: 'Medium', question: 'For f(x)=x², calculate the average gradient between x=−3 and x=0.', checkMode: 'auto', options: ['-3', '3', '-9', '9'], correctIndex: 0, explanation: 'Average gradient = (f(0)−f(−3))/(0−(−3)) = (0−9)/3 = −9/3 = −3. Choosing 3 flips the sign, -9 forgets to divide by 3, and 9 both flips the sign and forgets to divide.' },
        { difficulty: 'Medium', question: 'For f(x)=x²−1, calculate the average gradient between x=1 and x=3.', checkMode: 'auto', options: ['8', '4', '2', '-4'], correctIndex: 1, explanation: 'Average gradient = (f(3)−f(1))/(3−1) = (8−0)/2 = 8/2 = 4. Choosing 8 forgets to divide by 2, 2 miscalculates the difference in x, and -4 makes a sign error.' },
        { difficulty: 'Medium-Hard', question: 'For f(x)=2x²−5, calculate the average gradient between x=−2 and x=1.', checkMode: 'auto', options: ['2', '6', '-2', '-6'], correctIndex: 2, explanation: 'Average gradient = (f(1)−f(−2))/(1−(−2)) = (−3−3)/3 = −6/3 = −2. Choosing 2 flips the sign, 6 forgets to divide by 3, and -6 forgets the final division.' },
        { difficulty: 'Medium-Hard', question: 'For f(x)=−x²+5x, calculate the average gradient between x=0 and x=4.', checkMode: 'auto', options: ['4', '2', '0', '1'], correctIndex: 3, explanation: 'Average gradient = (f(4)−f(0))/(4−0) = (4−0)/4 = 4/4 = 1. Choosing 4 forgets to divide by 4, 2 miscalculates f(4), and 0 wrongly assumes f(4)=f(0).' },

        { difficulty: 'Hard', question: 'A hyperbola is shown on a set of axes with vertical asymptote x=4, horizontal asymptote y=−2, and passing through the point (6,1), in the form y=a/(x−4)−2. Using the diagram, find a and write the full equation.', checkMode: 'auto', options: ['y=6/(x-4)-2', 'y=3/(x-4)-2', 'y=6/(x-4)+2', 'y=6/(x+4)-2'], correctIndex: 0, explanation: 'Substitute (6,1): 1=a/(6−4)−2, so 3=a/2, giving a=6. Equation: y=6/(x−4)−2. The other options use the wrong value of a, or flip the sign of q or p read from the diagram.', diagramSvg: '<svg viewBox="0 0 220 220" xmlns="http://www.w3.org/2000/svg"><line x1="14" y1="2" x2="14" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="38" y1="2" x2="38" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="62" y1="2" x2="62" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="86" y1="2" x2="86" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="110" y1="2" x2="110" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="134" y1="2" x2="134" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="158" y1="2" x2="158" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="182" y1="2" x2="182" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="206" y1="2" x2="206" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="206" x2="218" y2="206" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="182" x2="218" y2="182" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="158" x2="218" y2="158" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="134" x2="218" y2="134" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="110" x2="218" y2="110" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="86" x2="218" y2="86" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="62" x2="218" y2="62" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="38" x2="218" y2="38" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="14" x2="218" y2="14" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="86" x2="218" y2="86" stroke="#374151" stroke-width="1.5"/><text x="210" y="80" font-size="11" fill="#374151">x</text><line x1="62" y1="2" x2="62" y2="218" stroke="#374151" stroke-width="1.5"/><text x="68" y="12" font-size="11" fill="#374151">y</text><line x1="16.88" y1="110" x2="203.12" y2="110" stroke="#ea580c" stroke-width="1.8" stroke-dasharray="5,4"/><text x="156.08" y="104" font-size="12" fill="#ea580c" font-weight="700" text-anchor="end">y = -2</text><line x1="110" y1="203.12" x2="110" y2="16.88" stroke="#ea580c" stroke-width="1.8" stroke-dasharray="5,4"/><text x="116" y="16" font-size="12" fill="#ea580c" font-weight="700" text-anchor="start">x = 4</text><path d="M119.12,15.26 L120.8,30 L122.48,40.77 L124.16,48.98 L125.84,55.45 L127.52,60.68 L129.2,65 L130.88,68.62 L132.56,71.7 L134.24,74.36 L135.92,76.67 L137.6,78.7 L139.28,80.49 L140.96,82.09 L142.64,83.53 L144.32,84.83 L146,86 L147.68,87.07 L149.36,88.05 L151.04,88.95 L152.72,89.78 L154.4,90.54 L156.08,91.25 L157.76,91.91 L159.44,92.52 L161.12,93.1 L162.8,93.64 L164.48,94.14 L166.16,94.62 L167.84,95.06 L169.52,95.48 L171.2,95.88 L172.88,96.26 L174.56,96.62 L176.24,96.96 L177.92,97.28 L179.6,97.59 L181.28,97.88 L182.96,98.16 L184.64,98.42 L186.32,98.68 L188,98.92 L189.68,99.16 L191.36,99.38 L193.04,99.6 L194.72,99.8 L196.4,100 L198.08,100.19 L199.76,100.37 L201.44,100.55 L203.12,100.72 L204.8,100.89 L206.48,101.04 L208.16,101.2 L209.84,101.35 L211.52,101.49 L213.2,101.63 L214.88,101.76 L216.56,101.89 L218.24,102.02 L219.92,102.14 L221.6,102.26 L223.28,102.37 L224.96,102.48 L226.64,102.59 L228.32,102.7 L230,102.8" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><path d="M100.88,204.74 L99.2,190 L97.52,179.23 L95.84,171.02 L94.16,164.55 L92.48,159.32 L90.8,155 L89.12,151.38 L87.44,148.3 L85.76,145.64 L84.08,143.33 L82.4,141.3 L80.72,139.51 L79.04,137.91 L77.36,136.47 L75.68,135.17 L74,134 L72.32,132.93 L70.64,131.95 L68.96,131.05 L67.28,130.22 L65.6,129.46 L63.92,128.75 L62.24,128.09 L60.56,127.48 L58.88,126.9 L57.2,126.36 L55.52,125.86 L53.84,125.38 L52.16,124.94 L50.48,124.52 L48.8,124.12 L47.12,123.74 L45.44,123.38 L43.76,123.04 L42.08,122.72 L40.4,122.41 L38.72,122.12 L37.04,121.84 L35.36,121.58 L33.68,121.32 L32,121.08 L30.32,120.84 L28.64,120.62 L26.96,120.4 L25.28,120.2 L23.6,120 L21.92,119.81 L20.24,119.63 L18.56,119.45 L16.88,119.28 L15.2,119.11 L13.52,118.96 L11.84,118.8 L10.16,118.65 L8.48,118.51 L6.8,118.37 L5.12,118.24 L3.44,118.11 L1.76,117.98 L0.08,117.86 L-1.6,117.74 L-3.28,117.63 L-4.96,117.52 L-6.64,117.41 L-8.32,117.3 L-10,117.2" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><circle cx="134" cy="74" r="3.5" fill="#2563eb"/><text x="141" y="66" font-size="12" fill="#2563eb" font-weight="700" text-anchor="start">(6, 1)</text></svg>' },
        { difficulty: 'Hard', question: 'Thabo says that if a parabola opens downward, its average gradient between any two points must always be negative. Use f(x)=−x²+5x between x=0 and x=4 to check his claim — is he correct in general?', checkMode: 'auto', options: [
          'He is correct — downward-opening parabolas always have a negative average gradient everywhere.',
          'For f(x)=−x²+5x (which opens downward since a=−1<0), the average gradient between x=0 and x=4 is (4−0)/4=1, which is positive. This disproves his claim — even a downward-opening parabola can have a positive average gradient over an interval where the function is still increasing overall (before reaching its turning point).',
          'He is correct, but only when the interval includes the turning point.',
          'He is incorrect — the average gradient between x=0 and x=4 is -1, which is negative but proves nothing about parabolas in general.',
        ], correctIndex: 1, explanation: 'f(0)=0 and f(4)=4, so the average gradient is (4−0)/4=1, which is positive — disproving Thabo\'s claim. A downward-opening parabola can still have a positive average gradient over an interval where it is increasing overall, before reaching its turning point.' },
        { difficulty: 'Hard', question: 'A parabola is shown on a set of axes with turning point (3,2), passing through the point (5,10), in the form y=a(x−3)²+2. Using the diagram, find a and write the full equation.', checkMode: 'auto', options: ['y=4(x-3)²+2', 'y=2(x+3)²+2', 'y=2(x-3)²+2', 'y=2(x-3)²-2'], correctIndex: 2, explanation: 'Substitute (5,10): 10=a(5−3)²+2, so 8=4a, giving a=2. Equation: y=2(x−3)²+2. The other options use the wrong value of a, or flip the sign of p or q read from the diagram.', diagramSvg: '<svg viewBox="0 0 220 220" xmlns="http://www.w3.org/2000/svg"><line x1="20" y1="2" x2="20" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="50" y1="2" x2="50" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="80" y1="2" x2="80" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="110" y1="2" x2="110" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="140" y1="2" x2="140" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="170" y1="2" x2="170" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="200" y1="2" x2="200" y2="218" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="190" x2="218" y2="190" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="160" x2="218" y2="160" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="130" x2="218" y2="130" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="100" x2="218" y2="100" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="70" x2="218" y2="70" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="40" x2="218" y2="40" stroke="#e5e7eb" stroke-width="1"/><line x1="2" y1="130" x2="218" y2="130" stroke="#374151" stroke-width="1.5"/><text x="210" y="124" font-size="11" fill="#374151">x</text><line x1="80" y1="2" x2="80" y2="218" stroke="#374151" stroke-width="1.5"/><text x="86" y="12" font-size="11" fill="#374151">y</text><path d="M88,13.2 L90.75,35.89 L93.5,55.55 L96.25,72.19 L99,85.8 L101.75,96.39 L104.5,103.95 L107.25,108.49 L110,110 L112.75,108.49 L115.5,103.95 L118.25,96.39 L121,85.8 L123.75,72.19 L126.5,55.55 L129.25,35.89 L132,13.2" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><circle cx="110" cy="110" r="3.5" fill="#2563eb"/><text x="116" y="126" font-size="12" fill="#2563eb" font-weight="700" text-anchor="start">(3, 2)</text><circle cx="130" cy="30" r="3.5" fill="#2563eb"/><text x="137" y="22" font-size="12" fill="#2563eb" font-weight="700" text-anchor="start">(5, 10)</text></svg>' },
      ],
      scoreMessages: [
