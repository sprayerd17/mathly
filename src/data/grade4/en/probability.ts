  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'A baby will be born somewhere in South Africa today. Classify this event.', answer: 'Likely', checkMode: 'auto', correctAnswer: 'likely', correctAnswers: ['likely'], explanation: 'This is almost always true — babies are born in South Africa every single day — but it is not a logical certainty, so we call it Likely rather than Certain.' },
