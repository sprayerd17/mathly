  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium-Hard', question: 'Explain how you would find the rule for a pattern when the difference between terms is not the same each time.', answer: 'If the difference keeps changing, addition or subtraction is probably not the rule. Instead, try dividing each term by the one before it — if that ratio is always the same number, the pattern is a multiplication (or division) pattern, and that ratio is the rule. If neither a constant difference nor a constant ratio works, look for a two-step or changing rule, and test it against every pair of terms before deciding.', checkMode: 'self' },
