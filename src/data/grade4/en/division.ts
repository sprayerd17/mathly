  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'True or false: 9 × 6 = 54, so it must also be true that 54 ÷ 9 = 6. Write "true" or "false".', answer: 'true', checkMode: 'auto', correctAnswer: 'true', correctAnswers: ['true', 'yes', 'correct'], explanation: 'True — 9 × 6 = 54, and dividing a product by one factor always gives the other factor, so 54 ÷ 9 = 6.' },
        ...
        { difficulty: 'Medium', question: 'A box holds 61 apples. If 8 apples are packed per bag, how many full bags are there, and how many apples are left over?', answer: '7 r 5', checkMode: 'auto', correctAnswer: '7r5', correctAnswers: ['7r5', '7remainder5', '7rem5'], explanation: '8 × 7 = 56 (closest without exceeding 61). 61 − 56 = 5 left over. 61 ÷ 8 = 7 r 5.' },
        ...
        { difficulty: 'Medium', question: 'A charity packed 315 blankets equally into 5 delivery trucks. How many blankets went into each truck? Show your long division working.', answer: '63', checkMode: 'self', correctAnswer: '63', explanation: '31 ÷ 5 = 6 r 1, bring down 5 → 15. 15 ÷ 5 = 3. So 315 ÷ 5 = 63 blankets per truck.' },
        ...
        { difficulty: 'Medium', question: 'A learner used long division and got 386 ÷ 9 = 43 r 8. Check the working by multiplying the quotient by the divisor and adding the remainder. Is the learner\'s answer correct? Give the correct quotient and remainder.', answer: '42 r 8', checkMode: 'self', explanation: 'Check: 9 × 43 = 387, plus 8 gives 395 — far more than 386, so the learner is wrong. Correct working: 38 ÷ 9 = 4 r 2 (9 × 4 = 36, 38 − 36 = 2). Bring down 6 → 26. 26 ÷ 9 = 2 r 8 (9 × 2 = 18, 26 − 18 = 8). So 386 ÷ 9 = 42 r 8.' },
        ...
        { difficulty: 'Medium', question: 'A gardener plants 91 seedlings in equal rows of 7. Write the division number sentence for this problem, then solve it to find how many rows there are.', answer: '91 ÷ 7 = 13', checkMode: 'auto', correctAnswer: '91÷7=13', correctAnswers: ['91÷7=13', '91/7=13', '13'], explanation: 'The number sentence is 91 ÷ 7. 91 ÷ 7 = 13 rows.' },
        ...
        { difficulty: 'Medium-Hard', question: 'A bakery earns R216 from selling loaves, shared equally across a 9-hour shift. If the baker then spends R14 on flour for the next batch, how much money is left from one hour\'s earnings after buying the flour?', answer: '10', checkMode: 'auto', correctAnswer: '10', explanation: '216 ÷ 9 = 24 (earned per hour). 24 − 14 = 10. R10 is left over.' },
        { difficulty: 'Medium-Hard', question: 'A school is organising transport for 100 learners on a trip. Each van holds 8 learners. Explain why simply calculating 100 ÷ 8 does not give the number of vans needed, and state how many vans must actually be booked.', answer: '13', checkMode: 'self', correctAnswer: '13', correctAnswers: ['13', '13 vans'], explanation: '100 ÷ 8 = 12 r 4. Twelve vans fill exactly 96 seats, but 4 learners are still left without a seat, so a 13th van is needed even though it will not be full. Simply taking the quotient (12) would leave learners behind — you must round up whenever there is a remainder. 13 vans in total.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'Fill in the missing number: 7 × ___ = 49, and use it to state what 49 ÷ 7 equals.', answer: '7', checkMode: 'auto', correctAnswer: '7', explanation: '7 × 7 = 49, so the missing number is 7. This also means 49 ÷ 7 = 7.' },
        ...
        { difficulty: 'Medium', question: 'A crate holds 67 eggs. If they are repacked into egg trays of 9, how many full trays are there, and how many eggs are left over?', answer: '7 r 4', checkMode: 'auto', correctAnswer: '7r4', correctAnswers: ['7r4', '7remainder4', '7rem4'], explanation: '9 × 7 = 63 (closest without exceeding 67). 67 − 63 = 4 left over. 67 ÷ 9 = 7 r 4.' },
        ...
        { difficulty: 'Medium', question: 'A factory produced 434 tins and packed them equally onto 7 pallets. How many tins are on each pallet? Show your long division working.', answer: '62', checkMode: 'self', correctAnswer: '62', explanation: '43 ÷ 7 = 6 r 1, bring down 4 → 14. 14 ÷ 7 = 2. So 434 ÷ 7 = 62 tins per pallet.' },
        ...
        { difficulty: 'Medium', question: 'A learner used long division and got 462 ÷ 11 = 24. Check the working by multiplying the quotient by the divisor. Is the learner\'s answer correct? Give the correct answer.', answer: '42', checkMode: 'self', explanation: 'Check: 11 × 24 = 264, which does not equal 462, so the learner is wrong (they likely swapped the digits of the answer). Correct working: 46 ÷ 11 = 4 r 2 (11 × 4 = 44, 46 − 44 = 2). Bring down 2 → 22. 22 ÷ 11 = 2 (11 × 2 = 22, 22 − 22 = 0). So 462 ÷ 11 = 42 exactly.' },

        // Block 4 — Word Problems: Sharing vs Grouping (12-15, Medium)
        { difficulty: 'Medium', question: 'A shopkeeper shares 84 sweets equally among 6 children. Is this a sharing problem or a grouping problem? Explain briefly, then give the answer.', answer: 'Sharing — 14 sweets each', checkMode: 'self', explanation: 'This is a sharing problem: we know the total (84) and the number of groups (6), and must find how many each group receives. 84 ÷ 6 = 14 sweets each.' },
        ...
        { difficulty: 'Medium', question: 'A farmer plants 117 cabbages in equal rows of 9. Write the division number sentence for this problem, then solve it to find how many rows there are.', answer: '117 ÷ 9 = 13', checkMode: 'auto', correctAnswer: '117÷9=13', correctAnswers: ['117÷9=13', '117/9=13', '13'], explanation: 'The number sentence is 117 ÷ 9. 117 ÷ 9 = 13 rows.' },
        ...
        // Block 5 — Multi-Step & Applied Problems (16-17, Medium-Hard)
        { difficulty: 'Medium-Hard', question: 'A market stall earns R270 from selling fruit, shared equally across a 9-hour day. If the stallholder then spends R18 on ice for keeping fruit cool, how much money is left from one hour\'s earnings after buying the ice?', answer: '12', checkMode: 'auto', correctAnswer: '12', explanation: '270 ÷ 9 = 30 (earned per hour). 30 − 18 = 12. R12 is left over.' },
        { difficulty: 'Medium-Hard', question: 'A community hall is arranging seating for 130 guests at a wedding. Each table seats 9 guests. Explain why simply calculating 130 ÷ 9 does not give the number of tables needed, and state how many tables must actually be set up.', answer: '15', checkMode: 'self', correctAnswer: '15', correctAnswers: ['15', '15 tables'], explanation: '130 ÷ 9 = 14 r 4. Fourteen tables seat exactly 126 guests, but 4 guests are still left without a seat, so a 15th table is needed even though it will not be full. Simply taking the quotient (14) would leave guests without seats — you must round up whenever there is a remainder. 15 tables in total.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'A learner says the missing number in 6 × ___ = 42 is 8. Is this correct? Give the correct missing number and state what 42 ÷ 6 equals.', answer: '7', checkMode: 'auto', correctAnswer: '7', explanation: 'The learner is wrong: 6 × 8 = 48, not 42. The correct missing number is 7, since 6 × 7 = 42. This also means 42 ÷ 6 = 7.' },
        ...
        { difficulty: 'Medium', question: 'A tank holds 71 litres, poured out into containers of 9 litres each. How many full containers are there, and how many litres are left over?', answer: '7 r 8', checkMode: 'auto', correctAnswer: '7r8', correctAnswers: ['7r8', '7remainder8', '7rem8'], explanation: '9 × 7 = 63 (closest without exceeding 71). 71 − 63 = 8 left over. 71 ÷ 9 = 7 r 8.' },
        ...
        { difficulty: 'Medium', question: 'A printer produced 512 pamphlets and bundled them equally into 8 boxes. How many pamphlets are in each box? Show your long division working.', answer: '64', checkMode: 'self', correctAnswer: '64', explanation: '51 ÷ 8 = 6 r 3, bring down 2 → 32. 32 ÷ 8 = 4. So 512 ÷ 8 = 64 pamphlets per box.' },
        ...
        { difficulty: 'Medium', question: 'A learner used long division and got 429 ÷ 12 = 34 r 21. Check the working — is the remainder allowed for this divisor? Give the correct quotient and remainder.', answer: '35 r 9', checkMode: 'self', explanation: 'The learner is wrong: a remainder of 21 cannot be correct when dividing by 12, since 21 is bigger than 12 — another whole group of 12 still fits inside it. Correct working: 42 ÷ 12 = 3 r 6 (12 × 3 = 36, 42 − 36 = 6). Bring down 9 → 69. 69 ÷ 12 = 5 r 9 (12 × 5 = 60, 69 − 60 = 9). So 429 ÷ 12 = 35 r 9.' },
        ...
        { difficulty: 'Medium', question: 'A learner arranges 78 desks in equal rows of 6. Write the division number sentence for this problem, then solve it to find how many rows there are.', answer: '78 ÷ 6 = 13', checkMode: 'auto', correctAnswer: '78÷6=13', correctAnswers: ['78÷6=13', '78/6=13', '13'], explanation: 'The number sentence is 78 ÷ 6. 78 ÷ 6 = 13 rows.' },
        ...
        // Block 5 — Multi-Step & Applied Problems (16-17, Medium-Hard)
        { difficulty: 'Medium-Hard', question: 'A car wash earns R288 from washing cars, shared equally across an 8-hour shift. If the owner then spends R11 on soap for the next shift, how much money is left from one hour\'s earnings after buying the soap?', answer: '25', checkMode: 'auto', correctAnswer: '25', explanation: '288 ÷ 8 = 36 (earned per hour). 36 − 11 = 25. R25 is left over.' },
        { difficulty: 'Medium-Hard', question: 'A church is arranging transport for 85 members to a conference. Each bus holds 9 members. Explain why simply calculating 85 ÷ 9 does not give the number of buses needed, and state how many buses must actually be booked.', answer: '10', checkMode: 'self', correctAnswer: '10', correctAnswers: ['10', '10 buses'], explanation: '85 ÷ 9 = 9 r 4. Nine buses seat exactly 81 members, but 4 members are still left without a seat, so a 10th bus is needed even though it will not be full. Simply taking the quotient (9) would leave members behind — you must round up whenever there is a remainder. 10 buses in total.' },
