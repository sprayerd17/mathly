  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'Look at the picture: a house made from 1 triangle (the roof) sitting on top of 1 square (the walls). How many basic shapes make up this composite shape in total?', answer: '2', checkMode: 'auto', correctAnswer: '2', correctAnswers: ['2', 'two'], explanation: '1 triangle + 1 square = 2 basic shapes in total ✓', diagramSvg: '<svg viewBox="0 0 220 170" xmlns="http://www.w3.org/2000/svg"><rect x="75" y="85" width="70" height="70" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><polygon points="110,40 75,85 145,85" fill="none" stroke="#0f1f3d" stroke-width="2.5"/></svg>' },
        { difficulty: 'Easy', question: 'Using the same house picture (1 triangle roof on 1 square wall), name the basic shapes used to build it.', answer: 'The house is made from 1 triangle (the roof) and 1 square (the walls).', checkMode: 'self', diagramSvg: '<svg viewBox="0 0 220 170" xmlns="http://www.w3.org/2000/svg"><rect x="75" y="85" width="70" height="70" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><polygon points="110,40 75,85 145,85" fill="none" stroke="#0f1f3d" stroke-width="2.5"/></svg>' },
