  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy-Medium', question: 'Convert 600 cm to m.', answer: '6 m', checkMode: 'auto', correctAnswer: '6m', correctAnswers: ['6m', '6', '6 m'], explanation: 'To convert cm to m, divide by 100. 600 ÷ 100 = 6 m ✓' },
        { difficulty: 'Medium', question: 'Convert 3 km to m.', answer: '3 000 m', checkMode: 'auto', correctAnswer: '3000m', correctAnswers: ['3000m', '3000', '3 000m', '3000 m', '3 000 m'], explanation: 'To convert km to m, multiply by 1 000. 3 × 1 000 = 3 000 m ✓' },
        ...
        { difficulty: 'Medium', question: 'Convert 480 cm to the mixed form (m and cm).', answer: '4 m 80 cm', checkMode: 'auto', correctAnswer: '4m80cm', correctAnswers: ['4m80cm', '4 m80cm', '480cm', '480'], explanation: '480 cm = 400 cm + 80 cm = 4 m 80 cm ✓' },
        { difficulty: 'Medium', question: 'Convert 1 350 m to the mixed form (km and m).', answer: '1 km 350 m', checkMode: 'auto', correctAnswer: '1km350m', correctAnswers: ['1km350m', '1 km350m', '1350m', '1350'], explanation: '1 350 m = 1 000 m + 350 m = 1 km 350 m ✓' },
        { difficulty: 'Medium', question: 'Convert 2 km 600 m to a single number of metres.', answer: '2 600 m', checkMode: 'auto', correctAnswer: '2600m', correctAnswers: ['2600m', '2600', '2 600m', '2600 m', '2 600 m'], explanation: '2 km 600 m = 2 000 m + 600 m = 2 600 m ✓' },
        { difficulty: 'Medium', question: 'Convert 6 m 25 cm to a single number of centimetres.', answer: '625 cm', checkMode: 'auto', correctAnswer: '625cm', correctAnswers: ['625cm', '625', '625 cm'], explanation: '6 m 25 cm = 600 cm + 25 cm = 625 cm ✓' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'Convert 12 cm to mm.', answer: '120 mm', checkMode: 'auto', correctAnswer: '120mm', correctAnswers: ['120mm', '120', '120 mm'], explanation: 'To convert cm to mm, multiply by 10. 12 × 10 = 120 mm ✓' },
        { difficulty: 'Easy-Medium', question: 'Convert 9 m to cm.', answer: '900 cm', checkMode: 'auto', correctAnswer: '900cm', correctAnswers: ['900cm', '900', '900 cm'], explanation: 'To convert m to cm, multiply by 100. 9 × 100 = 900 cm ✓' },
        { difficulty: 'Medium', question: 'Convert 8 000 m to km.', answer: '8 km', checkMode: 'auto', correctAnswer: '8km', correctAnswers: ['8km', '8', '8 km'], explanation: 'To convert m to km, divide by 1 000. 8 000 ÷ 1 000 = 8 km ✓' },
        ...
        // Block C — Multi-step / mixed-unit conversions (9-12, Medium)
        { difficulty: 'Medium', question: 'Convert 640 cm to the mixed form (m and cm).', answer: '6 m 40 cm', checkMode: 'auto', correctAnswer: '6m40cm', correctAnswers: ['6m40cm', '6 m40cm', '640cm', '640'], explanation: '640 cm = 600 cm + 40 cm = 6 m 40 cm ✓' },
        { difficulty: 'Medium', question: 'Convert 2 175 m to the mixed form (km and m).', answer: '2 km 175 m', checkMode: 'auto', correctAnswer: '2km175m', correctAnswers: ['2km175m', '2 km175m', '2175m', '2175'], explanation: '2 175 m = 2 000 m + 175 m = 2 km 175 m ✓' },
        { difficulty: 'Medium', question: 'Convert 3 km 400 m to a single number of metres.', answer: '3 400 m', checkMode: 'auto', correctAnswer: '3400m', correctAnswers: ['3400m', '3400', '3 400m', '3400 m', '3 400 m'], explanation: '3 km 400 m = 3 000 m + 400 m = 3 400 m ✓' },
        { difficulty: 'Medium', question: 'Convert 4 m 15 cm to a single number of centimetres.', answer: '415 cm', checkMode: 'auto', correctAnswer: '415cm', correctAnswers: ['415cm', '415', '415 cm'], explanation: '4 m 15 cm = 400 cm + 15 cm = 415 cm ✓' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'Convert 6 cm to mm.', answer: '60 mm', checkMode: 'auto', correctAnswer: '60mm', correctAnswers: ['60mm', '60', '60 mm'], explanation: 'To convert cm to mm, multiply by 10. 6 × 10 = 60 mm ✓' },
        { difficulty: 'Easy-Medium', question: 'Convert 250 cm to m.', answer: '2.5 m', checkMode: 'auto', correctAnswer: '2.5m', correctAnswers: ['2.5m', '2.5', '2.5 m'], explanation: 'To convert cm to m, divide by 100. 250 ÷ 100 = 2.5 m ✓' },
        { difficulty: 'Medium', question: 'Convert 6 km to m.', answer: '6 000 m', checkMode: 'auto', correctAnswer: '6000m', correctAnswers: ['6000m', '6000', '6 000m', '6000 m', '6 000 m'], explanation: 'To convert km to m, multiply by 1 000. 6 × 1 000 = 6 000 m ✓' },
        ...
        // Block C — Multi-step / mixed-unit conversions (9-12, Medium)
        { difficulty: 'Medium', question: 'Convert 720 cm to the mixed form (m and cm).', answer: '7 m 20 cm', checkMode: 'auto', correctAnswer: '7m20cm', correctAnswers: ['7m20cm', '7 m20cm', '720cm', '720'], explanation: '720 cm = 700 cm + 20 cm = 7 m 20 cm ✓' },
        { difficulty: 'Medium', question: 'Convert 4 080 m to the mixed form (km and m).', answer: '4 km 80 m', checkMode: 'auto', correctAnswer: '4km80m', correctAnswers: ['4km80m', '4 km80m', '4080m', '4080'], explanation: '4 080 m = 4 000 m + 80 m = 4 km 80 m ✓' },
        { difficulty: 'Medium', question: 'Convert 5 km 90 m to a single number of metres.', answer: '5 090 m', checkMode: 'auto', correctAnswer: '5090m', correctAnswers: ['5090m', '5090', '5 090m', '5090 m', '5 090 m'], explanation: '5 km 90 m = 5 000 m + 90 m = 5 090 m ✓' },
        { difficulty: 'Medium', question: 'Convert 2 m 8 cm to a single number of centimetres.', answer: '208 cm', checkMode: 'auto', correctAnswer: '208cm', correctAnswers: ['208cm', '208', '208 cm'], explanation: '2 m 8 cm = 200 cm + 8 cm = 208 cm ✓' },
