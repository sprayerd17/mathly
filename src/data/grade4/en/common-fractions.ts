  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: "Which fraction is bigger: 3/7 or 5/7?", answer: "5/7", checkMode: 'auto', correctAnswer: "5/7", explanation: "Same denominator (7), so compare numerators. 5 is greater than 3, so 5/7 is bigger." },
        { difficulty: 'Medium', question: "Which fraction is bigger: 1/4 or 1/8?", answer: "1/4", checkMode: 'auto', correctAnswer: "1/4", explanation: "Both are unit fractions (numerator 1). The smaller the denominator, the bigger the fraction. 4 is less than 8, so 1/4 is bigger." },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: "Which fraction is smaller: 2/9 or 6/9?", answer: "2/9", checkMode: 'auto', correctAnswer: "2/9", explanation: "Same denominator (9), so compare numerators. 2 is less than 6, so 2/9 is smaller." },
        { difficulty: 'Medium', question: "Which fraction is smaller: 1/3 or 1/6?", answer: "1/6", checkMode: 'auto', correctAnswer: "1/6", explanation: "Both are unit fractions. The bigger the denominator, the smaller the fraction. 6 is greater than 3, so 1/6 is smaller." },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: "Which fraction is bigger: 4/11 or 8/11?", answer: "8/11", checkMode: 'auto', correctAnswer: "8/11", explanation: "Same denominator (11), so compare numerators. 8 is greater than 4, so 8/11 is bigger." },
        { difficulty: 'Medium', question: "Which fraction is bigger: 1/5 or 1/9?", answer: "1/5", checkMode: 'auto', correctAnswer: "1/5", explanation: "Both are unit fractions (numerator 1). The smaller the denominator, the bigger the fraction. 5 is less than 9, so 1/5 is bigger." },
