  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy-Medium', question: 'A charity concert sold 6 194 tickets. Look at the digit 9 in the ticket total — what column is it in, and what is its value?', answer: 'Tens column; value is 90', checkMode: 'auto', correctAnswer: '90', correctAnswers: ['90'], explanation: 'The digit 9 in 6 194 is in the Tens column, so its value is 9 × 10 = 90.' },
        ...
        { difficulty: 'Medium', question: 'Order these numbers from smallest to biggest, separated by commas: 5 148, 876, 5 481, 2 019', answer: '876, 2 019, 5 148, 5 481', checkMode: 'auto', correctAnswer: '876201951485481', correctAnswers: ['876201951485481'], explanation: '876 has 3 digits, so it is smallest. 2 019 has 4 digits with 2 thousands. 5 148 and 5 481 both have 5 thousands — compare hundreds: 1 < 4, so 5 148 < 5 481. Order: 876, 2 019, 5 148, 5 481.' },
        ...
        { difficulty: 'Medium', question: 'A baker needs 3 456 grams of flour for a big order. Round this mass to the nearest 10 grams so it fits neatly on the recipe card.', answer: '3 460', checkMode: 'auto', correctAnswer: '3460', correctAnswers: ['3460', '3 460'], explanation: 'The units digit is 6 (≥ 5), so round up: 3 456 → 3 460.' },
        { difficulty: 'Medium', question: 'A charity event raised R5 234. The newsletter wants to report the total rounded to the nearest R100. What amount should it print?', answer: 'R5 200', checkMode: 'auto', correctAnswer: '5200', correctAnswers: ['5200', '5 200'], explanation: 'The tens digit is 3 (< 5), so round down: 5 234 → 5 200.' },
        { difficulty: 'Medium', question: 'A student claims that rounding 5 999 to the nearest 10 leaves the number almost unchanged, "since we\'re only rounding the units." Show the actual rounded answer and explain why several digits change.', answer: '6 000 — several digits change because of carrying', checkMode: 'auto', correctAnswer: '6000', correctAnswers: ['6000', '6 000'], explanation: 'The units digit is 9 (≥ 5), so round up: 5 999 → 6 000. Even though only the units column is the "deciding digit," rounding up causes the tens, hundreds and thousands digits to all change because of carrying — the claim is misleading.' },
        ...
        { difficulty: 'Hard', question: 'A concert hall had 3 847 people attend a show. The venue manager wants an easy-to-read estimate rounded to the nearest 100, and a news report rounds the same crowd to the nearest 10 for a "final tally". Write both rounded numbers (nearest 100 first, then nearest 10), then say which one is closer to the real crowd of 3 847.', answer: 'Nearest 100 = 3 800; Nearest 10 = 3 850; the nearest-10 estimate (3 850) is closer.', checkMode: 'auto', correctAnswer: '38003850', correctAnswers: ['38003850', '3800 3850 nearest10', '3 800, 3 850, nearest 10'], explanation: 'Nearest 100: tens digit 4 (< 5), round down → 3 800. Nearest 10: units digit 7 (≥ 5), round up → 3 850. Distances from 3 847: 3 847 − 3 800 = 47, while 3 850 − 3 847 = 3. Since 3 < 47, the nearest-10 estimate is closer.' },
      ],
      scoreMessages: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy-Medium', question: 'A vending machine has counted 3 516 sales this year. Look at the digit 6 in that total — which column is it in, and what is its value?', answer: 'Units column; value is 6', checkMode: 'auto', correctAnswer: '6', correctAnswers: ['6'], explanation: 'The digit 6 in 3 516 is in the Units column, so its value is 6 × 1 = 6.' },
        ...
        { difficulty: 'Medium', question: 'A delivery van has driven 6 784 km this month. Round this distance to the nearest 10 km for the driver\'s logbook.', answer: '6 780', checkMode: 'auto', correctAnswer: '6780', correctAnswers: ['6780', '6 780'], explanation: 'The units digit is 4 (< 5), so round down: 6 784 → 6 780.' },
        { difficulty: 'Medium', question: 'A farm harvested 7 849 kg of maize. The co-op wants this reported rounded to the nearest 100 kg. What figure should appear on the report?', answer: '7 800 kg', checkMode: 'auto', correctAnswer: '7800', correctAnswers: ['7800', '7 800'], explanation: 'The tens digit is 4 (< 5), so round down: 7 849 → 7 800.' },
        { difficulty: 'Medium', question: 'A student rounds 1 499 to the nearest 100 and writes 1 400, arguing "the first digit is 1, so it must round down." Show the correct rounded answer and explain the student\'s mistake.', answer: '1 500 — the student looked at the wrong digit', checkMode: 'auto', correctAnswer: '1500', correctAnswers: ['1500', '1 500'], explanation: 'To round to the nearest 100 you must check the tens digit, not the thousands digit. In 1 499 the tens digit is 9 (≥ 5), so round up: 1 499 → 1 500 (the hundreds and tens digits change because of carrying).' },
