  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'Comparing grid references D2 and D4, are these two grid references the same position, different columns, or different rows?', checkMode: 'auto', answer: 'Different rows', correctAnswer: 'different rows', correctAnswers: ['different rows', 'different row', 'different'], explanation: 'D2 and D4 share the same column (D) but have different row numbers (2 and 4), so they are different rows.' },
