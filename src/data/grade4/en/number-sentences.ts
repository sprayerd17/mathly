  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'Thabo claims that in the number sentence □ + 8 = 20, the missing value must be 12. Is he correct? Explain your reasoning.', answer: 'Yes, Thabo is correct. Since 8 is being added to the missing value, use the inverse operation — subtraction — to undo the addition: 20 − 8 = 12, so □ = 12. Checking by substituting back: 12 + 8 = 20, which matches the right side, confirming that Thabo\'s claim is correct.', checkMode: 'self' },
