  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'A shop had 96 loaves of bread. By the end of the day, 59 loaves were sold.\n\na) Write the number sentence for this problem. Use □ for the unknown value.\nb) Solve it to find how many loaves are left. Write only the number.\nc) Explain why subtraction is the correct operation to use here, rather than addition.', answer: 'a) 96 − 59 = □  b) 37  c) Because loaves are being sold (taken away), the total decreases, so subtraction correctly models loaves being removed from the starting amount.', parts: [ { label: 'a) Number sentence', correctAnswer: '96-59=□', correctAnswers: ['96-59=□', '96-59=?', '96-59=n', '96−59=□'], explanation: 'The shop starts with 96 loaves and 59 are sold (subtracted).\nNumber sentence: 96 − 59 = □', checkMode: 'auto' }, { label: 'b) Loaves left', correctAnswer: '37', explanation: '96 − 59 = 37\nThere are 37 loaves left ✓', checkMode: 'auto' }, { label: 'c) Reasoning', answer: 'Because loaves are being sold (taken away), the total decreases, so subtraction correctly models loaves being removed from the starting amount.', explanation: 'Selling loaves removes them from the total, so subtraction is the correct operation to model the decrease.', checkMode: 'self' } ], checkMode: 'auto' },
        ...
        { difficulty: 'Hard', question: 'Sipho solves the number sentence □ × 4 = 36 and gets □ = 9, but his friend Lerato solved a similar sentence □ × 4 = 40 and also wrote □ = 9. Explain why Lerato\'s answer must be wrong, and show how she should check her work.', answer: 'Lerato\'s answer must be wrong because different number sentences generally have different missing values — she cannot get the same answer of 9 for both 36 and 40 on the right side. To check her work, she should substitute her answer back into her own number sentence: 9 × 4 = 36, not 40, so □ = 9 does not make her sentence true. She should instead use the inverse operation: 40 ÷ 4 = 10, so the correct missing value for her sentence is □ = 10.', checkMode: 'self' },
      ],
      scoreMessages: [
        { minScore: 20, message: 'Outstanding! You have mastered finding and reasoning about missing values in number sentences.' },
        { minScore: 15, message: 'Great work! Review any missed questions and try again.' },
