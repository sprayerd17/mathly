  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'I have two flat circular faces and one curved surface joining them, with no vertices at all. What 3D object am I?', answer: 'Cylinder', checkMode: 'auto', correctAnswer: 'Cylinder', correctAnswers: ['Cylinder', 'cylinder', 'a cylinder'], explanation: 'Two flat circular faces joined by a curved surface, with no sharp points, describe a cylinder.' },
        ...
        { difficulty: 'Medium', question: 'Thabo says a dice is shaped like a cube. Is he correct?', answer: 'Yes', checkMode: 'auto', correctAnswer: 'Yes', correctAnswers: ['Yes', 'yes'], explanation: 'A dice has 6 equal square faces, 12 edges and 8 vertices — it is a cube.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'How many faces does a triangular prism have in total?', answer: '5', checkMode: 'auto', correctAnswer: '5', correctAnswers: ['5', 'five'], explanation: 'A triangular prism has 5 faces — 2 triangular bases and 3 rectangular side faces.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'All of my faces are flat squares, and I have 8 vertices. What 3D object am I?', answer: 'Cube', checkMode: 'auto', correctAnswer: 'Cube', correctAnswers: ['Cube', 'cube', 'a cube'], explanation: 'A 3D object with all flat square faces and 8 vertices is a cube.' },
        { difficulty: 'Easy', question: 'I have exactly 1 flat circular face and 1 curved surface, and I come to a sharp point. What 3D object am I?', answer: 'Cone', checkMode: 'auto', correctAnswer: 'Cone', correctAnswers: ['Cone', 'cone', 'a cone'], explanation: 'One flat circular base plus a curved surface tapering to a point describes a cone.' },
        { difficulty: 'Easy', question: 'I have 6 vertices in total. Two of my faces are triangles and the rest are rectangles. What 3D object am I?', answer: 'Triangular prism', checkMode: 'auto', correctAnswer: 'Triangular prism', correctAnswers: ['Triangular prism', 'triangular prism', 'a triangular prism'], explanation: 'A triangular prism has 6 vertices: 2 triangular bases and 3 rectangular side faces.' },
        ...
        { difficulty: 'Easy', question: 'How many flat faces does a cylinder have?', answer: '2', checkMode: 'auto', correctAnswer: '2', correctAnswers: ['2', 'two'], explanation: 'A cylinder has 2 flat circular faces, plus 1 curved surface joining them.' },
        ...
        { difficulty: 'Medium', question: 'Amahle says: "All prisms have exactly 2 triangular faces." Is she correct? Explain.', answer: 'No. Only a triangular prism has 2 triangular faces (its bases). A rectangular prism has rectangular bases, not triangular ones, so not all prisms have triangular faces.', checkMode: 'self', explanation: 'The shape of a prism\'s bases matches the name of the prism — a triangular prism has triangle bases, a rectangular prism has rectangle bases.' },
