  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'A cube is a special type of rectangular prism. What makes a cube different from other rectangular prisms?', answer: 'All of a cube\'s faces and edges are equal squares, while a general rectangular prism can have edges of different lengths.', checkMode: 'self', explanation: 'A cube is a special rectangular prism whose faces are all equal squares and whose edges are all the same length, while a general rectangular prism can have edges of different lengths.' },
