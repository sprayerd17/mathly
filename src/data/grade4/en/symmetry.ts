...
<div style="background:#f0fdf4;border:1.5px solid #86efac;border-radius:8px;padding:10px 16px;display:inline-block;margin-top:8px;">
  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      name: 'Set 1',
      questions: [
        { difficulty: 'Easy', question: 'A shape is folded exactly in half and both sides match perfectly. What is this fold line called?', checkMode: 'auto', options: ['Line of symmetry', 'Diagonal line', 'Axis of rotation', 'Midpoint line'], correctIndex: 0, explanation: 'The fold line that divides a shape into two matching mirror-image halves is called the line of symmetry. (The other terms describe different geometry ideas that students often confuse with it.)' },
        { difficulty: 'Easy', question: "Which statement about a square's symmetry is correct?", checkMode: 'auto', options: ['A square is not symmetrical because its sides are straight.', 'A square is symmetrical — it can be folded so both halves match exactly.', 'A square is only symmetrical if it is drawn perfectly to scale.', 'A square is symmetrical only along its diagonals, not vertically or horizontally.'], correctIndex: 1, explanation: 'A square can be folded along 4 different lines (vertical, horizontal, 2 diagonals) and each time both halves match exactly, so it is symmetrical. (Being drawn to scale has nothing to do with symmetry, and the vertical/horizontal folds work just as well as the diagonals.)' },
        { difficulty: 'Easy', question: 'A student folds a shape along a line and the two halves do NOT match. Which statement is correct?', checkMode: 'auto', options: ['The line is still a line of symmetry, because folding was attempted.', 'The line is a line of symmetry only if the shape is a triangle.', 'The line is NOT a line of symmetry, because the halves must match exactly to count.', 'The line becomes a line of symmetry the second time you fold it.'], correctIndex: 2, explanation: 'A line only counts as a line of symmetry if both halves match exactly when folded. If they do not match, it is not a line of symmetry — attempting the fold or trying again does not change that.' },
        { difficulty: 'Easy', question: 'Which statement about the letter S is correct?', checkMode: 'auto', options: ['S is symmetrical along a vertical line only.', 'S is symmetrical along a horizontal line only.', 'S is symmetrical along both a vertical and a horizontal line.', 'S is not symmetrical — no fold line makes the two halves match.'], correctIndex: 3, explanation: 'No matter how you fold the letter S, the two halves never match — its curve reverses direction on each half, so it has 0 lines of symmetry.' },
        { difficulty: 'Easy', question: 'How many lines of symmetry does a circle have?', checkMode: 'auto', options: ['Infinite lines of symmetry', '4 lines of symmetry', '1 line of symmetry', '0 lines of symmetry'], correctIndex: 0, explanation: 'Any line through the centre of a circle (a diameter) is a line of symmetry, so a circle has infinite lines of symmetry.' },
        { difficulty: 'Easy', question: 'How many lines of symmetry does a square have?', checkMode: 'auto', options: ['2 lines of symmetry', '4 lines of symmetry', '8 lines of symmetry', '0 lines of symmetry'], correctIndex: 1, explanation: 'A square has 4 lines of symmetry: vertical, horizontal, and 2 diagonals. (2 is the count for a rectangle, and 8 double-counts by treating each fold as two lines.)' },
        { difficulty: 'Easy-Medium', question: 'Which of these has more lines of symmetry: a square or a rectangle (not a square)?', checkMode: 'auto', options: ['The rectangle — it has more sides that are equal.', 'They have the same number of lines of symmetry.', "The square — it has 4 lines compared to the rectangle's 2.", 'Neither has any lines of symmetry.'], correctIndex: 2, explanation: 'A square has 4 lines of symmetry, while a non-square rectangle has only 2.' },
        { difficulty: 'Medium', question: 'How many lines of symmetry does a scalene triangle (all sides different lengths) have?', checkMode: 'auto', options: ['3 lines of symmetry, since it is still a triangle', '1 line of symmetry, through the longest side', '2 lines of symmetry', '0 lines of symmetry'], correctIndex: 3, explanation: 'A scalene triangle has all sides and angles different, so no fold produces two matching halves. It has 0 lines of symmetry.' },
        { difficulty: 'Medium', question: 'Kagiso says a rhombus (all 4 sides equal, no right angles) has 4 lines of symmetry, the same as a square, because both shapes have 4 equal sides. Which statement correctly evaluates his reasoning?', checkMode: 'auto', options: ['Kagiso is incorrect — a rhombus has only 2 lines of symmetry (its diagonals), because its angles are not right angles like a square\'s.', 'Kagiso is correct — any shape with 4 equal sides has 4 lines of symmetry.', 'Kagiso is incorrect — a rhombus actually has more lines of symmetry than a square.', 'Kagiso is correct, but only if the rhombus is tilted at 45°.'], correctIndex: 0, explanation: 'Kagiso is incorrect. A rhombus has only 2 lines of symmetry — its two diagonals. Because its angles are not right angles, the vertical and horizontal folds do not match, unlike in a square. Having equal sides is not enough on its own.' },
        { difficulty: 'Medium', question: 'Which statement about the letter M is correct?', checkMode: 'auto', options: ['M has a horizontal line of symmetry but not a vertical one.', 'M has a vertical line of symmetry — folding down the middle makes the halves match.', 'M has no lines of symmetry at all.', 'M has both a vertical and a horizontal line of symmetry.'], correctIndex: 1, explanation: 'The letter M folds neatly down the middle — the left and right halves match. It does not fold to match top-to-bottom, so it has no horizontal line of symmetry.' },
        { difficulty: 'Medium', question: 'Which letter has BOTH a vertical and a horizontal line of symmetry: H or N?', checkMode: 'auto', options: ['N — it folds neatly in both directions.', 'Neither letter has any line of symmetry.', 'H — it has both a vertical and horizontal line of symmetry, while N has none.', 'Both H and N have both lines of symmetry.'], correctIndex: 2, explanation: 'The letter H can be folded vertically and horizontally, and in both cases the halves match. N has no lines of symmetry at all.' },
        { difficulty: 'Medium', question: 'Which letters in the word "MUM" have at least one line of symmetry?', checkMode: 'auto', options: ['Only the two M\'s, not the U', 'Only the U, not either M', 'None of the letters in MUM have a line of symmetry', 'M, U and M — all three letters have at least one line of symmetry'], correctIndex: 3, explanation: 'M has a vertical line of symmetry, and U also has a vertical line of symmetry. Since the word is M-U-M, every letter in it has at least one line of symmetry.' },
        { difficulty: 'Medium', question: 'A regular polygon has 5 equal sides (a regular pentagon). How many lines of symmetry does it have?', checkMode: 'auto', options: ['5 lines of symmetry', '10 lines of symmetry', '4 lines of symmetry', '1 line of symmetry'], correctIndex: 0, explanation: 'A regular polygon has the same number of lines of symmetry as it has sides. A regular pentagon has 5 sides, so it has 5 lines of symmetry.' },
        { difficulty: 'Medium', question: 'A regular polygon has 8 equal sides (a regular octagon). How many lines of symmetry does it have?', checkMode: 'auto', options: ['4 lines of symmetry', '8 lines of symmetry', '16 lines of symmetry', 'It has too many sides to fold evenly, so 0 lines of symmetry'], correctIndex: 1, explanation: 'For a regular polygon, the number of lines of symmetry always equals the number of sides — 8 sides means 8 lines of symmetry.' },
        { difficulty: 'Medium', question: 'Which explanation correctly justifies why a regular polygon always has the same number of lines of symmetry as it has sides?', checkMode: 'auto', options: ['Because regular polygons always have an even number of sides, so folds always pair up evenly.', 'Because every polygon, regular or not, has one line of symmetry per side.', 'Because all the sides and angles are exactly equal, so each corner (or midpoint) lines up with a matching fold that produces two identical halves.', 'Because the number of lines of symmetry is always one less than the number of sides.'], correctIndex: 2, explanation: 'In a regular polygon every side and every angle is exactly equal, so for each corner there is exactly one matching fold line to the opposite side or midpoint that produces two identical halves — giving one line of symmetry per side.' },
        { difficulty: 'Medium-Hard', question: 'The grid shows a vertical red dashed line of symmetry with points A, B and C marked on the left side only. How many squares from the line is point A, and how many squares from the line should its mirror point be on the right?', checkMode: 'auto', options: ['A is 3 squares from the line; its mirror point is 2 squares from the line.', 'A is 2 squares from the line; its mirror point is 3 squares from the line.', 'A is 1 square from the line; its mirror point is 1 square from the line.', 'A is 2 squares from the line; its mirror point is also 2 squares from the line, on the right.'], correctIndex: 3, explanation: 'Point A sits 2 squares to the left of the line of symmetry. A mirror point is always the same distance from the line as the original point, just on the opposite side — so A′ is also 2 squares from the line, but on the right.', diagramSvg: '<svg viewBox="0 0 220 180" xmlns="http://www.w3.org/2000/svg" font-family="Arial, sans-serif"><rect x="10" y="10" width="200" height="160" fill="none" stroke="#9ca3af" stroke-width="1"/><g stroke="#e5e7eb" stroke-width="1"><line x1="30" y1="10" x2="30" y2="170"/><line x1="50" y1="10" x2="50" y2="170"/><line x1="70" y1="10" x2="70" y2="170"/><line x1="90" y1="10" x2="90" y2="170"/><line x1="110" y1="10" x2="110" y2="170"/><line x1="130" y1="10" x2="130" y2="170"/><line x1="150" y1="10" x2="150" y2="170"/><line x1="170" y1="10" x2="170" y2="170"/><line x1="190" y1="10" x2="190" y2="170"/><line x1="10" y1="30" x2="210" y2="30"/><line x1="10" y1="50" x2="210" y2="50"/><line x1="10" y1="70" x2="210" y2="70"/><line x1="10" y1="90" x2="210" y2="90"/><line x1="10" y1="110" x2="210" y2="110"/><line x1="10" y1="130" x2="210" y2="130"/><line x1="10" y1="150" x2="210" y2="150"/></g><line x1="110" y1="10" x2="110" y2="170" stroke="#dc2626" stroke-width="2.5" stroke-dasharray="6,4"/><circle cx="70" cy="50" r="4" fill="#2563eb"/><text x="65" y="46" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">A</text><circle cx="90" cy="90" r="4" fill="#2563eb"/><text x="85" y="86" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">B</text><circle cx="50" cy="130" r="4" fill="#2563eb"/><text x="45" y="126" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">C</text><text x="110" y="22" font-size="12" font-weight="700" fill="#dc2626" text-anchor="middle">line of symmetry</text></svg>' },
        { difficulty: 'Medium-Hard', question: 'Using the same grid: point C is 3 squares from the line of symmetry, and point B is 1 square from the line. If you drew in the mirror points for A, B and C, would the total height of the completed shape change from the height of just the given half?', checkMode: 'auto', options: ['No, the height stays the same — only the width changes.', 'Yes, the height doubles along with the width.', 'Yes, the height decreases because points move closer to the line.', 'It depends on which point is furthest from the line.'], correctIndex: 0, explanation: 'A vertical line of symmetry reflects points left and right only. It never moves anything up or down, so the overall height of the shape stays exactly the same — only the width increases as the mirror half is added.', diagramSvg: '<svg viewBox="0 0 220 180" xmlns="http://www.w3.org/2000/svg" font-family="Arial, sans-serif"><rect x="10" y="10" width="200" height="160" fill="none" stroke="#9ca3af" stroke-width="1"/><g stroke="#e5e7eb" stroke-width="1"><line x1="30" y1="10" x2="30" y2="170"/><line x1="50" y1="10" x2="50" y2="170"/><line x1="70" y1="10" x2="70" y2="170"/><line x1="90" y1="10" x2="90" y2="170"/><line x1="110" y1="10" x2="110" y2="170"/><line x1="130" y1="10" x2="130" y2="170"/><line x1="150" y1="10" x2="150" y2="170"/><line x1="170" y1="10" x2="170" y2="170"/><line x1="190" y1="10" x2="190" y2="170"/><line x1="10" y1="30" x2="210" y2="30"/><line x1="10" y1="50" x2="210" y2="50"/><line x1="10" y1="70" x2="210" y2="70"/><line x1="10" y1="90" x2="210" y2="90"/><line x1="10" y1="110" x2="210" y2="110"/><line x1="10" y1="130" x2="210" y2="130"/><line x1="10" y1="150" x2="210" y2="150"/></g><line x1="110" y1="10" x2="110" y2="170" stroke="#dc2626" stroke-width="2.5" stroke-dasharray="6,4"/><circle cx="70" cy="50" r="4" fill="#2563eb"/><text x="65" y="46" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">A</text><circle cx="90" cy="90" r="4" fill="#2563eb"/><text x="85" y="86" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">B</text><circle cx="50" cy="130" r="4" fill="#2563eb"/><text x="45" y="126" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">C</text><text x="110" y="22" font-size="12" font-weight="700" fill="#dc2626" text-anchor="middle">line of symmetry</text></svg>' },
        { difficulty: 'Medium-Hard', question: 'Using the same grid again: is the red dashed line of symmetry oriented vertically or horizontally, and what tells you this?', checkMode: 'auto', options: ['Horizontally — it splits the grid into a top half and a bottom half.', 'Vertically — it runs up and down, splitting the grid into a left side and a right side.', 'Diagonally — it runs corner to corner across the grid.', 'It cannot be determined without seeing the mirrored points.'], correctIndex: 1, explanation: 'A vertical line of symmetry runs straight up and down, splitting the grid into a left side and a right side, which is exactly how the red dashed line is drawn here — not side to side like a horizontal line would be.', diagramSvg: '<svg viewBox="0 0 220 180" xmlns="http://www.w3.org/2000/svg" font-family="Arial, sans-serif"><rect x="10" y="10" width="200" height="160" fill="none" stroke="#9ca3af" stroke-width="1"/><g stroke="#e5e7eb" stroke-width="1"><line x1="30" y1="10" x2="30" y2="170"/><line x1="50" y1="10" x2="50" y2="170"/><line x1="70" y1="10" x2="70" y2="170"/><line x1="90" y1="10" x2="90" y2="170"/><line x1="110" y1="10" x2="110" y2="170"/><line x1="130" y1="10" x2="130" y2="170"/><line x1="150" y1="10" x2="150" y2="170"/><line x1="170" y1="10" x2="170" y2="170"/><line x1="190" y1="10" x2="190" y2="170"/><line x1="10" y1="30" x2="210" y2="30"/><line x1="10" y1="50" x2="210" y2="50"/><line x1="10" y1="70" x2="210" y2="70"/><line x1="10" y1="90" x2="210" y2="90"/><line x1="10" y1="110" x2="210" y2="110"/><line x1="10" y1="130" x2="210" y2="130"/><line x1="10" y1="150" x2="210" y2="150"/></g><line x1="110" y1="10" x2="110" y2="170" stroke="#dc2626" stroke-width="2.5" stroke-dasharray="6,4"/><circle cx="70" cy="50" r="4" fill="#2563eb"/><text x="65" y="46" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">A</text><circle cx="90" cy="90" r="4" fill="#2563eb"/><text x="85" y="86" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">B</text><circle cx="50" cy="130" r="4" fill="#2563eb"/><text x="45" y="126" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">C</text><text x="110" y="22" font-size="12" font-weight="700" fill="#dc2626" text-anchor="middle">line of symmetry</text></svg>' },
        { difficulty: 'Hard', question: 'Which statement best describes the symmetry of a real human face?', checkMode: 'auto', options: ['A human face is perfectly symmetrical, with both halves always identical.', 'A human face has no symmetry at all — the two sides are completely different.', 'A human face is only roughly (approximately) symmetrical — the two halves are similar but never perfectly identical.', 'A human face is symmetrical only when the person is smiling.'], correctIndex: 2, explanation: 'A human face looks symmetrical at a glance, but in reality no two halves of a real face are ever perfectly identical — there are always small natural differences, so we say it is "roughly" or "approximately" symmetrical, not perfectly symmetrical.' },
        { difficulty: 'Hard', question: 'Lerato says every 4-sided shape has 4 lines of symmetry, just like a square. Which response correctly evaluates her claim?', checkMode: 'auto', options: ['Lerato is correct — every 4-sided shape has exactly 4 lines of symmetry.', 'Lerato is correct, but only for shapes with straight sides.', 'Lerato is incorrect — no 4-sided shape has any lines of symmetry except the square.', 'Lerato is incorrect — for example, a rectangle has only 2 lines of symmetry and a general parallelogram has 0.'], correctIndex: 3, explanation: 'Lerato is incorrect. Only special 4-sided shapes like a square have 4 lines of symmetry. A rectangle (not a square) has 2, a rhombus has 2, and a parallelogram has 0 lines of symmetry — the number of lines depends on the exact shape, not just the number of sides.' },
      ],
      scoreMessages: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      name: 'Set 2',
      questions: [
        { difficulty: 'Easy', question: 'When a shape is folded so that both halves land exactly on top of each other, what do we call the fold line?', checkMode: 'auto', options: ['Axis of rotation', 'Line of symmetry', 'Diagonal', 'Perimeter line'], correctIndex: 1, explanation: 'A fold line along which both halves of a shape match exactly is called the line of symmetry.' },
        { difficulty: 'Easy', question: 'Which statement about the letter A is correct?', checkMode: 'auto', options: ['A is not symmetrical — no fold line makes its halves match.', 'A is symmetrical only along a horizontal line.', 'A is symmetrical — folding down the middle makes the left and right halves match.', 'A is symmetrical along both a vertical and horizontal line.'], correctIndex: 2, explanation: 'The letter A can be folded down the middle, and the left and right halves match — it is symmetrical. It does not fold to match top-to-bottom, so it has no horizontal line of symmetry.' },
        { difficulty: 'Easy', question: 'Which statement about lines of symmetry is correct?', checkMode: 'auto', options: ['Any line drawn across a shape is automatically a line of symmetry.', 'A line only counts as a line of symmetry if it passes through a corner of the shape.', 'A line is a line of symmetry as long as it divides the shape into two equal areas.', 'A line only counts as a line of symmetry if folding along it makes both halves match exactly.'], correctIndex: 3, explanation: 'A line only counts as a line of symmetry if folding along it produces two halves that match exactly. A random line across a shape usually will not — even one that splits it into two equal areas, or passes through a corner.' },
        { difficulty: 'Easy', question: 'Which statement about the letter F is correct?', checkMode: 'auto', options: ['F has no lines of symmetry — no fold makes its halves match.', 'F has one vertical line of symmetry.', 'F has one horizontal line of symmetry.', 'F has both a vertical and a horizontal line of symmetry.'], correctIndex: 0, explanation: 'The letter F cannot be folded along any line so that both halves match — it has 0 lines of symmetry.' },
        { difficulty: 'Easy', question: 'How many lines of symmetry does an isosceles triangle (two equal sides) have?', checkMode: 'auto', options: ['0 lines of symmetry', '1 line of symmetry', '2 lines of symmetry', '3 lines of symmetry'], correctIndex: 1, explanation: 'An isosceles triangle has exactly one line of symmetry — the fold line running from the top corner straight down to the middle of the base.' },
        { difficulty: 'Easy', question: 'How many lines of symmetry does a rectangle (not a square) have?', checkMode: 'auto', options: ['4 lines of symmetry', '1 line of symmetry', '2 lines of symmetry', '0 lines of symmetry'], correctIndex: 2, explanation: 'A rectangle has 2 lines of symmetry: one vertical and one horizontal. The diagonals do not work because the sides are not all equal.' },
        { difficulty: 'Easy-Medium', question: 'Which shape has more lines of symmetry: a regular pentagon or a regular hexagon?', checkMode: 'auto', options: ['The pentagon — it has 6 lines of symmetry.', 'They have the same number of lines of symmetry.', 'Neither shape has any lines of symmetry.', "The hexagon — it has 6 lines of symmetry compared to the pentagon's 5."], correctIndex: 3, explanation: 'A regular hexagon has 6 lines of symmetry, more than a regular pentagon\'s 5 lines.' },
        { difficulty: 'Medium', question: 'How many lines of symmetry does a general parallelogram have (slanted sides, opposite sides equal, but not a rectangle or rhombus)?', checkMode: 'auto', options: ['0 lines of symmetry', '2 lines of symmetry, the same as a rectangle', '4 lines of symmetry, the same as a square', '1 line of symmetry, along the longer diagonal'], correctIndex: 0, explanation: 'A general parallelogram has 0 lines of symmetry — no fold produces two matching halves, even though its opposite sides are equal.' },
        { difficulty: 'Medium', question: 'Naledi says an isosceles triangle and an equilateral triangle must have the same number of lines of symmetry, since both have at least 2 equal sides. Which statement correctly evaluates her claim?', checkMode: 'auto', options: ['Naledi is correct — both triangles always have exactly 2 lines of symmetry.', 'Naledi is incorrect — an isosceles triangle has 1 line of symmetry, but an equilateral triangle has 3.', 'Naledi is incorrect — neither triangle has any lines of symmetry.', 'Naledi is correct, since both shapes are triangles.'], correctIndex: 1, explanation: 'Naledi is incorrect. An isosceles triangle has 1 line of symmetry, but an equilateral triangle (all 3 sides equal) has 3 lines of symmetry — one from each corner. Having some equal sides is not enough to guarantee the same symmetry.' },
        { difficulty: 'Medium', question: 'Which statement about the letter W is correct?', checkMode: 'auto', options: ['W has a horizontal line of symmetry but not a vertical one.', 'W has no lines of symmetry at all.', 'W has a vertical line of symmetry — folding down the middle makes the halves match.', 'W has both a vertical and a horizontal line of symmetry.'], correctIndex: 2, explanation: 'The letter W folds neatly down the middle — the left and right halves match.' },
        { difficulty: 'Medium', question: 'Which letter has NO lines of symmetry at all: O or Z?', checkMode: 'auto', options: ['O — it has no lines of symmetry.', 'Neither O nor Z has any lines of symmetry.', 'Both O and Z have no lines of symmetry.', 'Z — it has no lines of symmetry, while O has both vertical and horizontal symmetry.'], correctIndex: 3, explanation: 'O has both vertical and horizontal symmetry, but Z has no line of symmetry at all.' },
        { difficulty: 'Medium', question: 'Which letters in the word "TOY" have at least one line of symmetry?', checkMode: 'auto', options: ['T, O and Y — all three letters have at least one line of symmetry.', 'Only O has a line of symmetry.', 'Only T and Y have a line of symmetry, not O.', 'None of the letters in TOY have a line of symmetry.'], correctIndex: 0, explanation: 'T has a vertical line of symmetry, O has both vertical and horizontal symmetry, and Y also has a vertical line of symmetry. All three letters in TOY have at least one line of symmetry.' },
        { difficulty: 'Medium', question: 'A regular polygon has 6 equal sides (a regular hexagon). How many lines of symmetry does it have?', checkMode: 'auto', options: ['3 lines of symmetry', '6 lines of symmetry', '12 lines of symmetry', '0 lines of symmetry'], correctIndex: 1, explanation: 'A regular hexagon has 6 equal sides, so it has 6 lines of symmetry — 3 through opposite corners and 3 through midpoints of opposite sides.' },
        { difficulty: 'Medium', question: 'A regular polygon has 10 equal sides (a regular decagon). How many lines of symmetry does it have?', checkMode: 'auto', options: ['5 lines of symmetry', '20 lines of symmetry', '10 lines of symmetry', '1 line of symmetry'], correctIndex: 2, explanation: 'A regular polygon always has the same number of lines of symmetry as it has sides — 10 sides means 10 lines of symmetry.' },
        { difficulty: 'Medium', question: 'Which explanation correctly justifies why the rule "lines of symmetry equal number of sides" only works for REGULAR polygons and not for irregular ones?', checkMode: 'auto', options: ['Because irregular polygons always have an odd number of sides.', 'Because the rule actually works for all polygons, regular or not.', 'Because irregular polygons have more lines of symmetry than regular ones.', 'Because irregular polygons do not have all sides and angles equal, so most folds will not produce matching halves.'], correctIndex: 3, explanation: 'The rule relies on every side and angle being identical, so that each corner lines up with a matching fold. In an irregular polygon the sides and angles are different sizes, so most possible fold lines will not create two identical halves — the shape may end up with fewer lines of symmetry than it has sides, or none at all.' },
        { difficulty: 'Medium-Hard', question: 'The grid shows a vertical red dashed line of symmetry with points P, Q and R marked on the left side only. Point P is 1 square from the line. How far from the line should its mirror point be, and on which side?', checkMode: 'auto', options: ['1 square from the line, on the right side.', '1 square from the line, on the left side.', '2 squares from the line, on the right side.', 'It cannot have a mirror point since P is already close to the line.'], correctIndex: 0, explanation: 'A mirror point is always the same distance from the line of symmetry as the original point, just on the opposite side. Since P is 1 square left of the line, its mirror point P′ is 1 square to the right.', diagramSvg: '<svg viewBox="0 0 220 180" xmlns="http://www.w3.org/2000/svg" font-family="Arial, sans-serif"><rect x="10" y="10" width="200" height="160" fill="none" stroke="#9ca3af" stroke-width="1"/><g stroke="#e5e7eb" stroke-width="1"><line x1="30" y1="10" x2="30" y2="170"/><line x1="50" y1="10" x2="50" y2="170"/><line x1="70" y1="10" x2="70" y2="170"/><line x1="90" y1="10" x2="90" y2="170"/><line x1="110" y1="10" x2="110" y2="170"/><line x1="130" y1="10" x2="130" y2="170"/><line x1="150" y1="10" x2="150" y2="170"/><line x1="170" y1="10" x2="170" y2="170"/><line x1="190" y1="10" x2="190" y2="170"/><line x1="10" y1="30" x2="210" y2="30"/><line x1="10" y1="50" x2="210" y2="50"/><line x1="10" y1="70" x2="210" y2="70"/><line x1="10" y1="90" x2="210" y2="90"/><line x1="10" y1="110" x2="210" y2="110"/><line x1="10" y1="130" x2="210" y2="130"/><line x1="10" y1="150" x2="210" y2="150"/></g><line x1="110" y1="10" x2="110" y2="170" stroke="#dc2626" stroke-width="2.5" stroke-dasharray="6,4"/><circle cx="90" cy="50" r="4" fill="#2563eb"/><text x="85" y="46" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">P</text><circle cx="50" cy="90" r="4" fill="#2563eb"/><text x="45" y="86" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">Q</text><circle cx="70" cy="150" r="4" fill="#2563eb"/><text x="65" y="146" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">R</text><text x="110" y="22" font-size="12" font-weight="700" fill="#dc2626" text-anchor="middle">line of symmetry</text></svg>' },
        { difficulty: 'Medium-Hard', question: 'Using the same grid: point Q is 3 squares from the line and point R is 2 squares from the line. Once the mirror half is drawn in using P, Q and R, will the width of the whole shape be more, less, or the same as just the given (left) half?', checkMode: 'auto', options: ['Less — reflecting removes some of the original width.', 'More — the total width increases because the mirror half adds new squares on the right.', 'The same — reflecting does not change the width at all.', 'It depends on the height of the shape, not the reflection.'], correctIndex: 1, explanation: 'Reflecting the given half across the line of symmetry adds an entirely new mirror half on the right side. This makes the completed shape wider than just the original half — roughly double the width, since the mirror half matches the original in size.', diagramSvg: '<svg viewBox="0 0 220 180" xmlns="http://www.w3.org/2000/svg" font-family="Arial, sans-serif"><rect x="10" y="10" width="200" height="160" fill="none" stroke="#9ca3af" stroke-width="1"/><g stroke="#e5e7eb" stroke-width="1"><line x1="30" y1="10" x2="30" y2="170"/><line x1="50" y1="10" x2="50" y2="170"/><line x1="70" y1="10" x2="70" y2="170"/><line x1="90" y1="10" x2="90" y2="170"/><line x1="110" y1="10" x2="110" y2="170"/><line x1="130" y1="10" x2="130" y2="170"/><line x1="150" y1="10" x2="150" y2="170"/><line x1="170" y1="10" x2="170" y2="170"/><line x1="190" y1="10" x2="190" y2="170"/><line x1="10" y1="30" x2="210" y2="30"/><line x1="10" y1="50" x2="210" y2="50"/><line x1="10" y1="70" x2="210" y2="70"/><line x1="10" y1="90" x2="210" y2="90"/><line x1="10" y1="110" x2="210" y2="110"/><line x1="10" y1="130" x2="210" y2="130"/><line x1="10" y1="150" x2="210" y2="150"/></g><line x1="110" y1="10" x2="110" y2="170" stroke="#dc2626" stroke-width="2.5" stroke-dasharray="6,4"/><circle cx="90" cy="50" r="4" fill="#2563eb"/><text x="85" y="46" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">P</text><circle cx="50" cy="90" r="4" fill="#2563eb"/><text x="45" y="86" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">Q</text><circle cx="70" cy="150" r="4" fill="#2563eb"/><text x="65" y="146" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">R</text><text x="110" y="22" font-size="12" font-weight="700" fill="#dc2626" text-anchor="middle">line of symmetry</text></svg>' },
        { difficulty: 'Medium-Hard', question: 'Using the same grid again: if the red dashed line had instead been drawn running left to right across the middle of the grid instead of up and down, what type of line of symmetry would that be?', checkMode: 'auto', options: ['It would still be a vertical line of symmetry.', 'It would be a diagonal line of symmetry.', 'It would be a horizontal line of symmetry.', 'It would no longer be a valid line of symmetry.'], correctIndex: 2, explanation: 'A line that runs left to right (side to side) across a shape or grid, splitting it into a top half and a bottom half, is called a horizontal line of symmetry — different from the vertical line shown here, which splits left and right.', diagramSvg: '<svg viewBox="0 0 220 180" xmlns="http://www.w3.org/2000/svg" font-family="Arial, sans-serif"><rect x="10" y="10" width="200" height="160" fill="none" stroke="#9ca3af" stroke-width="1"/><g stroke="#e5e7eb" stroke-width="1"><line x1="30" y1="10" x2="30" y2="170"/><line x1="50" y1="10" x2="50" y2="170"/><line x1="70" y1="10" x2="70" y2="170"/><line x1="90" y1="10" x2="90" y2="170"/><line x1="110" y1="10" x2="110" y2="170"/><line x1="130" y1="10" x2="130" y2="170"/><line x1="150" y1="10" x2="150" y2="170"/><line x1="170" y1="10" x2="170" y2="170"/><line x1="190" y1="10" x2="190" y2="170"/><line x1="10" y1="30" x2="210" y2="30"/><line x1="10" y1="50" x2="210" y2="50"/><line x1="10" y1="70" x2="210" y2="70"/><line x1="10" y1="90" x2="210" y2="90"/><line x1="10" y1="110" x2="210" y2="110"/><line x1="10" y1="130" x2="210" y2="130"/><line x1="10" y1="150" x2="210" y2="150"/></g><line x1="110" y1="10" x2="110" y2="170" stroke="#dc2626" stroke-width="2.5" stroke-dasharray="6,4"/><circle cx="90" cy="50" r="4" fill="#2563eb"/><text x="85" y="46" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">P</text><circle cx="50" cy="90" r="4" fill="#2563eb"/><text x="45" y="86" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">Q</text><circle cx="70" cy="150" r="4" fill="#2563eb"/><text x="65" y="146" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">R</text><text x="110" y="22" font-size="12" font-weight="700" fill="#dc2626" text-anchor="middle">line of symmetry</text></svg>' },
        { difficulty: 'Hard', question: "A stop sign is a regular octagon and a honeycomb cell is a regular hexagon. Which statement correctly checks Sipho's claim that they have the same number of lines of symmetry?", checkMode: 'auto', options: ['Sipho is correct — both shapes have 6 lines of symmetry.', 'Sipho is correct — both shapes have 8 lines of symmetry.', 'Sipho is incorrect — the hexagon has more lines of symmetry than the octagon.', 'Sipho is incorrect — the octagon has 8 lines of symmetry while the hexagon has 6.'], correctIndex: 3, explanation: 'Sipho is incorrect. A regular octagon has 8 sides and therefore 8 lines of symmetry, while a regular hexagon has 6 sides and 6 lines of symmetry. They are different shapes with different numbers of sides, so they cannot have the same number of lines of symmetry.' },
        { difficulty: 'Hard', question: "A flag design uses a rectangle with a smaller equilateral triangle placed exactly in its centre, pointing straight up. Which statement correctly describes the combined design's symmetry?", checkMode: 'auto', options: ["It has 1 line of symmetry — the shared vertical line, since the triangle breaks the rectangle's horizontal symmetry.", 'It has 2 lines of symmetry, the same as the rectangle alone.', 'It has 3 lines of symmetry, the same as the triangle alone.', 'It has 0 lines of symmetry, because combining two shapes always destroys symmetry.'], correctIndex: 0, explanation: 'A rectangle alone would have 2 lines of symmetry (vertical and horizontal), but adding a triangle in the centre breaks the horizontal symmetry unless the triangle itself is symmetrical about that same line too. If the triangle is centred and points straight up (or down), only the shared vertical line still works for both shapes, so the combined design has just 1 line of symmetry.' },
      ],
      scoreMessages: [
        { minScore: 20, message: 'Outstanding! You have mastered symmetry across shapes, letters, polygons and grids.' },
        { minScore: 15, message: 'Great work! You understand symmetry well — review any missed questions.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      name: 'Set 3',
      questions: [
        { difficulty: 'Easy', question: 'What do we call the fold line along which a shape can be divided into two mirror-image halves?', checkMode: 'auto', options: ['Diagonal line', 'Axis of rotation', 'Line of symmetry', 'Perimeter'], correctIndex: 2, explanation: 'This fold line, along which the two halves match exactly, is called the line of symmetry.' },
        { difficulty: 'Easy', question: 'Which statement about the letter B is correct?', checkMode: 'auto', options: ['B is not symmetrical — no fold makes its halves match.', 'B is symmetrical only along a vertical line.', 'B is symmetrical along both a vertical and a horizontal line.', 'B is symmetrical — folding horizontally (top to bottom) makes the two humps match.'], correctIndex: 3, explanation: 'The letter B can be folded horizontally (top to bottom) and the two humps match — it is symmetrical. It does not fold to match left-to-right, so it has no vertical line of symmetry.' },
        { difficulty: 'Easy', question: 'Which statement about lines of symmetry is correct?', checkMode: 'auto', options: ['A fold line only counts as a line of symmetry if it makes both halves identical when folded.', 'Any fold line through the centre of a shape is automatically a line of symmetry.', 'A fold line is a line of symmetry as long as the shape has straight sides.', 'A shape can only have a line of symmetry if it is a regular polygon.'], correctIndex: 0, explanation: 'A line of symmetry must produce two halves that match exactly when folded — this is the definition of the fold test. Passing through the centre or having straight sides is not enough on its own.' },
        { difficulty: 'Easy', question: 'Which statement about the letter Z is correct?', checkMode: 'auto', options: ['Z has one vertical line of symmetry.', 'Z has no lines of symmetry — no straight fold makes its halves match.', 'Z has one horizontal line of symmetry.', 'Z has both a vertical and a horizontal line of symmetry.'], correctIndex: 1, explanation: 'The letter Z cannot be folded along any straight line so that both halves match — it has 0 lines of symmetry.' },
        { difficulty: 'Easy', question: 'How many lines of symmetry does a rhombus (all 4 sides equal, no right angles) have?', checkMode: 'auto', options: ['4 lines of symmetry', '0 lines of symmetry', '2 lines of symmetry', '1 line of symmetry'], correctIndex: 2, explanation: 'A rhombus has 2 lines of symmetry — its two diagonals. The vertical and horizontal folds do not work because its angles are not right angles.' },
        { difficulty: 'Easy', question: 'How many lines of symmetry does an equilateral triangle (all 3 sides equal) have?', checkMode: 'auto', options: ['1 line of symmetry', '2 lines of symmetry', '6 lines of symmetry', '3 lines of symmetry'], correctIndex: 3, explanation: 'An equilateral triangle has 3 equal sides, so it has 3 lines of symmetry — one from each corner to the midpoint of the opposite side.' },
        { difficulty: 'Easy-Medium', question: 'Which has more lines of symmetry: an equilateral triangle or an isosceles triangle?', checkMode: 'auto', options: ["The equilateral triangle — it has 3 lines compared to the isosceles triangle's 1.", 'The isosceles triangle — it has more equal sides in proportion.', 'They have the same number of lines of symmetry.', 'Neither triangle has any lines of symmetry.'], correctIndex: 0, explanation: 'An equilateral triangle has 3 lines of symmetry, while an isosceles triangle has only 1 — so the equilateral triangle has more.' },
        { difficulty: 'Medium', question: 'How many lines of symmetry does a square have compared to a scalene triangle?', checkMode: 'auto', options: ['The square has 2, the scalene triangle has 1.', 'The square has 4, the scalene triangle has 0.', 'They both have 4 lines of symmetry.', 'The square has 0, the scalene triangle has 4.'], correctIndex: 1, explanation: 'A square has 4 lines of symmetry. A scalene triangle, with all sides and angles different, has 0 lines of symmetry.' },
        { difficulty: 'Medium', question: 'Bongani says a rectangle (not a square) has 4 lines of symmetry, the same as a square, because both shapes have 4 right angles. Which statement correctly evaluates his reasoning?', checkMode: 'auto', options: ['Bongani is correct — having 4 right angles guarantees 4 lines of symmetry.', 'Bongani is correct, but only if the rectangle is drawn to scale.', "Bongani is incorrect — a rectangle that is not a square has only 2 lines of symmetry, because its sides are not all equal like a square's.", 'Bongani is incorrect — a rectangle actually has more lines of symmetry than a square.'], correctIndex: 2, explanation: 'Bongani is incorrect. A rectangle that is not a square has only 2 lines of symmetry (vertical and horizontal) — its diagonals do not work as lines of symmetry because its sides are not all equal, unlike a square. Having right angles is not enough on its own.' },
        { difficulty: 'Medium', question: 'Which statement about the letter T is correct?', checkMode: 'auto', options: ['T has a horizontal line of symmetry but not a vertical one.', 'T has no lines of symmetry at all.', 'T has both a vertical and a horizontal line of symmetry.', 'T has a vertical line of symmetry — folding down the middle of its stem makes the halves match.'], correctIndex: 3, explanation: 'The letter T folds down the middle of its stem, and the left and right halves match.' },
        { difficulty: 'Medium', question: 'Which letter has BOTH a vertical and a horizontal line of symmetry: X or S?', checkMode: 'auto', options: ['X — it has both a vertical and horizontal line of symmetry, while S has none.', 'S — it has both a vertical and horizontal line of symmetry, while X has none.', 'Both X and S have both lines of symmetry.', 'Neither letter has any line of symmetry.'], correctIndex: 0, explanation: 'The letter X can be folded vertically and horizontally, and in both cases the halves match. S has no lines of symmetry at all.' },
        { difficulty: 'Medium', question: 'Which letters in the word "HAT" have at least one line of symmetry?', checkMode: 'auto', options: ['Only H has a line of symmetry.', 'H, A and T — all three letters have at least one line of symmetry.', 'Only A and T have a line of symmetry, not H.', 'None of the letters in HAT have a line of symmetry.'], correctIndex: 1, explanation: 'H has both vertical and horizontal symmetry, A has a vertical line of symmetry, and T also has a vertical line of symmetry. Every letter in HAT has at least one line of symmetry.' },
        { difficulty: 'Medium', question: 'A regular polygon has 9 equal sides (a regular nonagon). How many lines of symmetry does it have?', checkMode: 'auto', options: ['3 lines of symmetry', '18 lines of symmetry', '9 lines of symmetry', '0 lines of symmetry'], correctIndex: 2, explanation: 'A regular polygon has the same number of lines of symmetry as it has sides. A regular nonagon has 9 sides, so it has 9 lines of symmetry.' },
        { difficulty: 'Medium', question: 'A regular polygon has 12 equal sides (a regular dodecagon). How many lines of symmetry does it have?', checkMode: 'auto', options: ['6 lines of symmetry', '24 lines of symmetry', '1 line of symmetry', '12 lines of symmetry'], correctIndex: 3, explanation: 'For any regular polygon, the number of lines of symmetry equals the number of sides — 12 sides gives 12 lines of symmetry.' },
        { difficulty: 'Medium', question: 'Which explanation correctly justifies why doubling the number of sides of a regular polygon (for example, going from a hexagon to a 12-sided shape) also doubles its number of lines of symmetry?', checkMode: 'auto', options: ['Because each side always contributes exactly one matching line of symmetry in a regular polygon.', 'Because doubling the sides always doubles the size of the shape, which doubles the lines too.', 'Because lines of symmetry only depend on the number of right angles, not the number of sides.', 'Because a 12-sided shape always has 4 times as many lines of symmetry as a hexagon.'], correctIndex: 0, explanation: 'In a regular polygon, the number of lines of symmetry always equals the number of sides — each side (or corner) contributes exactly one line. So if the number of sides doubles from 6 to 12, the number of lines of symmetry also doubles, from 6 to 12.' },
        { difficulty: 'Medium-Hard', question: 'The grid shows a vertical red dashed line of symmetry with points X, Y and Z marked on the left side only. Point X is 3 squares from the line. How far from the line should its mirror point be, and on which side?', checkMode: 'auto', options: ['3 squares from the line, on the left side.', '3 squares from the line, on the right side.', '6 squares from the line, on the right side.', 'It has no mirror point because X is the furthest marked point from the line.'], correctIndex: 1, explanation: 'A mirror point sits the same distance from the line of symmetry as the original point, just on the opposite side. Since X is 3 squares left of the line, its mirror point X′ is 3 squares to the right.', diagramSvg: '<svg viewBox="0 0 220 180" xmlns="http://www.w3.org/2000/svg" font-family="Arial, sans-serif"><rect x="10" y="10" width="200" height="160" fill="none" stroke="#9ca3af" stroke-width="1"/><g stroke="#e5e7eb" stroke-width="1"><line x1="30" y1="10" x2="30" y2="170"/><line x1="50" y1="10" x2="50" y2="170"/><line x1="70" y1="10" x2="70" y2="170"/><line x1="90" y1="10" x2="90" y2="170"/><line x1="110" y1="10" x2="110" y2="170"/><line x1="130" y1="10" x2="130" y2="170"/><line x1="150" y1="10" x2="150" y2="170"/><line x1="170" y1="10" x2="170" y2="170"/><line x1="190" y1="10" x2="190" y2="170"/><line x1="10" y1="30" x2="210" y2="30"/><line x1="10" y1="50" x2="210" y2="50"/><line x1="10" y1="70" x2="210" y2="70"/><line x1="10" y1="90" x2="210" y2="90"/><line x1="10" y1="110" x2="210" y2="110"/><line x1="10" y1="130" x2="210" y2="130"/><line x1="10" y1="150" x2="210" y2="150"/></g><line x1="110" y1="10" x2="110" y2="170" stroke="#dc2626" stroke-width="2.5" stroke-dasharray="6,4"/><circle cx="50" cy="50" r="4" fill="#2563eb"/><text x="45" y="46" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">X</text><circle cx="70" cy="100" r="4" fill="#2563eb"/><text x="65" y="96" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">Y</text><circle cx="90" cy="150" r="4" fill="#2563eb"/><text x="85" y="146" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">Z</text><text x="110" y="22" font-size="12" font-weight="700" fill="#dc2626" text-anchor="middle">line of symmetry</text></svg>' },
        { difficulty: 'Medium-Hard', question: 'Using the same grid: point Y is 2 squares from the line and point Z is 1 square from the line. Does reflecting Y and Z across the line change how high up or down they are, compared to their original heights?', checkMode: 'auto', options: ['Yes, both points move higher after reflecting.', 'Yes, both points move lower after reflecting.', 'No — each mirror point stays at exactly the same height as its original point.', 'It depends on how far each point is from the line.'], correctIndex: 2, explanation: 'A vertical line of symmetry only reflects points from left to right — it never changes how high or low a point is. So the mirror points for Y and Z stay at exactly the same heights as Y and Z themselves.', diagramSvg: '<svg viewBox="0 0 220 180" xmlns="http://www.w3.org/2000/svg" font-family="Arial, sans-serif"><rect x="10" y="10" width="200" height="160" fill="none" stroke="#9ca3af" stroke-width="1"/><g stroke="#e5e7eb" stroke-width="1"><line x1="30" y1="10" x2="30" y2="170"/><line x1="50" y1="10" x2="50" y2="170"/><line x1="70" y1="10" x2="70" y2="170"/><line x1="90" y1="10" x2="90" y2="170"/><line x1="110" y1="10" x2="110" y2="170"/><line x1="130" y1="10" x2="130" y2="170"/><line x1="150" y1="10" x2="150" y2="170"/><line x1="170" y1="10" x2="170" y2="170"/><line x1="190" y1="10" x2="190" y2="170"/><line x1="10" y1="30" x2="210" y2="30"/><line x1="10" y1="50" x2="210" y2="50"/><line x1="10" y1="70" x2="210" y2="70"/><line x1="10" y1="90" x2="210" y2="90"/><line x1="10" y1="110" x2="210" y2="110"/><line x1="10" y1="130" x2="210" y2="130"/><line x1="10" y1="150" x2="210" y2="150"/></g><line x1="110" y1="10" x2="110" y2="170" stroke="#dc2626" stroke-width="2.5" stroke-dasharray="6,4"/><circle cx="50" cy="50" r="4" fill="#2563eb"/><text x="45" y="46" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">X</text><circle cx="70" cy="100" r="4" fill="#2563eb"/><text x="65" y="96" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">Y</text><circle cx="90" cy="150" r="4" fill="#2563eb"/><text x="85" y="146" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">Z</text><text x="110" y="22" font-size="12" font-weight="700" fill="#dc2626" text-anchor="middle">line of symmetry</text></svg>' },
        { difficulty: 'Medium-Hard', question: 'Using the same grid again: looking at where points X, Y and Z are marked, is the line of symmetry vertical or horizontal, and how can you tell just from the way the red dashed line is drawn?', checkMode: 'auto', options: ['Horizontal — the line splits the grid into a top and bottom half.', 'Diagonal — the line runs corner to corner.', 'It cannot be told without measuring the distances of X, Y and Z.', 'Vertical — the red dashed line runs straight up and down, not side to side.'], correctIndex: 3, explanation: 'The red dashed line runs from the top of the grid to the bottom, splitting it into a left side and a right side — that up-and-down direction is what makes it a vertical line of symmetry, rather than a horizontal one which would run side to side.', diagramSvg: '<svg viewBox="0 0 220 180" xmlns="http://www.w3.org/2000/svg" font-family="Arial, sans-serif"><rect x="10" y="10" width="200" height="160" fill="none" stroke="#9ca3af" stroke-width="1"/><g stroke="#e5e7eb" stroke-width="1"><line x1="30" y1="10" x2="30" y2="170"/><line x1="50" y1="10" x2="50" y2="170"/><line x1="70" y1="10" x2="70" y2="170"/><line x1="90" y1="10" x2="90" y2="170"/><line x1="110" y1="10" x2="110" y2="170"/><line x1="130" y1="10" x2="130" y2="170"/><line x1="150" y1="10" x2="150" y2="170"/><line x1="170" y1="10" x2="170" y2="170"/><line x1="190" y1="10" x2="190" y2="170"/><line x1="10" y1="30" x2="210" y2="30"/><line x1="10" y1="50" x2="210" y2="50"/><line x1="10" y1="70" x2="210" y2="70"/><line x1="10" y1="90" x2="210" y2="90"/><line x1="10" y1="110" x2="210" y2="110"/><line x1="10" y1="130" x2="210" y2="130"/><line x1="10" y1="150" x2="210" y2="150"/></g><line x1="110" y1="10" x2="110" y2="170" stroke="#dc2626" stroke-width="2.5" stroke-dasharray="6,4"/><circle cx="50" cy="50" r="4" fill="#2563eb"/><text x="45" y="46" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">X</text><circle cx="70" cy="100" r="4" fill="#2563eb"/><text x="65" y="96" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">Y</text><circle cx="90" cy="150" r="4" fill="#2563eb"/><text x="85" y="146" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">Z</text><text x="110" y="22" font-size="12" font-weight="700" fill="#dc2626" text-anchor="middle">line of symmetry</text></svg>' },
        { difficulty: 'Hard', question: 'A road sign is shaped like a regular octagon (a stop sign) and another is shaped like an equilateral triangle (a yield sign). Which statement correctly compares their symmetry?', checkMode: 'auto', options: ["The octagon has more lines of symmetry (8 vs 3), but this does not make it 'more symmetrical' in every sense — both shapes are fully symmetrical, the octagon just has more sides and so more folds that work.", 'The triangle has more lines of symmetry because it is a simpler shape.', 'Both shapes have exactly the same number of lines of symmetry.', 'Neither shape is truly symmetrical because road signs are not regular polygons.'], correctIndex: 0, explanation: 'The octagon (stop sign) has 8 lines of symmetry, while the equilateral triangle (yield sign) has 3. The octagon has more possible fold lines that work, but both shapes are equally "symmetrical" in the sense that every fold along one of their lines of symmetry produces two matching halves — one is not more perfectly symmetrical than the other, it simply has more lines because it has more sides.' },
        { difficulty: 'Hard', question: "Thabo says a beehive honeycomb (made of regular hexagons) and a soccer ball pattern (made partly of regular pentagons and hexagons) must have exactly the same symmetry because they are both 'nature-inspired' designs. Which statement correctly evaluates Thabo's claim?", checkMode: 'auto', options: ['Thabo is correct — all nature-inspired shapes automatically share the same symmetry.', 'Thabo is incorrect — a regular hexagon has 6 lines of symmetry while a regular pentagon has only 5, so the shapes in each pattern have different symmetry.', 'Thabo is correct — both hexagons and pentagons always have 5 lines of symmetry.', 'Thabo is incorrect — neither hexagons nor pentagons have any lines of symmetry.'], correctIndex: 1, explanation: 'Thabo is incorrect to assume the two designs share the same symmetry just because both come from nature-inspired shapes. A honeycomb\'s hexagons each have 6 lines of symmetry, but the pentagons used in a soccer ball pattern have only 5 lines of symmetry each — different regular polygons have different amounts of symmetry depending on their number of sides.' },
      ],
      scoreMessages: [
        { minScore: 20, message: 'Outstanding! You have mastered symmetry across shapes, letters, polygons and grids.' },
        { minScore: 15, message: 'Great work! You understand symmetry well — review any missed questions.' },
