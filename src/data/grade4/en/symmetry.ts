  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'How many lines of symmetry does an isosceles triangle (two equal sides) have?', answer: '1', checkMode: 'auto', correctAnswer: '1', correctAnswers: ['1', 'one', '1 line'], explanation: 'An isosceles triangle has exactly one line of symmetry — the fold line running from the top corner straight down to the middle of the base.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'How many lines of symmetry does a rhombus (all 4 sides equal, no right angles) have?', answer: '2', checkMode: 'auto', correctAnswer: '2', correctAnswers: ['2', 'two', '2 lines'], explanation: 'A rhombus has 2 lines of symmetry — its two diagonals. The vertical and horizontal folds do not work because its angles are not right angles.' },
        ...
        { difficulty: 'Medium', question: 'A regular polygon has 9 equal sides (a regular nonagon). How many lines of symmetry does it have?', answer: '9', checkMode: 'auto', correctAnswer: '9', correctAnswers: ['9', 'nine', '9 lines'], explanation: 'A regular polygon has the same number of lines of symmetry as it has sides. A regular nonagon has 9 sides, so it has 9 lines of symmetry.' },
