  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'Imagine the shoebox lying flat with its long side facing you. A picture is printed only on one of its short ends. From which two views could you possibly see that picture: front and top, or front and one side?', answer: 'Front and one side', checkMode: 'self', explanation: 'The short end could be viewed as either the "front" or a "side," depending on which way the box is turned, but the top view would only show the flat lid, not the printed end.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'A picture shows a triangle-like outline with two straight slanted sides meeting at a point, and a curved line at the bottom. Which view of a party hat (cone) is this likely to be?', answer: 'Side view (or front view)', checkMode: 'self', explanation: 'A cone-shaped hat seen from the side (or front) shows two straight slanted sides meeting at a point at the top, with a curved base at the bottom. The top view would instead show a plain circle for the brim.', diagramSvg: '<svg viewBox="0 0 220 140" xmlns="http://www.w3.org/2000/svg"><path d="M110 15 L165 115 C165 122 140 128 110 128 C80 128 55 122 55 115 Z" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><ellipse cx="110" cy="115" rx="55" ry="10" fill="none" stroke="#2563eb" stroke-width="1.5"/></svg>' },
