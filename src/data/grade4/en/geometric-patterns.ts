  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'Three regular hexagons meet at a point in a tessellating pattern, with no gaps or overlaps. What is the size of each hexagon\'s angle at that point?', answer: '120°', checkMode: 'auto', correctAnswer: '120°', correctAnswers: ['120°', '120', '120 degrees'], explanation: 'For tessellation, the angles at a point must add up to 360°.\n360° ÷ 3 hexagons = 120° for each hexagon\'s angle.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        // Block C — Shape and tessellation reasoning (positions 9-12, Medium)
        { difficulty: 'Medium', question: 'Look at the diagram. Do regular hexagons tessellate? Write Yes or No.', answer: 'Yes', checkMode: 'auto', correctAnswer: 'Yes', correctAnswers: ['Yes', 'yes'], explanation: 'The diagram shows three regular hexagons meeting perfectly at a point with no gaps or overlaps. Regular hexagons have straight edges that fit together edge to edge. Yes, hexagons tessellate.', diagramSvg: '<svg viewBox="0 0 220 190" xmlns="http://www.w3.org/2000/svg"><polygon points="110,100 144.6,120 144.6,160 110,180 75.4,160 75.4,120" fill="none" stroke="#0f1f3d" stroke-width="2"/><polygon points="110,100 75.4,120 40.7,100 40.7,60 75.4,40 110,60" fill="none" stroke="#0f1f3d" stroke-width="2"/><polygon points="110,100 110,60 144.6,40 179.3,60 179.3,100 144.6,120" fill="none" stroke="#0f1f3d" stroke-width="2"/><circle cx="110" cy="100" r="3" fill="#dc2626"/></svg>' },
