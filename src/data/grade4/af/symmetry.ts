  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: "Hoeveel simmetrielyne het ’n ongelyksydige driehoek (al die sye verskillende lengtes)?", answer: '0', checkMode: 'auto', correctAnswer: '0', correctAnswers: ['0', 'nul', 'geen'], explanation: '’n Ongelyksydige driehoek het al die sye en hoeke verskillend, so geen vou lewer twee bypassende helftes op nie. Dit het 0 simmetrielyne.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'Watter letters in die woord "TOY" het ten minste een simmetrielyn?', answer: 'T, O en Y (al drie letters)', checkMode: 'auto', correctAnswer: 'TOY', correctAnswers: ['TOY', 'T,O,Y', 'T, O, Y', 'aldrieletters', 'T, O en Y'], explanation: 'T het ’n vertikale simmetrielyn, O het beide vertikale en horisontale simmetrie, en Y het ook ’n vertikale simmetrielyn. Al drie letters in TOY het ten minste een simmetrielyn.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: "Hoeveel simmetrielyne het ’n vierkant in vergelyking met ’n ongelyksydige driehoek?", answer: 'Die vierkant het 4, die ongelyksydige driehoek het 0.', checkMode: 'auto', correctAnswer: '4en0', correctAnswers: ['4en0', '4,0', '40'], explanation: "’n Vierkant het 4 simmetrielyne. ’n Ongelyksydige driehoek, met al die sye en hoeke verskillend, het 0 simmetrielyne." },
