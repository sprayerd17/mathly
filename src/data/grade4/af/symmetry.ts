...
<div style="background:#eff6ff;border:1.5px solid #bfdbfe;border-radius:10px;padding:16px 20px;margin-bottom:8px;">
  ...
  <div style="display:flex;flex-direction:column;gap:0;">
    ...
    <div style="display:flex;align-items:center;gap:12px;padding:10px 0;border-bottom:1px solid #e0e7ff;">
      <span style="min-width:170px;font-weight:700;color:#1e3a8a;font-size:15px;">Ongelyksydige driehoek</span>
...
<div style="background:#eff6ff;border:1.5px solid #bfdbfe;border-radius:10px;padding:16px 20px;margin-bottom:16px;">
  ...
  <div style="display:flex;flex-direction:column;gap:10px;">
    ...
    <div style="display:flex;align-items:flex-start;gap:10px;flex-wrap:wrap;">
      ...
      workedExamples: [
        {
          question: "Watter letters in die woord MATH het ’n simmetrielyn?",
...
<div style="background:#f0fdf4;border:1.5px solid #86efac;border-radius:8px;padding:10px 16px;display:inline-block;margin-top:8px;">
  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      name: 'Stel 1',
      questions: [
        { difficulty: 'Easy', question: "’n Vorm word presies in die helfte gevou en albei kante pas perfek. Wat word hierdie vouliyn genoem?", checkMode: 'auto', options: ['Simmetrielyn', 'Diagonale lyn', 'Rotasie-as', 'Middellyn van die vorm'], correctIndex: 0, explanation: 'Die vouliyn wat ’n vorm in twee bypassende spieëlbeeld-helftes verdeel, word die simmetrielyn genoem.' },
        { difficulty: 'Easy', question: "Watter stelling oor ’n vierkant se simmetrie is korrek?", checkMode: 'auto', options: ["’n Vierkant is nie simmetries nie omdat sy sye reguit is.", "’n Vierkant is simmetries — dit kan gevou word sodat albei helftes presies pas.", "’n Vierkant is slegs simmetries as dit perfek volgens skaal geteken is.", "’n Vierkant is slegs simmetries langs sy diagonale, nie vertikaal of horisontaal nie."], correctIndex: 1, explanation: "’n Vierkant kan langs 4 verskillende lyne gevou word (vertikaal, horisontaal, 2 diagonale) en elke keer pas albei helftes presies, so dit is simmetries." },
        { difficulty: 'Easy', question: "’n Leerder vou ’n vorm langs ’n lyn en die twee helftes pas NIE. Watter stelling is korrek?", checkMode: 'auto', options: ['Die lyn is steeds ’n simmetrielyn, omdat die leerder probeer het om te vou.', 'Die lyn is slegs ’n simmetrielyn as die vorm ’n driehoek is.', 'Die lyn is NIE ’n simmetrielyn nie, want die helftes moet presies pas om te tel.', 'Die lyn word ’n simmetrielyn die tweede keer wat jy dit vou.'], correctIndex: 2, explanation: '’n Lyn tel slegs as ’n simmetrielyn as albei helftes presies pas wanneer dit gevou word. As hulle nie pas nie, is dit nie ’n simmetrielyn nie.' },
        { difficulty: 'Easy', question: 'Watter stelling oor die letter S is korrek?', checkMode: 'auto', options: ['S is simmetries langs slegs ’n vertikale lyn.', 'S is simmetries langs slegs ’n horisontale lyn.', 'S is simmetries langs beide ’n vertikale en ’n horisontale lyn.', 'S is nie simmetries nie — geen vouliyn maak die twee helftes bypassend nie.'], correctIndex: 3, explanation: 'Maak nie saak hoe jy die letter S vou nie, die twee helftes pas nooit — dit het 0 simmetrielyne.' },
        { difficulty: 'Easy', question: "Hoeveel simmetrielyne het ’n sirkel?", checkMode: 'auto', options: ['Oneindige simmetrielyne', '4 simmetrielyne', '1 simmetrielyn', '0 simmetrielyne'], correctIndex: 0, explanation: 'Enige lyn deur die middelpunt van ’n sirkel (’n middellyn) is ’n simmetrielyn, so ’n sirkel het oneindige simmetrielyne.' },
        { difficulty: 'Easy', question: "Hoeveel simmetrielyne het ’n vierkant?", checkMode: 'auto', options: ['2 simmetrielyne', '4 simmetrielyne', '8 simmetrielyne', '0 simmetrielyne'], correctIndex: 1, explanation: "’n Vierkant het 4 simmetrielyne: vertikaal, horisontaal, en 2 diagonale." },
        { difficulty: 'Easy-Medium', question: "Watter een van hierdie het meer simmetrielyne: ’n vierkant of ’n reghoek (nie ’n vierkant nie)?", checkMode: 'auto', options: ['Die reghoek — dit het meer sye wat gelyk is.', 'Hulle het dieselfde aantal simmetrielyne.', 'Die vierkant — dit het 4 lyne teenoor die reghoek se 2.', 'Geeneen het enige simmetrielyne nie.'], correctIndex: 2, explanation: "’n Vierkant het 4 simmetrielyne, terwyl ’n reghoek wat nie ’n vierkant is nie, slegs 2 het." },
        { difficulty: 'Medium', question: "Hoeveel simmetrielyne het ’n ongelyksydige driehoek (al die sye verskillende lengtes)?", checkMode: 'auto', options: ['3 simmetrielyne, aangesien dit steeds ’n driehoek is', '1 simmetrielyn, deur die langste sy', '2 simmetrielyne', '0 simmetrielyne'], correctIndex: 3, explanation: '’n Ongelyksydige driehoek het al die sye en hoeke verskillend, so geen vou lewer twee bypassende helftes op nie. Dit het 0 simmetrielyne.' },
        { difficulty: 'Medium', question: "Kagiso sê ’n ruit (al 4 sye gelyk, geen regte hoeke) het 4 simmetrielyne, net soos ’n vierkant, omdat albei vorms 4 gelyke sye het. Watter stelling evalueer Kagiso se redenasie korrek?", checkMode: 'auto', options: ["Kagiso is verkeerd — ’n ruit het slegs 2 simmetrielyne (sy diagonale), omdat sy hoeke nie regte hoeke soos ’n vierkant s'n is nie.", 'Kagiso is korrek — enige vorm met 4 gelyke sye het 4 simmetrielyne.', "Kagiso is verkeerd — ’n ruit het eintlik meer simmetrielyne as ’n vierkant.", "Kagiso is korrek, maar slegs as die ruit teen 45° gekantel is."], correctIndex: 0, explanation: "Kagiso is verkeerd. ’n Ruit het slegs 2 simmetrielyne — sy twee diagonale. Omdat sy hoeke nie regte hoeke is nie, pas die vertikale en horisontale voue nie, anders as by ’n vierkant. Om gelyke sye te hê is nie op sy eie genoeg nie." },
        { difficulty: 'Medium', question: 'Watter stelling oor die letter M is korrek?', checkMode: 'auto', options: ['M het ’n horisontale simmetrielyn maar nie ’n vertikale een nie.', 'M het ’n vertikale simmetrielyn — as dit deur die middel gevou word, pas die helftes.', 'M het glad geen simmetrielyne nie.', 'M het beide ’n vertikale en ’n horisontale simmetrielyn.'], correctIndex: 1, explanation: 'Die letter M vou netjies deur die middel — die linker- en regterhelftes pas.' },
        { difficulty: 'Medium', question: 'Watter letter het BEIDE ’n vertikale en ’n horisontale simmetrielyn: H of N?', checkMode: 'auto', options: ['N — dit vou netjies in albei rigtings.', 'Geeneen van die letters het enige simmetrielyn nie.', 'H — dit het beide ’n vertikale en horisontale simmetrielyn, terwyl N geeneen het nie.', 'Beide H en N het beide simmetrielyne.'], correctIndex: 2, explanation: 'Die letter H kan vertikaal en horisontaal gevou word, en in albei gevalle pas die helftes. N het glad geen simmetrielyne nie.' },
        { difficulty: 'Medium', question: 'Watter letters in die woord "MUM" het ten minste een simmetrielyn?', checkMode: 'auto', options: ["Slegs die twee M's, nie die U nie", 'Slegs die U, nie enige M nie', 'Geeneen van die letters in MUM het ’n simmetrielyn nie', 'M, U en M — al drie letters het ten minste een simmetrielyn'], correctIndex: 3, explanation: 'M het ’n vertikale simmetrielyn, en U het ook ’n vertikale simmetrielyn. Aangesien die woord M-U-M is, het elke letter daarin ten minste een simmetrielyn.' },
        { difficulty: 'Medium', question: "’n Reëlmatige veelhoek het 5 gelyke sye (’n reëlmatige vyfhoek). Hoeveel simmetrielyne het dit?", checkMode: 'auto', options: ['5 simmetrielyne', '10 simmetrielyne', '4 simmetrielyne', '1 simmetrielyn'], correctIndex: 0, explanation: 'ʼn Reëlmatige veelhoek het dieselfde aantal simmetrielyne as wat dit sye het. ’n Reëlmatige vyfhoek het 5 sye, so dit het 5 simmetrielyne.' },
        { difficulty: 'Medium', question: "’n Reëlmatige veelhoek het 8 gelyke sye (’n reëlmatige agthoek). Hoeveel simmetrielyne het dit?", checkMode: 'auto', options: ['4 simmetrielyne', '8 simmetrielyne', '16 simmetrielyne', '0 simmetrielyne, aangesien dit te veel sye het om eweredig te vou'], correctIndex: 1, explanation: "Vir ’n reëlmatige veelhoek is die aantal simmetrielyne altyd gelyk aan die aantal sye — 8 sye beteken 8 simmetrielyne." },
        { difficulty: 'Medium', question: "Watter verduideliking regverdig korrek hoekom ’n reëlmatige veelhoek altyd dieselfde aantal simmetrielyne het as wat dit sye het?", checkMode: 'auto', options: ['Omdat reëlmatige veelhoeke altyd ’n ewe aantal sye het, so voue pas altyd eweredig.', 'Omdat elke veelhoek, reëlmatig of nie, een simmetrielyn per sy het.', 'Omdat al die sye en hoeke presies gelyk is, so elke hoek (of middelpunt) stem ooreen met ’n bypassende vou wat twee identiese helftes oplewer.', 'Omdat die aantal simmetrielyne altyd een minder is as die aantal sye.'], correctIndex: 2, explanation: 'In ’n reëlmatige veelhoek is elke sy en elke hoek presies gelyk, so vir elke hoek is daar presies een bypassende vouliyn na die teenoorgestelde sy of middelpunt wat twee identiese helftes oplewer — dit gee een simmetrielyn per sy.' },
        { difficulty: 'Medium-Hard', question: "Die rooster wys ’n vertikale rooi stippellyn as simmetrielyn met punte A, B en C slegs aan die linkerkant gemerk. Hoeveel blokkies vanaf die lyn is punt A, en hoeveel blokkies vanaf die lyn behoort sy spieëlpunt aan die regterkant te wees?", checkMode: 'auto', options: ['A is 3 blokkies vanaf die lyn; sy spieëlpunt is 2 blokkies vanaf die lyn.', 'A is 2 blokkies vanaf die lyn; sy spieëlpunt is 3 blokkies vanaf die lyn.', 'A is 1 blokkie vanaf die lyn; sy spieëlpunt is 1 blokkie vanaf die lyn.', 'A is 2 blokkies vanaf die lyn; sy spieëlpunt is ook 2 blokkies vanaf die lyn, aan die regterkant.'], correctIndex: 3, explanation: 'Punt A sit 2 blokkies links van die simmetrielyn. ’n Spieëlpunt is altyd dieselfde afstand vanaf die lyn as die oorspronklike punt, net aan die teenoorgestelde kant — so A′ is ook 2 blokkies vanaf die lyn, maar aan die regterkant.', diagramSvg: '<svg viewBox="0 0 220 180" xmlns="http://www.w3.org/2000/svg" font-family="Arial, sans-serif"><rect x="10" y="10" width="200" height="160" fill="none" stroke="#9ca3af" stroke-width="1"/><g stroke="#e5e7eb" stroke-width="1"><line x1="30" y1="10" x2="30" y2="170"/><line x1="50" y1="10" x2="50" y2="170"/><line x1="70" y1="10" x2="70" y2="170"/><line x1="90" y1="10" x2="90" y2="170"/><line x1="110" y1="10" x2="110" y2="170"/><line x1="130" y1="10" x2="130" y2="170"/><line x1="150" y1="10" x2="150" y2="170"/><line x1="170" y1="10" x2="170" y2="170"/><line x1="190" y1="10" x2="190" y2="170"/><line x1="10" y1="30" x2="210" y2="30"/><line x1="10" y1="50" x2="210" y2="50"/><line x1="10" y1="70" x2="210" y2="70"/><line x1="10" y1="90" x2="210" y2="90"/><line x1="10" y1="110" x2="210" y2="110"/><line x1="10" y1="130" x2="210" y2="130"/><line x1="10" y1="150" x2="210" y2="150"/></g><line x1="110" y1="10" x2="110" y2="170" stroke="#dc2626" stroke-width="2.5" stroke-dasharray="6,4"/><circle cx="70" cy="50" r="4" fill="#2563eb"/><text x="65" y="46" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">A</text><circle cx="90" cy="90" r="4" fill="#2563eb"/><text x="85" y="86" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">B</text><circle cx="50" cy="130" r="4" fill="#2563eb"/><text x="45" y="126" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">C</text><text x="110" y="22" font-size="12" font-weight="700" fill="#dc2626" text-anchor="middle">simmetrielyn</text></svg>' },
        { difficulty: 'Medium-Hard', question: "Met dieselfde rooster: punt C is 3 blokkies vanaf die simmetrielyn, en punt B is 1 blokkie vanaf die lyn. As jy die spieëlpunte vir A, B en C sou inteken, sou die totale hoogte van die voltooide vorm verander van die hoogte van net die gegewe helfte?", checkMode: 'auto', options: ['Nee, die hoogte bly dieselfde — slegs die wydte verander.', 'Ja, die hoogte verdubbel saam met die wydte.', 'Ja, die hoogte verminder omdat punte nader aan die lyn beweeg.', 'Dit hang af van watter punt die verste van die lyn is.'], correctIndex: 0, explanation: '’n Vertikale simmetrielyn reflekteer punte slegs links en regs. Dit verskuif nooit iets op of af nie, so die algehele hoogte van die vorm bly presies dieselfde — slegs die wydte neem toe soos die spieëlhelfte bygevoeg word.', diagramSvg: '<svg viewBox="0 0 220 180" xmlns="http://www.w3.org/2000/svg" font-family="Arial, sans-serif"><rect x="10" y="10" width="200" height="160" fill="none" stroke="#9ca3af" stroke-width="1"/><g stroke="#e5e7eb" stroke-width="1"><line x1="30" y1="10" x2="30" y2="170"/><line x1="50" y1="10" x2="50" y2="170"/><line x1="70" y1="10" x2="70" y2="170"/><line x1="90" y1="10" x2="90" y2="170"/><line x1="110" y1="10" x2="110" y2="170"/><line x1="130" y1="10" x2="130" y2="170"/><line x1="150" y1="10" x2="150" y2="170"/><line x1="170" y1="10" x2="170" y2="170"/><line x1="190" y1="10" x2="190" y2="170"/><line x1="10" y1="30" x2="210" y2="30"/><line x1="10" y1="50" x2="210" y2="50"/><line x1="10" y1="70" x2="210" y2="70"/><line x1="10" y1="90" x2="210" y2="90"/><line x1="10" y1="110" x2="210" y2="110"/><line x1="10" y1="130" x2="210" y2="130"/><line x1="10" y1="150" x2="210" y2="150"/></g><line x1="110" y1="10" x2="110" y2="170" stroke="#dc2626" stroke-width="2.5" stroke-dasharray="6,4"/><circle cx="70" cy="50" r="4" fill="#2563eb"/><text x="65" y="46" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">A</text><circle cx="90" cy="90" r="4" fill="#2563eb"/><text x="85" y="86" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">B</text><circle cx="50" cy="130" r="4" fill="#2563eb"/><text x="45" y="126" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">C</text><text x="110" y="22" font-size="12" font-weight="700" fill="#dc2626" text-anchor="middle">simmetrielyn</text></svg>' },
        { difficulty: 'Medium-Hard', question: "Met dieselfde rooster weer: is die rooi stippellyn (simmetrielyn) vertikaal of horisontaal georiënteer, en wat wys jou dit?", checkMode: 'auto', options: ['Horisontaal — dit verdeel die rooster in ’n boonste en ’n onderste helfte.', 'Vertikaal — dit loop op en af, en verdeel die rooster in ’n linkerkant en ’n regterkant.', 'Diagonaal — dit loop hoek tot hoek oor die rooster.', 'Dit kan nie bepaal word sonder om die spieëlpunte te sien nie.'], correctIndex: 1, explanation: "’n Vertikale simmetrielyn loop reguit op en af, en verdeel die rooster in ’n linkerkant en ’n regterkant, presies soos die rooi stippellyn hier geteken is — nie sy-aan-sy soos ’n horisontale lyn sou wees nie.", diagramSvg: '<svg viewBox="0 0 220 180" xmlns="http://www.w3.org/2000/svg" font-family="Arial, sans-serif"><rect x="10" y="10" width="200" height="160" fill="none" stroke="#9ca3af" stroke-width="1"/><g stroke="#e5e7eb" stroke-width="1"><line x1="30" y1="10" x2="30" y2="170"/><line x1="50" y1="10" x2="50" y2="170"/><line x1="70" y1="10" x2="70" y2="170"/><line x1="90" y1="10" x2="90" y2="170"/><line x1="110" y1="10" x2="110" y2="170"/><line x1="130" y1="10" x2="130" y2="170"/><line x1="150" y1="10" x2="150" y2="170"/><line x1="170" y1="10" x2="170" y2="170"/><line x1="190" y1="10" x2="190" y2="170"/><line x1="10" y1="30" x2="210" y2="30"/><line x1="10" y1="50" x2="210" y2="50"/><line x1="10" y1="70" x2="210" y2="70"/><line x1="10" y1="90" x2="210" y2="90"/><line x1="10" y1="110" x2="210" y2="110"/><line x1="10" y1="130" x2="210" y2="130"/><line x1="10" y1="150" x2="210" y2="150"/></g><line x1="110" y1="10" x2="110" y2="170" stroke="#dc2626" stroke-width="2.5" stroke-dasharray="6,4"/><circle cx="70" cy="50" r="4" fill="#2563eb"/><text x="65" y="46" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">A</text><circle cx="90" cy="90" r="4" fill="#2563eb"/><text x="85" y="86" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">B</text><circle cx="50" cy="130" r="4" fill="#2563eb"/><text x="45" y="126" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">C</text><text x="110" y="22" font-size="12" font-weight="700" fill="#dc2626" text-anchor="middle">simmetrielyn</text></svg>' },
        { difficulty: 'Hard', question: "Watter stelling beskryf die simmetrie van ’n regte mens se gesig die beste?", checkMode: 'auto', options: ["’n Mens se gesig is perfek simmetries, met albei helftes altyd identies.", "’n Mens se gesig het glad geen simmetrie nie — die twee kante is heeltemal verskillend.", "’n Mens se gesig is slegs redelik (ongeveer) simmetries — die twee helftes lyk soortgelyk maar is nooit perfek identies nie.", "’n Mens se gesig is slegs simmetries wanneer die persoon glimlag."], correctIndex: 2, explanation: '’n Mens se gesig lyk met die eerste oogopslag simmetries, maar in werklikheid is geen twee helftes van ’n regte gesig ooit perfek identies nie — daar is altyd klein natuurlike verskille, so ons sê dit is "redelik" of "ongeveer" simmetries, nie perfek simmetries nie.' },
        { difficulty: 'Hard', question: "Lerato sê elke 4-sydige vorm het 4 simmetrielyne, net soos ’n vierkant. Is sy korrek? Verduidelik, en gee ten minste een voorbeeld wat haar bewering weerlê.", checkMode: 'auto', options: ["Lerato is korrek — elke 4-sydige vorm het presies 4 simmetrielyne.", "Lerato is korrek, maar slegs vir vorms met reguit sye.", "Lerato is verkeerd — geen 4-sydige vorm het enige simmetrielyne behalwe die vierkant nie.", "Lerato is verkeerd — byvoorbeeld, ’n reghoek het slegs 2 simmetrielyne en ’n algemene parallelogram het 0."], correctIndex: 3, explanation: "Lerato is verkeerd. Slegs spesiale 4-sydige vorms soos ’n vierkant het 4 simmetrielyne. ’n Reghoek (nie ’n vierkant nie) het 2, ’n ruit het 2, en ’n parallelogram het 0 simmetrielyne — die aantal lyne hang af van die presiese vorm, nie net die aantal sye nie." },
      ],
      scoreMessages: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      name: 'Stel 2',
      questions: [
        { difficulty: 'Easy', question: "Wanneer ’n vorm gevou word sodat albei helftes presies op mekaar land, wat noem ons hierdie vouliyn?", checkMode: 'auto', options: ['Rotasie-as', 'Simmetrielyn', 'Diagonaal', 'Omtreklyn'], correctIndex: 1, explanation: "’n Vouliyn waarlangs albei helftes van ’n vorm presies pas, word die simmetrielyn genoem." },
        { difficulty: 'Easy', question: 'Watter stelling oor die letter A is korrek?', checkMode: 'auto', options: ["A is nie simmetries nie — geen vouliyn maak sy helftes bypassend nie.", "A is slegs simmetries langs ’n horisontale lyn.", "A is simmetries — as dit deur die middel gevou word, pas die linker- en regterhelftes.", "A is simmetries langs beide ’n vertikale en horisontale lyn."], correctIndex: 2, explanation: "Die letter A kan deur die middel gevou word, en die linker- en regterhelftes pas — dit is simmetries. Dit vou nie bo-na-onder bypassend nie, so dit het geen horisontale simmetrielyn nie." },
        { difficulty: 'Easy', question: 'Watter stelling oor simmetrielyne is korrek?', checkMode: 'auto', options: ["Enige lyn wat oor ’n vorm getrek word, is outomaties ’n simmetrielyn.", "’n Lyn tel slegs as ’n simmetrielyn as dit deur ’n hoek van die vorm loop.", "’n Lyn is ’n simmetrielyn solank dit die vorm in twee gelyke oppervlaktes verdeel.", "’n Lyn tel slegs as ’n simmetrielyn as om daarlangs te vou, albei helftes presies laat pas."], correctIndex: 3, explanation: "’n Lyn tel slegs as ’n simmetrielyn as om daarlangs te vou, twee helftes oplewer wat presies pas. ’n Lukrake lyn oor ’n vorm sal gewoonlik nie — selfs een wat dit in twee gelyke oppervlaktes verdeel, of deur ’n hoek loop." },
        { difficulty: 'Easy', question: 'Watter stelling oor die letter F is korrek?', checkMode: 'auto', options: ["F het geen simmetrielyne nie — geen vou laat sy helftes pas nie.", "F het een vertikale simmetrielyn.", "F het een horisontale simmetrielyn.", "F het beide ’n vertikale en ’n horisontale simmetrielyn."], correctIndex: 0, explanation: "Die letter F kan langs geen lyn gevou word sodat albei helftes pas nie — dit het 0 simmetrielyne." },
        { difficulty: 'Easy', question: "Hoeveel simmetrielyne het ’n gelykbenige driehoek (twee gelyke sye)?", checkMode: 'auto', options: ['0 simmetrielyne', '1 simmetrielyn', '2 simmetrielyne', '3 simmetrielyne'], correctIndex: 1, explanation: "’n Gelykbenige driehoek het presies een simmetrielyn — die vouliyn wat vanaf die boonste hoek reguit af na die middel van die basis loop." },
        { difficulty: 'Easy', question: "Hoeveel simmetrielyne het ’n reghoek (nie ’n vierkant nie)?", checkMode: 'auto', options: ['4 simmetrielyne', '1 simmetrielyn', '2 simmetrielyne', '0 simmetrielyne'], correctIndex: 2, explanation: "’n Reghoek het 2 simmetrielyne: een vertikaal en een horisontaal. Die diagonale werk nie omdat die sye nie almal gelyk is nie." },
        { difficulty: 'Easy-Medium', question: "Watter vorm het meer simmetrielyne: ’n reëlmatige vyfhoek of ’n reëlmatige seshoek?", checkMode: 'auto', options: ["Die vyfhoek — dit het 6 simmetrielyne.", "Hulle het dieselfde aantal simmetrielyne.", "Geeneen van die vorms het enige simmetrielyne nie.", "Die seshoek — dit het 6 simmetrielyne teenoor die vyfhoek se 5."], correctIndex: 3, explanation: "’n Reëlmatige seshoek het 6 simmetrielyne, meer as die vyfhoek se 5 lyne." },
        { difficulty: 'Medium', question: "Hoeveel simmetrielyne het ’n algemene parallelogram (skuins sye, teenoorgestelde sye gelyk, maar nie ’n reghoek of ruit nie)?", checkMode: 'auto', options: ['0 simmetrielyne', "2 simmetrielyne, dieselfde as ’n reghoek", "4 simmetrielyne, dieselfde as ’n vierkant", "1 simmetrielyn, langs die langer diagonaal"], correctIndex: 0, explanation: "’n Algemene parallelogram het 0 simmetrielyne — geen vou lewer twee bypassende helftes op nie, al is die teenoorgestelde sye gelyk." },
        { difficulty: 'Medium', question: "Naledi sê ’n gelykbenige driehoek en ’n gelyksydige driehoek moet dieselfde aantal simmetrielyne hê, aangesien albei ten minste 2 gelyke sye het. Watter stelling evalueer haar bewering korrek?", checkMode: 'auto', options: ["Naledi is korrek — albei driehoeke het altyd presies 2 simmetrielyne.", "Naledi is verkeerd — ’n gelykbenige driehoek het 1 simmetrielyn, maar ’n gelyksydige driehoek het 3.", "Naledi is verkeerd — geeneen van die driehoeke het enige simmetrielyne nie.", "Naledi is korrek, aangesien albei vorms driehoeke is."], correctIndex: 1, explanation: "Naledi is verkeerd. ’n Gelykbenige driehoek het 1 simmetrielyn, maar ’n gelyksydige driehoek (al 3 sye gelyk) het 3 simmetrielyne — een vanaf elke hoek. Om sommige gelyke sye te hê waarborg nie dieselfde simmetrie nie." },
        { difficulty: 'Medium', question: 'Watter stelling oor die letter W is korrek?', checkMode: 'auto', options: ["W het ’n horisontale simmetrielyn maar nie ’n vertikale een nie.", "W het glad geen simmetrielyne nie.", "W het ’n vertikale simmetrielyn — as dit deur die middel gevou word, pas die helftes.", "W het beide ’n vertikale en ’n horisontale simmetrielyn."], correctIndex: 2, explanation: "Die letter W vou netjies deur die middel — die linker- en regterhelftes pas." },
        { difficulty: 'Medium', question: 'Watter letter het GEEN simmetrielyne nie: O of Z?', checkMode: 'auto', options: ["O — dit het geen simmetrielyne nie.", "Geeneen van O of Z het enige simmetrielyne nie.", "Beide O en Z het geen simmetrielyne nie.", "Z — dit het geen simmetrielyne nie, terwyl O beide vertikale en horisontale simmetrie het."], correctIndex: 3, explanation: "O het beide vertikale en horisontale simmetrie, maar Z het glad geen simmetrielyn nie." },
        { difficulty: 'Medium', question: 'Watter letters in die woord "TOY" het ten minste een simmetrielyn?', checkMode: 'auto', options: ["T, O en Y — al drie letters het ten minste een simmetrielyn.", "Slegs O het ’n simmetrielyn.", "Slegs T en Y het ’n simmetrielyn, nie O nie.", "Geeneen van die letters in TOY het ’n simmetrielyn nie."], correctIndex: 0, explanation: "T het ’n vertikale simmetrielyn, O het beide vertikale en horisontale simmetrie, en Y het ook ’n vertikale simmetrielyn. Al drie letters in TOY het ten minste een simmetrielyn." },
        { difficulty: 'Medium', question: "’n Reëlmatige veelhoek het 6 gelyke sye (’n reëlmatige seshoek). Hoeveel simmetrielyne het dit?", checkMode: 'auto', options: ['3 simmetrielyne', '6 simmetrielyne', '12 simmetrielyne', '0 simmetrielyne'], correctIndex: 1, explanation: "’n Reëlmatige seshoek het 6 gelyke sye, so dit het 6 simmetrielyne — 3 deur teenoorgestelde hoeke en 3 deur middelpunte van teenoorgestelde sye." },
        { difficulty: 'Medium', question: "’n Reëlmatige veelhoek het 10 gelyke sye (’n reëlmatige tienhoek). Hoeveel simmetrielyne het dit?", checkMode: 'auto', options: ['5 simmetrielyne', '20 simmetrielyne', '10 simmetrielyne', '1 simmetrielyn'], correctIndex: 2, explanation: "’n Reëlmatige veelhoek het altyd dieselfde aantal simmetrielyne as wat dit sye het — 10 sye beteken 10 simmetrielyne." },
        { difficulty: 'Medium', question: 'Watter verduideliking regverdig korrek hoekom die reël "simmetrielyne is gelyk aan aantal sye" slegs vir REËLMATIGE veelhoeke werk en nie vir onreëlmatige veelhoeke nie?', checkMode: 'auto', options: ["Omdat onreëlmatige veelhoeke altyd ’n onewe aantal sye het.", "Omdat die reël eintlik vir alle veelhoeke werk, reëlmatig of nie.", "Omdat onreëlmatige veelhoeke meer simmetrielyne het as reëlmatige veelhoeke.", "Omdat onreëlmatige veelhoeke nie al hul sye en hoeke gelyk het nie, so die meeste voue lewer nie bypassende helftes op nie."], correctIndex: 3, explanation: "Die reël berus daarop dat elke sy en hoek identies is, sodat elke hoek met ’n bypassende vou ooreenstem. In ’n onreëlmatige veelhoek is die sye en hoeke verskillende groottes, so die meeste moontlike vouliyne sal nie twee identiese helftes skep nie — die vorm kan minder simmetrielyne hê as wat dit sye het, of glad geen." },
        { difficulty: 'Medium-Hard', question: "Die rooster wys ’n vertikale rooi stippellyn as simmetrielyn met punte P, Q en R slegs aan die linkerkant gemerk. Punt P is 1 blokkie vanaf die lyn. Hoe ver vanaf die lyn behoort sy spieëlpunt te wees, en aan watter kant?", checkMode: 'auto', options: ["1 blokkie vanaf die lyn, aan die regterkant.", "1 blokkie vanaf die lyn, aan die linkerkant.", "2 blokkies vanaf die lyn, aan die regterkant.", "Dit kan nie ’n spieëlpunt hê nie, aangesien P reeds naby die lyn is."], correctIndex: 0, explanation: "’n Spieëlpunt is altyd dieselfde afstand vanaf die simmetrielyn as die oorspronklike punt, net aan die teenoorgestelde kant. Aangesien P 1 blokkie links van die lyn is, is sy spieëlpunt P′ 1 blokkie na regs.", diagramSvg: '<svg viewBox="0 0 220 180" xmlns="http://www.w3.org/2000/svg" font-family="Arial, sans-serif"><rect x="10" y="10" width="200" height="160" fill="none" stroke="#9ca3af" stroke-width="1"/><g stroke="#e5e7eb" stroke-width="1"><line x1="30" y1="10" x2="30" y2="170"/><line x1="50" y1="10" x2="50" y2="170"/><line x1="70" y1="10" x2="70" y2="170"/><line x1="90" y1="10" x2="90" y2="170"/><line x1="110" y1="10" x2="110" y2="170"/><line x1="130" y1="10" x2="130" y2="170"/><line x1="150" y1="10" x2="150" y2="170"/><line x1="170" y1="10" x2="170" y2="170"/><line x1="190" y1="10" x2="190" y2="170"/><line x1="10" y1="30" x2="210" y2="30"/><line x1="10" y1="50" x2="210" y2="50"/><line x1="10" y1="70" x2="210" y2="70"/><line x1="10" y1="90" x2="210" y2="90"/><line x1="10" y1="110" x2="210" y2="110"/><line x1="10" y1="130" x2="210" y2="130"/><line x1="10" y1="150" x2="210" y2="150"/></g><line x1="110" y1="10" x2="110" y2="170" stroke="#dc2626" stroke-width="2.5" stroke-dasharray="6,4"/><circle cx="90" cy="50" r="4" fill="#2563eb"/><text x="85" y="46" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">P</text><circle cx="50" cy="90" r="4" fill="#2563eb"/><text x="45" y="86" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">Q</text><circle cx="70" cy="150" r="4" fill="#2563eb"/><text x="65" y="146" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">R</text><text x="110" y="22" font-size="12" font-weight="700" fill="#dc2626" text-anchor="middle">simmetrielyn</text></svg>' },
        { difficulty: 'Medium-Hard', question: "Met dieselfde rooster: punt Q is 3 blokkies vanaf die lyn en punt R is 2 blokkies vanaf die lyn. Sodra die spieëlhelfte met P, Q en R ingeteken is, sal die wydte van die hele vorm meer, minder, of dieselfde wees as net die gegewe (linker) helfte?", checkMode: 'auto', options: ["Minder — refleksie verwyder ’n deel van die oorspronklike wydte.", "Meer — die totale wydte neem toe omdat die spieëlhelfte nuwe blokkies aan die regterkant byvoeg.", "Dieselfde — refleksie verander die wydte glad nie.", "Dit hang af van die hoogte van die vorm, nie van die refleksie nie."], correctIndex: 1, explanation: "Om die gegewe helfte oor die simmetrielyn te reflekteer, voeg ’n heeltemal nuwe spieëlhelfte aan die regterkant by. Dit maak die voltooide vorm wyer as net die oorspronklike helfte — ongeveer dubbel die wydte, aangesien die spieëlhelfte in grootte ooreenstem met die oorspronklike.", diagramSvg: '<svg viewBox="0 0 220 180" xmlns="http://www.w3.org/2000/svg" font-family="Arial, sans-serif"><rect x="10" y="10" width="200" height="160" fill="none" stroke="#9ca3af" stroke-width="1"/><g stroke="#e5e7eb" stroke-width="1"><line x1="30" y1="10" x2="30" y2="170"/><line x1="50" y1="10" x2="50" y2="170"/><line x1="70" y1="10" x2="70" y2="170"/><line x1="90" y1="10" x2="90" y2="170"/><line x1="110" y1="10" x2="110" y2="170"/><line x1="130" y1="10" x2="130" y2="170"/><line x1="150" y1="10" x2="150" y2="170"/><line x1="170" y1="10" x2="170" y2="170"/><line x1="190" y1="10" x2="190" y2="170"/><line x1="10" y1="30" x2="210" y2="30"/><line x1="10" y1="50" x2="210" y2="50"/><line x1="10" y1="70" x2="210" y2="70"/><line x1="10" y1="90" x2="210" y2="90"/><line x1="10" y1="110" x2="210" y2="110"/><line x1="10" y1="130" x2="210" y2="130"/><line x1="10" y1="150" x2="210" y2="150"/></g><line x1="110" y1="10" x2="110" y2="170" stroke="#dc2626" stroke-width="2.5" stroke-dasharray="6,4"/><circle cx="90" cy="50" r="4" fill="#2563eb"/><text x="85" y="46" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">P</text><circle cx="50" cy="90" r="4" fill="#2563eb"/><text x="45" y="86" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">Q</text><circle cx="70" cy="150" r="4" fill="#2563eb"/><text x="65" y="146" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">R</text><text x="110" y="22" font-size="12" font-weight="700" fill="#dc2626" text-anchor="middle">simmetrielyn</text></svg>' },
        { difficulty: 'Medium-Hard', question: "Met dieselfde rooster weer: as die rooi stippellyn eerder van links na regs oor die middel van die rooster getrek was, in plaas van op en af, watter tipe simmetrielyn sou dit wees?", checkMode: 'auto', options: ["Dit sou steeds ’n vertikale simmetrielyn wees.", "Dit sou ’n diagonale simmetrielyn wees.", "Dit sou ’n horisontale simmetrielyn wees.", "Dit sou nie meer ’n geldige simmetrielyn wees nie."], correctIndex: 2, explanation: "’n Lyn wat van links na regs (sy-aan-sy) oor ’n vorm of rooster loop, en dit in ’n boonste en onderste helfte verdeel, word ’n horisontale simmetrielyn genoem — anders as die vertikale lyn hier, wat links en regs verdeel.", diagramSvg: '<svg viewBox="0 0 220 180" xmlns="http://www.w3.org/2000/svg" font-family="Arial, sans-serif"><rect x="10" y="10" width="200" height="160" fill="none" stroke="#9ca3af" stroke-width="1"/><g stroke="#e5e7eb" stroke-width="1"><line x1="30" y1="10" x2="30" y2="170"/><line x1="50" y1="10" x2="50" y2="170"/><line x1="70" y1="10" x2="70" y2="170"/><line x1="90" y1="10" x2="90" y2="170"/><line x1="110" y1="10" x2="110" y2="170"/><line x1="130" y1="10" x2="130" y2="170"/><line x1="150" y1="10" x2="150" y2="170"/><line x1="170" y1="10" x2="170" y2="170"/><line x1="190" y1="10" x2="190" y2="170"/><line x1="10" y1="30" x2="210" y2="30"/><line x1="10" y1="50" x2="210" y2="50"/><line x1="10" y1="70" x2="210" y2="70"/><line x1="10" y1="90" x2="210" y2="90"/><line x1="10" y1="110" x2="210" y2="110"/><line x1="10" y1="130" x2="210" y2="130"/><line x1="10" y1="150" x2="210" y2="150"/></g><line x1="110" y1="10" x2="110" y2="170" stroke="#dc2626" stroke-width="2.5" stroke-dasharray="6,4"/><circle cx="90" cy="50" r="4" fill="#2563eb"/><text x="85" y="46" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">P</text><circle cx="50" cy="90" r="4" fill="#2563eb"/><text x="45" y="86" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">Q</text><circle cx="70" cy="150" r="4" fill="#2563eb"/><text x="65" y="146" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">R</text><text x="110" y="22" font-size="12" font-weight="700" fill="#dc2626" text-anchor="middle">simmetrielyn</text></svg>' },
        { difficulty: 'Hard', question: "’n Stopteken is ’n reëlmatige agthoek en ’n heuningkoekvak is ’n reëlmatige seshoek. Watter stelling kontroleer Sipho se bewering dat hulle dieselfde aantal simmetrielyne het, korrek?", checkMode: 'auto', options: ["Sipho is korrek — albei vorms het 6 simmetrielyne.", "Sipho is korrek — albei vorms het 8 simmetrielyne.", "Sipho is verkeerd — die seshoek het meer simmetrielyne as die agthoek.", "Sipho is verkeerd — die agthoek het 8 simmetrielyne terwyl die seshoek 6 het."], correctIndex: 3, explanation: "Sipho is verkeerd. ’n Reëlmatige agthoek het 8 sye en dus 8 simmetrielyne, terwyl ’n reëlmatige seshoek 6 sye en 6 simmetrielyne het. Hulle is verskillende vorms met verskillende aantal sye, so hulle kan nie dieselfde aantal simmetrielyne hê nie." },
        { difficulty: 'Hard', question: "’n Vlagontwerp gebruik ’n reghoek met ’n kleiner gelyksydige driehoek presies in die middel geplaas, wat reguit opwys. Watter stelling beskryf die gekombineerde ontwerp se simmetrie korrek?", checkMode: 'auto', options: ["Dit het 1 simmetrielyn — die gedeelde vertikale lyn, aangesien die driehoek die reghoek se horisontale simmetrie breek.", "Dit het 2 simmetrielyne, dieselfde as die reghoek alleen.", "Dit het 3 simmetrielyne, dieselfde as die driehoek alleen.", "Dit het 0 simmetrielyne, omdat die kombinasie van twee vorms altyd simmetrie vernietig."], correctIndex: 0, explanation: "’n Reghoek alleen sou 2 simmetrielyne hê (vertikaal en horisontaal), maar om ’n driehoek in die middel by te voeg, breek die horisontale simmetrie tensy die driehoek self ook simmetries is om daardie selfde lyn. As die driehoek gesentreer is en reguit op (of af) wys, werk slegs die gedeelde vertikale lyn nog vir albei vorms, so die gekombineerde ontwerp het net 1 simmetrielyn." },
      ],
      scoreMessages: [
        { minScore: 20, message: 'Uitstekend! Jy het simmetrie in vorms, letters, veelhoeke en roosters baasgeraak.' },
        { minScore: 15, message: 'Goeie werk! Jy verstaan simmetrie goed — gaan enige vrae wat jy verkeerd gehad het weer deur.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      name: 'Stel 3',
      questions: [
        { difficulty: 'Easy', question: "Wat noem ons die vouliyn waarlangs ’n vorm in twee spieëlbeeld-helftes verdeel kan word?", checkMode: 'auto', options: ['Diagonale lyn', 'Rotasie-as', 'Simmetrielyn', 'Omtrek'], correctIndex: 2, explanation: "Hierdie vouliyn, waarlangs die twee helftes presies pas, word die simmetrielyn genoem." },
        { difficulty: 'Easy', question: 'Watter stelling oor die letter B is korrek?', checkMode: 'auto', options: ["B is nie simmetries nie — geen vou laat sy helftes pas nie.", "B is slegs simmetries langs ’n vertikale lyn.", "B is simmetries langs beide ’n vertikale en ’n horisontale lyn.", "B is simmetries — as dit horisontaal (bo na onder) gevou word, pas die twee boggels."], correctIndex: 3, explanation: "Die letter B kan horisontaal (bo na onder) gevou word en die twee boggels pas — dit is simmetries. Dit vou nie links-na-regs bypassend nie, so dit het geen vertikale simmetrielyn nie." },
        { difficulty: 'Easy', question: 'Watter stelling oor simmetrielyne is korrek?', checkMode: 'auto', options: ["’n Vouliyn tel slegs as ’n simmetrielyn as dit albei helftes identies maak wanneer dit gevou word.", "Enige vouliyn deur die middelpunt van ’n vorm is outomaties ’n simmetrielyn.", "’n Vouliyn is ’n simmetrielyn solank die vorm reguit sye het.", "’n Vorm kan slegs ’n simmetrielyn hê as dit ’n reëlmatige veelhoek is."], correctIndex: 0, explanation: "’n Simmetrielyn moet twee helftes oplewer wat presies pas wanneer dit gevou word — dit is die definisie van die voutoets. Om deur die middelpunt te loop of reguit sye te hê, is nie op sy eie genoeg nie." },
        { difficulty: 'Easy', question: 'Watter stelling oor die letter Z is korrek?', checkMode: 'auto', options: ["Z het een vertikale simmetrielyn.", "Z het geen simmetrielyne nie — geen reguit vou laat sy helftes pas nie.", "Z het een horisontale simmetrielyn.", "Z het beide ’n vertikale en ’n horisontale simmetrielyn."], correctIndex: 1, explanation: "Die letter Z kan langs geen reguit lyn gevou word sodat albei helftes pas nie — dit het 0 simmetrielyne." },
        { difficulty: 'Easy', question: "Hoeveel simmetrielyne het ’n ruit (al 4 sye gelyk, geen regte hoeke nie)?", checkMode: 'auto', options: ['4 simmetrielyne', '0 simmetrielyne', '2 simmetrielyne', '1 simmetrielyn'], correctIndex: 2, explanation: "’n Ruit het 2 simmetrielyne — sy twee diagonale. Die vertikale en horisontale voue werk nie omdat sy hoeke nie regte hoeke is nie." },
        { difficulty: 'Easy', question: "Hoeveel simmetrielyne het ’n gelyksydige driehoek (al 3 sye gelyk)?", checkMode: 'auto', options: ['1 simmetrielyn', '2 simmetrielyne', '6 simmetrielyne', '3 simmetrielyne'], correctIndex: 3, explanation: "’n Gelyksydige driehoek het 3 gelyke sye, so dit het 3 simmetrielyne — een vanaf elke hoek na die middelpunt van die teenoorgestelde sy." },
        { difficulty: 'Easy-Medium', question: "Watter een het meer simmetrielyne: ’n gelyksydige driehoek of ’n gelykbenige driehoek?", checkMode: 'auto', options: ["Die gelyksydige driehoek — dit het 3 lyne teenoor die gelykbenige driehoek se 1.", "Die gelykbenige driehoek — dit het proporsioneel meer gelyke sye.", "Hulle het dieselfde aantal simmetrielyne.", "Geeneen van die driehoeke het enige simmetrielyne nie."], correctIndex: 0, explanation: "’n Gelyksydige driehoek het 3 simmetrielyne, terwyl ’n gelykbenige driehoek slegs 1 het — so die gelyksydige driehoek het meer." },
        { difficulty: 'Medium', question: "Hoeveel simmetrielyne het ’n vierkant in vergelyking met ’n ongelyksydige driehoek?", checkMode: 'auto', options: ["Die vierkant het 2, die ongelyksydige driehoek het 1.", "Die vierkant het 4, die ongelyksydige driehoek het 0.", "Hulle het albei 4 simmetrielyne.", "Die vierkant het 0, die ongelyksydige driehoek het 4."], correctIndex: 1, explanation: "’n Vierkant het 4 simmetrielyne. ’n Ongelyksydige driehoek, met al die sye en hoeke verskillend, het 0 simmetrielyne." },
        { difficulty: 'Medium', question: "Bongani sê ’n reghoek (nie ’n vierkant nie) het 4 simmetrielyne, net soos ’n vierkant, omdat albei vorms 4 regte hoeke het. Watter stelling evalueer sy redenasie korrek?", checkMode: 'auto', options: ["Bongani is korrek — om 4 regte hoeke te hê waarborg 4 simmetrielyne.", "Bongani is korrek, maar slegs as die reghoek volgens skaal geteken is.", "Bongani is verkeerd — ’n reghoek wat nie ’n vierkant is nie, het slegs 2 simmetrielyne, omdat sy sye nie almal gelyk is soos ’n vierkant s'n nie.", "Bongani is verkeerd — ’n reghoek het eintlik meer simmetrielyne as ’n vierkant."], correctIndex: 2, explanation: "Bongani is verkeerd. ’n Reghoek wat nie ’n vierkant is nie, het slegs 2 simmetrielyne (vertikaal en horisontaal) — sy diagonale werk nie as simmetrielyne nie omdat sy sye nie almal gelyk is nie, anders as ’n vierkant. Om regte hoeke te hê is nie op sy eie genoeg nie." },
        { difficulty: 'Medium', question: 'Watter stelling oor die letter T is korrek?', checkMode: 'auto', options: ["T het ’n horisontale simmetrielyn maar nie ’n vertikale een nie.", "T het glad geen simmetrielyne nie.", "T het beide ’n vertikale en ’n horisontale simmetrielyn.", "T het ’n vertikale simmetrielyn — as dit deur die middel van sy stam gevou word, pas die helftes."], correctIndex: 3, explanation: "Die letter T vou deur die middel van sy stam, en die linker- en regterhelftes pas." },
        { difficulty: 'Medium', question: 'Watter letter het BEIDE ’n vertikale en ’n horisontale simmetrielyn: X of S?', checkMode: 'auto', options: ["X — dit het beide ’n vertikale en horisontale simmetrielyn, terwyl S geeneen het nie.", "S — dit het beide ’n vertikale en horisontale simmetrielyn, terwyl X geeneen het nie.", "Beide X en S het beide simmetrielyne.", "Geeneen van die letters het enige simmetrielyn nie."], correctIndex: 0, explanation: "Die letter X kan vertikaal en horisontaal gevou word, en in albei gevalle pas die helftes. S het glad geen simmetrielyne nie." },
        { difficulty: 'Medium', question: 'Watter letters in die woord "HAT" het ten minste een simmetrielyn?', checkMode: 'auto', options: ["Slegs H het ’n simmetrielyn.", "H, A en T — al drie letters het ten minste een simmetrielyn.", "Slegs A en T het ’n simmetrielyn, nie H nie.", "Geeneen van die letters in HAT het ’n simmetrielyn nie."], correctIndex: 1, explanation: "H het beide vertikale en horisontale simmetrie, A het ’n vertikale simmetrielyn, en T het ook ’n vertikale simmetrielyn. Elke letter in HAT het ten minste een simmetrielyn." },
        { difficulty: 'Medium', question: "’n Reëlmatige veelhoek het 9 gelyke sye (’n reëlmatige negehoek). Hoeveel simmetrielyne het dit?", checkMode: 'auto', options: ['3 simmetrielyne', '18 simmetrielyne', '9 simmetrielyne', '0 simmetrielyne'], correctIndex: 2, explanation: "’n Reëlmatige veelhoek het dieselfde aantal simmetrielyne as wat dit sye het. ’n Reëlmatige negehoek het 9 sye, so dit het 9 simmetrielyne." },
        { difficulty: 'Medium', question: "’n Reëlmatige veelhoek het 12 gelyke sye (’n reëlmatige twaalfhoek). Hoeveel simmetrielyne het dit?", checkMode: 'auto', options: ['6 simmetrielyne', '24 simmetrielyne', '1 simmetrielyn', '12 simmetrielyne'], correctIndex: 3, explanation: "Vir enige reëlmatige veelhoek is die aantal simmetrielyne gelyk aan die aantal sye — 12 sye gee 12 simmetrielyne." },
        { difficulty: 'Medium', question: "Watter verduideliking regverdig korrek hoekom die verdubbeling van die aantal sye van ’n reëlmatige veelhoek (byvoorbeeld, van ’n seshoek na ’n 12-sydige vorm), ook sy aantal simmetrielyne verdubbel?", checkMode: 'auto', options: ["Omdat elke sy altyd presies een bypassende simmetrielyn bydra in ’n reëlmatige veelhoek.", "Omdat die verdubbeling van die sye altyd die grootte van die vorm verdubbel, wat ook die lyne verdubbel.", "Omdat simmetrielyne slegs afhang van die aantal regte hoeke, nie die aantal sye nie.", "Omdat ’n 12-sydige vorm altyd 4 keer soveel simmetrielyne het as ’n seshoek."], correctIndex: 0, explanation: "In ’n reëlmatige veelhoek is die aantal simmetrielyne altyd gelyk aan die aantal sye — elke sy (of hoek) dra presies een lyn by. So as die aantal sye van 6 na 12 verdubbel, verdubbel die aantal simmetrielyne ook, van 6 na 12." },
        { difficulty: 'Medium-Hard', question: "Die rooster wys ’n vertikale rooi stippellyn as simmetrielyn met punte X, Y en Z slegs aan die linkerkant gemerk. Punt X is 3 blokkies vanaf die lyn. Hoe ver vanaf die lyn behoort sy spieëlpunt te wees, en aan watter kant?", checkMode: 'auto', options: ["3 blokkies vanaf die lyn, aan die linkerkant.", "3 blokkies vanaf die lyn, aan die regterkant.", "6 blokkies vanaf die lyn, aan die regterkant.", "Dit het geen spieëlpunt nie, want X is die verste gemerkte punt vanaf die lyn."], correctIndex: 1, explanation: "’n Spieëlpunt sit dieselfde afstand vanaf die simmetrielyn as die oorspronklike punt, net aan die teenoorgestelde kant. Aangesien X 3 blokkies links van die lyn is, is sy spieëlpunt X′ 3 blokkies na regs.", diagramSvg: '<svg viewBox="0 0 220 180" xmlns="http://www.w3.org/2000/svg" font-family="Arial, sans-serif"><rect x="10" y="10" width="200" height="160" fill="none" stroke="#9ca3af" stroke-width="1"/><g stroke="#e5e7eb" stroke-width="1"><line x1="30" y1="10" x2="30" y2="170"/><line x1="50" y1="10" x2="50" y2="170"/><line x1="70" y1="10" x2="70" y2="170"/><line x1="90" y1="10" x2="90" y2="170"/><line x1="110" y1="10" x2="110" y2="170"/><line x1="130" y1="10" x2="130" y2="170"/><line x1="150" y1="10" x2="150" y2="170"/><line x1="170" y1="10" x2="170" y2="170"/><line x1="190" y1="10" x2="190" y2="170"/><line x1="10" y1="30" x2="210" y2="30"/><line x1="10" y1="50" x2="210" y2="50"/><line x1="10" y1="70" x2="210" y2="70"/><line x1="10" y1="90" x2="210" y2="90"/><line x1="10" y1="110" x2="210" y2="110"/><line x1="10" y1="130" x2="210" y2="130"/><line x1="10" y1="150" x2="210" y2="150"/></g><line x1="110" y1="10" x2="110" y2="170" stroke="#dc2626" stroke-width="2.5" stroke-dasharray="6,4"/><circle cx="50" cy="50" r="4" fill="#2563eb"/><text x="45" y="46" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">X</text><circle cx="70" cy="100" r="4" fill="#2563eb"/><text x="65" y="96" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">Y</text><circle cx="90" cy="150" r="4" fill="#2563eb"/><text x="85" y="146" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">Z</text><text x="110" y="22" font-size="12" font-weight="700" fill="#dc2626" text-anchor="middle">simmetrielyn</text></svg>' },
        { difficulty: 'Medium-Hard', question: "Met dieselfde rooster: punt Y is 2 blokkies vanaf die lyn en punt Z is 1 blokkie vanaf die lyn. Verander dit hoe hoog of laag Y en Z is, in vergelyking met hul oorspronklike hoogtes, as jy hulle oor die lyn reflekteer?", checkMode: 'auto', options: ["Ja, albei punte beweeg hoër na refleksie.", "Ja, albei punte beweeg laer na refleksie.", "Nee — elke spieëlpunt bly op presies dieselfde hoogte as sy oorspronklike punt.", "Dit hang af van hoe ver elke punt vanaf die lyn is."], correctIndex: 2, explanation: "’n Vertikale simmetrielyn reflekteer punte slegs van links na regs — dit verander nooit hoe hoog of laag ’n punt is nie. So die spieëlpunte vir Y en Z bly op presies dieselfde hoogtes as Y en Z self.", diagramSvg: '<svg viewBox="0 0 220 180" xmlns="http://www.w3.org/2000/svg" font-family="Arial, sans-serif"><rect x="10" y="10" width="200" height="160" fill="none" stroke="#9ca3af" stroke-width="1"/><g stroke="#e5e7eb" stroke-width="1"><line x1="30" y1="10" x2="30" y2="170"/><line x1="50" y1="10" x2="50" y2="170"/><line x1="70" y1="10" x2="70" y2="170"/><line x1="90" y1="10" x2="90" y2="170"/><line x1="110" y1="10" x2="110" y2="170"/><line x1="130" y1="10" x2="130" y2="170"/><line x1="150" y1="10" x2="150" y2="170"/><line x1="170" y1="10" x2="170" y2="170"/><line x1="190" y1="10" x2="190" y2="170"/><line x1="10" y1="30" x2="210" y2="30"/><line x1="10" y1="50" x2="210" y2="50"/><line x1="10" y1="70" x2="210" y2="70"/><line x1="10" y1="90" x2="210" y2="90"/><line x1="10" y1="110" x2="210" y2="110"/><line x1="10" y1="130" x2="210" y2="130"/><line x1="10" y1="150" x2="210" y2="150"/></g><line x1="110" y1="10" x2="110" y2="170" stroke="#dc2626" stroke-width="2.5" stroke-dasharray="6,4"/><circle cx="50" cy="50" r="4" fill="#2563eb"/><text x="45" y="46" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">X</text><circle cx="70" cy="100" r="4" fill="#2563eb"/><text x="65" y="96" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">Y</text><circle cx="90" cy="150" r="4" fill="#2563eb"/><text x="85" y="146" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">Z</text><text x="110" y="22" font-size="12" font-weight="700" fill="#dc2626" text-anchor="middle">simmetrielyn</text></svg>' },
        { difficulty: 'Medium-Hard', question: "Met dieselfde rooster weer: as jy kyk na waar punte X, Y en Z gemerk is, is die simmetrielyn vertikaal of horisontaal, en hoe kan jy dit net sien aan die manier waarop die rooi stippellyn geteken is?", checkMode: 'auto', options: ["Horisontaal — die lyn verdeel die rooster in ’n boonste en onderste helfte.", "Diagonaal — die lyn loop hoek tot hoek.", "Dit kan nie bepaal word sonder om die afstande van X, Y en Z te meet nie.", "Vertikaal — die rooi stippellyn loop reguit op en af, nie sy-aan-sy nie."], correctIndex: 3, explanation: "Die rooi stippellyn loop van die bokant van die rooster na die onderkant, en verdeel dit in ’n linkerkant en ’n regterkant — daardie op-en-af-rigting is wat dit ’n vertikale simmetrielyn maak, eerder as ’n horisontale een wat sy-aan-sy sou loop.", diagramSvg: '<svg viewBox="0 0 220 180" xmlns="http://www.w3.org/2000/svg" font-family="Arial, sans-serif"><rect x="10" y="10" width="200" height="160" fill="none" stroke="#9ca3af" stroke-width="1"/><g stroke="#e5e7eb" stroke-width="1"><line x1="30" y1="10" x2="30" y2="170"/><line x1="50" y1="10" x2="50" y2="170"/><line x1="70" y1="10" x2="70" y2="170"/><line x1="90" y1="10" x2="90" y2="170"/><line x1="110" y1="10" x2="110" y2="170"/><line x1="130" y1="10" x2="130" y2="170"/><line x1="150" y1="10" x2="150" y2="170"/><line x1="170" y1="10" x2="170" y2="170"/><line x1="190" y1="10" x2="190" y2="170"/><line x1="10" y1="30" x2="210" y2="30"/><line x1="10" y1="50" x2="210" y2="50"/><line x1="10" y1="70" x2="210" y2="70"/><line x1="10" y1="90" x2="210" y2="90"/><line x1="10" y1="110" x2="210" y2="110"/><line x1="10" y1="130" x2="210" y2="130"/><line x1="10" y1="150" x2="210" y2="150"/></g><line x1="110" y1="10" x2="110" y2="170" stroke="#dc2626" stroke-width="2.5" stroke-dasharray="6,4"/><circle cx="50" cy="50" r="4" fill="#2563eb"/><text x="45" y="46" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">X</text><circle cx="70" cy="100" r="4" fill="#2563eb"/><text x="65" y="96" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">Y</text><circle cx="90" cy="150" r="4" fill="#2563eb"/><text x="85" y="146" font-size="14" font-weight="700" fill="#2563eb" text-anchor="end">Z</text><text x="110" y="22" font-size="12" font-weight="700" fill="#dc2626" text-anchor="middle">simmetrielyn</text></svg>' },
        { difficulty: 'Hard', question: "’n Padteken is in die vorm van ’n reëlmatige agthoek (’n stopteken) en ’n ander is in die vorm van ’n gelyksydige driehoek (’n toegeeteken). Watter stelling vergelyk hul simmetrie korrek?", checkMode: 'auto', options: ["Die agthoek het meer simmetrielyne (8 teenoor 3), maar dit maak dit nie in elke sin ’n vorm wat 'meer simmetries' is nie — albei vorms is volledig simmetries, die agthoek het net meer sye en dus meer voue wat werk.", "Die driehoek het meer simmetrielyne omdat dit ’n eenvoudiger vorm is.", "Albei vorms het presies dieselfde aantal simmetrielyne.", "Geeneen van die vorms is werklik simmetries nie, omdat padtekens nie reëlmatige veelhoeke is nie."], correctIndex: 0, explanation: "Die agthoek (stopteken) het 8 simmetrielyne, terwyl die gelyksydige driehoek (toegeeteken) 3 het. Die agthoek het meer moontlike vouliyne wat werk, maar albei vorms is ewe 'simmetries' in die sin dat elke vou langs een van hul simmetrielyne twee bypassende helftes oplewer — die een is nie perfekter simmetries as die ander nie, dit het bloot meer lyne omdat dit meer sye het." },
        { difficulty: 'Hard', question: "Thabo sê ’n bynes-heuningkoek (gemaak van reëlmatige seshoeke) en ’n sokkerbalpatroon (gedeeltelik gemaak van reëlmatige vyfhoeke en seshoeke) moet presies dieselfde simmetrie hê omdat albei ’n 'natuur-geïnspireerde' ontwerp is. Watter stelling evalueer Thabo se bewering korrek?", checkMode: 'auto', options: ["Thabo is korrek — alle natuur-geïnspireerde vorms deel outomaties dieselfde simmetrie.", "Thabo is verkeerd — ’n reëlmatige seshoek het 6 simmetrielyne terwyl ’n reëlmatige vyfhoek slegs 5 het, so die vorms in elke patroon het verskillende simmetrie.", "Thabo is korrek — beide seshoeke en vyfhoeke het altyd 5 simmetrielyne.", "Thabo is verkeerd — geeneen van seshoeke of vyfhoeke het enige simmetrielyne nie."], correctIndex: 1, explanation: "Thabo is verkeerd om aan te neem dat die twee ontwerpe dieselfde simmetrie deel net omdat albei van natuur-geïnspireerde vorms kom. ’n Heuningkoek se seshoeke het elk 6 simmetrielyne, maar die vyfhoeke wat in ’n sokkerbalpatroon gebruik word, het elk slegs 5 simmetrielyne — verskillende reëlmatige veelhoeke het verskillende hoeveelhede simmetrie, afhangende van hul aantal sye." },
      ],
      scoreMessages: [
        { minScore: 20, message: 'Uitstekend! Jy het simmetrie in vorms, letters, veelhoeke en roosters baasgeraak.' },
        { minScore: 15, message: 'Goeie werk! Jy verstaan simmetrie goed — gaan enige vrae wat jy verkeerd gehad het weer deur.' },
