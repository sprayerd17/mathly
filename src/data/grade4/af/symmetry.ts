  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: "Hoeveel simmetrielyne het ’n sirkel?", answer: 'Oneindig', checkMode: 'auto', correctAnswer: 'oneindig', correctAnswers: ['oneindig', 'oneindiglyne', 'onbeperk', 'eindeloos', 'oneindigvellyne'], explanation: 'Elke middellyn van ’n sirkel is ’n simmetrielyn, so ’n sirkel het oneindig baie simmetrielyne.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: "’n Reëlmatige veelhoek het 6 gelyke sye (’n reëlmatige seshoek). Hoeveel simmetrielyne het dit?", answer: '6', checkMode: 'auto', correctAnswer: '6', correctAnswers: ['6', 'ses', '6 lyne'], explanation: "’n Reëlmatige seshoek het 6 gelyke sye, so dit het 6 simmetrielyne." },
