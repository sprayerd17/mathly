  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'Verbeel jou die skoenboks lê plat met sy lang kant na jou toe. ʼn Prentjie is net op een van sy kort punte gedruk. Vanuit watter twee aansigte sou jy moontlik daardie prentjie kon sien: voor en bo, of voor en een kant?', answer: 'Voor en een kant', checkMode: 'self', explanation: 'Die kort punt kan as óf die "voorkant" óf ʼn "sykant" bekyk word, afhangende van hoe die boks gedraai is, maar die bo-aansig sou net die plat deksel wys, nie die gedrukte punt nie.' },
