  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'Met dieselfde huisprentjie (1 driehoekdak op 1 vierkantmuur), noem die basiese vorms wat gebruik is om dit te bou.', answer: 'Die huis is gemaak van 1 driehoek (die dak) en 1 vierkant (die mure).', checkMode: 'self', diagramSvg: '<svg viewBox="0 0 220 170" xmlns="http://www.w3.org/2000/svg"><rect x="75" y="85" width="70" height="70" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><polygon points="110,40 75,85 145,85" fill="none" stroke="#0f1f3d" stroke-width="2.5"/></svg>' },
