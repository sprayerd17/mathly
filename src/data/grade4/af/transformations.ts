  ...
  topicPractice: [
...

    {
      ...
      correctAnswers: [
        ...
        // Afrikaans — with "en", all 6 orderings
        'translasie, refleksie en rotasie',
        'translasie, rotasie en refleksie',
        'refleksie, translasie en rotasie',
        'refleksie, rotasie en translasie',
        'rotasie, translasie en refleksie',
        'rotasie, refleksie en translasie',
        // Afrikaans — without "en", all 6 orderings
        'translasie, refleksie, rotasie',
        'translasie, rotasie, refleksie',
        'refleksie, translasie, rotasie',
        'refleksie, rotasie, translasie',
        'rotasie, translasie, refleksie',
        'rotasie, refleksie, translasie',
      ],
      explanation:
      ...
      parts: [
        {
          ...
          correctAnswers: ['Reflection', 'reflection', 'Refleksie', 'refleksie'],
        ...
        },
        {
          ...
          correctAnswers: ['Translation', 'translation', 'Translasie', 'translasie'],
        ...
        },
        {
          ...
          correctAnswers: ['Rotation', 'rotation', 'Rotasie', 'rotasie'],
      ...
      parts: [
        {
          ...
          correctAnswer: 'size',
          correctAnswers: ['size', 'Size', 'the size', 'grootte', 'Grootte', 'die grootte'],
        ...
        },
        {
          ...
          correctAnswer: 'shape',
          correctAnswers: ['shape', 'Shape', 'the shape', 'vorm', 'Vorm', 'die vorm'],
...

    {
      ...
      answer: 'Translasie',
      correctAnswer: 'Translation',
      correctAnswers: ['Translation', 'translation', 'a translation', 'Translasie', 'translasie', "'n translasie"],
      ...
      parts: [
        {
          ...
          correctAnswer: '3',
          correctAnswers: ['3', 'three', '3 units', '3units', 'drie', '3 eenhede', '3eenhede'],
        ...
        },
        {
          ...
          correctAnswer: '2',
          correctAnswers: ['2', 'two', '2 units', '2units', 'twee', '2 eenhede', '2eenhede'],
        ...
        },
        {
          ...
          correctAnswer: 'No',
          correctAnswers: ['No', 'no', 'No it does not', 'no it does not', 'neitherchanges', 'neither', 'Nee', 'nee'],
      ...
      parts: [
        {
          ...
          correctAnswer: 'Left',
          correctAnswers: ['Left', 'left', 'to the left', 'Links', 'links', 'na links'],
        ...
        },
        {
          ...
          correctAnswer: 'Down',
          correctAnswers: ['Down', 'down', 'downward', 'downwards', 'Af', 'af', 'na onder', 'ondertoe'],
        ...
        },
        {
          ...
          correctAnswers: [
            ...
            '1 unit',
            '1unit',
            '1 eenheid vanaf die linkerrand',
            '1eenheidvandielinkerrand',
            '1 eenheid',
            '1eenheid',
          ],
...

    {
      ...
      answer: 'Refleksie',
      correctAnswer: 'Reflection',
      correctAnswers: ['Reflection', 'reflection', 'a reflection', 'Refleksie', 'refleksie', "'n refleksie"],
      ...
      parts: [
        {
          ...
          correctAnswer: '4',
          correctAnswers: ['4', 'four', '4 blocks', '4blocks', 'vier', '4 blokke', '4blokke'],
        ...
        },
        {
          ...
          correctAnswer: 'No',
          correctAnswers: ['No', 'no', 'no it does not', 'noidoesnot', 'Nee', 'nee'],
      ...
      parts: [
        {
          ...
          correctAnswers: [
            ...
            'onder die lyn', 'onderdielyn',
            'onder', 'onder die spieëllyn', 'onderdiespieëllyn',
          ],
        ...
        },
        {
          ...
          correctAnswers: [
            ...
            '5blocksbelow',
            '5',
            '5 blokke onder die spieëllyn',
            '5blokkeonderdiespieëllyn',
            '5 blokke onder',
            '5blokkeonder',
          ],
...

    {
      ...
      answer: 'Rotasie',
      correctAnswer: 'Rotation',
      correctAnswers: ['Rotation', 'rotation', 'a rotation', 'Rotasie', 'rotasie', "'n rotasie"],
      ...
      parts: [
        {
          ...
          correctAnswer: '90',
          correctAnswers: ['90', '90 degrees', '90degrees', '90°', 'ninety', '90 grade', '90grade'],
        ...
        },
        {
          ...
          correctAnswers: ['Clockwise', 'clockwise', 'Kloksgewys', 'kloksgewys'],
      ...
      parts: [
        {
          ...
          correctAnswer: '180',
          correctAnswers: ['180', '180 degrees', '180degrees', '180°', 'one hundred and eighty', '180 grade', '180grade'],
