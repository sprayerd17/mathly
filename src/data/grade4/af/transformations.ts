  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'ʼn Saamgestelde vorm het 3 identiese driehoeke aan die bo-, linker- en regterkant van ʼn sentrale vierkant vasgemaak, maar geen driehoek aan die onderkant nie. Is hierdie saamgestelde vorm simmetries langs ʼn vertikale lyn deur die middel? Skryf ja of nee.', answer: 'Ja', checkMode: 'auto', correctAnswer: 'Ja', correctAnswers: ['Ja', 'ja', 'Yes', 'yes'], explanation: 'Die linker- en regterdriehoeke spieël mekaar, en die boonste driehoek spieël homself oor die vertikale middellyn, so dit is steeds simmetries langs hierdie lyn ✓', diagramSvg: '<svg viewBox="0 0 220 170" xmlns="http://www.w3.org/2000/svg"><rect x="75" y="80" width="70" height="70" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><polygon points="110,35 85,80 135,80" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><polygon points="75,80 40,95 75,110" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><polygon points="145,80 180,95 145,110" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="110" y1="20" x2="110" y2="165" stroke="#dc2626" stroke-width="2" stroke-dasharray="5,4"/><line x1="25" y1="115" x2="195" y2="115" stroke="#ea580c" stroke-width="2" stroke-dasharray="5,4"/></svg>' },
        { difficulty: 'Medium', question: 'Met dieselfde vorm as voorheen (3 identiese driehoeke bo, links en regs van ʼn sentrale vierkant, geen onder nie), is hierdie saamgestelde vorm simmetries langs ʼn horisontale lyn deur die middel? Skryf ja of nee.', answer: 'Nee', checkMode: 'auto', correctAnswer: 'Nee', correctAnswers: ['Nee', 'nee', 'No', 'no'], explanation: 'Die boonste driehoek het geen passende driehoek aan die onderkant nie, so ʼn vou langs ʼn horisontale middellyn laat nie albei helftes ooreenstem nie ✓', diagramSvg: '<svg viewBox="0 0 220 170" xmlns="http://www.w3.org/2000/svg"><rect x="75" y="80" width="70" height="70" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><polygon points="110,35 85,80 135,80" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><polygon points="75,80 40,95 75,110" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><polygon points="145,80 180,95 145,110" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="110" y1="20" x2="110" y2="165" stroke="#dc2626" stroke-width="2" stroke-dasharray="5,4"/><line x1="25" y1="115" x2="195" y2="115" stroke="#ea580c" stroke-width="2" stroke-dasharray="5,4"/></svg>' },
        ...
        { difficulty: 'Medium', question: 'ʼn Saamgestelde vorm is gemaak van ʼn reghoek met 1 driehoek aan die boonste rand vasgemaak, maar die driehoek is nader aan die linkerkant as die regterkant geposisioneer. Is hierdie saamgestelde vorm simmetries langs ʼn vertikale lyn deur die middel van die reghoek? Skryf ja of nee.', answer: 'Nee', checkMode: 'auto', correctAnswer: 'Nee', correctAnswers: ['Nee', 'nee', 'No', 'no'], explanation: 'Aangesien die driehoek nie in die middel is nie, sal ʼn vou in die middel van die reghoek nie albei helftes laat ooreenstem nie ✓', diagramSvg: '<svg viewBox="0 0 220 170" xmlns="http://www.w3.org/2000/svg"><rect x="55" y="85" width="110" height="55" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><polygon points="80,40 60,85 100,85" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><line x1="110" y1="35" x2="110" y2="150" stroke="#dc2626" stroke-width="2" stroke-dasharray="5,4"/></svg>' },
        ...
        { difficulty: 'Hard', question: 'ʼn Saamgestelde vorm het 6 identiese klein driehoeke eweredig en simmetries rondom ʼn sentrale reëlmatige seshoek gerangskik, soos die blomblare van ʼn blom. Het hierdie saamgestelde vorm meer as een simmetrielyn? Skryf ja of nee.', answer: 'Ja', checkMode: 'auto', correctAnswer: 'Ja', correctAnswers: ['Ja', 'ja', 'Yes', 'yes'], explanation: 'Omdat die seshoek en die 6 eweredig-geplaasde driehoeke met gelyke spasiëring rondom die middel gerangskik is, is daar verskeie verskillende lyne deur die middel wat albei helftes laat ooreenstem ✓', diagramSvg: '<svg viewBox="0 0 220 190" xmlns="http://www.w3.org/2000/svg"><polygon points="110,65 135,80 135,110 110,125 85,110 85,80" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><polygon points="110,65 96,32 124,32" fill="none" stroke="#0f1f3d" stroke-width="2"/><polygon points="110,125 96,158 124,158" fill="none" stroke="#0f1f3d" stroke-width="2"/><polygon points="85,80 51,66 51,94" fill="none" stroke="#0f1f3d" stroke-width="2"/><polygon points="85,110 51,96 51,124" fill="none" stroke="#0f1f3d" stroke-width="2"/><polygon points="135,80 169,66 169,94" fill="none" stroke="#0f1f3d" stroke-width="2"/><polygon points="135,110 169,96 169,124" fill="none" stroke="#0f1f3d" stroke-width="2"/></svg>' },
        { difficulty: 'Hard', question: 'ʼn Saamgestelde vorm is gebou van 1 vierkant met 2 identiese driehoeke, een bo-op en een onder vasgemaak, albei gesentreer. Is hierdie vorm simmetries langs ʼn horisontale lyn deur die middel van die vierkant? Skryf ja of nee.', answer: 'Ja', checkMode: 'auto', correctAnswer: 'Ja', correctAnswers: ['Ja', 'ja', 'Yes', 'yes'], explanation: 'Die bo- en onderdriehoeke is identies en gesentreer, so ʼn vou langs ʼn horisontale middellyn laat hulle presies ooreenstem ✓', diagramSvg: '<svg viewBox="0 0 220 190" xmlns="http://www.w3.org/2000/svg"><rect x="75" y="65" width="70" height="70" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><polygon points="110,20 85,65 135,65" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><polygon points="110,180 85,135 135,135" fill="none" stroke="#0f1f3d" stroke-width="2.5"/></svg>' },
        { difficulty: 'Hard', question: 'Met dieselfde vorm as voorheen (ʼn vierkant met 1 identiese gesentreerde driehoek bo-op en 1 identiese gesentreerde driehoek onder), is dit ook simmetries langs ʼn vertikale lyn deur die middel? Skryf ja of nee.', answer: 'Ja', checkMode: 'auto', correctAnswer: 'Ja', correctAnswers: ['Ja', 'ja', 'Yes', 'yes'], explanation: 'Aangesien albei driehoeke presies op die vierkant gesentreer is, is hulle ook simmetries om die vertikale lyn, so hierdie vorm het twee simmetrielyne ✓', diagramSvg: '<svg viewBox="0 0 220 190" xmlns="http://www.w3.org/2000/svg"><rect x="75" y="65" width="70" height="70" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><polygon points="110,20 85,65 135,65" fill="none" stroke="#0f1f3d" stroke-width="2.5"/><polygon points="110,180 85,135 135,135" fill="none" stroke="#0f1f3d" stroke-width="2.5"/></svg>' },
