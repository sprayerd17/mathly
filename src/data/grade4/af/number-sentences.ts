  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'Thabo beweer dat in die getallesin □ + 8 = 20, die ontbrekende waarde 12 moet wees. Is hy korrek? Verduidelik jou redenasie.', answer: 'Ja, Thabo is korrek. Aangesien 8 by die ontbrekende waarde getel word, moet jy die inverse bewerking — aftrekking — gebruik om die optelling ongedaan te maak: 20 − 8 = 12, dus □ = 12. Deur terug te vervang om te kontroleer: 12 + 8 = 20, wat ooreenstem met die regterkant, wat bevestig dat Thabo se bewering korrek is.', checkMode: 'self' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Hard', question: 'Nomvula en Kagiso kry elkeen ʼn ander oop getallesin om op te los: Nomvula het □ − 18 = 25 en Kagiso het □ − 18 = 32. Kagiso kyk na Nomvula se werk en kopieer haar antwoord van □ = 43 vir sy eie sin. Verduidelik waarom dit ʼn fout is, en vind die korrekte ontbrekende waarde vir Kagiso se sin.', answer: 'Dit is ʼn fout omdat Kagiso se getallesin nie dieselfde is as Nomvula s\'n nie — die regterkant is anders (32 in plaas van 25), so dit benodig sy eie ontbrekende waarde; om ʼn antwoord van ʼn ander sin te kopieer maak nie sy sin waar nie. Om Kagiso se korrekte antwoord te vind, gebruik die inverse bewerking op sy eie sin: 32 + 18 = 50, so □ = 50 vir Kagiso. (Kontroleer: 50 − 18 = 32 ✓, terwyl 43 − 18 = 25, wat slegs Nomvula se sin bevredig, nie Kagiso s\'n nie.)', checkMode: 'self' },
      ],
      scoreMessages: [
        { minScore: 20, message: 'Uitstekend! Jy het die vind van en redenering oor ontbrekende waardes in getallesinne baasgeraak.' },
        { minScore: 15, message: 'Goeie werk! Gaan enige vrae wat jy verkeerd gehad het weer deur en probeer weer.' },
