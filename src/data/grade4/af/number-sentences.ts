...
<p style="margin-bottom:12px;font-weight:600;">Hoe om die ontbrekende waarde te vind — gebruik omgekeerde bewerkings:</p>
...
<div style="background:#f0fdf4;border:1.5px solid #86efac;border-radius:10px;padding:14px 18px;">
  ...
  <div style="color:#374151;font-size:14px;">Nadat jy die ontbrekende waarde gevind het, vervang dit terug in die oorspronklike getallesin om seker te maak dit is waar. As albei kante gelyk is, is jou antwoord korrek.</div>
      ...
      videoPlaceholder: 'Kort video wat wys hoe om ontbrekende waardes in oop getallesinne te vind deur omgekeerde bewerkings te gebruik',
      ...
      workedExamples: [
        {
          ...
          answer: '□ = 7',
          steps: [
            `Identifiseer die bewerking: <span style="color:#1e40af;font-weight:700;">6</span> word <span style="color:#dc2626;font-weight:700;">bygetel</span> by die ontbrekende waarde. Gebruik die omgekeerde — <span style="color:#dc2626;font-weight:700;">aftrekking</span>.`,
        ...
        },
        {
          ...
          answer: '□ = 6',
          steps: [
            `Identifiseer die bewerking: ons <span style="color:#dc2626;font-weight:700;">deel</span> 24 deur die ontbrekende waarde. Gebruik die omgekeerde — <span style="color:#dc2626;font-weight:700;">vermenigvuldiging</span>.`,
        ...
        },
        {
          ...
          answer: '□ = 8',
          steps: [
            `Identifiseer die bewerking: die ontbrekende waarde word <span style="color:#dc2626;font-weight:700;">vermenigvuldig</span> met 7. Gebruik die omgekeerde — <span style="color:#dc2626;font-weight:700;">deling</span>.`,
...
<div style="display:flex;flex-direction:column;gap:8px;margin-bottom:22px;">
  ...
  <div style="background:white;border:1px solid #bfdbfe;border-radius:10px;padding:12px 16px;display:flex;align-items:flex-start;gap:12px;">
    ...
    <div><strong>Los op</strong> met behulp van ʼn omgekeerde bewerking om die ontbrekende waarde te vind.</div>
  </div>
  <div style="background:white;border:1px solid #bfdbfe;border-radius:10px;padding:12px 16px;display:flex;align-items:flex-start;gap:12px;">
      ...
      workedExamples: [
        {
          ...
          steps: [
            ...
            `Gebruik die omgekeerde bewerking: <span style="color:#1e40af;font-weight:700;">45</span> <span style="color:#dc2626;font-weight:700;">−</span> <span style="color:#1e40af;font-weight:700;">28</span> = <span style="color:#ea580c;font-weight:700;font-size:18px;">17</span>`,
        ...
        },
        {
          ...
          steps: [
            ...
            `Gebruik die omgekeerde bewerking: <span style="color:#1e40af;font-weight:700;">31</span> <span style="color:#dc2626;font-weight:700;">−</span> <span style="color:#1e40af;font-weight:700;">14</span> = <span style="color:#ea580c;font-weight:700;font-size:18px;">17</span>`,
  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'Vind die ontbrekende waarde. Skryf slegs die getal.\n\n□ − 15 = 27', answer: '42', checkMode: 'auto', correctAnswer: '42', explanation: 'Gebruik die omgekeerde — optelling: 27 + 15 = 42.\n□ = 42\nKontroleer: 42 − 15 = 27 ✓' },
        { difficulty: 'Easy', question: 'Vind die ontbrekende waarde. Skryf slegs die getal.\n\n22 − □ = 13', answer: '9', checkMode: 'auto', correctAnswer: '9', explanation: 'Gebruik die omgekeerde — aftrekking: 22 − 13 = 9.\n□ = 9\nKontroleer: 22 − 9 = 13 ✓' },
        { difficulty: 'Easy', question: 'Vind die ontbrekende waarde. Skryf slegs die getal.\n\n□ × 7 = 63', answer: '9', checkMode: 'auto', correctAnswer: '9', explanation: 'Gebruik die omgekeerde — deling: 63 ÷ 7 = 9.\n□ = 9\nKontroleer: 9 × 7 = 63 ✓' },
        { difficulty: 'Easy', question: 'Vind die ontbrekende waarde. Skryf slegs die getal.\n\n48 ÷ □ = 8', answer: '6', checkMode: 'auto', correctAnswer: '6', explanation: 'Gebruik die omgekeerde — vermenigvuldiging: 8 × 6 = 48.\n□ = 6\nKontroleer: 48 ÷ 6 = 8 ✓' },
        { difficulty: 'Easy', question: 'Vind die ontbrekende waarde. Skryf slegs die getal.\n\n□ + 56 = 100', answer: '44', checkMode: 'auto', correctAnswer: '44', explanation: 'Gebruik die omgekeerde — aftrekking: 100 − 56 = 44.\n□ = 44\nKontroleer: 44 + 56 = 100 ✓' },
        ...
        { difficulty: 'Medium', question: 'ʼn Leerder sê dat jy 6 by 13 moet optel om die ontbrekende waarde in □ + 6 = 13 te vind. Is die leerder korrek? Verduidelik jou redenasie.', answer: 'Nee, die leerder is nie korrek nie. Aangesien 6 by die ontbrekende waarde bygetel word, moet jy die omgekeerde bewerking — aftrekking — gebruik om die optelling ongedaan te maak. Jy moet aftrek: 13 − 6 = 7, dus □ = 7. Om 6 by 13 te tel sou eerder die verkeerde antwoord (19) gee, wat nie die oorspronklike getallesin waar maak nie.', checkMode: 'self' },
        { difficulty: 'Medium', question: 'Sipho los die getallesin □ × 4 = 36 op en kry □ = 9. Verduidelik hoe hy kan kontroleer of sy antwoord korrek is, en wys die kontrole.', answer: 'Sipho kan sy antwoord kontroleer deur sy waarde terug in die oorspronklike getallesin te vervang. Hy vervang □ met 9: 9 × 4 = 36. Aangesien die linkerkant (36) gelyk is aan die regterkant (36), is die getallesin waar, so sy antwoord van □ = 9 is korrek.', checkMode: 'self' },
        { difficulty: 'Medium', question: 'ʼn Klasmaat sê dat 8 × 6 = 42 ʼn ware getallesin is "omdat 42 min of meer reg klink vir 8 keer 6." Stem jy saam met hierdie redenasie? Verduidelik wat verkeerd is daarmee en gee die korrekte antwoord.', answer: 'Nee, ek stem nie saam nie. Jy kan nie besluit of ʼn getallesin waar is net omdat ʼn getal "min of meer reg klink" nie — jy moet werklik die linkerkant bereken en dit met die regterkant vergelyk. 8 × 6 = 48, nie 42 nie. Aangesien 48 ≠ 42, is die getallesin 8 × 6 = 42 onwaar. Die korrekte berekening wys die fout — bereken altyd noukeurig eerder as om te raai op grond van ʼn vae indruk van hoe groot die antwoord moet wees.', checkMode: 'self' },

        // Blok 4 — Woordprobleme: omskakel en oplos, een stap (Medium) — posisies 12-16
        { difficulty: 'Medium', question: 'Thabo het 34 plakkers. Hy koop nog 19. Skryf ʼn getallesin en los dit op om te vind hoeveel plakkers hy altesaam het.\n\nSkryf slegs die totale getal.', answer: '53', checkMode: 'auto', correctAnswer: '53', explanation: 'Getallesin: 34 + 19 = □\n34 + 19 = 53\nThabo het altesaam 53 plakkers ✓' },
        { difficulty: 'Medium', question: 'ʼn Netbalspan behaal 45 punte in die eerste helfte. Teen die einde van die wedstryd het hulle altesaam 78 punte behaal. Skryf ʼn getallesin en los dit op om te vind hoeveel punte hulle in die tweede helfte behaal het.\n\nSkryf slegs die getal.', answer: '33', checkMode: 'auto', correctAnswer: '33', explanation: 'Getallesin: 45 + □ = 78\nGebruik die omgekeerde: 78 − 45 = 33\nHulle het 33 punte in die tweede helfte behaal ✓' },
        { difficulty: 'Medium', question: 'ʼn Resep benodig 3 eiers om een bondel muffins te maak. Skryf ʼn getallesin en los dit op om te vind hoeveel eiers benodig word vir 8 bondels.\n\nSkryf slegs die getal.', answer: '24', checkMode: 'auto', correctAnswer: '24', explanation: 'Getallesin: 3 × 8 = □\n3 × 8 = 24\n24 eiers word benodig vir 8 bondels ✓' },
        { difficulty: 'Medium', question: 'Die klas moet 36 stoele in gelyke rye rangskik vir ʼn klaskamervergadering, met 9 stoele in elke ry. Skryf ʼn getallesin en los dit op om te vind hoeveel rye nodig is.\n\nSkryf slegs die getal.', answer: '4', checkMode: 'auto', correctAnswer: '4', explanation: 'Getallesin: 36 ÷ 9 = □\n36 ÷ 9 = 4\n4 rye is nodig ✓' },
        { difficulty: 'Medium', question: 'ʼn Gesin reis 240 km op die eerste dag van ʼn padtoer. Teen die einde van dag twee het hulle altesaam 410 km gereis.\n\na) Skryf die getallesin vir hierdie probleem. Gebruik □ vir die onbekende waarde.\nb) Los dit op om te vind hoe ver hulle op dag twee gereis het. Skryf slegs die getal.\nc) Verduidelik waarom jy aftrekking (as die omgekeerde) eerder as optelling gekies het om die ontbrekende waarde op te los.', answer: 'a) 240 + □ = 410  b) 170  c) Omdat die onbekende afstand by 240 getel is om die totaal van 410 te bereik, maak die aftrekking van 240 van 410 daardie optelling ongedaan en onthul dit die ontbrekende waarde.', parts: [ { label: 'a) Getallesin', correctAnswer: '240+□=410', correctAnswers: ['240+□=410', '240+?=410', '240+n=410'], explanation: 'ʼn Onbekende afstand word by 240 getel om ʼn totaal van 410 te gee.\nGetallesin: 240 + □ = 410', checkMode: 'auto' }, { label: 'b) Afstand op dag twee', correctAnswer: '170', explanation: 'Gebruik die omgekeerde — aftrekking: 410 − 240 = 170.\n□ = 170', checkMode: 'auto' }, { label: 'c) Redenasie', answer: 'Omdat die onbekende afstand by 240 getel is, word die omgekeerde bewerking (aftrekking) benodig om dit te isoleer en te vind: 410 − 240 = 170.', explanation: 'Aangesien die ontbrekende waarde by 240 getel is, maak aftrekking daardie optelling ongedaan en onthul dit die ontbrekende waarde.', checkMode: 'self' } ], checkMode: 'auto' },
      ...
      scoreMessages: [
        ...
        { minScore: 10, message: 'Goeie poging! Gaan die uitgewerkte voorbeelde oor omgekeerde bewerkings en sleutelwoorde weer deur, en probeer weer.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // Blok 1 — Ontbrekende waardes, een bewerking (Maklik) — posisies 0-4
        { difficulty: 'Easy', question: 'Vind die ontbrekende waarde. Skryf slegs die getal.\n\n□ − 25 = 17', answer: '42', checkMode: 'auto', correctAnswer: '42', explanation: 'Gebruik die omgekeerde — optelling: 17 + 25 = 42.\n□ = 42\nKontroleer: 42 − 25 = 17 ✓' },
        { difficulty: 'Easy', question: 'Vind die ontbrekende waarde. Skryf slegs die getal.\n\n5 × □ = 35', answer: '7', checkMode: 'auto', correctAnswer: '7', explanation: 'Gebruik die omgekeerde — deling: 35 ÷ 5 = 7.\n□ = 7\nKontroleer: 5 × 7 = 35 ✓' },
        { difficulty: 'Easy', question: 'Vind die ontbrekende waarde. Skryf slegs die getal.\n\n□ ÷ 5 = 7', answer: '35', checkMode: 'auto', correctAnswer: '35', explanation: 'Gebruik die omgekeerde — vermenigvuldiging: 7 × 5 = 35.\n□ = 35\nKontroleer: 35 ÷ 5 = 7 ✓' },
        { difficulty: 'Easy', question: 'Vind die ontbrekende waarde. Skryf slegs die getal.\n\n15 − □ = 8', answer: '7', checkMode: 'auto', correctAnswer: '7', explanation: 'Gebruik die omgekeerde — aftrekking: 15 − 8 = 7.\n□ = 7\nKontroleer: 15 − 7 = 8 ✓' },
        { difficulty: 'Easy', question: 'Vind die ontbrekende waarde. Skryf slegs die getal.\n\n□ + 48 = 91', answer: '43', checkMode: 'auto', correctAnswer: '43', explanation: 'Gebruik die omgekeerde — aftrekking: 91 − 48 = 43.\n□ = 43\nKontroleer: 43 + 48 = 91 ✓' },
        ...
        // Blok 3 — Redenering / foutopsporing (Medium) — posisies 9-11
        { difficulty: 'Medium', question: 'Verduidelik, in jou eie woorde, waarom jy aftrekking gebruik om die ontbrekende waarde in □ + 6 = 13 te vind, maar jy gebruik optelling om die ontbrekende waarde in □ − 6 = 13 te vind.', answer: 'Optelling en aftrekking is omgekeerde bewerkings — hulle maak mekaar ongedaan. In □ + 6 = 13 word ʼn getal bygetel, so deur 6 van 13 af te trek, word die optelling ongedaan gemaak en die ontbrekende waarde (7) onthul. In □ − 6 = 13 word ʼn getal afgetrek, so deur 6 by 13 te tel, word die aftrekking ongedaan gemaak en die ontbrekende waarde (19) onthul. Deur die omgekeerde bewerking te gebruik, word altyd "ongedaan gemaak" wat gedoen is om die ontbrekende waarde te isoleer.', checkMode: 'self' },
        { difficulty: 'Medium', question: 'Thabo beweer dat in die getallesin □ + 8 = 20, die ontbrekende waarde 12 moet wees. Is hy korrek? Verduidelik jou redenasie.', answer: 'Ja, Thabo is korrek. Aangesien 8 by die ontbrekende waarde getel word, moet jy die omgekeerde bewerking — aftrekking — gebruik om die optelling ongedaan te maak: 20 − 8 = 12, dus □ = 12. Deur terug te vervang om te kontroleer: 12 + 8 = 20, wat ooreenstem met die regterkant, wat bevestig dat Thabo se bewering korrek is.', checkMode: 'self' },
        { difficulty: 'Medium', question: 'ʼn Leerder sê dat 90 ÷ 9 = 8 ʼn ware getallesin is. ʼn Klasmaat stem nie saam nie. Wie is korrek, en hoe sou jy dit bewys?', answer: 'Die klasmaat is korrek — die leerder het ʼn fout gemaak. Om dit te bewys, bereken die linkerkant: 90 ÷ 9 = 10 (aangesien 9 × 10 = 90), nie 8 nie. Aangesien 10 ≠ 8, is die getallesin 90 ÷ 9 = 8 onwaar. Jy kan altyd bewys of ʼn getallesin waar of onwaar is deur die berekening op een kant werklik uit te werk en dit met die ander kant te vergelyk, eerder as om op ʼn raaiskoot staat te maak.', checkMode: 'self' },

        // Blok 4 — Woordprobleme: omskakel en oplos, een stap (Medium) — posisies 12-16
        { difficulty: 'Medium', question: 'Sipho het 50 lekkers. Hy gee ʼn paar weg en het 22 oor. Skryf ʼn getallesin en los dit op om te vind hoeveel hy weggegee het.\n\nSkryf slegs die getal.', answer: '28', checkMode: 'auto', correctAnswer: '28', explanation: 'Getallesin: 50 − □ = 22\nGebruik die omgekeerde: 50 − 22 = 28\nSipho het 28 lekkers weggegee ✓' },
        { difficulty: 'Medium', question: 'ʼn Sokkerspan reis 18 km na ʼn uitwedstryd en reis dan ʼn verdere afstand ʼn ander pad huis toe, en dek altesaam 45 km vir die retoerrit. Skryf ʼn getallesin en los dit op om die afstand op die terugrit te vind.\n\nSkryf slegs die getal.', answer: '27', checkMode: 'auto', correctAnswer: '27', explanation: 'Getallesin: 18 + □ = 45\nGebruik die omgekeerde: 45 − 18 = 27\nDie span het 27 km op die terugrit gereis ✓' },
        { difficulty: 'Medium', question: 'Elke klaskamerdesk huisves 4 leerders. Skryf ʼn getallesin en los dit op om te vind hoeveel leerders by 11 desks kan sit.\n\nSkryf slegs die getal.', answer: '44', checkMode: 'auto', correctAnswer: '44', explanation: 'Getallesin: 4 × 11 = □\n4 × 11 = 44\n44 leerders kan sit ✓' },
        { difficulty: 'Medium', question: 'Amahle het 96 krale. Sy deel dit gelykop tussen 8 vriende. Skryf ʼn getallesin en los dit op om te vind hoeveel krale elke vriend kry.\n\nSkryf slegs die getal.', answer: '12', checkMode: 'auto', correctAnswer: '12', explanation: 'Getallesin: 96 ÷ 8 = □\n96 ÷ 8 = 12\nElke vriend kry 12 krale ✓' },
        { difficulty: 'Medium', question: 'ʼn Winkel het ʼn aantal brode gehad. Teen die einde van die dag is 59 brode verkoop, en 37 brode het oorgebly.\n\na) Skryf die getallesin vir hierdie probleem. Gebruik □ vir die onbekende waarde.\nb) Los dit op om te vind hoeveel brode die winkel aan die begin gehad het. Skryf slegs die getal.\nc) Verduidelik waarom jy optelling (as die omgekeerde) gekies het om die ontbrekende waarde op te los.', answer: 'a) □ − 59 = 37  b) 96  c) Omdat 59 van die ontbrekende waarde afgetrek is, maak dit om 59 terug by 37 te tel daardie aftrekking ongedaan en onthul dit die ontbrekende waarde.', parts: [ { label: 'a) Getallesin', correctAnswer: '□-59=37', correctAnswers: ['□-59=37', '?-59=37', 'n-59=37', '□−59=37'], explanation: 'ʼn Onbekende beginhoeveelheid minus 59 (verkoop) laat 37 oor.\nGetallesin: □ − 59 = 37', checkMode: 'auto' }, { label: 'b) Beginbrode', correctAnswer: '96', explanation: 'Gebruik die omgekeerde — optelling: 37 + 59 = 96.\n□ = 96', checkMode: 'auto' }, { label: 'c) Redenasie', answer: 'Aangesien 59 van die ontbrekende waarde afgetrek is, is optelling die omgekeerde bewerking wat nodig is om dit te isoleer en te vind: 37 + 59 = 96.', explanation: 'Optelling maak aftrekking ongedaan — deur terug te tel wat weggeneem is, word die oorspronklike beginwaarde onthul.', checkMode: 'self' } ], checkMode: 'auto' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // Blok 1 — Ontbrekende waardes, een bewerking (Maklik) — posisies 0-4
        { difficulty: 'Easy', question: 'Vind die ontbrekende waarde. Skryf slegs die getal.\n\n□ + 27 = 45', answer: '18', checkMode: 'auto', correctAnswer: '18', explanation: 'Gebruik die omgekeerde — aftrekking: 45 − 27 = 18.\n□ = 18\nKontroleer: 18 + 27 = 45 ✓' },
        { difficulty: 'Easy', question: 'Vind die ontbrekende waarde. Skryf slegs die getal.\n\n93 − □ = 47', answer: '46', checkMode: 'auto', correctAnswer: '46', explanation: 'Gebruik die omgekeerde — aftrekking: 93 − 47 = 46.\n□ = 46\nKontroleer: 93 − 46 = 47 ✓' },
        { difficulty: 'Easy', question: 'Vind die ontbrekende waarde. Skryf slegs die getal.\n\n□ × 8 = 56', answer: '7', checkMode: 'auto', correctAnswer: '7', explanation: 'Gebruik die omgekeerde — deling: 56 ÷ 8 = 7.\n□ = 7\nKontroleer: 7 × 8 = 56 ✓' },
        { difficulty: 'Easy', question: 'Vind die ontbrekende waarde. Skryf slegs die getal.\n\n63 ÷ □ = 9', answer: '7', checkMode: 'auto', correctAnswer: '7', explanation: 'Gebruik die omgekeerde — vermenigvuldiging: 9 × 7 = 63.\n□ = 7\nKontroleer: 63 ÷ 7 = 9 ✓' },
        { difficulty: 'Easy', question: 'Vind die ontbrekende waarde. Skryf slegs die getal.\n\n□ − 38 = 54', answer: '92', checkMode: 'auto', correctAnswer: '92', explanation: 'Gebruik die omgekeerde — optelling: 54 + 38 = 92.\n□ = 92\nKontroleer: 92 − 38 = 54 ✓' },
        ...
        // Blok 3 — Redenering / foutopsporing (Medium) — posisies 9-11
        { difficulty: 'Medium', question: 'Verduidelik die verskil tussen □ + 5 = 9 en die vraag "is 4 + 5 = 9 waar of onwaar?" Waarom benodig een ʼn omgekeerde bewerking en die ander nie?', answer: '□ + 5 = 9 is ʼn oop getallesin — een waarde is onbekend, so jy moet ʼn omgekeerde bewerking (aftrekking: 9 − 5 = 4) gebruik om dit te vind. "Is 4 + 5 = 9 waar of onwaar?" het geen onbekendes nie — elke getal is reeds gegee, so jy bereken bloot die linkerkant (4 + 5 = 9) en vergelyk dit met die regterkant om te besluit of die stelling waar of onwaar is. Geen omgekeerde bewerking word benodig nie, aangesien daar niks ontbrekend is om voor op te los nie.', checkMode: 'self' },
        { difficulty: 'Medium', question: 'ʼn Leerder sê dat om te kontroleer of □ = 6 korrek is vir die getallesin 54 ÷ □ = 9, jy 54 ÷ 9 moet bereken. Is dit die korrekte manier om te kontroleer? Verduidelik.', answer: 'Nee, dit is nie die korrekte manier om te kontroleer nie. Om ʼn antwoord te kontroleer, vervang jy die gevonde waarde terug in die oorspronklike getallesin in die plek van die boks, en deel jy nie weer deur die boks se posisie nie. Die korrekte kontrole is om □ met 6 te vervang: 54 ÷ 6 = 9. Aangesien dit met die regterkant van die oorspronklike sin ooreenstem, word □ = 6 bevestig as korrek. Om 54 ÷ 9 te bereken (wat 6 gee) werk ook toevallig hier weens hoe deling en vermenigvuldiging verband hou, maar die korrekte kontrolemetode is altyd substitusie terug in die oorspronklike sin.', checkMode: 'self' },
        { difficulty: 'Medium', question: 'ʼn Klasmaat beweer dat 11 × 8 = 98 ʼn ware getallesin is. Stem jy saam? Verduidelik hoe jy dit sou kontroleer.', answer: 'Nee, ek stem nie saam nie. Om te kontroleer, bereken 11 × 8 = 88, nie 98 nie. Aangesien 88 ≠ 98, is die getallesin 11 × 8 = 98 onwaar. Jy moet altyd die berekening self uitwerk eerder as om ʼn bewerde antwoord sonder meer te aanvaar — dit is die beste manier om ʼn fout soos hierdie een raak te sien.', checkMode: 'self' },

        // Blok 4 — Woordprobleme: omskakel en oplos, een stap (Medium) — posisies 12-16
        { difficulty: 'Medium', question: 'Lerato spaar elke week R15. Skryf ʼn getallesin en los dit op om te vind hoeveel sy in 6 weke spaar.\n\nSkryf slegs die getal sonder die R-simbool.', answer: '90', checkMode: 'auto', correctAnswer: '90', correctAnswers: ['90', 'r90'], explanation: 'Getallesin: 15 × 6 = □\n15 × 6 = 90\nLerato spaar R90 in 6 weke ✓' },
        { difficulty: 'Medium', question: 'ʼn Fietsryer ry 22 km op Saterdag. Op Sondag ry sy ʼn verdere afstand, en dek altesaam 58 km oor die naweek. Skryf ʼn getallesin en los dit op om te vind hoe ver sy op Sondag gery het.\n\nSkryf slegs die getal.', answer: '36', checkMode: 'auto', correctAnswer: '36', explanation: 'Getallesin: 22 + □ = 58\nGebruik die omgekeerde: 58 − 22 = 36\nSy het 36 km op Sondag gery ✓' },
        { difficulty: 'Medium', question: 'ʼn Resep vir ʼn pot sop gebruik 6 aartappels vir een pot. Skryf ʼn getallesin en los dit op om te vind hoeveel aartappels nodig is om 7 potte te maak.\n\nSkryf slegs die getal.', answer: '42', checkMode: 'auto', correctAnswer: '42', explanation: 'Getallesin: 6 × 7 = □\n6 × 7 = 42\n42 aartappels is nodig vir 7 potte ✓' },
        { difficulty: 'Medium', question: '117 potlode word gelykop tussen 9 leerders verdeel. Skryf ʼn getallesin en los dit op om te vind hoeveel potlode elke leerder kry.\n\nSkryf slegs die getal.', answer: '13', checkMode: 'auto', correctAnswer: '13', explanation: 'Getallesin: 117 ÷ 9 = □\n117 ÷ 9 = 13\nElke leerder kry 13 potlode ✓' },
        ...
        { difficulty: 'Hard', question: 'Nomvula en Kagiso kry elkeen ʼn ander oop getallesin om op te los: Nomvula het □ − 18 = 25 en Kagiso het □ − 18 = 32. Kagiso kyk na Nomvula se werk en kopieer haar antwoord van □ = 43 vir sy eie sin. Verduidelik waarom dit ʼn fout is, en vind die korrekte ontbrekende waarde vir Kagiso se sin.', answer: 'Dit is ʼn fout omdat Kagiso se getallesin nie dieselfde is as Nomvula s\'n nie — die regterkant is anders (32 in plaas van 25), so dit benodig sy eie ontbrekende waarde; om ʼn antwoord van ʼn ander sin te kopieer maak nie sy sin waar nie. Om Kagiso se korrekte antwoord te vind, gebruik die omgekeerde bewerking op sy eie sin: 32 + 18 = 50, so □ = 50 vir Kagiso. (Kontroleer: 50 − 18 = 32 ✓, terwyl 43 − 18 = 25, wat slegs Nomvula se sin bevredig, nie Kagiso s\'n nie.)', checkMode: 'self' },
      ],
      scoreMessages: [
        { minScore: 20, message: 'Uitstekend! Jy het die vind van en redenering oor ontbrekende waardes in getallesinne baasgeraak.' },
        { minScore: 15, message: 'Goeie werk! Gaan enige vrae wat jy verkeerd gehad het weer deur en probeer weer.' },
