  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'ʼn Baba sal vandag iewers in Suid-Afrika gebore word. Klassifiseer hierdie gebeurtenis.', answer: 'Waarskynlik', checkMode: 'auto', correctAnswer: 'waarskynlik', correctAnswers: ['waarskynlik'], explanation: 'Dit is byna altyd waar — babas word elke enkele dag in Suid-Afrika gebore — maar dit is nie ʼn logiese sekerheid nie, so ons noem dit Waarskynlik eerder as Seker.' },
