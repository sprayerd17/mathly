  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'ʼn Keël het net een skerp punt aan sy bopunt. Hoeveel hoekpunte gee dit hom in totaal?', answer: '1', checkMode: 'auto', correctAnswer: '1', correctAnswers: ['1', 'een'], explanation: 'ʼn Keël het 1 hoekpunt — die skerp punt aan die bopunt, ook genoem die piek.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        // Blok 2 — Vlakke, Rande, Hoekpunte Tel (Maklik)
        { difficulty: 'Easy', question: 'Hoeveel hoekpunte het ʼn vierkantige piramide?', answer: '5', checkMode: 'auto', correctAnswer: '5', correctAnswers: ['5', 'vyf'], explanation: 'ʼn Vierkantige piramide het 5 hoekpunte — 4 by die basishoeke en 1 by die piek.' },
        ...
        { difficulty: 'Medium', question: 'Sonder om presies te tel, watter een dink jy het meer rande: ʼn driehoekige prisma of ʼn vierkantige piramide? Verduidelik jou redenasie.', answer: 'ʼn Driehoekige prisma, want ʼn prisma het twee volle basisse (wat elkeen rande bydra) plus verbindende rande, terwyl ʼn piramide net een basis plus rande wat na ʼn enkele piek skuins loop het — so die prisma het gewoonlik meer rande in totaal.', checkMode: 'self', explanation: 'ʼn Driehoekige prisma het eintlik 9 rande vergeleke met ʼn vierkantige piramide se 8, wat pas by die redenasie dat twee volle basisse gewoonlik meer rande bydra as een basis plus skuins rande na ʼn piek.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // Blok 1 — Noem uit Eienskappe (Maklik)
        { difficulty: 'Easy', question: 'Ek het ʼn driehoekige basis en nog 3 driehoekige vlakke wat by ʼn punt bo-aan ontmoet. Watter 3D-voorwerp is ek?', answer: 'Driehoekige piramide', checkMode: 'auto', correctAnswer: 'Driehoekige piramide', correctAnswers: ['Driehoekige piramide', 'driehoekige piramide', 'ʼn driehoekige piramide', 'tetraëder', 'ʼn tetraëder'], explanation: 'Al 4 vlakke is driehoeke, wat by ʼn piek ontmoet — dit beskryf ʼn driehoekige piramide (tetraëder).' },
        ...
        // Blok 2 — Vlakke, Rande, Hoekpunte Tel (Maklik)
        { difficulty: 'Easy', question: 'Hoeveel rande het ʼn vierkantige piramide?', answer: '8', checkMode: 'auto', correctAnswer: '8', correctAnswers: ['8', 'agt'], explanation: 'ʼn Vierkantige piramide het 8 rande — 4 rondom die vierkantige basis en 4 wat skuins na die piek loop.' },
        ...
        // Blok 4 — Sorteer en Klassifiseer (Medium)
        { difficulty: 'Medium', question: 'ʼn Voorwerp het 1 vierkantige vlak en 4 driehoekige vlakke. Watter 3D-voorwerp is dit, en hoeveel rande het dit?', answer: 'Vierkantige piramide, 8 rande', checkMode: 'self', explanation: '1 vierkantige basis + 4 driehoekige sye wat by ʼn piek ontmoet is ʼn vierkantige piramide, wat 8 rande het — 4 rondom die basis en 4 wat skuins na die piek loop.' },
