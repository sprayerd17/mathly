...
<div style="background:#fef9c3;border:1.5px solid #fde68a;border-radius:10px;padding:14px 18px;margin-bottom:16px;">
  ...
  <div style="display:flex;flex-direction:column;gap:10px;margin-top:10px;">
    ...
    <div style="display:flex;align-items:flex-start;gap:10px;">
      ...
      <span style="color:#78350f;font-size:15px;padding-top:1px;">Het <strong>een basis</strong> met <strong>driehoekige vlakke</strong> wat almal by ʼn enkele punt bo-aan ontmoet, genoem die <strong>toppunt</strong>. ʼn Vierkantige piramide het ʼn vierkantige basis. ʼn Driehoekige piramide (tetraëder) het ʼn driehoekbasis.</span>
    </div>
  </div>
</div>
`,
      workedExamples: [
        ...
        },
        {
          ...
          steps: [
            ...
            'ʼn <strong style="color:#dc2626;">Piramide</strong> het een basis met driehoekige vlakke wat by ʼn toppunt ontmoet.',
            ...
            '<strong>Vierkantige piramide</strong> — een vierkantige basis met 4 driehoekige vlakke wat by ʼn toppunt ontmoet ✔ piramide.',
            '<strong>Driehoekige piramide</strong> — een driehoekbasis met 3 driehoekige vlakke wat by ʼn toppunt ontmoet ✔ piramide.',
          ],
          answer:
  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'ʼn Keël het net een skerp punt aan sy bopunt. Hoeveel hoekpunte gee dit hom in totaal?', answer: '1', checkMode: 'auto', correctAnswer: '1', correctAnswers: ['1', 'een'], explanation: 'ʼn Keël het 1 hoekpunt — die skerp punt aan die bopunt, ook genoem die toppunt.' },
        ...
        { difficulty: 'Easy', question: 'Verduidelik waarom ʼn sfeer 0 rande het.', answer: 'ʼn Sfeer het 0 rande omdat ʼn rand net vorm waar twee plat vlakke ontmoet, en ʼn sfeer het glad geen plat vlakke nie — net een deurlopende geboë oppervlak.', checkMode: 'self', explanation: 'Rande vorm waar plat vlakke mekaar ontmoet. Omdat ʼn sfeer heeltemal geboë is, kan dit geen rande vorm nie.' },

        // Blok 3 — Vergelyk en Kontrasteer Voorwerpe (Medium)
        { difficulty: 'Medium', question: 'ʼn Kubus is ʼn spesiale soort reghoekige prisma. Wat maak ʼn kubus anders as ander reghoekige prismas?', answer: 'Al ʼn kubus se vlakke en rande is gelyke vierkante, terwyl ʼn gewone reghoekige prisma rande van verskillende lengtes kan hê.', checkMode: 'self', explanation: 'ʼn Kubus is ʼn spesiale reghoekige prisma waarvan al die vlakke gelyke vierkante is en al die rande dieselfde lengte het, terwyl ʼn algemene reghoekige prisma rande van verskillende lengtes kan hê.' },
        ...
        { difficulty: 'Medium', question: 'Noem die twee 3D-voorwerpe met geboë oppervlakke wat glad geen hoekpunte het nie.', answer: 'Sfeer en silinder', checkMode: 'self', explanation: 'ʼn Sfeer het 0 hoekpunte en ʼn silinder het ook 0 hoekpunte, omdat geeneen van hulle ʼn skerp punt het nie.' },
        ...
        { difficulty: 'Medium', question: 'Sorteer hierdie in prismas en piramides:\ndriehoekige prisma, vierkantige piramide, reghoekige prisma, driehoekige piramide, kubus', answer: 'a) driehoekige prisma, reghoekige prisma, kubus   b) vierkantige piramide, driehoekige piramide', checkMode: 'auto', parts: [
          ...
          { label: 'b) Piramides', correctAnswer: 'vierkantige piramide, driehoekige piramide', correctAnswers: ['vierkantige piramide, driehoekige piramide', 'driehoekige piramide, vierkantige piramide'], explanation: 'ʼn Piramide het een basis met driehoekige vlakke wat by ʼn enkele toppunt ontmoet. Vierkantige piramide en driehoekige piramide volg albei hierdie reël.' },
        ] },
        { difficulty: 'Medium', question: 'Sipho sê voorwerpe met slegs plat vlakke word veelvlakke genoem. Is hy reg?', answer: 'Ja', checkMode: 'auto', correctAnswer: 'Ja', correctAnswers: ['Ja', 'ja'], explanation: 'Voorwerpe met slegs plat vlakke (soos ʼn kubus of piramide) is veelvlakke. Voorwerpe met ʼn geboë oppervlak (soos ʼn sfeer) is nie.' },
        { difficulty: 'Medium', question: 'Watter een hoort nie by die res nie, en waarom: sfeer, silinder, keël, kubus?', answer: 'Kubus — dit is die enigste een met geen geboë oppervlak nie, so dit kan nie rol nie. Die ander drie het almal ʼn geboë oppervlak en kan rol.', checkMode: 'self', explanation: 'Sfeer, silinder en keël het almal ʼn geboë oppervlak. ʼn Kubus het slegs plat vlakke, wat dit die uitsondering maak.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // Blok 1 — Noem uit Eienskappe (Maklik)
        { difficulty: 'Easy', question: 'Ek is perfek rond met net een geboë oppervlak. Ek het geen plat vlakke, rande of hoekpunte nie. Watter 3D-voorwerp is ek?', answer: 'Sfeer', checkMode: 'auto', correctAnswer: 'Sfeer', correctAnswers: ['Sfeer', 'sfeer', 'ʼn sfeer'], explanation: 'Een deurlopende geboë oppervlak met geen plat vlakke, rande of hoekpunte nie beskryf ʼn sfeer.' },
        ...
        // Blok 2 — Vlakke, Rande, Hoekpunte Tel (Maklik)
        { difficulty: 'Easy', question: 'Hoeveel hoekpunte het ʼn vierkantige piramide?', answer: '5', checkMode: 'auto', correctAnswer: '5', correctAnswers: ['5', 'vyf'], explanation: 'ʼn Vierkantige piramide het 5 hoekpunte — 4 by die basishoeke en 1 by die toppunt.' },
        ...
        { difficulty: 'Easy', question: 'Verduidelik waarom ʼn sfeer 0 hoekpunte het, al lyk dit of dit op ʼn punt kan balanseer.', answer: 'ʼn Hoekpunt vorm net waar rande ontmoet, en ʼn sfeer het glad geen rande nie omdat dit geen plat vlakke het nie. Sonder enige rande is daar nêrens vir ʼn hoekpunt om te vorm nie.', checkMode: 'self', explanation: 'Hoekpunte benodig rande om te ontmoet. Omdat ʼn sfeer heeltemal geboë is en geen rande het nie, het dit 0 hoekpunte.' },
        ...
        { difficulty: 'Medium', question: 'Sonder om presies te tel, watter een dink jy het meer rande: ʼn driehoekige prisma of ʼn vierkantige piramide? Verduidelik jou redenasie.', answer: 'ʼn Driehoekige prisma, want ʼn prisma het twee volle basisse (wat elkeen rande bydra) plus verbindende rande, terwyl ʼn piramide net een basis plus rande wat na ʼn enkele toppunt skuins loop het — so die prisma het gewoonlik meer rande in totaal.', checkMode: 'self', explanation: 'ʼn Driehoekige prisma het eintlik 9 rande vergeleke met ʼn vierkantige piramide se 8, wat pas by die redenasie dat twee volle basisse gewoonlik meer rande bydra as een basis plus skuins rande na ʼn toppunt.' },

        // Blok 4 — Sorteer en Klassifiseer (Medium)
        { difficulty: 'Medium', question: 'Sorteer hierdie regte-lewe voorwerpe in kan rol en kan nie rol nie: ʼn albaster, ʼn vuurhoutjiedosie, ʼn verkeerskeël, ʼn boek.', answer: 'Kan rol: albaster, verkeerskeël.   Kan nie rol nie: vuurhoutjiedosie, boek.', checkMode: 'self', explanation: 'ʼn Albaster (sfeer) en verkeerskeël (keël) het altwee geboë oppervlakke, so hulle kan rol. ʼn Vuurhoutjiedosie en boek (reghoekige prismas) het slegs plat vlakke, so hulle kan nie rol nie.' },
        ...
        { difficulty: 'Medium', question: 'Watter van hierdie voorwerpe kan maklik op mekaar gestapel word: ʼn sfeer, ʼn kubus of ʼn keël?', answer: 'Kubus', checkMode: 'auto', correctAnswer: 'Kubus', correctAnswers: ['Kubus', 'kubus', 'ʼn kubus'], explanation: 'ʼn Kubus het plat vlakke wat stabiel op mekaar rus, anders as ʼn sfeer (rol weg) of ʼn keël (balanseer op ʼn punt).' },
        { difficulty: 'Medium', question: 'Watter een hoort nie by die res nie, en waarom: kubus, vierkantige piramide, driehoekige prisma, sfeer?', answer: 'Sfeer — dit is die enigste een met glad geen plat vlakke nie. Die ander drie is veelvlakke wat heeltemal uit plat vlakke bestaan.', checkMode: 'self', explanation: 'Kubus, vierkantige piramide en driehoekige prisma is almal veelvlakke met slegs plat vlakke. ʼn Sfeer het ʼn geboë oppervlak in plaas daarvan, wat dit die uitsondering maak.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        // Blok 1 — Noem uit Eienskappe (Maklik)
        { difficulty: 'Easy', question: 'Ek het ʼn driehoekige basis en nog 3 driehoekige vlakke wat by ʼn punt bo-aan ontmoet. Watter 3D-voorwerp is ek?', answer: 'Driehoekige piramide', checkMode: 'auto', correctAnswer: 'Driehoekige piramide', correctAnswers: ['Driehoekige piramide', 'driehoekige piramide', 'ʼn driehoekige piramide', 'tetraëder', 'ʼn tetraëder'], explanation: 'Al 4 vlakke is driehoeke, wat by ʼn toppunt ontmoet — dit beskryf ʼn driehoekige piramide (tetraëder).' },
        ...
        // Blok 2 — Vlakke, Rande, Hoekpunte Tel (Maklik)
        { difficulty: 'Easy', question: 'Hoeveel rande het ʼn vierkantige piramide?', answer: '8', checkMode: 'auto', correctAnswer: '8', correctAnswers: ['8', 'agt'], explanation: 'ʼn Vierkantige piramide het 8 rande — 4 rondom die vierkantige basis en 4 wat skuins na die toppunt loop.' },
        ...
        { difficulty: 'Easy', question: 'ʼn Sfeer het 0 plat vlakke. Verduidelik hoe hierdie feit alleen vir jou wys dat dit ook 0 rande moet hê.', answer: 'ʼn Rand kan net vorm waar twee plat vlakke ontmoet. Aangesien ʼn sfeer 0 plat vlakke het, is daar geen plat vlakke wat mekaar kan ontmoet nie, so dit kan ook geen rande hê nie.', checkMode: 'self', explanation: 'Rande hang af van plat vlakke wat ontmoet. Met glad geen plat vlakke nie, het ʼn sfeer geen moontlike rande nie.' },

        // Blok 3 — Vergelyk en Kontrasteer Voorwerpe (Medium)
        { difficulty: 'Medium', question: 'Watter voorwerp het presies 1 geboë oppervlak en slegs 1 plat vlak?', answer: 'Keël', checkMode: 'self', explanation: 'ʼn Keël het presies 1 plat sirkelvormige vlak en 1 geboë oppervlak — ʼn silinder het 2 plat vlakke en ʼn sfeer het 0.' },
        ...
        { difficulty: 'Medium', question: 'ʼn 3D-voorwerp het geen plat vlakke en geen rande nie. Wat is die enigste voorwerp wat dit kan wees?', answer: 'Sfeer', checkMode: 'auto', correctAnswer: 'Sfeer', correctAnswers: ['Sfeer', 'sfeer', 'ʼn sfeer'], explanation: 'ʼn Sfeer is die enigste algemene 3D-voorwerp met glad geen plat vlakke of rande nie — net een geboë oppervlak.' },
        ...
        // Blok 4 — Sorteer en Klassifiseer (Medium)
        { difficulty: 'Medium', question: 'ʼn Voorwerp het 1 vierkantige vlak en 4 driehoekige vlakke. Watter 3D-voorwerp is dit, en hoeveel rande het dit?', answer: 'Vierkantige piramide, 8 rande', checkMode: 'self', explanation: '1 vierkantige basis + 4 driehoekige sye wat by ʼn toppunt ontmoet is ʼn vierkantige piramide, wat 8 rande het — 4 rondom die basis en 4 wat skuins na die toppunt loop.' },
        ...
        { difficulty: 'Medium', question: 'Amahle het ʼn roomyshorinkie, ʼn dobbelsteen en ʼn sokkerbal. Pas elke item by sy 3D-voorwerp.', answer: 'Roomyshorinkie — keël; Dobbelsteen — kubus; Sokkerbal — sfeer.', checkMode: 'self', explanation: 'ʼn Roomyshorinkie is ʼn keël, ʼn dobbelsteen is ʼn kubus, en ʼn sokkerbal is ʼn sfeer.' },
