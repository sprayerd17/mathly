  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'Ek het twee plat sirkelvormige vlakke en een geboë oppervlak wat hulle verbind, en glad geen hoekpunte nie. Watter 3D-voorwerp is ek?', answer: 'Silinder', checkMode: 'auto', correctAnswer: 'Silinder', correctAnswers: ['Silinder', 'silinder', 'ʼn silinder'], explanation: 'Twee plat sirkelvormige vlakke verbind deur ʼn geboë oppervlak, sonder skerp punte, beskryf ʼn silinder.' },
        ...
        { difficulty: 'Medium', question: 'Thabo sê ʼn dobbelsteen is soos ʼn kubus gevorm. Is hy reg?', answer: 'Ja', checkMode: 'auto', correctAnswer: 'Ja', correctAnswers: ['Ja', 'ja'], explanation: 'ʼn Dobbelsteen het 6 gelyke vierkantige vlakke, 12 rande en 8 hoekpunte — dit is ʼn kubus.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'Ek het 5 hoekpunte in totaal. Vier van my vlakke is driehoeke en een vlak is ʼn ander vorm. Watter 3D-voorwerp is ek?', answer: 'Vierkantige piramide', checkMode: 'auto', correctAnswer: 'Vierkantige piramide', correctAnswers: ['Vierkantige piramide', 'vierkantige piramide', 'ʼn vierkantige piramide'], explanation: 'ʼn Vierkantige piramide het 5 hoekpunte: 4 driehoekige vlakke plus 1 vierkantige basis.' },
        ...
        { difficulty: 'Easy', question: 'Hoeveel vlakke het ʼn driehoekige prisma in totaal?', answer: '5', checkMode: 'auto', correctAnswer: '5', correctAnswers: ['5', 'vyf'], explanation: 'ʼn Driehoekige prisma het 5 vlakke — 2 driehoekige basisse en 3 reghoekige sy-vlakke.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Easy', question: 'Al my vlakke is plat vierkante, en ek het 8 hoekpunte. Watter 3D-voorwerp is ek?', answer: 'Kubus', checkMode: 'auto', correctAnswer: 'Kubus', correctAnswers: ['Kubus', 'kubus', 'ʼn kubus'], explanation: 'ʼn 3D-voorwerp met al plat vierkantige vlakke en 8 hoekpunte is ʼn kubus.' },
        { difficulty: 'Easy', question: 'Ek het presies 1 plat sirkelvormige vlak en 1 geboë oppervlak, en ek eindig in ʼn skerp punt. Watter 3D-voorwerp is ek?', answer: 'Keël', checkMode: 'auto', correctAnswer: 'Keël', correctAnswers: ['Keël', 'keël', 'ʼn keël'], explanation: 'Een plat sirkelvormige basis plus ʼn geboë oppervlak wat na ʼn punt smaller word, beskryf ʼn keël.' },
        { difficulty: 'Easy', question: 'Ek het 6 hoekpunte in totaal. Twee van my vlakke is driehoeke en die res is reghoeke. Watter 3D-voorwerp is ek?', answer: 'Driehoekige prisma', checkMode: 'auto', correctAnswer: 'Driehoekige prisma', correctAnswers: ['Driehoekige prisma', 'driehoekige prisma', 'ʼn driehoekige prisma'], explanation: 'ʼn Driehoekige prisma het 6 hoekpunte: 2 driehoekige basisse en 3 reghoekige sy-vlakke.' },
        ...
        { difficulty: 'Easy', question: 'Hoeveel plat vlakke het ʼn silinder?', answer: '2', checkMode: 'auto', correctAnswer: '2', correctAnswers: ['2', 'twee'], explanation: 'ʼn Silinder het 2 plat sirkelvormige vlakke, plus 1 geboë oppervlak wat hulle verbind.' },
        ...
        { difficulty: 'Medium', question: 'Amahle sê: "Alle prismas het presies 2 driehoekige vlakke." Is sy reg? Verduidelik.', answer: 'Nee. Net ʼn driehoekige prisma het 2 driehoekige vlakke (sy basisse). ʼn Reghoekige prisma het reghoekige basisse, nie driehoekige nie, so nie alle prismas het driehoekige vlakke nie.', checkMode: 'self', explanation: 'Die vorm van ʼn prisma se basisse pas by die naam van die prisma — ʼn driehoekige prisma het driehoekbasisse, ʼn reghoekige prisma het reghoekbasisse.' },
