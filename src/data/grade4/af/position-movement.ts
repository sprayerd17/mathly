  ...
  practiceSets: [
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'Vergelyk die roosterverwysings B3 en B1: is B3 hoër op, laer af, of in dieselfde ry as B1?', checkMode: 'auto', answer: 'Hoër op', correctAnswer: 'hoër op', correctAnswers: ['hoër op', 'hoer op', 'hoer'], explanation: 'Ry 3 is bo ry 1, aangesien rye toeneem soos jy opgaan, so B3 is hoër op as B1.' },
    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
      ...
      questions: [
        ...
        { difficulty: 'Medium', question: 'Vergelyk die roosterverwysings D2 en D4: is hierdie twee roosterverwysings dieselfde posisie, verskillende kolomme, of verskillende rye?', checkMode: 'auto', answer: 'Verskillende rye', correctAnswer: 'verskillende rye', correctAnswers: ['verskillende rye', 'verskillende ry', 'verskillende'], explanation: 'D2 en D4 deel dieselfde kolom (D) maar het verskillende rynommers (2 en 4), so hulle is verskillende rye.' },
