...
export const defaultTopics: Topic[] = [
  {
    ...
    nameAf: 'Topic 1',
    descriptionAf: 'Foundational concepts and key definitions to build your understanding.',
    free: true,
  },
  {
    slug: 'topic-2',
    ...
    nameAf: 'Topic 2',
    descriptionAf: 'Core techniques and step-by-step methods explained clearly.',
    free: false,
  },
  {
    slug: 'topic-3',
    ...
    nameAf: 'Topic 3',
    descriptionAf: 'Visual approaches and real-world applications of the concept.',
    free: false,
  },
  {
    slug: 'topic-4',
    ...
    nameAf: 'Topic 4',
    descriptionAf: 'Practice patterns and common problem types you will encounter.',
    free: false,
  },
  {
    slug: 'topic-5',
    ...
    nameAf: 'Topic 5',
    descriptionAf: 'Deeper exploration with worked examples and key formulas.',
    free: false,
  },
  {
    slug: 'topic-6',
    ...
    nameAf: 'Topic 6',
    descriptionAf: 'Advanced techniques that build on earlier concepts in this grade.',
    free: false,
  },
  {
    slug: 'topic-7',
    ...
    nameAf: 'Topic 7',
    descriptionAf: 'Mixed problem solving with strategy guides and common mistakes to avoid.',
    free: false,
  },
  {
    slug: 'topic-8',
    ...
    nameAf: 'Topic 8',
    descriptionAf: 'Review and consolidation with exam-style questions and model answers.',
    free: false,
  },
]
