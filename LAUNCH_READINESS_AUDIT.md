...
### 4. No named Information Officer
...
### 5. Waitlist page loads Google Analytics with no consent gate
...
### 6. AI Assistant chat panel overflows small phone screens
...
### 7. Pervasive low-contrast gray text
...
### 8. Paystack/internal error text passed straight to the client
